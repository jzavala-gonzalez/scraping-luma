const timestamp_saved = '09/29/2023 02:25 PM';
const dataFechaAcualizado = '9/29/2023' + ' 10:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'37', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'37', Cost:10.67, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 40,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 40, MVar:'15', Cost:25.99, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'91', Cost:9.41, ParentId: '17'},
		]
	},
