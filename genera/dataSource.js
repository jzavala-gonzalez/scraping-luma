const timestamp_saved = '10/02/2023 12:55 PM';
const dataFechaAcualizado = '10/2/2023' + ' 8:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'38', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'36', Cost:11.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'2', Cost:26.82, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 147, MVar:'0', Cost:17.10, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'163', Cost:17.06, ParentId: '16'},
		]
	},
