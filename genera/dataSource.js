const timestamp_saved = '11/27/2023 08:10 PM';
const dataFechaAcualizado = '11/27/2023' + ' 4:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'40', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'49', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'61', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'1', Cost:33.79, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 252,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 252, MVar:'170', Cost:17.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'112', Cost:9.21, ParentId: '17'},
		]
	},
