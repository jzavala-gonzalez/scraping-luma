const timestamp_saved = '10/03/2023 10:55 PM';
const dataFechaAcualizado = '10/3/2023' + ' 6:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'44', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'43', Cost:10.25, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:21.93, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'10', Cost:22.86, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'2', Cost:22.42, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:16.78, ParentId: '11'},
