const timestamp_saved = '10/21/2023 09:15 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'20', Cost:11.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'19', Cost:11.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'56', Cost:11.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'68', Cost:11.07, ParentId: '17'},
		]
	},
