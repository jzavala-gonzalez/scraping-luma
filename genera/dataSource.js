const timestamp_saved = '09/16/2023 03:40 AM';
const dataFechaAcualizado = '9/15/2023' + ' 11:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'45', Cost:12.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'44', Cost:12.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'60', Cost:12.76, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'0', Cost:26.29, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.38, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'17', Cost:18.87, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'143', Cost:16.71, ParentId: '16'},
		]
	},
