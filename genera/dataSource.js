const timestamp_saved = '11/25/2023 02:30 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 161,
		units:[
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'21', Cost:12.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'30', Cost:12.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'48', Cost:12.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.49, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 107, MVar:'30', Cost:19.82, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:19.82, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'11', Cost:19.75, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'28', Cost:9.84, ParentId: '17'},
		]
	},
