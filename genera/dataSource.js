const timestamp_saved = '09/30/2023 08:45 PM';
const dataFechaAcualizado = '9/30/2023' + ' 4:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'40', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'38', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'51', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 94,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 42, MVar:'4', Cost:39.56, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.05, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'46', Cost:17.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.49, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'19', Cost:19.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'84', Cost:16.53, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'143', Cost:17.40, ParentId: '16'},
		]
	},
