const timestamp_saved = '09/27/2023 05:00 AM';
const dataFechaAcualizado = '9/27/2023' + ' 12:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'31', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'33', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'64', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.37, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 306,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 306, MVar:'146', Cost:16.81, ParentId: '16'},
		]
	},
