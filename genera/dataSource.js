const timestamp_saved = '09/16/2023 12:00 PM';
const dataFechaAcualizado = '9/16/2023' + ' 7:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'41', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'40', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'56', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'82', Cost:9.47, ParentId: '17'},
		]
	},
