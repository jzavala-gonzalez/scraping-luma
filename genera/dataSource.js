const timestamp_saved = '11/24/2023 04:05 PM';
const dataFechaAcualizado = '11/24/2023' + ' 12:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'28', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'37', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 169,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'39', Cost:18.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:18.06, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'79', Cost:9.35, ParentId: '17'},
		]
	},
