const timestamp_saved = '11/21/2023 08:00 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 274,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 88, MVar:'18', Cost:13.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'28', Cost:13.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 100, MVar:'46', Cost:13.96, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'41', Cost:18.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'121', Cost:18.87, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'66', Cost:9.20, ParentId: '17'},
		]
	},
