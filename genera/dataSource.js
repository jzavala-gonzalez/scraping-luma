const timestamp_saved = '07/29/2023 02:55 AM';
const dataFechaAcualizado = '7/28/2023' + ' 10:50:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'2', Cost:22.39, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'0', Cost:22.17, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'8', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'82', Cost:16.66, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'23', Cost:15.57, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'78', Cost:13.85, ParentId: '17'},
		]
	},
