const timestamp_saved = '12/02/2023 10:10 PM';
const dataFechaAcualizado = '12/2/2023' + ' 6:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'54', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'56', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'56', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'16', Cost:56.91, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.71, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'97', Cost:10.88, ParentId: '17'},
		]
	},
