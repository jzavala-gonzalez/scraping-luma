const timestamp_saved = '07/29/2023 09:20 AM';
const dataFechaAcualizado = '7/29/2023' + ' 5:15:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'48', Cost:10.48, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 134, MVar:'25', Cost:15.97, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'79', Cost:13.64, ParentId: '17'},
		]
	},
