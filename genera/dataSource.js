const timestamp_saved = '11/23/2023 06:30 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:26:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1194},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'23', Cost:12.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'32', Cost:12.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'48', Cost:12.94, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'141', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'57', Cost:9.74, ParentId: '17'},
		]
	},
