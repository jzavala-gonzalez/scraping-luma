const timestamp_saved = '08/14/2023 03:50 PM';
const dataFechaAcualizado = '8/14/2023' + ' 11:47:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'51', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'47', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'3', Cost:27.56, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'7', Cost:26.88, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'23', Cost:30.94, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.64, ParentId: '12'},
