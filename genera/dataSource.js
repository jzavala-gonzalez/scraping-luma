const timestamp_saved = '12/03/2023 12:50 PM';
const dataFechaAcualizado = '12/3/2023' + ' 8:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 198, MVar:'63', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'36', Cost:13.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'38', Cost:13.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'44', Cost:13.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'53', Cost:11.62, ParentId: '17'},
		]
	},
