const timestamp_saved = '11/08/2023 10:10 PM';
const dataFechaAcualizado = '11/8/2023' + ' 6:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'54', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'54', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'55', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:51.73, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'4', Cost:23.66, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'8', Cost:19.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'95', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'177', Cost:17.15, ParentId: '16'},
		]
	},
