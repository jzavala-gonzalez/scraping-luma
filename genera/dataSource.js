const timestamp_saved = '11/30/2023 01:20 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 127, MVar:'53', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'76', Cost:9.58, ParentId: '17'},
		]
	},
