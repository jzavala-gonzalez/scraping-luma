const timestamp_saved = '09/10/2023 03:00 PM';
const dataFechaAcualizado = '9/10/2023' + ' 10:55:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'62', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'61', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'63', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'125', Cost:18.29, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 64,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 35, MVar:'9', Cost:19.60, ParentId: '19'},
