const timestamp_saved = '09/10/2023 06:15 PM';
const dataFechaAcualizado = '9/10/2023' + ' 2:10:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'63', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'63', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'63', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'4', Cost:30.84, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'17', Cost:18.77, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'78', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'123', Cost:17.89, ParentId: '16'},
		]
	},
