const timestamp_saved = '10/29/2023 10:10 AM';
const dataFechaAcualizado = '10/29/2023' + ' 6:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'46', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'47', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'69', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'66', Cost:16.94, ParentId: '15'},
