const timestamp_saved = '10/28/2023 11:30 AM';
const dataFechaAcualizado = '10/28/2023' + ' 7:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'42', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'44', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'17', Cost:31.07, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.57, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'17', Cost:18.89, ParentId: '14'},
