const timestamp_saved = '08/18/2023 06:30 PM';
const dataFechaAcualizado = '8/18/2023' + ' 2:27:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'64', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'73', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'10', Cost:30.76, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'31', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'83', Cost:18.39, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'147', Cost:17.39, ParentId: '16'},
		]
	},
