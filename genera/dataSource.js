const timestamp_saved = '12/05/2023 10:21 AM';
const dataFechaAcualizado = '12/5/2023' + ' 6:16:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'52', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'46', Cost:8.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'10', Cost:8.01, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'71', Cost:11.20, ParentId: '17'},
		]
	},
