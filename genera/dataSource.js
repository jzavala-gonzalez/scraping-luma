const timestamp_saved = '10/19/2023 11:35 AM';
const dataFechaAcualizado = '10/19/2023' + ' 7:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'32', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'41', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'45', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'29', Cost:9.47, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:9.47, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:19.51, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'145', Cost:17.37, ParentId: '16'},
		]
	},
