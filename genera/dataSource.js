const timestamp_saved = '11/22/2023 09:30 PM';
const dataFechaAcualizado = '11/22/2023' + ' 5:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'34', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:11.74, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'21', Cost:34.36, ParentId: '10'},
