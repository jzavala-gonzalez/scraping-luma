const timestamp_saved = '10/26/2023 09:05 PM';
const dataFechaAcualizado = '10/26/2023' + ' 5:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'52', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'53', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'54', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'146', Cost:16.76, ParentId: '16'},
		]
	},
