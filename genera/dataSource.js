const timestamp_saved = '11/08/2023 07:10 AM';
const dataFechaAcualizado = '11/8/2023' + ' 3:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'38', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'35', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'42', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'68', Cost:16.71, ParentId: '15'},
