const timestamp_saved = '09/30/2023 12:50 PM';
const dataFechaAcualizado = '9/30/2023' + ' 8:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'30', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'28', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.40, ParentId: '14'},
