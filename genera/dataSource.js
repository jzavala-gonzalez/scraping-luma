const timestamp_saved = '09/24/2023 01:05 PM';
const dataFechaAcualizado = '9/24/2023' + ' 9:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'41', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'44', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'54', Cost:12.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 65,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 251, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:31.29, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'78', Cost:9.53, ParentId: '17'},
		]
	},
