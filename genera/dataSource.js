const timestamp_saved = '10/31/2023 01:30 AM';
const dataFechaAcualizado = '10/30/2023' + ' 9:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'65', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'68', Cost:10.68, ParentId: '7'},
		]
	},
