const timestamp_saved = '09/12/2023 10:50 AM';
const dataFechaAcualizado = '9/12/2023' + ' 6:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'61', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:26.29, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'114', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'38', Cost:10.35, ParentId: '17'},
		]
	},
