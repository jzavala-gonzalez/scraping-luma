const timestamp_saved = '11/20/2023 12:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 8:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'42', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'51', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'61', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'181', Cost:18.25, ParentId: '16'},
		]
	},
