const timestamp_saved = '11/23/2023 08:00 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'26', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'36', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'49', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'54', Cost:9.80, ParentId: '17'},
		]
	},
