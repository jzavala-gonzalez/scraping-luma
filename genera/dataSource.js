const timestamp_saved = '09/14/2023 07:25 PM';
const dataFechaAcualizado = '9/14/2023' + ' 3:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'58', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'68', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 71, MVar:'0', Cost:7.05, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 58, MVar:'13', Cost:30.96, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:28.44, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'104', Cost:17.21, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'170', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'119', Cost:9.22, ParentId: '17'},
		]
	},
