const timestamp_saved = '10/11/2023 07:45 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'45', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'48', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'57', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'41', Cost:17.82, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'58', Cost:9.11, ParentId: '17'},
		]
	},
