const timestamp_saved = '10/22/2023 09:40 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'48', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'49', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'47', Cost:10.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 13,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 13, MVar:'0', Cost:22.95, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'10', Cost:18.29, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'70', Cost:11.29, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:21.69, ParentId: '21'},
