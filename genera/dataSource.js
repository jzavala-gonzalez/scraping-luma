const timestamp_saved = '11/04/2023 02:10 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'44', Cost:12.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:12.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'43', Cost:12.59, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'85', Cost:16.95, ParentId: '15'},
