const timestamp_saved = '10/29/2023 03:00 AM';
const dataFechaAcualizado = '10/28/2023' + ' 10:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'47', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'47', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'70', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'6', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'138', Cost:17.41, ParentId: '16'},
		]
	},
