const timestamp_saved = '10/01/2023 01:35 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 256,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'75', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 4, MVar:'33', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'28', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'26', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'44', Cost:10.76, ParentId: '7'},
		]
	},
