const timestamp_saved = '10/05/2023 03:05 PM';
const dataFechaAcualizado = '10/5/2023' + ' 11:01:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'44', Cost:10.35, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'114', Cost:9.34, ParentId: '17'},
		]
	},
