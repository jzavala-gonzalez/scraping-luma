const timestamp_saved = '10/20/2023 06:25 AM';
const dataFechaAcualizado = '10/20/2023' + ' 2:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'34', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'41', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'40', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'81', Cost:10.53, ParentId: '17'},
		]
	},
