const timestamp_saved = '10/25/2023 12:00 PM';
const dataFechaAcualizado = '10/25/2023' + ' 7:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:11.07, ParentId: '7'},
