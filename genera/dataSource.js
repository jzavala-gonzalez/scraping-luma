const timestamp_saved = '11/30/2023 11:35 PM';
const dataFechaAcualizado = '11/30/2023' + ' 7:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'61', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'63', Cost:10.60, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'21', Cost:30.99, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'162', Cost:17.73, ParentId: '16'},
		]
	},
