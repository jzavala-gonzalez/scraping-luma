const timestamp_saved = '09/10/2023 08:35 AM';
const dataFechaAcualizado = '9/10/2023' + ' 4:30:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'63', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'61', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'63', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 94, MVar:'29', Cost:8.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:8.89, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'0', Cost:11.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'10', Cost:11.61, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'6', Cost:28.02, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'64', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'128', Cost:17.14, ParentId: '16'},
		]
	},
