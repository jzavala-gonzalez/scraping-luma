const timestamp_saved = '09/22/2023 07:20 AM';
const dataFechaAcualizado = '9/22/2023' + ' 3:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'40', Cost:10.84, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'8', Cost:8.31, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 182,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 182, MVar:'67', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'71', Cost:32.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'79', Cost:17.18, ParentId: '17'},
		]
	},
