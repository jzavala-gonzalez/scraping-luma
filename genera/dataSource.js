const timestamp_saved = '10/30/2023 03:45 PM';
const dataFechaAcualizado = '10/30/2023' + ' 11:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 251,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'106', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'65', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'68', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'69', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'39', Cost:18.42, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 316,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 316, MVar:'90', Cost:9.34, ParentId: '17'},
		]
	},
