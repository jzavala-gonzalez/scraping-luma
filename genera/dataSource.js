const timestamp_saved = '08/04/2023 08:25 PM';
const dataFechaAcualizado = '8/4/2023' + ' 4:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'45', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'50', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:28.81, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'49', Cost:16.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'153', Cost:16.97, ParentId: '16'},
		]
	},
