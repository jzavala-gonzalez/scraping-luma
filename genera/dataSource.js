const timestamp_saved = '10/26/2023 05:40 AM';
const dataFechaAcualizado = '10/26/2023' + ' 1:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'38', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'41', Cost:10.85, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'46', Cost:18.43, ParentId: '15'},
