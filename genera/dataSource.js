const timestamp_saved = '08/16/2023 05:35 PM';
const dataFechaAcualizado = '8/16/2023' + ' 1:32:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'64', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'91', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'60', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'58', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'62', Cost:10.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 110, MVar:'0', Cost:6.80, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'13', Cost:30.97, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'34', Cost:18.88, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'194', Cost:17.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'99', Cost:10.24, ParentId: '17'},
		]
	},
