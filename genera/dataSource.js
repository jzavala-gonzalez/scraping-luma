const timestamp_saved = '11/20/2023 09:10 AM';
const dataFechaAcualizado = '11/20/2023' + ' 5:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'29', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'54', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'92', Cost:9.18, ParentId: '17'},
		]
	},
