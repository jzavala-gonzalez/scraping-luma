const timestamp_saved = '11/27/2023 10:35 AM';
const dataFechaAcualizado = '11/27/2023' + ' 6:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'26', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'36', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'49', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'50', Cost:8.22, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'18', Cost:19.44, ParentId: '14'},
