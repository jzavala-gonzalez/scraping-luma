const timestamp_saved = '09/27/2023 01:05 PM';
const dataFechaAcualizado = '9/27/2023' + ' 9:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'32', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'32', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:17.84, ParentId: '11'},
