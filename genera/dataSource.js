const timestamp_saved = '10/30/2023 11:55 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'64', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'67', Cost:10.34, ParentId: '7'},
