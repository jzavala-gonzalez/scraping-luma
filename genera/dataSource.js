const timestamp_saved = '09/07/2023 11:00 AM';
const dataFechaAcualizado = '9/7/2023' + ' 6:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'48', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'38', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'44', Cost:11.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:7.11, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:18.99, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'138', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'89', Cost:9.78, ParentId: '17'},
		]
	},
