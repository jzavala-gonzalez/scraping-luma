const timestamp_saved = '10/01/2023 10:20 PM';
const dataFechaAcualizado = '10/1/2023' + ' 6:15:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2622},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'31', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'47', Cost:10.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:35.12, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'7', Cost:17.03, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:42.06, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 13, MVar:'2', Cost:42.06, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'137', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'102', Cost:9.20, ParentId: '17'},
		]
	},
