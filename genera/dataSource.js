const timestamp_saved = '09/06/2023 02:30 AM';
const dataFechaAcualizado = '9/5/2023' + ' 10:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'51', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'53', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'63', Cost:11.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 184,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:31.76, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:26.02, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:19.94, ParentId: '11'},
