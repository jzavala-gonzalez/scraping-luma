const timestamp_saved = '12/02/2023 03:45 PM';
const dataFechaAcualizado = '12/2/2023' + ' 11:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 187,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 187, MVar:'75', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'44', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'45', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'46', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.51, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 232,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 232, MVar:'66', Cost:11.93, ParentId: '17'},
		]
	},
