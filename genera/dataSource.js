const timestamp_saved = '11/06/2023 03:45 PM';
const dataFechaAcualizado = '11/6/2023' + ' 11:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'58', Cost:10.45, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'160', Cost:18.30, ParentId: '16'},
		]
	},
