const timestamp_saved = '10/19/2023 06:25 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'29', Cost:12.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'38', Cost:12.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'43', Cost:12.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'81', Cost:10.93, ParentId: '17'},
		]
	},
