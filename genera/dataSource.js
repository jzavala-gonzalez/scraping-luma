const timestamp_saved = '09/12/2023 09:05 PM';
const dataFechaAcualizado = '9/12/2023' + ' 5:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'59', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'56', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'67', Cost:10.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 59, MVar:'0', Cost:13.21, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 151, MVar:'80', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'108', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'152', Cost:16.75, ParentId: '16'},
		]
	},
