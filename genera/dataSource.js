const timestamp_saved = '10/04/2023 09:40 PM';
const dataFechaAcualizado = '10/4/2023' + ' 5:36:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'48', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'46', Cost:10.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'6', Cost:17.43, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'37', Cost:17.95, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'8', Cost:17.95, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'84', Cost:17.08, ParentId: '15'},
