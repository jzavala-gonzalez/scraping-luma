const timestamp_saved = '11/28/2023 12:20 PM';
const dataFechaAcualizado = '11/28/2023' + ' 8:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'31', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'41', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'54', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'154', Cost:18.25, ParentId: '16'},
		]
	},
