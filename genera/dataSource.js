const timestamp_saved = '08/08/2023 10:05 AM';
const dataFechaAcualizado = '8/8/2023' + ' 6:00:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'48', Cost:10.86, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'38', Cost:20.46, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'30', Cost:16.29, ParentId: '15'},
		]
	},
