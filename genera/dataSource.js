const timestamp_saved = '09/18/2023 07:10 PM';
const dataFechaAcualizado = '9/18/2023' + ' 3:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'56', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'68', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'70', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 69, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:30.99, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.46, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'95', Cost:17.04, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 77,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 19, MVar:'21', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 26, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
