const timestamp_saved = '11/07/2023 01:15 AM';
const dataFechaAcualizado = '11/6/2023' + ' 9:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'53', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'52', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'50', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 66, MVar:'8', Cost:19.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'76', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'172', Cost:17.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'110', Cost:9.21, ParentId: '17'},
		]
	},
