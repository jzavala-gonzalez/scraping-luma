const timestamp_saved = '08/11/2023 09:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 5:32:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'48', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'1', Cost:29.61, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'11', Cost:30.88, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:31.91, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:31.79, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:31.83, ParentId: '13'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 26,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 7, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
