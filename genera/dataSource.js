const timestamp_saved = '09/03/2023 07:15 PM';
const dataFechaAcualizado = '9/3/2023' + ' 3:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'38', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'42', Cost:10.88, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'80', Cost:16.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'66', Cost:9.30, ParentId: '17'},
		]
	},
