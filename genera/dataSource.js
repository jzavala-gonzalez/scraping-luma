const timestamp_saved = '08/29/2023 10:00 AM';
const dataFechaAcualizado = '8/29/2023' + ' 5:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'57', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'76', Cost:16.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'151', Cost:18.32, ParentId: '16'},
		]
	},
