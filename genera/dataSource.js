const timestamp_saved = '11/11/2023 06:10 PM';
const dataFechaAcualizado = '11/11/2023' + ' 2:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'48', Cost:10.23, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'48', Cost:8.23, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'31', Cost:30.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'10', Cost:22.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'125', Cost:9.54, ParentId: '17'},
		]
	},
