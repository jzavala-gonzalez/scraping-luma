const timestamp_saved = '10/26/2023 08:00 PM';
const dataFechaAcualizado = '10/26/2023' + ' 3:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'5', Type:'Hidroelectricas', Desc:'Yauco', SiteTotal: 8,
		units:[
			{Index:'0', Unit:'Hidro 1', MW: 0, MVar:'0', Cost:0, ParentId: '5'},
			{Index:'1', Unit:'Hidro 2', MW: 4, MVar:'0', Cost:9.35, ParentId: '5'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'50', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'54', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 165, MVar:'53', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 26,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'21', Cost:42.24, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.42, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'35', Cost:18.18, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'140', Cost:17.38, ParentId: '16'},
		]
	},
