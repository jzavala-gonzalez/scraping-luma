const timestamp_saved = '09/30/2023 05:55 PM';
const dataFechaAcualizado = '9/30/2023' + ' 1:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'37', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'35', Cost:10.29, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 91, MVar:'28', Cost:18.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:18.70, ParentId: '11'},
