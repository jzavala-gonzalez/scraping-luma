const timestamp_saved = '08/09/2023 05:20 PM';
const dataFechaAcualizado = '8/9/2023' + ' 1:15:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'61', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'60', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'34', Cost:19.11, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'85', Cost:11.52, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 72,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 34, MVar:'1', Cost:17, ParentId: '19'},
		]
	},
