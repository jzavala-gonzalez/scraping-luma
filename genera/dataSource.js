const timestamp_saved = '11/12/2023 09:00 AM';
const dataFechaAcualizado = '11/12/2023' + ' 4:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'51', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:30.23, ParentId: '13'},
