const timestamp_saved = '10/29/2023 11:25 PM';
const dataFechaAcualizado = '10/29/2023' + ' 7:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'50', Cost:10.26, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 215, MVar:'64', Cost:10.28, ParentId: '17'},
		]
	},
