const timestamp_saved = '07/29/2023 07:50 PM';
const dataFechaAcualizado = '7/29/2023' + ' 3:45:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'55', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'51', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'5', Cost:0, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'12', Cost:30.88, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 132, MVar:'40', Cost:18.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:18.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 132, MVar:'0', Cost:18.09, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.34, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'93', Cost:10.89, ParentId: '17'},
		]
	},
