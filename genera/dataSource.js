const timestamp_saved = '10/01/2023 01:20 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 265,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'77', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 12, MVar:'34', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'27', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'26', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'44', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'109', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'84', Cost:9.50, ParentId: '17'},
		]
	},
