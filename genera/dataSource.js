const timestamp_saved = '11/07/2023 02:25 AM';
const dataFechaAcualizado = '11/6/2023' + ' 10:21:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'50', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'48', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'46', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:28.73, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:8.22, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:28.78, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'0', Cost:28.65, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'7', Cost:19.97, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'162', Cost:17.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'103', Cost:9.20, ParentId: '17'},
		]
	},
