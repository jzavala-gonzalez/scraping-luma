const timestamp_saved = '10/22/2023 06:05 AM';
const dataFechaAcualizado = '10/22/2023' + ' 2:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'44', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'45', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'47', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 6,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 6, MVar:'2', Cost:35.66, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.58, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 185,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'142', Cost:19.46, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'64', Cost:11.11, ParentId: '17'},
		]
	},
