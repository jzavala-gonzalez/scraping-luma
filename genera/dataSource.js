const timestamp_saved = '11/01/2023 01:40 PM';
const dataFechaAcualizado = '11/1/2023' + ' 9:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'58', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'61', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'65', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'81', Cost:16.99, ParentId: '15'},
