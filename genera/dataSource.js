const timestamp_saved = '10/21/2023 01:05 AM';
const dataFechaAcualizado = '10/20/2023' + ' 9:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'44', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'51', Cost:10.43, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'6', Cost:19.29, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'106', Cost:10.53, ParentId: '17'},
		]
	},
