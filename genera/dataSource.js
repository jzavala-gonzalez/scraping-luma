const timestamp_saved = '11/02/2023 08:10 AM';
const dataFechaAcualizado = '11/2/2023' + ' 4:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'45', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'46', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'43', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'53', Cost:9.60, ParentId: '17'},
		]
	},
