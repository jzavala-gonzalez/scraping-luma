const timestamp_saved = '11/27/2023 06:20 AM';
const dataFechaAcualizado = '11/27/2023' + ' 2:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'22', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'32', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'63', Cost:9.86, ParentId: '17'},
		]
	},
