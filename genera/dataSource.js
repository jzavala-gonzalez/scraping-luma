const timestamp_saved = '10/04/2023 12:55 PM';
const dataFechaAcualizado = '10/4/2023' + ' 8:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'41', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'169', Cost:16.98, ParentId: '16'},
		]
	},
