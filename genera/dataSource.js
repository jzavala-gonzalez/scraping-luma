const timestamp_saved = '09/28/2023 09:05 AM';
const dataFechaAcualizado = '9/28/2023' + ' 5:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'17', Cost:13.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'18', Cost:13.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'43', Cost:13.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.20, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'90', Cost:18.43, ParentId: '16'},
		]
	},
