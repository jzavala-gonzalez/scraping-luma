const timestamp_saved = '10/20/2023 06:10 AM';
const dataFechaAcualizado = '10/20/2023' + ' 2:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'31', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'42', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'42', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'7', Cost:19.28, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'133', Cost:18.51, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'82', Cost:10.53, ParentId: '17'},
		]
	},
