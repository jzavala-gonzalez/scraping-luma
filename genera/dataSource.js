const timestamp_saved = '09/11/2023 04:35 PM';
const dataFechaAcualizado = '9/11/2023' + ' 12:30:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'70', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'68', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'75', Cost:10.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 82, MVar:'0', Cost:9.05, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'8', Cost:30.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:31.20, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.52, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'93', Cost:17.16, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 105,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 39, MVar:'25', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 31, MVar:'13', Cost:17, ParentId: '19'},
		]
	},
