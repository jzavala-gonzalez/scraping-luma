const timestamp_saved = '12/05/2023 01:55 AM';
const dataFechaAcualizado = '12/4/2023' + ' 9:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'56', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'58', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'62', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'88', Cost:10.87, ParentId: '17'},
		]
	},
