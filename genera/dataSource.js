const timestamp_saved = '09/29/2023 04:25 AM';
const dataFechaAcualizado = '9/29/2023' + ' 12:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'38', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'36', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:17.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:17.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:20.92, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'0', Cost:20.92, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'61', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 261, MVar:'118', Cost:17.45, ParentId: '16'},
		]
	},
