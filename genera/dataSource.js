const timestamp_saved = '11/22/2023 06:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 1:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'33', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'43', Cost:10.98, ParentId: '7'},
