const timestamp_saved = '08/05/2023 03:00 PM';
const dataFechaAcualizado = '8/5/2023' + ' 10:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'43', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.89, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'43', Cost:8.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:8.36, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'3', Cost:31.30, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'80', Cost:16.55, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'44', Cost:15.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'93', Cost:11.78, ParentId: '17'},
		]
	},
