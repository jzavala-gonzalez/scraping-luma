const timestamp_saved = '11/27/2023 01:00 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'30', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'40', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'24', Cost:19.42, ParentId: '14'},
