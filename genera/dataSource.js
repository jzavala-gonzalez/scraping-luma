const timestamp_saved = '11/28/2023 06:10 PM';
const dataFechaAcualizado = '11/28/2023' + ' 2:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'42', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'50', Cost:10.25, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'103', Cost:9.83, ParentId: '17'},
		]
	},
