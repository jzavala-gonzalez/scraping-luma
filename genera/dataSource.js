const timestamp_saved = '10/15/2023 02:00 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'63', Cost:9.52, ParentId: '17'},
		]
	},
