const timestamp_saved = '09/14/2023 03:25 AM';
const dataFechaAcualizado = '9/13/2023' + ' 11:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 36,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:27.31, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.63, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 15, MVar:'1', Cost:26.65, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'7', Cost:10.07, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'56', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'173', Cost:16.66, ParentId: '16'},
		]
	},
