const timestamp_saved = '09/05/2023 08:45 AM';
const dataFechaAcualizado = '9/5/2023' + ' 4:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'34', Cost:0, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'38', Cost:0, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'53', Cost:0, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.48, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'10', Cost:19.23, ParentId: '14'},
