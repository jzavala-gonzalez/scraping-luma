const timestamp_saved = '11/18/2023 08:40 PM';
const dataFechaAcualizado = '11/18/2023' + ' 4:36:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2628},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:14.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'65', Cost:14.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'4', Cost:14.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.47, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.08, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'6', Cost:30.78, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:31.18, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 131,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'12', Cost:22.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'82', Cost:16.48, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'137', Cost:9.13, ParentId: '17'},
		]
	},
