const timestamp_saved = '10/01/2023 01:15 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 12, MVar:'34', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'27', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'26', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.79, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'108', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'85', Cost:9.48, ParentId: '17'},
		]
	},
