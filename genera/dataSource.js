const timestamp_saved = '08/05/2023 01:35 PM';
const dataFechaAcualizado = '8/5/2023' + ' 9:30:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'40', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'47', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'2', Cost:26.95, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.51, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'86', Cost:16.53, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'44', Cost:15.38, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'89', Cost:11.70, ParentId: '17'},
		]
	},
