const timestamp_saved = '11/09/2023 02:00 PM';
const dataFechaAcualizado = '11/9/2023' + ' 9:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'46', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'43', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'49', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:31.06, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'19', Cost:22.06, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'83', Cost:9.76, ParentId: '17'},
		]
	},
