const timestamp_saved = '09/17/2023 06:55 PM';
const dataFechaAcualizado = '9/17/2023' + ' 2:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'45', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'59', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'24', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'115', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'81', Cost:9.25, ParentId: '17'},
		]
	},
