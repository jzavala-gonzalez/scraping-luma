const timestamp_saved = '11/26/2023 06:20 PM';
const dataFechaAcualizado = '11/26/2023' + ' 2:16:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1151},
	{Index:'5', Desc:'Capacidad Disponible', value: 3107},
	{Index:'6', Desc:'Próxima Hora MW', value: 2001},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'25', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'36', Cost:11.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.94, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'137', Cost:19.70, ParentId: '16'},
		]
	},
