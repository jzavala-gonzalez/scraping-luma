const timestamp_saved = '10/14/2023 05:00 PM';
const dataFechaAcualizado = '10/14/2023' + ' 12:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'49', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'50', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'80', Cost:9.29, ParentId: '17'},
		]
	},
