const timestamp_saved = '10/15/2023 01:40 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'53', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'47', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'52', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'64', Cost:9.55, ParentId: '17'},
		]
	},
