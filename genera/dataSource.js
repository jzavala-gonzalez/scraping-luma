const timestamp_saved = '08/24/2023 04:00 PM';
const dataFechaAcualizado = '8/24/2023' + ' 11:55:45 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'61', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'61', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'58', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'19', Cost:31.39, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'32', Cost:18.98, ParentId: '14'},
