const timestamp_saved = '08/28/2023 01:40 PM';
const dataFechaAcualizado = '8/28/2023' + ' 9:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'52', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'55', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'17', Cost:31.04, ParentId: '10'},
		]
	},
