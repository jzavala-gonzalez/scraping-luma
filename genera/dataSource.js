const timestamp_saved = '09/21/2023 11:10 PM';
const dataFechaAcualizado = '9/21/2023' + ' 7:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 550,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:9.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'52', Cost:9.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'68', Cost:9.90, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 169,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:32.51, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'4', Cost:24.55, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 27, MVar:'3', Cost:22.24, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'11', Cost:27.96, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'5', Cost:30.10, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 88,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'5', Cost:29.37, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 55, MVar:'21', Cost:21.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'98', Cost:16.32, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'136', Cost:32.80, ParentId: '16'},
		]
	},
