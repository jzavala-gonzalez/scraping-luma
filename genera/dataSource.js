const timestamp_saved = '08/12/2023 01:55 PM';
const dataFechaAcualizado = '8/12/2023' + ' 9:52:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 233, MVar:'77', Cost:4.38, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'45', Cost:10.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 48, MVar:'31', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'97', Cost:11.63, ParentId: '17'},
		]
	},
