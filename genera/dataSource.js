const timestamp_saved = '10/29/2023 11:00 PM';
const dataFechaAcualizado = '10/29/2023' + ' 6:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'50', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'51', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'71', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'16', Cost:21.63, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'145', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 214,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 214, MVar:'65', Cost:10.31, ParentId: '17'},
		]
	},
