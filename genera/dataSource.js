const timestamp_saved = '09/27/2023 11:20 PM';
const dataFechaAcualizado = '9/27/2023' + ' 7:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'37', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'37', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'66', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'152', Cost:17.41, ParentId: '16'},
		]
	},
