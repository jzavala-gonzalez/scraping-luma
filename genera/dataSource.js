const timestamp_saved = '09/28/2023 01:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 9:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'37', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'37', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'66', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:30.47, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'144', Cost:17.31, ParentId: '16'},
		]
	},
