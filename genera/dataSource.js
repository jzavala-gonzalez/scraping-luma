const timestamp_saved = '10/07/2023 08:40 AM';
const dataFechaAcualizado = '10/7/2023' + ' 4:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 57, MVar:'32', Cost:4.63, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.63, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'46', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'47', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'48', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'5', Cost:30.83, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'4', Cost:31.11, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'57', Cost:16.86, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'93', Cost:9.26, ParentId: '17'},
		]
	},
