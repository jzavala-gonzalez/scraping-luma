const timestamp_saved = '08/03/2023 06:15 PM';
const dataFechaAcualizado = '8/3/2023' + ' 2:10:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'52', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'50', Cost:10.31, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'108', Cost:17.09, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'96', Cost:11.39, ParentId: '17'},
		]
	},
