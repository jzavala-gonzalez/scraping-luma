const timestamp_saved = '08/12/2023 03:10 PM';
const dataFechaAcualizado = '8/12/2023' + ' 11:07:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 157, MVar:'47', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'102', Cost:11.63, ParentId: '17'},
		]
	},
