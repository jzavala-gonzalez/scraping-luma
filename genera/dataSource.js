const timestamp_saved = '10/13/2023 01:20 PM';
const dataFechaAcualizado = '10/13/2023' + ' 9:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'62', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'68', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'71', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'80', Cost:9.20, ParentId: '17'},
		]
	},
