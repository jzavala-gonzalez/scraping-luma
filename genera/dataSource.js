const timestamp_saved = '10/18/2023 03:30 PM';
const dataFechaAcualizado = '10/18/2023' + ' 11:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'51', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'64', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'77', Cost:23.22, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'105', Cost:10.56, ParentId: '17'},
		]
	},
