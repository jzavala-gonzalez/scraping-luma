const timestamp_saved = '10/27/2023 12:30 AM';
const dataFechaAcualizado = '10/26/2023' + ' 8:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'56', Cost:10.10, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'29', Cost:31.10, ParentId: '10'},
