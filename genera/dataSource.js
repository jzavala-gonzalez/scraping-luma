const timestamp_saved = '09/10/2023 01:05 AM';
const dataFechaAcualizado = '9/9/2023' + ' 9:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 561,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'75', Cost:9.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'72', Cost:9.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'72', Cost:9.84, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:22.20, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:28.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'10', Cost:28.29, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'80', Cost:16.99, ParentId: '15'},
