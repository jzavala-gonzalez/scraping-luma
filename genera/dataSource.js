const timestamp_saved = '11/22/2023 09:25 AM';
const dataFechaAcualizado = '11/22/2023' + ' 5:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'24', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'33', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'70', Cost:9.78, ParentId: '17'},
		]
	},
