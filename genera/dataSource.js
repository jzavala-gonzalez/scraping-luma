const timestamp_saved = '11/29/2023 05:30 AM';
const dataFechaAcualizado = '11/29/2023' + ' 1:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'27', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'37', Cost:10.90, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.20, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'74', Cost:9.80, ParentId: '17'},
		]
	},
