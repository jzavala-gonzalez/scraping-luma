const timestamp_saved = '11/19/2023 03:40 AM';
const dataFechaAcualizado = '11/18/2023' + ' 11:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:14.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'60', Cost:14.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'9', Cost:8.21, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'65', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'136', Cost:18.36, ParentId: '16'},
		]
	},
