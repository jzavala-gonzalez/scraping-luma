const timestamp_saved = '11/16/2023 04:50 AM';
const dataFechaAcualizado = '11/16/2023' + ' 12:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'44', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'44', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 187,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 187, MVar:'62', Cost:10.79, ParentId: '17'},
		]
	},
