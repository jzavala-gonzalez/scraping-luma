const timestamp_saved = '11/15/2023 07:05 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'31', Cost:13.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'36', Cost:13.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'43', Cost:13.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.64, ParentId: '11'},
