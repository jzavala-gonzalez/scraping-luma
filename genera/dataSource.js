const timestamp_saved = '11/23/2023 12:00 PM';
const dataFechaAcualizado = '11/23/2023' + ' 7:56:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1873},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'21', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'31', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'46', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'63', Cost:9.76, ParentId: '17'},
		]
	},
