const timestamp_saved = '09/11/2023 11:40 PM';
const dataFechaAcualizado = '9/11/2023' + ' 7:35:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'69', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'69', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 213, MVar:'78', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.23, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'8', Cost:27.75, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'5', Cost:22.39, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'11', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'84', Cost:16.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'165', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 0, MVar:'40', Cost:24.99, ParentId: '17'},
		]
	},
