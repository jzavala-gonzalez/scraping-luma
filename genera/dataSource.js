const timestamp_saved = '09/24/2023 06:35 AM';
const dataFechaAcualizado = '9/24/2023' + ' 2:30:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'40', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:12.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'53', Cost:12.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 93,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 42, MVar:'0', Cost:30.84, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'5', Cost:31.35, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'73', Cost:9.25, ParentId: '17'},
		]
	},
