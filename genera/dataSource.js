const timestamp_saved = '12/06/2023 01:50 AM';
const dataFechaAcualizado = '12/5/2023' + ' 9:45:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 400},
	{Index:'6', Desc:'Reserva Operacional', value: 671},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'58', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'58', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'62', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 48, MVar:'0', Cost:10.47, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'92', Cost:10.88, ParentId: '17'},
		]
	},
