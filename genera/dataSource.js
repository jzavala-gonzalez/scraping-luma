const timestamp_saved = '09/30/2023 05:35 AM';
const dataFechaAcualizado = '9/30/2023' + ' 1:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'55', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'34', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'32', Cost:10.54, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:8.32, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:17.15, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:17.15, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 42, MVar:'4', Cost:29.56, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'6', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 196,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 196, MVar:'90', Cost:10.23, ParentId: '17'},
		]
	},
