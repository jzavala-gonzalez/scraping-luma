const timestamp_saved = '11/15/2023 09:40 PM';
const dataFechaAcualizado = '11/15/2023' + ' 5:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'56', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'56', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:30.47, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'103', Cost:9.17, ParentId: '17'},
		]
	},
