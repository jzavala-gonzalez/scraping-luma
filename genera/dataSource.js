const timestamp_saved = '10/27/2023 10:10 AM';
const dataFechaAcualizado = '10/27/2023' + ' 6:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'50', Cost:10.22, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'92', Cost:17.04, ParentId: '15'},
