const timestamp_saved = '09/30/2023 08:00 PM';
const dataFechaAcualizado = '9/30/2023' + ' 3:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'66', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'39', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'37', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'50', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.35, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'18', Cost:19.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'82', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'143', Cost:17.79, ParentId: '16'},
		]
	},
