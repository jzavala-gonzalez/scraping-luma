const timestamp_saved = '12/06/2023 04:50 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:45:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Capacidad Disponible', value: 3015},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'47', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'51', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'58', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'67', Cost:14.58, ParentId: '17'},
		]
	},
