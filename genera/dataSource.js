const timestamp_saved = '09/03/2023 01:40 PM';
const dataFechaAcualizado = '9/3/2023' + ' 9:35:51 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1103},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'32', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'37', Cost:10.95, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'55', Cost:9.80, ParentId: '17'},
		]
	},
