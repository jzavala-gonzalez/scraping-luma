const timestamp_saved = '11/30/2023 12:30 PM';
const dataFechaAcualizado = '11/30/2023' + ' 8:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'52', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.47, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:17.47, ParentId: '11'},
