const timestamp_saved = '10/21/2023 08:55 AM';
const dataFechaAcualizado = '10/21/2023' + ' 4:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'20', Cost:11.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'17', Cost:11.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'56', Cost:11.98, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'6', Cost:19.11, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'68', Cost:11.03, ParentId: '17'},
		]
	},
