const timestamp_saved = '08/11/2023 11:20 PM';
const dataFechaAcualizado = '8/11/2023' + ' 7:17:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2977},
	{Index:'7', Desc:'Máxima para Hoy', value: 2967},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'51', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'8', Cost:23.13, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 56, MVar:'13', Cost:30.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'16', Cost:31.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:31.30, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:31.84, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:33.89, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'186', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'142', Cost:11.42, ParentId: '17'},
		]
	},
