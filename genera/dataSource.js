const timestamp_saved = '12/03/2023 07:45 AM';
const dataFechaAcualizado = '12/3/2023' + ' 3:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'39', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'41', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'96', Cost:18.22, ParentId: '16'},
		]
	},
