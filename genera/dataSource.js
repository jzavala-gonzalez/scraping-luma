const timestamp_saved = '12/02/2023 09:10 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'40', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'42', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'47', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'49', Cost:8.09, ParentId: '11'},
