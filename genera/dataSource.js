const timestamp_saved = '08/13/2023 06:40 AM';
const dataFechaAcualizado = '8/13/2023' + ' 2:37:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 509,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'41', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'48', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'45', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:26.09, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'40', Cost:18.87, ParentId: '14'},
