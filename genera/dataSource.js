const timestamp_saved = '09/18/2023 03:45 PM';
const dataFechaAcualizado = '9/18/2023' + ' 11:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'50', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'50', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'62', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'30', Cost:18.98, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'83', Cost:9.81, ParentId: '17'},
		]
	},
