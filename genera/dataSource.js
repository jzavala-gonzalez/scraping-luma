const timestamp_saved = '08/12/2023 04:55 PM';
const dataFechaAcualizado = '8/12/2023' + ' 12:52:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 238, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'88', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'50', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'47', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 39,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'0', Cost:26.33, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'6', Cost:32.58, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'4', Cost:33.02, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'147', Cost:18.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'98', Cost:11.61, ParentId: '17'},
		]
	},
