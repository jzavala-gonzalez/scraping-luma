const timestamp_saved = '09/13/2023 02:20 PM';
const dataFechaAcualizado = '9/13/2023' + ' 10:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'51', Cost:12.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'50', Cost:12.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'66', Cost:12.23, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'14', Cost:28.36, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'22', Cost:19.05, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 86,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 37, MVar:'19', Cost:19.60, ParentId: '19'},
