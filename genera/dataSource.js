const timestamp_saved = '09/22/2023 10:50 PM';
const dataFechaAcualizado = '9/22/2023' + ' 6:45:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 105},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 236, MVar:'75', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'79', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 542,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:9.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'51', Cost:9.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 200, MVar:'67', Cost:9.93, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:22.62, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 127,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'10', Cost:28.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.11, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:19.95, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'9', Cost:32.14, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'28', Cost:19.08, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'128', Cost:32.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'111', Cost:9.13, ParentId: '17'},
		]
	},
