const timestamp_saved = '11/07/2023 06:45 AM';
const dataFechaAcualizado = '11/7/2023' + ' 2:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'38', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.40, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'124', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'69', Cost:9.80, ParentId: '17'},
		]
	},
