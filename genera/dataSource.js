const timestamp_saved = '11/25/2023 11:15 PM';
const dataFechaAcualizado = '11/25/2023' + ' 7:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 204, MVar:'68', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'34', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:11.33, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'41', Cost:18.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:18.07, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'34', Cost:18.47, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.63, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'22', Cost:9.93, ParentId: '17'},
		]
	},
