const timestamp_saved = '09/01/2023 01:50 AM';
const dataFechaAcualizado = '8/31/2023' + ' 9:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'49', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'58', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'66', Cost:11.57, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 153,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'38', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'11', Cost:30.64, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'88', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'188', Cost:16.65, ParentId: '16'},
		]
	},
