const timestamp_saved = '08/12/2023 01:35 PM';
const dataFechaAcualizado = '8/12/2023' + ' 9:32:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 234, MVar:'80', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'48', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'45', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'5', Cost:27.30, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'0', Cost:20.27, ParentId: '11'},
