const timestamp_saved = '09/16/2023 01:25 PM';
const dataFechaAcualizado = '9/16/2023' + ' 9:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'40', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'38', Cost:11.23, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'102', Cost:19.72, ParentId: '16'},
		]
	},
