const timestamp_saved = '10/15/2023 08:40 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'46', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'47', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'53', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'57', Cost:9.18, ParentId: '17'},
		]
	},
