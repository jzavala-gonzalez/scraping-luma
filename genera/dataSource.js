const timestamp_saved = '09/11/2023 04:50 PM';
const dataFechaAcualizado = '9/11/2023' + ' 12:45:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'70', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'68', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'77', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'8', Cost:30.93, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'8', Cost:31.28, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.93, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'25', Cost:19.16, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'94', Cost:16.61, ParentId: '15'},
