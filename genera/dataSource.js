const timestamp_saved = '09/18/2023 06:25 AM';
const dataFechaAcualizado = '9/18/2023' + ' 2:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'42', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'58', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'20', Cost:18.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'123', Cost:19.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'72', Cost:9.13, ParentId: '17'},
		]
	},
