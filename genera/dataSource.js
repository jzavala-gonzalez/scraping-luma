const timestamp_saved = '08/12/2023 07:05 AM';
const dataFechaAcualizado = '8/12/2023' + ' 3:02:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'53', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'57', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'52', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'177', Cost:16.69, ParentId: '16'},
		]
	},
