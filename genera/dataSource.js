const timestamp_saved = '07/30/2023 06:50 AM';
const dataFechaAcualizado = '7/30/2023' + ' 2:45:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'47', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'40', Cost:10.86, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.21, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 17, MVar:'5', Cost:26.98, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'9', Cost:30.86, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'64', Cost:17.09, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 102, MVar:'65', Cost:25.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'71', Cost:11.15, ParentId: '17'},
		]
	},
