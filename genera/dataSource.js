const timestamp_saved = '08/12/2023 11:00 PM';
const dataFechaAcualizado = '8/12/2023' + ' 6:57:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'80', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'91', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'41', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'44', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'43', Cost:10.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 73, MVar:'0', Cost:6.63, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 53,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'8', Cost:30.97, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'160', Cost:17.14, ParentId: '16'},
		]
	},
