const timestamp_saved = '09/27/2023 11:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'26', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'28', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'58', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'76', Cost:9.42, ParentId: '17'},
		]
	},
