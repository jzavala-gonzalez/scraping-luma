const timestamp_saved = '09/04/2023 05:35 AM';
const dataFechaAcualizado = '9/4/2023' + ' 1:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'68', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'36', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.50, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'45', Cost:8.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:8.21, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:8.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'15', Cost:8.11, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.65, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'136', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'60', Cost:9.35, ParentId: '17'},
		]
	},
