const timestamp_saved = '10/31/2023 02:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 9:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'65', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'68', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'81', Cost:16.90, ParentId: '15'},
