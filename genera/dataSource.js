const timestamp_saved = '11/10/2023 12:50 PM';
const dataFechaAcualizado = '11/10/2023' + ' 8:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'51', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'56', Cost:11.38, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'10', Cost:21.70, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'76', Cost:9.54, ParentId: '17'},
		]
	},
