const timestamp_saved = '11/25/2023 02:15 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'22', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'31', Cost:12.41, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'28', Cost:20.56, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:20.56, ParentId: '11'},
		]
	},
