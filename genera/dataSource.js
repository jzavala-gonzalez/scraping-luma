const timestamp_saved = '11/23/2023 01:30 PM';
const dataFechaAcualizado = '11/23/2023' + ' 9:26:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1204},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 209, MVar:'73', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'21', Cost:12.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'31', Cost:12.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'47', Cost:12.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 99, MVar:'32', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:19.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'66', Cost:9.79, ParentId: '17'},
		]
	},
