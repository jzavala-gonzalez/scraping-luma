const timestamp_saved = '12/04/2023 06:30 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'36', Cost:12.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'39', Cost:12.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'45', Cost:12.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'44', Cost:11.61, ParentId: '17'},
		]
	},
