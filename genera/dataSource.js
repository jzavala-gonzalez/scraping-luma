const timestamp_saved = '10/19/2023 11:06 AM';
const dataFechaAcualizado = '10/19/2023' + ' 7:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'33', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'39', Cost:11.07, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 278,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'30', Cost:19.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:19.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'30', Cost:8.98, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:8.98, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'7', Cost:46.54, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'145', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'95', Cost:10.53, ParentId: '17'},
		]
	},
