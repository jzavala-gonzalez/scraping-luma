const timestamp_saved = '10/02/2023 08:10 AM';
const dataFechaAcualizado = '10/2/2023' + ' 4:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'31', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'29', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'45', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'4', Cost:19.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'72', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'124', Cost:17.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 202,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 202, MVar:'84', Cost:10.40, ParentId: '17'},
		]
	},
