const timestamp_saved = '09/07/2023 07:05 AM';
const dataFechaAcualizado = '9/7/2023' + ' 3:00:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'48', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'27', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'45', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'2', Cost:19.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'62', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'130', Cost:17.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'85', Cost:9.83, ParentId: '17'},
		]
	},
