const timestamp_saved = '10/18/2023 02:00 AM';
const dataFechaAcualizado = '10/17/2023' + ' 9:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'65', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'64', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'35', Cost:17.23, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:19.64, ParentId: '14'},
