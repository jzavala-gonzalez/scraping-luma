const timestamp_saved = '11/20/2023 10:15 PM';
const dataFechaAcualizado = '11/20/2023' + ' 6:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'38', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'47', Cost:10.73, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'84', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'103', Cost:9.43, ParentId: '17'},
		]
	},
