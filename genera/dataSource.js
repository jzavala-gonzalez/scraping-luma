const timestamp_saved = '09/16/2023 03:30 PM';
const dataFechaAcualizado = '9/16/2023' + ' 11:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'41', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'40', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 147, MVar:'68', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'26', Cost:19.43, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 213,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'104', Cost:18.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'82', Cost:9.46, ParentId: '17'},
		]
	},
