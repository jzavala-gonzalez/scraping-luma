const timestamp_saved = '10/21/2023 06:50 PM';
const dataFechaAcualizado = '10/21/2023' + ' 2:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'47', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'48', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'51', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'35', Cost:17.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'11', Cost:17.14, ParentId: '11'},
		]
	},
