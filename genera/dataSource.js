const timestamp_saved = '09/29/2023 07:15 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'33', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'29', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'47', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.68, ParentId: '11'},
