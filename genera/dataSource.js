const timestamp_saved = '10/26/2023 06:56 AM';
const dataFechaAcualizado = '10/26/2023' + ' 2:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'34', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'37', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'42', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'12', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'45', Cost:18.44, ParentId: '15'},
