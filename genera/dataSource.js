const timestamp_saved = '08/08/2023 07:30 PM';
const dataFechaAcualizado = '8/8/2023' + ' 3:25:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 465},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'79', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'58', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'65', Cost:11.22, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 115, MVar:'0', Cost:6.97, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'3', Cost:23.66, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.89, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'5', Cost:22.68, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'5', Cost:28.81, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'41', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 158, MVar:'52', Cost:15.57, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 360, MVar:'180', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'103', Cost:12.22, ParentId: '17'},
		]
	},
