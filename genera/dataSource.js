const timestamp_saved = '09/17/2023 09:25 AM';
const dataFechaAcualizado = '9/17/2023' + ' 5:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'38', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'55', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:19.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 137, MVar:'0', Cost:8.20, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'10', Cost:8.20, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'20', Cost:19.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'70', Cost:18.37, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'111', Cost:18.09, ParentId: '16'},
		]
	},
