const timestamp_saved = '11/27/2023 12:30 AM';
const dataFechaAcualizado = '11/26/2023' + ' 8:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'39', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'49', Cost:10.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'163', Cost:16.95, ParentId: '16'},
		]
	},
