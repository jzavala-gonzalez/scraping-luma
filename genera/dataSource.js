const timestamp_saved = '10/21/2023 11:45 AM';
const dataFechaAcualizado = '10/21/2023' + ' 7:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'36', Cost:12.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'35', Cost:12.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'37', Cost:12.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.58, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'67', Cost:11.06, ParentId: '17'},
		]
	},
