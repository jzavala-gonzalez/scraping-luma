const timestamp_saved = '08/14/2023 07:25 AM';
const dataFechaAcualizado = '8/14/2023' + ' 3:22:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'36', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'41', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'40', Cost:10.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 82,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 127, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'15', Cost:30.97, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'144', Cost:16.95, ParentId: '16'},
		]
	},
