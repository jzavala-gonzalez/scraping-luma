const timestamp_saved = '11/23/2023 07:35 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'23', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'34', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'55', Cost:9.81, ParentId: '17'},
		]
	},
