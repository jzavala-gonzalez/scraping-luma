const timestamp_saved = '10/31/2023 10:55 PM';
const dataFechaAcualizado = '10/31/2023' + ' 6:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'64', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'68', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'70', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 77,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 148, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:26.37, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.92, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'30', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:25.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'48', Cost:16.95, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:16.95, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.58, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:31.37, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'28', Cost:18.71, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'173', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'97', Cost:9.13, ParentId: '17'},
		]
	},
