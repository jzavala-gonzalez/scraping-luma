const timestamp_saved = '08/31/2023 10:00 AM';
const dataFechaAcualizado = '8/31/2023' + ' 5:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 153, MVar:'61', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'79', Cost:16.44, ParentId: '15'},
