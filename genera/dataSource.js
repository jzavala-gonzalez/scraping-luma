const timestamp_saved = '08/17/2023 09:15 AM';
const dataFechaAcualizado = '8/17/2023' + ' 5:12:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'69', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 224,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 224, MVar:'66', Cost:10.17, ParentId: '17'},
		]
	},
