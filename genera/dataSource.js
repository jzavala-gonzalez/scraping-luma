const timestamp_saved = '08/24/2023 05:30 AM';
const dataFechaAcualizado = '8/24/2023' + ' 1:25:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'54', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'50', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'19', Cost:19.01, ParentId: '14'},
