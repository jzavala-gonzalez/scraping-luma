const timestamp_saved = '08/22/2023 12:50 PM';
const dataFechaAcualizado = '8/22/2023' + ' 8:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'137', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'83', Cost:9.26, ParentId: '17'},
		]
	},
