const timestamp_saved = '11/21/2023 03:15 AM';
const dataFechaAcualizado = '11/20/2023' + ' 11:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'32', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'42', Cost:11.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'162', Cost:18.26, ParentId: '16'},
		]
	},
