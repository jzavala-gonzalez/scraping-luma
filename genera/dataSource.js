const timestamp_saved = '10/20/2023 11:25 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'42', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'48', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'156', Cost:17.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'108', Cost:10.56, ParentId: '17'},
		]
	},
