const timestamp_saved = '08/05/2023 08:25 AM';
const dataFechaAcualizado = '8/5/2023' + ' 4:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'38', Cost:10.67, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'93', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'83', Cost:11.29, ParentId: '17'},
		]
	},
