const timestamp_saved = '11/11/2023 04:35 AM';
const dataFechaAcualizado = '11/11/2023' + ' 12:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 240,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'83', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'44', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'46', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'49', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'86', Cost:16.84, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'82', Cost:9.23, ParentId: '17'},
		]
	},
