const timestamp_saved = '07/28/2023 04:58 AM';
const dataFechaAcualizado = '7/28/2023' + ' 12:50:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'45', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:23.06, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'1', Cost:22.38, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:9.76, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:9.76, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'30', Cost:15.43, ParentId: '15'},
		]
	},
