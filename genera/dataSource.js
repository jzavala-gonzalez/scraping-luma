const timestamp_saved = '12/02/2023 01:50 PM';
const dataFechaAcualizado = '12/2/2023' + ' 9:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 242,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'78', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'42', Cost:13.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'46', Cost:13.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'44', Cost:13.01, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'29', Cost:19.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'122', Cost:18.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 234,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 234, MVar:'64', Cost:10.01, ParentId: '17'},
		]
	},
