const timestamp_saved = '10/08/2023 06:00 AM';
const dataFechaAcualizado = '10/8/2023' + ' 1:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'39', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'40', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:16.92, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'81', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'145', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 142,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 142, MVar:'73', Cost:12.00, ParentId: '17'},
		]
	},
