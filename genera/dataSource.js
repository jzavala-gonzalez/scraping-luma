const timestamp_saved = '10/19/2023 08:01 AM';
const dataFechaAcualizado = '10/19/2023' + ' 3:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'31', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'38', Cost:10.53, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'0', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'63', Cost:16.91, ParentId: '15'},
