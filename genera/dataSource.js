const timestamp_saved = '11/11/2023 01:50 PM';
const dataFechaAcualizado = '11/11/2023' + ' 9:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'42', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'43', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'49', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'102', Cost:9.60, ParentId: '17'},
		]
	},
