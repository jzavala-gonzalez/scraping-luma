const timestamp_saved = '11/03/2023 03:35 PM';
const dataFechaAcualizado = '11/3/2023' + ' 11:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'54', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'54', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'50', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'78', Cost:9.77, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 104,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 39, MVar:'19', Cost:19.60, ParentId: '19'},
