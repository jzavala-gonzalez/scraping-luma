const timestamp_saved = '09/13/2023 02:40 PM';
const dataFechaAcualizado = '9/13/2023' + ' 10:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'53', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'52', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'66', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'14', Cost:28.29, ParentId: '10'},
		]
	},
