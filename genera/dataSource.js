const timestamp_saved = '10/06/2023 07:20 AM';
const dataFechaAcualizado = '10/6/2023' + ' 3:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'34', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'33', Cost:10.61, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'58', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 214,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'159', Cost:18.53, ParentId: '16'},
		]
	},
