const timestamp_saved = '10/23/2023 05:35 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'38', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'38', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'39', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'112', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'51', Cost:11.31, ParentId: '17'},
		]
	},
