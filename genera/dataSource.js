const timestamp_saved = '10/09/2023 01:50 AM';
const dataFechaAcualizado = '10/8/2023' + ' 9:46:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'52', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'54', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'54', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'7', Cost:26.38, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'23', Cost:27.68, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'85', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'164', Cost:16.66, ParentId: '16'},
		]
	},
