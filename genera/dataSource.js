const timestamp_saved = '07/25/2023 11:48 PM';
const dataFechaAcualizado = '7/25/2023' + ' 7:40:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'59', Cost:10.15, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'85', Cost:9.34, ParentId: '17'},
		]
	},
