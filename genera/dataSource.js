const timestamp_saved = '11/24/2023 06:00 AM';
const dataFechaAcualizado = '11/24/2023' + ' 1:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'23', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'32', Cost:11.10, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 11, MVar:'0', Cost:30.57, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:19.60, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'71', Cost:9.51, ParentId: '17'},
		]
	},
