const timestamp_saved = '08/18/2023 02:10 PM';
const dataFechaAcualizado = '8/18/2023' + ' 10:07:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'62', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'71', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'9', Cost:31.30, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'35', Cost:18.11, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 16,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 16, MVar:'32', Cost:48.38, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'146', Cost:17.40, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'80', Cost:9.24, ParentId: '17'},
		]
	},
