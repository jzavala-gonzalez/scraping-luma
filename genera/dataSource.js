const timestamp_saved = '09/29/2023 07:00 PM';
const dataFechaAcualizado = '9/29/2023' + ' 2:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'2', Cost:27.03, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'14', Cost:31.24, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 107, MVar:'32', Cost:18.02, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:18.02, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:35.84, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'106', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'137', Cost:17.79, ParentId: '16'},
		]
	},
