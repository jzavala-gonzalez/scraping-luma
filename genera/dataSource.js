const timestamp_saved = '10/13/2023 05:05 AM';
const dataFechaAcualizado = '10/13/2023' + ' 1:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'59', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'64', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'68', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'182', Cost:17.80, ParentId: '16'},
		]
	},
