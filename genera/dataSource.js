const timestamp_saved = '09/30/2023 08:25 AM';
const dataFechaAcualizado = '9/30/2023' + ' 4:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'38', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'35', Cost:10.18, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'8', Cost:18.98, ParentId: '11'},
