const timestamp_saved = '08/10/2023 02:20 PM';
const dataFechaAcualizado = '8/10/2023' + ' 10:15:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 143, MVar:'60', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'87', Cost:11.57, ParentId: '17'},
		]
	},
