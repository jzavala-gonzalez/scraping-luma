const timestamp_saved = '08/16/2023 06:45 PM';
const dataFechaAcualizado = '8/16/2023' + ' 2:42:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'64', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'90', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'60', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'63', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'15', Cost:31.28, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:19.93, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'194', Cost:17.04, ParentId: '16'},
		]
	},
