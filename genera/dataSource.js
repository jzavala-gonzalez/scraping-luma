const timestamp_saved = '07/30/2023 01:55 AM';
const dataFechaAcualizado = '7/29/2023' + ' 9:50:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'52', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'51', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'43', Cost:10.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 175,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 34, MVar:'0', Cost:30.73, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 197,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'9', Cost:22.42, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'8', Cost:30.96, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:19.29, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:17.13, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'11', Cost:17.13, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'13', Cost:30.95, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.48, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:30.94, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'76', Cost:16.61, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'38', Cost:15.49, ParentId: '15'},
		]
	},
