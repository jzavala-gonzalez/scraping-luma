const timestamp_saved = '09/30/2023 02:55 PM';
const dataFechaAcualizado = '9/30/2023' + ' 10:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'31', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'47', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'100', Cost:9.40, ParentId: '17'},
		]
	},
