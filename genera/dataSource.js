const timestamp_saved = '12/01/2023 08:55 PM';
const dataFechaAcualizado = '12/1/2023' + ' 4:51:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2399},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'56', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'57', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.24, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 67, MVar:'25', Cost:19.49, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'159', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'92', Cost:9.19, ParentId: '17'},
		]
	},
