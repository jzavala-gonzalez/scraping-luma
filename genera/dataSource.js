const timestamp_saved = '07/27/2023 04:58 PM';
const dataFechaAcualizado = '7/27/2023' + ' 12:50:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'69', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'53', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'43', Cost:19.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:19.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.46, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'9', Cost:8.46, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:32.04, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'86', Cost:13.18, ParentId: '17'},
		]
	},
