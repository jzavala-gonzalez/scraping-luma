const timestamp_saved = '07/27/2023 05:48 AM';
const dataFechaAcualizado = '7/27/2023' + ' 1:40:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'57', Cost:10.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.46, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.84, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'8', Cost:8.84, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'24', Cost:15.41, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'85', Cost:13.17, ParentId: '17'},
		]
	},
