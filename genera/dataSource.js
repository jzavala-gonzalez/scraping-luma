const timestamp_saved = '10/22/2023 05:30 PM';
const dataFechaAcualizado = '10/22/2023' + ' 1:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'48', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'51', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'16', Cost:19.27, ParentId: '14'},
