const timestamp_saved = '11/01/2023 01:10 AM';
const dataFechaAcualizado = '10/31/2023' + ' 9:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'59', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'63', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'68', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'28', Cost:27.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.31, ParentId: '11'},
