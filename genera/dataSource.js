const timestamp_saved = '08/05/2023 06:10 PM';
const dataFechaAcualizado = '8/5/2023' + ' 2:05:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'46', Cost:10.75, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'97', Cost:11.89, ParentId: '17'},
		]
	},
