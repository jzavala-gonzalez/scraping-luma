const timestamp_saved = '07/31/2023 12:00 PM';
const dataFechaAcualizado = '7/31/2023' + ' 7:55:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'41', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:19.27, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'88', Cost:11.12, ParentId: '17'},
		]
	},
