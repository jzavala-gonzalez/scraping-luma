const timestamp_saved = '11/21/2023 03:55 AM';
const dataFechaAcualizado = '11/20/2023' + ' 11:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'29', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'40', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'54', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.20, ParentId: '11'},
