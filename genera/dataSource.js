const timestamp_saved = '10/25/2023 09:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 5:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 168, MVar:'53', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'147', Cost:17.38, ParentId: '16'},
		]
	},
