const timestamp_saved = '10/10/2023 02:30 AM';
const dataFechaAcualizado = '10/9/2023' + ' 10:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 516,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'71', Cost:9.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'72', Cost:9.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 174, MVar:'83', Cost:9.93, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'28', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.91, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:16.91, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'49', Cost:16.94, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'9', Cost:16.94, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:31.82, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'10', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'90', Cost:16.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'167', Cost:16.91, ParentId: '16'},
		]
	},
