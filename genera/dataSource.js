const timestamp_saved = '09/17/2023 09:55 PM';
const dataFechaAcualizado = '9/17/2023' + ' 5:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'75', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'48', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'62', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'31', Cost:18.88, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'128', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'93', Cost:9.11, ParentId: '17'},
		]
	},
