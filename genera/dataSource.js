const timestamp_saved = '10/27/2023 06:40 AM';
const dataFechaAcualizado = '10/27/2023' + ' 2:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'43', Cost:10.96, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'91', Cost:18.23, ParentId: '16'},
		]
	},
