const timestamp_saved = '10/06/2023 02:20 PM';
const dataFechaAcualizado = '10/6/2023' + ' 10:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'48', Cost:10.75, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:16.99, ParentId: '11'},
