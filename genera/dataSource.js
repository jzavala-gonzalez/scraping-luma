const timestamp_saved = '09/14/2023 03:35 PM';
const dataFechaAcualizado = '9/14/2023' + ' 11:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'59', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'59', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'70', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'33', Cost:18.75, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'100', Cost:16.97, ParentId: '15'},
