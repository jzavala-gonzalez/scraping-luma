const timestamp_saved = '09/11/2023 03:55 AM';
const dataFechaAcualizado = '9/10/2023' + ' 11:50:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'70', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'69', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'67', Cost:10.70, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 157,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:31.78, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:26.07, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.54, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.25, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'17', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'15', Cost:28.04, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:19.79, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:24.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'160', Cost:16.62, ParentId: '16'},
		]
	},
