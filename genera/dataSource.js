const timestamp_saved = '09/25/2023 07:10 AM';
const dataFechaAcualizado = '9/25/2023' + ' 3:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'38', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'38', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:61.17, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'48', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 29, MVar:'105', Cost:61.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'80', Cost:9.39, ParentId: '17'},
		]
	},
