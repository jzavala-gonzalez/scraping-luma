const timestamp_saved = '11/29/2023 02:55 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'43', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'49', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'77', Cost:9.77, ParentId: '17'},
		]
	},
