const timestamp_saved = '10/17/2023 12:10 PM';
const dataFechaAcualizado = '10/17/2023' + ' 8:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'56', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'56', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'56', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'87', Cost:16.73, ParentId: '15'},
