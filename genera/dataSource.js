const timestamp_saved = '11/23/2023 09:30 PM';
const dataFechaAcualizado = '11/23/2023' + ' 5:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'26', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'36', Cost:10.68, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'58', Cost:9.81, ParentId: '17'},
		]
	},
