const timestamp_saved = '09/06/2023 06:35 PM';
const dataFechaAcualizado = '9/6/2023' + ' 2:30:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'59', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'37', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'161', Cost:17.65, ParentId: '16'},
		]
	},
