const timestamp_saved = '08/06/2023 08:25 AM';
const dataFechaAcualizado = '8/6/2023' + ' 4:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'41', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'41', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.69, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'77', Cost:16.99, ParentId: '15'},
