const timestamp_saved = '11/05/2023 05:45 PM';
const dataFechaAcualizado = '11/5/2023' + ' 1:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'46', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'44', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.62, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'58', Cost:9.93, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 104,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 38, MVar:'4', Cost:19.60, ParentId: '19'},
