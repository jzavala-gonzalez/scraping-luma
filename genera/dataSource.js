const timestamp_saved = '07/26/2023 11:10 AM';
const dataFechaAcualizado = '7/26/2023' + ' 7:05:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'83', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'59', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'53', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'11', Cost:31.05, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'47', Cost:15.43, ParentId: '15'},
		]
	},
