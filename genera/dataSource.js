const timestamp_saved = '11/02/2023 01:55 PM';
const dataFechaAcualizado = '11/2/2023' + ' 9:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'53', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'52', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'50', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'76', Cost:9.40, ParentId: '17'},
		]
	},
