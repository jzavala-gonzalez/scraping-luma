const timestamp_saved = '12/05/2023 03:30 PM';
const dataFechaAcualizado = '12/5/2023' + ' 11:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'46', Cost:12.97, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.99, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 171,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 98, MVar:'11', Cost:18.51, ParentId: '14'},
