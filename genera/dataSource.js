const timestamp_saved = '10/22/2023 04:25 AM';
const dataFechaAcualizado = '10/22/2023' + ' 12:21:16 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2359},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'44', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'45', Cost:11.32, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 302,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 302, MVar:'142', Cost:17.02, ParentId: '16'},
		]
	},
