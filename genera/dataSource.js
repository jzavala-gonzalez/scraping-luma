const timestamp_saved = '10/28/2023 07:35 PM';
const dataFechaAcualizado = '10/28/2023' + ' 3:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'49', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'50', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'54', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'24', Cost:26.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:26.51, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.72, ParentId: '12'},
