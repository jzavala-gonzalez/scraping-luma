const timestamp_saved = '11/15/2023 11:20 PM';
const dataFechaAcualizado = '11/15/2023' + ' 7:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'61', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'63', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.64, ParentId: '11'},
