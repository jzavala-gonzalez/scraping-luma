const timestamp_saved = '10/14/2023 01:10 PM';
const dataFechaAcualizado = '10/14/2023' + ' 9:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'50', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:18.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:18.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'66', Cost:9.28, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 73,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 26, MVar:'8', Cost:19.60, ParentId: '19'},
