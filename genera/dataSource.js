const timestamp_saved = '07/30/2023 04:45 AM';
const dataFechaAcualizado = '7/30/2023' + ' 12:40:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'42', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'37', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:26.98, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'3', Cost:31.25, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:19.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:19.49, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'64', Cost:16.61, ParentId: '15'},
