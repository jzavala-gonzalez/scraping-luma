const timestamp_saved = '11/22/2023 06:35 AM';
const dataFechaAcualizado = '11/22/2023' + ' 2:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'21', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'31', Cost:11.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:17.64, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'64', Cost:9.77, ParentId: '17'},
		]
	},
