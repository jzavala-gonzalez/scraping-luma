const timestamp_saved = '11/29/2023 08:45 AM';
const dataFechaAcualizado = '11/29/2023' + ' 4:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'22', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'32', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:11.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'65', Cost:9.80, ParentId: '17'},
		]
	},
