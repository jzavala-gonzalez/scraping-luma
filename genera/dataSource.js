const timestamp_saved = '10/02/2023 08:45 PM';
const dataFechaAcualizado = '10/2/2023' + ' 4:40:56 PM';
const dataFuelCost = [
...
const dataByFuel = [
	...
	{fuel: 'Diesel', value: 28},
	{fuel: 'LNG', value: 41},
	{fuel: 'Coal', value: 9},
	{fuel: 'Renew', value: 2},
];
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2873},
	{Index:'1', Desc:'PREPA', value: 71},
	{Index:'2', Desc:'COGEN', value: 29},
	{Index:'3', Desc:'Reserva en Rotación', value: 211},
	{Index:'4', Desc:'Reserva Operacional', value: 222},
	{Index:'5', Desc:'Capacidad Disponible', value: 3074},
	{Index:'6', Desc:'Próxima Hora MW', value: 2851},
	{Index:'7', Desc:'Máxima para Hoy', value: 2879},
	{Index:'8', Desc:'Máxima Mensual', value: 2879},
];
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Hidro 2', MW: 0, MVar:'4', Cost:0, ParentId: '0'},
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 248,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'98', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'45', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'42', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'56', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 106,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:30.56, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:30.37, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:31.52, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'2', Cost:22.14, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:22.06, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.95, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'3', Cost:22.39, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'19', Cost:28.23, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'34', Cost:17.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:17.66, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:17.08, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:17.08, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:31.63, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.45, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'15', Cost:19.37, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'94', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'182', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'118', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 73,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 18, MVar:'0', Cost:61, ParentId: '21'},
			{Index:'1', Unit:'CT Block 2', MW: 18, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'2', Unit:'CT Block 3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.21, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:34.84, ParentId: '21'},
