const timestamp_saved = '11/30/2023 06:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 2:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'38', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'42', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'46', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.55, ParentId: '11'},
