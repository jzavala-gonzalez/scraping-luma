const timestamp_saved = '11/21/2023 07:25 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'20', Cost:12.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'29', Cost:12.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'47', Cost:12.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 79, MVar:'23', Cost:0, ParentId: '8'},
