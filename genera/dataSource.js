const timestamp_saved = '11/25/2023 04:15 AM';
const dataFechaAcualizado = '11/25/2023' + ' 12:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 169,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 170, MVar:'58', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'24', Cost:13.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'34', Cost:13.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'49', Cost:13.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 32,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'11', Cost:30.46, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.27, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'130', Cost:16.83, ParentId: '16'},
		]
	},
