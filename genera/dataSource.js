const timestamp_saved = '11/05/2023 06:20 AM';
const dataFechaAcualizado = '11/5/2023' + ' 2:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'44', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'42', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'0', Cost:31.51, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'60', Cost:9.39, ParentId: '17'},
		]
	},
