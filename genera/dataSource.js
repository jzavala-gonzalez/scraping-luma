const timestamp_saved = '08/24/2023 12:05 PM';
const dataFechaAcualizado = '8/24/2023' + ' 8:00:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'68', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'83', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'54', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'51', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'51', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'12', Cost:31.53, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'35', Cost:19.39, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'96', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'141', Cost:17.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'87', Cost:9.23, ParentId: '17'},
		]
	},
