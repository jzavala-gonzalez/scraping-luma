const timestamp_saved = '10/21/2023 05:50 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'24', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'23', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'61', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'135', Cost:17.45, ParentId: '16'},
		]
	},
