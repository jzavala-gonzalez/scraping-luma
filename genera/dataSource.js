const timestamp_saved = '11/30/2023 09:35 PM';
const dataFechaAcualizado = '11/30/2023' + ' 5:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'55', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'58', Cost:10.88, ParentId: '7'},
