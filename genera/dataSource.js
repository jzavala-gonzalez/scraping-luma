const timestamp_saved = '09/08/2023 04:10 AM';
const dataFechaAcualizado = '9/8/2023' + ' 12:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'52', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'46', Cost:12.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'47', Cost:12.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 64,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:26.54, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:10.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:10.18, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'14', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 323, MVar:'172', Cost:16.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'94', Cost:9.20, ParentId: '17'},
		]
	},
