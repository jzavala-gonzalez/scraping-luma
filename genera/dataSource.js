const timestamp_saved = '07/29/2023 04:00 PM';
const dataFechaAcualizado = '7/29/2023' + ' 11:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'51', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:19.72, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'25', Cost:15.82, ParentId: '15'},
		]
	},
