const timestamp_saved = '11/15/2023 07:35 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'31', Cost:13.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'34', Cost:13.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'43', Cost:13.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.52, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'99', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'58', Cost:9.78, ParentId: '17'},
		]
	},
