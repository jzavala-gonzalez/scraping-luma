const timestamp_saved = '11/25/2023 03:10 PM';
const dataFechaAcualizado = '11/25/2023' + ' 11:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'58', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'21', Cost:13.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'31', Cost:13.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'47', Cost:13.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.63, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'35', Cost:18.54, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.54, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'11', Cost:19.77, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'123', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'27', Cost:9.84, ParentId: '17'},
		]
	},
