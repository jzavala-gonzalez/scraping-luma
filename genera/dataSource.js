const timestamp_saved = '07/30/2023 08:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 4:20:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'44', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'38', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'40', Cost:19.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:19.19, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 127, MVar:'0', Cost:17.16, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:17.16, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:30.87, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'9', Cost:52.78, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'67', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'40', Cost:15.86, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 165, MVar:'63', Cost:20.47, ParentId: '16'},
		]
	},
