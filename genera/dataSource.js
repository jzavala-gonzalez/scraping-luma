const timestamp_saved = '09/09/2023 01:00 PM';
const dataFechaAcualizado = '9/9/2023' + ' 8:55:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'52', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'57', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 87, MVar:'6', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.72, ParentId: '13'},
