const timestamp_saved = '12/02/2023 05:45 PM';
const dataFechaAcualizado = '12/2/2023' + ' 1:41:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1892},
	{Index:'1', Desc:'PREPA', value: 55},
	{Index:'2', Desc:'COGEN', value: 45},
	{Index:'3', Desc:'Reserva en Rotación', value: 654},
	{Index:'4', Desc:'Reserva Operacional', value: 1224},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 174, MVar:'70', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'45', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'46', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'44', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.83, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:8.67, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'8', Cost:8.67, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'66', Cost:11.92, ParentId: '17'},
		]
	},
