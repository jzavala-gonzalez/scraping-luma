const timestamp_saved = '09/27/2023 11:40 PM';
const dataFechaAcualizado = '9/27/2023' + ' 7:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'40', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'38', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'68', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:8.33, ParentId: '11'},
