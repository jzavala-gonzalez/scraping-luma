const timestamp_saved = '10/15/2023 04:25 PM';
const dataFechaAcualizado = '10/15/2023' + ' 12:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'48', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'47', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 19, MVar:'8', Cost:84.35, ParentId: '12'},
