const timestamp_saved = '10/22/2023 07:35 PM';
const dataFechaAcualizado = '10/22/2023' + ' 3:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.16, ParentId: '7'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 25,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 13, MVar:'11', Cost:19.60, ParentId: '19'},
