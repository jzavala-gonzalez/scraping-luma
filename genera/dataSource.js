const timestamp_saved = '10/13/2023 07:10 PM';
const dataFechaAcualizado = '10/13/2023' + ' 3:06:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'67', Cost:10.10, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:16.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'12', Cost:16.94, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'47', Cost:8.18, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'13', Cost:29.39, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'198', Cost:17.58, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'105', Cost:9.22, ParentId: '17'},
		]
	},
