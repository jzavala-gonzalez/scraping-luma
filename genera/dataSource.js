const timestamp_saved = '09/06/2023 07:20 AM';
const dataFechaAcualizado = '9/6/2023' + ' 3:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'42', Cost:13.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'45', Cost:13.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'57', Cost:13.34, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'14', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'78', Cost:16.83, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'70', Cost:9.18, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 12, MVar:'0', Cost:25.83, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 9, MVar:'0', Cost:0, ParentId: '21'},
