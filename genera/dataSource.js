const timestamp_saved = '09/07/2023 05:35 AM';
const dataFechaAcualizado = '9/7/2023' + ' 1:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'50', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'28', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'45', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 217,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 217, MVar:'133', Cost:17.86, ParentId: '16'},
		]
	},
