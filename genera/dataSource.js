const timestamp_saved = '11/20/2023 06:20 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:16:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2061},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'25', Cost:14.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'36', Cost:14.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 73, MVar:'56', Cost:14.66, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'0', Cost:28.70, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 18, MVar:'0', Cost:30.87, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'14', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'71', Cost:17.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 223,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 223, MVar:'148', Cost:18.15, ParentId: '16'},
		]
	},
