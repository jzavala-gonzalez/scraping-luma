const timestamp_saved = '07/25/2023 10:01 PM';
const dataFechaAcualizado = '7/25/2023' + ' 5:55:30 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2376},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'64', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'54', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'51', Cost:10.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 105, MVar:'0', Cost:4.89, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:8.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.05, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:32.12, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'4', Cost:30.15, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 60, MVar:'61', Cost:20.38, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'81', Cost:9.35, ParentId: '17'},
		]
	},
