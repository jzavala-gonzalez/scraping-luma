const timestamp_saved = '12/02/2023 01:05 AM';
const dataFechaAcualizado = '12/1/2023' + ' 9:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'54', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'57', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'58', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'93', Cost:9.20, ParentId: '17'},
		]
	},
