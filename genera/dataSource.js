const timestamp_saved = '11/06/2023 02:25 AM';
const dataFechaAcualizado = '11/5/2023' + ' 10:21:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'48', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'49', Cost:12.02, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:31.17, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'73', Cost:9.24, ParentId: '17'},
		]
	},
