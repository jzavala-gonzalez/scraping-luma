const timestamp_saved = '10/18/2023 02:10 PM';
const dataFechaAcualizado = '10/18/2023' + ' 10:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'68', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'45', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'63', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'74', Cost:23.29, ParentId: '15'},
