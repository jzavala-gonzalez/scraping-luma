const timestamp_saved = '09/09/2023 07:35 AM';
const dataFechaAcualizado = '9/9/2023' + ' 3:30:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'52', Cost:13.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'58', Cost:13.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'56', Cost:13.28, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'12', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:28.24, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'3', Cost:28.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'6', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'62', Cost:16.66, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'142', Cost:16.66, ParentId: '16'},
		]
	},
