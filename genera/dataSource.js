const timestamp_saved = '11/30/2023 11:05 PM';
const dataFechaAcualizado = '11/30/2023' + ' 7:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'60', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'62', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'61', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:31.66, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'164', Cost:17.36, ParentId: '16'},
		]
	},
