const timestamp_saved = '11/01/2023 02:00 AM';
const dataFechaAcualizado = '10/31/2023' + ' 9:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'60', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'63', Cost:10.73, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'72', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'159', Cost:16.75, ParentId: '16'},
		]
	},
