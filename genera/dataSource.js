const timestamp_saved = '10/09/2023 05:40 PM';
const dataFechaAcualizado = '10/9/2023' + ' 1:36:25 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'63', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'63', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'57', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:18.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:18.56, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'41', Cost:17.41, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'8', Cost:17.41, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.15, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'82', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'173', Cost:17.80, ParentId: '16'},
		]
	},
