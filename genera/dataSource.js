const timestamp_saved = '09/29/2023 11:25 AM';
const dataFechaAcualizado = '9/29/2023' + ' 7:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'30', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'27', Cost:12.91, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 66,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:22.59, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.31, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:18.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.19, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:18.25, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:18.25, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 247,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 247, MVar:'118', Cost:18.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'87', Cost:9.16, ParentId: '17'},
		]
	},
