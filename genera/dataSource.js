const timestamp_saved = '11/17/2023 09:00 AM';
const dataFechaAcualizado = '11/17/2023' + ' 4:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'50', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'50', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'39', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:30.65, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'69', Cost:16.87, ParentId: '15'},
