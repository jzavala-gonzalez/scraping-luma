const timestamp_saved = '10/15/2023 08:15 PM';
const dataFechaAcualizado = '10/15/2023' + ' 4:11:15 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2515},
	{Index:'7', Desc:'Máxima para Hoy', value: 2541},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'54', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'54', Cost:10.38, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'8', Cost:27.92, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'7', Cost:43.88, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 65,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:71.17, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'11', Cost:29.52, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'101', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'170', Cost:16.62, ParentId: '16'},
		]
	},
