const timestamp_saved = '08/27/2023 09:50 AM';
const dataFechaAcualizado = '8/27/2023' + ' 5:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'28', Cost:30.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:30.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:30.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 144, MVar:'47', Cost:19.58, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'74', Cost:17.16, ParentId: '15'},
