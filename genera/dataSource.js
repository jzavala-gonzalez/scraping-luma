const timestamp_saved = '09/10/2023 11:05 PM';
const dataFechaAcualizado = '9/10/2023' + ' 7:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'70', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'84', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'72', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'71', Cost:9.75, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 134,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.70, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 16, MVar:'0', Cost:42.58, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.16, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'10', Cost:46.67, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'1', Cost:25.26, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'14', Cost:27.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'13', Cost:28.20, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.72, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 98,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'11', Cost:28.65, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'22', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'96', Cost:16.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'154', Cost:16.49, ParentId: '16'},
		]
	},
