const timestamp_saved = '11/11/2023 12:45 AM';
const dataFechaAcualizado = '11/10/2023' + ' 8:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'52', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'55', Cost:10.39, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'96', Cost:9.22, ParentId: '17'},
		]
	},
