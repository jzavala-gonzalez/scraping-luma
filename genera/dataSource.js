const timestamp_saved = '08/08/2023 08:55 AM';
const dataFechaAcualizado = '8/8/2023' + ' 4:50:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'38', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'46', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'80', Cost:11.63, ParentId: '17'},
		]
	},
