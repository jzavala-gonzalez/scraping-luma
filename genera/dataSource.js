const timestamp_saved = '12/04/2023 03:25 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'52', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'55', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'55', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'78', Cost:11.44, ParentId: '17'},
		]
	},
