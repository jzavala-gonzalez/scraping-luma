const timestamp_saved = '08/03/2023 11:10 PM';
const dataFechaAcualizado = '8/3/2023' + ' 7:05:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'44', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:11.04, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 71, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 31, MVar:'12', Cost:43.68, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'6', Cost:8.23, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'110', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'20', Cost:15.61, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'96', Cost:10.86, ParentId: '17'},
		]
	},
