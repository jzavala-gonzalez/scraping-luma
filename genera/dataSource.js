const timestamp_saved = '11/24/2023 02:25 PM';
const dataFechaAcualizado = '11/24/2023' + ' 10:21:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1938},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'23', Cost:12.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'33', Cost:12.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'50', Cost:12.51, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'73', Cost:9.72, ParentId: '17'},
		]
	},
