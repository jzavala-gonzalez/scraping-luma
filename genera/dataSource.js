const timestamp_saved = '11/03/2023 06:00 AM';
const dataFechaAcualizado = '11/3/2023' + ' 1:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'47', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:11.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.26, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'60', Cost:9.33, ParentId: '17'},
		]
	},
