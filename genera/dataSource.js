const timestamp_saved = '10/18/2023 11:30 AM';
const dataFechaAcualizado = '10/18/2023' + ' 7:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 230,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'62', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'42', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'45', Cost:10.53, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'92', Cost:10.55, ParentId: '17'},
		]
	},
