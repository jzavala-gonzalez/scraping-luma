const timestamp_saved = '08/14/2023 06:35 AM';
const dataFechaAcualizado = '8/14/2023' + ' 2:32:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'44', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'42', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'8', Cost:31.15, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'105', Cost:12.98, ParentId: '17'},
		]
	},
