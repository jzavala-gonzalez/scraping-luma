const timestamp_saved = '10/07/2023 05:20 PM';
const dataFechaAcualizado = '10/7/2023' + ' 1:16:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 174, MVar:'50', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'42', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'43', Cost:12.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'43', Cost:12.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 266,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 266, MVar:'88', Cost:9.70, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 97,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'16', Cost:19.60, ParentId: '19'},
