const timestamp_saved = '10/31/2023 10:42 AM';
const dataFechaAcualizado = '10/31/2023' + ' 6:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'52', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'57', Cost:10.61, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'14', Cost:20.91, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'63', Cost:9.38, ParentId: '17'},
		]
	},
