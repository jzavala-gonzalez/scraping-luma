const timestamp_saved = '10/21/2023 04:20 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:13.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'36', Cost:13.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'39', Cost:13.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'69', Cost:11.07, ParentId: '17'},
		]
	},
