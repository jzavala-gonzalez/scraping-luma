const timestamp_saved = '10/20/2023 10:20 AM';
const dataFechaAcualizado = '10/20/2023' + ' 6:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'39', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'44', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'44', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'92', Cost:10.51, ParentId: '17'},
		]
	},
