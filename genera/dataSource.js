const timestamp_saved = '10/27/2023 11:05 PM';
const dataFechaAcualizado = '10/27/2023' + ' 7:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'48', Cost:11.24, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 36, MVar:'4', Cost:24.56, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 58, MVar:'6', Cost:21.39, ParentId: '14'},
