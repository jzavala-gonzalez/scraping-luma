const timestamp_saved = '11/27/2023 10:40 AM';
const dataFechaAcualizado = '11/27/2023' + ' 6:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'26', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'34', Cost:11.36, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'49', Cost:17.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.42, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 165, MVar:'50', Cost:8.08, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'18', Cost:19.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'116', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'74', Cost:9.78, ParentId: '17'},
		]
	},
