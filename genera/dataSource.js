const timestamp_saved = '08/05/2023 04:55 PM';
const dataFechaAcualizado = '8/5/2023' + ' 12:50:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'45', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 64,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 64, MVar:'22', Cost:28.40, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.68, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'100', Cost:11.73, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 120,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 38, MVar:'13', Cost:17, ParentId: '19'},
		]
	},
