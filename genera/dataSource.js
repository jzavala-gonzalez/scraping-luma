const timestamp_saved = '11/13/2023 11:10 AM';
const dataFechaAcualizado = '11/13/2023' + ' 7:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'44', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'86', Cost:9.76, ParentId: '17'},
		]
	},
