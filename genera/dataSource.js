const timestamp_saved = '11/05/2023 09:50 PM';
const dataFechaAcualizado = '11/5/2023' + ' 5:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'83', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'77', Cost:9.21, ParentId: '17'},
		]
	},
