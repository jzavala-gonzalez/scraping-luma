const timestamp_saved = '10/26/2023 11:15 PM';
const dataFechaAcualizado = '10/26/2023' + ' 7:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'56', Cost:10.36, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'34', Cost:17.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'12', Cost:17.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'41', Cost:18.15, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'18', Cost:19.51, ParentId: '14'},
