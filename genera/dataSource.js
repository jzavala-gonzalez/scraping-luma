const timestamp_saved = '11/24/2023 03:55 AM';
const dataFechaAcualizado = '11/23/2023' + ' 11:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'29', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'52', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'88', Cost:9.16, ParentId: '17'},
		]
	},
