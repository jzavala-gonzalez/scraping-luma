const timestamp_saved = '11/07/2023 06:05 PM';
const dataFechaAcualizado = '11/7/2023' + ' 2:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'49', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'47', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'52', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'1', Cost:22.04, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:16.99, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 60, MVar:'12', Cost:20.50, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'102', Cost:9.16, ParentId: '17'},
		]
	},
