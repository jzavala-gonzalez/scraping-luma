const timestamp_saved = '10/04/2023 06:10 AM';
const dataFechaAcualizado = '10/4/2023' + ' 2:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'35', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'33', Cost:10.51, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 195,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'139', Cost:19.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'95', Cost:9.40, ParentId: '17'},
		]
	},
