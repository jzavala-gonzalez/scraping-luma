const timestamp_saved = '11/28/2023 11:55 PM';
const dataFechaAcualizado = '11/28/2023' + ' 7:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'43', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'52', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'64', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'23', Cost:30.81, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'11', Cost:28.62, ParentId: '12'},
