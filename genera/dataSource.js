const timestamp_saved = '11/13/2023 12:45 AM';
const dataFechaAcualizado = '11/12/2023' + ' 8:41:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2456},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 239,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'53', Cost:18.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'56', Cost:18.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:18.94, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 194,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:23.14, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'11', Cost:28.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 74,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:60.73, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'16', Cost:28.56, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'13', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'66', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'109', Cost:9.24, ParentId: '17'},
		]
	},
