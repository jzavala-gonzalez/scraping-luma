const timestamp_saved = '11/30/2023 05:20 PM';
const dataFechaAcualizado = '11/30/2023' + ' 1:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'53', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'54', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'54', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'78', Cost:9.81, ParentId: '17'},
		]
	},
