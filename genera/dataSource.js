const timestamp_saved = '11/19/2023 07:55 AM';
const dataFechaAcualizado = '11/19/2023' + ' 3:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'40', Cost:15.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'49', Cost:15.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:15.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.54, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:50.91, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'15', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'64', Cost:16.74, ParentId: '15'},
