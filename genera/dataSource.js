const timestamp_saved = '07/31/2023 06:15 AM';
const dataFechaAcualizado = '7/31/2023' + ' 2:10:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'35', Cost:19.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:19.65, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 328,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'87', Cost:16.70, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'55', Cost:15.54, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'129', Cost:17.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 220,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 220, MVar:'82', Cost:11.79, ParentId: '17'},
		]
	},
