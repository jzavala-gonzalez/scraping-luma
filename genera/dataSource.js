const timestamp_saved = '07/27/2023 11:54 AM';
const dataFechaAcualizado = '7/27/2023' + ' 7:45:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'54', Cost:10.83, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'21', Cost:18.66, ParentId: '14'},
