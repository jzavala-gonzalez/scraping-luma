const timestamp_saved = '10/14/2023 02:45 AM';
const dataFechaAcualizado = '10/13/2023' + ' 10:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'64', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'70', Cost:10.31, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 355,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 355, MVar:'164', Cost:16.50, ParentId: '16'},
		]
	},
