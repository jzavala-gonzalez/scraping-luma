const timestamp_saved = '10/30/2023 09:20 AM';
const dataFechaAcualizado = '10/30/2023' + ' 5:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'36', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'41', Cost:9.67, ParentId: '17'},
		]
	},
