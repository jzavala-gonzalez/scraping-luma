const timestamp_saved = '10/14/2023 09:45 AM';
const dataFechaAcualizado = '10/14/2023' + ' 5:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'47', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'52', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'50', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:17.54, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'70', Cost:9.29, ParentId: '17'},
		]
	},
