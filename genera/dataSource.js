const timestamp_saved = '08/21/2023 06:15 AM';
const dataFechaAcualizado = '8/21/2023' + ' 2:12:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'40', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'50', Cost:10.96, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'14', Cost:18.78, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'47', Cost:9.86, ParentId: '17'},
		]
	},
