const timestamp_saved = '10/30/2023 07:11 AM';
const dataFechaAcualizado = '10/30/2023' + ' 3:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'31', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'32', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'59', Cost:11.94, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'101', Cost:18.72, ParentId: '16'},
		]
	},
