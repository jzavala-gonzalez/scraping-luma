const timestamp_saved = '08/16/2023 03:35 PM';
const dataFechaAcualizado = '8/16/2023' + ' 11:32:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'59', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'54', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'60', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'11', Cost:30.66, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'13', Cost:31.16, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'30', Cost:18.66, ParentId: '14'},
