const timestamp_saved = '08/31/2023 07:40 AM';
const dataFechaAcualizado = '8/31/2023' + ' 3:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'46', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'83', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'42', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'51', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'61', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'19', Cost:18.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'78', Cost:16.53, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 201,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 201, MVar:'69', Cost:10.63, ParentId: '17'},
		]
	},
