const timestamp_saved = '10/13/2023 08:35 AM';
const dataFechaAcualizado = '10/13/2023' + ' 4:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'55', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'60', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'66', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'61', Cost:16.90, ParentId: '15'},
