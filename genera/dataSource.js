const timestamp_saved = '11/16/2023 03:45 AM';
const dataFechaAcualizado = '11/15/2023' + ' 11:41:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'54', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.30, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'132', Cost:17.08, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 171, MVar:'70', Cost:10.74, ParentId: '17'},
		]
	},
