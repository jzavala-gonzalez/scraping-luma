const timestamp_saved = '11/28/2023 05:00 PM';
const dataFechaAcualizado = '11/28/2023' + ' 12:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'37', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'47', Cost:10.99, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'178', Cost:18.24, ParentId: '16'},
		]
	},
