const timestamp_saved = '08/18/2023 04:00 PM';
const dataFechaAcualizado = '8/18/2023' + ' 11:57:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'60', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'72', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'28', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 77, MVar:'74', Cost:18.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'150', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'76', Cost:9.46, ParentId: '17'},
		]
	},
