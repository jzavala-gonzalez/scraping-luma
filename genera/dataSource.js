const timestamp_saved = '10/22/2023 09:35 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'47', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'49', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'45', Cost:10.66, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 13,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 13, MVar:'0', Cost:21.33, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'12', Cost:19.63, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'67', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'125', Cost:17.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:11.28, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:21.33, ParentId: '21'},
