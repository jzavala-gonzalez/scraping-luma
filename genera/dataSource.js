const timestamp_saved = '08/30/2023 10:55 AM';
const dataFechaAcualizado = '8/30/2023' + ' 6:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'82', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'45', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:30.80, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 60, MVar:'31', Cost:19.97, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'142', Cost:17.96, ParentId: '16'},
		]
	},
