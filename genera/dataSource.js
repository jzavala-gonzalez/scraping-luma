const timestamp_saved = '11/27/2023 04:35 PM';
const dataFechaAcualizado = '11/27/2023' + ' 12:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'33', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'55', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'163', Cost:18.25, ParentId: '16'},
		]
	},
