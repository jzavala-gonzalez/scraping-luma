const timestamp_saved = '11/13/2023 04:35 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'47', Cost:21.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'51', Cost:21.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 4, MVar:'0', Cost:34.55, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'66', Cost:16.61, ParentId: '15'},
