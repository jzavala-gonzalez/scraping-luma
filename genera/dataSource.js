const timestamp_saved = '08/15/2023 11:10 AM';
const dataFechaAcualizado = '8/15/2023' + ' 7:07:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'40', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.34, ParentId: '12'},
