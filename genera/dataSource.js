const timestamp_saved = '08/08/2023 05:30 AM';
const dataFechaAcualizado = '8/8/2023' + ' 1:25:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'39', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'59', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'75', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'39', Cost:20.39, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:20.39, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'26', Cost:16.26, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'139', Cost:17.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'77', Cost:11.67, ParentId: '17'},
		]
	},
