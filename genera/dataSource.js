const timestamp_saved = '08/05/2023 10:30 AM';
const dataFechaAcualizado = '8/5/2023' + ' 6:25:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'42', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'36', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'125', Cost:18.18, ParentId: '16'},
		]
	},
