const timestamp_saved = '11/20/2023 04:40 PM';
const dataFechaAcualizado = '11/20/2023' + ' 12:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'33', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'43', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'57', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'103', Cost:9.19, ParentId: '17'},
		]
	},
