const timestamp_saved = '07/27/2023 08:49 PM';
const dataFechaAcualizado = '7/27/2023' + ' 4:40:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'58', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'52', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'51', Cost:15.67, ParentId: '15'},
		]
	},
