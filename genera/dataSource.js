const timestamp_saved = '09/28/2023 09:45 AM';
const dataFechaAcualizado = '9/28/2023' + ' 5:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'20', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'19', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.22, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'101', Cost:18.42, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'68', Cost:9.76, ParentId: '17'},
		]
	},
