const timestamp_saved = '10/17/2023 06:55 AM';
const dataFechaAcualizado = '10/17/2023' + ' 2:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'53', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'55', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'12', Cost:18.47, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'6', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'74', Cost:16.86, ParentId: '15'},
