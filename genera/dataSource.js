const timestamp_saved = '11/22/2023 03:45 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'30', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'40', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'53', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 26,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'0', Cost:27.36, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 79, MVar:'72', Cost:19.64, ParentId: '15'},
