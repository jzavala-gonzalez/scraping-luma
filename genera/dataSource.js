const timestamp_saved = '10/15/2023 08:50 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'47', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'52', Cost:9.06, ParentId: '17'},
		]
	},
