const timestamp_saved = '11/15/2023 04:05 AM';
const dataFechaAcualizado = '11/15/2023' + ' 12:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'45', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'50', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'52', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:27.61, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'21', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 217,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 217, MVar:'148', Cost:18.76, ParentId: '16'},
		]
	},
