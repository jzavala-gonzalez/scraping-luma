const timestamp_saved = '08/15/2023 06:15 AM';
const dataFechaAcualizado = '8/15/2023' + ' 2:12:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'47', Cost:10.50, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:26.84, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:26.37, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'167', Cost:18.16, ParentId: '16'},
		]
	},
