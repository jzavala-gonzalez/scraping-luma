const timestamp_saved = '09/17/2023 02:05 PM';
const dataFechaAcualizado = '9/17/2023' + ' 10:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'43', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'43', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'58', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'74', Cost:9.59, ParentId: '17'},
		]
	},
