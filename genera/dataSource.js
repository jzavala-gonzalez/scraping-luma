const timestamp_saved = '08/02/2023 05:30 PM';
const dataFechaAcualizado = '8/2/2023' + ' 1:25:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'49', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'50', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.85, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'109', Cost:16.83, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 121, MVar:'25', Cost:16.67, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 342, MVar:'164', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'100', Cost:11.00, ParentId: '17'},
		]
	},
