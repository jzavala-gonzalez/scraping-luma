const timestamp_saved = '10/02/2023 03:40 PM';
const dataFechaAcualizado = '10/2/2023' + ' 11:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'40', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'38', Cost:10.81, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'160', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'112', Cost:9.23, ParentId: '17'},
		]
	},
