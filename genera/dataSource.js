const timestamp_saved = '11/21/2023 08:20 AM';
const dataFechaAcualizado = '11/21/2023' + ' 4:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'19', Cost:13.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'27', Cost:13.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 99, MVar:'46', Cost:13.80, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'42', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'123', Cost:18.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'62', Cost:9.18, ParentId: '17'},
		]
	},
