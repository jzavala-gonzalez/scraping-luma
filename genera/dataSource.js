const timestamp_saved = '12/04/2023 06:40 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:36:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1839},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'36', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'37', Cost:12.78, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'97', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'43', Cost:11.61, ParentId: '17'},
		]
	},
