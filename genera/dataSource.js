const timestamp_saved = '11/17/2023 04:40 AM';
const dataFechaAcualizado = '11/17/2023' + ' 12:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'60', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'60', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 3, MVar:'0', Cost:22.12, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'15', Cost:18.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'70', Cost:16.82, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'100', Cost:9.33, ParentId: '17'},
		]
	},
