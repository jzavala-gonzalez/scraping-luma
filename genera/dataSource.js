const timestamp_saved = '08/08/2023 01:30 PM';
const dataFechaAcualizado = '8/8/2023' + ' 9:25:41 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 751},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'59', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'63', Cost:10.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 119, MVar:'45', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:26.25, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:733.72, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'38', Cost:20.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:20.45, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:32.72, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'48', Cost:15.73, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'168', Cost:18.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'102', Cost:11.67, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 56,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 10, MVar:'17', Cost:17, ParentId: '19'},
		]
	},
