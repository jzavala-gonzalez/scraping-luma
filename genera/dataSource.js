const timestamp_saved = '11/06/2023 11:10 AM';
const dataFechaAcualizado = '11/6/2023' + ' 7:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:8.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'10', Cost:8.17, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'91', Cost:16.81, ParentId: '15'},
