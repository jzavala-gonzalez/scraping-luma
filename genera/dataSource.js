const timestamp_saved = '08/20/2023 08:30 PM';
const dataFechaAcualizado = '8/20/2023' + ' 4:27:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'38', Cost:10.44, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'80', Cost:17.82, ParentId: '15'},
