const timestamp_saved = '12/01/2023 01:05 PM';
const dataFechaAcualizado = '12/1/2023' + ' 9:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'49', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'51', Cost:10.88, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'77', Cost:9.52, ParentId: '17'},
		]
	},
