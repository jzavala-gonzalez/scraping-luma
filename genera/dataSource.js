const timestamp_saved = '11/22/2023 09:25 PM';
const dataFechaAcualizado = '11/22/2023' + ' 5:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'32', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'44', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'20', Cost:38.89, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:31.58, ParentId: '12'},
