const timestamp_saved = '10/21/2023 01:11 AM';
const dataFechaAcualizado = '10/20/2023' + ' 9:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'44', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'51', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'49', Cost:17.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.42, ParentId: '14'},
