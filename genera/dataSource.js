const timestamp_saved = '08/04/2023 08:55 PM';
const dataFechaAcualizado = '8/4/2023' + ' 4:50:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 19,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'7', Cost:44.22, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'152', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'91', Cost:11.55, ParentId: '17'},
		]
	},
