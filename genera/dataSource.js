const timestamp_saved = '09/09/2023 06:10 AM';
const dataFechaAcualizado = '9/9/2023' + ' 2:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'55', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'60', Cost:11.34, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'13', Cost:28.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:19.91, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.91, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.19, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'8', Cost:8.19, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'70', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'150', Cost:16.65, ParentId: '16'},
		]
	},
