const timestamp_saved = '08/18/2023 09:30 AM';
const dataFechaAcualizado = '8/18/2023' + ' 5:27:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 506,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'41', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'57', Cost:10.16, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:31.15, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'64', Cost:9.43, ParentId: '17'},
		]
	},
