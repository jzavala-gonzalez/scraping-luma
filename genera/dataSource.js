const timestamp_saved = '09/07/2023 02:25 AM';
const dataFechaAcualizado = '9/6/2023' + ' 10:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'59', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'36', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'52', Cost:10.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 182,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 128, MVar:'38', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.92, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'19', Cost:30.81, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'23', Cost:30.91, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'115', Cost:9.20, ParentId: '17'},
		]
	},
