const timestamp_saved = '11/09/2023 09:05 AM';
const dataFechaAcualizado = '11/9/2023' + ' 5:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'38', Cost:12.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'37', Cost:12.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'42', Cost:12.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'69', Cost:9.82, ParentId: '17'},
		]
	},
