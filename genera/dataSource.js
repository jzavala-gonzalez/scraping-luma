const timestamp_saved = '09/27/2023 08:30 PM';
const dataFechaAcualizado = '9/27/2023' + ' 4:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'29', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'30', Cost:11.13, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.84, ParentId: '11'},
