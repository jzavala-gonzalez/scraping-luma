const timestamp_saved = '11/04/2023 02:40 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'45', Cost:12.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'43', Cost:12.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'44', Cost:12.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'58', Cost:9.82, ParentId: '17'},
		]
	},
