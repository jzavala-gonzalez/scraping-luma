const timestamp_saved = '11/05/2023 02:15 PM';
const dataFechaAcualizado = '11/5/2023' + ' 10:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'41', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'40', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'42', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.71, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'51', Cost:9.89, ParentId: '17'},
		]
	},
