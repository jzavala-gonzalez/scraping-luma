const timestamp_saved = '08/27/2023 07:40 PM';
const dataFechaAcualizado = '8/27/2023' + ' 3:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'39', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'38', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'48', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'10', Cost:31.83, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'43', Cost:19.89, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'75', Cost:18.39, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'143', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'92', Cost:11.94, ParentId: '17'},
		]
	},
