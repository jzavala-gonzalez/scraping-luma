const timestamp_saved = '08/17/2023 11:05 AM';
const dataFechaAcualizado = '8/17/2023' + ' 7:02:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'56', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'68', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.75, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'20', Cost:18.45, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'71', Cost:9.41, ParentId: '17'},
		]
	},
