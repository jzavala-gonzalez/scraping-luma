const timestamp_saved = '10/04/2023 06:30 AM';
const dataFechaAcualizado = '10/4/2023' + ' 2:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'36', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'33', Cost:11.11, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:16.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:16.94, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'140', Cost:18.25, ParentId: '16'},
		]
	},
