const timestamp_saved = '10/19/2023 08:10 AM';
const dataFechaAcualizado = '10/19/2023' + ' 4:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'31', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'38', Cost:10.57, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'0', Cost:19.28, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'82', Cost:10.91, ParentId: '17'},
		]
	},
