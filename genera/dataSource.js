const timestamp_saved = '10/15/2023 07:15 AM';
const dataFechaAcualizado = '10/15/2023' + ' 3:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'48', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'49', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'53', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'66', Cost:9.17, ParentId: '17'},
		]
	},
