const timestamp_saved = '08/18/2023 05:25 PM';
const dataFechaAcualizado = '8/18/2023' + ' 1:22:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'67', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'72', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'8', Cost:32.31, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:31.61, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 86, MVar:'74', Cost:19.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 253,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 253, MVar:'151', Cost:17.56, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 316,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 316, MVar:'84', Cost:9.38, ParentId: '17'},
		]
	},
