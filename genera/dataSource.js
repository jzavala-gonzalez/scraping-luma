const timestamp_saved = '08/10/2023 10:35 AM';
const dataFechaAcualizado = '8/10/2023' + ' 6:30:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'52', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'55', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:30.39, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:30.90, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'7', Cost:30.83, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 324, MVar:'173', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'77', Cost:11.98, ParentId: '17'},
		]
	},
