const timestamp_saved = '09/23/2023 01:15 PM';
const dataFechaAcualizado = '9/23/2023' + ' 9:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'46', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'58', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'45', Cost:21.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:21.53, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'61', Cost:19.60, ParentId: '15'},
