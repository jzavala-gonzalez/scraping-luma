const timestamp_saved = '10/16/2023 10:10 AM';
const dataFechaAcualizado = '10/16/2023' + ' 6:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.16, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:18.53, ParentId: '11'},
