const timestamp_saved = '10/28/2023 05:25 AM';
const dataFechaAcualizado = '10/28/2023' + ' 1:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'38', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'40', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 40, MVar:'13', Cost:36.40, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.75, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'111', Cost:17.69, ParentId: '16'},
		]
	},
