const timestamp_saved = '11/24/2023 12:15 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'23', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'33', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'47', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'68', Cost:9.90, ParentId: '17'},
		]
	},
