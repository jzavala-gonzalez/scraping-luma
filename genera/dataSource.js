const timestamp_saved = '08/02/2023 02:45 PM';
const dataFechaAcualizado = '8/2/2023' + ' 10:40:36 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1025},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'42', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.55, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'88', Cost:11.03, ParentId: '17'},
		]
	},
