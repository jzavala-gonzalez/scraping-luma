const timestamp_saved = '12/02/2023 03:40 PM';
const dataFechaAcualizado = '12/2/2023' + ' 11:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 188,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 188, MVar:'75', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'44', Cost:13.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'47', Cost:13.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'46', Cost:13.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.55, ParentId: '14'},
