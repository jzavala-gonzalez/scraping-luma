const timestamp_saved = '09/25/2023 04:45 AM';
const dataFechaAcualizado = '9/25/2023' + ' 12:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'52', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:10.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:12.81, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:20.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:20.15, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:17.68, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.78, ParentId: '12'},
