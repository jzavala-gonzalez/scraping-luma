const timestamp_saved = '10/01/2023 12:10 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'60', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 51, MVar:'56', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'26', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'24', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'41', Cost:11.40, ParentId: '7'},
		]
	},
