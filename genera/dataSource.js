const timestamp_saved = '11/09/2023 07:05 PM';
const dataFechaAcualizado = '11/9/2023' + ' 3:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'50', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'50', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'52', Cost:11.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 39,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:49.14, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'19', Cost:21.99, ParentId: '14'},
