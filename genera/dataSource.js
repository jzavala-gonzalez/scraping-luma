const timestamp_saved = '11/20/2023 02:25 PM';
const dataFechaAcualizado = '11/20/2023' + ' 10:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'41', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'49', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'60', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:231.82, ParentId: '13'},
