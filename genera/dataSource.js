const timestamp_saved = '08/13/2023 01:40 PM';
const dataFechaAcualizado = '8/13/2023' + ' 9:37:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'41', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'47', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'43', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'7', Cost:30.66, ParentId: '13'},
