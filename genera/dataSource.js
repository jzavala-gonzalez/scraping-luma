const timestamp_saved = '11/23/2023 05:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 1:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'21', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'33', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'50', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'50', Cost:17.38, ParentId: '11'},
