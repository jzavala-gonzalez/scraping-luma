const timestamp_saved = '12/05/2023 11:05 AM';
const dataFechaAcualizado = '12/5/2023' + ' 7:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'48', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'56', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'66', Cost:11.18, ParentId: '17'},
		]
	},
