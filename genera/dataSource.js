const timestamp_saved = '09/29/2023 05:35 PM';
const dataFechaAcualizado = '9/29/2023' + ' 1:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.68, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:17.63, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'0', Cost:20.65, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:20.65, ParentId: '11'},
		]
	},
