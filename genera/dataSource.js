const timestamp_saved = '09/18/2023 08:15 AM';
const dataFechaAcualizado = '9/18/2023' + ' 4:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'42', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'40', Cost:10.79, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'64', Cost:9.80, ParentId: '17'},
		]
	},
