const timestamp_saved = '11/23/2023 02:55 PM';
const dataFechaAcualizado = '11/23/2023' + ' 10:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 195,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 195, MVar:'79', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'23', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'34', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'32', Cost:19.29, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'71', Cost:9.81, ParentId: '17'},
		]
	},
