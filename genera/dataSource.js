const timestamp_saved = '10/23/2023 09:15 AM';
const dataFechaAcualizado = '10/23/2023' + ' 5:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'39', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'39', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'50', Cost:11.30, ParentId: '17'},
		]
	},
