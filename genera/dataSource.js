const timestamp_saved = '08/22/2023 04:00 AM';
const dataFechaAcualizado = '8/21/2023' + ' 11:55:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'57', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'63', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'50', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'50', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:26.90, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:19.73, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:25.52, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'123', Cost:18.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'69', Cost:9.18, ParentId: '17'},
		]
	},
