const timestamp_saved = '09/19/2023 11:50 AM';
const dataFechaAcualizado = '9/19/2023' + ' 7:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'71', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'49', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'63', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'11', Cost:31.03, ParentId: '10'},
		]
	},
