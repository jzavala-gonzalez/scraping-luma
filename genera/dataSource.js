const timestamp_saved = '08/23/2023 12:20 PM';
const dataFechaAcualizado = '8/23/2023' + ' 8:15:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'54', Cost:10.07, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'28', Cost:19.02, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'74', Cost:9.76, ParentId: '17'},
		]
	},
