const timestamp_saved = '11/05/2023 11:00 AM';
const dataFechaAcualizado = '11/5/2023' + ' 6:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'39', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'38', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'39', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.82, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 132,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 132, MVar:'71', Cost:16.68, ParentId: '15'},
