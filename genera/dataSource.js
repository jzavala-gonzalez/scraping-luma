const timestamp_saved = '11/27/2023 05:10 PM';
const dataFechaAcualizado = '11/27/2023' + ' 1:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'33', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'44', Cost:11.10, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'96', Cost:9.57, ParentId: '17'},
		]
	},
