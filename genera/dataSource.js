const timestamp_saved = '12/06/2023 02:10 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:05:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 527},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'47', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'49', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'58', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'69', Cost:14.33, ParentId: '17'},
		]
	},
