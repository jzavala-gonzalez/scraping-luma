const timestamp_saved = '11/22/2023 05:20 PM';
const dataFechaAcualizado = '11/22/2023' + ' 1:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'35', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'44', Cost:11.31, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'10', Cost:19.78, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'94', Cost:9.81, ParentId: '17'},
		]
	},
