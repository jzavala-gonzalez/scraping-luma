const timestamp_saved = '11/18/2023 09:25 AM';
const dataFechaAcualizado = '11/18/2023' + ' 5:21:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2483},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'31', Cost:16.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'69', Cost:16.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:16.13, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'7', Cost:29.23, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 75,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'12', Cost:28.77, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'72', Cost:17.10, ParentId: '15'},
