const timestamp_saved = '09/04/2023 02:50 PM';
const dataFechaAcualizado = '9/4/2023' + ' 10:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'36', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'42', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'55', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'68', Cost:9.40, ParentId: '17'},
		]
	},
