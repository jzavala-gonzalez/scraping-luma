const timestamp_saved = '11/29/2023 01:15 AM';
const dataFechaAcualizado = '11/28/2023' + ' 9:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'40', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'51', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'61', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'6', Cost:26.53, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:17.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.36, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:29.09, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'7', Cost:28.92, ParentId: '13'},
