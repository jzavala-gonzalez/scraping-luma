const timestamp_saved = '11/19/2023 02:00 PM';
const dataFechaAcualizado = '11/19/2023' + ' 9:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:16.70, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'80', Cost:16.98, ParentId: '15'},
