const timestamp_saved = '12/06/2023 05:10 AM';
const dataFechaAcualizado = '12/6/2023' + ' 1:05:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 1025},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'47', Cost:10.87, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'59', Cost:14.50, ParentId: '17'},
		]
	},
