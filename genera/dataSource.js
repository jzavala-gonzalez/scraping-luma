const timestamp_saved = '08/20/2023 01:25 AM';
const dataFechaAcualizado = '8/19/2023' + ' 9:22:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'63', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'60', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:27.16, ParentId: '9'},
