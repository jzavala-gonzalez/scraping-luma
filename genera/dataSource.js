const timestamp_saved = '10/20/2023 05:45 AM';
const dataFechaAcualizado = '10/20/2023' + ' 1:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'35', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'42', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'42', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'1', Cost:31.06, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 194,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'129', Cost:19.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'86', Cost:10.50, ParentId: '17'},
		]
	},
