const timestamp_saved = '09/03/2023 03:35 AM';
const dataFechaAcualizado = '9/2/2023' + ' 11:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'48', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'55', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'65', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'2', Cost:27.61, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'157', Cost:16.79, ParentId: '16'},
		]
	},
