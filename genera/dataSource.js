const timestamp_saved = '10/27/2023 01:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 8:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'53', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'56', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'56', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:17.24, ParentId: '11'},
