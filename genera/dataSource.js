const timestamp_saved = '08/06/2023 12:55 PM';
const dataFechaAcualizado = '8/6/2023' + ' 8:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'41', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'40', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 231,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'82', Cost:17.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'21', Cost:17.08, ParentId: '15'},
		]
	},
