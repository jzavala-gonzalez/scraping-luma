const timestamp_saved = '08/28/2023 12:30 AM';
const dataFechaAcualizado = '8/27/2023' + ' 8:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'49', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'48', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'51', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'23', Cost:19.10, ParentId: '14'},
