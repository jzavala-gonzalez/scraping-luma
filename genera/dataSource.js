const timestamp_saved = '11/03/2023 08:40 AM';
const dataFechaAcualizado = '11/3/2023' + ' 4:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'42', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'42', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'41', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'56', Cost:9.43, ParentId: '17'},
		]
	},
