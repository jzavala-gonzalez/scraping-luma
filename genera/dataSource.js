const timestamp_saved = '09/27/2023 11:35 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:30:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'28', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'28', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'59', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:17.91, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'77', Cost:9.40, ParentId: '17'},
		]
	},
