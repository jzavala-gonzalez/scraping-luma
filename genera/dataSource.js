const timestamp_saved = '10/03/2023 11:45 PM';
const dataFechaAcualizado = '10/3/2023' + ' 7:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'45', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'45', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'55', Cost:10.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:26.30, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'11', Cost:22.74, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:16.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:16.83, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'0', Cost:16.93, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'15', Cost:18.82, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'83', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 376,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 376, MVar:'167', Cost:16.63, ParentId: '16'},
		]
	},
