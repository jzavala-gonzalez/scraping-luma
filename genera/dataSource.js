const timestamp_saved = '09/09/2023 08:20 AM';
const dataFechaAcualizado = '9/9/2023' + ' 4:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'52', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'55', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'55', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'11', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'6', Cost:18.88, ParentId: '14'},
