const timestamp_saved = '10/20/2023 04:45 AM';
const dataFechaAcualizado = '10/20/2023' + ' 12:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'38', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'45', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'44', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 39,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'14', Cost:30.97, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'58', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'148', Cost:17.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'90', Cost:10.53, ParentId: '17'},
		]
	},
