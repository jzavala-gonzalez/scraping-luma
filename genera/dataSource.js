const timestamp_saved = '12/03/2023 03:00 AM';
const dataFechaAcualizado = '12/2/2023' + ' 10:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 135, MVar:'53', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'83', Cost:11.02, ParentId: '17'},
		]
	},
