const timestamp_saved = '09/26/2023 08:55 AM';
const dataFechaAcualizado = '9/26/2023' + ' 4:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'45', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'47', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'55', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:18.45, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'66', Cost:16.90, ParentId: '15'},
