const timestamp_saved = '10/20/2023 08:35 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'29', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'36', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'80', Cost:10.53, ParentId: '17'},
		]
	},
