const timestamp_saved = '10/23/2023 05:30 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'38', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'39', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'41', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'113', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'50', Cost:11.28, ParentId: '17'},
		]
	},
