const timestamp_saved = '07/28/2023 05:56 AM';
const dataFechaAcualizado = '7/28/2023' + ' 1:50:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'43', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:10.62, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'0', Cost:22.39, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:63.56, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'82', Cost:13.16, ParentId: '17'},
		]
	},
