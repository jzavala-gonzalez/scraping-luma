const timestamp_saved = '08/12/2023 09:20 AM';
const dataFechaAcualizado = '8/12/2023' + ' 5:17:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'48', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'103', Cost:11.62, ParentId: '17'},
		]
	},
