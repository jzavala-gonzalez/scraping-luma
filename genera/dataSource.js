const timestamp_saved = '09/24/2023 06:00 AM';
const dataFechaAcualizado = '9/24/2023' + ' 1:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'43', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'45', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'53', Cost:12.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'84', Cost:9.22, ParentId: '17'},
		]
	},
