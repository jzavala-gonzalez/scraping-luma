const timestamp_saved = '08/14/2023 07:45 PM';
const dataFechaAcualizado = '8/14/2023' + ' 3:42:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'49', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'47', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'131', Cost:11.69, ParentId: '17'},
		]
	},
