const timestamp_saved = '11/10/2023 08:45 PM';
const dataFechaAcualizado = '11/10/2023' + ' 4:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'43', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'36', Cost:11.23, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:31.36, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'98', Cost:9.22, ParentId: '17'},
		]
	},
