const timestamp_saved = '11/12/2023 12:25 PM';
const dataFechaAcualizado = '11/12/2023' + ' 8:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'44', Cost:11.08, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'80', Cost:9.65, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 29,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 15, MVar:'10', Cost:19.60, ParentId: '19'},
