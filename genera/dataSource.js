const timestamp_saved = '07/28/2023 07:16 AM';
const dataFechaAcualizado = '7/28/2023' + ' 3:10:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'42', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'43', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'42', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'77', Cost:13.17, ParentId: '17'},
		]
	},
