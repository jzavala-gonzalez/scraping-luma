const timestamp_saved = '10/27/2023 08:45 PM';
const dataFechaAcualizado = '10/27/2023' + ' 4:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'41', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'42', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'48', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'0', Cost:22.64, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.09, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'124', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'4', Cost:11.52, ParentId: '17'},
		]
	},
