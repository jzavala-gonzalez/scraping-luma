const timestamp_saved = '10/03/2023 04:30 PM';
const dataFechaAcualizado = '10/3/2023' + ' 12:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'44', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'41', Cost:10.29, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'76', Cost:16.70, ParentId: '15'},
