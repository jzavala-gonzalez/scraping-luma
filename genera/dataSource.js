const timestamp_saved = '09/30/2023 12:30 AM';
const dataFechaAcualizado = '9/29/2023' + ' 8:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'80', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'74', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'49', Cost:10.27, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'13', Cost:17.49, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'11', Cost:29.53, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'13', Cost:19.35, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'136', Cost:9.12, ParentId: '17'},
		]
	},
