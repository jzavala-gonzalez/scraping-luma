const timestamp_saved = '10/25/2023 06:10 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'53', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'14', Cost:43.51, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'156', Cost:17.36, ParentId: '16'},
		]
	},
