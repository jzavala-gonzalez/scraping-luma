const timestamp_saved = '11/06/2023 08:00 AM';
const dataFechaAcualizado = '11/6/2023' + ' 3:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 128, MVar:'40', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:17.20, ParentId: '11'},
