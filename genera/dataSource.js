const timestamp_saved = '09/05/2023 08:15 AM';
const dataFechaAcualizado = '9/5/2023' + ' 4:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'35', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'38', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'53', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.69, ParentId: '12'},
