const timestamp_saved = '11/21/2023 09:25 AM';
const dataFechaAcualizado = '11/21/2023' + ' 5:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'24', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'33', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'49', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'70', Cost:9.58, ParentId: '17'},
		]
	},
