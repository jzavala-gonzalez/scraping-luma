const timestamp_saved = '09/16/2023 04:55 AM';
const dataFechaAcualizado = '9/16/2023' + ' 12:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'61', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 375, MVar:'98', Cost:9.12, ParentId: '17'},
		]
	},
