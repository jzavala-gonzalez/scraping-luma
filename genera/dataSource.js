const timestamp_saved = '11/23/2023 08:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 4:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'27', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'35', Cost:11.12, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'60', Cost:9.81, ParentId: '17'},
		]
	},
