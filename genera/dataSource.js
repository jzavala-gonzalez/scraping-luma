const timestamp_saved = '08/05/2023 08:20 AM';
const dataFechaAcualizado = '8/5/2023' + ' 4:15:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'38', Cost:10.59, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'84', Cost:11.30, ParentId: '17'},
		]
	},
