const timestamp_saved = '10/31/2023 02:40 AM';
const dataFechaAcualizado = '10/30/2023' + ' 10:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'61', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'67', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'166', Cost:16.71, ParentId: '16'},
		]
	},
