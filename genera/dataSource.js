const timestamp_saved = '09/18/2023 07:05 PM';
const dataFechaAcualizado = '9/18/2023' + ' 3:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'57', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'55', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'66', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 299, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.33, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'92', Cost:16.86, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'101', Cost:9.17, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 83,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 28, MVar:'18', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 21, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
