const timestamp_saved = '09/16/2023 03:10 AM';
const dataFechaAcualizado = '9/15/2023' + ' 11:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'48', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'47', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'61', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 375, MVar:'99', Cost:9.11, ParentId: '17'},
		]
	},
