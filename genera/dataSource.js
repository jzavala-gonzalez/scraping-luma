const timestamp_saved = '09/03/2023 07:30 PM';
const dataFechaAcualizado = '9/3/2023' + ' 3:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'37', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:10.71, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'82', Cost:17.05, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'67', Cost:9.29, ParentId: '17'},
		]
	},
