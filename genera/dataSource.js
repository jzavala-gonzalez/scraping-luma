const timestamp_saved = '08/18/2023 09:40 AM';
const dataFechaAcualizado = '8/18/2023' + ' 5:37:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'41', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'58', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'67', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'18', Cost:19.82, ParentId: '14'},
