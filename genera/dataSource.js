const timestamp_saved = '12/04/2023 05:50 AM';
const dataFechaAcualizado = '12/4/2023' + ' 1:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'38', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'38', Cost:12.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 136, MVar:'43', Cost:17.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.29, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'52', Cost:11.62, ParentId: '17'},
		]
	},
