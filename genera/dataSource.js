const timestamp_saved = '09/17/2023 08:55 AM';
const dataFechaAcualizado = '9/17/2023' + ' 4:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'35', Cost:13.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'35', Cost:13.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'53', Cost:13.53, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 112, MVar:'60', Cost:17.66, ParentId: '15'},
