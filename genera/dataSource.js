const timestamp_saved = '09/26/2023 06:10 AM';
const dataFechaAcualizado = '9/26/2023' + ' 2:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'48', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'50', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'58', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:18.07, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'1', Cost:19.35, ParentId: '14'},
