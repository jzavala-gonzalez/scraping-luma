const timestamp_saved = '10/01/2023 08:45 PM';
const dataFechaAcualizado = '10/1/2023' + ' 4:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'32', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'29', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'45', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 187,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:26.12, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'6', Cost:23.39, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'8', Cost:30.57, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 267,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 135, MVar:'40', Cost:17.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'8', Cost:30.84, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 8,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 8, MVar:'8', Cost:0, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'9', Cost:19.20, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 136, MVar:'78', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 305,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 305, MVar:'136', Cost:17.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'96', Cost:9.23, ParentId: '17'},
		]
	},
