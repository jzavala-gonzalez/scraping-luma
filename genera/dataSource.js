const timestamp_saved = '12/05/2023 03:25 PM';
const dataFechaAcualizado = '12/5/2023' + ' 11:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'46', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'48', Cost:12.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'57', Cost:12.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.86, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:18.56, ParentId: '14'},
