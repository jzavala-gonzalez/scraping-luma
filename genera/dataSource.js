const timestamp_saved = '10/25/2023 01:10 PM';
const dataFechaAcualizado = '10/25/2023' + ' 9:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'47', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'35', Cost:18.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.49, ParentId: '14'},
