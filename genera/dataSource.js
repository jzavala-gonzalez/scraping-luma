const timestamp_saved = '11/30/2023 07:55 PM';
const dataFechaAcualizado = '11/30/2023' + ' 3:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'59', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'58', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 15,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 15, MVar:'7', Cost:0, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'89', Cost:9.32, ParentId: '17'},
		]
	},
