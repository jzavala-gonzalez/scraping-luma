const timestamp_saved = '08/17/2023 05:05 PM';
const dataFechaAcualizado = '8/17/2023' + ' 1:02:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'67', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'75', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'10', Cost:31.48, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'13', Cost:31.03, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:19.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:19.68, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:29.93, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'29', Cost:19.65, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'93', Cost:9.20, ParentId: '17'},
		]
	},
