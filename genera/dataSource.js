const timestamp_saved = '11/04/2023 11:35 AM';
const dataFechaAcualizado = '11/4/2023' + ' 7:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'44', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'43', Cost:11.07, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.23, ParentId: '11'},
