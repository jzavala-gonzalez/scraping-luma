const timestamp_saved = '11/12/2023 11:40 PM';
const dataFechaAcualizado = '11/12/2023' + ' 7:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 155, MVar:'62', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'73', Cost:16.80, ParentId: '15'},
