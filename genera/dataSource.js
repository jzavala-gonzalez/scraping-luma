const timestamp_saved = '10/02/2023 04:55 AM';
const dataFechaAcualizado = '10/2/2023' + ' 12:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'32', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'31', Cost:10.40, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'6', Cost:19.36, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'95', Cost:9.20, ParentId: '17'},
		]
	},
