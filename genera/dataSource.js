const timestamp_saved = '10/31/2023 02:25 AM';
const dataFechaAcualizado = '10/30/2023' + ' 10:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'109', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'58', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'61', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'66', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'14', Cost:20.95, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'167', Cost:16.78, ParentId: '16'},
		]
	},
