const timestamp_saved = '10/25/2023 01:45 PM';
const dataFechaAcualizado = '10/25/2023' + ' 9:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'48', Cost:11.16, ParentId: '7'},
