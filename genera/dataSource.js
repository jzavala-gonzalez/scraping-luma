const timestamp_saved = '08/14/2023 05:15 AM';
const dataFechaAcualizado = '8/14/2023' + ' 1:12:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'40', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'41', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:28.91, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:28.34, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 227,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 227, MVar:'102', Cost:13.82, ParentId: '17'},
		]
	},
