const timestamp_saved = '08/14/2023 05:50 PM';
const dataFechaAcualizado = '8/14/2023' + ' 1:47:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'110', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'52', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'50', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'4', Cost:27.54, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 68,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 68, MVar:'20', Cost:29.39, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:28.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 6, MVar:'2', Cost:28.89, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'38', Cost:19.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'169', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'132', Cost:12.47, ParentId: '17'},
		]
	},
