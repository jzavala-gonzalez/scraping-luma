const timestamp_saved = '08/11/2023 07:15 AM';
const dataFechaAcualizado = '8/11/2023' + ' 3:10:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'22', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'52', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'49', Cost:10.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 128, MVar:'14', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'5', Cost:30.62, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'7', Cost:30.65, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 237,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 237, MVar:'87', Cost:12.20, ParentId: '17'},
		]
	},
