const timestamp_saved = '10/09/2023 08:15 PM';
const dataFechaAcualizado = '10/9/2023' + ' 4:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'65', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'68', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'60', Cost:10.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 22, MVar:'0', Cost:20.13, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:30.50, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'3', Cost:26.62, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.65, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:23.00, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:26.95, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:17.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'46', Cost:16.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:16.99, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:28.68, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'19', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'96', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 340,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 340, MVar:'197', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'114', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 17, MVar:'0', Cost:26, ParentId: '21'},
			{Index:'1', Unit:'CT Block 2', MW: 5, MVar:'0', Cost:0, ParentId: '21'},
			...
			{Index:'5', Unit:'GT3', MW: 5, MVar:'0', Cost:0, ParentId: '21'},
