const timestamp_saved = '10/25/2023 06:31 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'48', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'51', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.87, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:18.16, ParentId: '11'},
		]
	},
