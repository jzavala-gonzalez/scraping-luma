const timestamp_saved = '08/01/2023 11:25 AM';
const dataFechaAcualizado = '8/1/2023' + ' 7:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'50', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:8.75, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'94', Cost:11.01, ParentId: '17'},
		]
	},
