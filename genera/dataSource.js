const timestamp_saved = '07/28/2023 08:38 AM';
const dataFechaAcualizado = '7/28/2023' + ' 4:30:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'40', Cost:11.05, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'0', Cost:26.96, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'31', Cost:15.85, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'75', Cost:13.18, ParentId: '17'},
		]
	},
