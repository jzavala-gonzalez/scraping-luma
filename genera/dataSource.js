const timestamp_saved = '08/28/2023 10:30 AM';
const dataFechaAcualizado = '8/28/2023' + ' 6:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'35', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'36', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'13', Cost:19.01, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'87', Cost:12.06, ParentId: '17'},
		]
	},
