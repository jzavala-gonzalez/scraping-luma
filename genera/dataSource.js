const timestamp_saved = '11/16/2023 01:25 PM';
const dataFechaAcualizado = '11/16/2023' + ' 9:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'52', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'50', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 204,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'134', Cost:18.43, ParentId: '16'},
		]
	},
