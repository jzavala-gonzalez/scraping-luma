const timestamp_saved = '08/19/2023 05:55 PM';
const dataFechaAcualizado = '8/19/2023' + ' 1:52:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'54', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'56', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 111,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:30.78, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'11', Cost:30.44, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.93, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 103, MVar:'86', Cost:18.60, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 318, MVar:'69', Cost:9.41, ParentId: '17'},
		]
	},
