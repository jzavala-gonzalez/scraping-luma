const timestamp_saved = '10/11/2023 05:35 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'60', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'63', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'68', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'34', Cost:17.22, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:17.22, ParentId: '11'},
		]
	},
