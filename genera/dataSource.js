const timestamp_saved = '08/02/2023 01:20 AM';
const dataFechaAcualizado = '8/1/2023' + ' 9:15:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'48', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'51', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:20.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'8', Cost:20.14, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'37', Cost:15.67, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'145', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'96', Cost:11.01, ParentId: '17'},
		]
	},
