const timestamp_saved = '11/03/2023 03:40 PM';
const dataFechaAcualizado = '11/3/2023' + ' 11:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'55', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'52', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'50', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'78', Cost:9.79, ParentId: '17'},
		]
	},
