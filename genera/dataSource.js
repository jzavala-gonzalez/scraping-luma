const timestamp_saved = '10/04/2023 05:15 AM';
const dataFechaAcualizado = '10/4/2023' + ' 1:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'39', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'36', Cost:11.21, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 4, MVar:'2', Cost:23.67, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'141', Cost:17.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'100', Cost:9.43, ParentId: '17'},
		]
	},
