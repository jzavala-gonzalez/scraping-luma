const timestamp_saved = '08/20/2023 09:40 PM';
const dataFechaAcualizado = '8/20/2023' + ' 5:37:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'49', Cost:11.32, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'88', Cost:17.33, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'65', Cost:9.22, ParentId: '17'},
		]
	},
