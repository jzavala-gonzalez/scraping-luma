const timestamp_saved = '10/30/2023 04:10 PM';
const dataFechaAcualizado = '10/30/2023' + ' 12:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'62', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'68', Cost:10.09, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'17', Cost:21.20, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'37', Cost:18.58, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'105', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 312,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 312, MVar:'172', Cost:17.03, ParentId: '16'},
		]
	},
