const timestamp_saved = '10/29/2023 04:35 PM';
const dataFechaAcualizado = '10/29/2023' + ' 12:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'46', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'49', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'72', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:44.05, ParentId: '13'},
