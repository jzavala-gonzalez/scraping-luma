const timestamp_saved = '12/01/2023 11:30 PM';
const dataFechaAcualizado = '12/1/2023' + ' 7:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'56', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'58', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'58', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 47, MVar:'4', Cost:28.65, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'162', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'97', Cost:9.21, ParentId: '17'},
		]
	},
