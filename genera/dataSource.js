const timestamp_saved = '08/28/2023 08:40 PM';
const dataFechaAcualizado = '8/28/2023' + ' 4:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'95', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'60', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'60', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'66', Cost:10.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 91, MVar:'0', Cost:5.18, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 160,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'5', Cost:22.14, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'37', Cost:30.98, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'39', Cost:18.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'102', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'183', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'126', Cost:9.19, ParentId: '17'},
		]
	},
