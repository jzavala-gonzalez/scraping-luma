const timestamp_saved = '07/30/2023 10:06 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:00:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 129, MVar:'37', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 41,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'4', Cost:30.99, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 259,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 119, MVar:'62', Cost:17.15, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'63', Cost:19.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'63', Cost:11.14, ParentId: '17'},
		]
	},
