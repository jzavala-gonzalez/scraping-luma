const timestamp_saved = '10/05/2023 01:05 PM';
const dataFechaAcualizado = '10/5/2023' + ' 9:01:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'40', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'38', Cost:10.54, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'89', Cost:16.94, ParentId: '15'},
