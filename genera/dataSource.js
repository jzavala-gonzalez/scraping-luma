const timestamp_saved = '08/08/2023 12:20 PM';
const dataFechaAcualizado = '8/8/2023' + ' 8:15:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'59', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'62', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:29.82, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 122,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 122, MVar:'30', Cost:16.29, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'160', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'100', Cost:11.62, ParentId: '17'},
		]
	},
