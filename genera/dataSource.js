const timestamp_saved = '09/28/2023 08:55 AM';
const dataFechaAcualizado = '9/28/2023' + ' 4:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'18', Cost:13.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'17', Cost:13.03, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.86, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'51', Cost:16.95, ParentId: '15'},
