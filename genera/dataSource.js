const timestamp_saved = '10/28/2023 06:20 PM';
const dataFechaAcualizado = '10/28/2023' + ' 2:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'46', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'50', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'51', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 50, MVar:'14', Cost:32.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:32.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'27', Cost:0, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 26, MVar:'2', Cost:0, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'19', Cost:21.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'82', Cost:16.67, ParentId: '15'},
