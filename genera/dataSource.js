const timestamp_saved = '12/03/2023 08:10 PM';
const dataFechaAcualizado = '12/3/2023' + ' 4:06:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1098},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 185,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 185, MVar:'73', Cost:4.44, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.44, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'45', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'47', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'35', Cost:17.91, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.91, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'47', Cost:8.24, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:8.24, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'114', Cost:17.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'66', Cost:11.41, ParentId: '17'},
		]
	},
