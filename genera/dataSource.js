const timestamp_saved = '11/08/2023 01:55 PM';
const dataFechaAcualizado = '11/8/2023' + ' 9:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 19,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 19, MVar:'1', Cost:26.74, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'86', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'98', Cost:9.62, ParentId: '17'},
		]
	},
