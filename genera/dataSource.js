const timestamp_saved = '10/11/2023 06:20 PM';
const dataFechaAcualizado = '10/11/2023' + ' 2:16:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'72', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'72', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 35, MVar:'0', Cost:26.14, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'43', Cost:18.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:18.03, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'35', Cost:18.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:18.30, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'7', Cost:0, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'102', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'183', Cost:17.92, ParentId: '16'},
		]
	},
