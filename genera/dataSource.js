const timestamp_saved = '08/02/2023 10:45 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:40:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'41', Cost:10.94, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:32.34, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 307,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'88', Cost:16.73, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'10', Cost:15.84, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'145', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'88', Cost:10.85, ParentId: '17'},
		]
	},
