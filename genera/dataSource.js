const timestamp_saved = '09/08/2023 08:10 PM';
const dataFechaAcualizado = '9/8/2023' + ' 4:05:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'62', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'67', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'61', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:22.97, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'7', Cost:27.44, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'2', Cost:22.25, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'27', Cost:28.10, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:28.85, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'10', Cost:29.82, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'96', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'182', Cost:16.65, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 37,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 19, MVar:'17', Cost:17, ParentId: '19'},
		]
	},
