const timestamp_saved = '10/02/2023 05:50 PM';
const dataFechaAcualizado = '10/2/2023' + ' 1:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'40', Cost:10.26, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'97', Cost:17.00, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'177', Cost:17.04, ParentId: '16'},
		]
	},
