const timestamp_saved = '09/18/2023 04:25 PM';
const dataFechaAcualizado = '9/18/2023' + ' 12:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'79', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'52', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'51', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'63', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:19.70, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 10,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'0', Cost:86.01, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'30', Cost:18.94, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'86', Cost:16.39, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'82', Cost:9.82, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 100,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'12', Cost:19.60, ParentId: '19'},
