const timestamp_saved = '11/24/2023 12:25 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:21:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1885},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'32', Cost:11.32, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'69', Cost:9.91, ParentId: '17'},
		]
	},
