const timestamp_saved = '10/28/2023 07:55 AM';
const dataFechaAcualizado = '10/28/2023' + ' 3:51:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2594},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'37', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'39', Cost:11.37, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'1', Cost:51.88, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'17', Cost:29.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.94, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 30, MVar:'8', Cost:0, ParentId: '11'},
