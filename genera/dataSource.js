const timestamp_saved = '11/15/2023 04:20 PM';
const dataFechaAcualizado = '11/15/2023' + ' 12:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'50', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'53', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.92, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'30', Cost:19.59, ParentId: '14'},
