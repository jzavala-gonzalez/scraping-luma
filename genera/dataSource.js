const timestamp_saved = '11/21/2023 06:35 PM';
const dataFechaAcualizado = '11/21/2023' + ' 2:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'34', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'44', Cost:10.82, ParentId: '7'},
