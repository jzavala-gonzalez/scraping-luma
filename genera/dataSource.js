const timestamp_saved = '08/02/2023 10:35 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'40', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'46', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'10', Cost:15.98, ParentId: '15'},
		]
	},
