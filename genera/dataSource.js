const timestamp_saved = '08/10/2023 06:05 PM';
const dataFechaAcualizado = '8/10/2023' + ' 2:00:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'54', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:30.81, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'172', Cost:17.82, ParentId: '16'},
		]
	},
