const timestamp_saved = '08/15/2023 12:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 8:52:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 550,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'61', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'55', Cost:9.77, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:22.09, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'29', Cost:28.01, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'8', Cost:30.85, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:28.87, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'11', Cost:28.43, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'149', Cost:11.65, ParentId: '17'},
		]
	},
