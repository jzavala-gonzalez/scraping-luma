const timestamp_saved = '10/21/2023 05:15 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'23', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'22', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'59', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 38,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'8', Cost:30.79, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'62', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'142', Cost:16.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'76', Cost:11.01, ParentId: '17'},
		]
	},
