const timestamp_saved = '09/27/2023 10:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 6:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'28', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'29', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.40, ParentId: '11'},
