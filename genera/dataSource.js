const timestamp_saved = '11/27/2023 02:50 AM';
const dataFechaAcualizado = '11/26/2023' + ' 10:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'32', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'43', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'6', Cost:29.42, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'146', Cost:17.32, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'95', Cost:9.30, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:17.25, ParentId: '21'},
