const timestamp_saved = '12/03/2023 04:30 AM';
const dataFechaAcualizado = '12/3/2023' + ' 12:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'49', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'66', Cost:11.22, ParentId: '17'},
		]
	},
