const timestamp_saved = '10/17/2023 09:01 PM';
const dataFechaAcualizado = '10/17/2023' + ' 4:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 256,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'98', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'68', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'66', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:16.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:16.70, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'205', Cost:16.64, ParentId: '16'},
		]
	},
