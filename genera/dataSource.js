const timestamp_saved = '08/02/2023 10:55 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'41', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:30.40, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:30.23, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'147', Cost:17.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'89', Cost:10.85, ParentId: '17'},
		]
	},
