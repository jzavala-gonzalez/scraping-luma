const timestamp_saved = '10/01/2023 12:45 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 261,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'71', Cost:4.32, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 10, MVar:'44', Cost:4.32, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'25', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'23', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'43', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:17.65, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'104', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'83', Cost:9.51, ParentId: '17'},
		]
	},
