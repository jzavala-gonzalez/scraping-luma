const timestamp_saved = '08/12/2023 06:00 AM';
const dataFechaAcualizado = '8/12/2023' + ' 1:57:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 153, MVar:'52', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'9', Cost:31.19, ParentId: '12'},
