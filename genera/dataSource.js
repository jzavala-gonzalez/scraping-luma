const timestamp_saved = '10/07/2023 07:45 AM';
const dataFechaAcualizado = '10/7/2023' + ' 3:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 35, MVar:'33', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'44', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:11.28, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'153', Cost:16.76, ParentId: '16'},
		]
	},
