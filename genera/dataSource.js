const timestamp_saved = '12/05/2023 01:50 PM';
const dataFechaAcualizado = '12/5/2023' + ' 9:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'49', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'51', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'58', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.95, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 183,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 95, MVar:'12', Cost:18.65, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'29', Cost:18.64, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'67', Cost:11.47, ParentId: '17'},
		]
	},
