const timestamp_saved = '11/23/2023 09:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'17', Cost:13.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:13.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'46', Cost:13.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.09, ParentId: '11'},
