const timestamp_saved = '10/10/2023 04:45 PM';
const dataFechaAcualizado = '10/10/2023' + ' 12:41:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'79', Cost:4.16, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.16, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'66', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'70', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'71', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'43', Cost:17.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.52, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'34', Cost:18.19, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'10', Cost:18.19, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'90', Cost:16.64, ParentId: '15'},
