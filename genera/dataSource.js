const timestamp_saved = '08/18/2023 01:50 PM';
const dataFechaAcualizado = '8/18/2023' + ' 9:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'60', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'71', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'6', Cost:30.85, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'8', Cost:31.71, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'146', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'78', Cost:9.28, ParentId: '17'},
		]
	},
