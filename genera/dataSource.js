const timestamp_saved = '11/27/2023 01:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 9:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'31', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'40', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'55', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'87', Cost:9.81, ParentId: '17'},
		]
	},
