const timestamp_saved = '09/20/2023 04:35 AM';
const dataFechaAcualizado = '9/20/2023' + ' 12:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'48', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'50', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'63', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'1', Cost:21.29, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 16, MVar:'0', Cost:26.61, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:10.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'7', Cost:10.24, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'59', Cost:16.87, ParentId: '15'},
