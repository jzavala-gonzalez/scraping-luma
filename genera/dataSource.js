const timestamp_saved = '10/02/2023 06:30 AM';
const dataFechaAcualizado = '10/2/2023' + ' 2:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'33', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'31', Cost:10.69, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'72', Cost:16.73, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'95', Cost:9.23, ParentId: '17'},
		]
	},
