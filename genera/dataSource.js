const timestamp_saved = '11/16/2023 12:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 8:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'60', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'60', Cost:11.00, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'22', Cost:30.96, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'86', Cost:16.73, ParentId: '15'},
