const timestamp_saved = '10/31/2023 02:10 AM';
const dataFechaAcualizado = '10/30/2023' + ' 10:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'58', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'64', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'68', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:28.88, ParentId: '12'},
