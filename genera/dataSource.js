const timestamp_saved = '10/13/2023 01:05 AM';
const dataFechaAcualizado = '10/12/2023' + ' 9:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 564,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'82', Cost:9.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'81', Cost:9.73, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 135,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 42, MVar:'0', Cost:22.00, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'26', Cost:28.34, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:16.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'12', Cost:16.87, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'10', Cost:29.46, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'88', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'215', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'107', Cost:9.16, ParentId: '17'},
		]
	},
