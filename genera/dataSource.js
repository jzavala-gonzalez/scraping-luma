const timestamp_saved = '11/25/2023 11:20 PM';
const dataFechaAcualizado = '11/25/2023' + ' 7:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 204, MVar:'69', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'33', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'44', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'57', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:18.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:18.01, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'21', Cost:9.93, ParentId: '17'},
		]
	},
