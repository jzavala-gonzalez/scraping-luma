const timestamp_saved = '09/29/2023 09:35 AM';
const dataFechaAcualizado = '9/29/2023' + ' 5:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'34', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'32', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'48', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'92', Cost:9.14, ParentId: '17'},
		]
	},
