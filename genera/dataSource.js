const timestamp_saved = '11/27/2023 11:00 AM';
const dataFechaAcualizado = '11/27/2023' + ' 6:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'22', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'32', Cost:11.56, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'50', Cost:17.25, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'70', Cost:9.83, ParentId: '17'},
		]
	},
