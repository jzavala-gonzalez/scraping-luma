const timestamp_saved = '10/19/2023 11:15 AM';
const dataFechaAcualizado = '10/19/2023' + ' 7:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'32', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'40', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.26, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'29', Cost:9.43, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:9.43, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.06, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'96', Cost:10.52, ParentId: '17'},
		]
	},
