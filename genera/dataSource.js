const timestamp_saved = '09/27/2023 10:15 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'28', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'28', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'60', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'3', Cost:19.37, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'108', Cost:9.09, ParentId: '17'},
		]
	},
