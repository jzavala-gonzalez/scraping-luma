const timestamp_saved = '11/12/2023 12:45 AM';
const dataFechaAcualizado = '11/11/2023' + ' 8:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'57', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'61', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:17.47, ParentId: '11'},
