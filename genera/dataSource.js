const timestamp_saved = '10/25/2023 07:15 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'51', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'80', Cost:16.79, ParentId: '15'},
