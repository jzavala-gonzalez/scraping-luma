const timestamp_saved = '09/02/2023 06:25 AM';
const dataFechaAcualizado = '9/2/2023' + ' 2:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'43', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'52', Cost:11.47, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'46', Cost:16.67, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'59', Cost:9.83, ParentId: '17'},
		]
	},
