const timestamp_saved = '12/02/2023 11:50 AM';
const dataFechaAcualizado = '12/2/2023' + ' 7:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'42', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'43', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'42', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'60', Cost:9.91, ParentId: '17'},
		]
	},
