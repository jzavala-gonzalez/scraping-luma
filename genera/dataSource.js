const timestamp_saved = '11/15/2023 12:10 PM';
const dataFechaAcualizado = '11/15/2023' + ' 8:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'45', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'45', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'9', Cost:30.98, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'78', Cost:9.78, ParentId: '17'},
		]
	},
