const timestamp_saved = '08/31/2023 02:30 AM';
const dataFechaAcualizado = '8/30/2023' + ' 10:25:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 3000},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'67', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'104', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'57', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'67', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'73', Cost:11.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 171,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 133, MVar:'21', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'3', Cost:23.01, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'24', Cost:28.12, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:18.94, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.97, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.04, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 95,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'4', Cost:28.82, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'27', Cost:18.73, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'91', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'189', Cost:16.64, ParentId: '16'},
		]
	},
