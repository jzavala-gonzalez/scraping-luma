const timestamp_saved = '11/19/2023 03:25 PM';
const dataFechaAcualizado = '11/19/2023' + ' 11:21:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2109},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'36', Cost:17.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'44', Cost:17.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:17.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'4', Cost:31.39, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:18.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:18.04, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'90', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 209,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'129', Cost:18.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'89', Cost:9.89, ParentId: '17'},
		]
	},
