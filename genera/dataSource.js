const timestamp_saved = '09/13/2023 11:00 AM';
const dataFechaAcualizado = '9/13/2023' + ' 6:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'49', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'48', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'62', Cost:11.57, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'148', Cost:18.27, ParentId: '16'},
		]
	},
