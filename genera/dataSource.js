const timestamp_saved = '11/04/2023 11:20 AM';
const dataFechaAcualizado = '11/4/2023' + ' 7:16:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2021},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'43', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'42', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'41', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.24, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'54', Cost:9.74, ParentId: '17'},
		]
	},
