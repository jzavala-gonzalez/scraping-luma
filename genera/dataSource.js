const timestamp_saved = '08/17/2023 10:20 AM';
const dataFechaAcualizado = '8/17/2023' + ' 6:17:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'59', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'71', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'18', Cost:18.55, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'143', Cost:17.84, ParentId: '16'},
		]
	},
