const timestamp_saved = '09/10/2023 03:10 PM';
const dataFechaAcualizado = '9/10/2023' + ' 11:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'62', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'61', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'62', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'124', Cost:18.29, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 95,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 40, MVar:'10', Cost:19.60, ParentId: '19'},
