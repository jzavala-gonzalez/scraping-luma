const timestamp_saved = '11/02/2023 05:25 AM';
const dataFechaAcualizado = '11/2/2023' + ' 1:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 511,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'49', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'62', Cost:10.14, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.02, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 24, MVar:'20', Cost:30.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'64', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'121', Cost:18.57, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'59', Cost:9.62, ParentId: '17'},
		]
	},
