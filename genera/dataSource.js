const timestamp_saved = '07/31/2023 07:50 PM';
const dataFechaAcualizado = '7/31/2023' + ' 3:45:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'49', Cost:10.72, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'28', Cost:31.30, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'90', Cost:16.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'52', Cost:15.44, ParentId: '15'},
		]
	},
