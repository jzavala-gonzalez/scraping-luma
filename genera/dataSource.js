const timestamp_saved = '08/15/2023 01:00 PM';
const dataFechaAcualizado = '8/15/2023' + ' 8:57:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'44', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'2', Cost:22.96, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'43', Cost:19.93, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.87, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'166', Cost:17.86, ParentId: '16'},
		]
	},
