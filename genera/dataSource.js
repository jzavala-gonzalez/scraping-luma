const timestamp_saved = '11/18/2023 11:55 AM';
const dataFechaAcualizado = '11/18/2023' + ' 7:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'46', Cost:16.03, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.37, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'24', Cost:18.59, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'86', Cost:16.63, ParentId: '15'},
