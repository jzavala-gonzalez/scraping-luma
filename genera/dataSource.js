const timestamp_saved = '08/12/2023 06:55 AM';
const dataFechaAcualizado = '8/12/2023' + ' 2:52:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'54', Cost:10.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'58', Cost:10.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'51', Cost:10.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.57, ParentId: '9'},
