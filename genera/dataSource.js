const timestamp_saved = '10/22/2023 06:45 AM';
const dataFechaAcualizado = '10/22/2023' + ' 2:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'41', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'42', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'46', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'38', Cost:17.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.01, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'69', Cost:17.24, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 215,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'127', Cost:19.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'56', Cost:11.11, ParentId: '17'},
		]
	},
