const timestamp_saved = '10/31/2023 11:40 AM';
const dataFechaAcualizado = '10/31/2023' + ' 7:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'56', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'56', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'24', Cost:19.46, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'150', Cost:17.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'66', Cost:9.40, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'20', Cost:19.60, ParentId: '19'},
