const timestamp_saved = '09/17/2023 01:30 PM';
const dataFechaAcualizado = '9/17/2023' + ' 9:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 182, MVar:'67', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'42', Cost:11.66, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'84', Cost:18.52, ParentId: '15'},
