const timestamp_saved = '10/07/2023 04:30 PM';
const dataFechaAcualizado = '10/7/2023' + ' 12:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'43', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'44', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'43', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'87', Cost:9.71, ParentId: '17'},
		]
	},
