const timestamp_saved = '10/13/2023 12:30 PM';
const dataFechaAcualizado = '10/13/2023' + ' 8:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'64', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'67', Cost:10.56, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.56, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'180', Cost:18.23, ParentId: '16'},
		]
	},
