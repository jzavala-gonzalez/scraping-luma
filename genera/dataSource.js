const timestamp_saved = '08/12/2023 11:25 AM';
const dataFechaAcualizado = '8/12/2023' + ' 7:22:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'46', Cost:10.84, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'152', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'93', Cost:11.75, ParentId: '17'},
		]
	},
