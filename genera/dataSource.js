const timestamp_saved = '10/24/2023 10:50 PM';
const dataFechaAcualizado = '10/24/2023' + ' 6:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'58', Cost:10.11, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'24', Cost:27.92, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:17.32, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'47', Cost:16.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'89', Cost:16.91, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'95', Cost:11.28, ParentId: '17'},
		]
	},
