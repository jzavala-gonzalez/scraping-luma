const timestamp_saved = '11/17/2023 02:05 AM';
const dataFechaAcualizado = '11/16/2023' + ' 10:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'58', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'58', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'46', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'26', Cost:27.89, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 99, MVar:'174', Cost:25.73, ParentId: '16'},
		]
	},
