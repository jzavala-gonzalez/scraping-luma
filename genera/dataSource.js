const timestamp_saved = '11/10/2023 07:45 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'45', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'50', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'41', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 270,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 101, MVar:'30', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:21.95, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'53', Cost:9.81, ParentId: '17'},
		]
	},
