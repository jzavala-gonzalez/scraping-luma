const timestamp_saved = '09/04/2023 12:40 AM';
const dataFechaAcualizado = '9/3/2023' + ' 8:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'49', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'59', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 152,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 109, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'31', Cost:19.24, ParentId: '14'},
