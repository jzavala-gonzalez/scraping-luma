const timestamp_saved = '08/07/2023 03:05 AM';
const dataFechaAcualizado = '8/6/2023' + ' 11:00:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'54', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'51', Cost:10.73, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'2', Cost:26.50, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.54, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:27.25, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:25.90, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'20', Cost:28.02, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'20', Cost:27.99, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.92, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'66', Cost:18.22, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'29', Cost:15.58, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'108', Cost:11.62, ParentId: '17'},
		]
	},
