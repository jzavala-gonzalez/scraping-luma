const timestamp_saved = '11/04/2023 03:15 PM';
const dataFechaAcualizado = '11/4/2023' + ' 11:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'44', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'43', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'43', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 52, MVar:'17', Cost:21.25, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 104,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 40, MVar:'7', Cost:19.60, ParentId: '19'},
