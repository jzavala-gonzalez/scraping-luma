const timestamp_saved = '09/28/2023 12:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 8:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'38', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'38', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'66', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'18', Cost:30.70, ParentId: '10'},
		]
	},
