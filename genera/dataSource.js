const timestamp_saved = '09/16/2023 09:20 PM';
const dataFechaAcualizado = '9/16/2023' + ' 5:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'45', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'59', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'88', Cost:16.74, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 17,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 11, MVar:'2', Cost:19.60, ParentId: '19'},
