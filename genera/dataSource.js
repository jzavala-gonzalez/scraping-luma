const timestamp_saved = '08/08/2023 10:30 PM';
const dataFechaAcualizado = '8/8/2023' + ' 6:25:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'39', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'46', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'55', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:10.35, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 31, MVar:'6', Cost:10.35, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.79, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:30.72, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'48', Cost:15.63, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'154', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'77', Cost:12.45, ParentId: '17'},
		]
	},
