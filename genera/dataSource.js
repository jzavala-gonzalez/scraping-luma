const timestamp_saved = '10/27/2023 07:30 PM';
const dataFechaAcualizado = '10/27/2023' + ' 3:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'52', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'53', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'27', Cost:20.86, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'6', Cost:20.86, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'112', Cost:17.16, ParentId: '16'},
		]
	},
