const timestamp_saved = '08/23/2023 03:30 AM';
const dataFechaAcualizado = '8/22/2023' + ' 11:25:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 193, MVar:'60', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'48', Cost:10.84, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:29.14, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'13', Cost:19.20, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 267,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 267, MVar:'120', Cost:17.41, ParentId: '16'},
		]
	},
