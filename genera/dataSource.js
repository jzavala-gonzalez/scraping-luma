const timestamp_saved = '11/09/2023 12:25 PM';
const dataFechaAcualizado = '11/9/2023' + ' 8:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'50', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'48', Cost:10.42, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'19', Cost:21.97, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'87', Cost:9.80, ParentId: '17'},
		]
	},
