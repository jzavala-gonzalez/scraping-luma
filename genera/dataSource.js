const timestamp_saved = '08/22/2023 07:55 AM';
const dataFechaAcualizado = '8/22/2023' + ' 3:50:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'58', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'48', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.31, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 235,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 235, MVar:'51', Cost:9.99, ParentId: '17'},
		]
	},
