const timestamp_saved = '09/23/2023 10:20 PM';
const dataFechaAcualizado = '9/23/2023' + ' 6:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 82,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'10', Cost:28.53, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'73', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'100', Cost:9.22, ParentId: '17'},
		]
	},
