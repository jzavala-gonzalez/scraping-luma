const timestamp_saved = '08/15/2023 06:00 AM';
const dataFechaAcualizado = '8/15/2023' + ' 1:57:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:10.56, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 104,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 32, MVar:'3', Cost:22.95, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'167', Cost:18.18, ParentId: '16'},
		]
	},
