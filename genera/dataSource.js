const timestamp_saved = '10/26/2023 04:20 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'47', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'50', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'51', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'6', Cost:17.00, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.16, ParentId: '14'},
