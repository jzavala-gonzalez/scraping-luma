const timestamp_saved = '11/13/2023 11:55 PM';
const dataFechaAcualizado = '11/13/2023' + ' 7:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'69', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 205, MVar:'67', Cost:9.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 128,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'28', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'25', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'83', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'131', Cost:10.89, ParentId: '17'},
		]
	},
