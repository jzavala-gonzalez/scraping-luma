const timestamp_saved = '09/08/2023 02:30 PM';
const dataFechaAcualizado = '9/8/2023' + ' 10:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'59', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'55', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'0', Cost:21.98, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'16', Cost:31.30, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'26', Cost:19.19, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'148', Cost:17.13, ParentId: '16'},
		]
	},
