const timestamp_saved = '08/05/2023 06:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 2:20:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'47', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'51', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.67, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'98', Cost:11.87, ParentId: '17'},
		]
	},
