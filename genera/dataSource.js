const timestamp_saved = '08/07/2023 08:30 AM';
const dataFechaAcualizado = '8/7/2023' + ' 4:25:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'43', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'43', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:30.29, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'44', Cost:18.46, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'14', Cost:17.04, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'91', Cost:11.82, ParentId: '17'},
		]
	},
