const timestamp_saved = '12/02/2023 09:50 PM';
const dataFechaAcualizado = '12/2/2023' + ' 5:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'56', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'58', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'98', Cost:10.87, ParentId: '17'},
		]
	},
