const timestamp_saved = '10/09/2023 10:15 AM';
const dataFechaAcualizado = '10/9/2023' + ' 6:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'45', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'44', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'10', Cost:17.54, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'133', Cost:17.83, ParentId: '16'},
		]
	},
