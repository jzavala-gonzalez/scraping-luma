const timestamp_saved = '10/22/2023 04:15 PM';
const dataFechaAcualizado = '10/22/2023' + ' 12:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'45', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'50', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'18', Cost:18.87, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'65', Cost:11.23, ParentId: '17'},
		]
	},
