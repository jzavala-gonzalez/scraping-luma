const timestamp_saved = '11/26/2023 01:40 AM';
const dataFechaAcualizado = '11/25/2023' + ' 9:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'31', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'42', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'55', Cost:12.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:26.23, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 51,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:29.18, ParentId: '13'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:26.62, ParentId: '21'},
