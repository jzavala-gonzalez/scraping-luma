const timestamp_saved = '07/31/2023 01:30 PM';
const dataFechaAcualizado = '7/31/2023' + ' 9:25:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'45', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'50', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:19.03, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'93', Cost:11.17, ParentId: '17'},
		]
	},
