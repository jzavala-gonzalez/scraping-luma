const timestamp_saved = '10/25/2023 08:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 4:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'48', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 163, MVar:'52', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'19', Cost:19.46, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'153', Cost:17.36, ParentId: '16'},
		]
	},
