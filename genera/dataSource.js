const timestamp_saved = '11/04/2023 05:10 PM';
const dataFechaAcualizado = '11/4/2023' + ' 1:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'44', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'45', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'43', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'58', Cost:9.87, ParentId: '17'},
		]
	},
