const timestamp_saved = '10/21/2023 07:20 AM';
const dataFechaAcualizado = '10/21/2023' + ' 3:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'22', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'18', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'57', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'140', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'70', Cost:11.04, ParentId: '17'},
		]
	},
