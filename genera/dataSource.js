const timestamp_saved = '08/12/2023 06:15 PM';
const dataFechaAcualizado = '8/12/2023' + ' 2:12:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'41', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'45', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'43', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:77.55, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'148', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'109', Cost:11.62, ParentId: '17'},
		]
	},
