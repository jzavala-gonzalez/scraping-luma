const timestamp_saved = '10/06/2023 11:15 PM';
const dataFechaAcualizado = '10/6/2023' + ' 7:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'61', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'63', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 214, MVar:'61', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'14', Cost:23.03, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'13', Cost:28.45, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'12', Cost:18.78, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'85', Cost:16.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'129', Cost:9.27, ParentId: '17'},
		]
	},
