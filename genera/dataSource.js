const timestamp_saved = '12/05/2023 05:30 AM';
const dataFechaAcualizado = '12/5/2023' + ' 1:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'42', Cost:12.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'43', Cost:12.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'52', Cost:12.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'62', Cost:10.94, ParentId: '17'},
		]
	},
