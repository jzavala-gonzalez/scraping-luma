const timestamp_saved = '12/03/2023 11:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 7:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'35', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'37', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'43', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'50', Cost:11.66, ParentId: '17'},
		]
	},
