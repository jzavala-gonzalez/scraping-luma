const timestamp_saved = '11/07/2023 12:10 PM';
const dataFechaAcualizado = '11/7/2023' + ' 8:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'43', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'42', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'81', Cost:9.78, ParentId: '17'},
		]
	},
