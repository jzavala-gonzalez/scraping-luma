const timestamp_saved = '10/19/2023 02:25 PM';
const dataFechaAcualizado = '10/19/2023' + ' 10:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'40', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'48', Cost:11.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:18.00, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 359, MVar:'109', Cost:10.53, ParentId: '17'},
		]
	},
