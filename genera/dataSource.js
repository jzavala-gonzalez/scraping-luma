const timestamp_saved = '11/28/2023 02:15 PM';
const dataFechaAcualizado = '11/28/2023' + ' 10:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'35', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'43', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'96', Cost:9.55, ParentId: '17'},
		]
	},
