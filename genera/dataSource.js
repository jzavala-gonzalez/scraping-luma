const timestamp_saved = '08/28/2023 11:10 AM';
const dataFechaAcualizado = '8/28/2023' + ' 7:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'36', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'36', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'43', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'17', Cost:19.28, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'89', Cost:12.02, ParentId: '17'},
		]
	},
