const timestamp_saved = '11/30/2023 03:00 PM';
const dataFechaAcualizado = '11/30/2023' + ' 10:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'47', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'49', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'53', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'72', Cost:9.55, ParentId: '17'},
		]
	},
