const timestamp_saved = '11/20/2023 11:10 AM';
const dataFechaAcualizado = '11/20/2023' + ' 7:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'35', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'45', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'57', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:17.33, ParentId: '11'},
