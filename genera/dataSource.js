const timestamp_saved = '10/25/2023 11:11 PM';
const dataFechaAcualizado = '10/25/2023' + ' 7:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'51', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'51', Cost:11.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.08, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:17.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:17.74, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'81', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'155', Cost:16.77, ParentId: '16'},
		]
	},
