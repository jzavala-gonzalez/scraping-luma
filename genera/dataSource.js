const timestamp_saved = '07/25/2023 11:20 AM';
const dataFechaAcualizado = '7/25/2023' + ' 7:15:30 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2580},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'86', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'86', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'52', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'65', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'58', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:26.93, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:31.79, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'9', Cost:32.95, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:39.26, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'10', Cost:29.35, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'23', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'56', Cost:15.42, ParentId: '15'},
		]
	},
