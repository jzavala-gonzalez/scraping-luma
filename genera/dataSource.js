const timestamp_saved = '08/26/2023 01:20 PM';
const dataFechaAcualizado = '8/26/2023' + ' 9:15:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:6.83, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'9', Cost:31.21, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.67, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'84', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'129', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'112', Cost:16.71, ParentId: '17'},
		]
	},
