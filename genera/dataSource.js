const timestamp_saved = '08/28/2023 01:05 PM';
const dataFechaAcualizado = '8/28/2023' + ' 9:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'86', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'51', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'54', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'52', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'87', Cost:16.86, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'107', Cost:9.27, ParentId: '17'},
		]
	},
