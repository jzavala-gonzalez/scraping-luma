const timestamp_saved = '08/01/2023 12:10 PM';
const dataFechaAcualizado = '8/1/2023' + ' 8:05:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:8.80, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'0', Cost:8.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:8.74, ParentId: '11'},
		]
	},
