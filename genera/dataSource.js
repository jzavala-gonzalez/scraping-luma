const timestamp_saved = '07/29/2023 02:25 PM';
const dataFechaAcualizado = '7/29/2023' + ' 10:20:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'51', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'48', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'35', Cost:18.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.55, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:18.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'8', Cost:18.31, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'96', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'26', Cost:15.84, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'93', Cost:13.35, ParentId: '17'},
		]
	},
