const timestamp_saved = '10/30/2023 07:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 2:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'31', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'32', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'60', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 51, MVar:'15', Cost:21.37, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'100', Cost:18.75, ParentId: '16'},
		]
	},
