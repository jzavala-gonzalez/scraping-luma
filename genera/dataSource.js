const timestamp_saved = '09/30/2023 12:20 AM';
const dataFechaAcualizado = '9/29/2023' + ' 8:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'49', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'48', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'58', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:22.08, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.86, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'14', Cost:27.48, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'24', Cost:31.03, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'11', Cost:29.59, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'154', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'137', Cost:9.14, ParentId: '17'},
		]
	},
