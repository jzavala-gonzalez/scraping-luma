const timestamp_saved = '11/21/2023 07:20 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'19', Cost:12.88, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 69, MVar:'22', Cost:0, ParentId: '8'},
