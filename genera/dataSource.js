const timestamp_saved = '10/14/2023 10:20 AM';
const dataFechaAcualizado = '10/14/2023' + ' 6:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'48', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:11.35, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'11', Cost:18.70, ParentId: '11'},
