const timestamp_saved = '11/19/2023 05:20 AM';
const dataFechaAcualizado = '11/19/2023' + ' 1:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:14.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'54', Cost:14.31, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'76', Cost:16.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'125', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'106', Cost:9.35, ParentId: '17'},
		]
	},
