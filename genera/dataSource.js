const timestamp_saved = '10/21/2023 03:20 AM';
const dataFechaAcualizado = '10/20/2023' + ' 11:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'39', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'46', Cost:10.65, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'6', Cost:19.53, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 316, MVar:'156', Cost:17.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'87', Cost:11.03, ParentId: '17'},
		]
	},
