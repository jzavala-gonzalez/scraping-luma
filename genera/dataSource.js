const timestamp_saved = '09/13/2023 02:00 PM';
const dataFechaAcualizado = '9/13/2023' + ' 9:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'50', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'51', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'64', Cost:12.52, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.80, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'12', Cost:28.22, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'98', Cost:9.12, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 81,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'16', Cost:19.60, ParentId: '19'},
