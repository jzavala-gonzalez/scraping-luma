const timestamp_saved = '11/25/2023 08:35 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'19', Cost:13.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'28', Cost:13.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'46', Cost:13.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.82, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'117', Cost:17.73, ParentId: '16'},
		]
	},
