const timestamp_saved = '11/28/2023 12:50 PM';
const dataFechaAcualizado = '11/28/2023' + ' 8:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'31', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'40', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'54', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'90', Cost:9.43, ParentId: '17'},
		]
	},
