const timestamp_saved = '12/03/2023 12:45 AM';
const dataFechaAcualizado = '12/2/2023' + ' 8:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'56', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'58', Cost:10.66, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'97', Cost:10.90, ParentId: '17'},
		]
	},
