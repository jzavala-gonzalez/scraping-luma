const timestamp_saved = '10/01/2023 02:00 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'27', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'25', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'43', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 51,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 21, MVar:'1', Cost:31.30, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'87', Cost:9.49, ParentId: '17'},
		]
	},
