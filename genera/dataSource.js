const timestamp_saved = '11/11/2023 08:20 AM';
const dataFechaAcualizado = '11/11/2023' + ' 4:16:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1972},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'41', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'43', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'42', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'66', Cost:9.76, ParentId: '17'},
		]
	},
