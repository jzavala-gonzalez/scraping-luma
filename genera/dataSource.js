const timestamp_saved = '10/14/2023 02:55 AM';
const dataFechaAcualizado = '10/13/2023' + ' 10:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'65', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'68', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'71', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 332, MVar:'162', Cost:16.62, ParentId: '16'},
		]
	},
