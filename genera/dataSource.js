const timestamp_saved = '11/23/2023 03:20 PM';
const dataFechaAcualizado = '11/23/2023' + ' 11:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 189,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 189, MVar:'79', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'26', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'36', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'49', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'32', Cost:18.97, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'74', Cost:9.77, ParentId: '17'},
		]
	},
