const timestamp_saved = '08/23/2023 04:10 AM';
const dataFechaAcualizado = '8/23/2023' + ' 12:05:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'47', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'115', Cost:18.22, ParentId: '16'},
		]
	},
