const timestamp_saved = '10/23/2023 12:50 AM';
const dataFechaAcualizado = '10/22/2023' + ' 8:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'51', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'52', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 10, MVar:'0', Cost:18.50, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'69', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'128', Cost:16.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'77', Cost:11.34, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 19,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:21.26, ParentId: '21'},
