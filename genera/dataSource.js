const timestamp_saved = '09/07/2023 06:10 AM';
const dataFechaAcualizado = '9/7/2023' + ' 2:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'31', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'46', Cost:10.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 111, MVar:'0', Cost:7.06, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:24.70, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'65', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 168,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 168, MVar:'135', Cost:19.54, ParentId: '16'},
		]
	},
