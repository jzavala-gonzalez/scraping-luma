const timestamp_saved = '10/29/2023 11:10 PM';
const dataFechaAcualizado = '10/29/2023' + ' 7:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'52', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'72', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:18.56, ParentId: '11'},
