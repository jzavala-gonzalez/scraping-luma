const timestamp_saved = '10/31/2023 04:15 AM';
const dataFechaAcualizado = '10/31/2023' + ' 12:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'53', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'57', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'61', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.60, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'151', Cost:17.96, ParentId: '16'},
		]
	},
