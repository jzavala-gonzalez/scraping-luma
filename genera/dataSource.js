const timestamp_saved = '11/04/2023 09:55 AM';
const dataFechaAcualizado = '11/4/2023' + ' 5:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:11.19, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'48', Cost:9.76, ParentId: '17'},
		]
	},
