const timestamp_saved = '11/23/2023 02:45 AM';
const dataFechaAcualizado = '11/22/2023' + ' 10:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'36', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'46', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'58', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:17.01, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'17', Cost:9.20, ParentId: '17'},
		]
	},
