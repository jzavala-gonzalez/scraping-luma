const timestamp_saved = '11/05/2023 10:05 PM';
const dataFechaAcualizado = '11/5/2023' + ' 6:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'54', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'53', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'48', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'0', Cost:24.32, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'5', Cost:31.01, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:31.22, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'83', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 253,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 253, MVar:'137', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'78', Cost:9.19, ParentId: '17'},
		]
	},
