const timestamp_saved = '08/01/2023 12:45 AM';
const dataFechaAcualizado = '7/31/2023' + ' 8:40:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'50', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'11', Cost:22.31, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:19.29, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'90', Cost:16.61, ParentId: '15'},
