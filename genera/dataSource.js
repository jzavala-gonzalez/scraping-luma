const timestamp_saved = '08/18/2023 10:20 AM';
const dataFechaAcualizado = '8/18/2023' + ' 6:17:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'58', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'69', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:29.96, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:18.92, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'73', Cost:9.25, ParentId: '17'},
		]
	},
