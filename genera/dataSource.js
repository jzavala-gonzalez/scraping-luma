const timestamp_saved = '11/22/2023 10:05 AM';
const dataFechaAcualizado = '11/22/2023' + ' 6:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'29', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'36', Cost:10.52, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'76', Cost:9.78, ParentId: '17'},
		]
	},
