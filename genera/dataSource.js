const timestamp_saved = '10/19/2023 03:10 PM';
const dataFechaAcualizado = '10/19/2023' + ' 11:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'40', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'51', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'109', Cost:10.57, ParentId: '17'},
		]
	},
