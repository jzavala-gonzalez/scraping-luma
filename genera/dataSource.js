const timestamp_saved = '08/28/2023 09:50 AM';
const dataFechaAcualizado = '8/28/2023' + ' 5:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'39', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'39', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'45', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:21.94, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'70', Cost:17.07, ParentId: '15'},
