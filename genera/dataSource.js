const timestamp_saved = '10/20/2023 01:20 AM';
const dataFechaAcualizado = '10/19/2023' + ' 9:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'49', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'71', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'112', Cost:10.53, ParentId: '17'},
		]
	},
