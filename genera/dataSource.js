const timestamp_saved = '10/28/2023 05:50 AM';
const dataFechaAcualizado = '10/28/2023' + ' 1:46:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2544},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'41', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'42', Cost:10.56, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'3', Cost:24.70, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 50, MVar:'17', Cost:32.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:32.45, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'13', Cost:23.82, ParentId: '14'},
