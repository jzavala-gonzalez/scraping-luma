const timestamp_saved = '11/20/2023 08:40 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'43', Cost:8.28, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'89', Cost:9.16, ParentId: '17'},
		]
	},
