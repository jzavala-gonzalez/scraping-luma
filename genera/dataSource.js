const timestamp_saved = '10/29/2023 09:25 AM';
const dataFechaAcualizado = '10/29/2023' + ' 5:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'44', Cost:10.18, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 139,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 139, MVar:'64', Cost:17.34, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'112', Cost:17.69, ParentId: '16'},
		]
	},
