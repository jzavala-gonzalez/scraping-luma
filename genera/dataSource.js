const timestamp_saved = '11/18/2023 05:20 PM';
const dataFechaAcualizado = '11/18/2023' + ' 1:16:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2278},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'52', Cost:14.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'61', Cost:14.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:14.64, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 91,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'35', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:30.77, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'11', Cost:31.11, ParentId: '13'},
