const timestamp_saved = '11/10/2023 04:50 AM';
const dataFechaAcualizado = '11/10/2023' + ' 12:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'41', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'38', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'39', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.55, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 105,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 105, MVar:'68', Cost:17.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'115', Cost:18.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'61', Cost:9.81, ParentId: '17'},
		]
	},
