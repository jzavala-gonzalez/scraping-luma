const timestamp_saved = '11/12/2023 11:35 PM';
const dataFechaAcualizado = '11/12/2023' + ' 7:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'58', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'62', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'17', Cost:28.00, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'74', Cost:16.78, ParentId: '15'},
