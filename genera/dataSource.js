const timestamp_saved = '09/07/2023 07:40 AM';
const dataFechaAcualizado = '9/7/2023' + ' 3:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'49', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'25', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'43', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 188,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 188, MVar:'81', Cost:10.55, ParentId: '17'},
		]
	},
