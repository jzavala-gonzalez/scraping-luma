const timestamp_saved = '10/09/2023 06:20 AM';
const dataFechaAcualizado = '10/9/2023' + ' 2:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'137', Cost:17.15, ParentId: '16'},
		]
	},
