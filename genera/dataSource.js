const timestamp_saved = '10/16/2023 11:21 PM';
const dataFechaAcualizado = '10/16/2023' + ' 7:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'78', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'80', Cost:9.79, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 114,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'5', Cost:22.44, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:16.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:16.43, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'48', Cost:8.15, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:34.76, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'9', Cost:31.53, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'93', Cost:16.42, ParentId: '15'},
