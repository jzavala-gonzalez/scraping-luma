const timestamp_saved = '10/28/2023 05:15 AM';
const dataFechaAcualizado = '10/28/2023' + ' 1:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'41', Cost:11.21, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 126,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:24.90, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 40, MVar:'12', Cost:36.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:36.65, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'13', Cost:23.74, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'18', Cost:19.01, ParentId: '14'},
