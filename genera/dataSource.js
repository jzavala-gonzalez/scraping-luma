const timestamp_saved = '10/22/2023 04:40 PM';
const dataFechaAcualizado = '10/22/2023' + ' 12:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'47', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'48', Cost:10.40, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'18', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'138', Cost:18.21, ParentId: '16'},
		]
	},
