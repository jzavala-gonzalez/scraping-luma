const timestamp_saved = '11/24/2023 04:00 AM';
const dataFechaAcualizado = '11/23/2023' + ' 11:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'27', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'38', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'53', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'87', Cost:9.18, ParentId: '17'},
		]
	},
