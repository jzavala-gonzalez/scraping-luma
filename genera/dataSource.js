const timestamp_saved = '12/06/2023 03:15 AM';
const dataFechaAcualizado = '12/5/2023' + ' 11:10:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 812},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 123, MVar:'58', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'77', Cost:10.88, ParentId: '17'},
		]
	},
