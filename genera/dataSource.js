const timestamp_saved = '11/22/2023 05:50 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'32', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'67', Cost:9.60, ParentId: '17'},
		]
	},
