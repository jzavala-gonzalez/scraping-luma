const timestamp_saved = '10/07/2023 01:25 PM';
const dataFechaAcualizado = '10/7/2023' + ' 9:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 110, MVar:'47', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'43', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'44', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'49', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:17.42, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.51, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'142', Cost:17.36, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 80,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 29, MVar:'15', Cost:19.60, ParentId: '19'},
