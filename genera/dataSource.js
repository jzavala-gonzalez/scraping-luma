const timestamp_saved = '11/10/2023 07:35 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'51', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'42', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 258,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'38', Cost:17.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.66, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'54', Cost:9.84, ParentId: '17'},
		]
	},
