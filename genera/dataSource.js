const timestamp_saved = '10/09/2023 04:15 AM';
const dataFechaAcualizado = '10/9/2023' + ' 12:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'47', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:17.45, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'151', Cost:16.63, ParentId: '16'},
		]
	},
