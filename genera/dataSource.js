const timestamp_saved = '11/22/2023 11:40 PM';
const dataFechaAcualizado = '11/22/2023' + ' 7:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'41', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'51', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'62', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'109', Cost:9.23, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:26.54, ParentId: '21'},
