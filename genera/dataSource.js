const timestamp_saved = '10/23/2023 08:05 AM';
const dataFechaAcualizado = '10/23/2023' + ' 4:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'35', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'36', Cost:12.97, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'50', Cost:17.41, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'60', Cost:16.79, ParentId: '15'},
