const timestamp_saved = '11/24/2023 02:30 PM';
const dataFechaAcualizado = '11/24/2023' + ' 10:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'24', Cost:12.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'34', Cost:12.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'50', Cost:12.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 207,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:17.56, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'72', Cost:9.71, ParentId: '17'},
		]
	},
