const timestamp_saved = '09/29/2023 12:10 PM';
const dataFechaAcualizado = '9/29/2023' + ' 8:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'56', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'33', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'32', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'48', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:18.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'0', Cost:20.79, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:20.79, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'12', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'86', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'122', Cost:17.84, ParentId: '16'},
		]
	},
