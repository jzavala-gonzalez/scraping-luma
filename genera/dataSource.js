const timestamp_saved = '09/23/2023 01:55 PM';
const dataFechaAcualizado = '9/23/2023' + ' 9:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'45', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'46', Cost:10.18, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'45', Cost:10.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:10.06, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.33, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'61', Cost:19.54, ParentId: '15'},
