const timestamp_saved = '11/24/2023 01:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 9:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'34', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'43', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'55', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'98', Cost:9.20, ParentId: '17'},
		]
	},
