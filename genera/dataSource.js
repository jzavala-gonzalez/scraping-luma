const timestamp_saved = '10/28/2023 05:05 PM';
const dataFechaAcualizado = '10/28/2023' + ' 1:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'46', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'49', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'18', Cost:21.41, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'128', Cost:17.24, ParentId: '16'},
		]
	},
