const timestamp_saved = '12/04/2023 06:15 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'38', Cost:12.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'38', Cost:12.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'44', Cost:12.25, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'44', Cost:11.62, ParentId: '17'},
		]
	},
