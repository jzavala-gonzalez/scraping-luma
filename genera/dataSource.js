const timestamp_saved = '08/09/2023 05:45 AM';
const dataFechaAcualizado = '8/9/2023' + ' 1:40:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'40', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'47', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.98, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'106', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 229, MVar:'66', Cost:13.12, ParentId: '17'},
		]
	},
