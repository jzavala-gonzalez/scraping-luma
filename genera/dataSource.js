const timestamp_saved = '11/04/2023 01:00 PM';
const dataFechaAcualizado = '11/4/2023' + ' 8:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'44', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'44', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'42', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'56', Cost:9.75, ParentId: '17'},
		]
	},
