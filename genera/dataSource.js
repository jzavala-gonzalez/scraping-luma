const timestamp_saved = '10/14/2023 09:40 AM';
const dataFechaAcualizado = '10/14/2023' + ' 5:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'46', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'50', Cost:11.41, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:18.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:18.68, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'65', Cost:9.27, ParentId: '17'},
		]
	},
