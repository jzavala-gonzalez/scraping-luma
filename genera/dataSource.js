const timestamp_saved = '10/22/2023 12:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'39', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'40', Cost:12.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'45', Cost:12.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.97, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'13', Cost:19.07, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'55', Cost:11.24, ParentId: '17'},
		]
	},
