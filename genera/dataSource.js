const timestamp_saved = '10/15/2023 08:30 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'49', Cost:12.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'53', Cost:12.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'61', Cost:9.15, ParentId: '17'},
		]
	},
