const timestamp_saved = '08/17/2023 05:55 AM';
const dataFechaAcualizado = '8/17/2023' + ' 1:52:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'59', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'69', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.14, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'74', Cost:9.36, ParentId: '17'},
		]
	},
