const timestamp_saved = '08/13/2023 06:55 PM';
const dataFechaAcualizado = '8/13/2023' + ' 2:52:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'34', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'38', Cost:10.91, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:34.55, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'108', Cost:12.31, ParentId: '17'},
		]
	},
