const timestamp_saved = '10/28/2023 12:15 AM';
const dataFechaAcualizado = '10/27/2023' + ' 8:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'47', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'49', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.40, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'82', Cost:17.07, ParentId: '15'},
