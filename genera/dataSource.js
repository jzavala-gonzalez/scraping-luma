const timestamp_saved = '09/24/2023 06:10 AM';
const dataFechaAcualizado = '9/24/2023' + ' 2:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'41', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'44', Cost:12.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'0', Cost:8.43, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'83', Cost:9.21, ParentId: '17'},
		]
	},
