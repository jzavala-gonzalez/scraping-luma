const timestamp_saved = '12/03/2023 03:30 AM';
const dataFechaAcualizado = '12/2/2023' + ' 11:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'47', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'51', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'77', Cost:11.03, ParentId: '17'},
		]
	},
