const timestamp_saved = '09/05/2023 02:50 PM';
const dataFechaAcualizado = '9/5/2023' + ' 10:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'58', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:8.23, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'82', Cost:17.66, ParentId: '15'},
