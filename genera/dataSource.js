const timestamp_saved = '10/26/2023 10:25 PM';
const dataFechaAcualizado = '10/26/2023' + ' 6:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'53', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'54', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'54', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:41.01, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:17.29, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.18, ParentId: '11'},
		]
	},
