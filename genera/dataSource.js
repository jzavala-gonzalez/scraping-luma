const timestamp_saved = '11/12/2023 06:01 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'45', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'46', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:12.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.89, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'11', Cost:22.31, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'87', Cost:9.68, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 96,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 36, MVar:'16', Cost:19.60, ParentId: '19'},
