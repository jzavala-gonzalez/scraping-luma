const timestamp_saved = '10/01/2023 02:20 PM';
const dataFechaAcualizado = '10/1/2023' + ' 10:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'28', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'26', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'43', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:19.64, ParentId: '14'},
