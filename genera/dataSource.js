const timestamp_saved = '10/12/2023 04:55 PM';
const dataFechaAcualizado = '10/12/2023' + ' 12:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'58', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'63', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'67', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'186', Cost:17.34, ParentId: '16'},
		]
	},
