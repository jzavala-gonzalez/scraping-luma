const timestamp_saved = '10/30/2023 10:20 AM';
const dataFechaAcualizado = '10/30/2023' + ' 6:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'47', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'44', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'16', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 113, MVar:'68', Cost:18.13, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 224,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 224, MVar:'113', Cost:18.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'58', Cost:9.70, ParentId: '17'},
		]
	},
