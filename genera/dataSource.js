const timestamp_saved = '10/08/2023 06:35 AM';
const dataFechaAcualizado = '10/8/2023' + ' 2:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'37', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'39', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'39', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 128, MVar:'38', Cost:17.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.00, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.28, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'78', Cost:16.70, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 360, MVar:'147', Cost:16.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 148,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 148, MVar:'72', Cost:11.77, ParentId: '17'},
		]
	},
