const timestamp_saved = '11/22/2023 05:40 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'23', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'31', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'47', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'68', Cost:9.60, ParentId: '17'},
		]
	},
