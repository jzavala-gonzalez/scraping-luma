const timestamp_saved = '10/13/2023 12:45 PM';
const dataFechaAcualizado = '10/13/2023' + ' 8:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'61', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'66', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'71', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:17.38, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'69', Cost:16.88, ParentId: '15'},
