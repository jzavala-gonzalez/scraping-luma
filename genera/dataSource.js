const timestamp_saved = '09/27/2023 05:40 PM';
const dataFechaAcualizado = '9/27/2023' + ' 1:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'33', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'33', Cost:11.04, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:18.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:18.31, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 94, MVar:'0', Cost:18.18, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'91', Cost:16.99, ParentId: '15'},
