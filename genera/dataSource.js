const timestamp_saved = '09/28/2023 01:50 AM';
const dataFechaAcualizado = '9/27/2023' + ' 9:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'34', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'35', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'65', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'118', Cost:9.15, ParentId: '17'},
		]
	},
