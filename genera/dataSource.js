const timestamp_saved = '11/01/2023 04:40 AM';
const dataFechaAcualizado = '11/1/2023' + ' 12:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.40, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'55', Cost:16.82, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'69', Cost:9.17, ParentId: '17'},
		]
	},
