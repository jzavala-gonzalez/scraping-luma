const timestamp_saved = '08/31/2023 06:25 PM';
const dataFechaAcualizado = '8/31/2023' + ' 2:20:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'55', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'64', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'69', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:18.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:18.90, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'0', Cost:17.35, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'40', Cost:19.34, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'104', Cost:9.32, ParentId: '17'},
		]
	},
