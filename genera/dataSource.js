const timestamp_saved = '10/17/2023 01:35 AM';
const dataFechaAcualizado = '10/16/2023' + ' 9:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'75', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'77', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'77', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:16.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:16.46, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'12', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'88', Cost:16.44, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'98', Cost:9.12, ParentId: '17'},
		]
	},
