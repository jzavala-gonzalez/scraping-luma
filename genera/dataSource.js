const timestamp_saved = '11/28/2023 01:20 PM';
const dataFechaAcualizado = '11/28/2023' + ' 9:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'33', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'42', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'95', Cost:9.46, ParentId: '17'},
		]
	},
