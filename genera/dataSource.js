const timestamp_saved = '10/11/2023 11:45 AM';
const dataFechaAcualizado = '10/11/2023' + ' 7:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'46', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'51', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'60', Cost:12.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:26.19, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 351,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:18.00, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'145', Cost:18.25, ParentId: '16'},
		]
	},
