const timestamp_saved = '11/05/2023 03:10 AM';
const dataFechaAcualizado = '11/4/2023' + ' 11:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'51', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 248,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 93, MVar:'30', Cost:18.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.88, ParentId: '11'},
