const timestamp_saved = '11/24/2023 01:45 PM';
const dataFechaAcualizado = '11/24/2023' + ' 9:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'24', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'34', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'70', Cost:9.93, ParentId: '17'},
		]
	},
