const timestamp_saved = '10/06/2023 03:45 AM';
const dataFechaAcualizado = '10/5/2023' + ' 11:41:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'42', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'40', Cost:10.57, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:29.90, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'98', Cost:9.69, ParentId: '17'},
		]
	},
