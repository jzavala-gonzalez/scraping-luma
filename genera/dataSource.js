const timestamp_saved = '10/26/2023 11:10 AM';
const dataFechaAcualizado = '10/26/2023' + ' 7:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'42', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'43', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'46', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 79, MVar:'78', Cost:19.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'128', Cost:18.27, ParentId: '16'},
		]
	},
