const timestamp_saved = '11/12/2023 11:00 AM';
const dataFechaAcualizado = '11/12/2023' + ' 6:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'40', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'43', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'38', Cost:17.78, ParentId: '11'},
