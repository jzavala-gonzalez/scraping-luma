const timestamp_saved = '11/16/2023 10:10 AM';
const dataFechaAcualizado = '11/16/2023' + ' 6:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'47', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 186, MVar:'67', Cost:10.77, ParentId: '17'},
		]
	},
