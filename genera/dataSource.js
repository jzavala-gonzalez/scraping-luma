const timestamp_saved = '11/07/2023 07:45 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'37', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'36', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'37', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:16.95, ParentId: '11'},
