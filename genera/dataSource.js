const timestamp_saved = '09/03/2023 05:40 PM';
const dataFechaAcualizado = '9/3/2023' + ' 1:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'34', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'38', Cost:11.31, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'61', Cost:9.53, ParentId: '17'},
		]
	},
