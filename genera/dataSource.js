const timestamp_saved = '09/13/2023 09:15 PM';
const dataFechaAcualizado = '9/13/2023' + ' 5:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'86', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 526,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'64', Cost:9.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'64', Cost:9.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 188, MVar:'74', Cost:9.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.87, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 149, MVar:'76', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'19', Cost:28.33, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'21', Cost:28.26, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:8.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:8.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:33.49, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'8', Cost:30.45, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'34', Cost:18.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 177,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 177, MVar:'87', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'177', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'118', Cost:9.12, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 33,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 16, MVar:'28', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 9, MVar:'16', Cost:17, ParentId: '19'},
		]
	},
