const timestamp_saved = '08/02/2023 05:50 PM';
const dataFechaAcualizado = '8/2/2023' + ' 1:45:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 865},
	{Index:'5', Desc:'Capacidad Disponible', value: 3507},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'50', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'51', Cost:10.06, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 6,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 6, MVar:'0', Cost:16.80, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 275,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'112', Cost:16.98, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 122, MVar:'27', Cost:16.27, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 344, MVar:'168', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'101', Cost:11.01, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 84,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 16, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
