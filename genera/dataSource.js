const timestamp_saved = '09/15/2023 12:25 PM';
const dataFechaAcualizado = '9/15/2023' + ' 8:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'22', Cost:18.98, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'82', Cost:16.44, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 46,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 16, MVar:'13', Cost:19.60, ParentId: '19'},
