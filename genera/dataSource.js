const timestamp_saved = '08/13/2023 11:25 AM';
const dataFechaAcualizado = '8/13/2023' + ' 7:22:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'37', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'39', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'41', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.03, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:26.22, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.67, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'141', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'109', Cost:12.26, ParentId: '17'},
		]
	},
