const timestamp_saved = '10/09/2023 07:25 AM';
const dataFechaAcualizado = '10/9/2023' + ' 3:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'43', Cost:11.07, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 10, MVar:'0', Cost:28.57, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'132', Cost:17.82, ParentId: '16'},
		]
	},
