const timestamp_saved = '11/16/2023 05:55 AM';
const dataFechaAcualizado = '11/16/2023' + ' 1:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'45', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'45', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'68', Cost:18.47, ParentId: '15'},
