const timestamp_saved = '08/20/2023 03:00 PM';
const dataFechaAcualizado = '8/20/2023' + ' 10:57:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'53', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'6', Cost:32.00, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'65', Cost:9.40, ParentId: '17'},
		]
	},
