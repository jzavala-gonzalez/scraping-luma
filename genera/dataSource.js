const timestamp_saved = '11/22/2023 12:55 PM';
const dataFechaAcualizado = '11/22/2023' + ' 8:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'37', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'45', Cost:10.43, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'93', Cost:9.78, ParentId: '17'},
		]
	},
