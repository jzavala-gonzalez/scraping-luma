const timestamp_saved = '10/08/2023 02:50 PM';
const dataFechaAcualizado = '10/8/2023' + ' 10:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'40', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'42', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'40', Cost:11.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.68, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'80', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'153', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'76', Cost:11.40, ParentId: '17'},
		]
	},
