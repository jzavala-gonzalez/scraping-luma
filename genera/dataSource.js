const timestamp_saved = '10/28/2023 01:35 PM';
const dataFechaAcualizado = '10/28/2023' + ' 9:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'96', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'41', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'47', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'48', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 125,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 35, MVar:'10', Cost:39.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:39.18, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'10', Cost:22.39, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'134', Cost:17.30, ParentId: '16'},
		]
	},
