const timestamp_saved = '10/19/2023 03:25 PM';
const dataFechaAcualizado = '10/19/2023' + ' 11:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'40', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'47', Cost:11.08, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'21', Cost:19.34, ParentId: '14'},
