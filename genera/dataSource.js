const timestamp_saved = '10/16/2023 08:20 AM';
const dataFechaAcualizado = '10/16/2023' + ' 4:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'46', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'46', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'49', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.29, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.54, ParentId: '13'},
