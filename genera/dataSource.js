const timestamp_saved = '10/16/2023 12:20 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'61', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'58', Cost:10.14, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'12', Cost:19.04, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'165', Cost:18.24, ParentId: '16'},
		]
	},
