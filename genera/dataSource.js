const timestamp_saved = '08/30/2023 07:10 AM';
const dataFechaAcualizado = '8/30/2023' + ' 3:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'45', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'46', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'57', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'63', Cost:16.81, ParentId: '15'},
