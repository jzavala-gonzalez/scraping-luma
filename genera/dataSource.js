const timestamp_saved = '11/16/2023 12:50 PM';
const dataFechaAcualizado = '11/16/2023' + ' 8:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'52', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'50', Cost:10.65, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 111, MVar:'34', Cost:0, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 185,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 185, MVar:'74', Cost:10.83, ParentId: '17'},
		]
	},
