const timestamp_saved = '10/02/2023 10:20 PM';
const dataFechaAcualizado = '10/2/2023' + ' 6:15:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2940},
];
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'101', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'47', Cost:9.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'60', Cost:9.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 187,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'10', Cost:22.74, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 270,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'20', Cost:28.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.29, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'0', Cost:17.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'10', Cost:17.10, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'9', Cost:32.09, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 95,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'10', Cost:30.26, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'15', Cost:18.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'100', Cost:16.39, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 359, MVar:'125', Cost:9.17, ParentId: '17'},
		]
	},
