const timestamp_saved = '10/22/2023 03:55 AM';
const dataFechaAcualizado = '10/21/2023' + ' 11:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'45', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'46', Cost:11.71, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'145', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'69', Cost:11.12, ParentId: '17'},
		]
	},
