const timestamp_saved = '10/07/2023 07:15 AM';
const dataFechaAcualizado = '10/7/2023' + ' 3:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 34, MVar:'34', Cost:4.49, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.49, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'44', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'50', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'60', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'150', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'95', Cost:9.28, ParentId: '17'},
		]
	},
