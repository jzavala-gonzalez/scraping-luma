const timestamp_saved = '09/27/2023 09:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 5:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'29', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'29', Cost:11.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.90, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'76', Cost:9.13, ParentId: '17'},
		]
	},
