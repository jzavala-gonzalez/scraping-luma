const timestamp_saved = '08/11/2023 10:30 AM';
const dataFechaAcualizado = '8/11/2023' + ' 6:25:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'36', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'45', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'39', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.28, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'134', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'66', Cost:11.90, ParentId: '17'},
		]
	},
