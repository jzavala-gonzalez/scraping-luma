const timestamp_saved = '09/27/2023 11:45 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'28', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'28', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'58', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'76', Cost:9.40, ParentId: '17'},
		]
	},
