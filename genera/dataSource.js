const timestamp_saved = '10/08/2023 04:40 PM';
const dataFechaAcualizado = '10/8/2023' + ' 12:36:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'43', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'42', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'41', Cost:10.65, ParentId: '7'},
		]
	},
