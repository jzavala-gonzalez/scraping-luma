const timestamp_saved = '10/17/2023 02:46 PM';
const dataFechaAcualizado = '10/17/2023' + ' 10:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'62', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'61', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'60', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'86', Cost:16.70, ParentId: '15'},
