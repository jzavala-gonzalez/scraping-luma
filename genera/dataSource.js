const timestamp_saved = '09/18/2023 03:30 AM';
const dataFechaAcualizado = '9/17/2023' + ' 11:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'81', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'50', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'48', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'61', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:19.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.88, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 92, MVar:'0', Cost:8.40, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:8.40, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'1', Cost:30.69, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'17', Cost:19.01, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'154', Cost:16.92, ParentId: '16'},
		]
	},
