const timestamp_saved = '11/22/2023 05:05 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'22', Cost:12.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'32', Cost:12.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.13, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 51, MVar:'56', Cost:24.01, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'72', Cost:9.33, ParentId: '17'},
		]
	},
