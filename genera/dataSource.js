const timestamp_saved = '08/04/2023 11:15 AM';
const dataFechaAcualizado = '8/4/2023' + ' 7:10:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'72', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'39', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 154, MVar:'40', Cost:15.59, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'134', Cost:18.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'84', Cost:10.95, ParentId: '17'},
		]
	},
