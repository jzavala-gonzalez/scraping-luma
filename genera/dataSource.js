const timestamp_saved = '08/25/2023 07:55 AM';
const dataFechaAcualizado = '8/25/2023' + ' 3:50:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'56', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'54', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'94', Cost:9.28, ParentId: '17'},
		]
	},
