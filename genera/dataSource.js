const timestamp_saved = '10/08/2023 10:00 AM';
const dataFechaAcualizado = '10/8/2023' + ' 5:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'35', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'34', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'36', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'118', Cost:18.31, ParentId: '16'},
		]
	},
