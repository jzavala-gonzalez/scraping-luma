const timestamp_saved = '11/01/2023 05:40 PM';
const dataFechaAcualizado = '11/1/2023' + ' 1:36:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2358},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'60', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'65', Cost:10.67, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'86', Cost:9.36, ParentId: '17'},
		]
	},
