const timestamp_saved = '11/23/2023 09:00 PM';
const dataFechaAcualizado = '11/23/2023' + ' 4:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'28', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'38', Cost:10.43, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.55, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 72, MVar:'7', Cost:19.63, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'143', Cost:18.32, ParentId: '16'},
		]
	},
