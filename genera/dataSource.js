const timestamp_saved = '10/26/2023 04:56 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'48', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'50', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 167, MVar:'53', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'146', Cost:18.26, ParentId: '16'},
		]
	},
