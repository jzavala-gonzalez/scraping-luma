const timestamp_saved = '08/20/2023 05:05 AM';
const dataFechaAcualizado = '8/20/2023' + ' 1:02:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'56', Cost:10.83, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'143', Cost:16.99, ParentId: '16'},
		]
	},
