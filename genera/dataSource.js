const timestamp_saved = '10/12/2023 03:40 PM';
const dataFechaAcualizado = '10/12/2023' + ' 11:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'57', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'62', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'66', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'175', Cost:17.34, ParentId: '16'},
		]
	},
