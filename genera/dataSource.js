const timestamp_saved = '11/23/2023 07:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'23', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'33', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'49', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'54', Cost:9.84, ParentId: '17'},
		]
	},
