const timestamp_saved = '10/16/2023 12:45 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'61', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'58', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'58', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:18.98, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'167', Cost:17.86, ParentId: '16'},
		]
	},
