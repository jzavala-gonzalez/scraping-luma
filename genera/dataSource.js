const timestamp_saved = '12/05/2023 07:00 AM';
const dataFechaAcualizado = '12/5/2023' + ' 2:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'39', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'41', Cost:13.17, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.64, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'102', Cost:18.26, ParentId: '16'},
		]
	},
