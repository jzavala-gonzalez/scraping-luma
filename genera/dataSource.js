const timestamp_saved = '08/01/2023 05:55 AM';
const dataFechaAcualizado = '8/1/2023' + ' 1:50:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'45', Cost:10.78, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 102, MVar:'0', Cost:17.35, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:17.35, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'91', Cost:10.98, ParentId: '17'},
		]
	},
