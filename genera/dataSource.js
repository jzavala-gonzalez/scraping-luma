const timestamp_saved = '11/14/2023 04:30 AM';
const dataFechaAcualizado = '11/14/2023' + ' 12:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'53', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'56', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'12', Cost:30.88, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'63', Cost:16.88, ParentId: '15'},
