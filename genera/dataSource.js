const timestamp_saved = '11/21/2023 10:20 PM';
const dataFechaAcualizado = '11/21/2023' + ' 6:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'42', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'52', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'60', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 8,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 8, MVar:'7', Cost:0, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'0', Cost:19.77, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'169', Cost:17.54, ParentId: '16'},
		]
	},
