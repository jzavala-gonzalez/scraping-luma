const timestamp_saved = '10/22/2023 08:30 AM';
const dataFechaAcualizado = '10/22/2023' + ' 4:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'39', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.62, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 16,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 16, MVar:'0', Cost:26.44, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:18.20, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'67', Cost:16.83, ParentId: '15'},
