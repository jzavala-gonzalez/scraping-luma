const timestamp_saved = '09/16/2023 02:55 PM';
const dataFechaAcualizado = '9/16/2023' + ' 10:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'40', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'39', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'57', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'46', Cost:19.83, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.52, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 213,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'100', Cost:18.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'80', Cost:9.46, ParentId: '17'},
		]
	},
