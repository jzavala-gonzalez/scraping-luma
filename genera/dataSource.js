const timestamp_saved = '11/12/2023 04:55 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'42', Cost:13.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'43', Cost:13.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'52', Cost:13.06, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 14,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'0', Cost:26.59, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'9', Cost:19.26, ParentId: '14'},
