const timestamp_saved = '11/26/2023 05:50 PM';
const dataFechaAcualizado = '11/26/2023' + ' 1:46:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1903},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'23', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'35', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.97, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'134', Cost:19.72, ParentId: '16'},
		]
	},
