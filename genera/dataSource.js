const timestamp_saved = '07/31/2023 12:30 PM';
const dataFechaAcualizado = '7/31/2023' + ' 8:25:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'44', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'49', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:19.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:19.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:17.15, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'8', Cost:17.15, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 166, MVar:'51', Cost:15.47, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'90', Cost:11.15, ParentId: '17'},
		]
	},
