const timestamp_saved = '10/04/2023 04:15 PM';
const dataFechaAcualizado = '10/4/2023' + ' 12:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'42', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'41', Cost:11.37, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'60', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'170', Cost:17.65, ParentId: '16'},
		]
	},
