const timestamp_saved = '09/22/2023 09:10 AM';
const dataFechaAcualizado = '9/22/2023' + ' 5:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'35', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'39', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'59', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'61', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'74', Cost:32.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'80', Cost:17.17, ParentId: '17'},
		]
	},
