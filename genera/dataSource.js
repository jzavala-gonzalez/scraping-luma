const timestamp_saved = '09/17/2023 09:15 PM';
const dataFechaAcualizado = '9/17/2023' + ' 5:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'71', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'46', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'47', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 144,
		units:[
			...
			{Index:'5', Unit:'Yabucoa', MW: 16, MVar:'0', Cost:354.82, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'29', Cost:18.80, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'125', Cost:17.12, ParentId: '16'},
		]
	},
