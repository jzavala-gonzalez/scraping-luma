const timestamp_saved = '09/08/2023 03:30 PM';
const dataFechaAcualizado = '9/8/2023' + ' 11:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'59', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'64', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'58', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'32', Cost:19.22, ParentId: '14'},
