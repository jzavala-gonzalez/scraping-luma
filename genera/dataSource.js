const timestamp_saved = '11/20/2023 09:15 AM';
const dataFechaAcualizado = '11/20/2023' + ' 5:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'30', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'41', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'53', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'93', Cost:9.16, ParentId: '17'},
		]
	},
