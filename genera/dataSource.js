const timestamp_saved = '09/11/2023 08:10 PM';
const dataFechaAcualizado = '9/11/2023' + ' 4:05:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 544,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'76', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'74', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 201, MVar:'81', Cost:9.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'16', Cost:28.20, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'15', Cost:28.17, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:19.89, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 98,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'7', Cost:28.53, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'84', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'166', Cost:16.62, ParentId: '16'},
		]
	},
