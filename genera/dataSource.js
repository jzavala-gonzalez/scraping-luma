const timestamp_saved = '08/23/2023 01:25 AM';
const dataFechaAcualizado = '8/22/2023' + ' 9:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 172, MVar:'65', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'48', Cost:11.09, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'2', Cost:20.68, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:32.18, ParentId: '12'},
