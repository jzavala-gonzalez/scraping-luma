const timestamp_saved = '10/16/2023 05:00 AM';
const dataFechaAcualizado = '10/16/2023' + ' 12:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'49', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'54', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.54, ParentId: '14'},
