const timestamp_saved = '08/10/2023 02:50 PM';
const dataFechaAcualizado = '8/10/2023' + ' 10:45:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'96', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'58', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.32, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:9.04, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'86', Cost:11.54, ParentId: '17'},
		]
	},
