const timestamp_saved = '11/27/2023 05:30 AM';
const dataFechaAcualizado = '11/27/2023' + ' 1:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'25', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'35', Cost:10.35, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'69', Cost:9.84, ParentId: '17'},
		]
	},
