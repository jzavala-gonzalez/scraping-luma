const timestamp_saved = '08/13/2023 01:55 PM';
const dataFechaAcualizado = '8/13/2023' + ' 9:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'41', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'46', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'43', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'120', Cost:12.26, ParentId: '17'},
		]
	},
