const timestamp_saved = '08/02/2023 10:20 AM';
const dataFechaAcualizado = '8/2/2023' + ' 6:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'48', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'43', Cost:10.78, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'80', Cost:17.38, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'37', Cost:15.65, ParentId: '15'},
		]
	},
