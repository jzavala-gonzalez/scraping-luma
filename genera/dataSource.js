const timestamp_saved = '10/21/2023 04:30 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'25', Cost:12.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'23', Cost:12.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'60', Cost:12.94, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'80', Cost:11.03, ParentId: '17'},
		]
	},
