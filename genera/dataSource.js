const timestamp_saved = '08/27/2023 07:50 PM';
const dataFechaAcualizado = '8/27/2023' + ' 3:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'40', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'39', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'50', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 7,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 7, MVar:'8', Cost:101.19, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'11', Cost:31.49, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'42', Cost:20.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'93', Cost:11.86, ParentId: '17'},
		]
	},
