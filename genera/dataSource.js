const timestamp_saved = '08/12/2023 09:35 PM';
const dataFechaAcualizado = '8/12/2023' + ' 5:32:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'46', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'44', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'0', Cost:28.42, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'29', Cost:19.70, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'161', Cost:17.45, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'117', Cost:11.64, ParentId: '17'},
		]
	},
