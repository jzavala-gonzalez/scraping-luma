const timestamp_saved = '10/02/2023 11:45 AM';
const dataFechaAcualizado = '10/2/2023' + ' 7:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'35', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'104', Cost:9.12, ParentId: '17'},
		]
	},
