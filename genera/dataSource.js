const timestamp_saved = '08/01/2023 10:25 AM';
const dataFechaAcualizado = '8/1/2023' + ' 6:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'43', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'90', Cost:11.00, ParentId: '17'},
		]
	},
