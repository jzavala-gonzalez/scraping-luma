const timestamp_saved = '12/02/2023 02:10 PM';
const dataFechaAcualizado = '12/2/2023' + ' 10:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 226,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 226, MVar:'78', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'44', Cost:13.51, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 234,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 234, MVar:'64', Cost:10.03, ParentId: '17'},
		]
	},
