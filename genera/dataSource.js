const timestamp_saved = '11/03/2023 04:10 PM';
const dataFechaAcualizado = '11/3/2023' + ' 12:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'54', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'53', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 104,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 34, MVar:'7', Cost:17, ParentId: '19'},
		]
	},
