const timestamp_saved = '12/06/2023 02:05 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:00:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 897},
	{Index:'7', Desc:'Capacidad Disponible', value: 3006},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'48', Cost:12.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'49', Cost:12.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'58', Cost:12.72, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'11', Cost:18.70, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'69', Cost:14.32, ParentId: '17'},
		]
	},
