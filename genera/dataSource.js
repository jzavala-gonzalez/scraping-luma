const timestamp_saved = '08/03/2023 08:25 AM';
const dataFechaAcualizado = '8/3/2023' + ' 4:20:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:21.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'7', Cost:21.79, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 235,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'51', Cost:17.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'40', Cost:16.87, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'79', Cost:11.41, ParentId: '17'},
		]
	},
