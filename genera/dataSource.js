const timestamp_saved = '12/03/2023 05:15 PM';
const dataFechaAcualizado = '12/3/2023' + ' 1:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'39', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'44', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:17.99, ParentId: '11'},
