const timestamp_saved = '10/12/2023 11:35 PM';
const dataFechaAcualizado = '10/12/2023' + ' 7:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 562,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'78', Cost:9.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'83', Cost:9.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 216, MVar:'82', Cost:9.73, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'29', Cost:28.22, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'10', Cost:29.11, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'14', Cost:28.35, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'96', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'213', Cost:16.65, ParentId: '16'},
		]
	},
