const timestamp_saved = '11/04/2023 10:10 PM';
const dataFechaAcualizado = '11/4/2023' + ' 6:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'50', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'50', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'47', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'92', Cost:16.84, ParentId: '15'},
