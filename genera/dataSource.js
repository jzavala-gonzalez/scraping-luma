const timestamp_saved = '07/30/2023 05:30 PM';
const dataFechaAcualizado = '7/30/2023' + ' 1:25:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1236},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'60', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'43', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'38', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'37', Cost:17.05, ParentId: '15'},
		]
	},
