const timestamp_saved = '11/05/2023 11:05 PM';
const dataFechaAcualizado = '11/5/2023' + ' 7:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'58', Cost:10.13, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'4', Cost:88.90, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'9', Cost:20.11, ParentId: '14'},
