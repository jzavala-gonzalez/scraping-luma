const timestamp_saved = '10/07/2023 03:10 PM';
const dataFechaAcualizado = '10/7/2023' + ' 11:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 152, MVar:'48', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'42', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'43', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'43', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'139', Cost:17.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'89', Cost:9.54, ParentId: '17'},
		]
	},
