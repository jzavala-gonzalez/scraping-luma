const timestamp_saved = '09/26/2023 04:15 AM';
const dataFechaAcualizado = '9/26/2023' + ' 12:10:55 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 628},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'48', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'50', Cost:11.54, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'10', Cost:30.93, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'18', Cost:31.20, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'46', Cost:17.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.81, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 107, MVar:'0', Cost:18.20, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'165', Cost:17.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'67', Cost:10.16, ParentId: '17'},
		]
	},
