const timestamp_saved = '08/29/2023 05:30 PM';
const dataFechaAcualizado = '8/29/2023' + ' 1:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'83', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'62', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'64', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'68', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'0', Cost:18.04, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'12', Cost:18.04, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'34', Cost:19.34, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'113', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 282, MVar:'146', Cost:17.54, ParentId: '16'},
		]
	},
