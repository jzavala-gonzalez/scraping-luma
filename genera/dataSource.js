const timestamp_saved = '09/10/2023 11:55 AM';
const dataFechaAcualizado = '9/10/2023' + ' 7:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'59', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'58', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'60', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'6', Cost:31.14, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:19.71, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'0', Cost:51.45, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'64', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'116', Cost:17.83, ParentId: '16'},
		]
	},
