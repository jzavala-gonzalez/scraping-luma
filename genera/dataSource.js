const timestamp_saved = '11/27/2023 08:00 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:56:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1832},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'18', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'28', Cost:12.60, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'58', Cost:9.85, ParentId: '17'},
		]
	},
