const timestamp_saved = '07/29/2023 05:40 PM';
const dataFechaAcualizado = '7/29/2023' + ' 1:35:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'48', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'104', Cost:17.10, ParentId: '15'},
