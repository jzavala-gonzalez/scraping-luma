const timestamp_saved = '12/01/2023 12:20 AM';
const dataFechaAcualizado = '11/30/2023' + ' 8:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'62', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'65', Cost:10.31, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'163', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'107', Cost:9.14, ParentId: '17'},
		]
	},
