const timestamp_saved = '09/17/2023 02:40 AM';
const dataFechaAcualizado = '9/16/2023' + ' 10:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:21.39, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'93', Cost:16.48, ParentId: '15'},
