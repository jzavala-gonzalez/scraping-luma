const timestamp_saved = '11/30/2023 01:45 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'50', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'52', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'52', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'74', Cost:9.56, ParentId: '17'},
		]
	},
