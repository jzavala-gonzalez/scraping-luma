const timestamp_saved = '11/23/2023 12:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 8:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'38', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'50', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'60', Cost:11.27, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:26.12, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'33', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:8.17, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'111', Cost:9.25, ParentId: '17'},
		]
	},
