const timestamp_saved = '09/17/2023 05:50 PM';
const dataFechaAcualizado = '9/17/2023' + ' 1:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'46', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'45', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'58', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'72', Cost:9.66, ParentId: '17'},
		]
	},
