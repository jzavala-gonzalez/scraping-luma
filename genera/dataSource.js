const timestamp_saved = '09/26/2023 01:40 PM';
const dataFechaAcualizado = '9/26/2023' + ' 9:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'67', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'45', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'46', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'55', Cost:11.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 54,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 63, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'81', Cost:9.11, ParentId: '17'},
		]
	},
