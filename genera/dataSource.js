const timestamp_saved = '10/11/2023 11:45 PM';
const dataFechaAcualizado = '10/11/2023' + ' 7:41:14 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 3045},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'76', Cost:9.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'82', Cost:9.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'81', Cost:9.73, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:35.26, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 195,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'11', Cost:22.53, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'2', Cost:22.23, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'27', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:18.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:18.03, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 84,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 34, MVar:'9', Cost:31.01, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'99', Cost:16.66, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'224', Cost:16.63, ParentId: '16'},
		]
	},
