const timestamp_saved = '08/09/2023 07:20 AM';
const dataFechaAcualizado = '8/9/2023' + ' 3:15:42 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2148},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.10, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:29.57, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.10, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'94', Cost:17.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'63', Cost:12.96, ParentId: '17'},
		]
	},
