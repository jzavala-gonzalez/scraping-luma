const timestamp_saved = '08/13/2023 10:25 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:22:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'36', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'38', Cost:11.29, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'143', Cost:17.07, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'105', Cost:12.26, ParentId: '17'},
		]
	},
