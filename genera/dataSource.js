const timestamp_saved = '10/01/2023 11:05 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'61', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 80, MVar:'53', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'25', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'24', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'43', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:17.72, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'80', Cost:9.50, ParentId: '17'},
		]
	},
