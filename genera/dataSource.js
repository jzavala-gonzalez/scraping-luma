const timestamp_saved = '10/27/2023 10:30 PM';
const dataFechaAcualizado = '10/27/2023' + ' 6:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'48', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'49', Cost:10.64, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 19, MVar:'10', Cost:33.74, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 25, MVar:'10', Cost:38.35, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'1', Cost:12.91, ParentId: '17'},
		]
	},
