const timestamp_saved = '09/28/2023 03:45 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'29', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'29', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'47', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 95, MVar:'29', Cost:18.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.04, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'0', Cost:31.15, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'97', Cost:9.11, ParentId: '17'},
		]
	},
