const timestamp_saved = '10/21/2023 11:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 7:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'35', Cost:12.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'33', Cost:12.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'36', Cost:12.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'66', Cost:11.06, ParentId: '17'},
		]
	},
