const timestamp_saved = '09/21/2023 05:35 PM';
const dataFechaAcualizado = '9/21/2023' + ' 1:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'43', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'47', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'67', Cost:11.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 97,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 156, MVar:'63', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'5', Cost:27.72, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'45', Cost:19.92, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:33.09, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:33.02, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'24', Cost:27.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'85', Cost:17.22, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 94,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 94, MVar:'91', Cost:26.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'107', Cost:16.20, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 112,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 41, MVar:'2', Cost:19.60, ParentId: '19'},
