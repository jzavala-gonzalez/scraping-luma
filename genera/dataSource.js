const timestamp_saved = '08/20/2023 09:25 AM';
const dataFechaAcualizado = '8/20/2023' + ' 5:22:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'49', Cost:11.10, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'101', Cost:16.54, ParentId: '15'},
