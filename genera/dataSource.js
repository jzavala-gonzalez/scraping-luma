const timestamp_saved = '10/05/2023 10:55 PM';
const dataFechaAcualizado = '10/5/2023' + ' 6:51:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'47', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'46', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'58', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'7', Cost:26.48, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'37', Cost:18.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:18.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'135', Cost:9.19, ParentId: '17'},
		]
	},
