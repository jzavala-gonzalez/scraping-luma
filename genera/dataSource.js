const timestamp_saved = '08/22/2023 11:15 AM';
const dataFechaAcualizado = '8/22/2023' + ' 7:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.51, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'129', Cost:18.19, ParentId: '16'},
		]
	},
