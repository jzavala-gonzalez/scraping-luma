const timestamp_saved = '09/25/2023 02:25 PM';
const dataFechaAcualizado = '9/25/2023' + ' 10:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'144', Cost:18.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'86', Cost:9.37, ParentId: '17'},
		]
	},
