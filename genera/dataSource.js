const timestamp_saved = '09/23/2023 06:55 AM';
const dataFechaAcualizado = '9/23/2023' + ' 2:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'41', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'42', Cost:11.42, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'52', Cost:16.90, ParentId: '15'},
