const timestamp_saved = '11/23/2023 06:20 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:16:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1915},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'23', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'32', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'49', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.17, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'56', Cost:9.82, ParentId: '17'},
		]
	},
