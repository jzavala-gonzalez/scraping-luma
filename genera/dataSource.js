const timestamp_saved = '11/25/2023 04:50 AM';
const dataFechaAcualizado = '11/25/2023' + ' 12:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 185,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 186, MVar:'60', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'24', Cost:12.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'34', Cost:12.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'50', Cost:12.96, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.47, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'128', Cost:16.71, ParentId: '16'},
		]
	},
