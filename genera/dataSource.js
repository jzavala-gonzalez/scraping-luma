const timestamp_saved = '08/11/2023 08:55 PM';
const dataFechaAcualizado = '8/11/2023' + ' 4:52:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'47', Cost:10.88, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 130,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:30.26, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'14', Cost:31.10, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:32.00, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'136', Cost:11.49, ParentId: '17'},
		]
	},
