const timestamp_saved = '09/24/2023 11:10 PM';
const dataFechaAcualizado = '9/24/2023' + ' 7:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'55', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'55', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'61', Cost:10.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 150,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 290, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 189,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:22.02, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:22.24, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'0', Cost:17.43, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:28.49, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:30.06, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'111', Cost:9.13, ParentId: '17'},
		]
	},
