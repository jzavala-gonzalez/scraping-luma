const timestamp_saved = '11/13/2023 02:35 PM';
const dataFechaAcualizado = '11/13/2023' + ' 10:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'45', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'51', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'75', Cost:17.64, ParentId: '15'},
