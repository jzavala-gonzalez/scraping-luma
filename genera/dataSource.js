const timestamp_saved = '09/19/2023 10:05 AM';
const dataFechaAcualizado = '9/19/2023' + ' 6:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'46', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'60', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.28, ParentId: '10'},
		]
	},
