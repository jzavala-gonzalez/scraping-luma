const timestamp_saved = '08/25/2023 09:05 AM';
const dataFechaAcualizado = '8/25/2023' + ' 5:00:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'57', Cost:11.08, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:31.29, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'18', Cost:18.59, ParentId: '14'},
