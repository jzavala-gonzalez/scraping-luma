const timestamp_saved = '10/01/2023 09:25 PM';
const dataFechaAcualizado = '10/1/2023' + ' 5:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'32', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'30', Cost:10.68, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:26.73, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'135', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'96', Cost:9.20, ParentId: '17'},
		]
	},
