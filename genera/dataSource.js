const timestamp_saved = '11/19/2023 02:05 AM';
const dataFechaAcualizado = '11/18/2023' + ' 10:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:14.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'58', Cost:14.35, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 83,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'5', Cost:30.16, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.20, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'76', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 168,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 168, MVar:'148', Cost:20.20, ParentId: '16'},
		]
	},
