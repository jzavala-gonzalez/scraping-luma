const timestamp_saved = '11/13/2023 01:55 PM';
const dataFechaAcualizado = '11/13/2023' + ' 9:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'45', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'51', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'54', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.37, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'93', Cost:9.57, ParentId: '17'},
		]
	},
