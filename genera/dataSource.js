const timestamp_saved = '10/11/2023 11:00 AM';
const dataFechaAcualizado = '10/11/2023' + ' 6:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'48', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'51', Cost:11.46, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'42', Cost:17.92, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'64', Cost:9.13, ParentId: '17'},
		]
	},
