const timestamp_saved = '09/27/2023 04:10 AM';
const dataFechaAcualizado = '9/27/2023' + ' 12:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'45', Cost:12.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'46', Cost:12.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'57', Cost:12.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:19.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'8', Cost:19.44, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:30.66, ParentId: '12'},
