const timestamp_saved = '07/30/2023 10:45 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:40:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'42', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'37', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:19.80, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'35', Cost:16.30, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'61', Cost:19.71, ParentId: '16'},
		]
	},
