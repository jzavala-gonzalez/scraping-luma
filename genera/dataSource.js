const timestamp_saved = '09/28/2023 12:20 PM';
const dataFechaAcualizado = '9/28/2023' + ' 8:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'24', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'24', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'46', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:17.83, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'115', Cost:18.42, ParentId: '16'},
		]
	},
