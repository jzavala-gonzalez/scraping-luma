const timestamp_saved = '11/30/2023 06:35 AM';
const dataFechaAcualizado = '11/30/2023' + ' 2:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'47', Cost:8.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'62', Cost:9.79, ParentId: '17'},
		]
	},
