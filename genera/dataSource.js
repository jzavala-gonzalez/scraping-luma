const timestamp_saved = '10/27/2023 07:50 AM';
const dataFechaAcualizado = '10/27/2023' + ' 3:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'40', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.57, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'87', Cost:18.23, ParentId: '16'},
		]
	},
