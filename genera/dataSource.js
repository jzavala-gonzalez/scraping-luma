const timestamp_saved = '08/29/2023 12:10 AM';
const dataFechaAcualizado = '8/28/2023' + ' 8:05:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3230},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 211, MVar:'75', Cost:9.73, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:22.05, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'41', Cost:28.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'43', Cost:28.26, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'42', Cost:18.66, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'214', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'134', Cost:9.20, ParentId: '17'},
		]
	},
