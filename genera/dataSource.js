const timestamp_saved = '12/01/2023 03:25 PM';
const dataFechaAcualizado = '12/1/2023' + ' 11:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'44', Cost:13.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'48', Cost:13.55, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 15, MVar:'0', Cost:26.63, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'4', Cost:27.96, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'149', Cost:17.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'69', Cost:9.50, ParentId: '17'},
		]
	},
