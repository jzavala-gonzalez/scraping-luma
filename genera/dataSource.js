const timestamp_saved = '09/13/2023 03:10 PM';
const dataFechaAcualizado = '9/13/2023' + ' 11:05:53 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 841},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'52', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'52', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'66', Cost:12.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.66, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'61', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'12', Cost:28.38, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'14', Cost:28.16, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:19.81, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'153', Cost:18.20, ParentId: '16'},
		]
	},
