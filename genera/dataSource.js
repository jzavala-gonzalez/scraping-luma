const timestamp_saved = '09/06/2023 04:25 PM';
const dataFechaAcualizado = '9/6/2023' + ' 12:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'50', Cost:17.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:17.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 64, MVar:'48', Cost:17.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:21.27, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'6', Cost:29.51, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'26', Cost:19.27, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'96', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'146', Cost:17.64, ParentId: '16'},
		]
	},
