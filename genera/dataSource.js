const timestamp_saved = '08/01/2023 01:00 PM';
const dataFechaAcualizado = '8/1/2023' + ' 8:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'47', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'34', Cost:15.46, ParentId: '15'},
		]
	},
