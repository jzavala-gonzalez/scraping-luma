const timestamp_saved = '11/19/2023 02:10 AM';
const dataFechaAcualizado = '11/18/2023' + ' 10:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'20', Cost:27.87, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'77', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 170,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 170, MVar:'150', Cost:20.17, ParentId: '16'},
		]
	},
