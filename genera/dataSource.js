const timestamp_saved = '08/30/2023 05:55 AM';
const dataFechaAcualizado = '8/30/2023' + ' 1:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'49', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'58', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:28.65, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'68', Cost:16.60, ParentId: '15'},
