const timestamp_saved = '11/17/2023 08:05 PM';
const dataFechaAcualizado = '11/17/2023' + ' 4:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'69', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'69', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'53', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'1', Cost:26.97, ParentId: '9'},
		]
	},
