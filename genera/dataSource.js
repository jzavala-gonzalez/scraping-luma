const timestamp_saved = '11/19/2023 05:40 PM';
const dataFechaAcualizado = '11/19/2023' + ' 1:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'39', Cost:15.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:17.38, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 111,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'20', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'83', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'143', Cost:17.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 245,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 245, MVar:'95', Cost:9.91, ParentId: '17'},
		]
	},
