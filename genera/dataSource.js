const timestamp_saved = '12/03/2023 06:25 PM';
const dataFechaAcualizado = '12/3/2023' + ' 2:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'38', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'40', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'44', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'92', Cost:18.45, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 230,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 230, MVar:'51', Cost:11.96, ParentId: '17'},
		]
	},
