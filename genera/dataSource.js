const timestamp_saved = '09/21/2023 09:30 AM';
const dataFechaAcualizado = '9/21/2023' + ' 5:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'44', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'46', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'64', Cost:10.44, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'52', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:10.04, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'77', Cost:17.28, ParentId: '15'},
