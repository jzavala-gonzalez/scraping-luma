const timestamp_saved = '08/06/2023 01:40 PM';
const dataFechaAcualizado = '8/6/2023' + ' 9:35:40 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2294},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'42', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'42', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'3', Cost:30.30, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:30.27, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:30.46, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'86', Cost:17.31, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'18', Cost:17.03, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'91', Cost:11.54, ParentId: '17'},
		]
	},
