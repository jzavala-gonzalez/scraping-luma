const timestamp_saved = '11/22/2023 08:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 4:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'20', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'29', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'67', Cost:9.83, ParentId: '17'},
		]
	},
