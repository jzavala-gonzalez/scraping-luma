const timestamp_saved = '09/21/2023 01:10 AM';
const dataFechaAcualizado = '9/20/2023' + ' 9:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'59', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'62', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'67', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'16', Cost:28.16, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'17', Cost:28.30, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:19.98, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:28.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 84,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 34, MVar:'7', Cost:30.11, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'16', Cost:26.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'82', Cost:16.45, ParentId: '15'},
