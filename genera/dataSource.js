const timestamp_saved = '11/20/2023 07:25 AM';
const dataFechaAcualizado = '11/20/2023' + ' 3:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'28', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'38', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'51', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'87', Cost:9.17, ParentId: '17'},
		]
	},
