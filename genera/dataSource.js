const timestamp_saved = '08/07/2023 12:35 AM';
const dataFechaAcualizado = '8/6/2023' + ' 8:30:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'61', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'60', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'52', Cost:10.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 171,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:7.00, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'13', Cost:22.73, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'30', Cost:28.02, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'31', Cost:28.01, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'40', Cost:20.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:20.30, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.69, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'11', Cost:8.69, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'16', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 254,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'71', Cost:18.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'26', Cost:15.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'123', Cost:11.57, ParentId: '17'},
		]
	},
