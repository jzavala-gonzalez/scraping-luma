const timestamp_saved = '09/15/2023 09:40 PM';
const dataFechaAcualizado = '9/15/2023' + ' 5:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'52', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'52', Cost:11.30, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.70, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'99', Cost:16.83, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 9,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 4, MVar:'7', Cost:19.60, ParentId: '19'},
