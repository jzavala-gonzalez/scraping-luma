const timestamp_saved = '08/04/2023 06:20 PM';
const dataFechaAcualizado = '8/4/2023' + ' 2:15:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'50', Cost:10.40, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:23.05, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 6, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 29, MVar:'10', Cost:27.11, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'1', Cost:27.48, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'83', Cost:17.02, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 38, MVar:'48', Cost:25.94, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'164', Cost:17.27, ParentId: '16'},
		]
	},
