const timestamp_saved = '10/28/2023 09:30 AM';
const dataFechaAcualizado = '10/28/2023' + ' 5:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'37', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'39', Cost:11.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:28.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.06, ParentId: '11'},
