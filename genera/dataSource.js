const timestamp_saved = '08/10/2023 05:20 AM';
const dataFechaAcualizado = '8/10/2023' + ' 1:15:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'56', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'56', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'3', Cost:26.99, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:30.81, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'75', Cost:11.99, ParentId: '17'},
		]
	},
