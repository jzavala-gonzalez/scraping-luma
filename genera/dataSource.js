const timestamp_saved = '11/13/2023 07:10 AM';
const dataFechaAcualizado = '11/13/2023' + ' 3:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 233,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 82, MVar:'35', Cost:16.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 83, MVar:'41', Cost:16.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 68, MVar:'47', Cost:16.21, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'0', Cost:31.53, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'47', Cost:16.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:16.84, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'58', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'79', Cost:9.15, ParentId: '17'},
		]
	},
