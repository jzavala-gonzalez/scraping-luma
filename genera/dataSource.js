const timestamp_saved = '09/17/2023 04:55 PM';
const dataFechaAcualizado = '9/17/2023' + ' 12:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'41', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'57', Cost:11.74, ParentId: '7'},
		]
	},
