const timestamp_saved = '08/22/2023 09:15 PM';
const dataFechaAcualizado = '8/22/2023' + ' 5:10:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'61', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'45', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'45', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'2', Cost:0, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'84', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'118', Cost:17.67, ParentId: '16'},
		]
	},
