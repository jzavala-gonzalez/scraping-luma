const timestamp_saved = '10/20/2023 11:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'44', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'50', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'153', Cost:17.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'108', Cost:10.55, ParentId: '17'},
		]
	},
