const timestamp_saved = '08/02/2023 09:55 PM';
const dataFechaAcualizado = '8/2/2023' + ' 5:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'42', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'11', Cost:20.61, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'150', Cost:17.19, ParentId: '16'},
		]
	},
