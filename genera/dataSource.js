const timestamp_saved = '07/29/2023 12:20 AM';
const dataFechaAcualizado = '7/28/2023' + ' 8:15:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'51', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 100, MVar:'0', Cost:4.83, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'0', Cost:22.13, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'44', Cost:8.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.83, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.36, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'16', Cost:18.66, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'86', Cost:13.84, ParentId: '17'},
		]
	},
