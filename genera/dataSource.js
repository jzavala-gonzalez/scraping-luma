const timestamp_saved = '11/08/2023 02:25 AM';
const dataFechaAcualizado = '11/7/2023' + ' 10:21:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'51', Cost:10.81, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 25,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 25, MVar:'0', Cost:29.16, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:16.96, ParentId: '11'},
