const timestamp_saved = '08/20/2023 10:30 PM';
const dataFechaAcualizado = '8/20/2023' + ' 6:27:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'29', Cost:10.67, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:19.60, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'103', Cost:17.41, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'74', Cost:9.32, ParentId: '17'},
		]
	},
