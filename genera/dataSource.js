const timestamp_saved = '11/10/2023 11:15 PM';
const dataFechaAcualizado = '11/10/2023' + ' 7:11:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'46', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'45', Cost:10.64, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:19.16, ParentId: '14'},
