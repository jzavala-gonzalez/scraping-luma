const timestamp_saved = '10/31/2023 12:35 AM';
const dataFechaAcualizado = '10/30/2023' + ' 8:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'63', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'67', Cost:10.50, ParentId: '7'},
