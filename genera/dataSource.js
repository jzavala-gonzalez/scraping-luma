const timestamp_saved = '08/21/2023 10:00 PM';
const dataFechaAcualizado = '8/21/2023' + ' 5:55:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'53', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'55', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:30.74, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'49', Cost:8.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'12', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'147', Cost:17.67, ParentId: '16'},
		]
	},
