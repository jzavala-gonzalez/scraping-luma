const timestamp_saved = '11/27/2023 01:15 AM';
const dataFechaAcualizado = '11/26/2023' + ' 9:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'38', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'48', Cost:10.54, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'9', Cost:29.26, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'103', Cost:9.30, ParentId: '17'},
		]
	},
