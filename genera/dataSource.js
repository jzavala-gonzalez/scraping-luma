const timestamp_saved = '10/22/2023 08:00 PM';
const dataFechaAcualizado = '10/22/2023' + ' 3:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'45', Cost:10.84, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'133', Cost:18.26, ParentId: '16'},
		]
	},
