const timestamp_saved = '12/02/2023 02:00 AM';
const dataFechaAcualizado = '12/1/2023' + ' 9:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'53', Cost:12.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'55', Cost:12.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'57', Cost:12.77, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.83, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'90', Cost:9.18, ParentId: '17'},
		]
	},
