const timestamp_saved = '08/12/2023 04:20 AM';
const dataFechaAcualizado = '8/12/2023' + ' 12:17:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'54', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'52', Cost:11.04, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 101, MVar:'0', Cost:5.82, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'13', Cost:30.91, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'14', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'175', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'114', Cost:11.62, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 40,
		units:[
			...
			{Index:'1', Unit:'CT Block 2', MW: 0, MVar:'0', Cost:90, ParentId: '21'},
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:89.51, ParentId: '21'},
