const timestamp_saved = '08/15/2023 11:55 AM';
const dataFechaAcualizado = '8/15/2023' + ' 7:52:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'44', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'1', Cost:24.56, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.87, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'1', Cost:27.23, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'6', Cost:31.21, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 56,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 56, MVar:'23', Cost:19.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'112', Cost:11.65, ParentId: '17'},
		]
	},
