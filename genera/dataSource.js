const timestamp_saved = '11/07/2023 07:25 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'37', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'38', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'123', Cost:18.29, ParentId: '16'},
		]
	},
