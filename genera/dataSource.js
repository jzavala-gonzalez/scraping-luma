const timestamp_saved = '08/05/2023 02:20 PM';
const dataFechaAcualizado = '8/5/2023' + ' 10:15:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'48', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:25.91, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:26.91, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'0', Cost:8.43, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:30.48, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:30.31, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'27', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'78', Cost:16.52, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'42', Cost:15.49, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'92', Cost:11.68, ParentId: '17'},
		]
	},
