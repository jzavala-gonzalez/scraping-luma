const timestamp_saved = '09/28/2023 10:25 PM';
const dataFechaAcualizado = '9/28/2023' + ' 6:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'52', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'156', Cost:16.85, ParentId: '16'},
		]
	},
