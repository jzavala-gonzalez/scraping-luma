const timestamp_saved = '10/13/2023 06:40 AM';
const dataFechaAcualizado = '10/13/2023' + ' 2:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'56', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'61', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'67', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'0', Cost:22.36, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 205,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'193', Cost:20.23, ParentId: '16'},
		]
	},
