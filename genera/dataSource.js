const timestamp_saved = '12/03/2023 05:00 PM';
const dataFechaAcualizado = '12/3/2023' + ' 12:56:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1720},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'39', Cost:13.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.91, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 230,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 230, MVar:'49', Cost:11.93, ParentId: '17'},
		]
	},
