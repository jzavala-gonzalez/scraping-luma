const timestamp_saved = '09/26/2023 01:25 AM';
const dataFechaAcualizado = '9/25/2023' + ' 9:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'48', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'51', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'57', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'46', Cost:17.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.78, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'73', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'188', Cost:16.68, ParentId: '16'},
		]
	},
