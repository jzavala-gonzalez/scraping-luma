const timestamp_saved = '11/10/2023 07:00 PM';
const dataFechaAcualizado = '11/10/2023' + ' 2:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'42', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'37', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'56', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:22.14, ParentId: '14'},
