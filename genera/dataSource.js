const timestamp_saved = '11/02/2023 08:00 PM';
const dataFechaAcualizado = '11/2/2023' + ' 3:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'65', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'65', Cost:10.11, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 22,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'15', Cost:43.51, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'109', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 263,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 263, MVar:'166', Cost:17.62, ParentId: '16'},
		]
	},
