const timestamp_saved = '11/10/2023 09:10 AM';
const dataFechaAcualizado = '11/10/2023' + ' 5:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'45', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'50', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'41', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'56', Cost:9.82, ParentId: '17'},
		]
	},
