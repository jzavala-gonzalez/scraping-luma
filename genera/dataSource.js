const timestamp_saved = '09/17/2023 10:45 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'39', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'39', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'55', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 109, MVar:'0', Cost:8.59, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:8.59, ParentId: '11'},
		]
	},
