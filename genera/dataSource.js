const timestamp_saved = '09/17/2023 10:50 PM';
const dataFechaAcualizado = '9/17/2023' + ' 6:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'80', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'51', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'63', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:28.73, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'93', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'159', Cost:17.14, ParentId: '16'},
		]
	},
