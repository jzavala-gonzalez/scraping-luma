const timestamp_saved = '11/27/2023 04:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 12:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'32', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'42', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'163', Cost:18.28, ParentId: '16'},
		]
	},
