const timestamp_saved = '10/14/2023 04:45 AM';
const dataFechaAcualizado = '10/14/2023' + ' 12:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'57', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'62', Cost:10.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:16.97, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 186,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'151', Cost:18.99, ParentId: '16'},
		]
	},
