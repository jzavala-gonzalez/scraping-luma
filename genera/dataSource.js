const timestamp_saved = '12/06/2023 11:00 AM';
const dataFechaAcualizado = '12/6/2023' + ' 6:55:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 806},
	{Index:'7', Desc:'Capacidad Disponible', value: 2916},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 253,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'81', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'50', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'52', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'48', Cost:8.05, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'11', Cost:8.05, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'28', Cost:19.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 236,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 236, MVar:'123', Cost:18.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'67', Cost:14.31, ParentId: '17'},
		]
	},
