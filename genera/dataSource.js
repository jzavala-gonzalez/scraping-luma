const timestamp_saved = '08/17/2023 09:30 AM';
const dataFechaAcualizado = '8/17/2023' + ' 5:27:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'45', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'60', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'70', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'70', Cost:9.87, ParentId: '17'},
		]
	},
