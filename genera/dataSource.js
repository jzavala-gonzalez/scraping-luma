const timestamp_saved = '10/26/2023 09:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 4:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'35', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'36', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'42', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'57', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'123', Cost:18.28, ParentId: '16'},
		]
	},
