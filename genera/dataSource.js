const timestamp_saved = '08/20/2023 10:15 AM';
const dataFechaAcualizado = '8/20/2023' + ' 6:12:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'53', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.79, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'127', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'64', Cost:9.18, ParentId: '17'},
		]
	},
