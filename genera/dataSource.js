const timestamp_saved = '09/28/2023 05:30 PM';
const dataFechaAcualizado = '9/28/2023' + ' 1:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'135', Cost:18.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'89', Cost:9.73, ParentId: '17'},
		]
	},
