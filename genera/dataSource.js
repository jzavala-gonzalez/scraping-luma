const timestamp_saved = '08/14/2023 07:45 AM';
const dataFechaAcualizado = '8/14/2023' + ' 3:42:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'40', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'39', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:21.85, ParentId: '9'},
