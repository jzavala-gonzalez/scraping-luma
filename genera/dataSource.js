const timestamp_saved = '10/21/2023 10:05 PM';
const dataFechaAcualizado = '10/21/2023' + ' 6:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'49', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'50', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.76, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:31.79, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'84', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'146', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'71', Cost:10.98, ParentId: '17'},
		]
	},
