const timestamp_saved = '08/07/2023 10:25 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:20:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.57, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'22', Cost:16.48, ParentId: '15'},
		]
	},
