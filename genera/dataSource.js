const timestamp_saved = '08/16/2023 11:25 PM';
const dataFechaAcualizado = '8/16/2023' + ' 7:22:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3061},
	{Index:'1', Desc:'PREPA', value: 64},
	{Index:'2', Desc:'COGEN', value: 36},
	{Index:'3', Desc:'Reserva en Rotación', value: 66},
	{Index:'4', Desc:'Reserva Operacional', value: 67},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 538,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'60', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'78', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 202, MVar:'82', Cost:9.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.36, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 149, MVar:'49', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 185,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:22.09, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.80, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'10', Cost:26.05, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'2', Cost:27.12, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'19', Cost:27.88, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'19', Cost:33.11, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:19.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:19.81, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'13', Cost:28.50, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:28.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'10', Cost:28.66, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'28', Cost:18.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'231', Cost:16.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'108', Cost:9.20, ParentId: '17'},
		]
	},
