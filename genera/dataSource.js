const timestamp_saved = '10/09/2023 05:01 PM';
const dataFechaAcualizado = '10/9/2023' + ' 12:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'89', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'59', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'60', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'54', Cost:10.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:26.85, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.59, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:17.59, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'38', Cost:18.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'9', Cost:18.18, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.46, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'175', Cost:18.22, ParentId: '16'},
		]
	},
