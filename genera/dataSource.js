const timestamp_saved = '09/01/2023 09:10 AM';
const dataFechaAcualizado = '9/1/2023' + ' 5:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'41', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'48', Cost:10.42, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:20.51, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 190,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 190, MVar:'97', Cost:19.50, ParentId: '16'},
		]
	},
