const timestamp_saved = '10/24/2023 12:10 PM';
const dataFechaAcualizado = '10/24/2023' + ' 8:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'48', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:16.94, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'75', Cost:11.03, ParentId: '17'},
		]
	},
