const timestamp_saved = '11/21/2023 10:35 AM';
const dataFechaAcualizado = '11/21/2023' + ' 6:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'28', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'37', Cost:10.99, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'60', Cost:18.46, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'77', Cost:9.60, ParentId: '17'},
		]
	},
