const timestamp_saved = '10/30/2023 10:40 AM';
const dataFechaAcualizado = '10/30/2023' + ' 6:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'61', Cost:9.44, ParentId: '17'},
		]
	},
