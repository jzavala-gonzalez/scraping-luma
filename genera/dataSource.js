const timestamp_saved = '10/03/2023 08:55 AM';
const dataFechaAcualizado = '10/3/2023' + ' 4:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'50', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'92', Cost:9.86, ParentId: '17'},
		]
	},
