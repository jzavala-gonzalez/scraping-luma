const timestamp_saved = '08/04/2023 01:10 AM';
const dataFechaAcualizado = '8/3/2023' + ' 9:05:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'50', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'10', Cost:22.52, ParentId: '9'},
