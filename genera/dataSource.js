const timestamp_saved = '12/03/2023 12:25 PM';
const dataFechaAcualizado = '12/3/2023' + ' 8:21:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1294},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'36', Cost:12.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'38', Cost:12.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'44', Cost:12.68, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'53', Cost:11.66, ParentId: '17'},
		]
	},
