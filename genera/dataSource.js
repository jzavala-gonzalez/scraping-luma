const timestamp_saved = '08/02/2023 07:50 AM';
const dataFechaAcualizado = '8/2/2023' + ' 3:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'38', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'44', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'12', Cost:8.33, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'69', Cost:17.38, ParentId: '15'},
