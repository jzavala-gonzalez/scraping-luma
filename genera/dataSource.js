const timestamp_saved = '11/18/2023 08:25 AM';
const dataFechaAcualizado = '11/18/2023' + ' 4:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 185,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 46, MVar:'11', Cost:27.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'72', Cost:27.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:27.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:26.33, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:26.84, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:58.08, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.61, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 75,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'12', Cost:28.84, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'66', Cost:16.86, ParentId: '15'},
