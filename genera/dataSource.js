const timestamp_saved = '08/01/2023 08:50 PM';
const dataFechaAcualizado = '8/1/2023' + ' 4:45:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'45', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'5', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'39', Cost:8.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:8.85, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'13', Cost:18.86, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 149, MVar:'32', Cost:15.68, ParentId: '15'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 68,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 20, MVar:'0', Cost:25.58, ParentId: '21'},
