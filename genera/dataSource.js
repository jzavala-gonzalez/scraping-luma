const timestamp_saved = '11/05/2023 02:55 AM';
const dataFechaAcualizado = '11/4/2023' + ' 10:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'77', Cost:9.22, ParentId: '17'},
		]
	},
