const timestamp_saved = '10/16/2023 05:20 AM';
const dataFechaAcualizado = '10/16/2023' + ' 1:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'50', Cost:13.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'49', Cost:13.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'53', Cost:13.57, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 19,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'6', Cost:31.41, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'6', Cost:19.98, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'76', Cost:16.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'145', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'84', Cost:9.08, ParentId: '17'},
		]
	},
