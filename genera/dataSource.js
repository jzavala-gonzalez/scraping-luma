const timestamp_saved = '09/06/2023 08:40 AM';
const dataFechaAcualizado = '9/6/2023' + ' 4:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'42', Cost:13.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'42', Cost:13.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'56', Cost:13.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'65', Cost:9.18, ParentId: '17'},
		]
	},
