const timestamp_saved = '09/03/2023 10:25 PM';
const dataFechaAcualizado = '9/3/2023' + ' 6:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'41', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'43', Cost:10.73, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'158', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'74', Cost:9.18, ParentId: '17'},
		]
	},
