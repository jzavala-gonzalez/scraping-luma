const timestamp_saved = '07/26/2023 05:26 AM';
const dataFechaAcualizado = '7/26/2023' + ' 1:20:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'32', Cost:20.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:20.57, ParentId: '11'},
