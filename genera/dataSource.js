const timestamp_saved = '08/22/2023 08:00 PM';
const dataFechaAcualizado = '8/22/2023' + ' 3:55:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'48', Cost:10.80, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'123', Cost:17.68, ParentId: '16'},
		]
	},
