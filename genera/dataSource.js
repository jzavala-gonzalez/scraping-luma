const timestamp_saved = '10/29/2023 04:55 PM';
const dataFechaAcualizado = '10/29/2023' + ' 12:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'47', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'50', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'71', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:17.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'47', Cost:17.02, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'125', Cost:16.95, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 45,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'23', Cost:19.60, ParentId: '19'},
