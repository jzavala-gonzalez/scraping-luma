const timestamp_saved = '10/20/2023 11:35 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'44', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'154', Cost:17.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'107', Cost:10.55, ParentId: '17'},
		]
	},
