const timestamp_saved = '08/18/2023 04:25 PM';
const dataFechaAcualizado = '8/18/2023' + ' 12:22:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'63', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'72', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'9', Cost:31.72, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'28', Cost:19.57, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 79, MVar:'74', Cost:19.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'146', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'77', Cost:9.47, ParentId: '17'},
		]
	},
