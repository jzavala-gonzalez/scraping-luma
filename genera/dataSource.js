const timestamp_saved = '11/15/2023 09:15 PM';
const dataFechaAcualizado = '11/15/2023' + ' 5:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'57', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'60', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'61', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'3', Cost:0, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 38,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'11', Cost:44.90, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'89', Cost:16.81, ParentId: '15'},
