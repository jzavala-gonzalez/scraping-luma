const timestamp_saved = '11/13/2023 12:25 PM';
const dataFechaAcualizado = '11/13/2023' + ' 8:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'46', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'51', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'14', Cost:30.93, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:30.88, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 111,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'16', Cost:19.35, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'88', Cost:9.57, ParentId: '17'},
		]
	},
