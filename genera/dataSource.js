const timestamp_saved = '10/10/2023 09:35 AM';
const dataFechaAcualizado = '10/10/2023' + ' 5:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'56', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'60', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'64', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.68, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'75', Cost:9.13, ParentId: '17'},
		]
	},
