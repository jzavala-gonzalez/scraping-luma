const timestamp_saved = '07/25/2023 06:00 PM';
const dataFechaAcualizado = '7/25/2023' + ' 1:50:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 235, MVar:'88', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'69', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'55', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'50', Cost:20.30, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'6', Cost:31.03, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 200, MVar:'83', Cost:10.71, ParentId: '17'},
		]
	},
