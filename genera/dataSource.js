const timestamp_saved = '09/04/2023 03:10 PM';
const dataFechaAcualizado = '9/4/2023' + ' 11:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'41', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'44', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'55', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'24', Cost:19.46, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'74', Cost:9.40, ParentId: '17'},
		]
	},
