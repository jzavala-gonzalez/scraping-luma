const timestamp_saved = '09/09/2023 12:15 PM';
const dataFechaAcualizado = '9/9/2023' + ' 8:10:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'51', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'61', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'56', Cost:10.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 120,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 2, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.02, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'19', Cost:19.58, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'88', Cost:16.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'142', Cost:16.65, ParentId: '16'},
		]
	},
