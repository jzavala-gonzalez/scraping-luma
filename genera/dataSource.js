const timestamp_saved = '08/02/2023 12:25 PM';
const dataFechaAcualizado = '8/2/2023' + ' 8:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'51', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:10.41, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.48, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'41', Cost:15.65, ParentId: '15'},
		]
	},
