const timestamp_saved = '09/29/2023 08:20 AM';
const dataFechaAcualizado = '9/29/2023' + ' 4:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'54', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'31', Cost:13.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:13.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'48', Cost:13.32, ParentId: '7'},
		]
	},
