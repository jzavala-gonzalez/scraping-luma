const timestamp_saved = '08/22/2023 02:45 PM';
const dataFechaAcualizado = '8/22/2023' + ' 10:40:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'47', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'81', Cost:18.38, ParentId: '15'},
