const timestamp_saved = '11/12/2023 06:05 PM';
const dataFechaAcualizado = '11/12/2023' + ' 2:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'46', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'47', Cost:11.97, ParentId: '7'},
