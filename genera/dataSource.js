const timestamp_saved = '09/28/2023 06:40 PM';
const dataFechaAcualizado = '9/28/2023' + ' 2:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'36', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'34', Cost:10.52, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'143', Cost:18.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'101', Cost:9.40, ParentId: '17'},
		]
	},
