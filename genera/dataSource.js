const timestamp_saved = '10/01/2023 11:20 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'58', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 68, MVar:'50', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'26', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'24', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'43', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'107', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'79', Cost:9.49, ParentId: '17'},
		]
	},
