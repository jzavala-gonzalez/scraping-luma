const timestamp_saved = '11/25/2023 05:00 PM';
const dataFechaAcualizado = '11/25/2023' + ' 12:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'63', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'25', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'36', Cost:11.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.60, ParentId: '11'},
