const timestamp_saved = '07/25/2023 11:55 PM';
const dataFechaAcualizado = '7/25/2023' + ' 7:50:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'87', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'68', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'47', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'59', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'54', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.80, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'15', Cost:18.96, ParentId: '14'},
