const timestamp_saved = '10/15/2023 11:05 AM';
const dataFechaAcualizado = '10/15/2023' + ' 7:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'50', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'45', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'10', Cost:19.32, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'58', Cost:9.51, ParentId: '17'},
		]
	},
