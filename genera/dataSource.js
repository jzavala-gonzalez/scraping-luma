const timestamp_saved = '10/20/2023 10:40 PM';
const dataFechaAcualizado = '10/20/2023' + ' 6:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'43', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.48, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'104', Cost:10.54, ParentId: '17'},
		]
	},
