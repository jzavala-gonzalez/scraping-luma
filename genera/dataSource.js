const timestamp_saved = '09/28/2023 04:00 PM';
const dataFechaAcualizado = '9/28/2023' + ' 11:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'28', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'28', Cost:11.65, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.59, ParentId: '11'},
