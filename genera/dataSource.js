const timestamp_saved = '08/22/2023 03:00 PM';
const dataFechaAcualizado = '8/22/2023' + ' 10:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 85, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'73', Cost:9.20, ParentId: '17'},
		]
	},
