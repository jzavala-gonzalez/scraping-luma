const timestamp_saved = '11/20/2023 07:45 PM';
const dataFechaAcualizado = '11/20/2023' + ' 3:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'43', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'57', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.24, ParentId: '11'},
