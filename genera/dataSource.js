const timestamp_saved = '09/24/2023 08:20 AM';
const dataFechaAcualizado = '9/24/2023' + ' 4:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'41', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'7', Cost:8.48, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 1,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'2', Cost:27.19, ParentId: '12'},
