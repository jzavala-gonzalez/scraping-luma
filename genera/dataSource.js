const timestamp_saved = '11/15/2023 05:10 PM';
const dataFechaAcualizado = '11/15/2023' + ' 1:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'56', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'56', Cost:10.88, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.07, ParentId: '14'},
