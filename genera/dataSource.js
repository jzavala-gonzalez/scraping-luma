const timestamp_saved = '09/01/2023 05:55 AM';
const dataFechaAcualizado = '9/1/2023' + ' 1:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'38', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'46', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'58', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:31.11, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:20.64, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 142, MVar:'0', Cost:16.92, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'10', Cost:16.92, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'73', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'139', Cost:16.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'75', Cost:9.19, ParentId: '17'},
		]
	},
