const timestamp_saved = '10/17/2023 02:00 AM';
const dataFechaAcualizado = '10/16/2023' + ' 9:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'71', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'72', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'75', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:28.76, ParentId: '13'},
