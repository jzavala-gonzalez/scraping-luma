const timestamp_saved = '09/20/2023 12:55 AM';
const dataFechaAcualizado = '9/19/2023' + ' 8:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 226, MVar:'80', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'87', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'53', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'55', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'67', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:31.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.88, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.70, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'79', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'168', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'92', Cost:9.15, ParentId: '17'},
		]
	},
