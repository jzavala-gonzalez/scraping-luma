const timestamp_saved = '11/26/2023 04:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 12:26:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 675},
	{Index:'4', Desc:'Reserva Operacional', value: 1263},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'22', Cost:12.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'34', Cost:12.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'48', Cost:12.27, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'134', Cost:19.67, ParentId: '16'},
		]
	},
