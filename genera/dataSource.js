const timestamp_saved = '11/04/2023 01:35 PM';
const dataFechaAcualizado = '11/4/2023' + ' 9:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'46', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'45', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'44', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'57', Cost:9.74, ParentId: '17'},
		]
	},
