const timestamp_saved = '11/07/2023 02:15 AM';
const dataFechaAcualizado = '11/6/2023' + ' 10:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'49', Cost:13.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'48', Cost:13.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'46', Cost:13.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'3', Cost:21.34, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 63, MVar:'11', Cost:27.84, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 94,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'7', Cost:28.63, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'7', Cost:19.92, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'164', Cost:17.63, ParentId: '16'},
		]
	},
