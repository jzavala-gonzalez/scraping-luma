const timestamp_saved = '11/20/2023 06:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'26', Cost:13.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'37', Cost:13.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 87, MVar:'57', Cost:13.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 132,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'16', Cost:18.82, ParentId: '14'},
