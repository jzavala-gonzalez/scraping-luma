const timestamp_saved = '11/29/2023 03:00 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'49', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'45', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'44', Cost:17.24, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'78', Cost:9.79, ParentId: '17'},
		]
	},
