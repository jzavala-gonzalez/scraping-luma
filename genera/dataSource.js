const timestamp_saved = '08/29/2023 02:45 AM';
const dataFechaAcualizado = '8/28/2023' + ' 10:40:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'60', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'58', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'67', Cost:11.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 92, MVar:'0', Cost:5.38, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'6', Cost:22.49, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 158,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'22', Cost:27.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'23', Cost:28.08, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'5', Cost:28.43, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 99,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'5', Cost:28.54, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'28', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'93', Cost:16.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'186', Cost:16.76, ParentId: '16'},
		]
	},
