const timestamp_saved = '09/07/2023 05:55 PM';
const dataFechaAcualizado = '9/7/2023' + ' 1:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'60', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'49', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'51', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'26', Cost:30.82, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:18.98, ParentId: '14'},
