const timestamp_saved = '08/06/2023 12:05 PM';
const dataFechaAcualizado = '8/6/2023' + ' 8:00:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'42', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'38', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'39', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 254,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'77', Cost:17.37, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 124, MVar:'20', Cost:16.04, ParentId: '15'},
		]
	},
