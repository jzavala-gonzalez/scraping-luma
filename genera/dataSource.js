const timestamp_saved = '09/30/2023 06:05 AM';
const dataFechaAcualizado = '9/30/2023' + ' 2:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'35', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'33', Cost:10.87, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 70, MVar:'0', Cost:18.34, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 30, MVar:'0', Cost:18.34, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:29.99, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:19.62, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'102', Cost:9.79, ParentId: '17'},
		]
	},
