const timestamp_saved = '08/30/2023 09:05 AM';
const dataFechaAcualizado = '8/30/2023' + ' 5:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'50', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'51', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'59', Cost:10.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 40, MVar:'37', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 60, MVar:'12', Cost:29.52, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'24', Cost:18.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 240,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 240, MVar:'141', Cost:16.86, ParentId: '16'},
		]
	},
