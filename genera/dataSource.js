const timestamp_saved = '08/05/2023 07:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 3:20:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'47', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'50', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'14', Cost:43.89, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:19.95, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.55, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'32', Cost:15.51, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'100', Cost:12.11, ParentId: '17'},
		]
	},
