const timestamp_saved = '10/21/2023 06:00 PM';
const dataFechaAcualizado = '10/21/2023' + ' 1:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'53', Cost:10.21, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 125, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:17.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'12', Cost:17.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 130, MVar:'36', Cost:18.09, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 54, MVar:'13', Cost:20.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'86', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'148', Cost:17.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'76', Cost:11.05, ParentId: '17'},
		]
	},
