const timestamp_saved = '08/14/2023 07:00 AM';
const dataFechaAcualizado = '8/14/2023' + ' 2:57:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'35', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'41', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'41', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'101', Cost:13.00, ParentId: '17'},
		]
	},
