const timestamp_saved = '10/31/2023 09:25 PM';
const dataFechaAcualizado = '10/31/2023' + ' 5:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'100', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'58', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'63', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'67', Cost:10.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 113, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'26', Cost:28.03, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 205,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'48', Cost:16.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'35', Cost:18.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'102', Cost:17.00, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'91', Cost:9.12, ParentId: '17'},
		]
	},
