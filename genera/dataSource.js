const timestamp_saved = '11/07/2023 03:55 AM';
const dataFechaAcualizado = '11/6/2023' + ' 11:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'50', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'47', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'45', Cost:10.40, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 21,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:29.08, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'0', Cost:26.08, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:21.36, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'7', Cost:20.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'57', Cost:16.16, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 221,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 221, MVar:'141', Cost:18.00, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'86', Cost:9.95, ParentId: '17'},
		]
	},
