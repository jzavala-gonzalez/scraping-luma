const timestamp_saved = '08/17/2023 05:30 PM';
const dataFechaAcualizado = '8/17/2023' + ' 1:27:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'70', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'77', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:32.12, ParentId: '13'},
