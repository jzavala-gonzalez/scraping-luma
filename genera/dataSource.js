const timestamp_saved = '10/09/2023 04:05 PM';
const dataFechaAcualizado = '10/9/2023' + ' 12:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'53', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'56', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:10.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:27.01, ParentId: '8'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 34,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:27.01, ParentId: '21'},
