const timestamp_saved = '09/30/2023 07:40 AM';
const dataFechaAcualizado = '9/30/2023' + ' 3:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'37', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'36', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'49', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 160,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'38', Cost:18.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'13', Cost:19.41, ParentId: '14'},
