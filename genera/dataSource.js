const timestamp_saved = '10/29/2023 06:20 PM';
const dataFechaAcualizado = '10/29/2023' + ' 2:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'49', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'52', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'71', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'47', Cost:16.97, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'16', Cost:21.66, ParentId: '14'},
