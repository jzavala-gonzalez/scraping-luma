const timestamp_saved = '10/28/2023 06:35 AM';
const dataFechaAcualizado = '10/28/2023' + ' 2:31:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1900},
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2546},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'40', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'44', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'46', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 50, MVar:'14', Cost:32.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:32.56, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.98, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:32.05, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'13', Cost:23.63, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'18', Cost:18.96, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 186,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'117', Cost:19.86, ParentId: '16'},
		]
	},
