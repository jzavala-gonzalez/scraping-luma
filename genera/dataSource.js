const timestamp_saved = '09/12/2023 09:40 PM';
const dataFechaAcualizado = '9/12/2023' + ' 5:35:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'58', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'56', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'67', Cost:10.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 51, MVar:'0', Cost:14.72, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'9', Cost:31.29, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'0', Cost:8.28, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'8', Cost:8.28, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.59, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.17, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'35', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'108', Cost:16.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'153', Cost:16.67, ParentId: '16'},
		]
	},
