const timestamp_saved = '10/30/2023 10:55 AM';
const dataFechaAcualizado = '10/30/2023' + ' 6:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'44', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'45', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'45', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'61', Cost:9.42, ParentId: '17'},
		]
	},
