const timestamp_saved = '09/27/2023 02:25 PM';
const dataFechaAcualizado = '9/27/2023' + ' 10:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'33', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'33', Cost:10.77, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:18.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.17, ParentId: '11'},
