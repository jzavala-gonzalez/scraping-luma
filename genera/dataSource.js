const timestamp_saved = '10/03/2023 05:15 AM';
const dataFechaAcualizado = '10/3/2023' + ' 1:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'36', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'34', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'50', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'100', Cost:9.15, ParentId: '17'},
		]
	},
