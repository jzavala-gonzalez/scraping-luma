const timestamp_saved = '12/04/2023 04:30 PM';
const dataFechaAcualizado = '12/4/2023' + ' 12:26:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1111},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'53', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'53', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'77', Cost:11.42, ParentId: '17'},
		]
	},
