const timestamp_saved = '11/15/2023 04:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 12:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'45', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'48', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'53', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:27.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:27.51, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'20', Cost:19.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'91', Cost:11.13, ParentId: '17'},
		]
	},
