const timestamp_saved = '11/22/2023 05:00 AM';
const dataFechaAcualizado = '11/22/2023' + ' 12:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'22', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'33', Cost:12.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.12, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'61', Cost:23.42, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'74', Cost:9.29, ParentId: '17'},
		]
	},
