const timestamp_saved = '09/13/2023 01:15 AM';
const dataFechaAcualizado = '9/12/2023' + ' 9:10:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'56', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'54', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'66', Cost:11.22, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:9.38, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:21.56, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'7', Cost:28.16, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'6', Cost:28.99, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:28.95, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.23, ParentId: '14'},
