const timestamp_saved = '07/31/2023 09:30 PM';
const dataFechaAcualizado = '7/31/2023' + ' 5:25:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'49', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.39, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.39, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.70, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'76', Cost:16.63, ParentId: '15'},
