const timestamp_saved = '09/16/2023 06:20 AM';
const dataFechaAcualizado = '9/16/2023' + ' 2:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'47', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'46', Cost:10.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:21.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'7', Cost:21.64, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'84', Cost:9.44, ParentId: '17'},
		]
	},
