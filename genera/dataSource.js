const timestamp_saved = '10/27/2023 07:00 PM';
const dataFechaAcualizado = '10/27/2023' + ' 2:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'49', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'52', Cost:11.35, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.24, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 98, MVar:'30', Cost:17.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:17.99, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'105', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'114', Cost:17.17, ParentId: '16'},
		]
	},
