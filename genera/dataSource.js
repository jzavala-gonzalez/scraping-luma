const timestamp_saved = '10/25/2023 09:00 PM';
const dataFechaAcualizado = '10/25/2023' + ' 4:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'49', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 171, MVar:'52', Cost:10.16, ParentId: '7'},
		]
	},
