const timestamp_saved = '08/25/2023 12:50 AM';
const dataFechaAcualizado = '8/24/2023' + ' 8:45:46 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'113', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'74', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'77', Cost:10.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'17', Cost:23.04, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'12', Cost:22.21, ParentId: '9'},
		]
	},
