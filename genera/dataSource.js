const timestamp_saved = '10/06/2023 02:05 AM';
const dataFechaAcualizado = '10/5/2023' + ' 10:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'45', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'44', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 131, MVar:'37', Cost:18.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'6', Cost:18.81, ParentId: '11'},
