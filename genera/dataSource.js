const timestamp_saved = '08/16/2023 12:15 AM';
const dataFechaAcualizado = '8/15/2023' + ' 8:12:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'115', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 551,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'73', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'72', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'68', Cost:9.76, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'14', Cost:22.36, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'27', Cost:28.14, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:8.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:28.42, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'13', Cost:28.10, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'28', Cost:18.65, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'241', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'122', Cost:10.09, ParentId: '17'},
		]
	},
