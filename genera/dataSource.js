const timestamp_saved = '10/20/2023 09:35 PM';
const dataFechaAcualizado = '10/20/2023' + ' 5:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'37', Cost:12.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:12.56, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'153', Cost:16.82, ParentId: '16'},
		]
	},
