const timestamp_saved = '09/08/2023 11:00 PM';
const dataFechaAcualizado = '9/8/2023' + ' 6:55:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 25},
	{Index:'4', Desc:'Reserva Operacional', value: 31},
	{Index:'5', Desc:'Capacidad Disponible', value: 2887},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'65', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'71', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'64', Cost:9.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 108, MVar:'0', Cost:6.91, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'8', Cost:27.50, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'31', Cost:28.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'29', Cost:29.69, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:20.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:20.00, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'0', Cost:8.16, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:8.16, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'14', Cost:28.76, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'24', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'90', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'187', Cost:16.72, ParentId: '16'},
		]
	},
