const timestamp_saved = '10/28/2023 01:40 AM';
const dataFechaAcualizado = '10/27/2023' + ' 9:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'46', Cost:10.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'25', Cost:18.41, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'6', Cost:18.41, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'36', Cost:18.19, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:18.19, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'11', Cost:23.55, ParentId: '14'},
