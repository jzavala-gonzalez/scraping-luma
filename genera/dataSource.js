const timestamp_saved = '10/28/2023 10:25 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'38', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'39', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'45', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 64, MVar:'20', Cost:29.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.07, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'13', Cost:19.02, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'110', Cost:18.21, ParentId: '16'},
		]
	},
