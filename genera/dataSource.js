const timestamp_saved = '08/28/2023 11:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 7:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'40', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'38', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'93', Cost:12.05, ParentId: '17'},
		]
	},
