const timestamp_saved = '11/22/2023 12:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 7:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'33', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'42', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'54', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'163', Cost:18.27, ParentId: '16'},
		]
	},
