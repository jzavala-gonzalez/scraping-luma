const timestamp_saved = '12/01/2023 02:50 AM';
const dataFechaAcualizado = '11/30/2023' + ' 10:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'55', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'57', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'13', Cost:17.49, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 191,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 191, MVar:'148', Cost:19.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'92', Cost:9.16, ParentId: '17'},
		]
	},
