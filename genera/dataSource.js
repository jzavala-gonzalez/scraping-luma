const timestamp_saved = '10/30/2023 02:40 AM';
const dataFechaAcualizado = '10/29/2023' + ' 10:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'45', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'47', Cost:11.39, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 51, MVar:'15', Cost:21.31, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'65', Cost:9.40, ParentId: '17'},
		]
	},
