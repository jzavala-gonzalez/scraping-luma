const timestamp_saved = '11/30/2023 11:25 PM';
const dataFechaAcualizado = '11/30/2023' + ' 7:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'61', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'62', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'60', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'163', Cost:17.80, ParentId: '16'},
		]
	},
