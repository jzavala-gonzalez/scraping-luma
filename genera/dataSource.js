const timestamp_saved = '12/01/2023 08:15 AM';
const dataFechaAcualizado = '12/1/2023' + ' 4:11:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1925},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1887},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'38', Cost:12.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'41', Cost:12.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'45', Cost:12.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'51', Cost:9.88, ParentId: '17'},
		]
	},
