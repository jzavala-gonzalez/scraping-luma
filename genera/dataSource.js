const timestamp_saved = '11/30/2023 08:15 PM';
const dataFechaAcualizado = '11/30/2023' + ' 4:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'60', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'60', Cost:10.36, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'95', Cost:9.23, ParentId: '17'},
		]
	},
