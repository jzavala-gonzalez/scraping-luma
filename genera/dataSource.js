const timestamp_saved = '10/21/2023 12:45 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'36', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'34', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'38', Cost:12.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:17.11, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'68', Cost:11.05, ParentId: '17'},
		]
	},
