const timestamp_saved = '10/12/2023 03:50 AM';
const dataFechaAcualizado = '10/11/2023' + ' 11:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'56', Cost:12.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'61', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'67', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:33.68, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:17.22, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 147, MVar:'45', Cost:16.91, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'2', Cost:29.28, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 372, MVar:'174', Cost:16.63, ParentId: '16'},
		]
	},
