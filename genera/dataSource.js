const timestamp_saved = '10/10/2023 02:25 AM';
const dataFechaAcualizado = '10/9/2023' + ' 10:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'87', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 517,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'70', Cost:9.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'73', Cost:9.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 176, MVar:'83', Cost:9.96, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:20.51, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.64, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'11', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'90', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'167', Cost:16.87, ParentId: '16'},
		]
	},
