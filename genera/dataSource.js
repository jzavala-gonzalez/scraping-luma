const timestamp_saved = '10/11/2023 08:45 AM';
const dataFechaAcualizado = '10/11/2023' + ' 4:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'45', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'49', Cost:13.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'58', Cost:13.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:26.60, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:19.16, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'138', Cost:17.16, ParentId: '16'},
		]
	},
