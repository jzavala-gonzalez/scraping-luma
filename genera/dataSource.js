const timestamp_saved = '10/20/2023 07:25 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'31', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'38', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'39', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:32.40, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'79', Cost:10.53, ParentId: '17'},
		]
	},
