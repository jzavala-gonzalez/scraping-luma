const timestamp_saved = '11/12/2023 04:50 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'42', Cost:13.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'44', Cost:13.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'53', Cost:13.06, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'19', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.34, ParentId: '11'},
