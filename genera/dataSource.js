const timestamp_saved = '11/29/2023 11:20 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'40', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'38', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'42', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'49', Cost:17.32, ParentId: '11'},
