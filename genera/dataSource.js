const timestamp_saved = '09/29/2023 04:25 PM';
const dataFechaAcualizado = '9/29/2023' + ' 12:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'42', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'37', Cost:10.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 102, MVar:'0', Cost:18.13, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'0', Cost:18.13, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'94', Cost:17.65, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'96', Cost:9.43, ParentId: '17'},
		]
	},
