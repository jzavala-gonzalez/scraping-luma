const timestamp_saved = '12/04/2023 04:15 AM';
const dataFechaAcualizado = '12/4/2023' + ' 12:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 13,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 13, MVar:'4', Cost:33.10, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'50', Cost:17.37, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'13', Cost:19.39, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'66', Cost:11.91, ParentId: '17'},
		]
	},
