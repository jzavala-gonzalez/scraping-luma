const timestamp_saved = '11/05/2023 11:25 PM';
const dataFechaAcualizado = '11/5/2023' + ' 7:21:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'56', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'54', Cost:10.55, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:17.04, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:39.00, ParentId: '12'},
