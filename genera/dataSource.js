const timestamp_saved = '11/21/2023 05:10 PM';
const dataFechaAcualizado = '11/21/2023' + ' 1:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'33', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'43', Cost:11.46, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'159', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'94', Cost:9.61, ParentId: '17'},
		]
	},
