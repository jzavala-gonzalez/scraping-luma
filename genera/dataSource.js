const timestamp_saved = '11/21/2023 08:35 AM';
const dataFechaAcualizado = '11/21/2023' + ' 4:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'20', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'30', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.26, ParentId: '11'},
