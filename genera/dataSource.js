const timestamp_saved = '10/25/2023 10:00 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 143, MVar:'47', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 379,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:18.00, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'50', Cost:16.97, ParentId: '11'},
