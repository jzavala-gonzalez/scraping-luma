const timestamp_saved = '11/10/2023 09:50 AM';
const dataFechaAcualizado = '11/10/2023' + ' 5:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'50', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'55', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'44', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'15', Cost:30.78, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'78', Cost:18.40, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'65', Cost:9.81, ParentId: '17'},
		]
	},
