const timestamp_saved = '08/30/2023 04:40 AM';
const dataFechaAcualizado = '8/30/2023' + ' 12:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'47', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'58', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'0', Cost:27.74, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'0', Cost:21.88, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:26.75, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:26.25, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'13', Cost:27.98, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'19', Cost:18.54, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'66', Cost:16.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'106', Cost:9.21, ParentId: '17'},
		]
	},
