const timestamp_saved = '10/24/2023 07:05 PM';
const dataFechaAcualizado = '10/24/2023' + ' 3:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'52', Cost:10.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.16, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'87', Cost:16.79, ParentId: '15'},
