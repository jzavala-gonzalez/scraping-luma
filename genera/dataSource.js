const timestamp_saved = '10/01/2023 09:55 AM';
const dataFechaAcualizado = '10/1/2023' + ' 5:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 129, MVar:'56', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'30', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'27', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'46', Cost:11.27, ParentId: '7'},
		]
	},
