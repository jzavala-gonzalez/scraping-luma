const timestamp_saved = '10/25/2023 03:15 PM';
const dataFechaAcualizado = '10/25/2023' + ' 11:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'51', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'52', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'152', Cost:17.66, ParentId: '16'},
		]
	},
