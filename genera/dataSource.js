const timestamp_saved = '11/27/2023 02:30 AM';
const dataFechaAcualizado = '11/26/2023' + ' 10:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'32', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'42', Cost:11.26, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'44', Cost:8.21, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'7', Cost:29.56, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'96', Cost:9.32, ParentId: '17'},
		]
	},
