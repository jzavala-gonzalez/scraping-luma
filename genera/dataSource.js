const timestamp_saved = '11/28/2023 04:50 PM';
const dataFechaAcualizado = '11/28/2023' + ' 12:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'48', Cost:11.03, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'176', Cost:18.25, ParentId: '16'},
		]
	},
