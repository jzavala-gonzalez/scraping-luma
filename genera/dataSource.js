const timestamp_saved = '11/27/2023 02:40 AM';
const dataFechaAcualizado = '11/26/2023' + ' 10:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'33', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'43', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'56', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:17.52, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.22, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'147', Cost:16.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'94', Cost:9.32, ParentId: '17'},
		]
	},
