const timestamp_saved = '12/03/2023 08:40 AM';
const dataFechaAcualizado = '12/3/2023' + ' 4:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'59', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'39', Cost:11.48, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'10', Cost:19.54, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'52', Cost:11.63, ParentId: '17'},
		]
	},
