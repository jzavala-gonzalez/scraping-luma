const timestamp_saved = '10/01/2023 07:10 PM';
const dataFechaAcualizado = '10/1/2023' + ' 3:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'34', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'33', Cost:10.47, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 19, MVar:'7', Cost:27.80, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'136', Cost:17.48, ParentId: '16'},
		]
	},
