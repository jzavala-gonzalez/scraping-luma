const timestamp_saved = '11/21/2023 09:05 PM';
const dataFechaAcualizado = '11/21/2023' + ' 5:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'35', Cost:10.68, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 59, MVar:'4', Cost:20.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'169', Cost:18.21, ParentId: '16'},
		]
	},
