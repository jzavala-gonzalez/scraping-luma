const timestamp_saved = '11/05/2023 01:00 AM';
const dataFechaAcualizado = '11/4/2023' + ' 8:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'55', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'50', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 66, MVar:'9', Cost:19.96, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'151', Cost:17.05, ParentId: '16'},
		]
	},
