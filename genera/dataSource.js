const timestamp_saved = '11/16/2023 09:05 AM';
const dataFechaAcualizado = '11/16/2023' + ' 5:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'41', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'41', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'48', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.03, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 181,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 181, MVar:'56', Cost:10.85, ParentId: '17'},
		]
	},
