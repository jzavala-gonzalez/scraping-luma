const timestamp_saved = '09/19/2023 03:10 AM';
const dataFechaAcualizado = '9/18/2023' + ' 11:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'78', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'51', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'51', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'65', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 26,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'2', Cost:37.50, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.24, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'166', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'95', Cost:9.11, ParentId: '17'},
		]
	},
