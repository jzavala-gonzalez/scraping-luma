const timestamp_saved = '10/31/2023 02:00 PM';
const dataFechaAcualizado = '10/31/2023' + ' 9:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'58', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'62', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'61', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'76', Cost:9.40, ParentId: '17'},
		]
	},
