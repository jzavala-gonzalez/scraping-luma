const timestamp_saved = '07/25/2023 09:38 AM';
const dataFechaAcualizado = '7/25/2023' + ' 5:30:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 545,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'50', Cost:9.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'62', Cost:9.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 193, MVar:'56', Cost:9.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:27.06, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'9', Cost:28.22, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'9', Cost:28.30, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:28.29, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:27.86, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'58', Cost:15.47, ParentId: '15'},
		]
	},
