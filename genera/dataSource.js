const timestamp_saved = '09/17/2023 02:25 PM';
const dataFechaAcualizado = '9/17/2023' + ' 10:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'63', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'41', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'39', Cost:11.76, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'105', Cost:18.27, ParentId: '16'},
		]
	},
