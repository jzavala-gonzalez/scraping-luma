const timestamp_saved = '10/25/2023 05:50 AM';
const dataFechaAcualizado = '10/25/2023' + ' 1:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'41', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'44', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 379,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'39', Cost:17.20, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:17.20, ParentId: '11'},
		]
	},
