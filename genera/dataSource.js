const timestamp_saved = '10/21/2023 02:55 PM';
const dataFechaAcualizado = '10/21/2023' + ' 10:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'38', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'36', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'37', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'72', Cost:11.07, ParentId: '17'},
		]
	},
