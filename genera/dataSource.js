const timestamp_saved = '11/12/2023 04:10 PM';
const dataFechaAcualizado = '11/12/2023' + ' 12:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'44', Cost:13.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'45', Cost:13.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'55', Cost:13.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.83, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'12', Cost:22.21, ParentId: '14'},
