const timestamp_saved = '09/16/2023 12:50 PM';
const dataFechaAcualizado = '9/16/2023' + ' 8:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'40', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'37', Cost:11.33, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'66', Cost:17.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'99', Cost:19.70, ParentId: '16'},
		]
	},
