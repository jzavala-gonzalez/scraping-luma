const timestamp_saved = '11/06/2023 08:40 AM';
const dataFechaAcualizado = '11/6/2023' + ' 4:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'40', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'39', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'39', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'78', Cost:16.85, ParentId: '15'},
