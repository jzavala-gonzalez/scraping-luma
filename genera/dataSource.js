const timestamp_saved = '08/14/2023 07:30 AM';
const dataFechaAcualizado = '8/14/2023' + ' 3:27:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'41', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'39', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'100', Cost:12.98, ParentId: '17'},
		]
	},
