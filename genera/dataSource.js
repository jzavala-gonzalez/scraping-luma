const timestamp_saved = '11/07/2023 08:20 AM';
const dataFechaAcualizado = '11/7/2023' + ' 4:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'38', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'37', Cost:11.80, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 60, MVar:'9', Cost:20.38, ParentId: '14'},
