const timestamp_saved = '08/08/2023 07:55 AM';
const dataFechaAcualizado = '8/8/2023' + ' 3:50:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'46', Cost:11.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:20.42, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'78', Cost:11.63, ParentId: '17'},
		]
	},
