const timestamp_saved = '10/12/2023 11:50 AM';
const dataFechaAcualizado = '10/12/2023' + ' 7:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'56', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'64', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'75', Cost:9.08, ParentId: '17'},
		]
	},
