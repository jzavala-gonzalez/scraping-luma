const timestamp_saved = '12/05/2023 03:45 AM';
const dataFechaAcualizado = '12/4/2023' + ' 11:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'45', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'47', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'55', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'3', Cost:18.80, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'69', Cost:10.87, ParentId: '17'},
		]
	},
