const timestamp_saved = '11/23/2023 04:20 AM';
const dataFechaAcualizado = '11/23/2023' + ' 12:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'28', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'38', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'8', Cost:30.75, ParentId: '10'},
