const timestamp_saved = '11/13/2023 04:15 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 84, MVar:'46', Cost:22.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 84, MVar:'51', Cost:22.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:22.42, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 126,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:25.05, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:22.99, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'0', Cost:21.64, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:16.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.98, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'99', Cost:9.16, ParentId: '17'},
		]
	},
