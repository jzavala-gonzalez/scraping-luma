const timestamp_saved = '11/20/2023 07:55 AM';
const dataFechaAcualizado = '11/20/2023' + ' 3:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'28', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'36', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'51', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'87', Cost:9.18, ParentId: '17'},
		]
	},
