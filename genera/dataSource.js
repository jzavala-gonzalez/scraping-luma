const timestamp_saved = '11/21/2023 02:35 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:31:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2179},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'33', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'41', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.35, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'90', Cost:9.59, ParentId: '17'},
		]
	},
