const timestamp_saved = '09/29/2023 07:20 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'31', Cost:12.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'30', Cost:12.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'48', Cost:12.70, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.62, ParentId: '11'},
