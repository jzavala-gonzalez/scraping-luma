const timestamp_saved = '11/25/2023 12:45 AM';
const dataFechaAcualizado = '11/24/2023' + ' 8:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 70, MVar:'77', Cost:4.64, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.64, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'34', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'46', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'58', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.11, ParentId: '14'},
