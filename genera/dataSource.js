const timestamp_saved = '08/03/2023 07:25 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:20:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'38', Cost:11.28, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'42', Cost:17.34, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'77', Cost:11.31, ParentId: '17'},
		]
	},
