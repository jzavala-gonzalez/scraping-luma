const timestamp_saved = '08/15/2023 09:00 AM';
const dataFechaAcualizado = '8/15/2023' + ' 4:57:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'43', Cost:11.06, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:27.08, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'161', Cost:18.17, ParentId: '16'},
		]
	},
