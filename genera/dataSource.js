const timestamp_saved = '11/25/2023 02:55 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 164,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'21', Cost:13.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'31', Cost:13.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'47', Cost:13.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:18.60, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'42', Cost:9.84, ParentId: '17'},
		]
	},
