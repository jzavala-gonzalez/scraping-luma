const timestamp_saved = '10/23/2023 06:20 AM';
const dataFechaAcualizado = '10/23/2023' + ' 2:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'37', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'38', Cost:12.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'40', Cost:12.88, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'103', Cost:17.40, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'48', Cost:11.27, ParentId: '17'},
		]
	},
