const timestamp_saved = '11/25/2023 02:40 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:36:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1851},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 162, MVar:'59', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'20', Cost:13.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'29', Cost:13.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'48', Cost:13.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:18.55, ParentId: '11'},
		]
	},
