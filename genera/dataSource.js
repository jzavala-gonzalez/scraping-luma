const timestamp_saved = '10/25/2023 12:05 PM';
const dataFechaAcualizado = '10/25/2023' + ' 8:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'46', Cost:11.07, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'26', Cost:19.39, ParentId: '14'},
