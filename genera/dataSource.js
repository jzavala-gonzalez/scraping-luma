const timestamp_saved = '07/31/2023 05:00 AM';
const dataFechaAcualizado = '7/31/2023' + ' 12:55:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'50', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'2', Cost:36.30, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'78', Cost:11.42, ParentId: '17'},
		]
	},
