const timestamp_saved = '08/13/2023 04:10 PM';
const dataFechaAcualizado = '8/13/2023' + ' 12:07:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'36', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'40', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'40', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 42,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:29.13, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'108', Cost:12.27, ParentId: '17'},
		]
	},
