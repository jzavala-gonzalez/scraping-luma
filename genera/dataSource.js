const timestamp_saved = '09/13/2023 11:05 AM';
const dataFechaAcualizado = '9/13/2023' + ' 7:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'49', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'47', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'62', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'150', Cost:18.15, ParentId: '16'},
		]
	},
