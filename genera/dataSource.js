const timestamp_saved = '09/28/2023 08:50 AM';
const dataFechaAcualizado = '9/28/2023' + ' 4:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'18', Cost:13.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'18', Cost:13.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'44', Cost:13.07, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'51', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'91', Cost:18.46, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'62', Cost:9.73, ParentId: '17'},
		]
	},
