const timestamp_saved = '11/27/2023 07:30 PM';
const dataFechaAcualizado = '11/27/2023' + ' 3:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'52', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'60', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'1', Cost:32.94, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.77, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'109', Cost:9.40, ParentId: '17'},
		]
	},
