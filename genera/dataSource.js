const timestamp_saved = '11/09/2023 10:40 PM';
const dataFechaAcualizado = '11/9/2023' + ' 6:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'53', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'49', Cost:10.21, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'26', Cost:21.98, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'120', Cost:9.19, ParentId: '17'},
		]
	},
