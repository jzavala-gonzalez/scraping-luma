const timestamp_saved = '10/25/2023 11:20 AM';
const dataFechaAcualizado = '10/25/2023' + ' 7:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'43', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'44', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'44', Cost:17.01, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'4', Cost:31.53, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'138', Cost:17.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'0', Cost:11.31, ParentId: '17'},
		]
	},
