const timestamp_saved = '09/19/2023 11:25 AM';
const dataFechaAcualizado = '9/19/2023' + ' 7:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'49', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'62', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'85', Cost:9.25, ParentId: '17'},
		]
	},
