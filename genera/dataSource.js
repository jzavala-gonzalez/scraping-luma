const timestamp_saved = '11/07/2023 06:50 PM';
const dataFechaAcualizado = '11/7/2023' + ' 2:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'53', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'50', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 36,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:41.06, ParentId: '8'},
