const timestamp_saved = '10/25/2023 07:45 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'49', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 166, MVar:'53', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'86', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'155', Cost:17.36, ParentId: '16'},
		]
	},
