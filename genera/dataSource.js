const timestamp_saved = '11/03/2023 07:05 AM';
const dataFechaAcualizado = '11/3/2023' + ' 3:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'42', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'41', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'34', Cost:36.24, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'0', Cost:36.24, ParentId: '11'},
		]
	},
