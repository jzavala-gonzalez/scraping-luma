const timestamp_saved = '12/06/2023 03:10 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:05:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'46', Cost:13.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'48', Cost:13.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'56', Cost:13.49, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'10', Cost:18.76, ParentId: '14'},
