const timestamp_saved = '11/12/2023 11:05 AM';
const dataFechaAcualizado = '11/12/2023' + ' 7:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'40', Cost:11.64, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.42, ParentId: '11'},
