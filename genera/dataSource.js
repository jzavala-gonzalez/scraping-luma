const timestamp_saved = '10/01/2023 11:15 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'60', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 73, MVar:'52', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'26', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'24', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'43', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:17.51, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'106', Cost:17.83, ParentId: '16'},
		]
	},
