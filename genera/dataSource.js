const timestamp_saved = '07/28/2023 09:11 AM';
const dataFechaAcualizado = '7/28/2023' + ' 5:05:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'41', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'43', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'42', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.08, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.52, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'80', Cost:13.20, ParentId: '17'},
		]
	},
