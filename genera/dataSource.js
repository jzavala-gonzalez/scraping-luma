const timestamp_saved = '10/21/2023 05:10 PM';
const dataFechaAcualizado = '10/21/2023' + ' 1:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'43', Cost:12.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:12.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'39', Cost:12.09, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'76', Cost:11.06, ParentId: '17'},
		]
	},
