const timestamp_saved = '10/30/2023 03:55 PM';
const dataFechaAcualizado = '10/30/2023' + ' 11:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'104', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'64', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'69', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'70', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 52, MVar:'17', Cost:21.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'109', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 313, MVar:'174', Cost:17.18, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'90', Cost:9.36, ParentId: '17'},
		]
	},
