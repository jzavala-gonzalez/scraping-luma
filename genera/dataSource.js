const timestamp_saved = '10/31/2023 07:20 PM';
const dataFechaAcualizado = '10/31/2023' + ' 3:16:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2449},
	{Index:'7', Desc:'Máxima para Hoy', value: 2455},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'60', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'66', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'68', Cost:10.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 21,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 2, MVar:'0', Cost:623.29, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 139, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:22.00, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 0, MVar:'0', Cost:0, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:0, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'37', Cost:18.27, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:18.27, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 131,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'16', Cost:20.95, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'39', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'114', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'180', Cost:16.80, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 45,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 4, MVar:'22', Cost:19.60, ParentId: '19'},
