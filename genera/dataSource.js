const timestamp_saved = '10/09/2023 06:55 AM';
const dataFechaAcualizado = '10/9/2023' + ' 2:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'44', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'44', Cost:10.77, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:17.51, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'125', Cost:17.87, ParentId: '16'},
		]
	},
