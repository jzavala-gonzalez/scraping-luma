const timestamp_saved = '09/25/2023 03:30 AM';
const dataFechaAcualizado = '9/24/2023' + ' 11:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'48', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'49', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'57', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 120,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 69, MVar:'6', Cost:28.06, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.78, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.91, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'98', Cost:9.14, ParentId: '17'},
		]
	},
