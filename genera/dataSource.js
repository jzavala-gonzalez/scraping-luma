const timestamp_saved = '09/02/2023 10:40 PM';
const dataFechaAcualizado = '9/2/2023' + ' 6:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 175, MVar:'89', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'52', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'60', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'66', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.57, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.56, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'80', Cost:16.97, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'150', Cost:16.76, ParentId: '16'},
		]
	},
