const timestamp_saved = '10/25/2023 07:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'51', Cost:10.96, ParentId: '7'},
		]
	},
