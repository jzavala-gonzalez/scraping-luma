const timestamp_saved = '11/28/2023 08:00 AM';
const dataFechaAcualizado = '11/28/2023' + ' 3:56:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1914},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'24', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'33', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:11.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:25.66, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:8.70, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'110', Cost:18.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'69', Cost:9.52, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 20, MVar:'0', Cost:40, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:14.77, ParentId: '21'},
