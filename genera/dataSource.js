const timestamp_saved = '09/25/2023 01:55 AM';
const dataFechaAcualizado = '9/24/2023' + ' 9:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'54', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'55', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'61', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'11', Cost:28.04, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'4', Cost:28.39, ParentId: '12'},
