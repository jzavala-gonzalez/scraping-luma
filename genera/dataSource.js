const timestamp_saved = '07/27/2023 03:44 AM';
const dataFechaAcualizado = '7/26/2023' + ' 11:35:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'70', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'55', Cost:10.49, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'9', Cost:18.66, ParentId: '14'},
