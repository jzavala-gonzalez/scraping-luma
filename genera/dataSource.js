const timestamp_saved = '09/06/2023 12:55 AM';
const dataFechaAcualizado = '9/5/2023' + ' 8:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'59', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'60', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'68', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'23', Cost:28.01, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:30.39, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:30.34, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.52, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'94', Cost:16.86, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 65,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:24.09, ParentId: '21'},
