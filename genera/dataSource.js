const timestamp_saved = '09/04/2023 05:40 PM';
const dataFechaAcualizado = '9/4/2023' + ' 1:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'41', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'45', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'55', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 44, MVar:'3', Cost:25.25, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'73', Cost:9.40, ParentId: '17'},
		]
	},
