const timestamp_saved = '10/28/2023 02:15 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:12.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'44', Cost:12.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'46', Cost:12.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 145,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'15', Cost:33.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:33.20, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 36, MVar:'73', Cost:32.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'126', Cost:16.99, ParentId: '16'},
		]
	},
