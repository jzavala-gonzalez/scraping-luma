const timestamp_saved = '10/16/2023 03:46 PM';
const dataFechaAcualizado = '10/16/2023' + ' 11:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'66', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'64', Cost:10.36, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'17', Cost:19.65, ParentId: '14'},
