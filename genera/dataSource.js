const timestamp_saved = '08/10/2023 06:20 PM';
const dataFechaAcualizado = '8/10/2023' + ' 2:15:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'95', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'53', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'55', Cost:11.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 104,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 20, MVar:'0', Cost:33.25, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:17.75, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'26', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'169', Cost:17.75, ParentId: '16'},
		]
	},
