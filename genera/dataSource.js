const timestamp_saved = '09/18/2023 05:25 PM';
const dataFechaAcualizado = '9/18/2023' + ' 1:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'81', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'81', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'51', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'52', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'64', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 146, MVar:'65', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:19.91, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'7', Cost:77.33, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'33', Cost:18.92, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'151', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'87', Cost:9.46, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 106,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 41, MVar:'13', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 23, MVar:'17', Cost:17, ParentId: '19'},
		]
	},
