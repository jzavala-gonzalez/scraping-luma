const timestamp_saved = '08/30/2023 06:55 AM';
const dataFechaAcualizado = '8/30/2023' + ' 2:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'44', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'45', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'57', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:21.20, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'54', Cost:16.66, ParentId: '15'},
