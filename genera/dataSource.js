const timestamp_saved = '09/17/2023 10:40 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'39', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'38', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'55', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'0', Cost:8.57, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:8.57, ParentId: '11'},
		]
	},
