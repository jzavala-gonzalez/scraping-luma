const timestamp_saved = '11/15/2023 11:15 PM';
const dataFechaAcualizado = '11/15/2023' + ' 7:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'62', Cost:10.68, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'88', Cost:16.81, ParentId: '15'},
