const timestamp_saved = '11/13/2023 10:45 PM';
const dataFechaAcualizado = '11/13/2023' + ' 6:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 550,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'67', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'73', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 202, MVar:'70', Cost:9.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 12, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'9', Cost:29.13, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'27', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'86', Cost:16.58, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'139', Cost:10.87, ParentId: '17'},
		]
	},
