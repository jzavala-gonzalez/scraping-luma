const timestamp_saved = '08/20/2023 03:55 AM';
const dataFechaAcualizado = '8/19/2023' + ' 11:52:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'58', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'58', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'58', Cost:11.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 139, MVar:'28', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:21.70, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'101', Cost:16.56, ParentId: '15'},
