const timestamp_saved = '10/17/2023 11:35 AM';
const dataFechaAcualizado = '10/17/2023' + ' 7:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'53', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.18, ParentId: '11'},
