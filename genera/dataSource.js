const timestamp_saved = '08/01/2023 04:55 PM';
const dataFechaAcualizado = '8/1/2023' + ' 12:50:36 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 947},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'48', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.72, ParentId: '7'},
		]
	},
