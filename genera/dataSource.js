const timestamp_saved = '11/12/2023 05:00 PM';
const dataFechaAcualizado = '11/12/2023' + ' 12:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'43', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'45', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'55', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'12', Cost:22.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'65', Cost:17.65, ParentId: '15'},
