const timestamp_saved = '11/25/2023 06:40 AM';
const dataFechaAcualizado = '11/25/2023' + ' 2:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 213,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 213, MVar:'60', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'21', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'32', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.80, ParentId: '7'},
		]
	},
