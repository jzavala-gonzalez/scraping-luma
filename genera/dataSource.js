const timestamp_saved = '10/14/2023 09:30 AM';
const dataFechaAcualizado = '10/14/2023' + ' 5:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'47', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'59', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'64', Cost:9.28, ParentId: '17'},
		]
	},
