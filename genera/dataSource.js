const timestamp_saved = '11/26/2023 04:20 AM';
const dataFechaAcualizado = '11/26/2023' + ' 12:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'24', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'35', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'49', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 106, MVar:'31', Cost:21.44, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:21.44, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'11', Cost:19.81, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:18.93, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'122', Cost:18.17, ParentId: '16'},
		]
	},
