const timestamp_saved = '07/28/2023 12:14 PM';
const dataFechaAcualizado = '7/28/2023' + ' 8:05:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'45', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'43', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.20, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'75', Cost:13.63, ParentId: '17'},
		]
	},
