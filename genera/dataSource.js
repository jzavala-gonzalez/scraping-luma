const timestamp_saved = '10/16/2023 05:25 PM';
const dataFechaAcualizado = '10/16/2023' + ' 1:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'70', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'71', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'66', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'35', Cost:17.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.09, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 34, MVar:'8', Cost:31.38, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:31.03, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 64,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 34, MVar:'9', Cost:31.14, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'96', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'177', Cost:17.34, ParentId: '16'},
		]
	},
