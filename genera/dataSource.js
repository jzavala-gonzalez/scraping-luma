const timestamp_saved = '10/05/2023 04:05 PM';
const dataFechaAcualizado = '10/5/2023' + ' 12:01:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'47', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'44', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'57', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'113', Cost:9.32, ParentId: '17'},
		]
	},
