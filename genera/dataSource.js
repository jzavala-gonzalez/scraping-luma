const timestamp_saved = '09/04/2023 10:55 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'37', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'41', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'135', Cost:17.30, ParentId: '16'},
		]
	},
