const timestamp_saved = '12/02/2023 08:20 PM';
const dataFechaAcualizado = '12/2/2023' + ' 4:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'53', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'54', Cost:11.06, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'88', Cost:11.01, ParentId: '17'},
		]
	},
