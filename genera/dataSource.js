const timestamp_saved = '08/07/2023 01:30 AM';
const dataFechaAcualizado = '8/6/2023' + ' 9:20:40 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 144},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'107', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'60', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'58', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'52', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:22.02, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.65, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'13', Cost:21.73, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'24', Cost:28.07, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'24', Cost:28.21, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'43', Cost:20.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:20.30, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:27.76, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:28.72, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 103,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'9', Cost:27.75, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'14', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 154, MVar:'27', Cost:15.59, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'122', Cost:11.61, ParentId: '17'},
		]
	},
