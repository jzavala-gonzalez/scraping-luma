const timestamp_saved = '08/27/2023 05:30 PM';
const dataFechaAcualizado = '8/27/2023' + ' 1:25:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 602},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'27', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'17', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'57', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'8', Cost:30.87, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'83', Cost:12.52, ParentId: '17'},
		]
	},
