const timestamp_saved = '10/01/2023 07:15 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 203, MVar:'60', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'28', Cost:12.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'26', Cost:12.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'46', Cost:12.98, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'0', Cost:26.57, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 208,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'49', Cost:17.58, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'122', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'91', Cost:9.50, ParentId: '17'},
		]
	},
