const timestamp_saved = '07/25/2023 03:46 AM';
const dataFechaAcualizado = '7/24/2023' + ' 11:40:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'63', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 513,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'61', Cost:10.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 167, MVar:'55', Cost:10.00, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 201,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'7', Cost:22.44, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 123,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'8', Cost:27.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'6', Cost:31.28, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'11', Cost:18.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'131', Cost:17.39, ParentId: '16'},
		]
	},
