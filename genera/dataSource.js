const timestamp_saved = '12/04/2023 03:40 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'53', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'55', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'56', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'76', Cost:11.45, ParentId: '17'},
		]
	},
