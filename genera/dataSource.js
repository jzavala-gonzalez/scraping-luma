const timestamp_saved = '10/15/2023 02:20 PM';
const dataFechaAcualizado = '10/15/2023' + ' 10:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'52', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'53', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'64', Cost:9.54, ParentId: '17'},
		]
	},
