const timestamp_saved = '11/26/2023 10:05 AM';
const dataFechaAcualizado = '11/26/2023' + ' 6:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'18', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'29', Cost:12.43, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.53, ParentId: '14'},
