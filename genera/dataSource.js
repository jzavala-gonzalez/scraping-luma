const timestamp_saved = '08/03/2023 08:05 PM';
const dataFechaAcualizado = '8/3/2023' + ' 4:00:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3583},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'50', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'50', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 38, MVar:'0', Cost:29.06, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:27.07, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'8', Cost:27.12, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:22.26, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:19.85, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 316,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'114', Cost:16.66, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'21', Cost:15.57, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'172', Cost:17.53, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'98', Cost:11.05, ParentId: '17'},
		]
	},
