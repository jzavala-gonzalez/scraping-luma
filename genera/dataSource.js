const timestamp_saved = '11/21/2023 12:00 PM';
const dataFechaAcualizado = '11/21/2023' + ' 7:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'28', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'39', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:17.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'81', Cost:9.60, ParentId: '17'},
		]
	},
