const timestamp_saved = '07/28/2023 06:35 PM';
const dataFechaAcualizado = '7/28/2023' + ' 2:30:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'55', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'51', Cost:10.35, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 30,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 147, MVar:'21', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'5', Cost:22.42, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'10', Cost:28.91, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'9', Cost:30.73, ParentId: '12'},
