const timestamp_saved = '08/02/2023 01:55 PM';
const dataFechaAcualizado = '8/2/2023' + ' 9:50:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'47', Cost:10.58, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'87', Cost:16.90, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'38', Cost:15.95, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'98', Cost:11.02, ParentId: '17'},
		]
	},
