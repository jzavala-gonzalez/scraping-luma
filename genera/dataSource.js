const timestamp_saved = '09/25/2023 05:35 PM';
const dataFechaAcualizado = '9/25/2023' + ' 1:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'45', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'46', Cost:10.67, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'11', Cost:31.86, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'39', Cost:20.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.26, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:31.61, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'86', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'172', Cost:17.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'93', Cost:9.60, ParentId: '17'},
		]
	},
