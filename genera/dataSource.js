const timestamp_saved = '09/24/2023 05:55 AM';
const dataFechaAcualizado = '9/24/2023' + ' 1:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'43', Cost:12.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'45', Cost:12.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'54', Cost:12.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'84', Cost:9.20, ParentId: '17'},
		]
	},
