const timestamp_saved = '09/19/2023 03:35 AM';
const dataFechaAcualizado = '9/18/2023' + ' 11:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'80', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'51', Cost:10.63, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'167', Cost:16.66, ParentId: '16'},
		]
	},
