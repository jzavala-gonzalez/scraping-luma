const timestamp_saved = '10/07/2023 02:35 PM';
const dataFechaAcualizado = '10/7/2023' + ' 10:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 131, MVar:'47', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'41', Cost:12.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'43', Cost:12.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'48', Cost:12.92, ParentId: '7'},
		]
	},
