const timestamp_saved = '08/13/2023 05:25 AM';
const dataFechaAcualizado = '8/13/2023' + ' 1:22:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 239, MVar:'85', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'96', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'41', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'45', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'44', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'149', Cost:17.08, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'117', Cost:12.26, ParentId: '17'},
		]
	},
