const timestamp_saved = '10/30/2023 07:40 PM';
const dataFechaAcualizado = '10/30/2023' + ' 3:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'66', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'67', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'166', Cost:16.93, ParentId: '16'},
		]
	},
