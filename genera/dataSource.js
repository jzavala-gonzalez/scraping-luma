const timestamp_saved = '10/03/2023 09:55 AM';
const dataFechaAcualizado = '10/3/2023' + ' 5:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'38', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'36', Cost:10.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'35', Cost:23.77, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'102', Cost:9.50, ParentId: '17'},
		]
	},
