const timestamp_saved = '08/14/2023 02:30 PM';
const dataFechaAcualizado = '8/14/2023' + ' 10:27:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'46', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'46', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:31.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'120', Cost:12.35, ParentId: '17'},
		]
	},
