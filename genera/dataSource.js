const timestamp_saved = '11/16/2023 09:15 AM';
const dataFechaAcualizado = '11/16/2023' + ' 5:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'45', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'44', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 190,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 190, MVar:'59', Cost:10.74, ParentId: '17'},
		]
	},
