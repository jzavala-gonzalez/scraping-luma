const timestamp_saved = '08/11/2023 06:25 PM';
const dataFechaAcualizado = '8/11/2023' + ' 2:20:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'52', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'47', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.51, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'134', Cost:11.71, ParentId: '17'},
		]
	},
