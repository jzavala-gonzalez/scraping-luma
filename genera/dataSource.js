const timestamp_saved = '10/23/2023 05:10 PM';
const dataFechaAcualizado = '10/23/2023' + ' 1:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'55', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'58', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'51', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 320, MVar:'146', Cost:16.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'89', Cost:11.33, ParentId: '17'},
		]
	},
