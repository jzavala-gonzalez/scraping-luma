const timestamp_saved = '09/12/2023 12:41 PM';
const dataFechaAcualizado = '9/12/2023' + ' 8:35:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'54', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'54', Cost:10.14, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'27', Cost:19.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'93', Cost:16.41, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'53', Cost:9.69, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 51,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 22, MVar:'8', Cost:19.60, ParentId: '19'},
