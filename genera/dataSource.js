const timestamp_saved = '11/23/2023 05:00 AM';
const dataFechaAcualizado = '11/23/2023' + ' 12:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'27', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'37', Cost:11.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'14', Cost:17.31, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'29', Cost:9.23, ParentId: '17'},
		]
	},
