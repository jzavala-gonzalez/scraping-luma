const timestamp_saved = '08/16/2023 07:40 AM';
const dataFechaAcualizado = '8/16/2023' + ' 3:37:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'49', Cost:10.92, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'78', Cost:10.48, ParentId: '17'},
		]
	},
