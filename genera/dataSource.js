const timestamp_saved = '08/01/2023 11:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 7:20:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'45', Cost:20.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.61, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'0', Cost:8.78, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:8.78, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'79', Cost:16.77, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'41', Cost:15.67, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'128', Cost:17.16, ParentId: '16'},
		]
	},
