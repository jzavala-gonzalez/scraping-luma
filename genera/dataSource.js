const timestamp_saved = '11/25/2023 08:00 AM';
const dataFechaAcualizado = '11/25/2023' + ' 3:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 227,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 227, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'19', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'28', Cost:13.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'47', Cost:13.51, ParentId: '7'},
		]
	},
