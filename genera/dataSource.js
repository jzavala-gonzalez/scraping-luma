const timestamp_saved = '10/31/2023 07:50 AM';
const dataFechaAcualizado = '10/31/2023' + ' 3:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'46', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'52', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'58', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'49', Cost:9.82, ParentId: '17'},
		]
	},
