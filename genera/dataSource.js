const timestamp_saved = '11/25/2023 05:55 AM';
const dataFechaAcualizado = '11/25/2023' + ' 1:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 201,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 201, MVar:'60', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'25', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'35', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'50', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 26,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 18, MVar:'0', Cost:31.66, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'16', Cost:9.84, ParentId: '17'},
		]
	},
