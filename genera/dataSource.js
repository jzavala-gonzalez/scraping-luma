const timestamp_saved = '08/13/2023 11:35 AM';
const dataFechaAcualizado = '8/13/2023' + ' 7:32:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'37', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'38', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'41', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'109', Cost:12.27, ParentId: '17'},
		]
	},
