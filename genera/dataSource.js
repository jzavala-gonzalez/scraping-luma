const timestamp_saved = '08/20/2023 11:00 AM';
const dataFechaAcualizado = '8/20/2023' + ' 6:57:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'47', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'46', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'55', Cost:9.30, ParentId: '17'},
		]
	},
