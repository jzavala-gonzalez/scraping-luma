const timestamp_saved = '11/07/2023 02:36 PM';
const dataFechaAcualizado = '11/7/2023' + ' 10:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'44', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:17.08, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:30.46, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 60, MVar:'12', Cost:20.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'88', Cost:9.78, ParentId: '17'},
		]
	},
