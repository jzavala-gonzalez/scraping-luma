const timestamp_saved = '10/14/2023 06:25 PM';
const dataFechaAcualizado = '10/14/2023' + ' 2:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'56', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'55', Cost:10.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:35.87, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'14', Cost:18.98, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'156', Cost:17.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'99', Cost:9.17, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 18, MVar:'0', Cost:71, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:45.23, ParentId: '21'},
