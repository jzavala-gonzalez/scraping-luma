const timestamp_saved = '10/15/2023 01:15 AM';
const dataFechaAcualizado = '10/14/2023' + ' 9:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'61', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'63', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'61', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:16.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'12', Cost:16.86, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'149', Cost:17.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'90', Cost:9.13, ParentId: '17'},
		]
	},
