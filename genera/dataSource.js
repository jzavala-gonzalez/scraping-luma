const timestamp_saved = '10/06/2023 04:00 AM';
const dataFechaAcualizado = '10/5/2023' + ' 11:56:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'41', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'39', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 117, MVar:'36', Cost:18.42, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:18.42, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:32.30, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'96', Cost:9.76, ParentId: '17'},
		]
	},
