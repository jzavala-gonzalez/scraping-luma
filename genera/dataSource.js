const timestamp_saved = '11/05/2023 11:11 PM';
const dataFechaAcualizado = '11/5/2023' + ' 7:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'56', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'55', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'50', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'4', Cost:55.52, ParentId: '12'},
