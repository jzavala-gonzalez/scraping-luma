const timestamp_saved = '08/04/2023 06:15 AM';
const dataFechaAcualizado = '8/4/2023' + ' 2:10:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:19.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'66', Cost:16.52, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'20', Cost:15.55, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'125', Cost:17.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 217,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 217, MVar:'76', Cost:11.76, ParentId: '17'},
		]
	},
