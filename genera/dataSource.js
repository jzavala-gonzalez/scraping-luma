const timestamp_saved = '11/16/2023 10:05 AM';
const dataFechaAcualizado = '11/16/2023' + ' 6:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'46', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:8.18, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 180,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 180, MVar:'65', Cost:10.91, ParentId: '17'},
		]
	},
