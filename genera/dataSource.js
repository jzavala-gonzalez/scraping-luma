const timestamp_saved = '10/12/2023 05:40 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'56', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'59', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'64', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'3', Cost:31.12, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:18.50, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.39, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'170', Cost:17.81, ParentId: '16'},
		]
	},
