const timestamp_saved = '10/21/2023 09:31 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'31', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'31', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'30', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'6', Cost:19.46, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'70', Cost:11.05, ParentId: '17'},
		]
	},
