const timestamp_saved = '12/03/2023 07:15 AM';
const dataFechaAcualizado = '12/3/2023' + ' 3:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 201,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 201, MVar:'60', Cost:4.38, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 138, MVar:'46', Cost:10.75, ParentId: '7'},
		]
	},
