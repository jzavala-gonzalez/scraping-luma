const timestamp_saved = '10/18/2023 10:40 AM';
const dataFechaAcualizado = '10/18/2023' + ' 6:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'40', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'45', Cost:10.56, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'70', Cost:23.29, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'91', Cost:10.57, ParentId: '17'},
		]
	},
