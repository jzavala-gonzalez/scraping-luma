const timestamp_saved = '08/30/2023 07:15 PM';
const dataFechaAcualizado = '8/30/2023' + ' 3:10:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'89', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'60', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'70', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'74', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:19.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:19.63, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'6', Cost:30.67, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'42', Cost:19.61, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'98', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'165', Cost:17.52, ParentId: '16'},
		]
	},
