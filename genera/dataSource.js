const timestamp_saved = '09/29/2023 03:15 AM';
const dataFechaAcualizado = '9/28/2023' + ' 11:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'42', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 73,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 6, MVar:'0', Cost:26.59, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:19.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'7', Cost:19.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'79', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'135', Cost:16.77, ParentId: '16'},
		]
	},
