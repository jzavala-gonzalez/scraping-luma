const timestamp_saved = '08/15/2023 08:45 AM';
const dataFechaAcualizado = '8/15/2023' + ' 4:42:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'44', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'160', Cost:18.19, ParentId: '16'},
		]
	},
