const timestamp_saved = '11/13/2023 07:30 AM';
const dataFechaAcualizado = '11/13/2023' + ' 3:26:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2476},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'38', Cost:13.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'43', Cost:13.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 101, MVar:'49', Cost:13.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'12', Cost:18.75, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'78', Cost:9.34, ParentId: '17'},
		]
	},
