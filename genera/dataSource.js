const timestamp_saved = '11/22/2023 09:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 5:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'22', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'31', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'47', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'67', Cost:9.76, ParentId: '17'},
		]
	},
