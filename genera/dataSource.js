const timestamp_saved = '11/03/2023 02:00 PM';
const dataFechaAcualizado = '11/3/2023' + ' 9:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'55', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'52', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'51', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:17.24, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'99', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'151', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'80', Cost:9.39, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 30, MVar:'20', Cost:19.60, ParentId: '19'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:26.69, ParentId: '21'},
