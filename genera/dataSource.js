const timestamp_saved = '08/14/2023 11:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 7:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'47', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'45', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'21', Cost:30.85, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 262,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 54, MVar:'13', Cost:40.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:40.33, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:32.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:32.08, ParentId: '13'},
