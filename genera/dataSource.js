const timestamp_saved = '08/17/2023 07:35 PM';
const dataFechaAcualizado = '8/17/2023' + ' 3:32:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'66', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'76', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'10', Cost:31.09, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:31.95, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'160', Cost:17.37, ParentId: '16'},
		]
	},
