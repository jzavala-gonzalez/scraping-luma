const timestamp_saved = '11/17/2023 11:20 PM';
const dataFechaAcualizado = '11/17/2023' + ' 7:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'80', Cost:9.76, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 47, MVar:'0', Cost:10.72, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:26.89, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'7', Cost:33.57, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:25.16, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'11', Cost:33.51, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'28', Cost:18.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'82', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'136', Cost:9.13, ParentId: '17'},
		]
	},
