const timestamp_saved = '09/28/2023 10:00 PM';
const dataFechaAcualizado = '9/28/2023' + ' 5:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'50', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.59, ParentId: '11'},
