const timestamp_saved = '11/25/2023 08:06 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'19', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'28', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'47', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'9', Cost:19.06, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'119', Cost:17.36, ParentId: '16'},
		]
	},
