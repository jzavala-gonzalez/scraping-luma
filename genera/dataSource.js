const timestamp_saved = '09/27/2023 02:20 AM';
const dataFechaAcualizado = '9/26/2023' + ' 10:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'54', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'53', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'60', Cost:10.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:29.14, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.72, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.22, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:18.22, ParentId: '11'},
		]
	},
