const timestamp_saved = '09/19/2023 05:55 PM';
const dataFechaAcualizado = '9/19/2023' + ' 1:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 164, MVar:'72', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'83', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'62', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'64', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'71', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 131,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'1', Cost:24.60, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.98, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.77, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 93, MVar:'0', Cost:8.59, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:8.59, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:30.96, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'5', Cost:29.48, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 78, MVar:'88', Cost:19.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'166', Cost:17.38, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 76,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 14, MVar:'16', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 25, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
