const timestamp_saved = '10/23/2023 11:20 AM';
const dataFechaAcualizado = '10/23/2023' + ' 7:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'43', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'22', Cost:19.56, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'124', Cost:17.40, ParentId: '16'},
		]
	},
