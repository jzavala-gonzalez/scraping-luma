const timestamp_saved = '10/25/2023 09:35 PM';
const dataFechaAcualizado = '10/25/2023' + ' 5:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'48', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'51', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'51', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'18', Cost:19.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'79', Cost:16.97, ParentId: '15'},
