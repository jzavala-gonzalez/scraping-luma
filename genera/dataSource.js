const timestamp_saved = '11/22/2023 07:05 PM';
const dataFechaAcualizado = '11/22/2023' + ' 3:01:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2148},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'36', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'46', Cost:10.45, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'96', Cost:9.76, ParentId: '17'},
		]
	},
