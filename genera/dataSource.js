const timestamp_saved = '11/21/2023 08:50 PM';
const dataFechaAcualizado = '11/21/2023' + ' 4:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'36', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'46', Cost:10.70, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'7', Cost:21.87, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'27', Cost:19.39, ParentId: '14'},
