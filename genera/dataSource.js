const timestamp_saved = '08/02/2023 04:40 AM';
const dataFechaAcualizado = '8/2/2023' + ' 12:35:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 138, MVar:'49', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:32.64, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:75.43, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'145', Cost:17.77, ParentId: '16'},
		]
	},
