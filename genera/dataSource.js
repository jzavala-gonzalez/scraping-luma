const timestamp_saved = '09/07/2023 03:00 PM';
const dataFechaAcualizado = '9/7/2023' + ' 10:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'57', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'47', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'49', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 108,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 124, MVar:'59', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'23', Cost:31.33, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:19.49, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'102', Cost:9.76, ParentId: '17'},
		]
	},
