const timestamp_saved = '10/29/2023 09:05 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'40', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'41', Cost:12.02, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'79', Cost:16.86, ParentId: '15'},
