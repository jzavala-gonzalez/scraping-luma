const timestamp_saved = '11/26/2023 10:15 PM';
const dataFechaAcualizado = '11/26/2023' + ' 6:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'46', Cost:10.39, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'16', Cost:43.81, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'95', Cost:9.56, ParentId: '17'},
		]
	},
