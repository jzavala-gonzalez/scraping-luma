const timestamp_saved = '08/18/2023 06:30 AM';
const dataFechaAcualizado = '8/18/2023' + ' 2:27:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'49', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'66', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'39', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'66', Cost:11.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 132, MVar:'13', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:28.59, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:19.46, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'118', Cost:18.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'55', Cost:9.44, ParentId: '17'},
		]
	},
