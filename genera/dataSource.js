const timestamp_saved = '10/22/2023 12:15 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'37', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'38', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'44', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'3', Cost:19.44, ParentId: '14'},
