const timestamp_saved = '11/20/2023 03:00 PM';
const dataFechaAcualizado = '11/20/2023' + ' 10:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'38', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'48', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'61', Cost:10.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.43, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'180', Cost:18.24, ParentId: '16'},
		]
	},
