const timestamp_saved = '11/15/2023 09:10 PM';
const dataFechaAcualizado = '11/15/2023' + ' 5:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'61', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'61', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'61', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 24,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'10', Cost:43.98, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'160', Cost:17.15, ParentId: '16'},
		]
	},
