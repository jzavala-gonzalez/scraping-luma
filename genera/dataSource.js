const timestamp_saved = '11/04/2023 02:00 PM';
const dataFechaAcualizado = '11/4/2023' + ' 9:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'44', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'43', Cost:12.29, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'85', Cost:16.76, ParentId: '15'},
