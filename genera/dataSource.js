const timestamp_saved = '12/04/2023 05:25 AM';
const dataFechaAcualizado = '12/4/2023' + ' 1:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'39', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'40', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'47', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'111', Cost:18.82, ParentId: '16'},
		]
	},
