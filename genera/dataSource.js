const timestamp_saved = '08/26/2023 05:25 PM';
const dataFechaAcualizado = '8/26/2023' + ' 1:20:49 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2170},
	{Index:'1', Desc:'PREPA', value: 69},
	{Index:'2', Desc:'COGEN', value: 31},
	{Index:'3', Desc:'Reserva en Rotación', value: 372},
	{Index:'4', Desc:'Reserva Operacional', value: 668},
	{Index:'5', Desc:'Capacidad Disponible', value: 2842},
	{Index:'6', Desc:'Próxima Hora MW', value: 2222},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'78', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:0, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 93, MVar:'0', Cost:2.80, ParentId: '8'},
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:17.90, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 143, MVar:'31', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:22.12, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:26.05, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'9', Cost:30.88, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'11', Cost:31.48, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:19.70, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'6', Cost:31.43, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:31.52, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 55,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'8', Cost:31.27, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'16', Cost:18.98, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'69', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'117', Cost:17.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'128', Cost:16.26, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 5, MVar:'3', Cost:21.43, ParentId: '19'},
			{Index:'2', Unit:'Horizon', MW: 2, MVar:'5', Cost:19.60, ParentId: '19'},
			{Index:'3', Unit:'Coto Laurel', MW: 0, MVar:'0', Cost:19.10, ParentId: '19'},
			{Index:'4', Unit:'Oriana', MW: 21, MVar:'28', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 28, MVar:'9', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 12, MVar:'0', Cost:0, ParentId: '21'},
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:22.13, ParentId: '21'},
