const timestamp_saved = '08/13/2023 10:30 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:27:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'35', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'37', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'39', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'144', Cost:16.92, ParentId: '16'},
		]
	},
