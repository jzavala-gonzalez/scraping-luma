const timestamp_saved = '11/23/2023 07:10 AM';
const dataFechaAcualizado = '11/23/2023' + ' 3:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'19', Cost:13.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'27', Cost:13.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'47', Cost:13.55, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'115', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'56', Cost:9.31, ParentId: '17'},
		]
	},
