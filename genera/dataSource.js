const timestamp_saved = '10/01/2023 10:45 AM';
const dataFechaAcualizado = '10/1/2023' + ' 6:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'59', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 100, MVar:'53', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'26', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'24', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'41', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'2', Cost:31.05, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'113', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'81', Cost:9.47, ParentId: '17'},
		]
	},
