const timestamp_saved = '08/11/2023 04:15 PM';
const dataFechaAcualizado = '8/11/2023' + ' 12:10:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'48', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'45', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.92, ParentId: '13'},
