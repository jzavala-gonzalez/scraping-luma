const timestamp_saved = '12/02/2023 05:05 PM';
const dataFechaAcualizado = '12/2/2023' + ' 1:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'43', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'45', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'64', Cost:11.92, ParentId: '17'},
		]
	},
