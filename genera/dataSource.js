const timestamp_saved = '10/13/2023 11:35 AM';
const dataFechaAcualizado = '10/13/2023' + ' 7:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'57', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'61', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'66', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'72', Cost:9.14, ParentId: '17'},
		]
	},
