const timestamp_saved = '09/01/2023 05:20 AM';
const dataFechaAcualizado = '9/1/2023' + ' 1:15:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'39', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'46', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'46', Cost:18.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:18.66, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'26', Cost:19.47, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'140', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'78', Cost:9.19, ParentId: '17'},
		]
	},
