const timestamp_saved = '10/16/2023 02:20 PM';
const dataFechaAcualizado = '10/16/2023' + ' 10:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'61', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'61', Cost:10.76, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:17.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.01, ParentId: '14'},
