const timestamp_saved = '11/18/2023 05:30 PM';
const dataFechaAcualizado = '11/18/2023' + ' 1:26:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2670},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 255,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'102', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:14.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:17.15, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'92', Cost:16.70, ParentId: '15'},
