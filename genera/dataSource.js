const timestamp_saved = '11/17/2023 09:05 AM';
const dataFechaAcualizado = '11/17/2023' + ' 5:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'49', Cost:12.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'49', Cost:12.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'40', Cost:12.23, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.87, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'69', Cost:16.88, ParentId: '15'},
