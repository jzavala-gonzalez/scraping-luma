const timestamp_saved = '08/15/2023 12:10 AM';
const dataFechaAcualizado = '8/14/2023' + ' 8:07:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:9.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'61', Cost:9.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'55', Cost:9.84, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:22.02, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'29', Cost:28.06, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:25.83, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'11', Cost:28.70, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'25', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'206', Cost:16.62, ParentId: '16'},
		]
	},
