const timestamp_saved = '08/04/2023 09:00 AM';
const dataFechaAcualizado = '8/4/2023' + ' 4:55:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'67', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'38', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'43', Cost:11.10, ParentId: '7'},
		]
	},
