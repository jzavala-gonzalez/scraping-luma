const timestamp_saved = '10/12/2023 05:55 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'58', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'62', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'66', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:34.60, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'4', Cost:30.87, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 209,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'151', Cost:18.29, ParentId: '16'},
		]
	},
