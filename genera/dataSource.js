const timestamp_saved = '07/31/2023 06:55 PM';
const dataFechaAcualizado = '7/31/2023' + ' 2:50:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'54', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'55', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'28', Cost:31.48, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 320,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'85', Cost:16.78, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'54', Cost:15.57, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'152', Cost:17.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'110', Cost:11.02, ParentId: '17'},
		]
	},
