const timestamp_saved = '09/29/2023 07:30 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'32', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'30', Cost:12.90, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.48, ParentId: '11'},
