const timestamp_saved = '10/23/2023 09:05 AM';
const dataFechaAcualizado = '10/23/2023' + ' 5:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'37', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'37', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'38', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'47', Cost:11.27, ParentId: '17'},
		]
	},
