const timestamp_saved = '11/23/2023 12:40 PM';
const dataFechaAcualizado = '11/23/2023' + ' 8:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'72', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'20', Cost:12.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'30', Cost:12.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'47', Cost:12.27, ParentId: '7'},
		]
	},
