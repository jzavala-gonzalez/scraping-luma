const timestamp_saved = '09/16/2023 09:35 PM';
const dataFechaAcualizado = '9/16/2023' + ' 5:30:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'46', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'61', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.58, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'100', Cost:9.10, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 13,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'3', Cost:19.60, ParentId: '19'},
