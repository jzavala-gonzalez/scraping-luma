const timestamp_saved = '08/02/2023 06:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 2:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'40', Cost:10.59, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'66', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'40', Cost:16.04, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'83', Cost:10.99, ParentId: '17'},
		]
	},
