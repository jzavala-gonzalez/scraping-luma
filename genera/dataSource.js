const timestamp_saved = '07/31/2023 09:55 PM';
const dataFechaAcualizado = '7/31/2023' + ' 5:50:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'46', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'51', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:43.79, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:19.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:19.20, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'76', Cost:16.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'152', Cost:17.59, ParentId: '16'},
		]
	},
