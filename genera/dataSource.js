const timestamp_saved = '10/26/2023 08:26 AM';
const dataFechaAcualizado = '10/26/2023' + ' 4:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'35', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'37', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'42', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'45', Cost:18.46, ParentId: '15'},
