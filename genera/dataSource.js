const timestamp_saved = '11/16/2023 03:45 PM';
const dataFechaAcualizado = '11/16/2023' + ' 11:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'51', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'51', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'51', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'25', Cost:18.96, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'81', Cost:9.80, ParentId: '17'},
		]
	},
