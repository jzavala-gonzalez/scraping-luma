const timestamp_saved = '08/22/2023 07:15 AM';
const dataFechaAcualizado = '8/22/2023' + ' 3:10:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'50', Cost:10.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:20.31, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'117', Cost:18.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'53', Cost:10.01, ParentId: '17'},
		]
	},
