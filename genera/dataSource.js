const timestamp_saved = '08/14/2023 03:00 PM';
const dataFechaAcualizado = '8/14/2023' + ' 10:57:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'46', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:17.73, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'25', Cost:31.38, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.38, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'9', Cost:31.40, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:31.52, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 27, MVar:'8', Cost:31.46, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'162', Cost:16.95, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 112,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 34, MVar:'13', Cost:17, ParentId: '19'},
		]
	},
