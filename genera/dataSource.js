const timestamp_saved = '09/28/2023 06:30 PM';
const dataFechaAcualizado = '9/28/2023' + ' 2:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'33', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'34', Cost:10.62, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'143', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'98', Cost:9.41, ParentId: '17'},
		]
	},
