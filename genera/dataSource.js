const timestamp_saved = '09/01/2023 05:10 PM';
const dataFechaAcualizado = '9/1/2023' + ' 1:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'45', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'53', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'60', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 81, MVar:'0', Cost:5.76, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'84', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 191,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 191, MVar:'68', Cost:10.67, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 116,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 42, MVar:'21', Cost:19.60, ParentId: '19'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:25.58, ParentId: '21'},
