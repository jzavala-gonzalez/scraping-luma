const timestamp_saved = '10/13/2023 11:30 PM';
const dataFechaAcualizado = '10/13/2023' + ' 7:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'74', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'77', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'79', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:16.96, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'46', Cost:8.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:8.14, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'9', Cost:28.32, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'17', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'93', Cost:16.67, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'121', Cost:9.13, ParentId: '17'},
		]
	},
