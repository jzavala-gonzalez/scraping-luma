const timestamp_saved = '08/03/2023 04:15 PM';
const dataFechaAcualizado = '8/3/2023' + ' 12:10:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'48', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'111', Cost:17.06, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'20', Cost:15.64, ParentId: '15'},
		]
	},
