const timestamp_saved = '10/31/2023 02:16 PM';
const dataFechaAcualizado = '10/31/2023' + ' 10:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'62', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'60', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:36.26, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'15', Cost:20.96, ParentId: '14'},
