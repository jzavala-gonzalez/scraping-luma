const timestamp_saved = '12/03/2023 08:10 AM';
const dataFechaAcualizado = '12/3/2023' + ' 4:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'57', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'37', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'39', Cost:11.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.98, ParentId: '11'},
