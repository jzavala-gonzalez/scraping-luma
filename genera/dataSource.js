const timestamp_saved = '08/11/2023 03:50 PM';
const dataFechaAcualizado = '8/11/2023' + ' 11:45:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'47', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'45', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'131', Cost:11.70, ParentId: '17'},
		]
	},
