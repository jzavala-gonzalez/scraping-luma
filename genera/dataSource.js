const timestamp_saved = '10/20/2023 05:55 AM';
const dataFechaAcualizado = '10/20/2023' + ' 1:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'35', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'42', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'41', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 206,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 206, MVar:'133', Cost:18.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'86', Cost:10.54, ParentId: '17'},
		]
	},
