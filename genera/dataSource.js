const timestamp_saved = '10/30/2023 09:15 PM';
const dataFechaAcualizado = '10/30/2023' + ' 5:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'57', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'61', Cost:10.73, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'11', Cost:43.55, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 324, MVar:'165', Cost:17.22, ParentId: '16'},
		]
	},
