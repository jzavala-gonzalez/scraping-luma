const timestamp_saved = '10/20/2023 12:35 PM';
const dataFechaAcualizado = '10/20/2023' + ' 8:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'53', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'49', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 247,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 247, MVar:'155', Cost:17.90, ParentId: '16'},
		]
	},
