const timestamp_saved = '11/03/2023 05:30 AM';
const dataFechaAcualizado = '11/3/2023' + ' 1:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'48', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'45', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:25.86, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:33.07, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:30.93, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'76', Cost:16.90, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'65', Cost:9.23, ParentId: '17'},
		]
	},
