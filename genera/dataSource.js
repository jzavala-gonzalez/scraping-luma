const timestamp_saved = '08/27/2023 04:55 PM';
const dataFechaAcualizado = '8/27/2023' + ' 12:50:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'29', Cost:13.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 63, MVar:'12', Cost:13.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 100, MVar:'57', Cost:13.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 46,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'6', Cost:30.67, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:20.28, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'28', Cost:18.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'78', Cost:16.21, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'124', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'80', Cost:12.51, ParentId: '17'},
		]
	},
