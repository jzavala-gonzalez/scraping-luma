const timestamp_saved = '11/11/2023 03:20 PM';
const dataFechaAcualizado = '11/11/2023' + ' 11:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'42', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'44', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.32, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'101', Cost:16.74, ParentId: '15'},
