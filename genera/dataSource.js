const timestamp_saved = '10/08/2023 04:10 PM';
const dataFechaAcualizado = '10/8/2023' + ' 12:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'42', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'44', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'41', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'97', Cost:16.74, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 159, MVar:'76', Cost:11.45, ParentId: '17'},
		]
	},
