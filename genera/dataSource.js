const timestamp_saved = '11/13/2023 02:35 AM';
const dataFechaAcualizado = '11/12/2023' + ' 10:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'59', Cost:14.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'61', Cost:14.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:14.75, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'7', Cost:29.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'16', Cost:29.43, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'67', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'113', Cost:9.16, ParentId: '17'},
		]
	},
