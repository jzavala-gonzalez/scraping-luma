const timestamp_saved = '08/03/2023 01:45 PM';
const dataFechaAcualizado = '8/3/2023' + ' 9:40:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'46', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'45', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'48', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'144', Cost:18.23, ParentId: '16'},
		]
	},
