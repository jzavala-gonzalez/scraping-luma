const timestamp_saved = '11/22/2023 04:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 11:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'31', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'41', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'55', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'91', Cost:9.81, ParentId: '17'},
		]
	},
