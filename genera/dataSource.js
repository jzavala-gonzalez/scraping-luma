const timestamp_saved = '11/14/2023 04:55 AM';
const dataFechaAcualizado = '11/14/2023' + ' 12:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'46', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'50', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'53', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'97', Cost:10.86, ParentId: '17'},
		]
	},
