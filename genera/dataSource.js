const timestamp_saved = '09/19/2023 05:55 AM';
const dataFechaAcualizado = '9/19/2023' + ' 1:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'48', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'46', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'62', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 126, MVar:'0', Cost:9.24, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:9.24, ParentId: '11'},
		]
	},
