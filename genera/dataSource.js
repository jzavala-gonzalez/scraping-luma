const timestamp_saved = '09/22/2023 08:40 AM';
const dataFechaAcualizado = '9/22/2023' + ' 4:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'41', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'60', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 117,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 18, MVar:'0', Cost:31.37, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 132, MVar:'39', Cost:20.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:20.67, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'63', Cost:16.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'71', Cost:32.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'78', Cost:17.21, ParentId: '17'},
		]
	},
