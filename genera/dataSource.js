const timestamp_saved = '11/21/2023 07:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'21', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'30', Cost:12.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.31, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'72', Cost:9.22, ParentId: '17'},
		]
	},
