const timestamp_saved = '09/02/2023 03:40 PM';
const dataFechaAcualizado = '9/2/2023' + ' 11:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 160, MVar:'72', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'45', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'52', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'62', Cost:10.69, ParentId: '7'},
		]
	},
