const timestamp_saved = '09/26/2023 11:40 PM';
const dataFechaAcualizado = '9/26/2023' + ' 7:35:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3101},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'65', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'9', Cost:26.57, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'27', Cost:31.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'48', Cost:17.55, ParentId: '11'},
