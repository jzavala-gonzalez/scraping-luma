const timestamp_saved = '08/03/2023 07:15 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:10:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'39', Cost:11.16, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 235,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'42', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'36', Cost:16.87, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'78', Cost:11.31, ParentId: '17'},
		]
	},
