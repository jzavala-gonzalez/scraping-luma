const timestamp_saved = '10/12/2023 03:55 PM';
const dataFechaAcualizado = '10/12/2023' + ' 11:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 240,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'85', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'56', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'63', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'66', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.06, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'181', Cost:17.34, ParentId: '16'},
		]
	},
