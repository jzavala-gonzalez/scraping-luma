const timestamp_saved = '12/04/2023 01:02 AM';
const dataFechaAcualizado = '12/3/2023' + ' 8:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'52', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'54', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'139', Cost:17.53, ParentId: '16'},
		]
	},
