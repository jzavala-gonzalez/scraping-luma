const timestamp_saved = '12/04/2023 02:20 PM';
const dataFechaAcualizado = '12/4/2023' + ' 10:16:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1101},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'51', Cost:11.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'53', Cost:11.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.89, ParentId: '7'},
		]
	},
