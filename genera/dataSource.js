const timestamp_saved = '10/27/2023 11:55 AM';
const dataFechaAcualizado = '10/27/2023' + ' 7:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'47', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.32, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.63, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'48', Cost:17.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:17.08, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'46', Cost:17.17, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 113, MVar:'106', Cost:17.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'0', Cost:17.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'9', Cost:11.52, ParentId: '17'},
		]
	},
