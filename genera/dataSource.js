const timestamp_saved = '08/21/2023 01:55 AM';
const dataFechaAcualizado = '8/20/2023' + ' 9:52:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'61', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'48', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'60', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'7', Cost:19.07, ParentId: '14'},
