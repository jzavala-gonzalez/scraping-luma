const timestamp_saved = '10/29/2023 06:50 PM';
const dataFechaAcualizado = '10/29/2023' + ' 2:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'52', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'72', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:18.14, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'47', Cost:17.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:17.01, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.17, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:30.25, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'128', Cost:16.97, ParentId: '16'},
		]
	},
