const timestamp_saved = '11/12/2023 03:50 AM';
const dataFechaAcualizado = '11/11/2023' + ' 11:46:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'46', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'50', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'57', Cost:11.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'21', Cost:0, ParentId: '8'},
