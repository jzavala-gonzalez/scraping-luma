const timestamp_saved = '10/29/2023 11:15 AM';
const dataFechaAcualizado = '10/29/2023' + ' 7:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'44', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'68', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'4', Cost:19.50, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.66, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'112', Cost:17.39, ParentId: '16'},
		]
	},
