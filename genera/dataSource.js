const timestamp_saved = '11/30/2023 07:00 AM';
const dataFechaAcualizado = '11/30/2023' + ' 2:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'36', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'41', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'44', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'61', Cost:9.78, ParentId: '17'},
		]
	},
