const timestamp_saved = '08/10/2023 05:35 AM';
const dataFechaAcualizado = '8/10/2023' + ' 1:30:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'56', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'56', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:28.56, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:26.73, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:30.73, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'165', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'74', Cost:11.99, ParentId: '17'},
		]
	},
