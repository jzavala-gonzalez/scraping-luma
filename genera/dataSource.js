const timestamp_saved = '10/28/2023 11:50 PM';
const dataFechaAcualizado = '10/28/2023' + ' 7:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'53', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'56', Cost:11.21, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'77', Cost:16.87, ParentId: '15'},
