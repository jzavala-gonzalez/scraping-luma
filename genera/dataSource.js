const timestamp_saved = '11/25/2023 05:20 AM';
const dataFechaAcualizado = '11/25/2023' + ' 1:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 194,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 194, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'27', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'35', Cost:12.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'51', Cost:12.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 30, MVar:'0', Cost:26.10, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 39,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 9, MVar:'2', Cost:30.67, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.67, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'133', Cost:17.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'18', Cost:9.51, ParentId: '17'},
		]
	},
