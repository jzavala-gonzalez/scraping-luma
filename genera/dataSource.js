const timestamp_saved = '08/17/2023 05:25 PM';
const dataFechaAcualizado = '8/17/2023' + ' 1:22:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'70', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'77', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:19.66, ParentId: '11'},
