const timestamp_saved = '11/18/2023 09:55 AM';
const dataFechaAcualizado = '11/18/2023' + ' 5:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'40', Cost:16.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'64', Cost:16.05, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'11', Cost:28.97, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'72', Cost:16.91, ParentId: '15'},
