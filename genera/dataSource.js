const timestamp_saved = '10/20/2023 10:00 AM';
const dataFechaAcualizado = '10/20/2023' + ' 5:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'35', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'41', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'89', Cost:10.54, ParentId: '17'},
		]
	},
