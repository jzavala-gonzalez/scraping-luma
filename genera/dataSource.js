const timestamp_saved = '10/16/2023 04:50 AM';
const dataFechaAcualizado = '10/16/2023' + ' 12:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'50', Cost:12.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'49', Cost:12.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'53', Cost:12.72, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'4', Cost:19.33, ParentId: '14'},
