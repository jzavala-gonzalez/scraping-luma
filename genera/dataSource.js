const timestamp_saved = '10/20/2023 11:10 AM';
const dataFechaAcualizado = '10/20/2023' + ' 7:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'38', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'45', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'43', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'95', Cost:10.52, ParentId: '17'},
		]
	},
