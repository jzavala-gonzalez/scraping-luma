const timestamp_saved = '10/01/2023 04:45 AM';
const dataFechaAcualizado = '10/1/2023' + ' 12:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 502,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'63', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'30', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'26', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'46', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 208,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.75, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'13', Cost:19.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'118', Cost:17.82, ParentId: '16'},
		]
	},
