const timestamp_saved = '10/03/2023 03:30 PM';
const dataFechaAcualizado = '10/3/2023' + ' 11:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'42', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'39', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'7', Cost:17.44, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'112', Cost:9.17, ParentId: '17'},
		]
	},
