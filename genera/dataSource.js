const timestamp_saved = '10/07/2023 12:15 AM';
const dataFechaAcualizado = '10/6/2023' + ' 8:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'62', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'62', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'62', Cost:9.75, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 65, MVar:'0', Cost:14.83, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'10', Cost:22.01, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:20.81, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:27.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'10', Cost:19.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'89', Cost:17.03, ParentId: '15'},
