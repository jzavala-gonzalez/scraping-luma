const timestamp_saved = '10/25/2023 05:35 PM';
const dataFechaAcualizado = '10/25/2023' + ' 1:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'48', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'52', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 135, MVar:'41', Cost:16.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:16.78, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:17.41, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:17.41, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'161', Cost:17.38, ParentId: '16'},
		]
	},
