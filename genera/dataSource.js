const timestamp_saved = '11/29/2023 11:35 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 127, MVar:'44', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'72', Cost:9.51, ParentId: '17'},
		]
	},
