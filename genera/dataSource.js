const timestamp_saved = '12/05/2023 12:10 PM';
const dataFechaAcualizado = '12/5/2023' + ' 8:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'47', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'50', Cost:10.76, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'68', Cost:11.17, ParentId: '17'},
		]
	},
