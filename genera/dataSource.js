const timestamp_saved = '10/19/2023 02:50 AM';
const dataFechaAcualizado = '10/18/2023' + ' 10:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'49', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'63', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.49, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:31.86, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'12', Cost:18.29, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'102', Cost:10.51, ParentId: '17'},
		]
	},
