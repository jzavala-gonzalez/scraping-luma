const timestamp_saved = '10/21/2023 01:40 PM';
const dataFechaAcualizado = '10/21/2023' + ' 9:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'40', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'37', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'38', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'71', Cost:11.04, ParentId: '17'},
		]
	},
