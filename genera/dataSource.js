const timestamp_saved = '10/26/2023 02:45 AM';
const dataFechaAcualizado = '10/25/2023' + ' 10:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'46', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'47', Cost:10.78, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 10, MVar:'1', Cost:30.04, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'50', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'143', Cost:17.09, ParentId: '16'},
		]
	},
