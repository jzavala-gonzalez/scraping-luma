const timestamp_saved = '12/02/2023 10:05 PM';
const dataFechaAcualizado = '12/2/2023' + ' 6:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'56', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'58', Cost:10.51, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:19.52, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'100', Cost:10.85, ParentId: '17'},
		]
	},
