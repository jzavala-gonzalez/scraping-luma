const timestamp_saved = '10/02/2023 03:20 AM';
const dataFechaAcualizado = '10/1/2023' + ' 11:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'36', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'33', Cost:10.68, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:12.34, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 1, MVar:'0', Cost:34.31, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:8.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:8.35, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:31.82, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'7', Cost:19.31, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'79', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 344, MVar:'141', Cost:16.76, ParentId: '16'},
		]
	},
