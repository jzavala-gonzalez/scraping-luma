const timestamp_saved = '07/28/2023 04:15 PM';
const dataFechaAcualizado = '7/28/2023' + ' 12:10:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'52', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'50', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'4', Cost:22.57, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:19.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:19.79, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'91', Cost:13.50, ParentId: '17'},
		]
	},
