const timestamp_saved = '11/16/2023 04:30 PM';
const dataFechaAcualizado = '11/16/2023' + ' 12:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'51', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'51', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'52', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:17.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'10', Cost:17.22, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'23', Cost:19.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'148', Cost:19.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'84', Cost:9.68, ParentId: '17'},
		]
	},
