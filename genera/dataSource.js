const timestamp_saved = '09/24/2023 11:50 PM';
const dataFechaAcualizado = '9/24/2023' + ' 7:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'55', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'57', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'62', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:20.07, ParentId: '11'},
