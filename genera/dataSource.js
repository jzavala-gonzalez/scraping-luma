const timestamp_saved = '12/05/2023 06:45 AM';
const dataFechaAcualizado = '12/5/2023' + ' 2:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'40', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'51', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'50', Cost:11.38, ParentId: '17'},
		]
	},
