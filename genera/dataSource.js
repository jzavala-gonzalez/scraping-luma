const timestamp_saved = '09/28/2023 05:55 AM';
const dataFechaAcualizado = '9/28/2023' + ' 1:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'20', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'20', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'44', Cost:11.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 79,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.60, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:8.82, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 142,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 142, MVar:'115', Cost:20.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'70', Cost:9.75, ParentId: '17'},
		]
	},
