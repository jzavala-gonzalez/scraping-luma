const timestamp_saved = '10/25/2023 02:45 PM';
const dataFechaAcualizado = '10/25/2023' + ' 10:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'49', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'53', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'81', Cost:16.82, ParentId: '15'},
