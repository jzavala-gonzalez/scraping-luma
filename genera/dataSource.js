const timestamp_saved = '11/06/2023 02:00 AM';
const dataFechaAcualizado = '11/5/2023' + ' 9:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'51', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'50', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'48', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 161,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.94, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:26.70, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'76', Cost:9.22, ParentId: '17'},
		]
	},
