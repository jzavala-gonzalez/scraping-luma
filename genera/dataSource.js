const timestamp_saved = '10/11/2023 12:56 PM';
const dataFechaAcualizado = '10/11/2023' + ' 8:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'52', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'57', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.92, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'70', Cost:9.31, ParentId: '17'},
		]
	},
