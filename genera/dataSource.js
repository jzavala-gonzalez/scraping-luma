const timestamp_saved = '08/05/2023 06:00 PM';
const dataFechaAcualizado = '8/5/2023' + ' 1:55:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'45', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.33, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'97', Cost:11.76, ParentId: '17'},
		]
	},
