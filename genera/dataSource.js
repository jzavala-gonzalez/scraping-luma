const timestamp_saved = '08/05/2023 01:45 PM';
const dataFechaAcualizado = '8/5/2023' + ' 9:40:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'41', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'47', Cost:11.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:20.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'0', Cost:20.51, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.64, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'32', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'84', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'92', Cost:11.68, ParentId: '17'},
		]
	},
