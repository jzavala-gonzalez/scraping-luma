const timestamp_saved = '11/28/2023 02:50 AM';
const dataFechaAcualizado = '11/27/2023' + ' 10:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'32', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'57', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 6,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 6, MVar:'1', Cost:22.93, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:19.19, ParentId: '14'},
