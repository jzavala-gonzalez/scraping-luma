const timestamp_saved = '09/24/2023 01:30 PM';
const dataFechaAcualizado = '9/24/2023' + ' 9:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:11.02, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 276, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 76,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 18, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
