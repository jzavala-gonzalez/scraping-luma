const timestamp_saved = '08/04/2023 02:05 AM';
const dataFechaAcualizado = '8/3/2023' + ' 10:00:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'45', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:30.70, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'100', Cost:10.86, ParentId: '17'},
		]
	},
