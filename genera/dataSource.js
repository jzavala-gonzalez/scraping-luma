const timestamp_saved = '10/01/2023 01:40 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 261,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'76', Cost:4.46, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 9, MVar:'34', Cost:4.46, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'28', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'25', Cost:10.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'50', Cost:8.24, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'108', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'85', Cost:9.50, ParentId: '17'},
		]
	},
