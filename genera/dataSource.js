const timestamp_saved = '10/13/2023 07:45 AM';
const dataFechaAcualizado = '10/13/2023' + ' 3:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'55', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'61', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'65', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.51, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'67', Cost:9.16, ParentId: '17'},
		]
	},
