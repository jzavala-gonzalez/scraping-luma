const timestamp_saved = '09/22/2023 12:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 8:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 558,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'53', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'70', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 36, MVar:'4', Cost:22.75, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'11', Cost:27.99, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'46', Cost:19.87, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 33,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'5', Cost:31.00, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'5', Cost:30.71, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'19', Cost:18.76, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 179,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 179, MVar:'96', Cost:16.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'125', Cost:32.75, ParentId: '16'},
		]
	},
