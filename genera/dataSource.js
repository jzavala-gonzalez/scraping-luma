const timestamp_saved = '09/26/2023 10:50 AM';
const dataFechaAcualizado = '9/26/2023' + ' 6:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'56', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'60', Cost:9.76, ParentId: '17'},
		]
	},
