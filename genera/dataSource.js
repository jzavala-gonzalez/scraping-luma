const timestamp_saved = '11/17/2023 10:05 AM';
const dataFechaAcualizado = '11/17/2023' + ' 6:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'54', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'54', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'42', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'90', Cost:9.83, ParentId: '17'},
		]
	},
