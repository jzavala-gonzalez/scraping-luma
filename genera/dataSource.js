const timestamp_saved = '08/28/2023 11:45 AM';
const dataFechaAcualizado = '8/28/2023' + ' 7:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'39', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'94', Cost:12.03, ParentId: '17'},
		]
	},
