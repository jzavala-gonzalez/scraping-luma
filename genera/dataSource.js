const timestamp_saved = '08/19/2023 01:20 PM';
const dataFechaAcualizado = '8/19/2023' + ' 9:17:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'50', Cost:10.71, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'68', Cost:9.19, ParentId: '17'},
		]
	},
