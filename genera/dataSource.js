const timestamp_saved = '11/13/2023 05:45 AM';
const dataFechaAcualizado = '11/13/2023' + ' 1:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 87, MVar:'46', Cost:21.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'50', Cost:21.00, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'7', Cost:27.89, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'59', Cost:16.89, ParentId: '15'},
