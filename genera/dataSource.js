const timestamp_saved = '12/01/2023 01:25 PM';
const dataFechaAcualizado = '12/1/2023' + ' 9:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'49', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'50', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'53', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'75', Cost:9.54, ParentId: '17'},
		]
	},
