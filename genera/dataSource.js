const timestamp_saved = '08/13/2023 07:40 PM';
const dataFechaAcualizado = '8/13/2023' + ' 3:37:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'36', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'40', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'41', Cost:10.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'43', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 33,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 33, MVar:'10', Cost:45.59, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'110', Cost:12.24, ParentId: '17'},
		]
	},
