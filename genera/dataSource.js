const timestamp_saved = '11/29/2023 02:05 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'47', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'46', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'77', Cost:9.46, ParentId: '17'},
		]
	},
