const timestamp_saved = '09/01/2023 12:05 PM';
const dataFechaAcualizado = '9/1/2023' + ' 8:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'43', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'50', Cost:10.47, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'66', Cost:16.77, ParentId: '15'},
