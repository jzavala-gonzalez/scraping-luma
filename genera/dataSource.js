const timestamp_saved = '09/29/2023 05:05 AM';
const dataFechaAcualizado = '9/29/2023' + ' 1:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'32', Cost:11.35, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 20, MVar:'0', Cost:26.35, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'110', Cost:18.88, ParentId: '16'},
		]
	},
