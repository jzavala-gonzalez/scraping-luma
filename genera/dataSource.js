const timestamp_saved = '10/30/2023 08:40 PM';
const dataFechaAcualizado = '10/30/2023' + ' 4:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'61', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'64', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'68', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'166', Cost:17.15, ParentId: '16'},
		]
	},
