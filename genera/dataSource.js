const timestamp_saved = '08/07/2023 11:10 AM';
const dataFechaAcualizado = '8/7/2023' + ' 7:05:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'47', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'44', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.06, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'103', Cost:11.64, ParentId: '17'},
		]
	},
