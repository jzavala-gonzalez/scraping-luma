const timestamp_saved = '11/12/2023 04:30 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'43', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'45', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'54', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:17.48, ParentId: '11'},
