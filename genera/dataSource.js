const timestamp_saved = '11/06/2023 11:50 AM';
const dataFechaAcualizado = '11/6/2023' + ' 7:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'49', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:16.92, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 30,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 11, MVar:'11', Cost:19.60, ParentId: '19'},
