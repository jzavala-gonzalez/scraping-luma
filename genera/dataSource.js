const timestamp_saved = '08/15/2023 03:10 AM';
const dataFechaAcualizado = '8/14/2023' + ' 11:07:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'58', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'52', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'130', Cost:11.62, ParentId: '17'},
		]
	},
