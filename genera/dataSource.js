const timestamp_saved = '09/25/2023 10:15 AM';
const dataFechaAcualizado = '9/25/2023' + ' 6:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'39', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'50', Cost:11.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:23.34, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'53', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'42', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 133,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 133, MVar:'123', Cost:23.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'79', Cost:9.87, ParentId: '17'},
		]
	},
