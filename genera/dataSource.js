const timestamp_saved = '08/29/2023 05:40 PM';
const dataFechaAcualizado = '8/29/2023' + ' 1:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'83', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'82', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'60', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'62', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'66', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'20', Cost:31.27, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'45', Cost:19.79, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'36', Cost:19.57, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'102', Cost:16.97, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'147', Cost:17.10, ParentId: '16'},
		]
	},
