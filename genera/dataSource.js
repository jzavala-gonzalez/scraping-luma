const timestamp_saved = '10/25/2023 07:10 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'48', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'52', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'85', Cost:17.08, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'152', Cost:17.36, ParentId: '16'},
		]
	},
