const timestamp_saved = '07/29/2023 02:50 PM';
const dataFechaAcualizado = '7/29/2023' + ' 10:45:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'51', Cost:10.78, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'34', Cost:19.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:19.70, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'0', Cost:18.26, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'8', Cost:18.26, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:32.02, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'99', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'27', Cost:15.69, ParentId: '15'},
		]
	},
