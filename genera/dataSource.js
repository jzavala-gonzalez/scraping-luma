const timestamp_saved = '08/21/2023 08:20 PM';
const dataFechaAcualizado = '8/21/2023' + ' 4:15:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'59', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'37', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'58', Cost:10.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'30', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'14', Cost:19.12, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'155', Cost:17.64, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 25,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 12, MVar:'0', Cost:0, ParentId: '21'},
