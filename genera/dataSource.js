const timestamp_saved = '10/30/2023 11:45 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'68', Cost:10.30, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'170', Cost:16.73, ParentId: '16'},
		]
	},
