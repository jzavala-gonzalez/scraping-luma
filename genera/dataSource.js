const timestamp_saved = '10/13/2023 02:35 AM';
const dataFechaAcualizado = '10/12/2023' + ' 10:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'67', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'72', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'73', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'12', Cost:19.33, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'85', Cost:9.14, ParentId: '17'},
		]
	},
