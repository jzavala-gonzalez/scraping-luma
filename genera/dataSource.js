const timestamp_saved = '12/04/2023 04:30 AM';
const dataFechaAcualizado = '12/4/2023' + ' 12:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:17.35, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 204,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'116', Cost:18.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'64', Cost:11.65, ParentId: '17'},
		]
	},
