const timestamp_saved = '11/08/2023 02:35 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'51', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'51', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 16,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 16, MVar:'4', Cost:37.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'97', Cost:9.60, ParentId: '17'},
		]
	},
