const timestamp_saved = '10/23/2023 07:45 AM';
const dataFechaAcualizado = '10/23/2023' + ' 3:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'35', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'36', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'37', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'60', Cost:16.80, ParentId: '15'},
