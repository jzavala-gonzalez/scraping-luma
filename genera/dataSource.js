const timestamp_saved = '10/21/2023 12:05 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'36', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'34', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'37', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'66', Cost:11.04, ParentId: '17'},
		]
	},
