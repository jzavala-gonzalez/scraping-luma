const timestamp_saved = '11/20/2023 06:30 PM';
const dataFechaAcualizado = '11/20/2023' + ' 2:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'32', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'42', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'57', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'95', Cost:9.42, ParentId: '17'},
		]
	},
