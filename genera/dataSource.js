const timestamp_saved = '10/18/2023 04:15 PM';
const dataFechaAcualizado = '10/18/2023' + ' 12:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'54', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'72', Cost:23.25, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'110', Cost:10.57, ParentId: '17'},
		]
	},
