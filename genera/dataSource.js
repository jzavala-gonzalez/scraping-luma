const timestamp_saved = '08/28/2023 05:15 PM';
const dataFechaAcualizado = '8/28/2023' + ' 1:10:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'52', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'57', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'54', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'18', Cost:31.14, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'33', Cost:19.10, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'104', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 252,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 252, MVar:'166', Cost:17.78, ParentId: '16'},
		]
	},
