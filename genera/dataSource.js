const timestamp_saved = '09/28/2023 01:10 PM';
const dataFechaAcualizado = '9/28/2023' + ' 9:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'25', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'25', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'49', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'121', Cost:18.43, ParentId: '16'},
		]
	},
