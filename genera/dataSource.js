const timestamp_saved = '08/19/2023 05:10 PM';
const dataFechaAcualizado = '8/19/2023' + ' 1:07:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'51', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:19.60, ParentId: '11'},
