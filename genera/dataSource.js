const timestamp_saved = '11/20/2023 11:25 AM';
const dataFechaAcualizado = '11/20/2023' + ' 7:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'34', Cost:10.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:17.61, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'100', Cost:9.19, ParentId: '17'},
		]
	},
