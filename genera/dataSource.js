const timestamp_saved = '11/25/2023 03:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 11:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'59', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'21', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'31', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'49', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'34', Cost:18.52, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:18.52, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'29', Cost:9.84, ParentId: '17'},
		]
	},
