const timestamp_saved = '10/12/2023 04:40 AM';
const dataFechaAcualizado = '10/12/2023' + ' 12:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'54', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'58', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'64', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.08, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:30.20, ParentId: '12'},
