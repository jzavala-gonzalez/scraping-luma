const timestamp_saved = '09/30/2023 05:05 PM';
const dataFechaAcualizado = '9/30/2023' + ' 1:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'33', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'31', Cost:11.17, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 190,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'44', Cost:17.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.36, ParentId: '11'},
