const timestamp_saved = '09/03/2023 09:10 PM';
const dataFechaAcualizado = '9/3/2023' + ' 5:05:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'37', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'55', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 94,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'9', Cost:36.50, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:19.70, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 21, MVar:'12', Cost:91.14, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'154', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'72', Cost:9.19, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 16,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 12, MVar:'16', Cost:19.60, ParentId: '19'},
