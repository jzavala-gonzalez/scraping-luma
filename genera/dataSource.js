const timestamp_saved = '10/03/2023 06:15 PM';
const dataFechaAcualizado = '10/3/2023' + ' 2:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'50', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'43', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'55', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'102', Cost:16.80, ParentId: '15'},
