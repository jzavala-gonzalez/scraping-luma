const timestamp_saved = '12/02/2023 09:15 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'40', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'42', Cost:13.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'46', Cost:13.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'49', Cost:8.08, ParentId: '11'},
