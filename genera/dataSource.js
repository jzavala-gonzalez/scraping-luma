const timestamp_saved = '11/12/2023 10:05 PM';
const dataFechaAcualizado = '11/12/2023' + ' 6:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'53', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'57', Cost:10.35, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 42, MVar:'5', Cost:29.10, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'0', Cost:29.53, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 83,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'6', Cost:29.24, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'110', Cost:9.19, ParentId: '17'},
		]
	},
