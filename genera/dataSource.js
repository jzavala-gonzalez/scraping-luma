const timestamp_saved = '08/15/2023 01:10 AM';
const dataFechaAcualizado = '8/14/2023' + ' 9:07:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'63', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'60', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'54', Cost:9.79, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'28', Cost:28.11, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.39, ParentId: '12'},
