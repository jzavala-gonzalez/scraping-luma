const timestamp_saved = '09/29/2023 03:05 AM';
const dataFechaAcualizado = '9/28/2023' + ' 11:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'48', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'8', Cost:10.11, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 42,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'2', Cost:26.56, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'80', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'138', Cost:16.78, ParentId: '16'},
		]
	},
