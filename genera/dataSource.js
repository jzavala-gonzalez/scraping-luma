const timestamp_saved = '11/08/2023 09:30 PM';
const dataFechaAcualizado = '11/8/2023' + ' 5:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'54', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'8', Cost:19.78, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'174', Cost:17.15, ParentId: '16'},
		]
	},
