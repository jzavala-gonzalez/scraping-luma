const timestamp_saved = '08/12/2023 04:20 PM';
const dataFechaAcualizado = '8/12/2023' + ' 12:17:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'47', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'47', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'0', Cost:20.21, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'145', Cost:18.02, ParentId: '16'},
		]
	},
