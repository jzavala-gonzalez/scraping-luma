const timestamp_saved = '10/26/2023 04:00 PM';
const dataFechaAcualizado = '10/26/2023' + ' 11:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'47', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'50', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:16.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:16.90, ParentId: '11'},
