const timestamp_saved = '08/11/2023 07:05 PM';
const dataFechaAcualizado = '8/11/2023' + ' 3:00:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'48', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'47', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 110, MVar:'0', Cost:6.90, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'4', Cost:27.11, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 13, MVar:'3', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:20.19, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.70, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'135', Cost:11.48, ParentId: '17'},
		]
	},
