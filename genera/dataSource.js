const timestamp_saved = '08/19/2023 09:50 AM';
const dataFechaAcualizado = '8/19/2023' + ' 5:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'40', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'55', Cost:11.04, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:30.52, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'63', Cost:9.19, ParentId: '17'},
		]
	},
