const timestamp_saved = '10/21/2023 05:05 PM';
const dataFechaAcualizado = '10/21/2023' + ' 1:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'40', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'37', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'40', Cost:12.29, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 125, MVar:'30', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.03, ParentId: '11'},
