const timestamp_saved = '10/22/2023 07:55 PM';
const dataFechaAcualizado = '10/22/2023' + ' 3:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'44', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'45', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.62, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'133', Cost:17.86, ParentId: '16'},
		]
	},
