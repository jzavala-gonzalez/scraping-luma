const timestamp_saved = '08/19/2023 08:45 PM';
const dataFechaAcualizado = '8/19/2023' + ' 4:42:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'58', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'57', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'2', Cost:27.18, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'108', Cost:16.88, ParentId: '15'},
