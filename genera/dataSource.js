const timestamp_saved = '12/04/2023 06:20 PM';
const dataFechaAcualizado = '12/4/2023' + ' 2:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'56', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'58', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'56', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'81', Cost:11.46, ParentId: '17'},
		]
	},
