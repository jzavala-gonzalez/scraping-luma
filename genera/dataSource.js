const timestamp_saved = '11/22/2023 04:15 AM';
const dataFechaAcualizado = '11/22/2023' + ' 12:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'28', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'38', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'53', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 61, MVar:'66', Cost:20.33, ParentId: '15'},
