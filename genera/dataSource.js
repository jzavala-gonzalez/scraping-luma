const timestamp_saved = '10/18/2023 07:35 PM';
const dataFechaAcualizado = '10/18/2023' + ' 3:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'54', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'59', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'67', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 17, MVar:'0', Cost:47.70, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:18.45, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'118', Cost:10.52, ParentId: '17'},
		]
	},
