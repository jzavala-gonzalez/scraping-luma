const timestamp_saved = '10/06/2023 08:25 AM';
const dataFechaAcualizado = '10/6/2023' + ' 4:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'34', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'33', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'57', Cost:16.82, ParentId: '15'},
