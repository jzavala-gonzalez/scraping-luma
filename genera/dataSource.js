const timestamp_saved = '09/15/2023 07:15 PM';
const dataFechaAcualizado = '9/15/2023' + ' 3:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'62', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'61', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'71', Cost:10.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:4.90, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'76', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:8.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:8.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:9.76, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:9.76, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:31.40, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'12', Cost:28.41, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'41', Cost:18.83, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 177,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 177, MVar:'107', Cost:16.53, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'164', Cost:16.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'126', Cost:9.16, ParentId: '17'},
		]
	},
