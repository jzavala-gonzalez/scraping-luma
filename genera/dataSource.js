const timestamp_saved = '10/13/2023 11:55 AM';
const dataFechaAcualizado = '10/13/2023' + ' 7:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'59', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'64', Cost:11.24, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'6', Cost:17.45, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'74', Cost:9.12, ParentId: '17'},
		]
	},
