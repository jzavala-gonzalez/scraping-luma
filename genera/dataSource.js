const timestamp_saved = '08/13/2023 08:25 PM';
const dataFechaAcualizado = '8/13/2023' + ' 4:22:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'35', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'40', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'40', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:32.18, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'110', Cost:12.26, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 65,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 24, MVar:'24', Cost:19.60, ParentId: '19'},
