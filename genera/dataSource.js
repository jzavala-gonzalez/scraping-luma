const timestamp_saved = '11/24/2023 09:55 PM';
const dataFechaAcualizado = '11/24/2023' + ' 5:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'34', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'44', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'159', Cost:17.16, ParentId: '16'},
		]
	},
