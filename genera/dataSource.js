const timestamp_saved = '10/24/2023 07:30 PM';
const dataFechaAcualizado = '10/24/2023' + ' 3:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'55', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'55', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'56', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:57.65, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'30', Cost:19.44, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'159', Cost:17.05, ParentId: '16'},
		]
	},
