const timestamp_saved = '11/13/2023 03:15 AM';
const dataFechaAcualizado = '11/12/2023' + ' 11:11:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2568},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 253,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'54', Cost:15.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'56', Cost:15.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:15.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'0', Cost:26.85, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:17.52, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 103,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:30.06, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:29.96, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'15', Cost:30.26, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'11', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'64', Cost:16.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'107', Cost:9.16, ParentId: '17'},
		]
	},
