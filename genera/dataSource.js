const timestamp_saved = '11/30/2023 06:15 PM';
const dataFechaAcualizado = '11/30/2023' + ' 2:11:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2200},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'54', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'56', Cost:10.58, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'81', Cost:9.64, ParentId: '17'},
		]
	},
