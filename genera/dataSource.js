const timestamp_saved = '08/09/2023 07:15 PM';
const dataFechaAcualizado = '8/9/2023' + ' 3:10:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'79', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'91', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'61', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'61', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:31.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'45', Cost:18.68, ParentId: '14'},
