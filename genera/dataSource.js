const timestamp_saved = '07/30/2023 10:20 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:15:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'38', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 2,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'2', Cost:43.31, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.20, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 129, MVar:'38', Cost:15.62, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'64', Cost:19.69, ParentId: '16'},
		]
	},
