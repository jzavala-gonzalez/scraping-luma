const timestamp_saved = '10/19/2023 10:45 AM';
const dataFechaAcualizado = '10/19/2023' + ' 6:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'34', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'40', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'2', Cost:50.94, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'9', Cost:8.78, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'153', Cost:17.66, ParentId: '16'},
		]
	},
