const timestamp_saved = '10/21/2023 12:45 AM';
const dataFechaAcualizado = '10/20/2023' + ' 8:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'45', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'52', Cost:10.46, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:17.30, ParentId: '11'},
