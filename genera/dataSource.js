const timestamp_saved = '09/28/2023 11:45 PM';
const dataFechaAcualizado = '9/28/2023' + ' 7:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'54', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'56', Cost:10.30, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.39, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'90', Cost:16.81, ParentId: '15'},
