const timestamp_saved = '09/21/2023 08:45 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'37', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'41', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'63', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.06, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'10', Cost:26.63, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'66', Cost:17.60, ParentId: '15'},
