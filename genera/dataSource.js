const timestamp_saved = '09/24/2023 02:40 PM';
const dataFechaAcualizado = '9/24/2023' + ' 10:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'55', Cost:11.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 310, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:31.41, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'27', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 98, MVar:'77', Cost:19.23, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'86', Cost:9.52, ParentId: '17'},
		]
	},
