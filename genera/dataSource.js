const timestamp_saved = '10/11/2023 07:05 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'46', Cost:12.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'49', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'59', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.48, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'88', Cost:17.08, ParentId: '15'},
