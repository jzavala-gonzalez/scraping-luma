const timestamp_saved = '10/21/2023 11:00 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'35', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'33', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'37', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'8', Cost:18.87, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'66', Cost:11.07, ParentId: '17'},
		]
	},
