const timestamp_saved = '08/13/2023 03:55 PM';
const dataFechaAcualizado = '8/13/2023' + ' 11:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'35', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'39', Cost:10.75, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 42,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:29.09, ParentId: '9'},
