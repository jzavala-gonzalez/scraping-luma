const timestamp_saved = '10/28/2023 02:45 AM';
const dataFechaAcualizado = '10/27/2023' + ' 10:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'44', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'45', Cost:11.02, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 107, MVar:'34', Cost:17.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'8', Cost:17.64, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'11', Cost:23.73, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'6', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'61', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'106', Cost:18.23, ParentId: '16'},
		]
	},
