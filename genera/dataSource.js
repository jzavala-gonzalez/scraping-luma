const timestamp_saved = '08/13/2023 02:30 PM';
const dataFechaAcualizado = '8/13/2023' + ' 10:27:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'81', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'97', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'41', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'44', Cost:11.00, ParentId: '7'},
