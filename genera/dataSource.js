const timestamp_saved = '10/29/2023 03:55 AM';
const dataFechaAcualizado = '10/28/2023' + ' 11:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'45', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'46', Cost:10.57, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'48', Cost:16.96, ParentId: '15'},
