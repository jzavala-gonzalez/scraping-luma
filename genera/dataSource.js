const timestamp_saved = '11/10/2023 05:05 PM';
const dataFechaAcualizado = '11/10/2023' + ' 1:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'61', Cost:10.63, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 38, MVar:'15', Cost:23.51, ParentId: '14'},
