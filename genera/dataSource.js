const timestamp_saved = '10/05/2023 09:50 AM';
const dataFechaAcualizado = '10/5/2023' + ' 5:46:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'34', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'50', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'96', Cost:9.17, ParentId: '17'},
		]
	},
