const timestamp_saved = '10/31/2023 03:10 AM';
const dataFechaAcualizado = '10/30/2023' + ' 11:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'56', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'59', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'64', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'160', Cost:17.23, ParentId: '16'},
		]
	},
