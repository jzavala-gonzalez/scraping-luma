const timestamp_saved = '10/16/2023 03:30 AM';
const dataFechaAcualizado = '10/15/2023' + ' 11:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'53', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'53', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'55', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.25, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:28.74, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'2', Cost:28.67, ParentId: '13'},
