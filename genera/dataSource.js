const timestamp_saved = '09/01/2023 11:50 PM';
const dataFechaAcualizado = '9/1/2023' + ' 7:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 508,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'57', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'65', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 179, MVar:'70', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'15', Cost:28.15, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'0', Cost:8.58, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:8.58, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'19', Cost:19.25, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'157', Cost:16.70, ParentId: '16'},
		]
	},
