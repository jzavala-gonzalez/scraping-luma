const timestamp_saved = '09/14/2023 11:25 AM';
const dataFechaAcualizado = '9/14/2023' + ' 7:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'51', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'50', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'63', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'93', Cost:9.21, ParentId: '17'},
		]
	},
