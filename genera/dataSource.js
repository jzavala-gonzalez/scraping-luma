const timestamp_saved = '10/05/2023 02:50 AM';
const dataFechaAcualizado = '10/4/2023' + ' 10:46:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'42', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'40', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'55', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'154', Cost:16.65, ParentId: '16'},
		]
	},
