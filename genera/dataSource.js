const timestamp_saved = '12/04/2023 01:55 PM';
const dataFechaAcualizado = '12/4/2023' + ' 9:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'50', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'52', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'53', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.80, ParentId: '14'},
