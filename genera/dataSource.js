const timestamp_saved = '08/09/2023 02:25 AM';
const dataFechaAcualizado = '8/8/2023' + ' 10:20:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'52', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'59', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'7', Cost:22.41, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:25.87, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.18, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 308,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 308, MVar:'164', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'85', Cost:12.22, ParentId: '17'},
		]
	},
