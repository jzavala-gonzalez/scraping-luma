const timestamp_saved = '11/13/2023 06:15 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 181,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'46', Cost:20.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'51', Cost:20.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:20.95, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:27.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'13', Cost:19.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'65', Cost:16.75, ParentId: '15'},
