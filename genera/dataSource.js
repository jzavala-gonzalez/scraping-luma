const timestamp_saved = '11/26/2023 04:30 AM';
const dataFechaAcualizado = '11/26/2023' + ' 12:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'24', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'34', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'50', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:19.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:19.10, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 66, MVar:'12', Cost:19.86, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'119', Cost:18.02, ParentId: '16'},
		]
	},
