const timestamp_saved = '08/02/2023 09:45 AM';
const dataFechaAcualizado = '8/2/2023' + ' 5:40:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'46', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'43', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'34', Cost:20.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:20.86, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 283,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'76', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'41', Cost:15.75, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'146', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'86', Cost:11.00, ParentId: '17'},
		]
	},
