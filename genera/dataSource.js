const timestamp_saved = '08/11/2023 11:05 AM';
const dataFechaAcualizado = '8/11/2023' + ' 7:00:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'45', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'40', Cost:10.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 115,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 123, MVar:'16', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:31.19, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'4', Cost:31.11, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'142', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'68', Cost:11.90, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 9,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 3, MVar:'19', Cost:19.60, ParentId: '19'},
