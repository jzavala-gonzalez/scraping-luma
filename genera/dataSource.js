const timestamp_saved = '07/25/2023 04:08 PM';
const dataFechaAcualizado = '7/25/2023' + ' 12:00:30 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2332},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 237, MVar:'82', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'78', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'57', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:21.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:21.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:12.44, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'9', Cost:12.44, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:31.52, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 198,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 198, MVar:'75', Cost:10.56, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 118,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 37, MVar:'6', Cost:17, ParentId: '19'},
		]
	},
