const timestamp_saved = '11/21/2023 09:51 AM';
const dataFechaAcualizado = '11/21/2023' + ' 5:46:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2007},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'24', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'32', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'70', Cost:9.58, ParentId: '17'},
		]
	},
