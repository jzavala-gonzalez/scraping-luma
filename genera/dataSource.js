const timestamp_saved = '09/23/2023 09:35 PM';
const dataFechaAcualizado = '9/23/2023' + ' 5:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'52', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'63', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:26.23, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:31.03, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.19, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 82,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'9', Cost:28.55, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'23', Cost:19.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'99', Cost:9.18, ParentId: '17'},
		]
	},
