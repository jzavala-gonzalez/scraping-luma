const timestamp_saved = '10/16/2023 12:41 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 150, MVar:'58', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'167', Cost:18.13, ParentId: '16'},
		]
	},
