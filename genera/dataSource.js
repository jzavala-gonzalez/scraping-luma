const timestamp_saved = '10/19/2023 09:15 PM';
const dataFechaAcualizado = '10/19/2023' + ' 5:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'38', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'68', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:26.53, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'12', Cost:17.31, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 45, MVar:'17', Cost:23.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'78', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'188', Cost:16.83, ParentId: '16'},
		]
	},
