const timestamp_saved = '10/04/2023 03:25 PM';
const dataFechaAcualizado = '10/4/2023' + ' 11:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'43', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'40', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'17', Cost:27.60, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:31.63, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'72', Cost:17.04, ParentId: '15'},
