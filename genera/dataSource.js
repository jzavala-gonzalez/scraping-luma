const timestamp_saved = '12/03/2023 05:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 1:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 39,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'18', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'7', Cost:19.29, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'61', Cost:11.61, ParentId: '17'},
		]
	},
