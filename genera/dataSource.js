const timestamp_saved = '09/15/2023 10:00 AM';
const dataFechaAcualizado = '9/15/2023' + ' 5:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'49', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'49', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'63', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'21', Cost:18.81, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'133', Cost:17.84, ParentId: '16'},
		]
	},
