const timestamp_saved = '09/02/2023 05:50 AM';
const dataFechaAcualizado = '9/2/2023' + ' 1:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'43', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'51', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'62', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'7', Cost:18.74, ParentId: '14'},
