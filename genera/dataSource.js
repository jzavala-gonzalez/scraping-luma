const timestamp_saved = '12/05/2023 05:40 AM';
const dataFechaAcualizado = '12/5/2023' + ' 1:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'40', Cost:12.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'44', Cost:12.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'53', Cost:12.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'61', Cost:10.93, ParentId: '17'},
		]
	},
