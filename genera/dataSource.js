const timestamp_saved = '11/21/2023 05:50 AM';
const dataFechaAcualizado = '11/21/2023' + ' 1:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'23', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'32', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.29, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 60, MVar:'24', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'136', Cost:18.35, ParentId: '16'},
		]
	},
