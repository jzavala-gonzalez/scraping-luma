const timestamp_saved = '11/25/2023 02:45 AM';
const dataFechaAcualizado = '11/24/2023' + ' 10:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 129, MVar:'62', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'31', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'41', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'55', Cost:12.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:26.08, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'149', Cost:16.77, ParentId: '16'},
		]
	},
