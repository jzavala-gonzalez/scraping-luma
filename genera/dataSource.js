const timestamp_saved = '11/03/2023 07:55 AM';
const dataFechaAcualizado = '11/3/2023' + ' 3:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'42', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'41', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'42', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'55', Cost:9.43, ParentId: '17'},
		]
	},
