const timestamp_saved = '10/05/2023 09:26 AM';
const dataFechaAcualizado = '10/5/2023' + ' 5:21:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'36', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'33', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'49', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'90', Cost:9.52, ParentId: '17'},
		]
	},
