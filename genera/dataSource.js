const timestamp_saved = '11/25/2023 03:15 AM';
const dataFechaAcualizado = '11/24/2023' + ' 11:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 145,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 145, MVar:'61', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'28', Cost:12.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'38', Cost:12.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'54', Cost:12.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 60,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:29.12, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 286,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.78, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'9', Cost:19.70, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'16', Cost:19.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'148', Cost:16.77, ParentId: '16'},
		]
	},
