const timestamp_saved = '11/07/2023 01:20 AM';
const dataFechaAcualizado = '11/6/2023' + ' 9:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'54', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'53', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.94, ParentId: '11'},
