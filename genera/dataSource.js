const timestamp_saved = '10/22/2023 07:10 PM';
const dataFechaAcualizado = '10/22/2023' + ' 3:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'45', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'46', Cost:10.94, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:17.25, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'63', Cost:11.28, ParentId: '17'},
		]
	},
