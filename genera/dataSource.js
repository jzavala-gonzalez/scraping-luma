const timestamp_saved = '11/18/2023 05:31 AM';
const dataFechaAcualizado = '11/18/2023' + ' 1:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 151,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:22.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'79', Cost:22.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:22.52, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:28.22, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'11', Cost:22.55, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'75', Cost:16.52, ParentId: '15'},
