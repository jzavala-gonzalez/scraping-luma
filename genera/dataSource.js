const timestamp_saved = '10/22/2023 08:10 PM';
const dataFechaAcualizado = '10/22/2023' + ' 4:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'48', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.55, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'66', Cost:11.28, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 30,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 20, MVar:'11', Cost:19.60, ParentId: '19'},
