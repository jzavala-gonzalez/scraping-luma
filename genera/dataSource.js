const timestamp_saved = '10/25/2023 11:15 AM';
const dataFechaAcualizado = '10/25/2023' + ' 7:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'44', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 149, MVar:'45', Cost:16.88, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:16.88, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'86', Cost:17.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'136', Cost:18.19, ParentId: '16'},
		]
	},
