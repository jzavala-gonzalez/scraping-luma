const timestamp_saved = '11/11/2023 04:45 AM';
const dataFechaAcualizado = '11/11/2023' + ' 12:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 240,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'84', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'44', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'46', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'44', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 28,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'0', Cost:29.67, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'13', Cost:27.95, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.21, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'87', Cost:16.77, ParentId: '15'},
