const timestamp_saved = '09/16/2023 05:25 PM';
const dataFechaAcualizado = '9/16/2023' + ' 1:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'47', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'46', Cost:10.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:19.98, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'78', Cost:19.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'110', Cost:18.22, ParentId: '16'},
		]
	},
