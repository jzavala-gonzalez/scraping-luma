const timestamp_saved = '09/24/2023 12:45 AM';
const dataFechaAcualizado = '9/23/2023' + ' 8:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'8', Cost:28.08, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:30.88, ParentId: '10'},
		]
	},
