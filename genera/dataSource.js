const timestamp_saved = '11/12/2023 05:45 AM';
const dataFechaAcualizado = '11/12/2023' + ' 1:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'51', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'13', Cost:17.20, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'4', Cost:31.48, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.77, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'5', Cost:31.50, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'9', Cost:22.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'82', Cost:16.28, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 198,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 198, MVar:'76', Cost:10.53, ParentId: '17'},
		]
	},
