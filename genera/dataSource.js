const timestamp_saved = '08/20/2023 10:55 AM';
const dataFechaAcualizado = '8/20/2023' + ' 6:52:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'45', Cost:11.09, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'55', Cost:9.20, ParentId: '17'},
		]
	},
