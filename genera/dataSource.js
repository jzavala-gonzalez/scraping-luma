const timestamp_saved = '09/14/2023 07:20 PM';
const dataFechaAcualizado = '9/14/2023' + ' 3:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'59', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'58', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'68', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.96, ParentId: '12'},
