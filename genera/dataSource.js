const timestamp_saved = '08/17/2023 06:10 PM';
const dataFechaAcualizado = '8/17/2023' + ' 2:07:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'73', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'79', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 110, MVar:'0', Cost:6.78, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 106,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:30.62, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'8', Cost:30.70, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'168', Cost:18.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'99', Cost:9.23, ParentId: '17'},
		]
	},
