const timestamp_saved = '09/25/2023 12:40 AM';
const dataFechaAcualizado = '9/24/2023' + ' 8:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'58', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'62', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:19.64, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:28.52, ParentId: '12'},
