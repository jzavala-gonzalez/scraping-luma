const timestamp_saved = '09/18/2023 10:15 AM';
const dataFechaAcualizado = '9/18/2023' + ' 6:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'43', Cost:10.37, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 135, MVar:'54', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'69', Cost:9.81, ParentId: '17'},
		]
	},
