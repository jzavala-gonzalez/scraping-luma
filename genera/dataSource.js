const timestamp_saved = '12/02/2023 08:25 AM';
const dataFechaAcualizado = '12/2/2023' + ' 4:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'38', Cost:12.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'40', Cost:12.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'46', Cost:12.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'51', Cost:9.81, ParentId: '17'},
		]
	},
