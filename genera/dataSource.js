const timestamp_saved = '08/22/2023 11:45 PM';
const dataFechaAcualizado = '8/22/2023' + ' 7:40:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'53', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'49', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:19.14, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 282, MVar:'135', Cost:17.33, ParentId: '16'},
		]
	},
