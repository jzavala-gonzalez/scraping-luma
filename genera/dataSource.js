const timestamp_saved = '09/13/2023 04:25 PM';
const dataFechaAcualizado = '9/13/2023' + ' 12:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'55', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'54', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'67', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.44, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'14', Cost:28.40, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'26', Cost:19.31, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'100', Cost:9.11, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:26.19, ParentId: '21'},
