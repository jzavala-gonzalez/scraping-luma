const timestamp_saved = '09/25/2023 05:40 AM';
const dataFechaAcualizado = '9/25/2023' + ' 1:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'51', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'59', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 85,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'5', Cost:29.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:30.95, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 116, MVar:'34', Cost:20.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:20.80, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:16.98, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'0', Cost:16.98, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'2', Cost:31.35, ParentId: '12'},
