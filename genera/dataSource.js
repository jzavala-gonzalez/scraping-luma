const timestamp_saved = '09/27/2023 04:10 PM';
const dataFechaAcualizado = '9/27/2023' + ' 12:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'36', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'36', Cost:10.77, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'96', Cost:16.61, ParentId: '15'},
