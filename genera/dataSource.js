const timestamp_saved = '10/15/2023 05:35 PM';
const dataFechaAcualizado = '10/15/2023' + ' 1:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'50', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'49', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'51', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 21, MVar:'1', Cost:104.82, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'92', Cost:16.88, ParentId: '15'},
