const timestamp_saved = '10/03/2023 02:11 PM';
const dataFechaAcualizado = '10/3/2023' + ' 10:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'43', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'41', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'55', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'1', Cost:29.23, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'31', Cost:17.98, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.98, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 138, MVar:'0', Cost:16.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'9', Cost:16.99, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'166', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'119', Cost:9.18, ParentId: '17'},
		]
	},
