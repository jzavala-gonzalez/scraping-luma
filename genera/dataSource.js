const timestamp_saved = '10/28/2023 01:25 AM';
const dataFechaAcualizado = '10/27/2023' + ' 9:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'45', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'46', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:21.19, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'9', Cost:23.10, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'10', Cost:19.22, ParentId: '14'},
