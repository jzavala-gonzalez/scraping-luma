const timestamp_saved = '09/06/2023 06:00 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'44', Cost:12.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'48', Cost:12.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'59', Cost:12.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:20.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'144', Cost:16.91, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'70', Cost:9.17, ParentId: '17'},
		]
	},
