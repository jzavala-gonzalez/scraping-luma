const timestamp_saved = '11/24/2023 09:50 AM';
const dataFechaAcualizado = '11/24/2023' + ' 5:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'22', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'30', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'64', Cost:9.90, ParentId: '17'},
		]
	},
