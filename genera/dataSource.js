const timestamp_saved = '11/23/2023 07:05 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:01:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1906},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1900},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'23', Cost:12.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'34', Cost:12.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'50', Cost:12.89, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'50', Cost:9.85, ParentId: '17'},
		]
	},
