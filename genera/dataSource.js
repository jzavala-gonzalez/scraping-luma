const timestamp_saved = '12/06/2023 03:40 AM';
const dataFechaAcualizado = '12/5/2023' + ' 11:35:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 877},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'49', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'72', Cost:10.93, ParentId: '17'},
		]
	},
