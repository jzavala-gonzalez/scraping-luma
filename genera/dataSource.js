const timestamp_saved = '11/25/2023 06:45 AM';
const dataFechaAcualizado = '11/25/2023' + ' 2:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 214,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 214, MVar:'61', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'21', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'31', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.82, ParentId: '7'},
		]
	},
