const timestamp_saved = '09/15/2023 04:55 PM';
const dataFechaAcualizado = '9/15/2023' + ' 12:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'53', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'64', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:19.89, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'29', Cost:18.23, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'146', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'105', Cost:9.29, ParentId: '17'},
		]
	},
