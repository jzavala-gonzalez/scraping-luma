const timestamp_saved = '09/19/2023 09:55 AM';
const dataFechaAcualizado = '9/19/2023' + ' 5:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'47', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'47', Cost:10.98, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:19.90, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'86', Cost:9.20, ParentId: '17'},
		]
	},
