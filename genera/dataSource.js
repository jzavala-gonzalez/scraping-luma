const timestamp_saved = '08/02/2023 07:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 3:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'40', Cost:11.20, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'69', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'43', Cost:16.04, ParentId: '15'},
		]
	},
