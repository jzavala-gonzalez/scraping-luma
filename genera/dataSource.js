const timestamp_saved = '10/14/2023 03:55 PM';
const dataFechaAcualizado = '10/14/2023' + ' 11:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'47', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'46', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.61, ParentId: '11'},
