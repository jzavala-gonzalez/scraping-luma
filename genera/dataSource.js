const timestamp_saved = '09/06/2023 08:05 PM';
const dataFechaAcualizado = '9/6/2023' + ' 4:00:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'61', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 113, MVar:'0', Cost:8.04, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:19.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'105', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'174', Cost:17.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'100', Cost:9.20, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 71,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 19, MVar:'20', Cost:17, ParentId: '19'},
		]
	},
