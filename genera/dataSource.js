const timestamp_saved = '08/03/2023 08:35 PM';
const dataFechaAcualizado = '8/3/2023' + ' 4:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'50', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'0', Cost:22.22, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'8', Cost:42.87, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:19.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 315,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'115', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'174', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'98', Cost:11.05, ParentId: '17'},
		]
	},
