const timestamp_saved = '09/04/2023 11:30 PM';
const dataFechaAcualizado = '9/4/2023' + ' 7:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'47', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'53', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'62', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 95,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'7', Cost:31.04, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'207', Cost:16.66, ParentId: '16'},
		]
	},
