const timestamp_saved = '10/17/2023 06:00 AM';
const dataFechaAcualizado = '10/17/2023' + ' 1:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'59', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'56', Cost:10.12, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'151', Cost:18.42, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'75', Cost:9.23, ParentId: '17'},
		]
	},
