const timestamp_saved = '09/26/2023 08:10 PM';
const dataFechaAcualizado = '9/26/2023' + ' 4:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'55', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'57', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:17.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.36, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 14,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'6', Cost:68.78, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'77', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'177', Cost:17.65, ParentId: '16'},
		]
	},
