const timestamp_saved = '10/16/2023 05:05 AM';
const dataFechaAcualizado = '10/16/2023' + ' 1:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'49', Cost:13.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'49', Cost:13.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'53', Cost:13.37, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'3', Cost:19.29, ParentId: '14'},
