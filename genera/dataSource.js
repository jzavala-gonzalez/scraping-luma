const timestamp_saved = '09/01/2023 06:15 AM';
const dataFechaAcualizado = '9/1/2023' + ' 2:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'41', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'48', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'1', Cost:22.34, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'7', Cost:30.89, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 110, MVar:'0', Cost:17.02, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:17.02, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'140', Cost:16.98, ParentId: '16'},
		]
	},
