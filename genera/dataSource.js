const timestamp_saved = '11/27/2023 10:55 AM';
const dataFechaAcualizado = '11/27/2023' + ' 6:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'25', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'32', Cost:11.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 432,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'48', Cost:8.06, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 52, MVar:'9', Cost:8.06, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'70', Cost:9.82, ParentId: '17'},
		]
	},
