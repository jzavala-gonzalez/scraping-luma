const timestamp_saved = '11/07/2023 02:55 PM';
const dataFechaAcualizado = '11/7/2023' + ' 10:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'49', Cost:10.81, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'90', Cost:9.80, ParentId: '17'},
		]
	},
