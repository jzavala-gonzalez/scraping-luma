const timestamp_saved = '10/21/2023 06:00 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'24', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'23', Cost:11.42, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'134', Cost:17.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'77', Cost:11.03, ParentId: '17'},
		]
	},
