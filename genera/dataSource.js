const timestamp_saved = '10/13/2023 04:50 PM';
const dataFechaAcualizado = '10/13/2023' + ' 12:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'64', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'70', Cost:10.61, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.83, ParentId: '13'},
