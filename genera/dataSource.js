const timestamp_saved = '09/30/2023 06:45 AM';
const dataFechaAcualizado = '9/30/2023' + ' 2:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'39', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'38', Cost:10.09, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 197,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:18.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:18.14, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'14', Cost:19.11, ParentId: '14'},
