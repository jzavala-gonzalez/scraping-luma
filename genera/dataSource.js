const timestamp_saved = '08/31/2023 05:15 AM';
const dataFechaAcualizado = '8/31/2023' + ' 1:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'46', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'84', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 506,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'48', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'58', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'64', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 54,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'2', Cost:34.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 55, MVar:'13', Cost:31.12, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:30.39, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 26,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'2', Cost:32.40, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'76', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 203,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 203, MVar:'141', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'85', Cost:9.19, ParentId: '17'},
		]
	},
