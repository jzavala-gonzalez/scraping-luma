const timestamp_saved = '09/04/2023 02:20 PM';
const dataFechaAcualizado = '9/4/2023' + ' 10:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'39', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'45', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'54', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'22', Cost:18.93, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'70', Cost:9.39, ParentId: '17'},
		]
	},
