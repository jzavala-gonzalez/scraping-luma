const timestamp_saved = '08/17/2023 07:05 AM';
const dataFechaAcualizado = '8/17/2023' + ' 3:02:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'59', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'68', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:31.34, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.99, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'144', Cost:17.97, ParentId: '16'},
		]
	},
