const timestamp_saved = '11/30/2023 05:40 PM';
const dataFechaAcualizado = '11/30/2023' + ' 1:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'53', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'55', Cost:10.59, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'79', Cost:9.82, ParentId: '17'},
		]
	},
