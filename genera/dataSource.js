const timestamp_saved = '08/30/2023 04:50 AM';
const dataFechaAcualizado = '8/30/2023' + ' 12:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'47', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'58', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'0', Cost:27.50, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'12', Cost:27.45, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'19', Cost:18.87, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'69', Cost:16.70, ParentId: '15'},
