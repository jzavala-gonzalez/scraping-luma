const timestamp_saved = '07/25/2023 10:28 PM';
const dataFechaAcualizado = '7/25/2023' + ' 6:20:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'82', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'61', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'53', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'51', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:8.26, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.66, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.78, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 104,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'60', Cost:17.75, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'77', Cost:9.36, ParentId: '17'},
		]
	},
