const timestamp_saved = '11/17/2023 07:35 AM';
const dataFechaAcualizado = '11/17/2023' + ' 3:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'49', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'49', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'40', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.98, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'80', Cost:9.82, ParentId: '17'},
		]
	},
