const timestamp_saved = '11/19/2023 10:45 AM';
const dataFechaAcualizado = '11/19/2023' + ' 6:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'37', Cost:15.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:15.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:15.07, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'5', Cost:30.89, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:18.10, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.23, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'73', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'131', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'90', Cost:9.90, ParentId: '17'},
		]
	},
