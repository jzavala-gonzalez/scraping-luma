const timestamp_saved = '10/31/2023 04:25 PM';
const dataFechaAcualizado = '10/31/2023' + ' 12:21:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2267},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'61', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'65', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'67', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'86', Cost:16.71, ParentId: '15'},
