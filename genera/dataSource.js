const timestamp_saved = '08/24/2023 08:10 PM';
const dataFechaAcualizado = '8/24/2023' + ' 4:05:46 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'65', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'68', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'61', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:22.64, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:21.97, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'11', Cost:26.91, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:27.18, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'30', Cost:18.76, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'82', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 333, MVar:'201', Cost:16.84, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 45,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 13, MVar:'1', Cost:17, ParentId: '19'},
		]
	},
