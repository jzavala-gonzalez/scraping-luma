const timestamp_saved = '11/17/2023 09:55 AM';
const dataFechaAcualizado = '11/17/2023' + ' 5:51:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2119},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'43', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'88', Cost:9.83, ParentId: '17'},
		]
	},
