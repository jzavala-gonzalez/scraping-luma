const timestamp_saved = '11/21/2023 09:20 PM';
const dataFechaAcualizado = '11/21/2023' + ' 5:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 140, MVar:'57', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 66, MVar:'0', Cost:20.28, ParentId: '14'},
