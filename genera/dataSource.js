const timestamp_saved = '07/27/2023 04:43 AM';
const dataFechaAcualizado = '7/27/2023' + ' 12:35:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'53', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'54', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'30', Cost:21.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:21.07, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'10', Cost:18.66, ParentId: '14'},
