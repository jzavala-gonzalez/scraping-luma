const timestamp_saved = '09/24/2023 05:45 PM';
const dataFechaAcualizado = '9/24/2023' + ' 1:40:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2268},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2224},
	{Index:'7', Desc:'Máxima para Hoy', value: 2392},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'49', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'56', Cost:10.63, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 2, MVar:'0', Cost:82.51, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.90, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'7', Cost:28.15, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:19.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.74, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'90', Cost:17.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'97', Cost:9.12, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 61,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 25, MVar:'17', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 8,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 2, MVar:'0', Cost:83, ParentId: '21'},
			{Index:'1', Unit:'CT Block 2', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'2', Unit:'CT Block 3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'3', Unit:'GT1', MW: 6, MVar:'0', Cost:82.51, ParentId: '21'},
