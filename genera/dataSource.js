const timestamp_saved = '09/03/2023 12:50 AM';
const dataFechaAcualizado = '9/2/2023' + ' 8:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'53', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'62', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'68', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'6', Cost:26.35, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'87', Cost:9.22, ParentId: '17'},
		]
	},
