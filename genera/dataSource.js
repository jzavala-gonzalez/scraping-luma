const timestamp_saved = '10/01/2023 03:25 AM';
const dataFechaAcualizado = '9/30/2023' + ' 11:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 240, MVar:'71', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'34', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'33', Cost:10.88, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'86', Cost:16.47, ParentId: '15'},
