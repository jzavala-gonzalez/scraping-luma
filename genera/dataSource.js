const timestamp_saved = '12/02/2023 08:20 AM';
const dataFechaAcualizado = '12/2/2023' + ' 4:16:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1855},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'41', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'47', Cost:12.90, ParentId: '7'},
		]
	},
