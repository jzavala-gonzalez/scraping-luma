const timestamp_saved = '09/24/2023 09:30 PM';
const dataFechaAcualizado = '9/24/2023' + ' 5:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'45', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'46', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'55', Cost:10.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:5.00, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 135,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.39, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:22.88, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:31.00, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:19.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:19.69, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:17.41, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'0', Cost:17.41, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.57, ParentId: '13'},
