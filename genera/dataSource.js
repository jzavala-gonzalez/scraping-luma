const timestamp_saved = '10/27/2023 10:25 PM';
const dataFechaAcualizado = '10/27/2023' + ' 6:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'48', Cost:10.77, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 16, MVar:'11', Cost:32.51, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 21, MVar:'9', Cost:38.00, ParentId: '14'},
