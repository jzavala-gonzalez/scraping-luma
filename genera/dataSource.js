const timestamp_saved = '08/21/2023 09:45 PM';
const dataFechaAcualizado = '8/21/2023' + ' 5:40:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'56', Cost:10.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:10.85, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'11', Cost:19.02, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'71', Cost:18.41, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'73', Cost:9.20, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'CT Block 2', MW: 0, MVar:'0', Cost:53, ParentId: '21'},
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:53.31, ParentId: '21'},
