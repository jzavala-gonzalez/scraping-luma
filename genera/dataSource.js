const timestamp_saved = '09/23/2023 08:35 PM';
const dataFechaAcualizado = '9/23/2023' + ' 4:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'50', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'51', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'62', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 87,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 87, MVar:'0', Cost:5.51, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:30.83, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'4', Cost:31.48, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.40, ParentId: '11'},
