const timestamp_saved = '10/22/2023 04:50 AM';
const dataFechaAcualizado = '10/22/2023' + ' 12:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'44', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'45', Cost:11.25, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'138', Cost:17.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'65', Cost:11.10, ParentId: '17'},
		]
	},
