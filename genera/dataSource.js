const timestamp_saved = '11/12/2023 08:30 PM';
const dataFechaAcualizado = '11/12/2023' + ' 4:26:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2310},
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2304},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'54', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'59', Cost:10.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 16, MVar:'0', Cost:36.15, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'5', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'12', Cost:17.26, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'4', Cost:29.40, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:33.28, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:33.88, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'11', Cost:22.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'62', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'105', Cost:9.18, ParentId: '17'},
		]
	},
