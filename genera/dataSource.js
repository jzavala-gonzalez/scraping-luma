const timestamp_saved = '11/01/2023 01:35 PM';
const dataFechaAcualizado = '11/1/2023' + ' 9:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'62', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'66', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:18.44, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'74', Cost:9.36, ParentId: '17'},
		]
	},
