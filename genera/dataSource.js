const timestamp_saved = '08/01/2023 09:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 5:20:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'43', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:11.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 120, MVar:'0', Cost:7.24, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'12', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'7', Cost:31.22, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 149, MVar:'36', Cost:15.69, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'127', Cost:17.16, ParentId: '16'},
		]
	},
