const timestamp_saved = '09/28/2023 02:45 AM';
const dataFechaAcualizado = '9/27/2023' + ' 10:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'31', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'29', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'62', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:18.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:18.01, ParentId: '11'},
		]
	},
