const timestamp_saved = '09/18/2023 10:40 PM';
const dataFechaAcualizado = '9/18/2023' + ' 6:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'102', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 527,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'59', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'58', Cost:10.05, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:19.93, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:29.15, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'10', Cost:27.06, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'15', Cost:28.37, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'16', Cost:29.72, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:19.94, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:29.59, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'8', Cost:29.49, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'30', Cost:19.10, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'92', Cost:16.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 355,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 355, MVar:'192', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'110', Cost:9.12, ParentId: '17'},
		]
	},
