const timestamp_saved = '12/01/2023 01:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 9:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'59', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'61', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'58', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:26.14, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:17.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'14', Cost:17.44, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'50', Cost:8.11, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'158', Cost:18.30, ParentId: '16'},
		]
	},
