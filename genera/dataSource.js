const timestamp_saved = '10/26/2023 11:55 PM';
const dataFechaAcualizado = '10/26/2023' + ' 7:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'54', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'57', Cost:10.34, ParentId: '7'},
