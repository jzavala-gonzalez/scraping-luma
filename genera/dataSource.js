const timestamp_saved = '09/04/2023 03:40 AM';
const dataFechaAcualizado = '9/3/2023' + ' 11:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'40', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'43', Cost:10.39, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:32.03, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'74', Cost:9.22, ParentId: '17'},
		]
	},
