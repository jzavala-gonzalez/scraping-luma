const timestamp_saved = '09/17/2023 02:15 PM';
const dataFechaAcualizado = '9/17/2023' + ' 10:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'42', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'43', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'59', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'76', Cost:9.62, ParentId: '17'},
		]
	},
