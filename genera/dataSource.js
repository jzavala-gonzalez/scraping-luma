const timestamp_saved = '11/16/2023 11:05 AM';
const dataFechaAcualizado = '11/16/2023' + ' 7:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'46', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'46', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.46, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 185,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 185, MVar:'63', Cost:10.79, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:23.23, ParentId: '21'},
