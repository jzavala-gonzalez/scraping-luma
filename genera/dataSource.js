const timestamp_saved = '09/17/2023 07:50 AM';
const dataFechaAcualizado = '9/17/2023' + ' 3:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'39', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'39', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'56', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'84', Cost:9.12, ParentId: '17'},
		]
	},
