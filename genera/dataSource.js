const timestamp_saved = '11/06/2023 06:55 AM';
const dataFechaAcualizado = '11/6/2023' + ' 2:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'41', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'40', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'12', Cost:16.90, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 33,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 3, MVar:'0', Cost:26.50, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 184,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'115', Cost:19.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'48', Cost:9.83, ParentId: '17'},
		]
	},
