const timestamp_saved = '10/25/2023 10:45 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 152, MVar:'49', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 92, MVar:'27', Cost:17.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.88, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'48', Cost:16.91, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'7', Cost:16.91, ParentId: '11'},
		]
	},
