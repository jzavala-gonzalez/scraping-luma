const timestamp_saved = '11/16/2023 06:40 AM';
const dataFechaAcualizado = '11/16/2023' + ' 2:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'42', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'41', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'49', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'58', Cost:10.88, ParentId: '17'},
		]
	},
