const timestamp_saved = '11/20/2023 09:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 5:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'38', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'46', Cost:10.66, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'100', Cost:9.41, ParentId: '17'},
		]
	},
