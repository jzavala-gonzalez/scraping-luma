const timestamp_saved = '07/25/2023 10:32 AM';
const dataFechaAcualizado = '7/25/2023' + ' 6:25:30 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2570},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 205, MVar:'58', Cost:9.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'9', Cost:28.00, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 86,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'9', Cost:31.04, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 169, MVar:'58', Cost:15.41, ParentId: '15'},
		]
	},
