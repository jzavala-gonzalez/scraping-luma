const timestamp_saved = '11/12/2023 05:05 AM';
const dataFechaAcualizado = '11/12/2023' + ' 1:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'41', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'43', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'53', Cost:12.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'20', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:22.12, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'83', Cost:16.78, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'86', Cost:9.14, ParentId: '17'},
		]
	},
