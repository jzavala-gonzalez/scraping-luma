const timestamp_saved = '11/24/2023 03:50 PM';
const dataFechaAcualizado = '11/24/2023' + ' 11:46:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1923},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 127, MVar:'52', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:18.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'80', Cost:9.60, ParentId: '17'},
		]
	},
