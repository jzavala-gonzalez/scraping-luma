const timestamp_saved = '09/19/2023 12:20 PM';
const dataFechaAcualizado = '9/19/2023' + ' 8:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'51', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'53', Cost:10.31, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'92', Cost:9.49, ParentId: '17'},
		]
	},
