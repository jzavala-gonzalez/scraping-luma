const timestamp_saved = '08/05/2023 06:15 AM';
const dataFechaAcualizado = '8/5/2023' + ' 2:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'40', Cost:10.72, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.74, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'53', Cost:15.62, ParentId: '15'},
		]
	},
