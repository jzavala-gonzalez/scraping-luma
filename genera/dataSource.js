const timestamp_saved = '10/25/2023 07:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'50', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 170, MVar:'52', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'153', Cost:17.37, ParentId: '16'},
		]
	},
