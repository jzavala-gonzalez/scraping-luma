const timestamp_saved = '09/21/2023 07:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'38', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'42', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'61', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'8', Cost:26.81, ParentId: '14'},
