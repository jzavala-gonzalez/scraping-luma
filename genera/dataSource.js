const timestamp_saved = '08/10/2023 07:40 AM';
const dataFechaAcualizado = '8/10/2023' + ' 3:35:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'100', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'57', Cost:10.75, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'77', Cost:12.02, ParentId: '17'},
		]
	},
