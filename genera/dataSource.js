const timestamp_saved = '09/08/2023 06:35 AM';
const dataFechaAcualizado = '9/8/2023' + ' 2:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'62', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'59', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'55', Cost:10.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 106, MVar:'0', Cost:7.41, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:19.85, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:30.94, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'3', Cost:19.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'67', Cost:17.02, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 40, MVar:'0', Cost:0, ParentId: '17'},
		]
	},
