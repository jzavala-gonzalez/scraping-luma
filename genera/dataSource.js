const timestamp_saved = '11/13/2023 07:35 AM';
const dataFechaAcualizado = '11/13/2023' + ' 3:31:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2477},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'36', Cost:13.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'42', Cost:13.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'48', Cost:13.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:30.45, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.63, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.34, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'11', Cost:18.41, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'75', Cost:9.39, ParentId: '17'},
		]
	},
