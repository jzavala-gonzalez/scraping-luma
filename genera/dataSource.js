const timestamp_saved = '11/09/2023 02:15 AM';
const dataFechaAcualizado = '11/8/2023' + ' 10:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'51', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'50', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'52', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'0', Cost:26.20, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'104', Cost:9.24, ParentId: '17'},
		]
	},
