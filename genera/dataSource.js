const timestamp_saved = '08/30/2023 03:40 AM';
const dataFechaAcualizado = '8/29/2023' + ' 11:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'53', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'54', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 98,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.42, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'3', Cost:22.27, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'18', Cost:28.00, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 38,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:30.71, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 8, MVar:'0', Cost:28.59, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'23', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'108', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 167,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 167, MVar:'153', Cost:19.42, ParentId: '16'},
		]
	},
