const timestamp_saved = '08/28/2023 11:30 AM';
const dataFechaAcualizado = '8/28/2023' + ' 7:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'39', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'37', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'92', Cost:12.03, ParentId: '17'},
		]
	},
