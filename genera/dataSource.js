const timestamp_saved = '09/18/2023 07:45 AM';
const dataFechaAcualizado = '9/18/2023' + ' 3:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'42', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'16', Cost:18.98, ParentId: '14'},
