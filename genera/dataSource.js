const timestamp_saved = '10/12/2023 06:10 AM';
const dataFechaAcualizado = '10/12/2023' + ' 2:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'61', Cost:10.14, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'86', Cost:16.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 187,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 187, MVar:'154', Cost:19.37, ParentId: '16'},
		]
	},
