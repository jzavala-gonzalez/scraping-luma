const timestamp_saved = '11/26/2023 04:05 AM';
const dataFechaAcualizado = '11/26/2023' + ' 12:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'24', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'34', Cost:11.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 318,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 81, MVar:'25', Cost:21.22, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'8', Cost:21.22, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'122', Cost:18.29, ParentId: '16'},
		]
	},
