const timestamp_saved = '10/22/2023 03:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 11:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'49', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'48', Cost:10.85, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:75.69, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'67', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'155', Cost:16.87, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'73', Cost:11.12, ParentId: '17'},
		]
	},
