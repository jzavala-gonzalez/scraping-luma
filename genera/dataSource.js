const timestamp_saved = '10/16/2023 10:00 PM';
const dataFechaAcualizado = '10/16/2023' + ' 5:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 561,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'70', Cost:9.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'70', Cost:9.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'66', Cost:9.84, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:26.20, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'88', Cost:17.11, ParentId: '15'},
