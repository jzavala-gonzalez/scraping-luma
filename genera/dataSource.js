const timestamp_saved = '10/23/2023 05:50 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'56', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'38', Cost:13.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'39', Cost:13.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'40', Cost:13.01, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'108', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'49', Cost:11.31, ParentId: '17'},
		]
	},
