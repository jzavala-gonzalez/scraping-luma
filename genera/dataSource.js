const timestamp_saved = '07/29/2023 06:35 AM';
const dataFechaAcualizado = '7/29/2023' + ' 2:30:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'46', Cost:11.31, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'6', Cost:18.69, ParentId: '14'},
