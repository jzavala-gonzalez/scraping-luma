const timestamp_saved = '11/01/2023 12:30 AM';
const dataFechaAcualizado = '10/31/2023' + ' 8:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'58', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'64', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'68', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 96, MVar:'29', Cost:18.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:18.31, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'20', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'82', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'165', Cost:16.73, ParentId: '16'},
		]
	},
