const timestamp_saved = '11/23/2023 11:45 PM';
const dataFechaAcualizado = '11/23/2023' + ' 7:41:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2146},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'34', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'96', Cost:9.21, ParentId: '17'},
		]
	},
