const timestamp_saved = '09/12/2023 04:25 AM';
const dataFechaAcualizado = '9/12/2023' + ' 12:20:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'66', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'77', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'58', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'58', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'70', Cost:10.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 151,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 15, MVar:'0', Cost:31.42, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 98, MVar:'0', Cost:10.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'8', Cost:10.10, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'151', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 0, MVar:'34', Cost:10.46, ParentId: '17'},
		]
	},
