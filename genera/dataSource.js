const timestamp_saved = '11/17/2023 01:30 PM';
const dataFechaAcualizado = '11/17/2023' + ' 9:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'58', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'58', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:34.88, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'32', Cost:30.82, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:17.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'10', Cost:17.04, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:19.46, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'90', Cost:16.92, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'105', Cost:9.38, ParentId: '17'},
		]
	},
