const timestamp_saved = '11/21/2023 04:30 AM';
const dataFechaAcualizado = '11/21/2023' + ' 12:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'28', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'38', Cost:11.96, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.14, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 115, MVar:'60', Cost:17.07, ParentId: '15'},
