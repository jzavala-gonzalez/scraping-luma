const timestamp_saved = '11/06/2023 04:00 AM';
const dataFechaAcualizado = '11/5/2023' + ' 11:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'45', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'44', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 84,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'1', Cost:22.28, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'79', Cost:16.78, ParentId: '15'},
