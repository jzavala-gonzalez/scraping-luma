const timestamp_saved = '08/20/2023 09:50 AM';
const dataFechaAcualizado = '8/20/2023' + ' 5:47:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'50', Cost:10.92, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 58,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'3', Cost:30.51, ParentId: '13'},
