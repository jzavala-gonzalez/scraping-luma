const timestamp_saved = '09/19/2023 12:35 PM';
const dataFechaAcualizado = '9/19/2023' + ' 8:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 227, MVar:'65', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'71', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'49', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'51', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'64', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'0', Cost:0, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'23', Cost:19.55, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 59,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 20, MVar:'2', Cost:19.60, ParentId: '19'},
