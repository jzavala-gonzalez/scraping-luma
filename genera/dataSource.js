const timestamp_saved = '10/25/2023 10:25 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'46', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'49', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'50', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 103, MVar:'32', Cost:18.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.19, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'49', Cost:16.93, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.71, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 2, MVar:'1', Cost:15.33, ParentId: '17'},
		]
	},
