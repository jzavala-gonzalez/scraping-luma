const timestamp_saved = '10/09/2023 05:20 AM';
const dataFechaAcualizado = '10/9/2023' + ' 1:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'44', Cost:11.59, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'0', Cost:23.26, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'143', Cost:16.61, ParentId: '16'},
		]
	},
