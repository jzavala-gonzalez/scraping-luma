const timestamp_saved = '11/14/2023 03:05 AM';
const dataFechaAcualizado = '11/13/2023' + ' 11:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 537,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'59', Cost:9.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 180, MVar:'64', Cost:9.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 181, MVar:'62', Cost:9.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'15', Cost:31.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:17.30, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'70', Cost:16.58, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'117', Cost:10.87, ParentId: '17'},
		]
	},
