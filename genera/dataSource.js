const timestamp_saved = '09/22/2023 09:25 AM';
const dataFechaAcualizado = '9/22/2023' + ' 5:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'41', Cost:11.12, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'64', Cost:16.46, ParentId: '15'},
