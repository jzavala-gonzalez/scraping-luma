const timestamp_saved = '12/03/2023 05:30 PM';
const dataFechaAcualizado = '12/3/2023' + ' 1:26:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1731},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'35', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'39', Cost:13.51, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.84, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'18', Cost:19.76, ParentId: '14'},
