const timestamp_saved = '09/03/2023 01:45 PM';
const dataFechaAcualizado = '9/3/2023' + ' 9:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'33', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'38', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'56', Cost:9.79, ParentId: '17'},
		]
	},
