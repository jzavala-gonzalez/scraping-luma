const timestamp_saved = '08/07/2023 01:50 AM';
const dataFechaAcualizado = '8/6/2023' + ' 9:45:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'59', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'53', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'5', Cost:22.83, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.58, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'14', Cost:22.40, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'4', Cost:26.41, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'25', Cost:27.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'26', Cost:28.00, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 257,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'70', Cost:18.31, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'28', Cost:15.77, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'125', Cost:11.64, ParentId: '17'},
		]
	},
