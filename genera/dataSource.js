const timestamp_saved = '10/30/2023 08:55 AM';
const dataFechaAcualizado = '10/30/2023' + ' 4:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'32', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'33', Cost:11.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'59', Cost:11.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'93', Cost:18.75, ParentId: '16'},
		]
	},
