const timestamp_saved = '08/13/2023 10:10 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:07:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'38', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'39', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'42', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'35', Cost:19.20, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'144', Cost:17.06, ParentId: '16'},
		]
	},
