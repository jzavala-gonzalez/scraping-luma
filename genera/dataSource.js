const timestamp_saved = '10/26/2023 09:40 PM';
const dataFechaAcualizado = '10/26/2023' + ' 5:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'49', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:10.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:35.21, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'36', Cost:18.46, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.98, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'146', Cost:16.74, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 73,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:45.16, ParentId: '21'},
