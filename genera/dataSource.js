const timestamp_saved = '10/09/2023 06:45 AM';
const dataFechaAcualizado = '10/9/2023' + ' 2:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'43', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'45', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'127', Cost:17.64, ParentId: '16'},
		]
	},
