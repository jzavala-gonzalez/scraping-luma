const timestamp_saved = '08/13/2023 06:55 AM';
const dataFechaAcualizado = '8/13/2023' + ' 2:52:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'42', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.13, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'41', Cost:18.86, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 331, MVar:'156', Cost:16.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'121', Cost:12.26, ParentId: '17'},
		]
	},
