const timestamp_saved = '10/14/2023 07:45 AM';
const dataFechaAcualizado = '10/14/2023' + ' 3:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'50', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'54', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'61', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'68', Cost:9.26, ParentId: '17'},
		]
	},
