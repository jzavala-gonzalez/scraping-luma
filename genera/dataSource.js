const timestamp_saved = '10/05/2023 09:35 PM';
const dataFechaAcualizado = '10/5/2023' + ' 5:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'46', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'45', Cost:10.36, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'39', Cost:18.06, ParentId: '11'},
