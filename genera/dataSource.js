const timestamp_saved = '09/03/2023 01:05 PM';
const dataFechaAcualizado = '9/3/2023' + ' 9:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'33', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'38', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'50', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'55', Cost:9.79, ParentId: '17'},
		]
	},
