const timestamp_saved = '08/22/2023 10:40 PM';
const dataFechaAcualizado = '8/22/2023' + ' 6:35:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'123', Cost:17.69, ParentId: '16'},
		]
	},
