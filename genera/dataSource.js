const timestamp_saved = '10/11/2023 07:25 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'44', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'50', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'57', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:17.71, ParentId: '11'},
