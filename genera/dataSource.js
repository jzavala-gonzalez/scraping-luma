const timestamp_saved = '11/24/2023 12:40 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'23', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'33', Cost:11.50, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'136', Cost:18.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'69', Cost:9.90, ParentId: '17'},
		]
	},
