const timestamp_saved = '11/29/2023 06:30 AM';
const dataFechaAcualizado = '11/29/2023' + ' 2:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'24', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'33', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'49', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:17.34, ParentId: '11'},
