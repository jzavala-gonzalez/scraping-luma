const timestamp_saved = '10/04/2023 06:40 PM';
const dataFechaAcualizado = '10/4/2023' + ' 2:36:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'48', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'46', Cost:10.51, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'36', Cost:17.96, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.88, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'18', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'82', Cost:17.03, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'114', Cost:9.36, ParentId: '17'},
		]
	},
