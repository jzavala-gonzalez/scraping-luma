const timestamp_saved = '12/03/2023 01:25 PM';
const dataFechaAcualizado = '12/3/2023' + ' 9:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 181,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 181, MVar:'60', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'37', Cost:13.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'40', Cost:13.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'45', Cost:13.37, ParentId: '7'},
		]
	},
