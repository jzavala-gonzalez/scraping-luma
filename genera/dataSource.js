const timestamp_saved = '08/08/2023 07:00 AM';
const dataFechaAcualizado = '8/8/2023' + ' 2:55:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'36', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'57', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'73', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:20.43, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'73', Cost:11.64, ParentId: '17'},
		]
	},
