const timestamp_saved = '09/04/2023 06:35 PM';
const dataFechaAcualizado = '9/4/2023' + ' 2:30:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'43', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'49', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'58', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'80', Cost:9.27, ParentId: '17'},
		]
	},
