const timestamp_saved = '09/04/2023 09:10 PM';
const dataFechaAcualizado = '9/4/2023' + ' 5:05:51 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2595},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'40', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'43', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'7', Cost:22.91, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:27.05, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 72, MVar:'18', Cost:28.16, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.30, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'179', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'79', Cost:9.18, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 15, MVar:'23', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 5, MVar:'11', Cost:17, ParentId: '19'},
		]
	},
