const timestamp_saved = '08/18/2023 02:40 AM';
const dataFechaAcualizado = '8/17/2023' + ' 10:37:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'64', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'73', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.38, ParentId: '14'},
