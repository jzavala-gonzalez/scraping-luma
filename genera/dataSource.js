const timestamp_saved = '08/08/2023 06:30 AM';
const dataFechaAcualizado = '8/8/2023' + ' 2:25:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'37', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'58', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'74', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'75', Cost:11.63, ParentId: '17'},
		]
	},
