const timestamp_saved = '08/28/2023 07:30 AM';
const dataFechaAcualizado = '8/28/2023' + ' 3:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.23, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'87', Cost:12.05, ParentId: '17'},
		]
	},
