const timestamp_saved = '11/22/2023 04:30 AM';
const dataFechaAcualizado = '11/22/2023' + ' 12:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'27', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'35', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'52', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'43', Cost:17.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.67, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 58,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 58, MVar:'67', Cost:21.55, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'86', Cost:9.14, ParentId: '17'},
		]
	},
