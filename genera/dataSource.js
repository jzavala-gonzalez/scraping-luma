const timestamp_saved = '09/01/2023 12:00 PM';
const dataFechaAcualizado = '9/1/2023' + ' 7:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'42', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'49', Cost:10.58, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'64', Cost:16.65, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'78', Cost:9.32, ParentId: '17'},
		]
	},
