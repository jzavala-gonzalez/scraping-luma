const timestamp_saved = '11/12/2023 07:35 AM';
const dataFechaAcualizado = '11/12/2023' + ' 3:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'40', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'42', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'50', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'1', Cost:31.18, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'74', Cost:9.64, ParentId: '17'},
		]
	},
