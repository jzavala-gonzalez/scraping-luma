const timestamp_saved = '09/25/2023 04:25 AM';
const dataFechaAcualizado = '9/25/2023' + ' 12:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'53', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'60', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:60.64, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.63, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:17.63, ParentId: '11'},
		]
	},
