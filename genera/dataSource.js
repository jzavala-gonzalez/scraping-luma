const timestamp_saved = '09/10/2023 12:05 PM';
const dataFechaAcualizado = '9/10/2023' + ' 8:00:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'60', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'59', Cost:11.35, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'116', Cost:17.85, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 29,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 14, MVar:'1', Cost:19.60, ParentId: '19'},
