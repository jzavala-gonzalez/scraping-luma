const timestamp_saved = '08/14/2023 05:40 PM';
const dataFechaAcualizado = '8/14/2023' + ' 1:37:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'110', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'47', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'51', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'49', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 57,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 57, MVar:'20', Cost:32.37, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:29.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 8, MVar:'2', Cost:29.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'11', Cost:31.31, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:29.89, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'171', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'133', Cost:12.29, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 122,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 36, MVar:'15', Cost:17, ParentId: '19'},
		]
	},
