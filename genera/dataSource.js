const timestamp_saved = '10/19/2023 03:35 AM';
const dataFechaAcualizado = '10/18/2023' + ' 11:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'41', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'47', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'61', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:22.95, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:16.47, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'9', Cost:18.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'182', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'97', Cost:10.53, ParentId: '17'},
		]
	},
