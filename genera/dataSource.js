const timestamp_saved = '11/15/2023 07:55 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'31', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'34', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'43', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'69', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'93', Cost:18.37, ParentId: '16'},
		]
	},
