const timestamp_saved = '09/10/2023 10:50 AM';
const dataFechaAcualizado = '9/10/2023' + ' 6:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'59', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'56', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'59', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'111', Cost:17.83, ParentId: '16'},
		]
	},
