const timestamp_saved = '11/08/2023 05:45 PM';
const dataFechaAcualizado = '11/8/2023' + ' 1:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'57', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'56', Cost:10.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 26, MVar:'0', Cost:21.89, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.81, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'3', Cost:30.88, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.78, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'96', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'164', Cost:18.22, ParentId: '16'},
		]
	},
