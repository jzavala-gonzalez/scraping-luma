const timestamp_saved = '11/28/2023 02:40 AM';
const dataFechaAcualizado = '11/27/2023' + ' 10:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'32', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'57', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'101', Cost:9.15, ParentId: '17'},
		]
	},
