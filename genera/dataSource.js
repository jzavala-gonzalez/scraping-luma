const timestamp_saved = '10/30/2023 06:20 AM';
const dataFechaAcualizado = '10/30/2023' + ' 2:16:18 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2038},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'35', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'36', Cost:11.22, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'102', Cost:18.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'36', Cost:9.68, ParentId: '17'},
		]
	},
