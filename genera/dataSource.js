const timestamp_saved = '08/16/2023 01:40 PM';
const dataFechaAcualizado = '8/16/2023' + ' 9:37:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'52', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'60', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 64, MVar:'30', Cost:20.15, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'87', Cost:10.41, ParentId: '17'},
		]
	},
