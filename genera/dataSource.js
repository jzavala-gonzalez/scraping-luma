const timestamp_saved = '10/08/2023 12:10 PM';
const dataFechaAcualizado = '10/8/2023' + ' 8:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'69', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'35', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'36', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'37', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'83', Cost:16.66, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 162, MVar:'66', Cost:11.36, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 53,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'0', Cost:19.60, ParentId: '19'},
