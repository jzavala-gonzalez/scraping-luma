const timestamp_saved = '09/28/2023 04:45 PM';
const dataFechaAcualizado = '9/28/2023' + ' 12:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'28', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'27', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'51', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.40, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.12, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:18.12, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'129', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'86', Cost:9.75, ParentId: '17'},
		]
	},
