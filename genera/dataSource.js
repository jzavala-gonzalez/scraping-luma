const timestamp_saved = '12/05/2023 05:50 PM';
const dataFechaAcualizado = '12/5/2023' + ' 1:45:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 617},
	{Index:'6', Desc:'Reserva Operacional', value: 1181},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'47', Cost:13.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'50', Cost:13.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'56', Cost:13.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.92, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'66', Cost:11.63, ParentId: '17'},
		]
	},
