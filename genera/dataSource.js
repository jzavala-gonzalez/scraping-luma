const timestamp_saved = '11/01/2023 05:50 AM';
const dataFechaAcualizado = '11/1/2023' + ' 1:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'50', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'56', Cost:10.48, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'59', Cost:16.99, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'56', Cost:9.62, ParentId: '17'},
		]
	},
