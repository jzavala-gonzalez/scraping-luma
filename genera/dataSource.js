const timestamp_saved = '11/17/2023 06:15 PM';
const dataFechaAcualizado = '11/17/2023' + ' 2:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'65', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'65', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'50', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'30', Cost:19.37, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'85', Cost:16.99, ParentId: '15'},
