const timestamp_saved = '10/14/2023 02:50 PM';
const dataFechaAcualizado = '10/14/2023' + ' 10:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'46', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'45', Cost:11.61, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'71', Cost:9.28, ParentId: '17'},
		]
	},
