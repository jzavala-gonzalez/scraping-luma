const timestamp_saved = '11/26/2023 02:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 10:26:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1827},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'21', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'31', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'47', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'119', Cost:19.76, ParentId: '16'},
		]
	},
