const timestamp_saved = '11/07/2023 09:20 PM';
const dataFechaAcualizado = '11/7/2023' + ' 5:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'54', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'51', Cost:10.95, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 59, MVar:'11', Cost:20.47, ParentId: '14'},
