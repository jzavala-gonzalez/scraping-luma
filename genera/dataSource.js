const timestamp_saved = '11/27/2023 05:45 PM';
const dataFechaAcualizado = '11/27/2023' + ' 1:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'37', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'47', Cost:10.58, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'98', Cost:9.61, ParentId: '17'},
		]
	},
