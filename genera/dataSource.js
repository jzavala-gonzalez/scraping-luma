const timestamp_saved = '11/12/2023 05:20 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:16:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2044},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'43', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'46', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'55', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'36', Cost:17.47, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.47, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'85', Cost:9.65, ParentId: '17'},
		]
	},
