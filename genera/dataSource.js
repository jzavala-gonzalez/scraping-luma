const timestamp_saved = '11/20/2023 11:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 7:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'36', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'44', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'57', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.26, ParentId: '11'},
