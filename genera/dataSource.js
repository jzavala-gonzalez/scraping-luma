const timestamp_saved = '09/04/2023 04:20 PM';
const dataFechaAcualizado = '9/4/2023' + ' 12:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'41', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'44', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'56', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.59, ParentId: '14'},
