const timestamp_saved = '09/18/2023 12:50 AM';
const dataFechaAcualizado = '9/17/2023' + ' 8:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'65', Cost:10.35, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 146,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.37, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'27', Cost:18.78, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'85', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'169', Cost:16.37, ParentId: '16'},
		]
	},
