const timestamp_saved = '10/13/2023 03:30 AM';
const dataFechaAcualizado = '10/12/2023' + ' 11:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'66', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'69', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'5', Cost:27.41, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:16.83, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'8', Cost:19.13, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 225,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 225, MVar:'67', Cost:10.12, ParentId: '17'},
		]
	},
