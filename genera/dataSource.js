const timestamp_saved = '08/02/2023 08:05 AM';
const dataFechaAcualizado = '8/2/2023' + ' 4:00:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'40', Cost:11.24, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'70', Cost:17.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'44', Cost:16.05, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'81', Cost:11.01, ParentId: '17'},
		]
	},
