const timestamp_saved = '11/12/2023 05:30 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'43', Cost:12.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'47', Cost:12.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'55', Cost:12.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'11', Cost:22.18, ParentId: '14'},
