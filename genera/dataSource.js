const timestamp_saved = '12/06/2023 12:35 PM';
const dataFechaAcualizado = '12/6/2023' + ' 8:30:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 828},
	{Index:'7', Desc:'Capacidad Disponible', value: 2971},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'50', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:10.79, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'28', Cost:19.72, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'70', Cost:14.31, ParentId: '17'},
		]
	},
