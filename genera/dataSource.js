const timestamp_saved = '10/25/2023 12:25 AM';
const dataFechaAcualizado = '10/24/2023' + ' 8:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'55', Cost:10.41, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.41, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 174,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 174, MVar:'12', Cost:11.31, ParentId: '17'},
		]
	},
