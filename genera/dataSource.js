const timestamp_saved = '11/05/2023 08:40 AM';
const dataFechaAcualizado = '11/5/2023' + ' 4:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'41', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'40', Cost:11.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'7', Cost:17.82, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'47', Cost:9.61, ParentId: '17'},
		]
	},
