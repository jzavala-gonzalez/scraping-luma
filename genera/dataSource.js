const timestamp_saved = '11/04/2023 12:45 PM';
const dataFechaAcualizado = '11/4/2023' + ' 8:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'44', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'43', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'56', Cost:9.76, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 52,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 23, MVar:'1', Cost:19.60, ParentId: '19'},
