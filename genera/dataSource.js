const timestamp_saved = '11/01/2023 12:20 AM';
const dataFechaAcualizado = '10/31/2023' + ' 8:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'59', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'64', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'68', Cost:11.27, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:25.19, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:25.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 30, MVar:'6', Cost:25.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'20', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'84', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'167', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'88', Cost:9.13, ParentId: '17'},
		]
	},
