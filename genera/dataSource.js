const timestamp_saved = '08/13/2023 10:15 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:12:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'40', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:11.14, ParentId: '7'},
		]
	},
