const timestamp_saved = '09/24/2023 03:10 PM';
const dataFechaAcualizado = '9/24/2023' + ' 11:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'47', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'47', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:11.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 330, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'26', Cost:19.14, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'85', Cost:9.55, ParentId: '17'},
		]
	},
