const timestamp_saved = '12/05/2023 03:35 AM';
const dataFechaAcualizado = '12/4/2023' + ' 11:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'47', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'49', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'56', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'4', Cost:18.82, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'11', Cost:18.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'114', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'72', Cost:10.87, ParentId: '17'},
		]
	},
