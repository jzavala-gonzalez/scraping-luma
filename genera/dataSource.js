const timestamp_saved = '07/25/2023 05:38 AM';
const dataFechaAcualizado = '7/25/2023' + ' 1:30:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'67', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'57', Cost:10.55, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'7', Cost:22.35, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:26.15, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:32.06, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'14', Cost:18.67, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'129', Cost:17.47, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:18.56, ParentId: '21'},
