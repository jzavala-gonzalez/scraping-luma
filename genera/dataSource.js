const timestamp_saved = '09/18/2023 03:05 PM';
const dataFechaAcualizado = '9/18/2023' + ' 11:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'50', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'48', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'28', Cost:18.89, ParentId: '14'},
