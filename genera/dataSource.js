const timestamp_saved = '11/07/2023 08:50 AM';
const dataFechaAcualizado = '11/7/2023' + ' 4:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'36', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'37', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'47', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'119', Cost:18.28, ParentId: '16'},
		]
	},
