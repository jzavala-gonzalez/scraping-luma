const timestamp_saved = '11/11/2023 03:55 PM';
const dataFechaAcualizado = '11/11/2023' + ' 11:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'42', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:11.66, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'12', Cost:17.51, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.86, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'102', Cost:9.84, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 100,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 40, MVar:'15', Cost:19.60, ParentId: '19'},
