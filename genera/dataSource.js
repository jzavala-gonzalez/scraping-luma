const timestamp_saved = '11/12/2023 07:40 AM';
const dataFechaAcualizado = '11/12/2023' + ' 3:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'39', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'42', Cost:12.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'50', Cost:12.63, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:28.89, ParentId: '12'},
