const timestamp_saved = '08/15/2023 03:40 PM';
const dataFechaAcualizado = '8/15/2023' + ' 11:37:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'55', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'51', Cost:10.08, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'15', Cost:30.26, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 54, MVar:'32', Cost:21.22, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 266,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 266, MVar:'188', Cost:17.80, ParentId: '16'},
		]
	},
