const timestamp_saved = '09/18/2023 08:40 AM';
const dataFechaAcualizado = '9/18/2023' + ' 4:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'63', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'40', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'38', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:10.87, ParentId: '7'},
		]
	},
