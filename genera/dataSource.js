const timestamp_saved = '10/25/2023 01:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 9:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'47', Cost:11.21, ParentId: '7'},
