const timestamp_saved = '11/15/2023 09:00 AM';
const dataFechaAcualizado = '11/15/2023' + ' 4:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'34', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'37', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'45', Cost:12.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'29', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'102', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'62', Cost:9.77, ParentId: '17'},
		]
	},
