const timestamp_saved = '12/01/2023 09:25 PM';
const dataFechaAcualizado = '12/1/2023' + ' 5:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'57', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'59', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 30, MVar:'0', Cost:281.31, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 65,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:29.67, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'154', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'94', Cost:9.16, ParentId: '17'},
		]
	},
