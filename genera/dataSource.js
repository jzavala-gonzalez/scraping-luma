const timestamp_saved = '10/23/2023 07:35 AM';
const dataFechaAcualizado = '10/23/2023' + ' 3:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'35', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'36', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'37', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'43', Cost:11.31, ParentId: '17'},
		]
	},
