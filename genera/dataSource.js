const timestamp_saved = '11/22/2023 03:40 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'30', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'40', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 33,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'1', Cost:27.36, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 79, MVar:'74', Cost:19.64, ParentId: '15'},
