const timestamp_saved = '11/23/2023 03:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 11:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 191, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'24', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'34', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'49', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'8', Cost:19.66, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'32', Cost:19.36, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'73', Cost:9.81, ParentId: '17'},
		]
	},
