const timestamp_saved = '07/31/2023 04:10 AM';
const dataFechaAcualizado = '7/31/2023' + ' 12:05:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'50', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'45', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 1, MVar:'0', Cost:36.26, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 117, MVar:'34', Cost:20.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:20.20, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'86', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'52', Cost:15.45, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'129', Cost:16.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'82', Cost:10.95, ParentId: '17'},
		]
	},
