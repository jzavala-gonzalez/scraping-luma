const timestamp_saved = '08/02/2023 11:55 AM';
const dataFechaAcualizado = '8/2/2023' + ' 7:50:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:10.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'11', Cost:20.44, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'88', Cost:11.02, ParentId: '17'},
		]
	},
