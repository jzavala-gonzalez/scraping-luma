const timestamp_saved = '11/28/2023 12:45 PM';
const dataFechaAcualizado = '11/28/2023' + ' 8:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'75', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'31', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'40', Cost:11.30, ParentId: '7'},
