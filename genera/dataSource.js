const timestamp_saved = '07/31/2023 05:05 PM';
const dataFechaAcualizado = '7/31/2023' + ' 1:00:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'55', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'49', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 148, MVar:'0', Cost:17.12, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'104', Cost:11.11, ParentId: '17'},
		]
	},
