const timestamp_saved = '09/11/2023 04:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 12:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'65', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'66', Cost:11.27, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:31.70, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'153', Cost:16.65, ParentId: '16'},
		]
	},
