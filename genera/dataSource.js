const timestamp_saved = '09/16/2023 07:00 AM';
const dataFechaAcualizado = '9/16/2023' + ' 2:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'43', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'58', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:8.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:8.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 117, MVar:'0', Cost:8.19, ParentId: '11'},
