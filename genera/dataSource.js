const timestamp_saved = '10/24/2023 01:45 AM';
const dataFechaAcualizado = '10/23/2023' + ' 9:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'57', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'57', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'57', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'13', Cost:27.17, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:17.22, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.48, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'77', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'155', Cost:16.67, ParentId: '16'},
		]
	},
