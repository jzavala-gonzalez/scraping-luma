const timestamp_saved = '08/28/2023 07:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 3:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'35', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'36', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:18.99, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'86', Cost:12.04, ParentId: '17'},
		]
	},
