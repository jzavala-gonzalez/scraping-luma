const timestamp_saved = '11/27/2023 11:05 AM';
const dataFechaAcualizado = '11/27/2023' + ' 7:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'24', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'32', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'48', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'50', Cost:8.19, ParentId: '11'},
