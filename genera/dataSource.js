const timestamp_saved = '09/26/2023 08:20 AM';
const dataFechaAcualizado = '9/26/2023' + ' 4:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'45', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'47', Cost:11.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:18.43, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'60', Cost:9.78, ParentId: '17'},
		]
	},
