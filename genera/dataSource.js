const timestamp_saved = '11/08/2023 01:15 PM';
const dataFechaAcualizado = '11/8/2023' + ' 9:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'51', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.40, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'94', Cost:9.60, ParentId: '17'},
		]
	},
