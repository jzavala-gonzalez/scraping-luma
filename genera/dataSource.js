const timestamp_saved = '11/26/2023 10:45 AM';
const dataFechaAcualizado = '11/26/2023' + ' 6:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'18', Cost:12.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'26', Cost:12.84, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.76, ParentId: '11'},
