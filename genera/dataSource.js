const timestamp_saved = '11/05/2023 04:30 PM';
const dataFechaAcualizado = '11/5/2023' + ' 12:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'44', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'42', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'42', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'35', Cost:17.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.97, ParentId: '11'},
