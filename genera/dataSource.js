const timestamp_saved = '11/28/2023 11:35 PM';
const dataFechaAcualizado = '11/28/2023' + ' 7:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'44', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'54', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'63', Cost:11.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.33, ParentId: '8'},
