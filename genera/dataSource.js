const timestamp_saved = '10/22/2023 01:05 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'39', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'40', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'45', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'13', Cost:19.04, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'54', Cost:11.21, ParentId: '17'},
		]
	},
