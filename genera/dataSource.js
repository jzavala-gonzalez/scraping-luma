const timestamp_saved = '11/10/2023 04:55 PM';
const dataFechaAcualizado = '11/10/2023' + ' 12:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'55', Cost:10.58, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 32, MVar:'16', Cost:25.28, ParentId: '14'},
