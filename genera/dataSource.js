const timestamp_saved = '11/01/2023 07:10 AM';
const dataFechaAcualizado = '11/1/2023' + ' 3:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'51', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'59', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'50', Cost:9.64, ParentId: '17'},
		]
	},
