const timestamp_saved = '11/10/2023 10:00 PM';
const dataFechaAcualizado = '11/10/2023' + ' 5:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'101', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'46', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'43', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'56', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:54.16, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'11', Cost:21.93, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'98', Cost:9.22, ParentId: '17'},
		]
	},
