const timestamp_saved = '08/12/2023 09:00 PM';
const dataFechaAcualizado = '8/12/2023' + ' 4:57:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'46', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'43', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:15.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:15.08, ParentId: '11'},
