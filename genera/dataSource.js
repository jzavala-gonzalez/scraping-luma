const timestamp_saved = '10/14/2023 06:30 PM';
const dataFechaAcualizado = '10/14/2023' + ' 2:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'58', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'57', Cost:10.30, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 20,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 20, MVar:'9', Cost:0, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'151', Cost:17.49, ParentId: '16'},
		]
	},
