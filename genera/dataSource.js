const timestamp_saved = '08/27/2023 04:00 PM';
const dataFechaAcualizado = '8/27/2023' + ' 11:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 264,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'27', Cost:14.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 96, MVar:'57', Cost:14.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'11', Cost:30.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:20.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:20.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:8.72, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'9', Cost:8.72, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'24', Cost:18.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'99', Cost:16.21, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'78', Cost:12.53, ParentId: '17'},
		]
	},
