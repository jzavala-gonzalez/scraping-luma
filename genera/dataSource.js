const timestamp_saved = '09/03/2023 02:05 PM';
const dataFechaAcualizado = '9/3/2023' + ' 10:00:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'34', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'39', Cost:10.56, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'14', Cost:19.01, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'56', Cost:9.81, ParentId: '17'},
		]
	},
