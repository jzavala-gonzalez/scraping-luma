const timestamp_saved = '11/20/2023 10:40 AM';
const dataFechaAcualizado = '11/20/2023' + ' 6:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'34', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'76', Cost:17.75, ParentId: '15'},
