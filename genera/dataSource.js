const timestamp_saved = '10/05/2023 09:55 AM';
const dataFechaAcualizado = '10/5/2023' + ' 5:51:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'37', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'34', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'49', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:31.83, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'97', Cost:9.21, ParentId: '17'},
		]
	},
