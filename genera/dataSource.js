const timestamp_saved = '09/13/2023 11:50 AM';
const dataFechaAcualizado = '9/13/2023' + ' 7:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'50', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'50', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'64', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'95', Cost:9.14, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 28,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 10, MVar:'3', Cost:19.60, ParentId: '19'},
