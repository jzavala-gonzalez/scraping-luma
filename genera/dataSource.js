const timestamp_saved = '11/04/2023 10:30 AM';
const dataFechaAcualizado = '11/4/2023' + ' 6:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'40', Cost:17.27, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'47', Cost:9.73, ParentId: '17'},
		]
	},
