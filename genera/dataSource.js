const timestamp_saved = '08/04/2023 12:05 AM';
const dataFechaAcualizado = '8/3/2023' + ' 8:00:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'56', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'54', Cost:10.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 99, MVar:'0', Cost:4.78, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'11', Cost:22.46, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:30.31, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'180', Cost:16.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'108', Cost:10.88, ParentId: '17'},
		]
	},
