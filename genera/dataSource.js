const timestamp_saved = '08/05/2023 07:25 AM';
const dataFechaAcualizado = '8/5/2023' + ' 3:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'45', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:10.42, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 177,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'0', Cost:21.87, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'0', Cost:21.85, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'95', Cost:16.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'124', Cost:18.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'84', Cost:11.32, ParentId: '17'},
		]
	},
