const timestamp_saved = '10/21/2023 05:30 PM';
const dataFechaAcualizado = '10/21/2023' + ' 1:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'44', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'41', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'40', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'79', Cost:11.06, ParentId: '17'},
		]
	},
