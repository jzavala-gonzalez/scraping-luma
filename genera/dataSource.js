const timestamp_saved = '08/05/2023 10:00 AM';
const dataFechaAcualizado = '8/5/2023' + ' 5:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'38', Cost:10.79, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'126', Cost:18.18, ParentId: '16'},
		]
	},
