const timestamp_saved = '09/18/2023 01:55 PM';
const dataFechaAcualizado = '9/18/2023' + ' 9:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'71', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'49', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'49', Cost:10.46, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'80', Cost:9.80, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 91,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'8', Cost:19.60, ParentId: '19'},
