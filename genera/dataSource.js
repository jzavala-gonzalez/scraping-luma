const timestamp_saved = '09/03/2023 08:30 PM';
const dataFechaAcualizado = '9/3/2023' + ' 4:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'63', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'39', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'43', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'54', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 54,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 3, MVar:'1', Cost:0, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 20,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'0', Cost:40.33, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'23', Cost:19.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'84', Cost:16.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'66', Cost:9.29, ParentId: '17'},
		]
	},
