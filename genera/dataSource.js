const timestamp_saved = '08/18/2023 02:20 AM';
const dataFechaAcualizado = '8/17/2023' + ' 10:17:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'53', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'66', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'74', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 121,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:25.61, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:19.80, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'180', Cost:16.60, ParentId: '16'},
		]
	},
