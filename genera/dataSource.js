const timestamp_saved = '11/13/2023 08:05 AM';
const dataFechaAcualizado = '11/13/2023' + ' 4:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'38', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'42', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'47', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'1', Cost:31.19, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'13', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'62', Cost:17.47, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 210,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 210, MVar:'73', Cost:10.42, ParentId: '17'},
		]
	},
