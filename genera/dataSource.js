const timestamp_saved = '11/16/2023 11:40 PM';
const dataFechaAcualizado = '11/16/2023' + ' 7:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'62', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'62', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'92', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 99, MVar:'183', Cost:25.74, ParentId: '16'},
		]
	},
