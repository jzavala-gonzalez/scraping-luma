const timestamp_saved = '10/04/2023 11:30 PM';
const dataFechaAcualizado = '10/4/2023' + ' 7:26:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'60', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:32.04, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.14, ParentId: '14'},
