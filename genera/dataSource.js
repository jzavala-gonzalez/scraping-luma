const timestamp_saved = '10/02/2023 07:20 AM';
const dataFechaAcualizado = '10/2/2023' + ' 3:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'33', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'29', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'46', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 40,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'7', Cost:26.65, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:31.74, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'86', Cost:9.83, ParentId: '17'},
		]
	},
