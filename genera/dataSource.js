const timestamp_saved = '08/12/2023 05:15 PM';
const dataFechaAcualizado = '8/12/2023' + ' 1:12:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:11.31, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:22.00, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:29.48, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'4', Cost:29.57, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 241,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 241, MVar:'143', Cost:18.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'98', Cost:11.63, ParentId: '17'},
		]
	},
