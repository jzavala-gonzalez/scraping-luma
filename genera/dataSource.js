const timestamp_saved = '12/06/2023 05:15 PM';
const dataFechaAcualizado = '12/6/2023' + ' 1:10:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 923},
	{Index:'7', Desc:'Capacidad Disponible', value: 3036},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'49', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'51', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'58', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:14.61, ParentId: '17'},
		]
	},
