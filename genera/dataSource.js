const timestamp_saved = '11/29/2023 09:50 PM';
const dataFechaAcualizado = '11/29/2023' + ' 5:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'54', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'58', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'57', Cost:10.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:25.88, ParentId: '8'},
