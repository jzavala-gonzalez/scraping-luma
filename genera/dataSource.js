const timestamp_saved = '08/08/2023 08:20 AM';
const dataFechaAcualizado = '8/8/2023' + ' 4:15:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'46', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:8.78, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'133', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'79', Cost:11.62, ParentId: '17'},
		]
	},
