const timestamp_saved = '08/14/2023 11:40 PM';
const dataFechaAcualizado = '8/14/2023' + ' 7:37:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 541,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'60', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 195, MVar:'54', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 189,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'5', Cost:22.87, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'28', Cost:28.13, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:20.00, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'10', Cost:28.73, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'12', Cost:28.55, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'31', Cost:18.70, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'187', Cost:16.41, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'148', Cost:11.62, ParentId: '17'},
		]
	},
