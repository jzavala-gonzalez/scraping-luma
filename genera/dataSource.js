const timestamp_saved = '11/22/2023 05:35 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'22', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'32', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'70', Cost:9.63, ParentId: '17'},
		]
	},
