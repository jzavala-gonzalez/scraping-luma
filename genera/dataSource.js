const timestamp_saved = '11/02/2023 01:10 AM';
const dataFechaAcualizado = '11/1/2023' + ' 9:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'72', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'72', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'70', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'98', Cost:9.15, ParentId: '17'},
		]
	},
