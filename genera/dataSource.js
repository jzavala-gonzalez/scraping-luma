const timestamp_saved = '08/16/2023 01:10 PM';
const dataFechaAcualizado = '8/16/2023' + ' 9:07:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'54', Cost:10.32, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 112,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 120, MVar:'40', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:30.87, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'11', Cost:31.15, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 61, MVar:'29', Cost:20.14, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'197', Cost:17.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'85', Cost:10.46, ParentId: '17'},
		]
	},
