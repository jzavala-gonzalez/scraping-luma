const timestamp_saved = '11/28/2023 01:30 PM';
const dataFechaAcualizado = '11/28/2023' + ' 9:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'33', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'44', Cost:10.94, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.27, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'160', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'95', Cost:9.45, ParentId: '17'},
		]
	},
