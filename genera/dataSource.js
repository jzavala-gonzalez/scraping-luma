const timestamp_saved = '10/02/2023 10:10 AM';
const dataFechaAcualizado = '10/2/2023' + ' 6:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'36', Cost:10.32, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'102', Cost:9.24, ParentId: '17'},
		]
	},
