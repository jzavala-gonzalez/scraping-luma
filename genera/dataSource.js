const timestamp_saved = '12/05/2023 05:10 PM';
const dataFechaAcualizado = '12/5/2023' + ' 1:05:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 104, MVar:'56', Cost:13.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'8', Cost:8.65, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 88, MVar:'20', Cost:18.71, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'26', Cost:19.58, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 223,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 223, MVar:'117', Cost:18.50, ParentId: '16'},
		]
	},
	...
	{Index:'18', Type:'Renovable', Desc:'Wind', SiteTotal: 81,
		units:[
