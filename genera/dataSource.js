const timestamp_saved = '11/24/2023 02:20 AM';
const dataFechaAcualizado = '11/23/2023' + ' 10:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'35', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'44', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'55', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'97', Cost:9.22, ParentId: '17'},
		]
	},
