const timestamp_saved = '09/18/2023 08:50 AM';
const dataFechaAcualizado = '9/18/2023' + ' 4:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'62', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'39', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'38', Cost:10.88, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 136, MVar:'47', Cost:0, ParentId: '8'},
