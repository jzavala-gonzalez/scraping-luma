const timestamp_saved = '10/17/2023 11:21 AM';
const dataFechaAcualizado = '10/17/2023' + ' 7:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'52', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'51', Cost:10.77, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.05, ParentId: '11'},
