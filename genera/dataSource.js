const timestamp_saved = '11/25/2023 04:50 PM';
const dataFechaAcualizado = '11/25/2023' + ' 12:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'26', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'34', Cost:11.50, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'27', Cost:19.31, ParentId: '14'},
