const timestamp_saved = '11/16/2023 02:20 AM';
const dataFechaAcualizado = '11/15/2023' + ' 10:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'54', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'54', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'57', Cost:11.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 5, MVar:'0', Cost:34.40, ParentId: '8'},
