const timestamp_saved = '10/25/2023 05:15 PM';
const dataFechaAcualizado = '10/25/2023' + ' 1:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'50', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'54', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:16.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'45', Cost:17.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'10', Cost:17.18, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'90', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'159', Cost:17.36, ParentId: '16'},
		]
	},
