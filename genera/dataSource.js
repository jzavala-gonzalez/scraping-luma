const timestamp_saved = '10/28/2023 01:30 AM';
const dataFechaAcualizado = '10/27/2023' + ' 9:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'47', Cost:11.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'6', Cost:18.51, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 39, MVar:'11', Cost:22.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'132', Cost:17.66, ParentId: '16'},
		]
	},
