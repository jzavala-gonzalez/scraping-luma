const timestamp_saved = '09/27/2023 05:30 PM';
const dataFechaAcualizado = '9/27/2023' + ' 1:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'34', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'34', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'63', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.88, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'113', Cost:9.11, ParentId: '17'},
		]
	},
