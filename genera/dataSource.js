const timestamp_saved = '10/23/2023 10:55 AM';
const dataFechaAcualizado = '10/23/2023' + ' 6:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'43', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'45', Cost:10.77, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'122', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'59', Cost:11.28, ParentId: '17'},
		]
	},
