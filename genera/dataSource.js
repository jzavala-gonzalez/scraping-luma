const timestamp_saved = '10/21/2023 08:10 AM';
const dataFechaAcualizado = '10/21/2023' + ' 4:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'20', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'19', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'57', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'69', Cost:11.05, ParentId: '17'},
		]
	},
