const timestamp_saved = '08/15/2023 01:00 AM';
const dataFechaAcualizado = '8/14/2023' + ' 8:57:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'63', Cost:9.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 179, MVar:'60', Cost:9.80, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:32.48, ParentId: '12'},
