const timestamp_saved = '10/08/2023 03:45 PM';
const dataFechaAcualizado = '10/8/2023' + ' 11:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'43', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'43', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'41', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'76', Cost:11.42, ParentId: '17'},
		]
	},
