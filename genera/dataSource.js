const timestamp_saved = '10/27/2023 11:15 AM';
const dataFechaAcualizado = '10/27/2023' + ' 7:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'51', Cost:10.07, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 125, MVar:'89', Cost:17.20, ParentId: '15'},
