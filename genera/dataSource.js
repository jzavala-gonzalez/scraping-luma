const timestamp_saved = '09/13/2023 05:45 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'56', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'55', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'67', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'14', Cost:28.33, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:39.91, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'105', Cost:9.10, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 70,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 12, MVar:'20', Cost:17, ParentId: '19'},
		]
	},
