const timestamp_saved = '12/01/2023 06:35 AM';
const dataFechaAcualizado = '12/1/2023' + ' 2:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'41', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'54', Cost:9.87, ParentId: '17'},
		]
	},
