const timestamp_saved = '10/18/2023 08:25 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'37', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:10.65, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 67, MVar:'64', Cost:20.80, ParentId: '15'},
