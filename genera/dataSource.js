const timestamp_saved = '10/24/2023 04:20 PM';
const dataFechaAcualizado = '10/24/2023' + ' 12:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'52', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'52', Cost:10.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:18.23, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'89', Cost:17.19, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 237,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 237, MVar:'150', Cost:18.31, ParentId: '16'},
		]
	},
