const timestamp_saved = '09/23/2023 04:40 AM';
const dataFechaAcualizado = '9/23/2023' + ' 12:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'57', Cost:12.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 138,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:34.33, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'39', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'4', Cost:28.12, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'9', Cost:18.90, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 56,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 56, MVar:'96', Cost:34.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'79', Cost:9.12, ParentId: '17'},
		]
	},
