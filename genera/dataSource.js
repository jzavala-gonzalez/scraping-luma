const timestamp_saved = '09/13/2023 02:05 AM';
const dataFechaAcualizado = '9/12/2023' + ' 10:00:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'52', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'51', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'65', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 111,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'0', Cost:21.94, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'85', Cost:16.82, ParentId: '15'},
