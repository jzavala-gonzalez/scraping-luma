const timestamp_saved = '12/03/2023 09:30 AM';
const dataFechaAcualizado = '12/3/2023' + ' 5:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'38', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'40', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'44', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.89, ParentId: '11'},
