const timestamp_saved = '12/03/2023 02:35 PM';
const dataFechaAcualizado = '12/3/2023' + ' 10:31:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 749},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 168, MVar:'59', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'38', Cost:13.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'37', Cost:13.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'43', Cost:13.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'37', Cost:8.77, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'16', Cost:19.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'91', Cost:18.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 233,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 233, MVar:'49', Cost:11.77, ParentId: '17'},
		]
	},
