const timestamp_saved = '08/24/2023 05:05 PM';
const dataFechaAcualizado = '8/24/2023' + ' 1:00:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'62', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'65', Cost:10.16, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'6', Cost:22.06, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'21', Cost:31.15, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'33', Cost:19.13, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 261, MVar:'192', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'104', Cost:9.24, ParentId: '17'},
		]
	},
