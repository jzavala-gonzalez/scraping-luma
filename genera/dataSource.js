const timestamp_saved = '11/21/2023 07:00 AM';
const dataFechaAcualizado = '11/21/2023' + ' 2:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'21', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'31', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'48', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'10', Cost:22.52, ParentId: '14'},
