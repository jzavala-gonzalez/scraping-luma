const timestamp_saved = '11/22/2023 07:45 PM';
const dataFechaAcualizado = '11/22/2023' + ' 3:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'37', Cost:10.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'46', Cost:10.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'59', Cost:10.02, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'4', Cost:69.76, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'171', Cost:18.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'101', Cost:9.38, ParentId: '17'},
		]
	},
