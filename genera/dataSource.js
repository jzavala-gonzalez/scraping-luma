const timestamp_saved = '08/11/2023 09:40 AM';
const dataFechaAcualizado = '8/11/2023' + ' 5:35:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'20', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'47', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'87', Cost:11.93, ParentId: '17'},
		]
	},
