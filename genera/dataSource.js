const timestamp_saved = '07/30/2023 02:35 PM';
const dataFechaAcualizado = '7/30/2023' + ' 10:30:34 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1163},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'63', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'45', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'40', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:19.66, ParentId: '11'},
