const timestamp_saved = '09/20/2023 02:45 AM';
const dataFechaAcualizado = '9/19/2023' + ' 10:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'80', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'84', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'49', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'51', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'63', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 5, MVar:'1', Cost:34.54, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'10', Cost:31.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:8.78, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:8.78, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.27, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 53,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'1', Cost:30.89, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.20, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'74', Cost:16.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'160', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'85', Cost:9.13, ParentId: '17'},
		]
	},
