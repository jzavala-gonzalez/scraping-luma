const timestamp_saved = '09/25/2023 03:25 PM';
const dataFechaAcualizado = '9/25/2023' + ' 11:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'41', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'44', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'52', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:19.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:19.85, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'158', Cost:17.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'85', Cost:9.94, ParentId: '17'},
		]
	},
