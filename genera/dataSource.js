const timestamp_saved = '09/07/2023 10:15 PM';
const dataFechaAcualizado = '9/7/2023' + ' 6:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'93', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'95', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'58', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'49', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'51', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'21', Cost:31.24, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'22', Cost:30.86, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:31.01, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:18.98, ParentId: '14'},
