const timestamp_saved = '08/21/2023 03:55 AM';
const dataFechaAcualizado = '8/20/2023' + ' 11:52:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'44', Cost:10.98, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'62', Cost:17.36, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'68', Cost:9.11, ParentId: '17'},
		]
	},
