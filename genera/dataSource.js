const timestamp_saved = '09/30/2023 10:05 PM';
const dataFechaAcualizado = '9/30/2023' + ' 6:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'67', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'39', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'35', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'50', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 186,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'7', Cost:24.05, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'0', Cost:22.41, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'6', Cost:30.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 57, MVar:'9', Cost:32.26, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:29.67, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'76', Cost:16.40, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'145', Cost:19.29, ParentId: '16'},
		]
	},
