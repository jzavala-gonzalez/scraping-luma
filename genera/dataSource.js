const timestamp_saved = '10/29/2023 01:30 PM';
const dataFechaAcualizado = '10/29/2023' + ' 9:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'69', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.69, ParentId: '14'},
