const timestamp_saved = '11/21/2023 07:35 PM';
const dataFechaAcualizado = '11/21/2023' + ' 3:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'33', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'43', Cost:11.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'160', Cost:18.17, ParentId: '16'},
		]
	},
