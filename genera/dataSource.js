const timestamp_saved = '11/15/2023 12:20 AM';
const dataFechaAcualizado = '11/14/2023' + ' 8:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'60', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'62', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'63', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:27.46, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'11', Cost:28.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'28', Cost:18.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'86', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 302,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 302, MVar:'175', Cost:17.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'122', Cost:10.92, ParentId: '17'},
		]
	},
