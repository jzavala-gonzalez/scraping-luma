const timestamp_saved = '11/01/2023 06:50 PM';
const dataFechaAcualizado = '11/1/2023' + ' 2:46:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2446},
	{Index:'8', Desc:'Máxima Mensual', value: 2449},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'65', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'68', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'71', Cost:10.44, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 27, MVar:'0', Cost:16.98, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'14', Cost:21.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'154', Cost:17.82, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 54,
		units:[
