const timestamp_saved = '09/24/2023 11:05 AM';
const dataFechaAcualizado = '9/24/2023' + ' 7:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'41', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'51', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'71', Cost:9.78, ParentId: '17'},
		]
	},
