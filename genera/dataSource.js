const timestamp_saved = '09/27/2023 09:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 5:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'29', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'31', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'60', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'77', Cost:9.15, ParentId: '17'},
		]
	},
