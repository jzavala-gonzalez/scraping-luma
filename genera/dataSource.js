const timestamp_saved = '08/29/2023 04:05 AM';
const dataFechaAcualizado = '8/29/2023' + ' 12:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'52', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'53', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 158,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'15', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'16', Cost:27.97, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.22, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'72', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'167', Cost:16.75, ParentId: '16'},
		]
	},
