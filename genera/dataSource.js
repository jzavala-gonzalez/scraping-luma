const timestamp_saved = '07/25/2023 02:19 AM';
const dataFechaAcualizado = '7/24/2023' + ' 10:10:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 227, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'74', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'65', Cost:9.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'69', Cost:9.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'60', Cost:9.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'10', Cost:22.36, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'13', Cost:28.21, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'13', Cost:28.17, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:28.31, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'9', Cost:29.65, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'17', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'58', Cost:15.42, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'149', Cost:17.62, ParentId: '16'},
		]
	},
