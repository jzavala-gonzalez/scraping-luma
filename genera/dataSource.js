const timestamp_saved = '11/06/2023 12:25 PM';
const dataFechaAcualizado = '11/6/2023' + ' 8:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'51', Cost:10.44, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'96', Cost:16.81, ParentId: '15'},
