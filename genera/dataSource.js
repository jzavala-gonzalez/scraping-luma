const timestamp_saved = '11/08/2023 08:00 AM';
const dataFechaAcualizado = '11/8/2023' + ' 3:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'36', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'42', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'60', Cost:16.84, ParentId: '15'},
