const timestamp_saved = '11/05/2023 12:35 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'42', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'41', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'40', Cost:12.15, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'74', Cost:18.44, ParentId: '15'},
