const timestamp_saved = '08/20/2023 08:15 AM';
const dataFechaAcualizado = '8/20/2023' + ' 4:12:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'50', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'53', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:31.15, ParentId: '10'},
		]
	},
