const timestamp_saved = '09/07/2023 04:10 AM';
const dataFechaAcualizado = '9/7/2023' + ' 12:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'52', Cost:13.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'28', Cost:13.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'48', Cost:13.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:20.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:20.20, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'8', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 362, MVar:'154', Cost:16.67, ParentId: '16'},
		]
	},
