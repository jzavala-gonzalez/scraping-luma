const timestamp_saved = '11/23/2023 05:50 PM';
const dataFechaAcualizado = '11/23/2023' + ' 1:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'22', Cost:13.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'34', Cost:13.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'50', Cost:13.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:8.75, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.48, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'52', Cost:9.83, ParentId: '17'},
		]
	},
