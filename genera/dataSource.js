const timestamp_saved = '09/04/2023 03:50 AM';
const dataFechaAcualizado = '9/3/2023' + ' 11:45:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'38', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'43', Cost:10.73, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:28.61, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'156', Cost:17.35, ParentId: '16'},
		]
	},
