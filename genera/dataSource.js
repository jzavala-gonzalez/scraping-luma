const timestamp_saved = '10/24/2023 07:50 PM';
const dataFechaAcualizado = '10/24/2023' + ' 3:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'14', Cost:30.72, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.48, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'153', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'86', Cost:11.27, ParentId: '17'},
		]
	},
