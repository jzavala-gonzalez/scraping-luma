const timestamp_saved = '12/06/2023 04:25 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:20:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 916},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'47', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'49', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'58', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:14.58, ParentId: '17'},
		]
	},
