const timestamp_saved = '09/20/2023 12:40 PM';
const dataFechaAcualizado = '9/20/2023' + ' 8:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'56', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'66', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'77', Cost:18.41, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 64,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 22, MVar:'10', Cost:19.60, ParentId: '19'},
