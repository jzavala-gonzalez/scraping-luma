const timestamp_saved = '08/17/2023 04:50 AM';
const dataFechaAcualizado = '8/17/2023' + ' 12:47:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'62', Cost:11.28, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 17, MVar:'7', Cost:27.21, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:19.79, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:30.65, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'11', Cost:18.74, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'181', Cost:16.97, ParentId: '16'},
		]
	},
