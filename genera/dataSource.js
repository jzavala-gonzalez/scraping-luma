const timestamp_saved = '10/30/2023 04:20 AM';
const dataFechaAcualizado = '10/30/2023' + ' 12:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'42', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'43', Cost:10.61, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'11', Cost:19.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'73', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 215,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'118', Cost:18.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'51', Cost:9.40, ParentId: '17'},
		]
	},
