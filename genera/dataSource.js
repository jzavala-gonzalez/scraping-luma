const timestamp_saved = '10/07/2023 02:00 PM';
const dataFechaAcualizado = '10/7/2023' + ' 9:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 121, MVar:'49', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'42', Cost:12.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'43', Cost:12.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:12.13, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 97,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 35, MVar:'14', Cost:19.60, ParentId: '19'},
