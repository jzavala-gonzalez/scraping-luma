const timestamp_saved = '08/20/2023 10:20 PM';
const dataFechaAcualizado = '8/20/2023' + ' 6:17:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'45', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'55', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'104', Cost:17.34, ParentId: '15'},
