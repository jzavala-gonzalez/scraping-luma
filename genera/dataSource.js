const timestamp_saved = '08/04/2023 09:45 AM';
const dataFechaAcualizado = '8/4/2023' + ' 5:40:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'70', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'38', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'44', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:20.10, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'75', Cost:16.54, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 154, MVar:'22', Cost:15.62, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'129', Cost:18.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'78', Cost:11.66, ParentId: '17'},
		]
	},
