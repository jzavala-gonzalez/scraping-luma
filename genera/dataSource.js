const timestamp_saved = '11/12/2023 10:55 AM';
const dataFechaAcualizado = '11/12/2023' + ' 6:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'40', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'42', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'51', Cost:17.61, ParentId: '15'},
