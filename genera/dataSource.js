const timestamp_saved = '10/05/2023 06:15 AM';
const dataFechaAcualizado = '10/5/2023' + ' 2:11:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'33', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'31', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'1', Cost:31.20, ParentId: '12'},
