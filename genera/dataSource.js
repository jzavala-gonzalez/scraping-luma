const timestamp_saved = '10/21/2023 10:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'32', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'31', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'29', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'74', Cost:11.04, ParentId: '17'},
		]
	},
