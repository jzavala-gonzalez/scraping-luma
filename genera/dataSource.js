const timestamp_saved = '10/02/2023 01:40 AM';
const dataFechaAcualizado = '10/1/2023' + ' 9:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'34', Cost:11.03, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'80', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'145', Cost:16.75, ParentId: '16'},
		]
	},
