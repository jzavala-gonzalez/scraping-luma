const timestamp_saved = '11/14/2023 07:00 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'45', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 221,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 221, MVar:'76', Cost:12.32, ParentId: '17'},
		]
	},
