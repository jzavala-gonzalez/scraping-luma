const timestamp_saved = '10/14/2023 07:45 PM';
const dataFechaAcualizado = '10/14/2023' + ' 3:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'62', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'64', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'63', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'14', Cost:19.29, ParentId: '14'},
