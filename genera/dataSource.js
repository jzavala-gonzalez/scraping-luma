const timestamp_saved = '08/07/2023 11:15 AM';
const dataFechaAcualizado = '8/7/2023' + ' 7:10:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'45', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'11', Cost:31.16, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'24', Cost:16.44, ParentId: '15'},
		]
	},
