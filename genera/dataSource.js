const timestamp_saved = '11/17/2023 08:45 AM';
const dataFechaAcualizado = '11/17/2023' + ' 4:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'48', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'48', Cost:12.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'39', Cost:12.63, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:30.96, ParentId: '13'},
