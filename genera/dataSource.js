const timestamp_saved = '11/16/2023 07:05 PM';
const dataFechaAcualizado = '11/16/2023' + ' 3:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'61', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'62', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'26', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'87', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 191,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 191, MVar:'158', Cost:18.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'99', Cost:9.71, ParentId: '17'},
		]
	},
