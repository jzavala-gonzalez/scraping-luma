const timestamp_saved = '09/17/2023 06:05 PM';
const dataFechaAcualizado = '9/17/2023' + ' 2:00:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'67', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'45', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'46', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'58', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'24', Cost:19.29, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 98, MVar:'82', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'115', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'73', Cost:9.64, ParentId: '17'},
		]
	},
