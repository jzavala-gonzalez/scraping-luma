const timestamp_saved = '08/20/2023 04:35 AM';
const dataFechaAcualizado = '8/20/2023' + ' 12:32:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'56', Cost:11.37, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'1', Cost:26.65, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'150', Cost:16.55, ParentId: '16'},
		]
	},
