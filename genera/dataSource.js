const timestamp_saved = '11/03/2023 03:50 PM';
const dataFechaAcualizado = '11/3/2023' + ' 11:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'54', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'54', Cost:11.71, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'9', Cost:30.62, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'79', Cost:9.78, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:25.85, ParentId: '21'},
