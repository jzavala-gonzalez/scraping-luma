const timestamp_saved = '07/31/2023 03:45 AM';
const dataFechaAcualizado = '7/30/2023' + ' 11:40:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'52', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 105,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'0', Cost:22.23, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:20.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'6', Cost:20.89, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.45, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'139', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'86', Cost:10.97, ParentId: '17'},
		]
	},
