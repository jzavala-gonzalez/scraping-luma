const timestamp_saved = '09/17/2023 08:15 AM';
const dataFechaAcualizado = '9/17/2023' + ' 4:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'37', Cost:12.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'56', Cost:12.74, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'59', Cost:17.68, ParentId: '15'},
