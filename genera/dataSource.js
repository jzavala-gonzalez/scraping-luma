const timestamp_saved = '11/22/2023 10:40 PM';
const dataFechaAcualizado = '11/22/2023' + ' 6:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'40', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'52', Cost:10.86, ParentId: '7'},
