const timestamp_saved = '10/09/2023 04:20 PM';
const dataFechaAcualizado = '10/9/2023' + ' 12:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'54', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'55', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'52', Cost:10.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:26.34, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:18.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.63, ParentId: '11'},
