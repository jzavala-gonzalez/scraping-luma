const timestamp_saved = '10/10/2023 07:15 PM';
const dataFechaAcualizado = '10/10/2023' + ' 3:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 233,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 233, MVar:'79', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'63', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'67', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'71', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'26', Cost:30.75, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:18.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:18.07, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:31.54, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'93', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'168', Cost:17.16, ParentId: '16'},
		]
	},
