const timestamp_saved = '11/27/2023 01:40 AM';
const dataFechaAcualizado = '11/26/2023' + ' 9:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'36', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'46', Cost:10.68, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'8', Cost:29.75, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'160', Cost:16.95, ParentId: '16'},
		]
	},
