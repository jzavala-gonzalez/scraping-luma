const timestamp_saved = '10/09/2023 10:30 AM';
const dataFechaAcualizado = '10/9/2023' + ' 6:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'43', Cost:10.86, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'134', Cost:17.83, ParentId: '16'},
		]
	},
