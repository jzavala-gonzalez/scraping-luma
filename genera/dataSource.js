const timestamp_saved = '08/01/2023 11:15 AM';
const dataFechaAcualizado = '8/1/2023' + ' 7:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'45', Cost:10.54, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'96', Cost:16.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'93', Cost:11.00, ParentId: '17'},
		]
	},
