const timestamp_saved = '11/20/2023 09:15 PM';
const dataFechaAcualizado = '11/20/2023' + ' 5:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'34', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'44', Cost:11.09, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'173', Cost:17.95, ParentId: '16'},
		]
	},
