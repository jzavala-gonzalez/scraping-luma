const timestamp_saved = '10/11/2023 12:00 PM';
const dataFechaAcualizado = '10/11/2023' + ' 7:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'47', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'52', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'60', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'64', Cost:9.11, ParentId: '17'},
		]
	},
