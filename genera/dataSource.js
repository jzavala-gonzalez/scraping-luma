const timestamp_saved = '10/25/2023 07:40 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'49', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 167, MVar:'51', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.80, ParentId: '12'},
