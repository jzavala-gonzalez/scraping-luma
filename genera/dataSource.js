const timestamp_saved = '10/25/2023 07:55 AM';
const dataFechaAcualizado = '10/25/2023' + ' 3:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'40', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'40', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'45', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:17.29, ParentId: '11'},
