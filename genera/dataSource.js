const timestamp_saved = '08/20/2023 04:30 PM';
const dataFechaAcualizado = '8/20/2023' + ' 12:27:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'52', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'49', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'92', Cost:18.41, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'57', Cost:9.66, ParentId: '17'},
		]
	},
