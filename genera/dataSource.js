const timestamp_saved = '10/30/2023 11:40 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'64', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'67', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'70', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'16', Cost:21.01, ParentId: '14'},
