const timestamp_saved = '10/26/2023 05:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 12:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'41', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'42', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'67', Cost:17.14, ParentId: '15'},
