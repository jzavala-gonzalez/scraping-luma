const timestamp_saved = '09/27/2023 08:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 4:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'26', Cost:12.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'25', Cost:12.27, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:8.83, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'72', Cost:9.15, ParentId: '17'},
		]
	},
