const timestamp_saved = '10/06/2023 10:10 AM';
const dataFechaAcualizado = '10/6/2023' + ' 6:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'163', Cost:17.54, ParentId: '16'},
		]
	},
