const timestamp_saved = '08/05/2023 04:35 PM';
const dataFechaAcualizado = '8/5/2023' + ' 12:30:39 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2374},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'43', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:39.23, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:34.85, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 65,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'0', Cost:31.54, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 311,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'75', Cost:16.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 162, MVar:'42', Cost:15.87, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 12,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 12, MVar:'122', Cost:39.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'90', Cost:11.86, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 107,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 39, MVar:'13', Cost:17, ParentId: '19'},
		]
	},
