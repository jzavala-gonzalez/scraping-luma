const timestamp_saved = '12/06/2023 07:25 AM';
const dataFechaAcualizado = '12/6/2023' + ' 3:20:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Próxima Hora MW', value: 1929},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'39', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'43', Cost:12.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'52', Cost:12.19, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'50', Cost:14.53, ParentId: '17'},
		]
	},
