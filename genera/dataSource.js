const timestamp_saved = '08/24/2023 01:35 PM';
const dataFechaAcualizado = '8/24/2023' + ' 9:30:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'84', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'55', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'15', Cost:31.24, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'29', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'173', Cost:17.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'92', Cost:9.23, ParentId: '17'},
		]
	},
