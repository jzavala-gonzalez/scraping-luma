const timestamp_saved = '11/18/2023 01:15 AM';
const dataFechaAcualizado = '11/17/2023' + ' 9:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'6', Cost:29.73, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'80', Cost:16.82, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'131', Cost:9.15, ParentId: '17'},
		]
	},
