const timestamp_saved = '09/26/2023 06:05 PM';
const dataFechaAcualizado = '9/26/2023' + ' 2:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'48', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'49', Cost:11.40, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'85', Cost:9.41, ParentId: '17'},
		]
	},
