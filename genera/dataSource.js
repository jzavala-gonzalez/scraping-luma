const timestamp_saved = '07/29/2023 11:35 PM';
const dataFechaAcualizado = '7/29/2023' + ' 7:30:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'54', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'50', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 172,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'4', Cost:22.44, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'10', Cost:31.21, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'12', Cost:31.45, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:31.38, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:28.72, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.78, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'95', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'40', Cost:15.48, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'94', Cost:10.95, ParentId: '17'},
		]
	},
