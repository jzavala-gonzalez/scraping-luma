const timestamp_saved = '09/03/2023 06:50 AM';
const dataFechaAcualizado = '9/3/2023' + ' 2:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'42', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'49', Cost:10.50, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.27, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'42', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 157, MVar:'132', Cost:20.27, ParentId: '16'},
		]
	},
