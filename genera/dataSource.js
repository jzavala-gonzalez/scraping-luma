const timestamp_saved = '08/10/2023 04:30 AM';
const dataFechaAcualizado = '8/10/2023' + ' 12:25:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'56', Cost:10.62, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 63,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 63, MVar:'21', Cost:18.70, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'78', Cost:12.01, ParentId: '17'},
		]
	},
