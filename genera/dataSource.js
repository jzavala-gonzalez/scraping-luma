const timestamp_saved = '10/31/2023 03:30 PM';
const dataFechaAcualizado = '10/31/2023' + ' 11:26:18 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2220},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'64', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'66', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'162', Cost:17.77, ParentId: '16'},
		]
	},
