const timestamp_saved = '10/24/2023 05:45 PM';
const dataFechaAcualizado = '10/24/2023' + ' 1:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'56', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'55', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.09, ParentId: '11'},
