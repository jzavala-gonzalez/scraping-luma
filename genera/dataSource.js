const timestamp_saved = '10/11/2023 03:35 AM';
const dataFechaAcualizado = '10/10/2023' + ' 11:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'59', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'62', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'66', Cost:10.86, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:26.38, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:26.69, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'93', Cost:16.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'160', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'83', Cost:9.08, ParentId: '17'},
		]
	},
