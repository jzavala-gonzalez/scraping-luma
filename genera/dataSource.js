const timestamp_saved = '10/15/2023 07:20 AM';
const dataFechaAcualizado = '10/15/2023' + ' 3:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'49', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'50', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'54', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'64', Cost:9.14, ParentId: '17'},
		]
	},
