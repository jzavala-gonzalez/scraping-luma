const timestamp_saved = '12/02/2023 10:25 AM';
const dataFechaAcualizado = '12/2/2023' + ' 6:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'42', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'44', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'43', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.79, ParentId: '11'},
