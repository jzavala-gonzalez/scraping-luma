const timestamp_saved = '10/26/2023 06:00 PM';
const dataFechaAcualizado = '10/26/2023' + ' 1:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'45', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'52', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'51', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:16.94, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'42', Cost:17.29, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'147', Cost:17.39, ParentId: '16'},
		]
	},
