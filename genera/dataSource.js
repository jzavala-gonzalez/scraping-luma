const timestamp_saved = '09/17/2023 11:20 AM';
const dataFechaAcualizado = '9/17/2023' + ' 7:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'41', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'41', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'56', Cost:10.87, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 136, MVar:'53', Cost:0, ParentId: '8'},
