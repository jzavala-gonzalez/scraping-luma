const timestamp_saved = '10/27/2023 03:15 AM';
const dataFechaAcualizado = '10/26/2023' + ' 11:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'47', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:10.73, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'126', Cost:17.04, ParentId: '16'},
		]
	},
