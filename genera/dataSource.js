const timestamp_saved = '11/18/2023 09:45 AM';
const dataFechaAcualizado = '11/18/2023' + ' 5:41:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2484},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 277,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'40', Cost:16.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'64', Cost:16.01, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'74', Cost:16.68, ParentId: '15'},
