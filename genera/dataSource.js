const timestamp_saved = '09/04/2023 09:20 PM';
const dataFechaAcualizado = '9/4/2023' + ' 5:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'40', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'46', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'57', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'14', Cost:27.65, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'80', Cost:9.19, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 13,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'25', Cost:19.60, ParentId: '19'},
