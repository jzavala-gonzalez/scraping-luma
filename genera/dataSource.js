const timestamp_saved = '09/24/2023 04:50 AM';
const dataFechaAcualizado = '9/24/2023' + ' 12:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'45', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'46', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'55', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'4', Cost:27.97, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'87', Cost:9.22, ParentId: '17'},
		]
	},
