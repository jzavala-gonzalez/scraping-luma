const timestamp_saved = '10/12/2023 03:01 PM';
const dataFechaAcualizado = '10/12/2023' + ' 10:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 225,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 225, MVar:'78', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'60', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'65', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'67', Cost:10.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:42.27, ParentId: '8'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 74,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:59.55, ParentId: '21'},
