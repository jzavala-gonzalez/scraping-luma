const timestamp_saved = '08/28/2023 07:45 AM';
const dataFechaAcualizado = '8/28/2023' + ' 3:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'36', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'36', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'86', Cost:12.07, ParentId: '17'},
		]
	},
