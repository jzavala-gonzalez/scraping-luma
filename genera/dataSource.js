const timestamp_saved = '11/30/2023 03:55 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'49', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'53', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'151', Cost:18.25, ParentId: '16'},
		]
	},
