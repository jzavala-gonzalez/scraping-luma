const timestamp_saved = '11/12/2023 04:30 PM';
const dataFechaAcualizado = '11/12/2023' + ' 12:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'43', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'45', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'54', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'86', Cost:9.67, ParentId: '17'},
		]
	},
