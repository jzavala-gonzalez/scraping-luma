const timestamp_saved = '10/25/2023 02:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 10:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'47', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'25', Cost:19.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'143', Cost:17.48, ParentId: '16'},
		]
	},
