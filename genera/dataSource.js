const timestamp_saved = '08/15/2023 04:45 PM';
const dataFechaAcualizado = '8/15/2023' + ' 12:42:53 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2576},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'55', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'48', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 59, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 61, MVar:'11', Cost:27.36, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.09, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'5', Cost:30.59, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'31', Cost:19.97, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'188', Cost:17.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'123', Cost:11.63, ParentId: '17'},
		]
	},
