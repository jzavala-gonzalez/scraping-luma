const timestamp_saved = '09/28/2023 08:35 PM';
const dataFechaAcualizado = '9/28/2023' + ' 4:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'50', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'50', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:17.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:20.77, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'0', Cost:20.77, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'94', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'156', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'106', Cost:9.12, ParentId: '17'},
		]
	},
