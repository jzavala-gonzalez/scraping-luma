const timestamp_saved = '07/31/2023 11:45 AM';
const dataFechaAcualizado = '7/31/2023' + ' 7:40:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'44', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'46', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:26.13, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'6', Cost:17.14, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'111', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'85', Cost:11.13, ParentId: '17'},
		]
	},
