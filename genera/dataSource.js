const timestamp_saved = '10/26/2023 08:35 PM';
const dataFechaAcualizado = '10/26/2023' + ' 4:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'53', Cost:10.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'145', Cost:17.17, ParentId: '16'},
		]
	},
