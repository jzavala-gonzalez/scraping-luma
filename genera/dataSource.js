const timestamp_saved = '08/23/2023 10:05 PM';
const dataFechaAcualizado = '8/23/2023' + ' 6:00:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'58', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'57', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'55', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'6', Cost:61.45, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.24, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'2', Cost:22.98, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'167', Cost:16.96, ParentId: '16'},
		]
	},
