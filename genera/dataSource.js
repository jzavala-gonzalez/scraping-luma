const timestamp_saved = '10/21/2023 07:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 3:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'22', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'19', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'58', Cost:12.15, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'69', Cost:11.03, ParentId: '17'},
		]
	},
