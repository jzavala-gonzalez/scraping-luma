const timestamp_saved = '11/23/2023 11:50 AM';
const dataFechaAcualizado = '11/23/2023' + ' 7:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'71', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'21', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'31', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'47', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'9', Cost:19.58, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'63', Cost:9.78, ParentId: '17'},
		]
	},
