const timestamp_saved = '09/28/2023 07:25 AM';
const dataFechaAcualizado = '9/28/2023' + ' 3:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'17', Cost:12.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'17', Cost:12.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'44', Cost:12.98, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'51', Cost:16.95, ParentId: '15'},
