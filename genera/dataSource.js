const timestamp_saved = '10/22/2023 01:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 9:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'49', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'50', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'53', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.00, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 36,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 36, MVar:'9', Cost:26.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'57', Cost:16.75, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 266,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 266, MVar:'74', Cost:11.12, ParentId: '17'},
		]
	},
