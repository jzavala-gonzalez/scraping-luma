const timestamp_saved = '11/14/2023 05:00 AM';
const dataFechaAcualizado = '11/14/2023' + ' 12:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'44', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'50', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'53', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'60', Cost:16.89, ParentId: '15'},
