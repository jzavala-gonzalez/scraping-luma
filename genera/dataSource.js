const timestamp_saved = '08/27/2023 06:40 PM';
const dataFechaAcualizado = '8/27/2023' + ' 2:35:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1127},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'65', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'75', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'30', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'30', Cost:10.37, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'10', Cost:31.09, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 139, MVar:'44', Cost:19.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:19.90, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 135, MVar:'0', Cost:8.66, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'86', Cost:12.52, ParentId: '17'},
		]
	},
