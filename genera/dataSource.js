const timestamp_saved = '07/30/2023 04:30 AM';
const dataFechaAcualizado = '7/30/2023' + ' 12:25:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'42', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'42', Cost:11.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'38', Cost:11.60, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 164,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 46, MVar:'0', Cost:22.03, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.80, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'6', Cost:22.52, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 92,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'1', Cost:31.88, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'3', Cost:31.86, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 137, MVar:'40', Cost:18.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.07, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'8', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'62', Cost:16.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 166, MVar:'35', Cost:15.49, ParentId: '15'},
		]
	},
