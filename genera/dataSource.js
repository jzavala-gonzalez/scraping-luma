const timestamp_saved = '12/01/2023 12:35 AM';
const dataFechaAcualizado = '11/30/2023' + ' 8:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'63', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'65', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'60', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'162', Cost:18.30, ParentId: '16'},
		]
	},
