const timestamp_saved = '09/12/2023 07:05 AM';
const dataFechaAcualizado = '9/12/2023' + ' 3:00:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'60', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'61', Cost:10.35, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.45, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:31.10, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.77, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.47, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 142,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 142, MVar:'116', Cost:21.55, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'33', Cost:10.44, ParentId: '17'},
		]
	},
