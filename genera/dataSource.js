const timestamp_saved = '09/28/2023 06:40 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'18', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'19', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'43', Cost:11.75, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.23, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 216,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 216, MVar:'105', Cost:19.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'66', Cost:9.72, ParentId: '17'},
		]
	},
