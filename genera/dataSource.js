const timestamp_saved = '07/25/2023 02:51 PM';
const dataFechaAcualizado = '7/25/2023' + ' 10:45:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'78', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'54', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:9.54, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'8', Cost:9.54, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.96, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 192,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 192, MVar:'71', Cost:10.66, ParentId: '17'},
		]
	},
