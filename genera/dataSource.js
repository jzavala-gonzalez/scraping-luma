const timestamp_saved = '08/02/2023 09:10 PM';
const dataFechaAcualizado = '8/2/2023' + ' 5:05:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'40', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:20.45, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'3', Cost:30.86, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'94', Cost:16.61, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'13', Cost:15.84, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'150', Cost:17.22, ParentId: '16'},
		]
	},
