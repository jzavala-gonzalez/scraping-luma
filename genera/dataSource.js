const timestamp_saved = '11/29/2023 12:20 AM';
const dataFechaAcualizado = '11/28/2023' + ' 8:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'43', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'53', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'64', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:26.30, ParentId: '9'},
