const timestamp_saved = '09/19/2023 07:05 AM';
const dataFechaAcualizado = '9/19/2023' + ' 3:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'45', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'44', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'61', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'138', Cost:17.84, ParentId: '16'},
		]
	},
