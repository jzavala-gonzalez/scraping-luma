const timestamp_saved = '08/18/2023 06:45 AM';
const dataFechaAcualizado = '8/18/2023' + ' 2:42:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'39', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'53', Cost:10.92, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:31.15, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'1', Cost:31.20, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'123', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'59', Cost:9.43, ParentId: '17'},
		]
	},
