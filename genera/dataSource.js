const timestamp_saved = '10/27/2023 12:15 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'49', Cost:11.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'47', Cost:11.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'51', Cost:11.89, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'50', Cost:17.10, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'23', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 113, MVar:'109', Cost:17.91, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'12', Cost:11.52, ParentId: '17'},
		]
	},
