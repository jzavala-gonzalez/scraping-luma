const timestamp_saved = '10/15/2023 07:45 AM';
const dataFechaAcualizado = '10/15/2023' + ' 3:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'48', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'49', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'54', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'61', Cost:9.16, ParentId: '17'},
		]
	},
