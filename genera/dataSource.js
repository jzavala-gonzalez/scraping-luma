const timestamp_saved = '08/24/2023 09:15 PM';
const dataFechaAcualizado = '8/24/2023' + ' 5:10:46 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2951},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'64', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'60', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'14', Cost:52.83, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'33', Cost:19.27, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'88', Cost:16.98, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 66,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:23.96, ParentId: '21'},
