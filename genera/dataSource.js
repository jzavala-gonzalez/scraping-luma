const timestamp_saved = '10/02/2023 10:55 AM';
const dataFechaAcualizado = '10/2/2023' + ' 6:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'33', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'32', Cost:10.77, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'133', Cost:18.31, ParentId: '16'},
		]
	},
