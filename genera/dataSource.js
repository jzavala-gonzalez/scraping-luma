const timestamp_saved = '09/28/2023 07:00 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'19', Cost:12.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'17', Cost:12.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'43', Cost:12.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'91', Cost:18.44, ParentId: '16'},
		]
	},
