const timestamp_saved = '08/04/2023 04:55 PM';
const dataFechaAcualizado = '8/4/2023' + ' 12:50:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'50', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'48', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'50', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 251,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'86', Cost:18.04, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'39', Cost:15.74, ParentId: '15'},
		]
	},
