const timestamp_saved = '10/02/2023 09:00 AM';
const dataFechaAcualizado = '10/2/2023' + ' 4:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'31', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'31', Cost:11.04, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'127', Cost:17.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'94', Cost:9.50, ParentId: '17'},
		]
	},
