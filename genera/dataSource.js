const timestamp_saved = '09/04/2023 04:05 PM';
const dataFechaAcualizado = '9/4/2023' + ' 12:00:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'40', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'44', Cost:10.67, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.16, ParentId: '14'},
