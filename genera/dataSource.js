const timestamp_saved = '07/26/2023 10:22 AM';
const dataFechaAcualizado = '7/26/2023' + ' 6:15:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 225, MVar:'75', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'81', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'55', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'53', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:30.29, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'65', Cost:15.42, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'80', Cost:9.34, ParentId: '17'},
		]
	},
