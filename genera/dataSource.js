const timestamp_saved = '10/18/2023 08:00 AM';
const dataFechaAcualizado = '10/18/2023' + ' 3:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:10.79, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 70, MVar:'65', Cost:20.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'82', Cost:10.67, ParentId: '17'},
		]
	},
