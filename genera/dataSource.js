const timestamp_saved = '11/16/2023 08:30 AM';
const dataFechaAcualizado = '11/16/2023' + ' 4:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'41', Cost:12.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'41', Cost:12.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:12.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 166, MVar:'25', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'53', Cost:10.84, ParentId: '17'},
		]
	},
