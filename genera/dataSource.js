const timestamp_saved = '09/02/2023 04:45 AM';
const dataFechaAcualizado = '9/2/2023' + ' 12:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'43', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'52', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'61', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 91,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'4', Cost:30.88, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'70', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'128', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'66', Cost:9.42, ParentId: '17'},
		]
	},
