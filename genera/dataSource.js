const timestamp_saved = '07/27/2023 05:17 AM';
const dataFechaAcualizado = '7/27/2023' + ' 1:10:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'55', Cost:11.31, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:108.22, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 58,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 5, MVar:'0', Cost:31.43, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'10', Cost:31.12, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 128, MVar:'0', Cost:8.12, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.37, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'17', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 340,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'102', Cost:16.49, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'24', Cost:15.48, ParentId: '15'},
		]
	},
