const timestamp_saved = '10/29/2023 10:40 AM';
const dataFechaAcualizado = '10/29/2023' + ' 6:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'42', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'45', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'68', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'16', Cost:21.48, ParentId: '14'},
