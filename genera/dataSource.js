const timestamp_saved = '11/30/2023 01:10 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'50', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'53', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'54', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.55, ParentId: '11'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:19.09, ParentId: '21'},
