const timestamp_saved = '09/20/2023 08:55 PM';
const dataFechaAcualizado = '9/20/2023' + ' 4:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'49', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'54', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'61', Cost:10.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.88, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.24, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'11', Cost:31.14, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'13', Cost:31.17, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 355,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 114, MVar:'0', Cost:10.04, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'8', Cost:10.04, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'8', Cost:29.07, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'32', Cost:26.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'170', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'100', Cost:9.14, ParentId: '17'},
		]
	},
