const timestamp_saved = '10/20/2023 06:30 AM';
const dataFechaAcualizado = '10/20/2023' + ' 2:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'34', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'39', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'40', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'80', Cost:10.55, ParentId: '17'},
		]
	},
