const timestamp_saved = '10/31/2023 04:05 AM';
const dataFechaAcualizado = '10/31/2023' + ' 12:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'53', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'56', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'63', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 242,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 242, MVar:'153', Cost:17.56, ParentId: '16'},
		]
	},
