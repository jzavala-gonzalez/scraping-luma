const timestamp_saved = '07/30/2023 03:55 PM';
const dataFechaAcualizado = '7/30/2023' + ' 11:50:34 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1222},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 226, MVar:'64', Cost:4.38, ParentId: '6'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:19.76, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'108', Cost:19.88, ParentId: '16'},
		]
	},
