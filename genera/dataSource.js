const timestamp_saved = '10/31/2023 01:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 8:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'62', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'66', Cost:10.62, ParentId: '7'},
