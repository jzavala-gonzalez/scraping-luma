const timestamp_saved = '10/09/2023 05:50 AM';
const dataFechaAcualizado = '10/9/2023' + ' 1:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'44', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'46', Cost:11.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 324, MVar:'137', Cost:16.69, ParentId: '16'},
		]
	},
