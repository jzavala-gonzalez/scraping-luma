const timestamp_saved = '10/20/2023 11:10 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'44', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'49', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'156', Cost:17.22, ParentId: '16'},
		]
	},
