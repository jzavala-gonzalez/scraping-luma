const timestamp_saved = '09/06/2023 11:45 PM';
const dataFechaAcualizado = '9/6/2023' + ' 7:40:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'104', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'106', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'67', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'45', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'57', Cost:10.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 184,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:7.37, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'6', Cost:21.98, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'28', Cost:30.92, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'14', Cost:29.49, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'13', Cost:31.22, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.25, ParentId: '14'},
