const timestamp_saved = '08/30/2023 11:05 AM';
const dataFechaAcualizado = '8/30/2023' + ' 7:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 158, MVar:'82', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'44', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'45', Cost:10.99, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:26.57, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 54, MVar:'31', Cost:21.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'77', Cost:16.77, ParentId: '15'},
