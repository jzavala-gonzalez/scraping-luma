const timestamp_saved = '08/05/2023 06:35 PM';
const dataFechaAcualizado = '8/5/2023' + ' 2:30:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'51', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:26.79, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'96', Cost:11.86, ParentId: '17'},
		]
	},
