const timestamp_saved = '11/21/2023 02:15 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'32', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'42', Cost:11.13, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'13', Cost:22.29, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'92', Cost:9.64, ParentId: '17'},
		]
	},
