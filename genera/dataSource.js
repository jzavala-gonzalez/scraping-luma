const timestamp_saved = '10/22/2023 02:00 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'40', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'45', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'57', Cost:11.23, ParentId: '17'},
		]
	},
