const timestamp_saved = '10/20/2023 09:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 5:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'33', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'40', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'40', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'86', Cost:10.52, ParentId: '17'},
		]
	},
