const timestamp_saved = '09/21/2023 07:35 PM';
const dataFechaAcualizado = '9/21/2023' + ' 3:30:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 230},
	{Index:'5', Desc:'Capacidad Disponible', value: 2966},
	{Index:'6', Desc:'Próxima Hora MW', value: 2677},
	{Index:'7', Desc:'Máxima para Hoy', value: 2763},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'79', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'98', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'50', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'53', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'69', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 95, MVar:'0', Cost:4.84, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:30.67, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:31.64, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 16, MVar:'0', Cost:42.58, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:31.37, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 151, MVar:'66', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 133,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'4', Cost:22.02, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 33, MVar:'7', Cost:28.69, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'4', Cost:22.21, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'9', Cost:31.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:31.21, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:19.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:8.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'8', Cost:8.11, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'10', Cost:28.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:47.01, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'7', Cost:28.65, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'28', Cost:26.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'101', Cost:16.44, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 71, MVar:'89', Cost:31.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'115', Cost:16.19, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 7, MVar:'1', Cost:18.32, ParentId: '19'},
			...
			{Index:'4', Unit:'Oriana', MW: 2, MVar:'26', Cost:19.60, ParentId: '19'},
