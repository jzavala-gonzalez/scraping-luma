const timestamp_saved = '12/06/2023 01:45 PM';
const dataFechaAcualizado = '12/6/2023' + ' 9:40:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 504},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'49', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'51', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'58', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'12', Cost:18.77, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'69', Cost:14.32, ParentId: '17'},
		]
	},
