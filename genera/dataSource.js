const timestamp_saved = '11/30/2023 08:35 AM';
const dataFechaAcualizado = '11/30/2023' + ' 4:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'35', Cost:12.80, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:8.18, ParentId: '11'},
