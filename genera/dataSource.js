const timestamp_saved = '09/24/2023 06:25 AM';
const dataFechaAcualizado = '9/24/2023' + ' 2:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'41', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'41', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'53', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.47, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.47, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:8.43, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:8.43, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'5', Cost:28.43, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'54', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'76', Cost:9.16, ParentId: '17'},
		]
	},
