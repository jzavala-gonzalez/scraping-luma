const timestamp_saved = '08/13/2023 06:30 PM';
const dataFechaAcualizado = '8/13/2023' + ' 2:27:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'40', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'39', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'107', Cost:12.41, ParentId: '17'},
		]
	},
