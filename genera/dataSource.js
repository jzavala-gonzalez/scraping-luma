const timestamp_saved = '11/10/2023 11:55 AM';
const dataFechaAcualizado = '11/10/2023' + ' 7:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'51', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'56', Cost:11.26, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'10', Cost:21.85, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'13', Cost:19.08, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 15,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 16, MVar:'17', Cost:19.60, ParentId: '19'},
