const timestamp_saved = '11/06/2023 01:50 AM';
const dataFechaAcualizado = '11/5/2023' + ' 9:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'50', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'51', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'48', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 177,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'5', Cost:22.96, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:30.66, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'77', Cost:9.24, ParentId: '17'},
		]
	},
