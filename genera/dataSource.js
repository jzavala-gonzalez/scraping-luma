const timestamp_saved = '11/22/2023 04:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 12:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'29', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'37', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 69, MVar:'68', Cost:20.52, ParentId: '15'},
