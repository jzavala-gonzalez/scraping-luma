const timestamp_saved = '10/01/2023 02:55 PM';
const dataFechaAcualizado = '10/1/2023' + ' 10:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'27', Cost:11.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'26', Cost:11.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'43', Cost:11.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'86', Cost:9.48, ParentId: '17'},
		]
	},
