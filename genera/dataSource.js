const timestamp_saved = '08/23/2023 01:20 PM';
const dataFechaAcualizado = '8/23/2023' + ' 9:15:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'54', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'52', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'33', Cost:18.84, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'151', Cost:18.11, ParentId: '16'},
		]
	},
