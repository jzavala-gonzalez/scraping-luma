const timestamp_saved = '09/15/2023 10:45 PM';
const dataFechaAcualizado = '9/15/2023' + ' 6:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'57', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'57', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'66', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.80, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'102', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'170', Cost:16.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 375, MVar:'117', Cost:9.11, ParentId: '17'},
		]
	},
