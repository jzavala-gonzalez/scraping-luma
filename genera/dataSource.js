const timestamp_saved = '12/04/2023 08:30 PM';
const dataFechaAcualizado = '12/4/2023' + ' 4:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'63', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'61', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 11,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 11, MVar:'4', Cost:0, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.43, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'36', Cost:19.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'142', Cost:17.57, ParentId: '16'},
		]
	},
