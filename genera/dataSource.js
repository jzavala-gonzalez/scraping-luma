const timestamp_saved = '11/28/2023 08:25 PM';
const dataFechaAcualizado = '11/28/2023' + ' 4:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'58', Cost:10.28, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'202', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'125', Cost:9.28, ParentId: '17'},
		]
	},
