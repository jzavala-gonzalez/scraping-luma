const timestamp_saved = '12/01/2023 07:45 AM';
const dataFechaAcualizado = '12/1/2023' + ' 3:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'39', Cost:12.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'45', Cost:12.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'51', Cost:9.86, ParentId: '17'},
		]
	},
