const timestamp_saved = '09/29/2023 06:30 AM';
const dataFechaAcualizado = '9/29/2023' + ' 2:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'55', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'34', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'30', Cost:12.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:12.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.60, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'4', Cost:19.31, ParentId: '14'},
