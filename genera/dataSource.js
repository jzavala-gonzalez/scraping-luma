const timestamp_saved = '09/09/2023 10:05 PM';
const dataFechaAcualizado = '9/9/2023' + ' 6:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'72', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'70', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'68', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'2', Cost:37.15, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'14', Cost:28.18, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.00, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'79', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'182', Cost:16.66, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 3,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 2, MVar:'14', Cost:19.60, ParentId: '19'},
