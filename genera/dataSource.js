const timestamp_saved = '07/28/2023 04:50 PM';
const dataFechaAcualizado = '7/28/2023' + ' 12:45:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'2', Cost:72.00, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'90', Cost:13.47, ParentId: '17'},
		]
	},
