const timestamp_saved = '08/13/2023 07:10 PM';
const dataFechaAcualizado = '8/13/2023' + ' 3:07:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'34', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'38', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'39', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'7', Cost:43.28, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'110', Cost:12.26, ParentId: '17'},
		]
	},
