const timestamp_saved = '10/05/2023 11:10 PM';
const dataFechaAcualizado = '10/5/2023' + ' 7:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'48', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'46', Cost:10.44, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'135', Cost:9.20, ParentId: '17'},
		]
	},
