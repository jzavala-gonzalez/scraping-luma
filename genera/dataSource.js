const timestamp_saved = '10/27/2023 05:40 PM';
const dataFechaAcualizado = '10/27/2023' + ' 1:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'50', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'54', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'55', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 101, MVar:'33', Cost:18.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:18.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 137, MVar:'41', Cost:16.70, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'8', Cost:16.70, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'23', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'88', Cost:17.06, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'108', Cost:17.69, ParentId: '16'},
		]
	},
