const timestamp_saved = '11/02/2023 11:40 AM';
const dataFechaAcualizado = '11/2/2023' + ' 7:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'47', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.38, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'7', Cost:17.38, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'80', Cost:16.99, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 168,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 168, MVar:'129', Cost:20.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'72', Cost:9.24, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 19,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 7, MVar:'8', Cost:19.60, ParentId: '19'},
