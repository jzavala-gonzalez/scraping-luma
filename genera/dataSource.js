const timestamp_saved = '10/03/2023 06:20 AM';
const dataFechaAcualizado = '10/3/2023' + ' 2:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'37', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'36', Cost:10.14, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'90', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'99', Cost:9.44, ParentId: '17'},
		]
	},
