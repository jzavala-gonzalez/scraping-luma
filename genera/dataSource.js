const timestamp_saved = '10/22/2023 10:25 AM';
const dataFechaAcualizado = '10/22/2023' + ' 6:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'39', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'40', Cost:10.68, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'53', Cost:11.24, ParentId: '17'},
		]
	},
