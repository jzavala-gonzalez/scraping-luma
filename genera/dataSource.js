const timestamp_saved = '10/13/2023 12:25 PM';
const dataFechaAcualizado = '10/13/2023' + ' 8:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'62', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'67', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'70', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:31.72, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.91, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'182', Cost:18.24, ParentId: '16'},
		]
	},
