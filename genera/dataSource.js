const timestamp_saved = '08/21/2023 05:10 AM';
const dataFechaAcualizado = '8/21/2023' + ' 1:07:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'35', Cost:10.42, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'75', Cost:17.37, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 226,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 226, MVar:'54', Cost:10.03, ParentId: '17'},
		]
	},
