const timestamp_saved = '08/06/2023 01:50 PM';
const dataFechaAcualizado = '8/6/2023' + ' 9:45:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'42', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'42', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.15, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'88', Cost:17.37, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'17', Cost:17.05, ParentId: '15'},
		]
	},
