const timestamp_saved = '09/05/2023 11:25 AM';
const dataFechaAcualizado = '9/5/2023' + ' 7:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'37', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'41', Cost:11.02, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:8.21, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'65', Cost:9.43, ParentId: '17'},
		]
	},
