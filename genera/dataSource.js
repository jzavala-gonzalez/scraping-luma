const timestamp_saved = '09/13/2023 09:55 AM';
const dataFechaAcualizado = '9/13/2023' + ' 5:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'51', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'51', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'62', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'92', Cost:9.21, ParentId: '17'},
		]
	},
