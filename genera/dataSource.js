const timestamp_saved = '11/13/2023 09:05 AM';
const dataFechaAcualizado = '11/13/2023' + ' 5:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'37', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'42', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'47', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:17.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.74, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'62', Cost:17.63, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'74', Cost:9.74, ParentId: '17'},
		]
	},
