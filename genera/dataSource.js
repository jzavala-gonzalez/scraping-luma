const timestamp_saved = '08/13/2023 05:10 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:07:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'34', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'37', Cost:10.84, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'2', Cost:26.81, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:29.65, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'107', Cost:12.25, ParentId: '17'},
		]
	},
