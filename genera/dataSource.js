const timestamp_saved = '10/03/2023 10:30 AM';
const dataFechaAcualizado = '10/3/2023' + ' 6:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'39', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'37', Cost:10.53, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'12', Cost:30.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'32', Cost:23.72, ParentId: '11'},
