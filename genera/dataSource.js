const timestamp_saved = '11/15/2023 07:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'31', Cost:13.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'34', Cost:13.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'44', Cost:13.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'69', Cost:16.84, ParentId: '15'},
