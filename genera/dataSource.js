const timestamp_saved = '08/02/2023 11:25 AM';
const dataFechaAcualizado = '8/2/2023' + ' 7:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'42', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'47', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'2', Cost:26.46, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'86', Cost:11.02, ParentId: '17'},
		]
	},
