const timestamp_saved = '11/22/2023 03:45 PM';
const dataFechaAcualizado = '11/22/2023' + ' 11:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'31', Cost:11.37, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'88', Cost:9.79, ParentId: '17'},
		]
	},
