const timestamp_saved = '08/02/2023 11:20 PM';
const dataFechaAcualizado = '8/2/2023' + ' 7:15:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'43', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'5', Cost:1398.12, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'14', Cost:30.59, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:28.73, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'150', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'90', Cost:10.84, ParentId: '17'},
		]
	},
