const timestamp_saved = '08/28/2023 07:50 AM';
const dataFechaAcualizado = '8/28/2023' + ' 3:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'36', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'36', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'42', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'86', Cost:12.02, ParentId: '17'},
		]
	},
