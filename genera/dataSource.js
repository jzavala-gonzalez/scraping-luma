const timestamp_saved = '10/01/2023 03:35 PM';
const dataFechaAcualizado = '10/1/2023' + ' 11:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'32', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'31', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'47', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:31.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'31', Cost:18.72, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'92', Cost:9.51, ParentId: '17'},
		]
	},
