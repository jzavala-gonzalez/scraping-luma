const timestamp_saved = '11/20/2023 01:55 AM';
const dataFechaAcualizado = '11/19/2023' + ' 9:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'53', Cost:14.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'62', Cost:14.32, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'27', Cost:19.56, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'86', Cost:17.32, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 347, MVar:'186', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'128', Cost:9.18, ParentId: '17'},
		]
	},
