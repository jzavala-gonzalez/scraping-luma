const timestamp_saved = '08/14/2023 08:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 4:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'35', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'41', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'40', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'100', Cost:12.97, ParentId: '17'},
		]
	},
