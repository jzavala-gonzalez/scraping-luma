const timestamp_saved = '09/29/2023 08:15 AM';
const dataFechaAcualizado = '9/29/2023' + ' 4:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'56', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'53', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'32', Cost:13.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'30', Cost:13.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'48', Cost:13.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.90, ParentId: '11'},
