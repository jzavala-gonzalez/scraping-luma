const timestamp_saved = '09/13/2023 03:40 PM';
const dataFechaAcualizado = '9/13/2023' + ' 11:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'53', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'65', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.25, ParentId: '10'},
