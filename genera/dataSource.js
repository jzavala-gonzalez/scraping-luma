const timestamp_saved = '09/18/2023 10:55 AM';
const dataFechaAcualizado = '9/18/2023' + ' 6:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'66', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'47', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'45', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'60', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'55', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:19.88, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'74', Cost:9.81, ParentId: '17'},
		]
	},
