const timestamp_saved = '07/29/2023 02:00 PM';
const dataFechaAcualizado = '7/29/2023' + ' 9:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'49', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:31.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:19.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:19.72, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 106, MVar:'0', Cost:19.51, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:19.51, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:30.26, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'92', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'27', Cost:15.84, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'90', Cost:13.38, ParentId: '17'},
		]
	},
