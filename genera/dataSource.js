const timestamp_saved = '09/15/2023 07:35 AM';
const dataFechaAcualizado = '9/15/2023' + ' 3:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'45', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'45', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'60', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 91,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'2', Cost:30.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:30.78, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'47', Cost:19.73, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'19', Cost:18.74, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'84', Cost:9.94, ParentId: '17'},
		]
	},
