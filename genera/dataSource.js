const timestamp_saved = '10/23/2023 04:40 AM';
const dataFechaAcualizado = '10/23/2023' + ' 12:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'40', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'41', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'42', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'54', Cost:11.31, ParentId: '17'},
		]
	},
