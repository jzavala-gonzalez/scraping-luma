const timestamp_saved = '12/03/2023 07:55 AM';
const dataFechaAcualizado = '12/3/2023' + ' 3:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'38', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'40', Cost:11.19, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.79, ParentId: '11'},
