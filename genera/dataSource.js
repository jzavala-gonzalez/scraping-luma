const timestamp_saved = '11/20/2023 12:10 PM';
const dataFechaAcualizado = '11/20/2023' + ' 8:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'49', Cost:10.29, ParentId: '7'},
