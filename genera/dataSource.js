const timestamp_saved = '09/13/2023 09:30 AM';
const dataFechaAcualizado = '9/13/2023' + ' 5:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:10.32, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'89', Cost:9.24, ParentId: '17'},
		]
	},
