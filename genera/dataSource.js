const timestamp_saved = '11/21/2023 07:30 PM';
const dataFechaAcualizado = '11/21/2023' + ' 3:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'34', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'42', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'172', Cost:18.21, ParentId: '16'},
		]
	},
