const timestamp_saved = '10/26/2023 05:10 PM';
const dataFechaAcualizado = '10/26/2023' + ' 1:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'48', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'52', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 165, MVar:'51', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:16.99, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'22', Cost:19.67, ParentId: '14'},
