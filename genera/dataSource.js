const timestamp_saved = '09/04/2023 10:35 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'37', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:10.87, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:19.60, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'61', Cost:9.81, ParentId: '17'},
		]
	},
