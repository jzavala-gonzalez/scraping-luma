const timestamp_saved = '09/18/2023 05:25 AM';
const dataFechaAcualizado = '9/18/2023' + ' 1:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'59', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'42', Cost:9.13, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:9.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'21', Cost:18.75, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'144', Cost:17.06, ParentId: '16'},
		]
	},
