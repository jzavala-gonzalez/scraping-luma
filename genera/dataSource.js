const timestamp_saved = '10/24/2023 08:05 PM';
const dataFechaAcualizado = '10/24/2023' + ' 4:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'53', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'56', Cost:10.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:17.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:17.55, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'155', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'88', Cost:11.27, ParentId: '17'},
		]
	},
