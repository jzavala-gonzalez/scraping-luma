const timestamp_saved = '08/21/2023 05:55 PM';
const dataFechaAcualizado = '8/21/2023' + ' 1:50:33 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1036},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'41', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'60', Cost:10.41, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 27,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'31', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.18, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'146', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'81', Cost:9.44, ParentId: '17'},
		]
	},
