const timestamp_saved = '08/28/2023 05:10 AM';
const dataFechaAcualizado = '8/28/2023' + ' 1:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'80', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'38', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'38', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'44', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:19.83, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'80', Cost:17.08, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'154', Cost:17.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 226,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 226, MVar:'87', Cost:12.81, ParentId: '17'},
		]
	},
