const timestamp_saved = '11/21/2023 04:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 12:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'28', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'38', Cost:11.90, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'91', Cost:9.21, ParentId: '17'},
		]
	},
