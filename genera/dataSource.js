const timestamp_saved = '12/05/2023 01:41 PM';
const dataFechaAcualizado = '12/5/2023' + ' 9:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'52', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'58', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.81, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'16', Cost:18.83, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'27', Cost:19.88, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'70', Cost:11.13, ParentId: '17'},
		]
	},
