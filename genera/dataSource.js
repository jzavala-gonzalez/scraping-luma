const timestamp_saved = '10/28/2023 03:25 AM';
const dataFechaAcualizado = '10/27/2023' + ' 11:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'41', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'43', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'44', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'0', Cost:93.27, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:0, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 38, MVar:'11', Cost:23.53, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'17', Cost:18.70, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'110', Cost:17.18, ParentId: '16'},
		]
	},
