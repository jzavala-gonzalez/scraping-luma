const timestamp_saved = '09/24/2023 06:15 PM';
const dataFechaAcualizado = '9/24/2023' + ' 2:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'47', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'48', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:11.00, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 58, MVar:'0', Cost:7.97, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'96', Cost:9.16, ParentId: '17'},
		]
	},
