const timestamp_saved = '08/01/2023 01:15 PM';
const dataFechaAcualizado = '8/1/2023' + ' 9:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'46', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'98', Cost:16.61, ParentId: '15'},
