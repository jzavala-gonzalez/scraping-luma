const timestamp_saved = '11/24/2023 01:25 PM';
const dataFechaAcualizado = '11/24/2023' + ' 9:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'23', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'34', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'49', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'70', Cost:9.91, ParentId: '17'},
		]
	},
