const timestamp_saved = '08/13/2023 11:50 AM';
const dataFechaAcualizado = '8/13/2023' + ' 7:47:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'38', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'41', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'38', Cost:19.26, ParentId: '14'},
