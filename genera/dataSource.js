const timestamp_saved = '10/15/2023 04:45 PM';
const dataFechaAcualizado = '10/15/2023' + ' 12:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'47', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.26, ParentId: '7'},
		]
	},
