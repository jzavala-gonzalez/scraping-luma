const timestamp_saved = '11/12/2023 05:55 AM';
const dataFechaAcualizado = '11/12/2023' + ' 1:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'43', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'45', Cost:10.49, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 21,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:28.66, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:32.04, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:32.00, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'79', Cost:10.15, ParentId: '17'},
		]
	},
