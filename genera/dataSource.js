const timestamp_saved = '12/02/2023 11:00 PM';
const dataFechaAcualizado = '12/2/2023' + ' 6:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'55', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'59', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'59', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'141', Cost:17.40, ParentId: '16'},
		]
	},
