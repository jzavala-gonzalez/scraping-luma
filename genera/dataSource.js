const timestamp_saved = '12/04/2023 10:25 AM';
const dataFechaAcualizado = '12/4/2023' + ' 6:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 516,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 178, MVar:'50', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'51', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'51', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.81, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:8.71, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'22', Cost:19.06, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'118', Cost:18.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'62', Cost:11.54, ParentId: '17'},
		]
	},
