const timestamp_saved = '08/16/2023 08:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 4:32:54 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2379},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'57', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'76', Cost:10.50, ParentId: '17'},
		]
	},
