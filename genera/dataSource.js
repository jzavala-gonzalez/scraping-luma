const timestamp_saved = '09/23/2023 08:20 AM';
const dataFechaAcualizado = '9/23/2023' + ' 4:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 432,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'69', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'39', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'40', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'56', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:33.79, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:30.89, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'45', Cost:19.76, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'5', Cost:19.13, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'71', Cost:9.40, ParentId: '17'},
		]
	},
