const timestamp_saved = '09/17/2023 02:10 PM';
const dataFechaAcualizado = '9/17/2023' + ' 10:05:53 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1200},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'42', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'59', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'75', Cost:9.63, ParentId: '17'},
		]
	},
