const timestamp_saved = '08/02/2023 02:35 PM';
const dataFechaAcualizado = '8/2/2023' + ' 10:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'41', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'46', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'37', Cost:15.52, ParentId: '15'},
		]
	},
