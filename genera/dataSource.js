const timestamp_saved = '09/10/2023 10:20 AM';
const dataFechaAcualizado = '9/10/2023' + ' 6:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'60', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'57', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'61', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'7', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'61', Cost:16.85, ParentId: '15'},
