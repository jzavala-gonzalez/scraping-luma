const timestamp_saved = '11/10/2023 07:55 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'44', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'40', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:21.89, ParentId: '14'},
