const timestamp_saved = '10/29/2023 09:10 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'41', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'66', Cost:11.90, ParentId: '7'},
		]
	},
