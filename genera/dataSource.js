const timestamp_saved = '09/06/2023 05:10 PM';
const dataFechaAcualizado = '9/6/2023' + ' 1:05:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'53', Cost:13.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'32', Cost:13.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 99, MVar:'50', Cost:13.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:19.73, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'149', Cost:17.68, ParentId: '16'},
		]
	},
