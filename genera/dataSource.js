const timestamp_saved = '10/12/2023 11:05 AM';
const dataFechaAcualizado = '10/12/2023' + ' 7:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'53', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'57', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'63', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'157', Cost:18.32, ParentId: '16'},
		]
	},
