const timestamp_saved = '10/27/2023 01:05 PM';
const dataFechaAcualizado = '10/27/2023' + ' 9:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'50', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'51', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'55', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'93', Cost:16.79, ParentId: '15'},
