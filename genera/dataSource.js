const timestamp_saved = '09/24/2023 01:00 AM';
const dataFechaAcualizado = '9/23/2023' + ' 8:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'50', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'64', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'8', Cost:28.12, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.39, ParentId: '14'},
