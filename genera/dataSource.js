const timestamp_saved = '09/01/2023 08:40 PM';
const dataFechaAcualizado = '9/1/2023' + ' 4:35:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2812},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'60', Cost:10.11, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 81,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'5', Cost:43.87, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'29', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'91', Cost:16.48, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 204,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 204, MVar:'79', Cost:10.45, ParentId: '17'},
		]
	},
