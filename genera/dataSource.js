const timestamp_saved = '12/04/2023 05:05 PM';
const dataFechaAcualizado = '12/4/2023' + ' 1:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'52', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'55', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'56', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'77', Cost:11.49, ParentId: '17'},
		]
	},
