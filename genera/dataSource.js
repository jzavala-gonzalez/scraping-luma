const timestamp_saved = '11/23/2023 11:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 7:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 208,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 208, MVar:'70', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'20', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'31', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'47', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'9', Cost:19.64, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:19.48, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'63', Cost:9.79, ParentId: '17'},
		]
	},
