const timestamp_saved = '11/27/2023 12:20 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'28', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'38', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'53', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 161, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.30, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'80', Cost:9.81, ParentId: '17'},
		]
	},
