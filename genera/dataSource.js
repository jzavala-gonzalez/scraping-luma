const timestamp_saved = '10/19/2023 11:10 AM';
const dataFechaAcualizado = '10/19/2023' + ' 7:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'32', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 98, MVar:'27', Cost:19.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:19.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'30', Cost:9.40, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'8', Cost:9.40, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'97', Cost:10.53, ParentId: '17'},
		]
	},
