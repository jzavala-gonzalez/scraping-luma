const timestamp_saved = '09/13/2023 08:00 PM';
const dataFechaAcualizado = '9/13/2023' + ' 3:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'60', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'58', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'70', Cost:10.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:35.80, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'15', Cost:28.36, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'17', Cost:28.39, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'45', Cost:8.34, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:8.34, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'91', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'165', Cost:17.41, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'110', Cost:9.11, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 48,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 22, MVar:'25', Cost:19.60, ParentId: '19'},
