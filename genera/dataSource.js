const timestamp_saved = '10/28/2023 11:15 PM';
const dataFechaAcualizado = '10/28/2023' + ' 7:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'54', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'55', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'58', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'11', Cost:18.95, ParentId: '14'},
