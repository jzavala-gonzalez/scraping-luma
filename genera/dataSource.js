const timestamp_saved = '11/14/2023 10:30 PM';
const dataFechaAcualizado = '11/14/2023' + ' 6:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'62', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'64', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'62', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'3', Cost:28.84, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.83, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.69, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'5', Cost:22.15, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'12', Cost:28.68, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'14', Cost:22.55, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'34', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'90', Cost:16.35, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'180', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'123', Cost:10.95, ParentId: '17'},
		]
	},
