const timestamp_saved = '11/28/2023 03:00 PM';
const dataFechaAcualizado = '11/28/2023' + ' 10:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'37', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'46', Cost:11.21, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'176', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'99', Cost:9.58, ParentId: '17'},
		]
	},
