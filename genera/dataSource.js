const timestamp_saved = '11/27/2023 10:00 PM';
const dataFechaAcualizado = '11/27/2023' + ' 5:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'38', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'49', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 128, MVar:'37', Cost:17.95, ParentId: '11'},
