const timestamp_saved = '12/04/2023 10:50 PM';
const dataFechaAcualizado = '12/4/2023' + ' 6:46:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2634},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'63', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'67', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'63', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'10', Cost:27.76, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:31.14, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 56, MVar:'0', Cost:21.76, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.13, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'164', Cost:16.87, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'106', Cost:10.92, ParentId: '17'},
		]
	},
