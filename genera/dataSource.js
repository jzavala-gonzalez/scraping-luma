const timestamp_saved = '08/02/2023 04:00 PM';
const dataFechaAcualizado = '8/2/2023' + ' 11:55:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'42', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'49', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:19.26, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 342,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 342, MVar:'161', Cost:16.79, ParentId: '16'},
		]
	},
