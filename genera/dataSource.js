const timestamp_saved = '08/01/2023 03:20 PM';
const dataFechaAcualizado = '8/1/2023' + ' 11:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'51', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'52', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'36', Cost:16.05, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'99', Cost:11.02, ParentId: '17'},
		]
	},
