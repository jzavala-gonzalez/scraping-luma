const timestamp_saved = '08/30/2023 04:30 AM';
const dataFechaAcualizado = '8/30/2023' + ' 12:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'46', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'47', Cost:11.45, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'0', Cost:27.46, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.84, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'4', Cost:22.89, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:25.58, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:36.11, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'21', Cost:18.48, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'72', Cost:16.66, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'144', Cost:18.06, ParentId: '16'},
		]
	},
