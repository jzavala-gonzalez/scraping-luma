const timestamp_saved = '09/21/2023 07:15 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'39', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'41', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'62', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'1', Cost:27.19, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'9', Cost:26.79, ParentId: '14'},
