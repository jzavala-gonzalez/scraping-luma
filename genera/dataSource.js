const timestamp_saved = '08/02/2023 01:40 AM';
const dataFechaAcualizado = '8/1/2023' + ' 9:35:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'49', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'96', Cost:10.99, ParentId: '17'},
		]
	},
