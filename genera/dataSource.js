const timestamp_saved = '08/29/2023 01:00 AM';
const dataFechaAcualizado = '8/28/2023' + ' 8:55:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'96', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'111', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'67', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'66', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'71', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'12', Cost:27.32, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'40', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'41', Cost:28.05, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'43', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'98', Cost:16.43, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'129', Cost:9.19, ParentId: '17'},
		]
	},
