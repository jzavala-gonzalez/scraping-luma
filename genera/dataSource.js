const timestamp_saved = '11/24/2023 12:00 PM';
const dataFechaAcualizado = '11/24/2023' + ' 7:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'23', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'32', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'48', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'65', Cost:9.93, ParentId: '17'},
		]
	},
