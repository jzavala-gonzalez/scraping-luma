const timestamp_saved = '11/04/2023 02:20 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'44', Cost:13.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'43', Cost:13.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'43', Cost:13.03, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'89', Cost:17.06, ParentId: '15'},
