const timestamp_saved = '11/07/2023 07:40 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'37', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'36', Cost:11.68, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.00, ParentId: '13'},
