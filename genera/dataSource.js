const timestamp_saved = '08/04/2023 06:55 PM';
const dataFechaAcualizado = '8/4/2023' + ' 2:50:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.54, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 81, MVar:'49', Cost:18.20, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'99', Cost:10.85, ParentId: '17'},
		]
	},
