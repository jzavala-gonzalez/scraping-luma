const timestamp_saved = '11/29/2023 02:25 AM';
const dataFechaAcualizado = '11/28/2023' + ' 10:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'39', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'49', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'59', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'183', Cost:16.52, ParentId: '16'},
		]
	},
