const timestamp_saved = '09/05/2023 02:40 PM';
const dataFechaAcualizado = '9/5/2023' + ' 10:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'42', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'46', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'80', Cost:18.42, ParentId: '15'},
