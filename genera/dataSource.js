const timestamp_saved = '11/03/2023 09:35 AM';
const dataFechaAcualizado = '11/3/2023' + ' 5:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'47', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'44', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'60', Cost:9.42, ParentId: '17'},
		]
	},
