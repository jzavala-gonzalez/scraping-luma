const timestamp_saved = '09/29/2023 12:20 AM';
const dataFechaAcualizado = '9/28/2023' + ' 8:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'55', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'55', Cost:10.50, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'45', Cost:8.40, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'88', Cost:16.71, ParentId: '15'},
