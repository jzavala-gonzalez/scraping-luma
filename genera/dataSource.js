const timestamp_saved = '11/22/2023 12:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 8:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'63', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'48', Cost:17.26, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 263,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 263, MVar:'173', Cost:17.61, ParentId: '16'},
		]
	},
