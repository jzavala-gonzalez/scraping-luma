const timestamp_saved = '12/06/2023 06:20 AM';
const dataFechaAcualizado = '12/6/2023' + ' 2:15:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 1105},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'42', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'44', Cost:12.18, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'53', Cost:14.51, ParentId: '17'},
		]
	},
