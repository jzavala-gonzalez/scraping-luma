const timestamp_saved = '09/19/2023 06:20 AM';
const dataFechaAcualizado = '9/19/2023' + ' 2:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'47', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'61', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'145', Cost:17.10, ParentId: '16'},
		]
	},
