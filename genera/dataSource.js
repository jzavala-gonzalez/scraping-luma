const timestamp_saved = '12/01/2023 08:00 AM';
const dataFechaAcualizado = '12/1/2023' + ' 3:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'39', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'39', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'45', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:17.53, ParentId: '11'},
