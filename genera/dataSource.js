const timestamp_saved = '09/08/2023 06:45 PM';
const dataFechaAcualizado = '9/8/2023' + ' 2:40:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2582},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'68', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'82', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'59', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'64', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'59', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 107,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 107, MVar:'0', Cost:6.89, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 124, MVar:'58', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'8', Cost:36.84, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'3', Cost:26.79, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'20', Cost:30.95, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:31.06, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:30.78, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'32', Cost:19.48, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'98', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'166', Cost:16.76, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 7, MVar:'5', Cost:18.32, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 28, MVar:'14', Cost:17, ParentId: '19'},
		]
	},
