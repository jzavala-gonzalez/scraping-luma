const timestamp_saved = '09/05/2023 09:16 AM';
const dataFechaAcualizado = '9/5/2023' + ' 5:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'37', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'40', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'70', Cost:9.30, ParentId: '17'},
		]
	},
