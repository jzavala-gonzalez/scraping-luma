const timestamp_saved = '09/23/2023 12:05 PM';
const dataFechaAcualizado = '9/23/2023' + ' 8:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'39', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'42', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'55', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'4', Cost:30.86, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 105, MVar:'0', Cost:9.92, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'50', Cost:19.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'74', Cost:9.40, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 39,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 15, MVar:'18', Cost:19.60, ParentId: '19'},
