const timestamp_saved = '11/13/2023 10:50 PM';
const dataFechaAcualizado = '11/13/2023' + ' 6:46:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2704},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 549,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'70', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'74', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 202, MVar:'71', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 128,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'8', Cost:26.65, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'31', Cost:28.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'12', Cost:31.04, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:28.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'10', Cost:29.26, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'28', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'87', Cost:16.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'142', Cost:10.88, ParentId: '17'},
		]
	},
