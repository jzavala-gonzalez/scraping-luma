const timestamp_saved = '10/01/2023 09:10 AM';
const dataFechaAcualizado = '10/1/2023' + ' 5:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 133, MVar:'58', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'29', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'27', Cost:12.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'46', Cost:12.19, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:31.01, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'119', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'92', Cost:9.49, ParentId: '17'},
		]
	},
