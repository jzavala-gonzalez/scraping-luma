const timestamp_saved = '10/26/2023 09:45 PM';
const dataFechaAcualizado = '10/26/2023' + ' 5:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:17.37, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.32, ParentId: '12'},
