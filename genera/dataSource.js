const timestamp_saved = '08/11/2023 08:55 AM';
const dataFechaAcualizado = '8/11/2023' + ' 4:50:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'44', Cost:11.41, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'2', Cost:31.44, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'4', Cost:31.36, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'133', Cost:17.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'79', Cost:11.93, ParentId: '17'},
		]
	},
