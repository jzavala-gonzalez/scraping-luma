const timestamp_saved = '10/26/2023 06:46 PM';
const dataFechaAcualizado = '10/26/2023' + ' 2:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'53', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'56', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'57', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:17.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'19', Cost:19.47, ParentId: '14'},
