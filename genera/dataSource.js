const timestamp_saved = '10/26/2023 07:10 AM';
const dataFechaAcualizado = '10/26/2023' + ' 3:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'34', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'37', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'42', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'6', Cost:17.26, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'45', Cost:18.43, ParentId: '15'},
