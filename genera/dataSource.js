const timestamp_saved = '07/30/2023 10:05 PM';
const dataFechaAcualizado = '7/30/2023' + ' 6:00:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 144, MVar:'45', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'85', Cost:11.39, ParentId: '17'},
		]
	},
