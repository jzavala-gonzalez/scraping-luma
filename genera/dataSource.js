const timestamp_saved = '09/29/2023 12:50 AM';
const dataFechaAcualizado = '9/28/2023' + ' 8:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'52', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'54', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'56', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:27.51, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'43', Cost:17.58, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.58, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'111', Cost:9.11, ParentId: '17'},
		]
	},
