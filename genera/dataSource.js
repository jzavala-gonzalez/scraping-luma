const timestamp_saved = '10/26/2023 05:00 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'46', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'50', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 164, MVar:'51', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:16.97, ParentId: '11'},
