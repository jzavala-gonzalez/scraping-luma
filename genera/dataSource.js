const timestamp_saved = '10/11/2023 07:30 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'45', Cost:13.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'48', Cost:13.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'57', Cost:13.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'58', Cost:9.12, ParentId: '17'},
		]
	},
