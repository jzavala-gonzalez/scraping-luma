const timestamp_saved = '10/06/2023 05:40 AM';
const dataFechaAcualizado = '10/6/2023' + ' 1:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'34', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'31', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'47', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'6', Cost:27.93, ParentId: '10'},
