const timestamp_saved = '09/19/2023 11:05 AM';
const dataFechaAcualizado = '9/19/2023' + ' 7:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'47', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'47', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'61', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'86', Cost:9.27, ParentId: '17'},
		]
	},
