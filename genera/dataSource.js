const timestamp_saved = '11/20/2023 05:55 PM';
const dataFechaAcualizado = '11/20/2023' + ' 1:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'32', Cost:13.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'42', Cost:13.19, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'82', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'171', Cost:18.24, ParentId: '16'},
		]
	},
