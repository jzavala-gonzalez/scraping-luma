const timestamp_saved = '09/23/2023 08:45 AM';
const dataFechaAcualizado = '9/23/2023' + ' 4:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'38', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'39', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'54', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'69', Cost:9.41, ParentId: '17'},
		]
	},
