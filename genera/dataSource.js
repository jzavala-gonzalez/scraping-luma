const timestamp_saved = '11/01/2023 03:55 PM';
const dataFechaAcualizado = '11/1/2023' + ' 11:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'58', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'63', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'67', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'141', Cost:18.26, ParentId: '16'},
		]
	},
