const timestamp_saved = '09/24/2023 02:45 AM';
const dataFechaAcualizado = '9/23/2023' + ' 10:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'46', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'49', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'62', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'0', Cost:21.97, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'6', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'4', Cost:30.90, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'0', Cost:8.36, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'69', Cost:16.85, ParentId: '15'},
