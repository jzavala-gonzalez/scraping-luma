const timestamp_saved = '10/08/2023 07:40 AM';
const dataFechaAcualizado = '10/8/2023' + ' 3:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 233,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 233, MVar:'66', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'35', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'37', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'38', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'36', Cost:18.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:18.77, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'72', Cost:16.66, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 156,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 156, MVar:'68', Cost:11.55, ParentId: '17'},
		]
	},
