const timestamp_saved = '11/03/2023 06:45 AM';
const dataFechaAcualizado = '11/3/2023' + ' 2:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'44', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'41', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'46', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'57', Cost:9.42, ParentId: '17'},
		]
	},
