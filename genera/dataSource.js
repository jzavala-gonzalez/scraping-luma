const timestamp_saved = '11/23/2023 06:40 AM';
const dataFechaAcualizado = '11/23/2023' + ' 2:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'20', Cost:13.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'30', Cost:13.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'47', Cost:13.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'27', Cost:9.23, ParentId: '17'},
		]
	},
