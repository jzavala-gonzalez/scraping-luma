const timestamp_saved = '09/11/2023 10:30 PM';
const dataFechaAcualizado = '9/11/2023' + ' 6:25:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 549,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'74', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'73', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 210, MVar:'80', Cost:9.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:8.98, ParentId: '8'},
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.52, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'7', Cost:29.04, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'14', Cost:19.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'165', Cost:16.57, ParentId: '16'},
		]
	},
