const timestamp_saved = '12/05/2023 02:45 PM';
const dataFechaAcualizado = '12/5/2023' + ' 10:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'46', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'50', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'56', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 187,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 99, MVar:'8', Cost:18.51, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'29', Cost:18.74, ParentId: '14'},
