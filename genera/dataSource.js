const timestamp_saved = '08/01/2023 12:45 PM';
const dataFechaAcualizado = '8/1/2023' + ' 8:35:36 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1010},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'50', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:20.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'11', Cost:8.68, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'98', Cost:16.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'34', Cost:15.50, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'98', Cost:11.01, ParentId: '17'},
		]
	},
