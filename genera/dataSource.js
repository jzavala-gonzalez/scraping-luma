const timestamp_saved = '10/23/2023 04:15 AM';
const dataFechaAcualizado = '10/23/2023' + ' 12:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'42', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'42', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'42', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'1', Cost:28.71, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'69', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'119', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'58', Cost:11.26, ParentId: '17'},
		]
	},
