const timestamp_saved = '09/22/2023 06:00 PM';
const dataFechaAcualizado = '9/22/2023' + ' 1:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'45', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'49', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'66', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 117,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'4', Cost:290.36, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'7', Cost:27.89, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'28', Cost:19.08, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'116', Cost:32.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'104', Cost:9.27, ParentId: '17'},
		]
	},
