const timestamp_saved = '08/11/2023 11:10 AM';
const dataFechaAcualizado = '8/11/2023' + ' 7:05:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'38', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'46', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'40', Cost:10.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 123, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'3', Cost:30.82, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'1', Cost:30.48, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'143', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'71', Cost:11.91, ParentId: '17'},
		]
	},
