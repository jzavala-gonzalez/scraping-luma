const timestamp_saved = '08/22/2023 07:10 PM';
const dataFechaAcualizado = '8/22/2023' + ' 3:05:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'58', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'48', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'47', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'21', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'123', Cost:17.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 318, MVar:'72', Cost:9.33, ParentId: '17'},
		]
	},
