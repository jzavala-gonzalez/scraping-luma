const timestamp_saved = '08/04/2023 10:35 AM';
const dataFechaAcualizado = '8/4/2023' + ' 6:30:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'68', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'38', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'23', Cost:15.62, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 237,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 237, MVar:'130', Cost:18.02, ParentId: '16'},
		]
	},
