const timestamp_saved = '08/13/2023 04:35 PM';
const dataFechaAcualizado = '8/13/2023' + ' 12:32:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'41', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'41', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:30.06, ParentId: '13'},
