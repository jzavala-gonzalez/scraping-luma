const timestamp_saved = '11/29/2023 02:20 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'78', Cost:9.74, ParentId: '17'},
		]
	},
