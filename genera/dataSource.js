const timestamp_saved = '09/23/2023 03:05 AM';
const dataFechaAcualizado = '9/22/2023' + ' 11:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'44', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'60', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'5', Cost:28.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'3', Cost:30.87, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'8', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'57', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'99', Cost:32.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'88', Cost:9.12, ParentId: '17'},
		]
	},
