const timestamp_saved = '11/13/2023 04:05 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 72, MVar:'47', Cost:24.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 82, MVar:'52', Cost:24.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:24.65, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:17.73, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'8', Cost:28.25, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'64', Cost:16.90, ParentId: '15'},
