const timestamp_saved = '08/13/2023 08:45 PM';
const dataFechaAcualizado = '8/13/2023' + ' 4:42:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'36', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'44', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'42', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 177,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 28, MVar:'5', Cost:27.30, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.69, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'162', Cost:17.68, ParentId: '16'},
		]
	},
