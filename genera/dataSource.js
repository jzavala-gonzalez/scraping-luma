const timestamp_saved = '09/25/2023 01:30 AM';
const dataFechaAcualizado = '9/24/2023' + ' 9:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'56', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'56', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'63', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:22.20, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'11', Cost:22.78, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:28.28, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'90', Cost:16.76, ParentId: '15'},
