const timestamp_saved = '11/20/2023 03:25 AM';
const dataFechaAcualizado = '11/19/2023' + ' 11:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'44', Cost:18.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'54', Cost:18.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:18.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:25.89, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'18', Cost:29.47, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'5', Cost:29.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'22', Cost:18.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'84', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'177', Cost:16.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'117', Cost:9.17, ParentId: '17'},
		]
	},
