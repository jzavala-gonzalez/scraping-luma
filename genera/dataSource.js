const timestamp_saved = '08/16/2023 04:55 AM';
const dataFechaAcualizado = '8/16/2023' + ' 12:52:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'65', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'60', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'65', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'7', Cost:26.66, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'15', Cost:18.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'108', Cost:10.22, ParentId: '17'},
		]
	},
