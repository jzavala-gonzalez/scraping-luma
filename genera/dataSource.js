const timestamp_saved = '12/01/2023 10:10 AM';
const dataFechaAcualizado = '12/1/2023' + ' 6:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'51', Cost:10.40, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'68', Cost:9.87, ParentId: '17'},
		]
	},
