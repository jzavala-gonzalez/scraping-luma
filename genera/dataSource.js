const timestamp_saved = '09/03/2023 02:50 PM';
const dataFechaAcualizado = '9/3/2023' + ' 10:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'32', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'38', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'6', Cost:31.21, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'17', Cost:19.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'75', Cost:17.33, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'55', Cost:9.84, ParentId: '17'},
		]
	},
