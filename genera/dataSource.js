const timestamp_saved = '11/16/2023 12:00 PM';
const dataFechaAcualizado = '11/16/2023' + ' 7:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'49', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 185,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 185, MVar:'68', Cost:10.79, ParentId: '17'},
		]
	},
