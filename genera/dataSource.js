const timestamp_saved = '08/21/2023 05:35 PM';
const dataFechaAcualizado = '8/21/2023' + ' 1:30:33 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1070},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'40', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'60', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'16', Cost:30.81, ParentId: '10'},
		]
	},
