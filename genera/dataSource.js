const timestamp_saved = '08/17/2023 10:05 AM';
const dataFechaAcualizado = '8/17/2023' + ' 6:02:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'60', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'71', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'17', Cost:18.20, ParentId: '14'},
