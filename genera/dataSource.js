const timestamp_saved = '08/21/2023 09:05 PM';
const dataFechaAcualizado = '8/21/2023' + ' 5:00:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'38', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'59', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'14', Cost:18.99, ParentId: '14'},
