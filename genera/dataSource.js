const timestamp_saved = '11/19/2023 06:55 AM';
const dataFechaAcualizado = '11/19/2023' + ' 2:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'50', Cost:14.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'69', Cost:17.00, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'96', Cost:9.92, ParentId: '17'},
		]
	},
