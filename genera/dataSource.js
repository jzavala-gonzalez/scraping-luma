const timestamp_saved = '07/31/2023 04:35 AM';
const dataFechaAcualizado = '7/31/2023' + ' 12:30:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'50', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'44', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 2,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'1', Cost:101.75, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'36', Cost:18.40, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'126', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'80', Cost:10.97, ParentId: '17'},
		]
	},
