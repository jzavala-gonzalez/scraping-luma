const timestamp_saved = '11/23/2023 07:50 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 241,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'79', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'24', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'34', Cost:11.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'49', Cost:11.99, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.72, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'50', Cost:9.82, ParentId: '17'},
		]
	},
