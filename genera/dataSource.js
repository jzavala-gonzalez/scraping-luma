const timestamp_saved = '08/03/2023 07:55 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:50:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'36', Cost:11.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 136, MVar:'40', Cost:20.04, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'53', Cost:17.51, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'36', Cost:16.88, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'133', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'75', Cost:11.27, ParentId: '17'},
		]
	},
