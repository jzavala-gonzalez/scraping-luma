const timestamp_saved = '10/30/2023 03:05 PM';
const dataFechaAcualizado = '10/30/2023' + ' 11:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'66', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'69', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 316,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 316, MVar:'87', Cost:9.33, ParentId: '17'},
		]
	},
