const timestamp_saved = '10/21/2023 04:35 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'25', Cost:13.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'23', Cost:13.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'60', Cost:13.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'146', Cost:16.77, ParentId: '16'},
		]
	},
