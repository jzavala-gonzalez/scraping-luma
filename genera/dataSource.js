const timestamp_saved = '07/28/2023 06:43 AM';
const dataFechaAcualizado = '7/28/2023' + ' 2:35:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'42', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'44', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'44', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.04, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'79', Cost:13.15, ParentId: '17'},
		]
	},
