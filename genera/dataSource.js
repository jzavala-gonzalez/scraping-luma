const timestamp_saved = '11/27/2023 01:55 PM';
const dataFechaAcualizado = '11/27/2023' + ' 9:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'30', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'41', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'54', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'48', Cost:8.21, ParentId: '11'},
