const timestamp_saved = '10/03/2023 09:55 PM';
const dataFechaAcualizado = '10/3/2023' + ' 5:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'41', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'39', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'54', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'171', Cost:16.63, ParentId: '16'},
		]
	},
