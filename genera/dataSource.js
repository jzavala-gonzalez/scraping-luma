const timestamp_saved = '11/02/2023 05:05 PM';
const dataFechaAcualizado = '11/2/2023' + ' 1:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'57', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'55', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'85', Cost:9.24, ParentId: '17'},
		]
	},
