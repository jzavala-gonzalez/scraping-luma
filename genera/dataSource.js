const timestamp_saved = '12/03/2023 03:10 AM';
const dataFechaAcualizado = '12/2/2023' + ' 11:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'50', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'53', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'80', Cost:11.02, ParentId: '17'},
		]
	},
