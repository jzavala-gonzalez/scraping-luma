const timestamp_saved = '11/11/2023 07:15 AM';
const dataFechaAcualizado = '11/11/2023' + ' 3:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'83', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'41', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'43', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'42', Cost:11.68, ParentId: '7'},
		]
	},
