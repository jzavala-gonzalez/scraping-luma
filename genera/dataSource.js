const timestamp_saved = '10/11/2023 02:01 PM';
const dataFechaAcualizado = '10/11/2023' + ' 9:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'54', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'60', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'65', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'171', Cost:18.22, ParentId: '16'},
		]
	},
