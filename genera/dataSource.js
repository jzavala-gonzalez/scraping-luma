const timestamp_saved = '08/07/2023 02:55 AM';
const dataFechaAcualizado = '8/6/2023' + ' 10:50:40 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2746},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'50', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'48', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'12', Cost:27.12, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:22.23, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'21', Cost:28.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'21', Cost:28.08, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.36, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'67', Cost:18.39, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'31', Cost:15.58, ParentId: '15'},
		]
	},
