const timestamp_saved = '11/12/2023 09:45 PM';
const dataFechaAcualizado = '11/12/2023' + ' 5:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'53', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'55', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'59', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.32, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:29.70, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'6', Cost:29.57, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 40, MVar:'13', Cost:22.94, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'66', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'110', Cost:9.18, ParentId: '17'},
		]
	},
