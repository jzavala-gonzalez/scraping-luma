const timestamp_saved = '07/31/2023 08:10 AM';
const dataFechaAcualizado = '7/31/2023' + ' 4:05:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'41', Cost:11.12, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 253,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 253, MVar:'107', Cost:17.63, ParentId: '16'},
		]
	},
