const timestamp_saved = '10/04/2023 06:05 AM';
const dataFechaAcualizado = '10/4/2023' + ' 2:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'37', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'35', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 184,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'140', Cost:19.72, ParentId: '16'},
		]
	},
