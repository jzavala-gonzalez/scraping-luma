const timestamp_saved = '10/05/2023 01:15 PM';
const dataFechaAcualizado = '10/5/2023' + ' 9:11:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'43', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'40', Cost:10.55, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'162', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'104', Cost:9.33, ParentId: '17'},
		]
	},
