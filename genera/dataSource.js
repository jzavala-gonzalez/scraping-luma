const timestamp_saved = '08/24/2023 02:30 AM';
const dataFechaAcualizado = '8/23/2023' + ' 10:25:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'59', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'58', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'56', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.92, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'18', Cost:19.06, ParentId: '14'},
