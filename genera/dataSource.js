const timestamp_saved = '10/12/2023 04:05 AM';
const dataFechaAcualizado = '10/12/2023' + ' 12:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'57', Cost:11.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'60', Cost:11.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'67', Cost:11.63, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'12', Cost:27.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.08, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 102, MVar:'33', Cost:18.21, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.21, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'168', Cost:16.62, ParentId: '16'},
		]
	},
