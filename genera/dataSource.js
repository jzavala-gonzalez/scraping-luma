const timestamp_saved = '10/20/2023 03:40 AM';
const dataFechaAcualizado = '10/19/2023' + ' 11:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'41', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'48', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'46', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'97', Cost:10.52, ParentId: '17'},
		]
	},
