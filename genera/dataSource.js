const timestamp_saved = '08/01/2023 01:20 PM';
const dataFechaAcualizado = '8/1/2023' + ' 9:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'47', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 166, MVar:'34', Cost:15.49, ParentId: '15'},
		]
	},
