const timestamp_saved = '11/12/2023 11:15 PM';
const dataFechaAcualizado = '11/12/2023' + ' 7:11:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'60', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'63', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:27.01, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:28.72, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:29.48, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'116', Cost:9.17, ParentId: '17'},
		]
	},
