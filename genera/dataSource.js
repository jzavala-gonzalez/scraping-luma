const timestamp_saved = '10/18/2023 01:55 PM';
const dataFechaAcualizado = '10/18/2023' + ' 9:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'46', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'49', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.58, ParentId: '13'},
