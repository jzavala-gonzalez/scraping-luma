const timestamp_saved = '08/30/2023 07:25 AM';
const dataFechaAcualizado = '8/30/2023' + ' 3:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'44', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'56', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'19', Cost:19.15, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'61', Cost:16.80, ParentId: '15'},
