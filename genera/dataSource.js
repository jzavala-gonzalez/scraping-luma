const timestamp_saved = '08/14/2023 04:05 PM';
const dataFechaAcualizado = '8/14/2023' + ' 12:02:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 239, MVar:'76', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'109', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'51', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'48', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'4', Cost:39.94, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.50, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 86, MVar:'25', Cost:30.88, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'167', Cost:17.00, ParentId: '16'},
		]
	},
