const timestamp_saved = '09/06/2023 02:36 PM';
const dataFechaAcualizado = '9/6/2023' + ' 10:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'57', Cost:20.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'35', Cost:20.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:20.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 28, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.38, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.37, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:26.29, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'5', Cost:26.59, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'25', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'143', Cost:17.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'90', Cost:9.20, ParentId: '17'},
		]
	},
