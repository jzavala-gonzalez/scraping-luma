const timestamp_saved = '11/30/2023 04:10 AM';
const dataFechaAcualizado = '11/30/2023' + ' 12:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'44', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'49', Cost:10.98, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 56,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 16, MVar:'1', Cost:31.49, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'78', Cost:9.55, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:26.65, ParentId: '21'},
