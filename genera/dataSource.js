const timestamp_saved = '08/04/2023 02:35 PM';
const dataFechaAcualizado = '8/4/2023' + ' 10:30:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'42', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'90', Cost:10.93, ParentId: '17'},
		]
	},
