const timestamp_saved = '11/07/2023 09:10 AM';
const dataFechaAcualizado = '11/7/2023' + ' 5:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'36', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'38', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'66', Cost:9.76, ParentId: '17'},
		]
	},
