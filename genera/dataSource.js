const timestamp_saved = '11/28/2023 12:00 PM';
const dataFechaAcualizado = '11/28/2023' + ' 7:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'29', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'38', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'52', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'87', Cost:9.39, ParentId: '17'},
		]
	},
