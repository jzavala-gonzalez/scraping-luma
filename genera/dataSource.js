const timestamp_saved = '10/16/2023 01:50 PM';
const dataFechaAcualizado = '10/16/2023' + ' 9:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'60', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'60', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'59', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:16.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:16.97, ParentId: '11'},
