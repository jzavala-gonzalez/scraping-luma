const timestamp_saved = '09/26/2023 10:55 PM';
const dataFechaAcualizado = '9/26/2023' + ' 6:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'57', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'59', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'64', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'2', Cost:28.67, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:17.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.82, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'0', Cost:17.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 355,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 355, MVar:'193', Cost:16.80, ParentId: '16'},
		]
	},
