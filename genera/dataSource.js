const timestamp_saved = '10/21/2023 04:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'27', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'24', Cost:11.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'62', Cost:11.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'144', Cost:16.77, ParentId: '16'},
		]
	},
