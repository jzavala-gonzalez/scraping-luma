const timestamp_saved = '09/26/2023 02:05 AM';
const dataFechaAcualizado = '9/25/2023' + ' 10:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'58', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'181', Cost:16.68, ParentId: '16'},
		]
	},
