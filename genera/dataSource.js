const timestamp_saved = '08/20/2023 11:10 PM';
const dataFechaAcualizado = '8/20/2023' + ' 7:07:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'60', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'31', Cost:10.14, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:19.72, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 22,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 22, MVar:'6', Cost:37.43, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 237,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 237, MVar:'146', Cost:18.26, ParentId: '16'},
		]
	},
