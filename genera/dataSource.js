const timestamp_saved = '12/06/2023 03:35 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:30:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 551},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'47', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'49', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'58', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:14.54, ParentId: '17'},
		]
	},
