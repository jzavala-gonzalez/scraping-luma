const timestamp_saved = '07/30/2023 04:05 PM';
const dataFechaAcualizado = '7/30/2023' + ' 12:00:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1234},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 219, MVar:'65', Cost:4.40, ParentId: '6'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'69', Cost:18.47, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'39', Cost:17.07, ParentId: '15'},
		]
	},
