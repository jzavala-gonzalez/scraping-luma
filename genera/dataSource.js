const timestamp_saved = '07/25/2023 11:24 PM';
const dataFechaAcualizado = '7/25/2023' + ' 7:15:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'84', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'64', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'51', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.05, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'65', Cost:15.96, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'80', Cost:9.36, ParentId: '17'},
		]
	},
