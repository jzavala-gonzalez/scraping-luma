const timestamp_saved = '08/07/2023 10:30 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:25:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:10.79, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:30.58, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'21', Cost:16.48, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'102', Cost:11.63, ParentId: '17'},
		]
	},
