const timestamp_saved = '11/29/2023 11:55 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'41', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'39', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'43', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'74', Cost:9.52, ParentId: '17'},
		]
	},
