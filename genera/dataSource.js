const timestamp_saved = '11/07/2023 10:35 AM';
const dataFechaAcualizado = '11/7/2023' + ' 6:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'42', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'42', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'64', Cost:16.91, ParentId: '15'},
