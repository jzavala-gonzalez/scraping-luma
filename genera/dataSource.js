const timestamp_saved = '10/08/2023 08:15 AM';
const dataFechaAcualizado = '10/8/2023' + ' 4:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'35', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'37', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'37', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'37', Cost:17.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:17.55, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'71', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'123', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 155, MVar:'66', Cost:11.58, ParentId: '17'},
		]
	},
