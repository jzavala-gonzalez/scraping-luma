const timestamp_saved = '09/21/2023 05:30 AM';
const dataFechaAcualizado = '9/21/2023' + ' 1:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'39', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'43', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'62', Cost:11.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 169,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:31.27, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'15', Cost:31.30, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'11', Cost:26.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 122, MVar:'62', Cost:17.36, ParentId: '15'},
