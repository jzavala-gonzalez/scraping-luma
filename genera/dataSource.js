const timestamp_saved = '11/26/2023 08:15 PM';
const dataFechaAcualizado = '11/26/2023' + ' 4:11:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2153},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'33', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'42', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'55', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'38', Cost:17.81, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 266,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 266, MVar:'150', Cost:17.94, ParentId: '16'},
		]
	},
