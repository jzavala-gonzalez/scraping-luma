const timestamp_saved = '09/05/2023 07:55 PM';
const dataFechaAcualizado = '9/5/2023' + ' 3:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'51', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'55', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'62', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 103,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 8, MVar:'0', Cost:89.52, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'4', Cost:0, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'28', Cost:19.54, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'88', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'170', Cost:17.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'97', Cost:9.19, ParentId: '17'},
		]
	},
