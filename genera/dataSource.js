const timestamp_saved = '10/18/2023 11:25 AM';
const dataFechaAcualizado = '10/18/2023' + ' 7:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'61', Cost:4.32, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.32, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'40', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'45', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'58', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'11', Cost:17.12, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'82', Cost:23.26, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'92', Cost:10.57, ParentId: '17'},
		]
	},
