const timestamp_saved = '08/12/2023 12:55 PM';
const dataFechaAcualizado = '8/12/2023' + ' 8:52:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'53', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'49', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 121,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:26.24, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'108', Cost:11.62, ParentId: '17'},
		]
	},
