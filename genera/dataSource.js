const timestamp_saved = '10/28/2023 09:00 PM';
const dataFechaAcualizado = '10/28/2023' + ' 4:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'48', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'54', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:25.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'38', Cost:18.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.18, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'6', Cost:30.15, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'60', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'124', Cost:17.23, ParentId: '16'},
		]
	},
