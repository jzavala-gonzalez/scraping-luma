const timestamp_saved = '10/08/2023 01:45 PM';
const dataFechaAcualizado = '10/8/2023' + ' 9:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'38', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'38', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'38', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'77', Cost:16.66, ParentId: '15'},
