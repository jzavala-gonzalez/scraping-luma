const timestamp_saved = '08/25/2023 01:50 PM';
const dataFechaAcualizado = '8/25/2023' + ' 9:45:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'66', Cost:10.33, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'15', Cost:31.42, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 261, MVar:'158', Cost:17.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'108', Cost:9.30, ParentId: '17'},
		]
	},
