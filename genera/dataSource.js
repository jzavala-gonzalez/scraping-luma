const timestamp_saved = '09/22/2023 09:20 PM';
const dataFechaAcualizado = '9/22/2023' + ' 5:15:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 226, MVar:'69', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'75', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'50', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'65', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'0', Cost:26.74, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'7', Cost:31.19, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.07, ParentId: '14'},
