const timestamp_saved = '10/07/2023 05:25 PM';
const dataFechaAcualizado = '10/7/2023' + ' 1:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 178, MVar:'52', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'42', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'43', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.45, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'79', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'141', Cost:17.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 266,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 266, MVar:'89', Cost:9.68, ParentId: '17'},
		]
	},
