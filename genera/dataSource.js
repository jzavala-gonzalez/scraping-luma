const timestamp_saved = '11/23/2023 11:35 AM';
const dataFechaAcualizado = '11/23/2023' + ' 7:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'20', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'31', Cost:11.50, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.61, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.02, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'123', Cost:18.26, ParentId: '16'},
		]
	},
