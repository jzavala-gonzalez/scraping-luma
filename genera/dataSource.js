const timestamp_saved = '10/30/2023 11:50 AM';
const dataFechaAcualizado = '10/30/2023' + ' 7:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'48', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'49', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'68', Cost:9.39, ParentId: '17'},
		]
	},
