const timestamp_saved = '08/01/2023 09:45 PM';
const dataFechaAcualizado = '8/1/2023' + ' 5:40:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 307,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'81', Cost:16.75, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 149, MVar:'32', Cost:15.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'125', Cost:17.16, ParentId: '16'},
		]
	},
