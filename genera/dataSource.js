const timestamp_saved = '08/10/2023 02:35 PM';
const dataFechaAcualizado = '8/10/2023' + ' 10:30:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'67', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'96', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'62', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'61', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:20.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.41, ParentId: '12'},
