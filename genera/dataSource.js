const timestamp_saved = '10/25/2023 12:35 AM';
const dataFechaAcualizado = '10/24/2023' + ' 8:31:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2819},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'56', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.18, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'48', Cost:16.99, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'161', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 174,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 174, MVar:'12', Cost:14.40, ParentId: '17'},
		]
	},
