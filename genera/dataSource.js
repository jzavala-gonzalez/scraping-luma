const timestamp_saved = '09/23/2023 11:25 AM';
const dataFechaAcualizado = '9/23/2023' + ' 7:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'40', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'45', Cost:19.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:19.78, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 103, MVar:'0', Cost:8.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:8.17, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'46', Cost:19.59, ParentId: '15'},
