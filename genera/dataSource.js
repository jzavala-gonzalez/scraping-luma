const timestamp_saved = '10/10/2023 07:10 AM';
const dataFechaAcualizado = '10/10/2023' + ' 3:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'61', Cost:10.32, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'81', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'68', Cost:9.13, ParentId: '17'},
		]
	},
