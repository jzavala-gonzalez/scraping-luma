const timestamp_saved = '08/13/2023 12:30 PM';
const dataFechaAcualizado = '8/13/2023' + ' 8:27:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'37', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'42', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'41', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'5', Cost:27.45, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'33', Cost:19.25, ParentId: '14'},
