const timestamp_saved = '10/25/2023 04:40 AM';
const dataFechaAcualizado = '10/25/2023' + ' 12:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'46', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 200,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'133', Cost:18.60, ParentId: '16'},
		]
	},
