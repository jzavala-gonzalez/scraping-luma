const timestamp_saved = '08/23/2023 07:40 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:35:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'42', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'43', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'50', Cost:18.43, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'56', Cost:9.85, ParentId: '17'},
		]
	},
