const timestamp_saved = '09/19/2023 01:30 AM';
const dataFechaAcualizado = '9/18/2023' + ' 9:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 544,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'61', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'60', Cost:9.77, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'86', Cost:16.47, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'189', Cost:16.67, ParentId: '16'},
		]
	},
