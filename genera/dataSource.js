const timestamp_saved = '11/25/2023 07:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 3:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 168, MVar:'67', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'33', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'41', Cost:10.35, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.69, ParentId: '11'},
