const timestamp_saved = '12/02/2023 04:00 PM';
const dataFechaAcualizado = '12/2/2023' + ' 11:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 182,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 182, MVar:'75', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'43', Cost:12.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'45', Cost:12.87, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'65', Cost:11.90, ParentId: '17'},
		]
	},
