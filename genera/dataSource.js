const timestamp_saved = '10/09/2023 11:55 AM';
const dataFechaAcualizado = '10/9/2023' + ' 7:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'44', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'44', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.43, ParentId: '11'},
