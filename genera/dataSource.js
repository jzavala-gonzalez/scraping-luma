const timestamp_saved = '08/03/2023 10:05 PM';
const dataFechaAcualizado = '8/3/2023' + ' 6:00:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:10.34, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'0', Cost:22.20, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'13', Cost:31.56, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:19.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 327,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'106', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 313, MVar:'172', Cost:17.22, ParentId: '16'},
		]
	},
