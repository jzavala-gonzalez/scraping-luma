const timestamp_saved = '11/04/2023 07:50 PM';
const dataFechaAcualizado = '11/4/2023' + ' 3:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'54', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'55', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'50', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 63, MVar:'11', Cost:20.24, ParentId: '14'},
