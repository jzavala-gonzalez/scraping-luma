const timestamp_saved = '07/31/2023 05:55 PM';
const dataFechaAcualizado = '7/31/2023' + ' 1:50:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'56', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'8', Cost:26.48, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'109', Cost:11.11, ParentId: '17'},
		]
	},
