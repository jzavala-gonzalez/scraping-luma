const timestamp_saved = '09/25/2023 08:10 PM';
const dataFechaAcualizado = '9/25/2023' + ' 4:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'75', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'46', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'48', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'56', Cost:11.61, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 126, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 43,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:26.80, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'77', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 372, MVar:'185', Cost:16.61, ParentId: '16'},
		]
	},
