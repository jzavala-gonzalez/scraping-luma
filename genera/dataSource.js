const timestamp_saved = '10/05/2023 11:55 AM';
const dataFechaAcualizado = '10/5/2023' + ' 7:51:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'34', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'32', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'49', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 10, MVar:'1', Cost:30.73, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'92', Cost:9.39, ParentId: '17'},
		]
	},
