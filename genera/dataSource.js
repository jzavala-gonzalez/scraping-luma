const timestamp_saved = '09/19/2023 02:50 PM';
const dataFechaAcualizado = '9/19/2023' + ' 10:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 167, MVar:'61', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'73', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'52', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'54', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'64', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'28', Cost:18.90, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 105,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 40, MVar:'9', Cost:19.60, ParentId: '19'},
