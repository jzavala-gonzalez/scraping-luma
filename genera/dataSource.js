const timestamp_saved = '11/18/2023 04:50 AM';
const dataFechaAcualizado = '11/18/2023' + ' 12:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'99', Cost:4.37, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 149,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'79', Cost:23.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:23.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 23, MVar:'5', Cost:27.59, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 26, MVar:'0', Cost:26.71, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:17.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'12', Cost:17.49, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'11', Cost:22.58, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'16', Cost:18.58, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'139', Cost:9.11, ParentId: '17'},
		]
	},
