const timestamp_saved = '07/26/2023 02:12 AM';
const dataFechaAcualizado = '7/25/2023' + ' 10:05:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'73', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'45', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'56', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'52', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'7', Cost:30.62, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:30.67, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'62', Cost:15.42, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'83', Cost:9.31, ParentId: '17'},
		]
	},
