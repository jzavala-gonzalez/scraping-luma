const timestamp_saved = '10/21/2023 04:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'24', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'22', Cost:13.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'60', Cost:13.31, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:31.29, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'148', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'80', Cost:11.04, ParentId: '17'},
		]
	},
