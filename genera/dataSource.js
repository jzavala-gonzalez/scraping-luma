const timestamp_saved = '09/12/2023 05:35 AM';
const dataFechaAcualizado = '9/12/2023' + ' 1:30:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'63', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'74', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'53', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'50', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'65', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:30.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'1', Cost:30.78, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:21.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'9', Cost:21.85, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'141', Cost:17.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'44', Cost:10.44, ParentId: '17'},
		]
	},
