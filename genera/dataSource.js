const timestamp_saved = '11/24/2023 09:50 PM';
const dataFechaAcualizado = '11/24/2023' + ' 5:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'34', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'44', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'56', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'157', Cost:17.17, ParentId: '16'},
		]
	},
