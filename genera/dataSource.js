const timestamp_saved = '10/23/2023 07:16 AM';
const dataFechaAcualizado = '10/23/2023' + ' 3:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'35', Cost:12.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'35', Cost:12.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'37', Cost:12.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'11', Cost:19.39, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'59', Cost:16.76, ParentId: '15'},
