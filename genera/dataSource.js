const timestamp_saved = '10/16/2023 08:05 PM';
const dataFechaAcualizado = '10/16/2023' + ' 4:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'66', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'67', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'64', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'7', Cost:29.78, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'10', Cost:29.61, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'17', Cost:19.52, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'92', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'187', Cost:16.63, ParentId: '16'},
		]
	},
