const timestamp_saved = '11/16/2023 10:50 AM';
const dataFechaAcualizado = '11/16/2023' + ' 6:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'46', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'47', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'48', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.71, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 186, MVar:'63', Cost:10.80, ParentId: '17'},
		]
	},
