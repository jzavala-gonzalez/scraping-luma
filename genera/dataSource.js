const timestamp_saved = '10/07/2023 11:20 AM';
const dataFechaAcualizado = '10/7/2023' + ' 7:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 64, MVar:'32', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'43', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'48', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:18.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:18.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'148', Cost:17.39, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 14,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 4, MVar:'9', Cost:19.60, ParentId: '19'},
