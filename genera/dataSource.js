const timestamp_saved = '10/13/2023 06:45 AM';
const dataFechaAcualizado = '10/13/2023' + ' 2:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'56', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'62', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'67', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:19.45, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'203', Cost:19.31, ParentId: '16'},
		]
	},
