const timestamp_saved = '09/17/2023 05:25 AM';
const dataFechaAcualizado = '9/17/2023' + ' 1:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 135, MVar:'59', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'117', Cost:17.35, ParentId: '16'},
		]
	},
