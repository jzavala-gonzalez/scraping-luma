const timestamp_saved = '10/17/2023 04:10 AM';
const dataFechaAcualizado = '10/17/2023' + ' 12:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'61', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'66', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'64', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:16.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:16.40, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'3', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'74', Cost:16.70, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 226,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 226, MVar:'73', Cost:10.09, ParentId: '17'},
		]
	},
