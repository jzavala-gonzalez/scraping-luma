const timestamp_saved = '12/04/2023 12:50 AM';
const dataFechaAcualizado = '12/3/2023' + ' 8:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'54', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'56', Cost:10.88, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'141', Cost:17.24, ParentId: '16'},
		]
	},
