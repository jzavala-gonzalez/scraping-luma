const timestamp_saved = '11/30/2023 06:30 PM';
const dataFechaAcualizado = '11/30/2023' + ' 2:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'56', Cost:10.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'49', Cost:8.09, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'82', Cost:9.57, ParentId: '17'},
		]
	},
