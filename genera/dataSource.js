const timestamp_saved = '10/02/2023 04:40 PM';
const dataFechaAcualizado = '10/2/2023' + ' 12:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'40', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'38', Cost:10.40, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'98', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'176', Cost:17.04, ParentId: '16'},
		]
	},
