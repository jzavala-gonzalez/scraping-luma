const timestamp_saved = '11/26/2023 03:05 AM';
const dataFechaAcualizado = '11/25/2023' + ' 11:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'69', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'30', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'40', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'53', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'11', Cost:19.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 175,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 175, MVar:'123', Cost:19.87, ParentId: '16'},
		]
	},
