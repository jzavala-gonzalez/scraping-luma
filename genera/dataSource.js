const timestamp_saved = '10/01/2023 11:35 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'57', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 55, MVar:'50', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'25', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'23', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'42', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'11', Cost:19.32, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'79', Cost:9.50, ParentId: '17'},
		]
	},
