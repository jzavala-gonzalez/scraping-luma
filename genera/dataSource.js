const timestamp_saved = '11/25/2023 07:15 PM';
const dataFechaAcualizado = '11/25/2023' + ' 3:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'68', Cost:4.39, ParentId: '6'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'56', Cost:9.84, ParentId: '17'},
		]
	},
