const timestamp_saved = '10/20/2023 05:05 PM';
const dataFechaAcualizado = '10/20/2023' + ' 1:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'48', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'55', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'51', Cost:10.89, ParentId: '7'},
		]
	},
