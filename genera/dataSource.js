const timestamp_saved = '10/18/2023 08:40 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'37', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:10.67, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 61, MVar:'68', Cost:20.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'82', Cost:10.65, ParentId: '17'},
		]
	},
