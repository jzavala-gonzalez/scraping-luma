const timestamp_saved = '08/05/2023 05:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 1:20:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'48', Cost:10.66, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'4', Cost:33.23, ParentId: '9'},
