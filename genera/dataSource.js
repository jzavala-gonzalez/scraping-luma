const timestamp_saved = '09/19/2023 03:50 PM';
const dataFechaAcualizado = '9/19/2023' + ' 11:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 166, MVar:'63', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'73', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'51', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'62', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'27', Cost:18.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'82', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'144', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'89', Cost:9.33, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 121,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 45, MVar:'4', Cost:19.60, ParentId: '19'},
