const timestamp_saved = '11/03/2023 06:20 AM';
const dataFechaAcualizado = '11/3/2023' + ' 2:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'43', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'61', Cost:9.34, ParentId: '17'},
		]
	},
