const timestamp_saved = '11/20/2023 08:10 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'27', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'51', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'88', Cost:9.18, ParentId: '17'},
		]
	},
