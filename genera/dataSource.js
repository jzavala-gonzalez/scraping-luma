const timestamp_saved = '12/03/2023 11:50 PM';
const dataFechaAcualizado = '12/3/2023' + ' 7:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'54', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'55', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'146', Cost:16.90, ParentId: '16'},
		]
	},
