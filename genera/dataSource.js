const timestamp_saved = '10/04/2023 04:40 AM';
const dataFechaAcualizado = '10/4/2023' + ' 12:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'37', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'35', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'12', Cost:16.94, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.60, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'143', Cost:16.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 225,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 225, MVar:'93', Cost:10.39, ParentId: '17'},
		]
	},
