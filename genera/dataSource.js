const timestamp_saved = '10/10/2023 05:50 AM';
const dataFechaAcualizado = '10/10/2023' + ' 1:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'59', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'61', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'64', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.67, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'77', Cost:16.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 200,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'143', Cost:18.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'68', Cost:9.14, ParentId: '17'},
		]
	},
