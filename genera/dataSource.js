const timestamp_saved = '11/15/2023 08:10 PM';
const dataFechaAcualizado = '11/15/2023' + ' 4:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'62', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'64', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:10.68, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:27.16, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'14', Cost:22.66, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'96', Cost:16.84, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:27.16, ParentId: '21'},
