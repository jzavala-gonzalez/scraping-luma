const timestamp_saved = '10/26/2023 03:05 PM';
const dataFechaAcualizado = '10/26/2023' + ' 11:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'45', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'50', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'51', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:16.66, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 67, MVar:'23', Cost:19.59, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'146', Cost:18.24, ParentId: '16'},
		]
	},
