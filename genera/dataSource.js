const timestamp_saved = '10/30/2023 06:10 AM';
const dataFechaAcualizado = '10/30/2023' + ' 2:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'35', Cost:11.12, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'105', Cost:18.73, ParentId: '16'},
		]
	},
