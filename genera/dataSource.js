const timestamp_saved = '08/28/2023 03:15 PM';
const dataFechaAcualizado = '8/28/2023' + ' 11:10:50 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2513},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 158, MVar:'88', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'53', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'55', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'53', Cost:10.57, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 124, MVar:'48', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'6', Cost:27.03, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'18', Cost:31.13, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'43', Cost:19.85, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'98', Cost:16.97, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 252,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 252, MVar:'167', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'110', Cost:9.27, ParentId: '17'},
		]
	},
