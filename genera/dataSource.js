const timestamp_saved = '09/09/2023 05:10 PM';
const dataFechaAcualizado = '9/9/2023' + ' 1:05:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2372},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'59', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'64', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'58', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:19.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:19.80, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.64, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'9', Cost:8.64, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.11, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:30.97, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'20', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'98', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'159', Cost:17.84, ParentId: '16'},
		]
	},
