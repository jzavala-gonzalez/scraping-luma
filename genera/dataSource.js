const timestamp_saved = '08/16/2023 01:25 PM';
const dataFechaAcualizado = '8/16/2023' + ' 9:22:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'58', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'53', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'59', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:19.85, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 61, MVar:'30', Cost:20.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'197', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'86', Cost:10.45, ParentId: '17'},
		]
	},
