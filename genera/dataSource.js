const timestamp_saved = '09/11/2023 12:15 PM';
const dataFechaAcualizado = '9/11/2023' + ' 8:10:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'74', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'71', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'68', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'19', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'89', Cost:16.81, ParentId: '15'},
