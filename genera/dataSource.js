const timestamp_saved = '09/04/2023 09:50 AM';
const dataFechaAcualizado = '9/4/2023' + ' 5:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'38', Cost:10.46, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'137', Cost:17.37, ParentId: '16'},
		]
	},
