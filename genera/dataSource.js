const timestamp_saved = '10/15/2023 05:25 AM';
const dataFechaAcualizado = '10/15/2023' + ' 1:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'55', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'56', Cost:10.80, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.72, ParentId: '14'},
