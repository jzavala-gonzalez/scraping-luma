const timestamp_saved = '12/05/2023 01:25 AM';
const dataFechaAcualizado = '12/4/2023' + ' 9:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 251,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'89', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'57', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'58', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'63', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:17.58, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.64, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 78, MVar:'15', Cost:19.21, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'25', Cost:18.71, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'138', Cost:17.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'91', Cost:10.87, ParentId: '17'},
		]
	},
