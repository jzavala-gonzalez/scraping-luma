const timestamp_saved = '11/06/2023 05:20 AM';
const dataFechaAcualizado = '11/6/2023' + ' 1:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'45', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'44', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'43', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'10', Cost:17.26, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'75', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'115', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 211,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 211, MVar:'52', Cost:10.75, ParentId: '17'},
		]
	},
