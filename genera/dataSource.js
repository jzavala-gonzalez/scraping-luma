const timestamp_saved = '11/08/2023 01:00 PM';
const dataFechaAcualizado = '11/8/2023' + ' 8:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'50', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'48', Cost:10.34, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'96', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'93', Cost:9.61, ParentId: '17'},
		]
	},
