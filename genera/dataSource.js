const timestamp_saved = '10/25/2023 06:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'51', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'12', Cost:43.31, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'87', Cost:17.01, ParentId: '15'},
