const timestamp_saved = '11/24/2023 08:00 AM';
const dataFechaAcualizado = '11/24/2023' + ' 3:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'21', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'30', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'46', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'62', Cost:9.89, ParentId: '17'},
		]
	},
