const timestamp_saved = '10/05/2023 03:40 AM';
const dataFechaAcualizado = '10/4/2023' + ' 11:36:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'39', Cost:12.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'37', Cost:12.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'52', Cost:12.73, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 323, MVar:'150', Cost:16.71, ParentId: '16'},
		]
	},
