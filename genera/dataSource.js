const timestamp_saved = '12/05/2023 01:10 AM';
const dataFechaAcualizado = '12/4/2023' + ' 9:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'56', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'59', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'62', Cost:10.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 19, MVar:'0', Cost:26.31, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 169,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 79, MVar:'15', Cost:19.20, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'27', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'141', Cost:17.37, ParentId: '16'},
		]
	},
