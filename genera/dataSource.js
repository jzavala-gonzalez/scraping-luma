const timestamp_saved = '11/30/2023 10:10 PM';
const dataFechaAcualizado = '11/30/2023' + ' 6:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'59', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'61', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'58', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:25.72, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 2, MVar:'0', Cost:1045.43, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.51, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'161', Cost:17.84, ParentId: '16'},
		]
	},
