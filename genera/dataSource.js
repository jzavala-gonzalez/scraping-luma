const timestamp_saved = '08/12/2023 06:40 AM';
const dataFechaAcualizado = '8/12/2023' + ' 2:37:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 510,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'58', Cost:10.08, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'5', Cost:107.08, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'179', Cost:16.74, ParentId: '16'},
		]
	},
