const timestamp_saved = '12/06/2023 05:35 AM';
const dataFechaAcualizado = '12/6/2023' + ' 1:30:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'43', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'45', Cost:11.28, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'110', Cost:18.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'57', Cost:14.51, ParentId: '17'},
		]
	},
