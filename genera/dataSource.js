const timestamp_saved = '11/10/2023 12:20 PM';
const dataFechaAcualizado = '11/10/2023' + ' 8:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'53', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'57', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'10', Cost:21.92, ParentId: '14'},
