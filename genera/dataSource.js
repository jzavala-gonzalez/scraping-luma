const timestamp_saved = '11/08/2023 09:05 PM';
const dataFechaAcualizado = '11/8/2023' + ' 5:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'54', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'53', Cost:10.86, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'10', Cost:19.90, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'107', Cost:9.25, ParentId: '17'},
		]
	},
