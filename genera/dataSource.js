const timestamp_saved = '08/07/2023 08:05 AM';
const dataFechaAcualizado = '8/7/2023' + ' 4:00:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'40', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'41', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'92', Cost:11.72, ParentId: '17'},
		]
	},
