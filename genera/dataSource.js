const timestamp_saved = '11/02/2023 11:40 PM';
const dataFechaAcualizado = '11/2/2023' + ' 7:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'65', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'67', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 138,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:22.97, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 274,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:16.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:16.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 75, MVar:'23', Cost:52.50, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'0', Cost:52.50, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'20', Cost:21.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'107', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'188', Cost:17.58, ParentId: '16'},
		]
	},
