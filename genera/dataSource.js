const timestamp_saved = '08/18/2023 07:00 PM';
const dataFechaAcualizado = '8/18/2023' + ' 2:57:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'67', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'73', Cost:10.52, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 71, MVar:'0', Cost:6.68, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'12', Cost:30.73, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:19.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'13', Cost:19.75, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'0', Cost:8.10, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:30.69, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'82', Cost:18.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'151', Cost:17.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'87', Cost:9.27, ParentId: '17'},
		]
	},
