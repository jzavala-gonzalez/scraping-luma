const timestamp_saved = '11/12/2023 10:10 AM';
const dataFechaAcualizado = '11/12/2023' + ' 6:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'39', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'41', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'50', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'76', Cost:9.64, ParentId: '17'},
		]
	},
