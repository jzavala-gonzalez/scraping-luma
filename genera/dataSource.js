const timestamp_saved = '10/22/2023 05:45 AM';
const dataFechaAcualizado = '10/22/2023' + ' 1:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'42', Cost:10.81, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'7', Cost:30.91, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 209,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'132', Cost:18.41, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'60', Cost:11.10, ParentId: '17'},
		]
	},
