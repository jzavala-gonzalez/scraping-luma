const timestamp_saved = '10/04/2023 01:40 PM';
const dataFechaAcualizado = '10/4/2023' + ' 9:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 517,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'43', Cost:9.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'40', Cost:9.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 173, MVar:'54', Cost:9.93, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 38,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:23.10, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 37, MVar:'4', Cost:22.24, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'3', Cost:31.79, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'11', Cost:18.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'79', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 128, MVar:'160', Cost:23.10, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'107', Cost:9.36, ParentId: '17'},
		]
	},
