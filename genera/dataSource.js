const timestamp_saved = '10/30/2023 10:15 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'65', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'67', Cost:10.30, ParentId: '7'},
		]
	},
