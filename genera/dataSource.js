const timestamp_saved = '10/08/2023 04:25 PM';
const dataFechaAcualizado = '10/8/2023' + ' 12:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'41', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'43', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'41', Cost:10.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:62.40, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 159, MVar:'77', Cost:11.49, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 106,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 43, MVar:'16', Cost:19.60, ParentId: '19'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:62.40, ParentId: '21'},
