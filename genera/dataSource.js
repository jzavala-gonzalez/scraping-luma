const timestamp_saved = '10/27/2023 11:40 PM';
const dataFechaAcualizado = '10/27/2023' + ' 7:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'47', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'50', Cost:11.58, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:17.36, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'2', Cost:30.99, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 106,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 36, MVar:'8', Cost:24.42, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.84, ParentId: '14'},
