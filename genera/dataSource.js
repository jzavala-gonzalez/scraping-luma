const timestamp_saved = '09/28/2023 03:30 PM';
const dataFechaAcualizado = '9/28/2023' + ' 11:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'26', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'26', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'49', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'127', Cost:18.42, ParentId: '16'},
		]
	},
