const timestamp_saved = '12/02/2023 07:25 PM';
const dataFechaAcualizado = '12/2/2023' + ' 3:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 202,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 202, MVar:'77', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 157, MVar:'49', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:8.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:8.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 135, MVar:'41', Cost:8.72, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'82', Cost:11.59, ParentId: '17'},
		]
	},
