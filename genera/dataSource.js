const timestamp_saved = '11/27/2023 07:55 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:51:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1834},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'18', Cost:12.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'27', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'45', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'100', Cost:18.28, ParentId: '16'},
		]
	},
