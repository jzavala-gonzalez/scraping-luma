const timestamp_saved = '07/25/2023 06:12 AM';
const dataFechaAcualizado = '7/25/2023' + ' 2:05:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'64', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'55', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'52', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'6', Cost:22.34, ParentId: '9'},
