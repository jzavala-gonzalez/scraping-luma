const timestamp_saved = '07/28/2023 02:42 AM';
const dataFechaAcualizado = '7/27/2023' + ' 10:35:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'53', Cost:10.72, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 107, MVar:'33', Cost:20.38, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:30.27, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'18', Cost:18.67, ParentId: '14'},
