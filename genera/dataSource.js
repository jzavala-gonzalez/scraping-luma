const timestamp_saved = '11/30/2023 04:45 AM';
const dataFechaAcualizado = '11/30/2023' + ' 12:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'42', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'47', Cost:10.83, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 30,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'2', Cost:29.65, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.49, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 232,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 232, MVar:'71', Cost:10.05, ParentId: '17'},
		]
	},
