const timestamp_saved = '09/14/2023 02:30 AM';
const dataFechaAcualizado = '9/13/2023' + ' 10:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'62', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'62', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'72', Cost:9.77, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'3', Cost:26.46, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 121,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'12', Cost:31.10, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 70, MVar:'17', Cost:27.13, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:31.16, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'15', Cost:19.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'59', Cost:17.15, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 361, MVar:'180', Cost:16.57, ParentId: '16'},
		]
	},
