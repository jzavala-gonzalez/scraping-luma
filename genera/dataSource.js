const timestamp_saved = '08/07/2023 09:15 AM';
const dataFechaAcualizado = '8/7/2023' + ' 5:10:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'51', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'45', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'54', Cost:18.44, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'103', Cost:11.90, ParentId: '17'},
		]
	},
