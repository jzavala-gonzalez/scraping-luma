const timestamp_saved = '10/13/2023 02:10 PM';
const dataFechaAcualizado = '10/13/2023' + ' 10:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'60', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'66', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'69', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'11', Cost:43.17, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.13, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.44, ParentId: '14'},
