const timestamp_saved = '09/08/2023 02:00 AM';
const dataFechaAcualizado = '9/7/2023' + ' 9:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'61', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'52', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'54', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:18.87, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.59, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:27.19, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'5', Cost:26.24, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'76', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'189', Cost:16.75, ParentId: '16'},
		]
	},
