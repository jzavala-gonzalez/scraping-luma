const timestamp_saved = '10/28/2023 03:05 AM';
const dataFechaAcualizado = '10/27/2023' + ' 11:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'45', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'45', Cost:10.63, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 253,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'15', Cost:31.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'47', Cost:17.23, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:17.23, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'11', Cost:23.62, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'7', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'74', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'109', Cost:18.01, ParentId: '16'},
		]
	},
