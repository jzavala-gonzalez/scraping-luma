const timestamp_saved = '07/26/2023 09:05 AM';
const dataFechaAcualizado = '7/26/2023' + ' 5:00:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 235, MVar:'73', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'51', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'14', Cost:17.77, ParentId: '14'},
