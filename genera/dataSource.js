const timestamp_saved = '12/06/2023 01:55 PM';
const dataFechaAcualizado = '12/6/2023' + ' 9:50:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 872},
	{Index:'7', Desc:'Capacidad Disponible', value: 2996},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'49', Cost:12.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'51', Cost:12.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'58', Cost:12.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'11', Cost:18.75, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'69', Cost:14.30, ParentId: '17'},
		]
	},
