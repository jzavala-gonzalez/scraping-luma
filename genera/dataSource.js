const timestamp_saved = '12/04/2023 02:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'53', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'87', Cost:10.93, ParentId: '17'},
		]
	},
