const timestamp_saved = '11/29/2023 02:15 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'43', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'46', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'77', Cost:9.69, ParentId: '17'},
		]
	},
