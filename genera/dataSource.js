const timestamp_saved = '10/27/2023 12:50 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'51', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'49', Cost:12.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'53', Cost:12.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:16.70, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'49', Cost:16.89, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'11', Cost:16.89, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'26', Cost:19.15, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'92', Cost:16.90, ParentId: '15'},
