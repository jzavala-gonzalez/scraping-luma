const timestamp_saved = '09/27/2023 03:45 AM';
const dataFechaAcualizado = '9/26/2023' + ' 11:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'45', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'46', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'56', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 14,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 14, MVar:'4', Cost:27.05, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'38', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.40, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.25, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:18.25, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'2', Cost:19.29, ParentId: '14'},
