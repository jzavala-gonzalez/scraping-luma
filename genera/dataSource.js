const timestamp_saved = '10/07/2023 10:00 AM';
const dataFechaAcualizado = '10/7/2023' + ' 5:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 59, MVar:'34', Cost:4.40, ParentId: '6'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'95', Cost:9.28, ParentId: '17'},
		]
	},
