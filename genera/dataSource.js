const timestamp_saved = '08/17/2023 05:35 AM';
const dataFechaAcualizado = '8/17/2023' + ' 1:32:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'59', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'70', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.03, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'180', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'77', Cost:9.23, ParentId: '17'},
		]
	},
