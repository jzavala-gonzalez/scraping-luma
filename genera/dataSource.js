const timestamp_saved = '12/03/2023 07:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 3:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'58', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'46', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'55', Cost:11.63, ParentId: '17'},
		]
	},
