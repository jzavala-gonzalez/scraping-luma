const timestamp_saved = '08/23/2023 07:35 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:30:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'42', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'43', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'43', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:20.29, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'53', Cost:18.42, ParentId: '15'},
