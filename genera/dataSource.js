const timestamp_saved = '09/27/2023 11:00 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'35', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'35', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'63', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:17.70, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'142', Cost:17.88, ParentId: '16'},
		]
	},
