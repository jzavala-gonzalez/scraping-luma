const timestamp_saved = '08/05/2023 12:30 PM';
const dataFechaAcualizado = '8/5/2023' + ' 8:25:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'40', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:20.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'0', Cost:20.63, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:29.40, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'30', Cost:18.80, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'90', Cost:16.60, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'21', Cost:15.46, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'92', Cost:11.55, ParentId: '17'},
		]
	},
