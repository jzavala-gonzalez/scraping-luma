const timestamp_saved = '08/02/2023 02:50 AM';
const dataFechaAcualizado = '8/1/2023' + ' 10:45:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'45', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'80', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'147', Cost:16.89, ParentId: '16'},
		]
	},
