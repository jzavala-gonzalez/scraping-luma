const timestamp_saved = '08/01/2023 04:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 12:20:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'47', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'51', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'101', Cost:10.99, ParentId: '17'},
		]
	},
