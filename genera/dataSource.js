const timestamp_saved = '07/27/2023 06:04 PM';
const dataFechaAcualizado = '7/27/2023' + ' 1:55:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 186, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'58', Cost:10.16, ParentId: '7'},
