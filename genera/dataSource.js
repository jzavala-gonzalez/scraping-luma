const timestamp_saved = '08/16/2023 07:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 3:32:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'49', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'58', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'79', Cost:10.49, ParentId: '17'},
		]
	},
