const timestamp_saved = '08/04/2023 06:05 AM';
const dataFechaAcualizado = '8/4/2023' + ' 2:00:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'40', Cost:10.87, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'65', Cost:16.54, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'19', Cost:15.57, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'76', Cost:11.41, ParentId: '17'},
		]
	},
