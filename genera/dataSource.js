const timestamp_saved = '11/18/2023 02:55 AM';
const dataFechaAcualizado = '11/17/2023' + ' 10:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'75', Cost:9.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'72', Cost:9.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 164, MVar:'58', Cost:9.92, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'23', Cost:27.91, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'4', Cost:30.55, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.82, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'20', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'71', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'122', Cost:9.14, ParentId: '17'},
		]
	},
