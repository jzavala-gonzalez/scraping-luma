const timestamp_saved = '11/30/2023 03:40 AM';
const dataFechaAcualizado = '11/29/2023' + ' 11:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'47', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'51', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:10.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:26.14, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:1.77, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.93, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:17.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.36, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'48', Cost:8.09, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 52, MVar:'12', Cost:8.09, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 221,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 221, MVar:'154', Cost:18.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'88', Cost:9.24, ParentId: '17'},
		]
	},
