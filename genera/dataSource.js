const timestamp_saved = '10/26/2023 08:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 3:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'34', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'35', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'43', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.20, ParentId: '11'},
