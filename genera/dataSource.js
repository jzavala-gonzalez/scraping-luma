const timestamp_saved = '09/04/2023 09:45 AM';
const dataFechaAcualizado = '9/4/2023' + ' 5:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'38', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'43', Cost:10.50, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'137', Cost:17.34, ParentId: '16'},
		]
	},
