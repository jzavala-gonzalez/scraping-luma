const timestamp_saved = '10/04/2023 03:25 AM';
const dataFechaAcualizado = '10/3/2023' + ' 11:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'35', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'35', Cost:11.07, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'72', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'95', Cost:9.43, ParentId: '17'},
		]
	},
