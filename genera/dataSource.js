const timestamp_saved = '10/17/2023 08:35 AM';
const dataFechaAcualizado = '10/17/2023' + ' 4:31:15 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1290},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'50', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'49', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'53', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'64', Cost:9.21, ParentId: '17'},
		]
	},
