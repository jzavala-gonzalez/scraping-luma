const timestamp_saved = '11/25/2023 07:20 PM';
const dataFechaAcualizado = '11/25/2023' + ' 3:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 166, MVar:'67', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'32', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'42', Cost:10.41, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'27', Cost:19.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'137', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'59', Cost:9.84, ParentId: '17'},
		]
	},
