const timestamp_saved = '07/28/2023 11:30 AM';
const dataFechaAcualizado = '7/28/2023' + ' 7:25:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'43', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'45', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'44', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 26,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 26, MVar:'0', Cost:22.63, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'7', Cost:30.05, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 142, MVar:'0', Cost:8.27, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:8.27, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:29.73, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'9', Cost:28.92, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 270,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'84', Cost:17.12, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'33', Cost:16.25, ParentId: '15'},
		]
	},
