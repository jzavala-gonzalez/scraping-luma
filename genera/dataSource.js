const timestamp_saved = '08/02/2023 09:40 AM';
const dataFechaAcualizado = '8/2/2023' + ' 5:35:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'46', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'47', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 107, MVar:'29', Cost:21.60, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 152, MVar:'42', Cost:15.59, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 213,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'149', Cost:18.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'87', Cost:11.04, ParentId: '17'},
		]
	},
