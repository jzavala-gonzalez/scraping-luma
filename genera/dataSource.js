const timestamp_saved = '11/02/2023 11:10 AM';
const dataFechaAcualizado = '11/2/2023' + ' 7:06:18 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2169},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2193},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'50', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'49', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'47', Cost:11.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.13, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:47.01, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:18.51, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'36', Cost:18.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:18.31, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'16', Cost:21.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'78', Cost:16.83, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 169,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'127', Cost:20.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'73', Cost:9.24, ParentId: '17'},
		]
	},
