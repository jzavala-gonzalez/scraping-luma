const timestamp_saved = '07/30/2023 11:15 AM';
const dataFechaAcualizado = '7/30/2023' + ' 7:10:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'41', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'38', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'65', Cost:19.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'62', Cost:11.14, ParentId: '17'},
		]
	},
