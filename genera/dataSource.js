const timestamp_saved = '10/21/2023 10:35 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'37', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'35', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'36', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.55, ParentId: '14'},
