const timestamp_saved = '08/17/2023 01:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:32:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 3057},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 525,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'60', Cost:9.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'76', Cost:9.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 183, MVar:'82', Cost:9.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.17, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'20', Cost:27.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'20', Cost:28.08, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:29.30, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 86,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'5', Cost:30.31, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'245', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'101', Cost:9.20, ParentId: '17'},
		]
	},
