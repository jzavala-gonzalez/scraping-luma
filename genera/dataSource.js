const timestamp_saved = '08/15/2023 07:50 AM';
const dataFechaAcualizado = '8/15/2023' + ' 3:47:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'44', Cost:10.97, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:20.93, ParentId: '9'},
