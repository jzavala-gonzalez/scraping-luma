const timestamp_saved = '08/25/2023 08:00 AM';
const dataFechaAcualizado = '8/25/2023' + ' 3:55:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'57', Cost:10.87, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:30.55, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'93', Cost:9.27, ParentId: '17'},
		]
	},
