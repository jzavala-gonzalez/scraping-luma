const timestamp_saved = '10/27/2023 06:50 PM';
const dataFechaAcualizado = '10/27/2023' + ' 2:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'51', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'52', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 117, MVar:'34', Cost:17.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.60, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'22', Cost:19.58, ParentId: '14'},
