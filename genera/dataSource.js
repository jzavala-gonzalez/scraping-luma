const timestamp_saved = '09/02/2023 12:10 AM';
const dataFechaAcualizado = '9/1/2023' + ' 8:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 551,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'60', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'67', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'72', Cost:9.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 193,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'5', Cost:23.78, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 150,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'12', Cost:28.15, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'13', Cost:28.18, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'7', Cost:28.66, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'21', Cost:18.74, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'162', Cost:16.68, ParentId: '16'},
		]
	},
