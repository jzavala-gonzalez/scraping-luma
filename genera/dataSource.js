const timestamp_saved = '11/30/2023 05:50 AM';
const dataFechaAcualizado = '11/30/2023' + ' 1:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'39', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'45', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.42, ParentId: '11'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:21.65, ParentId: '21'},
