const timestamp_saved = '07/27/2023 06:18 AM';
const dataFechaAcualizado = '7/27/2023' + ' 2:10:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'55', Cost:10.89, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 11, MVar:'2', Cost:25.41, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 3, MVar:'1', Cost:41.88, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 119, MVar:'0', Cost:8.83, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:8.83, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'98', Cost:16.59, ParentId: '15'},
