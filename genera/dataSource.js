const timestamp_saved = '11/05/2023 04:40 PM';
const dataFechaAcualizado = '11/5/2023' + ' 12:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'44', Cost:13.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'42', Cost:13.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'42', Cost:13.09, ParentId: '7'},
		]
	},
