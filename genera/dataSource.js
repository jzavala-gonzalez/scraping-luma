const timestamp_saved = '09/14/2023 11:30 PM';
const dataFechaAcualizado = '9/14/2023' + ' 7:25:53 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3156},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'66', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'65', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'72', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'21', Cost:28.24, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'23', Cost:28.15, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'37', Cost:18.58, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'97', Cost:16.72, ParentId: '15'},
