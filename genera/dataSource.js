const timestamp_saved = '11/15/2023 12:20 PM';
const dataFechaAcualizado = '11/15/2023' + ' 8:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'34', Cost:19.32, ParentId: '14'},
