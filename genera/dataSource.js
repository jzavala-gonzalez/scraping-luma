const timestamp_saved = '08/04/2023 01:45 AM';
const dataFechaAcualizado = '8/3/2023' + ' 9:40:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'48', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'52', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'10', Cost:22.66, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.43, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:30.79, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'95', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'19', Cost:15.62, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 315, MVar:'174', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'103', Cost:10.87, ParentId: '17'},
		]
	},
