const timestamp_saved = '09/27/2023 01:25 PM';
const dataFechaAcualizado = '9/27/2023' + ' 9:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'32', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'32', Cost:10.85, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'87', Cost:9.40, ParentId: '17'},
		]
	},
