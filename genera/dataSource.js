const timestamp_saved = '11/26/2023 08:10 AM';
const dataFechaAcualizado = '11/26/2023' + ' 4:06:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1844},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'18', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'28', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'45', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.80, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'110', Cost:18.25, ParentId: '16'},
		]
	},
