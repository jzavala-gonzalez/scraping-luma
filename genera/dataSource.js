const timestamp_saved = '08/22/2023 03:50 AM';
const dataFechaAcualizado = '8/21/2023' + ' 11:45:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'50', Cost:11.00, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:27.02, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'50', Cost:19.63, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'2', Cost:31.09, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:35.60, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'123', Cost:19.00, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'70', Cost:9.18, ParentId: '17'},
		]
	},
