const timestamp_saved = '08/20/2023 05:10 AM';
const dataFechaAcualizado = '8/20/2023' + ' 1:07:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'56', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'57', Cost:11.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'141', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'76', Cost:9.18, ParentId: '17'},
		]
	},
