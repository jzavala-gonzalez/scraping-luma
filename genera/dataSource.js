const timestamp_saved = '09/10/2023 07:55 AM';
const dataFechaAcualizado = '9/10/2023' + ' 3:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'63', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'61', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'62', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:9.96, ParentId: '11'},
		]
	},
