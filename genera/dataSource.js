const timestamp_saved = '10/22/2023 02:25 PM';
const dataFechaAcualizado = '10/22/2023' + ' 10:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:11.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'47', Cost:11.89, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'15', Cost:18.55, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'57', Cost:11.26, ParentId: '17'},
		]
	},
