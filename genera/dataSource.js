const timestamp_saved = '10/13/2023 02:15 PM';
const dataFechaAcualizado = '10/13/2023' + ' 10:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'60', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'66', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'70', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:16.87, ParentId: '11'},
