const timestamp_saved = '08/18/2023 05:55 AM';
const dataFechaAcualizado = '8/18/2023' + ' 1:52:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'41', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'55', Cost:10.83, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'64', Cost:9.43, ParentId: '17'},
		]
	},
