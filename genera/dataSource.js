const timestamp_saved = '10/21/2023 10:25 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'36', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'34', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'36', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'67', Cost:11.03, ParentId: '17'},
		]
	},
