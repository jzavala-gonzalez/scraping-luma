const timestamp_saved = '09/10/2023 11:25 PM';
const dataFechaAcualizado = '9/10/2023' + ' 7:20:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 45},
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Hidro 3', MW: 0, MVar:'5', Cost:0, ParentId: '0'},
		]
	},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 551,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'74', Cost:9.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'73', Cost:9.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 210, MVar:'71', Cost:9.66, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 82, MVar:'0', Cost:9.07, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'13', Cost:23.04, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'18', Cost:28.08, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'16', Cost:28.07, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:19.84, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'0', Cost:8.21, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'12', Cost:8.21, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'12', Cost:33.45, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'24', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'99', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 372, MVar:'161', Cost:16.63, ParentId: '16'},
		]
	},
