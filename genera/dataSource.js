const timestamp_saved = '08/31/2023 02:15 AM';
const dataFechaAcualizado = '8/30/2023' + ' 10:10:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'58', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'70', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'75', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'3', Cost:22.92, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'25', Cost:27.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'25', Cost:28.15, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:18.92, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:18.92, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:29.96, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'5', Cost:28.62, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'29', Cost:18.76, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'94', Cost:16.97, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'192', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'112', Cost:9.20, ParentId: '17'},
		]
	},
