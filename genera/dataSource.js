const timestamp_saved = '11/24/2023 08:11 AM';
const dataFechaAcualizado = '11/24/2023' + ' 4:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'21', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'30', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'45', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'61', Cost:9.91, ParentId: '17'},
		]
	},
