const timestamp_saved = '11/05/2023 04:10 PM';
const dataFechaAcualizado = '11/5/2023' + ' 12:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'44', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'42', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'43', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'37', Cost:17.92, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'55', Cost:9.93, ParentId: '17'},
		]
	},
