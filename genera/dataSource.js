const timestamp_saved = '10/25/2023 08:55 PM';
const dataFechaAcualizado = '10/25/2023' + ' 4:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'50', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 171, MVar:'52', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'83', Cost:16.86, ParentId: '15'},
