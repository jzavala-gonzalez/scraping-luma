const timestamp_saved = '11/07/2023 10:20 AM';
const dataFechaAcualizado = '11/7/2023' + ' 6:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'44', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'44', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'42', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:27.45, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'10', Cost:20.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'63', Cost:17.00, ParentId: '15'},
