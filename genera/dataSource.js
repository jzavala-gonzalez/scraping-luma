const timestamp_saved = '11/25/2023 05:20 PM';
const dataFechaAcualizado = '11/25/2023' + ' 1:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 166, MVar:'63', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'26', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'35', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.53, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'11', Cost:19.79, ParentId: '14'},
