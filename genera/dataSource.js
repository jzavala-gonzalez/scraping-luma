const timestamp_saved = '12/04/2023 04:45 PM';
const dataFechaAcualizado = '12/4/2023' + ' 12:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'85', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'52', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'52', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'54', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:17.59, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:18.93, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'129', Cost:18.21, ParentId: '16'},
		]
	},
