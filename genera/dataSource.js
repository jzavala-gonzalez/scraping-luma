const timestamp_saved = '11/14/2023 05:50 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'42', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'47', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'51', Cost:12.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'19', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:30.56, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'86', Cost:10.87, ParentId: '17'},
		]
	},
