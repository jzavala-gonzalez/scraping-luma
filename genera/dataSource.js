const timestamp_saved = '08/13/2023 04:25 AM';
const dataFechaAcualizado = '8/13/2023' + ' 12:22:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'42', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'48', Cost:10.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:28.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 13, MVar:'2', Cost:28.78, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'6', Cost:31.50, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:31.19, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 28,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'5', Cost:31.13, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'117', Cost:12.27, ParentId: '17'},
		]
	},
