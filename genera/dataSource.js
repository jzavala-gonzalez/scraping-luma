const timestamp_saved = '11/01/2023 03:30 AM';
const dataFechaAcualizado = '10/31/2023' + ' 11:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'58', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'64', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'68', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'135', Cost:17.31, ParentId: '16'},
		]
	},
