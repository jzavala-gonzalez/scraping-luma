const timestamp_saved = '11/01/2023 03:35 AM';
const dataFechaAcualizado = '10/31/2023' + ' 11:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'58', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'64', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'67', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'134', Cost:17.64, ParentId: '16'},
		]
	},
