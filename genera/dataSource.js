const timestamp_saved = '10/23/2023 01:05 AM';
const dataFechaAcualizado = '10/22/2023' + ' 9:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'52', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'53', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 8, MVar:'0', Cost:20.33, ParentId: '8'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 16,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:20.33, ParentId: '21'},
