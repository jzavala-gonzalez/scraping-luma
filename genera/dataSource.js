const timestamp_saved = '11/03/2023 03:00 AM';
const dataFechaAcualizado = '11/2/2023' + ' 10:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'51', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'51', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'57', Cost:11.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 10, MVar:'0', Cost:31.37, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'3', Cost:27.17, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'75', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'78', Cost:9.13, ParentId: '17'},
		]
	},
