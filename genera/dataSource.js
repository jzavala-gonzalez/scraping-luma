const timestamp_saved = '10/06/2023 07:30 PM';
const dataFechaAcualizado = '10/6/2023' + ' 3:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'50', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'53', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:28.37, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'99', Cost:16.82, ParentId: '15'},
