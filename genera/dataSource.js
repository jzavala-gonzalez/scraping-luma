const timestamp_saved = '11/23/2023 09:15 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:11:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1827},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'17', Cost:13.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'27', Cost:13.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'46', Cost:13.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.61, ParentId: '11'},
