const timestamp_saved = '08/04/2023 01:55 AM';
const dataFechaAcualizado = '8/3/2023' + ' 9:50:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'48', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'10', Cost:22.57, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.86, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'102', Cost:10.84, ParentId: '17'},
		]
	},
