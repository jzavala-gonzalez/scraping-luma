const timestamp_saved = '09/08/2023 02:15 PM';
const dataFechaAcualizado = '9/8/2023' + ' 10:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'59', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'55', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'52', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'15', Cost:31.19, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'16', Cost:31.15, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.84, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:31.59, ParentId: '13'},
