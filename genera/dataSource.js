const timestamp_saved = '11/06/2023 05:40 PM';
const dataFechaAcualizado = '11/6/2023' + ' 1:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 152, MVar:'51', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'115', Cost:9.43, ParentId: '17'},
		]
	},
