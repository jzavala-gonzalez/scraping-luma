const timestamp_saved = '09/13/2023 03:50 PM';
const dataFechaAcualizado = '9/13/2023' + ' 11:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'52', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'51', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'66', Cost:11.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.71, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'63', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'12', Cost:28.28, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'14', Cost:28.19, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:19.71, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'155', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'99', Cost:9.13, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 95,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'20', Cost:19.60, ParentId: '19'},
