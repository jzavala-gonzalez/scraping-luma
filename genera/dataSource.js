const timestamp_saved = '10/23/2023 05:10 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'39', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'39', Cost:12.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'40', Cost:12.63, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'71', Cost:16.79, ParentId: '15'},
