const timestamp_saved = '11/23/2023 10:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 6:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'19', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'30', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'63', Cost:9.55, ParentId: '17'},
		]
	},
