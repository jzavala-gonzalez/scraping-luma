const timestamp_saved = '07/25/2023 08:24 AM';
const dataFechaAcualizado = '7/25/2023' + ' 4:15:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'78', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 512,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'62', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 171, MVar:'56', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:26.91, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'9', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'9', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'9', Cost:28.88, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:28.78, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'13', Cost:18.65, ParentId: '14'},
