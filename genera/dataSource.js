const timestamp_saved = '11/22/2023 03:25 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'30', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'40', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'56', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 98, MVar:'76', Cost:17.81, ParentId: '15'},
