const timestamp_saved = '10/28/2023 03:00 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'39', Cost:13.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'41', Cost:13.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'46', Cost:13.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'15', Cost:34.27, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 56,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 56, MVar:'79', Cost:21.44, ParentId: '15'},
