const timestamp_saved = '08/04/2023 06:00 AM';
const dataFechaAcualizado = '8/4/2023' + ' 1:55:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'69', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'40', Cost:10.94, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'65', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 284, MVar:'124', Cost:17.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'77', Cost:11.24, ParentId: '17'},
		]
	},
