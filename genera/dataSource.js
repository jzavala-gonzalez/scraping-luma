const timestamp_saved = '10/27/2023 01:05 AM';
const dataFechaAcualizado = '10/26/2023' + ' 9:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'54', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'55', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'55', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'27', Cost:31.11, ParentId: '10'},
