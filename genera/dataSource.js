const timestamp_saved = '09/04/2023 10:35 PM';
const dataFechaAcualizado = '9/4/2023' + ' 6:30:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'57', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'7', Cost:22.91, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'5', Cost:31.27, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.56, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'186', Cost:16.73, ParentId: '16'},
		]
	},
