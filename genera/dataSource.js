const timestamp_saved = '11/25/2023 09:00 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'18', Cost:13.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'28', Cost:13.32, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'117', Cost:17.71, ParentId: '16'},
		]
	},
