const timestamp_saved = '10/26/2023 01:25 AM';
const dataFechaAcualizado = '10/25/2023' + ' 9:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'49', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'52', Cost:10.91, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'53', Cost:16.75, ParentId: '15'},
