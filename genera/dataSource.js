const timestamp_saved = '08/18/2023 11:35 PM';
const dataFechaAcualizado = '8/18/2023' + ' 7:32:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2981},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'68', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'76', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'3', Cost:27.03, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:19.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:19.60, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:30.58, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:30.66, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'85', Cost:17.39, ParentId: '15'},
