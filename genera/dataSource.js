const timestamp_saved = '08/25/2023 03:50 PM';
const dataFechaAcualizado = '8/25/2023' + ' 11:45:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'69', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'96', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'63', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'66', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'60', Cost:10.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 115, MVar:'0', Cost:7.08, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'5', Cost:26.26, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.91, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'3', Cost:27.06, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'15', Cost:30.89, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.91, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'86', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'162', Cost:17.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'108', Cost:9.30, ParentId: '17'},
		]
	},
