const timestamp_saved = '10/23/2023 03:40 AM';
const dataFechaAcualizado = '10/22/2023' + ' 11:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'44', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'45', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'44', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'62', Cost:11.30, ParentId: '17'},
		]
	},
