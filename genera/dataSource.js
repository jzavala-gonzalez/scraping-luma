const timestamp_saved = '10/29/2023 06:15 PM';
const dataFechaAcualizado = '10/29/2023' + ' 2:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'49', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'53', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'71', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'125', Cost:16.97, ParentId: '16'},
		]
	},
