const timestamp_saved = '10/05/2023 02:30 AM';
const dataFechaAcualizado = '10/4/2023' + ' 10:26:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'44', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'115', Cost:9.16, ParentId: '17'},
		]
	},
