const timestamp_saved = '09/18/2023 09:35 AM';
const dataFechaAcualizado = '9/18/2023' + ' 5:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'42', Cost:10.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'7', Cost:8.12, ParentId: '11'},
		]
	},
