const timestamp_saved = '11/01/2023 03:50 AM';
const dataFechaAcualizado = '10/31/2023' + ' 11:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'58', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'62', Cost:10.64, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'131', Cost:18.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'80', Cost:9.14, ParentId: '17'},
		]
	},
