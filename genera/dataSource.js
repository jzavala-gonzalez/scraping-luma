const timestamp_saved = '10/01/2023 11:10 PM';
const dataFechaAcualizado = '10/1/2023' + ' 7:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'39', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'35', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'50', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:20.55, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:20.55, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'83', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'146', Cost:16.63, ParentId: '16'},
		]
	},
