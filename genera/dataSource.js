const timestamp_saved = '09/17/2023 07:00 AM';
const dataFechaAcualizado = '9/17/2023' + ' 2:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'42', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'42', Cost:11.45, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.06, ParentId: '14'},
