const timestamp_saved = '09/25/2023 04:00 AM';
const dataFechaAcualizado = '9/24/2023' + ' 11:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'51', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'52', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'60', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'0', Cost:17.42, ParentId: '11'},
