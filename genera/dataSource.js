const timestamp_saved = '10/05/2023 01:05 AM';
const dataFechaAcualizado = '10/4/2023' + ' 9:01:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'47', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'47', Cost:10.97, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'24', Cost:31.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:18.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'6', Cost:18.44, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'49', Cost:16.92, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'75', Cost:16.88, ParentId: '15'},
