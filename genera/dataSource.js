const timestamp_saved = '12/01/2023 12:10 AM';
const dataFechaAcualizado = '11/30/2023' + ' 8:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 149, MVar:'60', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'162', Cost:18.29, ParentId: '16'},
		]
	},
