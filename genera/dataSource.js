const timestamp_saved = '11/15/2023 01:50 AM';
const dataFechaAcualizado = '11/14/2023' + ' 9:46:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'53', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'57', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'59', Cost:10.92, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'31', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 15, MVar:'1', Cost:27.23, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 32, MVar:'8', Cost:47.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:47.81, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'22', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'78', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 302,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 302, MVar:'161', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'115', Cost:10.91, ParentId: '17'},
		]
	},
