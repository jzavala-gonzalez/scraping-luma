const timestamp_saved = '09/27/2023 09:10 AM';
const dataFechaAcualizado = '9/27/2023' + ' 5:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'26', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'26', Cost:12.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'58', Cost:12.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.85, ParentId: '11'},
