const timestamp_saved = '08/05/2023 10:35 PM';
const dataFechaAcualizado = '8/5/2023' + ' 6:30:39 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 172},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 510,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'51', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'49', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 162, MVar:'50', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 191,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.14, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 44, MVar:'0', Cost:22.00, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.92, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'6', Cost:22.60, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'19', Cost:28.17, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'19', Cost:28.14, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'103', Cost:11.61, ParentId: '17'},
		]
	},
