const timestamp_saved = '11/07/2023 08:40 AM';
const dataFechaAcualizado = '11/7/2023' + ' 4:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'37', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'36', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'37', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'9', Cost:20.42, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'47', Cost:16.97, ParentId: '15'},
