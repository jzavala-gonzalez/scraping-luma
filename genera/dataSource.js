const timestamp_saved = '11/18/2023 08:40 AM';
const dataFechaAcualizado = '11/18/2023' + ' 4:36:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2533},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'14', Cost:17.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'71', Cost:17.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:17.94, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'6', Cost:29.23, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:28.98, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'11', Cost:28.60, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'18', Cost:19.04, ParentId: '14'},
