const timestamp_saved = '09/23/2023 08:45 PM';
const dataFechaAcualizado = '9/23/2023' + ' 4:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'52', Cost:10.20, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:30.81, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:31.23, ParentId: '10'},
		]
	},
