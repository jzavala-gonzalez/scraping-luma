const timestamp_saved = '08/21/2023 08:55 PM';
const dataFechaAcualizado = '8/21/2023' + ' 4:50:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'39', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'58', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'14', Cost:19.02, ParentId: '14'},
