const timestamp_saved = '11/17/2023 02:10 PM';
const dataFechaAcualizado = '11/17/2023' + ' 10:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'60', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'60', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'48', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'109', Cost:9.38, ParentId: '17'},
		]
	},
