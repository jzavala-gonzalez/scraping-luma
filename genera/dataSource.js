const timestamp_saved = '08/06/2023 07:25 PM';
const dataFechaAcualizado = '8/6/2023' + ' 3:20:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'46', Cost:10.41, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:31.44, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'18', Cost:15.61, ParentId: '15'},
		]
	},
