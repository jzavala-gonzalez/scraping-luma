const timestamp_saved = '10/27/2023 08:55 AM';
const dataFechaAcualizado = '10/27/2023' + ' 4:51:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1804},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'40', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'41', Cost:11.34, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'89', Cost:0, ParentId: '16'},
		]
	},
