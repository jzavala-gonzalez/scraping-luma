const timestamp_saved = '09/28/2023 08:05 PM';
const dataFechaAcualizado = '9/28/2023' + ' 4:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'54', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'54', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 93, MVar:'0', Cost:5.02, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 9,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 9, MVar:'9', Cost:86.08, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.57, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:20.54, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:20.54, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'8', Cost:57.46, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'19', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'101', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 322,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 322, MVar:'152', Cost:17.04, ParentId: '16'},
		]
	},
