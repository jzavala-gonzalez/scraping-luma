const timestamp_saved = '10/14/2023 04:50 AM';
const dataFechaAcualizado = '10/14/2023' + ' 12:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'55', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'61', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'65', Cost:10.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.15, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:20.40, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'160', Cost:19.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'84', Cost:9.15, ParentId: '17'},
		]
	},
