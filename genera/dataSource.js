const timestamp_saved = '09/06/2023 11:00 AM';
const dataFechaAcualizado = '9/6/2023' + ' 6:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'43', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'43', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'54', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'136', Cost:17.54, ParentId: '16'},
		]
	},
