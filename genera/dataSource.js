const timestamp_saved = '08/07/2023 04:35 AM';
const dataFechaAcualizado = '8/7/2023' + ' 12:30:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'49', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'44', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'15', Cost:28.03, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'15', Cost:27.98, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:9.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:9.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'53', Cost:18.37, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'94', Cost:11.65, ParentId: '17'},
		]
	},
