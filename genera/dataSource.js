const timestamp_saved = '10/20/2023 05:25 PM';
const dataFechaAcualizado = '10/20/2023' + ' 1:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'46', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'53', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'51', Cost:10.70, ParentId: '7'},
		]
	},
