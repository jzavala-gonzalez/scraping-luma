const timestamp_saved = '08/08/2023 08:20 PM';
const dataFechaAcualizado = '8/8/2023' + ' 4:15:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'54', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'60', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.30, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.27, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'3', Cost:21.99, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'0', Cost:22.16, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'6', Cost:43.36, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'3', Cost:43.48, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'36', Cost:18.67, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'93', Cost:12.18, ParentId: '17'},
		]
	},
