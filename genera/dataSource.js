const timestamp_saved = '08/19/2023 10:25 AM';
const dataFechaAcualizado = '8/19/2023' + ' 6:22:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'49', Cost:11.21, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 110,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 55, MVar:'2', Cost:31.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 55, MVar:'5', Cost:30.93, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 45,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:26.97, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'66', Cost:17.66, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'64', Cost:9.30, ParentId: '17'},
		]
	},
