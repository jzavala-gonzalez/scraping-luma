const timestamp_saved = '08/30/2023 11:45 AM';
const dataFechaAcualizado = '8/30/2023' + ' 7:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 160, MVar:'83', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'47', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'50', Cost:10.72, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 53, MVar:'33', Cost:21.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'86', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'108', Cost:9.20, ParentId: '17'},
		]
	},
