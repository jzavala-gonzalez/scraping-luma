const timestamp_saved = '10/29/2023 08:45 AM';
const dataFechaAcualizado = '10/29/2023' + ' 4:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'38', Cost:10.75, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'0', Cost:16.30, ParentId: '17'},
		]
	},
