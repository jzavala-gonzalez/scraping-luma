const timestamp_saved = '10/28/2023 10:10 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'38', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'40', Cost:11.07, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 65, MVar:'18', Cost:28.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.97, ParentId: '11'},
