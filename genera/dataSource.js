const timestamp_saved = '08/31/2023 02:50 AM';
const dataFechaAcualizado = '8/30/2023' + ' 10:45:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2946},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'55', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'64', Cost:12.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'72', Cost:12.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 171,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 133, MVar:'18', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 193,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'2', Cost:22.94, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'22', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'22', Cost:28.15, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.15, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.95, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.02, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 95,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'4', Cost:28.98, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'86', Cost:16.74, ParentId: '15'},
