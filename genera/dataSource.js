const timestamp_saved = '10/21/2023 03:30 PM';
const dataFechaAcualizado = '10/21/2023' + ' 11:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'39', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'38', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'142', Cost:17.82, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 12, MVar:'4', Cost:18.32, ParentId: '19'},
