const timestamp_saved = '10/01/2023 09:45 AM';
const dataFechaAcualizado = '10/1/2023' + ' 5:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 129, MVar:'56', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'29', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'27', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:30.38, ParentId: '13'},
