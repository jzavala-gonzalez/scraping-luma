const timestamp_saved = '11/10/2023 06:15 PM';
const dataFechaAcualizado = '11/10/2023' + ' 2:11:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 251,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'99', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'53', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'60', Cost:12.04, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'12', Cost:22.11, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'16', Cost:18.83, ParentId: '14'},
