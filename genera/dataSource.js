const timestamp_saved = '10/01/2023 05:30 AM';
const dataFechaAcualizado = '10/1/2023' + ' 1:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'30', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'29', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'130', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'98', Cost:9.27, ParentId: '17'},
		]
	},
