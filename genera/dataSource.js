const timestamp_saved = '11/06/2023 06:50 PM';
const dataFechaAcualizado = '11/6/2023' + ' 2:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'59', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'58', Cost:10.54, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 29,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 29, MVar:'0', Cost:19.55, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'11', Cost:43.63, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'170', Cost:18.28, ParentId: '16'},
		]
	},
