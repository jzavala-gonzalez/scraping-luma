const timestamp_saved = '08/18/2023 11:00 AM';
const dataFechaAcualizado = '8/18/2023' + ' 6:57:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'40', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'55', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'67', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'66', Cost:9.26, ParentId: '17'},
		]
	},
