const timestamp_saved = '09/07/2023 06:50 AM';
const dataFechaAcualizado = '9/7/2023' + ' 2:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'26', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:7.25, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'3', Cost:19.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'131', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'90', Cost:9.31, ParentId: '17'},
		]
	},
