const timestamp_saved = '08/17/2023 06:30 PM';
const dataFechaAcualizado = '8/17/2023' + ' 2:27:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'55', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'71', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'76', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'12', Cost:31.54, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'14', Cost:31.30, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'8', Cost:29.54, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'169', Cost:17.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'97', Cost:9.22, ParentId: '17'},
		]
	},
