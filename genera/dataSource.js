const timestamp_saved = '11/17/2023 05:45 AM';
const dataFechaAcualizado = '11/17/2023' + ' 1:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'53', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'55', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'44', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:17.46, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'64', Cost:16.86, ParentId: '15'},
