const timestamp_saved = '10/17/2023 06:30 PM';
const dataFechaAcualizado = '10/17/2023' + ' 2:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'69', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'69', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'65', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'15', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'88', Cost:16.82, ParentId: '15'},
