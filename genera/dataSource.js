const timestamp_saved = '11/14/2023 05:45 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'42', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'48', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'53', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:17.32, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'88', Cost:10.91, ParentId: '17'},
		]
	},
