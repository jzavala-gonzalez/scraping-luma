const timestamp_saved = '12/02/2023 02:05 PM';
const dataFechaAcualizado = '12/2/2023' + ' 10:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'42', Cost:13.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'44', Cost:13.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'45', Cost:13.52, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'123', Cost:18.31, ParentId: '16'},
		]
	},
