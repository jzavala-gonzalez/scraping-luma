const timestamp_saved = '11/08/2023 02:50 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'52', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'50', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 22, MVar:'5', Cost:31.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'87', Cost:16.96, ParentId: '15'},
