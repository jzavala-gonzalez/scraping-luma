const timestamp_saved = '11/08/2023 05:50 PM';
const dataFechaAcualizado = '11/8/2023' + ' 1:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'59', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'56', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'57', Cost:10.14, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 45,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:34.07, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.50, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:32.07, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'10', Cost:19.80, ParentId: '14'},
