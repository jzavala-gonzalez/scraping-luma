const timestamp_saved = '08/28/2023 07:35 PM';
const dataFechaAcualizado = '8/28/2023' + ' 3:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'59', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'59', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'64', Cost:10.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 91, MVar:'0', Cost:5.15, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'4', Cost:22.22, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'45', Cost:19.86, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'38', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'100', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'179', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'121', Cost:9.18, ParentId: '17'},
		]
	},
