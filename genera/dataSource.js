const timestamp_saved = '10/13/2023 12:50 PM';
const dataFechaAcualizado = '10/13/2023' + ' 8:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'61', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'66', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'71', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'46', Cost:8.11, ParentId: '11'},
