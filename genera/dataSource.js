const timestamp_saved = '10/29/2023 07:50 AM';
const dataFechaAcualizado = '10/29/2023' + ' 3:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'36', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'61', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.23, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'8', Cost:18.23, ParentId: '11'},
