const timestamp_saved = '09/01/2023 06:55 AM';
const dataFechaAcualizado = '9/1/2023' + ' 2:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'38', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'45', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'57', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'5', Cost:30.81, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:17.02, ParentId: '11'},
		]
	},
