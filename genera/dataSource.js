const timestamp_saved = '09/08/2023 05:00 PM';
const dataFechaAcualizado = '9/8/2023' + ' 12:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'57', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'62', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'58', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'18', Cost:31.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'19', Cost:31.16, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'48', Cost:19.78, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'30', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'95', Cost:16.80, ParentId: '15'},
