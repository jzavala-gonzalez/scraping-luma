const timestamp_saved = '10/15/2023 05:50 PM';
const dataFechaAcualizado = '10/15/2023' + ' 1:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'51', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'49', Cost:10.90, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:18.83, ParentId: '14'},
