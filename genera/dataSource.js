const timestamp_saved = '11/07/2023 09:05 AM';
const dataFechaAcualizado = '11/7/2023' + ' 5:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'38', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'36', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'38', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'121', Cost:18.30, ParentId: '16'},
		]
	},
