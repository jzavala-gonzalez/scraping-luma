const timestamp_saved = '10/20/2023 07:10 PM';
const dataFechaAcualizado = '10/20/2023' + ' 3:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'45', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'52', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'110', Cost:10.53, ParentId: '17'},
		]
	},
