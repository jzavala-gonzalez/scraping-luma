const timestamp_saved = '08/07/2023 08:25 AM';
const dataFechaAcualizado = '8/7/2023' + ' 4:20:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'59', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'88', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'44', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'44', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 106,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'11', Cost:30.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:31.42, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.34, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 201,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'46', Cost:18.47, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 101, MVar:'17', Cost:16.99, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'96', Cost:11.81, ParentId: '17'},
		]
	},
