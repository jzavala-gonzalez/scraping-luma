const timestamp_saved = '12/01/2023 02:50 PM';
const dataFechaAcualizado = '12/1/2023' + ' 10:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'48', Cost:12.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'50', Cost:12.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'53', Cost:12.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'73', Cost:9.51, ParentId: '17'},
		]
	},
