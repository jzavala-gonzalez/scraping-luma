const timestamp_saved = '09/16/2023 10:30 AM';
const dataFechaAcualizado = '9/16/2023' + ' 6:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'40', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'38', Cost:11.10, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'103', Cost:19.40, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'74', Cost:9.47, ParentId: '17'},
		]
	},
