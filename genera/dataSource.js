const timestamp_saved = '12/05/2023 11:00 AM';
const dataFechaAcualizado = '12/5/2023' + ' 6:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'49', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'56', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'17', Cost:18.77, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'34', Cost:19.57, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'125', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'67', Cost:11.15, ParentId: '17'},
		]
	},
