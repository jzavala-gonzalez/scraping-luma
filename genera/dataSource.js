const timestamp_saved = '09/19/2023 07:10 PM';
const dataFechaAcualizado = '9/19/2023' + ' 3:05:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2771},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 164, MVar:'73', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'86', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'59', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'63', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'71', Cost:10.62, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 149, MVar:'60', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:22.74, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 92,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'16', Cost:37.67, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'0', Cost:8.48, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:8.48, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.82, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'5', Cost:29.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'33', Cost:18.86, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'90', Cost:17.63, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 67,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 35, MVar:'5', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 24, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
