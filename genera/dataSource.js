const timestamp_saved = '08/22/2023 10:25 PM';
const dataFechaAcualizado = '8/22/2023' + ' 6:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'43', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.00, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'122', Cost:17.68, ParentId: '16'},
		]
	},
