const timestamp_saved = '10/15/2023 07:00 AM';
const dataFechaAcualizado = '10/15/2023' + ' 2:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'50', Cost:12.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'50', Cost:12.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'53', Cost:12.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:25.64, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'128', Cost:17.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'66', Cost:9.14, ParentId: '17'},
		]
	},
