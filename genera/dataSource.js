const timestamp_saved = '08/02/2023 11:15 AM';
const dataFechaAcualizado = '8/2/2023' + ' 7:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'45', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'47', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'85', Cost:17.07, ParentId: '15'},
