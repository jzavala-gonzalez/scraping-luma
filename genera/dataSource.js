const timestamp_saved = '10/15/2023 06:20 PM';
const dataFechaAcualizado = '10/15/2023' + ' 2:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'52', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'52', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'54', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:26.98, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 205,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'46', Cost:8.19, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'0', Cost:0, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.29, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'94', Cost:16.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'160', Cost:18.14, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 75,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 20, MVar:'14', Cost:19.60, ParentId: '19'},
