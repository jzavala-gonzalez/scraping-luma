const timestamp_saved = '10/31/2023 12:30 AM';
const dataFechaAcualizado = '10/30/2023' + ' 8:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'63', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'66', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'69', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'16', Cost:20.93, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'93', Cost:16.78, ParentId: '15'},
