const timestamp_saved = '11/13/2023 05:15 AM';
const dataFechaAcualizado = '11/13/2023' + ' 1:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 169,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 85, MVar:'46', Cost:21.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 85, MVar:'50', Cost:21.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.87, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 38, MVar:'0', Cost:31.39, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:17.48, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:28.55, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'0', Cost:28.58, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'60', Cost:16.85, ParentId: '15'},
