const timestamp_saved = '08/28/2023 10:05 AM';
const dataFechaAcualizado = '8/28/2023' + ' 6:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'38', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'37', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'89', Cost:12.01, ParentId: '17'},
		]
	},
