const timestamp_saved = '07/25/2023 09:46 AM';
const dataFechaAcualizado = '7/25/2023' + ' 5:40:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'79', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 548,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'63', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 199, MVar:'58', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:26.99, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 69,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'9', Cost:30.82, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'8', Cost:30.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'14', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'59', Cost:15.36, ParentId: '15'},
		]
	},
