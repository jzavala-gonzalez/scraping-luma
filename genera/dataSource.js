const timestamp_saved = '08/03/2023 09:00 AM';
const dataFechaAcualizado = '8/3/2023' + ' 4:55:37 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1286},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'39', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'33', Cost:21.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'6', Cost:21.15, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 136, MVar:'52', Cost:16.84, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'36', Cost:16.91, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'133', Cost:18.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'76', Cost:11.42, ParentId: '17'},
		]
	},
