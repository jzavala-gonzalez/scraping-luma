const timestamp_saved = '10/02/2023 06:30 PM';
const dataFechaAcualizado = '10/2/2023' + ' 2:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'42', Cost:10.16, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'7', Cost:27.16, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 88, MVar:'27', Cost:18.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'8', Cost:18.55, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 133, MVar:'0', Cost:18.04, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'184', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'117', Cost:9.19, ParentId: '17'},
		]
	},
