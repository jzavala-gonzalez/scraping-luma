const timestamp_saved = '10/21/2023 01:55 PM';
const dataFechaAcualizado = '10/21/2023' + ' 9:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'36', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'34', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'37', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'70', Cost:11.07, ParentId: '17'},
		]
	},
