const timestamp_saved = '07/30/2023 11:35 AM';
const dataFechaAcualizado = '7/30/2023' + ' 7:30:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'42', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'38', Cost:11.05, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'13', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:19.77, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'75', Cost:17.71, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'37', Cost:16.33, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'66', Cost:19.70, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 20,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'15', Cost:19.60, ParentId: '19'},
