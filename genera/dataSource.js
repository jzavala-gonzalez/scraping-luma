const timestamp_saved = '08/13/2023 05:15 AM';
const dataFechaAcualizado = '8/13/2023' + ' 1:12:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 239, MVar:'86', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'95', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'40', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'46', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'43', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'15', Cost:31.24, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 39,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 8, MVar:'0', Cost:30.97, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'152', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'121', Cost:12.26, ParentId: '17'},
		]
	},
