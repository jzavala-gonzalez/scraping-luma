const timestamp_saved = '09/28/2023 11:55 AM';
const dataFechaAcualizado = '9/28/2023' + ' 7:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'21', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'20', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'45', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'109', Cost:18.44, ParentId: '16'},
		]
	},
