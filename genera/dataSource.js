const timestamp_saved = '08/20/2023 09:15 PM';
const dataFechaAcualizado = '8/20/2023' + ' 5:12:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'52', Cost:11.29, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'0', Cost:26.67, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:31.13, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'143', Cost:18.23, ParentId: '16'},
		]
	},
