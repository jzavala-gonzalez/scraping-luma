const timestamp_saved = '11/26/2023 02:25 AM';
const dataFechaAcualizado = '11/25/2023' + ' 10:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'30', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'40', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'53', Cost:11.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 32, MVar:'0', Cost:26.20, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.62, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'128', Cost:17.78, ParentId: '16'},
		]
	},
