const timestamp_saved = '09/18/2023 09:10 PM';
const dataFechaAcualizado = '9/18/2023' + ' 5:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'97', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'57', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'56', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'67', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'10', Cost:30.05, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'92', Cost:16.93, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 20,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 7, MVar:'17', Cost:19.60, ParentId: '19'},
