const timestamp_saved = '09/17/2023 10:50 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'39', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'39', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'56', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'0', Cost:8.59, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:8.59, ParentId: '11'},
		]
	},
