const timestamp_saved = '11/22/2023 11:30 AM';
const dataFechaAcualizado = '11/22/2023' + ' 7:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'31', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'42', Cost:10.40, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'83', Cost:9.79, ParentId: '17'},
		]
	},
