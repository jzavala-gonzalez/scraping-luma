const timestamp_saved = '09/27/2023 04:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 12:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'31', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'33', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'63', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 26,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'2', Cost:29.41, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'148', Cost:16.80, ParentId: '16'},
		]
	},
