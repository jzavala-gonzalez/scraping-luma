const timestamp_saved = '08/09/2023 06:30 AM';
const dataFechaAcualizado = '8/9/2023' + ' 2:25:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'46', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'56', Cost:11.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.11, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'24', Cost:19.13, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 326, MVar:'102', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 223,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 223, MVar:'65', Cost:13.38, ParentId: '17'},
		]
	},
