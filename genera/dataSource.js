const timestamp_saved = '11/11/2023 11:40 AM';
const dataFechaAcualizado = '11/11/2023' + ' 7:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:11.03, ParentId: '7'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 22,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 7, MVar:'10', Cost:19.60, ParentId: '19'},
