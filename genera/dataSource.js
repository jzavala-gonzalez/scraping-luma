const timestamp_saved = '11/05/2023 05:25 AM';
const dataFechaAcualizado = '11/5/2023' + ' 1:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 135, MVar:'42', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'61', Cost:9.39, ParentId: '17'},
		]
	},
