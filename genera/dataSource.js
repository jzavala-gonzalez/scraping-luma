const timestamp_saved = '11/01/2023 02:35 AM';
const dataFechaAcualizado = '10/31/2023' + ' 10:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'57', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'62', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'67', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:17.20, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'164', Cost:16.74, ParentId: '16'},
		]
	},
