const timestamp_saved = '11/28/2023 08:15 PM';
const dataFechaAcualizado = '11/28/2023' + ' 4:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'46', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'56', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'64', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.40, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'49', Cost:8.10, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'195', Cost:17.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'122', Cost:9.29, ParentId: '17'},
		]
	},
