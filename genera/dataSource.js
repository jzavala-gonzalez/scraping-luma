const timestamp_saved = '12/03/2023 07:05 PM';
const dataFechaAcualizado = '12/3/2023' + ' 3:01:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 699},
	{Index:'4', Desc:'Reserva Operacional', value: 1336},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'38', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'41', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'45', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:8.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:8.69, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'20', Cost:19.76, ParentId: '14'},
