const timestamp_saved = '11/22/2023 11:20 PM';
const dataFechaAcualizado = '11/22/2023' + ' 7:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'40', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'52', Cost:10.94, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.14, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'114', Cost:9.24, ParentId: '17'},
		]
	},
