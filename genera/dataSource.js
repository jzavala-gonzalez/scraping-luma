const timestamp_saved = '09/17/2023 09:10 PM';
const dataFechaAcualizado = '9/17/2023' + ' 5:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'72', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'47', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'47', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:30.65, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'29', Cost:19.04, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'123', Cost:17.15, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 12,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'1', Cost:19.60, ParentId: '19'},
