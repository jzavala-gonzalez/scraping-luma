const timestamp_saved = '11/22/2023 03:15 PM';
const dataFechaAcualizado = '11/22/2023' + ' 11:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'31', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'54', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'88', Cost:9.77, ParentId: '17'},
		]
	},
