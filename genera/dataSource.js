const timestamp_saved = '07/30/2023 07:00 PM';
const dataFechaAcualizado = '7/30/2023' + ' 2:55:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1180},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'41', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:19.78, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 216,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 216, MVar:'109', Cost:18.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'69', Cost:11.41, ParentId: '17'},
		]
	},
