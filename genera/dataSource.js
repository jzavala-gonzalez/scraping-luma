const timestamp_saved = '08/20/2023 07:35 AM';
const dataFechaAcualizado = '8/20/2023' + ' 3:32:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'51', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'67', Cost:9.18, ParentId: '17'},
		]
	},
