const timestamp_saved = '12/05/2023 08:50 AM';
const dataFechaAcualizado = '12/5/2023' + ' 4:46:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1957},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'39', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'41', Cost:11.32, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'102', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'49', Cost:11.64, ParentId: '17'},
		]
	},
