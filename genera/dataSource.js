const timestamp_saved = '11/11/2023 02:35 PM';
const dataFechaAcualizado = '11/11/2023' + ' 10:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'41', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'43', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'48', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:32.08, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'11', Cost:22.09, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.43, ParentId: '14'},
