const timestamp_saved = '11/25/2023 01:55 PM';
const dataFechaAcualizado = '11/25/2023' + ' 9:51:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1148},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 158,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 158, MVar:'59', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'20', Cost:12.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'31', Cost:12.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'48', Cost:12.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'43', Cost:17.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.64, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'26', Cost:21.40, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 30, MVar:'6', Cost:21.40, ParentId: '11'},
		]
	},
