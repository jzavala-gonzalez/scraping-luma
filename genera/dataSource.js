const timestamp_saved = '11/23/2023 09:55 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'17', Cost:13.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'27', Cost:13.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'45', Cost:13.25, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'67', Cost:9.25, ParentId: '17'},
		]
	},
