const timestamp_saved = '08/16/2023 08:00 AM';
const dataFechaAcualizado = '8/16/2023' + ' 3:57:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'48', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'3', Cost:31.55, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'78', Cost:10.47, ParentId: '17'},
		]
	},
