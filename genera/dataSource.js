const timestamp_saved = '09/24/2023 03:15 PM';
const dataFechaAcualizado = '9/24/2023' + ' 11:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 133, MVar:'55', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'86', Cost:9.54, ParentId: '17'},
		]
	},
