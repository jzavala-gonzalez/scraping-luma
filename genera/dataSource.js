const timestamp_saved = '07/26/2023 01:53 PM';
const dataFechaAcualizado = '7/26/2023' + ' 9:45:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 235, MVar:'72', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'77', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'54', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'53', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'7', Cost:22.53, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.71, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'44', Cost:15.45, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'81', Cost:9.34, ParentId: '17'},
		]
	},
