const timestamp_saved = '12/05/2023 07:55 AM';
const dataFechaAcualizado = '12/5/2023' + ' 3:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'39', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'41', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'50', Cost:11.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'50', Cost:11.61, ParentId: '17'},
		]
	},
