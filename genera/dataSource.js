const timestamp_saved = '07/29/2023 09:00 AM';
const dataFechaAcualizado = '7/29/2023' + ' 4:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 137, MVar:'44', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'25', Cost:15.95, ParentId: '15'},
		]
	},
