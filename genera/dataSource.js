const timestamp_saved = '09/27/2023 03:40 PM';
const dataFechaAcualizado = '9/27/2023' + ' 11:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'33', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'33', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'64', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'14', Cost:18.98, ParentId: '14'},
