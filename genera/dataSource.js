const timestamp_saved = '10/12/2023 01:30 AM';
const dataFechaAcualizado = '10/11/2023' + ' 9:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 523,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'70', Cost:9.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'74', Cost:9.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 185, MVar:'75', Cost:9.94, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:35.24, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:18.03, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:30.87, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'13', Cost:18.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'213', Cost:16.62, ParentId: '16'},
		]
	},
