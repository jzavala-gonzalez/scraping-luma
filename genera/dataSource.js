const timestamp_saved = '08/23/2023 09:10 PM';
const dataFechaAcualizado = '8/23/2023' + ' 5:05:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'58', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'56', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'54', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'3', Cost:22.82, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:30.49, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'92', Cost:9.30, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 31,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 14, MVar:'17', Cost:17, ParentId: '19'},
		]
	},
