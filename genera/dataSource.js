const timestamp_saved = '12/02/2023 01:30 PM';
const dataFechaAcualizado = '12/2/2023' + ' 9:26:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1205},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'44', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'46', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'44', Cost:12.05, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.57, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 201,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'122', Cost:19.57, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 235,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 235, MVar:'64', Cost:10.00, ParentId: '17'},
		]
	},
