const timestamp_saved = '11/30/2023 05:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 1:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'42', Cost:10.67, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:26.37, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'50', Cost:8.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:8.20, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'49', Cost:8.12, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 4,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:24.39, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 198,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 198, MVar:'68', Cost:10.64, ParentId: '17'},
		]
	},
