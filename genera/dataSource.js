const timestamp_saved = '09/22/2023 03:25 AM';
const dataFechaAcualizado = '9/21/2023' + ' 11:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 87, MVar:'33', Cost:13.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'37', Cost:13.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'59', Cost:13.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 170,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'38', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'3', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'3', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'4', Cost:28.49, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'91', Cost:32.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'86', Cost:16.06, ParentId: '17'},
		]
	},
