const timestamp_saved = '11/04/2023 03:05 PM';
const dataFechaAcualizado = '11/4/2023' + ' 11:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'44', Cost:13.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'43', Cost:13.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'43', Cost:13.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'58', Cost:9.83, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'9', Cost:19.60, ParentId: '19'},
