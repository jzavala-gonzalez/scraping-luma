const timestamp_saved = '10/30/2023 11:35 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'65', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'67', Cost:10.37, ParentId: '7'},
