const timestamp_saved = '10/27/2023 12:40 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'51', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'49', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'54', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.72, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'92', Cost:17.77, ParentId: '15'},
