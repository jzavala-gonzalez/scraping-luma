const timestamp_saved = '08/18/2023 07:25 PM';
const dataFechaAcualizado = '8/18/2023' + ' 3:22:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'66', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'73', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 88, MVar:'0', Cost:5.44, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'5', Cost:42.17, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:30.03, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'32', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 111,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 111, MVar:'84', Cost:18.35, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'151', Cost:17.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'87', Cost:9.23, ParentId: '17'},
		]
	},
