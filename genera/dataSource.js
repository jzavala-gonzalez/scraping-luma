const timestamp_saved = '12/06/2023 05:55 AM';
const dataFechaAcualizado = '12/6/2023' + ' 1:50:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 1077},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'42', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'44', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'53', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'55', Cost:14.54, ParentId: '17'},
		]
	},
