const timestamp_saved = '10/13/2023 09:25 AM';
const dataFechaAcualizado = '10/13/2023' + ' 5:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'57', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'61', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'66', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'72', Cost:9.12, ParentId: '17'},
		]
	},
