const timestamp_saved = '09/08/2023 11:50 AM';
const dataFechaAcualizado = '9/8/2023' + ' 7:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'60', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'54', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'51', Cost:10.39, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.61, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'8', Cost:8.64, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'21', Cost:19.27, ParentId: '14'},
