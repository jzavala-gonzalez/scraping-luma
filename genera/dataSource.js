const timestamp_saved = '08/13/2023 03:20 PM';
const dataFechaAcualizado = '8/13/2023' + ' 11:17:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'40', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'39', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 43,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:29.11, ParentId: '9'},
