const timestamp_saved = '08/14/2023 07:25 PM';
const dataFechaAcualizado = '8/14/2023' + ' 3:22:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'46', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'51', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'49', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 146, MVar:'39', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'4', Cost:26.90, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.42, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'4', Cost:27.58, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'16', Cost:31.09, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:31.54, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'160', Cost:16.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'129', Cost:11.83, ParentId: '17'},
		]
	},
