const timestamp_saved = '10/02/2023 05:40 PM';
const dataFechaAcualizado = '10/2/2023' + ' 1:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'42', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'40', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'54', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'176', Cost:17.03, ParentId: '16'},
		]
	},
