const timestamp_saved = '11/06/2023 08:30 AM';
const dataFechaAcualizado = '11/6/2023' + ' 4:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'40', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'40', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:17.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'45', Cost:9.83, ParentId: '17'},
		]
	},
