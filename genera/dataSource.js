const timestamp_saved = '07/29/2023 12:10 PM';
const dataFechaAcualizado = '7/29/2023' + ' 8:05:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'45', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:20.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:20.28, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'89', Cost:17.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'81', Cost:13.64, ParentId: '17'},
		]
	},
