const timestamp_saved = '11/30/2023 09:45 PM';
const dataFechaAcualizado = '11/30/2023' + ' 5:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'56', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'58', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'56', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'159', Cost:17.82, ParentId: '16'},
		]
	},
