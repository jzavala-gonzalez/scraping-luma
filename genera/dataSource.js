const timestamp_saved = '11/11/2023 12:35 AM';
const dataFechaAcualizado = '11/10/2023' + ' 8:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'52', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'54', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'54', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'97', Cost:9.26, ParentId: '17'},
		]
	},
