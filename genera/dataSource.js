const timestamp_saved = '11/23/2023 11:00 AM';
const dataFechaAcualizado = '11/23/2023' + ' 6:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'68', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'20', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'29', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'23', Cost:18.63, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'121', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'59', Cost:10.41, ParentId: '17'},
		]
	},
