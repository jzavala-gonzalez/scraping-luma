const timestamp_saved = '09/20/2023 07:05 AM';
const dataFechaAcualizado = '9/20/2023' + ' 3:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'45', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:10.70, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'7', Cost:8.24, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'43', Cost:17.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'133', Cost:18.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'67', Cost:9.38, ParentId: '17'},
		]
	},
