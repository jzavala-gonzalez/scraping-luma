const timestamp_saved = '07/29/2023 03:40 PM';
const dataFechaAcualizado = '7/29/2023' + ' 11:35:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'51', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'31', Cost:20.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:20.42, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:30.62, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'98', Cost:17.11, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 147, MVar:'28', Cost:15.65, ParentId: '15'},
		]
	},
