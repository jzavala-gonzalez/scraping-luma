const timestamp_saved = '10/21/2023 09:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'30', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'31', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'29', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.57, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'71', Cost:11.02, ParentId: '17'},
		]
	},
