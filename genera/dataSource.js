const timestamp_saved = '07/30/2023 04:10 PM';
const dataFechaAcualizado = '7/30/2023' + ' 12:05:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'40', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'39', Cost:17.01, ParentId: '15'},
		]
	},
