const timestamp_saved = '10/30/2023 11:05 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'62', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'67', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'69', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'36', Cost:19.31, ParentId: '14'},
