const timestamp_saved = '11/29/2023 11:45 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'39', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'43', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.40, ParentId: '11'},
