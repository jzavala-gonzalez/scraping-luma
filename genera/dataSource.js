const timestamp_saved = '08/29/2023 01:25 PM';
const dataFechaAcualizado = '8/29/2023' + ' 9:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'83', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'82', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'63', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'41', Cost:19.16, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'141', Cost:18.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'106', Cost:9.17, ParentId: '17'},
		]
	},
