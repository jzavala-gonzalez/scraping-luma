const timestamp_saved = '08/20/2023 01:50 AM';
const dataFechaAcualizado = '8/19/2023' + ' 9:47:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'63', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'62', Cost:10.66, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'90', Cost:9.20, ParentId: '17'},
		]
	},
