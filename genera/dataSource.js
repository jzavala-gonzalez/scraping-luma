const timestamp_saved = '10/04/2023 09:10 AM';
const dataFechaAcualizado = '10/4/2023' + ' 5:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'36', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'34', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'48', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'95', Cost:9.39, ParentId: '17'},
		]
	},
