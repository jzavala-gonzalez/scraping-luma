const timestamp_saved = '10/16/2023 04:30 PM';
const dataFechaAcualizado = '10/16/2023' + ' 12:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'64', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'64', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'63', Cost:10.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 119, MVar:'37', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'48', Cost:8.17, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:64.32, ParentId: '12'},
