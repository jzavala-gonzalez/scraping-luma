const timestamp_saved = '10/27/2023 07:45 AM';
const dataFechaAcualizado = '10/27/2023' + ' 3:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'41', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'42', Cost:11.54, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'89', Cost:18.22, ParentId: '16'},
		]
	},
