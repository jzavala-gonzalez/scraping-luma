const timestamp_saved = '09/07/2023 08:15 AM';
const dataFechaAcualizado = '9/7/2023' + ' 4:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'51', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'27', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'45', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'90', Cost:9.79, ParentId: '17'},
		]
	},
