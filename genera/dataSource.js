const timestamp_saved = '07/31/2023 08:10 PM';
const dataFechaAcualizado = '7/31/2023' + ' 4:05:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'51', Cost:10.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:19.30, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'28', Cost:31.50, ParentId: '12'},
