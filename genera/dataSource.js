const timestamp_saved = '11/05/2023 06:40 AM';
const dataFechaAcualizado = '11/5/2023' + ' 2:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'46', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'45', Cost:10.57, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.53, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'59', Cost:9.40, ParentId: '17'},
		]
	},
