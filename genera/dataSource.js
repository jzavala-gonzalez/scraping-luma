const timestamp_saved = '11/18/2023 03:35 AM';
const dataFechaAcualizado = '11/17/2023' + ' 11:31:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'72', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'69', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'59', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:28.79, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'72', Cost:17.10, ParentId: '15'},
