const timestamp_saved = '09/29/2023 08:55 AM';
const dataFechaAcualizado = '9/29/2023' + ' 4:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'32', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'28', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'48', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.93, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.93, ParentId: '11'},
