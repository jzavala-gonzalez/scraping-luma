const timestamp_saved = '09/04/2023 10:00 PM';
const dataFechaAcualizado = '9/4/2023' + ' 5:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'42', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'48', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'58', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 138,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'5', Cost:26.90, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:18.97, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'181', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'83', Cost:9.18, ParentId: '17'},
		]
	},
