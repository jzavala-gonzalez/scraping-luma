const timestamp_saved = '11/21/2023 02:00 PM';
const dataFechaAcualizado = '11/21/2023' + ' 9:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'34', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'42', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'56', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'12', Cost:22.70, ParentId: '14'},
