const timestamp_saved = '09/15/2023 04:25 PM';
const dataFechaAcualizado = '9/15/2023' + ' 12:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'52', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'52', Cost:10.74, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'27', Cost:18.94, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'93', Cost:16.48, ParentId: '15'},
