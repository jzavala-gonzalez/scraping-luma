const timestamp_saved = '11/17/2023 11:20 AM';
const dataFechaAcualizado = '11/17/2023' + ' 7:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'57', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'58', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'44', Cost:10.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'43', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'94', Cost:9.84, ParentId: '17'},
		]
	},
