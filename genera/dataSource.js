const timestamp_saved = '08/08/2023 03:35 AM';
const dataFechaAcualizado = '8/7/2023' + ' 11:30:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'64', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'75', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:25.96, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:21.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:21.63, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'87', Cost:11.64, ParentId: '17'},
		]
	},
