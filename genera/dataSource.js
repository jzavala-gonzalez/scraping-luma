const timestamp_saved = '11/11/2023 04:05 AM';
const dataFechaAcualizado = '11/11/2023' + ' 12:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'46', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'48', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'50', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'84', Cost:9.25, ParentId: '17'},
		]
	},
