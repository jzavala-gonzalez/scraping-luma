const timestamp_saved = '09/11/2023 07:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 3:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'62', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'62', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'64', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'9', Cost:31.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 117, MVar:'37', Cost:8.32, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:8.32, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:9.54, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'11', Cost:9.54, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'12', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'74', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'140', Cost:16.63, ParentId: '16'},
		]
	},
