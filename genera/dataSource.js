const timestamp_saved = '10/09/2023 08:35 PM';
const dataFechaAcualizado = '10/9/2023' + ' 4:31:14 PM';
const dataFuelCost = [
...
const dataByFuel = [
	...
	{fuel: 'Diesel', value: 26},
	{fuel: 'LNG', value: 43},
	{fuel: 'Coal', value: 9},
	{fuel: 'Renew', value: 2},
];
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2861},
	{Index:'1', Desc:'PREPA', value: 68},
	{Index:'2', Desc:'COGEN', value: 32},
	{Index:'3', Desc:'Reserva en Rotación', value: 281},
	{Index:'4', Desc:'Reserva Operacional', value: 290},
	{Index:'5', Desc:'Capacidad Disponible', value: 3138},
	{Index:'6', Desc:'Próxima Hora MW', value: 2876},
	{Index:'7', Desc:'Máxima para Hoy', value: 2859},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'97', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'65', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'67', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'58', Cost:10.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 35, MVar:'0', Cost:25.68, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:30.16, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'3', Cost:26.93, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:27.02, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.77, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'4', Cost:26.90, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'25', Cost:43.70, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:16.98, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:16.98, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'48', Cost:16.97, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:16.97, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'12', Cost:28.42, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'10', Cost:28.44, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'20', Cost:19.66, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'94', Cost:16.25, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'191', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'113', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 32,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 6, MVar:'7', Cost:21.43, ParentId: '19'},
			{Index:'2', Unit:'Horizon', MW: 4, MVar:'7', Cost:19.60, ParentId: '19'},
			{Index:'3', Unit:'Coto Laurel', MW: 2, MVar:'0', Cost:19.10, ParentId: '19'},
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'29', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 7, MVar:'6', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.20, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:25.17, ParentId: '21'},
