const timestamp_saved = '09/24/2023 11:30 PM';
const dataFechaAcualizado = '9/24/2023' + ' 7:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'55', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'56', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'61', Cost:10.68, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 154,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 24, MVar:'0', Cost:23.83, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:22.16, ParentId: '9'},
