const timestamp_saved = '12/01/2023 06:35 PM';
const dataFechaAcualizado = '12/1/2023' + ' 2:31:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2229},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'54', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'56', Cost:10.43, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'84', Cost:9.56, ParentId: '17'},
		]
	},
