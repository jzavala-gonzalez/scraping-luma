const timestamp_saved = '11/21/2023 11:45 AM';
const dataFechaAcualizado = '11/21/2023' + ' 7:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'26', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'36', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'52', Cost:11.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'32', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'69', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'79', Cost:9.60, ParentId: '17'},
		]
	},
