const timestamp_saved = '08/10/2023 06:50 PM';
const dataFechaAcualizado = '8/10/2023' + ' 2:45:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'53', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:10.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.08, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'3', Cost:30.74, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:30.71, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'175', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'130', Cost:11.30, ParentId: '17'},
		]
	},
