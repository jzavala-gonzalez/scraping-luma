const timestamp_saved = '11/16/2023 07:35 PM';
const dataFechaAcualizado = '11/16/2023' + ' 3:31:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'61', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'61', Cost:10.90, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'27', Cost:19.51, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'90', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 165,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 165, MVar:'161', Cost:20.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'108', Cost:9.21, ParentId: '17'},
		]
	},
