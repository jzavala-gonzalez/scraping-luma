const timestamp_saved = '11/25/2023 11:30 AM';
const dataFechaAcualizado = '11/25/2023' + ' 7:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 116, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'21', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'30', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:10.82, ParentId: '7'},
		]
	},
