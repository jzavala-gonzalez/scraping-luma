const timestamp_saved = '10/14/2023 05:15 PM';
const dataFechaAcualizado = '10/14/2023' + ' 1:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'51', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'52', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'13', Cost:19.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'83', Cost:9.28, ParentId: '17'},
		]
	},
