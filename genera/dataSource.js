const timestamp_saved = '11/27/2023 09:05 AM';
const dataFechaAcualizado = '11/27/2023' + ' 5:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'18', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'29', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'45', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'60', Cost:9.83, ParentId: '17'},
		]
	},
