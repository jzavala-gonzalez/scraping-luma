const timestamp_saved = '10/16/2023 12:15 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'60', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'58', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'57', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'10', Cost:17.27, ParentId: '11'},
