const timestamp_saved = '10/09/2023 08:40 AM';
const dataFechaAcualizado = '10/9/2023' + ' 4:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'41', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'42', Cost:11.09, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'130', Cost:17.83, ParentId: '16'},
		]
	},
