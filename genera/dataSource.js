const timestamp_saved = '09/08/2023 01:01 AM';
const dataFechaAcualizado = '9/7/2023' + ' 8:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'64', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'52', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'54', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 146,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'2', Cost:21.86, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'27', Cost:31.03, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'27', Cost:30.57, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'19', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'85', Cost:16.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'197', Cost:16.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'113', Cost:9.22, ParentId: '17'},
		]
	},
