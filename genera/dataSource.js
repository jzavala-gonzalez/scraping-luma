const timestamp_saved = '08/03/2023 02:25 PM';
const dataFechaAcualizado = '8/3/2023' + ' 10:20:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 149, MVar:'47', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'103', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'22', Cost:15.61, ParentId: '15'},
		]
	},
