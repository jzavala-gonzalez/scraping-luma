const timestamp_saved = '10/19/2023 06:40 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'27', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'36', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'43', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'154', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'78', Cost:10.87, ParentId: '17'},
		]
	},
