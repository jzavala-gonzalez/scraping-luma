const timestamp_saved = '09/13/2023 04:50 PM';
const dataFechaAcualizado = '9/13/2023' + ' 12:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'54', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'54', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'67', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'101', Cost:9.15, ParentId: '17'},
		]
	},
