const timestamp_saved = '10/24/2023 09:30 AM';
const dataFechaAcualizado = '10/24/2023' + ' 5:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'43', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'44', Cost:10.68, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'64', Cost:11.27, ParentId: '17'},
		]
	},
