const timestamp_saved = '10/18/2023 05:05 AM';
const dataFechaAcualizado = '10/18/2023' + ' 1:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'55', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'55', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'56', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 46,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'17', Cost:30.35, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'39', Cost:17.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:17.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 126, MVar:'37', Cost:9.09, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:9.09, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'68', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'79', Cost:9.55, ParentId: '17'},
		]
	},
