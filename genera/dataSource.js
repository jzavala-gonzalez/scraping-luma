const timestamp_saved = '10/07/2023 11:40 PM';
const dataFechaAcualizado = '10/7/2023' + ' 7:36:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'55', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'56', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'52', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'17', Cost:28.09, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.24, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'100', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'186', Cost:16.59, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'117', Cost:9.18, ParentId: '17'},
		]
	},
