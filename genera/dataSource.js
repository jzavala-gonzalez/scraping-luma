const timestamp_saved = '10/19/2023 11:05 PM';
const dataFechaAcualizado = '10/19/2023' + ' 7:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'43', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'50', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'71', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'24', Cost:31.06, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.07, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'79', Cost:16.91, ParentId: '15'},
