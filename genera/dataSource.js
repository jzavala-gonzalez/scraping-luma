const timestamp_saved = '08/14/2023 07:50 AM';
const dataFechaAcualizado = '8/14/2023' + ' 3:47:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'35', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'41', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'41', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 81,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 12, MVar:'0', Cost:21.52, ParentId: '9'},
