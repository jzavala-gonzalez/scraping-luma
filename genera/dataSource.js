const timestamp_saved = '10/21/2023 04:06 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'37', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'35', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'39', Cost:12.16, ParentId: '7'},
		]
	},
