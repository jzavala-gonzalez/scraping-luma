const timestamp_saved = '11/21/2023 04:00 PM';
const dataFechaAcualizado = '11/21/2023' + ' 11:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'35', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'45', Cost:11.05, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'97', Cost:9.58, ParentId: '17'},
		]
	},
