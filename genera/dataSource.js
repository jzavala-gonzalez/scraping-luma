const timestamp_saved = '10/20/2023 07:10 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'32', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'37', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'39', Cost:12.16, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'78', Cost:10.53, ParentId: '17'},
		]
	},
