const timestamp_saved = '10/21/2023 12:30 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'37', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'35', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'37', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'35', Cost:18.12, ParentId: '11'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 0, MVar:'0', Cost:29, ParentId: '21'},
