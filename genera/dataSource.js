const timestamp_saved = '08/29/2023 11:30 AM';
const dataFechaAcualizado = '8/29/2023' + ' 7:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'76', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'76', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'48', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'48', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'57', Cost:10.63, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 95, MVar:'0', Cost:5.24, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'123', Cost:18.27, ParentId: '16'},
		]
	},
