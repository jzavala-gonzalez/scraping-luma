const timestamp_saved = '09/12/2023 09:50 PM';
const dataFechaAcualizado = '9/12/2023' + ' 5:45:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'56', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'67', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 51, MVar:'0', Cost:14.80, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 149, MVar:'79', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'14', Cost:31.16, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'9', Cost:31.30, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:8.23, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'33', Cost:19.16, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'106', Cost:16.96, ParentId: '15'},
