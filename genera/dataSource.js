const timestamp_saved = '07/26/2023 12:16 AM';
const dataFechaAcualizado = '7/25/2023' + ' 8:10:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'72', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'47', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'59', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'54', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.71, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'63', Cost:15.45, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'84', Cost:9.34, ParentId: '17'},
		]
	},
