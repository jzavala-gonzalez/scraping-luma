const timestamp_saved = '09/29/2023 02:20 PM';
const dataFechaAcualizado = '9/29/2023' + ' 10:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'38', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'36', Cost:10.85, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 139, MVar:'51', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 36,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 36, MVar:'16', Cost:27.31, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'92', Cost:9.42, ParentId: '17'},
		]
	},
