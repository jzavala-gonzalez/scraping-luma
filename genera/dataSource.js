const timestamp_saved = '10/04/2023 03:05 PM';
const dataFechaAcualizado = '10/4/2023' + ' 11:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'40', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'37', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'53', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'20', Cost:28.15, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'0', Cost:17.00, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'164', Cost:17.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'106', Cost:9.39, ParentId: '17'},
		]
	},
