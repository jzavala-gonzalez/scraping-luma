const timestamp_saved = '09/25/2023 05:15 PM';
const dataFechaAcualizado = '9/25/2023' + ' 1:10:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 488},
	{Index:'4', Desc:'Reserva Operacional', value: 911},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'62', Cost:4.33, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 191, MVar:'60', Cost:4.33, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'42', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'43', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'5', Cost:0, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 42, MVar:'7', Cost:31.07, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 128, MVar:'38', Cost:20.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.37, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 128, MVar:'0', Cost:18.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:18.17, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 43,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'4', Cost:32.12, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.11, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 111, MVar:'70', Cost:18.37, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'158', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'82', Cost:10.07, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 36,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:25.70, ParentId: '21'},
