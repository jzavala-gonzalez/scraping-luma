const timestamp_saved = '11/04/2023 06:00 PM';
const dataFechaAcualizado = '11/4/2023' + ' 1:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'48', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'46', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'44', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'61', Cost:9.89, ParentId: '17'},
		]
	},
