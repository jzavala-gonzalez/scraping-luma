const timestamp_saved = '08/02/2023 06:55 PM';
const dataFechaAcualizado = '8/2/2023' + ' 2:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'45', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:22.20, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.43, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:29.04, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 6, MVar:'0', Cost:0, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:42.57, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'18', Cost:29.67, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'33', Cost:18.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 327,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'115', Cost:16.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 161, MVar:'27', Cost:15.57, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 342, MVar:'159', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'100', Cost:10.83, ParentId: '17'},
		]
	},
