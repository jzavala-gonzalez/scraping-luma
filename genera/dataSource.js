const timestamp_saved = '10/23/2023 03:56 PM';
const dataFechaAcualizado = '10/23/2023' + ' 11:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'53', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'54', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'51', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'138', Cost:17.18, ParentId: '16'},
		]
	},
