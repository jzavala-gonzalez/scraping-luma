const timestamp_saved = '08/14/2023 10:10 AM';
const dataFechaAcualizado = '8/14/2023' + ' 6:07:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'37', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'41', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'42', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:32.42, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:30.13, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:29.17, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'151', Cost:16.98, ParentId: '16'},
		]
	},
