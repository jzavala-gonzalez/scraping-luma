const timestamp_saved = '08/19/2023 02:25 PM';
const dataFechaAcualizado = '8/19/2023' + ' 10:22:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'50', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'9', Cost:31.10, ParentId: '10'},
		]
	},
