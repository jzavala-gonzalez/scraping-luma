const timestamp_saved = '12/04/2023 01:40 PM';
const dataFechaAcualizado = '12/4/2023' + ' 9:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'49', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'51', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'54', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'71', Cost:11.44, ParentId: '17'},
		]
	},
