const timestamp_saved = '10/12/2023 04:40 PM';
const dataFechaAcualizado = '10/12/2023' + ' 12:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'65', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'69', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.24, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'183', Cost:17.36, ParentId: '16'},
		]
	},
