const timestamp_saved = '07/28/2023 07:39 AM';
const dataFechaAcualizado = '7/28/2023' + ' 3:30:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'42', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'42', Cost:11.01, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'0', Cost:26.97, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'5', Cost:30.76, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'76', Cost:13.16, ParentId: '17'},
		]
	},
