const timestamp_saved = '10/24/2023 08:35 AM';
const dataFechaAcualizado = '10/24/2023' + ' 4:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'40', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'41', Cost:11.23, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'69', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'60', Cost:11.27, ParentId: '17'},
		]
	},
