const timestamp_saved = '11/21/2023 12:05 PM';
const dataFechaAcualizado = '11/21/2023' + ' 8:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'29', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'38', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'52', Cost:11.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'83', Cost:9.59, ParentId: '17'},
		]
	},
