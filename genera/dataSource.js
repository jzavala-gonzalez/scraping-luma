const timestamp_saved = '09/21/2023 01:35 AM';
const dataFechaAcualizado = '9/20/2023' + ' 9:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:9.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'62', Cost:9.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 207, MVar:'66', Cost:9.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'16', Cost:28.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'17', Cost:28.28, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:29.72, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'15', Cost:26.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'81', Cost:16.46, ParentId: '15'},
