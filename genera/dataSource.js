const timestamp_saved = '08/19/2023 06:35 AM';
const dataFechaAcualizado = '8/19/2023' + ' 2:32:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'59', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'69', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:30.70, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'155', Cost:17.82, ParentId: '16'},
		]
	},
