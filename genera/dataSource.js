const timestamp_saved = '09/15/2023 03:15 AM';
const dataFechaAcualizado = '9/14/2023' + ' 11:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'50', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'51', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'64', Cost:11.56, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 143,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 71, MVar:'0', Cost:6.97, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:31.14, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'2', Cost:31.29, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'24', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'79', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'149', Cost:16.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'106', Cost:9.10, ParentId: '17'},
		]
	},
