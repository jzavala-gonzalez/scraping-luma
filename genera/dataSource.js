const timestamp_saved = '08/03/2023 06:50 PM';
const dataFechaAcualizado = '8/3/2023' + ' 2:45:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3595},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'50', Cost:10.09, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'5', Cost:85.01, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 316,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'100', Cost:16.71, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'20', Cost:15.60, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'94', Cost:11.21, ParentId: '17'},
		]
	},
