const timestamp_saved = '10/03/2023 12:15 AM';
const dataFechaAcualizado = '10/2/2023' + ' 8:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'98', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:9.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'48', Cost:9.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 216, MVar:'59', Cost:9.80, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:26.17, ParentId: '8'},
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:15.97, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:22.19, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:22.00, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'13', Cost:24.30, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'16', Cost:27.51, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 93, MVar:'27', Cost:25.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.88, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:16.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'9', Cost:16.99, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 42, MVar:'9', Cost:28.65, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'5', Cost:29.06, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'10', Cost:18.90, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'98', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'186', Cost:15.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'129', Cost:9.17, ParentId: '17'},
		]
	},
