const timestamp_saved = '11/27/2023 09:30 PM';
const dataFechaAcualizado = '11/27/2023' + ' 5:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'36', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'45', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 43,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'19', Cost:36.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.90, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'34', Cost:19.16, ParentId: '14'},
