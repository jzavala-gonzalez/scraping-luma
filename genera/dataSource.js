const timestamp_saved = '10/16/2023 05:35 AM';
const dataFechaAcualizado = '10/16/2023' + ' 1:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'52', Cost:11.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'50', Cost:11.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:11.98, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 332, MVar:'147', Cost:16.75, ParentId: '16'},
		]
	},
