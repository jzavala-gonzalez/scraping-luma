const timestamp_saved = '10/01/2023 01:15 AM';
const dataFechaAcualizado = '9/30/2023' + ' 9:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'72', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'39', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'37', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 175,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 34, MVar:'0', Cost:19.35, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'89', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'151', Cost:17.13, ParentId: '16'},
		]
	},
