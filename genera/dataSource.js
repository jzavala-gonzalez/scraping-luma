const timestamp_saved = '10/31/2023 07:20 AM';
const dataFechaAcualizado = '10/31/2023' + ' 3:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'52', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'58', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'50', Cost:9.33, ParentId: '17'},
		]
	},
