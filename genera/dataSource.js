const timestamp_saved = '09/13/2023 01:30 AM';
const dataFechaAcualizado = '9/12/2023' + ' 9:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'55', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'54', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'67', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'10', Cost:21.32, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'6', Cost:28.11, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:28.56, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:28.53, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.58, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'185', Cost:16.73, ParentId: '16'},
		]
	},
