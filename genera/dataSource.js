const timestamp_saved = '10/23/2023 08:31 PM';
const dataFechaAcualizado = '10/23/2023' + ' 4:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'55', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'56', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'56', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 65,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 19, MVar:'11', Cost:27.96, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'25', Cost:19.42, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'86', Cost:11.29, ParentId: '17'},
		]
	},
