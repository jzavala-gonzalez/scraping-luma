const timestamp_saved = '12/03/2023 03:40 PM';
const dataFechaAcualizado = '12/3/2023' + ' 11:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 162, MVar:'57', Cost:4.40, ParentId: '6'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:8.84, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'94', Cost:18.22, ParentId: '16'},
		]
	},
