const timestamp_saved = '11/30/2023 09:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 5:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'36', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'41', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'45', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:17.41, ParentId: '11'},
