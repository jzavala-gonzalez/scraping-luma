const timestamp_saved = '10/23/2023 10:30 PM';
const dataFechaAcualizado = '10/23/2023' + ' 6:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'54', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'55', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'56', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 91,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 18, MVar:'0', Cost:22.32, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 170,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:26.85, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.45, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'156', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'90', Cost:11.04, ParentId: '17'},
		]
	},
