const timestamp_saved = '12/03/2023 01:00 AM';
const dataFechaAcualizado = '12/2/2023' + ' 8:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'54', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'57', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 15,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 15, MVar:'0', Cost:26.36, ParentId: '9'},
