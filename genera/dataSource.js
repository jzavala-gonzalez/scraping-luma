const timestamp_saved = '11/14/2023 03:25 PM';
const dataFechaAcualizado = '11/14/2023' + ' 11:21:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2159},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'49', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'53', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'57', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:29.85, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:27.65, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:29.73, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.51, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 29, MVar:'139', Cost:61.52, ParentId: '16'},
		]
	},
