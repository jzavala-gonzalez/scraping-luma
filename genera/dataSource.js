const timestamp_saved = '10/30/2023 11:35 AM';
const dataFechaAcualizado = '10/30/2023' + ' 7:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'48', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'48', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'46', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:18.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:18.57, ParentId: '11'},
