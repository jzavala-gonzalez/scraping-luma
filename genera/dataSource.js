const timestamp_saved = '09/03/2023 07:00 PM';
const dataFechaAcualizado = '9/3/2023' + ' 2:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'36', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'40', Cost:11.14, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'80', Cost:17.00, ParentId: '15'},
