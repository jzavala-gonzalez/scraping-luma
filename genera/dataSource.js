const timestamp_saved = '11/08/2023 12:50 AM';
const dataFechaAcualizado = '11/7/2023' + ' 8:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'56', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'55', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.34, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 104,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'0', Cost:26.39, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'14', Cost:27.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:8.24, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 74,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 44, MVar:'0', Cost:31.27, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 5, MVar:'1', Cost:17.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'73', Cost:16.37, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'170', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'110', Cost:9.17, ParentId: '17'},
		]
	},
