const timestamp_saved = '08/06/2023 11:00 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'38', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'39', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.26, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.34, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 258,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'83', Cost:17.42, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 128, MVar:'18', Cost:16.06, ParentId: '15'},
		]
	},
