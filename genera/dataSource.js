const timestamp_saved = '12/06/2023 12:40 PM';
const dataFechaAcualizado = '12/6/2023' + ' 8:35:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 450},
	{Index:'6', Desc:'Reserva Operacional', value: 842},
	{Index:'7', Desc:'Capacidad Disponible', value: 2983},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'50', Cost:10.88, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'70', Cost:14.30, ParentId: '17'},
		]
	},
