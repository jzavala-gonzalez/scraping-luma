const timestamp_saved = '09/15/2023 07:40 PM';
const dataFechaAcualizado = '9/15/2023' + ' 3:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'55', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'54', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'67', Cost:10.57, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:5.42, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'4', Cost:29.52, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'13', Cost:44.98, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 92, MVar:'0', Cost:10.02, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'45', Cost:19.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'113', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'172', Cost:16.91, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 52,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'21', Cost:19.60, ParentId: '19'},
