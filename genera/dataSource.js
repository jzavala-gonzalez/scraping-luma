const timestamp_saved = '11/05/2023 11:15 PM';
const dataFechaAcualizado = '11/5/2023' + ' 7:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'50', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'152', Cost:17.17, ParentId: '16'},
		]
	},
