const timestamp_saved = '09/23/2023 06:50 AM';
const dataFechaAcualizado = '9/23/2023' + ' 2:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'41', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'41', Cost:11.34, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'53', Cost:16.92, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'75', Cost:9.41, ParentId: '17'},
		]
	},
