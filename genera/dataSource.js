const timestamp_saved = '08/01/2023 05:45 AM';
const dataFechaAcualizado = '8/1/2023' + ' 1:40:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:10.54, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.26, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.35, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'9', Cost:17.35, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'35', Cost:15.45, ParentId: '15'},
		]
	},
