const timestamp_saved = '09/26/2023 08:50 AM';
const dataFechaAcualizado = '9/26/2023' + ' 4:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'45', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'48', Cost:11.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:18.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.03, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'151', Cost:18.18, ParentId: '16'},
		]
	},
