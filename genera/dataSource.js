const timestamp_saved = '08/06/2023 08:35 AM';
const dataFechaAcualizado = '8/6/2023' + ' 4:30:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'39', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'40', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:20.08, ParentId: '11'},
