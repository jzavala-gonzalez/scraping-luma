const timestamp_saved = '09/23/2023 06:45 PM';
const dataFechaAcualizado = '9/23/2023' + ' 2:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'50', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'61', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:31.00, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:20.15, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'16', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'59', Cost:17.61, ParentId: '15'},
