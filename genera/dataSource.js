const timestamp_saved = '11/14/2023 06:00 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'42', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'47', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'52', Cost:12.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'84', Cost:11.12, ParentId: '17'},
		]
	},
