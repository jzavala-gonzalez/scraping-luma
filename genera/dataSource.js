const timestamp_saved = '08/01/2023 11:20 PM';
const dataFechaAcualizado = '8/1/2023' + ' 7:15:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'49', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'48', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'128', Cost:17.18, ParentId: '16'},
		]
	},
