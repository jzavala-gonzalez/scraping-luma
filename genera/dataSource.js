const timestamp_saved = '11/29/2023 09:45 AM';
const dataFechaAcualizado = '11/29/2023' + ' 5:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'26', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'37', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'73', Cost:9.83, ParentId: '17'},
		]
	},
