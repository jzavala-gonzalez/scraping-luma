const timestamp_saved = '11/23/2023 05:40 PM';
const dataFechaAcualizado = '11/23/2023' + ' 1:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 231,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 232, MVar:'81', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'23', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'33', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'8', Cost:19.60, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'146', Cost:18.31, ParentId: '16'},
		]
	},
