const timestamp_saved = '10/29/2023 11:25 AM';
const dataFechaAcualizado = '10/29/2023' + ' 7:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'45', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'68', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'65', Cost:16.84, ParentId: '15'},
