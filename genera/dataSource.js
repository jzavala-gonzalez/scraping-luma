const timestamp_saved = '09/24/2023 07:30 AM';
const dataFechaAcualizado = '9/24/2023' + ' 3:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'42', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'53', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'5', Cost:28.62, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 238,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 238, MVar:'71', Cost:10.09, ParentId: '17'},
		]
	},
