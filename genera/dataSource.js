const timestamp_saved = '11/10/2023 03:10 AM';
const dataFechaAcualizado = '11/9/2023' + ' 11:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'43', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'38', Cost:13.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'43', Cost:13.20, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'26', Cost:21.96, ParentId: '14'},
