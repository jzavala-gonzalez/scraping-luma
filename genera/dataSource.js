const timestamp_saved = '10/14/2023 07:55 PM';
const dataFechaAcualizado = '10/14/2023' + ' 3:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'61', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'64', Cost:10.65, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'85', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'149', Cost:17.53, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 44,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 12, MVar:'25', Cost:19.60, ParentId: '19'},
