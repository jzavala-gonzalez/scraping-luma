const timestamp_saved = '11/09/2023 11:00 AM';
const dataFechaAcualizado = '11/9/2023' + ' 6:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'45', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'46', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.33, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'21', Cost:22.00, ParentId: '14'},
