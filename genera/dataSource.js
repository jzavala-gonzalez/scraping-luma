const timestamp_saved = '08/01/2023 10:35 AM';
const dataFechaAcualizado = '8/1/2023' + ' 6:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'42', Cost:10.99, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:20.37, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'0', Cost:8.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:8.74, ParentId: '11'},
		]
	},
