const timestamp_saved = '10/24/2023 11:20 AM';
const dataFechaAcualizado = '10/24/2023' + ' 7:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:10.94, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'66', Cost:11.02, ParentId: '17'},
		]
	},
