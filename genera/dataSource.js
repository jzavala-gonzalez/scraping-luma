const timestamp_saved = '09/26/2023 03:15 PM';
const dataFechaAcualizado = '9/26/2023' + ' 11:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'46', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'47', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'55', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:17.35, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'84', Cost:9.17, ParentId: '17'},
		]
	},
