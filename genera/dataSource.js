const timestamp_saved = '11/16/2023 05:20 PM';
const dataFechaAcualizado = '11/16/2023' + ' 1:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'52', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'52', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'51', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:17.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.21, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'149', Cost:19.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'87', Cost:9.72, ParentId: '17'},
		]
	},
