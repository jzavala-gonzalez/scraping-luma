const timestamp_saved = '07/27/2023 11:23 PM';
const dataFechaAcualizado = '7/27/2023' + ' 7:15:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'53', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'51', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 320,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'99', Cost:16.90, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'24', Cost:15.43, ParentId: '15'},
		]
	},
