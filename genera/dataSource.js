const timestamp_saved = '08/20/2023 12:50 AM';
const dataFechaAcualizado = '8/19/2023' + ' 8:47:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'62', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'62', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'63', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'103', Cost:16.57, ParentId: '15'},
