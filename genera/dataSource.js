const timestamp_saved = '10/06/2023 05:20 AM';
const dataFechaAcualizado = '10/6/2023' + ' 1:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'30', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'30', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'3', Cost:33.47, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 33, MVar:'0', Cost:27.36, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:27.85, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 70, MVar:'4', Cost:29.32, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'53', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'156', Cost:16.90, ParentId: '16'},
		]
	},
