const timestamp_saved = '08/17/2023 07:45 AM';
const dataFechaAcualizado = '8/17/2023' + ' 3:42:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'61', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'68', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'3', Cost:31.21, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'146', Cost:19.73, ParentId: '16'},
		]
	},
