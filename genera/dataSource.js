const timestamp_saved = '11/15/2023 12:40 AM';
const dataFechaAcualizado = '11/14/2023' + ' 8:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'60', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'64', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'63', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.24, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:28.26, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'173', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'121', Cost:10.93, ParentId: '17'},
		]
	},
