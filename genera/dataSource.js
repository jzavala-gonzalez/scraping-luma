const timestamp_saved = '09/12/2023 08:10 AM';
const dataFechaAcualizado = '9/12/2023' + ' 4:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'46', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'44', Cost:11.05, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'109', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'29', Cost:10.46, ParentId: '17'},
		]
	},
