const timestamp_saved = '10/04/2023 03:45 AM';
const dataFechaAcualizado = '10/3/2023' + ' 11:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'36', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'34', Cost:10.55, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:32.05, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'90', Cost:9.75, ParentId: '17'},
		]
	},
