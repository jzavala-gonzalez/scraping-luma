const timestamp_saved = '09/27/2023 05:15 AM';
const dataFechaAcualizado = '9/27/2023' + ' 1:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'31', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'31', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'64', Cost:11.97, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 92, MVar:'0', Cost:0.37, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.26, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'143', Cost:17.22, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 17,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 1, MVar:'0', Cost:26.01, ParentId: '21'},
