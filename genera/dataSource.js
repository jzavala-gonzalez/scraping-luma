const timestamp_saved = '08/19/2023 08:40 PM';
const dataFechaAcualizado = '8/19/2023' + ' 4:37:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'57', Cost:10.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'160', Cost:16.83, ParentId: '16'},
		]
	},
