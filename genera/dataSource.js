const timestamp_saved = '09/30/2023 06:10 AM';
const dataFechaAcualizado = '9/30/2023' + ' 2:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'35', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'34', Cost:11.11, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 60, MVar:'0', Cost:18.53, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 19, MVar:'0', Cost:18.53, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:29.14, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'102', Cost:9.56, ParentId: '17'},
		]
	},
