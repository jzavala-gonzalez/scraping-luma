const timestamp_saved = '08/13/2023 03:00 AM';
const dataFechaAcualizado = '8/12/2023' + ' 10:57:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'37', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'41', Cost:10.67, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 253,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 253, MVar:'136', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'120', Cost:12.25, ParentId: '17'},
		]
	},
