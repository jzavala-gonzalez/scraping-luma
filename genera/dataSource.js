const timestamp_saved = '11/03/2023 08:10 AM';
const dataFechaAcualizado = '11/3/2023' + ' 4:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'42', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'41', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'41', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'56', Cost:9.43, ParentId: '17'},
		]
	},
