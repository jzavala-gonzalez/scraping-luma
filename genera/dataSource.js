const timestamp_saved = '11/14/2023 06:40 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'41', Cost:12.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'47', Cost:12.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'52', Cost:12.68, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.54, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'80', Cost:11.43, ParentId: '17'},
		]
	},
