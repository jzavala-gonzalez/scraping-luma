const timestamp_saved = '09/24/2023 01:15 PM';
const dataFechaAcualizado = '9/24/2023' + ' 9:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'42', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'44', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'53', Cost:12.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 34,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 267, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.13, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'80', Cost:9.56, ParentId: '17'},
		]
	},
