const timestamp_saved = '09/10/2023 12:20 AM';
const dataFechaAcualizado = '9/9/2023' + ' 8:15:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 211, MVar:'73', Cost:9.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 155,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 156, MVar:'50', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 194,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:23.05, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'19', Cost:19.37, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'83', Cost:16.55, ParentId: '15'},
