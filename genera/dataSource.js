const timestamp_saved = '10/21/2023 10:00 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'32', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'31', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'30', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'72', Cost:11.01, ParentId: '17'},
		]
	},
