const timestamp_saved = '09/15/2023 09:35 AM';
const dataFechaAcualizado = '9/15/2023' + ' 5:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:9.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'48', Cost:9.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'61', Cost:9.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:19.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:19.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 126, MVar:'0', Cost:9.57, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:9.57, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'24', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'128', Cost:17.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'95', Cost:9.30, ParentId: '17'},
		]
	},
