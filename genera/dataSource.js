const timestamp_saved = '08/22/2023 02:30 PM';
const dataFechaAcualizado = '8/22/2023' + ' 10:25:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'49', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'48', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'74', Cost:9.21, ParentId: '17'},
		]
	},
