const timestamp_saved = '09/18/2023 04:25 AM';
const dataFechaAcualizado = '9/18/2023' + ' 12:20:54 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2508},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'76', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'49', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:10.77, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 3, MVar:'0', Cost:26.23, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 135, MVar:'41', Cost:19.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:19.70, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'0', Cost:8.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'8', Cost:8.68, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'20', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'73', Cost:16.91, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'88', Cost:9.14, ParentId: '17'},
		]
	},
