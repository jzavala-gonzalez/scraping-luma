const timestamp_saved = '11/28/2023 06:05 PM';
const dataFechaAcualizado = '11/28/2023' + ' 2:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'40', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'50', Cost:10.34, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'103', Cost:9.80, ParentId: '17'},
		]
	},
