const timestamp_saved = '11/30/2023 07:35 AM';
const dataFechaAcualizado = '11/30/2023' + ' 3:31:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1916},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'35', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'38', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'44', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'60', Cost:9.77, ParentId: '17'},
		]
	},
