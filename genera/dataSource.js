const timestamp_saved = '10/02/2023 02:25 PM';
const dataFechaAcualizado = '10/2/2023' + ' 10:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'42', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'40', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'53', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:18.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'9', Cost:18.35, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.19, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'163', Cost:17.04, ParentId: '16'},
		]
	},
