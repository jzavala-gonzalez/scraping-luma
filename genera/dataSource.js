const timestamp_saved = '08/05/2023 07:00 AM';
const dataFechaAcualizado = '8/5/2023' + ' 2:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'43', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'46', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 164,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'0', Cost:26.74, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:38.44, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'96', Cost:16.77, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'50', Cost:15.44, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'129', Cost:17.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'84', Cost:11.40, ParentId: '17'},
		]
	},
