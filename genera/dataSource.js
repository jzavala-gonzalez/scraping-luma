const timestamp_saved = '09/29/2023 03:05 PM';
const dataFechaAcualizado = '9/29/2023' + ' 11:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'38', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'36', Cost:10.84, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'99', Cost:17.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'92', Cost:9.41, ParentId: '17'},
		]
	},
