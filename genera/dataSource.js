const timestamp_saved = '07/30/2023 05:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 1:20:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'50', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'41', Cost:10.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:52.97, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'76', Cost:16.90, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'39', Cost:15.49, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 34,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 34, MVar:'66', Cost:52.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'75', Cost:11.16, ParentId: '17'},
		]
	},
