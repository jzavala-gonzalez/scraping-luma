const timestamp_saved = '10/28/2023 04:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 12:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'46', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'48', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'13', Cost:34.54, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 51, MVar:'17', Cost:21.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 136, MVar:'83', Cost:17.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'128', Cost:17.24, ParentId: '16'},
		]
	},
