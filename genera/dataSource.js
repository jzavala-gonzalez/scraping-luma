const timestamp_saved = '11/03/2023 01:30 PM';
const dataFechaAcualizado = '11/3/2023' + ' 9:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'54', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'53', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'78', Cost:9.40, ParentId: '17'},
		]
	},
