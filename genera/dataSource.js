const timestamp_saved = '07/30/2023 11:55 PM';
const dataFechaAcualizado = '7/30/2023' + ' 7:50:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'55', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'144', Cost:16.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'90', Cost:10.96, ParentId: '17'},
		]
	},
