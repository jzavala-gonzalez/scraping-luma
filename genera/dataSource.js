const timestamp_saved = '10/29/2023 07:15 PM';
const dataFechaAcualizado = '10/29/2023' + ' 3:11:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2226},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'43', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'45', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'70', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'8', Cost:18.14, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'46', Cost:16.96, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:16.96, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'3', Cost:28.71, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:28.70, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'16', Cost:21.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'85', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'127', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 0, MVar:'17', Cost:41.44, ParentId: '17'},
		]
	},
