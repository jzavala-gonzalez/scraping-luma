const timestamp_saved = '08/22/2023 02:10 PM';
const dataFechaAcualizado = '8/22/2023' + ' 10:05:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'68', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.43, ParentId: '7'},
		]
	},
