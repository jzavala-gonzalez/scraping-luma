const timestamp_saved = '10/19/2023 05:30 PM';
const dataFechaAcualizado = '10/19/2023' + ' 1:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'40', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'47', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'70', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'9', Cost:8.25, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'23', Cost:23.84, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'177', Cost:17.66, ParentId: '16'},
		]
	},
