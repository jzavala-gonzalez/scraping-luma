const timestamp_saved = '10/13/2023 09:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 5:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'61', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'67', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'71', Cost:9.16, ParentId: '17'},
		]
	},
