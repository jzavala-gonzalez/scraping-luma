const timestamp_saved = '08/03/2023 08:30 AM';
const dataFechaAcualizado = '8/3/2023' + ' 4:25:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'40', Cost:10.66, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:21.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'6', Cost:21.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 239,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 134, MVar:'53', Cost:17.36, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'37', Cost:16.86, ParentId: '15'},
		]
	},
