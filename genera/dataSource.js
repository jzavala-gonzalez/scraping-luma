const timestamp_saved = '08/20/2023 01:20 AM';
const dataFechaAcualizado = '8/19/2023' + ' 9:17:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'61', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'61', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'61', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'91', Cost:9.17, ParentId: '17'},
		]
	},
