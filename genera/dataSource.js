const timestamp_saved = '07/29/2023 11:00 AM';
const dataFechaAcualizado = '7/29/2023' + ' 6:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'45', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'45', Cost:10.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 138, MVar:'14', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 56,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 56, MVar:'10', Cost:30.21, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 278,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 139, MVar:'86', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 139, MVar:'28', Cost:15.78, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'79', Cost:13.61, ParentId: '17'},
		]
	},
