const timestamp_saved = '08/24/2023 05:25 AM';
const dataFechaAcualizado = '8/24/2023' + ' 1:20:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'54', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'50', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'19', Cost:19.34, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'85', Cost:17.77, ParentId: '15'},
