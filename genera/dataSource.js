const timestamp_saved = '10/13/2023 05:15 AM';
const dataFechaAcualizado = '10/13/2023' + ' 1:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'59', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'63', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'66', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'182', Cost:17.79, ParentId: '16'},
		]
	},
