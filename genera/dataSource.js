const timestamp_saved = '07/25/2023 06:29 PM';
const dataFechaAcualizado = '7/25/2023' + ' 2:20:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 239, MVar:'88', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'68', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'58', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'54', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'9', Cost:30.90, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:20.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'50', Cost:20.03, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.62, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'46', Cost:15.44, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 228,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 228, MVar:'83', Cost:10.14, ParentId: '17'},
		]
	},
