const timestamp_saved = '10/10/2023 10:10 AM';
const dataFechaAcualizado = '10/10/2023' + ' 6:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'77', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'57', Cost:10.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'8', Cost:8.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 119, MVar:'35', Cost:18.25, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'87', Cost:16.77, ParentId: '15'},
