const timestamp_saved = '09/28/2023 06:00 AM';
const dataFechaAcualizado = '9/28/2023' + ' 1:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'20', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'21', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'45', Cost:11.57, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 79,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:21.52, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'47', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 142,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 142, MVar:'100', Cost:21.52, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'68', Cost:9.75, ParentId: '17'},
		]
	},
