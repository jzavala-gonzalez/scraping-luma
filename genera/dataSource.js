const timestamp_saved = '07/31/2023 03:20 AM';
const dataFechaAcualizado = '7/30/2023' + ' 11:15:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'45', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'52', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 116, MVar:'37', Cost:19.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:19.50, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 149, MVar:'0', Cost:17.27, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:17.27, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'90', Cost:16.60, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'49', Cost:15.46, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'140', Cost:16.73, ParentId: '16'},
		]
	},
