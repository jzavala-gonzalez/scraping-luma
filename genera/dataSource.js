const timestamp_saved = '08/27/2023 11:45 PM';
const dataFechaAcualizado = '8/27/2023' + ' 7:40:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'48', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'47', Cost:10.51, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'22', Cost:19.26, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'180', Cost:16.97, ParentId: '16'},
		]
	},
