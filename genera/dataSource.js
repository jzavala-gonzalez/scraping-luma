const timestamp_saved = '09/30/2023 08:20 PM';
const dataFechaAcualizado = '9/30/2023' + ' 4:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'39', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'38', Cost:10.39, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'140', Cost:17.35, ParentId: '16'},
		]
	},
