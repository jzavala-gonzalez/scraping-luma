const timestamp_saved = '08/31/2023 06:10 AM';
const dataFechaAcualizado = '8/31/2023' + ' 2:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'48', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'85', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'44', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'62', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'10', Cost:30.80, ParentId: '10'},
		]
	},
