const timestamp_saved = '11/25/2023 12:45 PM';
const dataFechaAcualizado = '11/25/2023' + ' 8:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 143,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 143, MVar:'60', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'21', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'30', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'47', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.81, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'30', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.83, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'124', Cost:18.19, ParentId: '16'},
		]
	},
