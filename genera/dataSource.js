const timestamp_saved = '10/25/2023 05:45 AM';
const dataFechaAcualizado = '10/25/2023' + ' 1:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'41', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'44', Cost:11.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 135, MVar:'42', Cost:16.88, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'10', Cost:16.88, ParentId: '11'},
		]
	},
