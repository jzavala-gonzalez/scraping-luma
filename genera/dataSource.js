const timestamp_saved = '08/01/2023 06:05 AM';
const dataFechaAcualizado = '8/1/2023' + ' 2:00:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'43', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:17.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:17.30, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'139', Cost:17.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'89', Cost:10.99, ParentId: '17'},
		]
	},
