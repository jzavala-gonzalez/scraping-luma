const timestamp_saved = '11/03/2023 05:05 AM';
const dataFechaAcualizado = '11/3/2023' + ' 1:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'47', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'47', Cost:11.87, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'132', Cost:18.02, ParentId: '16'},
		]
	},
