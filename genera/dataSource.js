const timestamp_saved = '08/02/2023 05:10 PM';
const dataFechaAcualizado = '8/2/2023' + ' 1:05:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'44', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'49', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'108', Cost:16.90, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'25', Cost:16.33, ParentId: '15'},
		]
	},
