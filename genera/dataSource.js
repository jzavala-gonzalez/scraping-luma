const timestamp_saved = '09/29/2023 10:45 AM';
const dataFechaAcualizado = '9/29/2023' + ' 6:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 114, MVar:'48', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:18.39, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.39, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'0', Cost:17.86, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'0', Cost:17.86, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:19.51, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'66', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'113', Cost:18.11, ParentId: '16'},
		]
	},
