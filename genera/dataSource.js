const timestamp_saved = '10/16/2023 02:45 AM';
const dataFechaAcualizado = '10/15/2023' + ' 10:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'57', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'54', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'58', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.19, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'3', Cost:28.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'2', Cost:28.47, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.32, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'186', Cost:16.67, ParentId: '16'},
		]
	},
