const timestamp_saved = '08/10/2023 08:25 PM';
const dataFechaAcualizado = '8/10/2023' + ' 4:20:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'57', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'57', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 5, MVar:'9', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'0', Cost:28.38, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'7', Cost:28.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'8', Cost:28.16, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:8.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:8.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'185', Cost:17.57, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'130', Cost:11.30, ParentId: '17'},
		]
	},
