const timestamp_saved = '11/21/2023 05:25 PM';
const dataFechaAcualizado = '11/21/2023' + ' 1:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'34', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'45', Cost:11.28, ParentId: '7'},
