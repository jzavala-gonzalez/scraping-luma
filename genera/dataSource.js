const timestamp_saved = '09/27/2023 09:25 PM';
const dataFechaAcualizado = '9/27/2023' + ' 5:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'29', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'29', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'62', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'140', Cost:18.29, ParentId: '16'},
		]
	},
