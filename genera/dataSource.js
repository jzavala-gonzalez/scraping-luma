const timestamp_saved = '11/29/2023 12:25 PM';
const dataFechaAcualizado = '11/29/2023' + ' 8:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:11.30, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'75', Cost:9.52, ParentId: '17'},
		]
	},
