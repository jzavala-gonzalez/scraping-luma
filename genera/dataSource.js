const timestamp_saved = '09/23/2023 11:15 AM';
const dataFechaAcualizado = '9/23/2023' + ' 7:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'38', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'41', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'56', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 386,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 133, MVar:'0', Cost:8.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'0', Cost:8.17, ParentId: '11'},
		]
	},
