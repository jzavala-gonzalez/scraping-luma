const timestamp_saved = '08/15/2023 03:45 AM';
const dataFechaAcualizado = '8/14/2023' + ' 11:42:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'50', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'54', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.92, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'19', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 305,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 305, MVar:'177', Cost:16.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'128', Cost:11.61, ParentId: '17'},
		]
	},
