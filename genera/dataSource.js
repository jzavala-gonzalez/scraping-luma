const timestamp_saved = '11/13/2023 10:20 AM';
const dataFechaAcualizado = '11/13/2023' + ' 6:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'47', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'51', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'52', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'88', Cost:9.78, ParentId: '17'},
		]
	},
