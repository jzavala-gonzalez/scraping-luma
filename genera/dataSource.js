const timestamp_saved = '10/20/2023 01:55 PM';
const dataFechaAcualizado = '10/20/2023' + ' 9:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'52', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'86', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'102', Cost:10.81, ParentId: '17'},
		]
	},
