const timestamp_saved = '09/11/2023 09:05 PM';
const dataFechaAcualizado = '9/11/2023' + ' 5:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'80', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'78', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 209, MVar:'84', Cost:9.76, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:9.22, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 150,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'18', Cost:28.20, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'16', Cost:28.22, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:19.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:19.88, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'0', Cost:8.12, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'12', Cost:8.12, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 37, MVar:'3', Cost:31.11, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'7', Cost:30.51, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 172, MVar:'86', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'167', Cost:16.63, ParentId: '16'},
		]
	},
