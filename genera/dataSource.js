const timestamp_saved = '11/25/2023 02:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:21:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1850},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'21', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'31', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'48', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'28', Cost:20.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'8', Cost:20.68, ParentId: '11'},
		]
	},
