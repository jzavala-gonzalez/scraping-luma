const timestamp_saved = '09/28/2023 05:35 AM';
const dataFechaAcualizado = '9/28/2023' + ' 1:30:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'22', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'22', Cost:12.06, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 78,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.82, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'38', Cost:18.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.00, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 185,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'110', Cost:18.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'71', Cost:9.88, ParentId: '17'},
		]
	},
