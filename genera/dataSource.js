const timestamp_saved = '09/28/2023 07:35 AM';
const dataFechaAcualizado = '9/28/2023' + ' 3:30:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'17', Cost:13.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'18', Cost:13.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'44', Cost:13.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:18.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:18.20, ParentId: '11'},
