const timestamp_saved = '08/19/2023 02:55 AM';
const dataFechaAcualizado = '8/18/2023' + ' 10:52:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'51', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'65', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'74', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:30.84, ParentId: '13'},
