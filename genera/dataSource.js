const timestamp_saved = '08/02/2023 09:00 AM';
const dataFechaAcualizado = '8/2/2023' + ' 4:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'39', Cost:11.26, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'71', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'44', Cost:16.07, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'82', Cost:11.00, ParentId: '17'},
		]
	},
