const timestamp_saved = '11/13/2023 04:10 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 73, MVar:'46', Cost:23.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 83, MVar:'51', Cost:23.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:23.47, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:25.85, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.13, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'8', Cost:27.91, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'65', Cost:17.06, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'100', Cost:9.15, ParentId: '17'},
		]
	},
