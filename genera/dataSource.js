const timestamp_saved = '11/28/2023 12:50 AM';
const dataFechaAcualizado = '11/27/2023' + ' 8:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'41', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'62', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'189', Cost:17.37, ParentId: '16'},
		]
	},
