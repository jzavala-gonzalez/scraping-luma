const timestamp_saved = '08/15/2023 12:30 AM';
const dataFechaAcualizado = '8/14/2023' + ' 8:27:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 550,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:9.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'61', Cost:9.81, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'29', Cost:28.18, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:30.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'11', Cost:29.00, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'149', Cost:11.63, ParentId: '17'},
		]
	},
