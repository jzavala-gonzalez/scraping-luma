const timestamp_saved = '11/28/2023 07:45 PM';
const dataFechaAcualizado = '11/28/2023' + ' 3:41:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2288},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'55', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'64', Cost:10.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 19,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.33, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:17.36, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'8', Cost:33.54, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'186', Cost:18.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'117', Cost:9.41, ParentId: '17'},
		]
	},
