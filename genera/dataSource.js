const timestamp_saved = '11/30/2023 12:00 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 253,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'90', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'56', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'60', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:27.00, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'108', Cost:9.25, ParentId: '17'},
		]
	},
