const timestamp_saved = '07/28/2023 10:42 AM';
const dataFechaAcualizado = '7/28/2023' + ' 6:35:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'40', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'40', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'41', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.94, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 241,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'78', Cost:17.67, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'33', Cost:16.30, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'76', Cost:13.16, ParentId: '17'},
		]
	},
