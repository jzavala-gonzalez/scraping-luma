const timestamp_saved = '08/30/2023 12:35 PM';
const dataFechaAcualizado = '8/30/2023' + ' 8:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'52', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'56', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 173, MVar:'63', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'0', Cost:17.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'10', Cost:17.18, ParentId: '11'},
		]
	},
