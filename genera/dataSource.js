const timestamp_saved = '09/18/2023 09:30 AM';
const dataFechaAcualizado = '9/18/2023' + ' 5:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'42', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'41', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'57', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'68', Cost:9.81, ParentId: '17'},
		]
	},
