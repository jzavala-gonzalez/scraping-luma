const timestamp_saved = '10/28/2023 11:40 PM';
const dataFechaAcualizado = '10/28/2023' + ' 7:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'53', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'54', Cost:11.23, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'6', Cost:18.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'35', Cost:18.65, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:18.65, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.56, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'10', Cost:18.99, ParentId: '14'},
