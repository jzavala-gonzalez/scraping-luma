const timestamp_saved = '10/17/2023 12:15 AM';
const dataFechaAcualizado = '10/16/2023' + ' 8:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'80', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'81', Cost:9.76, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'2', Cost:26.07, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.84, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'10', Cost:27.57, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'6', Cost:22.34, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:16.41, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:16.41, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'48', Cost:8.12, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:29.95, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'16', Cost:18.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'201', Cost:16.66, ParentId: '16'},
		]
	},
