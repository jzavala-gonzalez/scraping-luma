const timestamp_saved = '09/11/2023 10:15 AM';
const dataFechaAcualizado = '9/11/2023' + ' 6:10:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'69', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'67', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'67', Cost:10.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:9.38, ParentId: '8'},
