const timestamp_saved = '10/26/2023 09:40 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'40', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'41', Cost:10.81, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:18.39, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 94, MVar:'60', Cost:18.40, ParentId: '15'},
