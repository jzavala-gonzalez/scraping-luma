const timestamp_saved = '10/02/2023 03:40 AM';
const dataFechaAcualizado = '10/1/2023' + ' 11:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'35', Cost:10.90, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 320, MVar:'136', Cost:16.92, ParentId: '16'},
		]
	},
