const timestamp_saved = '11/25/2023 03:05 PM';
const dataFechaAcualizado = '11/25/2023' + ' 11:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 166, MVar:'60', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'22', Cost:13.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'30', Cost:13.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'47', Cost:13.53, ParentId: '7'},
		]
	},
