const timestamp_saved = '09/16/2023 11:15 AM';
const dataFechaAcualizado = '9/16/2023' + ' 7:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'41', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'39', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'56', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:31.04, ParentId: '10'},
		]
	},
