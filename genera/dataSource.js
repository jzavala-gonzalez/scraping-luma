const timestamp_saved = '11/09/2023 08:00 AM';
const dataFechaAcualizado = '11/9/2023' + ' 3:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'37', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'36', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'42', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'66', Cost:9.81, ParentId: '17'},
		]
	},
