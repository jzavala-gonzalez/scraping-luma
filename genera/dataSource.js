const timestamp_saved = '09/17/2023 10:20 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'64', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'64', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'39', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'37', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'55', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 382,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 130, MVar:'0', Cost:8.58, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:8.58, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'79', Cost:9.19, ParentId: '17'},
		]
	},
