const timestamp_saved = '08/23/2023 02:35 AM';
const dataFechaAcualizado = '8/22/2023' + ' 10:30:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'61', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:26.55, ParentId: '12'},
