const timestamp_saved = '09/23/2023 10:45 AM';
const dataFechaAcualizado = '9/23/2023' + ' 6:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'36', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'39', Cost:13.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'55', Cost:13.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'43', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 144, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'0', Cost:8.17, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 122, MVar:'46', Cost:17.10, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'68', Cost:9.41, ParentId: '17'},
		]
	},
