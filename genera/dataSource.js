const timestamp_saved = '10/13/2023 01:35 AM';
const dataFechaAcualizado = '10/12/2023' + ' 9:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 2,
		units:[
			...
			{Index:'1', Unit:'Hidro 2', MW: 2, MVar:'2', Cost:9.35, ParentId: '0'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 514,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'74', Cost:9.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'79', Cost:9.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 167, MVar:'77', Cost:9.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:16.83, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'9', Cost:29.26, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'89', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'213', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'101', Cost:9.18, ParentId: '17'},
		]
	},
