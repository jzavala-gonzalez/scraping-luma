const timestamp_saved = '11/28/2023 01:25 AM';
const dataFechaAcualizado = '11/27/2023' + ' 9:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'60', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.24, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'186', Cost:17.40, ParentId: '16'},
		]
	},
