const timestamp_saved = '08/05/2023 04:15 AM';
const dataFechaAcualizado = '8/5/2023' + ' 12:10:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'43', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 302,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 72, MVar:'0', Cost:10.93, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 32, MVar:'8', Cost:10.93, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'50', Cost:15.58, ParentId: '15'},
		]
	},
