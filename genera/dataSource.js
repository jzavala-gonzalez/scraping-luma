const timestamp_saved = '09/20/2023 08:40 PM';
const dataFechaAcualizado = '9/20/2023' + ' 4:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'68', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'93', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'51', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'54', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'60', Cost:10.40, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.85, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'35', Cost:26.84, ParentId: '14'},
