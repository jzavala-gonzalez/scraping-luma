const timestamp_saved = '11/29/2023 06:15 AM';
const dataFechaAcualizado = '11/29/2023' + ' 2:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'25', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'33', Cost:11.65, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:17.46, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'70', Cost:9.81, ParentId: '17'},
		]
	},
