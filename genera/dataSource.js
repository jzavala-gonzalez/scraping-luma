const timestamp_saved = '07/28/2023 07:07 AM';
const dataFechaAcualizado = '7/28/2023' + ' 3:00:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'41', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'42', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:31.28, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:20.50, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'13', Cost:19.17, ParentId: '14'},
