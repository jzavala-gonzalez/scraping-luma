const timestamp_saved = '11/17/2023 04:30 PM';
const dataFechaAcualizado = '11/17/2023' + ' 12:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'62', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'63', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'31', Cost:31.08, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.25, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'113', Cost:9.38, ParentId: '17'},
		]
	},
