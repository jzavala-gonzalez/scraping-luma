const timestamp_saved = '09/13/2023 04:20 PM';
const dataFechaAcualizado = '9/13/2023' + ' 12:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'54', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'53', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'67', Cost:11.55, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 51,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 144, MVar:'64', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'13', Cost:28.36, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'102', Cost:9.11, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 90,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'22', Cost:19.60, ParentId: '19'},
