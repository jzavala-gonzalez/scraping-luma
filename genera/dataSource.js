const timestamp_saved = '08/02/2023 08:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 4:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'38', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'44', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'70', Cost:17.38, ParentId: '15'},
