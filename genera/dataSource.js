const timestamp_saved = '11/23/2023 06:40 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:36:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1905},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 242,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'80', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'23', Cost:13.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'32', Cost:13.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'49', Cost:13.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.83, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'54', Cost:9.79, ParentId: '17'},
		]
	},
