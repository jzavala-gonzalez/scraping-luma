const timestamp_saved = '11/25/2023 01:00 PM';
const dataFechaAcualizado = '11/25/2023' + ' 8:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 146,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 146, MVar:'61', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'23', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'31', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'48', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'125', Cost:18.19, ParentId: '16'},
		]
	},
