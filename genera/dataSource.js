const timestamp_saved = '12/02/2023 08:15 AM';
const dataFechaAcualizado = '12/2/2023' + ' 4:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'39', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'41', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'118', Cost:18.21, ParentId: '16'},
		]
	},
