const timestamp_saved = '10/31/2023 09:40 AM';
const dataFechaAcualizado = '10/31/2023' + ' 5:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'56', Cost:10.10, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'70', Cost:16.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'61', Cost:9.65, ParentId: '17'},
		]
	},
