const timestamp_saved = '10/24/2023 10:10 AM';
const dataFechaAcualizado = '10/24/2023' + ' 6:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'48', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'49', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:18.27, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'71', Cost:11.29, ParentId: '17'},
		]
	},
