const timestamp_saved = '10/20/2023 11:15 AM';
const dataFechaAcualizado = '10/20/2023' + ' 7:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'40', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'45', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'43', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'10', Cost:18.98, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'94', Cost:10.55, ParentId: '17'},
		]
	},
