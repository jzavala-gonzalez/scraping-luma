const timestamp_saved = '10/27/2023 04:45 PM';
const dataFechaAcualizado = '10/27/2023' + ' 12:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'54', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'56', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'57', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'90', Cost:16.86, ParentId: '15'},
