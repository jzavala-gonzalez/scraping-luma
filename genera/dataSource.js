const timestamp_saved = '09/25/2023 06:00 PM';
const dataFechaAcualizado = '9/25/2023' + ' 1:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'72', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'47', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'55', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'37', Cost:20.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:20.19, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 324, MVar:'182', Cost:16.87, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'100', Cost:9.40, ParentId: '17'},
		]
	},
