const timestamp_saved = '11/06/2023 01:05 PM';
const dataFechaAcualizado = '11/6/2023' + ' 9:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'50', Cost:10.53, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 64, MVar:'10', Cost:20.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'102', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'68', Cost:9.81, ParentId: '17'},
		]
	},
