const timestamp_saved = '11/17/2023 07:55 AM';
const dataFechaAcualizado = '11/17/2023' + ' 3:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'49', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'49', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'39', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.02, ParentId: '13'},
