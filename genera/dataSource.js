const timestamp_saved = '08/24/2023 11:40 AM';
const dataFechaAcualizado = '8/24/2023' + ' 7:35:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'65', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'81', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'53', Cost:10.98, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'34', Cost:19.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'138', Cost:17.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'86', Cost:9.22, ParentId: '17'},
		]
	},
