const timestamp_saved = '11/07/2023 09:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 5:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'40', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'40', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'38', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.55, ParentId: '13'},
