const timestamp_saved = '08/17/2023 05:00 PM';
const dataFechaAcualizado = '8/17/2023' + ' 12:57:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'64', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'74', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:31.42, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'11', Cost:32.06, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'26', Cost:19.09, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'157', Cost:18.91, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'90', Cost:9.19, ParentId: '17'},
		]
	},
