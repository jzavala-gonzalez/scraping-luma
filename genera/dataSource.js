const timestamp_saved = '10/06/2023 08:25 PM';
const dataFechaAcualizado = '10/6/2023' + ' 4:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'55', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'56', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'56', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:25.72, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'97', Cost:16.65, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'115', Cost:9.23, ParentId: '17'},
		]
	},
