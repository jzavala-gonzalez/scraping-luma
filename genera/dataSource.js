const timestamp_saved = '07/30/2023 03:45 AM';
const dataFechaAcualizado = '7/29/2023' + ' 11:40:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'41', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 199,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'7', Cost:22.42, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'5', Cost:30.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'7', Cost:31.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:20.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'6', Cost:20.97, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'12', Cost:30.93, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'11', Cost:31.05, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'70', Cost:16.64, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'37', Cost:15.49, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'101', Cost:10.96, ParentId: '17'},
		]
	},
