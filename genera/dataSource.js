const timestamp_saved = '11/16/2023 02:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 10:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'56', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'55', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'58', Cost:11.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 2, MVar:'0', Cost:29.04, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'0', Cost:27.98, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.13, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'75', Cost:16.71, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'91', Cost:9.41, ParentId: '17'},
		]
	},
