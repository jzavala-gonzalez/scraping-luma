const timestamp_saved = '07/28/2023 08:31 AM';
const dataFechaAcualizado = '7/28/2023' + ' 4:25:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'42', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'42', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.07, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'30', Cost:15.84, ParentId: '15'},
		]
	},
