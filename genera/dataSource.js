const timestamp_saved = '08/03/2023 11:25 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:20:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'47', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'43', Cost:10.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:19.98, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'80', Cost:17.06, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'87', Cost:11.41, ParentId: '17'},
		]
	},
