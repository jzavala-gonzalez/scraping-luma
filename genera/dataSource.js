const timestamp_saved = '08/23/2023 04:15 AM';
const dataFechaAcualizado = '8/23/2023' + ' 12:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'47', Cost:11.00, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'50', Cost:18.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'68', Cost:9.16, ParentId: '17'},
		]
	},
