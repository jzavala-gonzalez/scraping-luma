const timestamp_saved = '10/05/2023 03:10 AM';
const dataFechaAcualizado = '10/4/2023' + ' 11:06:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'40', Cost:12.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'38', Cost:12.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:12.37, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'150', Cost:16.61, ParentId: '16'},
		]
	},
