const timestamp_saved = '11/24/2023 05:25 PM';
const dataFechaAcualizado = '11/24/2023' + ' 1:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'32', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'42', Cost:10.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 188,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'41', Cost:17.89, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'150', Cost:18.29, ParentId: '16'},
		]
	},
