const timestamp_saved = '10/30/2023 10:50 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'61', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'65', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'68', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'25', Cost:28.22, ParentId: '10'},
