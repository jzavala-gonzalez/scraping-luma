const timestamp_saved = '09/01/2023 06:00 AM';
const dataFechaAcualizado = '9/1/2023' + ' 1:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'38', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'45', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'58', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:30.87, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 132, MVar:'0', Cost:16.89, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'10', Cost:16.89, ParentId: '11'},
		]
	},
