const timestamp_saved = '10/11/2023 03:05 PM';
const dataFechaAcualizado = '10/11/2023' + ' 11:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'59', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'62', Cost:10.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:10.18, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'41', Cost:17.40, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:17.40, ParentId: '11'},
		]
	},
