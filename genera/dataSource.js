const timestamp_saved = '08/01/2023 03:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 11:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'49', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'52', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'36', Cost:15.96, ParentId: '15'},
		]
	},
