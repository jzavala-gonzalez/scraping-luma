const timestamp_saved = '09/28/2023 02:30 AM';
const dataFechaAcualizado = '9/27/2023' + ' 10:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'31', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'31', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:18.16, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:18.16, ParentId: '11'},
		]
	},
