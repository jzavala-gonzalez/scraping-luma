const timestamp_saved = '09/06/2023 07:45 PM';
const dataFechaAcualizado = '9/6/2023' + ' 3:40:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'60', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'40', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'54', Cost:10.35, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:3.01, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 124, MVar:'60', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'9', Cost:7512.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'18', Cost:31.23, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:29.94, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'10', Cost:30.20, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'105', Cost:16.70, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 305,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 305, MVar:'173', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'100', Cost:9.20, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 77,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 21, MVar:'18', Cost:17, ParentId: '19'},
		]
	},
