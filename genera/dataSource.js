const timestamp_saved = '08/15/2023 05:00 AM';
const dataFechaAcualizado = '8/15/2023' + ' 12:57:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'18', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 194,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'175', Cost:19.24, ParentId: '16'},
		]
	},
