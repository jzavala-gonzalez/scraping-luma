const timestamp_saved = '11/26/2023 08:15 AM';
const dataFechaAcualizado = '11/26/2023' + ' 4:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'19', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'29', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'46', Cost:12.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'29', Cost:9.84, ParentId: '17'},
		]
	},
