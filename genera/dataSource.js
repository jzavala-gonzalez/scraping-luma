const timestamp_saved = '10/20/2023 08:00 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'30', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'37', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'40', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'76', Cost:10.53, ParentId: '17'},
		]
	},
