const timestamp_saved = '08/03/2023 11:40 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:35:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'48', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'45', Cost:10.36, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'82', Cost:17.12, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'40', Cost:16.65, ParentId: '15'},
		]
	},
