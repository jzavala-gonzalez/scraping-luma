const timestamp_saved = '09/04/2023 03:40 PM';
const dataFechaAcualizado = '9/4/2023' + ' 11:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'39', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'42', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'13', Cost:26.39, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'67', Cost:9.40, ParentId: '17'},
		]
	},
