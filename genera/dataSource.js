const timestamp_saved = '10/30/2023 01:25 AM';
const dataFechaAcualizado = '10/29/2023' + ' 9:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'51', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'72', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 51, MVar:'15', Cost:21.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'140', Cost:17.09, ParentId: '16'},
		]
	},
