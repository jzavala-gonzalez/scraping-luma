const timestamp_saved = '08/28/2023 08:45 PM';
const dataFechaAcualizado = '8/28/2023' + ' 4:40:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3300},
	{Index:'6', Desc:'Próxima Hora MW', value: 2887},
	{Index:'7', Desc:'Máxima para Hoy', value: 2930},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 160, MVar:'96', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'62', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'62', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'67', Cost:10.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 91, MVar:'0', Cost:5.17, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'37', Cost:31.11, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'7', Cost:0, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:31.14, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'39', Cost:18.83, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'102', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'181', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'126', Cost:9.20, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 7, MVar:'10', Cost:21.43, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 14, MVar:'14', Cost:17, ParentId: '19'},
		]
	},
