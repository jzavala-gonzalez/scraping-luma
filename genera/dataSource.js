const timestamp_saved = '10/29/2023 12:30 PM';
const dataFechaAcualizado = '10/29/2023' + ' 8:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'45', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'45', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'68', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 35,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 22, MVar:'9', Cost:19.60, ParentId: '19'},
