const timestamp_saved = '11/14/2023 07:30 AM';
const dataFechaAcualizado = '11/14/2023' + ' 3:26:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2608},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'46', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'49', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 42,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 42, MVar:'3', Cost:32.49, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'12', Cost:29.46, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'10', Cost:29.48, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'83', Cost:11.58, ParentId: '17'},
		]
	},
