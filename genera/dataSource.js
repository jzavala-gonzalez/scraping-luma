const timestamp_saved = '09/15/2023 02:30 PM';
const dataFechaAcualizado = '9/15/2023' + ' 10:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'52', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'51', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'64', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'25', Cost:18.81, ParentId: '14'},
