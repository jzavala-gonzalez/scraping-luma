const timestamp_saved = '09/22/2023 03:15 PM';
const dataFechaAcualizado = '9/22/2023' + ' 11:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 159, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'43', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'48', Cost:10.13, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.48, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'25', Cost:18.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'70', Cost:16.39, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'108', Cost:32.75, ParentId: '16'},
		]
	},
