const timestamp_saved = '09/07/2023 08:55 AM';
const dataFechaAcualizado = '9/7/2023' + ' 4:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'48', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'37', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'44', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'19', Cost:30.91, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:19.67, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'87', Cost:9.76, ParentId: '17'},
		]
	},
