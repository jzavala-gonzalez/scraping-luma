const timestamp_saved = '10/21/2023 02:25 PM';
const dataFechaAcualizado = '10/21/2023' + ' 10:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'38', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'37', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'38', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'71', Cost:11.06, ParentId: '17'},
		]
	},
