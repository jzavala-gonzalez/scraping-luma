const timestamp_saved = '11/23/2023 07:05 AM';
const dataFechaAcualizado = '11/23/2023' + ' 3:01:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1895},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 104, MVar:'47', Cost:13.51, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'115', Cost:18.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'52', Cost:9.31, ParentId: '17'},
		]
	},
