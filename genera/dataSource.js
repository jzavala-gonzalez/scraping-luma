const timestamp_saved = '08/01/2023 05:50 AM';
const dataFechaAcualizado = '8/1/2023' + ' 1:45:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'46', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.29, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'6', Cost:17.29, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'34', Cost:15.46, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'143', Cost:17.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'92', Cost:10.97, ParentId: '17'},
		]
	},
