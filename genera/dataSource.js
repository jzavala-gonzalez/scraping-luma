const timestamp_saved = '10/24/2023 04:00 AM';
const dataFechaAcualizado = '10/23/2023' + ' 11:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'52', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'53', Cost:10.96, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'145', Cost:17.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'85', Cost:11.02, ParentId: '17'},
		]
	},
