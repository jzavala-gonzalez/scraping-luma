const timestamp_saved = '10/15/2023 06:35 AM';
const dataFechaAcualizado = '10/15/2023' + ' 2:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'51', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'52', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'54', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'68', Cost:9.18, ParentId: '17'},
		]
	},
