const timestamp_saved = '09/29/2023 04:55 PM';
const dataFechaAcualizado = '9/29/2023' + ' 12:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'38', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'36', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'51', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:30.34, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:29.66, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'0', Cost:20.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:20.68, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 105, MVar:'129', Cost:25.92, ParentId: '16'},
		]
	},
