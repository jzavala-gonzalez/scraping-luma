const timestamp_saved = '11/29/2023 05:30 PM';
const dataFechaAcualizado = '11/29/2023' + ' 1:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'49', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'51', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'51', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:17.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.72, ParentId: '11'},
