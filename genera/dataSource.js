const timestamp_saved = '09/04/2023 05:25 AM';
const dataFechaAcualizado = '9/4/2023' + ' 1:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'35', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.95, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:23.82, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'138', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 318, MVar:'63', Cost:9.11, ParentId: '17'},
		]
	},
