const timestamp_saved = '11/24/2023 02:55 PM';
const dataFechaAcualizado = '11/24/2023' + ' 10:51:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1888},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'24', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'36', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'77', Cost:9.62, ParentId: '17'},
		]
	},
