const timestamp_saved = '11/05/2023 04:16 AM';
const dataFechaAcualizado = '11/5/2023' + ' 12:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'51', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'50', Cost:10.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.83, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'68', Cost:9.27, ParentId: '17'},
		]
	},
