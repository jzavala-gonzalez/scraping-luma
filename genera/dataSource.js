const timestamp_saved = '11/30/2023 07:40 PM';
const dataFechaAcualizado = '11/30/2023' + ' 3:36:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2289},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'58', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'56', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'49', Cost:8.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:8.24, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'50', Cost:8.10, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'88', Cost:9.53, ParentId: '17'},
		]
	},
