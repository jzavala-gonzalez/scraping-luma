const timestamp_saved = '08/20/2023 12:10 PM';
const dataFechaAcualizado = '8/20/2023' + ' 8:07:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'50', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'88', Cost:16.55, ParentId: '15'},
