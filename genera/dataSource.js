const timestamp_saved = '09/11/2023 12:20 PM';
const dataFechaAcualizado = '9/11/2023' + ' 8:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'73', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'72', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'70', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'147', Cost:16.74, ParentId: '16'},
		]
	},
