const timestamp_saved = '09/29/2023 11:30 PM';
const dataFechaAcualizado = '9/29/2023' + ' 7:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'51', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'60', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:17.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'7', Cost:17.53, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'11', Cost:29.70, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.37, ParentId: '14'},
