const timestamp_saved = '09/13/2023 01:50 PM';
const dataFechaAcualizado = '9/13/2023' + ' 9:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'52', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'49', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'65', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 150,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'12', Cost:28.22, ParentId: '10'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 79,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 32, MVar:'15', Cost:19.60, ParentId: '19'},
