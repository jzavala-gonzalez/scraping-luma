const timestamp_saved = '11/25/2023 07:30 AM';
const dataFechaAcualizado = '11/25/2023' + ' 3:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 222,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 222, MVar:'58', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'19', Cost:12.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'30', Cost:12.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'46', Cost:12.84, ParentId: '7'},
		]
	},
