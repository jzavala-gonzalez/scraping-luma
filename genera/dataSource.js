const timestamp_saved = '11/13/2023 06:55 PM';
const dataFechaAcualizado = '11/13/2023' + ' 2:51:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2340},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'56', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'60', Cost:10.55, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:8.23, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'12', Cost:22.54, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'114', Cost:9.40, ParentId: '17'},
		]
	},
