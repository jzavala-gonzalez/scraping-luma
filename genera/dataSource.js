const timestamp_saved = '11/28/2023 08:25 AM';
const dataFechaAcualizado = '11/28/2023' + ' 4:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'22', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'33', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'48', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'108', Cost:18.62, ParentId: '16'},
		]
	},
