const timestamp_saved = '11/20/2023 08:45 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'29', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'37', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'53', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.16, ParentId: '11'},
