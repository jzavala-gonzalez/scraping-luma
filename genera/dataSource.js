const timestamp_saved = '11/26/2023 04:45 PM';
const dataFechaAcualizado = '11/26/2023' + ' 12:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'24', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'34', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'7', Cost:8.68, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.06, ParentId: '14'},
