const timestamp_saved = '10/01/2023 02:30 PM';
const dataFechaAcualizado = '10/1/2023' + ' 10:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'27', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'25', Cost:11.47, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'84', Cost:16.83, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'84', Cost:9.49, ParentId: '17'},
		]
	},
