const timestamp_saved = '10/20/2023 05:10 PM';
const dataFechaAcualizado = '10/20/2023' + ' 1:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'47', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'54', Cost:10.55, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'113', Cost:10.55, ParentId: '17'},
		]
	},
