const timestamp_saved = '11/04/2023 08:25 AM';
const dataFechaAcualizado = '11/4/2023' + ' 4:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'39', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:16.96, ParentId: '11'},
