const timestamp_saved = '07/29/2023 10:20 PM';
const dataFechaAcualizado = '7/29/2023' + ' 6:15:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'56', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'51', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'43', Cost:19.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:19.22, ParentId: '11'},
