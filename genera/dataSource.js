const timestamp_saved = '12/05/2023 05:00 AM';
const dataFechaAcualizado = '12/5/2023' + ' 12:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'43', Cost:12.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'44', Cost:12.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'54', Cost:12.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 1,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'3', Cost:32.38, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 163,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 89, MVar:'17', Cost:18.79, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'109', Cost:18.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'66', Cost:10.87, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:21.68, ParentId: '21'},
