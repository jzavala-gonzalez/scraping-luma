const timestamp_saved = '11/30/2023 05:30 AM';
const dataFechaAcualizado = '11/30/2023' + ' 1:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'40', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'45', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'47', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.26, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:342.78, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 222,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 222, MVar:'69', Cost:10.10, ParentId: '17'},
		]
	},
