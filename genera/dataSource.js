const timestamp_saved = '09/19/2023 02:00 AM';
const dataFechaAcualizado = '9/18/2023' + ' 9:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'59', Cost:10.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'59', Cost:10.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'70', Cost:10.00, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'7', Cost:28.66, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'80', Cost:16.66, ParentId: '15'},
