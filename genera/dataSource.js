const timestamp_saved = '09/29/2023 05:05 PM';
const dataFechaAcualizado = '9/29/2023' + ' 1:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'37', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'50', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:22.30, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.62, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'0', Cost:20.69, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:20.69, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'15', Cost:19.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'94', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'132', Cost:22.30, ParentId: '16'},
		]
	},
