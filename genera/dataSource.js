const timestamp_saved = '09/22/2023 10:40 AM';
const dataFechaAcualizado = '9/22/2023' + ' 6:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 136, MVar:'61', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:31.17, ParentId: '10'},
		]
	},
