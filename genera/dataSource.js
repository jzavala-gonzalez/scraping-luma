const timestamp_saved = '12/05/2023 01:30 AM';
const dataFechaAcualizado = '12/4/2023' + ' 9:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'57', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'59', Cost:10.54, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.62, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 78, MVar:'16', Cost:19.24, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'25', Cost:18.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'136', Cost:17.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'91', Cost:10.90, ParentId: '17'},
		]
	},
