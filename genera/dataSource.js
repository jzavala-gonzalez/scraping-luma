const timestamp_saved = '09/16/2023 05:30 PM';
const dataFechaAcualizado = '9/16/2023' + ' 1:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'45', Cost:10.33, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'89', Cost:9.47, ParentId: '17'},
		]
	},
