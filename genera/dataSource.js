const timestamp_saved = '11/17/2023 06:55 AM';
const dataFechaAcualizado = '11/17/2023' + ' 2:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'49', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'49', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'39', Cost:11.61, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:30.75, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'81', Cost:9.83, ParentId: '17'},
		]
	},
