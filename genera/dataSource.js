const timestamp_saved = '08/03/2023 06:35 AM';
const dataFechaAcualizado = '8/3/2023' + ' 2:30:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:10.97, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'51', Cost:17.31, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'35', Cost:16.61, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'134', Cost:18.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'81', Cost:11.20, ParentId: '17'},
		]
	},
