const timestamp_saved = '08/02/2023 10:25 AM';
const dataFechaAcualizado = '8/2/2023' + ' 6:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:10.59, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'82', Cost:17.41, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'38', Cost:15.73, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'93', Cost:11.01, ParentId: '17'},
		]
	},
