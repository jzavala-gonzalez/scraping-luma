const timestamp_saved = '09/09/2023 07:10 AM';
const dataFechaAcualizado = '9/9/2023' + ' 3:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'53', Cost:13.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'59', Cost:13.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'57', Cost:13.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'15', Cost:27.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'12', Cost:28.00, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'3', Cost:28.75, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'147', Cost:16.66, ParentId: '16'},
		]
	},
