const timestamp_saved = '10/10/2023 11:35 AM';
const dataFechaAcualizado = '10/10/2023' + ' 7:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 3,
		units:[
			...
			{Index:'1', Unit:'Hidro 2', MW: 3, MVar:'0', Cost:9.35, ParentId: '0'},
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'76', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'54', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'58', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'12', Cost:17.70, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'92', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'143', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'72', Cost:9.13, ParentId: '17'},
		]
	},
