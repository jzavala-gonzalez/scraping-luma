const timestamp_saved = '10/23/2023 05:05 PM';
const dataFechaAcualizado = '10/23/2023' + ' 1:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'56', Cost:10.35, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.62, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:30.36, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'88', Cost:11.28, ParentId: '17'},
		]
	},
