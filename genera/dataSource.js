const timestamp_saved = '10/13/2023 03:00 PM';
const dataFechaAcualizado = '10/13/2023' + ' 10:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'61', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'65', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'69', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.91, ParentId: '13'},
