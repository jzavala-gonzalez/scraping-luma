const timestamp_saved = '09/17/2023 12:00 PM';
const dataFechaAcualizado = '9/17/2023' + ' 7:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'40', Cost:12.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'40', Cost:12.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'58', Cost:12.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 379,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 131, MVar:'0', Cost:9.94, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:9.94, ParentId: '11'},
		]
	},
