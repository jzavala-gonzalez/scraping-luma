const timestamp_saved = '10/20/2023 09:15 AM';
const dataFechaAcualizado = '10/20/2023' + ' 5:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'32', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'39', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'40', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'85', Cost:10.53, ParentId: '17'},
		]
	},
