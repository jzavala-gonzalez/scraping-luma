const timestamp_saved = '08/19/2023 02:05 PM';
const dataFechaAcualizado = '8/19/2023' + ' 10:02:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'50', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'102', Cost:17.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'139', Cost:17.78, ParentId: '16'},
		]
	},
