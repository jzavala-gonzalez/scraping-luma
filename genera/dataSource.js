const timestamp_saved = '09/29/2023 06:30 PM';
const dataFechaAcualizado = '9/29/2023' + ' 2:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'46', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'44', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'56', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'39', Cost:8.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:8.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:18.04, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'0', Cost:18.04, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'17', Cost:19.10, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'138', Cost:18.28, ParentId: '16'},
		]
	},
