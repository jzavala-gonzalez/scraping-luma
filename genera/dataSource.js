const timestamp_saved = '11/06/2023 04:25 AM';
const dataFechaAcualizado = '11/6/2023' + ' 12:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'46', Cost:12.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'44', Cost:12.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'45', Cost:12.89, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:8.19, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'75', Cost:16.73, ParentId: '15'},
