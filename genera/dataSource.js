const timestamp_saved = '09/14/2023 08:00 PM';
const dataFechaAcualizado = '9/14/2023' + ' 3:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'62', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'62', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'71', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 141,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 155, MVar:'68', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 43,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:33.81, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'105', Cost:17.20, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'181', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 376,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 376, MVar:'126', Cost:9.10, ParentId: '17'},
		]
	},
