const timestamp_saved = '11/02/2023 01:06 PM';
const dataFechaAcualizado = '11/2/2023' + ' 9:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'53', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'51', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'49', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 222,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 222, MVar:'136', Cost:18.42, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 74,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 26, MVar:'14', Cost:19.60, ParentId: '19'},
