const timestamp_saved = '08/15/2023 06:45 PM';
const dataFechaAcualizado = '8/15/2023' + ' 2:42:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'63', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'98', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'56', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'52', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'54', Cost:10.56, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 150,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'47', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.32, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'30', Cost:18.71, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'129', Cost:10.57, ParentId: '17'},
		]
	},
