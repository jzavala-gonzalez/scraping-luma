const timestamp_saved = '08/17/2023 03:50 PM';
const dataFechaAcualizado = '8/17/2023' + ' 11:47:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'67', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'76', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'35', Cost:19.02, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'94', Cost:9.27, ParentId: '17'},
		]
	},
