const timestamp_saved = '09/14/2023 05:35 PM';
const dataFechaAcualizado = '9/14/2023' + ' 1:30:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'57', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'55', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'68', Cost:10.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 103,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 68, MVar:'0', Cost:6.93, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'64', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'31', Cost:19.04, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'115', Cost:9.23, ParentId: '17'},
		]
	},
