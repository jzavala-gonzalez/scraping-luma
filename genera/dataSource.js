const timestamp_saved = '08/27/2023 09:40 PM';
const dataFechaAcualizado = '8/27/2023' + ' 5:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'39', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'39', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'45', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'0', Cost:27.57, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'2', Cost:23.78, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'11', Cost:43.82, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 54, MVar:'12', Cost:30.59, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:19.82, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'84', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'159', Cost:18.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'101', Cost:11.63, ParentId: '17'},
		]
	},
