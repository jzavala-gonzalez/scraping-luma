const timestamp_saved = '11/07/2023 06:40 PM';
const dataFechaAcualizado = '11/7/2023' + ' 2:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'53', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'50', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.34, ParentId: '7'},
		]
	},
