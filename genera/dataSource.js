const timestamp_saved = '09/15/2023 09:40 AM';
const dataFechaAcualizado = '9/15/2023' + ' 5:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'50', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'48', Cost:10.15, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 141, MVar:'0', Cost:8.84, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:8.84, ParentId: '11'},
		]
	},
