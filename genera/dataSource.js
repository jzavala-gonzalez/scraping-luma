const timestamp_saved = '08/15/2023 04:35 PM';
const dataFechaAcualizado = '8/15/2023' + ' 12:32:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'49', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'7', Cost:26.71, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 62,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 62, MVar:'32', Cost:20.07, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'188', Cost:17.19, ParentId: '16'},
		]
	},
