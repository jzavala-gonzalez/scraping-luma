const timestamp_saved = '12/02/2023 12:15 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'56', Cost:13.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'57', Cost:13.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'59', Cost:13.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 62,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 23, MVar:'0', Cost:29.55, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'17', Cost:30.86, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'164', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'97', Cost:9.16, ParentId: '17'},
		]
	},
