const timestamp_saved = '10/11/2023 08:05 AM';
const dataFechaAcualizado = '10/11/2023' + ' 4:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'44', Cost:13.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'47', Cost:13.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'56', Cost:13.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:17.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:17.83, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'56', Cost:9.12, ParentId: '17'},
		]
	},
