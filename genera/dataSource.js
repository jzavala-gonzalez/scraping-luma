const timestamp_saved = '10/02/2023 06:15 PM';
const dataFechaAcualizado = '10/2/2023' + ' 2:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'43', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'41', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'54', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'12', Cost:30.69, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 113, MVar:'36', Cost:17.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:17.45, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'91', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'179', Cost:17.01, ParentId: '16'},
		]
	},
