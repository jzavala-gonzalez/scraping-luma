const timestamp_saved = '10/27/2023 05:20 AM';
const dataFechaAcualizado = '10/27/2023' + ' 1:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'45', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'46', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'48', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 184,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'110', Cost:18.05, ParentId: '16'},
		]
	},
