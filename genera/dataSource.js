const timestamp_saved = '07/27/2023 05:33 PM';
const dataFechaAcualizado = '7/27/2023' + ' 1:25:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'58', Cost:10.44, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'43', Cost:19.88, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'89', Cost:13.18, ParentId: '17'},
		]
	},
