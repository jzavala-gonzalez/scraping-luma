const timestamp_saved = '10/06/2023 10:55 PM';
const dataFechaAcualizado = '10/6/2023' + ' 6:51:14 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 72},
	{Index:'5', Desc:'Capacidad Disponible', value: 2858},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'58', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'58', Cost:9.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 55, MVar:'0', Cost:17.64, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:16.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:16.85, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:28.62, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'12', Cost:19.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'216', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'123', Cost:9.28, ParentId: '17'},
		]
	},
