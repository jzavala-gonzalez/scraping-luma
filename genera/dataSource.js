const timestamp_saved = '10/22/2023 01:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 9:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'52', Cost:10.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:16.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 48,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 48, MVar:'7', Cost:22.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'56', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'161', Cost:16.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'74', Cost:11.13, ParentId: '17'},
		]
	},
