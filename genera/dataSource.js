const timestamp_saved = '11/27/2023 10:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 6:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'53', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'63', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:31.35, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'196', Cost:17.15, ParentId: '16'},
		]
	},
