const timestamp_saved = '10/18/2023 09:10 PM';
const dataFechaAcualizado = '10/18/2023' + ' 5:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'49', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'52', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'65', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 17, MVar:'8', Cost:72.14, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'28', Cost:28.81, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.64, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'193', Cost:16.61, ParentId: '16'},
		]
	},
