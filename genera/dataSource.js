const timestamp_saved = '09/29/2023 05:35 AM';
const dataFechaAcualizado = '9/29/2023' + ' 1:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'38', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'35', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'51', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 1,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 1, MVar:'1', Cost:25.81, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'56', Cost:16.92, ParentId: '15'},
