const timestamp_saved = '09/19/2023 09:00 AM';
const dataFechaAcualizado = '9/19/2023' + ' 4:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'44', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'44', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'81', Cost:9.12, ParentId: '17'},
		]
	},
