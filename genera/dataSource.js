const timestamp_saved = '08/16/2023 04:30 PM';
const dataFechaAcualizado = '8/16/2023' + ' 12:27:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'55', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:11.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 92, MVar:'0', Cost:3.02, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'13', Cost:31.31, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'30', Cost:18.65, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'188', Cost:17.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'94', Cost:10.24, ParentId: '17'},
		]
	},
