const timestamp_saved = '09/18/2023 05:20 AM';
const dataFechaAcualizado = '9/18/2023' + ' 1:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'46', Cost:10.82, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'38', Cost:20.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:20.82, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:8.43, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'9', Cost:8.43, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'23', Cost:18.80, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 285, MVar:'146', Cost:17.17, ParentId: '16'},
		]
	},
