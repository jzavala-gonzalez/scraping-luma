const timestamp_saved = '10/02/2023 01:50 AM';
const dataFechaAcualizado = '10/1/2023' + ' 9:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'37', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'34', Cost:11.03, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'81', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'144', Cost:16.75, ParentId: '16'},
		]
	},
