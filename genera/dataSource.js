const timestamp_saved = '10/20/2023 01:55 AM';
const dataFechaAcualizado = '10/19/2023' + ' 9:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'70', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'189', Cost:16.81, ParentId: '16'},
		]
	},
