const timestamp_saved = '11/10/2023 05:00 PM';
const dataFechaAcualizado = '11/10/2023' + ' 12:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'57', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'62', Cost:10.56, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 35, MVar:'16', Cost:24.00, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'82', Cost:9.50, ParentId: '17'},
		]
	},
