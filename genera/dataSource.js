const timestamp_saved = '09/13/2023 10:45 AM';
const dataFechaAcualizado = '9/13/2023' + ' 6:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'48', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'62', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'91', Cost:9.10, ParentId: '17'},
		]
	},
