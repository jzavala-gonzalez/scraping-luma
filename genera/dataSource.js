const timestamp_saved = '09/05/2023 04:40 PM';
const dataFechaAcualizado = '9/5/2023' + ' 12:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 155, MVar:'60', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'88', Cost:9.29, ParentId: '17'},
		]
	},
