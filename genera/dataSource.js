const timestamp_saved = '09/26/2023 06:40 PM';
const dataFechaAcualizado = '9/26/2023' + ' 2:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'52', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'58', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.43, ParentId: '11'},
