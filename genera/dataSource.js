const timestamp_saved = '10/21/2023 05:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'26', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'22', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'135', Cost:17.31, ParentId: '16'},
		]
	},
