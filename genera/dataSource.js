const timestamp_saved = '10/28/2023 05:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 1:16:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1951},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'39', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'41', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'44', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 126,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'2', Cost:22.31, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 40, MVar:'13', Cost:36.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:36.49, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:30.19, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.74, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'18', Cost:18.98, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'112', Cost:17.76, ParentId: '16'},
		]
	},
