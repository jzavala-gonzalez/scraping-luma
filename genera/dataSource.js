const timestamp_saved = '08/27/2023 08:30 PM';
const dataFechaAcualizado = '8/27/2023' + ' 4:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'39', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'38', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'3', Cost:22.01, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'1', Cost:23.10, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'42', Cost:20.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 107,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 107, MVar:'78', Cost:18.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'149', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'94', Cost:11.71, ParentId: '17'},
		]
	},
