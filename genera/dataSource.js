const timestamp_saved = '09/18/2023 01:55 AM';
const dataFechaAcualizado = '9/17/2023' + ' 9:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'84', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'51', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'50', Cost:10.68, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'22', Cost:19.02, ParentId: '14'},
