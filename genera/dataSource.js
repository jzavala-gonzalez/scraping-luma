const timestamp_saved = '11/26/2023 05:35 PM';
const dataFechaAcualizado = '11/26/2023' + ' 1:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'22', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'34', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'48', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'70', Cost:10.01, ParentId: '17'},
		]
	},
