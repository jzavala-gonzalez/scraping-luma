const timestamp_saved = '08/05/2023 07:15 AM';
const dataFechaAcualizado = '8/5/2023' + ' 3:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'42', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'45', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 176,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'0', Cost:21.77, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 299,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'99', Cost:17.00, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'51', Cost:15.64, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'133', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'88', Cost:11.32, ParentId: '17'},
		]
	},
