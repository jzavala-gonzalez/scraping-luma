const timestamp_saved = '11/08/2023 05:40 AM';
const dataFechaAcualizado = '11/8/2023' + ' 1:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'40', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'39', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'44', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'70', Cost:9.84, ParentId: '17'},
		]
	},
