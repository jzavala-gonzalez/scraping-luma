const timestamp_saved = '10/15/2023 01:15 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'65', Cost:9.54, ParentId: '17'},
		]
	},
