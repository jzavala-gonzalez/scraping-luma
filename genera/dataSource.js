const timestamp_saved = '07/27/2023 12:46 PM';
const dataFechaAcualizado = '7/27/2023' + ' 8:40:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'76', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'61', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'57', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:8.79, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.15, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'26', Cost:18.68, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'99', Cost:13.17, ParentId: '17'},
		]
	},
