const timestamp_saved = '07/24/2023 10:36 PM';
const dataFechaAcualizado = '7/24/2023' + ' 10:30:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 228, MVar:'61', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 213, MVar:'75', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'64', Cost:9.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'66', Cost:9.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'60', Cost:9.67, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 201,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'9', Cost:22.28, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'12', Cost:28.17, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:27.36, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'58', Cost:15.44, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'144', Cost:17.50, ParentId: '16'},
		]
	},
