const timestamp_saved = '09/28/2023 03:35 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'26', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'26', Cost:13.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'58', Cost:13.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'42', Cost:17.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.24, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'0', Cost:18.24, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'142', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'94', Cost:9.11, ParentId: '17'},
		]
	},
