const timestamp_saved = '11/02/2023 02:15 PM';
const dataFechaAcualizado = '11/2/2023' + ' 10:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'55', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'53', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'132', Cost:18.21, ParentId: '16'},
		]
	},
