const timestamp_saved = '10/28/2023 07:40 AM';
const dataFechaAcualizado = '10/28/2023' + ' 3:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'38', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'39', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'20', Cost:28.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.22, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 10, MVar:'1', Cost:0, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'0', Cost:0, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'5', Cost:30.84, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:31.57, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'18', Cost:19.05, ParentId: '14'},
