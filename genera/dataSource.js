const timestamp_saved = '10/24/2023 08:00 PM';
const dataFechaAcualizado = '10/24/2023' + ' 3:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'56', Cost:10.41, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 352,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 352, MVar:'156', Cost:16.84, ParentId: '16'},
		]
	},
