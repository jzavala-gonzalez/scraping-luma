const timestamp_saved = '10/21/2023 05:05 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'24', Cost:12.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'22', Cost:12.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'61', Cost:12.49, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'143', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'77', Cost:11.05, ParentId: '17'},
		]
	},
