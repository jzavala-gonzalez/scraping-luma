const timestamp_saved = '09/01/2023 02:40 PM';
const dataFechaAcualizado = '9/1/2023' + ' 10:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'46', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'53', Cost:10.35, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'77', Cost:16.63, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'84', Cost:9.40, ParentId: '17'},
		]
	},
