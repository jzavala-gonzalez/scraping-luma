const timestamp_saved = '10/11/2023 05:10 AM';
const dataFechaAcualizado = '10/11/2023' + ' 1:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'54', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'59', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'41', Cost:17.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.73, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 21,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'1', Cost:31.28, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'155', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 221,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 221, MVar:'63', Cost:10.20, ParentId: '17'},
		]
	},
