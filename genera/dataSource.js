const timestamp_saved = '11/21/2023 10:25 AM';
const dataFechaAcualizado = '11/21/2023' + ' 6:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'27', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'38', Cost:10.91, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'62', Cost:18.31, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'78', Cost:9.61, ParentId: '17'},
		]
	},
