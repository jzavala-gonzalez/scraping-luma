const timestamp_saved = '10/24/2023 02:40 AM';
const dataFechaAcualizado = '10/23/2023' + ' 10:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'51', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'54', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'54', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:19.93, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:17.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.65, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'160', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'87', Cost:11.02, ParentId: '17'},
		]
	},
