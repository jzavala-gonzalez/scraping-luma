const timestamp_saved = '11/20/2023 08:40 PM';
const dataFechaAcualizado = '11/20/2023' + ' 4:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'77', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'35', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'44', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'57', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'167', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'99', Cost:9.37, ParentId: '17'},
		]
	},
