const timestamp_saved = '11/30/2023 07:20 PM';
const dataFechaAcualizado = '11/30/2023' + ' 3:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'55', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'57', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'83', Cost:9.56, ParentId: '17'},
		]
	},
