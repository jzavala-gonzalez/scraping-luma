const timestamp_saved = '12/04/2023 03:20 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:16:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1137},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'53', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'55', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'56', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'77', Cost:11.47, ParentId: '17'},
		]
	},
