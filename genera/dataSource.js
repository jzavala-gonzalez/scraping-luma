const timestamp_saved = '08/03/2023 01:55 AM';
const dataFechaAcualizado = '8/2/2023' + ' 9:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'40', Cost:11.37, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 73,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'8', Cost:28.02, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'2', Cost:28.61, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'14', Cost:15.81, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'138', Cost:17.19, ParentId: '16'},
		]
	},
