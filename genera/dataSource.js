const timestamp_saved = '12/06/2023 05:05 AM';
const dataFechaAcualizado = '12/6/2023' + ' 1:00:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 427},
	{Index:'6', Desc:'Reserva Operacional', value: 1023},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 136, MVar:'54', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'60', Cost:14.50, ParentId: '17'},
		]
	},
