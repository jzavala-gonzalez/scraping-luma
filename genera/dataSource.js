const timestamp_saved = '08/02/2023 06:50 AM';
const dataFechaAcualizado = '8/2/2023' + ' 2:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'39', Cost:10.81, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'40', Cost:16.06, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'82', Cost:10.97, ParentId: '17'},
		]
	},
