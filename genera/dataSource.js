const timestamp_saved = '08/22/2023 08:40 PM';
const dataFechaAcualizado = '8/22/2023' + ' 4:35:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'60', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.57, ParentId: '7'},
		]
	},
