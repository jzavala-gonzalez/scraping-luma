const timestamp_saved = '11/30/2023 03:20 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'49', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'52', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'52', Cost:12.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'72', Cost:9.76, ParentId: '17'},
		]
	},
