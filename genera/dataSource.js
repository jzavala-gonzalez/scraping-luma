const timestamp_saved = '12/04/2023 12:50 PM';
const dataFechaAcualizado = '12/4/2023' + ' 8:46:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2081},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 138, MVar:'53', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'68', Cost:11.43, ParentId: '17'},
		]
	},
