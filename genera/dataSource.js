const timestamp_saved = '09/30/2023 06:50 AM';
const dataFechaAcualizado = '9/30/2023' + ' 2:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'38', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'51', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'104', Cost:9.55, ParentId: '17'},
		]
	},
