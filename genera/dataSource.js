const timestamp_saved = '08/14/2023 08:25 PM';
const dataFechaAcualizado = '8/14/2023' + ' 4:22:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'53', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'48', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 17, MVar:'0', Cost:66.42, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'3', Cost:27.23, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'2', Cost:23.89, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'17', Cost:31.26, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:20.04, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'29', Cost:19.28, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'168', Cost:16.76, ParentId: '16'},
		]
	},
