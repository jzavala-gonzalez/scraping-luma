const timestamp_saved = '10/12/2023 03:45 AM';
const dataFechaAcualizado = '10/11/2023' + ' 11:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'55', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'60', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'66', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:33.68, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:27.22, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:22.14, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.31, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.01, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'3', Cost:29.37, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'179', Cost:16.58, ParentId: '16'},
		]
	},
