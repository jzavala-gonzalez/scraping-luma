const timestamp_saved = '10/27/2023 07:20 PM';
const dataFechaAcualizado = '10/27/2023' + ' 3:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'53', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'54', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'29', Cost:20.76, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'6', Cost:20.76, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'4', Cost:28.63, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'111', Cost:17.13, ParentId: '16'},
		]
	},
