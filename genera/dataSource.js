const timestamp_saved = '07/29/2023 07:20 AM';
const dataFechaAcualizado = '7/29/2023' + ' 3:15:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'78', Cost:13.63, ParentId: '17'},
		]
	},
