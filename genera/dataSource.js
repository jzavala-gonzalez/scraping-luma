const timestamp_saved = '11/24/2023 06:10 PM';
const dataFechaAcualizado = '11/24/2023' + ' 2:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'30', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'42', Cost:10.74, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'27', Cost:19.12, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'148', Cost:18.31, ParentId: '16'},
		]
	},
