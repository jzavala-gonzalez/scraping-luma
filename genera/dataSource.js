const timestamp_saved = '10/06/2023 03:15 PM';
const dataFechaAcualizado = '10/6/2023' + ' 11:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'50', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'52', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'52', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:16.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'80', Cost:17.01, ParentId: '15'},
