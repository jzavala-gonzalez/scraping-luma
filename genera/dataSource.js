const timestamp_saved = '11/21/2023 07:40 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'18', Cost:13.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'27', Cost:13.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'45', Cost:13.55, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'44', Cost:18.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'125', Cost:18.47, ParentId: '16'},
		]
	},
