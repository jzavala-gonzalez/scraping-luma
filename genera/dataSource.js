const timestamp_saved = '11/25/2023 03:35 PM';
const dataFechaAcualizado = '11/25/2023' + ' 11:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'59', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'21', Cost:12.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'31', Cost:12.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:12.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'34', Cost:18.51, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:18.51, ParentId: '11'},
		]
	},
