const timestamp_saved = '09/14/2023 04:10 PM';
const dataFechaAcualizado = '9/14/2023' + ' 12:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'57', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'57', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'68', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 68, MVar:'0', Cost:6.90, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 142, MVar:'67', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'0', Cost:8.12, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'159', Cost:17.88, ParentId: '16'},
		]
	},
