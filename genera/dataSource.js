const timestamp_saved = '10/04/2023 12:40 AM';
const dataFechaAcualizado = '10/3/2023' + ' 8:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 253,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'83', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'44', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'42', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'55', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'12', Cost:23.14, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:16.82, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'93', Cost:16.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'166', Cost:16.63, ParentId: '16'},
		]
	},
