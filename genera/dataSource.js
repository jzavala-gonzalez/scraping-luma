const timestamp_saved = '11/24/2023 07:40 PM';
const dataFechaAcualizado = '11/24/2023' + ' 3:36:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2166},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'37', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'49', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'57', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'106', Cost:9.22, ParentId: '17'},
		]
	},
