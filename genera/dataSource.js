const timestamp_saved = '11/09/2023 02:00 AM';
const dataFechaAcualizado = '11/8/2023' + ' 9:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'54', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'52', Cost:10.76, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 3, MVar:'1', Cost:27.30, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'49', Cost:17.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:30.92, ParentId: '12'},
