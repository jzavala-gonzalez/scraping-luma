const timestamp_saved = '09/28/2023 07:46 AM';
const dataFechaAcualizado = '9/28/2023' + ' 3:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'18', Cost:13.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'18', Cost:13.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'44', Cost:13.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:18.20, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'63', Cost:9.75, ParentId: '17'},
		]
	},
