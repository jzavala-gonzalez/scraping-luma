const timestamp_saved = '10/28/2023 11:25 PM';
const dataFechaAcualizado = '10/28/2023' + ' 7:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'53', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'56', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'57', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:21.06, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'10', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'79', Cost:17.15, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'153', Cost:16.75, ParentId: '16'},
		]
	},
