const timestamp_saved = '09/15/2023 07:00 AM';
const dataFechaAcualizado = '9/15/2023' + ' 2:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'48', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'47', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'61', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'20', Cost:19.00, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 225,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 225, MVar:'85', Cost:9.88, ParentId: '17'},
		]
	},
