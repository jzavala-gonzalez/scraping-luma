const timestamp_saved = '07/27/2023 11:39 AM';
const dataFechaAcualizado = '7/27/2023' + ' 7:30:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'71', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'54', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'7', Cost:8.81, ParentId: '11'},
