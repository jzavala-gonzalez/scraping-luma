const timestamp_saved = '12/06/2023 03:15 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:10:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 936},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'48', Cost:13.50, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 156,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 85, MVar:'15', Cost:18.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'66', Cost:14.55, ParentId: '17'},
		]
	},
