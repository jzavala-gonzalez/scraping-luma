const timestamp_saved = '09/16/2023 02:05 AM';
const dataFechaAcualizado = '9/15/2023' + ' 10:00:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'53', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'51', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'65', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:25.75, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'24', Cost:18.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'78', Cost:16.93, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'107', Cost:9.13, ParentId: '17'},
		]
	},
