const timestamp_saved = '11/26/2023 07:45 AM';
const dataFechaAcualizado = '11/26/2023' + ' 3:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'20', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'30', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'46', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'110', Cost:18.24, ParentId: '16'},
		]
	},
