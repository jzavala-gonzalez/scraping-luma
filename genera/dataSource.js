const timestamp_saved = '08/16/2023 01:05 PM';
const dataFechaAcualizado = '8/16/2023' + ' 9:02:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'53', Cost:10.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:19.83, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 61, MVar:'29', Cost:20.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'196', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'85', Cost:10.46, ParentId: '17'},
		]
	},
