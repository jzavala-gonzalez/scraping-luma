const timestamp_saved = '08/05/2023 10:35 AM';
const dataFechaAcualizado = '8/5/2023' + ' 6:30:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'41', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'36', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'42', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:19.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'89', Cost:16.97, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'20', Cost:15.61, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'125', Cost:18.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'79', Cost:11.33, ParentId: '17'},
		]
	},
