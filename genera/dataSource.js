const timestamp_saved = '11/10/2023 06:55 PM';
const dataFechaAcualizado = '11/10/2023' + ' 2:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'29', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'40', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'56', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'13', Cost:31.15, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:21.94, ParentId: '14'},
