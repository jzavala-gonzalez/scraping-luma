const timestamp_saved = '09/24/2023 07:40 PM';
const dataFechaAcualizado = '9/24/2023' + ' 3:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'49', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'50', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:27.13, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.37, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.79, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 96,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'7', Cost:45.71, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'3', Cost:27.57, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'35', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'96', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'99', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 56,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 10, MVar:'20', Cost:17, ParentId: '19'},
		]
	},
