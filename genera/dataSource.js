const timestamp_saved = '10/15/2023 05:50 AM';
const dataFechaAcualizado = '10/15/2023' + ' 1:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'51', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'54', Cost:11.36, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 20, MVar:'0', Cost:26.36, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'73', Cost:9.15, ParentId: '17'},
		]
	},
