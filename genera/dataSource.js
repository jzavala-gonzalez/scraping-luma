const timestamp_saved = '11/02/2023 07:45 AM';
const dataFechaAcualizado = '11/2/2023' + ' 3:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'116', Cost:20.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'53', Cost:9.62, ParentId: '17'},
		]
	},
