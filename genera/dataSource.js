const timestamp_saved = '11/22/2023 05:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'22', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'31', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'49', Cost:12.08, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 51, MVar:'56', Cost:22.99, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'71', Cost:9.35, ParentId: '17'},
		]
	},
