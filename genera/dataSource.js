const timestamp_saved = '09/14/2023 07:00 PM';
const dataFechaAcualizado = '9/14/2023' + ' 2:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'58', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'57', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 169, MVar:'69', Cost:10.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:7.10, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:32.03, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 82,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'6', Cost:29.02, ParentId: '13'},
