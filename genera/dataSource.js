const timestamp_saved = '09/24/2023 11:00 AM';
const dataFechaAcualizado = '9/24/2023' + ' 6:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'41', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'42', Cost:11.15, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'61', Cost:17.63, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'70', Cost:9.76, ParentId: '17'},
		]
	},
