const timestamp_saved = '09/19/2023 02:00 PM';
const dataFechaAcualizado = '9/19/2023' + ' 9:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 176, MVar:'62', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'73', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'50', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'52', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'65', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'2', Cost:26.40, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'27', Cost:18.92, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 95,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'3', Cost:19.60, ParentId: '19'},
