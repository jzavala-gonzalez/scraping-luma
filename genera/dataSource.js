const timestamp_saved = '12/06/2023 04:15 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:10:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'48', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'50', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'58', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.53, ParentId: '11'},
