const timestamp_saved = '10/19/2023 07:45 PM';
const dataFechaAcualizado = '10/19/2023' + ' 3:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'44', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'71', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:85.23, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:30.78, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'21', Cost:23.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'84', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'182', Cost:17.18, ParentId: '16'},
		]
	},
