const timestamp_saved = '10/12/2023 06:01 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 154, MVar:'66', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'87', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'155', Cost:18.09, ParentId: '16'},
		]
	},
