const timestamp_saved = '08/20/2023 10:06 AM';
const dataFechaAcualizado = '8/20/2023' + ' 6:02:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'50', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'4', Cost:31.30, ParentId: '10'},
		]
	},
