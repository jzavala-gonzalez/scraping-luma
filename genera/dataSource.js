const timestamp_saved = '08/18/2023 03:35 AM';
const dataFechaAcualizado = '8/17/2023' + ' 11:27:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2601},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'56', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'69', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'60', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'71', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:24.28, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:26.11, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 95,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'6', Cost:30.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'8', Cost:31.01, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:19.77, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:30.55, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:31.51, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.31, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'154', Cost:16.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'78', Cost:9.20, ParentId: '17'},
		]
	},
