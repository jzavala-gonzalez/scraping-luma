const timestamp_saved = '08/12/2023 07:10 AM';
const dataFechaAcualizado = '8/12/2023' + ' 3:07:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:10.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'56', Cost:10.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'52', Cost:10.02, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:31.85, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'113', Cost:11.64, ParentId: '17'},
		]
	},
