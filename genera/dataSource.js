const timestamp_saved = '08/06/2023 02:20 PM';
const dataFechaAcualizado = '8/6/2023' + ' 10:15:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'47', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'41', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'88', Cost:17.40, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'28', Cost:17.03, ParentId: '15'},
		]
	},
