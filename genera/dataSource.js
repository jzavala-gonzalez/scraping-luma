const timestamp_saved = '08/03/2023 11:35 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:30:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'44', Cost:10.37, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'39', Cost:16.63, ParentId: '15'},
		]
	},
