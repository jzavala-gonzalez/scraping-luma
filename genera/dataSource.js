const timestamp_saved = '08/31/2023 09:35 AM';
const dataFechaAcualizado = '8/31/2023' + ' 5:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'44', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'53', Cost:10.24, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:18.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:18.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'0', Cost:17.06, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'22', Cost:18.72, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'79', Cost:9.49, ParentId: '17'},
		]
	},
