const timestamp_saved = '08/31/2023 05:40 AM';
const dataFechaAcualizado = '8/31/2023' + ' 1:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'47', Cost:10.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'57', Cost:10.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'64', Cost:10.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:18.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'22', Cost:19.02, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 183,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 183, MVar:'81', Cost:16.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 175,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 175, MVar:'146', Cost:20.27, ParentId: '16'},
		]
	},
