const timestamp_saved = '11/06/2023 01:00 PM';
const dataFechaAcualizado = '11/6/2023' + ' 8:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:16.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:16.90, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'69', Cost:9.78, ParentId: '17'},
		]
	},
