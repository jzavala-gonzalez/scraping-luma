const timestamp_saved = '11/03/2023 07:40 AM';
const dataFechaAcualizado = '11/3/2023' + ' 3:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'43', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'41', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'41', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'56', Cost:9.41, ParentId: '17'},
		]
	},
