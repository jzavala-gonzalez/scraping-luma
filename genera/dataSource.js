const timestamp_saved = '08/27/2023 04:20 PM';
const dataFechaAcualizado = '8/27/2023' + ' 12:15:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 262,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'29', Cost:14.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 95, MVar:'56', Cost:14.13, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 142, MVar:'48', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'12', Cost:31.73, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:8.36, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'76', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'79', Cost:12.51, ParentId: '17'},
		]
	},
