const timestamp_saved = '11/24/2023 02:50 PM';
const dataFechaAcualizado = '11/24/2023' + ' 10:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'24', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'34', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'51', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'77', Cost:9.88, ParentId: '17'},
		]
	},
