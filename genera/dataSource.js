const timestamp_saved = '10/27/2023 02:30 PM';
const dataFechaAcualizado = '10/27/2023' + ' 10:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'52', Cost:12.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'49', Cost:12.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'54', Cost:12.83, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'86', Cost:16.50, ParentId: '15'},
