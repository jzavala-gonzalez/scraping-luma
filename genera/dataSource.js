const timestamp_saved = '11/21/2023 02:30 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'32', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'42', Cost:11.24, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'91', Cost:9.59, ParentId: '17'},
		]
	},
