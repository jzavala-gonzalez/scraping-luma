const timestamp_saved = '10/24/2023 01:25 PM';
const dataFechaAcualizado = '10/24/2023' + ' 9:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'50', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'53', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'82', Cost:11.27, ParentId: '17'},
		]
	},
