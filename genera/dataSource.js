const timestamp_saved = '11/23/2023 12:25 PM';
const dataFechaAcualizado = '11/23/2023' + ' 8:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'70', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'21', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'31', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:12.07, ParentId: '7'},
		]
	},
