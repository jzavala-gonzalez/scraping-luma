const timestamp_saved = '11/08/2023 07:59 AM';
const dataFechaAcualizado = '11/8/2023' + ' 3:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'37', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'36', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'42', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'60', Cost:17.01, ParentId: '15'},
