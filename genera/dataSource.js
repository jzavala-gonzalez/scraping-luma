const timestamp_saved = '10/04/2023 04:50 PM';
const dataFechaAcualizado = '10/4/2023' + ' 12:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'44', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'43', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'45', Cost:16.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:16.68, ParentId: '11'},
