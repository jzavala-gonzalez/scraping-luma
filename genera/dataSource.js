const timestamp_saved = '10/04/2023 11:00 PM';
const dataFechaAcualizado = '10/4/2023' + ' 6:56:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'44', Cost:10.96, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:17.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.04, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'47', Cost:17.38, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:17.38, ParentId: '11'},
		]
	},
