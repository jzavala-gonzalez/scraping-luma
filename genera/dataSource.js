const timestamp_saved = '10/12/2023 05:30 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'55', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'59', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'65', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.10, ParentId: '14'},
