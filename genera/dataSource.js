const timestamp_saved = '08/05/2023 07:15 PM';
const dataFechaAcualizado = '8/5/2023' + ' 3:10:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'49', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'0', Cost:26.98, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'14', Cost:43.82, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:20.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:20.04, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:31.17, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'97', Cost:11.89, ParentId: '17'},
		]
	},
