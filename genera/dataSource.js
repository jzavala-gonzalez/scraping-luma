const timestamp_saved = '11/13/2023 10:35 AM';
const dataFechaAcualizado = '11/13/2023' + ' 6:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'48', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'52', Cost:10.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 132, MVar:'37', Cost:8.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:8.80, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.02, ParentId: '14'},
