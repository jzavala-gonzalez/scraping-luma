const timestamp_saved = '11/16/2023 08:50 AM';
const dataFechaAcualizado = '11/16/2023' + ' 4:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'40', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'41', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'47', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.32, ParentId: '11'},
