const timestamp_saved = '10/23/2023 11:15 PM';
const dataFechaAcualizado = '10/23/2023' + ' 7:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'56', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'57', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'58', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'13', Cost:22.62, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.10, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:17.10, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'81', Cost:16.79, ParentId: '15'},
