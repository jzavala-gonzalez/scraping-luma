const timestamp_saved = '09/17/2023 12:30 PM';
const dataFechaAcualizado = '9/17/2023' + ' 8:25:53 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1154},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'42', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'40', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'58', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'73', Cost:9.40, ParentId: '17'},
		]
	},
