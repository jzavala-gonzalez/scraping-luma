const timestamp_saved = '10/30/2023 07:35 PM';
const dataFechaAcualizado = '10/30/2023' + ' 3:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'65', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'68', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:18.29, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'166', Cost:17.13, ParentId: '16'},
		]
	},
