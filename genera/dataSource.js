const timestamp_saved = '09/28/2023 02:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 10:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'30', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'31', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'61', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'0', Cost:18.25, ParentId: '11'},
		]
	},
