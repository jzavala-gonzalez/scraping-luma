const timestamp_saved = '10/12/2023 06:35 AM';
const dataFechaAcualizado = '10/12/2023' + ' 2:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'54', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'58', Cost:10.27, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:18.50, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 196,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'161', Cost:19.41, ParentId: '16'},
		]
	},
