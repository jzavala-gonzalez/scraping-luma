const timestamp_saved = '08/24/2023 07:55 AM';
const dataFechaAcualizado = '8/24/2023' + ' 3:50:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:10.52, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'17', Cost:18.90, ParentId: '14'},
