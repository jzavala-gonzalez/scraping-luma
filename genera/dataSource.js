const timestamp_saved = '10/13/2023 07:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 3:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'55', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'61', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'65', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'173', Cost:18.19, ParentId: '16'},
		]
	},
