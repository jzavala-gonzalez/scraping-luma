const timestamp_saved = '07/27/2023 03:48 PM';
const dataFechaAcualizado = '7/27/2023' + ' 11:40:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'55', Cost:10.81, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'40', Cost:20.23, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.23, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 129, MVar:'0', Cost:8.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'25', Cost:18.69, ParentId: '14'},
