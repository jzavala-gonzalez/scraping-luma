const timestamp_saved = '09/27/2023 01:40 AM';
const dataFechaAcualizado = '9/26/2023' + ' 9:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'58', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'62', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'7', Cost:26.59, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:16.83, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'0', Cost:16.83, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'7', Cost:19.26, ParentId: '14'},
