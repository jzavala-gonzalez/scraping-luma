const timestamp_saved = '08/13/2023 05:50 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:47:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'35', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'39', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'40', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'107', Cost:12.35, ParentId: '17'},
		]
	},
