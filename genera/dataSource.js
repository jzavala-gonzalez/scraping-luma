const timestamp_saved = '10/31/2023 03:15 AM';
const dataFechaAcualizado = '10/30/2023' + ' 11:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'55', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'60', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'64', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'14', Cost:20.86, ParentId: '14'},
