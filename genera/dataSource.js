const timestamp_saved = '09/13/2023 05:10 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'57', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'57', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'68', Cost:10.68, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 57, MVar:'0', Cost:4.16, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 143, MVar:'66', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'14', Cost:28.36, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'15', Cost:28.43, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'104', Cost:9.12, ParentId: '17'},
		]
	},
