const timestamp_saved = '10/08/2023 02:45 PM';
const dataFechaAcualizado = '10/8/2023' + ' 10:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'39', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'40', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'74', Cost:11.45, ParentId: '17'},
		]
	},
