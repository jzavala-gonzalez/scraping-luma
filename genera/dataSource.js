const timestamp_saved = '09/10/2023 10:15 AM';
const dataFechaAcualizado = '9/10/2023' + ' 6:10:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'60', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'57', Cost:10.86, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'61', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'117', Cost:17.80, ParentId: '16'},
		]
	},
