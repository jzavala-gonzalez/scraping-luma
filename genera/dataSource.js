const timestamp_saved = '12/02/2023 11:45 AM';
const dataFechaAcualizado = '12/2/2023' + ' 7:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'42', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'42', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.95, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'59', Cost:10.05, ParentId: '17'},
		]
	},
