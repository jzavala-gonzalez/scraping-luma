const timestamp_saved = '09/04/2023 07:40 AM';
const dataFechaAcualizado = '9/4/2023' + ' 3:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:10.62, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 27,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'0', Cost:25.09, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'61', Cost:9.86, ParentId: '17'},
		]
	},
