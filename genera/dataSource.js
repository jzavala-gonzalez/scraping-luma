const timestamp_saved = '11/15/2023 11:55 AM';
const dataFechaAcualizado = '11/15/2023' + ' 7:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'41', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'42', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'43', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'75', Cost:9.78, ParentId: '17'},
		]
	},
