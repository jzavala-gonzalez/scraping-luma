const timestamp_saved = '10/01/2023 09:15 AM';
const dataFechaAcualizado = '10/1/2023' + ' 5:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 135, MVar:'57', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'30', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'29', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'45', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.65, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:30.27, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 62,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 62, MVar:'10', Cost:19.15, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'91', Cost:9.51, ParentId: '17'},
		]
	},
