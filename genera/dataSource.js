const timestamp_saved = '10/01/2023 12:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 260,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'67', Cost:4.34, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 9, MVar:'64', Cost:4.34, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'25', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'24', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'41', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'10', Cost:19.26, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'95', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'82', Cost:9.49, ParentId: '17'},
		]
	},
