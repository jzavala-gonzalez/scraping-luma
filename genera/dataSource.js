const timestamp_saved = '07/28/2023 04:58 PM';
const dataFechaAcualizado = '7/28/2023' + ' 12:50:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'50', Cost:11.37, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 36,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 36, MVar:'4', Cost:22.40, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 10, MVar:'2', Cost:74.04, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'88', Cost:13.48, ParentId: '17'},
		]
	},
