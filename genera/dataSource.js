const timestamp_saved = '11/03/2023 06:35 AM';
const dataFechaAcualizado = '11/3/2023' + ' 2:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'48', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'60', Cost:9.33, ParentId: '17'},
		]
	},
