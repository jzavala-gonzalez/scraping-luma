const timestamp_saved = '10/31/2023 10:50 PM';
const dataFechaAcualizado = '10/31/2023' + ' 6:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'64', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'67', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'70', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:41.11, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:26.07, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.68, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'174', Cost:16.62, ParentId: '16'},
		]
	},
