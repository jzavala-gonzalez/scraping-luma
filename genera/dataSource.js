const timestamp_saved = '10/01/2023 01:00 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 9, MVar:'32', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'28', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'25', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'42', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'12', Cost:19.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'105', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'84', Cost:9.51, ParentId: '17'},
		]
	},
