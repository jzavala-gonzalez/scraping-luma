const timestamp_saved = '09/17/2023 09:10 AM';
const dataFechaAcualizado = '9/17/2023' + ' 5:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'36', Cost:12.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'37', Cost:12.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'53', Cost:12.70, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'103', Cost:18.29, ParentId: '16'},
		]
	},
