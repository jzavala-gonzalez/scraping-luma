const timestamp_saved = '10/25/2023 03:25 AM';
const dataFechaAcualizado = '10/24/2023' + ' 11:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'49', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'52', Cost:10.88, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:26.08, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'18', Cost:28.05, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'84', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 264,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 264, MVar:'154', Cost:17.28, ParentId: '16'},
		]
	},
