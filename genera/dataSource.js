const timestamp_saved = '09/26/2023 08:50 PM';
const dataFechaAcualizado = '9/26/2023' + ' 4:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'57', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'58', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'63', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'82', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'185', Cost:17.12, ParentId: '16'},
		]
	},
