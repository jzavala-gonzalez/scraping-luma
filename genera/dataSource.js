const timestamp_saved = '11/17/2023 05:15 AM';
const dataFechaAcualizado = '11/17/2023' + ' 1:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'57', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'58', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'45', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'94', Cost:9.42, ParentId: '17'},
		]
	},
