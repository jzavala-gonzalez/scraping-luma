const timestamp_saved = '08/11/2023 09:05 PM';
const dataFechaAcualizado = '8/11/2023' + ' 5:02:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'47', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 153,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:6.87, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 23, MVar:'0', Cost:31.38, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:26.84, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'11', Cost:30.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'13', Cost:30.88, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'40', Cost:20.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'135', Cost:11.48, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 35,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 5, MVar:'23', Cost:17, ParentId: '19'},
		]
	},
