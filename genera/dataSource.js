const timestamp_saved = '09/16/2023 05:05 AM';
const dataFechaAcualizado = '9/16/2023' + ' 1:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'19', Cost:18.91, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 359, MVar:'96', Cost:9.09, ParentId: '17'},
		]
	},
