const timestamp_saved = '09/17/2023 03:15 AM';
const dataFechaAcualizado = '9/16/2023' + ' 11:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'45', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'47', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:30.88, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 129, MVar:'36', Cost:9.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:9.40, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'29', Cost:19.21, ParentId: '14'},
