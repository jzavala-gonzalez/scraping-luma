const timestamp_saved = '12/06/2023 06:15 AM';
const dataFechaAcualizado = '12/6/2023' + ' 2:10:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 509},
	{Index:'6', Desc:'Reserva Operacional', value: 1103},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'42', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'43', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'53', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'54', Cost:14.51, ParentId: '17'},
		]
	},
