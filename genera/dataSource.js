const timestamp_saved = '09/26/2023 02:00 AM';
const dataFechaAcualizado = '9/25/2023' + ' 9:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'49', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'51', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'58', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'46', Cost:17.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.80, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'70', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'182', Cost:16.71, ParentId: '16'},
		]
	},
