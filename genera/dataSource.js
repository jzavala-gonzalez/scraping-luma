const timestamp_saved = '12/02/2023 03:30 AM';
const dataFechaAcualizado = '12/1/2023' + ' 11:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'53', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'54', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'54', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'79', Cost:9.83, ParentId: '17'},
		]
	},
