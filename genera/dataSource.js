const timestamp_saved = '10/09/2023 04:25 PM';
const dataFechaAcualizado = '10/9/2023' + ' 12:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'58', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'59', Cost:10.62, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'86', Cost:16.97, ParentId: '15'},
