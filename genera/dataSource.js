const timestamp_saved = '08/10/2023 10:05 AM';
const dataFechaAcualizado = '8/10/2023' + ' 6:00:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'55', Cost:11.20, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:30.65, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'1', Cost:30.67, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'41', Cost:8.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:8.46, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'175', Cost:16.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'79', Cost:11.98, ParentId: '17'},
		]
	},
