const timestamp_saved = '11/12/2023 04:35 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'43', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'45', Cost:12.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'54', Cost:12.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'22', Cost:0, ParentId: '8'},
