const timestamp_saved = '07/25/2023 07:31 PM';
const dataFechaAcualizado = '7/25/2023' + ' 3:25:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'89', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'60', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'55', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'8', Cost:30.81, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:8.34, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'50', Cost:8.34, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.53, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'28', Cost:18.64, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 86,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 86, MVar:'45', Cost:16.99, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 228,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 228, MVar:'86', Cost:9.84, ParentId: '17'},
		]
	},
