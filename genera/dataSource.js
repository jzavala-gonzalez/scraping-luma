const timestamp_saved = '09/27/2023 08:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 4:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'26', Cost:12.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'25', Cost:12.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'58', Cost:12.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'72', Cost:9.12, ParentId: '17'},
		]
	},
