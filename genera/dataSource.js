const timestamp_saved = '11/23/2023 10:45 AM';
const dataFechaAcualizado = '11/23/2023' + ' 6:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'19', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'29', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'45', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'58', Cost:9.83, ParentId: '17'},
		]
	},
