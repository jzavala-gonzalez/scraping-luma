const timestamp_saved = '08/06/2023 10:45 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:40:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'37', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'38', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 259,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 129, MVar:'84', Cost:17.34, ParentId: '15'},
