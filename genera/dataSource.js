const timestamp_saved = '11/27/2023 02:30 PM';
const dataFechaAcualizado = '11/27/2023' + ' 10:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'34', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'44', Cost:10.68, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'95', Cost:9.67, ParentId: '17'},
		]
	},
