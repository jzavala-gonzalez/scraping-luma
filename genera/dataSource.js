const timestamp_saved = '11/29/2023 02:25 PM';
const dataFechaAcualizado = '11/29/2023' + ' 10:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'44', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'46', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'79', Cost:9.75, ParentId: '17'},
		]
	},
