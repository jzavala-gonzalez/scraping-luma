const timestamp_saved = '09/29/2023 02:00 AM';
const dataFechaAcualizado = '9/28/2023' + ' 9:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'48', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'50', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'53', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:17.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.61, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'82', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'153', Cost:16.49, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'105', Cost:9.11, ParentId: '17'},
		]
	},
