const timestamp_saved = '09/27/2023 07:00 PM';
const dataFechaAcualizado = '9/27/2023' + ' 2:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'30', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'30', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'62', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:17.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.90, ParentId: '11'},
