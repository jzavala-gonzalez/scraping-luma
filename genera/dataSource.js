const timestamp_saved = '11/21/2023 02:55 AM';
const dataFechaAcualizado = '11/20/2023' + ' 10:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'33', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'44', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'56', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 1,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'0', Cost:32.06, ParentId: '12'},
