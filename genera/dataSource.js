const timestamp_saved = '08/30/2023 03:35 AM';
const dataFechaAcualizado = '8/29/2023' + ' 11:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'52', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'53', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'61', Cost:10.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 98,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.95, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'2', Cost:29.39, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'18', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'154', Cost:18.95, ParentId: '16'},
		]
	},
