const timestamp_saved = '11/02/2023 08:35 AM';
const dataFechaAcualizado = '11/2/2023' + ' 4:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'44', Cost:10.83, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:17.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.37, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'34', Cost:18.32, ParentId: '11'},
