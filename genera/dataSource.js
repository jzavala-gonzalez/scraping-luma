const timestamp_saved = '10/25/2023 05:00 PM';
const dataFechaAcualizado = '10/25/2023' + ' 12:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 177, MVar:'55', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:18.11, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:18.11, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 143, MVar:'42', Cost:17.94, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:17.94, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'6', Cost:0, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:31.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'0', Cost:0, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'158', Cost:17.45, ParentId: '16'},
		]
	},
