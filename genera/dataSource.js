const timestamp_saved = '10/06/2023 01:10 AM';
const dataFechaAcualizado = '10/5/2023' + ' 9:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'45', Cost:10.71, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'91', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'188', Cost:16.63, ParentId: '16'},
		]
	},
