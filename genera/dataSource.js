const timestamp_saved = '09/01/2023 04:10 PM';
const dataFechaAcualizado = '9/1/2023' + ' 12:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'52', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'62', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'6', Cost:27.08, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.46, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 5, MVar:'7', Cost:0, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'88', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'159', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 195,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 195, MVar:'74', Cost:10.53, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 120,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 33, MVar:'4', Cost:17, ParentId: '19'},
		]
	},
