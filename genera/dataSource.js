const timestamp_saved = '08/01/2023 05:35 PM';
const dataFechaAcualizado = '8/1/2023' + ' 1:30:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'53', Cost:10.17, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'1', Cost:28.52, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'4', Cost:0, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'106', Cost:10.98, ParentId: '17'},
		]
	},
