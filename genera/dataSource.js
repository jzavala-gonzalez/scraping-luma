const timestamp_saved = '08/14/2023 04:35 PM';
const dataFechaAcualizado = '8/14/2023' + ' 12:32:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'49', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'7', Cost:26.78, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:31.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.25, ParentId: '11'},
