const timestamp_saved = '09/06/2023 10:55 AM';
const dataFechaAcualizado = '9/6/2023' + ' 6:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'43', Cost:11.48, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'138', Cost:17.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'64', Cost:9.18, ParentId: '17'},
		]
	},
