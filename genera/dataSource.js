const timestamp_saved = '09/30/2023 01:25 PM';
const dataFechaAcualizado = '9/30/2023' + ' 9:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'31', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'29', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'96', Cost:9.49, ParentId: '17'},
		]
	},
