const timestamp_saved = '11/29/2023 07:35 AM';
const dataFechaAcualizado = '11/29/2023' + ' 3:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'20', Cost:12.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'31', Cost:12.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'47', Cost:12.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'50', Cost:17.50, ParentId: '11'},
