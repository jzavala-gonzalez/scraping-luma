const timestamp_saved = '11/01/2023 04:00 AM';
const dataFechaAcualizado = '10/31/2023' + ' 11:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'56', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'61', Cost:10.83, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'128', Cost:18.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'78', Cost:9.12, ParentId: '17'},
		]
	},
