const timestamp_saved = '10/06/2023 07:50 PM';
const dataFechaAcualizado = '10/6/2023' + ' 3:46:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'52', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'53', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'16', Cost:27.87, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:16.96, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:16.96, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'45', Cost:8.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'10', Cost:8.14, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:28.77, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'197', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'111', Cost:9.26, ParentId: '17'},
		]
	},
