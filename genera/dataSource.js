const timestamp_saved = '08/06/2023 01:35 AM';
const dataFechaAcualizado = '8/5/2023' + ' 9:30:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'105', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'54', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'63', Cost:9.76, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 198,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'9', Cost:22.54, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'25', Cost:28.01, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'8', Cost:27.03, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:27.44, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'5', Cost:28.94, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'110', Cost:16.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'29', Cost:15.55, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'114', Cost:11.54, ParentId: '17'},
		]
	},
