const timestamp_saved = '10/15/2023 02:30 AM';
const dataFechaAcualizado = '10/14/2023' + ' 10:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'62', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'64', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'6', Cost:40.84, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:16.85, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:32.17, ParentId: '13'},
