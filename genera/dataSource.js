const timestamp_saved = '08/16/2023 01:35 AM';
const dataFechaAcualizado = '8/15/2023' + ' 9:32:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3091},
	{Index:'1', Desc:'PREPA', value: 64},
	{Index:'2', Desc:'COGEN', value: 36},
	{Index:'3', Desc:'Reserva en Rotación', value: 57},
	{Index:'4', Desc:'Reserva Operacional', value: 56},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 537,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'71', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'70', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 193, MVar:'71', Cost:9.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:22.11, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.94, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'14', Cost:22.95, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'8', Cost:22.19, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'26', Cost:28.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'26', Cost:28.08, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:19.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:19.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'0', Cost:8.15, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'9', Cost:8.15, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 87,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 42, MVar:'10', Cost:31.06, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'12', Cost:28.65, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'239', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'119', Cost:10.10, ParentId: '17'},
		]
	},
