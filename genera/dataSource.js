const timestamp_saved = '10/16/2023 04:00 AM';
const dataFechaAcualizado = '10/15/2023' + ' 11:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'52', Cost:13.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'52', Cost:13.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'54', Cost:13.47, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'1', Cost:26.55, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:17.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'2', Cost:28.67, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'1', Cost:28.56, ParentId: '13'},
