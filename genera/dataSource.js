const timestamp_saved = '10/27/2023 01:10 PM';
const dataFechaAcualizado = '10/27/2023' + ' 9:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'49', Cost:12.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'50', Cost:12.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'54', Cost:12.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.71, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'95', Cost:16.82, ParentId: '15'},
