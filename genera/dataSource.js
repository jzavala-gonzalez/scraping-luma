const timestamp_saved = '12/02/2023 10:00 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:12.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:12.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'44', Cost:12.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'38', Cost:8.59, ParentId: '11'},
