const timestamp_saved = '09/30/2023 03:25 PM';
const dataFechaAcualizado = '9/30/2023' + ' 11:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'34', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'32', Cost:10.66, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'78', Cost:17.35, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'101', Cost:9.26, ParentId: '17'},
		]
	},
