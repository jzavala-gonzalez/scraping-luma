const timestamp_saved = '08/17/2023 12:45 AM';
const dataFechaAcualizado = '8/16/2023' + ' 8:42:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 37},
	{Index:'4', Desc:'Reserva Operacional', value: 39},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'82', Cost:9.79, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'12', Cost:22.83, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'8', Cost:28.61, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 86,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'7', Cost:30.19, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'30', Cost:18.61, ParentId: '14'},
