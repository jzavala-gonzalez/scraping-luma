const timestamp_saved = '11/16/2023 10:55 PM';
const dataFechaAcualizado = '11/16/2023' + ' 6:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'61', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'61', Cost:11.12, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 70,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.74, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'112', Cost:9.15, ParentId: '17'},
		]
	},
