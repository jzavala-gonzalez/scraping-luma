const timestamp_saved = '10/17/2023 06:20 PM';
const dataFechaAcualizado = '10/17/2023' + ' 2:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'68', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'67', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'64', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'113', Cost:9.14, ParentId: '17'},
		]
	},
