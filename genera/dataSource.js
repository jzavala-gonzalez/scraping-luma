const timestamp_saved = '11/07/2023 03:40 PM';
const dataFechaAcualizado = '11/7/2023' + ' 11:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'52', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'47', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:30.64, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'97', Cost:9.81, ParentId: '17'},
		]
	},
