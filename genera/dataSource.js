const timestamp_saved = '09/16/2023 05:00 PM';
const dataFechaAcualizado = '9/16/2023' + ' 12:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'44', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'43', Cost:10.67, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'87', Cost:9.47, ParentId: '17'},
		]
	},
