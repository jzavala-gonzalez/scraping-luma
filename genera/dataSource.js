const timestamp_saved = '08/10/2023 04:50 AM';
const dataFechaAcualizado = '8/10/2023' + ' 12:45:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'56', Cost:10.59, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'4', Cost:26.84, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.67, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'22', Cost:22.29, ParentId: '14'},
