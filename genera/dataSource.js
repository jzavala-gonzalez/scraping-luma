const timestamp_saved = '12/03/2023 10:20 PM';
const dataFechaAcualizado = '12/3/2023' + ' 6:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 220,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 220, MVar:'82', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'50', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'52', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'53', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'123', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'81', Cost:11.24, ParentId: '17'},
		]
	},
