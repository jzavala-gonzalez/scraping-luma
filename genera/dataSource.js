const timestamp_saved = '12/06/2023 07:10 AM';
const dataFechaAcualizado = '12/6/2023' + ' 3:05:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 545},
	{Index:'6', Desc:'Reserva Operacional', value: 1139},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'41', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'42', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'51', Cost:12.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'51', Cost:14.53, ParentId: '17'},
		]
	},
