const timestamp_saved = '08/17/2023 04:15 PM';
const dataFechaAcualizado = '8/17/2023' + ' 12:12:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'68', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'76', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'34', Cost:19.06, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'164', Cost:18.21, ParentId: '16'},
		]
	},
