const timestamp_saved = '09/10/2023 10:25 PM';
const dataFechaAcualizado = '9/10/2023' + ' 6:20:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 224, MVar:'64', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'80', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'71', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'70', Cost:9.76, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'4', Cost:24.83, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'0', Cost:38.38, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'12', Cost:28.02, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'20', Cost:18.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'88', Cost:16.06, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'148', Cost:16.63, ParentId: '16'},
		]
	},
