const timestamp_saved = '12/06/2023 12:55 AM';
const dataFechaAcualizado = '12/5/2023' + ' 8:50:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 373},
	{Index:'6', Desc:'Reserva Operacional', value: 576},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'61', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'63', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'64', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:24.23, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'98', Cost:10.88, ParentId: '17'},
		]
	},
