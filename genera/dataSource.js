const timestamp_saved = '08/16/2023 01:55 PM';
const dataFechaAcualizado = '8/16/2023' + ' 9:52:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'56', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'52', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'59', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'11', Cost:31.24, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'30', Cost:19.52, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'195', Cost:17.07, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'88', Cost:10.32, ParentId: '17'},
		]
	},
