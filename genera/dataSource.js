const timestamp_saved = '09/15/2023 01:25 PM';
const dataFechaAcualizado = '9/15/2023' + ' 9:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'51', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'65', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'24', Cost:18.98, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'142', Cost:17.84, ParentId: '16'},
		]
	},
