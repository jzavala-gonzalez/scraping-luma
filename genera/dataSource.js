const timestamp_saved = '08/12/2023 09:45 PM';
const dataFechaAcualizado = '8/12/2023' + ' 5:42:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'45', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:26.78, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'40', Cost:14.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:14.44, ParentId: '11'},
