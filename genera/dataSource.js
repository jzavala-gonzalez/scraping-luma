const timestamp_saved = '12/06/2023 03:25 AM';
const dataFechaAcualizado = '12/5/2023' + ' 11:20:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 444},
	{Index:'6', Desc:'Reserva Operacional', value: 842},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'48', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'50', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'57', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'74', Cost:10.87, ParentId: '17'},
		]
	},
