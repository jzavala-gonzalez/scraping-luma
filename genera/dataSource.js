const timestamp_saved = '08/05/2023 01:40 AM';
const dataFechaAcualizado = '8/4/2023' + ' 9:35:38 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3433},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'54', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'49', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'51', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'12', Cost:26.91, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'2', Cost:26.89, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.98, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'91', Cost:16.64, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'50', Cost:15.60, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'151', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'101', Cost:11.42, ParentId: '17'},
		]
	},
