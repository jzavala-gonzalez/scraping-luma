const timestamp_saved = '09/05/2023 12:45 PM';
const dataFechaAcualizado = '9/5/2023' + ' 8:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 150, MVar:'56', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'35', Cost:19.73, ParentId: '14'},
