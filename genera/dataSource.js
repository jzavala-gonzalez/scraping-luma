const timestamp_saved = '09/03/2023 05:55 AM';
const dataFechaAcualizado = '9/3/2023' + ' 1:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'41', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'49', Cost:10.69, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'46', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'63', Cost:9.20, ParentId: '17'},
		]
	},
