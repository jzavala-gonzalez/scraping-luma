const timestamp_saved = '12/04/2023 09:40 AM';
const dataFechaAcualizado = '12/4/2023' + ' 5:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'42', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'43', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'46', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.62, ParentId: '14'},
