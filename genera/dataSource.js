const timestamp_saved = '10/18/2023 02:00 PM';
const dataFechaAcualizado = '10/18/2023' + ' 9:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'46', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'51', Cost:11.06, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.18, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'80', Cost:23.22, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'102', Cost:10.58, ParentId: '17'},
		]
	},
