const timestamp_saved = '08/19/2023 07:25 AM';
const dataFechaAcualizado = '8/19/2023' + ' 3:22:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'61', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'69', Cost:10.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.29, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'3', Cost:30.31, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'59', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 161,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'148', Cost:20.29, ParentId: '16'},
		]
	},
