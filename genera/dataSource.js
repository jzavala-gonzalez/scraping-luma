const timestamp_saved = '10/22/2023 04:30 AM';
const dataFechaAcualizado = '10/22/2023' + ' 12:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'45', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'46', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'48', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'142', Cost:17.10, ParentId: '16'},
		]
	},
