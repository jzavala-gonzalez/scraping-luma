const timestamp_saved = '11/08/2023 05:35 PM';
const dataFechaAcualizado = '11/8/2023' + ' 1:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'60', Cost:10.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'59', Cost:10.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'58', Cost:10.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'118', Cost:9.24, ParentId: '17'},
		]
	},
