const timestamp_saved = '09/23/2023 08:10 AM';
const dataFechaAcualizado = '9/23/2023' + ' 4:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 171, MVar:'68', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'38', Cost:12.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'40', Cost:12.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'55', Cost:12.62, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 69,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:35.07, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.45, ParentId: '14'},
