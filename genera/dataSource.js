const timestamp_saved = '11/21/2023 02:25 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'33', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'42', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'91', Cost:9.62, ParentId: '17'},
		]
	},
