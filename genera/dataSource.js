const timestamp_saved = '07/30/2023 09:35 PM';
const dataFechaAcualizado = '7/30/2023' + ' 5:30:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 149, MVar:'46', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 44,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 44, MVar:'11', Cost:36.33, ParentId: '10'},
