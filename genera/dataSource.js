const timestamp_saved = '11/12/2023 01:50 PM';
const dataFechaAcualizado = '11/12/2023' + ' 9:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'43', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'44', Cost:11.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'83', Cost:9.66, ParentId: '17'},
		]
	},
