const timestamp_saved = '11/06/2023 07:35 PM';
const dataFechaAcualizado = '11/6/2023' + ' 3:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'56', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'55', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'52', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'91', Cost:16.95, ParentId: '15'},
