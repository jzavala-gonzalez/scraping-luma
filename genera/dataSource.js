const timestamp_saved = '09/25/2023 03:25 AM';
const dataFechaAcualizado = '9/24/2023' + ' 11:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'48', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'49', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.30, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'18', Cost:19.08, ParentId: '14'},
