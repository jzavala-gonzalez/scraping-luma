const timestamp_saved = '12/01/2023 12:45 PM';
const dataFechaAcualizado = '12/1/2023' + ' 8:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'49', Cost:10.77, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'73', Cost:9.55, ParentId: '17'},
		]
	},
