const timestamp_saved = '07/30/2023 09:15 PM';
const dataFechaAcualizado = '7/30/2023' + ' 5:10:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'51', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'5', Cost:43.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'45', Cost:17.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.27, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'81', Cost:11.44, ParentId: '17'},
		]
	},
