const timestamp_saved = '10/14/2023 10:40 AM';
const dataFechaAcualizado = '10/14/2023' + ' 6:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'46', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'45', Cost:12.03, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:17.59, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.15, ParentId: '14'},
