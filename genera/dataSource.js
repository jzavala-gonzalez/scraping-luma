const timestamp_saved = '11/17/2023 01:25 AM';
const dataFechaAcualizado = '11/16/2023' + ' 9:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'61', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'28', Cost:27.89, ParentId: '10'},
