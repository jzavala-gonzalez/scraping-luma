const timestamp_saved = '10/15/2023 09:20 PM';
const dataFechaAcualizado = '10/15/2023' + ' 5:16:15 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2591},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'57', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'56', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'56', Cost:10.27, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:26.06, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 14, MVar:'0', Cost:35.53, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'11', Cost:29.71, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'12', Cost:29.67, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'105', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'177', Cost:16.62, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 13,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'22', Cost:19.60, ParentId: '19'},
