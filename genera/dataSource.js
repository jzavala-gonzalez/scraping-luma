const timestamp_saved = '11/30/2023 03:15 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'50', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'50', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'53', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'71', Cost:9.73, ParentId: '17'},
		]
	},
