const timestamp_saved = '11/16/2023 11:20 PM';
const dataFechaAcualizado = '11/16/2023' + ' 7:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'61', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'62', Cost:11.20, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'1', Cost:22.87, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:17.09, ParentId: '11'},
