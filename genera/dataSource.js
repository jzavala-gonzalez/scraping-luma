const timestamp_saved = '09/21/2023 08:05 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'38', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'40', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'61', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'8', Cost:26.80, ParentId: '14'},
