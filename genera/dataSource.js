const timestamp_saved = '11/03/2023 06:25 AM';
const dataFechaAcualizado = '11/3/2023' + ' 2:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'45', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'63', Cost:9.32, ParentId: '17'},
		]
	},
