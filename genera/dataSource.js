const timestamp_saved = '09/06/2023 05:15 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'48', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'50', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'60', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.31, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 6,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'2', Cost:31.18, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'155', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'77', Cost:9.18, ParentId: '17'},
		]
	},
