const timestamp_saved = '09/11/2023 06:00 AM';
const dataFechaAcualizado = '9/11/2023' + ' 1:55:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'67', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'66', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'10', Cost:31.31, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'142', Cost:16.65, ParentId: '16'},
		]
	},
