const timestamp_saved = '10/19/2023 03:40 PM';
const dataFechaAcualizado = '10/19/2023' + ' 11:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'79', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'44', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'51', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 39,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 39, MVar:'22', Cost:21.62, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'113', Cost:10.57, ParentId: '17'},
		]
	},
