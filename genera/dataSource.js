const timestamp_saved = '08/07/2023 10:10 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:05:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'44', Cost:11.02, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 214,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'46', Cost:16.44, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'103', Cost:11.63, ParentId: '17'},
		]
	},
