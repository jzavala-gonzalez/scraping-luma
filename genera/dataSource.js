const timestamp_saved = '11/24/2023 04:40 AM';
const dataFechaAcualizado = '11/24/2023' + ' 12:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'27', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'36', Cost:11.54, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'87', Cost:9.17, ParentId: '17'},
		]
	},
