const timestamp_saved = '10/20/2023 09:05 AM';
const dataFechaAcualizado = '10/20/2023' + ' 5:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'30', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'40', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'81', Cost:10.50, ParentId: '17'},
		]
	},
