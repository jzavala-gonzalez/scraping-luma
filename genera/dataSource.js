const timestamp_saved = '08/20/2023 12:10 AM';
const dataFechaAcualizado = '8/19/2023' + ' 8:07:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'63', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'61', Cost:10.91, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:30.42, ParentId: '13'},
