const timestamp_saved = '08/17/2023 01:10 PM';
const dataFechaAcualizado = '8/17/2023' + ' 9:07:55 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 702},
	{Index:'5', Desc:'Capacidad Disponible', value: 3214},
	{Index:'6', Desc:'Próxima Hora MW', value: 2514},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'66', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'73', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'11', Cost:31.50, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:19.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:19.74, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.08, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'33', Cost:18.88, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'148', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'84', Cost:9.42, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 6, MVar:'4', Cost:18.32, ParentId: '19'},
			{Index:'1', Unit:'Ilumina', MW: 10, MVar:'1', Cost:21.43, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 19, MVar:'3', Cost:17, ParentId: '19'},
		]
	},
