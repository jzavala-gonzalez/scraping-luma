const timestamp_saved = '12/04/2023 05:00 PM';
const dataFechaAcualizado = '12/4/2023' + ' 12:56:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2132},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'53', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'55', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'56', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'76', Cost:11.45, ParentId: '17'},
		]
	},
