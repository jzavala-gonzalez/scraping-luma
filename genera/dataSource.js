const timestamp_saved = '11/17/2023 06:15 AM';
const dataFechaAcualizado = '11/17/2023' + ' 2:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'53', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'53', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'42', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'80', Cost:9.76, ParentId: '17'},
		]
	},
