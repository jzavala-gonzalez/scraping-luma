const timestamp_saved = '10/27/2023 06:00 PM';
const dataFechaAcualizado = '10/27/2023' + ' 1:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'54', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'54', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:18.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'8', Cost:18.28, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 73,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'4', Cost:32.36, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'88', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'112', Cost:17.64, ParentId: '16'},
		]
	},
