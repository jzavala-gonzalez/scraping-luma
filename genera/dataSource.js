const timestamp_saved = '07/29/2023 08:50 PM';
const dataFechaAcualizado = '7/29/2023' + ' 4:45:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'52', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 148, MVar:'13', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'5', Cost:22.43, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'46', Cost:19.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:19.33, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 83,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'8', Cost:28.45, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:30.78, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 336,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'118', Cost:16.53, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'90', Cost:10.93, ParentId: '17'},
		]
	},
