const timestamp_saved = '09/29/2023 03:50 PM';
const dataFechaAcualizado = '9/29/2023' + ' 11:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'38', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'36', Cost:10.84, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'13', Cost:19.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'93', Cost:9.44, ParentId: '17'},
		]
	},
