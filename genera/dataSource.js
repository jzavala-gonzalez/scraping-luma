const timestamp_saved = '11/06/2023 12:40 AM';
const dataFechaAcualizado = '11/5/2023' + ' 8:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'53', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'53', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'49', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 195,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 53, MVar:'0', Cost:21.82, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'143', Cost:17.16, ParentId: '16'},
		]
	},
