const timestamp_saved = '08/03/2023 10:10 AM';
const dataFechaAcualizado = '8/3/2023' + ' 6:05:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'40', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 245,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'38', Cost:16.86, ParentId: '15'},
		]
	},
