const timestamp_saved = '11/23/2023 09:55 PM';
const dataFechaAcualizado = '11/23/2023' + ' 5:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'26', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'36', Cost:10.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.11, ParentId: '11'},
