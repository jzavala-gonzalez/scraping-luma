const timestamp_saved = '10/05/2023 11:30 AM';
const dataFechaAcualizado = '10/5/2023' + ' 7:26:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'34', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'32', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:17.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:17.42, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'89', Cost:9.33, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'19', Cost:19.60, ParentId: '19'},
