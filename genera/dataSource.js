const timestamp_saved = '11/28/2023 01:55 PM';
const dataFechaAcualizado = '11/28/2023' + ' 9:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'32', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'43', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'55', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'94', Cost:9.45, ParentId: '17'},
		]
	},
