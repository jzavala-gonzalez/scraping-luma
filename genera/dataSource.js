const timestamp_saved = '10/31/2023 06:25 AM';
const dataFechaAcualizado = '10/31/2023' + ' 2:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'49', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'58', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'58', Cost:9.17, ParentId: '17'},
		]
	},
