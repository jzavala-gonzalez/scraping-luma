const timestamp_saved = '09/25/2023 05:55 AM';
const dataFechaAcualizado = '9/25/2023' + ' 1:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'52', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'53', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'61', Cost:10.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 96, MVar:'0', Cost:5.06, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:20.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:20.46, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'75', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'102', Cost:9.05, ParentId: '17'},
		]
	},
