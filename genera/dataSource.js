const timestamp_saved = '10/24/2023 09:10 AM';
const dataFechaAcualizado = '10/24/2023' + ' 5:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'42', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'43', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'46', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'63', Cost:11.29, ParentId: '17'},
		]
	},
