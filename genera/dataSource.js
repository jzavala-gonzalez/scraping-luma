const timestamp_saved = '08/09/2023 04:36 PM';
const dataFechaAcualizado = '8/9/2023' + ' 12:30:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'57', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'58', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 15,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 15, MVar:'1', Cost:26.90, ParentId: '9'},
