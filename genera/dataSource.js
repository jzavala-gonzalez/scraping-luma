const timestamp_saved = '11/21/2023 04:50 AM';
const dataFechaAcualizado = '11/21/2023' + ' 12:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'24', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'35', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'49', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'47', Cost:18.44, ParentId: '15'},
