const timestamp_saved = '09/23/2023 12:30 AM';
const dataFechaAcualizado = '9/22/2023' + ' 8:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'55', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 209, MVar:'67', Cost:9.76, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'11', Cost:28.09, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'9', Cost:31.17, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'11', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 179,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 179, MVar:'66', Cost:16.46, ParentId: '15'},
