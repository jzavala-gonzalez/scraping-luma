const timestamp_saved = '09/28/2023 07:50 PM';
const dataFechaAcualizado = '9/28/2023' + ' 3:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'50', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'52', Cost:10.27, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:10.41, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'28', Cost:30.99, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'8', Cost:36.98, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'98', Cost:17.02, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'151', Cost:17.18, ParentId: '16'},
		]
	},
