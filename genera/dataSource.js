const timestamp_saved = '11/25/2023 03:50 AM';
const dataFechaAcualizado = '11/24/2023' + ' 11:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 156,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 156, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'26', Cost:12.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'35', Cost:12.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'52', Cost:12.64, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.72, ParentId: '14'},
