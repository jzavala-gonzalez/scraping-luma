const timestamp_saved = '09/26/2023 06:30 PM';
const dataFechaAcualizado = '9/26/2023' + ' 2:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'53', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'52', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'58', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.65, ParentId: '11'},
