const timestamp_saved = '08/10/2023 07:05 PM';
const dataFechaAcualizado = '8/10/2023' + ' 3:00:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'60', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'57', Cost:10.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 120,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 144, MVar:'29', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 114,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 60, MVar:'7', Cost:31.25, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 54, MVar:'8', Cost:30.89, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'179', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'136', Cost:11.28, ParentId: '17'},
		]
	},
