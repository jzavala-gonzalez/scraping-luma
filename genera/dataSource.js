const timestamp_saved = '10/30/2023 01:10 PM';
const dataFechaAcualizado = '10/30/2023' + ' 9:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'56', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'54', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 104, MVar:'30', Cost:17.23, ParentId: '11'},
