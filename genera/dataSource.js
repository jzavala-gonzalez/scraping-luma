const timestamp_saved = '09/16/2023 06:25 AM';
const dataFechaAcualizado = '9/16/2023' + ' 2:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'46', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'44', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'60', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'85', Cost:9.45, ParentId: '17'},
		]
	},
