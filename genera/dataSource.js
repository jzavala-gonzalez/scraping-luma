const timestamp_saved = '10/04/2023 07:10 PM';
const dataFechaAcualizado = '10/4/2023' + ' 3:06:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'47', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'45', Cost:10.72, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'86', Cost:17.05, ParentId: '15'},
