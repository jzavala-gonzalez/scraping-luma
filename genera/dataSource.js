const timestamp_saved = '10/18/2023 06:50 AM';
const dataFechaAcualizado = '10/18/2023' + ' 2:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'41', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'45', Cost:10.27, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 185,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'158', Cost:20.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'87', Cost:10.68, ParentId: '17'},
		]
	},
