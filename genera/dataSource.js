const timestamp_saved = '10/01/2023 09:50 AM';
const dataFechaAcualizado = '10/1/2023' + ' 5:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 384,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 130, MVar:'56', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'29', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'27', Cost:11.16, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.59, ParentId: '11'},
