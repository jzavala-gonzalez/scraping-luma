const timestamp_saved = '10/08/2023 07:25 PM';
const dataFechaAcualizado = '10/8/2023' + ' 3:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'49', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'49', Cost:10.24, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'15', Cost:19.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'160', Cost:17.31, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'101', Cost:9.37, ParentId: '17'},
		]
	},
