const timestamp_saved = '11/20/2023 06:05 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 205,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'24', Cost:17.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'34', Cost:17.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 27, MVar:'56', Cost:17.89, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 39,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'5', Cost:29.74, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:30.93, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'15', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 134, MVar:'71', Cost:17.12, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'149', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'84', Cost:9.16, ParentId: '17'},
		]
	},
