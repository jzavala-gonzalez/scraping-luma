const timestamp_saved = '11/07/2023 06:45 PM';
const dataFechaAcualizado = '11/7/2023' + ' 2:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'52', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'52', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.62, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 23, MVar:'0', Cost:25.00, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'88', Cost:16.97, ParentId: '15'},
