const timestamp_saved = '11/22/2023 12:30 AM';
const dataFechaAcualizado = '11/21/2023' + ' 8:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'41', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'63', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'118', Cost:9.12, ParentId: '17'},
		]
	},
