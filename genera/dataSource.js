const timestamp_saved = '10/17/2023 02:10 PM';
const dataFechaAcualizado = '10/17/2023' + ' 10:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'60', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'60', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'59', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'12', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'83', Cost:16.69, ParentId: '15'},
