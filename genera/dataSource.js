const timestamp_saved = '08/20/2023 04:15 AM';
const dataFechaAcualizado = '8/20/2023' + ' 12:12:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'55', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'57', Cost:11.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 88, MVar:'0', Cost:1.53, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 138, MVar:'24', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'152', Cost:16.71, ParentId: '16'},
		]
	},
