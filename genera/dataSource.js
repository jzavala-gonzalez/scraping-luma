const timestamp_saved = '08/15/2023 05:10 AM';
const dataFechaAcualizado = '8/15/2023' + ' 1:07:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'47', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:10.92, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 122,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:30.18, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 161,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'0', Cost:21.45, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'3', Cost:23.02, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 215,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'169', Cost:18.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'119', Cost:11.63, ParentId: '17'},
		]
	},
