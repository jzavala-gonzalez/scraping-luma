const timestamp_saved = '10/19/2023 06:30 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'29', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'37', Cost:12.78, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'157', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'79', Cost:10.92, ParentId: '17'},
		]
	},
