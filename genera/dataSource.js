const timestamp_saved = '10/25/2023 08:05 PM';
const dataFechaAcualizado = '10/25/2023' + ' 4:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'47', Cost:10.54, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'152', Cost:17.39, ParentId: '16'},
		]
	},
