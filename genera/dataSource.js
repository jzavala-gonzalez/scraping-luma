const timestamp_saved = '10/26/2023 06:05 PM';
const dataFechaAcualizado = '10/26/2023' + ' 2:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'45', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'52', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'51', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:17.48, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.48, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'43', Cost:17.27, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:17.27, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'10', Cost:68.55, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'22', Cost:19.46, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'87', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'144', Cost:17.19, ParentId: '16'},
		]
	},
