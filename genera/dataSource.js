const timestamp_saved = '09/27/2023 06:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 2:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'30', Cost:10.79, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'81', Cost:9.12, ParentId: '17'},
		]
	},
