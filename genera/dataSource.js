const timestamp_saved = '10/19/2023 11:00 AM';
const dataFechaAcualizado = '10/19/2023' + ' 6:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'33', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'39', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'46', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'29', Cost:17.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:17.61, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 106, MVar:'34', Cost:8.62, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:8.62, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 33,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'8', Cost:0, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'145', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'95', Cost:10.54, ParentId: '17'},
		]
	},
