const timestamp_saved = '07/29/2023 08:10 AM';
const dataFechaAcualizado = '7/29/2023' + ' 4:05:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'44', Cost:11.36, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'5', Cost:31.00, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'13', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 282,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'80', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'24', Cost:15.87, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'73', Cost:13.61, ParentId: '17'},
		]
	},
