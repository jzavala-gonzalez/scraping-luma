const timestamp_saved = '10/15/2023 05:45 PM';
const dataFechaAcualizado = '10/15/2023' + ' 1:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'50', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'48', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'51', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.48, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'87', Cost:9.15, ParentId: '17'},
		]
	},
