const timestamp_saved = '12/01/2023 09:30 AM';
const dataFechaAcualizado = '12/1/2023' + ' 5:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'48', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'56', Cost:9.87, ParentId: '17'},
		]
	},
