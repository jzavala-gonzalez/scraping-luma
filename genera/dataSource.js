const timestamp_saved = '09/29/2023 09:05 AM';
const dataFechaAcualizado = '9/29/2023' + ' 5:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'31', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:13.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'47', Cost:13.51, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'114', Cost:17.81, ParentId: '16'},
		]
	},
