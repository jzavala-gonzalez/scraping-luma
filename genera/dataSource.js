const timestamp_saved = '08/28/2023 07:25 PM';
const dataFechaAcualizado = '8/28/2023' + ' 3:20:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'49', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'52', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'66', Cost:10.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 97,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 97, MVar:'0', Cost:4.83, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 140,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'3', Cost:22.90, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'33', Cost:31.03, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'37', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'99', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'180', Cost:17.23, ParentId: '16'},
		]
	},
