const timestamp_saved = '10/19/2023 04:20 AM';
const dataFechaAcualizado = '10/19/2023' + ' 12:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'36', Cost:12.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'44', Cost:12.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'48', Cost:12.73, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'1', Cost:18.89, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'97', Cost:10.53, ParentId: '17'},
		]
	},
