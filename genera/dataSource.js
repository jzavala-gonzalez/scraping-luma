const timestamp_saved = '10/12/2023 07:25 AM';
const dataFechaAcualizado = '10/12/2023' + ' 3:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'51', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'55', Cost:10.85, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:18.51, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'71', Cost:9.20, ParentId: '17'},
		]
	},
