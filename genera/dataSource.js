const timestamp_saved = '10/09/2023 11:35 AM';
const dataFechaAcualizado = '10/9/2023' + ' 7:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'74', Cost:4.38, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'43', Cost:10.57, ParentId: '7'},
		]
	},
