const timestamp_saved = '11/20/2023 06:25 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'26', Cost:13.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'36', Cost:13.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 82, MVar:'55', Cost:13.30, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:42.00, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:75.44, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'11', Cost:22.50, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'16', Cost:18.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 119, MVar:'67', Cost:17.58, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'87', Cost:9.16, ParentId: '17'},
		]
	},
