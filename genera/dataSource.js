const timestamp_saved = '10/22/2023 09:40 AM';
const dataFechaAcualizado = '10/22/2023' + ' 5:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'39', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'40', Cost:10.55, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'55', Cost:11.22, ParentId: '17'},
		]
	},
