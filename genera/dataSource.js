const timestamp_saved = '12/03/2023 11:50 AM';
const dataFechaAcualizado = '12/3/2023' + ' 7:46:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1811},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'37', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'39', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'44', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.83, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'93', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'51', Cost:11.65, ParentId: '17'},
		]
	},
