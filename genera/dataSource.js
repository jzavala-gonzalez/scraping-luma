const timestamp_saved = '11/10/2023 01:10 PM';
const dataFechaAcualizado = '11/10/2023' + ' 9:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'52', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'59', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'47', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'46', Cost:17.26, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'11', Cost:21.88, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'76', Cost:9.56, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 33,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 26, MVar:'24', Cost:19.60, ParentId: '19'},
