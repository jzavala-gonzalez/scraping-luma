const timestamp_saved = '09/14/2023 01:25 AM';
const dataFechaAcualizado = '9/13/2023' + ' 9:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 558,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'68', Cost:9.78, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 70, MVar:'0', Cost:6.93, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'5', Cost:26.43, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.62, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.66, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'6', Cost:26.51, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:19.99, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'11', Cost:28.53, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'24', Cost:18.59, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'72', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'193', Cost:16.68, ParentId: '16'},
		]
	},
