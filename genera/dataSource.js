const timestamp_saved = '08/07/2023 06:45 AM';
const dataFechaAcualizado = '8/7/2023' + ' 2:40:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'62', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'88', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'43', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:30.10, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'7', Cost:31.30, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'5', Cost:19.19, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 206,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'50', Cost:18.49, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 106, MVar:'25', Cost:15.94, ParentId: '15'},
		]
	},
