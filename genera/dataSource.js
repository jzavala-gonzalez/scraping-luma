const timestamp_saved = '10/21/2023 04:15 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'38', Cost:13.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'35', Cost:13.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'39', Cost:13.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.08, ParentId: '11'},
		]
	},
