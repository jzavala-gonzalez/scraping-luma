const timestamp_saved = '10/22/2023 12:20 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'37', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'38', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.45, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'3', Cost:19.06, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'53', Cost:11.24, ParentId: '17'},
		]
	},
