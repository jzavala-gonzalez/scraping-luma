const timestamp_saved = '09/27/2023 05:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 1:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'31', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'32', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'64', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:18.42, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'142', Cost:17.49, ParentId: '16'},
		]
	},
