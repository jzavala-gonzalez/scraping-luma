const timestamp_saved = '12/04/2023 02:35 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'48', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'50', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'53', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'82', Cost:10.92, ParentId: '17'},
		]
	},
