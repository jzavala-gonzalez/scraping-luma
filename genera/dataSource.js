const timestamp_saved = '11/16/2023 03:55 PM';
const dataFechaAcualizado = '11/16/2023' + ' 11:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'52', Cost:13.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'52', Cost:13.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'52', Cost:13.04, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'146', Cost:19.02, ParentId: '16'},
		]
	},
