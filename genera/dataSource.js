const timestamp_saved = '11/16/2023 04:25 PM';
const dataFechaAcualizado = '11/16/2023' + ' 12:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'51', Cost:13.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'51', Cost:13.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'52', Cost:13.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:17.18, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'24', Cost:18.93, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'148', Cost:18.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'84', Cost:9.74, ParentId: '17'},
		]
	},
