const timestamp_saved = '11/05/2023 02:05 PM';
const dataFechaAcualizado = '11/5/2023' + ' 10:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'41', Cost:13.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'40', Cost:13.51, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'75', Cost:18.37, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'50', Cost:9.76, ParentId: '17'},
		]
	},
