const timestamp_saved = '09/04/2023 10:40 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:11.03, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'61', Cost:9.80, ParentId: '17'},
		]
	},
