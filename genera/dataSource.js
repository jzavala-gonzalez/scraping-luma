const timestamp_saved = '11/09/2023 02:35 PM';
const dataFechaAcualizado = '11/9/2023' + ' 10:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'51', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'49', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'52', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:16.88, ParentId: '11'},
