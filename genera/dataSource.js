const timestamp_saved = '09/04/2023 02:35 AM';
const dataFechaAcualizado = '9/3/2023' + ' 10:30:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'41', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'44', Cost:11.17, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'26', Cost:18.97, ParentId: '14'},
