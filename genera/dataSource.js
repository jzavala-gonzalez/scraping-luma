const timestamp_saved = '11/26/2023 01:50 AM';
const dataFechaAcualizado = '11/25/2023' + ' 9:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'29', Cost:12.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'40', Cost:12.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'55', Cost:12.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'20', Cost:30.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'47', Cost:17.40, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'20', Cost:9.20, ParentId: '17'},
		]
	},
