const timestamp_saved = '09/19/2023 04:05 AM';
const dataFechaAcualizado = '9/19/2023' + ' 12:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'50', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'51', Cost:10.45, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:9.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:9.97, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'169', Cost:16.68, ParentId: '16'},
		]
	},
