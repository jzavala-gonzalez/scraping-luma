const timestamp_saved = '08/29/2023 05:35 PM';
const dataFechaAcualizado = '8/29/2023' + ' 1:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'84', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'81', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'62', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'64', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'68', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'20', Cost:30.90, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:17.05, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'34', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'108', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'147', Cost:17.30, ParentId: '16'},
		]
	},
