const timestamp_saved = '10/21/2023 01:45 PM';
const dataFechaAcualizado = '10/21/2023' + ' 9:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'39', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'36', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'37', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'67', Cost:16.92, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'71', Cost:11.06, ParentId: '17'},
		]
	},
