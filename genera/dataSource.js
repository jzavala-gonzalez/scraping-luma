const timestamp_saved = '08/06/2023 12:40 AM';
const dataFechaAcualizado = '8/5/2023' + ' 8:35:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'56', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'55', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 205, MVar:'55', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'4', Cost:21.96, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.85, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'10', Cost:22.60, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:22.16, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'26', Cost:28.02, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'27', Cost:28.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:27.99, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'0', Cost:27.36, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'5', Cost:28.65, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'111', Cost:16.54, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'30', Cost:15.52, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'118', Cost:11.55, ParentId: '17'},
		]
	},
