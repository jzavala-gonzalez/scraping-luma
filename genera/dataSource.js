const timestamp_saved = '08/20/2023 09:15 AM';
const dataFechaAcualizado = '8/20/2023' + ' 5:12:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'49', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'54', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:31.02, ParentId: '10'},
		]
	},
