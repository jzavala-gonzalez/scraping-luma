const timestamp_saved = '10/20/2023 05:05 AM';
const dataFechaAcualizado = '10/20/2023' + ' 1:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'39', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'44', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'43', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.34, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'55', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 181,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'133', Cost:18.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'89', Cost:10.56, ParentId: '17'},
		]
	},
