const timestamp_saved = '08/23/2023 03:40 AM';
const dataFechaAcualizado = '8/22/2023' + ' 11:35:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'46', Cost:10.98, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'8', Cost:19.65, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'122', Cost:17.51, ParentId: '16'},
		]
	},
