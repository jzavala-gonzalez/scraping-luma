const timestamp_saved = '10/19/2023 11:50 PM';
const dataFechaAcualizado = '10/19/2023' + ' 7:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'43', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.46, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'11', Cost:31.31, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.27, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.29, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'197', Cost:16.83, ParentId: '16'},
		]
	},
