const timestamp_saved = '11/14/2023 04:25 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'50', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'55', Cost:11.57, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.13, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'94', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 105, MVar:'157', Cost:25.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'103', Cost:10.94, ParentId: '17'},
		]
	},
