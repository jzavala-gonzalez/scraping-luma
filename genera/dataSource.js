const timestamp_saved = '11/11/2023 08:55 AM';
const dataFechaAcualizado = '11/11/2023' + ' 4:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'41', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'43', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'42', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'67', Cost:9.75, ParentId: '17'},
		]
	},
