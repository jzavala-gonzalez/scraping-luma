const timestamp_saved = '12/01/2023 08:55 AM';
const dataFechaAcualizado = '12/1/2023' + ' 4:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'39', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'40', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'53', Cost:9.87, ParentId: '17'},
		]
	},
