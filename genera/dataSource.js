const timestamp_saved = '10/28/2023 05:55 AM';
const dataFechaAcualizado = '10/28/2023' + ' 1:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'41', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'43', Cost:10.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 51, MVar:'16', Cost:32.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:32.42, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'13', Cost:23.73, ParentId: '14'},
