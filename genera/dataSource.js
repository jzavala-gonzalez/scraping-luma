const timestamp_saved = '11/30/2023 02:50 PM';
const dataFechaAcualizado = '11/30/2023' + ' 10:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'50', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'52', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'53', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'75', Cost:9.56, ParentId: '17'},
		]
	},
