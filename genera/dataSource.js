const timestamp_saved = '10/22/2023 09:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'49', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'50', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'47', Cost:10.40, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 14,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 14, MVar:'0', Cost:19.43, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'124', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'70', Cost:11.29, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 27,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:19.43, ParentId: '21'},
