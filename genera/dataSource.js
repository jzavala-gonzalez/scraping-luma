const timestamp_saved = '12/03/2023 04:55 PM';
const dataFechaAcualizado = '12/3/2023' + ' 12:51:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 773},
	{Index:'4', Desc:'Reserva Operacional', value: 1410},
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'91', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 232,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 232, MVar:'50', Cost:11.90, ParentId: '17'},
		]
	},
