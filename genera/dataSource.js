const timestamp_saved = '08/21/2023 03:05 AM';
const dataFechaAcualizado = '8/20/2023' + ' 11:02:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'59', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'37', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'60', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 1,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'1', Cost:27.30, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'68', Cost:17.34, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'153', Cost:17.25, ParentId: '16'},
		]
	},
