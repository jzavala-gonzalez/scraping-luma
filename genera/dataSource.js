const timestamp_saved = '10/01/2023 06:35 PM';
const dataFechaAcualizado = '10/1/2023' + ' 2:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'37', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'35', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'49', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 252,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 89, MVar:'0', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'11', Cost:19.41, ParentId: '14'},
