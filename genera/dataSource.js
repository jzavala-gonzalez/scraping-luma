const timestamp_saved = '11/11/2023 07:20 AM';
const dataFechaAcualizado = '11/11/2023' + ' 3:16:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1992},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'41', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'44', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'43', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.35, ParentId: '11'},
