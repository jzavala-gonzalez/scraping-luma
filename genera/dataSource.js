const timestamp_saved = '11/24/2023 03:05 PM';
const dataFechaAcualizado = '11/24/2023' + ' 11:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'26', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'35', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'50', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'77', Cost:9.62, ParentId: '17'},
		]
	},
