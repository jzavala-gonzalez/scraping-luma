const timestamp_saved = '10/20/2023 06:45 AM';
const dataFechaAcualizado = '10/20/2023' + ' 2:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'33', Cost:11.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'40', Cost:11.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'41', Cost:11.63, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'79', Cost:10.54, ParentId: '17'},
		]
	},
