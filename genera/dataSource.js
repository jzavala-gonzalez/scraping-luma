const timestamp_saved = '11/06/2023 07:45 AM';
const dataFechaAcualizado = '11/6/2023' + ' 3:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'40', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'40', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'74', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'45', Cost:9.82, ParentId: '17'},
		]
	},
