const timestamp_saved = '08/31/2023 04:30 AM';
const dataFechaAcualizado = '8/31/2023' + ' 12:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'46', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'84', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'41', Cost:13.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'52', Cost:13.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'63', Cost:13.41, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'76', Cost:17.11, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 344, MVar:'148', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'77', Cost:9.20, ParentId: '17'},
		]
	},
