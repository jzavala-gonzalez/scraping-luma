const timestamp_saved = '09/07/2023 09:55 AM';
const dataFechaAcualizado = '9/7/2023' + ' 5:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:19.80, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'93', Cost:9.79, ParentId: '17'},
		]
	},
