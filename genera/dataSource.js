const timestamp_saved = '11/17/2023 03:55 AM';
const dataFechaAcualizado = '11/16/2023' + ' 11:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'61', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'61', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'46', Cost:10.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:35.06, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'16', Cost:30.86, ParentId: '13'},
