const timestamp_saved = '07/31/2023 07:45 AM';
const dataFechaAcualizado = '7/31/2023' + ' 3:40:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'42', Cost:11.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'35', Cost:19.71, ParentId: '11'},
