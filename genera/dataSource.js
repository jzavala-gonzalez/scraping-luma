const timestamp_saved = '09/03/2023 04:30 PM';
const dataFechaAcualizado = '9/3/2023' + ' 12:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'38', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'42', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'54', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 109,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 109, MVar:'80', Cost:18.47, ParentId: '15'},
