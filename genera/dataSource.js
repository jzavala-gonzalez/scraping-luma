const timestamp_saved = '09/29/2023 10:50 AM';
const dataFechaAcualizado = '9/29/2023' + ' 6:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'54', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'32', Cost:12.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'29', Cost:12.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'48', Cost:12.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:8.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:8.78, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'67', Cost:16.50, ParentId: '15'},
