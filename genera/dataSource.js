const timestamp_saved = '12/06/2023 02:20 AM';
const dataFechaAcualizado = '12/5/2023' + ' 10:15:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 717},
	{Index:'7', Desc:'Capacidad Disponible', value: 3112},
	{Index:'8', Desc:'Próxima Hora MW', value: 2389},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'52', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'56', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'61', Cost:10.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 48, MVar:'0', Cost:10.71, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'86', Cost:10.89, ParentId: '17'},
		]
	},
