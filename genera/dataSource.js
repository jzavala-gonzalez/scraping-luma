const timestamp_saved = '12/05/2023 05:45 AM';
const dataFechaAcualizado = '12/5/2023' + ' 1:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'41', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'42', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'51', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'57', Cost:10.70, ParentId: '17'},
		]
	},
