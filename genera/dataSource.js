const timestamp_saved = '09/30/2023 05:35 PM';
const dataFechaAcualizado = '9/30/2023' + ' 1:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'37', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'35', Cost:10.10, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:18.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:18.43, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'77', Cost:16.79, ParentId: '15'},
