const timestamp_saved = '08/27/2023 10:55 PM';
const dataFechaAcualizado = '8/27/2023' + ' 6:50:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'44', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'47', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'2', Cost:27.44, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'3', Cost:26.60, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'18', Cost:30.79, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:30.00, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:30.80, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:19.19, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'167', Cost:17.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'107', Cost:11.64, ParentId: '17'},
		]
	},
