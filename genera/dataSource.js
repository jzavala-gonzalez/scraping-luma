const timestamp_saved = '09/12/2023 09:15 PM';
const dataFechaAcualizado = '9/12/2023' + ' 5:10:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'70', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'78', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'56', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'67', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 51, MVar:'0', Cost:14.86, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 151, MVar:'79', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 137, MVar:'0', Cost:8.16, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:30.69, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'35', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'108', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'153', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'87', Cost:9.13, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 18,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'17', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 4, MVar:'18', Cost:17, ParentId: '19'},
		]
	},
