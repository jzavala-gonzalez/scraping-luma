const timestamp_saved = '07/29/2023 02:30 PM';
const dataFechaAcualizado = '7/29/2023' + ' 10:25:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 148, MVar:'49', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 286,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'34', Cost:19.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:19.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:18.34, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'7', Cost:18.34, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'98', Cost:17.32, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'94', Cost:13.33, ParentId: '17'},
		]
	},
