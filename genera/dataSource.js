const timestamp_saved = '09/23/2023 09:15 AM';
const dataFechaAcualizado = '9/23/2023' + ' 5:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'70', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'37', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'39', Cost:12.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'54', Cost:12.88, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:19.41, ParentId: '14'},
