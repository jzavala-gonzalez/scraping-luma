const timestamp_saved = '12/03/2023 01:25 AM';
const dataFechaAcualizado = '12/2/2023' + ' 9:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'56', Cost:10.62, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'96', Cost:10.84, ParentId: '17'},
		]
	},
