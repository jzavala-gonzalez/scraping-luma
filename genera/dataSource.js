const timestamp_saved = '11/05/2023 01:50 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:46:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1909},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'41', Cost:13.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'41', Cost:13.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:8.79, ParentId: '11'},
