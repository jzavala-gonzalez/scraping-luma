const timestamp_saved = '09/22/2023 02:15 AM';
const dataFechaAcualizado = '9/21/2023' + ' 10:10:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'41', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:10.79, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:26.09, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'7', Cost:28.02, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'3', Cost:29.69, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'77', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'111', Cost:32.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'100', Cost:16.07, ParentId: '17'},
		]
	},
