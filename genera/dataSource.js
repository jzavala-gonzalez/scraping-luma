const timestamp_saved = '09/23/2023 05:45 AM';
const dataFechaAcualizado = '9/23/2023' + ' 1:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 162, MVar:'74', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'44', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'58', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:27.76, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'56', Cost:16.51, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'82', Cost:9.44, ParentId: '17'},
		]
	},
