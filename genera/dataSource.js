const timestamp_saved = '09/06/2023 09:10 AM';
const dataFechaAcualizado = '9/6/2023' + ' 5:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'42', Cost:13.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'44', Cost:13.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'58', Cost:13.27, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'138', Cost:17.23, ParentId: '16'},
		]
	},
