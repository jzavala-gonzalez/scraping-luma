const timestamp_saved = '10/11/2023 03:25 AM';
const dataFechaAcualizado = '10/10/2023' + ' 11:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'58', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'63', Cost:11.04, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'8', Cost:28.43, ParentId: '10'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 74,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.47, ParentId: '21'},
