const timestamp_saved = '11/23/2023 08:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 4:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 209, MVar:'60', Cost:4.38, ParentId: '6'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 221,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 221, MVar:'108', Cost:18.39, ParentId: '16'},
		]
	},
