const timestamp_saved = '11/21/2023 11:35 AM';
const dataFechaAcualizado = '11/21/2023' + ' 7:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'34', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'51', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'76', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'76', Cost:9.60, ParentId: '17'},
		]
	},
