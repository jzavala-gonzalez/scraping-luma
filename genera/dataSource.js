const timestamp_saved = '11/04/2023 04:06 PM';
const dataFechaAcualizado = '11/4/2023' + ' 12:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'44', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'43', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'86', Cost:16.90, ParentId: '15'},
