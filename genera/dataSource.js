const timestamp_saved = '08/02/2023 08:20 AM';
const dataFechaAcualizado = '8/2/2023' + ' 4:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'40', Cost:11.22, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'71', Cost:17.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'44', Cost:16.06, ParentId: '15'},
		]
	},
