const timestamp_saved = '08/20/2023 08:55 AM';
const dataFechaAcualizado = '8/20/2023' + ' 4:52:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'50', Cost:11.13, ParentId: '7'},
