const timestamp_saved = '10/26/2023 04:25 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:21:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2273},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'50', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 162, MVar:'51', Cost:10.61, ParentId: '7'},
		]
	},
