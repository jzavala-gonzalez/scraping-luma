const timestamp_saved = '10/31/2023 06:50 PM';
const dataFechaAcualizado = '10/31/2023' + ' 2:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'61', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'66', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'69', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.48, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'14', Cost:20.90, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'92', Cost:9.17, ParentId: '17'},
		]
	},
