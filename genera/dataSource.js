const timestamp_saved = '10/21/2023 06:35 PM';
const dataFechaAcualizado = '10/21/2023' + ' 2:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'47', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'48', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'70', Cost:11.03, ParentId: '17'},
		]
	},
