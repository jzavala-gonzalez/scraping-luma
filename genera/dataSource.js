const timestamp_saved = '09/03/2023 09:15 AM';
const dataFechaAcualizado = '9/3/2023' + ' 5:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'35', Cost:12.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:12.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'56', Cost:12.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:0.86, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'50', Cost:16.82, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'57', Cost:9.06, ParentId: '17'},
		]
	},
