const timestamp_saved = '10/20/2023 03:10 PM';
const dataFechaAcualizado = '10/20/2023' + ' 11:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'44', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'51', Cost:11.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 285, MVar:'161', Cost:17.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'107', Cost:10.80, ParentId: '17'},
		]
	},
