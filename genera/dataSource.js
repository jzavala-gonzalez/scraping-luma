const timestamp_saved = '09/25/2023 09:00 AM';
const dataFechaAcualizado = '9/25/2023' + ' 4:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'37', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'37', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'49', Cost:11.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:28.06, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:20.15, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'38', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 88,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 88, MVar:'121', Cost:28.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'74', Cost:9.88, ParentId: '17'},
		]
	},
