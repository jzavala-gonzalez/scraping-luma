const timestamp_saved = '10/08/2023 08:05 AM';
const dataFechaAcualizado = '10/8/2023' + ' 4:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'36', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'37', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'39', Cost:11.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'34', Cost:17.57, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'72', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'131', Cost:16.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 155, MVar:'67', Cost:11.57, ParentId: '17'},
		]
	},
