const timestamp_saved = '08/17/2023 06:55 AM';
const dataFechaAcualizado = '8/17/2023' + ' 2:52:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'57', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'68', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:31.08, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'70', Cost:9.41, ParentId: '17'},
		]
	},
