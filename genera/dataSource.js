const timestamp_saved = '09/16/2023 11:20 AM';
const dataFechaAcualizado = '9/16/2023' + ' 7:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'42', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'41', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'80', Cost:9.46, ParentId: '17'},
		]
	},
