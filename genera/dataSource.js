const timestamp_saved = '11/11/2023 07:20 PM';
const dataFechaAcualizado = '11/11/2023' + ' 3:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'51', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'57', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'14', Cost:31.41, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'10', Cost:22.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'100', Cost:9.22, ParentId: '17'},
		]
	},
