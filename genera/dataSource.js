const timestamp_saved = '10/02/2023 09:15 PM';
const dataFechaAcualizado = '10/2/2023' + ' 5:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'99', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'45', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'43', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'56', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 184,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:22.05, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 37, MVar:'8', Cost:29.63, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'33', Cost:17.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.70, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:30.94, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:30.94, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'93', Cost:16.89, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 7,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 4, MVar:'32', Cost:19.60, ParentId: '19'},
