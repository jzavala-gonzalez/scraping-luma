const timestamp_saved = '10/31/2023 07:05 AM';
const dataFechaAcualizado = '10/31/2023' + ' 3:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'51', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'58', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'53', Cost:9.42, ParentId: '17'},
		]
	},
