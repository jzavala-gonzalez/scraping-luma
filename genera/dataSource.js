const timestamp_saved = '10/02/2023 10:30 AM';
const dataFechaAcualizado = '10/2/2023' + ' 6:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'36', Cost:10.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.07, ParentId: '11'},
