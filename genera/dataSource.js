const timestamp_saved = '10/25/2023 04:35 AM';
const dataFechaAcualizado = '10/25/2023' + ' 12:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'44', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 12, MVar:'0', Cost:27.12, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 210,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'133', Cost:18.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'1', Cost:11.27, ParentId: '17'},
		]
	},
