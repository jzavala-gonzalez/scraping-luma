const timestamp_saved = '11/02/2023 12:35 PM';
const dataFechaAcualizado = '11/2/2023' + ' 8:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'54', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'52', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 192,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'127', Cost:19.51, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 51,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 21, MVar:'14', Cost:19.60, ParentId: '19'},
