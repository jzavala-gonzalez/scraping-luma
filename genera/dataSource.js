const timestamp_saved = '10/17/2023 04:55 AM';
const dataFechaAcualizado = '10/17/2023' + ' 12:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'55', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'60', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'61', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 136, MVar:'41', Cost:16.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:16.37, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 34,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:31.16, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'152', Cost:17.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'71', Cost:9.42, ParentId: '17'},
		]
	},
