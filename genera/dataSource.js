const timestamp_saved = '10/26/2023 05:35 AM';
const dataFechaAcualizado = '10/26/2023' + ' 1:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'41', Cost:10.75, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:17.18, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'13', Cost:19.38, ParentId: '14'},
