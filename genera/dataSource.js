const timestamp_saved = '11/15/2023 11:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 7:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'40', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'43', Cost:11.01, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:18.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.16, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'14', Cost:22.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'73', Cost:18.44, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'73', Cost:9.79, ParentId: '17'},
		]
	},
