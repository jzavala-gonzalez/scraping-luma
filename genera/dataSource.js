const timestamp_saved = '07/29/2023 01:10 PM';
const dataFechaAcualizado = '7/29/2023' + ' 9:05:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:20.38, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 241,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'88', Cost:17.64, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'23', Cost:16.32, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'83', Cost:13.63, ParentId: '17'},
		]
	},
