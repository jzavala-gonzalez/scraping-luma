const timestamp_saved = '08/08/2023 03:05 AM';
const dataFechaAcualizado = '8/7/2023' + ' 11:00:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'63', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'77', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:9.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:9.76, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:33.00, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:32.71, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 42,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 12, MVar:'2', Cost:27.41, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'29', Cost:15.68, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'158', Cost:17.26, ParentId: '16'},
		]
	},
