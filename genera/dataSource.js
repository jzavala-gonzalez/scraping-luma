const timestamp_saved = '09/21/2023 12:10 AM';
const dataFechaAcualizado = '9/20/2023' + ' 8:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'51', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'55', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'62', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'20', Cost:26.61, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'189', Cost:16.79, ParentId: '16'},
		]
	},
