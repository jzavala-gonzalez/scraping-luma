const timestamp_saved = '09/17/2023 10:55 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'41', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'42', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.65, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'9', Cost:8.65, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'22', Cost:19.03, ParentId: '14'},
