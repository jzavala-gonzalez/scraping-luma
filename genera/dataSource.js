const timestamp_saved = '09/18/2023 12:00 PM';
const dataFechaAcualizado = '9/18/2023' + ' 7:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'66', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'48', Cost:10.28, ParentId: '7'},
