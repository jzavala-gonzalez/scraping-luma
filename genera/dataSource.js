const timestamp_saved = '10/10/2023 07:40 AM';
const dataFechaAcualizado = '10/10/2023' + ' 3:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'81', Cost:16.82, ParentId: '15'},
