const timestamp_saved = '09/26/2023 10:00 AM';
const dataFechaAcualizado = '9/26/2023' + ' 5:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'49', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'49', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'58', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'65', Cost:9.79, ParentId: '17'},
		]
	},
