const timestamp_saved = '08/02/2023 05:05 AM';
const dataFechaAcualizado = '8/2/2023' + ' 1:00:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:10.74, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'3', Cost:112.02, ParentId: '12'},
