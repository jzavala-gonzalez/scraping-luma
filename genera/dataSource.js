const timestamp_saved = '11/13/2023 11:40 PM';
const dataFechaAcualizado = '11/13/2023' + ' 7:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'64', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'68', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'66', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'17', Cost:31.03, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'17', Cost:31.24, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'90', Cost:16.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'131', Cost:10.88, ParentId: '17'},
		]
	},
