const timestamp_saved = '10/28/2023 12:25 AM';
const dataFechaAcualizado = '10/27/2023' + ' 8:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'48', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'49', Cost:11.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.41, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'9', Cost:22.07, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'134', Cost:17.65, ParentId: '16'},
		]
	},
