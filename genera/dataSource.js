const timestamp_saved = '10/29/2023 09:20 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'42', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'67', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 164,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 164, MVar:'50', Cost:10.31, ParentId: '17'},
		]
	},
