const timestamp_saved = '11/05/2023 01:10 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'41', Cost:12.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'41', Cost:12.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'41', Cost:12.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'37', Cost:17.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.33, ParentId: '11'},
