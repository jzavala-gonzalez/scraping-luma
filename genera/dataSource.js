const timestamp_saved = '08/30/2023 05:40 PM';
const dataFechaAcualizado = '8/30/2023' + ' 1:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'50', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'69', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'72', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:19.60, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'41', Cost:18.76, ParentId: '14'},
