const timestamp_saved = '08/19/2023 06:15 AM';
const dataFechaAcualizado = '8/19/2023' + ' 2:12:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'61', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'70', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'74', Cost:9.21, ParentId: '17'},
		]
	},
