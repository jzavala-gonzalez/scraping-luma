const timestamp_saved = '08/19/2023 06:00 PM';
const dataFechaAcualizado = '8/19/2023' + ' 1:57:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'54', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'54', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:26.90, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 105,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 105, MVar:'92', Cost:18.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'144', Cost:18.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 318, MVar:'70', Cost:9.31, ParentId: '17'},
		]
	},
