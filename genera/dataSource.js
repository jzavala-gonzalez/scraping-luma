const timestamp_saved = '11/28/2023 11:15 AM';
const dataFechaAcualizado = '11/28/2023' + ' 7:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'27', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'36', Cost:11.81, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'49', Cost:17.28, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'85', Cost:9.32, ParentId: '17'},
		]
	},
