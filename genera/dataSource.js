const timestamp_saved = '12/02/2023 02:35 AM';
const dataFechaAcualizado = '12/1/2023' + ' 10:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'53', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'55', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'13', Cost:17.46, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'4', Cost:31.78, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 224,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 224, MVar:'80', Cost:9.90, ParentId: '17'},
		]
	},
