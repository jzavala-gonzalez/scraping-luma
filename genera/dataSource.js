const timestamp_saved = '09/06/2023 05:30 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'45', Cost:12.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'48', Cost:12.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'59', Cost:12.67, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.66, ParentId: '14'},
