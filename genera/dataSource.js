const timestamp_saved = '11/23/2023 07:40 PM';
const dataFechaAcualizado = '11/23/2023' + ' 3:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'23', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'34', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'49', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'51', Cost:9.73, ParentId: '17'},
		]
	},
