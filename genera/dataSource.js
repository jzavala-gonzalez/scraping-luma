const timestamp_saved = '08/10/2023 08:50 PM';
const dataFechaAcualizado = '8/10/2023' + ' 4:45:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'58', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'57', Cost:10.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.10, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 44, MVar:'0', Cost:24.09, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.15, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'8', Cost:28.20, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'9', Cost:28.16, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 265,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 265, MVar:'187', Cost:17.58, ParentId: '16'},
		]
	},
