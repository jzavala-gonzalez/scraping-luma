const timestamp_saved = '12/02/2023 12:20 PM';
const dataFechaAcualizado = '12/2/2023' + ' 8:16:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1899},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'42', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'44', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'43', Cost:11.76, ParentId: '7'},
		]
	},
