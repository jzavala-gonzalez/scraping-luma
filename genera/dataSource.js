const timestamp_saved = '11/26/2023 08:05 PM';
const dataFechaAcualizado = '11/26/2023' + ' 4:01:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2129},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'32', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'42', Cost:10.35, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'88', Cost:9.61, ParentId: '17'},
		]
	},
