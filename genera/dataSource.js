const timestamp_saved = '10/04/2023 07:55 PM';
const dataFechaAcualizado = '10/4/2023' + ' 3:51:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'59', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'84', Cost:17.07, ParentId: '15'},
