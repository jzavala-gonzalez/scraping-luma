const timestamp_saved = '10/28/2023 11:10 AM';
const dataFechaAcualizado = '10/28/2023' + ' 7:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'38', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'18', Cost:31.22, ParentId: '11'},
