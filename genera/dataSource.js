const timestamp_saved = '11/26/2023 07:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 3:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'30', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'40', Cost:10.53, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'145', Cost:17.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'80', Cost:10.00, ParentId: '17'},
		]
	},
