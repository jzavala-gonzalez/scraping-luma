const timestamp_saved = '09/21/2023 08:25 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'38', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'42', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'61', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.03, ParentId: '9'},
