const timestamp_saved = '11/30/2023 04:15 PM';
const dataFechaAcualizado = '11/30/2023' + ' 12:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'49', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'51', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'72', Cost:9.82, ParentId: '17'},
		]
	},
