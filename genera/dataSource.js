const timestamp_saved = '11/23/2023 03:00 AM';
const dataFechaAcualizado = '11/22/2023' + ' 10:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'36', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'45', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:30.90, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 15, MVar:'0', Cost:31.15, ParentId: '12'},
