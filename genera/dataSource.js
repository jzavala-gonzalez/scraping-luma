const timestamp_saved = '09/29/2023 07:50 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'51', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'32', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'29', Cost:13.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'48', Cost:13.31, ParentId: '7'},
		]
	},
