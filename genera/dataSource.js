const timestamp_saved = '08/27/2023 06:10 PM';
const dataFechaAcualizado = '8/27/2023' + ' 2:05:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1156},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'61', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'76', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'30', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'30', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'59', Cost:10.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 123, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 55,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 55, MVar:'10', Cost:30.33, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'95', Cost:18.39, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'130', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 239,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 239, MVar:'86', Cost:12.54, ParentId: '17'},
		]
	},
