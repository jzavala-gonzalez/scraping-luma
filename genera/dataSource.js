const timestamp_saved = '10/04/2023 02:05 AM';
const dataFechaAcualizado = '10/3/2023' + ' 10:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'37', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'52', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'4', Cost:22.12, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.17, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.52, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'1', Cost:21.29, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.14, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'10', Cost:18.85, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'151', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'110', Cost:9.18, ParentId: '17'},
		]
	},
