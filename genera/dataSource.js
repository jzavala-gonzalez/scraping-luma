const timestamp_saved = '11/07/2023 06:20 PM';
const dataFechaAcualizado = '11/7/2023' + ' 2:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'50', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'47', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'51', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'49', Cost:17.11, ParentId: '11'},
