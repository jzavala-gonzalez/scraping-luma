const timestamp_saved = '09/15/2023 09:00 PM';
const dataFechaAcualizado = '9/15/2023' + ' 4:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'53', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'52', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'65', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.26, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:32.00, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:31.67, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'35', Cost:18.87, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'99', Cost:16.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'164', Cost:16.71, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 21,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'7', Cost:19.60, ParentId: '19'},
