const timestamp_saved = '09/30/2023 09:30 AM';
const dataFechaAcualizado = '9/30/2023' + ' 5:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'36', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'35', Cost:10.40, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 63,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 17, MVar:'0', Cost:26.62, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.25, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:28.03, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'13', Cost:19.53, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'130', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'101', Cost:9.52, ParentId: '17'},
		]
	},
