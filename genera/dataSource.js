const timestamp_saved = '08/14/2023 05:20 AM';
const dataFechaAcualizado = '8/14/2023' + ' 1:17:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'41', Cost:11.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 128,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 27, MVar:'0', Cost:29.18, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'1', Cost:21.04, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 227,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 227, MVar:'105', Cost:13.33, ParentId: '17'},
		]
	},
