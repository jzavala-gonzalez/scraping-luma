const timestamp_saved = '09/27/2023 06:15 PM';
const dataFechaAcualizado = '9/27/2023' + ' 2:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'33', Cost:10.46, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:17.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.54, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'0', Cost:20.81, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:20.81, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'11', Cost:19.43, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'180', Cost:17.38, ParentId: '16'},
		]
	},
