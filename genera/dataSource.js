const timestamp_saved = '09/11/2023 02:10 PM';
const dataFechaAcualizado = '9/11/2023' + ' 10:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 220, MVar:'60', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'74', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'67', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'64', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'74', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'6', Cost:30.96, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.12, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'87', Cost:16.91, ParentId: '15'},
