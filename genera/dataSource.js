const timestamp_saved = '09/12/2023 07:00 AM';
const dataFechaAcualizado = '9/12/2023' + ' 2:55:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'61', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'59', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'47', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'45', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'61', Cost:10.66, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.31, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:30.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:30.99, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.66, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 142,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 142, MVar:'112', Cost:20.31, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'33', Cost:10.42, ParentId: '17'},
		]
	},
