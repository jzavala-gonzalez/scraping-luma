const timestamp_saved = '11/17/2023 08:00 AM';
const dataFechaAcualizado = '11/17/2023' + ' 3:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'49', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'49', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'40', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.20, ParentId: '11'},
