const timestamp_saved = '08/03/2023 04:21 PM';
const dataFechaAcualizado = '8/3/2023' + ' 12:15:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 118, MVar:'23', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 295,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'100', Cost:17.12, ParentId: '15'},
