const timestamp_saved = '09/15/2023 12:20 PM';
const dataFechaAcualizado = '9/15/2023' + ' 8:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'54', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'52', Cost:10.63, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:31.13, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'21', Cost:19.15, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 44,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 13, MVar:'13', Cost:19.60, ParentId: '19'},
