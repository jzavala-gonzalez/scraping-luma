const timestamp_saved = '10/11/2023 06:35 PM';
const dataFechaAcualizado = '10/11/2023' + ' 2:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'66', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'71', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'71', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.84, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'34', Cost:18.32, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:18.32, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'20', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'102', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'188', Cost:17.42, ParentId: '16'},
		]
	},
