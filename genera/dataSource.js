const timestamp_saved = '08/03/2023 08:15 PM';
const dataFechaAcualizado = '8/3/2023' + ' 4:10:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 315,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'115', Cost:16.73, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'97', Cost:11.05, ParentId: '17'},
		]
	},
