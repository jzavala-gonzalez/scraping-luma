const timestamp_saved = '11/22/2023 10:30 AM';
const dataFechaAcualizado = '11/22/2023' + ' 6:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'28', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'39', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'51', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:17.35, ParentId: '11'},
