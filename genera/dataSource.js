const timestamp_saved = '08/16/2023 05:55 PM';
const dataFechaAcualizado = '8/16/2023' + ' 1:52:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'61', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'62', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 116,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 67, MVar:'16', Cost:30.49, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'8', Cost:32.38, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.83, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 266,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 266, MVar:'193', Cost:17.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'99', Cost:10.25, ParentId: '17'},
		]
	},
