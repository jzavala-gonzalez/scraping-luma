const timestamp_saved = '09/27/2023 05:25 PM';
const dataFechaAcualizado = '9/27/2023' + ' 1:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'32', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'32', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'64', Cost:11.05, ParentId: '7'},
		]
	},
