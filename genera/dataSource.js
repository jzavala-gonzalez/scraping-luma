const timestamp_saved = '08/06/2023 07:10 AM';
const dataFechaAcualizado = '8/6/2023' + ' 3:05:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'41', Cost:11.17, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 10, MVar:'1', Cost:22.32, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:31.25, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'76', Cost:16.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 161, MVar:'22', Cost:15.53, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'92', Cost:11.54, ParentId: '17'},
		]
	},
