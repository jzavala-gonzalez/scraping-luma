const timestamp_saved = '10/29/2023 05:25 AM';
const dataFechaAcualizado = '10/29/2023' + ' 1:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'37', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'38', Cost:10.65, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'114', Cost:19.70, ParentId: '16'},
		]
	},
