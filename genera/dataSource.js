const timestamp_saved = '10/01/2023 10:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 6:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'36', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'34', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'50', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 182,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 32, MVar:'7', Cost:27.88, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'42', Cost:17.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:17.07, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:2.53, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 32, MVar:'6', Cost:2.53, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'9', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'81', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'144', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'105', Cost:9.23, ParentId: '17'},
		]
	},
