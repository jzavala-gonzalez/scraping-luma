const timestamp_saved = '08/16/2023 07:45 PM';
const dataFechaAcualizado = '8/16/2023' + ' 3:42:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 470},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'66', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'75', Cost:10.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 161,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:30.63, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:34.94, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'6', Cost:26.48, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'12', Cost:31.00, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'6', Cost:29.73, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'35', Cost:19.23, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'198', Cost:17.06, ParentId: '16'},
		]
	},
