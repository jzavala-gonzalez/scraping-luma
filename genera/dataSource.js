const timestamp_saved = '10/16/2023 04:05 AM';
const dataFechaAcualizado = '10/16/2023' + ' 12:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'53', Cost:13.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'53', Cost:13.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'56', Cost:13.59, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:23.30, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:25.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'1', Cost:28.69, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'7', Cost:19.66, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'174', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'94', Cost:9.12, ParentId: '17'},
		]
	},
