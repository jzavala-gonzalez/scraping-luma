const timestamp_saved = '09/04/2023 06:50 PM';
const dataFechaAcualizado = '9/4/2023' + ' 2:45:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'43', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'47', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'58', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:19.93, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 12,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 12, MVar:'3', Cost:0, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'29', Cost:19.01, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'84', Cost:9.21, ParentId: '17'},
		]
	},
