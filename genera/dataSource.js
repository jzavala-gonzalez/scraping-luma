const timestamp_saved = '10/01/2023 07:05 PM';
const dataFechaAcualizado = '10/1/2023' + ' 3:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'33', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'31', Cost:10.51, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'7', Cost:29.51, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:17.33, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'11', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'101', Cost:9.21, ParentId: '17'},
		]
	},
