const timestamp_saved = '08/15/2023 06:05 PM';
const dataFechaAcualizado = '8/15/2023' + ' 2:02:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'55', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'52', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'54', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'30', Cost:19.03, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'125', Cost:11.65, ParentId: '17'},
		]
	},
