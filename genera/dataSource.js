const timestamp_saved = '11/16/2023 04:00 PM';
const dataFechaAcualizado = '11/16/2023' + ' 11:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'52', Cost:13.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'52', Cost:13.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'52', Cost:13.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'44', Cost:17.38, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'145', Cost:19.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'82', Cost:9.71, ParentId: '17'},
		]
	},
