const timestamp_saved = '11/18/2023 01:35 PM';
const dataFechaAcualizado = '11/18/2023' + ' 9:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'49', Cost:16.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'59', Cost:16.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:16.02, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:30.87, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:17.12, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.60, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.16, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:31.69, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 137, MVar:'88', Cost:16.53, ParentId: '15'},
