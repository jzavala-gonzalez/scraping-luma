const timestamp_saved = '10/30/2023 02:45 AM';
const dataFechaAcualizado = '10/29/2023' + ' 10:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'47', Cost:11.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'48', Cost:16.91, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'64', Cost:9.38, ParentId: '17'},
		]
	},
