const timestamp_saved = '11/25/2023 08:15 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 104, MVar:'45', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:17.90, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'118', Cost:17.41, ParentId: '16'},
		]
	},
