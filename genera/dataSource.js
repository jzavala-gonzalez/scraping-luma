const timestamp_saved = '08/15/2023 08:30 AM';
const dataFechaAcualizado = '8/15/2023' + ' 4:27:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'44', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'112', Cost:11.62, ParentId: '17'},
		]
	},
