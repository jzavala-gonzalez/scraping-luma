const timestamp_saved = '10/04/2023 10:20 AM';
const dataFechaAcualizado = '10/4/2023' + ' 6:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:10.11, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'7', Cost:26.80, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'82', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'149', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'105', Cost:9.19, ParentId: '17'},
		]
	},
