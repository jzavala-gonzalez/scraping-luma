const timestamp_saved = '11/04/2023 09:00 AM';
const dataFechaAcualizado = '11/4/2023' + ' 4:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'40', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 306,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'8', Cost:16.95, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'45', Cost:9.73, ParentId: '17'},
		]
	},
