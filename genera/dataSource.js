const timestamp_saved = '08/13/2023 05:35 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:32:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'34', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'38', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'40', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'145', Cost:17.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'104', Cost:12.22, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 105,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 37, MVar:'21', Cost:19.60, ParentId: '19'},
