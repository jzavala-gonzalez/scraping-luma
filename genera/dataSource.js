const timestamp_saved = '11/14/2023 05:40 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'43', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'48', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'53', Cost:12.86, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'18', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:31.63, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'89', Cost:10.96, ParentId: '17'},
		]
	},
