const timestamp_saved = '09/24/2023 05:30 AM';
const dataFechaAcualizado = '9/24/2023' + ' 1:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'41', Cost:12.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'44', Cost:12.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'54', Cost:12.94, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'2', Cost:28.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:30.88, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'83', Cost:9.22, ParentId: '17'},
		]
	},
