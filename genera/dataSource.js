const timestamp_saved = '10/06/2023 12:05 PM';
const dataFechaAcualizado = '10/6/2023' + ' 8:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'45', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'47', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'49', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'98', Cost:9.28, ParentId: '17'},
		]
	},
