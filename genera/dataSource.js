const timestamp_saved = '11/27/2023 01:20 AM';
const dataFechaAcualizado = '11/26/2023' + ' 9:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'37', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'48', Cost:10.55, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'102', Cost:9.31, ParentId: '17'},
		]
	},
