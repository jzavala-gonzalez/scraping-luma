const timestamp_saved = '09/13/2023 06:05 AM';
const dataFechaAcualizado = '9/13/2023' + ' 2:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'50', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'62', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:8.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'1', Cost:31.78, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'73', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'148', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 195,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 195, MVar:'76', Cost:10.52, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 64,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:21.72, ParentId: '21'},
