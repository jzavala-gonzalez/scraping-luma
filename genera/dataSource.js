const timestamp_saved = '11/12/2023 08:25 AM';
const dataFechaAcualizado = '11/12/2023' + ' 4:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'39', Cost:12.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'41', Cost:12.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.51, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'73', Cost:9.63, ParentId: '17'},
		]
	},
