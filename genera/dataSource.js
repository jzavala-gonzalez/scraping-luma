const timestamp_saved = '08/12/2023 05:10 AM';
const dataFechaAcualizado = '8/12/2023' + ' 1:07:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'52', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'53', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'52', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:33.14, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'11', Cost:18.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'113', Cost:11.62, ParentId: '17'},
		]
	},
