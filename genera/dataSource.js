const timestamp_saved = '07/31/2023 01:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 9:20:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'57', Cost:10.61, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 324,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'98', Cost:16.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'95', Cost:10.96, ParentId: '17'},
		]
	},
