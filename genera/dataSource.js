const timestamp_saved = '11/14/2023 05:15 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'43', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'49', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'53', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'95', Cost:10.87, ParentId: '17'},
		]
	},
