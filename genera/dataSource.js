const timestamp_saved = '11/29/2023 12:05 AM';
const dataFechaAcualizado = '11/28/2023' + ' 8:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'43', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'53', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'64', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'2', Cost:26.03, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'11', Cost:28.90, ParentId: '12'},
