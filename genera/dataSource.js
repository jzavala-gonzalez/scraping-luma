const timestamp_saved = '08/02/2023 11:05 AM';
const dataFechaAcualizado = '8/2/2023' + ' 7:00:36 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1119},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'44', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'48', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'14', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'73', Cost:17.37, ParentId: '15'},
