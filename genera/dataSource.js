const timestamp_saved = '11/09/2023 06:10 AM';
const dataFechaAcualizado = '11/9/2023' + ' 2:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'42', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:11.08, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 41, MVar:'23', Cost:22.56, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'73', Cost:9.84, ParentId: '17'},
		]
	},
