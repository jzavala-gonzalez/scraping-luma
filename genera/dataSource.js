const timestamp_saved = '10/20/2023 06:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 2:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'44', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'51', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'47', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'47', Cost:17.49, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:17.49, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.48, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:0, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'154', Cost:18.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'106', Cost:10.53, ParentId: '17'},
		]
	},
