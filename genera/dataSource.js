const timestamp_saved = '11/09/2023 05:30 AM';
const dataFechaAcualizado = '11/9/2023' + ' 1:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'46', Cost:10.35, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.83, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 204,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 204, MVar:'74', Cost:10.44, ParentId: '17'},
		]
	},
