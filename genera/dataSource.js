const timestamp_saved = '09/15/2023 11:35 PM';
const dataFechaAcualizado = '9/15/2023' + ' 7:30:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'56', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'66', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'96', Cost:16.84, ParentId: '15'},
