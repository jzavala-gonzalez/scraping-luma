const timestamp_saved = '09/23/2023 02:55 AM';
const dataFechaAcualizado = '9/22/2023' + ' 10:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'6', Cost:28.09, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'8', Cost:18.56, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'100', Cost:32.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'91', Cost:9.13, ParentId: '17'},
		]
	},
