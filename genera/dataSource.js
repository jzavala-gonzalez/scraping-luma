const timestamp_saved = '10/01/2023 07:50 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'55', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'30', Cost:12.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'28', Cost:12.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.58, ParentId: '7'},
		]
	},
