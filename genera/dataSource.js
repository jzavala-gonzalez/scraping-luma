const timestamp_saved = '11/02/2023 08:00 AM';
const dataFechaAcualizado = '11/2/2023' + ' 3:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'46', Cost:10.89, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'110', Cost:20.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'53', Cost:9.63, ParentId: '17'},
		]
	},
