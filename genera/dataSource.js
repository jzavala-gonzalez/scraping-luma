const timestamp_saved = '09/05/2023 09:00 AM';
const dataFechaAcualizado = '9/5/2023' + ' 4:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'35', Cost:12.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'40', Cost:12.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'52', Cost:12.37, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:30.73, ParentId: '12'},
