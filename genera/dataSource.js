const timestamp_saved = '11/23/2023 11:50 PM';
const dataFechaAcualizado = '11/23/2023' + ' 7:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'42', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'97', Cost:9.20, ParentId: '17'},
		]
	},
