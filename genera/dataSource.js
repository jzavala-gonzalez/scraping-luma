const timestamp_saved = '11/25/2023 08:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 4:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 183,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 183, MVar:'70', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'34', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'43', Cost:10.60, ParentId: '7'},
