const timestamp_saved = '08/24/2023 11:30 AM';
const dataFechaAcualizado = '8/24/2023' + ' 7:25:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'52', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'52', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'85', Cost:16.51, ParentId: '15'},
