const timestamp_saved = '08/01/2023 07:40 AM';
const dataFechaAcualizado = '8/1/2023' + ' 3:35:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'40', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'33', Cost:15.51, ParentId: '15'},
		]
	},
