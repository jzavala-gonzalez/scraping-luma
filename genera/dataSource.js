const timestamp_saved = '11/28/2023 05:30 PM';
const dataFechaAcualizado = '11/28/2023' + ' 1:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'39', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'48', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'179', Cost:18.23, ParentId: '16'},
		]
	},
