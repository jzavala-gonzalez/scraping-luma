const timestamp_saved = '10/29/2023 12:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 8:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'53', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'56', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:18.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'8', Cost:18.16, ParentId: '11'},
