const timestamp_saved = '11/08/2023 01:40 PM';
const dataFechaAcualizado = '11/8/2023' + ' 9:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'50', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'50', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'0', Cost:19.26, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'94', Cost:9.62, ParentId: '17'},
		]
	},
