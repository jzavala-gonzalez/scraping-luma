const timestamp_saved = '07/27/2023 05:07 AM';
const dataFechaAcualizado = '7/27/2023' + ' 1:00:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'52', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'52', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'51', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 87,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'3', Cost:30.82, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'6', Cost:30.72, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'34', Cost:20.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:20.81, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'79', Cost:13.18, ParentId: '17'},
		]
	},
