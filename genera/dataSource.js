const timestamp_saved = '10/30/2023 10:05 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'58', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'63', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'67', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'35', Cost:19.49, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 340,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 340, MVar:'159', Cost:16.96, ParentId: '16'},
		]
	},
