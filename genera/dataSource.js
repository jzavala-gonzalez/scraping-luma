const timestamp_saved = '08/05/2023 06:30 AM';
const dataFechaAcualizado = '8/5/2023' + ' 2:25:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'40', Cost:10.85, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'132', Cost:17.18, ParentId: '16'},
		]
	},
