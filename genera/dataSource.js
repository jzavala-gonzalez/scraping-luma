const timestamp_saved = '11/01/2023 07:20 PM';
const dataFechaAcualizado = '11/1/2023' + ' 3:16:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2510},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'66', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'71', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'72', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.29, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'35', Cost:18.25, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'10', Cost:18.25, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 18,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 18, MVar:'8', Cost:0, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'24', Cost:19.58, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'83', Cost:16.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'156', Cost:17.74, ParentId: '16'},
		]
	},
