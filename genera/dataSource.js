const timestamp_saved = '11/05/2023 01:20 AM';
const dataFechaAcualizado = '11/4/2023' + ' 9:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'55', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'53', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 66, MVar:'9', Cost:20.03, ParentId: '14'},
