const timestamp_saved = '11/30/2023 08:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 4:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'35', Cost:12.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'39', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'43', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'58', Cost:9.76, ParentId: '17'},
		]
	},
