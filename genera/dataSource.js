const timestamp_saved = '10/28/2023 09:20 PM';
const dataFechaAcualizado = '10/28/2023' + ' 5:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'48', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'51', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'53', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:25.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.57, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'35', Cost:18.63, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:18.63, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 73,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'6', Cost:30.36, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 37, MVar:'0', Cost:29.97, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.55, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'75', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'124', Cost:17.24, ParentId: '16'},
		]
	},
