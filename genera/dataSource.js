const timestamp_saved = '09/23/2023 08:40 PM';
const dataFechaAcualizado = '9/23/2023' + ' 4:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'50', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'53', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'62', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:5.56, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'46', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'98', Cost:9.22, ParentId: '17'},
		]
	},
