const timestamp_saved = '07/30/2023 05:20 AM';
const dataFechaAcualizado = '7/30/2023' + ' 1:15:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'46', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:52.66, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:19.34, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:19.34, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:17.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'12', Cost:17.14, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'16', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'70', Cost:16.66, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'41', Cost:15.58, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 35, MVar:'67', Cost:52.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'76', Cost:10.84, ParentId: '17'},
		]
	},
