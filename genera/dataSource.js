const timestamp_saved = '11/23/2023 11:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 7:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 208, MVar:'69', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'20', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'31', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'47', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'36', Cost:17.59, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'63', Cost:9.97, ParentId: '17'},
		]
	},
