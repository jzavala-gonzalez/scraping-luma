const timestamp_saved = '10/29/2023 06:55 PM';
const dataFechaAcualizado = '10/29/2023' + ' 2:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'51', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'72', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'125', Cost:17.09, ParentId: '16'},
		]
	},
