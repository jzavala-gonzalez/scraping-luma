const timestamp_saved = '11/27/2023 08:55 AM';
const dataFechaAcualizado = '11/27/2023' + ' 4:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'18', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'27', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'46', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.90, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'100', Cost:18.24, ParentId: '16'},
		]
	},
