const timestamp_saved = '08/12/2023 09:45 AM';
const dataFechaAcualizado = '8/12/2023' + ' 5:42:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'49', Cost:11.07, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'102', Cost:11.63, ParentId: '17'},
		]
	},
