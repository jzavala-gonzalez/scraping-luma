const timestamp_saved = '08/22/2023 10:05 PM';
const dataFechaAcualizado = '8/22/2023' + ' 6:00:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'44', Cost:10.83, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:94.17, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'120', Cost:17.66, ParentId: '16'},
		]
	},
