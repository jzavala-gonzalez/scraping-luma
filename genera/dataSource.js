const timestamp_saved = '11/01/2023 08:20 AM';
const dataFechaAcualizado = '11/1/2023' + ' 4:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'57', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:18.94, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'48', Cost:9.64, ParentId: '17'},
		]
	},
