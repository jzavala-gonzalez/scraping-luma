const timestamp_saved = '12/01/2023 03:50 PM';
const dataFechaAcualizado = '12/1/2023' + ' 11:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'47', Cost:13.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:13.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'51', Cost:13.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'72', Cost:9.47, ParentId: '17'},
		]
	},
