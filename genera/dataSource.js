const timestamp_saved = '09/04/2023 02:40 PM';
const dataFechaAcualizado = '9/4/2023' + ' 10:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'39', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'42', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'55', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'69', Cost:9.40, ParentId: '17'},
		]
	},
