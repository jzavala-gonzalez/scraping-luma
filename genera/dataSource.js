const timestamp_saved = '11/22/2023 07:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 3:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'21', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'31', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'64', Cost:9.78, ParentId: '17'},
		]
	},
