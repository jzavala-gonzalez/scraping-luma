const timestamp_saved = '10/17/2023 05:00 AM';
const dataFechaAcualizado = '10/17/2023' + ' 12:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'61', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'61', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'39', Cost:16.59, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:16.59, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'9', Cost:19.13, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'78', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'151', Cost:17.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'71', Cost:9.38, ParentId: '17'},
		]
	},
