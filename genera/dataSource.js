const timestamp_saved = '08/06/2023 07:25 AM';
const dataFechaAcualizado = '8/6/2023' + ' 3:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'41', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'42', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 107,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'15', Cost:31.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'18', Cost:31.05, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.84, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'74', Cost:16.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'23', Cost:15.55, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'93', Cost:11.58, ParentId: '17'},
		]
	},
