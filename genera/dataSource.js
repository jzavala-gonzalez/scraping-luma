const timestamp_saved = '11/29/2023 05:35 PM';
const dataFechaAcualizado = '11/29/2023' + ' 1:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'48', Cost:10.54, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:17.77, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'84', Cost:9.79, ParentId: '17'},
		]
	},
