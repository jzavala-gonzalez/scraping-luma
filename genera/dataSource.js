const timestamp_saved = '11/19/2023 08:35 AM';
const dataFechaAcualizado = '11/19/2023' + ' 4:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'35', Cost:15.07, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'64', Cost:16.38, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'93', Cost:9.90, ParentId: '17'},
		]
	},
