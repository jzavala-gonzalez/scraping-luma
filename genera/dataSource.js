const timestamp_saved = '10/03/2023 04:50 PM';
const dataFechaAcualizado = '10/3/2023' + ' 12:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'43', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'42', Cost:10.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.40, ParentId: '11'},
