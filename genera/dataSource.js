const timestamp_saved = '11/30/2023 03:05 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'48', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'50', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'52', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'72', Cost:9.63, ParentId: '17'},
		]
	},
