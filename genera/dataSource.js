const timestamp_saved = '10/31/2023 12:35 PM';
const dataFechaAcualizado = '10/31/2023' + ' 8:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'56', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'59', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'58', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'72', Cost:9.41, ParentId: '17'},
		]
	},
