const timestamp_saved = '08/16/2023 08:05 AM';
const dataFechaAcualizado = '8/16/2023' + ' 4:02:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'53', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'48', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'57', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'77', Cost:10.48, ParentId: '17'},
		]
	},
