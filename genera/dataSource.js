const timestamp_saved = '09/29/2023 11:40 PM';
const dataFechaAcualizado = '9/29/2023' + ' 7:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'51', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'49', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'61', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'15', Cost:27.50, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'25', Cost:30.81, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:17.57, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:29.86, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'10', Cost:29.84, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'128', Cost:9.15, ParentId: '17'},
		]
	},
