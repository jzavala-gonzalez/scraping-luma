const timestamp_saved = '10/28/2023 08:05 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'39', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'43', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 104,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 61, MVar:'19', Cost:30.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 44, MVar:'13', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'16', Cost:19.07, ParentId: '14'},
