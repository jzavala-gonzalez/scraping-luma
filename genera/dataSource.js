const timestamp_saved = '09/24/2023 10:10 PM';
const dataFechaAcualizado = '9/24/2023' + ' 6:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'48', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:10.86, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 149,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:5.05, ParentId: '8'},
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 268, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'0', Cost:22.06, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.48, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:31.13, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.91, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'78', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'92', Cost:9.16, ParentId: '17'},
		]
	},
