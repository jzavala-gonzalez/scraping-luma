const timestamp_saved = '08/05/2023 12:55 PM';
const dataFechaAcualizado = '8/5/2023' + ' 8:50:39 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2331},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'40', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 160,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'0', Cost:21.89, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'8', Cost:22.53, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'9', Cost:43.76, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:20.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'0', Cost:20.35, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.02, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:20.46, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'30', Cost:19.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'86', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'45', Cost:15.44, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'91', Cost:11.57, ParentId: '17'},
		]
	},
