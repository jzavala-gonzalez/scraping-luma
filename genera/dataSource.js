const timestamp_saved = '09/24/2023 06:20 AM';
const dataFechaAcualizado = '9/24/2023' + ' 2:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'40', Cost:12.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'43', Cost:12.62, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 129, MVar:'0', Cost:8.43, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'0', Cost:8.43, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'5', Cost:28.31, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'55', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'79', Cost:9.05, ParentId: '17'},
		]
	},
