const timestamp_saved = '11/19/2023 06:50 PM';
const dataFechaAcualizado = '11/19/2023' + ' 2:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:14.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'51', Cost:14.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:14.50, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:49.56, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'12', Cost:22.48, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'18', Cost:19.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'85', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 261, MVar:'144', Cost:17.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'99', Cost:9.82, ParentId: '17'},
		]
	},
