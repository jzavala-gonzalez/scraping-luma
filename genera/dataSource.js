const timestamp_saved = '09/18/2023 06:55 PM';
const dataFechaAcualizado = '9/18/2023' + ' 2:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'87', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'52', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'52', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'65', Cost:10.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'66', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'7', Cost:31.24, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'33', Cost:18.93, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'90', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'160', Cost:17.51, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 37, MVar:'23', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 24, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
