const timestamp_saved = '10/03/2023 08:30 AM';
const dataFechaAcualizado = '10/3/2023' + ' 4:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'37', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'35', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'91', Cost:9.84, ParentId: '17'},
		]
	},
