const timestamp_saved = '07/31/2023 01:55 AM';
const dataFechaAcualizado = '7/30/2023' + ' 9:50:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'57', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'49', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.22, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 152, MVar:'50', Cost:15.69, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'149', Cost:16.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'95', Cost:10.97, ParentId: '17'},
		]
	},
