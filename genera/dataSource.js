const timestamp_saved = '11/04/2023 09:06 AM';
const dataFechaAcualizado = '11/4/2023' + ' 5:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'41', Cost:11.29, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:17.47, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'46', Cost:9.73, ParentId: '17'},
		]
	},
