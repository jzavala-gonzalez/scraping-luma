const timestamp_saved = '08/21/2023 02:10 AM';
const dataFechaAcualizado = '8/20/2023' + ' 10:07:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'52', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'59', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'1', Cost:26.31, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 315, MVar:'157', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'80', Cost:9.18, ParentId: '17'},
		]
	},
