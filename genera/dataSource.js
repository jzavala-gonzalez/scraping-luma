const timestamp_saved = '09/09/2023 10:20 AM';
const dataFechaAcualizado = '9/9/2023' + ' 6:15:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2217},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'51', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'56', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'62', Cost:16.80, ParentId: '15'},
