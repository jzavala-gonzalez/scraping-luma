const timestamp_saved = '10/18/2023 08:05 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'36', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'41', Cost:10.63, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 70, MVar:'61', Cost:20.51, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'82', Cost:10.66, ParentId: '17'},
		]
	},
