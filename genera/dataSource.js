const timestamp_saved = '09/25/2023 01:40 AM';
const dataFechaAcualizado = '9/24/2023' + ' 9:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'57', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'63', Cost:10.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 151,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 289, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'8', Cost:22.03, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:22.25, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'10', Cost:22.76, ParentId: '9'},
