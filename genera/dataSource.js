const timestamp_saved = '11/22/2023 06:45 PM';
const dataFechaAcualizado = '11/22/2023' + ' 2:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:11.10, ParentId: '7'},
		]
	},
