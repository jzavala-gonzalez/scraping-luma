const timestamp_saved = '10/21/2023 10:15 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'38', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'34', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'36', Cost:11.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'68', Cost:11.06, ParentId: '17'},
		]
	},
