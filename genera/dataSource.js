const timestamp_saved = '11/03/2023 06:40 AM';
const dataFechaAcualizado = '11/3/2023' + ' 2:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'43', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'47', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'58', Cost:9.40, ParentId: '17'},
		]
	},
