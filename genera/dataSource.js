const timestamp_saved = '11/28/2023 12:20 AM';
const dataFechaAcualizado = '11/27/2023' + ' 8:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'41', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'53', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'61', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'193', Cost:17.38, ParentId: '16'},
		]
	},
