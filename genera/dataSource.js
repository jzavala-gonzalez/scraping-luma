const timestamp_saved = '09/28/2023 01:40 PM';
const dataFechaAcualizado = '9/28/2023' + ' 9:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'26', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'27', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'48', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.78, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'126', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'82', Cost:9.76, ParentId: '17'},
		]
	},
