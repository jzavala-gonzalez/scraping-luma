const timestamp_saved = '09/17/2023 07:35 AM';
const dataFechaAcualizado = '9/17/2023' + ' 3:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'40', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'38', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'57', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'85', Cost:9.12, ParentId: '17'},
		]
	},
