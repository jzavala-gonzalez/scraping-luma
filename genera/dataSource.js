const timestamp_saved = '09/15/2023 01:55 PM';
const dataFechaAcualizado = '9/15/2023' + ' 9:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'52', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'49', Cost:10.92, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'24', Cost:18.81, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'139', Cost:17.84, ParentId: '16'},
		]
	},
