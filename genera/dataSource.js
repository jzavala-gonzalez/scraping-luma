const timestamp_saved = '09/27/2023 05:20 PM';
const dataFechaAcualizado = '9/27/2023' + ' 1:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'33', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'33', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'64', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:8.84, ParentId: '11'},
