const timestamp_saved = '10/23/2023 06:35 AM';
const dataFechaAcualizado = '10/23/2023' + ' 2:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'36', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'37', Cost:12.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'39', Cost:12.19, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'102', Cost:17.69, ParentId: '16'},
		]
	},
