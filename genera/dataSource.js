const timestamp_saved = '10/05/2023 02:05 AM';
const dataFechaAcualizado = '10/4/2023' + ' 10:01:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'48', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:10.57, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:18.46, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'11', Cost:19.10, ParentId: '14'},
