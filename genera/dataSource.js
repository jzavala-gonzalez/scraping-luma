const timestamp_saved = '11/10/2023 07:40 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'44', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'41', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'54', Cost:9.83, ParentId: '17'},
		]
	},
