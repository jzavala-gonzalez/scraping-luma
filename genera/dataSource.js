const timestamp_saved = '08/19/2023 12:15 AM';
const dataFechaAcualizado = '8/18/2023' + ' 8:12:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'69', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'76', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.45, ParentId: '13'},
