const timestamp_saved = '11/13/2023 02:10 AM';
const dataFechaAcualizado = '11/12/2023' + ' 10:06:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2562},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'58', Cost:14.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'60', Cost:14.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:14.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:25.87, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'14', Cost:28.01, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'8', Cost:30.88, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'0', Cost:29.39, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'17', Cost:28.72, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'70', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'115', Cost:9.16, ParentId: '17'},
		]
	},
