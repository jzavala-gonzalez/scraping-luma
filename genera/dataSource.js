const timestamp_saved = '08/08/2023 04:00 PM';
const dataFechaAcualizado = '8/8/2023' + ' 11:55:41 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 889},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'56', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'63', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'7', Cost:22.55, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'41', Cost:20.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:20.54, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'44', Cost:16.32, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'168', Cost:17.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'94', Cost:11.87, ParentId: '17'},
		]
	},
