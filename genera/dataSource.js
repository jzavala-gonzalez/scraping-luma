const timestamp_saved = '11/04/2023 11:35 PM';
const dataFechaAcualizado = '11/4/2023' + ' 7:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'55', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'54', Cost:10.88, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.17, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'83', Cost:9.22, ParentId: '17'},
		]
	},
