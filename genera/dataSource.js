const timestamp_saved = '07/28/2023 04:50 AM';
const dataFechaAcualizado = '7/28/2023' + ' 12:45:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'45', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.83, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'1', Cost:22.31, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:30.99, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:20.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:9.77, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:9.77, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'31', Cost:15.39, ParentId: '15'},
		]
	},
