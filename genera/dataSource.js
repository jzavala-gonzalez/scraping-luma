const timestamp_saved = '10/01/2023 01:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 11, MVar:'33', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'28', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'26', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'44', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'86', Cost:9.51, ParentId: '17'},
		]
	},
