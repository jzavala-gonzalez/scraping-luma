const timestamp_saved = '09/27/2023 04:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 12:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'44', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'46', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'56', Cost:12.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:19.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'8', Cost:19.65, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.49, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'1', Cost:19.27, ParentId: '14'},
