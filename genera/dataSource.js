const timestamp_saved = '10/13/2023 10:40 AM';
const dataFechaAcualizado = '10/13/2023' + ' 6:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'56', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'60', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'65', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:18.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'68', Cost:16.94, ParentId: '15'},
