const timestamp_saved = '11/08/2023 12:00 PM';
const dataFechaAcualizado = '11/8/2023' + ' 7:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'47', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.84, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'93', Cost:16.94, ParentId: '15'},
