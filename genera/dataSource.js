const timestamp_saved = '09/23/2023 11:00 AM';
const dataFechaAcualizado = '9/23/2023' + ' 6:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'37', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'40', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'54', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'46', Cost:17.99, ParentId: '15'},
