const timestamp_saved = '08/22/2023 03:05 PM';
const dataFechaAcualizado = '8/22/2023' + ' 11:00:36 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2381},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'47', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'2', Cost:43.85, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'130', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'76', Cost:9.19, ParentId: '17'},
		]
	},
