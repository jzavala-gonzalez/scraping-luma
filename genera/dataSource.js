const timestamp_saved = '10/31/2023 02:40 PM';
const dataFechaAcualizado = '10/31/2023' + ' 10:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'58', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'64', Cost:10.40, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'17', Cost:21.11, ParentId: '14'},
