const timestamp_saved = '09/15/2023 02:35 PM';
const dataFechaAcualizado = '9/15/2023' + ' 10:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'63', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'26', Cost:18.94, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'101', Cost:9.34, ParentId: '17'},
		]
	},
