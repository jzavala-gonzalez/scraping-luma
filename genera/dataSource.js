const timestamp_saved = '10/03/2023 04:00 PM';
const dataFechaAcualizado = '10/3/2023' + ' 11:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'44', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'42', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'53', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.44, ParentId: '11'},
