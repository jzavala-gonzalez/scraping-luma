const timestamp_saved = '11/28/2023 09:05 PM';
const dataFechaAcualizado = '11/28/2023' + ' 5:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'42', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'52', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'63', Cost:11.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:33.32, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'17', Cost:43.42, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'11', Cost:28.62, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:28.38, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 354,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 354, MVar:'206', Cost:16.95, ParentId: '16'},
		]
	},
