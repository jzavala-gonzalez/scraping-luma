const timestamp_saved = '09/01/2023 10:50 PM';
const dataFechaAcualizado = '9/1/2023' + ' 6:45:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 69},
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2880},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 537,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'61', Cost:9.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'69', Cost:9.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 209, MVar:'74', Cost:9.81, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 193,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'6', Cost:22.15, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:22.01, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:23.22, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'15', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'17', Cost:28.10, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:8.31, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'26', Cost:19.75, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 179,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 179, MVar:'90', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'175', Cost:16.65, ParentId: '16'},
		]
	},
