const timestamp_saved = '10/30/2023 03:30 AM';
const dataFechaAcualizado = '10/29/2023' + ' 11:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'46', Cost:10.51, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 242,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 242, MVar:'131', Cost:17.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'61', Cost:9.40, ParentId: '17'},
		]
	},
