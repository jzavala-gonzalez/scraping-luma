const timestamp_saved = '10/04/2023 06:00 AM';
const dataFechaAcualizado = '10/4/2023' + ' 1:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'38', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'36', Cost:10.26, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'0', Cost:16.95, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'141', Cost:19.76, ParentId: '16'},
		]
	},
