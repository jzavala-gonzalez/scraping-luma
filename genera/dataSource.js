const timestamp_saved = '12/04/2023 02:40 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'49', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'52', Cost:11.20, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.59, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 316,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 316, MVar:'80', Cost:10.82, ParentId: '17'},
		]
	},
