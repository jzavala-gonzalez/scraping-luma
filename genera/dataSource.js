const timestamp_saved = '10/26/2023 12:20 AM';
const dataFechaAcualizado = '10/25/2023' + ' 8:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'52', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'54', Cost:10.61, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'16', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'66', Cost:16.85, ParentId: '15'},
