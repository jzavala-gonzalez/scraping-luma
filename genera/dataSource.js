const timestamp_saved = '10/12/2023 06:15 AM';
const dataFechaAcualizado = '10/12/2023' + ' 2:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'61', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'65', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'87', Cost:16.40, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'166', Cost:19.34, ParentId: '16'},
		]
	},
