const timestamp_saved = '08/11/2023 05:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 1:30:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'44', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'46', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'175', Cost:17.38, ParentId: '16'},
		]
	},
