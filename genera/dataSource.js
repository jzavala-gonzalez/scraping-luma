const timestamp_saved = '11/25/2023 08:40 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'59', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'18', Cost:13.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'28', Cost:13.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'46', Cost:13.14, ParentId: '7'},
		]
	},
