const timestamp_saved = '11/08/2023 02:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 10:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'52', Cost:10.77, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 2,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 2, MVar:'0', Cost:30.53, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'102', Cost:9.16, ParentId: '17'},
		]
	},
