const timestamp_saved = '10/30/2023 01:35 PM';
const dataFechaAcualizado = '10/30/2023' + ' 9:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'58', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'61', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 236,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'18', Cost:24.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 18, MVar:'4', Cost:24.51, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'26', Cost:18.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'162', Cost:18.07, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'81', Cost:9.38, ParentId: '17'},
		]
	},
