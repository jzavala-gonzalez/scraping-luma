const timestamp_saved = '08/11/2023 07:00 PM';
const dataFechaAcualizado = '8/11/2023' + ' 2:55:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'97', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'47', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'5', Cost:27.12, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:20.13, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.59, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'31', Cost:19.28, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'173', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'135', Cost:11.47, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 100,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 27, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
