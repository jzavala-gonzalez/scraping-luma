const timestamp_saved = '11/01/2023 02:50 PM';
const dataFechaAcualizado = '11/1/2023' + ' 10:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'57', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'61', Cost:11.10, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'80', Cost:16.82, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'74', Cost:9.36, ParentId: '17'},
		]
	},
