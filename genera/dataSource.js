const timestamp_saved = '11/19/2023 12:05 AM';
const dataFechaAcualizado = '11/18/2023' + ' 8:01:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2700},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:14.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'60', Cost:14.38, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 91,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.92, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'2', Cost:27.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'19', Cost:18.88, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'80', Cost:16.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 100, MVar:'158', Cost:25.92, ParentId: '16'},
		]
	},
