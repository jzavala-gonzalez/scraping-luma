const timestamp_saved = '11/28/2023 03:25 AM';
const dataFechaAcualizado = '11/27/2023' + ' 11:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'29', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'39', Cost:12.19, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.45, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'47', Cost:8.08, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'4', Cost:19.15, ParentId: '14'},
