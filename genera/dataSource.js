const timestamp_saved = '11/22/2023 10:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 5:56:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2351},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'34', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'46', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'58', Cost:11.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 19, MVar:'0', Cost:26.46, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.80, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:31.28, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'171', Cost:17.37, ParentId: '16'},
		]
	},
