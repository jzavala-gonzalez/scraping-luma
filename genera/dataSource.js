const timestamp_saved = '11/16/2023 06:30 AM';
const dataFechaAcualizado = '11/16/2023' + ' 2:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'43', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'43', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'49', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'57', Cost:10.86, ParentId: '17'},
		]
	},
