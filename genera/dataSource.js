const timestamp_saved = '09/01/2023 09:15 AM';
const dataFechaAcualizado = '9/1/2023' + ' 5:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.37, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 200,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'100', Cost:19.40, ParentId: '16'},
		]
	},
