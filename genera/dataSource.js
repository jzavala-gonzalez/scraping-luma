const timestamp_saved = '10/05/2023 11:35 PM';
const dataFechaAcualizado = '10/5/2023' + ' 7:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'49', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'47', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'58', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'137', Cost:9.17, ParentId: '17'},
		]
	},
