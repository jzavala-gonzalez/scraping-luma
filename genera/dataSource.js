const timestamp_saved = '08/02/2023 06:35 PM';
const dataFechaAcualizado = '8/2/2023' + ' 2:30:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3491},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'47', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'51', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'4', Cost:22.15, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:27.00, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'8', Cost:24.74, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.44, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 342,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 342, MVar:'172', Cost:16.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'102', Cost:10.87, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 55,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 17, MVar:'21', Cost:17, ParentId: '19'},
		]
	},
