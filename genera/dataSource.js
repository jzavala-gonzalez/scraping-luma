const timestamp_saved = '11/27/2023 07:55 PM';
const dataFechaAcualizado = '11/27/2023' + ' 3:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'43', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'52', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'61', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.85, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 11,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 11, MVar:'9', Cost:0, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'169', Cost:18.14, ParentId: '16'},
		]
	},
