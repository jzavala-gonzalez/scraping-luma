const timestamp_saved = '10/28/2023 04:45 AM';
const dataFechaAcualizado = '10/28/2023' + ' 12:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'38', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'40', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'45', Cost:11.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 99, MVar:'30', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 65, MVar:'19', Cost:29.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.30, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'0', Cost:28.26, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.67, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'17', Cost:19.01, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'115', Cost:17.34, ParentId: '16'},
		]
	},
