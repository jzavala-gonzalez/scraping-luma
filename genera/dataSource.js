const timestamp_saved = '07/26/2023 05:33 AM';
const dataFechaAcualizado = '7/26/2023' + ' 1:25:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'74', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'78', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'46', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'56', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'31', Cost:9.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:9.42, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.88, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'82', Cost:9.34, ParentId: '17'},
		]
	},
