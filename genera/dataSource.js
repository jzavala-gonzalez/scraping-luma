const timestamp_saved = '11/27/2023 12:25 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'28', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'38', Cost:10.94, ParentId: '7'},
