const timestamp_saved = '08/04/2023 06:25 PM';
const dataFechaAcualizado = '8/4/2023' + ' 2:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 84, MVar:'44', Cost:10.51, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 165,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:62.67, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 42, MVar:'9', Cost:24.91, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:24.57, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 192,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'88', Cost:17.02, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 49, MVar:'49', Cost:25.48, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'163', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'96', Cost:10.85, ParentId: '17'},
		]
	},
