const timestamp_saved = '11/05/2023 03:20 AM';
const dataFechaAcualizado = '11/4/2023' + ' 11:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'52', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'51', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'48', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 92, MVar:'27', Cost:20.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:20.73, ParentId: '11'},
