const timestamp_saved = '09/09/2023 10:30 PM';
const dataFechaAcualizado = '9/9/2023' + ' 6:25:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 549,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'71', Cost:9.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'70', Cost:9.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'69', Cost:9.73, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 153,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 82, MVar:'0', Cost:9.17, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'11', Cost:31.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'9', Cost:8.22, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:31.23, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:25.31, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'10', Cost:28.47, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'18', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'81', Cost:17.32, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 61,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:22.18, ParentId: '21'},
