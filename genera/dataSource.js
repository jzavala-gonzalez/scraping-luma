const timestamp_saved = '11/09/2023 10:20 PM';
const dataFechaAcualizado = '11/9/2023' + ' 6:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'54', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'48', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'49', Cost:10.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 132, MVar:'16', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:17.25, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'19', Cost:31.33, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'25', Cost:21.87, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'138', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'117', Cost:9.17, ParentId: '17'},
		]
	},
