const timestamp_saved = '08/18/2023 06:35 PM';
const dataFechaAcualizado = '8/18/2023' + ' 2:32:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'63', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'72', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'32', Cost:19.13, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'84', Cost:18.41, ParentId: '15'},
