const timestamp_saved = '10/15/2023 01:00 AM';
const dataFechaAcualizado = '10/14/2023' + ' 8:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'63', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'63', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'63', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:16.91, ParentId: '11'},
