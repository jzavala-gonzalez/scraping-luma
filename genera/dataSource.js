const timestamp_saved = '09/30/2023 08:15 AM';
const dataFechaAcualizado = '9/30/2023' + ' 4:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'39', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'37', Cost:10.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:19.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'7', Cost:19.55, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'93', Cost:16.69, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'103', Cost:9.52, ParentId: '17'},
		]
	},
