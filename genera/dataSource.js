const timestamp_saved = '08/29/2023 12:20 PM';
const dataFechaAcualizado = '8/29/2023' + ' 8:15:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'80', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'79', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'52', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'54', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'60', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 97,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:27.44, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'36', Cost:18.97, ParentId: '14'},
