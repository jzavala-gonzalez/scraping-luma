const timestamp_saved = '10/27/2023 06:30 AM';
const dataFechaAcualizado = '10/27/2023' + ' 2:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'42', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'43', Cost:10.99, ParentId: '7'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:18.84, ParentId: '21'},
