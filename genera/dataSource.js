const timestamp_saved = '08/27/2023 10:30 PM';
const dataFechaAcualizado = '8/27/2023' + ' 6:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'42', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'41', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'46', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'12', Cost:30.84, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:19.84, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'103', Cost:11.64, ParentId: '17'},
		]
	},
