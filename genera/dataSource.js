const timestamp_saved = '09/24/2023 05:15 PM';
const dataFechaAcualizado = '9/24/2023' + ' 1:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'47', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'48', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'57', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 19, MVar:'6', Cost:27.84, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'6', Cost:27.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'45', Cost:20.03, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'82', Cost:18.24, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'93', Cost:9.28, ParentId: '17'},
		]
	},
