const timestamp_saved = '11/11/2023 11:30 AM';
const dataFechaAcualizado = '11/11/2023' + ' 7:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'48', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'86', Cost:9.12, ParentId: '17'},
		]
	},
