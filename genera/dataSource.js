const timestamp_saved = '09/07/2023 09:30 AM';
const dataFechaAcualizado = '9/7/2023' + ' 5:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'50', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'40', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'45', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'140', Cost:17.16, ParentId: '16'},
		]
	},
