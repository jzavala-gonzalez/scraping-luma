const timestamp_saved = '09/29/2023 03:25 AM';
const dataFechaAcualizado = '9/28/2023' + ' 11:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'43', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'49', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'1', Cost:22.69, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:22.75, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:10.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'79', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'136', Cost:16.76, ParentId: '16'},
		]
	},
