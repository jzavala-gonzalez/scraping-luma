const timestamp_saved = '10/10/2023 05:55 PM';
const dataFechaAcualizado = '10/10/2023' + ' 1:51:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 234,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 234, MVar:'81', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'61', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'64', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'69', Cost:10.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:26.66, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:17.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 149, MVar:'45', Cost:18.05, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:18.05, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:19.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'161', Cost:17.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'89', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.71, ParentId: '21'},
