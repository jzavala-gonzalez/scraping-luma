const timestamp_saved = '12/04/2023 02:50 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 143, MVar:'53', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'78', Cost:11.23, ParentId: '17'},
		]
	},
