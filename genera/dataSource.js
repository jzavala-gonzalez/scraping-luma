const timestamp_saved = '11/12/2023 11:05 PM';
const dataFechaAcualizado = '11/12/2023' + ' 7:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'60', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'63', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.45, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:26.94, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:28.65, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'68', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'116', Cost:9.16, ParentId: '17'},
		]
	},
