const timestamp_saved = '08/22/2023 08:55 PM';
const dataFechaAcualizado = '8/22/2023' + ' 4:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'121', Cost:17.68, ParentId: '16'},
		]
	},
