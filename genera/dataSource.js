const timestamp_saved = '11/20/2023 10:05 AM';
const dataFechaAcualizado = '11/20/2023' + ' 6:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'33', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'44', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.23, ParentId: '11'},
