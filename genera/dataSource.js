const timestamp_saved = '12/03/2023 11:25 AM';
const dataFechaAcualizado = '12/3/2023' + ' 7:21:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1814},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'36', Cost:12.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'38', Cost:12.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'43', Cost:12.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'50', Cost:11.65, ParentId: '17'},
		]
	},
