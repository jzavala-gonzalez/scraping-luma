const timestamp_saved = '09/30/2023 12:20 PM';
const dataFechaAcualizado = '9/30/2023' + ' 8:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'32', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'28', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'46', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'92', Cost:9.43, ParentId: '17'},
		]
	},
