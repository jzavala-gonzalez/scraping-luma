const timestamp_saved = '08/07/2023 10:20 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:15:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'45', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'44', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'21', Cost:16.45, ParentId: '15'},
		]
	},
