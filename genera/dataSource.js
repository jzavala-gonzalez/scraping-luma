const timestamp_saved = '10/28/2023 02:30 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'40', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'44', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'46', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'12', Cost:34.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:34.54, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.12, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 46,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 46, MVar:'73', Cost:23.98, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 18, MVar:'0', Cost:21.43, ParentId: '19'},
