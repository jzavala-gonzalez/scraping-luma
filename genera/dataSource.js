const timestamp_saved = '12/05/2023 03:10 PM';
const dataFechaAcualizado = '12/5/2023' + ' 11:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'46', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'50', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'56', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 186,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 99, MVar:'11', Cost:18.53, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'28', Cost:18.25, ParentId: '14'},
