const timestamp_saved = '10/22/2023 12:55 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'39', Cost:11.80, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'13', Cost:18.85, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'56', Cost:11.22, ParentId: '17'},
		]
	},
