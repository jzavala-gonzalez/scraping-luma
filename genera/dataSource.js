const timestamp_saved = '10/21/2023 02:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 10:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'41', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'49', Cost:10.56, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 26,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'1', Cost:26.03, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'102', Cost:10.53, ParentId: '17'},
		]
	},
