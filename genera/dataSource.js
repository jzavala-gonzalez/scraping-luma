const timestamp_saved = '10/30/2023 07:35 AM';
const dataFechaAcualizado = '10/30/2023' + ' 3:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'31', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'32', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'59', Cost:12.01, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'91', Cost:18.76, ParentId: '16'},
		]
	},
