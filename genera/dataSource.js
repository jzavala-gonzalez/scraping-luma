const timestamp_saved = '09/29/2023 09:25 AM';
const dataFechaAcualizado = '9/29/2023' + ' 5:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'33', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'32', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'48', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'6', Cost:19.70, ParentId: '14'},
