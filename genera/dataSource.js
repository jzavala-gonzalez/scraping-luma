const timestamp_saved = '09/06/2023 01:15 PM';
const dataFechaAcualizado = '9/6/2023' + ' 9:10:51 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2432},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'67', Cost:4.45, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'73', Cost:4.45, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 133,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'71', Cost:22.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'1', Cost:22.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'58', Cost:22.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'7', Cost:44.51, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 54, MVar:'16', Cost:30.45, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'24', Cost:18.75, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'96', Cost:16.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 322,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 322, MVar:'147', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'109', Cost:9.18, ParentId: '17'},
		]
	},
