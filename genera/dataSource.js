const timestamp_saved = '11/24/2023 01:35 PM';
const dataFechaAcualizado = '11/24/2023' + ' 9:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'23', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'34', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'50', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 212,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:17.57, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'138', Cost:18.28, ParentId: '16'},
		]
	},
