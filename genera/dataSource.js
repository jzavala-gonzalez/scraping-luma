const timestamp_saved = '10/12/2023 03:35 PM';
const dataFechaAcualizado = '10/12/2023' + ' 11:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'58', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'63', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'66', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.48, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'180', Cost:17.35, ParentId: '16'},
		]
	},
