const timestamp_saved = '08/12/2023 08:50 PM';
const dataFechaAcualizado = '8/12/2023' + ' 4:47:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'45', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'44', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.62, ParentId: '11'},
