const timestamp_saved = '10/27/2023 09:00 AM';
const dataFechaAcualizado = '10/27/2023' + ' 4:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'40', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'43', Cost:11.36, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'89', Cost:21.08, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'2', Unit:'Unit 5', MW: 0, MVar:'4', Cost:0, ParentId: '17'},
