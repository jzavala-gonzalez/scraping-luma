const timestamp_saved = '07/30/2023 12:15 AM';
const dataFechaAcualizado = '7/29/2023' + ' 8:10:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'55', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'52', Cost:10.66, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 335,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 196, MVar:'0', Cost:7.17, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:19.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:19.21, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'71', Cost:16.58, ParentId: '15'},
