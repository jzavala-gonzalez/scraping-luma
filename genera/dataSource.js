const timestamp_saved = '11/18/2023 02:35 PM';
const dataFechaAcualizado = '11/18/2023' + ' 10:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 259,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'49', Cost:16.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'58', Cost:16.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:16.69, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.24, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.26, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'95', Cost:17.00, ParentId: '15'},
