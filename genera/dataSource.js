const timestamp_saved = '08/02/2023 03:00 AM';
const dataFechaAcualizado = '8/1/2023' + ' 10:55:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:10.63, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'79', Cost:16.81, ParentId: '15'},
