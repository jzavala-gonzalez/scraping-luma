const timestamp_saved = '10/16/2023 06:45 PM';
const dataFechaAcualizado = '10/16/2023' + ' 2:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'66', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'66', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'62', Cost:10.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:33.31, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'27', Cost:30.99, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'41', Cost:16.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:16.75, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'48', Cost:8.19, ParentId: '11'},
