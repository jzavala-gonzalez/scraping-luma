const timestamp_saved = '07/29/2023 10:15 AM';
const dataFechaAcualizado = '7/29/2023' + ' 6:10:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'45', Cost:11.09, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'26', Cost:15.81, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'77', Cost:13.64, ParentId: '17'},
		]
	},
