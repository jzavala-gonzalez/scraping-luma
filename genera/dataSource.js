const timestamp_saved = '08/24/2023 06:45 PM';
const dataFechaAcualizado = '8/24/2023' + ' 2:40:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'62', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'61', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'59', Cost:10.70, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 56,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 56, MVar:'0', Cost:4.38, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:19.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:19.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:233.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:233.30, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'30', Cost:18.93, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'81', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'193', Cost:17.16, ParentId: '16'},
		]
	},
