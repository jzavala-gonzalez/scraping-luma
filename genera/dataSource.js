const timestamp_saved = '10/15/2023 12:25 PM';
const dataFechaAcualizado = '10/15/2023' + ' 8:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'44', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'48', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'43', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'64', Cost:9.52, ParentId: '17'},
		]
	},
