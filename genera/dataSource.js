const timestamp_saved = '09/27/2023 06:30 PM';
const dataFechaAcualizado = '9/27/2023' + ' 2:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'29', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'29', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:20.55, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'0', Cost:20.55, ParentId: '11'},
		]
	},
