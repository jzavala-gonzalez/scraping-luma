const timestamp_saved = '10/04/2023 07:25 PM';
const dataFechaAcualizado = '10/4/2023' + ' 3:21:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'48', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'46', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:18.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:18.40, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'39', Cost:17.93, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:17.93, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'85', Cost:17.04, ParentId: '15'},
