const timestamp_saved = '10/12/2023 05:15 PM';
const dataFechaAcualizado = '10/12/2023' + ' 1:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'59', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'64', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'69', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:16.84, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:31.35, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'185', Cost:17.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'83', Cost:9.44, ParentId: '17'},
		]
	},
