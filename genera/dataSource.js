const timestamp_saved = '07/25/2023 04:02 AM';
const dataFechaAcualizado = '7/24/2023' + ' 11:55:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'57', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'54', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 201,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'7', Cost:22.36, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.98, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.56, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.93, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'130', Cost:17.50, ParentId: '16'},
		]
	},
