const timestamp_saved = '09/02/2023 11:30 AM';
const dataFechaAcualizado = '9/2/2023' + ' 7:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'44', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'51', Cost:10.27, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'53', Cost:9.78, ParentId: '17'},
		]
	},
