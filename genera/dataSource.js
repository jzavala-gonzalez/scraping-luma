const timestamp_saved = '11/10/2023 06:40 PM';
const dataFechaAcualizado = '11/10/2023' + ' 2:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'53', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'60', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'49', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'84', Cost:9.22, ParentId: '17'},
		]
	},
