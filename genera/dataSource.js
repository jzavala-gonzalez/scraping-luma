const timestamp_saved = '11/09/2023 08:55 PM';
const dataFechaAcualizado = '11/9/2023' + ' 4:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'50', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'49', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'52', Cost:11.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 135, MVar:'21', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'19', Cost:21.88, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'102', Cost:9.20, ParentId: '17'},
		]
	},
