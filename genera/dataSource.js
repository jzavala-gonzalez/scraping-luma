const timestamp_saved = '10/19/2023 09:25 AM';
const dataFechaAcualizado = '10/19/2023' + ' 5:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'35', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'41', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'45', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'89', Cost:11.02, ParentId: '17'},
		]
	},
