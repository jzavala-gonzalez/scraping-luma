const timestamp_saved = '11/15/2023 01:00 PM';
const dataFechaAcualizado = '11/15/2023' + ' 8:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'46', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'14', Cost:22.56, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'137', Cost:18.32, ParentId: '16'},
		]
	},
