const timestamp_saved = '10/21/2023 01:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 9:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'52', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'48', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'7', Cost:19.52, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'65', Cost:16.75, ParentId: '15'},
