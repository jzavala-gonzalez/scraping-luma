const timestamp_saved = '11/27/2023 08:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 4:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'43', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'53', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'62', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:20.67, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.88, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'47', Cost:8.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 52, MVar:'12', Cost:8.10, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:31.22, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 285, MVar:'175', Cost:17.42, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'116', Cost:9.16, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 20, MVar:'0', Cost:42, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:41.98, ParentId: '21'},
