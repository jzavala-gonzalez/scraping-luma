const timestamp_saved = '07/30/2023 04:20 PM';
const dataFechaAcualizado = '7/30/2023' + ' 12:15:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1238},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 218, MVar:'62', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'61', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'47', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'38', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 201,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'80', Cost:18.49, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'36', Cost:17.08, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'107', Cost:20.07, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'63', Cost:11.43, ParentId: '17'},
		]
	},
