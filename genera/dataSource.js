const timestamp_saved = '11/08/2023 03:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 11:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'48', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'47', Cost:10.59, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'95', Cost:9.17, ParentId: '17'},
		]
	},
