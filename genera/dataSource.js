const timestamp_saved = '11/10/2023 10:55 AM';
const dataFechaAcualizado = '11/10/2023' + ' 6:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'49', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'54', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'68', Cost:9.52, ParentId: '17'},
		]
	},
