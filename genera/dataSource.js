const timestamp_saved = '09/08/2023 06:25 AM';
const dataFechaAcualizado = '9/8/2023' + ' 2:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'56', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'52', Cost:11.06, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 178,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 130, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'19', Cost:31.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'19', Cost:30.90, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.57, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'2', Cost:19.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'55', Cost:16.84, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 40, MVar:'20', Cost:22.41, ParentId: '17'},
		]
	},
