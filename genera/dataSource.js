const timestamp_saved = '07/25/2023 08:55 AM';
const dataFechaAcualizado = '7/25/2023' + ' 4:50:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'79', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'61', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'55', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:27.03, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'9', Cost:28.00, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:29.66, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:29.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'12', Cost:18.68, ParentId: '14'},
