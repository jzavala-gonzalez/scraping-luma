const timestamp_saved = '11/27/2023 05:25 AM';
const dataFechaAcualizado = '11/27/2023' + ' 1:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'25', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'35', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'49', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'108', Cost:18.28, ParentId: '16'},
		]
	},
