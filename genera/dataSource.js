const timestamp_saved = '09/05/2023 01:55 PM';
const dataFechaAcualizado = '9/5/2023' + ' 9:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'42', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'46', Cost:10.91, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 78, MVar:'78', Cost:20.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'146', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'75', Cost:9.44, ParentId: '17'},
		]
	},
