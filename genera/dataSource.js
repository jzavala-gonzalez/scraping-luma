const timestamp_saved = '07/26/2023 11:39 PM';
const dataFechaAcualizado = '7/26/2023' + ' 7:30:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'77', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'61', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'56', Cost:10.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 158,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 102, MVar:'0', Cost:4.93, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:34.05, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:19.70, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:30.87, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:30.76, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'7', Cost:30.75, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'104', Cost:16.55, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'21', Cost:15.42, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'93', Cost:13.18, ParentId: '17'},
		]
	},
