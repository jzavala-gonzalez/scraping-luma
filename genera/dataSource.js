const timestamp_saved = '09/14/2023 02:50 PM';
const dataFechaAcualizado = '9/14/2023' + ' 10:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'57', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'68', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'31', Cost:19.45, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'106', Cost:9.20, ParentId: '17'},
		]
	},
