const timestamp_saved = '09/19/2023 01:50 PM';
const dataFechaAcualizado = '9/19/2023' + ' 9:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 183, MVar:'63', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'71', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'51', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'53', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'65', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:18.89, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'26', Cost:18.88, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'81', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'138', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'92', Cost:9.32, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 93,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'1', Cost:19.60, ParentId: '19'},
