const timestamp_saved = '10/29/2023 04:20 PM';
const dataFechaAcualizado = '10/29/2023' + ' 12:16:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2043},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'72', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.29, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'46', Cost:17.01, ParentId: '11'},
