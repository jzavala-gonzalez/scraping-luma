const timestamp_saved = '11/15/2023 09:45 AM';
const dataFechaAcualizado = '11/15/2023' + ' 5:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'37', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'40', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'46', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:18.09, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'107', Cost:18.29, ParentId: '16'},
		]
	},
