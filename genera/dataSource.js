const timestamp_saved = '10/05/2023 12:40 AM';
const dataFechaAcualizado = '10/4/2023' + ' 8:36:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'48', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'60', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'48', Cost:16.91, ParentId: '11'},
