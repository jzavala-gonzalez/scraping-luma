const timestamp_saved = '10/20/2023 11:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 7:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'40', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'47', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'44', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'99', Cost:10.55, ParentId: '17'},
		]
	},
