const timestamp_saved = '10/31/2023 02:30 AM';
const dataFechaAcualizado = '10/30/2023' + ' 10:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'111', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'57', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'61', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'67', Cost:11.55, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 6, MVar:'0', Cost:31.47, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'169', Cost:16.76, ParentId: '16'},
		]
	},
