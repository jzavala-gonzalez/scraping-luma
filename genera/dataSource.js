const timestamp_saved = '10/31/2023 12:55 PM';
const dataFechaAcualizado = '10/31/2023' + ' 8:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'59', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'74', Cost:9.41, ParentId: '17'},
		]
	},
