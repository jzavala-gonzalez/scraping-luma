const timestamp_saved = '11/13/2023 06:55 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:16.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'41', Cost:16.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 30, MVar:'48', Cost:16.63, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'60', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'83', Cost:9.15, ParentId: '17'},
		]
	},
