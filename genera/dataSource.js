const timestamp_saved = '11/22/2023 04:25 AM';
const dataFechaAcualizado = '11/22/2023' + ' 12:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'26', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'37', Cost:12.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'51', Cost:12.21, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 60, MVar:'67', Cost:21.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'88', Cost:9.09, ParentId: '17'},
		]
	},
