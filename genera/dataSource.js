const timestamp_saved = '11/08/2023 06:40 PM';
const dataFechaAcualizado = '11/8/2023' + ' 2:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 5,
		units:[
			...
			{Index:'1', Unit:'Hidro 2', MW: 5, MVar:'5', Cost:9.35, ParentId: '0'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'57', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'54', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'56', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'16', Cost:30.76, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 67, MVar:'10', Cost:19.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'107', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'169', Cost:17.52, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'112', Cost:9.23, ParentId: '17'},
		]
	},
