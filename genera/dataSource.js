const timestamp_saved = '08/03/2023 10:35 AM';
const dataFechaAcualizado = '8/3/2023' + ' 6:30:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'43', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'38', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'45', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 244,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'67', Cost:17.13, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'38', Cost:16.81, ParentId: '15'},
		]
	},
