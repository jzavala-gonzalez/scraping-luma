const timestamp_saved = '11/06/2023 09:20 AM';
const dataFechaAcualizado = '11/6/2023' + ' 5:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'43', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'42', Cost:10.87, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.10, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'13', Cost:17.10, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'53', Cost:9.94, ParentId: '17'},
		]
	},
