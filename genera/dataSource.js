const timestamp_saved = '12/01/2023 05:30 AM';
const dataFechaAcualizado = '12/1/2023' + ' 1:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'46', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'46', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'60', Cost:9.86, ParentId: '17'},
		]
	},
