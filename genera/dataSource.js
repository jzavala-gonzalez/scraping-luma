const timestamp_saved = '11/16/2023 06:55 AM';
const dataFechaAcualizado = '11/16/2023' + ' 2:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'42', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'40', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'47', Cost:12.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'25', Cost:0, ParentId: '8'},
