const timestamp_saved = '09/04/2023 04:30 PM';
const dataFechaAcualizado = '9/4/2023' + ' 12:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'44', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'55', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'26', Cost:19.74, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'71', Cost:9.40, ParentId: '17'},
		]
	},
