const timestamp_saved = '08/22/2023 03:30 AM';
const dataFechaAcualizado = '8/21/2023' + ' 11:25:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2627},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'48', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'49', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:19.70, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.58, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:19.54, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 123, MVar:'57', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'128', Cost:19.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'62', Cost:9.19, ParentId: '17'},
		]
	},
