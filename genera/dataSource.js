const timestamp_saved = '11/14/2023 06:25 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'42', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'45', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'50', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.18, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'84', Cost:11.23, ParentId: '17'},
		]
	},
