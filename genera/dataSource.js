const timestamp_saved = '09/29/2023 04:40 PM';
const dataFechaAcualizado = '9/29/2023' + ' 12:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'39', Cost:10.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:17.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.84, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 101, MVar:'0', Cost:18.29, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:18.29, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'16', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 127, MVar:'94', Cost:17.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 191,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 191, MVar:'130', Cost:18.24, ParentId: '16'},
		]
	},
