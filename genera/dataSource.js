const timestamp_saved = '11/15/2023 06:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 2:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'34', Cost:11.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'37', Cost:11.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'45', Cost:11.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'62', Cost:9.76, ParentId: '17'},
		]
	},
