const timestamp_saved = '11/21/2023 01:35 AM';
const dataFechaAcualizado = '11/20/2023' + ' 9:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'39', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'49', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'60', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:29.76, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'109', Cost:9.23, ParentId: '17'},
		]
	},
