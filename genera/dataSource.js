const timestamp_saved = '11/21/2023 06:20 PM';
const dataFechaAcualizado = '11/21/2023' + ' 2:16:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2196},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'35', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:10.87, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'93', Cost:9.61, ParentId: '17'},
		]
	},
