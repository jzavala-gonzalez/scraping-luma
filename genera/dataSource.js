const timestamp_saved = '11/11/2023 04:35 PM';
const dataFechaAcualizado = '11/11/2023' + ' 12:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'43', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'45', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'47', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:18.00, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'103', Cost:16.84, ParentId: '15'},
