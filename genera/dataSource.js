const timestamp_saved = '09/21/2023 04:35 AM';
const dataFechaAcualizado = '9/21/2023' + ' 12:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'38', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'42', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'14', Cost:31.02, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'2', Cost:26.73, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'49', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'94', Cost:9.14, ParentId: '17'},
		]
	},
