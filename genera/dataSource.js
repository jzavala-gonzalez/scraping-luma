const timestamp_saved = '10/29/2023 12:40 AM';
const dataFechaAcualizado = '10/28/2023' + ' 8:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'54', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'55', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'57', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'8', Cost:18.18, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'36', Cost:18.62, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'8', Cost:18.62, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'9', Cost:18.96, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'6', Cost:11.38, ParentId: '17'},
		]
	},
