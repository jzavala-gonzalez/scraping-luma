const timestamp_saved = '08/22/2023 12:40 PM';
const dataFechaAcualizado = '8/22/2023' + ' 8:35:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'52', Cost:10.27, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'46', Cost:19.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:19.50, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:18.99, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'138', Cost:17.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'82', Cost:9.41, ParentId: '17'},
		]
	},
