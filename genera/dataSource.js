const timestamp_saved = '09/22/2023 02:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 10:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'38', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'62', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'2', Cost:23.57, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'6', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'6', Cost:28.06, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:30.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'3', Cost:28.28, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'97', Cost:16.07, ParentId: '17'},
		]
	},
