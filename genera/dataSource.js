const timestamp_saved = '10/01/2023 05:30 PM';
const dataFechaAcualizado = '10/1/2023' + ' 1:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'36', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'34', Cost:10.15, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'89', Cost:16.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'133', Cost:17.46, ParentId: '16'},
		]
	},
