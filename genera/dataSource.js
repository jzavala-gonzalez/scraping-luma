const timestamp_saved = '08/05/2023 08:00 AM';
const dataFechaAcualizado = '8/5/2023' + ' 3:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'44', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:25.28, ParentId: '9'},
