const timestamp_saved = '08/03/2023 03:25 AM';
const dataFechaAcualizado = '8/2/2023' + ' 11:20:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:10.80, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 58,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'2', Cost:30.97, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 307,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'104', Cost:16.61, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'36', Cost:15.84, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'148', Cost:17.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'96', Cost:10.83, ParentId: '17'},
		]
	},
