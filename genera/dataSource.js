const timestamp_saved = '09/14/2023 05:45 PM';
const dataFechaAcualizado = '9/14/2023' + ' 1:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'56', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'55', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'68', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:5.66, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'115', Cost:9.23, ParentId: '17'},
		]
	},
