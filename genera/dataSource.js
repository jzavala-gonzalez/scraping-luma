const timestamp_saved = '08/05/2023 03:55 PM';
const dataFechaAcualizado = '8/5/2023' + ' 11:50:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'46', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'50', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'18', Cost:31.88, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:19.81, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.08, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'42', Cost:15.52, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'94', Cost:11.84, ParentId: '17'},
		]
	},
