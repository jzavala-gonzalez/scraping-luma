const timestamp_saved = '10/20/2023 10:50 AM';
const dataFechaAcualizado = '10/20/2023' + ' 6:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'38', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'45', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'43', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'91', Cost:10.54, ParentId: '17'},
		]
	},
