const timestamp_saved = '10/21/2023 06:20 PM';
const dataFechaAcualizado = '10/21/2023' + ' 2:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'47', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'71', Cost:11.07, ParentId: '17'},
		]
	},
