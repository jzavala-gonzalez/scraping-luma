const timestamp_saved = '10/29/2023 03:25 PM';
const dataFechaAcualizado = '10/29/2023' + ' 11:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'56', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'73', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'17', Cost:21.62, ParentId: '14'},
