const timestamp_saved = '11/04/2023 07:40 AM';
const dataFechaAcualizado = '11/4/2023' + ' 3:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'42', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'42', Cost:11.27, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 13,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 13, MVar:'0', Cost:26.47, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'49', Cost:9.74, ParentId: '17'},
		]
	},
