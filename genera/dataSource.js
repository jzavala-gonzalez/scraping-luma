const timestamp_saved = '07/25/2023 04:12 AM';
const dataFechaAcualizado = '7/25/2023' + ' 12:05:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'60', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'62', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'56', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'0', Cost:21.84, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'7', Cost:22.29, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'127', Cost:17.49, ParentId: '16'},
		]
	},
