const timestamp_saved = '10/05/2023 05:40 PM';
const dataFechaAcualizado = '10/5/2023' + ' 1:36:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'46', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'44', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'56', Cost:10.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 52,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 140, MVar:'53', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:31.67, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:18.58, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:18.58, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.01, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'77', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 332, MVar:'186', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'127', Cost:9.27, ParentId: '17'},
		]
	},
