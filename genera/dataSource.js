const timestamp_saved = '09/19/2023 07:45 AM';
const dataFechaAcualizado = '9/19/2023' + ' 3:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'44', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'80', Cost:9.12, ParentId: '17'},
		]
	},
