const timestamp_saved = '10/22/2023 02:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 10:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'42', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'43', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'46', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'16', Cost:19.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'58', Cost:11.22, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 38, MVar:'1', Cost:19.60, ParentId: '19'},
