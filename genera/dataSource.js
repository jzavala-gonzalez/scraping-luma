const timestamp_saved = '11/29/2023 03:35 AM';
const dataFechaAcualizado = '11/28/2023' + ' 11:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'32', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'42', Cost:11.40, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 4,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:28.00, ParentId: '13'},
