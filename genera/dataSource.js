const timestamp_saved = '10/10/2023 01:45 PM';
const dataFechaAcualizado = '10/10/2023' + ' 9:41:14 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2453},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'79', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'62', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'68', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'68', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'1', Cost:26.40, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:8.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'36', Cost:18.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'10', Cost:18.18, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'6', Cost:30.75, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.51, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'88', Cost:16.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'156', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'84', Cost:9.40, ParentId: '17'},
		]
	},
