const timestamp_saved = '11/10/2023 05:00 AM';
const dataFechaAcualizado = '11/10/2023' + ' 12:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'42', Cost:12.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'38', Cost:12.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'39', Cost:12.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.98, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'59', Cost:9.80, ParentId: '17'},
		]
	},
