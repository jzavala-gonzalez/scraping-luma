const timestamp_saved = '10/26/2023 06:40 AM';
const dataFechaAcualizado = '10/26/2023' + ' 2:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'36', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'36', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'42', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'10', Cost:19.41, ParentId: '14'},
