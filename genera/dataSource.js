const timestamp_saved = '09/19/2023 04:40 PM';
const dataFechaAcualizado = '9/19/2023' + ' 12:35:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 412},
	{Index:'4', Desc:'Reserva Operacional', value: 656},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 165, MVar:'70', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'79', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'57', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'59', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'69', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'2', Cost:20.36, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:27.11, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.75, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:36.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'26', Cost:18.90, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 65,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 65, MVar:'79', Cost:21.00, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'159', Cost:17.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'52', Cost:9.10, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 115,
		units:[
			...
			{Index:'3', Unit:'Coto Laurel', MW: 8, MVar:'1', Cost:19.10, ParentId: '19'},
			{Index:'4', Unit:'Oriana', MW: 43, MVar:'12', Cost:19.60, ParentId: '19'},
