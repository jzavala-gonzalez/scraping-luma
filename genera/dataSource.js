const timestamp_saved = '10/20/2023 08:55 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'30', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'38', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'39', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.48, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'81', Cost:10.54, ParentId: '17'},
		]
	},
