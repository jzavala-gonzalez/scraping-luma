const timestamp_saved = '09/22/2023 04:35 AM';
const dataFechaAcualizado = '9/22/2023' + ' 12:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'57', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'77', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'36', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'41', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'61', Cost:11.50, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 170,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'46', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 106,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'2', Cost:31.43, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'5', Cost:30.94, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 33,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'4', Cost:30.69, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 63,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'3', Cost:31.21, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.64, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'91', Cost:32.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'87', Cost:16.51, ParentId: '17'},
		]
	},
