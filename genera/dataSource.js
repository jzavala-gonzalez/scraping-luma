const timestamp_saved = '11/26/2023 01:35 AM';
const dataFechaAcualizado = '11/25/2023' + ' 9:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 239,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 239, MVar:'72', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'30', Cost:11.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'41', Cost:11.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'54', Cost:11.98, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 52,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'7', Cost:29.13, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'134', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'44', Cost:9.20, ParentId: '17'},
		]
	},
