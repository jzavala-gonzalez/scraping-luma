const timestamp_saved = '11/25/2023 05:00 AM';
const dataFechaAcualizado = '11/25/2023' + ' 12:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 189,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 189, MVar:'64', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'26', Cost:12.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'36', Cost:12.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'52', Cost:12.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.47, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'133', Cost:16.75, ParentId: '16'},
		]
	},
