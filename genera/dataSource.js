const timestamp_saved = '10/13/2023 05:45 PM';
const dataFechaAcualizado = '10/13/2023' + ' 1:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'68', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'72', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'73', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 6,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'8', Cost:0, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:16.98, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'18', Cost:19.27, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'187', Cost:18.23, ParentId: '16'},
		]
	},
