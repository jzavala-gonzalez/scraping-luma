const timestamp_saved = '11/17/2023 07:45 AM';
const dataFechaAcualizado = '11/17/2023' + ' 3:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'49', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'49', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'40', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:30.63, ParentId: '13'},
