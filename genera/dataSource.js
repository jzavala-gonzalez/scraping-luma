const timestamp_saved = '11/04/2023 03:00 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'45', Cost:13.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'44', Cost:13.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'44', Cost:13.29, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'85', Cost:16.93, ParentId: '15'},
