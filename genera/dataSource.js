const timestamp_saved = '08/28/2023 06:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 2:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'38', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'38', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 115,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 131, MVar:'23', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.14, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'136', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'89', Cost:12.04, ParentId: '17'},
		]
	},
