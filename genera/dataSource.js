const timestamp_saved = '11/19/2023 09:05 AM';
const dataFechaAcualizado = '11/19/2023' + ' 5:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'38', Cost:15.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:15.05, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'63', Cost:16.87, ParentId: '15'},
