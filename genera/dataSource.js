const timestamp_saved = '11/25/2023 08:41 PM';
const dataFechaAcualizado = '11/25/2023' + ' 4:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'33', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'44', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 19, MVar:'0', Cost:42.46, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'36', Cost:18.56, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:18.56, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 264,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 264, MVar:'138', Cost:17.65, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 38,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 0, MVar:'0', Cost:42, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:42.46, ParentId: '21'},
