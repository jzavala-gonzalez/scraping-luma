const timestamp_saved = '10/26/2023 01:00 AM';
const dataFechaAcualizado = '10/25/2023' + ' 8:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'51', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'54', Cost:10.74, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'55', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'157', Cost:16.74, ParentId: '16'},
		]
	},
