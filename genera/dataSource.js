const timestamp_saved = '08/14/2023 10:20 PM';
const dataFechaAcualizado = '8/14/2023' + ' 6:17:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'51', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.61, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 163,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 91, MVar:'0', Cost:3.52, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 162,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.40, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'3', Cost:23.00, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:22.22, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:19.95, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:19.95, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'165', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'132', Cost:11.65, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 21,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 10, MVar:'0', Cost:31.19, ParentId: '21'},
