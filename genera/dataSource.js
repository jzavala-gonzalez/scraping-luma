const timestamp_saved = '08/08/2023 12:20 AM';
const dataFechaAcualizado = '8/7/2023' + ' 8:15:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 390},
	{Index:'5', Desc:'Capacidad Disponible', value: 3138},
	{Index:'6', Desc:'Próxima Hora MW', value: 2944},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'40', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'61', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'77', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 195,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 118, MVar:'0', Cost:7.11, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.25, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 20, MVar:'0', Cost:47.41, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.76, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 157, MVar:'16', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'1', Cost:26.20, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'3', Cost:31.23, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'6', Cost:31.25, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'41', Cost:20.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'0', Cost:20.46, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.42, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:27.56, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.12, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'9', Cost:18.76, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 251,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'43', Cost:18.42, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'30', Cost:15.68, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'149', Cost:19.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'85', Cost:11.63, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 68,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 20, MVar:'0', Cost:25.91, ParentId: '21'},
