const timestamp_saved = '08/23/2023 08:40 PM';
const dataFechaAcualizado = '8/23/2023' + ' 4:35:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'57', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'56', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:30.69, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'32', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'90', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'94', Cost:9.29, ParentId: '17'},
		]
	},
