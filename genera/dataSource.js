const timestamp_saved = '08/02/2023 03:40 AM';
const dataFechaAcualizado = '8/1/2023' + ' 11:35:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:10.74, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'61', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'87', Cost:10.99, ParentId: '17'},
		]
	},
