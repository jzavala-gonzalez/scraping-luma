const timestamp_saved = '12/04/2023 08:45 AM';
const dataFechaAcualizado = '12/4/2023' + ' 4:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'37', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'38', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'44', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'15', Cost:19.50, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'100', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'44', Cost:11.62, ParentId: '17'},
		]
	},
