const timestamp_saved = '11/21/2023 11:50 AM';
const dataFechaAcualizado = '11/21/2023' + ' 7:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'27', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'36', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'51', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'77', Cost:9.59, ParentId: '17'},
		]
	},
