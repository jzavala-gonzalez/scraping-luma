const timestamp_saved = '10/30/2023 05:25 PM';
const dataFechaAcualizado = '10/30/2023' + ' 1:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'61', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'65', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'69', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'103', Cost:16.73, ParentId: '15'},
