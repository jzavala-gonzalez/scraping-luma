const timestamp_saved = '10/09/2023 01:25 PM';
const dataFechaAcualizado = '10/9/2023' + ' 9:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'49', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'50', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'47', Cost:10.76, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:26.64, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:17.62, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'163', Cost:18.26, ParentId: '16'},
		]
	},
