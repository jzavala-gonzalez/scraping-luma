const timestamp_saved = '11/21/2023 12:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 8:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'50', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'113', Cost:9.21, ParentId: '17'},
		]
	},
