const timestamp_saved = '10/28/2023 02:50 AM';
const dataFechaAcualizado = '10/27/2023' + ' 10:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'44', Cost:10.81, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 92, MVar:'30', Cost:18.13, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'7', Cost:18.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'5', Cost:19.34, ParentId: '14'},
