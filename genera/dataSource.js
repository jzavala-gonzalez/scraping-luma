const timestamp_saved = '10/19/2023 05:40 AM';
const dataFechaAcualizado = '10/19/2023' + ' 1:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'34', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'41', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:16.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:16.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'0', Cost:18.88, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'83', Cost:11.46, ParentId: '17'},
		]
	},
