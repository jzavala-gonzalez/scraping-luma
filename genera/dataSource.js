const timestamp_saved = '11/09/2023 07:15 PM';
const dataFechaAcualizado = '11/9/2023' + ' 3:11:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'49', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'48', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'52', Cost:11.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 56,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:82.53, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:18.20, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 131, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'19', Cost:22.07, ParentId: '14'},
