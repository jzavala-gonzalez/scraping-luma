const timestamp_saved = '11/30/2023 11:50 AM';
const dataFechaAcualizado = '11/30/2023' + ' 7:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'50', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'68', Cost:9.55, ParentId: '17'},
		]
	},
