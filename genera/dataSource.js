const timestamp_saved = '11/21/2023 08:55 AM';
const dataFechaAcualizado = '11/21/2023' + ' 4:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'21', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'30', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'46', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'64', Cost:9.60, ParentId: '17'},
		]
	},
