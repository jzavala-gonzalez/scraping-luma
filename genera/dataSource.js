const timestamp_saved = '11/06/2023 10:35 AM';
const dataFechaAcualizado = '11/6/2023' + ' 6:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'45', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'44', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 63,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 11, MVar:'3', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'85', Cost:16.89, ParentId: '15'},
