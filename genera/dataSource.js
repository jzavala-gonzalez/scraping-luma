const timestamp_saved = '10/21/2023 07:00 AM';
const dataFechaAcualizado = '10/21/2023' + ' 2:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'23', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'19', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'59', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'71', Cost:11.03, ParentId: '17'},
		]
	},
