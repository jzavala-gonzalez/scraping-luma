const timestamp_saved = '10/28/2023 02:10 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'43', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'46', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 40, MVar:'12', Cost:39.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:39.14, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 26, MVar:'73', Cost:32.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'126', Cost:17.03, ParentId: '16'},
		]
	},
