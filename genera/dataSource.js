const timestamp_saved = '10/23/2023 06:55 PM';
const dataFechaAcualizado = '10/23/2023' + ' 2:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 158, MVar:'55', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'98', Cost:16.71, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'86', Cost:11.32, ParentId: '17'},
		]
	},
