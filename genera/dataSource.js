const timestamp_saved = '11/10/2023 05:40 AM';
const dataFechaAcualizado = '11/10/2023' + ' 1:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'40', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'36', Cost:12.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'38', Cost:12.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.06, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'5', Cost:30.77, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'25', Cost:22.02, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 154, MVar:'120', Cost:19.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'58', Cost:9.83, ParentId: '17'},
		]
	},
