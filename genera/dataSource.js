const timestamp_saved = '12/04/2023 08:40 AM';
const dataFechaAcualizado = '12/4/2023' + ' 4:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'37', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'38', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:18.04, ParentId: '11'},
