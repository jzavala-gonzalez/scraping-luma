const timestamp_saved = '10/31/2023 11:55 AM';
const dataFechaAcualizado = '10/31/2023' + ' 7:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'54', Cost:10.45, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'25', Cost:19.21, ParentId: '14'},
