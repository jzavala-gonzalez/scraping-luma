const timestamp_saved = '10/12/2023 06:05 AM';
const dataFechaAcualizado = '10/12/2023' + ' 2:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'61', Cost:10.09, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'88', Cost:16.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 188,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'163', Cost:19.42, ParentId: '16'},
		]
	},
