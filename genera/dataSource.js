const timestamp_saved = '08/31/2023 07:25 AM';
const dataFechaAcualizado = '8/31/2023' + ' 3:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'54', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'61', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'0', Cost:28.38, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'8', Cost:30.50, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'136', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 229, MVar:'70', Cost:10.03, ParentId: '17'},
		]
	},
