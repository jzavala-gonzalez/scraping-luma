const timestamp_saved = '09/16/2023 09:10 AM';
const dataFechaAcualizado = '9/16/2023' + ' 5:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'39', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'43', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.89, ParentId: '7'},
