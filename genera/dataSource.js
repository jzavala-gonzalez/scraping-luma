const timestamp_saved = '11/10/2023 11:45 AM';
const dataFechaAcualizado = '11/10/2023' + ' 7:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'50', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'55', Cost:11.46, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'10', Cost:21.86, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'13', Cost:18.82, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'71', Cost:9.55, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 5,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 4, MVar:'18', Cost:19.60, ParentId: '19'},
