const timestamp_saved = '09/24/2023 06:15 AM';
const dataFechaAcualizado = '9/24/2023' + ' 2:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'42', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'42', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'52', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 114, MVar:'0', Cost:8.43, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:8.43, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'6', Cost:28.23, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.34, ParentId: '14'},
