const timestamp_saved = '09/20/2023 12:50 AM';
const dataFechaAcualizado = '9/19/2023' + ' 8:45:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2942},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 225, MVar:'80', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'87', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'53', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'55', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'67', Cost:11.29, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:5.18, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'2', Cost:26.55, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'19', Cost:18.94, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'79', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'92', Cost:9.13, ParentId: '17'},
		]
	},
