const timestamp_saved = '10/26/2023 05:15 PM';
const dataFechaAcualizado = '10/26/2023' + ' 1:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'49', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'52', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 166, MVar:'53', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.48, ParentId: '11'},
