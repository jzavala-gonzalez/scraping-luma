const timestamp_saved = '11/21/2023 03:25 PM';
const dataFechaAcualizado = '11/21/2023' + ' 11:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 133, MVar:'57', Cost:11.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'40', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'13', Cost:17.74, ParentId: '11'},
