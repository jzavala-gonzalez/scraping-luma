const timestamp_saved = '10/26/2023 07:25 AM';
const dataFechaAcualizado = '10/26/2023' + ' 3:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'34', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'37', Cost:11.97, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'6', Cost:18.17, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'12', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'45', Cost:18.40, ParentId: '15'},
