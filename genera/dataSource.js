const timestamp_saved = '10/29/2023 05:10 PM';
const dataFechaAcualizado = '10/29/2023' + ' 1:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'48', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'51', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'72', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.34, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'46', Cost:17.02, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'16', Cost:21.71, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'124', Cost:16.96, ParentId: '16'},
		]
	},
