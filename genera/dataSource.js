const timestamp_saved = '07/30/2023 03:00 PM';
const dataFechaAcualizado = '7/30/2023' + ' 10:55:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'44', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'39', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'25', Cost:19.12, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'68', Cost:11.16, ParentId: '17'},
		]
	},
