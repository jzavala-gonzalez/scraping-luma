const timestamp_saved = '11/10/2023 08:05 PM';
const dataFechaAcualizado = '11/10/2023' + ' 4:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 242,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'100', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'38', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'56', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:17.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'13', Cost:17.24, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'12', Cost:31.26, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'98', Cost:9.23, ParentId: '17'},
		]
	},
