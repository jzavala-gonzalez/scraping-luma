const timestamp_saved = '09/17/2023 10:30 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'36', Cost:11.62, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 221,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 221, MVar:'109', Cost:18.43, ParentId: '16'},
		]
	},
