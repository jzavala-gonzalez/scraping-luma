const timestamp_saved = '09/14/2023 10:06 AM';
const dataFechaAcualizado = '9/14/2023' + ' 6:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'50', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'50', Cost:10.64, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'71', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'90', Cost:9.24, ParentId: '17'},
		]
	},
