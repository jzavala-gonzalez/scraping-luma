const timestamp_saved = '08/14/2023 06:05 PM';
const dataFechaAcualizado = '8/14/2023' + ' 2:02:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'48', Cost:10.67, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'20', Cost:28.29, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:21.91, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:21.91, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.63, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'126', Cost:12.44, ParentId: '17'},
		]
	},
