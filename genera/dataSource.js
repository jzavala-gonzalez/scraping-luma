const timestamp_saved = '07/30/2023 10:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:20:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'43', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'38', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'2', Cost:43.31, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'75', Cost:17.76, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'35', Cost:16.28, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'60', Cost:19.70, ParentId: '16'},
		]
	},
