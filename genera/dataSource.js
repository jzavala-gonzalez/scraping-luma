const timestamp_saved = '08/21/2023 07:50 PM';
const dataFechaAcualizado = '8/21/2023' + ' 3:45:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'59', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'41', Cost:10.21, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'78', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'154', Cost:17.93, ParentId: '16'},
		]
	},
