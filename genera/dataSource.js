const timestamp_saved = '11/15/2023 05:00 PM';
const dataFechaAcualizado = '11/15/2023' + ' 12:56:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'57', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'55', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.53, ParentId: '11'},
