const timestamp_saved = '10/29/2023 02:40 PM';
const dataFechaAcualizado = '10/29/2023' + ' 10:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'50', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'52', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'72', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:26.39, ParentId: '9'},
		]
	},
