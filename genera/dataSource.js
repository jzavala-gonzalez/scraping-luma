const timestamp_saved = '07/29/2023 12:27 AM';
const dataFechaAcualizado = '7/28/2023' + ' 8:20:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'49', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'48', Cost:11.27, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 101, MVar:'0', Cost:4.81, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'3', Cost:22.32, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:8.28, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:31.10, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.68, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'91', Cost:16.69, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'26', Cost:15.55, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'85', Cost:13.86, ParentId: '17'},
		]
	},
