const timestamp_saved = '11/20/2023 05:30 PM';
const dataFechaAcualizado = '11/20/2023' + ' 1:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'32', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'42', Cost:12.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'56', Cost:12.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.62, ParentId: '11'},
