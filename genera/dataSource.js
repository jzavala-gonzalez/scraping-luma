const timestamp_saved = '08/18/2023 05:00 AM';
const dataFechaAcualizado = '8/18/2023' + ' 12:57:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'55', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'67', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:30.74, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.09, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 308,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 308, MVar:'139', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'68', Cost:9.42, ParentId: '17'},
		]
	},
