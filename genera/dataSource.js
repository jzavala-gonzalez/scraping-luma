const timestamp_saved = '08/23/2023 12:25 AM';
const dataFechaAcualizado = '8/22/2023' + ' 8:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 163, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'51', Cost:10.54, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:24.44, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 313, MVar:'134', Cost:17.17, ParentId: '16'},
		]
	},
