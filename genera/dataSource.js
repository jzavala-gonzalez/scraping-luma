const timestamp_saved = '11/28/2023 05:30 AM';
const dataFechaAcualizado = '11/28/2023' + ' 1:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'26', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'36', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'50', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'35', Cost:8.69, ParentId: '11'},
