const timestamp_saved = '08/16/2023 07:30 AM';
const dataFechaAcualizado = '8/16/2023' + ' 3:27:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'57', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'79', Cost:10.47, ParentId: '17'},
		]
	},
