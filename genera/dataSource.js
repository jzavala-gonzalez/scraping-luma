const timestamp_saved = '09/28/2023 05:40 PM';
const dataFechaAcualizado = '9/28/2023' + ' 1:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'30', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'31', Cost:10.69, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'13', Cost:19.24, ParentId: '14'},
