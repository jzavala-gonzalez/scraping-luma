const timestamp_saved = '09/02/2023 02:50 AM';
const dataFechaAcualizado = '9/1/2023' + ' 10:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'60', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'75', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'48', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'55', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'63', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'5', Cost:31.07, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:31.63, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'15', Cost:19.64, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'149', Cost:16.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'61', Cost:9.87, ParentId: '17'},
		]
	},
