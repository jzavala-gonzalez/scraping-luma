const timestamp_saved = '08/19/2023 07:05 AM';
const dataFechaAcualizado = '8/19/2023' + ' 3:02:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'61', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'71', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:30.49, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:30.08, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'62', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 195,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'154', Cost:18.69, ParentId: '16'},
		]
	},
