const timestamp_saved = '09/02/2023 02:30 AM';
const dataFechaAcualizado = '9/1/2023' + ' 10:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:9.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'59', Cost:9.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 214, MVar:'64', Cost:9.72, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'5', Cost:30.36, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:30.20, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'17', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'147', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 232,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 232, MVar:'65', Cost:10.17, ParentId: '17'},
		]
	},
