const timestamp_saved = '10/26/2023 07:40 PM';
const dataFechaAcualizado = '10/26/2023' + ' 3:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'48', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'54', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'53', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'20', Cost:43.59, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.28, ParentId: '11'},
