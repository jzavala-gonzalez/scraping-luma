const timestamp_saved = '10/26/2023 06:40 PM';
const dataFechaAcualizado = '10/26/2023' + ' 2:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'52', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'57', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'56', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:17.50, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'43', Cost:17.29, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:17.29, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.18, ParentId: '14'},
