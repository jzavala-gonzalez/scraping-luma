const timestamp_saved = '10/31/2023 10:45 AM';
const dataFechaAcualizado = '10/31/2023' + ' 6:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'55', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'57', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'64', Cost:9.41, ParentId: '17'},
		]
	},
