const timestamp_saved = '08/07/2023 11:25 AM';
const dataFechaAcualizado = '8/7/2023' + ' 7:20:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'46', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'0', Cost:26.52, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.16, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'92', Cost:18.45, ParentId: '15'},
