const timestamp_saved = '11/21/2023 05:35 AM';
const dataFechaAcualizado = '11/21/2023' + ' 1:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'24', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'35', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 62, MVar:'29', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 102, MVar:'50', Cost:18.45, ParentId: '15'},
