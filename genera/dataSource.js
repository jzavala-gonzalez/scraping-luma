const timestamp_saved = '09/09/2023 08:40 AM';
const dataFechaAcualizado = '9/9/2023' + ' 4:35:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'50', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'55', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'54', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 138,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 68, MVar:'12', Cost:27.92, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 70, MVar:'11', Cost:27.92, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:19.77, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'62', Cost:16.60, ParentId: '15'},
