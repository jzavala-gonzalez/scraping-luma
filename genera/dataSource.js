const timestamp_saved = '09/07/2023 03:40 AM';
const dataFechaAcualizado = '9/6/2023' + ' 11:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'55', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'33', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:21.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:21.82, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.58, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 362, MVar:'163', Cost:16.66, ParentId: '16'},
		]
	},
