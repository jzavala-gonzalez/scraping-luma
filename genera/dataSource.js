const timestamp_saved = '08/31/2023 11:35 PM';
const dataFechaAcualizado = '8/31/2023' + ' 7:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'55', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'64', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'69', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 133,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 81, MVar:'25', Cost:28.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'15', Cost:30.99, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:18.95, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'46', Cost:19.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'98', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'201', Cost:16.68, ParentId: '16'},
		]
	},
