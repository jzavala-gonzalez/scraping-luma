const timestamp_saved = '11/20/2023 02:55 PM';
const dataFechaAcualizado = '11/20/2023' + ' 10:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'38', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'48', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'60', Cost:10.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.46, ParentId: '8'},
