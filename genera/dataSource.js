const timestamp_saved = '12/02/2023 12:30 PM';
const dataFechaAcualizado = '12/2/2023' + ' 8:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'44', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'46', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'44', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'64', Cost:9.76, ParentId: '17'},
		]
	},
