const timestamp_saved = '09/02/2023 02:20 AM';
const dataFechaAcualizado = '9/1/2023' + ' 10:15:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 566,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'57', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 216, MVar:'65', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 114,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:20.04, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 28, MVar:'9', Cost:20.84, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'2', Cost:21.46, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 63, MVar:'9', Cost:28.70, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 63, MVar:'10', Cost:29.94, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'17', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'75', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'159', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 219,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 219, MVar:'53', Cost:10.36, ParentId: '17'},
		]
	},
