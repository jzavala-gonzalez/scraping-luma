const timestamp_saved = '09/28/2023 08:00 AM';
const dataFechaAcualizado = '9/28/2023' + ' 3:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'18', Cost:13.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'17', Cost:13.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'43', Cost:13.42, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'89', Cost:18.42, ParentId: '16'},
		]
	},
