const timestamp_saved = '10/15/2023 11:55 AM';
const dataFechaAcualizado = '10/15/2023' + ' 7:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'47', Cost:11.04, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'126', Cost:17.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'62', Cost:9.52, ParentId: '17'},
		]
	},
