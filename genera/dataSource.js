const timestamp_saved = '12/06/2023 08:55 AM';
const dataFechaAcualizado = '12/6/2023' + ' 4:50:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 552},
	{Index:'6', Desc:'Reserva Operacional', value: 1146},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'40', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'42', Cost:12.12, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'52', Cost:14.52, ParentId: '17'},
		]
	},
