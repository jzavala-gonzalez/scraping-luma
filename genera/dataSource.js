const timestamp_saved = '10/28/2023 02:35 AM';
const dataFechaAcualizado = '10/27/2023' + ' 10:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'44', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'45', Cost:11.17, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'35', Cost:17.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'8', Cost:17.61, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 109,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'11', Cost:23.74, ParentId: '14'},
