const timestamp_saved = '11/28/2023 10:05 AM';
const dataFechaAcualizado = '11/28/2023' + ' 6:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'31', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'40', Cost:10.19, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'127', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'84', Cost:9.52, ParentId: '17'},
		]
	},
