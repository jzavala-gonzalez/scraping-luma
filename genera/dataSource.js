const timestamp_saved = '09/27/2023 01:40 PM';
const dataFechaAcualizado = '9/27/2023' + ' 9:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'31', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'32', Cost:10.92, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:17.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.77, ParentId: '11'},
