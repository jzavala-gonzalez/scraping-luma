const timestamp_saved = '09/27/2023 08:00 AM';
const dataFechaAcualizado = '9/27/2023' + ' 3:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'26', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'25', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'59', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.16, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'73', Cost:9.15, ParentId: '17'},
		]
	},
