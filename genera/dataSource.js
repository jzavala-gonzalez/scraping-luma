const timestamp_saved = '08/18/2023 03:55 AM';
const dataFechaAcualizado = '8/17/2023' + ' 11:52:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'45', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'59', Cost:11.29, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'8', Cost:31.54, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'14', Cost:19.81, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 333, MVar:'147', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'78', Cost:9.19, ParentId: '17'},
		]
	},
