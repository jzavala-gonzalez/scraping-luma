const timestamp_saved = '09/27/2023 11:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'26', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'26', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'57', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:18.45, ParentId: '11'},
