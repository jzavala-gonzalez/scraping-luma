const timestamp_saved = '11/17/2023 10:10 AM';
const dataFechaAcualizado = '11/17/2023' + ' 6:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'56', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'56', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'17', Cost:31.25, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'93', Cost:9.81, ParentId: '17'},
		]
	},
