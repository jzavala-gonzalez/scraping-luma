const timestamp_saved = '09/23/2023 09:55 PM';
const dataFechaAcualizado = '9/23/2023' + ' 5:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'51', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'51', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'62', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'22', Cost:18.59, ParentId: '14'},
