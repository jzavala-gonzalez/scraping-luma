const timestamp_saved = '09/04/2023 04:25 PM';
const dataFechaAcualizado = '9/4/2023' + ' 12:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'41', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'45', Cost:10.40, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 79,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 131, MVar:'55', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'24', Cost:19.22, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'70', Cost:9.39, ParentId: '17'},
		]
	},
