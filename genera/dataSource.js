const timestamp_saved = '10/23/2023 03:00 PM';
const dataFechaAcualizado = '10/23/2023' + ' 10:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'34', Cost:18.22, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'87', Cost:11.31, ParentId: '17'},
		]
	},
