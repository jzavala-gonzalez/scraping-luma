const timestamp_saved = '08/09/2023 06:00 AM';
const dataFechaAcualizado = '8/9/2023' + ' 1:55:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'39', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'47', Cost:11.29, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.53, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 344, MVar:'104', Cost:16.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 211,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 211, MVar:'66', Cost:13.57, ParentId: '17'},
		]
	},
