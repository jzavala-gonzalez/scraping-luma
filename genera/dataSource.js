const timestamp_saved = '11/26/2023 10:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 6:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'18', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'28', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'45', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.06, ParentId: '14'},
