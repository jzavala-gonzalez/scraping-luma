const timestamp_saved = '07/31/2023 01:10 AM';
const dataFechaAcualizado = '7/30/2023' + ' 9:05:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'58', Cost:10.62, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'99', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'95', Cost:10.95, ParentId: '17'},
		]
	},
