const timestamp_saved = '10/27/2023 07:20 AM';
const dataFechaAcualizado = '10/27/2023' + ' 3:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'40', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'43', Cost:11.36, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'90', Cost:18.21, ParentId: '16'},
		]
	},
