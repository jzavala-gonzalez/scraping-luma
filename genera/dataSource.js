const timestamp_saved = '09/16/2023 06:00 AM';
const dataFechaAcualizado = '9/16/2023' + ' 1:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'47', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'59', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:9.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:9.40, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'22', Cost:18.94, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'86', Cost:9.44, ParentId: '17'},
		]
	},
