const timestamp_saved = '09/26/2023 07:55 PM';
const dataFechaAcualizado = '9/26/2023' + ' 3:50:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3501},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'57', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'56', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'63', Cost:10.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 77, MVar:'0', Cost:5.99, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 10,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'0', Cost:83.31, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'11', Cost:19.29, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'78', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'181', Cost:17.84, ParentId: '16'},
		]
	},
