const timestamp_saved = '09/21/2023 08:15 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'37', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'61', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.14, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'9', Cost:26.81, ParentId: '14'},
