const timestamp_saved = '10/24/2023 05:20 PM';
const dataFechaAcualizado = '10/24/2023' + ' 1:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:17.55, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:39.77, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'151', Cost:17.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'81', Cost:11.28, ParentId: '17'},
		]
	},
