const timestamp_saved = '11/14/2023 09:15 PM';
const dataFechaAcualizado = '11/14/2023' + ' 5:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'54', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'59', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'60', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:28.39, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:28.63, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'100', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'195', Cost:17.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'112', Cost:10.93, ParentId: '17'},
		]
	},
