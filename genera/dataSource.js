const timestamp_saved = '07/29/2023 01:55 PM';
const dataFechaAcualizado = '7/29/2023' + ' 9:50:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'53', Cost:10.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:19.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:19.69, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 109, MVar:'0', Cost:9.35, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:9.35, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 269,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'93', Cost:17.69, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'28', Cost:15.91, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'90', Cost:13.42, ParentId: '17'},
		]
	},
