const timestamp_saved = '11/10/2023 10:05 PM';
const dataFechaAcualizado = '11/10/2023' + ' 6:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'104', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'45', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'44', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'55', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 53,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'16', Cost:30.88, ParentId: '10'},
