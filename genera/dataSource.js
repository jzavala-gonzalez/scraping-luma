const timestamp_saved = '11/04/2023 09:35 AM';
const dataFechaAcualizado = '11/4/2023' + ' 5:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'40', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'40', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'14', Cost:21.08, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'48', Cost:9.73, ParentId: '17'},
		]
	},
