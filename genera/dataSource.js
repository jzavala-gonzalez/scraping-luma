const timestamp_saved = '09/23/2023 03:55 AM';
const dataFechaAcualizado = '9/22/2023' + ' 11:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 285,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 89, MVar:'41', Cost:13.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'42', Cost:13.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'58', Cost:13.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 170,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 104, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 127,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'3', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'1', Cost:30.67, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'45', Cost:8.22, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'9', Cost:18.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'57', Cost:16.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'98', Cost:32.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'79', Cost:9.22, ParentId: '17'},
		]
	},
