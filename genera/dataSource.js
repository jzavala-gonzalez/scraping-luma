const timestamp_saved = '11/25/2023 08:25 AM';
const dataFechaAcualizado = '11/25/2023' + ' 4:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 230,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'58', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'18', Cost:13.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'28', Cost:13.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'47', Cost:13.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'9', Cost:19.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'118', Cost:17.37, ParentId: '16'},
		]
	},
