const timestamp_saved = '10/26/2023 03:55 AM';
const dataFechaAcualizado = '10/25/2023' + ' 11:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'43', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'44', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'48', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'40', Cost:16.73, ParentId: '15'},
