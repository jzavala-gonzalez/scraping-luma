const timestamp_saved = '09/29/2023 07:25 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'31', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'29', Cost:12.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'47', Cost:12.78, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'114', Cost:17.80, ParentId: '16'},
		]
	},
