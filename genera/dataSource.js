const timestamp_saved = '11/11/2023 12:30 AM';
const dataFechaAcualizado = '11/10/2023' + ' 8:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'52', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'54', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:18.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'90', Cost:16.95, ParentId: '15'},
