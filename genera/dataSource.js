const timestamp_saved = '08/31/2023 01:40 AM';
const dataFechaAcualizado = '8/30/2023' + ' 9:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'75', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'112', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'66', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'74', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'77', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.81, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'5', Cost:22.89, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'29', Cost:28.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'29', Cost:28.18, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:18.96, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:18.96, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.04, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 44, MVar:'0', Cost:29.72, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'7', Cost:29.13, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'35', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'106', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'204', Cost:16.63, ParentId: '16'},
		]
	},
