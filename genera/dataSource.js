const timestamp_saved = '10/21/2023 02:55 AM';
const dataFechaAcualizado = '10/20/2023' + ' 10:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'42', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'47', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'46', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:32.12, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'59', Cost:16.70, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'157', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'93', Cost:10.64, ParentId: '17'},
		]
	},
