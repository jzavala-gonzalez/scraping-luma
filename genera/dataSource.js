const timestamp_saved = '10/20/2023 04:05 AM';
const dataFechaAcualizado = '10/20/2023' + ' 12:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'39', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'46', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'53', Cost:16.87, ParentId: '15'},
