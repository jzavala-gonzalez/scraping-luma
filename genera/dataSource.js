const timestamp_saved = '07/28/2023 07:50 PM';
const dataFechaAcualizado = '7/28/2023' + ' 3:45:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'51', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'3', Cost:22.47, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'48', Cost:15.64, ParentId: '15'},
		]
	},
