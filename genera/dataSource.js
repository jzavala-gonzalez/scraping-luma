const timestamp_saved = '11/21/2023 08:00 PM';
const dataFechaAcualizado = '11/21/2023' + ' 3:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'35', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'46', Cost:10.79, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'99', Cost:9.32, ParentId: '17'},
		]
	},
