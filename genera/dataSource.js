const timestamp_saved = '10/29/2023 10:00 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'43', Cost:11.12, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 334, MVar:'135', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 214,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 214, MVar:'52', Cost:10.28, ParentId: '17'},
		]
	},
