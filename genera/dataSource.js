const timestamp_saved = '09/28/2023 09:35 PM';
const dataFechaAcualizado = '9/28/2023' + ' 5:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'45', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'47', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'51', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.48, ParentId: '11'},
