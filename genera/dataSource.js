const timestamp_saved = '10/05/2023 12:15 AM';
const dataFechaAcualizado = '10/4/2023' + ' 8:11:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'90', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'48', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'47', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'49', Cost:16.90, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'172', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'122', Cost:9.18, ParentId: '17'},
		]
	},
