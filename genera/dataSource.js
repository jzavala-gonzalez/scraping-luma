const timestamp_saved = '10/20/2023 09:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 5:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'39', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'46', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'44', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'152', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'98', Cost:10.53, ParentId: '17'},
		]
	},
