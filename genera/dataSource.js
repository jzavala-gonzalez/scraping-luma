const timestamp_saved = '08/21/2023 02:50 AM';
const dataFechaAcualizado = '8/20/2023' + ' 10:47:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'60', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'46', Cost:10.65, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'0', Cost:31.11, ParentId: '12'},
