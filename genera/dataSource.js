const timestamp_saved = '08/08/2023 09:15 AM';
const dataFechaAcualizado = '8/8/2023' + ' 5:10:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'40', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'48', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'56', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'29', Cost:16.28, ParentId: '15'},
		]
	},
