const timestamp_saved = '09/05/2023 02:20 PM';
const dataFechaAcualizado = '9/5/2023' + ' 10:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'43', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:10.84, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 74, MVar:'76', Cost:21.12, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'152', Cost:18.25, ParentId: '16'},
		]
	},
