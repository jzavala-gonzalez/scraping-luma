const timestamp_saved = '10/27/2023 03:50 PM';
const dataFechaAcualizado = '10/27/2023' + ' 11:46:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2323},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'55', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'54', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'56', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:16.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:16.72, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'116', Cost:17.10, ParentId: '16'},
		]
	},
