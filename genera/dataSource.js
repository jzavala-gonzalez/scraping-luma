const timestamp_saved = '10/28/2023 11:00 PM';
const dataFechaAcualizado = '10/28/2023' + ' 6:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'53', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'54', Cost:11.51, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'7', Cost:18.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'35', Cost:18.64, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'10', Cost:18.64, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'17', Cost:21.51, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'10', Cost:18.97, ParentId: '14'},
