const timestamp_saved = '10/22/2023 10:20 PM';
const dataFechaAcualizado = '10/22/2023' + ' 6:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'53', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'48', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 33,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 13, MVar:'0', Cost:25.37, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'128', Cost:17.35, ParentId: '16'},
		]
	},
