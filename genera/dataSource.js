const timestamp_saved = '08/03/2023 01:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 9:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'42', Cost:11.21, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:28.92, ParentId: '12'},
