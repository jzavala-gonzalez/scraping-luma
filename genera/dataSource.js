const timestamp_saved = '07/26/2023 05:58 PM';
const dataFechaAcualizado = '7/26/2023' + ' 1:50:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'57', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'53', Cost:11.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 100,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 146, MVar:'23', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 20,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.58, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 322,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'100', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'31', Cost:15.68, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'86', Cost:13.27, ParentId: '17'},
		]
	},
