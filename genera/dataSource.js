const timestamp_saved = '10/01/2023 03:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 11:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'30', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'28', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'46', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 129, MVar:'37', Cost:17.38, ParentId: '11'},
