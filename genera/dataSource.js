const timestamp_saved = '09/26/2023 05:10 PM';
const dataFechaAcualizado = '9/26/2023' + ' 1:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'48', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'47', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'56', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.81, ParentId: '11'},
