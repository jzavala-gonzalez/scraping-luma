const timestamp_saved = '12/06/2023 02:15 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:10:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 904},
	{Index:'7', Desc:'Capacidad Disponible', value: 3005},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'47', Cost:13.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'49', Cost:13.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'57', Cost:13.09, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'10', Cost:18.72, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'69', Cost:14.35, ParentId: '17'},
		]
	},
