const timestamp_saved = '11/23/2023 01:00 PM';
const dataFechaAcualizado = '11/23/2023' + ' 8:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 209, MVar:'70', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'21', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'30', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'47', Cost:12.41, ParentId: '7'},
		]
	},
