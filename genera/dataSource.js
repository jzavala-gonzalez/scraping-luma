const timestamp_saved = '09/18/2023 04:50 AM';
const dataFechaAcualizado = '9/18/2023' + ' 12:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'48', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'46', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'62', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:21.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:21.62, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'25', Cost:18.92, ParentId: '14'},
