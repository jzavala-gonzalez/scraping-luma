const timestamp_saved = '08/20/2023 08:45 PM';
const dataFechaAcualizado = '8/20/2023' + ' 4:42:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'32', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'56', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 5,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'5', Cost:629.58, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'74', Cost:9.17, ParentId: '17'},
		]
	},
