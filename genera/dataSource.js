const timestamp_saved = '10/31/2023 03:41 AM';
const dataFechaAcualizado = '10/30/2023' + ' 11:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'54', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'57', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'64', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'7', Cost:31.35, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 3, MVar:'0', Cost:30.53, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'14', Cost:20.94, ParentId: '14'},
