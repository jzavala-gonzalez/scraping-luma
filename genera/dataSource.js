const timestamp_saved = '10/29/2023 07:30 AM';
const dataFechaAcualizado = '10/29/2023' + ' 3:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'33', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'36', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'60', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.11, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:18.11, ParentId: '11'},
