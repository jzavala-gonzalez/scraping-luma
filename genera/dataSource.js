const timestamp_saved = '10/31/2023 08:10 AM';
const dataFechaAcualizado = '10/31/2023' + ' 4:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'48', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'52', Cost:10.12, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'61', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'127', Cost:17.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 193,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 193, MVar:'46', Cost:10.52, ParentId: '17'},
		]
	},
