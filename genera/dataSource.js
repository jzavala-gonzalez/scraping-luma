const timestamp_saved = '11/01/2023 03:10 PM';
const dataFechaAcualizado = '11/1/2023' + ' 11:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'57', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'61', Cost:10.99, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:17.26, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'76', Cost:9.40, ParentId: '17'},
		]
	},
