const timestamp_saved = '11/21/2023 05:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 1:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'22', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'31', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'48', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'78', Cost:9.18, ParentId: '17'},
		]
	},
