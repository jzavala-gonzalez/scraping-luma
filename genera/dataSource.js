const timestamp_saved = '07/30/2023 06:00 AM';
const dataFechaAcualizado = '7/30/2023' + ' 1:55:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'48', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'41', Cost:10.41, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:44.37, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 90,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'4', Cost:29.91, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.27, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'70', Cost:17.05, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 50, MVar:'67', Cost:44.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'75', Cost:11.18, ParentId: '17'},
		]
	},
