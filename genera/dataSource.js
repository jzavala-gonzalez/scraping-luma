const timestamp_saved = '10/02/2023 09:10 PM';
const dataFechaAcualizado = '10/2/2023' + ' 5:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'44', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'55', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'2', Cost:22.16, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:22.05, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 24, MVar:'8', Cost:27.62, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'3', Cost:22.49, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.39, ParentId: '14'},
