const timestamp_saved = '10/15/2023 04:45 AM';
const dataFechaAcualizado = '10/15/2023' + ' 12:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'52', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'55', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'56', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'25', Cost:18.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'8', Cost:18.40, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.12, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'128', Cost:17.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'74', Cost:9.17, ParentId: '17'},
		]
	},
