const timestamp_saved = '09/18/2023 10:55 PM';
const dataFechaAcualizado = '9/18/2023' + ' 6:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 534,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'62', Cost:9.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'60', Cost:9.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 189, MVar:'70', Cost:9.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 109,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'2', Cost:26.72, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'18', Cost:28.22, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'9', Cost:29.36, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'32', Cost:19.47, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'96', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'196', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'113', Cost:9.14, ParentId: '17'},
		]
	},
