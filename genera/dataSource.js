const timestamp_saved = '11/26/2023 03:40 AM';
const dataFechaAcualizado = '11/25/2023' + ' 11:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'27', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'37', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'50', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:17.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 85, MVar:'27', Cost:20.50, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'6', Cost:20.50, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'11', Cost:19.82, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'118', Cost:18.61, ParentId: '16'},
		]
	},
