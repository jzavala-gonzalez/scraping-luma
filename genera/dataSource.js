const timestamp_saved = '10/15/2023 05:00 PM';
const dataFechaAcualizado = '10/15/2023' + ' 12:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'50', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'48', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'86', Cost:9.14, ParentId: '17'},
		]
	},
