const timestamp_saved = '11/01/2023 01:50 AM';
const dataFechaAcualizado = '10/31/2023' + ' 9:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'61', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'65', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'68', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'90', Cost:9.13, ParentId: '17'},
		]
	},
