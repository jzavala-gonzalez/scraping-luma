const timestamp_saved = '10/25/2023 10:20 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'49', Cost:10.25, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 108, MVar:'35', Cost:18.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.56, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'51', Cost:16.88, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'11', Cost:16.88, ParentId: '11'},
		]
	},
