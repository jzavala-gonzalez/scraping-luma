const timestamp_saved = '09/11/2023 08:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 4:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'64', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'63', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'64', Cost:11.04, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:9.28, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'138', Cost:16.56, ParentId: '16'},
		]
	},
