const timestamp_saved = '09/28/2023 02:25 PM';
const dataFechaAcualizado = '9/28/2023' + ' 10:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'27', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'25', Cost:11.18, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.09, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'129', Cost:18.45, ParentId: '16'},
		]
	},
