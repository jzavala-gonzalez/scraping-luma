const timestamp_saved = '08/21/2023 01:25 AM';
const dataFechaAcualizado = '8/20/2023' + ' 9:22:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'53', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'58', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:21.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'90', Cost:17.34, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'158', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'82', Cost:9.17, ParentId: '17'},
		]
	},
