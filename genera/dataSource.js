const timestamp_saved = '10/27/2023 05:45 AM';
const dataFechaAcualizado = '10/27/2023' + ' 1:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'44', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'47', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 190,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 190, MVar:'107', Cost:19.84, ParentId: '16'},
		]
	},
