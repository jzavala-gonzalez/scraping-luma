const timestamp_saved = '10/22/2023 09:55 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'47', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'47', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 13,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 13, MVar:'0', Cost:23.31, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 15, MVar:'0', Cost:0, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'68', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'123', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'69', Cost:11.29, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 25,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:23.31, ParentId: '21'},
