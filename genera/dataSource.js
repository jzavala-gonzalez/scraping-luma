const timestamp_saved = '11/21/2023 08:20 PM';
const dataFechaAcualizado = '11/21/2023' + ' 4:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'78', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'37', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'46', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'58', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:17.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'100', Cost:9.45, ParentId: '17'},
		]
	},
