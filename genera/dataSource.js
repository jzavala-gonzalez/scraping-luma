const timestamp_saved = '08/07/2023 07:55 AM';
const dataFechaAcualizado = '8/7/2023' + ' 3:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'58', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'85', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'40', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'41', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'25', Cost:17.07, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'93', Cost:11.74, ParentId: '17'},
		]
	},
