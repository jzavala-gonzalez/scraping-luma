const timestamp_saved = '11/01/2023 01:25 AM';
const dataFechaAcualizado = '10/31/2023' + ' 9:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'58', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'62', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'67', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'0', Cost:26.22, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.35, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 133, MVar:'42', Cost:16.92, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'11', Cost:16.92, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'14', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'156', Cost:16.74, ParentId: '16'},
		]
	},
