const timestamp_saved = '09/19/2023 05:45 AM';
const dataFechaAcualizado = '9/19/2023' + ' 1:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'74', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'51', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'63', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'1', Cost:24.78, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 96, MVar:'0', Cost:9.26, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'8', Cost:9.26, ParentId: '11'},
		]
	},
