const timestamp_saved = '09/08/2023 08:00 AM';
const dataFechaAcualizado = '9/8/2023' + ' 3:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'60', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'54', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'54', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'67', Cost:16.91, ParentId: '15'},
