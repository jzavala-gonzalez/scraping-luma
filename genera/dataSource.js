const timestamp_saved = '09/27/2023 07:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 3:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'27', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'27', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'60', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'74', Cost:9.13, ParentId: '17'},
		]
	},
