const timestamp_saved = '09/20/2023 11:40 AM';
const dataFechaAcualizado = '9/20/2023' + ' 7:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'49', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'52', Cost:11.03, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'49', Cost:19.88, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'144', Cost:18.14, ParentId: '16'},
		]
	},
