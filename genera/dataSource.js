const timestamp_saved = '09/24/2023 05:00 PM';
const dataFechaAcualizado = '9/24/2023' + ' 12:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'85', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'47', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'48', Cost:10.37, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 12, MVar:'0', Cost:49.34, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'7', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 12, MVar:'1', Cost:51.97, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 59, MVar:'3', Cost:30.60, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:8.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:8.30, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:18.15, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'0', Cost:18.15, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'29', Cost:19.49, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'89', Cost:18.02, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'86', Cost:9.36, ParentId: '17'},
		]
	},
