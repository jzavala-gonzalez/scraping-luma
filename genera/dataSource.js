const timestamp_saved = '09/18/2023 01:25 PM';
const dataFechaAcualizado = '9/18/2023' + ' 9:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'68', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'70', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'51', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'51', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'63', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'3', Cost:19.72, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'33', Cost:18.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'139', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'84', Cost:9.83, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 77,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'11', Cost:19.60, ParentId: '19'},
