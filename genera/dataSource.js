const timestamp_saved = '10/20/2023 05:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 1:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'37', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'44', Cost:10.56, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 189,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'132', Cost:19.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'86', Cost:10.52, ParentId: '17'},
		]
	},
