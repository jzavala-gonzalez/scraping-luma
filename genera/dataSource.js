const timestamp_saved = '11/13/2023 10:55 AM';
const dataFechaAcualizado = '11/13/2023' + ' 6:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'45', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'48', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'11', Cost:31.23, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:8.25, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'85', Cost:9.77, ParentId: '17'},
		]
	},
