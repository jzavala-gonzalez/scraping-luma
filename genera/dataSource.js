const timestamp_saved = '07/28/2023 11:35 PM';
const dataFechaAcualizado = '7/28/2023' + ' 7:30:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'71', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'53', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'49', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'92', Cost:16.70, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'27', Cost:15.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'88', Cost:13.79, ParentId: '17'},
		]
	},
