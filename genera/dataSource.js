const timestamp_saved = '11/22/2023 01:05 AM';
const dataFechaAcualizado = '11/21/2023' + ' 9:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'52', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'62', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'116', Cost:9.10, ParentId: '17'},
		]
	},
