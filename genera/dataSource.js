const timestamp_saved = '12/04/2023 02:45 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'51', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'53', Cost:11.00, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'78', Cost:10.70, ParentId: '17'},
		]
	},
