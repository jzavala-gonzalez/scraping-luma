const timestamp_saved = '10/27/2023 03:05 AM';
const dataFechaAcualizado = '10/26/2023' + ' 11:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'48', Cost:10.65, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'128', Cost:17.04, ParentId: '16'},
		]
	},
