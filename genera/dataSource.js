const timestamp_saved = '07/30/2023 10:30 PM';
const dataFechaAcualizado = '7/30/2023' + ' 6:25:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'54', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'46', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 56, MVar:'13', Cost:30.78, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 24, MVar:'4', Cost:40.36, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:17.35, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.25, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'99', Cost:17.06, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'30', Cost:15.40, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'135', Cost:16.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'90', Cost:10.95, ParentId: '17'},
		]
	},
