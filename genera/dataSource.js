const timestamp_saved = '10/28/2023 02:55 AM';
const dataFechaAcualizado = '10/27/2023' + ' 10:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'45', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'46', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'49', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 75, MVar:'23', Cost:26.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'7', Cost:26.83, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 135, MVar:'40', Cost:18.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'11', Cost:23.68, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'6', Cost:19.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'73', Cost:17.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'110', Cost:18.16, ParentId: '16'},
		]
	},
