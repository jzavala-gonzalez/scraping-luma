const timestamp_saved = '10/06/2023 04:30 AM';
const dataFechaAcualizado = '10/6/2023' + ' 12:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'39', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'37', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'39', Cost:18.91, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.91, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:27.65, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'92', Cost:9.70, ParentId: '17'},
		]
	},
