const timestamp_saved = '09/01/2023 09:05 AM';
const dataFechaAcualizado = '9/1/2023' + ' 5:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'41', Cost:10.38, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 185,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'96', Cost:19.67, ParentId: '16'},
		]
	},
