const timestamp_saved = '10/14/2023 03:35 AM';
const dataFechaAcualizado = '10/13/2023' + ' 11:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'61', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'67', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'68', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'6', Cost:19.27, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'154', Cost:17.10, ParentId: '16'},
		]
	},
