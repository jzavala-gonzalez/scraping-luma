const timestamp_saved = '10/21/2023 06:11 PM';
const dataFechaAcualizado = '10/21/2023' + ' 2:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'48', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'51', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'53', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'47', Cost:17.63, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'10', Cost:17.63, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 177,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 177, MVar:'83', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'149', Cost:17.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'73', Cost:11.06, ParentId: '17'},
		]
	},
