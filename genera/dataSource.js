const timestamp_saved = '09/04/2023 03:05 AM';
const dataFechaAcualizado = '9/3/2023' + ' 11:00:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'41', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'47', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:10.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 22, MVar:'0', Cost:28.56, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'25', Cost:19.04, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'165', Cost:16.74, ParentId: '16'},
		]
	},
