const timestamp_saved = '11/13/2023 07:15 AM';
const dataFechaAcualizado = '11/13/2023' + ' 3:11:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2475},
	{Index:'6', Desc:'Próxima Hora MW', value: 2040},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 264,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'36', Cost:15.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'40', Cost:15.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 86, MVar:'47', Cost:15.92, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:31.65, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 133, MVar:'43', Cost:17.16, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 127, MVar:'59', Cost:16.98, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'80', Cost:9.20, ParentId: '17'},
		]
	},
