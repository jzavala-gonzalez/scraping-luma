const timestamp_saved = '08/29/2023 05:05 AM';
const dataFechaAcualizado = '8/29/2023' + ' 1:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'49', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'60', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:31.51, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'161', Cost:16.97, ParentId: '16'},
		]
	},
