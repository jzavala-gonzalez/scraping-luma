const timestamp_saved = '08/08/2023 06:15 PM';
const dataFechaAcualizado = '8/8/2023' + ' 2:10:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3393},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'62', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'66', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:26.29, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.78, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 42, MVar:'5', Cost:22.44, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 34,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:31.10, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'28', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 313, MVar:'173', Cost:17.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'104', Cost:11.79, ParentId: '17'},
		]
	},
