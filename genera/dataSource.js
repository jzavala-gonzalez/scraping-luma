const timestamp_saved = '09/25/2023 11:55 PM';
const dataFechaAcualizado = '9/25/2023' + ' 7:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'51', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'59', Cost:10.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 145,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:34.19, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:17.81, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:32.45, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:32.34, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'77', Cost:17.08, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'117', Cost:9.11, ParentId: '17'},
		]
	},
