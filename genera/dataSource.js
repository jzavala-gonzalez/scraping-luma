const timestamp_saved = '10/01/2023 03:25 PM';
const dataFechaAcualizado = '10/1/2023' + ' 11:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'32', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'30', Cost:10.37, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:31.26, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'31', Cost:18.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.00, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'93', Cost:9.47, ParentId: '17'},
		]
	},
