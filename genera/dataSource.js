const timestamp_saved = '08/15/2023 10:20 AM';
const dataFechaAcualizado = '8/15/2023' + ' 6:17:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'52', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'45', Cost:10.95, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:27.04, ParentId: '9'},
