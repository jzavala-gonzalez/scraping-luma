const timestamp_saved = '11/24/2023 04:30 AM';
const dataFechaAcualizado = '11/24/2023' + ' 12:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'35', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'51', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 267,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:8.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:8.17, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 52, MVar:'16', Cost:0, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'128', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'84', Cost:9.21, ParentId: '17'},
		]
	},
