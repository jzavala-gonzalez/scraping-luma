const timestamp_saved = '08/15/2023 11:05 AM';
const dataFechaAcualizado = '8/15/2023' + ' 7:02:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'41', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'47', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.26, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'153', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'106', Cost:11.65, ParentId: '17'},
		]
	},
