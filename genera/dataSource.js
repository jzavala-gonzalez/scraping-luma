const timestamp_saved = '08/02/2023 09:05 PM';
const dataFechaAcualizado = '8/2/2023' + ' 5:00:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'40', Cost:11.09, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'94', Cost:16.60, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'12', Cost:15.48, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'150', Cost:17.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'89', Cost:10.86, ParentId: '17'},
		]
	},
