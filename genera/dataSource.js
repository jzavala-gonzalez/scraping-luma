const timestamp_saved = '09/06/2023 06:45 PM';
const dataFechaAcualizado = '9/6/2023' + ' 2:40:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'75', Cost:0, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'80', Cost:0, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'61', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'37', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'52', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'26', Cost:19.64, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'160', Cost:17.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'98', Cost:9.19, ParentId: '17'},
		]
	},
