const timestamp_saved = '09/06/2023 12:20 AM';
const dataFechaAcualizado = '9/5/2023' + ' 8:15:51 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3035},
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3227},
	{Index:'6', Desc:'Próxima Hora MW', value: 3165},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'86', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'90', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 514,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'62', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'65', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 165, MVar:'71', Cost:9.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:31.18, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 53, MVar:'5', Cost:21.95, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.57, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'10', Cost:27.23, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:22.11, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'24', Cost:28.19, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'22', Cost:31.24, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'46', Cost:8.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:8.22, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'6', Cost:30.61, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:30.65, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'24', Cost:19.55, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'98', Cost:17.09, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 352,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 352, MVar:'188', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'104', Cost:9.18, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 64,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:21.88, ParentId: '21'},
