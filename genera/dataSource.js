const timestamp_saved = '10/11/2023 06:05 PM';
const dataFechaAcualizado = '10/11/2023' + ' 2:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'65', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'69', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'72', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.01, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'36', Cost:18.32, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.32, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.42, ParentId: '14'},
