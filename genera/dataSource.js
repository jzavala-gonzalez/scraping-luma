const timestamp_saved = '08/14/2023 06:40 AM';
const dataFechaAcualizado = '8/14/2023' + ' 2:37:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'44', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'40', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'1', Cost:26.39, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'16', Cost:30.70, ParentId: '10'},
