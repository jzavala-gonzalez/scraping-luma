const timestamp_saved = '10/27/2023 02:35 PM';
const dataFechaAcualizado = '10/27/2023' + ' 10:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'51', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'49', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'54', Cost:12.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:16.70, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'112', Cost:17.43, ParentId: '16'},
		]
	},
