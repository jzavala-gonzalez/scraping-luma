const timestamp_saved = '09/12/2023 03:50 PM';
const dataFechaAcualizado = '9/12/2023' + ' 11:45:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 937},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'61', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'65', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'52', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'64', Cost:10.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 81, MVar:'0', Cost:9.19, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'11', Cost:31.22, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:19.80, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'96', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'126', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'71', Cost:9.42, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 107,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 45, MVar:'16', Cost:19.60, ParentId: '19'},
