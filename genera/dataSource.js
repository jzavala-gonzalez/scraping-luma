const timestamp_saved = '11/07/2023 10:15 AM';
const dataFechaAcualizado = '11/7/2023' + ' 6:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'44', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'42', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:102.41, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'64', Cost:16.82, ParentId: '15'},
