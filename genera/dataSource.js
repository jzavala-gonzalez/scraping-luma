const timestamp_saved = '08/06/2023 10:10 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:05:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'39', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'41', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'81', Cost:17.25, ParentId: '15'},
