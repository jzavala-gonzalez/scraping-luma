const timestamp_saved = '11/16/2023 09:40 AM';
const dataFechaAcualizado = '11/16/2023' + ' 5:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'45', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'45', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'45', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'3', Cost:30.99, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 187,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 187, MVar:'63', Cost:10.78, ParentId: '17'},
		]
	},
