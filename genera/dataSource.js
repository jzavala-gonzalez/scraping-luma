const timestamp_saved = '09/13/2023 12:20 PM';
const dataFechaAcualizado = '9/13/2023' + ' 8:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'53', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'53', Cost:10.74, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 125,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 63, MVar:'11', Cost:30.82, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 62, MVar:'13', Cost:30.85, ParentId: '10'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 41,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'10', Cost:19.60, ParentId: '19'},
