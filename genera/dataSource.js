const timestamp_saved = '11/27/2023 06:25 AM';
const dataFechaAcualizado = '11/27/2023' + ' 2:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'21', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'31', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'47', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'63', Cost:9.84, ParentId: '17'},
		]
	},
