const timestamp_saved = '11/28/2023 09:10 PM';
const dataFechaAcualizado = '11/28/2023' + ' 5:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'43', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'53', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'62', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'16', Cost:43.59, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:17.42, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'11', Cost:28.07, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'203', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'120', Cost:9.18, ParentId: '17'},
		]
	},
