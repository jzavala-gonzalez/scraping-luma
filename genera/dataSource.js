const timestamp_saved = '10/01/2023 02:35 PM';
const dataFechaAcualizado = '10/1/2023' + ' 10:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'27', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'24', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'44', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'85', Cost:9.49, ParentId: '17'},
		]
	},
