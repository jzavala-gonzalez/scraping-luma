const timestamp_saved = '09/13/2023 08:30 PM';
const dataFechaAcualizado = '9/13/2023' + ' 4:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'61', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'60', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'71', Cost:10.25, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:26.15, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:35.42, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 146,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'17', Cost:28.42, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'18', Cost:28.47, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'44', Cost:8.34, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:8.34, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'0', Cost:8.21, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'11', Cost:8.21, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:28.70, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'30', Cost:19.10, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'79', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 347, MVar:'173', Cost:16.83, ParentId: '16'},
		]
	},
