const timestamp_saved = '09/15/2023 03:55 PM';
const dataFechaAcualizado = '9/15/2023' + ' 11:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'53', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'50', Cost:10.87, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'144', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'103', Cost:9.28, ParentId: '17'},
		]
	},
