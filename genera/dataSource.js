const timestamp_saved = '09/19/2023 12:10 AM';
const dataFechaAcualizado = '9/18/2023' + ' 8:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 208, MVar:'74', Cost:9.77, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'22', Cost:28.20, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'29', Cost:18.97, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'91', Cost:16.60, ParentId: '15'},
