const timestamp_saved = '09/16/2023 02:35 PM';
const dataFechaAcualizado = '9/16/2023' + ' 10:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'42', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'40', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'56', Cost:11.56, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.58, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:19.90, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'72', Cost:17.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 182,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 182, MVar:'103', Cost:19.58, ParentId: '16'},
		]
	},
