const timestamp_saved = '10/17/2023 02:40 PM';
const dataFechaAcualizado = '10/17/2023' + ' 10:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'62', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'61', Cost:10.60, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'86', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'166', Cost:18.25, ParentId: '16'},
		]
	},
