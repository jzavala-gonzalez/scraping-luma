const timestamp_saved = '11/06/2023 04:30 AM';
const dataFechaAcualizado = '11/6/2023' + ' 12:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'45', Cost:13.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'45', Cost:13.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'44', Cost:13.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'10', Cost:17.33, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 64, MVar:'8', Cost:20.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'73', Cost:16.84, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'61', Cost:9.40, ParentId: '17'},
		]
	},
