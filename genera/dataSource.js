const timestamp_saved = '10/27/2023 11:25 PM';
const dataFechaAcualizado = '10/27/2023' + ' 7:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'48', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'53', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.47, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'36', Cost:18.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'8', Cost:18.17, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 35, MVar:'8', Cost:23.80, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 64, MVar:'9', Cost:20.27, ParentId: '14'},
