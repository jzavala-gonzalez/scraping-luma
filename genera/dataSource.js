const timestamp_saved = '09/20/2023 03:40 PM';
const dataFechaAcualizado = '9/20/2023' + ' 11:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'52', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'53', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'64', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'80', Cost:16.94, ParentId: '15'},
