const timestamp_saved = '11/02/2023 11:50 PM';
const dataFechaAcualizado = '11/2/2023' + ' 7:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'65', Cost:9.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'65', Cost:9.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 207, MVar:'67', Cost:9.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 23, MVar:'6', Cost:22.31, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 42, MVar:'5', Cost:22.24, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'26', Cost:44.75, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'0', Cost:44.75, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'20', Cost:21.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'106', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'184', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'101', Cost:9.13, ParentId: '17'},
		]
	},
