const timestamp_saved = '08/07/2023 04:55 AM';
const dataFechaAcualizado = '8/7/2023' + ' 12:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'44', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:10.87, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 137,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 22, MVar:'0', Cost:2.58, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 154, MVar:'11', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:20.28, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'5', Cost:18.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'53', Cost:18.40, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'94', Cost:11.62, ParentId: '17'},
		]
	},
