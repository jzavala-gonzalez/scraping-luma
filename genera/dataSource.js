const timestamp_saved = '09/03/2023 03:00 PM';
const dataFechaAcualizado = '9/3/2023' + ' 10:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'34', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'39', Cost:10.87, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'6', Cost:58.25, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'122', Cost:18.25, ParentId: '16'},
		]
	},
