const timestamp_saved = '07/25/2023 12:08 PM';
const dataFechaAcualizado = '7/25/2023' + ' 8:00:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 232, MVar:'84', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'85', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'61', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'55', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'6', Cost:30.74, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'25', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'59', Cost:15.39, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 35, MVar:'33', Cost:18.07, ParentId: '17'},
		]
	},
