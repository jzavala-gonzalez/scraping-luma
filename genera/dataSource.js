const timestamp_saved = '09/27/2023 08:10 PM';
const dataFechaAcualizado = '9/27/2023' + ' 4:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'29', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'28', Cost:11.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'61', Cost:11.60, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'168', Cost:17.93, ParentId: '16'},
		]
	},
