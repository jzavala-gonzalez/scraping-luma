const timestamp_saved = '08/04/2023 03:10 AM';
const dataFechaAcualizado = '8/3/2023' + ' 11:05:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'45', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'49', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 15, MVar:'1', Cost:32.28, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.02, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'92', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'164', Cost:17.00, ParentId: '16'},
		]
	},
