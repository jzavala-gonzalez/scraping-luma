const timestamp_saved = '11/23/2023 09:20 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'17', Cost:13.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'27', Cost:13.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'46', Cost:13.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:18.95, ParentId: '14'},
