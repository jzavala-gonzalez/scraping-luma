const timestamp_saved = '09/21/2023 09:05 AM';
const dataFechaAcualizado = '9/21/2023' + ' 5:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'41', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'63', Cost:11.14, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 100,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'47', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:19.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.97, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.19, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:8.19, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'15', Cost:26.65, ParentId: '14'},
