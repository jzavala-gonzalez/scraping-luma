const timestamp_saved = '10/28/2023 04:35 AM';
const dataFechaAcualizado = '10/28/2023' + ' 12:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'39', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 95, MVar:'26', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'16', Cost:31.23, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:30.19, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 38, MVar:'12', Cost:23.74, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'21', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 282, MVar:'122', Cost:17.34, ParentId: '16'},
		]
	},
