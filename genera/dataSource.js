const timestamp_saved = '09/18/2023 01:05 PM';
const dataFechaAcualizado = '9/18/2023' + ' 9:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'51', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'50', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'62', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'31', Cost:19.20, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'90', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'136', Cost:18.31, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'83', Cost:9.84, ParentId: '17'},
		]
	},
