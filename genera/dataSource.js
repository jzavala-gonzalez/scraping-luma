const timestamp_saved = '08/19/2023 08:45 AM';
const dataFechaAcualizado = '8/19/2023' + ' 4:42:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'40', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'55', Cost:10.70, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:31.32, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:31.01, ParentId: '12'},
