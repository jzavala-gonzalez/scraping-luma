const timestamp_saved = '10/01/2023 11:50 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'60', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 57, MVar:'56', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'26', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'24', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.48, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'106', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'79', Cost:9.48, ParentId: '17'},
		]
	},
