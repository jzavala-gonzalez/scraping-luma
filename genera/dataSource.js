const timestamp_saved = '09/04/2023 08:55 PM';
const dataFechaAcualizado = '9/4/2023' + ' 4:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'42', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'45', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'57', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 115,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:34.68, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 130, MVar:'63', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:27.08, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'18', Cost:28.26, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.82, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'28', Cost:19.73, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'179', Cost:17.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'82', Cost:9.20, ParentId: '17'},
		]
	},
