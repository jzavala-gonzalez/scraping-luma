const timestamp_saved = '09/14/2023 05:00 AM';
const dataFechaAcualizado = '9/14/2023' + ' 12:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'56', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'56', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'68', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 101, MVar:'28', Cost:21.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'9', Cost:21.49, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.75, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'54', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'164', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'101', Cost:9.01, ParentId: '17'},
		]
	},
