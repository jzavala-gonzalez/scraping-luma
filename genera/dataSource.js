const timestamp_saved = '10/22/2023 01:10 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'39', Cost:12.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'40', Cost:12.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'45', Cost:12.19, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'14', Cost:18.81, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'54', Cost:11.23, ParentId: '17'},
		]
	},
