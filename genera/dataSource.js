const timestamp_saved = '11/10/2023 05:45 AM';
const dataFechaAcualizado = '11/10/2023' + ' 1:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'37', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'38', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.98, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'25', Cost:21.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 142,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 142, MVar:'120', Cost:20.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'57', Cost:9.82, ParentId: '17'},
		]
	},
