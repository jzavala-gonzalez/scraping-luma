const timestamp_saved = '10/25/2023 12:40 AM';
const dataFechaAcualizado = '10/24/2023' + ' 8:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'55', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'57', Cost:10.36, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:21.92, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.79, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:27.42, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'48', Cost:17.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'9', Cost:17.01, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'160', Cost:16.65, ParentId: '16'},
		]
	},
