const timestamp_saved = '08/23/2023 01:15 AM';
const dataFechaAcualizado = '8/22/2023' + ' 9:10:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 172, MVar:'65', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'47', Cost:10.98, ParentId: '7'},
