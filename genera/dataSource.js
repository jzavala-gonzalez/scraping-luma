const timestamp_saved = '10/28/2023 12:10 AM';
const dataFechaAcualizado = '10/27/2023' + ' 8:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'49', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'50', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'52', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.36, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'4', Cost:22.21, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'6', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'82', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'136', Cost:17.64, ParentId: '16'},
		]
	},
