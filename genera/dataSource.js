const timestamp_saved = '07/28/2023 06:40 PM';
const dataFechaAcualizado = '7/28/2023' + ' 2:35:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'54', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'51', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'10', Cost:28.33, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:29.02, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'96', Cost:13.50, ParentId: '17'},
		]
	},
