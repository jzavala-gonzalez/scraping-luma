const timestamp_saved = '10/08/2023 08:25 PM';
const dataFechaAcualizado = '10/8/2023' + ' 4:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'89', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'51', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'51', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'46', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'6', Cost:35.83, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 18, MVar:'0', Cost:57.04, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'11', Cost:44.03, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'17', Cost:19.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'103', Cost:16.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'171', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'105', Cost:9.09, ParentId: '17'},
		]
	},
