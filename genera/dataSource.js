const timestamp_saved = '10/04/2023 05:55 AM';
const dataFechaAcualizado = '10/4/2023' + ' 1:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'37', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'37', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'51', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'145', Cost:19.73, ParentId: '16'},
		]
	},
