const timestamp_saved = '10/05/2023 01:00 AM';
const dataFechaAcualizado = '10/4/2023' + ' 8:56:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'48', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'60', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 56,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 10, MVar:'0', Cost:26.80, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'50', Cost:16.90, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:16.90, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'124', Cost:9.20, ParentId: '17'},
		]
	},
