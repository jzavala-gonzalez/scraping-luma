const timestamp_saved = '09/07/2023 03:50 PM';
const dataFechaAcualizado = '9/7/2023' + ' 11:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'57', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'46', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'51', Cost:10.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 109,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 127, MVar:'60', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'24', Cost:31.29, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'33', Cost:19.26, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'106', Cost:9.76, ParentId: '17'},
		]
	},
