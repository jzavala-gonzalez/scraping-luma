const timestamp_saved = '10/16/2023 01:25 AM';
const dataFechaAcualizado = '10/15/2023' + ' 9:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'64', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'63', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'62', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 43, MVar:'4', Cost:22.05, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 104, MVar:'31', Cost:18.02, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:18.02, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'0', Cost:28.84, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'12', Cost:18.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'86', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'217', Cost:16.66, ParentId: '16'},
		]
	},
