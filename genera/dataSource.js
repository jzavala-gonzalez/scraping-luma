const timestamp_saved = '09/27/2023 09:05 PM';
const dataFechaAcualizado = '9/27/2023' + ' 5:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'31', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'30', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'60', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'5', Cost:74.89, ParentId: '13'},
