const timestamp_saved = '11/17/2023 11:30 AM';
const dataFechaAcualizado = '11/17/2023' + ' 7:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'59', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'59', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'44', Cost:10.48, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 161, MVar:'41', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:17.24, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.51, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'95', Cost:9.84, ParentId: '17'},
		]
	},
