const timestamp_saved = '11/09/2023 06:35 PM';
const dataFechaAcualizado = '11/9/2023' + ' 2:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'49', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'49', Cost:11.07, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'20', Cost:35.03, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'18', Cost:22.06, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'151', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'101', Cost:9.24, ParentId: '17'},
		]
	},
