const timestamp_saved = '10/01/2023 12:35 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'72', Cost:4.49, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 49, MVar:'45', Cost:4.49, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'26', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'24', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'42', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:8.24, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.05, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'83', Cost:9.53, ParentId: '17'},
		]
	},
