const timestamp_saved = '12/04/2023 07:00 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'37', Cost:13.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'37', Cost:13.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'44', Cost:13.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:18.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'41', Cost:11.62, ParentId: '17'},
		]
	},
