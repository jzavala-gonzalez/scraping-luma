const timestamp_saved = '08/17/2023 10:20 PM';
const dataFechaAcualizado = '8/17/2023' + ' 6:17:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'66', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'75', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:31.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:30.96, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:19.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:19.56, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:30.64, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:29.24, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'170', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'92', Cost:9.22, ParentId: '17'},
		]
	},
