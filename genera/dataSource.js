const timestamp_saved = '12/02/2023 12:10 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'55', Cost:12.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'57', Cost:12.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'57', Cost:12.96, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.93, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'94', Cost:9.16, ParentId: '17'},
		]
	},
