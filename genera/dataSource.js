const timestamp_saved = '11/30/2023 03:50 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'48', Cost:11.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'51', Cost:11.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'53', Cost:11.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'71', Cost:9.82, ParentId: '17'},
		]
	},
