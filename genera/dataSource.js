const timestamp_saved = '11/07/2023 02:11 PM';
const dataFechaAcualizado = '11/7/2023' + ' 10:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'44', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'86', Cost:9.79, ParentId: '17'},
		]
	},
