const timestamp_saved = '09/22/2023 05:55 AM';
const dataFechaAcualizado = '9/22/2023' + ' 1:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'40', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'44', Cost:10.53, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'9', Cost:19.11, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'74', Cost:32.86, ParentId: '16'},
		]
	},
