const timestamp_saved = '09/16/2023 02:50 AM';
const dataFechaAcualizado = '9/15/2023' + ' 10:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'49', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:11.31, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:31.30, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'23', Cost:18.87, ParentId: '14'},
