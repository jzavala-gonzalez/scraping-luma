const timestamp_saved = '08/03/2023 01:40 PM';
const dataFechaAcualizado = '8/3/2023' + ' 9:35:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'46', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'48', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'92', Cost:17.12, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'85', Cost:11.37, ParentId: '17'},
		]
	},
