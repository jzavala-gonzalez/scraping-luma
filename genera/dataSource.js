const timestamp_saved = '11/24/2023 10:00 PM';
const dataFechaAcualizado = '11/24/2023' + ' 5:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'35', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'45', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'58', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'159', Cost:17.17, ParentId: '16'},
		]
	},
