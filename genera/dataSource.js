const timestamp_saved = '11/28/2023 11:40 AM';
const dataFechaAcualizado = '11/28/2023' + ' 7:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'27', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'36', Cost:11.90, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'50', Cost:17.31, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'85', Cost:9.30, ParentId: '17'},
		]
	},
