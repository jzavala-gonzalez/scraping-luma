const timestamp_saved = '11/14/2023 05:10 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'45', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'49', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'53', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'60', Cost:16.92, ParentId: '15'},
