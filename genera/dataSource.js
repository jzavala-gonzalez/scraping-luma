const timestamp_saved = '09/14/2023 12:40 PM';
const dataFechaAcualizado = '9/14/2023' + ' 8:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'54', Cost:10.47, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 70, MVar:'0', Cost:6.85, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'100', Cost:9.25, ParentId: '17'},
		]
	},
