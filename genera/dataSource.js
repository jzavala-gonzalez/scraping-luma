const timestamp_saved = '10/02/2023 06:05 PM';
const dataFechaAcualizado = '10/2/2023' + ' 2:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'42', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'41', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'54', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:17.52, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'8', Cost:58.65, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'91', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'174', Cost:17.04, ParentId: '16'},
		]
	},
