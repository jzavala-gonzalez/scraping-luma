const timestamp_saved = '11/13/2023 08:40 PM';
const dataFechaAcualizado = '11/13/2023' + ' 4:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'103', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 530,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'60', Cost:9.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'64', Cost:9.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 181, MVar:'62', Cost:9.92, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:22.21, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 70,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 70, MVar:'31', Cost:28.47, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.02, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.02, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'9', Cost:28.70, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'13', Cost:22.56, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'28', Cost:19.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'86', Cost:16.66, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'125', Cost:9.28, ParentId: '17'},
		]
	},
