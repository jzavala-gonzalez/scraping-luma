const timestamp_saved = '10/04/2023 06:15 AM';
const dataFechaAcualizado = '10/4/2023' + ' 2:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'34', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'34', Cost:10.77, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 206,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 206, MVar:'135', Cost:19.28, ParentId: '16'},
		]
	},
