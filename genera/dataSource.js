const timestamp_saved = '11/22/2023 11:15 AM';
const dataFechaAcualizado = '11/22/2023' + ' 7:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'30', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'40', Cost:10.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 310,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 99, MVar:'29', Cost:0, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'82', Cost:9.75, ParentId: '17'},
		]
	},
