const timestamp_saved = '09/24/2023 04:40 PM';
const dataFechaAcualizado = '9/24/2023' + ' 12:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'46', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'48', Cost:11.16, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:30.87, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'83', Cost:18.42, ParentId: '15'},
