const timestamp_saved = '08/03/2023 07:45 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:40:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'39', Cost:17.38, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'36', Cost:16.90, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'73', Cost:11.33, ParentId: '17'},
		]
	},
