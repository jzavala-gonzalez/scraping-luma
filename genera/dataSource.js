const timestamp_saved = '08/14/2023 03:20 AM';
const dataFechaAcualizado = '8/13/2023' + ' 11:17:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'37', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'43', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'43', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'27', Cost:30.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.79, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:31.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'22', Cost:18.85, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'149', Cost:16.62, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 39,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 20, MVar:'0', Cost:25.95, ParentId: '21'},
