const timestamp_saved = '10/26/2023 09:10 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'36', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'37', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'44', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'57', Cost:18.39, ParentId: '15'},
