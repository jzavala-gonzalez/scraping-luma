const timestamp_saved = '10/29/2023 12:45 PM';
const dataFechaAcualizado = '10/29/2023' + ' 8:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'47', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'68', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'68', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'117', Cost:17.36, ParentId: '16'},
		]
	},
