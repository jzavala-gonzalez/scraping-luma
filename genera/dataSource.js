const timestamp_saved = '10/29/2023 03:00 PM';
const dataFechaAcualizado = '10/29/2023' + ' 10:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'51', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'72', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'123', Cost:17.35, ParentId: '16'},
		]
	},
