const timestamp_saved = '11/09/2023 11:50 PM';
const dataFechaAcualizado = '11/9/2023' + ' 7:46:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'52', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'48', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'49', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'119', Cost:9.19, ParentId: '17'},
		]
	},
