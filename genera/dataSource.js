const timestamp_saved = '10/20/2023 09:15 PM';
const dataFechaAcualizado = '10/20/2023' + ' 5:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'39', Cost:12.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'46', Cost:12.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'46', Cost:12.34, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'154', Cost:16.88, ParentId: '16'},
		]
	},
