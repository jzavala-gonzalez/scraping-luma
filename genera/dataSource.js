const timestamp_saved = '10/23/2023 09:40 AM';
const dataFechaAcualizado = '10/23/2023' + ' 5:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'41', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'40', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'40', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'53', Cost:11.29, ParentId: '17'},
		]
	},
