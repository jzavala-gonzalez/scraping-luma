const timestamp_saved = '10/07/2023 04:10 PM';
const dataFechaAcualizado = '10/7/2023' + ' 12:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'42', Cost:11.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'44', Cost:11.89, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 237,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 237, MVar:'87', Cost:10.05, ParentId: '17'},
		]
	},
