const timestamp_saved = '12/04/2023 03:55 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'53', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'55', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'56', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.52, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'76', Cost:11.46, ParentId: '17'},
		]
	},
