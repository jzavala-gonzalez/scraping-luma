const timestamp_saved = '10/05/2023 10:55 AM';
const dataFechaAcualizado = '10/5/2023' + ' 6:51:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'37', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'33', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:17.68, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:30.33, ParentId: '13'},
