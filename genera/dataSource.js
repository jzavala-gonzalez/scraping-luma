const timestamp_saved = '11/25/2023 10:45 PM';
const dataFechaAcualizado = '11/25/2023' + ' 6:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 196,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 196, MVar:'69', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'33', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'58', Cost:11.57, ParentId: '7'},
		]
	},
