const timestamp_saved = '09/08/2023 07:00 AM';
const dataFechaAcualizado = '9/8/2023' + ' 2:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'62', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'58', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'55', Cost:10.73, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 106, MVar:'0', Cost:7.32, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'19', Cost:31.17, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.38, ParentId: '12'},
