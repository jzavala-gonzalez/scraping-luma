const timestamp_saved = '12/05/2023 06:50 AM';
const dataFechaAcualizado = '12/5/2023' + ' 2:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'39', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'41', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'51', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'50', Cost:11.34, ParentId: '17'},
		]
	},
