const timestamp_saved = '11/14/2023 01:15 PM';
const dataFechaAcualizado = '11/14/2023' + ' 9:11:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2434},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'51', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'54', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:10.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:61.53, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'3', Cost:29.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'1', Cost:29.05, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 28, MVar:'133', Cost:61.53, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'102', Cost:10.94, ParentId: '17'},
		]
	},
