const timestamp_saved = '08/25/2023 04:35 PM';
const dataFechaAcualizado = '8/25/2023' + ' 12:30:49 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'63', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'64', Cost:10.46, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'15', Cost:31.23, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:19.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:19.61, ParentId: '11'},
