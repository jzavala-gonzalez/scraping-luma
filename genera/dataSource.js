const timestamp_saved = '12/06/2023 02:50 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:45:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 926},
	{Index:'7', Desc:'Capacidad Disponible', value: 3008},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'48', Cost:13.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'50', Cost:13.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'58', Cost:13.39, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 91, MVar:'10', Cost:18.71, ParentId: '14'},
