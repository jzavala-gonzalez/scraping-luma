const timestamp_saved = '11/09/2023 12:45 AM';
const dataFechaAcualizado = '11/8/2023' + ' 8:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'57', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'54', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'110', Cost:9.27, ParentId: '17'},
		]
	},
