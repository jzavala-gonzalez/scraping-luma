const timestamp_saved = '12/02/2023 06:00 PM';
const dataFechaAcualizado = '12/2/2023' + ' 1:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 179, MVar:'72', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'46', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'48', Cost:11.53, ParentId: '7'},
