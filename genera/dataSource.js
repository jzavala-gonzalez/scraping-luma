const timestamp_saved = '08/05/2023 03:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 11:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:26.66, ParentId: '9'},
