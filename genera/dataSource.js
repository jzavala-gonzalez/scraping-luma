const timestamp_saved = '10/03/2023 03:50 PM';
const dataFechaAcualizado = '10/3/2023' + ' 11:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'42', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'40', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'53', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'61', Cost:16.62, ParentId: '15'},
