const timestamp_saved = '10/15/2023 10:00 AM';
const dataFechaAcualizado = '10/15/2023' + ' 5:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'49', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'45', Cost:11.17, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'56', Cost:9.55, ParentId: '17'},
		]
	},
