const timestamp_saved = '09/29/2023 04:35 AM';
const dataFechaAcualizado = '9/29/2023' + ' 12:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'53', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'38', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'36', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'8', Cost:17.53, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:19.39, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:19.39, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'54', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'115', Cost:17.61, ParentId: '16'},
		]
	},
