const timestamp_saved = '08/02/2023 03:05 PM';
const dataFechaAcualizado = '8/2/2023' + ' 11:00:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'41', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'46', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 161, MVar:'30', Cost:15.55, ParentId: '15'},
		]
	},
