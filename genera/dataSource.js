const timestamp_saved = '11/18/2023 10:35 AM';
const dataFechaAcualizado = '11/18/2023' + ' 6:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'39', Cost:15.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'63', Cost:15.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:15.47, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'18', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.52, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'12', Cost:29.10, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'72', Cost:17.15, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'126', Cost:9.13, ParentId: '17'},
		]
	},
