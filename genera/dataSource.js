const timestamp_saved = '10/30/2023 08:30 AM';
const dataFechaAcualizado = '10/30/2023' + ' 4:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'32', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'32', Cost:12.05, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'90', Cost:18.74, ParentId: '16'},
		]
	},
