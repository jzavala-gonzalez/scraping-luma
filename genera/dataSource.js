const timestamp_saved = '11/27/2023 07:40 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'18', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'27', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'45', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'58', Cost:9.87, ParentId: '17'},
		]
	},
