const timestamp_saved = '08/20/2023 05:30 PM';
const dataFechaAcualizado = '8/20/2023' + ' 1:27:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'54', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'36', Cost:10.78, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'46', Cost:8.25, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'93', Cost:18.43, ParentId: '15'},
