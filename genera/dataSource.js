const timestamp_saved = '11/26/2023 04:05 PM';
const dataFechaAcualizado = '11/26/2023' + ' 12:01:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1874},
	{Index:'1', Desc:'PREPA', value: 54},
	{Index:'2', Desc:'COGEN', value: 46},
	{Index:'3', Desc:'Reserva en Rotación', value: 660},
	{Index:'4', Desc:'Reserva Operacional', value: 1245},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'23', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'33', Cost:11.90, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'133', Cost:19.67, ParentId: '16'},
		]
	},
