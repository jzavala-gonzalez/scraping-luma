const timestamp_saved = '07/25/2023 09:30 AM';
const dataFechaAcualizado = '7/25/2023' + ' 5:25:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 542,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'61', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 190, MVar:'56', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'8', Cost:27.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'8', Cost:27.47, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:29.74, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'9', Cost:28.58, ParentId: '12'},
