const timestamp_saved = '11/08/2023 03:55 AM';
const dataFechaAcualizado = '11/7/2023' + ' 11:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'46', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'48', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'65', Cost:16.92, ParentId: '15'},
