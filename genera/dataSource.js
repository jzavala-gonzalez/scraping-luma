const timestamp_saved = '11/21/2023 12:25 PM';
const dataFechaAcualizado = '11/21/2023' + ' 8:21:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2082},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'32', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'41', Cost:10.80, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'88', Cost:9.58, ParentId: '17'},
		]
	},
