const timestamp_saved = '11/10/2023 09:55 AM';
const dataFechaAcualizado = '11/10/2023' + ' 5:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 508,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'52', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'56', Cost:10.07, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'20', Cost:19.34, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'65', Cost:9.83, ParentId: '17'},
		]
	},
