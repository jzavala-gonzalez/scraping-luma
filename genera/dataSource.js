const timestamp_saved = '11/28/2023 04:15 PM';
const dataFechaAcualizado = '11/28/2023' + ' 12:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'38', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'45', Cost:11.29, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'99', Cost:9.86, ParentId: '17'},
		]
	},
