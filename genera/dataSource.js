const timestamp_saved = '09/16/2023 09:25 PM';
const dataFechaAcualizado = '9/16/2023' + ' 5:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'60', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.41, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'90', Cost:16.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'127', Cost:16.63, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 15,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 10, MVar:'2', Cost:19.60, ParentId: '19'},
