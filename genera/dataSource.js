const timestamp_saved = '10/24/2023 05:10 AM';
const dataFechaAcualizado = '10/24/2023' + ' 1:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'46', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'47', Cost:10.81, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:17.36, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'135', Cost:18.40, ParentId: '16'},
		]
	},
