const timestamp_saved = '10/21/2023 12:55 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'38', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'34', Cost:12.16, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:18.93, ParentId: '14'},
