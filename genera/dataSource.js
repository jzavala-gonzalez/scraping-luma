const timestamp_saved = '08/27/2023 01:55 PM';
const dataFechaAcualizado = '8/27/2023' + ' 9:50:50 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2018},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 266,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'25', Cost:14.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 97, MVar:'53', Cost:14.03, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 46,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'9', Cost:31.86, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'25', Cost:18.80, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'75', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 245,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 245, MVar:'73', Cost:17.24, ParentId: '17'},
		]
	},
