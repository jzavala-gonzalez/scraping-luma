const timestamp_saved = '07/27/2023 10:44 AM';
const dataFechaAcualizado = '7/27/2023' + ' 6:35:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'53', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'51', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:20.46, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'17', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'49', Cost:15.66, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'81', Cost:13.19, ParentId: '17'},
		]
	},
