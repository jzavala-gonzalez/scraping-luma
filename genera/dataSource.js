const timestamp_saved = '10/13/2023 03:35 PM';
const dataFechaAcualizado = '10/13/2023' + ' 11:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'63', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'69', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'71', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'182', Cost:18.24, ParentId: '16'},
		]
	},
