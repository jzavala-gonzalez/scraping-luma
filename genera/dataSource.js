const timestamp_saved = '12/05/2023 11:40 PM';
const dataFechaAcualizado = '12/5/2023' + ' 7:35:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 386},
	{Index:'6', Desc:'Reserva Operacional', value: 541},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'62', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'65', Cost:10.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 48, MVar:'0', Cost:10.70, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.40, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'47', Cost:8.08, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'10', Cost:8.08, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'136', Cost:17.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'100', Cost:10.88, ParentId: '17'},
		]
	},
	{Index:'18', Type:'Renovable', Desc:'Wind', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Pattern', MW: 2, MVar:'0', Cost:16.29, ParentId: '18'},
			{Index:'1', Unit:'Punta Lima', MW: 2, MVar:'3', Cost:16.29, ParentId: '18'},
		]
	},
