const timestamp_saved = '11/06/2023 03:40 AM';
const dataFechaAcualizado = '11/5/2023' + ' 11:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'47', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'44', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'8', Cost:20.18, ParentId: '14'},
