const timestamp_saved = '09/01/2023 08:35 AM';
const dataFechaAcualizado = '9/1/2023' + ' 4:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'42', Cost:10.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:18.32, ParentId: '11'},
