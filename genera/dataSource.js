const timestamp_saved = '10/17/2023 11:10 AM';
const dataFechaAcualizado = '10/17/2023' + ' 7:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'51', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'50', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'54', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'12', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'88', Cost:16.86, ParentId: '15'},
