const timestamp_saved = '08/12/2023 06:50 AM';
const dataFechaAcualizado = '8/12/2023' + ' 2:47:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 510,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'57', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'53', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 352,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 352, MVar:'179', Cost:16.73, ParentId: '16'},
		]
	},
