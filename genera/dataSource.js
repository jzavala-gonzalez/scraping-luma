const timestamp_saved = '11/01/2023 12:45 PM';
const dataFechaAcualizado = '11/1/2023' + ' 8:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'57', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'61', Cost:10.57, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:17.21, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'74', Cost:9.39, ParentId: '17'},
		]
	},
