const timestamp_saved = '10/13/2023 09:50 PM';
const dataFechaAcualizado = '10/13/2023' + ' 5:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'61', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'66', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'71', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'103', Cost:9.13, ParentId: '17'},
		]
	},
