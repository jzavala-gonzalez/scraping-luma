const timestamp_saved = '10/10/2023 04:25 AM';
const dataFechaAcualizado = '10/10/2023' + ' 12:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'63', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'67', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'20', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'46', Cost:18.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.14, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'48', Cost:16.91, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'87', Cost:17.11, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'162', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'75', Cost:9.12, ParentId: '17'},
		]
	},
