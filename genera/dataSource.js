const timestamp_saved = '08/20/2023 10:25 PM';
const dataFechaAcualizado = '8/20/2023' + ' 6:22:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'56', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'33', Cost:10.87, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'102', Cost:17.32, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'71', Cost:9.30, ParentId: '17'},
		]
	},
