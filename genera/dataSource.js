const timestamp_saved = '09/25/2023 05:10 AM';
const dataFechaAcualizado = '9/25/2023' + ' 1:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'52', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'55', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'62', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 4, MVar:'1', Cost:41.63, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'30', Cost:9.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:9.08, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'0', Cost:17.47, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'0', Cost:17.47, ParentId: '11'},
		]
	},
