const timestamp_saved = '08/31/2023 04:45 AM';
const dataFechaAcualizado = '8/31/2023' + ' 12:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'41', Cost:13.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'51', Cost:13.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'61', Cost:13.45, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'12', Cost:27.90, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'11', Cost:27.88, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:18.96, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:18.96, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 312,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 312, MVar:'142', Cost:16.75, ParentId: '16'},
		]
	},
