const timestamp_saved = '08/20/2023 04:20 AM';
const dataFechaAcualizado = '8/20/2023' + ' 12:17:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'56', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'58', Cost:11.35, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 82, MVar:'0', Cost:0.29, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 139, MVar:'25', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:30.78, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'100', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'154', Cost:16.61, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:19.29, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 1, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'5', Unit:'GT3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:19.81, ParentId: '21'},
