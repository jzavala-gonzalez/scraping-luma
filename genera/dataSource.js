const timestamp_saved = '11/06/2023 08:35 PM';
const dataFechaAcualizado = '11/6/2023' + ' 4:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'54', Cost:11.08, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'167', Cost:18.27, ParentId: '16'},
		]
	},
