const timestamp_saved = '08/13/2023 08:10 PM';
const dataFechaAcualizado = '8/13/2023' + ' 4:07:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'39', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'39', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'5', Cost:0, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'107', Cost:12.23, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 77,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 28, MVar:'24', Cost:19.60, ParentId: '19'},
