const timestamp_saved = '10/12/2023 05:25 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'56', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'60', Cost:10.79, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'169', Cost:17.84, ParentId: '16'},
		]
	},
