const timestamp_saved = '11/15/2023 05:05 PM';
const dataFechaAcualizado = '11/15/2023' + ' 1:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'56', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'56', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'92', Cost:9.77, ParentId: '17'},
		]
	},
