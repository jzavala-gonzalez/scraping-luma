const timestamp_saved = '10/04/2023 11:40 AM';
const dataFechaAcualizado = '10/4/2023' + ' 7:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'38', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'36', Cost:10.98, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'89', Cost:16.95, ParentId: '15'},
