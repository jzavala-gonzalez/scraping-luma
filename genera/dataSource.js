const timestamp_saved = '11/05/2023 10:10 AM';
const dataFechaAcualizado = '11/5/2023' + ' 6:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'38', Cost:11.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:8.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:8.81, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'47', Cost:9.78, ParentId: '17'},
		]
	},
