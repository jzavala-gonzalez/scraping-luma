const timestamp_saved = '09/20/2023 03:50 AM';
const dataFechaAcualizado = '9/19/2023' + ' 11:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'77', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'43', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'61', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 18, MVar:'1', Cost:27.21, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:9.87, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:9.87, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'52', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'147', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'75', Cost:9.13, ParentId: '17'},
		]
	},
