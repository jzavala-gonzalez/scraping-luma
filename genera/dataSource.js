const timestamp_saved = '09/10/2023 09:20 AM';
const dataFechaAcualizado = '9/10/2023' + ' 5:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'60', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'58', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'62', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 120,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 69, MVar:'9', Cost:27.58, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'7', Cost:31.15, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:20.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.46, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'125', Cost:17.13, ParentId: '16'},
		]
	},
