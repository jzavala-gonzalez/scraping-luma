const timestamp_saved = '10/22/2023 02:40 PM';
const dataFechaAcualizado = '10/22/2023' + ' 10:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'40', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'41', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'46', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'16', Cost:18.43, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'60', Cost:11.21, ParentId: '17'},
		]
	},
