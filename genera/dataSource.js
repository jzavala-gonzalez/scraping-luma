const timestamp_saved = '10/28/2023 11:05 AM';
const dataFechaAcualizado = '10/28/2023' + ' 7:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'35', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'37', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'17', Cost:31.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.63, ParentId: '14'},
