const timestamp_saved = '12/04/2023 07:45 AM';
const dataFechaAcualizado = '12/4/2023' + ' 3:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'39', Cost:12.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'45', Cost:12.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'41', Cost:11.63, ParentId: '17'},
		]
	},
