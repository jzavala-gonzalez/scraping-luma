const timestamp_saved = '11/07/2023 05:15 PM';
const dataFechaAcualizado = '11/7/2023' + ' 1:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'56', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'55', Cost:10.75, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 59, MVar:'12', Cost:20.46, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'113', Cost:9.17, ParentId: '17'},
		]
	},
