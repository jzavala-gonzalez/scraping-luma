const timestamp_saved = '08/04/2023 04:45 PM';
const dataFechaAcualizado = '8/4/2023' + ' 12:40:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'50', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'87', Cost:18.26, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'40', Cost:15.66, ParentId: '15'},
		]
	},
