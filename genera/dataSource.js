const timestamp_saved = '11/22/2023 10:55 PM';
const dataFechaAcualizado = '11/22/2023' + ' 6:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'40', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'51', Cost:10.78, ParentId: '7'},
