const timestamp_saved = '09/01/2023 05:50 AM';
const dataFechaAcualizado = '9/1/2023' + ' 1:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'40', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'47', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'59', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:30.69, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'33', Cost:20.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:20.07, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'0', Cost:16.92, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'73', Cost:16.95, ParentId: '15'},
