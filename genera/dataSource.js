const timestamp_saved = '08/27/2023 10:25 PM';
const dataFechaAcualizado = '8/27/2023' + ' 6:20:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'40', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'39', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'47', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'157', Cost:17.82, ParentId: '16'},
		]
	},
