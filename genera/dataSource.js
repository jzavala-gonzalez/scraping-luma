const timestamp_saved = '12/06/2023 04:30 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:25:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 548},
	{Index:'6', Desc:'Reserva Operacional', value: 914},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'49', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'51', Cost:12.50, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:14.59, ParentId: '17'},
		]
	},
