const timestamp_saved = '08/20/2023 12:15 AM';
const dataFechaAcualizado = '8/19/2023' + ' 8:12:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'61', Cost:10.84, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'104', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'171', Cost:16.62, ParentId: '16'},
		]
	},
