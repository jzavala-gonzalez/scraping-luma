const timestamp_saved = '09/06/2023 07:10 AM';
const dataFechaAcualizado = '9/6/2023' + ' 3:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'42', Cost:13.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'44', Cost:13.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'58', Cost:13.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:7.38, ParentId: '8'},
