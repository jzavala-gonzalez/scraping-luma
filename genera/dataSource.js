const timestamp_saved = '12/02/2023 04:05 AM';
const dataFechaAcualizado = '12/2/2023' + ' 12:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'54', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'54', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'75', Cost:9.84, ParentId: '17'},
		]
	},
