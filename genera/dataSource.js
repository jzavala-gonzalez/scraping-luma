const timestamp_saved = '11/05/2023 08:45 PM';
const dataFechaAcualizado = '11/5/2023' + ' 4:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 156, MVar:'48', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'0', Cost:22.61, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'0', Cost:44.63, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'93', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'72', Cost:9.40, ParentId: '17'},
		]
	},
