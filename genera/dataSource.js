const timestamp_saved = '11/17/2023 07:20 AM';
const dataFechaAcualizado = '11/17/2023' + ' 3:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'49', Cost:12.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'48', Cost:12.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'40', Cost:12.09, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'69', Cost:16.89, ParentId: '15'},
