const timestamp_saved = '09/23/2023 04:15 PM';
const dataFechaAcualizado = '9/23/2023' + ' 12:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'47', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'47', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'59', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'62', Cost:19.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'86', Cost:9.45, ParentId: '17'},
		]
	},
