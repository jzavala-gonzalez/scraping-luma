const timestamp_saved = '11/11/2023 05:30 AM';
const dataFechaAcualizado = '11/11/2023' + ' 1:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'45', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'47', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'45', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'81', Cost:9.29, ParentId: '17'},
		]
	},
