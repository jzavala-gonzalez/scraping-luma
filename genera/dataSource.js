const timestamp_saved = '07/25/2023 10:11 AM';
const dataFechaAcualizado = '7/25/2023' + ' 6:05:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'84', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'84', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:9.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'65', Cost:9.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'59', Cost:9.72, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'12', Cost:28.39, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'11', Cost:28.29, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'19', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'55', Cost:15.45, ParentId: '15'},
		]
	},
