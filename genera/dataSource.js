const timestamp_saved = '08/07/2023 10:40 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:35:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'43', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'23', Cost:16.47, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'100', Cost:11.63, ParentId: '17'},
		]
	},
