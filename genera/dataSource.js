const timestamp_saved = '08/24/2023 06:50 AM';
const dataFechaAcualizado = '8/24/2023' + ' 2:45:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'51', Cost:10.34, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'19', Cost:19.32, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'80', Cost:9.30, ParentId: '17'},
		]
	},
