const timestamp_saved = '09/19/2023 01:00 AM';
const dataFechaAcualizado = '9/18/2023' + ' 8:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 536,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:9.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'62', Cost:9.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 190, MVar:'72', Cost:9.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'13', Cost:22.95, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 69, MVar:'21', Cost:28.27, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:19.85, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'29', Cost:19.42, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'92', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'191', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'119', Cost:9.12, ParentId: '17'},
		]
	},
