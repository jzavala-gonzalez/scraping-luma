const timestamp_saved = '10/22/2023 12:25 AM';
const dataFechaAcualizado = '10/21/2023' + ' 8:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'52', Cost:10.57, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 17,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 17, MVar:'7', Cost:53.74, ParentId: '14'},
