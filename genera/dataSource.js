const timestamp_saved = '08/21/2023 11:00 PM';
const dataFechaAcualizado = '8/21/2023' + ' 6:55:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'53', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'55', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:67.85, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'11', Cost:19.13, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'151', Cost:17.62, ParentId: '16'},
		]
	},
