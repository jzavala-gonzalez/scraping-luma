const timestamp_saved = '12/03/2023 08:30 PM';
const dataFechaAcualizado = '12/3/2023' + ' 4:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 203,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 203, MVar:'74', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'43', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'45', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'48', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:8.50, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'118', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'66', Cost:11.37, ParentId: '17'},
		]
	},
