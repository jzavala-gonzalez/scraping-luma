const timestamp_saved = '10/02/2023 06:21 PM';
const dataFechaAcualizado = '10/2/2023' + ' 2:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'42', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'40', Cost:10.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 98, MVar:'31', Cost:18.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:18.56, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'15', Cost:19.47, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'92', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'179', Cost:16.99, ParentId: '16'},
		]
	},
