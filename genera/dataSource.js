const timestamp_saved = '11/16/2023 07:55 PM';
const dataFechaAcualizado = '11/16/2023' + ' 3:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'60', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'59', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'55', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:21.23, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'25', Cost:43.38, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'89', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 147, MVar:'161', Cost:21.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 375, MVar:'106', Cost:9.12, ParentId: '17'},
		]
	},
