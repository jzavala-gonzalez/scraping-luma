const timestamp_saved = '10/08/2023 11:50 AM';
const dataFechaAcualizado = '10/8/2023' + ' 7:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'35', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'35', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'37', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'35', Cost:17.59, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'2', Cost:29.87, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.43, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'125', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 162, MVar:'65', Cost:11.30, ParentId: '17'},
		]
	},
