const timestamp_saved = '09/16/2023 03:20 AM';
const dataFechaAcualizado = '9/15/2023' + ' 11:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'47', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'46', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'62', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'20', Cost:18.84, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'147', Cost:16.73, ParentId: '16'},
		]
	},
