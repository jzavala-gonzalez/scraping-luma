const timestamp_saved = '09/28/2023 06:30 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'20', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'20', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'43', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 190,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 190, MVar:'98', Cost:19.77, ParentId: '16'},
		]
	},
