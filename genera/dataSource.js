const timestamp_saved = '08/03/2023 02:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 10:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:11.36, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 34,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'8', Cost:29.98, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'3', Cost:27.61, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'104', Cost:16.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'13', Cost:15.88, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'159', Cost:17.22, ParentId: '16'},
		]
	},
