const timestamp_saved = '09/27/2023 10:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 6:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'25', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'25', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'38', Cost:18.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.21, ParentId: '11'},
