const timestamp_saved = '09/15/2023 06:30 PM';
const dataFechaAcualizado = '9/15/2023' + ' 2:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'55', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'55', Cost:10.77, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'32', Cost:18.94, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'96', Cost:16.49, ParentId: '15'},
