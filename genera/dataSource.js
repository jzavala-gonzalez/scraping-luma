const timestamp_saved = '08/23/2023 07:00 PM';
const dataFechaAcualizado = '8/23/2023' + ' 2:55:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'55', Cost:10.80, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:19.61, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'28', Cost:19.28, ParentId: '14'},
