const timestamp_saved = '08/03/2023 08:20 AM';
const dataFechaAcualizado = '8/3/2023' + ' 4:15:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'39', Cost:10.64, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:10.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'6', Cost:10.06, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 235,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'48', Cost:17.33, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'78', Cost:11.43, ParentId: '17'},
		]
	},
