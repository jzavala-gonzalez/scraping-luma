const timestamp_saved = '09/18/2023 07:05 AM';
const dataFechaAcualizado = '9/18/2023' + ' 3:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'44', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'42', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'57', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 233,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 233, MVar:'64', Cost:9.70, ParentId: '17'},
		]
	},
