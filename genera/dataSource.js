const timestamp_saved = '11/27/2023 07:30 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'17', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'27', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'46', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'98', Cost:18.28, ParentId: '16'},
		]
	},
