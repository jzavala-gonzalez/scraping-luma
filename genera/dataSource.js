const timestamp_saved = '11/05/2023 11:40 AM';
const dataFechaAcualizado = '11/5/2023' + ' 7:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'40', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'39', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'40', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'35', Cost:8.81, ParentId: '11'},
