const timestamp_saved = '10/07/2023 09:55 AM';
const dataFechaAcualizado = '10/7/2023' + ' 5:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 61, MVar:'35', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'46', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:10.69, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'58', Cost:16.86, ParentId: '15'},
