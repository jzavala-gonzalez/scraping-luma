const timestamp_saved = '08/27/2023 04:45 PM';
const dataFechaAcualizado = '8/27/2023' + ' 12:40:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 262,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'29', Cost:14.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'13', Cost:14.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 97, MVar:'57', Cost:14.12, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'28', Cost:18.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'80', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'124', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'80', Cost:12.53, ParentId: '17'},
		]
	},
