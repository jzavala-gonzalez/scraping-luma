const timestamp_saved = '08/21/2023 07:50 AM';
const dataFechaAcualizado = '8/21/2023' + ' 3:47:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'48', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'46', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'38', Cost:9.86, ParentId: '17'},
		]
	},
