const timestamp_saved = '10/25/2023 09:40 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'43', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'44', Cost:10.70, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'39', Cost:17.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.35, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'44', Cost:17.35, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:17.35, ParentId: '11'},
		]
	},
