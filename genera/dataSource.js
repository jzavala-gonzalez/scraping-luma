const timestamp_saved = '08/14/2023 05:35 AM';
const dataFechaAcualizado = '8/14/2023' + ' 1:32:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'42', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'41', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'2', Cost:26.36, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'0', Cost:21.97, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 53,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'17', Cost:30.98, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'9', Cost:29.34, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 82,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'7', Cost:29.19, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'151', Cost:16.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'104', Cost:13.02, ParentId: '17'},
		]
	},
