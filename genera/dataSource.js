const timestamp_saved = '08/21/2023 08:11 AM';
const dataFechaAcualizado = '8/21/2023' + ' 4:07:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'41', Cost:8.21, ParentId: '11'},
