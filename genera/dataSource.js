const timestamp_saved = '12/02/2023 08:30 AM';
const dataFechaAcualizado = '12/2/2023' + ' 4:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'38', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'40', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'45', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'53', Cost:9.78, ParentId: '17'},
		]
	},
