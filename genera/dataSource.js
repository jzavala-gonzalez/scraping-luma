const timestamp_saved = '11/18/2023 11:10 AM';
const dataFechaAcualizado = '11/18/2023' + ' 7:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 270,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'37', Cost:16.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'63', Cost:16.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:16.14, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:29.38, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'24', Cost:19.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'80', Cost:17.21, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'123', Cost:9.22, ParentId: '17'},
		]
	},
