const timestamp_saved = '09/14/2023 12:20 AM';
const dataFechaAcualizado = '9/13/2023' + ' 8:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'69', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'69', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 207, MVar:'76', Cost:9.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:7.00, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'7', Cost:22.25, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:20.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:20.06, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'13', Cost:28.56, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'31', Cost:18.83, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'81', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'205', Cost:16.65, ParentId: '16'},
		]
	},
