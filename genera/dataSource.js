const timestamp_saved = '12/05/2023 03:55 AM';
const dataFechaAcualizado = '12/4/2023' + ' 11:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'43', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'47', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'55', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 3,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'1', Cost:34.36, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'3', Cost:18.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'111', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'68', Cost:10.89, ParentId: '17'},
		]
	},
