const timestamp_saved = '09/27/2023 03:30 AM';
const dataFechaAcualizado = '9/26/2023' + ' 11:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'46', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'47', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'56', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'1', Cost:25.25, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'0', Cost:20.81, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:20.81, ParentId: '11'},
		]
	},
