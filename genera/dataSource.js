const timestamp_saved = '08/10/2023 08:15 PM';
const dataFechaAcualizado = '8/10/2023' + ' 4:10:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'55', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'57', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'7', Cost:28.13, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'8', Cost:28.15, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:30.28, ParentId: '12'},
