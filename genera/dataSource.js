const timestamp_saved = '10/28/2023 08:40 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'34', Cost:12.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'36', Cost:12.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'42', Cost:12.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 159,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:28.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.18, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 89, MVar:'24', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.55, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'13', Cost:19.13, ParentId: '14'},
