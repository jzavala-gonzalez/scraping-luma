const timestamp_saved = '11/25/2023 10:45 AM';
const dataFechaAcualizado = '11/25/2023' + ' 6:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 120, MVar:'53', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'21', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'30', Cost:11.02, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'116', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 169,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 169, MVar:'40', Cost:9.84, ParentId: '17'},
		]
	},
