const timestamp_saved = '10/19/2023 10:55 AM';
const dataFechaAcualizado = '10/19/2023' + ' 6:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'33', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'39', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'31', Cost:17.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:17.60, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'37', Cost:8.71, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'71', Cost:16.96, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'94', Cost:10.52, ParentId: '17'},
		]
	},
