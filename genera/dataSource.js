const timestamp_saved = '10/28/2023 12:10 PM';
const dataFechaAcualizado = '10/28/2023' + ' 8:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'41', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 145,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'18', Cost:31.02, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.28, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:26.96, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'19', Cost:18.97, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'119', Cost:17.75, ParentId: '16'},
		]
	},
