const timestamp_saved = '11/14/2023 04:50 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:46:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'48', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'51', Cost:11.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'56', Cost:11.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:23.67, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'94', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 126,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 126, MVar:'151', Cost:23.67, ParentId: '16'},
		]
	},
