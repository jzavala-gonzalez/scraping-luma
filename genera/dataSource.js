const timestamp_saved = '10/14/2023 02:25 AM';
const dataFechaAcualizado = '10/13/2023' + ' 10:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'67', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'71', Cost:10.31, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 66, MVar:'16', Cost:27.60, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.14, ParentId: '14'},
