const timestamp_saved = '10/26/2023 06:20 PM';
const dataFechaAcualizado = '10/26/2023' + ' 2:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'51', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'56', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'56', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:16.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:16.99, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'44', Cost:17.28, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:17.28, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.45, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'17', Cost:11.31, ParentId: '17'},
		]
	},
