const timestamp_saved = '08/02/2023 09:25 AM';
const dataFechaAcualizado = '8/2/2023' + ' 5:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 506,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'46', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'47', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:21.43, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 131, MVar:'44', Cost:16.08, ParentId: '15'},
		]
	},
