const timestamp_saved = '08/30/2023 03:00 PM';
const dataFechaAcualizado = '8/30/2023' + ' 10:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'66', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'59', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'32', Cost:20.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:20.75, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'105', Cost:16.76, ParentId: '15'},
