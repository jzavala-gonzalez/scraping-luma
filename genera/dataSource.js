const timestamp_saved = '08/11/2023 06:00 AM';
const dataFechaAcualizado = '8/11/2023' + ' 1:55:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'45', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'51', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:30.77, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.73, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.53, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 195,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'140', Cost:19.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'111', Cost:11.31, ParentId: '17'},
		]
	},
