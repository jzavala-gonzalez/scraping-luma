const timestamp_saved = '08/12/2023 10:10 PM';
const dataFechaAcualizado = '8/12/2023' + ' 6:07:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'78', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'90', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'45', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'44', Cost:10.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 49, MVar:'0', Cost:15.47, ParentId: '8'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 20, MVar:'0', Cost:39, ParentId: '21'},
			{Index:'1', Unit:'CT Block 2', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'2', Unit:'CT Block 3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'3', Unit:'GT1', MW: 20, MVar:'0', Cost:39.02, ParentId: '21'},
