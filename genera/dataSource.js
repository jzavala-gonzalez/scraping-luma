const timestamp_saved = '09/26/2023 11:05 PM';
const dataFechaAcualizado = '9/26/2023' + ' 7:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'57', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'58', Cost:10.52, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'10', Cost:24.48, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'8', Cost:26.56, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'25', Cost:31.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:17.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'0', Cost:17.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'0', Cost:17.61, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'198', Cost:16.74, ParentId: '16'},
		]
	},
