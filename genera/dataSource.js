const timestamp_saved = '08/30/2023 07:05 PM';
const dataFechaAcualizado = '8/30/2023' + ' 3:00:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'87', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'60', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'69', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'72', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:19.64, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'41', Cost:18.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'97', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'162', Cost:17.52, ParentId: '16'},
		]
	},
