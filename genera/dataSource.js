const timestamp_saved = '10/14/2023 08:35 AM';
const dataFechaAcualizado = '10/14/2023' + ' 4:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'50', Cost:11.17, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'64', Cost:9.26, ParentId: '17'},
		]
	},
