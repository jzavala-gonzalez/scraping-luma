const timestamp_saved = '10/07/2023 06:40 PM';
const dataFechaAcualizado = '10/7/2023' + ' 2:36:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 190, MVar:'56', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'47', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'48', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.52, ParentId: '7'},
		]
	},
