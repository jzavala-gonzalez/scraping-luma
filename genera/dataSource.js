const timestamp_saved = '10/22/2023 05:40 AM';
const dataFechaAcualizado = '10/22/2023' + ' 1:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'42', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'43', Cost:10.84, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:18.30, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 214,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'131', Cost:18.33, ParentId: '16'},
		]
	},
