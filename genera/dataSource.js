const timestamp_saved = '08/25/2023 08:45 AM';
const dataFechaAcualizado = '8/25/2023' + ' 4:40:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'56', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'55', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:18.93, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'94', Cost:9.29, ParentId: '17'},
		]
	},
