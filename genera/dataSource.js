const timestamp_saved = '09/17/2023 03:55 AM';
const dataFechaAcualizado = '9/16/2023' + ' 11:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'45', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'44', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'60', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:8.28, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'9', Cost:8.28, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 24,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'0', Cost:31.22, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'140', Cost:16.62, ParentId: '16'},
		]
	},
