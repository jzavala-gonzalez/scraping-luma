const timestamp_saved = '08/15/2023 10:05 AM';
const dataFechaAcualizado = '8/15/2023' + ' 6:02:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'44', Cost:11.02, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:31.73, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'169', Cost:17.85, ParentId: '16'},
		]
	},
