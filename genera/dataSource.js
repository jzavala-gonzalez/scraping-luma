const timestamp_saved = '08/31/2023 03:00 PM';
const dataFechaAcualizado = '8/31/2023' + ' 10:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'51', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'60', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'66', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'16', Cost:31.23, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'48', Cost:18.96, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'42', Cost:19.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'96', Cost:16.43, ParentId: '15'},
