const timestamp_saved = '08/07/2023 08:20 AM';
const dataFechaAcualizado = '8/7/2023' + ' 4:15:40 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2287},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'57', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'84', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'40', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:11.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:0.36, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 154, MVar:'8', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'8', Cost:31.02, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:30.53, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'3', Cost:33.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'6', Cost:33.68, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'4', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 199,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'51', Cost:18.49, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 99, MVar:'25', Cost:16.99, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'93', Cost:11.73, ParentId: '17'},
		]
	},
