const timestamp_saved = '09/27/2023 11:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'28', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'28', Cost:11.16, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:18.36, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'78', Cost:9.26, ParentId: '17'},
		]
	},
