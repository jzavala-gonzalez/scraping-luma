const timestamp_saved = '12/04/2023 07:20 PM';
const dataFechaAcualizado = '12/4/2023' + ' 3:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'60', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'59', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'32', Cost:19.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'92', Cost:11.10, ParentId: '17'},
		]
	},
