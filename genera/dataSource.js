const timestamp_saved = '11/10/2023 04:25 AM';
const dataFechaAcualizado = '11/10/2023' + ' 12:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'38', Cost:13.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'34', Cost:13.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'37', Cost:13.25, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'82', Cost:9.80, ParentId: '17'},
		]
	},
