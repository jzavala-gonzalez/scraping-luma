const timestamp_saved = '11/24/2023 04:45 AM';
const dataFechaAcualizado = '11/24/2023' + ' 12:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'28', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'52', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 214,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:17.27, ParentId: '11'},
