const timestamp_saved = '09/07/2023 09:00 AM';
const dataFechaAcualizado = '9/7/2023' + ' 4:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'49', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'37', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'45', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'87', Cost:9.79, ParentId: '17'},
		]
	},
