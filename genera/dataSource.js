const timestamp_saved = '08/22/2023 03:20 AM';
const dataFechaAcualizado = '8/21/2023' + ' 11:15:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'49', Cost:11.02, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:77.82, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'47', Cost:8.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:8.20, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'0', Cost:8.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'6', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'71', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 191,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 191, MVar:'128', Cost:18.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'62', Cost:9.18, ParentId: '17'},
		]
	},
