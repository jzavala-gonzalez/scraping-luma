const timestamp_saved = '09/19/2023 08:30 AM';
const dataFechaAcualizado = '9/19/2023' + ' 4:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'43', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'44', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'59', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'83', Cost:9.14, ParentId: '17'},
		]
	},
