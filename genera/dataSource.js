const timestamp_saved = '07/27/2023 06:44 AM';
const dataFechaAcualizado = '7/27/2023' + ' 2:35:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'54', Cost:11.16, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'97', Cost:16.55, ParentId: '15'},
