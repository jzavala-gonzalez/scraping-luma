const timestamp_saved = '10/27/2023 03:10 AM';
const dataFechaAcualizado = '10/26/2023' + ' 11:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'48', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'49', Cost:10.69, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'127', Cost:17.04, ParentId: '16'},
		]
	},
