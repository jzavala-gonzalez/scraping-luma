const timestamp_saved = '11/15/2023 10:15 PM';
const dataFechaAcualizado = '11/15/2023' + ' 6:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'59', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'59', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'60', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'88', Cost:16.74, ParentId: '15'},
