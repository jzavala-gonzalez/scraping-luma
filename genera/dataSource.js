const timestamp_saved = '10/01/2023 01:05 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 9, MVar:'32', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'26', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'25', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'42', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:8.20, ParentId: '11'},
