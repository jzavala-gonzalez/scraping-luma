const timestamp_saved = '08/30/2023 12:25 AM';
const dataFechaAcualizado = '8/29/2023' + ' 8:20:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 3264},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'95', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'106', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'67', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'70', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'73', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'30', Cost:28.03, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.74, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 66,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'9', Cost:30.07, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'41', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'113', Cost:16.44, ParentId: '15'},
