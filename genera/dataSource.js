const timestamp_saved = '08/11/2023 08:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 4:32:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'52', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'48', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 14,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:0, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:31.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'33', Cost:19.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'185', Cost:16.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'136', Cost:11.45, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 47,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 12, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
