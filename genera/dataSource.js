const timestamp_saved = '10/11/2023 11:50 AM';
const dataFechaAcualizado = '10/11/2023' + ' 7:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'47', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'51', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'60', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'64', Cost:9.14, ParentId: '17'},
		]
	},
