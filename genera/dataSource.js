const timestamp_saved = '11/22/2023 10:00 AM';
const dataFechaAcualizado = '11/22/2023' + ' 5:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'26', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'37', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'51', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'76', Cost:9.79, ParentId: '17'},
		]
	},
