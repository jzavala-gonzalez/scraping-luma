const timestamp_saved = '09/27/2023 03:40 AM';
const dataFechaAcualizado = '9/26/2023' + ' 11:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'45', Cost:12.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'46', Cost:12.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'57', Cost:12.73, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'16', Cost:30.83, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 134, MVar:'42', Cost:17.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:17.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'0', Cost:18.61, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'2', Cost:19.23, ParentId: '14'},
