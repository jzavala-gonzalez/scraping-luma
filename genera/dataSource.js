const timestamp_saved = '09/03/2023 09:50 PM';
const dataFechaAcualizado = '9/3/2023' + ' 5:45:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'38', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'42', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'11', Cost:31.43, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'36', Cost:19.20, ParentId: '14'},
