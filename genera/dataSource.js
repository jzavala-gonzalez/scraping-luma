const timestamp_saved = '10/01/2023 04:25 PM';
const dataFechaAcualizado = '10/1/2023' + ' 12:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'33', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'30', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'47', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'93', Cost:9.50, ParentId: '17'},
		]
	},
