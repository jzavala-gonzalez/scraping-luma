const timestamp_saved = '12/02/2023 07:50 AM';
const dataFechaAcualizado = '12/2/2023' + ' 3:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'39', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'53', Cost:9.80, ParentId: '17'},
		]
	},
