const timestamp_saved = '08/04/2023 10:00 AM';
const dataFechaAcualizado = '8/4/2023' + ' 5:55:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'39', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'44', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 307,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'73', Cost:16.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'129', Cost:18.02, ParentId: '16'},
		]
	},
