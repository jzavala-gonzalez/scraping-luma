const timestamp_saved = '09/03/2023 08:50 AM';
const dataFechaAcualizado = '9/3/2023' + ' 4:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'43', Cost:12.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'57', Cost:12.68, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'39', Cost:16.80, ParentId: '15'},
