const timestamp_saved = '11/28/2023 05:15 PM';
const dataFechaAcualizado = '11/28/2023' + ' 1:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'39', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'59', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'177', Cost:18.22, ParentId: '16'},
		]
	},
