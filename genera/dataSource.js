const timestamp_saved = '08/15/2023 12:15 AM';
const dataFechaAcualizado = '8/14/2023' + ' 8:12:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'61', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 203, MVar:'56', Cost:9.76, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:28.68, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'26', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'206', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'149', Cost:11.65, ParentId: '17'},
		]
	},
