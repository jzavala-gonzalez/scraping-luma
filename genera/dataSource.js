const timestamp_saved = '10/15/2023 07:40 AM';
const dataFechaAcualizado = '10/15/2023' + ' 3:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'48', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'48', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'54', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'64', Cost:9.15, ParentId: '17'},
		]
	},
