const timestamp_saved = '10/23/2023 12:05 PM';
const dataFechaAcualizado = '10/23/2023' + ' 8:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'45', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'46', Cost:10.66, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'78', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'71', Cost:11.29, ParentId: '17'},
		]
	},
