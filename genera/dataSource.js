const timestamp_saved = '08/08/2023 10:10 AM';
const dataFechaAcualizado = '8/8/2023' + ' 6:05:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'49', Cost:10.98, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'86', Cost:11.62, ParentId: '17'},
		]
	},
