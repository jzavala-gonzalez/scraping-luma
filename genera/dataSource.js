const timestamp_saved = '10/21/2023 09:35 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'30', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'30', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'30', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'70', Cost:11.02, ParentId: '17'},
		]
	},
