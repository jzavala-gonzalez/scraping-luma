const timestamp_saved = '10/08/2023 03:00 AM';
const dataFechaAcualizado = '10/7/2023' + ' 10:56:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 204, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'45', Cost:12.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'46', Cost:12.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'46', Cost:12.67, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'78', Cost:16.69, ParentId: '15'},
