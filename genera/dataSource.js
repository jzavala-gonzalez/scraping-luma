const timestamp_saved = '09/15/2023 02:30 AM';
const dataFechaAcualizado = '9/14/2023' + ' 10:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'55', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'54', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'67', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'15', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'16', Cost:28.03, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.77, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'74', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'164', Cost:16.65, ParentId: '16'},
		]
	},
