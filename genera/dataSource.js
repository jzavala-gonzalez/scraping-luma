const timestamp_saved = '07/31/2023 03:15 PM';
const dataFechaAcualizado = '7/31/2023' + ' 11:10:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'45', Cost:10.84, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'5', Cost:26.35, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:19.05, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'93', Cost:11.44, ParentId: '17'},
		]
	},
