const timestamp_saved = '08/04/2023 12:40 AM';
const dataFechaAcualizado = '8/3/2023' + ' 8:35:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'53', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:20.11, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:20.11, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.90, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'182', Cost:17.00, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'107', Cost:10.88, ParentId: '17'},
		]
	},
