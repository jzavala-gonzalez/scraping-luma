const timestamp_saved = '10/23/2023 05:55 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'36', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'37', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'39', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:19.45, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'106', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'49', Cost:11.30, ParentId: '17'},
		]
	},
