const timestamp_saved = '09/21/2023 08:25 PM';
const dataFechaAcualizado = '9/21/2023' + ' 4:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'100', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'48', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'54', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'68', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:33.53, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 166,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:27.30, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:23.06, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'11', Cost:28.15, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'11', Cost:28.24, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 92, MVar:'0', Cost:9.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'7', Cost:9.74, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'30', Cost:26.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'101', Cost:17.05, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'94', Cost:33.53, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'116', Cost:16.08, ParentId: '17'},
		]
	},
