const timestamp_saved = '08/03/2023 06:10 AM';
const dataFechaAcualizado = '8/3/2023' + ' 2:05:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'41', Cost:11.14, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 247,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'70', Cost:17.08, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 112, MVar:'35', Cost:16.32, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'138', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'82', Cost:10.99, ParentId: '17'},
		]
	},
