const timestamp_saved = '10/28/2023 10:15 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'38', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'40', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 65, MVar:'18', Cost:29.00, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'14', Cost:19.07, ParentId: '14'},
