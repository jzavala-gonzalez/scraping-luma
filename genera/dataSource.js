const timestamp_saved = '12/06/2023 02:25 AM';
const dataFechaAcualizado = '12/5/2023' + ' 10:20:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 726},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'53', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'55', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'61', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 44, MVar:'0', Cost:11.75, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'117', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'86', Cost:10.86, ParentId: '17'},
		]
	},
