const timestamp_saved = '09/15/2023 08:20 PM';
const dataFechaAcualizado = '9/15/2023' + ' 4:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'53', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'52', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'65', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'2', Cost:26.47, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'14', Cost:28.15, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'38', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'105', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'167', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 375, MVar:'111', Cost:9.11, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 27,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 5, MVar:'10', Cost:19.60, ParentId: '19'},
