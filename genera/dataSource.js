const timestamp_saved = '11/30/2023 11:30 AM';
const dataFechaAcualizado = '11/30/2023' + ' 7:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'49', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.50, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'64', Cost:9.57, ParentId: '17'},
		]
	},
