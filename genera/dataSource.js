const timestamp_saved = '08/22/2023 04:55 PM';
const dataFechaAcualizado = '8/22/2023' + ' 12:50:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 28,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 129, MVar:'24', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'121', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'69', Cost:9.26, ParentId: '17'},
		]
	},
