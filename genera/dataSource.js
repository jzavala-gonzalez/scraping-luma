const timestamp_saved = '11/15/2023 02:20 AM';
const dataFechaAcualizado = '11/14/2023' + ' 10:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'51', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'53', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'58', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:26.20, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'24', Cost:28.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.82, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'11', Cost:22.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'67', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'150', Cost:17.40, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'107', Cost:10.94, ParentId: '17'},
		]
	},
