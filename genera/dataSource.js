const timestamp_saved = '11/30/2023 09:50 PM';
const dataFechaAcualizado = '11/30/2023' + ' 5:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'56', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'58', Cost:10.83, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'96', Cost:9.15, ParentId: '17'},
		]
	},
