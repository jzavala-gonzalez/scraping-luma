const timestamp_saved = '11/19/2023 04:30 PM';
const dataFechaAcualizado = '11/19/2023' + ' 12:26:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2036},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'39', Cost:16.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'48', Cost:16.02, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'36', Cost:8.72, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'85', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'93', Cost:9.91, ParentId: '17'},
		]
	},
