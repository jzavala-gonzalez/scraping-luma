const timestamp_saved = '11/11/2023 12:55 PM';
const dataFechaAcualizado = '11/11/2023' + ' 8:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'93', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'42', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'44', Cost:10.94, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'17', Cost:30.84, ParentId: '13'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 47,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 23, MVar:'7', Cost:19.60, ParentId: '19'},
