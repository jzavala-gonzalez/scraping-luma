const timestamp_saved = '08/08/2023 10:25 AM';
const dataFechaAcualizado = '8/8/2023' + ' 6:20:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'50', Cost:10.83, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'31', Cost:16.30, ParentId: '15'},
		]
	},
