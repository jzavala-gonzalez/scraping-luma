const timestamp_saved = '09/24/2023 08:15 AM';
const dataFechaAcualizado = '9/24/2023' + ' 4:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'40', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'43', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'51', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'2', Cost:29.93, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'72', Cost:9.77, ParentId: '17'},
		]
	},
