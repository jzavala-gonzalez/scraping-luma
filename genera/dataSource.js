const timestamp_saved = '09/17/2023 08:40 AM';
const dataFechaAcualizado = '9/17/2023' + ' 4:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'37', Cost:13.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'37', Cost:13.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'55', Cost:13.15, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'59', Cost:17.63, ParentId: '15'},
