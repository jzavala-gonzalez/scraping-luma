const timestamp_saved = '11/20/2023 01:10 PM';
const dataFechaAcualizado = '11/20/2023' + ' 9:06:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2355},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'43', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'51', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'60', Cost:10.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'35', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 43,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:76.20, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'181', Cost:18.24, ParentId: '16'},
		]
	},
