const timestamp_saved = '11/10/2023 08:05 AM';
const dataFechaAcualizado = '11/10/2023' + ' 4:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'44', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'49', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'41', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'52', Cost:9.81, ParentId: '17'},
		]
	},
