const timestamp_saved = '09/27/2023 07:15 AM';
const dataFechaAcualizado = '9/27/2023' + ' 3:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'26', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'60', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'36', Cost:18.21, ParentId: '11'},
