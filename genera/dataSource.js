const timestamp_saved = '10/25/2023 01:05 AM';
const dataFechaAcualizado = '10/24/2023' + ' 9:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'53', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'56', Cost:10.71, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'9', Cost:27.24, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:22.30, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'46', Cost:16.95, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'90', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'159', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'10', Cost:11.27, ParentId: '17'},
		]
	},
