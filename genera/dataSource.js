const timestamp_saved = '11/29/2023 01:05 PM';
const dataFechaAcualizado = '11/29/2023' + ' 9:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'43', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'42', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'44', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'78', Cost:9.52, ParentId: '17'},
		]
	},
