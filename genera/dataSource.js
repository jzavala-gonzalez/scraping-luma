const timestamp_saved = '08/29/2023 09:25 AM';
const dataFechaAcualizado = '8/29/2023' + ' 5:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 203, MVar:'67', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'84', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'47', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'49', Cost:10.20, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'5', Cost:0, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:26.41, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'22', Cost:19.16, ParentId: '14'},
