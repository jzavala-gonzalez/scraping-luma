const timestamp_saved = '08/15/2023 03:55 PM';
const dataFechaAcualizado = '8/15/2023' + ' 11:52:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'49', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:26.69, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 57, MVar:'32', Cost:20.74, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'191', Cost:17.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'123', Cost:11.63, ParentId: '17'},
		]
	},
