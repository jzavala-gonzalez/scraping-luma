const timestamp_saved = '08/21/2023 01:30 AM';
const dataFechaAcualizado = '8/20/2023' + ' 9:27:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'49', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'59', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:32.14, ParentId: '12'},
