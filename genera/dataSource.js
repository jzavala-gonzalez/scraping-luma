const timestamp_saved = '11/11/2023 09:15 AM';
const dataFechaAcualizado = '11/11/2023' + ' 5:11:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'40', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'44', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'42', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'68', Cost:9.78, ParentId: '17'},
		]
	},
