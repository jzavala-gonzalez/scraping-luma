const timestamp_saved = '09/29/2023 11:35 PM';
const dataFechaAcualizado = '9/29/2023' + ' 7:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'74', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'52', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'50', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'61', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'15', Cost:27.60, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:8.24, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'9', Cost:29.56, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'14', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'92', Cost:16.51, ParentId: '15'},
