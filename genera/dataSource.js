const timestamp_saved = '07/30/2023 04:25 PM';
const dataFechaAcualizado = '7/30/2023' + ' 12:20:34 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1239},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 214, MVar:'62', Cost:4.38, ParentId: '6'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'109', Cost:19.76, ParentId: '16'},
		]
	},
