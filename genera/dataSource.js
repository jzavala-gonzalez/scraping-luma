const timestamp_saved = '08/05/2023 12:45 PM';
const dataFechaAcualizado = '8/5/2023' + ' 8:40:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'40', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'46', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'2', Cost:21.66, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'9', Cost:43.77, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:28.07, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'30', Cost:18.60, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'87', Cost:16.54, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'46', Cost:15.40, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'92', Cost:11.56, ParentId: '17'},
		]
	},
