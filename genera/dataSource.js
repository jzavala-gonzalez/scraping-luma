const timestamp_saved = '08/15/2023 01:25 AM';
const dataFechaAcualizado = '8/14/2023' + ' 9:22:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'82', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'108', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'62', Cost:9.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'59', Cost:9.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'58', Cost:9.81, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.83, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'0', Cost:28.78, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'146', Cost:11.63, ParentId: '17'},
		]
	},
