const timestamp_saved = '10/12/2023 09:15 AM';
const dataFechaAcualizado = '10/12/2023' + ' 5:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'54', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'57', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'62', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.25, ParentId: '13'},
