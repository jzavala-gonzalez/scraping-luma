const timestamp_saved = '08/30/2023 01:20 AM';
const dataFechaAcualizado = '8/29/2023' + ' 9:15:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3121},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 518,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'64', Cost:9.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'66', Cost:9.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 189, MVar:'71', Cost:9.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 171,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 156, MVar:'41', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'30', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'26', Cost:28.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.18, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.18, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'189', Cost:17.42, ParentId: '16'},
		]
	},
