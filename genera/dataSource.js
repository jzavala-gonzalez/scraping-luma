const timestamp_saved = '10/27/2023 01:15 AM';
const dataFechaAcualizado = '10/26/2023' + ' 9:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'55', Cost:10.35, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'27', Cost:30.96, ParentId: '10'},
