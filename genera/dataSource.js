const timestamp_saved = '10/13/2023 08:30 AM';
const dataFechaAcualizado = '10/13/2023' + ' 4:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'55', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'60', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'66', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'66', Cost:9.15, ParentId: '17'},
		]
	},
