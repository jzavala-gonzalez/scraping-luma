const timestamp_saved = '08/14/2023 02:20 AM';
const dataFechaAcualizado = '8/13/2023' + ' 10:17:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'42', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'46', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:25.57, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'28', Cost:31.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.12, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:29.60, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'8', Cost:29.35, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'19', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'162', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'120', Cost:12.28, ParentId: '17'},
		]
	},
