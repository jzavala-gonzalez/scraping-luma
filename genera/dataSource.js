const timestamp_saved = '11/12/2023 02:10 PM';
const dataFechaAcualizado = '11/12/2023' + ' 10:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'43', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'45', Cost:12.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'54', Cost:12.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'84', Cost:9.64, ParentId: '17'},
		]
	},
