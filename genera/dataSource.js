const timestamp_saved = '08/08/2023 06:10 AM';
const dataFechaAcualizado = '8/8/2023' + ' 2:05:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'58', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'73', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:31.31, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'76', Cost:11.64, ParentId: '17'},
		]
	},
