const timestamp_saved = '10/25/2023 11:00 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'44', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'46', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'36', Cost:19.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:19.22, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'48', Cost:16.89, ParentId: '11'},
