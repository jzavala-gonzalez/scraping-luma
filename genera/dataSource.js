const timestamp_saved = '09/29/2023 06:00 AM';
const dataFechaAcualizado = '9/29/2023' + ' 1:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'34', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'33', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'50', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.70, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'55', Cost:16.84, ParentId: '15'},
