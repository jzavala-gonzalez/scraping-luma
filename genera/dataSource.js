const timestamp_saved = '11/05/2023 01:05 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'41', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'41', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'40', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:8.79, ParentId: '11'},
