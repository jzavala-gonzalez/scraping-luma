const timestamp_saved = '08/12/2023 03:00 AM';
const dataFechaAcualizado = '8/11/2023' + ' 10:57:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'42', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'58', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'1', Cost:21.47, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.97, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'8', Cost:22.87, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 135,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 60, MVar:'8', Cost:27.93, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'10', Cost:28.07, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'189', Cost:16.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'141', Cost:11.61, ParentId: '17'},
		]
	},
