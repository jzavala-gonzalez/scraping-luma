const timestamp_saved = '11/24/2023 05:45 PM';
const dataFechaAcualizado = '11/24/2023' + ' 1:41:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1996},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1980},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'30', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'40', Cost:10.50, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'84', Cost:9.87, ParentId: '17'},
		]
	},
