const timestamp_saved = '10/28/2023 02:45 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'39', Cost:12.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'42', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'47', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'14', Cost:34.54, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.10, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'17', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 51, MVar:'77', Cost:22.93, ParentId: '15'},
