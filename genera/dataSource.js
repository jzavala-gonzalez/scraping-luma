const timestamp_saved = '09/24/2023 05:35 AM';
const dataFechaAcualizado = '9/24/2023' + ' 1:30:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'42', Cost:13.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'44', Cost:13.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'54', Cost:13.14, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'2', Cost:27.99, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:31.07, ParentId: '10'},
		]
	},
