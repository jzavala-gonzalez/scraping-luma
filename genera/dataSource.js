const timestamp_saved = '11/11/2023 09:55 AM';
const dataFechaAcualizado = '11/11/2023' + ' 5:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'47', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'44', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'71', Cost:9.77, ParentId: '17'},
		]
	},
