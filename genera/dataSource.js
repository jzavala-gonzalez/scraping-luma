const timestamp_saved = '12/06/2023 02:40 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:35:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 918},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'48', Cost:13.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'50', Cost:13.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'57', Cost:13.10, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'66', Cost:14.57, ParentId: '17'},
		]
	},
