const timestamp_saved = '09/01/2023 03:05 AM';
const dataFechaAcualizado = '8/31/2023' + ' 11:00:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'40', Cost:13.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'48', Cost:13.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'60', Cost:13.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 100,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'32', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 159,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:21.34, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.48, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 28, MVar:'9', Cost:22.68, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'13', Cost:27.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'4', Cost:31.16, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:18.91, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'4', Cost:31.07, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 78,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'5', Cost:28.21, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'77', Cost:17.11, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'165', Cost:16.70, ParentId: '16'},
		]
	},
