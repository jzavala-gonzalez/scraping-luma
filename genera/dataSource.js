const timestamp_saved = '07/29/2023 04:45 PM';
const dataFechaAcualizado = '7/29/2023' + ' 12:40:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'51', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'48', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'90', Cost:16.96, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'25', Cost:15.87, ParentId: '15'},
		]
	},
