const timestamp_saved = '12/01/2023 03:30 AM';
const dataFechaAcualizado = '11/30/2023' + ' 11:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'52', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'52', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'54', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.44, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'77', Cost:9.14, ParentId: '17'},
		]
	},
