const timestamp_saved = '10/14/2023 02:05 PM';
const dataFechaAcualizado = '10/14/2023' + ' 10:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'46', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'49', Cost:11.78, ParentId: '7'},
		]
	},
