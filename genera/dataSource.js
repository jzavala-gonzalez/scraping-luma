const timestamp_saved = '09/18/2023 03:50 AM';
const dataFechaAcualizado = '9/17/2023' + ' 11:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'47', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'45', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:31.00, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'6', Cost:10.02, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 19, MVar:'0', Cost:31.25, ParentId: '12'},
