const timestamp_saved = '11/04/2023 05:30 AM';
const dataFechaAcualizado = '11/4/2023' + ' 1:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'45', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'43', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:16.96, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 197,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 197, MVar:'52', Cost:9.96, ParentId: '17'},
		]
	},
