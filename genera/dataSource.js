const timestamp_saved = '09/20/2023 01:00 AM';
const dataFechaAcualizado = '9/19/2023' + ' 8:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 227, MVar:'79', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'87', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'53', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'55', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'67', Cost:11.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 157, MVar:'52', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:29.02, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'19', Cost:18.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'76', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'168', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'90', Cost:9.13, ParentId: '17'},
		]
	},
