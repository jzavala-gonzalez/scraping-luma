const timestamp_saved = '11/15/2023 10:45 AM';
const dataFechaAcualizado = '11/15/2023' + ' 6:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'42', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'44', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'71', Cost:9.76, ParentId: '17'},
		]
	},
