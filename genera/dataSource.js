const timestamp_saved = '10/30/2023 10:40 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 141, MVar:'69', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'8', Cost:28.40, ParentId: '12'},
