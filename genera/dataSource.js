const timestamp_saved = '10/08/2023 10:40 AM';
const dataFechaAcualizado = '10/8/2023' + ' 6:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'33', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'34', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'36', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 57,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 27, MVar:'0', Cost:30.87, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'126', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 155, MVar:'62', Cost:11.57, ParentId: '17'},
		]
	},
