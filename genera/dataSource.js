const timestamp_saved = '11/28/2023 12:30 PM';
const dataFechaAcualizado = '11/28/2023' + ' 8:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'32', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'41', Cost:11.03, ParentId: '7'},
