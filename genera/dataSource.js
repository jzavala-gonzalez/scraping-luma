const timestamp_saved = '10/21/2023 03:45 PM';
const dataFechaAcualizado = '10/21/2023' + ' 11:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'39', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'38', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.52, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'74', Cost:11.05, ParentId: '17'},
		]
	},
