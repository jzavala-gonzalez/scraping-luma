const timestamp_saved = '09/29/2023 12:45 PM';
const dataFechaAcualizado = '9/29/2023' + ' 8:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'37', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'32', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'10', Cost:31.37, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'40', Cost:17.71, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.71, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:17.71, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:17.71, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'11', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'92', Cost:16.78, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'94', Cost:9.13, ParentId: '17'},
		]
	},
