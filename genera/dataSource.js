const timestamp_saved = '08/16/2023 11:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 7:32:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.37, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'5', Cost:32.25, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 51, MVar:'24', Cost:21.48, ParentId: '14'},
