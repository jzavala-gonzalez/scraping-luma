const timestamp_saved = '08/22/2023 11:50 AM';
const dataFechaAcualizado = '8/22/2023' + ' 7:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'48', Cost:10.80, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'131', Cost:18.18, ParentId: '16'},
		]
	},
