const timestamp_saved = '07/31/2023 02:05 AM';
const dataFechaAcualizado = '7/30/2023' + ' 10:00:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'58', Cost:10.63, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'94', Cost:10.96, ParentId: '17'},
		]
	},
