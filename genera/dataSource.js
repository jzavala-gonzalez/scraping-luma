const timestamp_saved = '11/09/2023 07:40 AM';
const dataFechaAcualizado = '11/9/2023' + ' 3:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'39', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'36', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'42', Cost:12.00, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'18', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'21', Cost:21.93, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'124', Cost:18.25, ParentId: '16'},
		]
	},
