const timestamp_saved = '09/05/2023 05:20 PM';
const dataFechaAcualizado = '9/5/2023' + ' 1:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'47', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'51', Cost:10.58, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'36', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'94', Cost:9.20, ParentId: '17'},
		]
	},
