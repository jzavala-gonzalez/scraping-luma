const timestamp_saved = '09/08/2023 03:25 PM';
const dataFechaAcualizado = '9/8/2023' + ' 11:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'58', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'62', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'56', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'18', Cost:31.38, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:19.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:19.65, ParentId: '11'},
