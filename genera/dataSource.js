const timestamp_saved = '10/26/2023 07:55 AM';
const dataFechaAcualizado = '10/26/2023' + ' 3:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'34', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'36', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'42', Cost:12.15, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'12', Cost:19.39, ParentId: '14'},
