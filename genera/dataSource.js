const timestamp_saved = '08/05/2023 12:20 PM';
const dataFechaAcualizado = '8/5/2023' + ' 8:15:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'48', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 129, MVar:'38', Cost:8.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'0', Cost:8.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'6', Cost:41.60, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'29', Cost:18.82, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 342,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'89', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'21', Cost:15.44, ParentId: '15'},
		]
	},
