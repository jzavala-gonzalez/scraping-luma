const timestamp_saved = '11/04/2023 12:06 PM';
const dataFechaAcualizado = '11/4/2023' + ' 8:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'42', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'54', Cost:9.73, ParentId: '17'},
		]
	},
