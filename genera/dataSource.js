const timestamp_saved = '08/27/2023 07:45 PM';
const dataFechaAcualizado = '8/27/2023' + ' 3:40:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'40', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'38', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'48', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'11', Cost:32.11, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'92', Cost:11.91, ParentId: '17'},
		]
	},
