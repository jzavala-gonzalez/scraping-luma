const timestamp_saved = '08/23/2023 02:50 PM';
const dataFechaAcualizado = '8/23/2023' + ' 10:45:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'53', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'52', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'23', Cost:18.54, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'80', Cost:9.44, ParentId: '17'},
		]
	},
