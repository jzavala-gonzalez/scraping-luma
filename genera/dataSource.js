const timestamp_saved = '10/19/2023 08:35 AM';
const dataFechaAcualizado = '10/19/2023' + ' 4:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'31', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'40', Cost:10.56, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'0', Cost:19.54, ParentId: '14'},
