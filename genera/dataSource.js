const timestamp_saved = '11/05/2023 11:25 AM';
const dataFechaAcualizado = '11/5/2023' + ' 7:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'41', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'40', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'40', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'49', Cost:9.78, ParentId: '17'},
		]
	},
