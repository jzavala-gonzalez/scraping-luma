const timestamp_saved = '11/23/2023 03:25 AM';
const dataFechaAcualizado = '11/22/2023' + ' 11:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'36', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'45', Cost:10.62, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 166, MVar:'26', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 47,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 17, MVar:'0', Cost:31.47, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'62', Cost:9.20, ParentId: '17'},
		]
	},
