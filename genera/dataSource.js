const timestamp_saved = '08/28/2023 01:55 AM';
const dataFechaAcualizado = '8/27/2023' + ' 9:50:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'46', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'51', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'20', Cost:19.27, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'87', Cost:16.84, ParentId: '15'},
