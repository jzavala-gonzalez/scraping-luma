const timestamp_saved = '08/02/2023 05:55 PM';
const dataFechaAcualizado = '8/2/2023' + ' 1:50:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 815},
	{Index:'5', Desc:'Capacidad Disponible', value: 3484},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'82', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'78', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'53', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'51', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'51', Cost:10.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 10,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 10, MVar:'0', Cost:16.65, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 146, MVar:'25', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'6', Cost:0, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.83, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.32, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'4', Cost:27.81, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:20.36, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:29.04, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'29', Cost:19.24, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'110', Cost:17.08, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'26', Cost:16.05, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'166', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'99', Cost:10.92, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 65,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 4, MVar:'21', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'22', Type:'Turbina de Gas', Desc:'Aguirre', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'GT1', MW: 0, MVar:'0', Cost:0, ParentId: '22'},
			{Index:'1', Unit:'GT2', MW: 10, MVar:'3', Cost:0, ParentId: '22'},
		]
	},
