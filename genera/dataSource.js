const timestamp_saved = '10/31/2023 10:15 AM';
const dataFechaAcualizado = '10/31/2023' + ' 6:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'53', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'59', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'57', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'72', Cost:16.77, ParentId: '15'},
