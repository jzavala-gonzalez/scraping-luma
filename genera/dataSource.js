const timestamp_saved = '12/02/2023 04:55 AM';
const dataFechaAcualizado = '12/2/2023' + ' 12:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 43,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'5', Cost:30.80, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'67', Cost:9.80, ParentId: '17'},
		]
	},
