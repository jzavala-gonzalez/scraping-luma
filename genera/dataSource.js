const timestamp_saved = '11/18/2023 03:55 AM';
const dataFechaAcualizado = '11/17/2023' + ' 11:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'73', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'69', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'57', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 16,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:27.74, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:30.81, ParentId: '12'},
