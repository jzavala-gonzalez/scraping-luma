const timestamp_saved = '11/03/2023 06:00 PM';
const dataFechaAcualizado = '11/3/2023' + ' 1:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'56', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'55', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.23, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.09, ParentId: '13'},
