const timestamp_saved = '12/06/2023 03:45 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:40:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 910},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'49', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'51', Cost:12.53, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'68', Cost:14.59, ParentId: '17'},
		]
	},
