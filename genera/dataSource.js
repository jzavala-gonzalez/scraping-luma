const timestamp_saved = '08/04/2023 03:25 PM';
const dataFechaAcualizado = '8/4/2023' + ' 11:20:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'73', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'75', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 83, MVar:'42', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'48', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'85', Cost:18.20, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'38', Cost:15.59, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'147', Cost:17.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'88', Cost:10.95, ParentId: '17'},
		]
	},
