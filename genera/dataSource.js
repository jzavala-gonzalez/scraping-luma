const timestamp_saved = '10/15/2023 10:40 AM';
const dataFechaAcualizado = '10/15/2023' + ' 6:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'49', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'43', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'48', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'58', Cost:9.52, ParentId: '17'},
		]
	},
