const timestamp_saved = '09/24/2023 10:10 AM';
const dataFechaAcualizado = '9/24/2023' + ' 6:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'42', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'52', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:20.45, ParentId: '11'},
