const timestamp_saved = '08/06/2023 07:30 PM';
const dataFechaAcualizado = '8/6/2023' + ' 3:25:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'46', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'44', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 111,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 30, MVar:'0', Cost:95.17, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'98', Cost:11.64, ParentId: '17'},
		]
	},
