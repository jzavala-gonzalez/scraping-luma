const timestamp_saved = '10/25/2023 08:05 AM';
const dataFechaAcualizado = '10/25/2023' + ' 4:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'40', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'42', Cost:11.50, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.40, ParentId: '14'},
