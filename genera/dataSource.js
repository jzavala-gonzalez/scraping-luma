const timestamp_saved = '10/24/2023 03:40 PM';
const dataFechaAcualizado = '10/24/2023' + ' 11:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'49', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'52', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'51', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'77', Cost:11.54, ParentId: '17'},
		]
	},
