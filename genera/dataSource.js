const timestamp_saved = '11/24/2023 01:10 PM';
const dataFechaAcualizado = '11/24/2023' + ' 9:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'23', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'32', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'48', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'69', Cost:9.89, ParentId: '17'},
		]
	},
