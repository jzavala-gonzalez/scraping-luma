const timestamp_saved = '10/08/2023 06:25 PM';
const dataFechaAcualizado = '10/8/2023' + ' 2:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'86', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'46', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'44', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'93', Cost:16.78, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 218,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 218, MVar:'86', Cost:10.22, ParentId: '17'},
		]
	},
