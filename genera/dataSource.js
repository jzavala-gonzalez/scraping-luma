const timestamp_saved = '11/08/2023 02:10 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'51', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'51', Cost:10.66, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.29, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 8,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 8, MVar:'7', Cost:103.08, ParentId: '14'},
