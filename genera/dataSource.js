const timestamp_saved = '09/29/2023 07:15 PM';
const dataFechaAcualizado = '9/29/2023' + ' 3:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'68', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'63', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'42', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'42', Cost:10.59, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.70, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:18.70, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:55.09, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.10, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'106', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'136', Cost:17.63, ParentId: '16'},
		]
	},
