const timestamp_saved = '12/04/2023 05:15 PM';
const dataFechaAcualizado = '12/4/2023' + ' 1:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'54', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'54', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'79', Cost:11.45, ParentId: '17'},
		]
	},
