const timestamp_saved = '11/27/2023 03:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 11:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'32', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'41', Cost:10.64, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:41.92, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:30.57, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'5', Cost:29.63, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'141', Cost:18.33, ParentId: '16'},
		]
	},
