const timestamp_saved = '10/31/2023 01:05 AM';
const dataFechaAcualizado = '10/30/2023' + ' 9:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:28.92, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'171', Cost:16.76, ParentId: '16'},
		]
	},
