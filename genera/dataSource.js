const timestamp_saved = '08/13/2023 07:20 PM';
const dataFechaAcualizado = '8/13/2023' + ' 3:17:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'40', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'41', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'7', Cost:43.46, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.19, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'111', Cost:12.24, ParentId: '17'},
		]
	},
