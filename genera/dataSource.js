const timestamp_saved = '10/18/2023 07:45 PM';
const dataFechaAcualizado = '10/18/2023' + ' 3:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'58', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'67', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:18.46, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:31.93, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'187', Cost:16.87, ParentId: '16'},
		]
	},
