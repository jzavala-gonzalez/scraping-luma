const timestamp_saved = '10/08/2023 11:35 AM';
const dataFechaAcualizado = '10/8/2023' + ' 7:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'36', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'37', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'35', Cost:18.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:18.74, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'4', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'84', Cost:16.74, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 155, MVar:'63', Cost:11.58, ParentId: '17'},
		]
	},
