const timestamp_saved = '09/05/2023 06:45 AM';
const dataFechaAcualizado = '9/5/2023' + ' 2:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'37', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'54', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:31.59, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'68', Cost:9.32, ParentId: '17'},
		]
	},
