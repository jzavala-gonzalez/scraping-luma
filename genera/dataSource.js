const timestamp_saved = '10/07/2023 11:10 AM';
const dataFechaAcualizado = '10/7/2023' + ' 7:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'42', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'43', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'47', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'149', Cost:17.37, ParentId: '16'},
		]
	},
