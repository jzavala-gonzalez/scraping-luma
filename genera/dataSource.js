const timestamp_saved = '09/01/2023 06:00 PM';
const dataFechaAcualizado = '9/1/2023' + ' 1:55:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'47', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'55', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'61', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 19,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 19, MVar:'7', Cost:218.09, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'27', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'80', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'160', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 201,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 201, MVar:'72', Cost:10.47, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 110,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 29, MVar:'5', Cost:17, ParentId: '19'},
		]
	},
