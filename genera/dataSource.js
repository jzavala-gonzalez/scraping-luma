const timestamp_saved = '10/15/2023 03:40 AM';
const dataFechaAcualizado = '10/14/2023' + ' 11:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'55', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'58', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'60', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'3', Cost:28.76, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'82', Cost:9.14, ParentId: '17'},
		]
	},
