const timestamp_saved = '07/28/2023 11:50 PM';
const dataFechaAcualizado = '7/28/2023' + ' 7:45:33 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3035},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'49', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'3', Cost:22.44, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'17', Cost:18.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'90', Cost:13.85, ParentId: '17'},
		]
	},
