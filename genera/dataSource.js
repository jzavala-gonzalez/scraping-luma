const timestamp_saved = '11/03/2023 05:45 AM';
const dataFechaAcualizado = '11/3/2023' + ' 1:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'46', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'48', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'5', Cost:30.68, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'63', Cost:9.25, ParentId: '17'},
		]
	},
