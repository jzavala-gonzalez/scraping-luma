const timestamp_saved = '08/01/2023 05:30 PM';
const dataFechaAcualizado = '8/1/2023' + ' 1:25:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'53', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'53', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 19, MVar:'1', Cost:26.82, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'32', Cost:15.69, ParentId: '15'},
		]
	},
