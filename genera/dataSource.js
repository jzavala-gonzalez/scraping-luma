const timestamp_saved = '10/24/2023 05:35 AM';
const dataFechaAcualizado = '10/24/2023' + ' 1:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'46', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'46', Cost:10.70, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'43', Cost:17.25, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'68', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'138', Cost:18.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'70', Cost:11.02, ParentId: '17'},
		]
	},
