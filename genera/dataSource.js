const timestamp_saved = '09/14/2023 09:40 PM';
const dataFechaAcualizado = '9/14/2023' + ' 5:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'59', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'58', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'70', Cost:10.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 159,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 87, MVar:'0', Cost:5.55, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'17', Cost:28.20, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 136, MVar:'0', Cost:9.93, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:9.93, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'33', Cost:19.60, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'122', Cost:9.11, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 10,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 5, MVar:'26', Cost:19.60, ParentId: '19'},
