const timestamp_saved = '09/21/2023 08:00 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'38', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'42', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'62', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'8', Cost:26.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'68', Cost:17.71, ParentId: '15'},
