const timestamp_saved = '10/28/2023 11:46 PM';
const dataFechaAcualizado = '10/28/2023' + ' 7:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'53', Cost:11.27, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'9', Cost:18.30, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'10', Cost:18.97, ParentId: '14'},
