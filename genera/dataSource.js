const timestamp_saved = '08/23/2023 12:15 PM';
const dataFechaAcualizado = '8/23/2023' + ' 8:10:40 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2277},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'55', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'51', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'29', Cost:19.13, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'74', Cost:9.82, ParentId: '17'},
		]
	},
