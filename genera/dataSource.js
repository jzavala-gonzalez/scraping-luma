const timestamp_saved = '10/25/2023 09:05 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'40', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'45', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.00, ParentId: '11'},
