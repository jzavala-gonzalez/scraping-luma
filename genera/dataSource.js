const timestamp_saved = '09/20/2023 06:40 AM';
const dataFechaAcualizado = '9/20/2023' + ' 2:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'44', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'46', Cost:11.37, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 128, MVar:'46', Cost:16.53, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'136', Cost:17.88, ParentId: '16'},
		]
	},
