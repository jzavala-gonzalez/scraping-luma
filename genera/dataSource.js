const timestamp_saved = '09/06/2023 01:20 PM';
const dataFechaAcualizado = '9/6/2023' + ' 9:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'70', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'64', Cost:25.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'1', Cost:25.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:25.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 78,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'4', Cost:27.82, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:27.42, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 5, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'5', Cost:91.11, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 55,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 55, MVar:'12', Cost:30.56, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'21', Cost:18.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'92', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'142', Cost:16.88, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 70,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 17, MVar:'6', Cost:17, ParentId: '19'},
		]
	},
