const timestamp_saved = '08/03/2023 12:50 PM';
const dataFechaAcualizado = '8/3/2023' + ' 8:45:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'41', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'44', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'83', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'24', Cost:15.74, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'139', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'78', Cost:11.39, ParentId: '17'},
		]
	},
