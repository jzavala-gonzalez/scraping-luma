const timestamp_saved = '11/12/2023 11:10 AM';
const dataFechaAcualizado = '11/12/2023' + ' 7:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'40', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'42', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'50', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'51', Cost:17.66, ParentId: '15'},
