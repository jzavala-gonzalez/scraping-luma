const timestamp_saved = '11/04/2023 02:15 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'45', Cost:13.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'44', Cost:13.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'44', Cost:13.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 278,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:17.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'56', Cost:9.76, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 95,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'7', Cost:19.60, ParentId: '19'},
