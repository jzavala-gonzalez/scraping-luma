const timestamp_saved = '08/04/2023 04:45 AM';
const dataFechaAcualizado = '8/4/2023' + ' 12:40:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'39', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:10.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'9', Cost:10.05, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'129', Cost:17.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'86', Cost:10.85, ParentId: '17'},
		]
	},
