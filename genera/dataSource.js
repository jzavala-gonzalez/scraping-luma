const timestamp_saved = '12/01/2023 06:20 PM';
const dataFechaAcualizado = '12/1/2023' + ' 2:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'51', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'80', Cost:9.56, ParentId: '17'},
		]
	},
