const timestamp_saved = '11/25/2023 07:45 AM';
const dataFechaAcualizado = '11/25/2023' + ' 3:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'20', Cost:13.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'30', Cost:13.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'47', Cost:13.18, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'121', Cost:17.38, ParentId: '16'},
		]
	},
