const timestamp_saved = '11/03/2023 02:00 AM';
const dataFechaAcualizado = '11/2/2023' + ' 9:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'59', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'57', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'62', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.20, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:16.80, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 263,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 263, MVar:'164', Cost:17.58, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'88', Cost:9.14, ParentId: '17'},
		]
	},
