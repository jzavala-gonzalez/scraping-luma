const timestamp_saved = '11/04/2023 08:55 AM';
const dataFechaAcualizado = '11/4/2023' + ' 4:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'41', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'39', Cost:11.25, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'47', Cost:9.72, ParentId: '17'},
		]
	},
