const timestamp_saved = '10/26/2023 09:30 PM';
const dataFechaAcualizado = '10/26/2023' + ' 5:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'49', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'52', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:34.71, ParentId: '8'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 0, MVar:'0', Cost:35, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:34.71, ParentId: '21'},
