const timestamp_saved = '08/27/2023 11:30 AM';
const dataFechaAcualizado = '8/27/2023' + ' 7:25:50 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1983},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 265,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 97, MVar:'51', Cost:14.00, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'8', Cost:31.02, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'17', Cost:18.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 126, MVar:'76', Cost:17.45, ParentId: '15'},
