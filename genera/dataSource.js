const timestamp_saved = '08/23/2023 01:50 AM';
const dataFechaAcualizado = '8/22/2023' + ' 9:45:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'64', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'46', Cost:11.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'128', Cost:16.96, ParentId: '16'},
		]
	},
