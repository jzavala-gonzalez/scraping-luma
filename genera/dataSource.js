const timestamp_saved = '11/26/2023 03:20 PM';
const dataFechaAcualizado = '11/26/2023' + ' 11:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 203,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 203, MVar:'63', Cost:4.44, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.44, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'27', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'32', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'47', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'123', Cost:19.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'68', Cost:10.13, ParentId: '17'},
		]
	},
