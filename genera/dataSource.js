const timestamp_saved = '10/04/2023 11:05 AM';
const dataFechaAcualizado = '10/4/2023' + ' 7:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'36', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'33', Cost:11.13, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'81', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'152', Cost:17.35, ParentId: '16'},
		]
	},
