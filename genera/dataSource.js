const timestamp_saved = '11/27/2023 03:00 AM';
const dataFechaAcualizado = '11/26/2023' + ' 10:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'32', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'42', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.72, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 40,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'6', Cost:28.98, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'142', Cost:17.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'92', Cost:9.29, ParentId: '17'},
		]
	},
