const timestamp_saved = '09/29/2023 07:25 PM';
const dataFechaAcualizado = '9/29/2023' + ' 3:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'44', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'55', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:10.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'8', Cost:10.16, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'19', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'109', Cost:16.47, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'138', Cost:17.62, ParentId: '16'},
		]
	},
