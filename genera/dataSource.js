const timestamp_saved = '08/24/2023 11:35 AM';
const dataFechaAcualizado = '8/24/2023' + ' 7:30:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'67', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'81', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'51', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'33', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'92', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'137', Cost:17.27, ParentId: '16'},
		]
	},
