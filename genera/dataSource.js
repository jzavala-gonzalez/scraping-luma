const timestamp_saved = '09/11/2023 03:10 PM';
const dataFechaAcualizado = '9/11/2023' + ' 11:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'67', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'76', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'7', Cost:31.18, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'93', Cost:16.63, ParentId: '15'},
