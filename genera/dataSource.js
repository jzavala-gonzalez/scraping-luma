const timestamp_saved = '10/30/2023 09:45 PM';
const dataFechaAcualizado = '10/30/2023' + ' 5:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'57', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'60', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'66', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'16', Cost:30.90, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'155', Cost:16.87, ParentId: '16'},
		]
	},
