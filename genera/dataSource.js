const timestamp_saved = '11/15/2023 12:15 AM';
const dataFechaAcualizado = '11/14/2023' + ' 8:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'60', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'64', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'63', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'176', Cost:17.14, ParentId: '16'},
		]
	},
