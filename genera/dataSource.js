const timestamp_saved = '09/28/2023 03:55 PM';
const dataFechaAcualizado = '9/28/2023' + ' 11:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'27', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'27', Cost:11.64, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'130', Cost:18.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'86', Cost:9.75, ParentId: '17'},
		]
	},
