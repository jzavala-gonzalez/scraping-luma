const timestamp_saved = '11/22/2023 06:10 AM';
const dataFechaAcualizado = '11/22/2023' + ' 2:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'30', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'67', Cost:9.61, ParentId: '17'},
		]
	},
