const timestamp_saved = '08/31/2023 04:10 AM';
const dataFechaAcualizado = '8/31/2023' + ' 12:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'44', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'54', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'64', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:18.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:18.89, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'156', Cost:16.65, ParentId: '16'},
		]
	},
