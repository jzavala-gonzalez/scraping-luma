const timestamp_saved = '11/29/2023 07:00 AM';
const dataFechaAcualizado = '11/29/2023' + ' 2:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'22', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'32', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'48', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'66', Cost:9.80, ParentId: '17'},
		]
	},
