const timestamp_saved = '09/27/2023 10:15 AM';
const dataFechaAcualizado = '9/27/2023' + ' 6:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'29', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'30', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'61', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.93, ParentId: '11'},
