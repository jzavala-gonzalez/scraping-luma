const timestamp_saved = '12/05/2023 12:50 PM';
const dataFechaAcualizado = '12/5/2023' + ' 8:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'50', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'52', Cost:10.36, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 160,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'16', Cost:18.80, ParentId: '14'},
