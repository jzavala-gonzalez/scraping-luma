const timestamp_saved = '11/13/2023 03:55 AM';
const dataFechaAcualizado = '11/12/2023' + ' 11:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 149,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 65, MVar:'46', Cost:23.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 85, MVar:'52', Cost:23.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:23.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 195,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 53, MVar:'0', Cost:21.87, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.91, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:23.08, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'8', Cost:27.92, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.71, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 111,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'7', Cost:19.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'66', Cost:16.03, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'99', Cost:9.17, ParentId: '17'},
		]
	},
