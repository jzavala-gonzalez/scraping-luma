const timestamp_saved = '08/16/2023 07:00 AM';
const dataFechaAcualizado = '8/16/2023' + ' 2:57:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'56', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'49', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'57', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'186', Cost:17.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'82', Cost:10.36, ParentId: '17'},
		]
	},
