const timestamp_saved = '07/30/2023 04:35 AM';
const dataFechaAcualizado = '7/30/2023' + ' 12:30:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'44', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'42', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'37', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:24.20, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.90, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'6', Cost:24.59, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'1', Cost:31.54, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'3', Cost:31.51, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'43', Cost:17.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.69, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:30.94, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'8', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'62', Cost:16.60, ParentId: '15'},
