const timestamp_saved = '08/30/2023 10:45 AM';
const dataFechaAcualizado = '8/30/2023' + ' 6:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 162, MVar:'83', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'43', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'55', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:27.35, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'31', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'66', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 254, MVar:'143', Cost:17.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'101', Cost:9.19, ParentId: '17'},
		]
	},
