const timestamp_saved = '10/28/2023 09:15 PM';
const dataFechaAcualizado = '10/28/2023' + ' 5:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'48', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'51', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'52', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:25.59, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.59, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'36', Cost:18.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:18.61, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'6', Cost:30.22, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.14, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'17', Cost:21.54, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'76', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'124', Cost:17.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'1', Cost:11.29, ParentId: '17'},
		]
	},
