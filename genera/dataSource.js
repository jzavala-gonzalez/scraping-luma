const timestamp_saved = '11/26/2023 12:50 PM';
const dataFechaAcualizado = '11/26/2023' + ' 8:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 201,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 201, MVar:'57', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'19', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'29', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.42, ParentId: '7'},
		]
	},
