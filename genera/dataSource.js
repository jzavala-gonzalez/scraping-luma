const timestamp_saved = '10/27/2023 01:20 AM';
const dataFechaAcualizado = '10/26/2023' + ' 9:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'53', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'55', Cost:10.41, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 6, MVar:'1', Cost:26.53, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'142', Cost:16.74, ParentId: '16'},
		]
	},
