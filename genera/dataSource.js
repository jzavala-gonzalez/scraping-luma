const timestamp_saved = '10/09/2023 08:10 AM';
const dataFechaAcualizado = '10/9/2023' + ' 4:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'42', Cost:11.03, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:18.67, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.46, ParentId: '13'},
