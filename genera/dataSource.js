const timestamp_saved = '08/07/2023 08:00 PM';
const dataFechaAcualizado = '8/7/2023' + ' 3:55:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 161},
	{Index:'4', Desc:'Reserva Operacional', value: 176},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'109', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'59', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'58', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'53', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:30.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'9', Cost:28.56, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'17', Cost:18.73, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 259,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'85', Cost:18.42, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 10, MVar:'10', Cost:21.43, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 3, MVar:'7', Cost:17, ParentId: '19'},
		]
	},
