const timestamp_saved = '09/16/2023 11:55 AM';
const dataFechaAcualizado = '9/16/2023' + ' 7:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'41', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'40', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'56', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:31.34, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'69', Cost:17.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 180,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'108', Cost:19.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'79', Cost:9.46, ParentId: '17'},
		]
	},
