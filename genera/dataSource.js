const timestamp_saved = '10/28/2023 03:20 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:16:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1999},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'40', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'42', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 64, MVar:'18', Cost:30.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.55, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:20.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'95', Cost:19.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'124', Cost:17.22, ParentId: '16'},
		]
	},
