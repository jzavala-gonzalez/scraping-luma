const timestamp_saved = '10/12/2023 12:00 PM';
const dataFechaAcualizado = '10/12/2023' + ' 7:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'57', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'61', Cost:10.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'161', Cost:18.32, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'77', Cost:9.30, ParentId: '17'},
		]
	},
