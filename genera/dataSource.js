const timestamp_saved = '09/23/2023 07:50 AM';
const dataFechaAcualizado = '9/23/2023' + ' 3:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'37', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'40', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'55', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'45', Cost:8.21, ParentId: '11'},
