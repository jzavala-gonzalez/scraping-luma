const timestamp_saved = '09/06/2023 02:45 PM';
const dataFechaAcualizado = '9/6/2023' + ' 10:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'58', Cost:19.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'34', Cost:19.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:19.64, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:26.54, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:8.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:8.43, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'0', Cost:8.39, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'12', Cost:8.39, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:30.75, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'96', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'144', Cost:17.42, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'91', Cost:9.18, ParentId: '17'},
		]
	},
