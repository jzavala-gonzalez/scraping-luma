const timestamp_saved = '08/12/2023 03:45 PM';
const dataFechaAcualizado = '8/12/2023' + ' 11:42:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'75', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'86', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'47', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'0', Cost:20.40, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'142', Cost:18.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'100', Cost:11.61, ParentId: '17'},
		]
	},
