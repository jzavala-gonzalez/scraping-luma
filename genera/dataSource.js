const timestamp_saved = '09/22/2023 03:30 AM';
const dataFechaAcualizado = '9/21/2023' + ' 11:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'33', Cost:13.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'36', Cost:13.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'59', Cost:13.60, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:22.89, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'3', Cost:27.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'3', Cost:28.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:19.79, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'4', Cost:28.74, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.41, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'92', Cost:32.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'88', Cost:16.06, ParentId: '17'},
		]
	},
