const timestamp_saved = '10/22/2023 01:40 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'38', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'40', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'56', Cost:11.24, ParentId: '17'},
		]
	},
