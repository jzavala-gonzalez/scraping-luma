const timestamp_saved = '08/13/2023 02:35 PM';
const dataFechaAcualizado = '8/13/2023' + ' 10:32:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'44', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 64,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 16, MVar:'7', Cost:27.43, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'40', Cost:19.21, ParentId: '14'},
