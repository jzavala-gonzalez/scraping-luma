const timestamp_saved = '09/28/2023 10:10 PM';
const dataFechaAcualizado = '9/28/2023' + ' 6:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'46', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'46', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'90', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 334, MVar:'154', Cost:16.82, ParentId: '16'},
		]
	},
