const timestamp_saved = '11/29/2023 01:55 PM';
const dataFechaAcualizado = '11/29/2023' + ' 9:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'45', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'46', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'80', Cost:9.62, ParentId: '17'},
		]
	},
