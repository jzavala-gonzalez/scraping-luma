const timestamp_saved = '12/02/2023 12:35 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'55', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'56', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'57', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'94', Cost:9.16, ParentId: '17'},
		]
	},
