const timestamp_saved = '12/06/2023 06:05 AM';
const dataFechaAcualizado = '12/6/2023' + ' 2:00:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 494},
	{Index:'6', Desc:'Reserva Operacional', value: 1090},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'41', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'45', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'52', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'54', Cost:14.51, ParentId: '17'},
		]
	},
