const timestamp_saved = '09/25/2023 03:15 AM';
const dataFechaAcualizado = '9/24/2023' + ' 11:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'49', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'50', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'58', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:19.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:19.61, ParentId: '11'},
