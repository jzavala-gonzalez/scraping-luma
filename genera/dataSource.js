const timestamp_saved = '09/25/2023 04:55 AM';
const dataFechaAcualizado = '9/25/2023' + ' 12:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'49', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'52', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'59', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 34,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'1', Cost:26.50, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'47', Cost:19.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.66, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 117, MVar:'0', Cost:17.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'0', Cost:17.68, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.74, ParentId: '12'},
