const timestamp_saved = '10/22/2023 09:45 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'49', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'47', Cost:10.45, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:22.50, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'68', Cost:16.84, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 33,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:22.50, ParentId: '21'},
