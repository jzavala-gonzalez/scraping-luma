const timestamp_saved = '09/27/2023 09:50 PM';
const dataFechaAcualizado = '9/27/2023' + ' 5:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'30', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'30', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'61', Cost:11.08, ParentId: '7'},
		]
	},
