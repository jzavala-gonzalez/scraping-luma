const timestamp_saved = '12/02/2023 12:55 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'55', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'57', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'58', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'19', Cost:19.40, ParentId: '14'},
