const timestamp_saved = '07/26/2023 06:06 AM';
const dataFechaAcualizado = '7/26/2023' + ' 2:00:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'56', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 133, MVar:'37', Cost:20.60, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.86, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'60', Cost:15.43, ParentId: '15'},
		]
	},
