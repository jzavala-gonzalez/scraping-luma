const timestamp_saved = '08/28/2023 02:35 AM';
const dataFechaAcualizado = '8/27/2023' + ' 10:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'44', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'44', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'15', Cost:31.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'18', Cost:30.89, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 51,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 21, MVar:'0', Cost:29.40, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'17', Cost:19.22, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'169', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'112', Cost:11.64, ParentId: '17'},
		]
	},
