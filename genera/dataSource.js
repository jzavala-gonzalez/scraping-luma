const timestamp_saved = '10/30/2023 01:30 PM';
const dataFechaAcualizado = '10/30/2023' + ' 9:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'60', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'58', Cost:10.06, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 62, MVar:'21', Cost:18.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 31, MVar:'6', Cost:18.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'37', Cost:18.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'6', Cost:18.31, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'25', Cost:19.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'82', Cost:16.60, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'159', Cost:18.32, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'79', Cost:9.74, ParentId: '17'},
		]
	},
