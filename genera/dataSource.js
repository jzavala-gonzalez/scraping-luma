const timestamp_saved = '09/22/2023 11:40 PM';
const dataFechaAcualizado = '9/22/2023' + ' 7:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'74', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'76', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'56', Cost:9.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'57', Cost:9.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'68', Cost:9.70, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.81, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'9', Cost:29.41, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:18.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'75', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'128', Cost:32.74, ParentId: '16'},
		]
	},
