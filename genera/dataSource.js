const timestamp_saved = '08/14/2023 09:10 AM';
const dataFechaAcualizado = '8/14/2023' + ' 5:07:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'36', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'42', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'40', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'29', Cost:18.85, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'102', Cost:12.99, ParentId: '17'},
		]
	},
