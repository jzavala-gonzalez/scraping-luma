const timestamp_saved = '12/01/2023 09:25 AM';
const dataFechaAcualizado = '12/1/2023' + ' 5:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'41', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'43', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'57', Cost:9.85, ParentId: '17'},
		]
	},
