const timestamp_saved = '10/20/2023 12:00 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'41', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'48', Cost:10.64, ParentId: '7'},
