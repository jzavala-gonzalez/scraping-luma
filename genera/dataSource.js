const timestamp_saved = '10/18/2023 08:56 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'37', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'42', Cost:10.53, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 60, MVar:'66', Cost:21.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'148', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'82', Cost:10.68, ParentId: '17'},
		]
	},
