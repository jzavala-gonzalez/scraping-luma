const timestamp_saved = '10/02/2023 05:10 AM';
const dataFechaAcualizado = '10/2/2023' + ' 1:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'32', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'30', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'46', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'93', Cost:9.20, ParentId: '17'},
		]
	},
