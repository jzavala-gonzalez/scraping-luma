const timestamp_saved = '10/08/2023 03:05 PM';
const dataFechaAcualizado = '10/8/2023' + ' 11:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'41', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'41', Cost:10.78, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'81', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'76', Cost:11.43, ParentId: '17'},
		]
	},
