const timestamp_saved = '07/27/2023 12:57 PM';
const dataFechaAcualizado = '7/27/2023' + ' 8:50:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'66', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'55', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'54', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 138, MVar:'40', Cost:8.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:8.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 130, MVar:'0', Cost:8.73, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'20', Cost:18.71, ParentId: '14'},
