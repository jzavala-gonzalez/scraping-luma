const timestamp_saved = '10/29/2023 01:35 PM';
const dataFechaAcualizado = '10/29/2023' + ' 9:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'47', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'47', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'70', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'17', Cost:21.63, ParentId: '14'},
