const timestamp_saved = '11/22/2023 08:10 PM';
const dataFechaAcualizado = '11/22/2023' + ' 4:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'34', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'46', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'57', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'102', Cost:9.26, ParentId: '17'},
		]
	},
