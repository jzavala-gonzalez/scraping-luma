const timestamp_saved = '11/26/2023 02:00 PM';
const dataFechaAcualizado = '11/26/2023' + ' 9:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 189,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 189, MVar:'58', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'19', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'30', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'47', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.74, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 178,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'116', Cost:19.76, ParentId: '16'},
		]
	},
