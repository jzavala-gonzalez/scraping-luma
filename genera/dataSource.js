const timestamp_saved = '09/17/2023 04:00 PM';
const dataFechaAcualizado = '9/17/2023' + ' 11:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'64', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'42', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'56', Cost:11.61, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'4', Cost:31.23, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:19.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'71', Cost:9.66, ParentId: '17'},
		]
	},
