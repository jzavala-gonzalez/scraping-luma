const timestamp_saved = '10/07/2023 02:10 PM';
const dataFechaAcualizado = '10/7/2023' + ' 10:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 123, MVar:'48', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'41', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'42', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'47', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.47, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'140', Cost:17.34, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 94,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'13', Cost:19.60, ParentId: '19'},
