const timestamp_saved = '11/04/2023 12:26 PM';
const dataFechaAcualizado = '11/4/2023' + ' 8:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'71', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'44', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'43', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'42', Cost:11.35, ParentId: '7'},
		]
	},
