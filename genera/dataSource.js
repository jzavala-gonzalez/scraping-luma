const timestamp_saved = '11/23/2023 12:55 PM';
const dataFechaAcualizado = '11/23/2023' + ' 8:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'72', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'20', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'30', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'47', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'65', Cost:9.80, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 59,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 22, MVar:'18', Cost:19.60, ParentId: '19'},
