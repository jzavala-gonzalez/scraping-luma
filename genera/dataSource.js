const timestamp_saved = '11/16/2023 08:05 AM';
const dataFechaAcualizado = '11/16/2023' + ' 4:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'41', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:12.85, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'22', Cost:0, ParentId: '8'},
