const timestamp_saved = '08/09/2023 11:35 PM';
const dataFechaAcualizado = '8/9/2023' + ' 7:30:42 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2858},
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3113},
	{Index:'6', Desc:'Próxima Hora MW', value: 2841},
	{Index:'7', Desc:'Máxima para Hoy', value: 2833},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'99', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'62', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'60', Cost:10.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 191,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 119, MVar:'29', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:27.71, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:26.94, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:29.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'10', Cost:37.60, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'6', Cost:28.71, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 79,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'7', Cost:28.33, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'38', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'186', Cost:16.87, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'92', Cost:11.55, ParentId: '17'},
		]
	},
