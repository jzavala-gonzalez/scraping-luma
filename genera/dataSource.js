const timestamp_saved = '08/11/2023 06:50 PM';
const dataFechaAcualizado = '8/11/2023' + ' 2:45:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'45', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'5', Cost:27.16, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:20.20, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.60, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'133', Cost:11.60, ParentId: '17'},
		]
	},
