const timestamp_saved = '11/21/2023 09:50 PM';
const dataFechaAcualizado = '11/21/2023' + ' 5:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'39', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'47', Cost:10.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:17.41, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'0', Cost:19.82, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 236,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 236, MVar:'182', Cost:18.19, ParentId: '16'},
		]
	},
