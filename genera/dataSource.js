const timestamp_saved = '11/23/2023 09:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'64', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'17', Cost:13.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'27', Cost:13.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'45', Cost:13.39, ParentId: '7'},
		]
	},
