const timestamp_saved = '11/02/2023 11:15 AM';
const dataFechaAcualizado = '11/2/2023' + ' 7:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'50', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'49', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'48', Cost:11.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.11, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:47.01, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'77', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 168,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 168, MVar:'125', Cost:20.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'72', Cost:9.25, ParentId: '17'},
		]
	},
