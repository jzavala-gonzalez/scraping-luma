const timestamp_saved = '11/11/2023 06:20 AM';
const dataFechaAcualizado = '11/11/2023' + ' 2:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 195,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 195, MVar:'67', Cost:10.57, ParentId: '17'},
		]
	},
