const timestamp_saved = '09/20/2023 02:10 AM';
const dataFechaAcualizado = '9/19/2023' + ' 10:05:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'48', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'49', Cost:12.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'63', Cost:12.93, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'12', Cost:18.97, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'67', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'159', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'83', Cost:9.13, ParentId: '17'},
		]
	},
