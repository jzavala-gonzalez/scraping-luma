const timestamp_saved = '11/05/2023 10:00 AM';
const dataFechaAcualizado = '11/5/2023' + ' 5:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'39', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'38', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'38', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'36', Cost:17.67, ParentId: '11'},
