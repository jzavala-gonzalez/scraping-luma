const timestamp_saved = '09/12/2023 11:10 PM';
const dataFechaAcualizado = '9/12/2023' + ' 7:05:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'59', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'56', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'69', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 31, MVar:'0', Cost:24.32, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'3', Cost:24.93, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'7', Cost:28.14, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'13', Cost:31.02, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'95', Cost:16.85, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 62,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:21.85, ParentId: '21'},
