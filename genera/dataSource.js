const timestamp_saved = '11/19/2023 07:00 PM';
const dataFechaAcualizado = '11/19/2023' + ' 2:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'44', Cost:14.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'53', Cost:14.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:14.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:17.48, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:17.48, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'82', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'143', Cost:17.56, ParentId: '16'},
		]
	},
