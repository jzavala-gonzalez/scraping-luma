const timestamp_saved = '10/11/2023 03:00 PM';
const dataFechaAcualizado = '10/11/2023' + ' 10:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'58', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'61', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'66', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:10.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:10.14, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'43', Cost:17.69, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:17.69, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'72', Cost:9.65, ParentId: '17'},
		]
	},
