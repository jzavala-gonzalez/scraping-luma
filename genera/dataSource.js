const timestamp_saved = '08/02/2023 02:00 PM';
const dataFechaAcualizado = '8/2/2023' + ' 9:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:10.56, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 283,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'88', Cost:16.67, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'38', Cost:15.96, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'157', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'98', Cost:11.02, ParentId: '17'},
		]
	},
