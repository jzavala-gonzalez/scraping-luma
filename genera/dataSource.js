const timestamp_saved = '08/02/2023 07:00 AM';
const dataFechaAcualizado = '8/2/2023' + ' 2:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'43', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'40', Cost:10.88, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'65', Cost:17.37, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 131, MVar:'40', Cost:16.07, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'80', Cost:10.99, ParentId: '17'},
		]
	},
