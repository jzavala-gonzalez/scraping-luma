const timestamp_saved = '08/17/2023 12:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 8:32:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3083},
	{Index:'1', Desc:'PREPA', value: 65},
	{Index:'2', Desc:'COGEN', value: 35},
	{Index:'3', Desc:'Reserva en Rotación', value: 39},
	{Index:'4', Desc:'Reserva Operacional', value: 43},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'63', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'81', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'86', Cost:9.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.11, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'6', Cost:22.25, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'24', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'24', Cost:28.06, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:19.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:19.57, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'8', Cost:30.08, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'30', Cost:18.50, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'241', Cost:16.66, ParentId: '16'},
		]
	},
