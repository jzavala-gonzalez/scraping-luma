const timestamp_saved = '10/16/2023 12:50 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'60', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'58', Cost:10.45, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.29, ParentId: '11'},
