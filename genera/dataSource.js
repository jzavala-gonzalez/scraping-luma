const timestamp_saved = '09/04/2023 01:10 AM';
const dataFechaAcualizado = '9/3/2023' + ' 9:05:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'43', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'47', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'173', Cost:16.74, ParentId: '16'},
		]
	},
