const timestamp_saved = '12/01/2023 04:55 AM';
const dataFechaAcualizado = '12/1/2023' + ' 12:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'46', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'49', Cost:10.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:25.97, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'64', Cost:9.87, ParentId: '17'},
		]
	},
