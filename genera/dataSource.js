const timestamp_saved = '08/01/2023 12:50 AM';
const dataFechaAcualizado = '7/31/2023' + ' 8:45:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'48', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'50', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'11', Cost:22.35, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:19.34, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'90', Cost:16.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'35', Cost:15.47, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'100', Cost:10.98, ParentId: '17'},
		]
	},
