const timestamp_saved = '08/18/2023 04:30 PM';
const dataFechaAcualizado = '8/18/2023' + ' 12:27:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'48', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'63', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'72', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'9', Cost:31.73, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'75', Cost:19.59, ParentId: '15'},
