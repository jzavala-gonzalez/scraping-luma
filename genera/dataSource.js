const timestamp_saved = '08/02/2023 11:00 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:55:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'41', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'146', Cost:17.18, ParentId: '16'},
		]
	},
