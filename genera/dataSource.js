const timestamp_saved = '10/04/2023 12:05 PM';
const dataFechaAcualizado = '10/4/2023' + ' 8:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'40', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'38', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'162', Cost:17.13, ParentId: '16'},
		]
	},
