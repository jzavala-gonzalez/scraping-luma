const timestamp_saved = '10/23/2023 07:55 PM';
const dataFechaAcualizado = '10/23/2023' + ' 3:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'54', Cost:10.38, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'4', Cost:45.77, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.48, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.51, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'96', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'150', Cost:16.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'85', Cost:11.32, ParentId: '17'},
		]
	},
