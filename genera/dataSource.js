const timestamp_saved = '07/28/2023 03:16 PM';
const dataFechaAcualizado = '7/28/2023' + ' 11:10:33 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 843},
...
const dataLoadPerSite = [
	...
	{Index:'4', Type:'Hidroelectricas', Desc:'Toro Negro', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Hidro 1', MW: 2, MVar:'1', Cost:9.35, ParentId: '4'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 20,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'3', Cost:27.31, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'5', Cost:30.73, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'43', Cost:19.89, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.73, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:0, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'87', Cost:13.48, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 122,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 37, MVar:'8', Cost:17, ParentId: '19'},
		]
	},
