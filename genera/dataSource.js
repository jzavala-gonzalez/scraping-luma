const timestamp_saved = '09/30/2023 03:35 AM';
const dataFechaAcualizado = '9/29/2023' + ' 11:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'36', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'34', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'51', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.97, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'4', Cost:29.96, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'5', Cost:29.99, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 175,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 175, MVar:'134', Cost:19.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'111', Cost:9.11, ParentId: '17'},
		]
	},
