const timestamp_saved = '11/29/2023 01:30 PM';
const dataFechaAcualizado = '11/29/2023' + ' 9:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'44', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'42', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'47', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'80', Cost:9.60, ParentId: '17'},
		]
	},
