const timestamp_saved = '09/30/2023 05:50 PM';
const dataFechaAcualizado = '9/30/2023' + ' 1:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'35', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'33', Cost:10.17, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:10.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:10.12, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'78', Cost:16.53, ParentId: '15'},
