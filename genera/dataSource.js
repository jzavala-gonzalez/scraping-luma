const timestamp_saved = '08/29/2023 07:10 AM';
const dataFechaAcualizado = '8/29/2023' + ' 3:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'47', Cost:11.04, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'1', Cost:26.50, ParentId: '9'},
