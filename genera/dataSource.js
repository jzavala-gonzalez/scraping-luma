const timestamp_saved = '07/29/2023 06:35 PM';
const dataFechaAcualizado = '7/29/2023' + ' 2:30:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'56', Cost:10.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:19.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:19.73, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'11', Cost:30.83, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 279,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 139, MVar:'107', Cost:17.05, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'9', Cost:15.80, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'98', Cost:10.89, ParentId: '17'},
		]
	},
