const timestamp_saved = '10/09/2023 03:25 AM';
const dataFechaAcualizado = '10/8/2023' + ' 11:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'47', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'47', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 98, MVar:'31', Cost:9.56, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:9.56, ParentId: '11'},
		]
	},
