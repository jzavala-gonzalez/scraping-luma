const timestamp_saved = '09/01/2023 03:30 AM';
const dataFechaAcualizado = '8/31/2023' + ' 11:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'41', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'49', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'60', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.13, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'5', Cost:29.64, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:30.89, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'158', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'80', Cost:9.20, ParentId: '17'},
		]
	},
