const timestamp_saved = '09/05/2023 06:05 AM';
const dataFechaAcualizado = '9/5/2023' + ' 2:00:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'38', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'41', Cost:11.51, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'0', Cost:31.75, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'73', Cost:9.15, ParentId: '17'},
		]
	},
