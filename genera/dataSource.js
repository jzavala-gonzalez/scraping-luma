const timestamp_saved = '08/27/2023 10:35 PM';
const dataFechaAcualizado = '8/27/2023' + ' 6:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'41', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'40', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'46', Cost:10.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:6.75, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'13', Cost:30.65, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.23, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'170', Cost:17.81, ParentId: '16'},
		]
	},
