const timestamp_saved = '12/03/2023 08:15 PM';
const dataFechaAcualizado = '12/3/2023' + ' 4:11:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1083},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 188,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 188, MVar:'73', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'43', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'45', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 137, MVar:'39', Cost:17.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'47', Cost:8.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'10', Cost:8.30, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'115', Cost:17.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'66', Cost:11.31, ParentId: '17'},
		]
	},
