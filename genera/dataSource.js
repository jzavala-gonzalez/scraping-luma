const timestamp_saved = '08/01/2023 02:30 PM';
const dataFechaAcualizado = '8/1/2023' + ' 10:25:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'44', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 286,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'111', Cost:16.89, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'33', Cost:15.93, ParentId: '15'},
		]
	},
