const timestamp_saved = '10/25/2023 10:30 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'46', Cost:10.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 98, MVar:'29', Cost:17.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'49', Cost:16.90, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 2, MVar:'1', Cost:11.31, ParentId: '17'},
		]
	},
