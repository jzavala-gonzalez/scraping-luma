const timestamp_saved = '11/01/2023 08:40 AM';
const dataFechaAcualizado = '11/1/2023' + ' 4:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'45', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'49', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'57', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'48', Cost:9.64, ParentId: '17'},
		]
	},
