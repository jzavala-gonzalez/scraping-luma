const timestamp_saved = '11/26/2023 12:35 AM';
const dataFechaAcualizado = '11/25/2023' + ' 8:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 217,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 217, MVar:'71', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'32', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'56', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.11, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'135', Cost:17.37, ParentId: '16'},
		]
	},
