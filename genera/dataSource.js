const timestamp_saved = '08/18/2023 05:20 PM';
const dataFechaAcualizado = '8/18/2023' + ' 1:17:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'67', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'74', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 56, MVar:'8', Cost:31.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'10', Cost:31.70, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'6', Cost:31.28, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 79, MVar:'75', Cost:19.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'83', Cost:9.47, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 38, MVar:'0', Cost:17, ParentId: '19'},
		]
	},
