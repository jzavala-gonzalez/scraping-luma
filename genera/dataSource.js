const timestamp_saved = '10/26/2023 05:55 PM';
const dataFechaAcualizado = '10/26/2023' + ' 1:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'47', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'52', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'53', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:17.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.51, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'42', Cost:17.24, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:17.24, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'146', Cost:17.54, ParentId: '16'},
		]
	},
