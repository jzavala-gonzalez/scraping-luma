const timestamp_saved = '09/16/2023 06:10 PM';
const dataFechaAcualizado = '9/16/2023' + ' 2:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'45', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'44', Cost:10.74, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'79', Cost:19.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'89', Cost:9.49, ParentId: '17'},
		]
	},
