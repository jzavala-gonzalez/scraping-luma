const timestamp_saved = '10/14/2023 12:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 8:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 558,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'72', Cost:9.76, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 39, MVar:'8', Cost:29.91, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'89', Cost:16.98, ParentId: '15'},
