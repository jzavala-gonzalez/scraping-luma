const timestamp_saved = '10/29/2023 11:40 AM';
const dataFechaAcualizado = '10/29/2023' + ' 7:36:18 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1946},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'42', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'44', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'68', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.37, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'17', Cost:21.64, ParentId: '14'},
