const timestamp_saved = '10/01/2023 10:00 PM';
const dataFechaAcualizado = '10/1/2023' + ' 5:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'31', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'29', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'46', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.83, ParentId: '15'},
