const timestamp_saved = '11/10/2023 03:25 PM';
const dataFechaAcualizado = '11/10/2023' + ' 11:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'54', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'59', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'48', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.49, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.75, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'17', Cost:18.58, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'79', Cost:9.51, ParentId: '17'},
		]
	},
