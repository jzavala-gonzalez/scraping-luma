const timestamp_saved = '09/29/2023 04:35 PM';
const dataFechaAcualizado = '9/29/2023' + ' 12:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'42', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'40', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'52', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'0', Cost:18.22, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'94', Cost:17.62, ParentId: '15'},
