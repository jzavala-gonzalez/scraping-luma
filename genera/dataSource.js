const timestamp_saved = '11/15/2023 05:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 1:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'40', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'43', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 248,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 91, MVar:'27', Cost:19.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'6', Cost:19.67, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 10,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 10, MVar:'0', Cost:32.32, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'0', Cost:30.46, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 203, MVar:'71', Cost:10.47, ParentId: '17'},
		]
	},
