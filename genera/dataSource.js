const timestamp_saved = '07/29/2023 12:55 PM';
const dataFechaAcualizado = '7/29/2023' + ' 8:50:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'50', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 55,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'9', Cost:30.59, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 241,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'93', Cost:17.62, ParentId: '15'},
