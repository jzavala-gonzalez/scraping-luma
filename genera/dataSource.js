const timestamp_saved = '10/26/2023 08:12 PM';
const dataFechaAcualizado = '10/26/2023' + ' 4:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'51', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'54', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 167, MVar:'53', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'24', Cost:33.15, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:17.36, ParentId: '11'},
