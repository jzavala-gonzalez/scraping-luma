const timestamp_saved = '09/29/2023 12:35 PM';
const dataFechaAcualizado = '9/29/2023' + ' 8:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'38', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'34', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'50', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:8.66, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'0', Cost:17.09, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'0', Cost:17.09, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'11', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'84', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'127', Cost:17.84, ParentId: '16'},
		]
	},
