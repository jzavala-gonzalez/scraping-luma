const timestamp_saved = '08/10/2023 05:40 PM';
const dataFechaAcualizado = '8/10/2023' + ' 1:35:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'65', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'96', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'57', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'58', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:32.09, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'175', Cost:17.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'132', Cost:11.37, ParentId: '17'},
		]
	},
