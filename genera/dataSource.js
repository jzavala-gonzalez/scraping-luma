const timestamp_saved = '10/16/2023 06:40 PM';
const dataFechaAcualizado = '10/16/2023' + ' 2:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'66', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'65', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'63', Cost:10.87, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:49.59, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'28', Cost:31.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:17.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.50, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 151, MVar:'45', Cost:8.20, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'97', Cost:16.68, ParentId: '15'},
