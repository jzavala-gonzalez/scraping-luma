const timestamp_saved = '10/12/2023 10:01 AM';
const dataFechaAcualizado = '10/12/2023' + ' 5:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'55', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'59', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'65', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:19.27, ParentId: '14'},
