const timestamp_saved = '08/01/2023 04:40 PM';
const dataFechaAcualizado = '8/1/2023' + ' 12:35:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'49', Cost:10.48, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'36', Cost:15.67, ParentId: '15'},
		]
	},
