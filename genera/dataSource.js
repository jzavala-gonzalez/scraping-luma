const timestamp_saved = '12/02/2023 12:10 PM';
const dataFechaAcualizado = '12/2/2023' + ' 8:06:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1896},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1876},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'42', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'43', Cost:12.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'63', Cost:9.75, ParentId: '17'},
		]
	},
