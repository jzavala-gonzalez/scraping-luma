const timestamp_saved = '11/25/2023 06:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 2:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'33', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'41', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'52', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 138,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.52, ParentId: '14'},
