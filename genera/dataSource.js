const timestamp_saved = '08/19/2023 05:20 PM';
const dataFechaAcualizado = '8/19/2023' + ' 1:17:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'52', Cost:10.57, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'64', Cost:9.41, ParentId: '17'},
		]
	},
