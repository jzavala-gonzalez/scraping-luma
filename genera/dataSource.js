const timestamp_saved = '10/31/2023 07:50 PM';
const dataFechaAcualizado = '10/31/2023' + ' 3:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'61', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'67', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'69', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'0', Cost:46.93, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'26', Cost:0, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:17.06, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'38', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'111', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'181', Cost:16.70, ParentId: '16'},
		]
	},
