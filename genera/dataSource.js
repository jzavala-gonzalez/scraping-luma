const timestamp_saved = '09/07/2023 09:45 AM';
const dataFechaAcualizado = '9/7/2023' + ' 5:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'42', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'45', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'93', Cost:9.76, ParentId: '17'},
		]
	},
