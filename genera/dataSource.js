const timestamp_saved = '10/25/2023 10:35 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'47', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'47', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'50', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 93, MVar:'29', Cost:18.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:18.73, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 164, MVar:'49', Cost:16.90, ParentId: '11'},
