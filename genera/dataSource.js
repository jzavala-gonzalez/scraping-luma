const timestamp_saved = '08/12/2023 07:20 PM';
const dataFechaAcualizado = '8/12/2023' + ' 3:17:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'41', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'42', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'43', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 34,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'4', Cost:43.67, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.39, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'142', Cost:17.91, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'104', Cost:11.95, ParentId: '17'},
		]
	},
