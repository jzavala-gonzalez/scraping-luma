const timestamp_saved = '11/12/2023 01:30 AM';
const dataFechaAcualizado = '11/11/2023' + ' 9:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'54', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'56', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'59', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'78', Cost:16.97, ParentId: '15'},
