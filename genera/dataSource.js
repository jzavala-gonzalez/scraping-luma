const timestamp_saved = '08/16/2023 08:25 AM';
const dataFechaAcualizado = '8/16/2023' + ' 4:22:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'48', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'79', Cost:10.47, ParentId: '17'},
		]
	},
