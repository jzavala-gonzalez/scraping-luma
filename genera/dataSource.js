const timestamp_saved = '11/15/2023 01:55 AM';
const dataFechaAcualizado = '11/14/2023' + ' 9:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'49', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'58', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'60', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 3, MVar:'1', Cost:52.80, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'21', Cost:27.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 47, MVar:'12', Cost:36.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:36.61, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:28.72, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'12', Cost:22.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'76', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 302,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 302, MVar:'160', Cost:17.09, ParentId: '16'},
		]
	},
