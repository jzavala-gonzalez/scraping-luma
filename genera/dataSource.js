const timestamp_saved = '12/06/2023 05:50 AM';
const dataFechaAcualizado = '12/6/2023' + ' 1:45:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 1073},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'42', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'46', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'55', Cost:14.51, ParentId: '17'},
		]
	},
