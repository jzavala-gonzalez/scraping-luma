const timestamp_saved = '11/22/2023 03:20 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'30', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'40', Cost:12.11, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 107,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 107, MVar:'75', Cost:17.27, ParentId: '15'},
