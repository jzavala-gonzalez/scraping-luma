const timestamp_saved = '11/15/2023 08:55 AM';
const dataFechaAcualizado = '11/15/2023' + ' 4:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'34', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'37', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'45', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'104', Cost:18.28, ParentId: '16'},
		]
	},
