const timestamp_saved = '08/11/2023 07:45 AM';
const dataFechaAcualizado = '8/11/2023' + ' 3:40:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'20', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'53', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'47', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 110,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 55, MVar:'5', Cost:31.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 55, MVar:'7', Cost:31.25, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.50, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 221,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 221, MVar:'83', Cost:12.36, ParentId: '17'},
		]
	},
