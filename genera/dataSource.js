const timestamp_saved = '09/28/2023 11:15 AM';
const dataFechaAcualizado = '9/28/2023' + ' 7:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'20', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'20', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'44', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.72, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'117', Cost:18.44, ParentId: '16'},
		]
	},
