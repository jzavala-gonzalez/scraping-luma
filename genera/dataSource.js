const timestamp_saved = '09/06/2023 06:30 PM';
const dataFechaAcualizado = '9/6/2023' + ' 2:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'59', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'37', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'160', Cost:17.66, ParentId: '16'},
		]
	},
