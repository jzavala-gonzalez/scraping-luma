const timestamp_saved = '10/25/2023 03:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 11:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'50', Cost:10.82, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'152', Cost:17.63, ParentId: '16'},
		]
	},
