const timestamp_saved = '11/27/2023 10:30 AM';
const dataFechaAcualizado = '11/27/2023' + ' 6:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'26', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'35', Cost:11.07, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'50', Cost:17.61, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'73', Cost:9.79, ParentId: '17'},
		]
	},
