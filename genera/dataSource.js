const timestamp_saved = '07/28/2023 05:07 AM';
const dataFechaAcualizado = '7/28/2023' + ' 1:00:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'45', Cost:11.11, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'1', Cost:22.33, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 82,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'2', Cost:31.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'8', Cost:30.81, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:20.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.26, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:10.75, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:10.75, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'31', Cost:15.42, ParentId: '15'},
		]
	},
