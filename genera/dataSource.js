const timestamp_saved = '08/03/2023 07:05 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:00:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'39', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:20.20, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 235,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'34', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 105, MVar:'38', Cost:16.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'79', Cost:11.29, ParentId: '17'},
		]
	},
