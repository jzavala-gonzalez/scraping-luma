const timestamp_saved = '10/10/2023 05:00 PM';
const dataFechaAcualizado = '10/10/2023' + ' 12:56:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 222,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 222, MVar:'81', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'65', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'68', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'70', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'47', Cost:17.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.53, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'160', Cost:18.03, ParentId: '16'},
		]
	},
