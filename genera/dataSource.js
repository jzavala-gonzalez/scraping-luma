const timestamp_saved = '09/12/2023 09:45 AM';
const dataFechaAcualizado = '9/12/2023' + ' 5:40:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'48', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'45', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.65, ParentId: '13'},
