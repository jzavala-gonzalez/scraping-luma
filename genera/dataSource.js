const timestamp_saved = '10/29/2023 11:45 AM';
const dataFechaAcualizado = '10/29/2023' + ' 7:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'43', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'45', Cost:11.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.26, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'112', Cost:17.37, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 19,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 13, MVar:'5', Cost:19.60, ParentId: '19'},
