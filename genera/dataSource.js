const timestamp_saved = '10/20/2023 03:20 AM';
const dataFechaAcualizado = '10/19/2023' + ' 11:16:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'44', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'67', Cost:11.42, ParentId: '7'},
		]
	},
