const timestamp_saved = '10/27/2023 10:55 PM';
const dataFechaAcualizado = '10/27/2023' + ' 6:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:11.01, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:17.35, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'7', Cost:30.64, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:30.59, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 33, MVar:'5', Cost:28.16, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 50, MVar:'8', Cost:22.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'84', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'131', Cost:17.66, ParentId: '16'},
		]
	},
