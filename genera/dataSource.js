const timestamp_saved = '09/09/2023 12:40 PM';
const dataFechaAcualizado = '9/9/2023' + ' 8:35:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'53', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'58', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'53', Cost:10.52, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 14, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'88', Cost:16.69, ParentId: '15'},
