const timestamp_saved = '09/30/2023 06:50 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'37', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'35', Cost:10.10, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'7', Cost:86.43, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.06, ParentId: '14'},
