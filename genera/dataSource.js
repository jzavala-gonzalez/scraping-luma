const timestamp_saved = '10/20/2023 06:30 PM';
const dataFechaAcualizado = '10/20/2023' + ' 2:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'49', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'55', Cost:10.24, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:40.50, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'115', Cost:10.56, ParentId: '17'},
		]
	},
