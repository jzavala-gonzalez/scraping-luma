const timestamp_saved = '10/24/2023 10:20 AM';
const dataFechaAcualizado = '10/24/2023' + ' 6:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'47', Cost:10.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'48', Cost:10.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'50', Cost:10.00, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.84, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'135', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'71', Cost:11.18, ParentId: '17'},
		]
	},
