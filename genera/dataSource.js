const timestamp_saved = '09/06/2023 04:10 AM';
const dataFechaAcualizado = '9/6/2023' + ' 12:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'50', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'52', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'61', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:25.84, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:26.39, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:20.44, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'0', Cost:8.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'10', Cost:8.11, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.39, ParentId: '12'},
