const timestamp_saved = '12/04/2023 08:40 PM';
const dataFechaAcualizado = '12/4/2023' + ' 4:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'60', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'64', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'61', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'144', Cost:17.22, ParentId: '16'},
		]
	},
