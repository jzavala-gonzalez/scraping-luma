const timestamp_saved = '11/06/2023 08:25 AM';
const dataFechaAcualizado = '11/6/2023' + ' 4:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'40', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'39', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'39', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'46', Cost:9.82, ParentId: '17'},
		]
	},
