const timestamp_saved = '09/30/2023 08:55 AM';
const dataFechaAcualizado = '9/30/2023' + ' 4:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'34', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'32', Cost:10.57, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 202,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:8.60, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'99', Cost:9.53, ParentId: '17'},
		]
	},
