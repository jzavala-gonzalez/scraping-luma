const timestamp_saved = '12/02/2023 09:05 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'39', Cost:13.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'40', Cost:13.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'47', Cost:13.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'52', Cost:9.82, ParentId: '17'},
		]
	},
