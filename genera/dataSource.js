const timestamp_saved = '08/10/2023 12:30 AM';
const dataFechaAcualizado = '8/9/2023' + ' 8:25:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'55', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'60', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'62', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:27.13, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'3', Cost:22.32, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'94', Cost:11.35, ParentId: '17'},
		]
	},
