const timestamp_saved = '08/20/2023 08:35 PM';
const dataFechaAcualizado = '8/20/2023' + ' 4:32:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'54', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'47', Cost:10.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:8.27, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'79', Cost:17.17, ParentId: '15'},
