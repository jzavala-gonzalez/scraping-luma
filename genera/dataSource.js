const timestamp_saved = '10/28/2023 08:10 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'37', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'39', Cost:11.34, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 66, MVar:'20', Cost:29.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 50, MVar:'15', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'15', Cost:19.00, ParentId: '14'},
