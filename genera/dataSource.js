const timestamp_saved = '08/16/2023 06:10 PM';
const dataFechaAcualizado = '8/16/2023' + ' 2:07:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'64', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'91', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'60', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'56', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'62', Cost:10.87, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 109,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 109, MVar:'0', Cost:6.73, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 114,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 65, MVar:'16', Cost:29.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'15', Cost:31.26, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'194', Cost:17.23, ParentId: '16'},
		]
	},
