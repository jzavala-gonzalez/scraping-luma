const timestamp_saved = '10/21/2023 04:25 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'37', Cost:13.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'35', Cost:13.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'39', Cost:13.53, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'79', Cost:16.85, ParentId: '15'},
