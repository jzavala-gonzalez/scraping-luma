const timestamp_saved = '11/26/2023 07:55 PM';
const dataFechaAcualizado = '11/26/2023' + ' 3:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'30', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'52', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'83', Cost:9.76, ParentId: '17'},
		]
	},
