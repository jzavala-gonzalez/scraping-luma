const timestamp_saved = '08/24/2023 06:25 PM';
const dataFechaAcualizado = '8/24/2023' + ' 2:20:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'60', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'58', Cost:10.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 56,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 56, MVar:'0', Cost:3.51, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 140, MVar:'42', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'32', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'192', Cost:17.17, ParentId: '16'},
		]
	},
