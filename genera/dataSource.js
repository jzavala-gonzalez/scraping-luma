const timestamp_saved = '08/19/2023 07:30 PM';
const dataFechaAcualizado = '8/19/2023' + ' 3:27:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'57', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'58', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'98', Cost:17.34, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'150', Cost:17.46, ParentId: '16'},
		]
	},
