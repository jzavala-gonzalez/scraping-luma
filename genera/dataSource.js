const timestamp_saved = '08/10/2023 02:30 PM';
const dataFechaAcualizado = '8/10/2023' + ' 10:25:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'95', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'60', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'59', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'4', Cost:103.12, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.36, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'89', Cost:11.55, ParentId: '17'},
		]
	},
