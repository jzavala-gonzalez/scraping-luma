const timestamp_saved = '09/26/2023 03:45 PM';
const dataFechaAcualizado = '9/26/2023' + ' 11:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'46', Cost:12.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'47', Cost:12.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'56', Cost:12.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 238, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.71, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.71, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'167', Cost:18.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'80', Cost:9.25, ParentId: '17'},
		]
	},
