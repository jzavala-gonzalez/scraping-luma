const timestamp_saved = '11/11/2023 10:50 AM';
const dataFechaAcualizado = '11/11/2023' + ' 6:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'43', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'46', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'81', Cost:9.36, ParentId: '17'},
		]
	},
