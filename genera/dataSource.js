const timestamp_saved = '11/01/2023 03:20 PM';
const dataFechaAcualizado = '11/1/2023' + ' 11:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'58', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'62', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'11', Cost:17.24, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'77', Cost:9.38, ParentId: '17'},
		]
	},
