const timestamp_saved = '10/21/2023 03:40 PM';
const dataFechaAcualizado = '10/21/2023' + ' 11:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'36', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'141', Cost:17.82, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 17, MVar:'2', Cost:21.43, ParentId: '19'},
