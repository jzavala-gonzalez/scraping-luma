const timestamp_saved = '11/20/2023 08:15 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'27', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'37', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'53', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'88', Cost:9.17, ParentId: '17'},
		]
	},
