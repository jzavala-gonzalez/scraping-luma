const timestamp_saved = '10/03/2023 12:20 PM';
const dataFechaAcualizado = '10/3/2023' + ' 8:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'42', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'40', Cost:10.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:25.61, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'111', Cost:9.19, ParentId: '17'},
		]
	},
