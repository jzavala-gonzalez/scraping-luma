const timestamp_saved = '09/23/2023 09:05 AM';
const dataFechaAcualizado = '9/23/2023' + ' 5:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'68', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'38', Cost:12.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'38', Cost:12.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'54', Cost:12.71, ParentId: '7'},
		]
	},
