const timestamp_saved = '10/23/2023 02:40 PM';
const dataFechaAcualizado = '10/23/2023' + ' 10:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'53', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'54', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'50', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'34', Cost:18.91, ParentId: '14'},
