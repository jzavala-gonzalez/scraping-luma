const timestamp_saved = '11/06/2023 05:05 PM';
const dataFechaAcualizado = '11/6/2023' + ' 1:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'160', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'109', Cost:9.43, ParentId: '17'},
		]
	},
