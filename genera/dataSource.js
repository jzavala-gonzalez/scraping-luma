const timestamp_saved = '10/28/2023 03:15 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'40', Cost:12.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'41', Cost:12.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'46', Cost:12.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 49, MVar:'15', Cost:34.53, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:34.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 72, MVar:'92', Cost:21.23, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'124', Cost:17.24, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 90,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 37, MVar:'3', Cost:17, ParentId: '19'},
		]
	},
