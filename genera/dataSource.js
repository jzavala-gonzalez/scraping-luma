const timestamp_saved = '10/31/2023 05:15 PM';
const dataFechaAcualizado = '10/31/2023' + ' 1:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'64', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'67', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'71', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'90', Cost:9.34, ParentId: '17'},
		]
	},
