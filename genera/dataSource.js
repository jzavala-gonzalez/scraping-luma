const timestamp_saved = '09/06/2023 04:55 AM';
const dataFechaAcualizado = '9/6/2023' + ' 12:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'49', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'50', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'60', Cost:11.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 108, MVar:'0', Cost:7.34, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 17,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 17, MVar:'6', Cost:27.15, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:20.36, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 94, MVar:'0', Cost:18.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:18.99, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:30.59, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'96', Cost:16.86, ParentId: '15'},
