const timestamp_saved = '08/27/2023 11:15 AM';
const dataFechaAcualizado = '8/27/2023' + ' 7:10:50 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1979},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 264,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'22', Cost:14.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 96, MVar:'53', Cost:14.15, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 57,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 57, MVar:'2', Cost:29.86, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'17', Cost:18.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 123, MVar:'85', Cost:18.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'104', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'71', Cost:16.59, ParentId: '17'},
		]
	},
