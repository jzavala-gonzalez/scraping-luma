const timestamp_saved = '09/07/2023 12:40 PM';
const dataFechaAcualizado = '9/7/2023' + ' 8:35:51 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 837},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'53', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'43', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'88', Cost:16.82, ParentId: '15'},
