const timestamp_saved = '12/04/2023 08:55 AM';
const dataFechaAcualizado = '12/4/2023' + ' 4:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'37', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'38', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'44', Cost:12.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.59, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'44', Cost:11.62, ParentId: '17'},
		]
	},
