const timestamp_saved = '08/14/2023 08:50 PM';
const dataFechaAcualizado = '8/14/2023' + ' 4:47:53 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2740},
	{Index:'7', Desc:'Máxima para Hoy', value: 2774},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'101', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'50', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'47', Cost:10.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 135,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:52.71, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 143,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:22.34, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'16', Cost:31.30, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:28.47, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:31.29, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'28', Cost:18.81, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'167', Cost:16.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'130', Cost:11.64, ParentId: '17'},
		]
	},
	...
	{Index:'22', Type:'Turbina de Gas', Desc:'Aguirre', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'GT2', MW: 0, MVar:'11', Cost:0, ParentId: '22'},
		]
	},
