const timestamp_saved = '10/23/2023 09:10 AM';
const dataFechaAcualizado = '10/23/2023' + ' 5:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'36', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'37', Cost:12.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'40', Cost:12.06, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'64', Cost:16.83, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'48', Cost:11.30, ParentId: '17'},
		]
	},
