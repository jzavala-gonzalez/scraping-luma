const timestamp_saved = '09/23/2023 11:05 PM';
const dataFechaAcualizado = '9/23/2023' + ' 7:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'54', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'55', Cost:10.24, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'11', Cost:28.80, ParentId: '13'},
