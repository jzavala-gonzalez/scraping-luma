const timestamp_saved = '11/24/2023 12:15 AM';
const dataFechaAcualizado = '11/23/2023' + ' 8:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'33', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'44', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'97', Cost:9.19, ParentId: '17'},
		]
	},
