const timestamp_saved = '10/14/2023 09:50 AM';
const dataFechaAcualizado = '10/14/2023' + ' 5:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'48', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'47', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'47', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 6, MVar:'2', Cost:28.76, ParentId: '12'},
