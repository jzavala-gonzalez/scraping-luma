const timestamp_saved = '10/08/2023 03:40 PM';
const dataFechaAcualizado = '10/8/2023' + ' 11:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'43', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'42', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'41', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'76', Cost:11.45, ParentId: '17'},
		]
	},
