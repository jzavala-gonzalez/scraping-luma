const timestamp_saved = '11/04/2023 03:40 PM';
const dataFechaAcualizado = '11/4/2023' + ' 11:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'44', Cost:12.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'45', Cost:12.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'43', Cost:12.65, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'92', Cost:16.66, ParentId: '15'},
