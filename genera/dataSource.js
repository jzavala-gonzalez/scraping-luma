const timestamp_saved = '08/05/2023 11:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 7:20:39 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2851},
	{Index:'1', Desc:'PREPA', value: 59},
	{Index:'2', Desc:'COGEN', value: 41},
	{Index:'3', Desc:'Reserva en Rotación', value: 53},
	{Index:'4', Desc:'Reserva Operacional', value: 75},
	{Index:'5', Desc:'Capacidad Disponible', value: 2910},
	{Index:'6', Desc:'Próxima Hora MW', value: 2852},
...
const dataLoadPerSite = [
	...
	{Index:'5', Type:'Hidroelectricas', Desc:'Yauco', SiteTotal: 4,
		units:[
			...
			{Index:'2', Unit:'Hidro 3', MW: 4, MVar:'1', Cost:9.35, ParentId: '5'},
		]
	},
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'84', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'106', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 548,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'55', Cost:9.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'53', Cost:9.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 203, MVar:'54', Cost:9.80, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 190,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:30.85, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.32, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 20, MVar:'0', Cost:47.41, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 149, MVar:'35', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'2', Cost:22.07, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.91, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'8', Cost:22.49, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:22.18, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'24', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'25', Cost:28.16, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:20.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:20.00, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:31.34, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:31.18, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'2', Unit:'Gas 3', MW: 35, MVar:'0', Cost:31.46, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.82, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'30', Cost:18.61, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'112', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'31', Cost:15.53, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'114', Cost:11.55, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 0,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 0, MVar:'5', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 65,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:23.08, ParentId: '21'},
