const timestamp_saved = '10/12/2023 12:40 PM';
const dataFechaAcualizado = '10/12/2023' + ' 8:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'66', Cost:10.16, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'93', Cost:16.47, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'87', Cost:9.22, ParentId: '17'},
		]
	},
