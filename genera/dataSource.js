const timestamp_saved = '10/21/2023 08:15 AM';
const dataFechaAcualizado = '10/21/2023' + ' 4:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'20', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'19', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'58', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'129', Cost:17.78, ParentId: '16'},
		]
	},
