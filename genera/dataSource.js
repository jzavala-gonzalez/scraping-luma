const timestamp_saved = '12/04/2023 09:25 AM';
const dataFechaAcualizado = '12/4/2023' + ' 5:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'41', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'42', Cost:11.17, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'105', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'51', Cost:11.62, ParentId: '17'},
		]
	},
