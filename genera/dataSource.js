const timestamp_saved = '11/25/2023 02:45 PM';
const dataFechaAcualizado = '11/25/2023' + ' 10:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 161, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'20', Cost:13.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'29', Cost:13.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'47', Cost:13.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:18.04, ParentId: '11'},
