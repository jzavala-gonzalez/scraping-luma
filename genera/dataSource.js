const timestamp_saved = '12/05/2023 11:15 AM';
const dataFechaAcualizado = '12/5/2023' + ' 7:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'49', Cost:10.59, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:8.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'40', Cost:8.21, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'63', Cost:11.19, ParentId: '17'},
		]
	},
