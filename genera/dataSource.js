const timestamp_saved = '11/22/2023 01:25 AM';
const dataFechaAcualizado = '11/21/2023' + ' 9:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'42', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'50', Cost:10.56, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'47', Cost:17.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.15, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'116', Cost:9.09, ParentId: '17'},
		]
	},
