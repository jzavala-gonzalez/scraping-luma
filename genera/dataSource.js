const timestamp_saved = '08/18/2023 03:20 AM';
const dataFechaAcualizado = '8/17/2023' + ' 11:17:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'48', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'59', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'70', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 8, MVar:'1', Cost:26.55, ParentId: '9'},
