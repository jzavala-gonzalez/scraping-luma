const timestamp_saved = '08/12/2023 10:45 AM';
const dataFechaAcualizado = '8/12/2023' + ' 6:42:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'89', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'44', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'44', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'151', Cost:16.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'92', Cost:11.74, ParentId: '17'},
		]
	},
