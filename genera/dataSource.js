const timestamp_saved = '10/22/2023 04:55 AM';
const dataFechaAcualizado = '10/22/2023' + ' 12:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'43', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.21, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'137', Cost:17.33, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'65', Cost:11.14, ParentId: '17'},
		]
	},
