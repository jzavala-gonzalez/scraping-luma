const timestamp_saved = '09/15/2023 03:30 AM';
const dataFechaAcualizado = '9/14/2023' + ' 11:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'50', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'64', Cost:11.61, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 71, MVar:'0', Cost:6.94, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'10', Cost:28.03, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'11', Cost:28.10, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'24', Cost:18.67, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'148', Cost:16.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'105', Cost:9.10, ParentId: '17'},
		]
	},
