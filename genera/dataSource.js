const timestamp_saved = '11/10/2023 07:10 PM';
const dataFechaAcualizado = '11/10/2023' + ' 3:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'42', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'36', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'56', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:30.99, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'12', Cost:22.04, ParentId: '14'},
