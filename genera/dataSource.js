const timestamp_saved = '10/28/2023 02:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'38', Cost:13.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'42', Cost:13.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'47', Cost:13.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'13', Cost:34.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:34.46, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:29.79, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 59, MVar:'77', Cost:22.19, ParentId: '15'},
