const timestamp_saved = '10/23/2023 08:35 AM';
const dataFechaAcualizado = '10/23/2023' + ' 4:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'35', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'38', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'62', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'45', Cost:11.29, ParentId: '17'},
		]
	},
