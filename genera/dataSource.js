const timestamp_saved = '10/11/2023 04:20 AM';
const dataFechaAcualizado = '10/11/2023' + ' 12:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'56', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'60', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'64', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 9,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 9, MVar:'1', Cost:26.24, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.77, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.59, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'74', Cost:9.41, ParentId: '17'},
		]
	},
