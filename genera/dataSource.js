const timestamp_saved = '10/21/2023 06:50 AM';
const dataFechaAcualizado = '10/21/2023' + ' 2:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'22', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'21', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'59', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'73', Cost:11.03, ParentId: '17'},
		]
	},
