const timestamp_saved = '12/04/2023 01:40 AM';
const dataFechaAcualizado = '12/3/2023' + ' 9:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'52', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'56', Cost:10.75, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'136', Cost:17.84, ParentId: '16'},
		]
	},
