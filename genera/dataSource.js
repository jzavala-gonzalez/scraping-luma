const timestamp_saved = '08/19/2023 02:00 PM';
const dataFechaAcualizado = '8/19/2023' + ' 9:57:57 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 975},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'50', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'53', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'102', Cost:17.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'66', Cost:9.19, ParentId: '17'},
		]
	},
