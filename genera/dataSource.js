const timestamp_saved = '08/02/2023 08:10 AM';
const dataFechaAcualizado = '8/2/2023' + ' 4:05:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'39', Cost:11.24, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'82', Cost:11.01, ParentId: '17'},
		]
	},
