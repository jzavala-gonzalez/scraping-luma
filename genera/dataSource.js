const timestamp_saved = '09/21/2023 03:35 AM';
const dataFechaAcualizado = '9/20/2023' + ' 11:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'43', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'45', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'63', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'8', Cost:28.19, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'9', Cost:28.14, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'1', Cost:26.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.84, ParentId: '15'},
