const timestamp_saved = '11/21/2023 06:30 AM';
const dataFechaAcualizado = '11/21/2023' + ' 2:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'21', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'30', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'47', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'75', Cost:9.18, ParentId: '17'},
		]
	},
