const timestamp_saved = '10/26/2023 07:35 AM';
const dataFechaAcualizado = '10/26/2023' + ' 3:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'35', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'35', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'43', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'44', Cost:18.45, ParentId: '15'},
