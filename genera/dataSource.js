const timestamp_saved = '11/08/2023 02:25 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'52', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'49', Cost:10.90, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 11,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 11, MVar:'6', Cost:43.00, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'98', Cost:9.61, ParentId: '17'},
		]
	},
