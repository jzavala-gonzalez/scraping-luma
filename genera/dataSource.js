const timestamp_saved = '08/24/2023 09:55 AM';
const dataFechaAcualizado = '8/24/2023' + ' 5:50:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'57', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'53', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 110, MVar:'0', Cost:0, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'10', Cost:0, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'29', Cost:18.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'86', Cost:17.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'138', Cost:17.73, ParentId: '16'},
		]
	},
