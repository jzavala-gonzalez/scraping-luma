const timestamp_saved = '10/28/2023 10:30 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'17', Cost:29.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.77, ParentId: '11'},
