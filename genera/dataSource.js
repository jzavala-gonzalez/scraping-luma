const timestamp_saved = '11/03/2023 12:55 AM';
const dataFechaAcualizado = '11/2/2023' + ' 8:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'62', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'60', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'63', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:16.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:16.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 117, MVar:'37', Cost:35.25, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 0, MVar:'0', Cost:35.25, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:31.17, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'96', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 263,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 263, MVar:'178', Cost:17.60, ParentId: '16'},
		]
	},
