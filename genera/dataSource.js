const timestamp_saved = '11/26/2023 05:05 PM';
const dataFechaAcualizado = '11/26/2023' + ' 1:01:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1868},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'38', Cost:12.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:12.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'71', Cost:10.41, ParentId: '17'},
		]
	},
