const timestamp_saved = '11/28/2023 04:10 PM';
const dataFechaAcualizado = '11/28/2023' + ' 12:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'46', Cost:11.22, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'99', Cost:9.85, ParentId: '17'},
		]
	},
