const timestamp_saved = '11/14/2023 10:20 AM';
const dataFechaAcualizado = '11/14/2023' + ' 6:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 508,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'59', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'62', Cost:10.07, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 43, MVar:'6', Cost:29.13, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 44, MVar:'0', Cost:29.10, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'6', Cost:29.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'39', Cost:18.74, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'115', Cost:11.16, ParentId: '17'},
		]
	},
