const timestamp_saved = '11/02/2023 01:20 AM';
const dataFechaAcualizado = '11/1/2023' + ' 9:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'72', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'74', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'69', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.61, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:16.70, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'36', Cost:18.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:18.31, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'178', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'99', Cost:9.15, ParentId: '17'},
		]
	},
