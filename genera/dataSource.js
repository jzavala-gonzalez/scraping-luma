const timestamp_saved = '08/11/2023 03:15 PM';
const dataFechaAcualizado = '8/11/2023' + ' 11:10:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'43', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'46', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'44', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.46, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'128', Cost:11.71, ParentId: '17'},
		]
	},
