const timestamp_saved = '09/21/2023 07:45 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'39', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'44', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'62', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'8', Cost:26.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'66', Cost:17.52, ParentId: '15'},
