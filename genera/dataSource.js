const timestamp_saved = '10/01/2023 05:05 AM';
const dataFechaAcualizado = '10/1/2023' + ' 1:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 502,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'31', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'30', Cost:13.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'48', Cost:13.20, ParentId: '7'},
		]
	},
