const timestamp_saved = '11/25/2023 01:35 PM';
const dataFechaAcualizado = '11/25/2023' + ' 9:31:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1862},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 157,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 157, MVar:'64', Cost:4.46, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.46, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'23', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'31', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'47', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.74, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.86, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.02, ParentId: '14'},
