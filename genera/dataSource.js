const timestamp_saved = '09/27/2023 08:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 4:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'55', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'61', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'25', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'25', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'58', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'73', Cost:9.11, ParentId: '17'},
		]
	},
