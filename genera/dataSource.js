const timestamp_saved = '09/30/2023 07:40 PM';
const dataFechaAcualizado = '9/30/2023' + ' 3:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'38', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'35', Cost:10.27, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'78', Cost:16.92, ParentId: '15'},
