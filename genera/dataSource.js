const timestamp_saved = '09/28/2023 04:25 AM';
const dataFechaAcualizado = '9/28/2023' + ' 12:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'28', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'28', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 94, MVar:'26', Cost:10.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'7', Cost:19.47, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'50', Cost:16.83, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'84', Cost:9.59, ParentId: '17'},
		]
	},
