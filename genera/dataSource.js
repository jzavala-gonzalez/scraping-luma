const timestamp_saved = '07/28/2023 06:25 PM';
const dataFechaAcualizado = '7/28/2023' + ' 2:20:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'58', Cost:10.16, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'96', Cost:13.51, ParentId: '17'},
		]
	},
