const timestamp_saved = '09/19/2023 08:45 PM';
const dataFechaAcualizado = '9/19/2023' + ' 4:40:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 391},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 172, MVar:'73', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'82', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'51', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'55', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'67', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'1', Cost:22.14, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.83, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'9', Cost:22.47, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:30.97, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'4', Cost:29.29, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'86', Cost:16.86, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'90', Cost:9.14, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 21, MVar:'5', Cost:19.60, ParentId: '19'},
