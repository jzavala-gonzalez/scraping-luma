const timestamp_saved = '10/27/2023 12:05 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'48', Cost:11.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'48', Cost:11.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'51', Cost:11.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:17.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'47', Cost:17.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'8', Cost:17.17, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 113, MVar:'108', Cost:17.93, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 31,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 13, MVar:'19', Cost:19.60, ParentId: '19'},
