const timestamp_saved = '11/23/2023 08:00 AM';
const dataFechaAcualizado = '11/23/2023' + ' 3:56:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1842},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 211,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 211, MVar:'62', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'16', Cost:13.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'27', Cost:13.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'45', Cost:13.52, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 222,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 222, MVar:'108', Cost:18.47, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'63', Cost:9.23, ParentId: '17'},
		]
	},
