const timestamp_saved = '11/26/2023 03:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 11:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 212,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 212, MVar:'64', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'24', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'34', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.79, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'123', Cost:19.69, ParentId: '16'},
		]
	},
