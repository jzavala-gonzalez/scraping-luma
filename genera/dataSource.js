const timestamp_saved = '08/13/2023 08:05 AM';
const dataFechaAcualizado = '8/13/2023' + ' 4:02:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'41', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'42', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 331, MVar:'151', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'114', Cost:12.26, ParentId: '17'},
		]
	},
