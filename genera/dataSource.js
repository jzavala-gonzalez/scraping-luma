const timestamp_saved = '09/13/2023 10:15 AM';
const dataFechaAcualizado = '9/13/2023' + ' 6:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'48', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'63', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.45, ParentId: '14'},
