const timestamp_saved = '09/29/2023 02:15 PM';
const dataFechaAcualizado = '9/29/2023' + ' 10:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'39', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'35', Cost:11.05, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'16', Cost:28.13, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'124', Cost:17.78, ParentId: '16'},
		]
	},
