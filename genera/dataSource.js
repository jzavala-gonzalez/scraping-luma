const timestamp_saved = '10/30/2023 11:25 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'66', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'68', Cost:10.38, ParentId: '7'},
		]
	},
