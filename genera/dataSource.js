const timestamp_saved = '10/21/2023 04:10 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'37', Cost:12.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'35', Cost:12.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'39', Cost:12.99, ParentId: '7'},
		]
	},
