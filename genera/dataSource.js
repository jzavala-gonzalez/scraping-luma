const timestamp_saved = '11/23/2023 08:20 PM';
const dataFechaAcualizado = '11/23/2023' + ' 4:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'26', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'36', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'57', Cost:9.88, ParentId: '17'},
		]
	},
