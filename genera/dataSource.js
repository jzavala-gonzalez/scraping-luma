const timestamp_saved = '11/16/2023 07:20 AM';
const dataFechaAcualizado = '11/16/2023' + ' 3:16:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1939},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'40', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'41', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'47', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:31.62, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'54', Cost:10.87, ParentId: '17'},
		]
	},
