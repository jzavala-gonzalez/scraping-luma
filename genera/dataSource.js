const timestamp_saved = '10/28/2023 07:50 PM';
const dataFechaAcualizado = '10/28/2023' + ' 3:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'51', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'52', Cost:11.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'25', Cost:26.48, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'7', Cost:29.88, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:29.97, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'18', Cost:21.77, ParentId: '14'},
