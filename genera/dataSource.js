const timestamp_saved = '10/26/2023 08:15 PM';
const dataFechaAcualizado = '10/26/2023' + ' 4:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'51', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'54', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 169, MVar:'53', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 285, MVar:'141', Cost:17.41, ParentId: '16'},
		]
	},
