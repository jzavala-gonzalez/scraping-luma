const timestamp_saved = '11/30/2023 12:00 PM';
const dataFechaAcualizado = '11/30/2023' + ' 7:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'51', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.37, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'69', Cost:9.56, ParentId: '17'},
		]
	},
