const timestamp_saved = '11/13/2023 07:05 AM';
const dataFechaAcualizado = '11/13/2023' + ' 3:01:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2446},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 214,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 86, MVar:'37', Cost:16.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 85, MVar:'41', Cost:16.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 44, MVar:'48', Cost:16.89, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:31.91, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:30.79, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'58', Cost:16.91, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'80', Cost:9.15, ParentId: '17'},
		]
	},
