const timestamp_saved = '11/14/2023 06:35 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'41', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'47', Cost:12.85, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:31.05, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'80', Cost:11.31, ParentId: '17'},
		]
	},
