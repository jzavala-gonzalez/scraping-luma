const timestamp_saved = '11/06/2023 06:55 PM';
const dataFechaAcualizado = '11/6/2023' + ' 2:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'58', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'56', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'52', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'4', Cost:104.12, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'10', Cost:43.57, ParentId: '10'},
