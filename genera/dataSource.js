const timestamp_saved = '11/25/2023 04:05 PM';
const dataFechaAcualizado = '11/25/2023' + ' 12:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 166, MVar:'60', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'33', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.15, ParentId: '11'},
