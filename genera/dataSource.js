const timestamp_saved = '11/10/2023 09:10 PM';
const dataFechaAcualizado = '11/10/2023' + ' 5:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'43', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'37', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'56', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'12', Cost:22.02, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'64', Cost:16.85, ParentId: '15'},
