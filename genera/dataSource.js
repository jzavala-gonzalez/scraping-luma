const timestamp_saved = '08/25/2023 01:05 AM';
const dataFechaAcualizado = '8/24/2023' + ' 9:00:46 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3150},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'73', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'74', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'68', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 188,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:31.54, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'16', Cost:22.96, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'11', Cost:22.22, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:19.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:19.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'0', Cost:8.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'9', Cost:8.30, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'9', Cost:28.54, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'32', Cost:19.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'84', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'235', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'132', Cost:9.22, ParentId: '17'},
		]
	},
