const timestamp_saved = '09/30/2023 06:25 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'37', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'35', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'49', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 99, MVar:'28', Cost:19.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:19.52, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 172, MVar:'81', Cost:16.94, ParentId: '15'},
