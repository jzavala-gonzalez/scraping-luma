const timestamp_saved = '08/06/2023 06:10 AM';
const dataFechaAcualizado = '8/6/2023' + ' 2:05:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'42', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 11, MVar:'1', Cost:27.11, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'3', Cost:26.46, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:20.01, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.40, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'87', Cost:16.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'94', Cost:11.54, ParentId: '17'},
		]
	},
