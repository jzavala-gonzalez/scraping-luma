const timestamp_saved = '08/21/2023 05:40 AM';
const dataFechaAcualizado = '8/21/2023' + ' 1:37:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'46', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'50', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 38,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.85, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'6', Cost:30.15, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 132,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 132, MVar:'72', Cost:17.17, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 210,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 210, MVar:'41', Cost:10.35, ParentId: '17'},
		]
	},
