const timestamp_saved = '09/14/2023 10:46 AM';
const dataFechaAcualizado = '9/14/2023' + ' 6:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'49', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'63', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'89', Cost:9.21, ParentId: '17'},
		]
	},
