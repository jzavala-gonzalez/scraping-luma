const timestamp_saved = '09/04/2023 11:40 PM';
const dataFechaAcualizado = '9/4/2023' + ' 7:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'50', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'54', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'63', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 46, MVar:'8', Cost:28.24, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'8', Cost:26.52, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'208', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'99', Cost:9.16, ParentId: '17'},
		]
	},
