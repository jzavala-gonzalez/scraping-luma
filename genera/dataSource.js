const timestamp_saved = '10/18/2023 02:11 AM';
const dataFechaAcualizado = '10/17/2023' + ' 10:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'66', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'63', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'62', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:21.93, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'33', Cost:18.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.84, ParentId: '11'},
