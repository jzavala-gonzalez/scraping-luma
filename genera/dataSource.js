const timestamp_saved = '09/27/2023 07:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 3:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'25', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'25', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.92, ParentId: '11'},
