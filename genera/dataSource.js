const timestamp_saved = '08/16/2023 04:35 AM';
const dataFechaAcualizado = '8/16/2023' + ' 12:32:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'67', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'63', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'68', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'8', Cost:29.07, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'10', Cost:29.12, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'240', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'110', Cost:10.21, ParentId: '17'},
		]
	},
