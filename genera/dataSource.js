const timestamp_saved = '08/28/2023 01:45 AM';
const dataFechaAcualizado = '8/27/2023' + ' 9:40:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'49', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'48', Cost:10.30, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 143,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'6', Cost:22.35, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'172', Cost:16.98, ParentId: '16'},
		]
	},
