const timestamp_saved = '07/31/2023 02:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 10:20:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'54', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:19.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:19.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 113, MVar:'0', Cost:17.18, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:17.18, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 332,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'97', Cost:16.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'146', Cost:16.75, ParentId: '16'},
		]
	},
