const timestamp_saved = '11/30/2023 06:00 PM';
const dataFechaAcualizado = '11/30/2023' + ' 1:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'54', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'57', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'56', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'79', Cost:9.92, ParentId: '17'},
		]
	},
