const timestamp_saved = '11/28/2023 01:45 PM';
const dataFechaAcualizado = '11/28/2023' + ' 9:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'34', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'42', Cost:11.26, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'46', Cost:17.36, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'94', Cost:9.43, ParentId: '17'},
		]
	},
