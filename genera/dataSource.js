const timestamp_saved = '08/07/2023 10:00 AM';
const dataFechaAcualizado = '8/7/2023' + ' 5:55:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:10.59, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 33,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'10', Cost:164.50, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.22, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'47', Cost:18.43, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'45', Cost:16.43, ParentId: '15'},
		]
	},
