const timestamp_saved = '10/09/2023 10:10 AM';
const dataFechaAcualizado = '10/9/2023' + ' 6:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.47, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'133', Cost:17.85, ParentId: '16'},
		]
	},
