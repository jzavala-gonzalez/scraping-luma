const timestamp_saved = '07/28/2023 08:12 AM';
const dataFechaAcualizado = '7/28/2023' + ' 4:05:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'40', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:11.27, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:26.99, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 162, MVar:'31', Cost:15.41, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'77', Cost:13.16, ParentId: '17'},
		]
	},
