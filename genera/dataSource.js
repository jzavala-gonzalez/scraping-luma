const timestamp_saved = '12/01/2023 08:40 AM';
const dataFechaAcualizado = '12/1/2023' + ' 4:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'38', Cost:12.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'41', Cost:12.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'46', Cost:12.76, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'51', Cost:9.87, ParentId: '17'},
		]
	},
