const timestamp_saved = '11/29/2023 02:39 AM';
const dataFechaAcualizado = '11/28/2023' + ' 10:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'38', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:11.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:26.05, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'178', Cost:16.92, ParentId: '16'},
		]
	},
