const timestamp_saved = '11/24/2023 11:35 AM';
const dataFechaAcualizado = '11/24/2023' + ' 7:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'23', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'31', Cost:11.05, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'64', Cost:9.92, ParentId: '17'},
		]
	},
