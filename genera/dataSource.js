const timestamp_saved = '10/20/2023 05:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 1:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'48', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'55', Cost:10.56, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'163', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'114', Cost:10.53, ParentId: '17'},
		]
	},
