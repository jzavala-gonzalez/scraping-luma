const timestamp_saved = '09/27/2023 07:05 PM';
const dataFechaAcualizado = '9/27/2023' + ' 3:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'29', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'29', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'61', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'179', Cost:17.37, ParentId: '16'},
		]
	},
