const timestamp_saved = '11/14/2023 03:55 AM';
const dataFechaAcualizado = '11/13/2023' + ' 11:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'53', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'57', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'58', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'13', Cost:30.89, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'11', Cost:30.66, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'109', Cost:10.88, ParentId: '17'},
		]
	},
