const timestamp_saved = '09/19/2023 01:00 PM';
const dataFechaAcualizado = '9/19/2023' + ' 8:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 211, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'73', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'49', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'51', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'63', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:31.29, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'79', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'92', Cost:9.29, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 26, MVar:'4', Cost:19.60, ParentId: '19'},
