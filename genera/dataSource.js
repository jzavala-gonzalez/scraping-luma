const timestamp_saved = '08/14/2023 06:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 2:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'36', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'41', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'41', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 82,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'101', Cost:12.99, ParentId: '17'},
		]
	},
