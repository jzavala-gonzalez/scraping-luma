const timestamp_saved = '08/06/2023 09:45 AM';
const dataFechaAcualizado = '8/6/2023' + ' 5:40:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'39', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'41', Cost:11.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'17', Cost:0, ParentId: '8'},
