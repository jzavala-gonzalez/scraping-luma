const timestamp_saved = '10/22/2023 07:30 AM';
const dataFechaAcualizado = '10/22/2023' + ' 3:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'41', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:10.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:17.89, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'5', Cost:19.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'56', Cost:11.11, ParentId: '17'},
		]
	},
