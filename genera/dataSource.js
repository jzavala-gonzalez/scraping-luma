const timestamp_saved = '11/07/2023 05:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 1:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'44', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'43', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'42', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.21, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:27.91, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 62, MVar:'9', Cost:20.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'52', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'78', Cost:9.68, ParentId: '17'},
		]
	},
