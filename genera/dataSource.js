const timestamp_saved = '10/27/2023 09:00 PM';
const dataFechaAcualizado = '10/27/2023' + ' 4:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'39', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'39', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'45', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'8', Cost:43.95, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:17.20, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.13, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.13, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.78, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'100', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 343,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 343, MVar:'121', Cost:16.67, ParentId: '16'},
		]
	},
