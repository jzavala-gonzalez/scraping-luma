const timestamp_saved = '09/13/2023 05:35 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:30:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'56', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'55', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'68', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'14', Cost:28.31, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'16', Cost:28.33, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'47', Cost:19.77, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'0', Cost:0, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:19.54, ParentId: '14'},
