const timestamp_saved = '09/21/2023 07:55 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'37', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'42', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'61', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:23.00, ParentId: '9'},
