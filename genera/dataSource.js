const timestamp_saved = '11/05/2023 12:00 AM';
const dataFechaAcualizado = '11/4/2023' + ' 7:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'55', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'54', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'50', Cost:10.61, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 79,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 8, MVar:'0', Cost:31.23, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:17.23, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'156', Cost:17.15, ParentId: '16'},
		]
	},
