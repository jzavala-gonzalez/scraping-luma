const timestamp_saved = '08/04/2023 11:55 AM';
const dataFechaAcualizado = '8/4/2023' + ' 7:50:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'73', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'42', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'48', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'40', Cost:15.61, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'140', Cost:18.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'88', Cost:10.96, ParentId: '17'},
		]
	},
