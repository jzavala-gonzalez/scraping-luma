const timestamp_saved = '11/21/2023 06:50 AM';
const dataFechaAcualizado = '11/21/2023' + ' 2:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'20', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'31', Cost:12.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 60, MVar:'22', Cost:0, ParentId: '8'},
