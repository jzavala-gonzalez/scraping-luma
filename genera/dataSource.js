const timestamp_saved = '11/11/2023 11:35 AM';
const dataFechaAcualizado = '11/11/2023' + ' 7:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'46', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'85', Cost:9.14, ParentId: '17'},
		]
	},
