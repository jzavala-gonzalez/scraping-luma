const timestamp_saved = '11/30/2023 03:05 AM';
const dataFechaAcualizado = '11/29/2023' + ' 11:01:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'73', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'53', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:10.70, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.10, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 3, MVar:'1', Cost:20.66, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.52, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 194,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'156', Cost:19.10, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'96', Cost:9.23, ParentId: '17'},
		]
	},
