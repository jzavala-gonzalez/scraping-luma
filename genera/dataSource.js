const timestamp_saved = '10/30/2023 09:55 PM';
const dataFechaAcualizado = '10/30/2023' + ' 5:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'56', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'62', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'15', Cost:31.32, ParentId: '10'},
