const timestamp_saved = '09/08/2023 02:00 PM';
const dataFechaAcualizado = '9/8/2023' + ' 9:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'75', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'58', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'54', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:11.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 109,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'50', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'16', Cost:31.10, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'146', Cost:17.14, ParentId: '16'},
		]
	},
