const timestamp_saved = '09/14/2023 08:40 PM';
const dataFechaAcualizado = '9/14/2023' + ' 4:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'64', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'63', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'72', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 70, MVar:'0', Cost:7.01, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'182', Cost:16.64, ParentId: '16'},
		]
	},
