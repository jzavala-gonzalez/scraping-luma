const timestamp_saved = '12/01/2023 09:00 AM';
const dataFechaAcualizado = '12/1/2023' + ' 4:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'40', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'40', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'46', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'52', Cost:9.86, ParentId: '17'},
		]
	},
