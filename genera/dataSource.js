const timestamp_saved = '08/11/2023 08:30 AM';
const dataFechaAcualizado = '8/11/2023' + ' 4:25:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'18', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'46', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.66, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'4', Cost:28.58, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'132', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 226,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 226, MVar:'78', Cost:13.59, ParentId: '17'},
		]
	},
