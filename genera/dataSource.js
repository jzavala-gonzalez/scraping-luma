const timestamp_saved = '11/19/2023 09:40 AM';
const dataFechaAcualizado = '11/19/2023' + ' 5:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:15.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:15.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 19,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'25', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'64', Cost:16.68, ParentId: '15'},
