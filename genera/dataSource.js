const timestamp_saved = '11/20/2023 10:10 AM';
const dataFechaAcualizado = '11/20/2023' + ' 6:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'34', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'44', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'57', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:17.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:17.67, ParentId: '11'},
