const timestamp_saved = '09/16/2023 07:45 PM';
const dataFechaAcualizado = '9/16/2023' + ' 3:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'47', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'59', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:8.83, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'10', Cost:31.58, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'90', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'127', Cost:16.63, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 64,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 31, MVar:'1', Cost:19.60, ParentId: '19'},
