const timestamp_saved = '11/23/2023 10:50 AM';
const dataFechaAcualizado = '11/23/2023' + ' 6:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 209, MVar:'63', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'21', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'30', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.93, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 225,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 225, MVar:'58', Cost:9.89, ParentId: '17'},
		]
	},
