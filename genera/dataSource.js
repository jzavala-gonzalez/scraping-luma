const timestamp_saved = '11/28/2023 07:00 PM';
const dataFechaAcualizado = '11/28/2023' + ' 2:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'43', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'51', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'60', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'107', Cost:9.43, ParentId: '17'},
		]
	},
