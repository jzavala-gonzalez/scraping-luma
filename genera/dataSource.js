const timestamp_saved = '10/27/2023 09:10 AM';
const dataFechaAcualizado = '10/27/2023' + ' 5:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'41', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'43', Cost:11.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.30, ParentId: '11'},
