const timestamp_saved = '11/20/2023 05:40 PM';
const dataFechaAcualizado = '11/20/2023' + ' 1:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 247,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'78', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'33', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'43', Cost:12.97, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'174', Cost:18.23, ParentId: '16'},
		]
	},
