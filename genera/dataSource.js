const timestamp_saved = '11/16/2023 07:50 AM';
const dataFechaAcualizado = '11/16/2023' + ' 3:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'40', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'41', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:12.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.40, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'53', Cost:10.87, ParentId: '17'},
		]
	},
