const timestamp_saved = '09/14/2023 10:10 PM';
const dataFechaAcualizado = '9/14/2023' + ' 6:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'58', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'58', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'69', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'3', Cost:22.33, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'16', Cost:28.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'17', Cost:28.05, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.32, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'94', Cost:16.67, ParentId: '15'},
