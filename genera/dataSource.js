const timestamp_saved = '10/30/2023 10:55 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:51:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'62', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'66', Cost:10.57, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'36', Cost:19.31, ParentId: '14'},
