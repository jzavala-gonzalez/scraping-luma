const timestamp_saved = '08/04/2023 04:00 AM';
const dataFechaAcualizado = '8/3/2023' + ' 11:55:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'45', Cost:10.71, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 9,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'2', Cost:28.84, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:29.69, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'91', Cost:10.84, ParentId: '17'},
		]
	},
