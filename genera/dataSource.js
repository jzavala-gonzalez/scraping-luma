const timestamp_saved = '10/30/2023 05:00 PM';
const dataFechaAcualizado = '10/30/2023' + ' 12:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'62', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'65', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'69', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'37', Cost:19.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'103', Cost:16.76, ParentId: '15'},
