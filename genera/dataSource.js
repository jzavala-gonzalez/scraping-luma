const timestamp_saved = '10/04/2023 02:25 PM';
const dataFechaAcualizado = '10/4/2023' + ' 10:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'41', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'37', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.56, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 38,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.52, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'4', Cost:26.80, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:30.86, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'77', Cost:17.04, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 197,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'156', Cost:19.52, ParentId: '16'},
		]
	},
