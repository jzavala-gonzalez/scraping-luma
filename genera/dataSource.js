const timestamp_saved = '09/03/2023 06:15 PM';
const dataFechaAcualizado = '9/3/2023' + ' 2:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'37', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'41', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'67', Cost:9.33, ParentId: '17'},
		]
	},
