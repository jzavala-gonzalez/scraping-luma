const timestamp_saved = '08/03/2023 12:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 8:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:10.88, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'152', Cost:17.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'96', Cost:10.87, ParentId: '17'},
		]
	},
