const timestamp_saved = '10/24/2023 08:40 AM';
const dataFechaAcualizado = '10/24/2023' + ' 4:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'40', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'41', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'127', Cost:18.30, ParentId: '16'},
		]
	},
