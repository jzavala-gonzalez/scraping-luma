const timestamp_saved = '11/16/2023 02:20 PM';
const dataFechaAcualizado = '11/16/2023' + ' 10:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'50', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'50', Cost:11.23, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 185,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 185, MVar:'75', Cost:10.79, ParentId: '17'},
		]
	},
