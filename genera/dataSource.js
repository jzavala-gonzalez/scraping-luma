const timestamp_saved = '11/22/2023 07:40 PM';
const dataFechaAcualizado = '11/22/2023' + ' 3:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'39', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'49', Cost:10.11, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'170', Cost:18.09, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'102', Cost:9.40, ParentId: '17'},
		]
	},
