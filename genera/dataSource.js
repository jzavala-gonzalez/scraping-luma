const timestamp_saved = '09/02/2023 05:40 AM';
const dataFechaAcualizado = '9/2/2023' + ' 1:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'44', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'50', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'62', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'10', Cost:18.77, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'51', Cost:16.52, ParentId: '15'},
