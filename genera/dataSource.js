const timestamp_saved = '11/17/2023 09:15 AM';
const dataFechaAcualizado = '11/17/2023' + ' 5:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'51', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'51', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'42', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.32, ParentId: '13'},
