const timestamp_saved = '10/17/2023 03:35 PM';
const dataFechaAcualizado = '10/17/2023' + ' 11:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'62', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'62', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'60', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:25.58, ParentId: '8'},
