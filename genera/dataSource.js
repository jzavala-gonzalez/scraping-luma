const timestamp_saved = '08/14/2023 02:55 AM';
const dataFechaAcualizado = '8/13/2023' + ' 10:52:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'83', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'101', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'4', Cost:26.40, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'27', Cost:31.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.15, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 12,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'7', Cost:27.40, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'27', Cost:18.82, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'158', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'120', Cost:12.23, ParentId: '17'},
		]
	},
