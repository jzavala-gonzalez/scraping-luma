const timestamp_saved = '10/17/2023 08:30 AM';
const dataFechaAcualizado = '10/17/2023' + ' 4:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'52', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'81', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'65', Cost:9.22, ParentId: '17'},
		]
	},
