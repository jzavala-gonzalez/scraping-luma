const timestamp_saved = '08/24/2023 05:50 PM';
const dataFechaAcualizado = '8/24/2023' + ' 1:45:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'64', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'58', Cost:10.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 57, MVar:'0', Cost:3.51, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:27.43, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:27.29, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'34', Cost:18.41, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'196', Cost:17.17, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 3, MVar:'0', Cost:76.92, ParentId: '21'},
