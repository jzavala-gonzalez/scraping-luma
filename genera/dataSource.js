const timestamp_saved = '10/13/2023 03:45 AM';
const dataFechaAcualizado = '10/12/2023' + ' 11:41:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'59', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'64', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'68', Cost:10.97, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 64,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 5, MVar:'0', Cost:26.77, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 5, MVar:'0', Cost:34.79, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.42, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.80, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'8', Cost:29.34, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'79', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 229, MVar:'65', Cost:10.22, ParentId: '17'},
		]
	},
