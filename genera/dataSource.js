const timestamp_saved = '12/05/2023 06:40 AM';
const dataFechaAcualizado = '12/5/2023' + ' 2:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'38', Cost:12.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'50', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'50', Cost:11.36, ParentId: '17'},
		]
	},
