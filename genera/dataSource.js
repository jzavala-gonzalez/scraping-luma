const timestamp_saved = '09/17/2023 11:45 PM';
const dataFechaAcualizado = '9/17/2023' + ' 7:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'90', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'53', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'51', Cost:10.51, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'27', Cost:19.90, ParentId: '14'},
