const timestamp_saved = '08/02/2023 11:20 AM';
const dataFechaAcualizado = '8/2/2023' + ' 7:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'47', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'46', Cost:10.15, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'3', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'39', Cost:15.61, ParentId: '15'},
		]
	},
