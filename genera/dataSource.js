const timestamp_saved = '11/27/2023 07:10 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'18', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'28', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'45', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'61', Cost:9.85, ParentId: '17'},
		]
	},
