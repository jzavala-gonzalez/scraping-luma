const timestamp_saved = '11/22/2023 10:15 PM';
const dataFechaAcualizado = '11/22/2023' + ' 6:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'36', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'59', Cost:11.05, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 28, MVar:'0', Cost:17.82, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.39, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'103', Cost:9.23, ParentId: '17'},
		]
	},
