const timestamp_saved = '08/30/2023 12:15 AM';
const dataFechaAcualizado = '8/29/2023' + ' 8:10:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'67', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'69', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'73', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'34', Cost:28.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'30', Cost:28.06, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 65,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'9', Cost:29.94, ParentId: '13'},
