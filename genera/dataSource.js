const timestamp_saved = '11/20/2023 02:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 10:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'61', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.36, ParentId: '11'},
