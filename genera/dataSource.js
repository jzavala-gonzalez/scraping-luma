const timestamp_saved = '09/07/2023 05:30 AM';
const dataFechaAcualizado = '9/7/2023' + ' 1:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'50', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'28', Cost:11.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'46', Cost:11.72, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'134', Cost:17.75, ParentId: '16'},
		]
	},
