const timestamp_saved = '10/22/2023 07:30 PM';
const dataFechaAcualizado = '10/22/2023' + ' 3:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'44', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.08, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.46, ParentId: '14'},
