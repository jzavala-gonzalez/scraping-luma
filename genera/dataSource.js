const timestamp_saved = '10/29/2023 11:20 PM';
const dataFechaAcualizado = '10/29/2023' + ' 7:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'50', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'52', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'71', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 51, MVar:'16', Cost:21.45, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'145', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 215, MVar:'65', Cost:10.26, ParentId: '17'},
		]
	},
