const timestamp_saved = '11/29/2023 11:10 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'40', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'38', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'42', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'49', Cost:17.49, ParentId: '11'},
