const timestamp_saved = '11/24/2023 12:10 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'24', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'33', Cost:11.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 214,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'14', Cost:17.35, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'129', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'67', Cost:9.91, ParentId: '17'},
		]
	},
