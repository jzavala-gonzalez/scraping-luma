const timestamp_saved = '11/06/2023 12:35 AM';
const dataFechaAcualizado = '11/5/2023' + ' 8:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'53', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'53', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'49', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'143', Cost:17.16, ParentId: '16'},
		]
	},
