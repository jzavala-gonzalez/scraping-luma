const timestamp_saved = '10/01/2023 08:25 AM';
const dataFechaAcualizado = '10/1/2023' + ' 4:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 164, MVar:'58', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'28', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'27', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'46', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.38, ParentId: '11'},
