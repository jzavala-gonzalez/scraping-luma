const timestamp_saved = '08/14/2023 09:05 AM';
const dataFechaAcualizado = '8/14/2023' + ' 5:02:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'35', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'40', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'100', Cost:12.99, ParentId: '17'},
		]
	},
