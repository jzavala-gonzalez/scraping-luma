const timestamp_saved = '08/27/2023 09:40 AM';
const dataFechaAcualizado = '8/27/2023' + ' 5:35:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'29', Cost:33.23, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'72', Cost:16.82, ParentId: '15'},
