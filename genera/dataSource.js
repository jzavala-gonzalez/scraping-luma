const timestamp_saved = '11/08/2023 05:00 PM';
const dataFechaAcualizado = '11/8/2023' + ' 12:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'59', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'58', Cost:10.18, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 77, MVar:'6', Cost:19.42, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'113', Cost:9.40, ParentId: '17'},
		]
	},
