const timestamp_saved = '11/22/2023 09:55 PM';
const dataFechaAcualizado = '11/22/2023' + ' 5:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'34', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'44', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'58', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'100', Cost:9.24, ParentId: '17'},
		]
	},
