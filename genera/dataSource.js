const timestamp_saved = '10/27/2023 08:25 AM';
const dataFechaAcualizado = '10/27/2023' + ' 4:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'41', Cost:11.50, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'89', Cost:18.22, ParentId: '16'},
		]
	},
