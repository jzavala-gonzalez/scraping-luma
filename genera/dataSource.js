const timestamp_saved = '08/22/2023 01:45 AM';
const dataFechaAcualizado = '8/21/2023' + ' 9:40:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'56', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'54', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'74', Cost:17.09, ParentId: '15'},
