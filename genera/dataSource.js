const timestamp_saved = '09/03/2023 05:25 PM';
const dataFechaAcualizado = '9/3/2023' + ' 1:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'34', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'39', Cost:11.32, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'62', Cost:9.54, ParentId: '17'},
		]
	},
