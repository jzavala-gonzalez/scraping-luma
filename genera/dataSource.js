const timestamp_saved = '08/30/2023 08:05 PM';
const dataFechaAcualizado = '8/30/2023' + ' 4:00:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'91', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'62', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'71', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'75', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'15', Cost:42.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'22', Cost:30.79, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'44', Cost:19.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:19.68, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'6', Cost:28.71, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'42', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'98', Cost:16.53, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'175', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'111', Cost:9.21, ParentId: '17'},
		]
	},
