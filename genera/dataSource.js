const timestamp_saved = '08/03/2023 04:26 PM';
const dataFechaAcualizado = '8/3/2023' + ' 12:20:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1102},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'45', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'48', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'101', Cost:17.12, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'89', Cost:11.39, ParentId: '17'},
		]
	},
