const timestamp_saved = '08/16/2023 02:35 PM';
const dataFechaAcualizado = '8/16/2023' + ' 10:32:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'50', Cost:11.24, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.63, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'30', Cost:19.02, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'197', Cost:17.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'89', Cost:10.23, ParentId: '17'},
		]
	},
