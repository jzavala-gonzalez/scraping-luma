const timestamp_saved = '09/28/2023 05:20 PM';
const dataFechaAcualizado = '9/28/2023' + ' 1:15:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3525},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'30', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'30', Cost:11.17, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'134', Cost:18.43, ParentId: '16'},
		]
	},
