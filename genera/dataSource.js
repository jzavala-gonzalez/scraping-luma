const timestamp_saved = '10/08/2023 05:35 AM';
const dataFechaAcualizado = '10/8/2023' + ' 1:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 232,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 232, MVar:'71', Cost:4.44, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.44, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'42', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'41', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'41', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.48, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'81', Cost:16.74, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 170, MVar:'76', Cost:11.11, ParentId: '17'},
		]
	},
