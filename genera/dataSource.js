const timestamp_saved = '09/13/2023 07:30 PM';
const dataFechaAcualizado = '9/13/2023' + ' 3:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'58', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'57', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'69', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:26.18, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 147, MVar:'66', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 146,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'14', Cost:28.40, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'16', Cost:28.33, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 146, MVar:'46', Cost:8.34, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.54, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'26', Cost:18.80, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'158', Cost:18.21, ParentId: '16'},
		]
	},
