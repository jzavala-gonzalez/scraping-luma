const timestamp_saved = '10/19/2023 04:10 PM';
const dataFechaAcualizado = '10/19/2023' + ' 12:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'49', Cost:10.47, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'23', Cost:23.78, ParentId: '14'},
