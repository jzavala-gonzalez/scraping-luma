const timestamp_saved = '09/04/2023 08:05 AM';
const dataFechaAcualizado = '9/4/2023' + ' 4:00:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'37', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'41', Cost:10.83, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:18.94, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'61', Cost:9.77, ParentId: '17'},
		]
	},
