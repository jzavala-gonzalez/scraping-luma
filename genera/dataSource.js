const timestamp_saved = '08/10/2023 12:00 PM';
const dataFechaAcualizado = '8/10/2023' + ' 7:55:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'58', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'60', Cost:10.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 86, MVar:'0', Cost:9.05, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'7', Cost:30.99, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'9', Cost:31.12, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.67, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'182', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'90', Cost:11.54, ParentId: '17'},
		]
	},
