const timestamp_saved = '11/05/2023 12:05 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'40', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'39', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'40', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.40, ParentId: '11'},
