const timestamp_saved = '12/03/2023 12:40 AM';
const dataFechaAcualizado = '12/2/2023' + ' 8:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'55', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'58', Cost:10.72, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'130', Cost:18.17, ParentId: '16'},
		]
	},
