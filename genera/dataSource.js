const timestamp_saved = '09/09/2023 02:35 AM';
const dataFechaAcualizado = '9/8/2023' + ' 10:30:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 520,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'62', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'65', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 196, MVar:'62', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'4', Cost:27.50, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.95, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.18, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'1', Cost:26.06, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'20', Cost:28.14, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:8.26, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'14', Cost:19.16, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'77', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'174', Cost:16.73, ParentId: '16'},
		]
	},
