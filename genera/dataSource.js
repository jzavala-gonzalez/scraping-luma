const timestamp_saved = '07/30/2023 11:20 AM';
const dataFechaAcualizado = '7/30/2023' + ' 7:15:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:10.97, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'14', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:19.81, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:18.21, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'73', Cost:17.68, ParentId: '15'},
