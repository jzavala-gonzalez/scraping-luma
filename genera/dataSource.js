const timestamp_saved = '09/18/2023 07:35 AM';
const dataFechaAcualizado = '9/18/2023' + ' 3:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'64', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'43', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'41', Cost:10.67, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'17', Cost:18.92, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 234,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 234, MVar:'62', Cost:10.23, ParentId: '17'},
		]
	},
