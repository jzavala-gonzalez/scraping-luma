const timestamp_saved = '08/30/2023 08:55 AM';
const dataFechaAcualizado = '8/30/2023' + ' 4:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'44', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'56', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'71', Cost:16.68, ParentId: '15'},
