const timestamp_saved = '09/15/2023 04:10 AM';
const dataFechaAcualizado = '9/15/2023' + ' 12:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'49', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'47', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'63', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'19', Cost:18.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'137', Cost:17.15, ParentId: '16'},
		]
	},
