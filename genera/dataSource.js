const timestamp_saved = '10/23/2023 08:00 AM';
const dataFechaAcualizado = '10/23/2023' + ' 3:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'35', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'36', Cost:12.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'37', Cost:12.97, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'60', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'102', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'43', Cost:11.30, ParentId: '17'},
		]
	},
