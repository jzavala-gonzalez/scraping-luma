const timestamp_saved = '08/27/2023 05:35 PM';
const dataFechaAcualizado = '8/27/2023' + ' 1:30:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 609},
	{Index:'4', Desc:'Reserva Operacional', value: 1193},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'28', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'16', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'58', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'78', Cost:18.43, ParentId: '15'},
