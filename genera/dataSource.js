const timestamp_saved = '09/10/2023 08:05 AM';
const dataFechaAcualizado = '9/10/2023' + ' 4:00:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2688},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'64', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'62', Cost:10.97, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'10', Cost:19.18, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'130', Cost:17.14, ParentId: '16'},
		]
	},
