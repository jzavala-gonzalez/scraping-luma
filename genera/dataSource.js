const timestamp_saved = '09/28/2023 03:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'28', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'28', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:19.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'10', Cost:19.30, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:29.32, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'51', Cost:16.84, ParentId: '15'},
