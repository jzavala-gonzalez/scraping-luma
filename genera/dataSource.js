const timestamp_saved = '11/03/2023 03:45 PM';
const dataFechaAcualizado = '11/3/2023' + ' 11:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'54', Cost:12.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'53', Cost:12.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'50', Cost:12.17, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:30.48, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'79', Cost:9.78, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 98,
		units:[
			...
			{Index:'3', Unit:'Coto Laurel', MW: 8, MVar:'3', Cost:19.10, ParentId: '19'},
			{Index:'4', Unit:'Oriana', MW: 27, MVar:'22', Cost:19.60, ParentId: '19'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:25.90, ParentId: '21'},
