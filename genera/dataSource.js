const timestamp_saved = '11/16/2023 09:20 AM';
const dataFechaAcualizado = '11/16/2023' + ' 5:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'45', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'43', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'44', Cost:11.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 165, MVar:'27', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.03, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 187,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 187, MVar:'60', Cost:10.73, ParentId: '17'},
		]
	},
