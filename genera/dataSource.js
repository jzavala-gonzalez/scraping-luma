const timestamp_saved = '10/06/2023 05:10 AM';
const dataFechaAcualizado = '10/6/2023' + ' 1:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'41', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'54', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 59,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 59, MVar:'3', Cost:28.79, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:16.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:16.82, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'47', Cost:8.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'14', Cost:19.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'57', Cost:16.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'168', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'95', Cost:10.06, ParentId: '17'},
		]
	},
