const timestamp_saved = '09/28/2023 06:55 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'19', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'17', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'43', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'95', Cost:18.45, ParentId: '16'},
		]
	},
