const timestamp_saved = '10/13/2023 05:00 AM';
const dataFechaAcualizado = '10/13/2023' + ' 12:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'60', Cost:10.50, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'74', Cost:9.14, ParentId: '17'},
		]
	},
