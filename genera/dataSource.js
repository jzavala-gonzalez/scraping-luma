const timestamp_saved = '07/30/2023 11:55 AM';
const dataFechaAcualizado = '7/30/2023' + ' 7:50:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'41', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'37', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'62', Cost:11.15, ParentId: '17'},
		]
	},
