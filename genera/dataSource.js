const timestamp_saved = '10/01/2023 01:30 AM';
const dataFechaAcualizado = '9/30/2023' + ' 9:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 472,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'72', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'39', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'37', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'51', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:22.12, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 27, MVar:'0', Cost:21.48, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'10', Cost:30.85, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'149', Cost:17.12, ParentId: '16'},
		]
	},
