const timestamp_saved = '09/28/2023 04:55 AM';
const dataFechaAcualizado = '9/28/2023' + ' 12:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'24', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'24', Cost:11.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:18.34, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 229, MVar:'75', Cost:9.96, ParentId: '17'},
		]
	},
