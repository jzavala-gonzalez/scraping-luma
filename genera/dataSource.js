const timestamp_saved = '09/20/2023 07:35 PM';
const dataFechaAcualizado = '9/20/2023' + ' 3:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 148, MVar:'64', Cost:10.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 6, MVar:'0', Cost:114.93, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'31', Cost:25.69, ParentId: '14'},
