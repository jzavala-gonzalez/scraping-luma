const timestamp_saved = '09/18/2023 03:05 AM';
const dataFechaAcualizado = '9/17/2023' + ' 11:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'47', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'44', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'61', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'16', Cost:18.95, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'86', Cost:9.13, ParentId: '17'},
		]
	},
