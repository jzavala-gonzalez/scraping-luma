const timestamp_saved = '08/24/2023 05:15 AM';
const dataFechaAcualizado = '8/24/2023' + ' 1:10:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'50', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'52', Cost:10.39, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'17', Cost:18.30, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'81', Cost:9.27, ParentId: '17'},
		]
	},
