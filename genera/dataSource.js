const timestamp_saved = '09/11/2023 11:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 7:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'68', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'67', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'66', Cost:10.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.26, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'142', Cost:16.75, ParentId: '16'},
		]
	},
