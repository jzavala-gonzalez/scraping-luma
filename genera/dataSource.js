const timestamp_saved = '08/24/2023 04:05 PM';
const dataFechaAcualizado = '8/24/2023' + ' 12:00:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'61', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'58', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'5', Cost:22.04, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'32', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'188', Cost:17.81, ParentId: '16'},
		]
	},
