const timestamp_saved = '09/17/2023 11:00 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'41', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'40', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'56', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'7', Cost:9.95, ParentId: '11'},
		]
	},
