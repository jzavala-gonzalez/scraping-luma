const timestamp_saved = '11/03/2023 11:15 PM';
const dataFechaAcualizado = '11/3/2023' + ' 7:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'59', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'58', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'53', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'179', Cost:17.14, ParentId: '16'},
		]
	},
