const timestamp_saved = '11/06/2023 12:45 PM';
const dataFechaAcualizado = '11/6/2023' + ' 8:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'51', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'50', Cost:10.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'12', Cost:17.32, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'10', Cost:20.04, ParentId: '14'},
