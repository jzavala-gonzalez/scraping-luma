const timestamp_saved = '10/11/2023 07:35 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'44', Cost:13.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'48', Cost:13.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'58', Cost:13.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'43', Cost:18.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:18.30, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'146', Cost:17.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'58', Cost:9.11, ParentId: '17'},
		]
	},
