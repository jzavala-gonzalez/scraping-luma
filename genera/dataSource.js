const timestamp_saved = '10/05/2023 04:25 AM';
const dataFechaAcualizado = '10/5/2023' + ' 12:21:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'34', Cost:11.53, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.95, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'142', Cost:17.43, ParentId: '16'},
		]
	},
