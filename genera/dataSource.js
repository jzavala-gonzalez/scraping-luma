const timestamp_saved = '11/13/2023 06:35 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:31:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2448},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 207,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:17.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'42', Cost:17.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 27, MVar:'49', Cost:17.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 60, MVar:'2', Cost:27.74, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:17.01, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'60', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'82', Cost:9.14, ParentId: '17'},
		]
	},
