const timestamp_saved = '08/01/2023 11:05 PM';
const dataFechaAcualizado = '8/1/2023' + ' 7:00:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'45', Cost:10.47, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'125', Cost:17.15, ParentId: '16'},
		]
	},
