const timestamp_saved = '10/21/2023 02:10 AM';
const dataFechaAcualizado = '10/20/2023' + ' 10:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'42', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'102', Cost:10.54, ParentId: '17'},
		]
	},
