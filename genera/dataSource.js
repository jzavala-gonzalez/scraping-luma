const timestamp_saved = '10/05/2023 09:20 AM';
const dataFechaAcualizado = '10/5/2023' + ' 5:16:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'36', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'33', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'47', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'139', Cost:18.26, ParentId: '16'},
		]
	},
