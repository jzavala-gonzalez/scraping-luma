const timestamp_saved = '08/04/2023 06:40 PM';
const dataFechaAcualizado = '8/4/2023' + ' 2:35:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:10.95, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'10', Cost:26.22, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'2', Cost:22.56, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 222,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'90', Cost:17.08, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 79, MVar:'51', Cost:19.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'165', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'99', Cost:10.85, ParentId: '17'},
		]
	},
