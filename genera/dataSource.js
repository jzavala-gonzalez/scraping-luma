const timestamp_saved = '10/31/2023 04:40 PM';
const dataFechaAcualizado = '10/31/2023' + ' 12:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'61', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'65', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'68', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'8', Cost:26.85, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:61.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'32', Cost:19.17, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'89', Cost:9.30, ParentId: '17'},
		]
	},
