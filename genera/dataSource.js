const timestamp_saved = '09/09/2023 10:35 PM';
const dataFechaAcualizado = '9/9/2023' + ' 6:30:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2733},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'72', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'70', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 210, MVar:'70', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'15', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:30.57, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 44, MVar:'8', Cost:31.17, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'18', Cost:18.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'81', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'181', Cost:16.64, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 2,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 2, MVar:'15', Cost:19.60, ParentId: '19'},
