const timestamp_saved = '11/23/2023 10:30 PM';
const dataFechaAcualizado = '11/23/2023' + ' 6:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'29', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'38', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'52', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'55', Cost:9.20, ParentId: '17'},
		]
	},
