const timestamp_saved = '11/17/2023 11:25 AM';
const dataFechaAcualizado = '11/17/2023' + ' 7:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'59', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'44', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.38, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 161, MVar:'43', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'82', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'97', Cost:9.85, ParentId: '17'},
		]
	},
