const timestamp_saved = '11/28/2023 05:35 PM';
const dataFechaAcualizado = '11/28/2023' + ' 1:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'38', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'58', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'100', Cost:9.81, ParentId: '17'},
		]
	},
