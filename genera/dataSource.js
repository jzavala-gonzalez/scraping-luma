const timestamp_saved = '09/19/2023 10:55 PM';
const dataFechaAcualizado = '9/19/2023' + ' 6:50:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 318},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 208, MVar:'77', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'85', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'56', Cost:9.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'58', Cost:9.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'68', Cost:9.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 93, MVar:'0', Cost:5.17, ParentId: '8'},
			{Index:'1', Unit:'Vega Baja', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'2', Unit:'Costa Sur', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:31.35, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:35.77, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:30.35, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'25', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'83', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 343,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 343, MVar:'171', Cost:16.98, ParentId: '16'},
		]
	},
