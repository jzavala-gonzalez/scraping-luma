const timestamp_saved = '10/16/2023 08:00 PM';
const dataFechaAcualizado = '10/16/2023' + ' 3:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'68', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'66', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'64', Cost:10.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 55,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 1, MVar:'0', Cost:41.43, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:26.92, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.99, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 14, MVar:'7', Cost:57.71, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'1', Cost:26.88, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 62, MVar:'27', Cost:31.13, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:27.33, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'100', Cost:16.69, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'104', Cost:9.14, ParentId: '17'},
		]
	},
