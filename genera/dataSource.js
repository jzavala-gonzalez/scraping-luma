const timestamp_saved = '11/27/2023 09:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 5:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'35', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'174', Cost:17.16, ParentId: '16'},
		]
	},
