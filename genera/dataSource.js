const timestamp_saved = '10/05/2023 02:35 AM';
const dataFechaAcualizado = '10/4/2023' + ' 10:31:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'45', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'43', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'57', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'114', Cost:9.21, ParentId: '17'},
		]
	},
