const timestamp_saved = '08/20/2023 04:45 PM';
const dataFechaAcualizado = '8/20/2023' + ' 12:42:58 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1094},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'48', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'53', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:30.92, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'146', Cost:18.25, ParentId: '16'},
		]
	},
