const timestamp_saved = '11/28/2023 11:45 AM';
const dataFechaAcualizado = '11/28/2023' + ' 7:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'27', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'38', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'53', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 240,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 240, MVar:'149', Cost:17.78, ParentId: '16'},
		]
	},
