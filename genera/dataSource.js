const timestamp_saved = '09/23/2023 06:06 AM';
const dataFechaAcualizado = '9/23/2023' + ' 2:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 161, MVar:'71', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'43', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'44', Cost:10.98, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'45', Cost:19.82, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.53, ParentId: '12'},
