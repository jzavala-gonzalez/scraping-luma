const timestamp_saved = '11/14/2023 08:15 AM';
const dataFechaAcualizado = '11/14/2023' + ' 4:11:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1970},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'44', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'50', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'52', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:31.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'13', Cost:29.45, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'11', Cost:29.50, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'75', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'85', Cost:11.50, ParentId: '17'},
		]
	},
