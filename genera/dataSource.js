const timestamp_saved = '12/03/2023 12:25 AM';
const dataFechaAcualizado = '12/2/2023' + ' 8:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'58', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'129', Cost:18.17, ParentId: '16'},
		]
	},
