const timestamp_saved = '10/31/2023 09:45 PM';
const dataFechaAcualizado = '10/31/2023' + ' 5:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'60', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'64', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'68', Cost:10.81, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 122, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'25', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 227,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 20, MVar:'5', Cost:98.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:98.54, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'47', Cost:16.95, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'33', Cost:18.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'174', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'89', Cost:9.12, ParentId: '17'},
		]
	},
