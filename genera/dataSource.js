const timestamp_saved = '10/17/2023 01:30 PM';
const dataFechaAcualizado = '10/17/2023' + ' 9:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'60', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'62', Cost:10.29, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'11', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'92', Cost:16.75, ParentId: '15'},
