const timestamp_saved = '08/29/2023 09:40 AM';
const dataFechaAcualizado = '8/29/2023' + ' 5:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'45', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'48', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'56', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'0', Cost:26.44, ParentId: '9'},
		]
	},
