const timestamp_saved = '11/27/2023 12:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 8:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'49', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'58', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.70, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'105', Cost:9.31, ParentId: '17'},
		]
	},
