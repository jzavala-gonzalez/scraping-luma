const timestamp_saved = '10/14/2023 12:35 PM';
const dataFechaAcualizado = '10/14/2023' + ' 8:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:17.53, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'65', Cost:9.27, ParentId: '17'},
		]
	},
