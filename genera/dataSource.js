const timestamp_saved = '11/05/2023 09:45 PM';
const dataFechaAcualizado = '11/5/2023' + ' 5:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 158, MVar:'48', Cost:10.10, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'78', Cost:16.71, ParentId: '15'},
