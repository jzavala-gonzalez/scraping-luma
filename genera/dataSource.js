const timestamp_saved = '10/27/2023 06:45 AM';
const dataFechaAcualizado = '10/27/2023' + ' 2:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'42', Cost:11.00, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'91', Cost:18.24, ParentId: '16'},
		]
	},
