const timestamp_saved = '09/20/2023 08:00 AM';
const dataFechaAcualizado = '9/20/2023' + ' 3:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'42', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'44', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'59', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'63', Cost:9.14, ParentId: '17'},
		]
	},
