const timestamp_saved = '09/30/2023 06:40 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'38', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'36', Cost:10.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'37', Cost:18.34, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'77', Cost:16.33, ParentId: '15'},
