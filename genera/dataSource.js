const timestamp_saved = '11/15/2023 03:05 AM';
const dataFechaAcualizado = '11/14/2023' + ' 11:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'51', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'54', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 205,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'25', Cost:27.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:27.73, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 196,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'151', Cost:18.49, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'106', Cost:10.91, ParentId: '17'},
		]
	},
