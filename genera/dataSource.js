const timestamp_saved = '09/03/2023 03:15 PM';
const dataFechaAcualizado = '9/3/2023' + ' 11:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'40', Cost:10.82, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:19.40, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'58', Cost:9.82, ParentId: '17'},
		]
	},
