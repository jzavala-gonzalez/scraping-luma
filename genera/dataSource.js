const timestamp_saved = '08/08/2023 07:45 AM';
const dataFechaAcualizado = '8/8/2023' + ' 3:40:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'40', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'37', Cost:20.55, ParentId: '11'},
