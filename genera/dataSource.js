const timestamp_saved = '10/13/2023 01:10 PM';
const dataFechaAcualizado = '10/13/2023' + ' 9:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'62', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'67', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'70', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'178', Cost:18.23, ParentId: '16'},
		]
	},
