const timestamp_saved = '09/16/2023 08:10 PM';
const dataFechaAcualizado = '9/16/2023' + ' 4:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'49', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'62', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.28, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:8.28, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'35', Cost:19.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'93', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'129', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'99', Cost:9.22, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 49,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 21, MVar:'4', Cost:19.60, ParentId: '19'},
