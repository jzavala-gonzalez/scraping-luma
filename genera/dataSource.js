const timestamp_saved = '10/20/2023 06:01 AM';
const dataFechaAcualizado = '10/20/2023' + ' 1:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'41', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'41', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:29.44, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'131', Cost:18.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'84', Cost:10.55, ParentId: '17'},
		]
	},
