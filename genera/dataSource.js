const timestamp_saved = '09/05/2023 01:45 AM';
const dataFechaAcualizado = '9/4/2023' + ' 9:40:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'49', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'54', Cost:10.51, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'17', Cost:31.10, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'21', Cost:19.40, ParentId: '14'},
