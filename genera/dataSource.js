const timestamp_saved = '10/20/2023 11:16 PM';
const dataFechaAcualizado = '10/20/2023' + ' 7:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'42', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'49', Cost:11.04, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:40.89, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'152', Cost:17.22, ParentId: '16'},
		]
	},
