const timestamp_saved = '08/24/2023 01:30 AM';
const dataFechaAcualizado = '8/23/2023' + ' 9:25:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'60', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'59', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'58', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'49', Cost:19.64, ParentId: '11'},
