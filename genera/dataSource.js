const timestamp_saved = '12/02/2023 11:10 AM';
const dataFechaAcualizado = '12/2/2023' + ' 7:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'42', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'43', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'58', Cost:9.80, ParentId: '17'},
		]
	},
