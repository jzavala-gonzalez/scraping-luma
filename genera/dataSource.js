const timestamp_saved = '09/26/2023 06:20 AM';
const dataFechaAcualizado = '9/26/2023' + ' 2:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'47', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'49', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 55, MVar:'0', Cost:8.60, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'1', Cost:19.22, ParentId: '14'},
