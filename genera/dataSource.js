const timestamp_saved = '12/05/2023 04:50 AM';
const dataFechaAcualizado = '12/5/2023' + ' 12:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'42', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'44', Cost:12.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'52', Cost:12.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.37, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'5', Cost:29.77, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 89, MVar:'18', Cost:18.81, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 210,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'109', Cost:19.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'63', Cost:10.88, ParentId: '17'},
		]
	},
