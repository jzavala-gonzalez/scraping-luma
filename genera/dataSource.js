const timestamp_saved = '08/03/2023 08:55 PM';
const dataFechaAcualizado = '8/3/2023' + ' 4:50:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3549},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'51', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'51', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'8', Cost:27.29, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 22,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'10', Cost:46.31, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 315,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'115', Cost:16.66, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 154, MVar:'24', Cost:15.59, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'176', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'100', Cost:11.08, ParentId: '17'},
		]
	},
