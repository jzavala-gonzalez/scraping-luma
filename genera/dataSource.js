const timestamp_saved = '12/01/2023 01:20 PM';
const dataFechaAcualizado = '12/1/2023' + ' 9:16:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'50', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'50', Cost:10.93, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'155', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'76', Cost:9.52, ParentId: '17'},
		]
	},
