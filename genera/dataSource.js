const timestamp_saved = '11/18/2023 09:30 PM';
const dataFechaAcualizado = '11/18/2023' + ' 5:26:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2459},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:14.38, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 92,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:30.88, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 131,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'0', Cost:27.47, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:26.83, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.79, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'3', Cost:26.76, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'19', Cost:28.15, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'7', Cost:32.28, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.60, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'83', Cost:16.32, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'133', Cost:9.12, ParentId: '17'},
		]
	},
