const timestamp_saved = '09/13/2023 11:10 AM';
const dataFechaAcualizado = '9/13/2023' + ' 7:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'49', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'48', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'62', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 18,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 18, MVar:'1', Cost:26.55, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'19', Cost:19.64, ParentId: '14'},
