const timestamp_saved = '08/13/2023 07:00 PM';
const dataFechaAcualizado = '8/13/2023' + ' 2:57:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'38', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'39', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:22.09, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'110', Cost:12.29, ParentId: '17'},
		]
	},
