const timestamp_saved = '11/20/2023 09:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 5:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'32', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'40', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.05, ParentId: '7'},
		]
	},
