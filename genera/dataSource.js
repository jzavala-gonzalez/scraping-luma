const timestamp_saved = '11/28/2023 08:55 PM';
const dataFechaAcualizado = '11/28/2023' + ' 4:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'48', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'58', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'65', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:30.03, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 333, MVar:'205', Cost:17.50, ParentId: '16'},
		]
	},
