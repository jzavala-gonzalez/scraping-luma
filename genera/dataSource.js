const timestamp_saved = '10/28/2023 03:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'40', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'45', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'47', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'15', Cost:34.55, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'7', Cost:21.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'96', Cost:19.56, ParentId: '15'},
