const timestamp_saved = '10/25/2023 07:15 AM';
const dataFechaAcualizado = '10/25/2023' + ' 3:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'41', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'41', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'46', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.55, ParentId: '14'},
