const timestamp_saved = '08/27/2023 04:40 PM';
const dataFechaAcualizado = '8/27/2023' + ' 12:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 260,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'30', Cost:14.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 95, MVar:'57', Cost:14.11, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'13', Cost:31.02, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:20.23, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'28', Cost:19.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'79', Cost:16.50, ParentId: '15'},
