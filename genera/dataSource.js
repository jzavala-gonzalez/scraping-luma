const timestamp_saved = '11/09/2023 07:25 AM';
const dataFechaAcualizado = '11/9/2023' + ' 3:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'39', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'43', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.55, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.58, ParentId: '13'},
