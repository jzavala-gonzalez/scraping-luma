const timestamp_saved = '09/23/2023 03:20 PM';
const dataFechaAcualizado = '9/23/2023' + ' 11:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'47', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'48', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'60', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'45', Cost:20.29, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.04, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'63', Cost:19.56, ParentId: '15'},
