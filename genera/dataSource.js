const timestamp_saved = '08/06/2023 12:15 PM';
const dataFechaAcualizado = '8/6/2023' + ' 8:10:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'39', Cost:11.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 156, MVar:'19', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.57, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'81', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'22', Cost:16.15, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'88', Cost:11.54, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 48,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 14, MVar:'27', Cost:19.60, ParentId: '19'},
