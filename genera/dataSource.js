const timestamp_saved = '11/12/2023 04:55 PM';
const dataFechaAcualizado = '11/12/2023' + ' 12:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'43', Cost:12.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'45', Cost:12.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'54', Cost:12.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.77, ParentId: '11'},
