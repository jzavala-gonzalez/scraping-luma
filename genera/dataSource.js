const timestamp_saved = '11/03/2023 03:40 AM';
const dataFechaAcualizado = '11/2/2023' + ' 11:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'51', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'48', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'56', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'74', Cost:9.13, ParentId: '17'},
		]
	},
