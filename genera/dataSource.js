const timestamp_saved = '08/17/2023 04:55 PM';
const dataFechaAcualizado = '8/17/2023' + ' 12:52:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'66', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'74', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 95,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'7', Cost:31.12, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'9', Cost:31.10, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'43', Cost:19.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:19.81, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'0', Cost:8.15, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'7', Cost:8.15, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'24', Cost:19.39, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 203,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 203, MVar:'156', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'88', Cost:9.19, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 34, MVar:'29', Cost:19.60, ParentId: '19'},
