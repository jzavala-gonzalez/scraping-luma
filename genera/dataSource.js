const timestamp_saved = '07/29/2023 08:40 AM';
const dataFechaAcualizado = '7/29/2023' + ' 4:35:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'45', Cost:10.92, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.77, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'82', Cost:17.06, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'25', Cost:15.81, ParentId: '15'},
		]
	},
