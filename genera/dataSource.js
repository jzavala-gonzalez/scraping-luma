const timestamp_saved = '12/04/2023 03:30 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:26:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2114},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'51', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'54', Cost:12.16, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'76', Cost:11.42, ParentId: '17'},
		]
	},
