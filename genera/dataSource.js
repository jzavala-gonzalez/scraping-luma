const timestamp_saved = '09/06/2023 07:10 PM';
const dataFechaAcualizado = '9/6/2023' + ' 3:05:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'64', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'42', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'54', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 122, MVar:'54', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'7', Cost:50.73, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'8', Cost:0, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'99', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:16.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 1,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 1, MVar:'105', Cost:21.75, ParentId: '17'},
		]
	},
