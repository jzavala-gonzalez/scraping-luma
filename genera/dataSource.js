const timestamp_saved = '11/20/2023 03:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 11:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'60', Cost:10.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.61, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:32.41, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'84', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'182', Cost:18.25, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 39,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 0, MVar:'0', Cost:27, ParentId: '21'},
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:26.61, ParentId: '21'},
