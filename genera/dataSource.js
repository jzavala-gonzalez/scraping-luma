const timestamp_saved = '09/05/2023 07:20 AM';
const dataFechaAcualizado = '9/5/2023' + ' 3:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'36', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'40', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'54', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'67', Cost:9.30, ParentId: '17'},
		]
	},
