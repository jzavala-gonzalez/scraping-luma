const timestamp_saved = '08/27/2023 04:15 AM';
const dataFechaAcualizado = '8/27/2023' + ' 12:10:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 83, MVar:'11', Cost:40.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:40.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:40.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 118, MVar:'0', Cost:6.88, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'3', Cost:31.07, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'7', Cost:31.02, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'17', Cost:19.41, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'117', Cost:17.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'104', Cost:16.32, ParentId: '17'},
		]
	},
