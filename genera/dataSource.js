const timestamp_saved = '10/25/2023 10:00 PM';
const dataFechaAcualizado = '10/25/2023' + ' 5:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'50', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'52', Cost:10.13, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'16', Cost:19.21, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'151', Cost:17.41, ParentId: '16'},
		]
	},
