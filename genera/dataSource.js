const timestamp_saved = '11/28/2023 03:00 AM';
const dataFechaAcualizado = '11/27/2023' + ' 10:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'33', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'42', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'55', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 48,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 18, MVar:'2', Cost:31.79, ParentId: '13'},
