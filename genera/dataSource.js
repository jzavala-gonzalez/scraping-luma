const timestamp_saved = '11/15/2023 07:45 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'32', Cost:13.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'35', Cost:13.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'44', Cost:13.52, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'2', Cost:30.90, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.53, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'58', Cost:9.76, ParentId: '17'},
		]
	},
