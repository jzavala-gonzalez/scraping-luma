const timestamp_saved = '08/18/2023 10:50 AM';
const dataFechaAcualizado = '8/18/2023' + ' 6:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'41', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'55', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'67', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'66', Cost:9.25, ParentId: '17'},
		]
	},
