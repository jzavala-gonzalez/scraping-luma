const timestamp_saved = '10/23/2023 05:05 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'37', Cost:12.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'39', Cost:12.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'40', Cost:12.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 19,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 7, MVar:'0', Cost:26.59, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'78', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'111', Cost:16.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'52', Cost:11.30, ParentId: '17'},
		]
	},
