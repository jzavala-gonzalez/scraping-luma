const timestamp_saved = '08/04/2023 11:00 AM';
const dataFechaAcualizado = '8/4/2023' + ' 6:55:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 459,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'38', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'44', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'40', Cost:15.60, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'134', Cost:18.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'82', Cost:10.97, ParentId: '17'},
		]
	},
