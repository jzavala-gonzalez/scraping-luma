const timestamp_saved = '11/05/2023 08:35 AM';
const dataFechaAcualizado = '11/5/2023' + ' 4:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'40', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:17.69, ParentId: '11'},
