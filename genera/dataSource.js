const timestamp_saved = '11/23/2023 04:45 PM';
const dataFechaAcualizado = '11/23/2023' + ' 12:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'24', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'34', Cost:11.58, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.72, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'59', Cost:9.83, ParentId: '17'},
		]
	},
