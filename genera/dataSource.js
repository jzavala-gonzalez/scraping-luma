const timestamp_saved = '09/28/2023 11:50 AM';
const dataFechaAcualizado = '9/28/2023' + ' 7:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'20', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'20', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'44', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:18.34, ParentId: '11'},
