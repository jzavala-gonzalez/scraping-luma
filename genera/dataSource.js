const timestamp_saved = '08/08/2023 08:50 AM';
const dataFechaAcualizado = '8/8/2023' + ' 4:45:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'38', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'47', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'56', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:20.55, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'27', Cost:16.26, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'134', Cost:18.17, ParentId: '16'},
		]
	},
