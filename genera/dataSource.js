const timestamp_saved = '11/28/2023 09:00 AM';
const dataFechaAcualizado = '11/28/2023' + ' 4:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'23', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'33', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'49', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'112', Cost:18.64, ParentId: '16'},
		]
	},
