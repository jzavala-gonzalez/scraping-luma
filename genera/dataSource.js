const timestamp_saved = '09/30/2023 06:15 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'71', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'64', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'37', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'35', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'50', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:19.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:19.80, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'79', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'146', Cost:18.26, ParentId: '16'},
		]
	},
