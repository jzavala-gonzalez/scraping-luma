const timestamp_saved = '11/15/2023 07:40 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'32', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'34', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'43', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'58', Cost:9.75, ParentId: '17'},
		]
	},
