const timestamp_saved = '09/28/2023 11:50 PM';
const dataFechaAcualizado = '9/28/2023' + ' 7:45:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 3030},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'55', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'56', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'89', Cost:16.76, ParentId: '15'},
