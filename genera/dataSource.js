const timestamp_saved = '12/05/2023 06:55 AM';
const dataFechaAcualizado = '12/5/2023' + ' 2:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'39', Cost:12.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'41', Cost:12.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'51', Cost:12.92, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'50', Cost:11.32, ParentId: '17'},
		]
	},
