const timestamp_saved = '09/13/2023 07:05 AM';
const dataFechaAcualizado = '9/13/2023' + ' 3:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'48', Cost:10.51, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'141', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'77', Cost:9.80, ParentId: '17'},
		]
	},
