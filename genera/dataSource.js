const timestamp_saved = '08/07/2023 05:35 AM';
const dataFechaAcualizado = '8/7/2023' + ' 1:30:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'43', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'44', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 129, MVar:'25', Cost:15.25, ParentId: '15'},
		]
	},
