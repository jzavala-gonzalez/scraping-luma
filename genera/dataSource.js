const timestamp_saved = '10/25/2023 09:55 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.45, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'50', Cost:17.05, ParentId: '11'},
