const timestamp_saved = '09/10/2023 11:20 AM';
const dataFechaAcualizado = '9/10/2023' + ' 7:15:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2147},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'58', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'57', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'59', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'8', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'113', Cost:17.83, ParentId: '16'},
		]
	},
