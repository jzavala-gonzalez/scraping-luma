const timestamp_saved = '11/10/2023 02:45 PM';
const dataFechaAcualizado = '11/10/2023' + ' 10:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'51', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'56', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:16.98, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.00, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'16', Cost:18.66, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'76', Cost:9.48, ParentId: '17'},
		]
	},
