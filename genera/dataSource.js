const timestamp_saved = '08/01/2023 12:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 8:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 506,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'51', Cost:10.04, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 131, MVar:'0', Cost:8.73, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'96', Cost:16.70, ParentId: '15'},
