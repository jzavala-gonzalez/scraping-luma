const timestamp_saved = '09/26/2023 05:05 AM';
const dataFechaAcualizado = '9/26/2023' + ' 1:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'50', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'50', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'58', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 129, MVar:'40', Cost:17.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.07, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.23, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:18.23, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'67', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'69', Cost:9.77, ParentId: '17'},
		]
	},
