const timestamp_saved = '08/30/2023 10:15 PM';
const dataFechaAcualizado = '8/30/2023' + ' 6:10:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 265},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'72', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 174, MVar:'93', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'58', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'68', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'73', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 133,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:26.95, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.74, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:22.78, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'41', Cost:18.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'181', Cost:16.68, ParentId: '16'},
		]
	},
