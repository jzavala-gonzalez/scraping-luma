const timestamp_saved = '12/01/2023 07:55 AM';
const dataFechaAcualizado = '12/1/2023' + ' 3:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'39', Cost:12.80, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'50', Cost:9.87, ParentId: '17'},
		]
	},
