const timestamp_saved = '08/15/2023 04:10 PM';
const dataFechaAcualizado = '8/15/2023' + ' 12:07:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'50', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 62,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 62, MVar:'32', Cost:20.17, ParentId: '14'},
