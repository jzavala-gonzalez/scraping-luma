const timestamp_saved = '08/27/2023 08:20 AM';
const dataFechaAcualizado = '8/27/2023' + ' 4:15:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'27', Cost:33.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:33.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:33.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 39,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'0', Cost:26.36, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'11', Cost:19.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'97', Cost:18.20, ParentId: '16'},
		]
	},
