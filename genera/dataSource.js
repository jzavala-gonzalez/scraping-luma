const timestamp_saved = '11/24/2023 03:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 11:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'31', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'40', Cost:11.05, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'90', Cost:9.20, ParentId: '17'},
		]
	},
