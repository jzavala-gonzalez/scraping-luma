const timestamp_saved = '09/24/2023 02:30 AM';
const dataFechaAcualizado = '9/23/2023' + ' 10:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'49', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'61', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'96', Cost:9.21, ParentId: '17'},
		]
	},
