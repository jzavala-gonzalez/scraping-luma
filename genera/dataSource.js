const timestamp_saved = '10/22/2023 10:01 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'48', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'49', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:10.39, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 13,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 13, MVar:'0', Cost:23.25, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 15, MVar:'0', Cost:39.04, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'71', Cost:11.29, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:23.25, ParentId: '21'},
