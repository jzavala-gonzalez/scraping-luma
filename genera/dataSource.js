const timestamp_saved = '10/05/2023 03:00 PM';
const dataFechaAcualizado = '10/5/2023' + ' 10:56:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'45', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'43', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'55', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:17.31, ParentId: '11'},
