const timestamp_saved = '10/09/2023 05:10 PM';
const dataFechaAcualizado = '10/9/2023' + ' 1:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'61', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'63', Cost:10.43, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:18.60, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'169', Cost:18.24, ParentId: '16'},
		]
	},
