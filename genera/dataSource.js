const timestamp_saved = '08/19/2023 06:00 AM';
const dataFechaAcualizado = '8/19/2023' + ' 1:57:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'59', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'71', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'159', Cost:17.37, ParentId: '16'},
		]
	},
