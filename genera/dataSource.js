const timestamp_saved = '09/16/2023 07:15 AM';
const dataFechaAcualizado = '9/16/2023' + ' 3:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'44', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'59', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:9.60, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'7', Cost:9.60, ParentId: '11'},
		]
	},
