const timestamp_saved = '08/01/2023 04:10 PM';
const dataFechaAcualizado = '8/1/2023' + ' 12:05:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'48', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'50', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 94,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 38, MVar:'6', Cost:17, ParentId: '19'},
		]
	},
