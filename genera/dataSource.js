const timestamp_saved = '11/14/2023 11:55 PM';
const dataFechaAcualizado = '11/14/2023' + ' 7:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'61', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'63', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'62', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.26, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'5', Cost:22.16, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'13', Cost:22.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'85', Cost:16.69, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'123', Cost:10.93, ParentId: '17'},
		]
	},
