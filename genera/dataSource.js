const timestamp_saved = '08/22/2023 09:25 PM';
const dataFechaAcualizado = '8/22/2023' + ' 5:20:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'124', Cost:17.67, ParentId: '16'},
		]
	},
