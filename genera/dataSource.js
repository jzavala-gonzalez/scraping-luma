const timestamp_saved = '08/01/2023 11:50 AM';
const dataFechaAcualizado = '8/1/2023' + ' 7:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'48', Cost:10.35, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 166, MVar:'36', Cost:15.48, ParentId: '15'},
		]
	},
