const timestamp_saved = '09/18/2023 09:45 AM';
const dataFechaAcualizado = '9/18/2023' + ' 5:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'44', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'43', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'57', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'67', Cost:9.79, ParentId: '17'},
		]
	},
