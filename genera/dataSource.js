const timestamp_saved = '08/30/2023 10:40 PM';
const dataFechaAcualizado = '8/30/2023' + ' 6:35:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 3040},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'96', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'59', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'68', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'73', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:26.98, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.78, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:23.02, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'23', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'21', Cost:31.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:19.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:19.09, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'41', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'108', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'186', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'107', Cost:9.19, ParentId: '17'},
		]
	},
