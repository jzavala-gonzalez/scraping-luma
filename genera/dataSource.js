const timestamp_saved = '08/20/2023 09:05 AM';
const dataFechaAcualizado = '8/20/2023' + ' 5:02:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'50', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:19.60, ParentId: '11'},
