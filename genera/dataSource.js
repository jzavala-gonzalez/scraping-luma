const timestamp_saved = '11/18/2023 07:55 PM';
const dataFechaAcualizado = '11/18/2023' + ' 3:51:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:14.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'62', Cost:14.43, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'23', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'87', Cost:16.72, ParentId: '15'},
