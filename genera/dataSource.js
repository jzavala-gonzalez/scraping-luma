const timestamp_saved = '10/05/2023 03:35 PM';
const dataFechaAcualizado = '10/5/2023' + ' 11:31:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'45', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'42', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:18.05, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'112', Cost:9.31, ParentId: '17'},
		]
	},
