const timestamp_saved = '10/13/2023 05:40 PM';
const dataFechaAcualizado = '10/13/2023' + ' 1:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'71', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'72', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'21', Cost:30.84, ParentId: '10'},
