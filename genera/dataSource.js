const timestamp_saved = '08/02/2023 04:30 AM';
const dataFechaAcualizado = '8/2/2023' + ' 12:25:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'43', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:29.88, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'65', Cost:16.78, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'43', Cost:15.71, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'147', Cost:17.23, ParentId: '16'},
		]
	},
