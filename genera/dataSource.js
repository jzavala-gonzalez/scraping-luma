const timestamp_saved = '09/16/2023 03:45 PM';
const dataFechaAcualizado = '9/16/2023' + ' 11:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'40', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'39', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'56', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'75', Cost:17.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'104', Cost:18.18, ParentId: '16'},
		]
	},
