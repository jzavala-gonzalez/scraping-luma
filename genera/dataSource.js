const timestamp_saved = '11/23/2023 05:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 1:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'22', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'33', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'48', Cost:9.23, ParentId: '17'},
		]
	},
