const timestamp_saved = '11/08/2023 04:25 AM';
const dataFechaAcualizado = '11/8/2023' + ' 12:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'43', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'43', Cost:11.56, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.25, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'90', Cost:9.14, ParentId: '17'},
		]
	},
