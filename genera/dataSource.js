const timestamp_saved = '10/15/2023 01:35 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'53', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'47', Cost:10.94, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.13, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'64', Cost:9.56, ParentId: '17'},
		]
	},
