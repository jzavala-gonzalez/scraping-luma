const timestamp_saved = '11/23/2023 06:05 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'23', Cost:13.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'33', Cost:13.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'48', Cost:13.19, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'18', Cost:19.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'56', Cost:9.94, ParentId: '17'},
		]
	},
