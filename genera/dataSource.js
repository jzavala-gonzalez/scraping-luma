const timestamp_saved = '07/30/2023 02:11 PM';
const dataFechaAcualizado = '7/30/2023' + ' 10:05:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'43', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'38', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:19.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:19.74, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:18.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:18.14, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'37', Cost:17.04, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'116', Cost:19.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'66', Cost:11.16, ParentId: '17'},
		]
	},
