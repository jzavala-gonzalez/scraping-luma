const timestamp_saved = '09/10/2023 01:10 AM';
const dataFechaAcualizado = '9/9/2023' + ' 9:05:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 557,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'72', Cost:9.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 213, MVar:'70', Cost:9.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 27, MVar:'0', Cost:22.20, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'79', Cost:16.96, ParentId: '15'},
