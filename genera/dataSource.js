const timestamp_saved = '09/10/2023 11:50 AM';
const dataFechaAcualizado = '9/10/2023' + ' 7:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 1,
		units:[
			...
			{Index:'2', Unit:'Hidro 3', MW: 1, MVar:'1', Cost:9.35, ParentId: '0'},
		]
	},
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'53', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'66', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'58', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'57', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'60', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'2', Cost:51.45, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'115', Cost:17.83, ParentId: '16'},
		]
	},
