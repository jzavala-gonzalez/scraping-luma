const timestamp_saved = '09/28/2023 06:20 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'21', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'19', Cost:11.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:17.85, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 167,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 167, MVar:'95', Cost:20.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'67', Cost:9.73, ParentId: '17'},
		]
	},
