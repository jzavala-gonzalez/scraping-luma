const timestamp_saved = '09/24/2023 11:25 PM';
const dataFechaAcualizado = '9/24/2023' + ' 7:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'54', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'56', Cost:10.81, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'5', Cost:22.12, ParentId: '9'},
		]
	},
