const timestamp_saved = '08/14/2023 03:15 PM';
const dataFechaAcualizado = '8/14/2023' + ' 11:12:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'74', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'105', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'47', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'2', Cost:27.51, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'28', Cost:31.37, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'9', Cost:32.21, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:30.17, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'8', Cost:32.08, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'162', Cost:16.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'126', Cost:12.33, ParentId: '17'},
		]
	},
