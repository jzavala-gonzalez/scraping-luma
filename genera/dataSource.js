const timestamp_saved = '11/27/2023 07:25 PM';
const dataFechaAcualizado = '11/27/2023' + ' 3:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'38', Cost:10.35, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'1', Cost:72.65, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 378,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:8.76, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'169', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'105', Cost:9.43, ParentId: '17'},
		]
	},
