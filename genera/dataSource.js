const timestamp_saved = '11/05/2023 02:20 PM';
const dataFechaAcualizado = '11/5/2023' + ' 10:16:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1947},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'41', Cost:13.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'40', Cost:13.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'42', Cost:13.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:18.02, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'51', Cost:9.87, ParentId: '17'},
		]
	},
