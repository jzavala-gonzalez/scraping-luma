const timestamp_saved = '11/07/2023 07:20 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'39', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'37', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'38', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:17.50, ParentId: '11'},
