const timestamp_saved = '07/29/2023 03:30 PM';
const dataFechaAcualizado = '7/29/2023' + ' 11:25:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'52', Cost:10.88, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:20.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:20.69, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'97', Cost:17.07, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'27', Cost:15.66, ParentId: '15'},
		]
	},
