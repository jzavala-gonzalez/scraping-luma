const timestamp_saved = '10/29/2023 09:35 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'41', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'42', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'66', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'48', Cost:16.96, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 164,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 164, MVar:'51', Cost:10.32, ParentId: '17'},
		]
	},
