const timestamp_saved = '10/29/2023 04:25 PM';
const dataFechaAcualizado = '10/29/2023' + ' 12:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'48', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'51', Cost:10.65, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'46', Cost:17.04, ParentId: '11'},
