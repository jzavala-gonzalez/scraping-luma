const timestamp_saved = '11/21/2023 11:10 PM';
const dataFechaAcualizado = '11/21/2023' + ' 7:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'171', Cost:17.66, ParentId: '16'},
		]
	},
