const timestamp_saved = '08/27/2023 02:35 AM';
const dataFechaAcualizado = '8/26/2023' + ' 10:30:49 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:19.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'76', Cost:16.68, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'113', Cost:16.30, ParentId: '17'},
		]
	},
