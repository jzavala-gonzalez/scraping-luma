const timestamp_saved = '11/23/2023 01:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 9:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 209, MVar:'72', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'20', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'30', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'47', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:17.50, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'66', Cost:9.77, ParentId: '17'},
		]
	},
