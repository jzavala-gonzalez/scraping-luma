const timestamp_saved = '09/04/2023 08:20 PM';
const dataFechaAcualizado = '9/4/2023' + ' 4:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'42', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'58', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'8', Cost:29.13, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 124,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'18', Cost:32.00, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'179', Cost:17.45, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'82', Cost:9.17, ParentId: '17'},
		]
	},
