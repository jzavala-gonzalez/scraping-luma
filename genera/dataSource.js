const timestamp_saved = '09/10/2023 11:35 PM';
const dataFechaAcualizado = '9/10/2023' + ' 7:30:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'74', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'75', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 213, MVar:'73', Cost:9.79, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'3', Cost:22.16, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'17', Cost:28.07, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.24, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'8', Cost:28.82, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'25', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 179,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 179, MVar:'101', Cost:16.38, ParentId: '15'},
