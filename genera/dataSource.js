const timestamp_saved = '08/23/2023 05:10 PM';
const dataFechaAcualizado = '8/23/2023' + ' 1:05:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'55', Cost:10.52, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'88', Cost:9.35, ParentId: '17'},
		]
	},
