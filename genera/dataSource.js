const timestamp_saved = '08/01/2023 03:00 AM';
const dataFechaAcualizado = '7/31/2023' + ' 10:55:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'41', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'143', Cost:17.27, ParentId: '16'},
		]
	},
