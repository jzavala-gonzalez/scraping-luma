const timestamp_saved = '08/20/2023 08:15 PM';
const dataFechaAcualizado = '8/20/2023' + ' 4:12:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'62', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'21', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'61', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'84', Cost:9.20, ParentId: '17'},
		]
	},
