const timestamp_saved = '09/02/2023 09:40 AM';
const dataFechaAcualizado = '9/2/2023' + ' 5:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'58', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'105', Cost:18.23, ParentId: '16'},
		]
	},
