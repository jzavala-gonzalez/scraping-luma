const timestamp_saved = '07/30/2023 07:45 AM';
const dataFechaAcualizado = '7/30/2023' + ' 3:40:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 128, MVar:'39', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'59', Cost:16.94, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'36', Cost:15.89, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 120, MVar:'60', Cost:23.10, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'63', Cost:11.15, ParentId: '17'},
		]
	},
