const timestamp_saved = '10/21/2023 03:20 PM';
const dataFechaAcualizado = '10/21/2023' + ' 11:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'42', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'39', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'38', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'74', Cost:11.08, ParentId: '17'},
		]
	},
