const timestamp_saved = '11/08/2023 03:15 PM';
const dataFechaAcualizado = '11/8/2023' + ' 11:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'52', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'50', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'52', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'46', Cost:17.44, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:30.33, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 35, MVar:'5', Cost:24.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'99', Cost:9.60, ParentId: '17'},
		]
	},
