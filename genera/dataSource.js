const timestamp_saved = '11/29/2023 06:45 AM';
const dataFechaAcualizado = '11/29/2023' + ' 2:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'23', Cost:12.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'31', Cost:12.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'48', Cost:12.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'50', Cost:17.26, ParentId: '11'},
