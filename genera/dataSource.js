const timestamp_saved = '11/21/2023 11:05 AM';
const dataFechaAcualizado = '11/21/2023' + ' 7:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'25', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'34', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'49', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'76', Cost:9.59, ParentId: '17'},
		]
	},
