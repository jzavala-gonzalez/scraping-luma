const timestamp_saved = '08/16/2023 10:45 AM';
const dataFechaAcualizado = '8/16/2023' + ' 6:42:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'48', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:11.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 122, MVar:'33', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 264,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 264, MVar:'182', Cost:17.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'78', Cost:10.48, ParentId: '17'},
		]
	},
