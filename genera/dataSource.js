const timestamp_saved = '11/24/2023 04:15 PM';
const dataFechaAcualizado = '11/24/2023' + ' 12:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'29', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'38', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'51', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 168,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:8.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'80', Cost:9.82, ParentId: '17'},
		]
	},
