const timestamp_saved = '10/29/2023 04:30 AM';
const dataFechaAcualizado = '10/29/2023' + ' 12:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'41', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'42', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'65', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'7', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'44', Cost:16.80, ParentId: '15'},
