const timestamp_saved = '11/30/2023 08:50 PM';
const dataFechaAcualizado = '11/30/2023' + ' 4:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'59', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'59', Cost:10.27, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.39, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'163', Cost:17.78, ParentId: '16'},
		]
	},
