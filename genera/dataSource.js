const timestamp_saved = '12/02/2023 01:50 AM';
const dataFechaAcualizado = '12/1/2023' + ' 9:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'52', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'56', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'56', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'91', Cost:9.19, ParentId: '17'},
		]
	},
