const timestamp_saved = '10/01/2023 03:05 PM';
const dataFechaAcualizado = '10/1/2023' + ' 11:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'28', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'26', Cost:11.29, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'88', Cost:9.50, ParentId: '17'},
		]
	},
