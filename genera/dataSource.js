const timestamp_saved = '10/21/2023 12:06 AM';
const dataFechaAcualizado = '10/20/2023' + ' 8:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.81, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 77,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 3, MVar:'0', Cost:30.95, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'88', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'153', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'108', Cost:10.55, ParentId: '17'},
		]
	},
