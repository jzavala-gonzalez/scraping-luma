const timestamp_saved = '11/25/2023 05:50 AM';
const dataFechaAcualizado = '11/25/2023' + ' 1:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 197,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 197, MVar:'60', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'24', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'35', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'50', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.38, ParentId: '11'},
