const timestamp_saved = '08/17/2023 07:50 PM';
const dataFechaAcualizado = '8/17/2023' + ' 3:47:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'69', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'76', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:19.58, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'164', Cost:17.62, ParentId: '16'},
		]
	},
