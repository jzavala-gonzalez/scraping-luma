const timestamp_saved = '11/01/2023 03:20 AM';
const dataFechaAcualizado = '10/31/2023' + ' 11:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'60', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'63', Cost:10.89, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'56', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'138', Cost:17.20, ParentId: '16'},
		]
	},
