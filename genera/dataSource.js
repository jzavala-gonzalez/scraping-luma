const timestamp_saved = '10/18/2023 04:55 AM';
const dataFechaAcualizado = '10/18/2023' + ' 12:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 302,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 102, MVar:'31', Cost:19.75, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:19.75, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'4', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'70', Cost:16.55, ParentId: '15'},
