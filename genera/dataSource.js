const timestamp_saved = '08/06/2023 09:30 PM';
const dataFechaAcualizado = '8/6/2023' + ' 5:25:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'48', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'47', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'18', Cost:31.24, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'21', Cost:31.25, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:10.03, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'9', Cost:10.03, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'18', Cost:18.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 275,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'99', Cost:17.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'9', Cost:15.60, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'103', Cost:11.57, ParentId: '17'},
		]
	},
