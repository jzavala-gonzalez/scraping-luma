const timestamp_saved = '11/01/2023 02:40 AM';
const dataFechaAcualizado = '10/31/2023' + ' 10:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'55', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'61', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'65', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:18.32, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'74', Cost:16.87, ParentId: '15'},
