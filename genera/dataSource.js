const timestamp_saved = '10/18/2023 04:40 PM';
const dataFechaAcualizado = '10/18/2023' + ' 12:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'53', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'64', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'181', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'110', Cost:10.58, ParentId: '17'},
		]
	},
