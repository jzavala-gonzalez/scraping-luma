const timestamp_saved = '09/29/2023 06:10 AM';
const dataFechaAcualizado = '9/29/2023' + ' 2:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'35', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'32', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'50', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.76, ParentId: '11'},
