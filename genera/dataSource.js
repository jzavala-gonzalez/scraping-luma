const timestamp_saved = '10/02/2023 12:25 PM';
const dataFechaAcualizado = '10/2/2023' + ' 8:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'41', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'37', Cost:10.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 43,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 20, MVar:'2', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:16.97, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'156', Cost:17.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'106', Cost:9.23, ParentId: '17'},
		]
	},
