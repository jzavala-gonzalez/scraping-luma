const timestamp_saved = '11/28/2023 11:10 PM';
const dataFechaAcualizado = '11/28/2023' + ' 7:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'44', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'54', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'64', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'122', Cost:9.19, ParentId: '17'},
		]
	},
