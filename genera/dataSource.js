const timestamp_saved = '08/21/2023 12:20 AM';
const dataFechaAcualizado = '8/20/2023' + ' 8:17:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'63', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'35', Cost:10.47, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 52, MVar:'12', Cost:20.97, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'90', Cost:17.31, ParentId: '15'},
