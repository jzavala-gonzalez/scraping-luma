const timestamp_saved = '09/17/2023 03:30 PM';
const dataFechaAcualizado = '9/17/2023' + ' 11:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'44', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'42', Cost:10.59, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 107, MVar:'0', Cost:10.00, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:10.00, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'72', Cost:9.65, ParentId: '17'},
		]
	},
