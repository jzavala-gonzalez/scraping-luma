const timestamp_saved = '10/24/2023 01:50 PM';
const dataFechaAcualizado = '10/24/2023' + ' 9:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'52', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'52', Cost:10.76, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:17.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'83', Cost:11.25, ParentId: '17'},
		]
	},
