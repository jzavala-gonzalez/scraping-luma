const timestamp_saved = '09/05/2023 12:35 AM';
const dataFechaAcualizado = '9/4/2023' + ' 8:30:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'52', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'56', Cost:10.47, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'6', Cost:21.93, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 33, MVar:'0', Cost:19.15, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 129,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'18', Cost:31.09, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'5', Cost:29.07, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'4', Cost:29.12, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'28', Cost:19.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'211', Cost:16.67, ParentId: '16'},
		]
	},
