const timestamp_saved = '11/07/2023 02:50 PM';
const dataFechaAcualizado = '11/7/2023' + ' 10:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'45', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'89', Cost:9.80, ParentId: '17'},
		]
	},
