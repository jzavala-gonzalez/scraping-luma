const timestamp_saved = '08/06/2023 07:40 PM';
const dataFechaAcualizado = '8/6/2023' + ' 3:35:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'45', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'18', Cost:15.60, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'99', Cost:11.65, ParentId: '17'},
		]
	},
