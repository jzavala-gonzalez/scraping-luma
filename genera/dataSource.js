const timestamp_saved = '11/13/2023 06:00 AM';
const dataFechaAcualizado = '11/13/2023' + ' 1:56:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2418},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 172,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 87, MVar:'45', Cost:21.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'49', Cost:21.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'20', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 203, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 14,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'0', Cost:26.17, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'6', Cost:27.97, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'92', Cost:9.14, ParentId: '17'},
		]
	},
