const timestamp_saved = '11/10/2023 11:10 PM';
const dataFechaAcualizado = '11/10/2023' + ' 7:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.70, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'102', Cost:9.24, ParentId: '17'},
		]
	},
