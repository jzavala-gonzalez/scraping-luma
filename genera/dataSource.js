const timestamp_saved = '11/15/2023 06:05 PM';
const dataFechaAcualizado = '11/15/2023' + ' 2:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'60', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'60', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'60', Cost:10.34, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.01, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 195,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'161', Cost:19.35, ParentId: '16'},
		]
	},
