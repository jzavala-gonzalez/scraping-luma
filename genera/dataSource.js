const timestamp_saved = '11/21/2023 08:45 PM';
const dataFechaAcualizado = '11/21/2023' + ' 4:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'36', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'57', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 52, MVar:'9', Cost:22.17, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'165', Cost:18.19, ParentId: '16'},
		]
	},
