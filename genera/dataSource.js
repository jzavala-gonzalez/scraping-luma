const timestamp_saved = '09/28/2023 07:40 AM';
const dataFechaAcualizado = '9/28/2023' + ' 3:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'18', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'18', Cost:13.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'43', Cost:13.20, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'90', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'64', Cost:9.73, ParentId: '17'},
		]
	},
