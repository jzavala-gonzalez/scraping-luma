const timestamp_saved = '10/31/2023 11:05 PM';
const dataFechaAcualizado = '10/31/2023' + ' 7:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'62', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'68', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'70', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:26.22, ParentId: '8'},
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 149, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'172', Cost:16.71, ParentId: '16'},
		]
	},
