const timestamp_saved = '10/01/2023 12:10 AM';
const dataFechaAcualizado = '9/30/2023' + ' 8:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'38', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'53', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'10', Cost:23.00, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'9', Cost:30.87, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'11', Cost:31.28, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'150', Cost:17.15, ParentId: '16'},
		]
	},
