const timestamp_saved = '09/18/2023 02:05 AM';
const dataFechaAcualizado = '9/17/2023' + ' 10:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'52', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'49', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'63', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'22', Cost:18.80, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'78', Cost:16.93, ParentId: '15'},
