const timestamp_saved = '11/27/2023 06:00 AM';
const dataFechaAcualizado = '11/27/2023' + ' 1:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'23', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'33', Cost:10.83, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'105', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'65', Cost:9.83, ParentId: '17'},
		]
	},
