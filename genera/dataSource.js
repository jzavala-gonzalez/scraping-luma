const timestamp_saved = '09/27/2023 09:01 AM';
const dataFechaAcualizado = '9/27/2023' + ' 4:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'25', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'25', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:18.55, ParentId: '11'},
