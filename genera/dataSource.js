const timestamp_saved = '08/11/2023 07:10 AM';
const dataFechaAcualizado = '8/11/2023' + ' 3:05:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'22', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'52', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'47', Cost:10.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 113,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 128, MVar:'8', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 106,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'5', Cost:31.68, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'7', Cost:31.67, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 238,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 238, MVar:'87', Cost:12.12, ParentId: '17'},
		]
	},
