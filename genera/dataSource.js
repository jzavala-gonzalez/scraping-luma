const timestamp_saved = '10/02/2023 11:40 PM';
const dataFechaAcualizado = '10/2/2023' + ' 7:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'102', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'51', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'61', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'18', Cost:28.21, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:26.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:26.52, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'11', Cost:28.60, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'15', Cost:18.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'101', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'195', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'133', Cost:9.16, ParentId: '17'},
		]
	},
