const timestamp_saved = '11/20/2023 03:40 AM';
const dataFechaAcualizado = '11/19/2023' + ' 11:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'43', Cost:19.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'53', Cost:19.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:19.59, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'17', Cost:31.10, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'22', Cost:18.84, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'78', Cost:16.40, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 323, MVar:'175', Cost:16.91, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'115', Cost:9.16, ParentId: '17'},
		]
	},
