const timestamp_saved = '10/26/2023 02:05 PM';
const dataFechaAcualizado = '10/26/2023' + ' 10:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 132, MVar:'38', Cost:18.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.56, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'24', Cost:19.37, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'103', Cost:16.63, ParentId: '15'},
	...
	{Index:'20', Type:'Renovable', Desc:'Landfill', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Toa Baja', MW: 4, MVar:'0', Cost:10, ParentId: '20'},
