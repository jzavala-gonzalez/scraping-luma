const timestamp_saved = '10/08/2023 03:20 PM';
const dataFechaAcualizado = '10/8/2023' + ' 11:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'41', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'43', Cost:10.93, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'82', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 160,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 160, MVar:'78', Cost:11.44, ParentId: '17'},
		]
	},
