const timestamp_saved = '07/28/2023 08:02 AM';
const dataFechaAcualizado = '7/28/2023' + ' 3:55:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'41', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'40', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:20.43, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'30', Cost:15.42, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'74', Cost:13.17, ParentId: '17'},
		]
	},
