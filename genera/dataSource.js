const timestamp_saved = '10/29/2023 08:40 AM';
const dataFechaAcualizado = '10/29/2023' + ' 4:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'36', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'37', Cost:10.65, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'64', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'105', Cost:18.19, ParentId: '16'},
		]
	},
