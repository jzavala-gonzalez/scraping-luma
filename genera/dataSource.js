const timestamp_saved = '08/07/2023 02:30 AM';
const dataFechaAcualizado = '8/6/2023' + ' 10:25:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'103', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'60', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'57', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'52', Cost:10.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 173,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 152, MVar:'20', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'12', Cost:26.93, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'23', Cost:28.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'23', Cost:28.02, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 103,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'7', Cost:28.17, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'7', Cost:28.20, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'10', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'62', Cost:18.42, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'25', Cost:15.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'117', Cost:11.61, ParentId: '17'},
		]
	},
