const timestamp_saved = '11/19/2023 10:05 PM';
const dataFechaAcualizado = '11/19/2023' + ' 6:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:14.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'57', Cost:14.37, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.92, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'23', Cost:19.48, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 326, MVar:'183', Cost:17.11, ParentId: '16'},
		]
	},
