const timestamp_saved = '08/12/2023 06:45 PM';
const dataFechaAcualizado = '8/12/2023' + ' 2:42:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'75', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'3', Cost:165.23, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'146', Cost:17.99, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'109', Cost:11.78, ParentId: '17'},
		]
	},
