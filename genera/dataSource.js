const timestamp_saved = '11/27/2023 12:50 AM';
const dataFechaAcualizado = '11/26/2023' + ' 8:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'37', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'47', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'9', Cost:29.77, ParentId: '13'},
