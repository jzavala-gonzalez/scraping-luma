const timestamp_saved = '10/20/2023 10:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 6:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'43', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'17', Cost:30.89, ParentId: '10'},
