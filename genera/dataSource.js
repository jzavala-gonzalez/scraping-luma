const timestamp_saved = '11/20/2023 07:15 PM';
const dataFechaAcualizado = '11/20/2023' + ' 3:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'34', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'43', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'57', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'25', Cost:19.40, ParentId: '14'},
