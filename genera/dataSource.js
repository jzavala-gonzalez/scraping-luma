const timestamp_saved = '09/16/2023 02:50 PM';
const dataFechaAcualizado = '9/16/2023' + ' 10:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'38', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'39', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'57', Cost:12.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.20, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'23', Cost:19.44, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'100', Cost:19.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'79', Cost:9.46, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 104,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 40, MVar:'0', Cost:19.60, ParentId: '19'},
