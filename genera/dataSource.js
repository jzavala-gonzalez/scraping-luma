const timestamp_saved = '07/26/2023 09:38 AM';
const dataFechaAcualizado = '7/26/2023' + ' 5:30:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 225, MVar:'73', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'79', Cost:4.38, ParentId: '6'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:30.28, ParentId: '12'},
