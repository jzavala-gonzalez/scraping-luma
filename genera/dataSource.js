const timestamp_saved = '10/20/2023 07:05 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'37', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'39', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'60', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'79', Cost:10.53, ParentId: '17'},
		]
	},
