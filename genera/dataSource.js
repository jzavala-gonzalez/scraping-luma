const timestamp_saved = '11/07/2023 09:25 AM';
const dataFechaAcualizado = '11/7/2023' + ' 5:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'41', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'38', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'38', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'10', Cost:20.29, ParentId: '14'},
