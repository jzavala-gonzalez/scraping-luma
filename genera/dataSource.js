const timestamp_saved = '08/22/2023 03:50 PM';
const dataFechaAcualizado = '8/22/2023' + ' 11:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'51', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'129', Cost:17.80, ParentId: '16'},
		]
	},
