const timestamp_saved = '10/30/2023 11:30 PM';
const dataFechaAcualizado = '10/30/2023' + ' 7:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'63', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'66', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'69', Cost:10.37, ParentId: '7'},
		]
	},
