const timestamp_saved = '09/24/2023 02:10 PM';
const dataFechaAcualizado = '9/24/2023' + ' 10:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:11.30, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 303, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'81', Cost:9.54, ParentId: '17'},
		]
	},
