const timestamp_saved = '08/24/2023 05:00 PM';
const dataFechaAcualizado = '8/24/2023' + ' 12:55:45 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'79', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'91', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'62', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'64', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'59', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'34', Cost:18.36, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'191', Cost:17.85, ParentId: '16'},
		]
	},
