const timestamp_saved = '10/22/2023 12:35 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'36', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'39', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'44', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:18.11, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'53', Cost:11.20, ParentId: '17'},
		]
	},
