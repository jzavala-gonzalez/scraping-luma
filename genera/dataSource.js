const timestamp_saved = '12/03/2023 11:35 PM';
const dataFechaAcualizado = '12/3/2023' + ' 7:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'53', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'56', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'56', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'19', Cost:31.03, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:31.24, ParentId: '13'},
