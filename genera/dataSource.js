const timestamp_saved = '10/22/2023 04:25 PM';
const dataFechaAcualizado = '10/22/2023' + ' 12:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'48', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'49', Cost:10.49, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'136', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'67', Cost:11.22, ParentId: '17'},
		]
	},
