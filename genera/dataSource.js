const timestamp_saved = '08/23/2023 02:25 AM';
const dataFechaAcualizado = '8/22/2023' + ' 10:20:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 183, MVar:'63', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'46', Cost:11.29, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 56,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.63, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:31.46, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'74', Cost:16.99, ParentId: '15'},
