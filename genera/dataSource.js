const timestamp_saved = '09/27/2023 09:15 AM';
const dataFechaAcualizado = '9/27/2023' + ' 5:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'27', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'27', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'59', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'76', Cost:9.13, ParentId: '17'},
		]
	},
