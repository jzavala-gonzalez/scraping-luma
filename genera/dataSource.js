const timestamp_saved = '09/19/2023 02:25 AM';
const dataFechaAcualizado = '9/18/2023' + ' 10:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'56', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'68', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 107,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 57, MVar:'12', Cost:27.09, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'74', Cost:17.01, ParentId: '15'},
