const timestamp_saved = '09/06/2023 05:45 PM';
const dataFechaAcualizado = '9/6/2023' + ' 1:40:51 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3262},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'71', Cost:0, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'76', Cost:0, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'54', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'33', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:0, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:31.08, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:29.63, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:31.24, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.00, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'99', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'153', Cost:17.56, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 93,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 31, MVar:'14', Cost:17, ParentId: '19'},
		]
	},
