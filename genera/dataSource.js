const timestamp_saved = '11/08/2023 02:20 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'51', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 11,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 11, MVar:'6', Cost:45.73, ParentId: '14'},
