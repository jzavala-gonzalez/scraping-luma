const timestamp_saved = '09/28/2023 09:45 PM';
const dataFechaAcualizado = '9/28/2023' + ' 5:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'45', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'47', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'51', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'48', Cost:17.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.43, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'90', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 334, MVar:'155', Cost:16.84, ParentId: '16'},
		]
	},
