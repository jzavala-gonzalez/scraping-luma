const timestamp_saved = '08/18/2023 04:15 AM';
const dataFechaAcualizado = '8/18/2023' + ' 12:12:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'43', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'58', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'70', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:18.99, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 318,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 318, MVar:'72', Cost:9.31, ParentId: '17'},
		]
	},
