const timestamp_saved = '11/18/2023 10:50 AM';
const dataFechaAcualizado = '11/18/2023' + ' 6:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 293,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'41', Cost:15.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'63', Cost:15.49, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.03, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'75', Cost:17.11, ParentId: '15'},
