const timestamp_saved = '08/01/2023 03:20 AM';
const dataFechaAcualizado = '7/31/2023' + ' 11:15:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'40', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'8', Cost:22.39, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'1', Cost:31.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:31.03, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.38, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.38, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'77', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'32', Cost:15.55, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'137', Cost:17.27, ParentId: '16'},
		]
	},
