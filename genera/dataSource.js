const timestamp_saved = '11/13/2023 08:40 AM';
const dataFechaAcualizado = '11/13/2023' + ' 4:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'37', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'41', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'48', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'74', Cost:9.80, ParentId: '17'},
		]
	},
