const timestamp_saved = '09/29/2023 08:40 AM';
const dataFechaAcualizado = '9/29/2023' + ' 4:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'32', Cost:13.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'28', Cost:13.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'47', Cost:13.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'57', Cost:16.91, ParentId: '15'},
