const timestamp_saved = '08/07/2023 11:00 AM';
const dataFechaAcualizado = '8/7/2023' + ' 6:55:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'66', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'93', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'45', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'43', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.71, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'19', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 215,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 115, MVar:'23', Cost:16.48, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'100', Cost:11.67, ParentId: '17'},
		]
	},
