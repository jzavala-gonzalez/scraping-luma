const timestamp_saved = '10/07/2023 01:55 PM';
const dataFechaAcualizado = '10/7/2023' + ' 9:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 120, MVar:'47', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'44', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'48', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.49, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 90,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 33, MVar:'14', Cost:19.60, ParentId: '19'},
