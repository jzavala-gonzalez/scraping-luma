const timestamp_saved = '08/06/2023 10:30 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:25:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'43', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'38', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'40', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.48, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'82', Cost:17.29, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'17', Cost:16.06, ParentId: '15'},
		]
	},
