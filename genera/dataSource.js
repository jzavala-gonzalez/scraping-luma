const timestamp_saved = '10/14/2023 08:55 PM';
const dataFechaAcualizado = '10/14/2023' + ' 4:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'63', Cost:10.50, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'49', Cost:16.91, ParentId: '11'},
