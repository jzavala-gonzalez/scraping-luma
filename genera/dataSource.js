const timestamp_saved = '11/07/2023 01:35 PM';
const dataFechaAcualizado = '11/7/2023' + ' 9:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'47', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'44', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'43', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'85', Cost:9.79, ParentId: '17'},
		]
	},
