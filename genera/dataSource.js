const timestamp_saved = '10/14/2023 12:15 PM';
const dataFechaAcualizado = '10/14/2023' + ' 8:11:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'46', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:11.14, ParentId: '7'},
