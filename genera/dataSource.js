const timestamp_saved = '12/06/2023 08:25 AM';
const dataFechaAcualizado = '12/6/2023' + ' 4:20:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'40', Cost:12.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'43', Cost:12.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'52', Cost:12.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'50', Cost:14.53, ParentId: '17'},
		]
	},
