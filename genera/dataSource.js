const timestamp_saved = '10/08/2023 11:25 PM';
const dataFechaAcualizado = '10/8/2023' + ' 7:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'57', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'58', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'53', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'34', Cost:17.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:17.54, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'89', Cost:16.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'176', Cost:16.66, ParentId: '16'},
		]
	},
