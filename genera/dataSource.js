const timestamp_saved = '07/28/2023 11:10 PM';
const dataFechaAcualizado = '7/28/2023' + ' 7:05:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'50', Cost:10.67, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'2', Cost:22.44, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:31.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'0', Cost:8.23, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:8.23, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:32.18, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.71, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:32.32, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 161, MVar:'27', Cost:15.54, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'89', Cost:13.65, ParentId: '17'},
		]
	},
