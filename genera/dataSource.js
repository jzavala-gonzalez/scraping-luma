const timestamp_saved = '09/06/2023 05:55 PM';
const dataFechaAcualizado = '9/6/2023' + ' 1:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'55', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'32', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'49', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'15', Cost:31.25, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'7', Cost:29.61, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'26', Cost:19.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'97', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'155', Cost:17.66, ParentId: '16'},
		]
	},
