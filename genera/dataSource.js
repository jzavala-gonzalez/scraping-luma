const timestamp_saved = '12/05/2023 07:50 AM';
const dataFechaAcualizado = '12/5/2023' + ' 3:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'38', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'40', Cost:11.55, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 160,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 89, MVar:'17', Cost:18.80, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.42, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'46', Cost:11.61, ParentId: '17'},
		]
	},
