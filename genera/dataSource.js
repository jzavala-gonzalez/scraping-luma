const timestamp_saved = '11/12/2023 08:10 AM';
const dataFechaAcualizado = '11/12/2023' + ' 4:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'38', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'40', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'74', Cost:9.64, ParentId: '17'},
		]
	},
