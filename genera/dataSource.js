const timestamp_saved = '11/23/2023 09:35 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'17', Cost:13.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'28', Cost:13.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'46', Cost:13.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'66', Cost:9.23, ParentId: '17'},
		]
	},
