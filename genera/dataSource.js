const timestamp_saved = '10/12/2023 04:55 AM';
const dataFechaAcualizado = '10/12/2023' + ' 12:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'57', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'60', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'66', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:40.72, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:18.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.01, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'46', Cost:8.53, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'11', Cost:8.53, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'178', Cost:16.39, ParentId: '16'},
		]
	},
