const timestamp_saved = '11/20/2023 06:35 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'27', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'36', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'56', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 50,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 20, MVar:'1', Cost:29.99, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'14', Cost:18.94, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'65', Cost:17.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 215,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'144', Cost:18.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'85', Cost:9.17, ParentId: '17'},
		]
	},
