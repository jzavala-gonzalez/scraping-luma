const timestamp_saved = '09/06/2023 06:50 PM';
const dataFechaAcualizado = '9/6/2023' + ' 2:45:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'62', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'38', Cost:10.66, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 41,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 122, MVar:'56', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'161', Cost:17.67, ParentId: '16'},
		]
	},
