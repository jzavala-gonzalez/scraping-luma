const timestamp_saved = '12/01/2023 11:05 PM';
const dataFechaAcualizado = '12/1/2023' + ' 7:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'56', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'59', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:12.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 20, MVar:'0', Cost:30.85, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 47, MVar:'5', Cost:29.40, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'99', Cost:9.18, ParentId: '17'},
		]
	},
