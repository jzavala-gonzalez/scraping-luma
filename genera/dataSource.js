const timestamp_saved = '10/29/2023 10:25 PM';
const dataFechaAcualizado = '10/29/2023' + ' 6:21:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'49', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'48', Cost:10.33, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 333, MVar:'140', Cost:16.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 213,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 213, MVar:'59', Cost:10.32, ParentId: '17'},
		]
	},
