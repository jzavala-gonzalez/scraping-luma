const timestamp_saved = '11/01/2023 03:40 PM';
const dataFechaAcualizado = '11/1/2023' + ' 11:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'58', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'62', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'38', Cost:18.24, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.28, ParentId: '14'},
