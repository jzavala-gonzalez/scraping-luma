const timestamp_saved = '09/29/2023 02:55 PM';
const dataFechaAcualizado = '9/29/2023' + ' 10:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'36', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'50', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.79, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 65, MVar:'13', Cost:20.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'102', Cost:17.09, ParentId: '15'},
