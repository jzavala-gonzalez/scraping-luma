const timestamp_saved = '08/18/2023 07:15 AM';
const dataFechaAcualizado = '8/18/2023' + ' 3:12:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'51', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'65', Cost:11.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 86, MVar:'0', Cost:0.15, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'10', Cost:19.17, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'58', Cost:9.43, ParentId: '17'},
		]
	},
