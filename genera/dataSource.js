const timestamp_saved = '10/11/2023 07:10 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'46', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'50', Cost:12.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'57', Cost:12.63, ParentId: '7'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 74,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.64, ParentId: '21'},
