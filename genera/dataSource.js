const timestamp_saved = '10/25/2023 02:30 PM';
const dataFechaAcualizado = '10/25/2023' + ' 10:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'49', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'151', Cost:17.59, ParentId: '16'},
		]
	},
