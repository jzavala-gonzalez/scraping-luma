const timestamp_saved = '10/28/2023 08:30 PM';
const dataFechaAcualizado = '10/28/2023' + ' 4:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'52', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 225,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:25.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.62, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 100, MVar:'31', Cost:20.37, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'6', Cost:20.37, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'7', Cost:30.08, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.19, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'17', Cost:21.70, ParentId: '14'},
