const timestamp_saved = '10/27/2023 01:00 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'49', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'50', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'55', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.63, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:16.63, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'50', Cost:16.93, ParentId: '11'},
