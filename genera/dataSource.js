const timestamp_saved = '08/04/2023 01:35 PM';
const dataFechaAcualizado = '8/4/2023' + ' 9:30:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'45', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'47', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'87', Cost:17.97, ParentId: '15'},
