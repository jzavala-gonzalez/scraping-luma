const timestamp_saved = '11/27/2023 12:05 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'26', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'36', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'52', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'78', Cost:9.83, ParentId: '17'},
		]
	},
