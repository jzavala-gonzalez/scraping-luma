const timestamp_saved = '10/15/2023 08:25 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'46', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'49', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'52', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'123', Cost:17.21, ParentId: '16'},
		]
	},
