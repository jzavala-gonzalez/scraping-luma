const timestamp_saved = '11/06/2023 01:35 AM';
const dataFechaAcualizado = '11/5/2023' + ' 9:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'51', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'51', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 195,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:22.81, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:22.29, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:16.91, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.26, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 65, MVar:'8', Cost:20.11, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'78', Cost:9.24, ParentId: '17'},
		]
	},
