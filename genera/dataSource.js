const timestamp_saved = '07/29/2023 09:40 AM';
const dataFechaAcualizado = '7/29/2023' + ' 5:35:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:31.37, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 276,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'81', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 136, MVar:'25', Cost:16.00, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'79', Cost:13.63, ParentId: '17'},
		]
	},
