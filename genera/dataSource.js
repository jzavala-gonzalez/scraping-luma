const timestamp_saved = '11/05/2023 12:45 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'42', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'41', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'41', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'49', Cost:9.80, ParentId: '17'},
		]
	},
