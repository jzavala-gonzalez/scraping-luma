const timestamp_saved = '08/22/2023 12:35 AM';
const dataFechaAcualizado = '8/21/2023' + ' 8:30:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'54', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'57', Cost:10.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 88, MVar:'0', Cost:9.27, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 137, MVar:'75', Cost:17.19, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'76', Cost:9.18, ParentId: '17'},
		]
	},
