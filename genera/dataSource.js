const timestamp_saved = '08/15/2023 05:35 AM';
const dataFechaAcualizado = '8/15/2023' + ' 1:32:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'69', Cost:4.39, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'48', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'51', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'2', Cost:23.01, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.19, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:26.14, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'119', Cost:11.64, ParentId: '17'},
		]
	},
