const timestamp_saved = '08/01/2023 10:40 AM';
const dataFechaAcualizado = '8/1/2023' + ' 6:35:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'42', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'86', Cost:11.00, ParentId: '17'},
		]
	},
