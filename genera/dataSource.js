const timestamp_saved = '07/28/2023 10:55 PM';
const dataFechaAcualizado = '7/28/2023' + ' 6:50:33 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2643},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'69', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'49', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'2', Cost:22.41, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:31.26, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'5', Cost:31.41, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'15', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 320,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'91', Cost:16.70, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'26', Cost:15.56, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'86', Cost:13.58, ParentId: '17'},
		]
	},
