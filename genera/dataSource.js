const timestamp_saved = '10/25/2023 07:00 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'51', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'52', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 40,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'15', Cost:45.65, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'153', Cost:17.38, ParentId: '16'},
		]
	},
