const timestamp_saved = '08/02/2023 06:10 AM';
const dataFechaAcualizado = '8/2/2023' + ' 2:05:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'42', Cost:10.75, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'0', Cost:26.08, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 268,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'62', Cost:17.30, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 138, MVar:'40', Cost:15.78, ParentId: '15'},
		]
	},
