const timestamp_saved = '10/14/2023 02:10 PM';
const dataFechaAcualizado = '10/14/2023' + ' 10:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'46', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'45', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'49', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'72', Cost:9.28, ParentId: '17'},
		]
	},
