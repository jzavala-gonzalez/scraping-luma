const timestamp_saved = '11/14/2023 04:15 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'49', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'52', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'55', Cost:11.86, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.05, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 105, MVar:'142', Cost:25.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'104', Cost:10.92, ParentId: '17'},
		]
	},
