const timestamp_saved = '10/18/2023 10:40 PM';
const dataFechaAcualizado = '10/18/2023' + ' 6:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'51', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'56', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'66', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:16.54, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.12, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'9', Cost:29.81, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'101', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'116', Cost:10.52, ParentId: '17'},
		]
	},
