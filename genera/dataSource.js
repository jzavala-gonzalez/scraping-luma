const timestamp_saved = '11/23/2023 11:20 PM';
const dataFechaAcualizado = '11/23/2023' + ' 7:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'32', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'41', Cost:11.03, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'94', Cost:9.17, ParentId: '17'},
		]
	},
