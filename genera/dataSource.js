const timestamp_saved = '10/20/2023 07:45 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'32', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'39', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'39', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'76', Cost:10.54, ParentId: '17'},
		]
	},
