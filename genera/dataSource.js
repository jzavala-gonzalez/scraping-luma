const timestamp_saved = '09/20/2023 07:40 PM';
const dataFechaAcualizado = '9/20/2023' + ' 3:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'55', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'58', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'62', Cost:10.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 83,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 14, MVar:'0', Cost:41.64, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:8.71, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'31', Cost:26.76, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'89', Cost:16.86, ParentId: '15'},
