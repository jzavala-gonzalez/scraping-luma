const timestamp_saved = '09/23/2023 07:25 AM';
const dataFechaAcualizado = '9/23/2023' + ' 3:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'69', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'39', Cost:0, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'41', Cost:0, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'56', Cost:0, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'1', Cost:31.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'3', Cost:30.75, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'45', Cost:19.82, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'51', Cost:16.90, ParentId: '15'},
