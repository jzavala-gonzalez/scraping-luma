const timestamp_saved = '10/30/2023 05:15 AM';
const dataFechaAcualizado = '10/30/2023' + ' 1:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'36', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'39', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'63', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'10', Cost:19.10, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 114, MVar:'72', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 207,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 207, MVar:'108', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'42', Cost:9.64, ParentId: '17'},
		]
	},
