const timestamp_saved = '08/23/2023 11:40 PM';
const dataFechaAcualizado = '8/23/2023' + ' 7:35:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'62', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'60', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'57', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:23.12, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'16', Cost:30.87, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'26', Cost:18.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'181', Cost:16.77, ParentId: '16'},
		]
	},
