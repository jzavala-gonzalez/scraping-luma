const timestamp_saved = '08/01/2023 02:55 PM';
const dataFechaAcualizado = '8/1/2023' + ' 10:50:36 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1021},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'46', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'49', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'37', Cost:15.94, ParentId: '15'},
		]
	},
