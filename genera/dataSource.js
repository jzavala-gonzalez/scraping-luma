const timestamp_saved = '10/29/2023 12:05 PM';
const dataFechaAcualizado = '10/29/2023' + ' 8:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'44', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'44', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'68', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 26,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 19, MVar:'5', Cost:19.60, ParentId: '19'},
