const timestamp_saved = '08/27/2023 06:50 PM';
const dataFechaAcualizado = '8/27/2023' + ' 2:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'30', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'32', Cost:10.40, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:30.42, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:19.94, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:19.94, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.63, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:8.63, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 239,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 239, MVar:'84', Cost:12.52, ParentId: '17'},
		]
	},
