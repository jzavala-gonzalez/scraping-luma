const timestamp_saved = '10/22/2023 05:55 PM';
const dataFechaAcualizado = '10/22/2023' + ' 1:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'47', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:10.37, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 10,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 19, MVar:'8', Cost:0, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'73', Cost:16.88, ParentId: '15'},
