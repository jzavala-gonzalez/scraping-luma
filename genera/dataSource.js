const timestamp_saved = '08/06/2023 06:00 AM';
const dataFechaAcualizado = '8/6/2023' + ' 1:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'94', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'44', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'44', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'16', Cost:30.60, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'18', Cost:30.43, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:30.50, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:30.50, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 329,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'88', Cost:16.52, ParentId: '15'},
