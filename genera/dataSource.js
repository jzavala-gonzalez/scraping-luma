const timestamp_saved = '08/05/2023 12:25 PM';
const dataFechaAcualizado = '8/5/2023' + ' 8:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'46', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'41', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'46', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 198,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'7', Cost:22.57, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:8.59, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'0', Cost:8.59, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'7', Cost:32.12, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 339,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'90', Cost:16.58, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'93', Cost:11.56, ParentId: '17'},
		]
	},
