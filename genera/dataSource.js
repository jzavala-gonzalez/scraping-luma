const timestamp_saved = '10/21/2023 12:11 AM';
const dataFechaAcualizado = '10/20/2023' + ' 8:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'44', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'53', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'49', Cost:10.59, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:28.02, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 22, MVar:'0', Cost:29.31, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'109', Cost:10.54, ParentId: '17'},
		]
	},
