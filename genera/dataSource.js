const timestamp_saved = '10/14/2023 03:30 AM';
const dataFechaAcualizado = '10/13/2023' + ' 11:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'61', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'66', Cost:10.27, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'153', Cost:16.92, ParentId: '16'},
		]
	},
