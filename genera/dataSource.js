const timestamp_saved = '09/25/2023 06:20 AM';
const dataFechaAcualizado = '9/25/2023' + ' 2:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'44', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'47', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:20.13, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'0', Cost:16.94, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'0', Cost:16.94, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'53', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'94', Cost:9.32, ParentId: '17'},
		]
	},
