const timestamp_saved = '11/22/2023 12:35 AM';
const dataFechaAcualizado = '11/21/2023' + ' 8:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'40', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'50', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'61', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'7', Cost:17.49, ParentId: '11'},
