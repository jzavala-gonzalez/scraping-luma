const timestamp_saved = '09/20/2023 10:50 AM';
const dataFechaAcualizado = '9/20/2023' + ' 6:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'47', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'49', Cost:10.87, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'54', Cost:18.40, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'139', Cost:18.15, ParentId: '16'},
		]
	},
