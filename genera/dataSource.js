const timestamp_saved = '08/22/2023 06:25 AM';
const dataFechaAcualizado = '8/22/2023' + ' 2:20:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'42', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'48', Cost:10.55, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'53', Cost:9.98, ParentId: '17'},
		]
	},
