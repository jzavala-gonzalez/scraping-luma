const timestamp_saved = '09/08/2023 12:25 PM';
const dataFechaAcualizado = '9/8/2023' + ' 8:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'60', Cost:10.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'61', Cost:10.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'53', Cost:10.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 106,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 106, MVar:'0', Cost:7.37, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'14', Cost:30.69, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:19.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:19.61, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 153, MVar:'0', Cost:8.62, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'11', Cost:8.62, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'82', Cost:16.21, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'144', Cost:17.18, ParentId: '16'},
		]
	},
