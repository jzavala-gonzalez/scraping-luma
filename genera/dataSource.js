const timestamp_saved = '09/22/2023 10:25 PM';
const dataFechaAcualizado = '9/22/2023' + ' 6:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 228, MVar:'74', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'79', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 509,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'50', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 164, MVar:'66', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 152,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 153, MVar:'60', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.48, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'1', Cost:22.29, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 72, MVar:'8', Cost:29.38, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'6', Cost:30.78, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:8.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:8.25, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'0', Cost:8.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'0', Cost:8.17, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:29.30, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 79,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'8', Cost:29.52, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'73', Cost:16.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'123', Cost:32.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'106', Cost:9.13, ParentId: '17'},
		]
	},
