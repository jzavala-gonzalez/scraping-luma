const timestamp_saved = '10/29/2023 10:45 PM';
const dataFechaAcualizado = '10/29/2023' + ' 6:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 149, MVar:'72', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 213,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 213, MVar:'63', Cost:10.31, ParentId: '17'},
		]
	},
