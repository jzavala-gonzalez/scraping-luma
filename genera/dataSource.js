const timestamp_saved = '09/20/2023 05:45 PM';
const dataFechaAcualizado = '9/20/2023' + ' 1:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'56', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'57', Cost:10.68, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'156', Cost:18.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'89', Cost:9.27, ParentId: '17'},
		]
	},
