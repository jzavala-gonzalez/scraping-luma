const timestamp_saved = '09/20/2023 04:55 AM';
const dataFechaAcualizado = '9/20/2023' + ' 12:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'48', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'50', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:22.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'6', Cost:22.22, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'80', Cost:9.08, ParentId: '17'},
		]
	},
