const timestamp_saved = '12/02/2023 04:10 PM';
const dataFechaAcualizado = '12/2/2023' + ' 12:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 178,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 179, MVar:'74', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'44', Cost:12.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'45', Cost:12.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'45', Cost:12.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.75, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'65', Cost:11.92, ParentId: '17'},
		]
	},
