const timestamp_saved = '10/11/2023 03:16 PM';
const dataFechaAcualizado = '10/11/2023' + ' 11:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 240,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'80', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'58', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'62', Cost:10.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 274,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:19.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'8', Cost:19.16, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'41', Cost:17.37, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'8', Cost:17.37, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'75', Cost:9.68, ParentId: '17'},
		]
	},
