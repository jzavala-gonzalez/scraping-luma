const timestamp_saved = '10/14/2023 11:30 AM';
const dataFechaAcualizado = '10/14/2023' + ' 7:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'48', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'47', Cost:10.92, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:18.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:18.67, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'78', Cost:17.49, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 22,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'5', Cost:19.60, ParentId: '19'},
