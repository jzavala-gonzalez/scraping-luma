const timestamp_saved = '08/03/2023 03:35 PM';
const dataFechaAcualizado = '8/3/2023' + ' 11:30:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'44', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'47', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 295,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'108', Cost:17.11, ParentId: '15'},
