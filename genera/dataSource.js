const timestamp_saved = '12/06/2023 06:35 PM';
const dataFechaAcualizado = '12/6/2023' + ' 2:30:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 405},
	{Index:'6', Desc:'Reserva Operacional', value: 769},
	{Index:'7', Desc:'Capacidad Disponible', value: 3018},
	{Index:'8', Desc:'Próxima Hora MW', value: 2243},
	{Index:'9', Desc:'Máxima para Hoy', value: 2253},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'57', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'62', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 133, MVar:'42', Cost:8.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:8.55, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'80', Cost:14.51, ParentId: '17'},
		]
	},
