const timestamp_saved = '09/09/2023 05:20 PM';
const dataFechaAcualizado = '9/9/2023' + ' 1:15:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'57', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'64', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'58', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:29.91, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:30.20, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'6', Cost:31.43, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'22', Cost:18.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'88', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 266,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 266, MVar:'156', Cost:17.61, ParentId: '16'},
		]
	},
