const timestamp_saved = '10/14/2023 12:40 AM';
const dataFechaAcualizado = '10/13/2023' + ' 8:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'72', Cost:9.74, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'5', Cost:26.40, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'47', Cost:16.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'88', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'197', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'120', Cost:9.15, ParentId: '17'},
		]
	},
