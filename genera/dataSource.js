const timestamp_saved = '09/20/2023 02:40 PM';
const dataFechaAcualizado = '9/20/2023' + ' 10:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'50', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'52', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'63', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'146', Cost:18.14, ParentId: '16'},
		]
	},
