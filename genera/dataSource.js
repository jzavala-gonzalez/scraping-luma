const timestamp_saved = '10/15/2023 09:05 PM';
const dataFechaAcualizado = '10/15/2023' + ' 5:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'56', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'55', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 14, MVar:'0', Cost:36.50, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'8', Cost:43.82, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'10', Cost:29.44, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.55, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'11', Cost:29.64, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'21', Cost:19.13, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'102', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'173', Cost:16.64, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 20,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'20', Cost:19.60, ParentId: '19'},
