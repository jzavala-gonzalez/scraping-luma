const timestamp_saved = '10/11/2023 05:25 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:21:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'58', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'61', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'66', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 355,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.07, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 142, MVar:'44', Cost:17.10, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'173', Cost:17.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'85', Cost:9.12, ParentId: '17'},
		]
	},
