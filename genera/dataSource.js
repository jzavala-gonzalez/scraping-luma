const timestamp_saved = '10/03/2023 12:15 PM';
const dataFechaAcualizado = '10/3/2023' + ' 8:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'38', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:25.65, ParentId: '11'},
