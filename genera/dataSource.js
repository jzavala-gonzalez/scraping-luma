const timestamp_saved = '09/07/2023 04:25 PM';
const dataFechaAcualizado = '9/7/2023' + ' 12:20:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'47', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'51', Cost:10.25, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 111,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 111, MVar:'0', Cost:7.42, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 116, MVar:'56', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'24', Cost:30.99, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:19.82, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'31', Cost:19.59, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'96', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'154', Cost:17.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'106', Cost:9.77, ParentId: '17'},
		]
	},
