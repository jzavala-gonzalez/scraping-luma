const timestamp_saved = '11/22/2023 01:40 PM';
const dataFechaAcualizado = '11/22/2023' + ' 9:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'32', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'42', Cost:10.85, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'170', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'90', Cost:9.75, ParentId: '17'},
		]
	},
