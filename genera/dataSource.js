const timestamp_saved = '10/03/2023 04:16 PM';
const dataFechaAcualizado = '10/3/2023' + ' 12:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'42', Cost:10.17, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 261, MVar:'167', Cost:17.76, ParentId: '16'},
		]
	},
