const timestamp_saved = '09/17/2023 08:10 AM';
const dataFechaAcualizado = '9/17/2023' + ' 4:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'37', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'38', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'56', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'83', Cost:9.12, ParentId: '17'},
		]
	},
