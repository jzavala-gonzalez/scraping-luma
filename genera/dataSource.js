const timestamp_saved = '10/22/2023 08:35 PM';
const dataFechaAcualizado = '10/22/2023' + ' 4:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'49', Cost:10.15, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'132', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'69', Cost:11.32, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 27,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 20, MVar:'12', Cost:19.60, ParentId: '19'},
