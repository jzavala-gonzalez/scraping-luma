const timestamp_saved = '07/25/2023 11:03 AM';
const dataFechaAcualizado = '7/25/2023' + ' 6:55:30 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2578},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'82', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'52', Cost:9.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'65', Cost:9.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 204, MVar:'57', Cost:9.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'5', Cost:27.03, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'9', Cost:27.91, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.47, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 66,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'9', Cost:29.59, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'20', Cost:18.67, ParentId: '14'},
