const timestamp_saved = '09/28/2023 02:50 AM';
const dataFechaAcualizado = '9/27/2023' + ' 10:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'30', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'30', Cost:11.23, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.14, ParentId: '13'},
