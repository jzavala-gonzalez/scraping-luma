const timestamp_saved = '11/04/2023 02:40 AM';
const dataFechaAcualizado = '11/3/2023' + ' 10:36:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'53', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'53', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.04, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:16.93, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 21,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'1', Cost:29.59, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 17, MVar:'0', Cost:30.30, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'14', Cost:21.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'75', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'83', Cost:9.22, ParentId: '17'},
		]
	},
