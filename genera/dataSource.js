const timestamp_saved = '10/30/2023 01:05 PM';
const dataFechaAcualizado = '10/30/2023' + ' 9:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'53', Cost:10.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'36', Cost:17.35, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'81', Cost:9.54, ParentId: '17'},
		]
	},
