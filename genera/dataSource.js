const timestamp_saved = '11/25/2023 02:00 AM';
const dataFechaAcualizado = '11/24/2023' + ' 9:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 103,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 102, MVar:'96', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'30', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'42', Cost:12.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'55', Cost:12.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'26', Cost:27.93, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:38.80, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'5', Cost:28.07, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'151', Cost:16.76, ParentId: '16'},
		]
	},
