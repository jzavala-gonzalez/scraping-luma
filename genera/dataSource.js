const timestamp_saved = '09/23/2023 07:30 AM';
const dataFechaAcualizado = '9/23/2023' + ' 3:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'39', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'41', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'55', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'1', Cost:31.14, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'3', Cost:31.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'45', Cost:19.95, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'49', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'70', Cost:9.43, ParentId: '17'},
		]
	},
