const timestamp_saved = '07/28/2023 04:06 AM';
const dataFechaAcualizado = '7/28/2023' + ' 12:00:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'49', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'50', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'48', Cost:10.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 74, MVar:'0', Cost:6.68, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'2', Cost:22.38, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 294,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:9.47, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:9.47, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:30.74, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:30.27, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 20,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'0', Cost:35.04, ParentId: '13'},
