const timestamp_saved = '09/27/2023 11:25 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'28', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'28', Cost:11.06, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:18.42, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'79', Cost:9.30, ParentId: '17'},
		]
	},
