const timestamp_saved = '08/22/2023 12:45 AM';
const dataFechaAcualizado = '8/21/2023' + ' 8:40:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'56', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'53', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.62, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 88, MVar:'0', Cost:9.43, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.57, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 137, MVar:'75', Cost:17.15, ParentId: '15'},
