const timestamp_saved = '09/29/2023 03:56 PM';
const dataFechaAcualizado = '9/29/2023' + ' 11:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'38', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'36', Cost:10.75, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'45', Cost:17.74, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:17.74, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'14', Cost:19.11, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'127', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'94', Cost:9.43, ParentId: '17'},
		]
	},
