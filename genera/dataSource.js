const timestamp_saved = '08/22/2023 03:55 AM';
const dataFechaAcualizado = '8/21/2023' + ' 11:50:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'50', Cost:11.15, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 9, MVar:'2', Cost:29.14, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 203,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 203, MVar:'123', Cost:18.90, ParentId: '16'},
		]
	},
