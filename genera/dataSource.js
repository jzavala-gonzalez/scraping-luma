const timestamp_saved = '11/11/2023 04:50 PM';
const dataFechaAcualizado = '11/11/2023' + ' 12:46:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'42', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'44', Cost:11.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:17.95, ParentId: '11'},
