const timestamp_saved = '08/16/2023 08:15 AM';
const dataFechaAcualizado = '8/16/2023' + ' 4:12:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'49', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'58', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'78', Cost:10.48, ParentId: '17'},
		]
	},
