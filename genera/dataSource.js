const timestamp_saved = '11/16/2023 03:35 PM';
const dataFechaAcualizado = '11/16/2023' + ' 11:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'51', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'51', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'80', Cost:9.99, ParentId: '17'},
		]
	},
