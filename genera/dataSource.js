const timestamp_saved = '08/06/2023 10:55 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:50:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'38', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'39', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.45, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'81', Cost:17.32, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'18', Cost:16.05, ParentId: '15'},
		]
	},
