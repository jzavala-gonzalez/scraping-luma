const timestamp_saved = '10/03/2023 11:40 PM';
const dataFechaAcualizado = '10/3/2023' + ' 7:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'46', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'43', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'56', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 188,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'11', Cost:23.03, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.80, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:16.80, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'0', Cost:16.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'15', Cost:18.88, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'166', Cost:16.55, ParentId: '16'},
		]
	},
