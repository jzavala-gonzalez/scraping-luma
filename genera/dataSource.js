const timestamp_saved = '08/21/2023 06:45 PM';
const dataFechaAcualizado = '8/21/2023' + ' 2:40:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'37', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'58', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'17', Cost:19.46, ParentId: '14'},
