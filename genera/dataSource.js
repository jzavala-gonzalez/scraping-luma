const timestamp_saved = '10/07/2023 09:05 PM';
const dataFechaAcualizado = '10/7/2023' + ' 5:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 186,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 186, MVar:'67', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'56', Cost:10.13, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:17.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'5', Cost:17.50, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'13', Cost:20.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'102', Cost:16.46, ParentId: '15'},
