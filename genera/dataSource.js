const timestamp_saved = '12/06/2023 04:05 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:00:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Capacidad Disponible', value: 3022},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'47', Cost:12.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'50', Cost:12.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'58', Cost:12.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'67', Cost:14.57, ParentId: '17'},
		]
	},
