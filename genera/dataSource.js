const timestamp_saved = '10/02/2023 12:50 PM';
const dataFechaAcualizado = '10/2/2023' + ' 8:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'35', Cost:11.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'40', Cost:17.57, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.57, ParentId: '11'},
