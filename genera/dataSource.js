const timestamp_saved = '10/31/2023 01:00 PM';
const dataFechaAcualizado = '10/31/2023' + ' 8:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'60', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'59', Cost:10.15, ParentId: '7'},
		]
	},
