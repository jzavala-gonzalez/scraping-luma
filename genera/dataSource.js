const timestamp_saved = '11/19/2023 10:35 AM';
const dataFechaAcualizado = '11/19/2023' + ' 6:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'39', Cost:15.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'48', Cost:15.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:15.09, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:25.97, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'14', Cost:19.31, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'74', Cost:16.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'92', Cost:9.91, ParentId: '17'},
		]
	},
