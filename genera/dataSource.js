const timestamp_saved = '09/13/2023 02:35 PM';
const dataFechaAcualizado = '9/13/2023' + ' 10:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'53', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'52', Cost:12.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'66', Cost:12.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'14', Cost:28.28, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'154', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'98', Cost:9.14, ParentId: '17'},
		]
	},
