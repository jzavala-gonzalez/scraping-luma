const timestamp_saved = '10/11/2023 05:10 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'57', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'62', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:11.06, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 35, MVar:'0', Cost:26.24, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'25', Cost:9.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:9.99, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'179', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'86', Cost:9.13, ParentId: '17'},
		]
	},
