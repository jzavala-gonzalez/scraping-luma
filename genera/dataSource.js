const timestamp_saved = '10/23/2023 12:30 PM';
const dataFechaAcualizado = '10/23/2023' + ' 8:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'47', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'46', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'130', Cost:17.13, ParentId: '16'},
		]
	},
