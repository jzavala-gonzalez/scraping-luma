const timestamp_saved = '11/07/2023 09:35 PM';
const dataFechaAcualizado = '11/7/2023' + ' 5:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'54', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'52', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'52', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:112.60, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 59, MVar:'12', Cost:20.57, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'76', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'107', Cost:9.16, ParentId: '17'},
		]
	},
