const timestamp_saved = '09/23/2023 11:50 AM';
const dataFechaAcualizado = '9/23/2023' + ' 7:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'40', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'41', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'56', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:20.05, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'11', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'49', Cost:19.63, ParentId: '15'},
