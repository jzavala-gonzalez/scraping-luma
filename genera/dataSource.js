const timestamp_saved = '10/12/2023 04:00 PM';
const dataFechaAcualizado = '10/12/2023' + ' 11:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'56', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'61', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'66', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.49, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'170', Cost:17.33, ParentId: '16'},
		]
	},
