const timestamp_saved = '10/04/2023 06:35 AM';
const dataFechaAcualizado = '10/4/2023' + ' 2:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'35', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'34', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'136', Cost:18.25, ParentId: '16'},
		]
	},
