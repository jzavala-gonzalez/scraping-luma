const timestamp_saved = '11/14/2023 04:00 PM';
const dataFechaAcualizado = '11/14/2023' + ' 11:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'50', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'54', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'57', Cost:11.68, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:32.31, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:30.81, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 95, MVar:'125', Cost:30.40, ParentId: '16'},
		]
	},
