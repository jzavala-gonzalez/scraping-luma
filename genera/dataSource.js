const timestamp_saved = '09/01/2023 07:05 AM';
const dataFechaAcualizado = '9/1/2023' + ' 3:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'38', Cost:12.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'45', Cost:12.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'56', Cost:12.64, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'5', Cost:30.76, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:17.03, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'9', Cost:17.03, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'71', Cost:9.19, ParentId: '17'},
		]
	},
