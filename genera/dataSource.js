const timestamp_saved = '11/15/2023 06:15 AM';
const dataFechaAcualizado = '11/15/2023' + ' 2:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'37', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'40', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'45', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'6', Cost:30.96, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'59', Cost:16.90, ParentId: '15'},
