const timestamp_saved = '07/29/2023 04:35 AM';
const dataFechaAcualizado = '7/29/2023' + ' 12:30:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'50', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:26.74, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.85, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'87', Cost:16.70, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 314,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 314, MVar:'89', Cost:13.35, ParentId: '17'},
		]
	},
