const timestamp_saved = '10/09/2023 03:20 PM';
const dataFechaAcualizado = '10/9/2023' + ' 11:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'89', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'55', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'50', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:26.50, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 12,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 12, MVar:'7', Cost:0, ParentId: '12'},
