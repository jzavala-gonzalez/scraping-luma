const timestamp_saved = '10/15/2023 06:20 AM';
const dataFechaAcualizado = '10/15/2023' + ' 2:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'50', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'53', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'54', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'69', Cost:9.15, ParentId: '17'},
		]
	},
