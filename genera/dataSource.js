const timestamp_saved = '08/31/2023 08:05 AM';
const dataFechaAcualizado = '8/31/2023' + ' 4:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'44', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'82', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'39', Cost:10.69, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:17.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.05, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'18', Cost:18.82, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 239,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 239, MVar:'68', Cost:9.99, ParentId: '17'},
		]
	},
