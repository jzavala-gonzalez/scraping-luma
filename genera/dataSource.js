const timestamp_saved = '09/27/2023 11:10 AM';
const dataFechaAcualizado = '9/27/2023' + ' 7:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'25', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'25', Cost:11.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'59', Cost:11.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'10', Cost:17.81, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'78', Cost:9.25, ParentId: '17'},
		]
	},
