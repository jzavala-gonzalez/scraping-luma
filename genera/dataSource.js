const timestamp_saved = '11/27/2023 12:50 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'30', Cost:11.15, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'155', Cost:18.24, ParentId: '16'},
		]
	},
