const timestamp_saved = '10/28/2023 03:30 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'40', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'42', Cost:13.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'48', Cost:13.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 150,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'20', Cost:30.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.28, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'94', Cost:19.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'126', Cost:17.23, ParentId: '16'},
		]
	},
