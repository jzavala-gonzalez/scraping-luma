const timestamp_saved = '08/23/2023 02:30 AM';
const dataFechaAcualizado = '8/22/2023' + ' 10:25:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 188, MVar:'62', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'46', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'46', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 34,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'3', Cost:31.05, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:29.18, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'126', Cost:16.96, ParentId: '16'},
		]
	},
