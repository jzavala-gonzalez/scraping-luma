const timestamp_saved = '11/22/2023 05:25 AM';
const dataFechaAcualizado = '11/22/2023' + ' 1:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'23', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'32', Cost:11.67, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 0, MVar:'0', Cost:28.36, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'128', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'70', Cost:9.57, ParentId: '17'},
		]
	},
