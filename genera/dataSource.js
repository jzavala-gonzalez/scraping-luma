const timestamp_saved = '09/21/2023 06:50 AM';
const dataFechaAcualizado = '9/21/2023' + ' 2:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'38', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'43', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'63', Cost:11.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'44', Cost:0, ParentId: '8'},
