const timestamp_saved = '08/13/2023 12:00 PM';
const dataFechaAcualizado = '8/13/2023' + ' 7:57:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'39', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'41', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'38', Cost:19.25, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'110', Cost:12.25, ParentId: '17'},
		]
	},
