const timestamp_saved = '10/18/2023 03:45 PM';
const dataFechaAcualizado = '10/18/2023' + ' 11:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'79', Cost:23.33, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'107', Cost:10.56, ParentId: '17'},
		]
	},
