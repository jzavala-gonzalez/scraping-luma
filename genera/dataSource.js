const timestamp_saved = '08/24/2023 06:15 AM';
const dataFechaAcualizado = '8/24/2023' + ' 2:10:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'54', Cost:10.13, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'1', Cost:20.70, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:26.13, ParentId: '9'},
