const timestamp_saved = '12/02/2023 01:15 AM';
const dataFechaAcualizado = '12/1/2023' + ' 9:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'52', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'56', Cost:12.93, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'18', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'161', Cost:16.74, ParentId: '16'},
		]
	},
