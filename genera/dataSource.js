const timestamp_saved = '10/27/2023 11:10 AM';
const dataFechaAcualizado = '10/27/2023' + ' 7:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'51', Cost:10.35, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 135,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'89', Cost:17.04, ParentId: '15'},
