const timestamp_saved = '11/09/2023 05:20 AM';
const dataFechaAcualizado = '11/9/2023' + ' 1:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'44', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'43', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.39, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'7', Cost:19.76, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 232,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 232, MVar:'74', Cost:9.70, ParentId: '17'},
		]
	},
