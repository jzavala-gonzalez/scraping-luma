const timestamp_saved = '10/21/2023 07:50 AM';
const dataFechaAcualizado = '10/21/2023' + ' 3:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'22', Cost:12.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'18', Cost:12.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'57', Cost:12.17, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'7', Cost:18.90, ParentId: '14'},
