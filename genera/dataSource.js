const timestamp_saved = '09/05/2023 11:55 AM';
const dataFechaAcualizado = '9/5/2023' + ' 7:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'37', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'41', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'55', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'67', Cost:9.43, ParentId: '17'},
		]
	},
