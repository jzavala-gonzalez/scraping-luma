const timestamp_saved = '12/03/2023 10:50 PM';
const dataFechaAcualizado = '12/3/2023' + ' 6:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 232,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 232, MVar:'94', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'53', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'57', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'55', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 39,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 39, MVar:'17', Cost:46.38, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'14', Cost:32.17, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'144', Cost:16.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'94', Cost:10.96, ParentId: '17'},
		]
	},
