const timestamp_saved = '11/14/2023 05:25 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'44', Cost:13.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'48', Cost:13.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'52', Cost:13.32, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 161, MVar:'20', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'9', Cost:18.67, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'93', Cost:10.86, ParentId: '17'},
		]
	},
