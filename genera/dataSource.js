const timestamp_saved = '10/14/2023 12:25 PM';
const dataFechaAcualizado = '10/14/2023' + ' 8:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:18.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:18.66, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'66', Cost:9.26, ParentId: '17'},
		]
	},
