const timestamp_saved = '11/22/2023 08:25 PM';
const dataFechaAcualizado = '11/22/2023' + ' 4:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'46', Cost:11.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.60, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'171', Cost:17.37, ParentId: '16'},
		]
	},
