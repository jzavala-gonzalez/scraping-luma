const timestamp_saved = '10/28/2023 01:20 PM';
const dataFechaAcualizado = '10/28/2023' + ' 9:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'39', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'44', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 125,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 35, MVar:'13', Cost:37.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:37.65, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'10', Cost:22.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'129', Cost:17.23, ParentId: '16'},
		]
	},
