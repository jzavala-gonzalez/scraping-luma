const timestamp_saved = '12/04/2023 07:25 PM';
const dataFechaAcualizado = '12/4/2023' + ' 3:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'58', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'60', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'58', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'92', Cost:11.02, ParentId: '17'},
		]
	},
