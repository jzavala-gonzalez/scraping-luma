const timestamp_saved = '08/26/2023 07:05 AM';
const dataFechaAcualizado = '8/26/2023' + ' 3:00:49 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1189},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 218, MVar:'57', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'59', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 286,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'39', Cost:13.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'44', Cost:13.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 90, MVar:'42', Cost:13.59, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.68, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.01, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'60', Cost:18.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'123', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'52', Cost:17.11, ParentId: '17'},
		]
	},
