const timestamp_saved = '10/07/2023 08:15 PM';
const dataFechaAcualizado = '10/7/2023' + ' 4:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'48', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'46', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'1', Cost:49.88, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'17', Cost:30.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:17.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.06, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'11', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'90', Cost:17.00, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'166', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'102', Cost:9.32, ParentId: '17'},
		]
	},
