const timestamp_saved = '10/10/2023 08:10 PM';
const dataFechaAcualizado = '10/10/2023' + ' 4:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 234,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 234, MVar:'84', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'64', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'67', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'69', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'25', Cost:31.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'44', Cost:17.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.84, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'45', Cost:17.08, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'9', Cost:17.08, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:30.77, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.24, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'17', Cost:19.34, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'95', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'179', Cost:17.18, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:26.02, ParentId: '21'},
