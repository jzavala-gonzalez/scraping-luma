const timestamp_saved = '08/29/2023 12:05 PM';
const dataFechaAcualizado = '8/29/2023' + ' 8:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 198, MVar:'80', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'77', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'50', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'53', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'59', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'34', Cost:19.24, ParentId: '14'},
