const timestamp_saved = '10/02/2023 03:05 AM';
const dataFechaAcualizado = '10/1/2023' + ' 11:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'36', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'34', Cost:10.75, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'105', Cost:9.20, ParentId: '17'},
		]
	},
