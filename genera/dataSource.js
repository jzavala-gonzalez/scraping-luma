const timestamp_saved = '10/20/2023 08:40 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'30', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'38', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'81', Cost:10.54, ParentId: '17'},
		]
	},
