const timestamp_saved = '08/02/2023 10:30 AM';
const dataFechaAcualizado = '8/2/2023' + ' 6:25:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'48', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'42', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'48', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 276,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 128, MVar:'83', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 148, MVar:'38', Cost:15.60, ParentId: '15'},
		]
	},
