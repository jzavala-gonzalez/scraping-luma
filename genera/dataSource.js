const timestamp_saved = '09/27/2023 06:40 AM';
const dataFechaAcualizado = '9/27/2023' + ' 2:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'27', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'29', Cost:11.00, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:8.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:8.81, ParentId: '11'},
