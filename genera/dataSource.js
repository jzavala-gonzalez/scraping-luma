const timestamp_saved = '11/22/2023 08:05 AM';
const dataFechaAcualizado = '11/22/2023' + ' 4:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'21', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'30', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'63', Cost:9.82, ParentId: '17'},
		]
	},
