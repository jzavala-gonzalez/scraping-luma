const timestamp_saved = '10/24/2023 01:00 AM';
const dataFechaAcualizado = '10/23/2023' + ' 8:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'58', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'59', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'57', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:20.08, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.47, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'13', Cost:27.39, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:21.25, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'27', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.55, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'7', Cost:31.92, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'79', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'95', Cost:11.01, ParentId: '17'},
		]
	},
