const timestamp_saved = '11/01/2023 04:05 PM';
const dataFechaAcualizado = '11/1/2023' + ' 12:01:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'60', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'63', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'68', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:18.44, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'22', Cost:19.62, ParentId: '14'},
