const timestamp_saved = '11/23/2023 07:25 AM';
const dataFechaAcualizado = '11/23/2023' + ' 3:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 237,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 237, MVar:'66', Cost:4.38, ParentId: '6'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:18.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:18.15, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 223,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 223, MVar:'111', Cost:18.41, ParentId: '16'},
		]
	},
