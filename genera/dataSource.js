const timestamp_saved = '12/04/2023 03:10 PM';
const dataFechaAcualizado = '12/4/2023' + ' 11:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'50', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'53', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'56', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'76', Cost:11.44, ParentId: '17'},
		]
	},
