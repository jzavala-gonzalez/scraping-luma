const timestamp_saved = '10/10/2023 12:30 PM';
const dataFechaAcualizado = '10/10/2023' + ' 8:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'79', Cost:4.38, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'64', Cost:10.12, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'5', Cost:26.64, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'14', Cost:18.90, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'84', Cost:16.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'156', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'79', Cost:9.26, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:26.75, ParentId: '21'},
