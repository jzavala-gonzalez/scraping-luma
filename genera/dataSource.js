const timestamp_saved = '09/11/2023 01:30 AM';
const dataFechaAcualizado = '9/10/2023' + ' 9:25:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2849},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 561,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'76', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'75', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 213, MVar:'71', Cost:9.79, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 194,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'7', Cost:21.95, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.95, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'12', Cost:22.93, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'3', Cost:22.29, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'18', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'17', Cost:28.00, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:19.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:19.87, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'7', Cost:31.62, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'8', Cost:29.98, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'15', Cost:18.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'88', Cost:16.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'179', Cost:16.66, ParentId: '16'},
		]
	},
