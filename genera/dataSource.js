const timestamp_saved = '11/24/2023 04:15 AM';
const dataFechaAcualizado = '11/24/2023' + ' 12:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'26', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'36', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'50', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'83', Cost:9.19, ParentId: '17'},
		]
	},
