const timestamp_saved = '09/21/2023 12:45 AM';
const dataFechaAcualizado = '9/20/2023' + ' 8:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 552,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 177, MVar:'56', Cost:10.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'59', Cost:10.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 199, MVar:'64', Cost:10.00, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 69, MVar:'15', Cost:28.31, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'16', Cost:28.36, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'13', Cost:29.69, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'18', Cost:26.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'85', Cost:16.53, ParentId: '15'},
