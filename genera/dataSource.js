const timestamp_saved = '11/30/2023 07:30 PM';
const dataFechaAcualizado = '11/30/2023' + ' 3:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'56', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'57', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'57', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.45, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'83', Cost:9.55, ParentId: '17'},
		]
	},
