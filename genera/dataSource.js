const timestamp_saved = '08/28/2023 08:55 AM';
const dataFechaAcualizado = '8/28/2023' + ' 4:50:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'37', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'37', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'43', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'7', Cost:18.86, ParentId: '14'},
