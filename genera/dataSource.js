const timestamp_saved = '11/27/2023 07:50 AM';
const dataFechaAcualizado = '11/27/2023' + ' 3:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'18', Cost:12.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'28', Cost:12.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.43, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'98', Cost:18.26, ParentId: '16'},
		]
	},
