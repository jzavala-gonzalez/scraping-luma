const timestamp_saved = '09/16/2023 08:00 PM';
const dataFechaAcualizado = '9/16/2023' + ' 3:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'48', Cost:10.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 126, MVar:'0', Cost:8.78, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:31.29, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'93', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'129', Cost:16.66, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 57,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 17, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
