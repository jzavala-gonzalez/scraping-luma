const timestamp_saved = '09/03/2023 12:00 PM';
const dataFechaAcualizado = '9/3/2023' + ' 7:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'31', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'35', Cost:11.05, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'65', Cost:17.02, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'50', Cost:9.82, ParentId: '17'},
		]
	},
