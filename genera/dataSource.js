const timestamp_saved = '07/28/2023 01:41 PM';
const dataFechaAcualizado = '7/28/2023' + ' 9:35:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'47', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'84', Cost:13.53, ParentId: '17'},
		]
	},
