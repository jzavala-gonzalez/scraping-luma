const timestamp_saved = '08/17/2023 01:25 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:22:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 524,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'60', Cost:9.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'78', Cost:9.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 183, MVar:'82', Cost:9.93, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.25, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'22', Cost:27.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'22', Cost:28.02, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 85,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'6', Cost:30.31, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'26', Cost:19.19, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'240', Cost:16.62, ParentId: '16'},
		]
	},
