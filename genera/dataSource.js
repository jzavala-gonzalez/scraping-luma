const timestamp_saved = '07/30/2023 11:15 PM';
const dataFechaAcualizado = '7/30/2023' + ' 7:10:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'58', Cost:10.35, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'3', Cost:43.35, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'139', Cost:16.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'93', Cost:10.96, ParentId: '17'},
		]
	},
