const timestamp_saved = '09/03/2023 05:30 PM';
const dataFechaAcualizado = '9/3/2023' + ' 1:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'36', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'40', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'61', Cost:9.53, ParentId: '17'},
		]
	},
