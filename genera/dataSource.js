const timestamp_saved = '09/27/2023 05:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 1:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'32', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'33', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'64', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.15, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'144', Cost:16.91, ParentId: '16'},
		]
	},
