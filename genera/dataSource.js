const timestamp_saved = '11/30/2023 09:20 PM';
const dataFechaAcualizado = '11/30/2023' + ' 5:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'59', Cost:10.62, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 26,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'12', Cost:43.29, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'7', Cost:30.81, ParentId: '13'},
