const timestamp_saved = '11/28/2023 11:00 PM';
const dataFechaAcualizado = '11/28/2023' + ' 6:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'44', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'54', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'63', Cost:11.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.19, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'8', Cost:26.66, ParentId: '9'},
		]
	},
