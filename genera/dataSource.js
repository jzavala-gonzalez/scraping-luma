const timestamp_saved = '07/29/2023 09:10 PM';
const dataFechaAcualizado = '7/29/2023' + ' 5:05:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'52', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'50', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'45', Cost:19.25, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 336,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'99', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 166, MVar:'39', Cost:15.49, ParentId: '15'},
		]
	},
