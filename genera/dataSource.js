const timestamp_saved = '10/25/2023 09:50 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'43', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'46', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'39', Cost:18.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'6', Cost:18.19, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.35, ParentId: '14'},
