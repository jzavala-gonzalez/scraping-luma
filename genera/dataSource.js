const timestamp_saved = '10/01/2023 05:35 AM';
const dataFechaAcualizado = '10/1/2023' + ' 1:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 503,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'68', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'31', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'29', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'47', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'46', Cost:8.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'97', Cost:9.28, ParentId: '17'},
		]
	},
