const timestamp_saved = '11/16/2023 02:05 PM';
const dataFechaAcualizado = '11/16/2023' + ' 10:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'50', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'52', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 186, MVar:'76', Cost:10.76, ParentId: '17'},
		]
	},
