const timestamp_saved = '08/04/2023 06:35 AM';
const dataFechaAcualizado = '8/4/2023' + ' 2:30:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'38', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'44', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'19', Cost:15.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'124', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 211,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 211, MVar:'74', Cost:12.21, ParentId: '17'},
		]
	},
