const timestamp_saved = '09/11/2023 07:20 AM';
const dataFechaAcualizado = '9/11/2023' + ' 3:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'66', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'65', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'65', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'9', Cost:30.95, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'9', Cost:30.97, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 111, MVar:'0', Cost:10.02, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:10.02, ParentId: '11'},
		]
	},
