const timestamp_saved = '11/10/2023 10:35 AM';
const dataFechaAcualizado = '11/10/2023' + ' 6:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'52', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'56', Cost:10.81, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'12', Cost:21.96, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.04, ParentId: '14'},
