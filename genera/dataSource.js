const timestamp_saved = '09/12/2023 08:25 AM';
const dataFechaAcualizado = '9/12/2023' + ' 4:20:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 448,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'59', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'44', Cost:10.97, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'110', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'29', Cost:10.44, ParentId: '17'},
		]
	},
