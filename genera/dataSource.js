const timestamp_saved = '11/03/2023 11:00 AM';
const dataFechaAcualizado = '11/3/2023' + ' 6:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'49', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'46', Cost:11.21, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'65', Cost:9.43, ParentId: '17'},
		]
	},
