const timestamp_saved = '09/26/2023 02:25 AM';
const dataFechaAcualizado = '9/25/2023' + ' 10:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'54', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'56', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'63', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:23.17, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'14', Cost:27.23, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:17.69, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'179', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'89', Cost:9.13, ParentId: '17'},
		]
	},
