const timestamp_saved = '11/01/2023 10:25 AM';
const dataFechaAcualizado = '11/1/2023' + ' 6:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'52', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'57', Cost:10.43, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'64', Cost:9.43, ParentId: '17'},
		]
	},
