const timestamp_saved = '09/28/2023 05:10 AM';
const dataFechaAcualizado = '9/28/2023' + ' 1:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'24', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'24', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'46', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'35', Cost:8.84, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:8.84, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.41, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'127', Cost:18.18, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 203, MVar:'70', Cost:10.40, ParentId: '17'},
		]
	},
