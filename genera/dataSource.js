const timestamp_saved = '10/07/2023 08:30 PM';
const dataFechaAcualizado = '10/7/2023' + ' 4:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 191, MVar:'67', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'49', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.66, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:17.10, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.10, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'95', Cost:16.66, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'170', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'107', Cost:9.22, ParentId: '17'},
		]
	},
