const timestamp_saved = '09/21/2023 01:30 AM';
const dataFechaAcualizado = '9/20/2023' + ' 9:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'61', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'66', Cost:9.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'17', Cost:28.13, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:27.26, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'15', Cost:26.78, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'80', Cost:16.44, ParentId: '15'},
