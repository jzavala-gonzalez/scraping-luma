const timestamp_saved = '08/03/2023 05:10 AM';
const dataFechaAcualizado = '8/3/2023' + ' 1:05:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'45', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'47', Cost:10.20, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.44, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.95, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 181,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'145', Cost:19.44, ParentId: '16'},
		]
	},
