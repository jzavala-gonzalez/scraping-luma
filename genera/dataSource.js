const timestamp_saved = '11/01/2023 11:00 AM';
const dataFechaAcualizado = '11/1/2023' + ' 6:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'58', Cost:10.58, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'119', Cost:18.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'63', Cost:9.40, ParentId: '17'},
		]
	},
