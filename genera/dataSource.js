const timestamp_saved = '09/05/2023 06:40 AM';
const dataFechaAcualizado = '9/5/2023' + ' 2:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'37', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'41', Cost:11.41, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:31.61, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'66', Cost:9.32, ParentId: '17'},
		]
	},
