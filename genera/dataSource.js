const timestamp_saved = '10/16/2023 09:05 AM';
const dataFechaAcualizado = '10/16/2023' + ' 5:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'47', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'47', Cost:11.23, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:30.63, ParentId: '12'},
