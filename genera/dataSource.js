const timestamp_saved = '10/13/2023 05:25 PM';
const dataFechaAcualizado = '10/13/2023' + ' 1:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'66', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'72', Cost:10.62, ParentId: '7'},
