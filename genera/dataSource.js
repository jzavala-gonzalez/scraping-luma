const timestamp_saved = '11/15/2023 07:10 PM';
const dataFechaAcualizado = '11/15/2023' + ' 3:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'61', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'61', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'60', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'28', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 27, MVar:'0', Cost:55.82, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'90', Cost:18.43, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'102', Cost:9.45, ParentId: '17'},
		]
	},
