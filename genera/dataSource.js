const timestamp_saved = '11/26/2023 10:50 PM';
const dataFechaAcualizado = '11/26/2023' + ' 6:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'38', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'48', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 10,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 10, MVar:'4', Cost:408.20, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'25', Cost:31.47, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'22', Cost:19.52, ParentId: '14'},
