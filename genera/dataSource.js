const timestamp_saved = '08/06/2023 06:15 PM';
const dataFechaAcualizado = '8/6/2023' + ' 2:10:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'45', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'43', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 270,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'97', Cost:16.96, ParentId: '15'},
