const timestamp_saved = '10/21/2023 01:30 PM';
const dataFechaAcualizado = '10/21/2023' + ' 9:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'38', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'36', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'38', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'72', Cost:11.04, ParentId: '17'},
		]
	},
