const timestamp_saved = '11/23/2023 06:55 AM';
const dataFechaAcualizado = '11/23/2023' + ' 2:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'18', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'29', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 104, MVar:'46', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'118', Cost:18.29, ParentId: '16'},
		]
	},
