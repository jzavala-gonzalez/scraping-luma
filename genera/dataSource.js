const timestamp_saved = '08/11/2023 08:15 PM';
const dataFechaAcualizado = '8/11/2023' + ' 4:12:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'47', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.90, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'183', Cost:16.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'134', Cost:11.49, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 63,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 17, MVar:'22', Cost:17, ParentId: '19'},
		]
	},
