const timestamp_saved = '08/06/2023 05:35 AM';
const dataFechaAcualizado = '8/6/2023' + ' 1:30:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'44', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'44', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:25.99, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:27.13, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'2', Cost:19.65, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'16', Cost:30.77, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'19', Cost:30.94, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'43', Cost:20.07, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:30.87, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.69, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'96', Cost:11.55, ParentId: '17'},
		]
	},
