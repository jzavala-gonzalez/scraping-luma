const timestamp_saved = '11/14/2023 07:55 PM';
const dataFechaAcualizado = '11/14/2023' + ' 3:51:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2488},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'54', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'59', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'58', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:52.00, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'111', Cost:10.96, ParentId: '17'},
		]
	},
