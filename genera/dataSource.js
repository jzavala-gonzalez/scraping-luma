const timestamp_saved = '08/03/2023 10:40 AM';
const dataFechaAcualizado = '8/3/2023' + ' 6:35:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'38', Cost:11.04, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 245,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'67', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 105, MVar:'40', Cost:16.83, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'80', Cost:11.41, ParentId: '17'},
		]
	},
