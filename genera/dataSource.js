const timestamp_saved = '11/26/2023 02:30 AM';
const dataFechaAcualizado = '11/25/2023' + ' 10:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'33', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'41', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'53', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 6,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 6, MVar:'0', Cost:26.29, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'36', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.64, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'33', Cost:18.47, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.47, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 13,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 13, MVar:'0', Cost:29.91, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.75, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 216,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 216, MVar:'128', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'26', Cost:9.20, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 12,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:17.67, ParentId: '21'},
