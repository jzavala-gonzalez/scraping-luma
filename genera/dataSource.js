const timestamp_saved = '11/04/2023 02:35 PM';
const dataFechaAcualizado = '11/4/2023' + ' 10:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'44', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'43', Cost:12.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'44', Cost:12.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:18.43, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 52, MVar:'17', Cost:21.22, ParentId: '14'},
