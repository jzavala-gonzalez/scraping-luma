const timestamp_saved = '10/12/2023 05:05 AM';
const dataFechaAcualizado = '10/12/2023' + ' 1:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'61', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'66', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'174', Cost:16.54, ParentId: '16'},
		]
	},
