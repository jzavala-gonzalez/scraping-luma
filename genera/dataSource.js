const timestamp_saved = '12/06/2023 12:30 PM';
const dataFechaAcualizado = '12/6/2023' + ' 8:25:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 817},
	{Index:'7', Desc:'Capacidad Disponible', value: 2960},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'49', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'52', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'70', Cost:14.34, ParentId: '17'},
		]
	},
