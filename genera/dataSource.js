const timestamp_saved = '09/28/2023 05:35 PM';
const dataFechaAcualizado = '9/28/2023' + ' 1:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'32', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'32', Cost:10.98, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'90', Cost:9.75, ParentId: '17'},
		]
	},
