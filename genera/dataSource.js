const timestamp_saved = '11/30/2023 11:00 AM';
const dataFechaAcualizado = '11/30/2023' + ' 6:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'65', Cost:9.56, ParentId: '17'},
		]
	},
