const timestamp_saved = '10/31/2023 07:10 PM';
const dataFechaAcualizado = '10/31/2023' + ' 3:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'59', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'63', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'66', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:23.52, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 74,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'24', Cost:28.40, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 129,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'15', Cost:20.79, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'36', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'111', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 351,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 351, MVar:'175', Cost:16.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'89', Cost:9.10, ParentId: '17'},
		]
	},
