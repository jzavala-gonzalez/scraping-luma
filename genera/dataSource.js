const timestamp_saved = '11/28/2023 09:45 PM';
const dataFechaAcualizado = '11/28/2023' + ' 5:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'42', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'52', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'62', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'21', Cost:36.05, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'119', Cost:9.19, ParentId: '17'},
		]
	},
