const timestamp_saved = '09/29/2023 09:00 AM';
const dataFechaAcualizado = '9/29/2023' + ' 4:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'31', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'28', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'47', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.52, ParentId: '11'},
