const timestamp_saved = '08/18/2023 03:10 AM';
const dataFechaAcualizado = '8/17/2023' + ' 11:07:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'62', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'71', Cost:11.06, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:23.85, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'163', Cost:16.64, ParentId: '16'},
		]
	},
