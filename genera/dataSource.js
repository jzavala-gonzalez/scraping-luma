const timestamp_saved = '08/18/2023 02:50 AM';
const dataFechaAcualizado = '8/17/2023' + ' 10:47:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'62', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'74', Cost:11.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 173,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:28.76, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:30.77, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.22, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'15', Cost:19.27, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'87', Cost:9.18, ParentId: '17'},
		]
	},
