const timestamp_saved = '08/08/2023 05:25 PM';
const dataFechaAcualizado = '8/8/2023' + ' 1:20:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'53', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'60', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'66', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'9', Cost:22.60, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 17, MVar:'2', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:30.97, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 144, MVar:'46', Cost:15.89, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'168', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'105', Cost:11.89, ParentId: '17'},
		]
	},
