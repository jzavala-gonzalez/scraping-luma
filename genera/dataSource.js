const timestamp_saved = '10/21/2023 02:35 PM';
const dataFechaAcualizado = '10/21/2023' + ' 10:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'37', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'37', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.34, ParentId: '11'},
