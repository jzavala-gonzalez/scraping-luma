const timestamp_saved = '10/18/2023 01:45 PM';
const dataFechaAcualizado = '10/18/2023' + ' 9:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:10.80, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'0', Cost:21.65, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:18.84, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'102', Cost:10.57, ParentId: '17'},
		]
	},
