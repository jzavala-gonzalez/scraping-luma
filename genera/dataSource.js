const timestamp_saved = '10/19/2023 03:05 PM';
const dataFechaAcualizado = '10/19/2023' + ' 11:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'39', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'46', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'50', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'109', Cost:10.55, ParentId: '17'},
		]
	},
