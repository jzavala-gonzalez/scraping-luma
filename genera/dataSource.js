const timestamp_saved = '09/30/2023 02:00 PM';
const dataFechaAcualizado = '9/30/2023' + ' 9:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'34', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'33', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'46', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'76', Cost:17.04, ParentId: '15'},
