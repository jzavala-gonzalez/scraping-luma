const timestamp_saved = '10/18/2023 11:50 AM';
const dataFechaAcualizado = '10/18/2023' + ' 7:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'64', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'43', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'47', Cost:10.44, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.14, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'83', Cost:23.20, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 359, MVar:'95', Cost:10.57, ParentId: '17'},
		]
	},
