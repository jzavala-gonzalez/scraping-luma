const timestamp_saved = '11/12/2023 05:05 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:01:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1948},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'43', Cost:12.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'46', Cost:12.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'55', Cost:12.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.88, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.88, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'64', Cost:17.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'85', Cost:9.62, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 105,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 39, MVar:'14', Cost:19.60, ParentId: '19'},
