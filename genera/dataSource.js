const timestamp_saved = '09/26/2023 10:40 AM';
const dataFechaAcualizado = '9/26/2023' + ' 6:35:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'48', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'61', Cost:9.79, ParentId: '17'},
		]
	},
