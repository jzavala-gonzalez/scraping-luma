const timestamp_saved = '12/01/2023 03:40 AM';
const dataFechaAcualizado = '11/30/2023' + ' 11:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'52', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'54', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'52', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:28.98, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 13, MVar:'0', Cost:30.68, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 265,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 265, MVar:'74', Cost:9.36, ParentId: '17'},
		]
	},
