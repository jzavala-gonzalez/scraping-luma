const timestamp_saved = '09/30/2023 06:20 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'37', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'35', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'50', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:19.25, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:19.25, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'19', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'79', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'140', Cost:18.24, ParentId: '16'},
		]
	},
