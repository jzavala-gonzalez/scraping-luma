const timestamp_saved = '07/30/2023 10:10 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:05:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'42', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'39', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 26,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 26, MVar:'3', Cost:35.94, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 261,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'64', Cost:17.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'64', Cost:19.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'65', Cost:11.16, ParentId: '17'},
		]
	},
