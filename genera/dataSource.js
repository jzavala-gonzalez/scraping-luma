const timestamp_saved = '09/11/2023 10:20 PM';
const dataFechaAcualizado = '9/11/2023' + ' 6:15:52 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2864},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'83', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'74', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'73', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'79', Cost:9.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 156,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.50, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 155, MVar:'55', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'7', Cost:28.77, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'13', Cost:18.84, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'82', Cost:17.00, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 360, MVar:'163', Cost:16.61, ParentId: '16'},
		]
	},
