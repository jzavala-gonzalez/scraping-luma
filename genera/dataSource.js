const timestamp_saved = '09/05/2023 08:41 AM';
const dataFechaAcualizado = '9/5/2023' + ' 4:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'34', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'38', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'52', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.02, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'67', Cost:9.29, ParentId: '17'},
		]
	},
