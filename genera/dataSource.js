const timestamp_saved = '12/04/2023 02:15 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'51', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'86', Cost:10.92, ParentId: '17'},
		]
	},
