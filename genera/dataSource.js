const timestamp_saved = '09/27/2023 10:25 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'30', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'30', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'61', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:17.53, ParentId: '11'},
