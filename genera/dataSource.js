const timestamp_saved = '08/24/2023 08:30 PM';
const dataFechaAcualizado = '8/24/2023' + ' 4:25:46 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'66', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'67', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'60', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'12', Cost:26.94, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'8', Cost:27.25, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:31.94, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:18.82, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'86', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 347, MVar:'204', Cost:16.76, ParentId: '16'},
		]
	},
