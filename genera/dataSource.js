const timestamp_saved = '09/25/2023 04:30 AM';
const dataFechaAcualizado = '9/25/2023' + ' 12:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'52', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'54', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'61', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.75, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'0', Cost:17.75, ParentId: '11'},
		]
	},
