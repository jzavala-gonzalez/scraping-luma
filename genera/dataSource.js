const timestamp_saved = '11/07/2023 06:15 AM';
const dataFechaAcualizado = '11/7/2023' + ' 2:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'40', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'39', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'40', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.41, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'9', Cost:20.33, ParentId: '14'},
