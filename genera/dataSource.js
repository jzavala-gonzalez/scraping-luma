const timestamp_saved = '07/29/2023 09:55 AM';
const dataFechaAcualizado = '7/29/2023' + ' 5:50:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'46', Cost:10.70, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'26', Cost:15.83, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'78', Cost:13.64, ParentId: '17'},
		]
	},
