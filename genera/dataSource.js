const timestamp_saved = '09/30/2023 07:00 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'35', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'49', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:17.47, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'77', Cost:16.47, ParentId: '15'},
