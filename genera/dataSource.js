const timestamp_saved = '10/21/2023 04:45 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'25', Cost:13.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'23', Cost:13.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'60', Cost:13.41, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 5, MVar:'0', Cost:26.78, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.20, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'144', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'79', Cost:11.04, ParentId: '17'},
		]
	},
