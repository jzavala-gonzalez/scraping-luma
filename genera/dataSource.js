const timestamp_saved = '10/01/2023 08:55 AM';
const dataFechaAcualizado = '10/1/2023' + ' 4:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 140, MVar:'57', Cost:4.40, ParentId: '6'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'119', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'90', Cost:9.48, ParentId: '17'},
		]
	},
