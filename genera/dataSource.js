const timestamp_saved = '11/01/2023 12:10 PM';
const dataFechaAcualizado = '11/1/2023' + ' 8:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'54', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'58', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'63', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'68', Cost:9.40, ParentId: '17'},
		]
	},
