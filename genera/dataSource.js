const timestamp_saved = '11/23/2023 10:15 PM';
const dataFechaAcualizado = '11/23/2023' + ' 6:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 241,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 242, MVar:'78', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'30', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'39', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'51', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'141', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'73', Cost:9.69, ParentId: '17'},
		]
	},
