const timestamp_saved = '09/12/2023 06:30 AM';
const dataFechaAcualizado = '9/12/2023' + ' 2:25:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'49', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'47', Cost:11.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'132', Cost:17.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'37', Cost:10.43, ParentId: '17'},
		]
	},
