const timestamp_saved = '10/30/2023 08:20 PM';
const dataFechaAcualizado = '10/30/2023' + ' 4:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'60', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'65', Cost:10.57, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:19.27, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 335,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 335, MVar:'86', Cost:9.25, ParentId: '17'},
		]
	},
