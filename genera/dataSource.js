const timestamp_saved = '09/14/2023 11:05 AM';
const dataFechaAcualizado = '9/14/2023' + ' 7:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'49', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'48', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'63', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'91', Cost:9.23, ParentId: '17'},
		]
	},
