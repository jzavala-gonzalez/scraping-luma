const timestamp_saved = '11/11/2023 08:15 PM';
const dataFechaAcualizado = '11/11/2023' + ' 4:11:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2296},
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2302},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'51', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'59', Cost:11.52, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:15.58, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'46', Cost:16.98, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:16.98, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'14', Cost:30.43, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:19.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'105', Cost:16.78, ParentId: '15'},
