const timestamp_saved = '12/06/2023 11:45 AM';
const dataFechaAcualizado = '12/6/2023' + ' 7:40:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Capacidad Disponible', value: 2928},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'47', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'49', Cost:11.12, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 241,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 241, MVar:'125', Cost:18.00, ParentId: '16'},
		]
	},
