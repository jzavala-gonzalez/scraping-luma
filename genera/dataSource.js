const timestamp_saved = '10/25/2023 01:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 9:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'50', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'9', Cost:18.74, ParentId: '11'},
		]
	},
