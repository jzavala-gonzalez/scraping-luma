const timestamp_saved = '09/02/2023 11:45 AM';
const dataFechaAcualizado = '9/2/2023' + ' 7:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'51', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'60', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'104', Cost:18.25, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 28,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'14', Cost:19.60, ParentId: '19'},
