const timestamp_saved = '10/29/2023 06:40 PM';
const dataFechaAcualizado = '10/29/2023' + ' 2:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'52', Cost:10.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'33', Cost:17.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:17.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'48', Cost:17.02, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'10', Cost:17.02, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:31.95, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:32.92, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'126', Cost:16.97, ParentId: '16'},
		]
	},
