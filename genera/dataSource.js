const timestamp_saved = '10/16/2023 10:25 PM';
const dataFechaAcualizado = '10/16/2023' + ' 6:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'7', Cost:0, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:16.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:16.37, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'50', Cost:8.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'16', Cost:19.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'93', Cost:16.48, ParentId: '15'},
