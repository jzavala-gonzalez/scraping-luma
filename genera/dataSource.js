const timestamp_saved = '08/01/2023 02:10 PM';
const dataFechaAcualizado = '8/1/2023' + ' 10:05:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'44', Cost:10.91, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 284,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'109', Cost:16.60, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 119, MVar:'32', Cost:16.38, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'91', Cost:11.00, ParentId: '17'},
		]
	},
