const timestamp_saved = '09/24/2023 05:25 AM';
const dataFechaAcualizado = '9/24/2023' + ' 1:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'41', Cost:12.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'44', Cost:12.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'54', Cost:12.82, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'3', Cost:27.95, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.17, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'84', Cost:9.21, ParentId: '17'},
		]
	},
