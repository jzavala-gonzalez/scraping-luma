const timestamp_saved = '11/24/2023 09:15 AM';
const dataFechaAcualizado = '11/24/2023' + ' 5:11:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1836},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'21', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'30', Cost:11.26, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'63', Cost:9.90, ParentId: '17'},
		]
	},
