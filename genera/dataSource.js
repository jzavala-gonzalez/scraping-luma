const timestamp_saved = '10/25/2023 10:10 AM';
const dataFechaAcualizado = '10/25/2023' + ' 6:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'48', Cost:10.51, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'36', Cost:8.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:8.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'47', Cost:16.89, ParentId: '11'},
