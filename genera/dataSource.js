const timestamp_saved = '11/26/2023 08:45 PM';
const dataFechaAcualizado = '11/26/2023' + ' 4:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'151', Cost:17.18, ParentId: '16'},
		]
	},
