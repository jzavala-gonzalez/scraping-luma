const timestamp_saved = '12/06/2023 11:25 AM';
const dataFechaAcualizado = '12/6/2023' + ' 7:20:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 425},
	{Index:'6', Desc:'Reserva Operacional', value: 820},
	{Index:'7', Desc:'Capacidad Disponible', value: 2920},
	{Index:'8', Desc:'Próxima Hora MW', value: 2078},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:11.05, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.58, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.58, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 242,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 242, MVar:'121', Cost:17.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 271, MVar:'64', Cost:14.31, ParentId: '17'},
		]
	},
