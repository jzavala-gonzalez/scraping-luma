const timestamp_saved = '10/27/2023 12:35 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'50', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'48', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:16.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:16.69, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'48', Cost:16.92, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'26', Cost:19.46, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 133, MVar:'91', Cost:18.21, ParentId: '15'},
