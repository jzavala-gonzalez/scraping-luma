const timestamp_saved = '11/29/2023 04:55 AM';
const dataFechaAcualizado = '11/29/2023' + ' 12:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'26', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'36', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'50', Cost:11.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.58, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 44,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 44, MVar:'7', Cost:30.98, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.29, ParentId: '11'},
