const timestamp_saved = '11/13/2023 04:25 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:21:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2404},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 181,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'46', Cost:21.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'52', Cost:21.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'1', Cost:20.64, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:24.94, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'9', Cost:27.95, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'66', Cost:16.89, ParentId: '15'},
