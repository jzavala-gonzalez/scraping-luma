const timestamp_saved = '09/03/2023 02:10 PM';
const dataFechaAcualizado = '9/3/2023' + ' 10:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'35', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'40', Cost:10.77, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.11, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'55', Cost:9.81, ParentId: '17'},
		]
	},
