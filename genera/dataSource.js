const timestamp_saved = '11/24/2023 12:50 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'24', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'33', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'49', Cost:11.57, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'68', Cost:9.91, ParentId: '17'},
		]
	},
