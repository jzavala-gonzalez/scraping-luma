const timestamp_saved = '08/05/2023 06:30 PM';
const dataFechaAcualizado = '8/5/2023' + ' 2:25:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'46', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'49', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 200,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:8.33, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.55, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'45', Cost:15.52, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 296,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 296, MVar:'97', Cost:11.89, ParentId: '17'},
		]
	},
