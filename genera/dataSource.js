const timestamp_saved = '11/12/2023 07:20 PM';
const dataFechaAcualizado = '11/12/2023' + ' 3:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'54', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'58', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'68', Cost:17.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'98', Cost:9.66, ParentId: '17'},
		]
	},
