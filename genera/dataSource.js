const timestamp_saved = '08/03/2023 09:15 AM';
const dataFechaAcualizado = '8/3/2023' + ' 5:10:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'39', Cost:10.97, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'54', Cost:17.25, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 105, MVar:'38', Cost:16.84, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'81', Cost:11.40, ParentId: '17'},
		]
	},
