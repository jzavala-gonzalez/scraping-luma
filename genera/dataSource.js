const timestamp_saved = '10/24/2023 05:45 AM';
const dataFechaAcualizado = '10/24/2023' + ' 1:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'51', Cost:10.96, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 130, MVar:'40', Cost:17.04, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'70', Cost:11.03, ParentId: '17'},
		]
	},
