const timestamp_saved = '10/27/2023 06:15 AM';
const dataFechaAcualizado = '10/27/2023' + ' 2:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'42', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'42', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'48', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.51, ParentId: '14'},
