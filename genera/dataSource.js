const timestamp_saved = '09/25/2023 08:50 PM';
const dataFechaAcualizado = '9/25/2023' + ' 4:45:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3535},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'47', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'47', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'57', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:49.41, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:17.47, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:31.41, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'182', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'106', Cost:9.12, ParentId: '17'},
		]
	},
