const timestamp_saved = '10/23/2023 04:25 PM';
const dataFechaAcualizado = '10/23/2023' + ' 12:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'53', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'54', Cost:10.86, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'89', Cost:17.02, ParentId: '15'},
