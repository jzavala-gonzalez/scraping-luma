const timestamp_saved = '10/28/2023 06:50 PM';
const dataFechaAcualizado = '10/28/2023' + ' 2:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'54', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'53', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 148,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 58, MVar:'18', Cost:32.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:32.69, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'8', Cost:30.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'19', Cost:21.94, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'88', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'141', Cost:17.54, ParentId: '16'},
		]
	},
