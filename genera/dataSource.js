const timestamp_saved = '09/01/2023 11:30 AM';
const dataFechaAcualizado = '9/1/2023' + ' 7:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'51', Cost:10.82, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 4,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'1', Cost:42.63, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:20.53, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'72', Cost:17.04, ParentId: '15'},
