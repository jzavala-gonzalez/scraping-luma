const timestamp_saved = '11/29/2023 04:20 AM';
const dataFechaAcualizado = '11/29/2023' + ' 12:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'28', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'38', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'53', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 11,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 11, MVar:'0', Cost:30.39, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'84', Cost:9.40, ParentId: '17'},
		]
	},
