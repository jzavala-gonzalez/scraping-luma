const timestamp_saved = '07/25/2023 07:53 AM';
const dataFechaAcualizado = '7/25/2023' + ' 3:45:30 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'81', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'77', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 509,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'61', Cost:10.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 180, MVar:'56', Cost:10.00, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'10', Cost:28.57, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 80, MVar:'10', Cost:28.00, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:8.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:8.18, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 34, MVar:'9', Cost:30.84, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 42, MVar:'9', Cost:29.31, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 53, MVar:'8', Cost:28.52, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 173, MVar:'56', Cost:15.46, ParentId: '15'},
		]
	},
