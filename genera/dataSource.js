const timestamp_saved = '10/28/2023 01:50 AM';
const dataFechaAcualizado = '10/27/2023' + ' 9:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 143, MVar:'49', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 275,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'24', Cost:18.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 32, MVar:'6', Cost:18.81, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'8', Cost:18.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'63', Cost:16.97, ParentId: '15'},
