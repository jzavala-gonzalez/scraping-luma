const timestamp_saved = '08/17/2023 02:00 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:57:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'74', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 168, MVar:'81', Cost:9.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.08, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'11', Cost:22.96, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'19', Cost:28.02, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'19', Cost:28.10, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:27.73, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:19.34, ParentId: '14'},
