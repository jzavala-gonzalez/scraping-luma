const timestamp_saved = '10/26/2023 09:05 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'35', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'36', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'43', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'126', Cost:18.28, ParentId: '16'},
		]
	},
