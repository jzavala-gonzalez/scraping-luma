const timestamp_saved = '09/30/2023 10:20 AM';
const dataFechaAcualizado = '9/30/2023' + ' 6:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'33', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'32', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'49', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'102', Cost:9.43, ParentId: '17'},
		]
	},
