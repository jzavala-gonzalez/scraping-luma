const timestamp_saved = '10/21/2023 02:45 PM';
const dataFechaAcualizado = '10/21/2023' + ' 10:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'37', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'36', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'69', Cost:11.05, ParentId: '17'},
		]
	},
