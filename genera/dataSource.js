const timestamp_saved = '09/27/2023 12:55 AM';
const dataFechaAcualizado = '9/26/2023' + ' 8:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'61', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'64', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'8', Cost:26.46, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:17.48, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.48, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:17.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'0', Cost:17.31, ParentId: '11'},
		]
	},
