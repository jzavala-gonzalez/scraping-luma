const timestamp_saved = '12/05/2023 04:15 PM';
const dataFechaAcualizado = '12/5/2023' + ' 12:10:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 564},
	{Index:'6', Desc:'Reserva Operacional', value: 1131},
	{Index:'7', Desc:'Capacidad Disponible', value: 3181},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:13.51, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 167,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 98, MVar:'11', Cost:18.54, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'27', Cost:19.40, ParentId: '14'},
