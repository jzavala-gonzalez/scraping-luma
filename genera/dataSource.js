const timestamp_saved = '10/22/2023 09:15 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'45', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'46', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:10.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 15,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 15, MVar:'0', Cost:24.23, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:32.89, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'123', Cost:17.36, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 0, MVar:'0', Cost:24, ParentId: '21'},
			{Index:'1', Unit:'CT Block 2', MW: 15, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'2', Unit:'CT Block 3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:24.23, ParentId: '21'},
			{Index:'5', Unit:'GT3', MW: 15, MVar:'0', Cost:0, ParentId: '21'},
