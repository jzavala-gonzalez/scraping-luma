const timestamp_saved = '11/27/2023 12:35 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'38', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.33, ParentId: '11'},
