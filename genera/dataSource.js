const timestamp_saved = '12/02/2023 08:35 PM';
const dataFechaAcualizado = '12/2/2023' + ' 4:31:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2255},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 237,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 237, MVar:'82', Cost:4.45, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.45, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'55', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'58', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'56', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'92', Cost:11.02, ParentId: '17'},
		]
	},
