const timestamp_saved = '08/17/2023 01:50 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:47:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 522,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:9.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'75', Cost:9.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 184, MVar:'81', Cost:9.91, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'19', Cost:28.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'19', Cost:28.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:31.34, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.35, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'20', Cost:19.47, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'249', Cost:16.52, ParentId: '16'},
		]
	},
