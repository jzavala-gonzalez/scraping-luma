const timestamp_saved = '10/28/2023 08:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 4:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'48', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'51', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'54', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 254,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'29', Cost:25.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'38', Cost:18.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'8', Cost:18.68, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'6', Cost:29.86, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.39, ParentId: '12'},
