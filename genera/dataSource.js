const timestamp_saved = '10/06/2023 01:35 AM';
const dataFechaAcualizado = '10/5/2023' + ' 9:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'43', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'42', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'55', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.47, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'46', Cost:16.95, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'11', Cost:16.95, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:30.86, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'5', Cost:30.88, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'89', Cost:16.94, ParentId: '15'},
