const timestamp_saved = '09/11/2023 02:30 PM';
const dataFechaAcualizado = '9/11/2023' + ' 10:25:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'65', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'75', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.61, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'90', Cost:16.82, ParentId: '15'},
