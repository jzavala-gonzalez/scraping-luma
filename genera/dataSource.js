const timestamp_saved = '10/17/2023 12:01 PM';
const dataFechaAcualizado = '10/17/2023' + ' 7:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'53', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'53', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'54', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'14', Cost:19.16, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'89', Cost:16.74, ParentId: '15'},
