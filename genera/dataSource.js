const timestamp_saved = '10/15/2023 09:45 AM';
const dataFechaAcualizado = '10/15/2023' + ' 5:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'44', Cost:11.04, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.47, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'56', Cost:9.62, ParentId: '17'},
		]
	},
