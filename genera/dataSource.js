const timestamp_saved = '08/30/2023 03:00 AM';
const dataFechaAcualizado = '8/29/2023' + ' 10:55:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'56', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'57', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'64', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:25.89, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.88, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'7', Cost:22.73, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'25', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'110', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 245,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 245, MVar:'157', Cost:17.71, ParentId: '16'},
		]
	},
