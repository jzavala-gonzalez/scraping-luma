const timestamp_saved = '09/12/2023 02:45 PM';
const dataFechaAcualizado = '9/12/2023' + ' 10:40:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 428,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 174, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'55', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'53', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'66', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 80, MVar:'0', Cost:8.88, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'103', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'133', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'71', Cost:9.57, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 58,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:21.56, ParentId: '21'},
