const timestamp_saved = '09/19/2023 04:25 PM';
const dataFechaAcualizado = '9/19/2023' + ' 12:20:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 495},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 164, MVar:'65', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'77', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'57', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'57', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'69', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:26.49, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'30', Cost:18.90, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 61,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 61, MVar:'82', Cost:21.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'151', Cost:17.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'52', Cost:9.13, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 120,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 44, MVar:'7', Cost:19.60, ParentId: '19'},
			{Index:'5', Unit:'Fonroche', MW: 33, MVar:'16', Cost:17, ParentId: '19'},
		]
	},
