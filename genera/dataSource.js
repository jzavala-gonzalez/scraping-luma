const timestamp_saved = '09/23/2023 09:30 PM';
const dataFechaAcualizado = '9/23/2023' + ' 5:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'52', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'64', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 146,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:14.83, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:30.35, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:30.56, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'23', Cost:18.46, ParentId: '14'},
