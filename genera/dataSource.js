const timestamp_saved = '09/08/2023 07:00 PM';
const dataFechaAcualizado = '9/8/2023' + ' 2:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'60', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'67', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'59', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 106,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 106, MVar:'0', Cost:6.86, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'22', Cost:31.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:34.63, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'27', Cost:18.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'94', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 351,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 351, MVar:'175', Cost:16.76, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 91,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 29, MVar:'16', Cost:17, ParentId: '19'},
		]
	},
