const timestamp_saved = '08/02/2023 09:35 AM';
const dataFechaAcualizado = '8/2/2023' + ' 5:30:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'49', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'47', Cost:10.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 92, MVar:'26', Cost:21.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:21.66, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 144, MVar:'45', Cost:15.65, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'90', Cost:11.01, ParentId: '17'},
		]
	},
