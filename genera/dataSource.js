const timestamp_saved = '11/22/2023 03:30 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'31', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'41', Cost:12.12, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 88, MVar:'74', Cost:18.03, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'96', Cost:9.14, ParentId: '17'},
		]
	},
