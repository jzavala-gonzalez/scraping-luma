const timestamp_saved = '10/01/2023 11:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 7:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'37', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'52', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 60, MVar:'19', Cost:30.85, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.05, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 105, MVar:'0', Cost:19.88, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'6', Cost:19.88, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'10', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'83', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'148', Cost:16.70, ParentId: '16'},
		]
	},
