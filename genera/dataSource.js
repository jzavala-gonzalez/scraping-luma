const timestamp_saved = '08/20/2023 07:30 AM';
const dataFechaAcualizado = '8/20/2023' + ' 3:27:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'50', Cost:11.09, ParentId: '7'},
