const timestamp_saved = '09/20/2023 02:10 PM';
const dataFechaAcualizado = '9/20/2023' + ' 10:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'53', Cost:10.32, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 106,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 106, MVar:'77', Cost:18.39, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'148', Cost:18.12, ParentId: '16'},
		]
	},
