const timestamp_saved = '11/03/2023 08:55 AM';
const dataFechaAcualizado = '11/3/2023' + ' 4:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'42', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'41', Cost:12.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'42', Cost:12.12, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'61', Cost:16.92, ParentId: '15'},
