const timestamp_saved = '07/29/2023 10:35 AM';
const dataFechaAcualizado = '7/29/2023' + ' 6:30:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'44', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'81', Cost:17.07, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'74', Cost:13.62, ParentId: '17'},
		]
	},
