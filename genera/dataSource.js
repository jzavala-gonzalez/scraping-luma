const timestamp_saved = '11/16/2023 09:50 AM';
const dataFechaAcualizado = '11/16/2023' + ' 5:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'45', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'45', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.67, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 180,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 180, MVar:'62', Cost:10.90, ParentId: '17'},
		]
	},
