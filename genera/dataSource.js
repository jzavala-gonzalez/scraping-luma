const timestamp_saved = '09/14/2023 10:15 PM';
const dataFechaAcualizado = '9/14/2023' + ' 6:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'58', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'57', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'69', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'17', Cost:28.44, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'18', Cost:28.09, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'33', Cost:19.63, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'97', Cost:16.70, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'184', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'123', Cost:9.15, ParentId: '17'},
		]
	},
