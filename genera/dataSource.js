const timestamp_saved = '08/01/2023 01:25 AM';
const dataFechaAcualizado = '7/31/2023' + ' 9:20:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'44', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:11.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 100, MVar:'0', Cost:2.60, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'10', Cost:22.50, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:19.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:19.31, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.41, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'87', Cost:16.64, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'34', Cost:15.50, ParentId: '15'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 10, MVar:'0', Cost:25.84, ParentId: '21'},
