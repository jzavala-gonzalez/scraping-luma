const timestamp_saved = '08/06/2023 03:35 PM';
const dataFechaAcualizado = '8/6/2023' + ' 11:30:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'51', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'49', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 164, MVar:'45', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 134,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 69, MVar:'19', Cost:28.68, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 65, MVar:'20', Cost:29.21, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 73,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'0', Cost:30.90, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'27', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 122, MVar:'27', Cost:16.68, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'103', Cost:11.58, ParentId: '17'},
		]
	},
