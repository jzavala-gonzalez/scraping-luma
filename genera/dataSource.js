const timestamp_saved = '10/28/2023 10:05 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:01:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1901},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'37', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'39', Cost:11.08, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 65, MVar:'20', Cost:28.95, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.95, ParentId: '11'},
