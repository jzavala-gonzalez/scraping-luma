const timestamp_saved = '08/10/2023 07:35 PM';
const dataFechaAcualizado = '8/10/2023' + ' 3:30:43 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2555},
	{Index:'1', Desc:'PREPA', value: 55},
	{Index:'2', Desc:'COGEN', value: 45},
	{Index:'3', Desc:'Reserva en Rotación', value: 426},
	{Index:'4', Desc:'Reserva Operacional', value: 568},
	{Index:'5', Desc:'Capacidad Disponible', value: 3124},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'67', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'98', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'48', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'51', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.00, ParentId: '8'},
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:17.62, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 144, MVar:'27', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'2', Cost:27.04, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 145,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'6', Cost:28.40, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 72, MVar:'7', Cost:28.69, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:8.43, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:8.43, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:29.81, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:29.18, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'7', Cost:29.23, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'128', Cost:11.30, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 72,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 33, MVar:'6', Cost:17, ParentId: '19'},
		]
	},
