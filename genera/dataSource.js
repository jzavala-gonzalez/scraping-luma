const timestamp_saved = '08/03/2023 07:30 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:25:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.34, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'51', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'34', Cost:16.87, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'76', Cost:11.30, ParentId: '17'},
		]
	},
