const timestamp_saved = '07/28/2023 03:55 PM';
const dataFechaAcualizado = '7/28/2023' + ' 11:50:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'52', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'51', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 29,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 29, MVar:'4', Cost:27.29, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'93', Cost:13.50, ParentId: '17'},
		]
	},
