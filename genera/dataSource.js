const timestamp_saved = '12/04/2023 09:30 PM';
const dataFechaAcualizado = '12/4/2023' + ' 5:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'62', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'58', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 27, MVar:'7', Cost:31.83, ParentId: '14'},
