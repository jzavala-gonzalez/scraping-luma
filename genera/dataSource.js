const timestamp_saved = '11/20/2023 01:55 PM';
const dataFechaAcualizado = '11/20/2023' + ' 9:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'41', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'52', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'62', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.27, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'187', Cost:18.24, ParentId: '16'},
		]
	},
