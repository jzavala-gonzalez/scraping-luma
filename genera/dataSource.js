const timestamp_saved = '11/15/2023 05:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 1:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'41', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'42', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 265,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 106, MVar:'32', Cost:19.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:19.29, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.14, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 203, MVar:'71', Cost:10.34, ParentId: '17'},
		]
	},
