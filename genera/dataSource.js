const timestamp_saved = '11/29/2023 10:45 PM';
const dataFechaAcualizado = '11/29/2023' + ' 6:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'56', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'60', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'58', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'180', Cost:16.78, ParentId: '16'},
		]
	},
