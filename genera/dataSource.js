const timestamp_saved = '08/22/2023 04:30 PM';
const dataFechaAcualizado = '8/22/2023' + ' 12:25:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 132, MVar:'46', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'123', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'70', Cost:9.19, ParentId: '17'},
		]
	},
