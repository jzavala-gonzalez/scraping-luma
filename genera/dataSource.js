const timestamp_saved = '10/29/2023 06:00 PM';
const dataFechaAcualizado = '10/29/2023' + ' 1:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'48', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'51', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'71', Cost:10.55, ParentId: '7'},
		]
	},
