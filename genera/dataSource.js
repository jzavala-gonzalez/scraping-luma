const timestamp_saved = '09/21/2023 06:00 PM';
const dataFechaAcualizado = '9/21/2023' + ' 1:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'43', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'47', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'65', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'2', Cost:22.92, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:19.86, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'5', Cost:31.47, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'24', Cost:27.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 71, MVar:'82', Cost:31.41, ParentId: '16'},
		]
	},
