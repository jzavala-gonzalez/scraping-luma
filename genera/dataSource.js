const timestamp_saved = '10/16/2023 09:40 PM';
const dataFechaAcualizado = '10/16/2023' + ' 5:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 512,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'69', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'68', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 166, MVar:'63', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'24', Cost:28.22, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'9', Cost:29.72, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.26, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'92', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'105', Cost:9.13, ParentId: '17'},
		]
	},
