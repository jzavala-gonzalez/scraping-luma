const timestamp_saved = '10/16/2023 03:55 PM';
const dataFechaAcualizado = '10/16/2023' + ' 11:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'66', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'64', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'62', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.01, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'94', Cost:16.98, ParentId: '15'},
