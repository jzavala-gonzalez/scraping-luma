const timestamp_saved = '10/07/2023 03:05 AM';
const dataFechaAcualizado = '10/6/2023' + ' 11:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'49', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'51', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'15', Cost:28.04, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'77', Cost:16.83, ParentId: '15'},
