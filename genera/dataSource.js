const timestamp_saved = '08/04/2023 02:30 PM';
const dataFechaAcualizado = '8/4/2023' + ' 10:25:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'72', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'42', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'48', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'38', Cost:15.69, ParentId: '15'},
		]
	},
