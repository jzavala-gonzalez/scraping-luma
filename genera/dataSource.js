const timestamp_saved = '11/04/2023 09:30 PM';
const dataFechaAcualizado = '11/4/2023' + ' 5:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'50', Cost:12.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'48', Cost:12.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:71.03, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:16.62, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'144', Cost:17.16, ParentId: '16'},
		]
	},
