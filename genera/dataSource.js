const timestamp_saved = '11/26/2023 01:25 AM';
const dataFechaAcualizado = '11/25/2023' + ' 9:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'31', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'40', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'55', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 51,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'7', Cost:28.31, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'134', Cost:17.39, ParentId: '16'},
		]
	},
