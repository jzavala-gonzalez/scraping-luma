const timestamp_saved = '10/16/2023 06:10 AM';
const dataFechaAcualizado = '10/16/2023' + ' 2:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'48', Cost:11.11, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'12', Cost:17.30, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'142', Cost:17.24, ParentId: '16'},
		]
	},
