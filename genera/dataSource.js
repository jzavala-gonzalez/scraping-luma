const timestamp_saved = '08/11/2023 07:40 PM';
const dataFechaAcualizado = '8/11/2023' + ' 3:35:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'51', Cost:10.25, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.46, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'180', Cost:17.17, ParentId: '16'},
		]
	},
