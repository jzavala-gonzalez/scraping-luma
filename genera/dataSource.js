const timestamp_saved = '09/04/2023 07:15 AM';
const dataFechaAcualizado = '9/4/2023' + ' 3:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'35', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'38', Cost:10.28, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:18.97, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 203, MVar:'48', Cost:10.39, ParentId: '17'},
		]
	},
