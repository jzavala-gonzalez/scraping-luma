const timestamp_saved = '11/28/2023 09:25 AM';
const dataFechaAcualizado = '11/28/2023' + ' 5:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'27', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'36', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'6', Cost:17.91, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'118', Cost:18.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'77', Cost:9.49, ParentId: '17'},
		]
	},
