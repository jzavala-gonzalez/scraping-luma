const timestamp_saved = '08/30/2023 09:10 AM';
const dataFechaAcualizado = '8/30/2023' + ' 5:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 512,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'49', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'48', Cost:10.09, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 99,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 40, MVar:'41', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 72, MVar:'12', Cost:29.23, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'24', Cost:18.25, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'143', Cost:18.05, ParentId: '16'},
		]
	},
