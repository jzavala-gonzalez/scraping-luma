const timestamp_saved = '11/04/2023 10:20 AM';
const dataFechaAcualizado = '11/4/2023' + ' 6:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'42', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'40', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'39', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'47', Cost:9.73, ParentId: '17'},
		]
	},
