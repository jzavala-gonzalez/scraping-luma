const timestamp_saved = '08/18/2023 06:55 PM';
const dataFechaAcualizado = '8/18/2023' + ' 2:52:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'65', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'74', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'13', Cost:30.74, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'33', Cost:19.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'85', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'152', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'89', Cost:9.26, ParentId: '17'},
		]
	},
