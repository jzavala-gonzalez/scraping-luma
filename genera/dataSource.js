const timestamp_saved = '10/25/2023 09:25 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'42', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.89, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'43', Cost:8.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:8.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 139, MVar:'42', Cost:18.00, ParentId: '11'},
