const timestamp_saved = '11/03/2023 09:40 AM';
const dataFechaAcualizado = '11/3/2023' + ' 5:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'46', Cost:11.17, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'61', Cost:9.42, ParentId: '17'},
		]
	},
