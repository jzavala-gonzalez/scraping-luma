const timestamp_saved = '09/09/2023 08:45 AM';
const dataFechaAcualizado = '9/9/2023' + ' 4:40:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'51', Cost:13.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'56', Cost:13.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'54', Cost:13.56, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 109,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'8', Cost:27.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 56, MVar:'9', Cost:27.41, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.40, ParentId: '14'},
