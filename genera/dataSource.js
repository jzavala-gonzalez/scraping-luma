const timestamp_saved = '09/08/2023 02:25 PM';
const dataFechaAcualizado = '9/8/2023' + ' 10:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'59', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'55', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'52', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'16', Cost:31.23, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'16', Cost:31.04, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'26', Cost:19.38, ParentId: '14'},
