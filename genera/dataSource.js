const timestamp_saved = '11/01/2023 02:25 PM';
const dataFechaAcualizado = '11/1/2023' + ' 10:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'57', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'61', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:17.24, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.59, ParentId: '14'},
