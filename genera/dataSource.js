const timestamp_saved = '08/14/2023 07:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 3:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'37', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'42', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'41', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'101', Cost:12.98, ParentId: '17'},
		]
	},
