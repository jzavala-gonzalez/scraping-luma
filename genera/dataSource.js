const timestamp_saved = '11/15/2023 11:40 AM';
const dataFechaAcualizado = '11/15/2023' + ' 7:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'42', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'44', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'73', Cost:9.77, ParentId: '17'},
		]
	},
