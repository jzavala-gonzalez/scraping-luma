const timestamp_saved = '11/25/2023 01:40 PM';
const dataFechaAcualizado = '11/25/2023' + ' 9:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 157,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 155, MVar:'63', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'22', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'31', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'47', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.85, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'129', Cost:18.19, ParentId: '16'},
		]
	},
