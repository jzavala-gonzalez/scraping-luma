const timestamp_saved = '10/23/2023 06:55 AM';
const dataFechaAcualizado = '10/23/2023' + ' 2:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'35', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'35', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'38', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'59', Cost:16.86, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'44', Cost:11.28, ParentId: '17'},
		]
	},
