const timestamp_saved = '08/16/2023 11:00 AM';
const dataFechaAcualizado = '8/16/2023' + ' 6:57:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'55', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:10.94, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'2', Cost:31.28, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:31.30, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'4', Cost:30.74, ParentId: '13'},
