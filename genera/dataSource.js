const timestamp_saved = '10/28/2023 01:55 AM';
const dataFechaAcualizado = '10/27/2023' + ' 9:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'48', Cost:10.61, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 274,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'25', Cost:19.00, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 32, MVar:'6', Cost:19.00, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'133', Cost:17.63, ParentId: '16'},
		]
	},
