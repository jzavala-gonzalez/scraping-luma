const timestamp_saved = '08/18/2023 02:40 PM';
const dataFechaAcualizado = '8/18/2023' + ' 10:37:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'60', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'70', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'8', Cost:31.52, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:30.50, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'28', Cost:20.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 54, MVar:'66', Cost:23.17, ParentId: '15'},
