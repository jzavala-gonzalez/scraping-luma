const timestamp_saved = '08/17/2023 02:10 AM';
const dataFechaAcualizado = '8/16/2023' + ' 10:07:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'91', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'57', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'74', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'79', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.47, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'10', Cost:26.30, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'18', Cost:27.99, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.50, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.84, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'16', Cost:18.18, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'247', Cost:16.61, ParentId: '16'},
		]
	},
