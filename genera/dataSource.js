const timestamp_saved = '10/18/2023 09:40 AM';
const dataFechaAcualizado = '10/18/2023' + ' 5:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'38', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'43', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'7', Cost:8.09, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'3', Cost:30.68, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 59, MVar:'72', Cost:21.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'87', Cost:10.60, ParentId: '17'},
		]
	},
