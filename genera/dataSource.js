const timestamp_saved = '11/08/2023 03:05 AM';
const dataFechaAcualizado = '11/7/2023' + ' 11:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'50', Cost:10.69, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 68,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 68, MVar:'7', Cost:27.55, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'156', Cost:19.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'100', Cost:9.17, ParentId: '17'},
		]
	},
