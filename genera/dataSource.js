const timestamp_saved = '09/28/2023 06:16 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'19', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'43', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'5', Cost:19.26, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 156, MVar:'99', Cost:21.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'66', Cost:9.75, ParentId: '17'},
		]
	},
