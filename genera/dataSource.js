const timestamp_saved = '11/20/2023 08:50 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'29', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'37', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'53', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'88', Cost:9.19, ParentId: '17'},
		]
	},
