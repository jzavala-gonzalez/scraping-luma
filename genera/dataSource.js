const timestamp_saved = '08/05/2023 07:50 AM';
const dataFechaAcualizado = '8/5/2023' + ' 3:45:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'38', Cost:10.77, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'0', Cost:23.48, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:21.79, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'95', Cost:16.93, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'51', Cost:15.65, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'126', Cost:18.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'85', Cost:11.32, ParentId: '17'},
		]
	},
