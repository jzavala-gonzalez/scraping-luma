const timestamp_saved = '10/22/2023 12:30 PM';
const dataFechaAcualizado = '10/22/2023' + ' 8:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'38', Cost:12.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'39', Cost:12.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.42, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'13', Cost:19.08, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'53', Cost:11.23, ParentId: '17'},
		]
	},
