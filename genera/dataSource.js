const timestamp_saved = '08/17/2023 03:25 AM';
const dataFechaAcualizado = '8/16/2023' + ' 11:17:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'54', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'68', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'78', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'92', Cost:9.20, ParentId: '17'},
		]
	},
