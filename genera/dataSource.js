const timestamp_saved = '11/15/2023 07:15 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'32', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'36', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'43', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'59', Cost:9.77, ParentId: '17'},
		]
	},
