const timestamp_saved = '10/19/2023 09:35 PM';
const dataFechaAcualizado = '10/19/2023' + ' 5:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'38', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'45', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'68', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:27.31, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 45,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 45, MVar:'17', Cost:23.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'81', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'105', Cost:10.56, ParentId: '17'},
		]
	},
