const timestamp_saved = '09/08/2023 01:40 AM';
const dataFechaAcualizado = '9/7/2023' + ' 9:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'62', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'50', Cost:10.43, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 104,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'26', Cost:31.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'27', Cost:30.90, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'79', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'191', Cost:16.75, ParentId: '16'},
		]
	},
