const timestamp_saved = '11/03/2023 10:05 AM';
const dataFechaAcualizado = '11/3/2023' + ' 6:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'46', Cost:11.24, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'61', Cost:9.41, ParentId: '17'},
		]
	},
