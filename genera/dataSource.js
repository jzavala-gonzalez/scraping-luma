const timestamp_saved = '12/03/2023 12:00 PM';
const dataFechaAcualizado = '12/3/2023' + ' 7:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'35', Cost:12.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'39', Cost:12.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'45', Cost:12.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'52', Cost:11.61, ParentId: '17'},
		]
	},
