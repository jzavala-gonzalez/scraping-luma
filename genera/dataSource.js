const timestamp_saved = '11/21/2023 02:20 AM';
const dataFechaAcualizado = '11/20/2023' + ' 10:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'33', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'43', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'58', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'102', Cost:9.22, ParentId: '17'},
		]
	},
