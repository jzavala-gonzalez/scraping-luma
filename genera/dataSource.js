const timestamp_saved = '09/30/2023 09:20 AM';
const dataFechaAcualizado = '9/30/2023' + ' 5:15:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'37', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'35', Cost:10.75, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 79,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 11, MVar:'0', Cost:26.21, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 67, MVar:'14', Cost:19.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'74', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'133', Cost:17.81, ParentId: '16'},
		]
	},
