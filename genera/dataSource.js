const timestamp_saved = '10/11/2023 10:35 PM';
const dataFechaAcualizado = '10/11/2023' + ' 6:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 565,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'72', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'76', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 214, MVar:'76', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.92, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.81, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'9', Cost:26.11, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:17.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'50', Cost:16.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'10', Cost:16.99, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'8', Cost:29.58, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'8', Cost:28.79, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'20', Cost:18.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'97', Cost:16.18, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'201', Cost:16.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'110', Cost:9.18, ParentId: '17'},
		]
	},
