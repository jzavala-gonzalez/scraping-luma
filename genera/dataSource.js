const timestamp_saved = '10/18/2023 06:05 AM';
const dataFechaAcualizado = '10/18/2023' + ' 2:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'46', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'58', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'7', Cost:19.22, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 215,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 215, MVar:'161', Cost:18.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'85', Cost:10.94, ParentId: '17'},
		]
	},
