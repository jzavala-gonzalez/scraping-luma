const timestamp_saved = '09/06/2023 07:40 AM';
const dataFechaAcualizado = '9/6/2023' + ' 3:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'42', Cost:12.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'44', Cost:12.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'56', Cost:12.77, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'137', Cost:17.25, ParentId: '16'},
		]
	},
