const timestamp_saved = '12/04/2023 04:50 PM';
const dataFechaAcualizado = '12/4/2023' + ' 12:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'52', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'52', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'75', Cost:11.46, ParentId: '17'},
		]
	},
