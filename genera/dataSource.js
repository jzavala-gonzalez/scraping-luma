const timestamp_saved = '11/06/2023 04:56 PM';
const dataFechaAcualizado = '11/6/2023' + ' 12:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'56', Cost:10.49, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'110', Cost:9.47, ParentId: '17'},
		]
	},
