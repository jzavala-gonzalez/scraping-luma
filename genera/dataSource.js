const timestamp_saved = '10/04/2023 03:30 PM';
const dataFechaAcualizado = '10/4/2023' + ' 11:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'39', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'53', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'75', Cost:17.08, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'109', Cost:9.39, ParentId: '17'},
		]
	},
