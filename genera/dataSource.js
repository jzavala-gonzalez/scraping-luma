const timestamp_saved = '08/28/2023 12:35 PM';
const dataFechaAcualizado = '8/28/2023' + ' 8:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'87', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'51', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'53', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'52', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'16', Cost:31.27, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'23', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'85', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'103', Cost:9.59, ParentId: '17'},
		]
	},
