const timestamp_saved = '09/26/2023 05:45 AM';
const dataFechaAcualizado = '9/26/2023' + ' 1:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'48', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'50', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'58', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 98, MVar:'29', Cost:18.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'8', Cost:18.75, ParentId: '11'},
