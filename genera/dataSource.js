const timestamp_saved = '09/28/2023 09:20 AM';
const dataFechaAcualizado = '9/28/2023' + ' 5:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'20', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'18', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'44', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'103', Cost:18.43, ParentId: '16'},
		]
	},
