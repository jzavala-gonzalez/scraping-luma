const timestamp_saved = '10/02/2023 10:05 AM';
const dataFechaAcualizado = '10/2/2023' + ' 6:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'36', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'34', Cost:10.33, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:8.36, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'102', Cost:9.37, ParentId: '17'},
		]
	},
