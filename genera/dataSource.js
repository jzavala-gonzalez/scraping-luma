const timestamp_saved = '12/01/2023 04:15 PM';
const dataFechaAcualizado = '12/1/2023' + ' 12:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'45', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'49', Cost:13.51, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'147', Cost:17.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'71', Cost:9.44, ParentId: '17'},
		]
	},
