const timestamp_saved = '10/29/2023 02:55 PM';
const dataFechaAcualizado = '10/29/2023' + ' 10:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 150, MVar:'73', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'123', Cost:17.38, ParentId: '16'},
		]
	},
