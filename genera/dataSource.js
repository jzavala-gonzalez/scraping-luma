const timestamp_saved = '09/13/2023 05:30 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'55', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'54', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'66', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.38, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'15', Cost:28.36, ParentId: '10'},
		]
	},
