const timestamp_saved = '09/02/2023 06:00 AM';
const dataFechaAcualizado = '9/2/2023' + ' 1:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'42', Cost:12.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'50', Cost:12.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'61', Cost:12.26, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 10, MVar:'1', Cost:26.42, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.38, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'0', Cost:26.34, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'9', Cost:31.06, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'56', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 336, MVar:'124', Cost:16.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'59', Cost:9.89, ParentId: '17'},
		]
	},
