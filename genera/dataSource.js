const timestamp_saved = '11/01/2023 05:55 PM';
const dataFechaAcualizado = '11/1/2023' + ' 1:51:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2368},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'61', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'66', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'68', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:18.41, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'87', Cost:9.21, ParentId: '17'},
		]
	},
