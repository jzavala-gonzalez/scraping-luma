const timestamp_saved = '10/23/2023 09:20 AM';
const dataFechaAcualizado = '10/23/2023' + ' 5:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'38', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'39', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'39', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'64', Cost:16.82, ParentId: '15'},
