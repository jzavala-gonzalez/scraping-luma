const timestamp_saved = '11/11/2023 03:35 PM';
const dataFechaAcualizado = '11/11/2023' + ' 11:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'42', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'44', Cost:12.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'48', Cost:12.06, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.55, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'12', Cost:22.18, ParentId: '14'},
