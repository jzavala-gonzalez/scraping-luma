const timestamp_saved = '09/27/2023 10:40 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'34', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'34', Cost:10.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.89, ParentId: '11'},
