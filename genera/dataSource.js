const timestamp_saved = '10/05/2023 10:10 PM';
const dataFechaAcualizado = '10/5/2023' + ' 6:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'45', Cost:10.80, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'37', Cost:17.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'8', Cost:17.52, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'48', Cost:17.05, ParentId: '11'},
