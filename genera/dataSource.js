const timestamp_saved = '09/16/2023 07:20 PM';
const dataFechaAcualizado = '9/16/2023' + ' 3:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'49', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'48', Cost:10.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'6', Cost:8.94, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.57, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'86', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 354,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 354, MVar:'121', Cost:16.91, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'96', Cost:9.29, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 56,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'4', Cost:19.60, ParentId: '19'},
