const timestamp_saved = '08/28/2023 04:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 12:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'39', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'39', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'46', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'90', Cost:11.96, ParentId: '17'},
		]
	},
