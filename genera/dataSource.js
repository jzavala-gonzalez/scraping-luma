const timestamp_saved = '10/01/2023 07:15 PM';
const dataFechaAcualizado = '10/1/2023' + ' 3:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'36', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'34', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'48', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 19, MVar:'7', Cost:27.94, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'104', Cost:9.20, ParentId: '17'},
		]
	},
