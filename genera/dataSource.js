const timestamp_saved = '08/12/2023 04:05 AM';
const dataFechaAcualizado = '8/12/2023' + ' 12:02:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'15', Cost:18.68, ParentId: '14'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 41,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:89.69, ParentId: '21'},
