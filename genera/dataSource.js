const timestamp_saved = '12/02/2023 09:30 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'39', Cost:13.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'41', Cost:13.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'43', Cost:13.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 382,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.99, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'55', Cost:9.82, ParentId: '17'},
		]
	},
