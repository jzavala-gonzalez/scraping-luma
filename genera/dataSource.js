const timestamp_saved = '07/30/2023 11:45 AM';
const dataFechaAcualizado = '7/30/2023' + ' 7:40:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'41', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'38', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'37', Cost:16.31, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'65', Cost:19.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'62', Cost:11.16, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 24,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'15', Cost:19.60, ParentId: '19'},
