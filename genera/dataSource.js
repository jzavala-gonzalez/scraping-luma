const timestamp_saved = '09/30/2023 06:05 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'37', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'34', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'48', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:19.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:19.54, ParentId: '11'},
