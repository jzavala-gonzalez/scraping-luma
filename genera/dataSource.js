const timestamp_saved = '10/18/2023 02:15 PM';
const dataFechaAcualizado = '10/18/2023' + ' 10:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'69', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'45', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'51', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'63', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.17, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'74', Cost:23.28, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'102', Cost:10.54, ParentId: '17'},
		]
	},
