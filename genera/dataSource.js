const timestamp_saved = '11/11/2023 07:35 AM';
const dataFechaAcualizado = '11/11/2023' + ' 3:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'40', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'43', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'42', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'67', Cost:9.77, ParentId: '17'},
		]
	},
