const timestamp_saved = '09/17/2023 05:20 PM';
const dataFechaAcualizado = '9/17/2023' + ' 1:15:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 432,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'66', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'42', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'43', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'4', Cost:30.92, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'46', Cost:19.97, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'70', Cost:9.66, ParentId: '17'},
		]
	},
