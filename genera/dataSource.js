const timestamp_saved = '10/21/2023 04:45 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'38', Cost:12.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'35', Cost:12.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'38', Cost:12.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'76', Cost:17.68, ParentId: '15'},
