const timestamp_saved = '09/03/2023 05:00 PM';
const dataFechaAcualizado = '9/3/2023' + ' 12:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'36', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'40', Cost:11.09, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'88', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 283,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 283, MVar:'60', Cost:9.59, ParentId: '17'},
		]
	},
