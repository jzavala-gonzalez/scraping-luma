const timestamp_saved = '09/26/2023 04:25 PM';
const dataFechaAcualizado = '9/26/2023' + ' 12:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'45', Cost:12.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'46', Cost:12.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'57', Cost:12.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:17.51, ParentId: '11'},
