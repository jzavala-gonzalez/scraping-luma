const timestamp_saved = '09/26/2023 02:25 PM';
const dataFechaAcualizado = '9/26/2023' + ' 10:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'47', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:11.15, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:17.32, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'72', Cost:16.77, ParentId: '15'},
