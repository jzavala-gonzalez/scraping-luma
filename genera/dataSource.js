const timestamp_saved = '07/30/2023 04:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 12:20:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'46', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'43', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'39', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'6', Cost:22.31, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'2', Cost:30.82, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'4', Cost:30.82, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'36', Cost:19.96, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:19.96, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'62', Cost:16.68, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'35', Cost:15.48, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'94', Cost:10.96, ParentId: '17'},
		]
	},
