const timestamp_saved = '12/04/2023 01:10 PM';
const dataFechaAcualizado = '12/4/2023' + ' 9:06:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2049},
	{Index:'7', Desc:'Máxima para Hoy', value: 2096},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'50', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'52', Cost:10.68, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.50, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'72', Cost:11.44, ParentId: '17'},
		]
	},
