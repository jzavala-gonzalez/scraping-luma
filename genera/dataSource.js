const timestamp_saved = '09/04/2023 03:50 PM';
const dataFechaAcualizado = '9/4/2023' + ' 11:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'38', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:11.08, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 78,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 133, MVar:'53', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'158', Cost:18.20, ParentId: '16'},
		]
	},
