const timestamp_saved = '12/02/2023 12:40 PM';
const dataFechaAcualizado = '12/2/2023' + ' 8:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'42', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'45', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'119', Cost:18.21, ParentId: '16'},
		]
	},
