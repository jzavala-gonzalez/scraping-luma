const timestamp_saved = '11/14/2023 01:45 PM';
const dataFechaAcualizado = '11/14/2023' + ' 9:41:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2430},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'52', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'54', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'57', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'3', Cost:29.38, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 28, MVar:'135', Cost:61.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'105', Cost:10.91, ParentId: '17'},
		]
	},
