const timestamp_saved = '10/14/2023 02:05 AM';
const dataFechaAcualizado = '10/13/2023' + ' 10:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'66', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'71', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'72', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 82,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 14, MVar:'0', Cost:22.06, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.31, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'76', Cost:17.26, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'185', Cost:16.62, ParentId: '16'},
		]
	},
