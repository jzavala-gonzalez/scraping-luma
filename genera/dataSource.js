const timestamp_saved = '10/15/2023 09:25 AM';
const dataFechaAcualizado = '10/15/2023' + ' 5:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'51', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'46', Cost:10.22, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.08, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 192,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 192, MVar:'51', Cost:10.57, ParentId: '17'},
		]
	},
