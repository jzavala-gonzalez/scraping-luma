const timestamp_saved = '12/03/2023 10:10 AM';
const dataFechaAcualizado = '12/3/2023' + ' 6:06:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'37', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'39', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'44', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'53', Cost:11.63, ParentId: '17'},
		]
	},
