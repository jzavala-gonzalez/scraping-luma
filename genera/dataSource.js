const timestamp_saved = '08/30/2023 05:45 AM';
const dataFechaAcualizado = '8/30/2023' + ' 1:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'47', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'1', Cost:25.22, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'15', Cost:27.95, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'19', Cost:19.49, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'73', Cost:16.90, ParentId: '15'},
