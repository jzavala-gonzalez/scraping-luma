const timestamp_saved = '11/12/2023 11:55 AM';
const dataFechaAcualizado = '11/12/2023' + ' 7:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.42, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'54', Cost:17.63, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'79', Cost:9.63, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 23,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'9', Cost:19.60, ParentId: '19'},
