const timestamp_saved = '10/24/2023 08:10 AM';
const dataFechaAcualizado = '10/24/2023' + ' 4:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'40', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'41', Cost:11.15, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'60', Cost:11.29, ParentId: '17'},
		]
	},
