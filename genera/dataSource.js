const timestamp_saved = '07/28/2023 10:27 AM';
const dataFechaAcualizado = '7/28/2023' + ' 6:20:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'40', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'40', Cost:11.01, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'6', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'0', Cost:22.28, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'77', Cost:17.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'34', Cost:16.30, ParentId: '15'},
		]
	},
