const timestamp_saved = '08/22/2023 01:15 PM';
const dataFechaAcualizado = '8/22/2023' + ' 9:10:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'67', Cost:4.38, ParentId: '6'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'130', Cost:17.77, ParentId: '16'},
		]
	},
