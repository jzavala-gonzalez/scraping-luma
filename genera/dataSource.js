const timestamp_saved = '08/13/2023 01:30 AM';
const dataFechaAcualizado = '8/12/2023' + ' 9:27:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'44', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:20.32, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'116', Cost:11.62, ParentId: '17'},
		]
	},
