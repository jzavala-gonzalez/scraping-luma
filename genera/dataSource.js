const timestamp_saved = '11/29/2023 07:55 AM';
const dataFechaAcualizado = '11/29/2023' + ' 3:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'20', Cost:13.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'30', Cost:13.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'46', Cost:13.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 137, MVar:'44', Cost:8.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:8.08, ParentId: '11'},
