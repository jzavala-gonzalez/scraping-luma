const timestamp_saved = '11/21/2023 10:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 6:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'26', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'37', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'50', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'77', Cost:9.61, ParentId: '17'},
		]
	},
