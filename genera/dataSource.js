const timestamp_saved = '08/18/2023 05:05 AM';
const dataFechaAcualizado = '8/18/2023' + ' 1:02:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'43', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'56', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'68', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 36,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 6, MVar:'0', Cost:27.89, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.59, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'138', Cost:16.97, ParentId: '16'},
		]
	},
