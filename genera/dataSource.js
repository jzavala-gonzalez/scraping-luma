const timestamp_saved = '09/17/2023 01:20 PM';
const dataFechaAcualizado = '9/17/2023' + ' 9:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 185, MVar:'66', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'42', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'43', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'57', Cost:12.00, ParentId: '7'},
		]
	},
