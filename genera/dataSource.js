const timestamp_saved = '08/10/2023 10:25 AM';
const dataFechaAcualizado = '8/10/2023' + ' 6:20:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'55', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'57', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'0', Cost:30.99, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:29.96, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 347, MVar:'177', Cost:16.73, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'79', Cost:11.99, ParentId: '17'},
		]
	},
