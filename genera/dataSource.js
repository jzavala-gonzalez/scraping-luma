const timestamp_saved = '11/16/2023 08:20 AM';
const dataFechaAcualizado = '11/16/2023' + ' 4:16:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1945},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'41', Cost:12.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'41', Cost:12.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'47', Cost:12.70, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 164, MVar:'21', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:17.24, ParentId: '11'},
