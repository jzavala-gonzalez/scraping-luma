const timestamp_saved = '07/28/2023 08:20 PM';
const dataFechaAcualizado = '7/28/2023' + ' 4:15:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'3', Cost:24.48, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'5', Cost:30.87, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'9', Cost:28.52, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.54, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'24', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'78', Cost:16.91, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'49', Cost:15.50, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'92', Cost:13.51, ParentId: '17'},
		]
	},
