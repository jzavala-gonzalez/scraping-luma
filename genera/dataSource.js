const timestamp_saved = '08/19/2023 04:50 AM';
const dataFechaAcualizado = '8/19/2023' + ' 12:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'62', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'72', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 57,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:31.04, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:30.91, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'0', Cost:30.78, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 23,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 23, MVar:'14', Cost:30.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'63', Cost:16.51, ParentId: '15'},
