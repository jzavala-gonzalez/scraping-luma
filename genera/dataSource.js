const timestamp_saved = '11/25/2023 04:40 PM';
const dataFechaAcualizado = '11/25/2023' + ' 12:36:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'24', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'35', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'50', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:18.12, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:18.12, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'35', Cost:18.59, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:18.59, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'49', Cost:9.84, ParentId: '17'},
		]
	},
