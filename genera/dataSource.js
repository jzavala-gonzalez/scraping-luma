const timestamp_saved = '08/11/2023 10:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 6:32:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'46', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'48', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 193,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'1', Cost:21.91, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'32', Cost:18.71, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'138', Cost:11.41, ParentId: '17'},
		]
	},
