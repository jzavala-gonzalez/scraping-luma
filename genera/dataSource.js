const timestamp_saved = '11/29/2023 10:55 PM';
const dataFechaAcualizado = '11/29/2023' + ' 6:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'57', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'60', Cost:10.59, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:27.04, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'178', Cost:16.80, ParentId: '16'},
		]
	},
