const timestamp_saved = '09/17/2023 10:35 AM';
const dataFechaAcualizado = '9/17/2023' + ' 6:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'38', Cost:11.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 382,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:8.58, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'111', Cost:18.44, ParentId: '16'},
		]
	},
