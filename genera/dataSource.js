const timestamp_saved = '10/25/2023 11:05 PM';
const dataFechaAcualizado = '10/25/2023' + ' 7:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'50', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:11.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 128, MVar:'39', Cost:16.91, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:16.91, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 127, MVar:'38', Cost:17.47, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:17.47, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.92, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'76', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'157', Cost:16.81, ParentId: '16'},
		]
	},
