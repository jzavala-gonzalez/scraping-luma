const timestamp_saved = '08/23/2023 11:55 AM';
const dataFechaAcualizado = '8/23/2023' + ' 7:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'69', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'67', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'50', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'47', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'136', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'67', Cost:9.84, ParentId: '17'},
		]
	},
