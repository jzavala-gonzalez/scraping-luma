const timestamp_saved = '09/27/2023 10:20 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'28', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'28', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'60', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:8.30, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'3', Cost:19.27, ParentId: '14'},
