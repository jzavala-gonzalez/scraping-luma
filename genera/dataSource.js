const timestamp_saved = '10/14/2023 10:06 AM';
const dataFechaAcualizado = '10/14/2023' + ' 6:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'46', Cost:11.10, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'69', Cost:9.28, ParentId: '17'},
		]
	},
