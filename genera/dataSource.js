const timestamp_saved = '09/23/2023 02:30 PM';
const dataFechaAcualizado = '9/23/2023' + ' 10:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'45', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'48', Cost:10.62, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'45', Cost:20.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'11', Cost:20.37, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:33.97, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'11', Cost:31.77, ParentId: '13'},
