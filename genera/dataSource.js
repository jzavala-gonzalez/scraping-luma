const timestamp_saved = '10/13/2023 05:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 1:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'58', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'61', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'66', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 246,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 246, MVar:'174', Cost:17.79, ParentId: '16'},
		]
	},
