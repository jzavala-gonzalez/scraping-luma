const timestamp_saved = '10/26/2023 04:10 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:06:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'47', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'50', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'51', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'153', Cost:18.26, ParentId: '16'},
		]
	},
