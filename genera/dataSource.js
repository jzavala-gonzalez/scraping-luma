const timestamp_saved = '08/18/2023 04:50 PM';
const dataFechaAcualizado = '8/18/2023' + ' 12:47:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'63', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'73', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'8', Cost:30.69, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'9', Cost:31.91, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:19.58, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'29', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'76', Cost:19.55, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'81', Cost:9.45, ParentId: '17'},
		]
	},
