const timestamp_saved = '10/26/2023 10:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'42', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'43', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'46', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'0', Cost:0, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.83, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'70', Cost:19.59, ParentId: '15'},
