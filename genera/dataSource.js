const timestamp_saved = '10/27/2023 12:00 AM';
const dataFechaAcualizado = '10/26/2023' + ' 7:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'54', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'57', Cost:10.36, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'29', Cost:30.95, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:18.19, ParentId: '11'},
