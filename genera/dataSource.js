const timestamp_saved = '11/29/2023 05:35 AM';
const dataFechaAcualizado = '11/29/2023' + ' 1:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'27', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'35', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'47', Cost:8.19, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'72', Cost:9.84, ParentId: '17'},
		]
	},
