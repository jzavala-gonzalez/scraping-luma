const timestamp_saved = '11/25/2023 06:15 PM';
const dataFechaAcualizado = '11/25/2023' + ' 2:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'30', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'40', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'52', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'14', Cost:17.27, ParentId: '11'},
