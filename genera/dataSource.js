const timestamp_saved = '09/21/2023 01:55 AM';
const dataFechaAcualizado = '9/20/2023' + ' 9:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 558,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'62', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'66', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'16', Cost:28.26, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'6', Cost:26.87, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'15', Cost:26.77, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'82', Cost:16.42, ParentId: '15'},
