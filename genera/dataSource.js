const timestamp_saved = '10/04/2023 01:00 AM';
const dataFechaAcualizado = '10/3/2023' + ' 8:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'44', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'42', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'55', Cost:10.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:26.20, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 189,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'10', Cost:23.45, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.82, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'167', Cost:16.63, ParentId: '16'},
		]
	},
