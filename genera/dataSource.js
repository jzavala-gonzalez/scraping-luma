const timestamp_saved = '10/01/2023 03:00 PM';
const dataFechaAcualizado = '10/1/2023' + ' 10:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'27', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'25', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'43', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'86', Cost:9.49, ParentId: '17'},
		]
	},
