const timestamp_saved = '11/24/2023 10:15 AM';
const dataFechaAcualizado = '11/24/2023' + ' 6:11:22 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1901},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'24', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'33', Cost:10.82, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'66', Cost:9.88, ParentId: '17'},
		]
	},
