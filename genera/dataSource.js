const timestamp_saved = '08/03/2023 05:25 PM';
const dataFechaAcualizado = '8/3/2023' + ' 1:20:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'44', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'48', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'20', Cost:15.55, ParentId: '15'},
		]
	},
