const timestamp_saved = '11/05/2023 01:35 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:31:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1887},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'42', Cost:13.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'41', Cost:13.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'40', Cost:13.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'36', Cost:8.79, ParentId: '11'},
