const timestamp_saved = '11/20/2023 09:55 PM';
const dataFechaAcualizado = '11/20/2023' + ' 5:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'37', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'47', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'59', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 7, MVar:'10', Cost:71.20, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'102', Cost:9.42, ParentId: '17'},
		]
	},
