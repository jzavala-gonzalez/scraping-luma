const timestamp_saved = '09/04/2023 02:40 AM';
const dataFechaAcualizado = '9/3/2023' + ' 10:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'39', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'44', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'57', Cost:11.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 151,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 97, MVar:'0', Cost:5.13, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 133, MVar:'41', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'26', Cost:19.48, ParentId: '14'},
