const timestamp_saved = '11/11/2023 03:45 AM';
const dataFechaAcualizado = '11/10/2023' + ' 11:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 236,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 236, MVar:'88', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'46', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'48', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'50', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 6, MVar:'1', Cost:27.30, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:22.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'89', Cost:9.25, ParentId: '17'},
		]
	},
