const timestamp_saved = '11/28/2023 04:45 AM';
const dataFechaAcualizado = '11/28/2023' + ' 12:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'31', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'39', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'52', Cost:10.52, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 102, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:8.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:8.26, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 130, MVar:'39', Cost:8.17, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:30.03, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'145', Cost:17.87, ParentId: '16'},
		]
	},
