const timestamp_saved = '11/24/2023 03:05 AM';
const dataFechaAcualizado = '11/23/2023' + ' 11:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'32', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'40', Cost:10.84, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'92', Cost:9.20, ParentId: '17'},
		]
	},
