const timestamp_saved = '11/03/2023 04:00 PM';
const dataFechaAcualizado = '11/3/2023' + ' 11:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'56', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'53', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'51', Cost:11.96, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:25.73, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'7', Cost:17.16, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'102', Cost:16.82, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'156', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'79', Cost:9.77, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:25.67, ParentId: '21'},
