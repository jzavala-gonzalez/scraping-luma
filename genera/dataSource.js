const timestamp_saved = '08/16/2023 06:40 AM';
const dataFechaAcualizado = '8/16/2023' + ' 2:37:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'58', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'53', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'60', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'87', Cost:10.26, ParentId: '17'},
		]
	},
