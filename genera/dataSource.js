const timestamp_saved = '11/19/2023 01:50 PM';
const dataFechaAcualizado = '11/19/2023' + ' 9:46:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2099},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 259,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'36', Cost:16.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'44', Cost:16.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:16.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'5', Cost:31.13, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:17.93, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.93, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 41, MVar:'13', Cost:22.80, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'79', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'132', Cost:18.31, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'89', Cost:9.91, ParentId: '17'},
		]
	},
