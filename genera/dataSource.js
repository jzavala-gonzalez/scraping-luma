const timestamp_saved = '10/13/2023 02:40 PM';
const dataFechaAcualizado = '10/13/2023' + ' 10:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'62', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'68', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'71', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 34,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'13', Cost:45.64, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:16.86, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'179', Cost:18.25, ParentId: '16'},
		]
	},
