const timestamp_saved = '12/04/2023 12:11 AM';
const dataFechaAcualizado = '12/3/2023' + ' 8:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'52', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'54', Cost:11.19, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'148', Cost:16.89, ParentId: '16'},
		]
	},
