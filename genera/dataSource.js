const timestamp_saved = '11/20/2023 01:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 9:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'42', Cost:10.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'187', Cost:18.26, ParentId: '16'},
		]
	},
