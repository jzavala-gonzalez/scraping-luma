const timestamp_saved = '08/13/2023 11:10 AM';
const dataFechaAcualizado = '8/13/2023' + ' 7:07:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'38', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'41', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'37', Cost:19.25, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'109', Cost:12.26, ParentId: '17'},
		]
	},
