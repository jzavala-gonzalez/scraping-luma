const timestamp_saved = '09/17/2023 01:05 PM';
const dataFechaAcualizado = '9/17/2023' + ' 9:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 363,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'42', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'41', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'57', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'76', Cost:18.50, ParentId: '15'},
