const timestamp_saved = '09/23/2023 03:40 AM';
const dataFechaAcualizado = '9/22/2023' + ' 11:35:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 448,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'65', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'41', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'42', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'57', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'9', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'101', Cost:32.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'83', Cost:9.03, ParentId: '17'},
		]
	},
