const timestamp_saved = '10/22/2023 11:50 AM';
const dataFechaAcualizado = '10/22/2023' + ' 7:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'38', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'39', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'3', Cost:18.99, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'53', Cost:11.24, ParentId: '17'},
		]
	},
