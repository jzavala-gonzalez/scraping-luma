const timestamp_saved = '10/19/2023 06:50 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'27', Cost:13.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'35', Cost:13.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'42', Cost:13.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 35,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'11', Cost:29.32, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.12, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'0', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 343,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 343, MVar:'148', Cost:16.56, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'79', Cost:10.89, ParentId: '17'},
		]
	},
