const timestamp_saved = '12/06/2023 03:55 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:50:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 924},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'47', Cost:12.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'50', Cost:12.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'57', Cost:12.48, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.33, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'66', Cost:14.56, ParentId: '17'},
		]
	},
