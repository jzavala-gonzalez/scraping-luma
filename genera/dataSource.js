const timestamp_saved = '08/21/2023 12:35 AM';
const dataFechaAcualizado = '8/20/2023' + ' 8:32:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'66', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'27', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'65', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:30.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 50, MVar:'11', Cost:21.62, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'94', Cost:9.15, ParentId: '17'},
		]
	},
