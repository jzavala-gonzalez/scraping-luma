const timestamp_saved = '10/21/2023 06:05 PM';
const dataFechaAcualizado = '10/21/2023' + ' 2:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'52', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'53', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:8.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 145, MVar:'41', Cost:17.84, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'8', Cost:17.84, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 0, MVar:'0', Cost:20.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 282, MVar:'149', Cost:17.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'72', Cost:11.05, ParentId: '17'},
		]
	},
