const timestamp_saved = '09/27/2023 03:55 PM';
const dataFechaAcualizado = '9/27/2023' + ' 11:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'32', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'32', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'63', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.40, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'96', Cost:16.47, ParentId: '15'},
