const timestamp_saved = '11/26/2023 10:10 PM';
const dataFechaAcualizado = '11/26/2023' + ' 6:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'36', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'44', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'55', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'15', Cost:43.48, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'93', Cost:9.53, ParentId: '17'},
		]
	},
