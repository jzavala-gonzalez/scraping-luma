const timestamp_saved = '11/05/2023 01:20 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'42', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'40', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'41', Cost:12.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'34', Cost:8.78, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'51', Cost:9.80, ParentId: '17'},
		]
	},
