const timestamp_saved = '11/08/2023 01:35 AM';
const dataFechaAcualizado = '11/7/2023' + ' 9:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	{Index:'0', Type:'Hidroelectricas', Desc:'Dos Bocas', SiteTotal: 1,
		units:[
			...
			{Index:'1', Unit:'Hidro 2', MW: 1, MVar:'0', Cost:0, ParentId: '0'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'108', Cost:9.16, ParentId: '17'},
		]
	},
