const timestamp_saved = '08/24/2023 09:45 AM';
const dataFechaAcualizado = '8/24/2023' + ' 5:40:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'4', Cost:26.76, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'9', Cost:8.13, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'22', Cost:19.07, ParentId: '14'},
