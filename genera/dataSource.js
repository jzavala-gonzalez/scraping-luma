const timestamp_saved = '08/05/2023 03:20 AM';
const dataFechaAcualizado = '8/4/2023' + ' 11:15:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'43', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:28.67, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'85', Cost:16.97, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'49', Cost:15.60, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'140', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'90', Cost:11.41, ParentId: '17'},
		]
	},
