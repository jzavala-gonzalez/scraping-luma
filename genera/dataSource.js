const timestamp_saved = '11/23/2023 11:40 AM';
const dataFechaAcualizado = '11/23/2023' + ' 7:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'21', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'31', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'47', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'62', Cost:9.78, ParentId: '17'},
		]
	},
