const timestamp_saved = '12/03/2023 05:45 PM';
const dataFechaAcualizado = '12/3/2023' + ' 1:41:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1741},
	{Index:'1', Desc:'PREPA', value: 61},
	{Index:'2', Desc:'COGEN', value: 39},
	{Index:'3', Desc:'Reserva en Rotación', value: 764},
	{Index:'4', Desc:'Reserva Operacional', value: 1401},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'36', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'39', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'45', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'18', Cost:19.71, ParentId: '14'},
