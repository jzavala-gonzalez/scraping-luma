const timestamp_saved = '11/28/2023 05:10 AM';
const dataFechaAcualizado = '11/28/2023' + ' 1:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'29', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'39', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'51', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:8.68, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'11', Cost:19.18, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'144', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'79', Cost:9.50, ParentId: '17'},
		]
	},
