const timestamp_saved = '11/10/2023 03:05 AM';
const dataFechaAcualizado = '11/9/2023' + ' 11:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'43', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'39', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'45', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'26', Cost:21.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'124', Cost:18.22, ParentId: '16'},
		]
	},
