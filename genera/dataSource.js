const timestamp_saved = '11/23/2023 09:40 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'62', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'19', Cost:13.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:13.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'46', Cost:13.42, ParentId: '7'},
		]
	},
