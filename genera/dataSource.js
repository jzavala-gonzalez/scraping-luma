const timestamp_saved = '08/11/2023 06:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 2:30:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'50', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'47', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'6', Cost:35.56, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'132', Cost:11.70, ParentId: '17'},
		]
	},
