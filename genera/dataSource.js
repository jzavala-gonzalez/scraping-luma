const timestamp_saved = '10/08/2023 11:45 AM';
const dataFechaAcualizado = '10/8/2023' + ' 7:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'34', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'36', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 162, MVar:'64', Cost:11.29, ParentId: '17'},
		]
	},
