const timestamp_saved = '10/13/2023 11:00 AM';
const dataFechaAcualizado = '10/13/2023' + ' 6:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'57', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'61', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'65', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.50, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'68', Cost:9.15, ParentId: '17'},
		]
	},
