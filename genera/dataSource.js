const timestamp_saved = '11/08/2023 02:45 PM';
const dataFechaAcualizado = '11/8/2023' + ' 10:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'53', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'52', Cost:11.05, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 19, MVar:'4', Cost:36.32, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'100', Cost:9.60, ParentId: '17'},
		]
	},
