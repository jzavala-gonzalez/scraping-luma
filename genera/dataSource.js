const timestamp_saved = '10/20/2023 07:20 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'32', Cost:12.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'38', Cost:12.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'39', Cost:12.26, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 4,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 4, MVar:'0', Cost:26.16, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'78', Cost:10.52, ParentId: '17'},
		]
	},
