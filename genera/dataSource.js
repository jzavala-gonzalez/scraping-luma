const timestamp_saved = '10/15/2023 09:35 AM';
const dataFechaAcualizado = '10/15/2023' + ' 5:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'50', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'45', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'48', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 7, MVar:'1', Cost:30.65, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 236,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 236, MVar:'55', Cost:10.13, ParentId: '17'},
		]
	},
