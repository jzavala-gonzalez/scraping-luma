const timestamp_saved = '08/04/2023 08:10 PM';
const dataFechaAcualizado = '8/4/2023' + ' 4:05:38 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3456},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'45', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'50', Cost:10.92, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 26, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:30.79, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.06, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.34, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'89', Cost:16.56, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'50', Cost:16.61, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'157', Cost:16.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 311, MVar:'97', Cost:11.51, ParentId: '17'},
		]
	},
