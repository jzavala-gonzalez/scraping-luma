const timestamp_saved = '09/21/2023 09:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 5:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'41', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'46', Cost:10.63, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 127, MVar:'0', Cost:10.00, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:10.00, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'15', Cost:26.53, ParentId: '14'},
