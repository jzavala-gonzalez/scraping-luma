const timestamp_saved = '09/27/2023 11:15 PM';
const dataFechaAcualizado = '9/27/2023' + ' 7:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'37', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'37', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'66', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'125', Cost:9.10, ParentId: '17'},
		]
	},
