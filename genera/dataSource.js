const timestamp_saved = '10/22/2023 09:30 PM';
const dataFechaAcualizado = '10/22/2023' + ' 5:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'46', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'45', Cost:10.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 14,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 14, MVar:'0', Cost:25.89, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:17.34, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'67', Cost:11.31, ParentId: '17'},
		]
	},
