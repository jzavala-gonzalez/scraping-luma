const timestamp_saved = '07/31/2023 10:05 AM';
const dataFechaAcualizado = '7/31/2023' + ' 6:00:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'45', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'49', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'37', Cost:19.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:19.72, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'110', Cost:17.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'88', Cost:11.39, ParentId: '17'},
		]
	},
