const timestamp_saved = '08/12/2023 06:25 PM';
const dataFechaAcualizado = '8/12/2023' + ' 2:22:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'41', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'41', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'42', Cost:10.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 130, MVar:'23', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 45, MVar:'0', Cost:22.24, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'147', Cost:17.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'112', Cost:11.62, ParentId: '17'},
		]
	},
