const timestamp_saved = '07/29/2023 06:00 AM';
const dataFechaAcualizado = '7/29/2023' + ' 1:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'47', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'47', Cost:11.08, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 157, MVar:'2', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:27.01, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:46.20, ParentId: '9'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 310,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 310, MVar:'82', Cost:13.41, ParentId: '17'},
		]
	},
