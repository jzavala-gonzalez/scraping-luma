const timestamp_saved = '10/15/2023 02:30 PM';
const dataFechaAcualizado = '10/15/2023' + ' 10:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'53', Cost:11.05, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.07, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'64', Cost:9.51, ParentId: '17'},
		]
	},
