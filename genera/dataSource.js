const timestamp_saved = '08/20/2023 10:50 AM';
const dataFechaAcualizado = '8/20/2023' + ' 6:47:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'45', Cost:11.00, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'55', Cost:9.27, ParentId: '17'},
		]
	},
