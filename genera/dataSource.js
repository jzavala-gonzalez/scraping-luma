const timestamp_saved = '11/23/2023 08:25 PM';
const dataFechaAcualizado = '11/23/2023' + ' 4:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'27', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'37', Cost:10.72, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.49, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'61', Cost:9.97, ParentId: '17'},
		]
	},
