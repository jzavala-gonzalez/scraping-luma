const timestamp_saved = '10/19/2023 10:40 PM';
const dataFechaAcualizado = '10/19/2023' + ' 6:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'40', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'47', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'69', Cost:10.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.21, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'192', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'112', Cost:10.53, ParentId: '17'},
		]
	},
