const timestamp_saved = '08/09/2023 05:35 AM';
const dataFechaAcualizado = '8/9/2023' + ' 1:30:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'39', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'46', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'57', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:30.90, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 347,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 347, MVar:'107', Cost:17.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'69', Cost:12.84, ParentId: '17'},
		]
	},
