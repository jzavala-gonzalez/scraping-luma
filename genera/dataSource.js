const timestamp_saved = '09/26/2023 11:30 PM';
const dataFechaAcualizado = '9/26/2023' + ' 7:25:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 3099},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'61', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'62', Cost:10.50, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'27', Cost:30.85, ParentId: '10'},
		]
	},
