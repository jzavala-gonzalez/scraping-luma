const timestamp_saved = '11/22/2023 01:15 PM';
const dataFechaAcualizado = '11/22/2023' + ' 9:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'35', Cost:10.60, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'170', Cost:18.25, ParentId: '16'},
		]
	},
