const timestamp_saved = '10/28/2023 04:00 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'41', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'47', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'15', Cost:34.60, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 55, MVar:'7', Cost:20.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'97', Cost:19.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'126', Cost:17.24, ParentId: '16'},
		]
	},
