const timestamp_saved = '12/03/2023 04:15 PM';
const dataFechaAcualizado = '12/3/2023' + ' 12:11:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1734},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 161, MVar:'57', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'37', Cost:13.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'38', Cost:13.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'45', Cost:13.49, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:8.75, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'91', Cost:18.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 230,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 230, MVar:'50', Cost:11.90, ParentId: '17'},
		]
	},
