const timestamp_saved = '08/18/2023 11:40 AM';
const dataFechaAcualizado = '8/18/2023' + ' 7:37:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.46, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'5', Cost:31.43, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'73', Cost:9.30, ParentId: '17'},
		]
	},
