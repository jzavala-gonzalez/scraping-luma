const timestamp_saved = '10/15/2023 07:15 PM';
const dataFechaAcualizado = '10/15/2023' + ' 3:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'55', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'53', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'53', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:27.08, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:283.44, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'96', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 293,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 293, MVar:'157', Cost:17.45, ParentId: '16'},
		]
	},
