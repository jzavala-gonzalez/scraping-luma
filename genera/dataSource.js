const timestamp_saved = '10/26/2023 08:20 PM';
const dataFechaAcualizado = '10/26/2023' + ' 4:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'51', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'52', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 166, MVar:'54', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'143', Cost:17.36, ParentId: '16'},
		]
	},
