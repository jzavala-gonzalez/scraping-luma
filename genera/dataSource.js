const timestamp_saved = '09/28/2023 01:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 9:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'36', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'36', Cost:10.70, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.96, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'150', Cost:17.83, ParentId: '16'},
		]
	},
