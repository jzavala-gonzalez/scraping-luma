const timestamp_saved = '09/13/2023 11:45 AM';
const dataFechaAcualizado = '9/13/2023' + ' 7:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'64', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'19', Cost:19.63, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'94', Cost:9.12, ParentId: '17'},
		]
	},
