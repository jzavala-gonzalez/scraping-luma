const timestamp_saved = '09/19/2023 05:05 AM';
const dataFechaAcualizado = '9/19/2023' + ' 1:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'47', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'47', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'59', Cost:11.32, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.02, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:19.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:19.99, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 127, MVar:'0', Cost:8.17, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'12', Cost:19.24, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'154', Cost:16.83, ParentId: '16'},
		]
	},
