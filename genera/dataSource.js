const timestamp_saved = '10/19/2023 06:15 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'31', Cost:12.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'37', Cost:12.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'45', Cost:12.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'10', Cost:8.08, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'0', Cost:18.81, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'59', Cost:16.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'84', Cost:10.82, ParentId: '17'},
		]
	},
