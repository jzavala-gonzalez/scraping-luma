const timestamp_saved = '10/19/2023 08:15 AM';
const dataFechaAcualizado = '10/19/2023' + ' 4:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'33', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'40', Cost:10.60, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'0', Cost:19.33, ParentId: '14'},
