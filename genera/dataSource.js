const timestamp_saved = '08/27/2023 05:10 PM';
const dataFechaAcualizado = '8/27/2023' + ' 1:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'30', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'14', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'56', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 44,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'7', Cost:32.18, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:8.36, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'29', Cost:19.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 125, MVar:'78', Cost:17.12, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'126', Cost:18.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'82', Cost:12.51, ParentId: '17'},
		]
	},
