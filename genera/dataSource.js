const timestamp_saved = '11/24/2023 07:35 PM';
const dataFechaAcualizado = '11/24/2023' + ' 3:31:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2157},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'36', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'46', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'56', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'102', Cost:9.18, ParentId: '17'},
		]
	},
