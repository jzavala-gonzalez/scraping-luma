const timestamp_saved = '12/01/2023 04:45 AM';
const dataFechaAcualizado = '12/1/2023' + ' 12:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:29.36, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'51', Cost:8.08, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'64', Cost:9.86, ParentId: '17'},
		]
	},
