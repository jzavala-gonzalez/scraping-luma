const timestamp_saved = '09/16/2023 09:45 PM';
const dataFechaAcualizado = '9/16/2023' + ' 5:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'45', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'45', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'60', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'89', Cost:16.75, ParentId: '15'},
