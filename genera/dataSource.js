const timestamp_saved = '08/02/2023 07:40 PM';
const dataFechaAcualizado = '8/2/2023' + ' 3:35:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'44', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'50', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:22.03, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.82, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 32, MVar:'8', Cost:22.82, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:20.43, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 328,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'117', Cost:16.66, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 162, MVar:'26', Cost:15.55, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 341, MVar:'163', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'99', Cost:10.87, ParentId: '17'},
		]
	},
