const timestamp_saved = '11/22/2023 06:40 AM';
const dataFechaAcualizado = '11/22/2023' + ' 2:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'20', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'30', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'47', Cost:11.65, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'66', Cost:9.79, ParentId: '17'},
		]
	},
