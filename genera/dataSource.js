const timestamp_saved = '09/04/2023 05:50 AM';
const dataFechaAcualizado = '9/4/2023' + ' 1:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'35', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'38', Cost:10.76, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'134', Cost:17.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'59', Cost:9.44, ParentId: '17'},
		]
	},
