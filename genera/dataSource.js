const timestamp_saved = '10/03/2023 01:25 PM';
const dataFechaAcualizado = '10/3/2023' + ' 9:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'43', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'55', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:25.65, ParentId: '11'},
