const timestamp_saved = '08/23/2023 04:45 PM';
const dataFechaAcualizado = '8/23/2023' + ' 12:40:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'13', Cost:30.69, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:19.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:19.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 148, MVar:'0', Cost:8.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 53, MVar:'10', Cost:8.30, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'26', Cost:18.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'92', Cost:18.38, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'153', Cost:17.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 313,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 313, MVar:'86', Cost:9.41, ParentId: '17'},
		]
	},
