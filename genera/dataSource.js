const timestamp_saved = '11/15/2023 02:40 AM';
const dataFechaAcualizado = '11/14/2023' + ' 10:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'49', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'51', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'55', Cost:12.44, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'37', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'23', Cost:29.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.15, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'12', Cost:22.46, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'78', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'164', Cost:17.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'103', Cost:10.93, ParentId: '17'},
		]
	},
