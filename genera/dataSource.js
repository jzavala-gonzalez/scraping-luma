const timestamp_saved = '10/16/2023 12:35 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'58', Cost:10.09, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'167', Cost:18.39, ParentId: '16'},
		]
	},
