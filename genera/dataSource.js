const timestamp_saved = '11/26/2023 11:20 AM';
const dataFechaAcualizado = '11/26/2023' + ' 7:16:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'17', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'26', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'44', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'13', Cost:19.27, ParentId: '14'},
