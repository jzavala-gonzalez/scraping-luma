const timestamp_saved = '11/29/2023 06:50 PM';
const dataFechaAcualizado = '11/29/2023' + ' 2:46:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2197},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'49', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'53', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'87', Cost:9.83, ParentId: '17'},
		]
	},
