const timestamp_saved = '10/26/2023 09:25 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'38', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'39', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'131', Cost:18.27, ParentId: '16'},
		]
	},
