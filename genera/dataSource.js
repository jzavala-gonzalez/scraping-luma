const timestamp_saved = '10/30/2023 02:15 AM';
const dataFechaAcualizado = '10/29/2023' + ' 10:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:10.91, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'68', Cost:9.38, ParentId: '17'},
		]
	},
