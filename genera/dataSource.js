const timestamp_saved = '11/15/2023 06:55 AM';
const dataFechaAcualizado = '11/15/2023' + ' 2:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'33', Cost:12.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'35', Cost:12.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'44', Cost:12.72, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'60', Cost:9.75, ParentId: '17'},
		]
	},
