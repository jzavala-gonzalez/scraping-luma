const timestamp_saved = '10/26/2023 09:20 AM';
const dataFechaAcualizado = '10/26/2023' + ' 5:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'39', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'40', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'59', Cost:18.45, ParentId: '15'},
