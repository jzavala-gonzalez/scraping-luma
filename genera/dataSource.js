const timestamp_saved = '09/19/2023 12:20 AM';
const dataFechaAcualizado = '9/18/2023' + ' 8:15:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'64', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'63', Cost:9.77, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'14', Cost:22.94, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'4', Cost:20.50, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'31', Cost:19.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 174, MVar:'95', Cost:16.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'195', Cost:16.65, ParentId: '16'},
		]
	},
