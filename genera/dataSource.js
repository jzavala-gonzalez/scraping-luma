const timestamp_saved = '11/22/2023 09:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 4:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'34', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'44', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'10', Cost:43.62, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:17.60, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'9', Cost:19.70, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'169', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'101', Cost:9.25, ParentId: '17'},
		]
	},
