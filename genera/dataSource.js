const timestamp_saved = '09/19/2023 05:05 PM';
const dataFechaAcualizado = '9/19/2023' + ' 1:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'59', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'60', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'71', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'2', Cost:26.94, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'8', Cost:8.15, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'27', Cost:18.87, ParentId: '14'},
			{Index:'3', Unit:'Unit 10', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
		]
	},
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:0, ParentId: '15'},
			{Index:'2', Unit:'Unit 3', MW: 70, MVar:'75', Cost:20.78, ParentId: '15'},
