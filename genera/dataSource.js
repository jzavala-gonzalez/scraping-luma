const timestamp_saved = '09/10/2023 10:55 AM';
const dataFechaAcualizado = '9/10/2023' + ' 6:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'58', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'57', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'61', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 14,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'2', Cost:27.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'65', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'113', Cost:17.85, ParentId: '16'},
		]
	},
