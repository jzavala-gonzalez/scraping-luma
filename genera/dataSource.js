const timestamp_saved = '11/12/2023 03:05 AM';
const dataFechaAcualizado = '11/11/2023' + ' 11:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'50', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'52', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'58', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'10', Cost:22.27, ParentId: '14'},
