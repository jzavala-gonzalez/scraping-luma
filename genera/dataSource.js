const timestamp_saved = '09/13/2023 03:30 PM';
const dataFechaAcualizado = '9/13/2023' + ' 11:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'54', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'53', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'65', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.47, ParentId: '10'},
