const timestamp_saved = '11/25/2023 12:40 PM';
const dataFechaAcualizado = '11/25/2023' + ' 8:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 144,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 144, MVar:'61', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'21', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'31', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'47', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 309,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 109, MVar:'33', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.70, ParentId: '14'},
