const timestamp_saved = '10/27/2023 02:50 AM';
const dataFechaAcualizado = '10/26/2023' + ' 10:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'50', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'50', Cost:10.64, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 44,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'2', Cost:27.16, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'131', Cost:17.04, ParentId: '16'},
		]
	},
