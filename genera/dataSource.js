const timestamp_saved = '11/25/2023 03:40 PM';
const dataFechaAcualizado = '11/25/2023' + ' 11:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'21', Cost:12.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'31', Cost:12.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:12.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.65, ParentId: '11'},
