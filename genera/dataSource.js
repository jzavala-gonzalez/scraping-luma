const timestamp_saved = '11/24/2023 11:45 AM';
const dataFechaAcualizado = '11/24/2023' + ' 7:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'23', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'32', Cost:11.16, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'64', Cost:9.90, ParentId: '17'},
		]
	},
