const timestamp_saved = '08/09/2023 07:00 AM';
const dataFechaAcualizado = '8/9/2023' + ' 2:55:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'37', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'43', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'54', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'95', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'62', Cost:12.93, ParentId: '17'},
		]
	},
