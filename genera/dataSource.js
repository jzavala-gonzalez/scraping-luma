const timestamp_saved = '11/02/2023 02:05 PM';
const dataFechaAcualizado = '11/2/2023' + ' 10:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'55', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'54', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'49', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.45, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:31.61, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 52, MVar:'17', Cost:21.23, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'76', Cost:9.40, ParentId: '17'},
		]
	},
