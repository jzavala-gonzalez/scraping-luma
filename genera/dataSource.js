const timestamp_saved = '08/13/2023 01:10 PM';
const dataFechaAcualizado = '8/13/2023' + ' 9:07:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'38', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'41', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'43', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'36', Cost:19.27, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'116', Cost:12.28, ParentId: '17'},
		]
	},
