const timestamp_saved = '07/28/2023 08:23 AM';
const dataFechaAcualizado = '7/28/2023' + ' 4:15:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'41', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'42', Cost:10.96, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'0', Cost:27.02, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'36', Cost:20.31, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'30', Cost:15.62, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'75', Cost:13.19, ParentId: '17'},
		]
	},
