const timestamp_saved = '08/13/2023 06:40 PM';
const dataFechaAcualizado = '8/13/2023' + ' 2:37:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'36', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'40', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'39', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'110', Cost:12.46, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 64,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 23, MVar:'24', Cost:19.60, ParentId: '19'},
