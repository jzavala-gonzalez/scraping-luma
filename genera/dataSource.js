const timestamp_saved = '09/07/2023 07:35 AM';
const dataFechaAcualizado = '9/7/2023' + ' 3:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'48', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'27', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:10.95, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 112,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 112, MVar:'0', Cost:7.20, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'3', Cost:19.33, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'53', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 188,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 188, MVar:'81', Cost:10.62, ParentId: '17'},
		]
	},
