const timestamp_saved = '10/28/2023 01:15 PM';
const dataFechaAcualizado = '10/28/2023' + ' 9:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'43', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'46', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'15', Cost:33.98, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:33.98, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'10', Cost:22.44, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'129', Cost:17.22, ParentId: '16'},
		]
	},
