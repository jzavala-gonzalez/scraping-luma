const timestamp_saved = '08/13/2023 04:55 PM';
const dataFechaAcualizado = '8/13/2023' + ' 12:52:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'39', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:28.24, ParentId: '9'},
