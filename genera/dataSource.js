const timestamp_saved = '08/21/2023 05:50 PM';
const dataFechaAcualizado = '8/21/2023' + ' 1:45:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'40', Cost:10.55, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'78', Cost:18.44, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'80', Cost:9.42, ParentId: '17'},
		]
	},
