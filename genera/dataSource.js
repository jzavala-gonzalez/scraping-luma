const timestamp_saved = '09/24/2023 01:35 AM';
const dataFechaAcualizado = '9/23/2023' + ' 9:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'49', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'52', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'64', Cost:11.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'22', Cost:19.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'74', Cost:17.00, ParentId: '15'},
