const timestamp_saved = '07/28/2023 10:50 PM';
const dataFechaAcualizado = '7/28/2023' + ' 6:45:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'48', Cost:10.78, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'2', Cost:22.38, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'2', Cost:30.80, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'87', Cost:13.37, ParentId: '17'},
		]
	},
