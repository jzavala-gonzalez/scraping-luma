const timestamp_saved = '11/27/2023 05:40 PM';
const dataFechaAcualizado = '11/27/2023' + ' 1:36:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2156},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'37', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'47', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'58', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'98', Cost:9.56, ParentId: '17'},
		]
	},
