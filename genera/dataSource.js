const timestamp_saved = '09/05/2023 12:15 AM';
const dataFechaAcualizado = '9/4/2023' + ' 8:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'50', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'55', Cost:10.50, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 151,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 37, MVar:'0', Cost:30.95, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 194,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'9', Cost:21.99, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'20', Cost:28.09, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'5', Cost:29.32, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'4', Cost:29.48, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'99', Cost:9.19, ParentId: '17'},
		]
	},
