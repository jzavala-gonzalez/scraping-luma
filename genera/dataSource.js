const timestamp_saved = '08/11/2023 07:25 AM';
const dataFechaAcualizado = '8/11/2023' + ' 3:20:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 504,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'20', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'53', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'47', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'4', Cost:30.48, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:30.68, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 237,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 237, MVar:'85', Cost:12.21, ParentId: '17'},
		]
	},
