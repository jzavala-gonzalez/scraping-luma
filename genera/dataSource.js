const timestamp_saved = '09/26/2023 02:20 AM';
const dataFechaAcualizado = '9/25/2023' + ' 10:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'53', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'56', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'62', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'14', Cost:27.27, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:31.91, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'74', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'180', Cost:16.59, ParentId: '16'},
		]
	},
