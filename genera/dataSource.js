const timestamp_saved = '08/22/2023 09:35 PM';
const dataFechaAcualizado = '8/22/2023' + ' 5:30:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:10.80, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'123', Cost:17.66, ParentId: '16'},
		]
	},
