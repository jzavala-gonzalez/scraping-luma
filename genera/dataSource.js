const timestamp_saved = '08/05/2023 02:05 AM';
const dataFechaAcualizado = '8/4/2023' + ' 10:00:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'50', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'51', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'11', Cost:26.81, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'4', Cost:31.10, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'149', Cost:16.89, ParentId: '16'},
		]
	},
