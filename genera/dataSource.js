const timestamp_saved = '11/23/2023 06:25 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'23', Cost:12.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'33', Cost:12.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'48', Cost:12.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'55', Cost:9.79, ParentId: '17'},
		]
	},
