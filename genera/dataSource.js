const timestamp_saved = '09/29/2023 05:30 PM';
const dataFechaAcualizado = '9/29/2023' + ' 1:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'42', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'39', Cost:10.74, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.45, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'0', Cost:20.87, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:20.87, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'97', Cost:17.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'135', Cost:18.28, ParentId: '16'},
		]
	},
