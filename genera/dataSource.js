const timestamp_saved = '10/02/2023 05:55 AM';
const dataFechaAcualizado = '10/2/2023' + ' 1:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'33', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'31', Cost:10.54, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'3', Cost:26.16, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'12', Cost:17.11, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:30.49, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'73', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 175,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 175, MVar:'127', Cost:19.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'99', Cost:9.21, ParentId: '17'},
		]
	},
