const timestamp_saved = '08/21/2023 11:30 PM';
const dataFechaAcualizado = '8/21/2023' + ' 7:25:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'52', Cost:10.68, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 46,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 15, MVar:'0', Cost:536.21, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'12', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 119, MVar:'72', Cost:18.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'151', Cost:17.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'72', Cost:9.19, ParentId: '17'},
		]
	},
