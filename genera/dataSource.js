const timestamp_saved = '10/27/2023 05:20 PM';
const dataFechaAcualizado = '10/27/2023' + ' 1:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 88, MVar:'52', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'55', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'57', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 166, MVar:'51', Cost:16.89, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'18', Cost:19.55, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 139,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 139, MVar:'81', Cost:17.14, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'108', Cost:17.13, ParentId: '16'},
		]
	},
