const timestamp_saved = '10/25/2023 08:20 AM';
const dataFechaAcualizado = '10/25/2023' + ' 4:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'40', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'41', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'46', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:18.32, ParentId: '11'},
		]
	},
