const timestamp_saved = '08/31/2023 09:25 AM';
const dataFechaAcualizado = '8/31/2023' + ' 5:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'45', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'52', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'60', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:18.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:18.83, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'0', Cost:17.10, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'22', Cost:19.54, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'78', Cost:9.50, ParentId: '17'},
		]
	},
