const timestamp_saved = '11/30/2023 10:35 PM';
const dataFechaAcualizado = '11/30/2023' + ' 6:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'59', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'61', Cost:10.67, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'19', Cost:31.20, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'166', Cost:17.24, ParentId: '16'},
		]
	},
