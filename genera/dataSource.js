const timestamp_saved = '11/24/2023 08:55 AM';
const dataFechaAcualizado = '11/24/2023' + ' 4:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'21', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'30', Cost:11.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 215,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:8.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:8.16, ParentId: '11'},
