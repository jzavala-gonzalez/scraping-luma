const timestamp_saved = '10/25/2023 08:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 4:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 170, MVar:'52', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'83', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'156', Cost:17.35, ParentId: '16'},
		]
	},
