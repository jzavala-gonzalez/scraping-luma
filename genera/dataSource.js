const timestamp_saved = '10/30/2023 03:50 AM';
const dataFechaAcualizado = '10/29/2023' + ' 11:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'44', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'45', Cost:10.37, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 196,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 196, MVar:'128', Cost:18.53, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'58', Cost:9.40, ParentId: '17'},
		]
	},
