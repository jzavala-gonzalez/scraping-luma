const timestamp_saved = '11/11/2023 04:05 PM';
const dataFechaAcualizado = '11/11/2023' + ' 12:01:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2046},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'100', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'43', Cost:11.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'44', Cost:11.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'47', Cost:11.44, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'12', Cost:8.74, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'9', Cost:30.69, ParentId: '13'},
