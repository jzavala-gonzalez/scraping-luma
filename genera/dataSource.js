const timestamp_saved = '11/21/2023 06:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 2:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'21', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'32', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'48', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'47', Cost:18.41, ParentId: '15'},
