const timestamp_saved = '10/08/2023 08:25 AM';
const dataFechaAcualizado = '10/8/2023' + ' 4:21:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 238, MVar:'63', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'35', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'37', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'37', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'71', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'118', Cost:17.29, ParentId: '16'},
		]
	},
