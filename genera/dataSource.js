const timestamp_saved = '10/07/2023 06:10 PM';
const dataFechaAcualizado = '10/7/2023' + ' 2:06:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 185, MVar:'55', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'44', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'45', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.40, ParentId: '7'},
		]
	},
