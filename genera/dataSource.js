const timestamp_saved = '08/20/2023 01:40 PM';
const dataFechaAcualizado = '8/20/2023' + ' 9:37:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'51', Cost:10.55, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:29.69, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'63', Cost:9.46, ParentId: '17'},
		]
	},
