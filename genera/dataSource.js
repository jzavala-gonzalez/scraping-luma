const timestamp_saved = '11/29/2023 10:10 PM';
const dataFechaAcualizado = '11/29/2023' + ' 6:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'56', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'60', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'59', Cost:10.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:25.93, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 12, MVar:'9', Cost:8551.60, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 284, MVar:'171', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'106', Cost:9.25, ParentId: '17'},
		]
	},
