const timestamp_saved = '09/18/2023 08:00 AM';
const dataFechaAcualizado = '9/18/2023' + ' 3:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'42', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'38', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'55', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'2', Cost:30.89, ParentId: '10'},
		]
	},
