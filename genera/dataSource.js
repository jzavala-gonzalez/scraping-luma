const timestamp_saved = '10/03/2023 11:55 PM';
const dataFechaAcualizado = '10/3/2023' + ' 7:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'44', Cost:10.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 187,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 37, MVar:'11', Cost:23.52, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'86', Cost:16.47, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'118', Cost:9.22, ParentId: '17'},
		]
	},
