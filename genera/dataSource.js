const timestamp_saved = '09/03/2023 05:15 PM';
const dataFechaAcualizado = '9/3/2023' + ' 1:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'34', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'40', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'53', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'61', Cost:9.52, ParentId: '17'},
		]
	},
