const timestamp_saved = '10/01/2023 11:40 PM';
const dataFechaAcualizado = '10/1/2023' + ' 7:35:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2755},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'39', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'37', Cost:10.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:20.58, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'84', Cost:16.79, ParentId: '15'},
