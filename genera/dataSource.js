const timestamp_saved = '09/17/2023 03:00 AM';
const dataFechaAcualizado = '9/16/2023' + ' 10:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'51', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'64', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'34', Cost:18.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'90', Cost:16.69, ParentId: '15'},
