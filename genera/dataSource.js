const timestamp_saved = '11/20/2023 11:45 PM';
const dataFechaAcualizado = '11/20/2023' + ' 7:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'51', Cost:10.77, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'115', Cost:9.30, ParentId: '17'},
		]
	},
