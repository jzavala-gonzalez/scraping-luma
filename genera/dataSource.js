const timestamp_saved = '12/01/2023 04:25 PM';
const dataFechaAcualizado = '12/1/2023' + ' 12:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'46', Cost:13.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'48', Cost:13.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'51', Cost:13.08, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'24', Cost:19.47, ParentId: '14'},
