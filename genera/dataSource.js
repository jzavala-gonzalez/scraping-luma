const timestamp_saved = '08/11/2023 09:30 AM';
const dataFechaAcualizado = '8/11/2023' + ' 5:25:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'21', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'48', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'85', Cost:11.92, ParentId: '17'},
		]
	},
