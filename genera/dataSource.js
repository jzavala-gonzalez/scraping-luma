const timestamp_saved = '10/28/2023 07:05 PM';
const dataFechaAcualizado = '10/28/2023' + ' 3:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'50', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'54', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 80, MVar:'23', Cost:27.03, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:27.03, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'27', Cost:0, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 69,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.56, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 8,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 8, MVar:'11', Cost:0, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'18', Cost:21.93, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'87', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'132', Cost:17.14, ParentId: '16'},
		]
	},
