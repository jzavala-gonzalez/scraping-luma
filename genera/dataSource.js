const timestamp_saved = '08/18/2023 12:20 PM';
const dataFechaAcualizado = '8/18/2023' + ' 8:17:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'63', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'71', Cost:10.07, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'7', Cost:31.39, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'5', Cost:31.18, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'30', Cost:19.37, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'76', Cost:9.27, ParentId: '17'},
		]
	},
