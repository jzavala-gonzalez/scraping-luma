const timestamp_saved = '11/14/2023 02:30 AM';
const dataFechaAcualizado = '11/13/2023' + ' 10:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'64', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 180, MVar:'69', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 201, MVar:'65', Cost:9.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 29, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 57,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 57, MVar:'22', Cost:29.45, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:31.22, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'70', Cost:17.39, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'131', Cost:10.86, ParentId: '17'},
		]
	},
