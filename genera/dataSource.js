const timestamp_saved = '09/28/2023 12:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 8:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'37', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'37', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'67', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'125', Cost:9.11, ParentId: '17'},
		]
	},
