const timestamp_saved = '08/14/2023 03:55 AM';
const dataFechaAcualizado = '8/13/2023' + ' 11:52:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'78', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'93', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'35', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'39', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'40', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 53,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'14', Cost:31.52, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'24', Cost:31.07, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:31.60, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'18', Cost:18.83, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 356,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 356, MVar:'140', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'107', Cost:12.19, ParentId: '17'},
		]
	},
