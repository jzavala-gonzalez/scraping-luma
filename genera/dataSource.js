const timestamp_saved = '12/02/2023 07:15 AM';
const dataFechaAcualizado = '12/2/2023' + ' 3:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'41', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'43', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'46', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'55', Cost:9.78, ParentId: '17'},
		]
	},
