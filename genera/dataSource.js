const timestamp_saved = '11/23/2023 11:35 PM';
const dataFechaAcualizado = '11/23/2023' + ' 7:31:22 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2138},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'32', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'42', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'55', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'97', Cost:9.18, ParentId: '17'},
		]
	},
