const timestamp_saved = '11/16/2023 04:20 PM';
const dataFechaAcualizado = '11/16/2023' + ' 12:16:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'51', Cost:13.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'51', Cost:13.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'52', Cost:13.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.46, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 198,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'147', Cost:19.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'84', Cost:9.71, ParentId: '17'},
		]
	},
