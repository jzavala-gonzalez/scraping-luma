const timestamp_saved = '11/10/2023 07:10 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 146, MVar:'41', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:31.27, ParentId: '13'},
