const timestamp_saved = '10/02/2023 04:10 PM';
const dataFechaAcualizado = '10/2/2023' + ' 12:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'39', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'39', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.41, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 145, MVar:'57', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:17.48, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 28,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'8', Cost:31.24, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.55, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'174', Cost:17.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'109', Cost:9.21, ParentId: '17'},
		]
	},
