const timestamp_saved = '08/28/2023 11:00 AM';
const dataFechaAcualizado = '8/28/2023' + ' 6:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'37', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'37', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'44', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.52, ParentId: '14'},
