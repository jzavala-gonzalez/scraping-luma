const timestamp_saved = '10/19/2023 10:05 AM';
const dataFechaAcualizado = '10/19/2023' + ' 6:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'37', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'43', Cost:10.35, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'35', Cost:18.51, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'97', Cost:10.63, ParentId: '17'},
		]
	},
