const timestamp_saved = '08/13/2023 03:45 AM';
const dataFechaAcualizado = '8/12/2023' + ' 11:42:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'39', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'43', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:15.08, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:15.08, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:32.01, ParentId: '12'},
