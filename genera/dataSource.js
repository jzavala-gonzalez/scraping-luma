const timestamp_saved = '11/22/2023 12:50 PM';
const dataFechaAcualizado = '11/22/2023' + ' 8:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'44', Cost:10.30, ParentId: '7'},
