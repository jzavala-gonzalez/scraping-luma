const timestamp_saved = '08/06/2023 11:15 AM';
const dataFechaAcualizado = '8/6/2023' + ' 7:10:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'42', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'39', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.04, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.29, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'85', Cost:17.34, ParentId: '15'},
