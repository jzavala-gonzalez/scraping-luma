const timestamp_saved = '08/20/2023 01:30 PM';
const dataFechaAcualizado = '8/20/2023' + ' 9:27:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'51', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'54', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'88', Cost:18.38, ParentId: '15'},
