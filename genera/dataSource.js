const timestamp_saved = '11/06/2023 02:35 AM';
const dataFechaAcualizado = '11/5/2023' + ' 10:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'47', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'48', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'47', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 53, MVar:'0', Cost:21.86, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.67, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'5', Cost:26.90, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:30.78, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'131', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'71', Cost:9.24, ParentId: '17'},
		]
	},
