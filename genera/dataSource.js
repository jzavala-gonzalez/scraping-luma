const timestamp_saved = '11/16/2023 10:30 AM';
const dataFechaAcualizado = '11/16/2023' + ' 6:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.23, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 187,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 187, MVar:'68', Cost:10.78, ParentId: '17'},
		]
	},
