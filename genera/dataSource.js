const timestamp_saved = '11/08/2023 01:10 PM';
const dataFechaAcualizado = '11/8/2023' + ' 9:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'50', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'48', Cost:10.42, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'45', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'92', Cost:9.61, ParentId: '17'},
		]
	},
