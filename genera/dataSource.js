const timestamp_saved = '08/14/2023 11:25 PM';
const dataFechaAcualizado = '8/14/2023' + ' 7:22:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'82', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'111', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 508,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'61', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 165, MVar:'53', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'12', Cost:28.58, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'32', Cost:18.70, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 376,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 376, MVar:'187', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'147', Cost:11.64, ParentId: '17'},
		]
	},
