const timestamp_saved = '08/24/2023 03:00 PM';
const dataFechaAcualizado = '8/24/2023' + ' 10:55:45 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'76', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'57', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:27.06, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'30', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'183', Cost:17.81, ParentId: '16'},
		]
	},
