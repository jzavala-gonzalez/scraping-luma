const timestamp_saved = '10/21/2023 06:25 AM';
const dataFechaAcualizado = '10/21/2023' + ' 2:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'25', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'22', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'60', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'75', Cost:11.04, ParentId: '17'},
		]
	},
