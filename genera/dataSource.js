const timestamp_saved = '11/30/2023 05:20 AM';
const dataFechaAcualizado = '11/30/2023' + ' 1:16:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1982},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'43', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'47', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 198,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 198, MVar:'66', Cost:10.14, ParentId: '17'},
		]
	},
