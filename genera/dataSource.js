const timestamp_saved = '12/07/2023 01:40 AM';
const dataFechaAcualizado = '12/6/2023' + ' 9:36:04 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 460},
	{Index:'6', Desc:'Reserva Operacional', value: 570},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'56', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'57', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'62', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'21', Cost:37.88, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 63,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'7', Cost:31.41, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.21, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'26', Cost:19.73, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'25', Cost:19.42, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 332, MVar:'161', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'93', Cost:13.66, ParentId: '17'},
		]
	},
