const timestamp_saved = '11/06/2023 04:40 AM';
const dataFechaAcualizado = '11/6/2023' + ' 12:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'45', Cost:13.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:13.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'43', Cost:13.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 7,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 7, MVar:'1', Cost:19.23, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'10', Cost:8.18, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'71', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'119', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'61', Cost:9.40, ParentId: '17'},
		]
	},
