const timestamp_saved = '12/01/2023 02:15 PM';
const dataFechaAcualizado = '12/1/2023' + ' 10:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'48', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'50', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'53', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'73', Cost:9.52, ParentId: '17'},
		]
	},
