const timestamp_saved = '08/19/2023 07:35 AM';
const dataFechaAcualizado = '8/19/2023' + ' 3:32:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'40', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'57', Cost:10.30, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'2', Cost:31.40, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'4', Cost:31.82, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:31.29, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 167,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 167, MVar:'67', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 197,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'128', Cost:19.27, ParentId: '16'},
		]
	},
