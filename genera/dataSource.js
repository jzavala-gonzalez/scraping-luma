const timestamp_saved = '12/01/2023 05:40 PM';
const dataFechaAcualizado = '12/1/2023' + ' 1:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'49', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 138, MVar:'40', Cost:17.81, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'156', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'77', Cost:9.57, ParentId: '17'},
		]
	},
