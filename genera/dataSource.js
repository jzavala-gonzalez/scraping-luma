const timestamp_saved = '10/25/2023 01:25 PM';
const dataFechaAcualizado = '10/25/2023' + ' 9:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'49', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'52', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.35, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'145', Cost:17.36, ParentId: '16'},
		]
	},
