const timestamp_saved = '08/25/2023 09:10 PM';
const dataFechaAcualizado = '8/25/2023' + ' 5:05:49 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'58', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'58', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'55', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 20,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'1', Cost:27.47, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'74', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'95', Cost:16.47, ParentId: '17'},
		]
	},
