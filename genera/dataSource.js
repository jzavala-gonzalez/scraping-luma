const timestamp_saved = '08/06/2023 03:25 PM';
const dataFechaAcualizado = '8/6/2023' + ' 11:20:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'52', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'51', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'47', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 116,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 58, MVar:'20', Cost:30.92, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 58, MVar:'23', Cost:31.05, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 195,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:20.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:20.06, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'34', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'106', Cost:17.33, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 102, MVar:'32', Cost:17.04, ParentId: '15'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 15, MVar:'10', Cost:21.43, ParentId: '19'},
