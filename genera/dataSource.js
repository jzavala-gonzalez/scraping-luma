const timestamp_saved = '09/23/2023 12:10 PM';
const dataFechaAcualizado = '9/23/2023' + ' 8:05:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'39', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'42', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 119, MVar:'0', Cost:9.92, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'50', Cost:19.56, ParentId: '15'},
