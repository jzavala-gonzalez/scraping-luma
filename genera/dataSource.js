const timestamp_saved = '10/14/2023 03:00 PM';
const dataFechaAcualizado = '10/14/2023' + ' 10:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'45', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'45', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'72', Cost:9.30, ParentId: '17'},
		]
	},
