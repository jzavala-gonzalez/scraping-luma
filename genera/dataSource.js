const timestamp_saved = '11/05/2023 12:25 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'42', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'40', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'40', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.42, ParentId: '11'},
