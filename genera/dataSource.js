const timestamp_saved = '11/20/2023 05:45 PM';
const dataFechaAcualizado = '11/20/2023' + ' 1:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'77', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'32', Cost:13.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'42', Cost:13.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'56', Cost:13.08, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'173', Cost:18.24, ParentId: '16'},
		]
	},
