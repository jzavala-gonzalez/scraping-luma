const timestamp_saved = '12/06/2023 02:45 PM';
const dataFechaAcualizado = '12/6/2023' + ' 10:40:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'48', Cost:13.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'50', Cost:13.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'58', Cost:13.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'67', Cost:14.56, ParentId: '17'},
		]
	},
