const timestamp_saved = '10/29/2023 05:35 AM';
const dataFechaAcualizado = '10/29/2023' + ' 1:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'37', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'37', Cost:11.08, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'62', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'114', Cost:18.82, ParentId: '16'},
		]
	},
