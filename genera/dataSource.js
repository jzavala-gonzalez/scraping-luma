const timestamp_saved = '08/14/2023 04:40 AM';
const dataFechaAcualizado = '8/14/2023' + ' 12:37:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'33', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'37', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'38', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 151,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'1', Cost:22.05, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:21.93, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:28.54, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 53,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 61, MVar:'13', Cost:30.67, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 260,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 51, MVar:'16', Cost:37.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:37.28, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 103,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'8', Cost:31.17, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:34.05, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'138', Cost:16.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 226,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 226, MVar:'92', Cost:13.13, ParentId: '17'},
		]
	},
