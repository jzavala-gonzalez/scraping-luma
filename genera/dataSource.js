const timestamp_saved = '11/21/2023 08:15 PM';
const dataFechaAcualizado = '11/21/2023' + ' 4:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'35', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'45', Cost:10.69, ParentId: '7'},
