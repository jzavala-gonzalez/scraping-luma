const timestamp_saved = '11/11/2023 11:55 PM';
const dataFechaAcualizado = '11/11/2023' + ' 7:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'55', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'57', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'62', Cost:10.30, ParentId: '7'},
		]
	},
