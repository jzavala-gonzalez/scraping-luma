const timestamp_saved = '07/29/2023 02:35 PM';
const dataFechaAcualizado = '7/29/2023' + ' 10:30:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'56', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'51', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 287,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'34', Cost:19.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:19.82, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:20.85, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'7', Cost:20.85, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.34, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'29', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 273,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 133, MVar:'98', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'28', Cost:15.83, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'95', Cost:13.36, ParentId: '17'},
		]
	},
