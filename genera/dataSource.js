const timestamp_saved = '08/20/2023 01:30 AM';
const dataFechaAcualizado = '8/19/2023' + ' 9:27:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'61', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'59', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'60', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'11', Cost:30.91, ParentId: '10'},
