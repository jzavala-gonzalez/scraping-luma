const timestamp_saved = '09/20/2023 10:10 AM';
const dataFechaAcualizado = '9/20/2023' + ' 6:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'48', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'48', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'62', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'51', Cost:18.42, ParentId: '15'},
