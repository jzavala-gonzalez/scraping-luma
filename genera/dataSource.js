const timestamp_saved = '12/06/2023 07:00 AM';
const dataFechaAcualizado = '12/6/2023' + ' 2:55:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 542},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'40', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'44', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'52', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'52', Cost:14.52, ParentId: '17'},
		]
	},
