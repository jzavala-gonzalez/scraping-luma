const timestamp_saved = '11/23/2023 05:15 PM';
const dataFechaAcualizado = '11/23/2023' + ' 1:11:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 225,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 225, MVar:'81', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'25', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'35', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'144', Cost:18.51, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'57', Cost:9.50, ParentId: '17'},
		]
	},
