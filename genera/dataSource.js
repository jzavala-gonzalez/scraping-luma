const timestamp_saved = '10/11/2023 05:05 AM';
const dataFechaAcualizado = '10/11/2023' + ' 1:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'55', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'59', Cost:10.36, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:18.02, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 218,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 218, MVar:'62', Cost:10.37, ParentId: '17'},
		]
	},
