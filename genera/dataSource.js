const timestamp_saved = '11/05/2023 01:40 PM';
const dataFechaAcualizado = '11/5/2023' + ' 9:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'40', Cost:13.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'41', Cost:13.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'40', Cost:13.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'51', Cost:9.78, ParentId: '17'},
		]
	},
