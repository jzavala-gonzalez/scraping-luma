const timestamp_saved = '10/31/2023 09:15 AM';
const dataFechaAcualizado = '10/31/2023' + ' 5:11:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'54', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'59', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'56', Cost:9.74, ParentId: '17'},
		]
	},
