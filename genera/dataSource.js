const timestamp_saved = '08/12/2023 11:40 AM';
const dataFechaAcualizado = '8/12/2023' + ' 7:37:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'46', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'0', Cost:14.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'9', Cost:14.10, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'151', Cost:17.39, ParentId: '16'},
		]
	},
