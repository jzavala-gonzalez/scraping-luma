const timestamp_saved = '10/23/2023 12:55 PM';
const dataFechaAcualizado = '10/23/2023' + ' 8:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'48', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'49', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'46', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'29', Cost:19.39, ParentId: '14'},
