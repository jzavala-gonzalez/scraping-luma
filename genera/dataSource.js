const timestamp_saved = '08/24/2023 02:45 PM';
const dataFechaAcualizado = '8/24/2023' + ' 10:40:45 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'59', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'56', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:27.15, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'28', Cost:18.60, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'182', Cost:17.81, ParentId: '16'},
		]
	},
