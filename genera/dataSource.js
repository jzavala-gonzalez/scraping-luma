const timestamp_saved = '08/01/2023 07:00 PM';
const dataFechaAcualizado = '8/1/2023' + ' 2:55:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'56', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'53', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'1', Cost:22.21, ParentId: '9'},
