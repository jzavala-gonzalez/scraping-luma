const timestamp_saved = '09/20/2023 07:40 AM';
const dataFechaAcualizado = '9/20/2023' + ' 3:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'42', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'44', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'59', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 207,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 207, MVar:'139', Cost:19.73, ParentId: '16'},
		]
	},
