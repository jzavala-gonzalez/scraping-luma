const timestamp_saved = '11/02/2023 01:20 PM';
const dataFechaAcualizado = '11/2/2023' + ' 9:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'53', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'52', Cost:11.46, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:18.28, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'133', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'75', Cost:9.40, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 74,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 28, MVar:'16', Cost:19.60, ParentId: '19'},
