const timestamp_saved = '08/17/2023 01:20 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:17:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 525,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:9.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'77', Cost:9.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 184, MVar:'83', Cost:9.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 17, MVar:'0', Cost:34.09, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'21', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'21', Cost:28.03, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'6', Cost:29.30, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:28.59, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 86,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'6', Cost:29.91, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'244', Cost:16.68, ParentId: '16'},
		]
	},
