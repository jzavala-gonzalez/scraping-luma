const timestamp_saved = '10/08/2023 05:40 AM';
const dataFechaAcualizado = '10/8/2023' + ' 1:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 226,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 227, MVar:'69', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'42', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'41', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'41', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:16.98, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'79', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'148', Cost:16.59, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 162, MVar:'76', Cost:11.27, ParentId: '17'},
		]
	},
