const timestamp_saved = '11/29/2023 06:55 PM';
const dataFechaAcualizado = '11/29/2023' + ' 2:51:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2203},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'54', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'53', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'89', Cost:9.82, ParentId: '17'},
		]
	},
