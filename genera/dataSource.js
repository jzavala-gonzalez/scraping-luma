const timestamp_saved = '12/01/2023 10:55 PM';
const dataFechaAcualizado = '12/1/2023' + ' 6:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'56', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'58', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'59', Cost:11.91, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'5', Cost:29.83, ParentId: '12'},
