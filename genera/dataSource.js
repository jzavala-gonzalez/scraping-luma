const timestamp_saved = '07/30/2023 09:35 AM';
const dataFechaAcualizado = '7/30/2023' + ' 5:30:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'42', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'39', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'39', Cost:15.87, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'63', Cost:11.15, ParentId: '17'},
		]
	},
