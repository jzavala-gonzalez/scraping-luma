const timestamp_saved = '09/19/2023 09:15 AM';
const dataFechaAcualizado = '9/19/2023' + ' 5:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'45', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'44', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'59', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'84', Cost:9.08, ParentId: '17'},
		]
	},
