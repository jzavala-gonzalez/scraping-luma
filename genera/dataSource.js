const timestamp_saved = '10/22/2023 09:10 AM';
const dataFechaAcualizado = '10/22/2023' + ' 5:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'40', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'39', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'45', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'54', Cost:11.22, ParentId: '17'},
		]
	},
