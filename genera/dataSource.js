const timestamp_saved = '10/09/2023 05:30 AM';
const dataFechaAcualizado = '10/9/2023' + ' 1:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'43', Cost:11.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'43', Cost:11.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'48', Cost:11.83, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'11', Cost:29.97, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'142', Cost:16.65, ParentId: '16'},
		]
	},
