const timestamp_saved = '08/01/2023 06:40 AM';
const dataFechaAcualizado = '8/1/2023' + ' 2:35:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'42', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'46', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:20.27, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'84', Cost:16.61, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'32', Cost:15.47, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'136', Cost:18.00, ParentId: '16'},
		]
	},
