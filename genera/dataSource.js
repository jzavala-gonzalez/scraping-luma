const timestamp_saved = '09/09/2023 08:30 AM';
const dataFechaAcualizado = '9/9/2023' + ' 4:25:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'51', Cost:13.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'56', Cost:13.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'55', Cost:13.15, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 157,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.53, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'12', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'10', Cost:27.96, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:19.73, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'61', Cost:16.55, ParentId: '15'},
