const timestamp_saved = '08/01/2023 06:45 PM';
const dataFechaAcualizado = '8/1/2023' + ' 2:40:36 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2719},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'57', Cost:10.13, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 48, MVar:'1', Cost:23.36, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'26', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 315,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'99', Cost:16.89, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'35', Cost:15.57, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'149', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'110', Cost:11.01, ParentId: '17'},
		]
	},
