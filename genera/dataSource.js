const timestamp_saved = '10/21/2023 04:10 AM';
const dataFechaAcualizado = '10/21/2023' + ' 12:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'26', Cost:11.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'24', Cost:11.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'62', Cost:11.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.28, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'143', Cost:16.75, ParentId: '16'},
		]
	},
