const timestamp_saved = '10/28/2023 03:25 PM';
const dataFechaAcualizado = '10/28/2023' + ' 11:21:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1990},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'39', Cost:13.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'41', Cost:13.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'47', Cost:13.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 150,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'20', Cost:29.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.62, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'96', Cost:19.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'125', Cost:17.23, ParentId: '16'},
		]
	},
