const timestamp_saved = '11/29/2023 08:00 PM';
const dataFechaAcualizado = '11/29/2023' + ' 3:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'61', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'60', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'112', Cost:9.33, ParentId: '17'},
		]
	},
