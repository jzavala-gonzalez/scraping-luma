const timestamp_saved = '12/03/2023 04:00 AM';
const dataFechaAcualizado = '12/2/2023' + ' 11:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'47', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'48', Cost:11.12, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'1', Cost:31.05, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'74', Cost:11.18, ParentId: '17'},
		]
	},
