const timestamp_saved = '09/28/2023 03:50 PM';
const dataFechaAcualizado = '9/28/2023' + ' 11:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'28', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'26', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'84', Cost:9.76, ParentId: '17'},
		]
	},
