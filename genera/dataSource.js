const timestamp_saved = '12/02/2023 11:35 PM';
const dataFechaAcualizado = '12/2/2023' + ' 7:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'56', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'58', Cost:11.16, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'138', Cost:17.30, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'100', Cost:10.89, ParentId: '17'},
		]
	},
