const timestamp_saved = '11/21/2023 05:05 PM';
const dataFechaAcualizado = '11/21/2023' + ' 1:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'34', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'44', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'57', Cost:11.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'38', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'93', Cost:9.60, ParentId: '17'},
		]
	},
