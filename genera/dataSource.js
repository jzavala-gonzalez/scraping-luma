const timestamp_saved = '11/23/2023 06:35 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'23', Cost:13.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'32', Cost:13.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'48', Cost:13.38, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'8', Cost:19.59, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'57', Cost:9.82, ParentId: '17'},
		]
	},
