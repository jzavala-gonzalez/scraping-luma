const timestamp_saved = '10/26/2023 12:25 PM';
const dataFechaAcualizado = '10/26/2023' + ' 8:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'45', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'48', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'50', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'19', Cost:19.59, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'82', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'143', Cost:18.26, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 48,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'12', Cost:19.60, ParentId: '19'},
