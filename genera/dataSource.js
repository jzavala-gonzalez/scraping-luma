const timestamp_saved = '09/21/2023 09:45 PM';
const dataFechaAcualizado = '9/21/2023' + ' 5:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'41', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'47', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'65', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 138,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'1', Cost:22.95, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'6', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'6', Cost:28.08, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:8.19, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.43, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'22', Cost:26.84, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'89', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'84', Cost:32.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'104', Cost:16.09, ParentId: '17'},
		]
	},
