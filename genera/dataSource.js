const timestamp_saved = '10/21/2023 09:25 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'23', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'26', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'71', Cost:11.03, ParentId: '17'},
		]
	},
