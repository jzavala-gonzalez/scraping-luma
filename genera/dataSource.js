const timestamp_saved = '11/29/2023 09:35 PM';
const dataFechaAcualizado = '11/29/2023' + ' 5:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'53', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'56', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'57', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'100', Cost:9.24, ParentId: '17'},
		]
	},
