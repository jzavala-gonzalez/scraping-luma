const timestamp_saved = '12/01/2023 04:00 PM';
const dataFechaAcualizado = '12/1/2023' + ' 11:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'45', Cost:13.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'49', Cost:13.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'51', Cost:13.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'71', Cost:9.48, ParentId: '17'},
		]
	},
