const timestamp_saved = '11/25/2023 12:25 AM';
const dataFechaAcualizado = '11/24/2023' + ' 8:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 60, MVar:'77', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'34', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'44', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'28', Cost:28.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'50', Cost:8.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'13', Cost:8.20, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'8', Cost:28.33, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:19.15, ParentId: '14'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 78,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 19, MVar:'0', Cost:25.64, ParentId: '21'},
