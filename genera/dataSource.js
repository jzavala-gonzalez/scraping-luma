const timestamp_saved = '11/20/2023 08:00 AM';
const dataFechaAcualizado = '11/20/2023' + ' 3:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'26', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'36', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'51', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'88', Cost:9.16, ParentId: '17'},
		]
	},
