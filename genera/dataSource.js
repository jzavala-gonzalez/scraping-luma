const timestamp_saved = '08/14/2023 04:15 AM';
const dataFechaAcualizado = '8/14/2023' + ' 12:12:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'43', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'40', Cost:10.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 139,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:11.97, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'138', Cost:16.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'99', Cost:12.38, ParentId: '17'},
		]
	},
