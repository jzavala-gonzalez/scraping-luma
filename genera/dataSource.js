const timestamp_saved = '09/27/2023 07:45 AM';
const dataFechaAcualizado = '9/27/2023' + ' 3:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'26', Cost:12.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'25', Cost:12.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'73', Cost:9.11, ParentId: '17'},
		]
	},
