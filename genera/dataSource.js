const timestamp_saved = '08/09/2023 12:15 PM';
const dataFechaAcualizado = '8/9/2023' + ' 8:10:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'55', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'60', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'88', Cost:11.76, ParentId: '17'},
		]
	},
