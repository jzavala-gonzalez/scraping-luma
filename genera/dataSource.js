const timestamp_saved = '10/11/2023 07:50 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:46:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'43', Cost:13.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'49', Cost:13.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:8.49, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'57', Cost:9.11, ParentId: '17'},
		]
	},
