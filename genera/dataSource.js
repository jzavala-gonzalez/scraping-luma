const timestamp_saved = '10/08/2023 10:10 AM';
const dataFechaAcualizado = '10/8/2023' + ' 6:06:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'34', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'35', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'37', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'34', Cost:18.78, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:18.78, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'2', Cost:19.36, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 154,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 154, MVar:'60', Cost:11.60, ParentId: '17'},
		]
	},
