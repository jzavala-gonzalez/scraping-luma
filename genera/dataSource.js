const timestamp_saved = '10/25/2023 01:20 AM';
const dataFechaAcualizado = '10/24/2023' + ' 9:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'53', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'55', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'54', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'12', Cost:21.97, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.70, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'8', Cost:27.43, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:26.17, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'47', Cost:16.93, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'155', Cost:16.66, ParentId: '16'},
		]
	},
