const timestamp_saved = '12/05/2023 10:20 PM';
const dataFechaAcualizado = '12/5/2023' + ' 6:15:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 270},
	{Index:'6', Desc:'Reserva Operacional', value: 606},
	{Index:'7', Desc:'Capacidad Disponible', value: 3127},
	{Index:'8', Desc:'Próxima Hora MW', value: 2560},
	{Index:'9', Desc:'Máxima para Hoy', value: 2532},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'66', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'67', Cost:10.05, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 47, MVar:'0', Cost:10.48, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 19,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 19, MVar:'0', Cost:130.27, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.37, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 56,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'9', Cost:30.60, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:31.00, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 58,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 28, MVar:'8', Cost:31.03, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 156,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 83, MVar:'24', Cost:19.02, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'135', Cost:17.48, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'106', Cost:10.87, ParentId: '17'},
		]
	},
	{Index:'18', Type:'Renovable', Desc:'Wind', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Pattern', MW: 16, MVar:'0', Cost:16.29, ParentId: '18'},
			{Index:'1', Unit:'Punta Lima', MW: 2, MVar:'2', Cost:16.29, ParentId: '18'},
		]
	},
