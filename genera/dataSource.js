const timestamp_saved = '08/19/2023 06:05 AM';
const dataFechaAcualizado = '8/19/2023' + ' 2:02:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'46', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'59', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'70', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 38,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 14, MVar:'6', Cost:27.33, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:19.65, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'65', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'159', Cost:17.65, ParentId: '16'},
		]
	},
