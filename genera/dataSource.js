const timestamp_saved = '10/03/2023 10:10 PM';
const dataFechaAcualizado = '10/3/2023' + ' 6:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'40', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'37', Cost:10.80, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 16, MVar:'8', Cost:133.14, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:19.53, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 0,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 0, MVar:'31', Cost:19.60, ParentId: '19'},
