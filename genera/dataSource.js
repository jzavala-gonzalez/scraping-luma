const timestamp_saved = '09/20/2023 03:50 PM';
const dataFechaAcualizado = '9/20/2023' + ' 11:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'55', Cost:10.49, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'152', Cost:18.13, ParentId: '16'},
		]
	},
