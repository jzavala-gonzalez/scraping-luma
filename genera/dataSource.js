const timestamp_saved = '10/15/2023 12:00 AM';
const dataFechaAcualizado = '10/14/2023' + ' 7:56:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'63', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'63', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'63', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'155', Cost:17.21, ParentId: '16'},
		]
	},
