const timestamp_saved = '11/30/2023 12:25 AM';
const dataFechaAcualizado = '11/29/2023' + ' 8:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'56', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'60', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'59', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.40, ParentId: '11'},
