const timestamp_saved = '09/27/2023 03:55 AM';
const dataFechaAcualizado = '9/26/2023' + ' 11:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'48', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'49', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'58', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'31', Cost:19.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:19.07, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'77', Cost:16.78, ParentId: '15'},
