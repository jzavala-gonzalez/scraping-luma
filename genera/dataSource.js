const timestamp_saved = '11/25/2023 02:00 PM';
const dataFechaAcualizado = '11/25/2023' + ' 9:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 158,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 158, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'21', Cost:12.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'30', Cost:12.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'47', Cost:12.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 131, MVar:'40', Cost:8.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:8.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'27', Cost:21.33, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'8', Cost:21.33, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'10', Cost:19.73, ParentId: '14'},
