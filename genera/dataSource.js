const timestamp_saved = '11/12/2023 08:00 AM';
const dataFechaAcualizado = '11/12/2023' + ' 3:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'39', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'40', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'51', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'74', Cost:9.63, ParentId: '17'},
		]
	},
