const timestamp_saved = '10/01/2023 01:30 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 261,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 10, MVar:'33', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'29', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'25', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'43', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'8', Cost:30.87, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'87', Cost:9.48, ParentId: '17'},
		]
	},
