const timestamp_saved = '12/01/2023 04:05 PM';
const dataFechaAcualizado = '12/1/2023' + ' 12:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 104, MVar:'52', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'70', Cost:9.47, ParentId: '17'},
		]
	},
