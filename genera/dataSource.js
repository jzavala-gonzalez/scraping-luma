const timestamp_saved = '08/28/2023 11:05 PM';
const dataFechaAcualizado = '8/28/2023' + ' 7:00:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3204},
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3274},
	{Index:'6', Desc:'Próxima Hora MW', value: 3049},
	{Index:'7', Desc:'Máxima para Hoy', value: 3204},
	{Index:'8', Desc:'Máxima Mensual', value: 3204},
];
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'107', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 527,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'65', Cost:10.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'64', Cost:10.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 180, MVar:'69', Cost:10.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 93, MVar:'0', Cost:5.28, ParentId: '8'},
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.55, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 146, MVar:'50', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:22.09, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:21.97, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:24.17, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 145,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'37', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 68, MVar:'37', Cost:30.78, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:19.86, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'9', Cost:31.05, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 0,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:49.56, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'7', Cost:30.51, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 100, MVar:'41', Cost:18.73, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'97', Cost:16.70, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 356,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 356, MVar:'202', Cost:16.55, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'123', Cost:9.21, ParentId: '17'},
		]
	},
