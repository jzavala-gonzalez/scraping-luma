const timestamp_saved = '11/15/2023 06:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 2:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'34', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'37', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:17.69, ParentId: '11'},
