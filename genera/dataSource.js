const timestamp_saved = '07/28/2023 03:05 PM';
const dataFechaAcualizado = '7/28/2023' + ' 11:00:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'50', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'49', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'52', Cost:15.69, ParentId: '15'},
		]
	},
