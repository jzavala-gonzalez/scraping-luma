const timestamp_saved = '09/04/2023 01:30 AM';
const dataFechaAcualizado = '9/3/2023' + ' 9:25:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.72, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'174', Cost:16.73, ParentId: '16'},
		]
	},
