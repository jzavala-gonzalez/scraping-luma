const timestamp_saved = '09/16/2023 04:40 PM';
const dataFechaAcualizado = '9/16/2023' + ' 12:35:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'45', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'42', Cost:10.78, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'28', Cost:19.36, ParentId: '14'},
