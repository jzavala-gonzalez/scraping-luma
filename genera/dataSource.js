const timestamp_saved = '10/02/2023 05:25 PM';
const dataFechaAcualizado = '10/2/2023' + ' 1:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'41', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'39', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'52', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:26.79, ParentId: '9'},
		]
	},
