const timestamp_saved = '07/30/2023 01:35 PM';
const dataFechaAcualizado = '7/30/2023' + ' 9:30:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'44', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'38', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:19.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:19.75, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'81', Cost:18.39, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'66', Cost:11.14, ParentId: '17'},
		]
	},
