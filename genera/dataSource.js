const timestamp_saved = '11/25/2023 05:25 PM';
const dataFechaAcualizado = '11/25/2023' + ' 1:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'26', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'36', Cost:11.19, ParentId: '7'},
