const timestamp_saved = '10/22/2023 01:45 AM';
const dataFechaAcualizado = '10/21/2023' + ' 9:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 492,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'52', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'51', Cost:10.11, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 49, MVar:'7', Cost:22.15, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'157', Cost:16.83, ParentId: '16'},
		]
	},
