const timestamp_saved = '11/06/2023 01:45 AM';
const dataFechaAcualizado = '11/5/2023' + ' 9:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 121, MVar:'47', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:16.92, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:16.92, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.43, ParentId: '12'},
