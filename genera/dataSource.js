const timestamp_saved = '08/07/2023 09:10 PM';
const dataFechaAcualizado = '8/7/2023' + ' 5:05:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2706},
	{Index:'1', Desc:'PREPA', value: 64},
	{Index:'2', Desc:'COGEN', value: 36},
	{Index:'3', Desc:'Reserva en Rotación', value: 323},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'61', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'89', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'41', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'61', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'91', Cost:11.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 172,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 38, MVar:'0', Cost:31.29, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:40.88, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 151, MVar:'15', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'7', Cost:27.20, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'0', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'1', Cost:28.10, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'40', Cost:20.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'0', Cost:20.22, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.25, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:31.12, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'7', Cost:30.10, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'5', Cost:18.77, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 261,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'69', Cost:18.42, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 49,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 49, MVar:'57', Cost:40.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'85', Cost:11.66, ParentId: '17'},
		]
	},
