const timestamp_saved = '11/30/2023 01:35 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'49', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'52', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:17.30, ParentId: '11'},
