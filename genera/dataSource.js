const timestamp_saved = '11/09/2023 10:35 PM';
const dataFechaAcualizado = '11/9/2023' + ' 6:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'55', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'49', Cost:10.22, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 39,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'4', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'26', Cost:21.97, ParentId: '14'},
