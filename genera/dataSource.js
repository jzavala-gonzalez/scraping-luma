const timestamp_saved = '09/05/2023 09:05 PM';
const dataFechaAcualizado = '9/5/2023' + ' 5:00:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'57', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'59', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'66', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'3', Cost:28.55, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:8.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.42, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'89', Cost:16.59, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 337,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 337, MVar:'176', Cost:16.92, ParentId: '16'},
		]
	},
