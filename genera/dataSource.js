const timestamp_saved = '11/01/2023 02:15 AM';
const dataFechaAcualizado = '10/31/2023' + ' 10:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'59', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'62', Cost:11.15, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'164', Cost:16.72, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'88', Cost:9.13, ParentId: '17'},
		]
	},
