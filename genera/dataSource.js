const timestamp_saved = '10/15/2023 02:35 AM';
const dataFechaAcualizado = '10/14/2023' + ' 10:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'62', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'62', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'61', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:30.28, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:18.98, ParentId: '14'},
