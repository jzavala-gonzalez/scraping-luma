const timestamp_saved = '07/27/2023 05:41 AM';
const dataFechaAcualizado = '7/27/2023' + ' 1:35:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'56', Cost:10.43, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'9', Cost:8.82, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'101', Cost:16.55, ParentId: '15'},
