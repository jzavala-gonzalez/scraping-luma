const timestamp_saved = '09/27/2023 08:25 AM';
const dataFechaAcualizado = '9/27/2023' + ' 4:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'26', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'26', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'73', Cost:9.13, ParentId: '17'},
		]
	},
