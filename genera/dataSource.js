const timestamp_saved = '07/30/2023 01:05 PM';
const dataFechaAcualizado = '7/30/2023' + ' 9:00:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'45', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'40', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:19.77, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'73', Cost:19.69, ParentId: '16'},
		]
	},
