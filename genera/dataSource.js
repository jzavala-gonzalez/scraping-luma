const timestamp_saved = '10/26/2023 07:16 PM';
const dataFechaAcualizado = '10/26/2023' + ' 3:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'54', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'52', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 12,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 12, MVar:'20', Cost:0, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 131, MVar:'40', Cost:16.95, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:16.95, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 136, MVar:'42', Cost:17.13, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:17.13, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'17', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'78', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'138', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'11', Cost:11.31, ParentId: '17'},
		]
	},
