const timestamp_saved = '10/15/2023 10:05 AM';
const dataFechaAcualizado = '10/15/2023' + ' 6:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'49', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'45', Cost:11.24, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'56', Cost:9.52, ParentId: '17'},
		]
	},
