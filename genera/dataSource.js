const timestamp_saved = '10/16/2023 04:35 PM';
const dataFechaAcualizado = '10/16/2023' + ' 12:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'66', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'65', Cost:10.66, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:18.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:18.42, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 151, MVar:'45', Cost:8.19, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'17', Cost:19.26, ParentId: '14'},
