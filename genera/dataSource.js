const timestamp_saved = '11/29/2023 11:15 AM';
const dataFechaAcualizado = '11/29/2023' + ' 7:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'40', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'38', Cost:11.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'49', Cost:17.40, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'71', Cost:9.49, ParentId: '17'},
		]
	},
