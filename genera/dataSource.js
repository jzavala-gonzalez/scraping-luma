const timestamp_saved = '08/02/2023 03:15 AM';
const dataFechaAcualizado = '8/1/2023' + ' 11:10:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'43', Cost:10.99, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 15, MVar:'2', Cost:38.28, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'143', Cost:16.91, ParentId: '16'},
		]
	},
