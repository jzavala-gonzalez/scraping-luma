const timestamp_saved = '07/31/2023 02:30 AM';
const dataFechaAcualizado = '7/30/2023' + ' 10:25:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'55', Cost:10.77, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.24, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 98, MVar:'0', Cost:17.21, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:17.21, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'92', Cost:10.99, ParentId: '17'},
		]
	},
