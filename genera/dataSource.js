const timestamp_saved = '10/27/2023 09:40 PM';
const dataFechaAcualizado = '10/27/2023' + ' 5:36:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 581},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'42', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'48', Cost:11.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 59,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:1.72, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'12', Cost:43.80, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 9,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 9, MVar:'0', Cost:46.79, ParentId: '14'},
