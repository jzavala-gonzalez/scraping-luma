const timestamp_saved = '11/21/2023 02:50 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'32', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'42', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'57', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'92', Cost:9.61, ParentId: '17'},
		]
	},
