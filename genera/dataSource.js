const timestamp_saved = '09/21/2023 08:30 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'38', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'42', Cost:11.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'61', Cost:11.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:19.90, ParentId: '11'},
