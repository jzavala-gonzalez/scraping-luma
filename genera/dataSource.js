const timestamp_saved = '10/08/2023 05:05 PM';
const dataFechaAcualizado = '10/8/2023' + ' 1:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'44', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'41', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'35', Cost:18.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:18.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 152, MVar:'45', Cost:8.15, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'89', Cost:16.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'153', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 159, MVar:'78', Cost:11.44, ParentId: '17'},
		]
	},
