const timestamp_saved = '07/29/2023 05:05 PM';
const dataFechaAcualizado = '7/29/2023' + ' 1:00:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'50', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:30.61, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'88', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'24', Cost:15.81, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'91', Cost:10.90, ParentId: '17'},
		]
	},
