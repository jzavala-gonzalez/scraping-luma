const timestamp_saved = '10/03/2023 08:35 PM';
const dataFechaAcualizado = '10/3/2023' + ' 4:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'41', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:11.20, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'112', Cost:9.16, ParentId: '17'},
		]
	},
