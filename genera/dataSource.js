const timestamp_saved = '08/13/2023 09:20 PM';
const dataFechaAcualizado = '8/13/2023' + ' 5:17:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'105', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'39', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'46', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'42', Cost:10.25, ParentId: '7'},
		]
	},
