const timestamp_saved = '08/01/2023 05:25 PM';
const dataFechaAcualizado = '8/1/2023' + ' 1:20:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'54', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'54', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'52', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'33', Cost:15.69, ParentId: '15'},
		]
	},
