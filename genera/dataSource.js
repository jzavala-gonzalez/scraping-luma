const timestamp_saved = '08/14/2023 11:00 AM';
const dataFechaAcualizado = '8/14/2023' + ' 6:57:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'37', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'43', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'41', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.37, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'108', Cost:12.53, ParentId: '17'},
		]
	},
