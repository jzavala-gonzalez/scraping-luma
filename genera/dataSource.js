const timestamp_saved = '09/24/2023 02:25 AM';
const dataFechaAcualizado = '9/23/2023' + ' 10:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'48', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'49', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'62', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'70', Cost:16.88, ParentId: '15'},
