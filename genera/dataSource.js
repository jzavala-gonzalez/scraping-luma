const timestamp_saved = '09/20/2023 04:40 AM';
const dataFechaAcualizado = '9/20/2023' + ' 12:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 195, MVar:'82', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'50', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'52', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'64', Cost:11.32, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 92, MVar:'0', Cost:5.32, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:22.52, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'8', Cost:21.61, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'159', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'83', Cost:9.15, ParentId: '17'},
		]
	},
