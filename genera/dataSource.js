const timestamp_saved = '08/14/2023 08:20 PM';
const dataFechaAcualizado = '8/14/2023' + ' 4:17:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'52', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.55, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'29', Cost:19.22, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'134', Cost:11.61, ParentId: '17'},
		]
	},
