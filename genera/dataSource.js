const timestamp_saved = '09/16/2023 05:50 PM';
const dataFechaAcualizado = '9/16/2023' + ' 1:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'46', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'46', Cost:10.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'59', Cost:10.17, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 80, MVar:'78', Cost:19.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'113', Cost:17.87, ParentId: '16'},
		]
	},
