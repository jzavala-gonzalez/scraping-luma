const timestamp_saved = '11/25/2023 01:45 PM';
const dataFechaAcualizado = '11/25/2023' + ' 9:41:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 157,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 157, MVar:'64', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'23', Cost:11.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'32', Cost:11.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'48', Cost:11.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'48', Cost:17.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.69, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'28', Cost:0, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 19, MVar:'0', Cost:0, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'11', Cost:19.73, ParentId: '14'},
