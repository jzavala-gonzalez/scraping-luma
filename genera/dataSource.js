const timestamp_saved = '07/31/2023 12:25 AM';
const dataFechaAcualizado = '7/30/2023' + ' 8:20:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'57', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'48', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'95', Cost:10.98, ParentId: '17'},
		]
	},
