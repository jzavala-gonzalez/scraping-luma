const timestamp_saved = '12/06/2023 04:45 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:40:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 554},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'47', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'50', Cost:12.63, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'69', Cost:14.58, ParentId: '17'},
		]
	},
