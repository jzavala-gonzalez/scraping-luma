const timestamp_saved = '09/25/2023 09:55 PM';
const dataFechaAcualizado = '9/25/2023' + ' 5:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'48', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'50', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'57', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'187', Cost:16.64, ParentId: '16'},
		]
	},
