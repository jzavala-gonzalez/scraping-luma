const timestamp_saved = '11/24/2023 02:30 AM';
const dataFechaAcualizado = '11/23/2023' + ' 10:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'35', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'44', Cost:10.61, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:17.06, ParentId: '11'},
