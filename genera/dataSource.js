const timestamp_saved = '10/14/2023 12:40 PM';
const dataFechaAcualizado = '10/14/2023' + ' 8:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'46', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'45', Cost:11.22, ParentId: '7'},
