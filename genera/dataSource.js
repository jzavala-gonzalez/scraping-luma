const timestamp_saved = '10/24/2023 10:00 AM';
const dataFechaAcualizado = '10/24/2023' + ' 5:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'45', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'46', Cost:10.43, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:11.29, ParentId: '17'},
		]
	},
