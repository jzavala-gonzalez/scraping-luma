const timestamp_saved = '08/07/2023 07:45 AM';
const dataFechaAcualizado = '8/7/2023' + ' 3:40:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'58', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'84', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'42', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'43', Cost:11.04, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 156, MVar:'9', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'95', Cost:11.72, ParentId: '17'},
		]
	},
