const timestamp_saved = '10/20/2023 07:30 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'32', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'39', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'40', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'77', Cost:10.55, ParentId: '17'},
		]
	},
