const timestamp_saved = '12/03/2023 12:15 PM';
const dataFechaAcualizado = '12/3/2023' + ' 8:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 200,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 198, MVar:'63', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'36', Cost:12.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'38', Cost:12.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'45', Cost:12.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'93', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'53', Cost:11.62, ParentId: '17'},
		]
	},
