const timestamp_saved = '09/28/2023 01:20 PM';
const dataFechaAcualizado = '9/28/2023' + ' 9:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'27', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'25', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'47', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'81', Cost:9.73, ParentId: '17'},
		]
	},
