const timestamp_saved = '11/29/2023 07:05 AM';
const dataFechaAcualizado = '11/29/2023' + ' 3:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'22', Cost:12.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'32', Cost:12.58, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 162, MVar:'48', Cost:17.40, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'65', Cost:9.80, ParentId: '17'},
		]
	},
