const timestamp_saved = '09/12/2023 02:50 PM';
const dataFechaAcualizado = '9/12/2023' + ' 10:45:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 960},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 172, MVar:'67', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'56', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'53', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'65', Cost:10.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 81, MVar:'0', Cost:8.84, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'135', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'72', Cost:9.57, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:21.12, ParentId: '21'},
