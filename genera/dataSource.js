const timestamp_saved = '08/13/2023 09:15 AM';
const dataFechaAcualizado = '8/13/2023' + ' 5:12:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'38', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'41', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'37', Cost:18.85, ParentId: '14'},
