const timestamp_saved = '10/23/2023 01:35 PM';
const dataFechaAcualizado = '10/23/2023' + ' 9:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'50', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'47', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'30', Cost:19.64, ParentId: '14'},
