const timestamp_saved = '10/22/2023 07:45 AM';
const dataFechaAcualizado = '10/22/2023' + ' 3:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'40', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'40', Cost:10.56, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'4', Cost:19.56, ParentId: '14'},
