const timestamp_saved = '11/10/2023 08:30 PM';
const dataFechaAcualizado = '11/10/2023' + ' 4:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'43', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'37', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'13', Cost:17.07, ParentId: '11'},
