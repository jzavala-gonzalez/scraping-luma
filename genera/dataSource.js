const timestamp_saved = '07/27/2023 09:29 AM';
const dataFechaAcualizado = '7/27/2023' + ' 5:20:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'56', Cost:10.62, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'17', Cost:18.86, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'24', Cost:15.76, ParentId: '15'},
		]
	},
