const timestamp_saved = '08/13/2023 12:30 AM';
const dataFechaAcualizado = '8/12/2023' + ' 8:27:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'43', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'45', Cost:11.05, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'117', Cost:11.61, ParentId: '17'},
		]
	},
