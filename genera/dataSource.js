const timestamp_saved = '10/29/2023 12:31 AM';
const dataFechaAcualizado = '10/28/2023' + ' 8:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:18.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 36, MVar:'9', Cost:18.17, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'33', Cost:18.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:18.61, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'4', Cost:10.80, ParentId: '17'},
		]
	},
