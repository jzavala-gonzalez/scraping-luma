const timestamp_saved = '11/25/2023 10:50 PM';
const dataFechaAcualizado = '11/25/2023' + ' 6:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'70', Cost:4.48, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.48, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'34', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'45', Cost:11.65, ParentId: '7'},
