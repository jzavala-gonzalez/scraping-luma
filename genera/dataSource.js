const timestamp_saved = '11/06/2023 04:10 PM';
const dataFechaAcualizado = '11/6/2023' + ' 12:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 157, MVar:'53', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'86', Cost:9.84, ParentId: '17'},
		]
	},
