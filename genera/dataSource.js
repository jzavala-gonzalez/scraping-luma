const timestamp_saved = '11/26/2023 06:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 2:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'25', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'36', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'50', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'22', Cost:18.89, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'138', Cost:19.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'75', Cost:10.01, ParentId: '17'},
		]
	},
