const timestamp_saved = '12/04/2023 09:15 AM';
const dataFechaAcualizado = '12/4/2023' + ' 5:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'41', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'42', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'45', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'48', Cost:11.62, ParentId: '17'},
		]
	},
