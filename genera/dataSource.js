const timestamp_saved = '10/19/2023 05:35 AM';
const dataFechaAcualizado = '10/19/2023' + ' 1:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'32', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'40', Cost:11.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'45', Cost:11.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'37', Cost:17.42, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.42, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 7, MVar:'0', Cost:29.33, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'0', Cost:18.84, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'64', Cost:17.00, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 234,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 234, MVar:'85', Cost:11.80, ParentId: '17'},
		]
	},
