const timestamp_saved = '11/27/2023 03:25 PM';
const dataFechaAcualizado = '11/27/2023' + ' 11:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'35', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'45', Cost:10.44, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'167', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'96', Cost:9.59, ParentId: '17'},
		]
	},
