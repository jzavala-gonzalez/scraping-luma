const timestamp_saved = '10/19/2023 06:05 PM';
const dataFechaAcualizado = '10/19/2023' + ' 2:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'44', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'51', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'72', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:30.83, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'23', Cost:23.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'181', Cost:17.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'120', Cost:10.54, ParentId: '17'},
		]
	},
