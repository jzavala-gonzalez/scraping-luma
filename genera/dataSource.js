const timestamp_saved = '09/10/2023 08:10 AM';
const dataFechaAcualizado = '9/10/2023' + ' 4:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'64', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'62', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'63', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 341,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 94, MVar:'0', Cost:10.00, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'8', Cost:10.00, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'130', Cost:17.16, ParentId: '16'},
		]
	},
