const timestamp_saved = '11/24/2023 04:45 PM';
const dataFechaAcualizado = '11/24/2023' + ' 12:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'30', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'39', Cost:10.74, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'81', Cost:9.87, ParentId: '17'},
		]
	},
