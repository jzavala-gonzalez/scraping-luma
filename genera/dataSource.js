const timestamp_saved = '09/21/2023 11:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 7:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 98,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:35.88, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 58,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 58, MVar:'64', Cost:35.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'96', Cost:9.57, ParentId: '17'},
		]
	},
