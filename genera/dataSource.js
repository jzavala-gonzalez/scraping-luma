const timestamp_saved = '11/30/2023 07:55 AM';
const dataFechaAcualizado = '11/30/2023' + ' 3:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'34', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'38', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'43', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'58', Cost:9.77, ParentId: '17'},
		]
	},
