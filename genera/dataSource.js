const timestamp_saved = '10/31/2023 10:30 PM';
const dataFechaAcualizado = '10/31/2023' + ' 6:26:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'63', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'67', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'70', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 88, MVar:'27', Cost:26.72, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:26.72, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'49', Cost:16.94, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'93', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 359,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 359, MVar:'174', Cost:16.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'94', Cost:9.09, ParentId: '17'},
		]
	},
