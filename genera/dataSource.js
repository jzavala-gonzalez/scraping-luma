const timestamp_saved = '08/02/2023 06:00 AM';
const dataFechaAcualizado = '8/2/2023' + ' 1:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'40', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'45', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 297,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'60', Cost:16.59, ParentId: '15'},
