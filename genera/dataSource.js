const timestamp_saved = '08/03/2023 03:30 AM';
const dataFechaAcualizado = '8/2/2023' + ' 11:25:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 141, MVar:'49', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'2', Cost:30.92, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'148', Cost:17.74, ParentId: '16'},
		]
	},
