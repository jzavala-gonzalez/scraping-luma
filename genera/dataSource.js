const timestamp_saved = '09/13/2023 06:30 AM';
const dataFechaAcualizado = '9/13/2023' + ' 2:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'46', Cost:10.92, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 321, MVar:'143', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'78', Cost:9.90, ParentId: '17'},
		]
	},
