const timestamp_saved = '09/24/2023 11:55 AM';
const dataFechaAcualizado = '9/24/2023' + ' 7:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'38', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'43', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'53', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:31.17, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:20.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:20.33, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 136, MVar:'0', Cost:17.52, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'65', Cost:17.52, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'76', Cost:9.65, ParentId: '17'},
		]
	},
