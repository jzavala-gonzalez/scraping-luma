const timestamp_saved = '11/20/2023 05:20 AM';
const dataFechaAcualizado = '11/20/2023' + ' 1:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'36', Cost:21.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'47', Cost:21.00, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'3', Cost:29.71, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'16', Cost:18.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'75', Cost:16.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'160', Cost:17.82, ParentId: '16'},
		]
	},
