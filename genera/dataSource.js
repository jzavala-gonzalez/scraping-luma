const timestamp_saved = '10/30/2023 06:45 PM';
const dataFechaAcualizado = '10/30/2023' + ' 2:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'59', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'62', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'67', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 159,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'6', Cost:18.30, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'102', Cost:16.95, ParentId: '15'},
