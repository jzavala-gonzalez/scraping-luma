const timestamp_saved = '12/02/2023 12:35 PM';
const dataFechaAcualizado = '12/2/2023' + ' 8:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'42', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'46', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'44', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 224,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 224, MVar:'122', Cost:18.25, ParentId: '16'},
		]
	},
