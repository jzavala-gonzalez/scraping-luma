const timestamp_saved = '10/13/2023 03:55 PM';
const dataFechaAcualizado = '10/13/2023' + ' 11:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'64', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'69', Cost:10.89, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'186', Cost:18.21, ParentId: '16'},
		]
	},
