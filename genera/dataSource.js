const timestamp_saved = '08/18/2023 03:00 PM';
const dataFechaAcualizado = '8/18/2023' + ' 10:57:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'60', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'70', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'8', Cost:31.51, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 59, MVar:'67', Cost:21.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'76', Cost:9.43, ParentId: '17'},
		]
	},
