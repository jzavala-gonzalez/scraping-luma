const timestamp_saved = '10/22/2023 10:40 AM';
const dataFechaAcualizado = '10/22/2023' + ' 6:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'37', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'37', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'42', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'36', Cost:8.78, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'4', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'67', Cost:16.75, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'51', Cost:11.22, ParentId: '17'},
		]
	},
