const timestamp_saved = '11/28/2023 03:15 AM';
const dataFechaAcualizado = '11/27/2023' + ' 11:11:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'31', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'41', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'55', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'97', Cost:9.16, ParentId: '17'},
		]
	},
