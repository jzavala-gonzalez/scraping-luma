const timestamp_saved = '11/30/2023 04:00 PM';
const dataFechaAcualizado = '11/30/2023' + ' 11:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'50', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'52', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'52', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'72', Cost:9.81, ParentId: '17'},
		]
	},
