const timestamp_saved = '08/06/2023 11:55 AM';
const dataFechaAcualizado = '8/6/2023' + ' 7:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'42', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'38', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'39', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'83', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'19', Cost:16.05, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'84', Cost:11.56, ParentId: '17'},
		]
	},
