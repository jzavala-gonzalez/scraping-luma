const timestamp_saved = '09/28/2023 09:50 PM';
const dataFechaAcualizado = '9/28/2023' + ' 5:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'45', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'47', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'51', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'48', Cost:17.47, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'157', Cost:16.84, ParentId: '16'},
		]
	},
