const timestamp_saved = '10/28/2023 01:30 PM';
const dataFechaAcualizado = '10/28/2023' + ' 9:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'41', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'46', Cost:11.38, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 125,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 35, MVar:'12', Cost:38.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:38.60, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 296,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 296, MVar:'132', Cost:17.22, ParentId: '16'},
		]
	},
