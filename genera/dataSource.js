const timestamp_saved = '10/13/2023 07:40 AM';
const dataFechaAcualizado = '10/13/2023' + ' 3:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'55', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'60', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'65', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'67', Cost:9.14, ParentId: '17'},
		]
	},
