const timestamp_saved = '10/30/2023 07:45 PM';
const dataFechaAcualizado = '10/30/2023' + ' 3:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'68', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'165', Cost:17.15, ParentId: '16'},
		]
	},
