const timestamp_saved = '09/27/2023 07:01 AM';
const dataFechaAcualizado = '9/27/2023' + ' 2:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'28', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'28', Cost:11.52, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'3', Cost:19.22, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'75', Cost:9.12, ParentId: '17'},
		]
	},
