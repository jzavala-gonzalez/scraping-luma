const timestamp_saved = '10/18/2023 12:16 AM';
const dataFechaAcualizado = '10/17/2023' + ' 8:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 252,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'104', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'69', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'66', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'66', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'32', Cost:30.93, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'93', Cost:16.74, ParentId: '15'},
