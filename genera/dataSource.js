const timestamp_saved = '12/04/2023 08:15 PM';
const dataFechaAcualizado = '12/4/2023' + ' 4:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'60', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'62', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'59', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'45', Cost:17.62, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:39.80, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 70,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'10', Cost:31.18, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'139', Cost:17.56, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'100', Cost:10.89, ParentId: '17'},
		]
	},
