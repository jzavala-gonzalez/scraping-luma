const timestamp_saved = '11/03/2023 06:35 PM';
const dataFechaAcualizado = '11/3/2023' + ' 2:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'55', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'56', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'11', Cost:30.47, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'82', Cost:9.63, ParentId: '17'},
		]
	},
