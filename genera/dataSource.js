const timestamp_saved = '08/13/2023 05:20 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:17:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'80', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'96', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'33', Cost:11.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'37', Cost:11.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'39', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:21.96, ParentId: '9'},
