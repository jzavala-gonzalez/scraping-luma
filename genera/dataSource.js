const timestamp_saved = '10/07/2023 04:30 AM';
const dataFechaAcualizado = '10/7/2023' + ' 12:26:14 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'1', Desc:'PREPA', value: 82},
	{Index:'2', Desc:'COGEN', value: 18},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2371},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'46', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'47', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'51', Cost:11.76, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:26.09, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'1', Cost:27.11, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'1', Cost:22.15, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:16.75, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'8', Cost:28.48, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'10', Cost:19.42, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'80', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'173', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'102', Cost:9.28, ParentId: '17'},
		]
	},
