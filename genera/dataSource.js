const timestamp_saved = '10/26/2023 10:15 AM';
const dataFechaAcualizado = '10/26/2023' + ' 6:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'44', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'44', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'46', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.62, ParentId: '14'},
