const timestamp_saved = '11/21/2023 04:00 AM';
const dataFechaAcualizado = '11/20/2023' + ' 11:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'30', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'40', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'54', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'69', Cost:16.86, ParentId: '15'},
