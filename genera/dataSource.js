const timestamp_saved = '11/16/2023 02:00 AM';
const dataFechaAcualizado = '11/15/2023' + ' 9:56:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'58', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'56', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'59', Cost:10.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.80, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'77', Cost:16.87, ParentId: '15'},
