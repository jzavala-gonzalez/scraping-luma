const timestamp_saved = '11/12/2023 04:40 PM';
const dataFechaAcualizado = '11/12/2023' + ' 12:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'44', Cost:12.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'46', Cost:12.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'55', Cost:12.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'23', Cost:19.00, ParentId: '14'},
