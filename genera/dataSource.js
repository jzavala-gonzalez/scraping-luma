const timestamp_saved = '08/05/2023 09:00 AM';
const dataFechaAcualizado = '8/5/2023' + ' 4:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'42', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'38', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'43', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'50', Cost:15.62, ParentId: '15'},
		]
	},
