const timestamp_saved = '09/24/2023 12:30 PM';
const dataFechaAcualizado = '9/24/2023' + ' 8:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 379,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'41', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:11.51, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'68', Cost:17.67, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'77', Cost:9.58, ParentId: '17'},
		]
	},
