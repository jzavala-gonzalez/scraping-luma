const timestamp_saved = '10/01/2023 06:35 AM';
const dataFechaAcualizado = '10/1/2023' + ' 2:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 481,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'61', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'29', Cost:12.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'29', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'47', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:22.32, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.62, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'12', Cost:19.23, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 293,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 293, MVar:'92', Cost:9.47, ParentId: '17'},
		]
	},
