const timestamp_saved = '08/29/2023 02:11 AM';
const dataFechaAcualizado = '8/28/2023' + ' 10:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'61', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'60', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'66', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 153,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'10', Cost:21.99, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.92, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 25, MVar:'10', Cost:25.78, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'4', Cost:25.26, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'35', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'36', Cost:28.09, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'84', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'194', Cost:16.76, ParentId: '16'},
		]
	},
