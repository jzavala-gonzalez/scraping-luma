const timestamp_saved = '08/18/2023 03:50 PM';
const dataFechaAcualizado = '8/18/2023' + ' 11:47:56 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3413},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'60', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'72', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'8', Cost:31.56, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 1,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'0', Cost:30.49, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:19.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 81, MVar:'73', Cost:19.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'144', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'78', Cost:9.45, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 127,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 39, MVar:'0', Cost:17, ParentId: '19'},
		]
	},
