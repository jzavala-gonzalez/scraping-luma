const timestamp_saved = '10/11/2023 05:15 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:11:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'80', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'59', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'62', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'67', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'28', Cost:18.95, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'9', Cost:18.95, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.12, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'86', Cost:9.14, ParentId: '17'},
		]
	},
