const timestamp_saved = '11/13/2023 02:05 PM';
const dataFechaAcualizado = '11/13/2023' + ' 10:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'47', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'51', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'54', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'92', Cost:9.55, ParentId: '17'},
		]
	},
