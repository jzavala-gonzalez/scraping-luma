const timestamp_saved = '10/28/2023 10:35 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:31:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1882},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'38', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:11.09, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 60, MVar:'17', Cost:30.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.30, ParentId: '11'},
