const timestamp_saved = '10/18/2023 03:15 AM';
const dataFechaAcualizado = '10/17/2023' + ' 11:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'25', Cost:31.03, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'36', Cost:17.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:17.30, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 126, MVar:'39', Cost:8.29, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:8.29, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'3', Cost:19.18, ParentId: '14'},
