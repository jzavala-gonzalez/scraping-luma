const timestamp_saved = '08/18/2023 01:30 PM';
const dataFechaAcualizado = '8/18/2023' + ' 9:27:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'61', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'72', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'6', Cost:31.07, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 48, MVar:'8', Cost:31.41, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:19.60, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 28,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 28, MVar:'0', Cost:58.87, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'34', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 309,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 309, MVar:'149', Cost:16.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'78', Cost:9.28, ParentId: '17'},
		]
	},
