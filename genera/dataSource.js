const timestamp_saved = '11/17/2023 11:40 AM';
const dataFechaAcualizado = '11/17/2023' + ' 7:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'59', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'59', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'45', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:34.46, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:17.04, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'84', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'94', Cost:9.82, ParentId: '17'},
		]
	},
