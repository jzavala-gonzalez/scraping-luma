const timestamp_saved = '10/28/2023 09:15 AM';
const dataFechaAcualizado = '10/28/2023' + ' 5:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'35', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'38', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'43', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:28.13, ParentId: '11'},
