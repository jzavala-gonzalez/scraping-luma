const timestamp_saved = '11/13/2023 05:50 AM';
const dataFechaAcualizado = '11/13/2023' + ' 1:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 172,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 86, MVar:'44', Cost:21.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'50', Cost:21.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.51, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.00, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'59', Cost:16.96, ParentId: '15'},
