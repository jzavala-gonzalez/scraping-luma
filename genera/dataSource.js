const timestamp_saved = '09/28/2023 05:45 PM';
const dataFechaAcualizado = '9/28/2023' + ' 1:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'30', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'30', Cost:10.97, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'135', Cost:18.44, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'91', Cost:9.75, ParentId: '17'},
		]
	},
