const timestamp_saved = '11/15/2023 06:50 AM';
const dataFechaAcualizado = '11/15/2023' + ' 2:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'33', Cost:12.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'35', Cost:12.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'45', Cost:12.68, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'60', Cost:9.76, ParentId: '17'},
		]
	},
