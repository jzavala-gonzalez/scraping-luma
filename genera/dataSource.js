const timestamp_saved = '11/06/2023 07:50 PM';
const dataFechaAcualizado = '11/6/2023' + ' 3:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'58', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'60', Cost:10.90, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'117', Cost:9.20, ParentId: '17'},
		]
	},
