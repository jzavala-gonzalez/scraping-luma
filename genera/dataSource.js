const timestamp_saved = '12/04/2023 06:35 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'37', Cost:12.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'37', Cost:12.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'45', Cost:12.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'43', Cost:11.63, ParentId: '17'},
		]
	},
