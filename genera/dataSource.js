const timestamp_saved = '09/23/2023 10:25 PM';
const dataFechaAcualizado = '9/23/2023' + ' 6:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'55', Cost:10.15, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'24', Cost:19.30, ParentId: '14'},
