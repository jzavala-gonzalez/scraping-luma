const timestamp_saved = '08/21/2023 06:25 PM';
const dataFechaAcualizado = '8/21/2023' + ' 2:20:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'60', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'39', Cost:10.76, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'16', Cost:19.30, ParentId: '14'},
