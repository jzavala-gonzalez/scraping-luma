const timestamp_saved = '08/20/2023 05:55 AM';
const dataFechaAcualizado = '8/20/2023' + ' 1:52:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'55', Cost:11.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'53', Cost:11.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'54', Cost:11.29, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'19', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:31.28, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'130', Cost:16.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'71', Cost:9.19, ParentId: '17'},
		]
	},
