const timestamp_saved = '09/02/2023 02:10 PM';
const dataFechaAcualizado = '9/2/2023' + ' 10:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'42', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'50', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'60', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 137, MVar:'56', Cost:16.92, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 98,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 36, MVar:'22', Cost:19.60, ParentId: '19'},
