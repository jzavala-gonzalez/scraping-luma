const timestamp_saved = '11/09/2023 06:20 PM';
const dataFechaAcualizado = '11/9/2023' + ' 2:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'50', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'49', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'3', Cost:30.10, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'18', Cost:21.86, ParentId: '14'},
