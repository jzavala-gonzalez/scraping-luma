const timestamp_saved = '09/16/2023 12:50 AM';
const dataFechaAcualizado = '9/15/2023' + ' 8:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'55', Cost:4.38, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'66', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:30.78, ParentId: '10'},
		]
	},
