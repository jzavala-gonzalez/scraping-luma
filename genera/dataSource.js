const timestamp_saved = '10/04/2023 08:20 PM';
const dataFechaAcualizado = '10/4/2023' + ' 4:16:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'49', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'47', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'7', Cost:17.42, ParentId: '11'},
