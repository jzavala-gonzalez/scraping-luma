const timestamp_saved = '08/07/2023 01:05 AM';
const dataFechaAcualizado = '8/6/2023' + ' 9:00:40 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 137},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'61', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'56', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'52', Cost:10.50, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 172,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 152, MVar:'22', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:22.04, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.72, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'14', Cost:22.20, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'4', Cost:22.24, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'24', Cost:28.00, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'25', Cost:28.04, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'44', Cost:20.27, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:28.39, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 252,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 98, MVar:'72', Cost:18.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 154, MVar:'28', Cost:15.58, ParentId: '15'},
		]
	},
