const timestamp_saved = '11/16/2023 04:40 PM';
const dataFechaAcualizado = '11/16/2023' + ' 12:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'51', Cost:13.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'51', Cost:13.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'52', Cost:13.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'84', Cost:9.70, ParentId: '17'},
		]
	},
