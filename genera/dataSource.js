const timestamp_saved = '11/14/2023 06:45 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'41', Cost:12.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'46', Cost:12.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'51', Cost:12.59, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:31.37, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.67, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 239,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 239, MVar:'79', Cost:11.34, ParentId: '17'},
		]
	},
