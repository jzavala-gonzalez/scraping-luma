const timestamp_saved = '08/05/2023 09:50 AM';
const dataFechaAcualizado = '8/5/2023' + ' 5:45:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'37', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'45', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'95', Cost:16.96, ParentId: '15'},
