const timestamp_saved = '10/27/2023 11:40 AM';
const dataFechaAcualizado = '10/27/2023' + ' 7:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'46', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 119, MVar:'96', Cost:17.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'0', Cost:18.32, ParentId: '16'},
		]
	},
