const timestamp_saved = '10/25/2023 06:40 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'47', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'52', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'35', Cost:18.16, ParentId: '11'},
