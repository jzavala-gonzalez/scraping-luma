const timestamp_saved = '11/01/2023 05:15 PM';
const dataFechaAcualizado = '11/1/2023' + ' 1:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'64', Cost:10.71, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'142', Cost:18.20, ParentId: '16'},
		]
	},
