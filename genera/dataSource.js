const timestamp_saved = '08/07/2023 08:10 AM';
const dataFechaAcualizado = '8/7/2023' + ' 4:05:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'85', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'46', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'41', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'42', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:30.81, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'6', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'54', Cost:18.42, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'97', Cost:11.72, ParentId: '17'},
		]
	},
