const timestamp_saved = '09/05/2023 06:50 PM';
const dataFechaAcualizado = '9/5/2023' + ' 2:45:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'48', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'53', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'62', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 87,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 87, MVar:'0', Cost:9.79, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.68, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'164', Cost:18.25, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:49.50, ParentId: '21'},
