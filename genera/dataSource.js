const timestamp_saved = '11/14/2023 04:30 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'53', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'56', Cost:11.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.06, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.83, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 105, MVar:'162', Cost:25.06, ParentId: '16'},
		]
	},
