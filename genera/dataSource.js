const timestamp_saved = '08/14/2023 05:30 PM';
const dataFechaAcualizado = '8/14/2023' + ' 1:27:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'48', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'2', Cost:27.50, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:31.21, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:32.03, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'126', Cost:12.38, ParentId: '17'},
		]
	},
