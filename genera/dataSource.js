const timestamp_saved = '11/04/2023 04:45 AM';
const dataFechaAcualizado = '11/4/2023' + ' 12:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'48', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'47', Cost:10.87, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:16.86, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'13', Cost:21.04, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'68', Cost:9.34, ParentId: '17'},
		]
	},
