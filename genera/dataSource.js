const timestamp_saved = '09/12/2023 08:55 AM';
const dataFechaAcualizado = '9/12/2023' + ' 4:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'44', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'43', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'58', Cost:11.00, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 158, MVar:'57', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:30.67, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'31', Cost:10.48, ParentId: '17'},
		]
	},
