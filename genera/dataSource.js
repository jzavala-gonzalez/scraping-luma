const timestamp_saved = '11/18/2023 09:50 AM';
const dataFechaAcualizado = '11/18/2023' + ' 5:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'40', Cost:15.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'64', Cost:15.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:15.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.11, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 76,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'12', Cost:28.88, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'72', Cost:16.51, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'126', Cost:9.14, ParentId: '17'},
		]
	},
