const timestamp_saved = '10/11/2023 06:00 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:56:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'66', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'69', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'70', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'36', Cost:18.31, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'8', Cost:18.31, ParentId: '11'},
		]
	},
