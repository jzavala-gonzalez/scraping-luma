const timestamp_saved = '11/14/2023 06:30 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'41', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'45', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'51', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'82', Cost:11.13, ParentId: '17'},
		]
	},
