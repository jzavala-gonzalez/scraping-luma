const timestamp_saved = '07/30/2023 09:25 PM';
const dataFechaAcualizado = '7/30/2023' + ' 5:20:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.63, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'6', Cost:43.41, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'46', Cost:17.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:17.33, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'95', Cost:17.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'133', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'83', Cost:11.42, ParentId: '17'},
		]
	},
