const timestamp_saved = '11/15/2023 11:10 AM';
const dataFechaAcualizado = '11/15/2023' + ' 7:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'42', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'42', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'72', Cost:9.78, ParentId: '17'},
		]
	},
