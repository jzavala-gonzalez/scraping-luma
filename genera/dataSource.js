const timestamp_saved = '11/20/2023 08:25 AM';
const dataFechaAcualizado = '11/20/2023' + ' 4:21:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'27', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'37', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'52', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'89', Cost:9.18, ParentId: '17'},
		]
	},
