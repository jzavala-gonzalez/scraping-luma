const timestamp_saved = '11/22/2023 05:05 PM';
const dataFechaAcualizado = '11/22/2023' + ' 1:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'34', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'44', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'10', Cost:19.79, ParentId: '14'},
