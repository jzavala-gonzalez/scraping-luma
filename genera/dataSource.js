const timestamp_saved = '08/21/2023 08:45 AM';
const dataFechaAcualizado = '8/21/2023' + ' 4:42:58 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'33', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'51', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'48', Cost:9.89, ParentId: '17'},
		]
	},
