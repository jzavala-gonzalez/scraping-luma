const timestamp_saved = '10/09/2023 06:15 PM';
const dataFechaAcualizado = '10/9/2023' + ' 2:11:25 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'59', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'62', Cost:10.46, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'5', Cost:27.18, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:27.94, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:17.59, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'83', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 287,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 287, MVar:'176', Cost:17.35, ParentId: '16'},
		]
	},
