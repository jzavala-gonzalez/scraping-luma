const timestamp_saved = '10/17/2023 11:00 AM';
const dataFechaAcualizado = '10/17/2023' + ' 6:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'52', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'50', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'53', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'4', Cost:30.99, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'11', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'81', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'77', Cost:9.24, ParentId: '17'},
		]
	},
