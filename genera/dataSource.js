const timestamp_saved = '11/21/2023 12:10 PM';
const dataFechaAcualizado = '11/21/2023' + ' 8:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'30', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'41', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'54', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'85', Cost:9.59, ParentId: '17'},
		]
	},
