const timestamp_saved = '09/06/2023 05:20 PM';
const dataFechaAcualizado = '9/6/2023' + ' 1:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'54', Cost:13.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'31', Cost:13.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'50', Cost:13.69, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:29.18, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'28', Cost:19.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 172, MVar:'101', Cost:16.59, ParentId: '15'},
