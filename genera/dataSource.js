const timestamp_saved = '10/20/2023 03:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 11:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'45', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'51', Cost:12.01, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'150', Cost:17.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'112', Cost:10.53, ParentId: '17'},
		]
	},
