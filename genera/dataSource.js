const timestamp_saved = '10/28/2023 08:01 PM';
const dataFechaAcualizado = '10/28/2023' + ' 3:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'50', Cost:10.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:10.93, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 207,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:26.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:26.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'27', Cost:3.68, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 27, MVar:'6', Cost:3.68, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'7', Cost:30.22, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'0', Cost:30.71, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'18', Cost:21.92, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'133', Cost:17.28, ParentId: '16'},
		]
	},
