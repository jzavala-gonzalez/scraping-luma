const timestamp_saved = '11/10/2023 11:20 PM';
const dataFechaAcualizado = '11/10/2023' + ' 7:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'95', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'47', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'47', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'56', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'11', Cost:22.08, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.04, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'103', Cost:9.26, ParentId: '17'},
		]
	},
