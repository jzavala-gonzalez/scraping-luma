const timestamp_saved = '10/21/2023 08:40 AM';
const dataFechaAcualizado = '10/21/2023' + ' 4:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'19', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'18', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'56', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'68', Cost:11.04, ParentId: '17'},
		]
	},
