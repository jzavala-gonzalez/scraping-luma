const timestamp_saved = '09/30/2023 10:25 AM';
const dataFechaAcualizado = '9/30/2023' + ' 6:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'34', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'32', Cost:11.57, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 37,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 14, MVar:'1', Cost:27.31, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'136', Cost:17.00, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'106', Cost:9.41, ParentId: '17'},
		]
	},
