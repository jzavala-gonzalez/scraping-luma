const timestamp_saved = '10/08/2023 01:20 AM';
const dataFechaAcualizado = '10/7/2023' + ' 9:16:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 180, MVar:'65', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'49', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'50', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'48', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'5', Cost:26.07, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'14', Cost:28.10, ParentId: '10'},
