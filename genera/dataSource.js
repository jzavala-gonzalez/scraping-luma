const timestamp_saved = '11/20/2023 07:00 AM';
const dataFechaAcualizado = '11/20/2023' + ' 2:56:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'29', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'39', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'53', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'15', Cost:18.91, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'67', Cost:17.69, ParentId: '15'},
