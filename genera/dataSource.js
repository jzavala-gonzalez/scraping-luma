const timestamp_saved = '11/06/2023 07:20 AM';
const dataFechaAcualizado = '11/6/2023' + ' 3:16:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'42', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'41', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'40', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'74', Cost:16.82, ParentId: '15'},
