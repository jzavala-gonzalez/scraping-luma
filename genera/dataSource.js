const timestamp_saved = '10/18/2023 08:10 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'41', Cost:10.79, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 70, MVar:'59', Cost:20.45, ParentId: '15'},
