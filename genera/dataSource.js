const timestamp_saved = '10/22/2023 04:06 AM';
const dataFechaAcualizado = '10/22/2023' + ' 12:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'43', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'44', Cost:11.92, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'141', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'68', Cost:11.11, ParentId: '17'},
		]
	},
