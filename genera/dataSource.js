const timestamp_saved = '08/19/2023 09:05 AM';
const dataFechaAcualizado = '8/19/2023' + ' 5:02:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'41', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'56', Cost:10.80, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:30.84, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:31.11, ParentId: '12'},
