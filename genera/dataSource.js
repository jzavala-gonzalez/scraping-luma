const timestamp_saved = '10/05/2023 01:20 PM';
const dataFechaAcualizado = '10/5/2023' + ' 9:16:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'43', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'39', Cost:10.62, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'89', Cost:16.80, ParentId: '15'},
