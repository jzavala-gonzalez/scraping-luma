const timestamp_saved = '10/22/2023 11:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 7:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'52', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 10, MVar:'0', Cost:23.83, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'69', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'137', Cost:16.95, ParentId: '16'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 19,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:23.83, ParentId: '21'},
