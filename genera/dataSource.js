const timestamp_saved = '11/06/2023 08:15 AM';
const dataFechaAcualizado = '11/6/2023' + ' 4:11:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'41', Cost:11.37, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'49', Cost:16.95, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'73', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'45', Cost:9.83, ParentId: '17'},
		]
	},
