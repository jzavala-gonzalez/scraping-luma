const timestamp_saved = '10/23/2023 09:25 PM';
const dataFechaAcualizado = '10/23/2023' + ' 5:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'52', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'53', Cost:10.64, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'11', Cost:17.14, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'23', Cost:19.35, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'148', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 209,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 209, MVar:'80', Cost:12.04, ParentId: '17'},
		]
	},
