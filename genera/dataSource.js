const timestamp_saved = '08/30/2023 01:35 PM';
const dataFechaAcualizado = '8/30/2023' + ' 9:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'68', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'90', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'51', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'53', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'63', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 53, MVar:'41', Cost:21.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'102', Cost:16.77, ParentId: '15'},
