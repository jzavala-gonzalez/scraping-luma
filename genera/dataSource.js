const timestamp_saved = '11/09/2023 04:05 AM';
const dataFechaAcualizado = '11/9/2023' + ' 12:01:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'45', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'47', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 110,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 40, MVar:'23', Cost:25.96, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 205,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'139', Cost:18.90, ParentId: '16'},
		]
	},
