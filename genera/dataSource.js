const timestamp_saved = '09/27/2023 05:35 PM';
const dataFechaAcualizado = '9/27/2023' + ' 1:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'32', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'32', Cost:11.15, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 136, MVar:'40', Cost:8.82, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:8.82, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 109, MVar:'0', Cost:18.17, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'11', Cost:19.36, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'92', Cost:17.13, ParentId: '15'},
