const timestamp_saved = '11/24/2023 07:10 AM';
const dataFechaAcualizado = '11/24/2023' + ' 3:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'21', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'30', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'46', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'63', Cost:9.88, ParentId: '17'},
		]
	},
