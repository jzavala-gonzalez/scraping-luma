const timestamp_saved = '08/13/2023 07:50 PM';
const dataFechaAcualizado = '8/13/2023' + ' 3:47:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'35', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'42', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'41', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:34.38, ParentId: '10'},
