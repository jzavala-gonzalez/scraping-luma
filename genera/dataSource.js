const timestamp_saved = '10/18/2023 09:00 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'37', Cost:10.59, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 29,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'3', Cost:31.42, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 59, MVar:'64', Cost:21.64, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'84', Cost:10.65, ParentId: '17'},
		]
	},
