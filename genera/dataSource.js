const timestamp_saved = '11/05/2023 10:25 AM';
const dataFechaAcualizado = '11/5/2023' + ' 6:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'38', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'37', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'39', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'36', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.62, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'72', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'44', Cost:9.78, ParentId: '17'},
		]
	},
