const timestamp_saved = '10/05/2023 04:20 AM';
const dataFechaAcualizado = '10/5/2023' + ' 12:16:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'36', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'36', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'51', Cost:11.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 38,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 127, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'5', Cost:31.56, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'8', Cost:19.38, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'144', Cost:17.45, ParentId: '16'},
		]
	},
