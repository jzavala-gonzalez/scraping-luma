const timestamp_saved = '09/11/2023 05:25 AM';
const dataFechaAcualizado = '9/11/2023' + ' 1:20:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'68', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'66', Cost:10.52, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:19.88, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'11', Cost:31.08, ParentId: '10'},
		]
	},
