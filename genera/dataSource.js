const timestamp_saved = '10/11/2023 06:00 AM';
const dataFechaAcualizado = '10/11/2023' + ' 1:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'50', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'54', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'59', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'44', Cost:8.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:8.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'89', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'142', Cost:16.89, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'63', Cost:9.31, ParentId: '17'},
		]
	},
