const timestamp_saved = '09/08/2023 06:35 PM';
const dataFechaAcualizado = '9/8/2023' + ' 2:30:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 255, MVar:'68', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'80', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'60', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'65', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'59', Cost:10.13, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 107,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 107, MVar:'0', Cost:6.95, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 124, MVar:'56', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'20', Cost:31.03, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'20', Cost:30.96, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:19.68, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'31', Cost:19.27, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'98', Cost:16.63, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'164', Cost:16.83, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 97,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 12, MVar:'5', Cost:21.43, ParentId: '19'},
