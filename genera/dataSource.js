const timestamp_saved = '10/30/2023 01:50 PM';
const dataFechaAcualizado = '10/30/2023' + ' 9:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 185,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 25, MVar:'8', Cost:77.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:77.86, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'32', Cost:18.95, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'170', Cost:17.55, ParentId: '16'},
		]
	},
