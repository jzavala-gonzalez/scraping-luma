const timestamp_saved = '10/14/2023 02:40 PM';
const dataFechaAcualizado = '10/14/2023' + ' 10:36:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'45', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'44', Cost:11.67, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:17.63, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'72', Cost:9.29, ParentId: '17'},
		]
	},
