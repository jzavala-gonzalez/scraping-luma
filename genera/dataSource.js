const timestamp_saved = '10/19/2023 06:45 PM';
const dataFechaAcualizado = '10/19/2023' + ' 2:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'40', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'46', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'70', Cost:11.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 33,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 15, MVar:'0', Cost:30.25, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'17', Cost:43.41, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:17.04, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'12', Cost:17.04, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 154, MVar:'47', Cost:17.16, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'10', Cost:17.16, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 73,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'7', Cost:28.14, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'18', Cost:23.79, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'177', Cost:17.17, ParentId: '16'},
		]
	},
