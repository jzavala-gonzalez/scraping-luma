const timestamp_saved = '11/12/2023 03:00 AM';
const dataFechaAcualizado = '11/11/2023' + ' 10:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'51', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'53', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'58', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'75', Cost:16.93, ParentId: '15'},
