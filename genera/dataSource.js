const timestamp_saved = '07/30/2023 11:00 AM';
const dataFechaAcualizado = '7/30/2023' + ' 6:55:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'42', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'37', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'7', Cost:19.77, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'18', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 240,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'78', Cost:17.62, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'37', Cost:16.34, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'63', Cost:19.70, ParentId: '16'},
		]
	},
