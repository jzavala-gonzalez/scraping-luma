const timestamp_saved = '12/06/2023 08:30 PM';
const dataFechaAcualizado = '12/6/2023' + ' 4:25:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 638},
	{Index:'7', Desc:'Capacidad Disponible', value: 3106},
	{Index:'8', Desc:'Próxima Hora MW', value: 2534},
	{Index:'9', Desc:'Máxima para Hoy', value: 2474},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'57', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'58', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'63', Cost:10.50, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 46, MVar:'0', Cost:10.50, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:17.93, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.93, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'39', Cost:8.67, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:8.67, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'6', Cost:71.78, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'90', Cost:13.71, ParentId: '17'},
		]
	},
