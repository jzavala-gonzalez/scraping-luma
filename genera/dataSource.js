const timestamp_saved = '08/05/2023 10:15 AM';
const dataFechaAcualizado = '8/5/2023' + ' 6:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'38', Cost:11.04, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'87', Cost:17.00, ParentId: '15'},
