const timestamp_saved = '08/23/2023 06:15 PM';
const dataFechaAcualizado = '8/23/2023' + ' 2:10:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'56', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'57', Cost:10.91, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:19.64, ParentId: '11'},
