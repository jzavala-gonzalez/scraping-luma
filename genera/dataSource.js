const timestamp_saved = '11/16/2023 07:45 AM';
const dataFechaAcualizado = '11/16/2023' + ' 3:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'41', Cost:12.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'41', Cost:12.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'48', Cost:12.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'10', Cost:17.53, ParentId: '11'},
