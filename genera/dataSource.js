const timestamp_saved = '11/25/2023 06:00 PM';
const dataFechaAcualizado = '11/25/2023' + ' 1:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'31', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'39', Cost:10.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'41', Cost:8.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:8.69, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'34', Cost:18.55, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'41', Cost:9.84, ParentId: '17'},
		]
	},
