const timestamp_saved = '11/28/2023 01:30 AM';
const dataFechaAcualizado = '11/27/2023' + ' 9:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'40', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'49', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'59', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'7', Cost:31.52, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'10', Cost:31.27, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 255,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 255, MVar:'183', Cost:17.40, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'111', Cost:9.16, ParentId: '17'},
		]
	},
