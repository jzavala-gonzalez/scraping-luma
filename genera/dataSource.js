const timestamp_saved = '07/29/2023 03:00 PM';
const dataFechaAcualizado = '7/29/2023' + ' 10:55:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'51', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'50', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 97, MVar:'31', Cost:19.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:19.75, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'96', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'26', Cost:15.67, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'94', Cost:13.33, ParentId: '17'},
		]
	},
