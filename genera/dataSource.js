const timestamp_saved = '10/21/2023 01:35 PM';
const dataFechaAcualizado = '10/21/2023' + ' 9:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'38', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'36', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'38', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'7', Cost:18.11, ParentId: '11'},
		]
	},
