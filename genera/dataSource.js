const timestamp_saved = '08/28/2023 07:35 AM';
const dataFechaAcualizado = '8/28/2023' + ' 3:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'37', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'35', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'5', Cost:19.07, ParentId: '14'},
