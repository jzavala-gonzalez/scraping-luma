const timestamp_saved = '11/23/2023 01:35 AM';
const dataFechaAcualizado = '11/22/2023' + ' 9:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'40', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'49', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'61', Cost:10.49, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 40, MVar:'0', Cost:26.11, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'61', Cost:9.20, ParentId: '17'},
		]
	},
