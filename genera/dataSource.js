const timestamp_saved = '10/25/2023 06:15 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'47', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 162, MVar:'53', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.56, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.01, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'155', Cost:17.38, ParentId: '16'},
		]
	},
