const timestamp_saved = '11/25/2023 10:55 AM';
const dataFechaAcualizado = '11/25/2023' + ' 6:51:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1838},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 128, MVar:'51', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'20', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'30', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.83, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'116', Cost:18.20, ParentId: '16'},
		]
	},
