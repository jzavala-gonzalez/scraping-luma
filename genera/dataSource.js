const timestamp_saved = '10/02/2023 08:10 PM';
const dataFechaAcualizado = '10/2/2023' + ' 4:05:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2816},
];
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 250,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'96', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'44', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'54', Cost:10.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 87,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:26.16, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 30, MVar:'0', Cost:42.22, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'14', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'92', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'118', Cost:9.16, ParentId: '17'},
		]
	},
