const timestamp_saved = '10/08/2023 06:20 PM';
const dataFechaAcualizado = '10/8/2023' + ' 2:16:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'84', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'47', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'46', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'43', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'34', Cost:17.48, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:17.48, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 151, MVar:'47', Cost:8.15, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'16', Cost:19.31, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'92', Cost:16.60, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 217,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 217, MVar:'85', Cost:10.34, ParentId: '17'},
		]
	},
