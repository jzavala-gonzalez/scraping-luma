const timestamp_saved = '10/22/2023 10:15 AM';
const dataFechaAcualizado = '10/22/2023' + ' 6:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'39', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'41', Cost:10.64, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'5', Cost:19.40, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'52', Cost:11.22, ParentId: '17'},
		]
	},
