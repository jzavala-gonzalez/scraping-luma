const timestamp_saved = '10/25/2023 11:25 AM';
const dataFechaAcualizado = '10/25/2023' + ' 7:21:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2252},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'47', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.10, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.10, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 139, MVar:'42', Cost:17.07, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:17.07, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'89', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'138', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'1', Cost:11.31, ParentId: '17'},
		]
	},
