const timestamp_saved = '09/11/2023 06:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 2:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'66', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'67', Cost:10.45, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'10', Cost:31.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'10', Cost:31.00, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:8.72, ParentId: '11'},
		]
	},
