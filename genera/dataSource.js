const timestamp_saved = '11/18/2023 02:15 AM';
const dataFechaAcualizado = '11/17/2023' + ' 10:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'74', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'61', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 68,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 38, MVar:'9', Cost:28.89, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'12', Cost:22.51, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'82', Cost:16.68, ParentId: '15'},
