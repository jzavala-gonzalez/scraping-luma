const timestamp_saved = '09/04/2023 05:15 PM';
const dataFechaAcualizado = '9/4/2023' + ' 1:10:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'41', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'45', Cost:10.32, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.45, ParentId: '14'},
