const timestamp_saved = '09/21/2023 01:25 AM';
const dataFechaAcualizado = '9/20/2023' + ' 9:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'116', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:9.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'62', Cost:9.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 205, MVar:'67', Cost:9.73, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 151,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'16', Cost:28.09, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'17', Cost:28.34, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:19.98, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'8', Cost:30.60, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'112', Cost:9.15, ParentId: '17'},
		]
	},
