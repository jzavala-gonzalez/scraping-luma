const timestamp_saved = '08/05/2023 02:00 AM';
const dataFechaAcualizado = '8/4/2023' + ' 9:55:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'50', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'51', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:26.14, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.50, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'12', Cost:27.02, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:32.07, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:31.83, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'94', Cost:16.65, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'150', Cost:16.89, ParentId: '16'},
		]
	},
