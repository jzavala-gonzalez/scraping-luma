const timestamp_saved = '10/20/2023 10:35 PM';
const dataFechaAcualizado = '10/20/2023' + ' 6:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 463,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.50, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'104', Cost:10.53, ParentId: '17'},
		]
	},
