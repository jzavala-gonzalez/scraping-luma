const timestamp_saved = '09/13/2023 09:35 AM';
const dataFechaAcualizado = '9/13/2023' + ' 5:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'50', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'48', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'63', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'90', Cost:9.26, ParentId: '17'},
		]
	},
