const timestamp_saved = '11/29/2023 07:30 AM';
const dataFechaAcualizado = '11/29/2023' + ' 3:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'21', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'30', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'47', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'65', Cost:9.81, ParentId: '17'},
		]
	},
