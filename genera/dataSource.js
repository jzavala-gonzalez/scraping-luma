const timestamp_saved = '10/05/2023 11:10 AM';
const dataFechaAcualizado = '10/5/2023' + ' 7:06:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'33', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'31', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'49', Cost:11.73, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 38,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 84, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:17.23, ParentId: '11'},
