const timestamp_saved = '11/16/2023 07:00 AM';
const dataFechaAcualizado = '11/16/2023' + ' 2:56:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1993},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 339,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'41', Cost:12.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'40', Cost:12.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'47', Cost:12.20, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'54', Cost:10.86, ParentId: '17'},
		]
	},
