const timestamp_saved = '08/03/2023 11:45 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:40:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'49', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'82', Cost:17.10, ParentId: '15'},
