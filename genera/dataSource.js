const timestamp_saved = '08/16/2023 02:20 PM';
const dataFechaAcualizado = '8/16/2023' + ' 10:17:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'52', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'60', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'88', Cost:10.24, ParentId: '17'},
		]
	},
