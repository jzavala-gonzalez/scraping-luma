const timestamp_saved = '10/18/2023 08:16 AM';
const dataFechaAcualizado = '10/18/2023' + ' 4:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.72, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 67, MVar:'63', Cost:20.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'151', Cost:17.79, ParentId: '16'},
		]
	},
