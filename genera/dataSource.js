const timestamp_saved = '10/14/2023 04:35 PM';
const dataFechaAcualizado = '10/14/2023' + ' 12:31:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'48', Cost:10.93, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'77', Cost:9.29, ParentId: '17'},
		]
	},
