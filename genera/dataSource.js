const timestamp_saved = '09/28/2023 03:20 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'28', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'28', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'60', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 105, MVar:'0', Cost:20.90, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:20.90, ParentId: '11'},
		]
	},
