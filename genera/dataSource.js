const timestamp_saved = '08/08/2023 12:10 PM';
const dataFechaAcualizado = '8/8/2023' + ' 8:05:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 150, MVar:'61', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 119,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 119, MVar:'30', Cost:16.32, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'96', Cost:11.63, ParentId: '17'},
		]
	},
