const timestamp_saved = '10/31/2023 11:40 PM';
const dataFechaAcualizado = '10/31/2023' + ' 7:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'61', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'64', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'68', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'93', Cost:9.12, ParentId: '17'},
		]
	},
