const timestamp_saved = '08/01/2023 08:35 PM';
const dataFechaAcualizado = '8/1/2023' + ' 4:30:36 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3471},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'51', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'45', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:11.00, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 119, MVar:'0', Cost:7.15, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'12', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'2', Cost:26.42, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'38', Cost:8.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:8.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'0', Cost:8.29, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'10', Cost:8.29, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:32.33, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:29.33, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 57,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:32.45, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'10', Cost:18.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'75', Cost:16.83, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 149, MVar:'33', Cost:15.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'135', Cost:17.50, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'97', Cost:11.01, ParentId: '17'},
		]
	},
