const timestamp_saved = '10/04/2023 03:55 PM';
const dataFechaAcualizado = '10/4/2023' + ' 11:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'43', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'40', Cost:10.85, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'160', Cost:18.29, ParentId: '16'},
		]
	},
