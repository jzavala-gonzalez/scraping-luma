const timestamp_saved = '11/24/2023 02:10 AM';
const dataFechaAcualizado = '11/23/2023' + ' 10:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'34', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'44', Cost:10.48, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.71, ParentId: '14'},
