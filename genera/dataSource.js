const timestamp_saved = '08/26/2023 10:45 PM';
const dataFechaAcualizado = '8/26/2023' + ' 6:40:49 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'73', Cost:4.39, ParentId: '6'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 107,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'7', Cost:31.14, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'9', Cost:31.50, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:19.79, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'8', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'68', Cost:17.22, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'115', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'118', Cost:16.54, ParentId: '17'},
		]
	},
