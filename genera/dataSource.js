const timestamp_saved = '11/16/2023 04:20 AM';
const dataFechaAcualizado = '11/16/2023' + ' 12:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'46', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'51', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'1', Cost:31.79, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.81, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 247,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 247, MVar:'127', Cost:17.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 186, MVar:'66', Cost:10.94, ParentId: '17'},
		]
	},
