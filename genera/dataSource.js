const timestamp_saved = '10/27/2023 12:55 PM';
const dataFechaAcualizado = '10/27/2023' + ' 8:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'50', Cost:12.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'51', Cost:12.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'53', Cost:12.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'50', Cost:16.89, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'9', Cost:16.89, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'27', Cost:19.42, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'92', Cost:16.86, ParentId: '15'},
