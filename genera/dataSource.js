const timestamp_saved = '10/21/2023 06:35 AM';
const dataFechaAcualizado = '10/21/2023' + ' 2:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'24', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'20', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'58', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'73', Cost:11.02, ParentId: '17'},
		]
	},
