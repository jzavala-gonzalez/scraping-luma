const timestamp_saved = '12/06/2023 02:05 AM';
const dataFechaAcualizado = '12/5/2023' + ' 10:00:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 684},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'56', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'58', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'62', Cost:10.55, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 48, MVar:'0', Cost:10.69, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'120', Cost:18.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'89', Cost:10.87, ParentId: '17'},
		]
	},
