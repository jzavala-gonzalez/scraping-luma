const timestamp_saved = '09/29/2023 04:45 PM';
const dataFechaAcualizado = '9/29/2023' + ' 12:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'65', Cost:4.36, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'58', Cost:4.36, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'42', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'40', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'53', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 148, MVar:'44', Cost:17.50, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.50, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 99, MVar:'0', Cost:18.32, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 128, MVar:'91', Cost:17.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 125,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 125, MVar:'129', Cost:20.59, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'100', Cost:9.40, ParentId: '17'},
		]
	},
