const timestamp_saved = '10/18/2023 01:35 AM';
const dataFechaAcualizado = '10/17/2023' + ' 9:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'67', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'64', Cost:10.62, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:17.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.83, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'49', Cost:8.10, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'10', Cost:18.59, ParentId: '14'},
