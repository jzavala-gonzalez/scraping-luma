const timestamp_saved = '08/01/2023 11:35 PM';
const dataFechaAcualizado = '8/1/2023' + ' 7:30:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'48', Cost:10.20, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 118,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'10', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'79', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'146', Cost:17.15, ParentId: '16'},
		]
	},
