const timestamp_saved = '11/05/2023 03:20 PM';
const dataFechaAcualizado = '11/5/2023' + ' 11:16:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1932},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'42', Cost:12.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'42', Cost:12.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'42', Cost:12.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'35', Cost:17.64, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'54', Cost:9.93, ParentId: '17'},
		]
	},
