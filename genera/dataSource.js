const timestamp_saved = '09/16/2023 03:05 AM';
const dataFechaAcualizado = '9/15/2023' + ' 11:00:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'47', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'62', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'20', Cost:18.90, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 376,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 376, MVar:'99', Cost:9.11, ParentId: '17'},
		]
	},
