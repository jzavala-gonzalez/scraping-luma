const timestamp_saved = '08/24/2023 03:35 AM';
const dataFechaAcualizado = '8/23/2023' + ' 11:30:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'56', Cost:10.54, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'15', Cost:30.92, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'2', Cost:31.54, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'161', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'91', Cost:9.32, ParentId: '17'},
		]
	},
