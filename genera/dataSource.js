const timestamp_saved = '11/30/2023 01:20 AM';
const dataFechaAcualizado = '11/29/2023' + ' 9:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'58', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'58', Cost:10.47, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 39, MVar:'0', Cost:26.12, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:26.88, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'165', Cost:17.05, ParentId: '16'},
		]
	},
