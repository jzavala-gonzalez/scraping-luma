const timestamp_saved = '10/29/2023 02:00 PM';
const dataFechaAcualizado = '10/29/2023' + ' 9:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'47', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'48', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'71', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'17', Cost:21.68, ParentId: '14'},
