const timestamp_saved = '10/20/2023 06:25 PM';
const dataFechaAcualizado = '10/20/2023' + ' 2:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 151, MVar:'51', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 27, MVar:'7', Cost:62.20, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'114', Cost:10.55, ParentId: '17'},
		]
	},
