const timestamp_saved = '12/02/2023 09:50 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'40', Cost:13.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'43', Cost:13.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'43', Cost:13.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:18.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.17, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 128, MVar:'39', Cost:8.00, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'9', Cost:8.00, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'57', Cost:9.81, ParentId: '17'},
		]
	},
