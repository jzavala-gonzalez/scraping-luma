const timestamp_saved = '08/21/2023 11:10 PM';
const dataFechaAcualizado = '8/21/2023' + ' 7:05:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'57', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'57', Cost:10.26, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 107,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 34, MVar:'1', Cost:26.19, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:26.72, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'46', Cost:19.56, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:19.56, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'6', Cost:0, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 277,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 277, MVar:'151', Cost:17.41, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'73', Cost:9.19, ParentId: '17'},
		]
	},
