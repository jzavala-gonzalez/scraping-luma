const timestamp_saved = '08/13/2023 12:25 PM';
const dataFechaAcualizado = '8/13/2023' + ' 8:22:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'37', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'42', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'41', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'144', Cost:17.70, ParentId: '16'},
		]
	},
