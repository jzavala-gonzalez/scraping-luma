const timestamp_saved = '09/28/2023 08:05 AM';
const dataFechaAcualizado = '9/28/2023' + ' 4:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'18', Cost:13.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'17', Cost:13.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'43', Cost:13.39, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 219,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 219, MVar:'92', Cost:18.44, ParentId: '16'},
		]
	},
