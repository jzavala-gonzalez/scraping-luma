const timestamp_saved = '08/08/2023 09:35 PM';
const dataFechaAcualizado = '8/8/2023' + ' 5:30:41 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 477},
	{Index:'4', Desc:'Reserva Operacional', value: 659},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'68', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'48', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'57', Cost:11.30, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 116, MVar:'0', Cost:6.98, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'0', Cost:26.52, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'5', Cost:30.83, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.25, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'2', Cost:31.24, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:31.04, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'21', Cost:18.68, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'79', Cost:12.43, ParentId: '17'},
		]
	},
