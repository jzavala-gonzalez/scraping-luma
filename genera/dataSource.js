const timestamp_saved = '11/21/2023 02:10 AM';
const dataFechaAcualizado = '11/20/2023' + ' 10:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'34', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'45', Cost:11.74, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'166', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'102', Cost:9.17, ParentId: '17'},
		]
	},
