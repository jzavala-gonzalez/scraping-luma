const timestamp_saved = '09/25/2023 06:10 PM';
const dataFechaAcualizado = '9/25/2023' + ' 2:05:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2612},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'50', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'50', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'56', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'6', Cost:26.86, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 127, MVar:'39', Cost:8.71, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:8.71, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 128, MVar:'0', Cost:18.00, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:18.00, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:31.41, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'86', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 326,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 326, MVar:'185', Cost:16.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'103', Cost:9.40, ParentId: '17'},
		]
	},
