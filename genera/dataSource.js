const timestamp_saved = '10/19/2023 04:25 PM';
const dataFechaAcualizado = '10/19/2023' + ' 12:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'50', Cost:10.28, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'24', Cost:23.88, ParentId: '14'},
