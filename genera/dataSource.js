const timestamp_saved = '10/22/2023 11:35 PM';
const dataFechaAcualizado = '10/22/2023' + ' 7:31:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'52', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'48', Cost:10.51, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 11, MVar:'0', Cost:21.60, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'13', Cost:19.63, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'69', Cost:16.83, ParentId: '15'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 22,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:21.60, ParentId: '21'},
