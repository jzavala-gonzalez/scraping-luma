const timestamp_saved = '11/09/2023 11:30 AM';
const dataFechaAcualizado = '11/9/2023' + ' 7:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'46', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'44', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'47', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.72, ParentId: '13'},
