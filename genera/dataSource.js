const timestamp_saved = '11/01/2023 04:10 AM';
const dataFechaAcualizado = '11/1/2023' + ' 12:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'56', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'59', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'64', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 5, MVar:'0', Cost:34.44, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'1', Cost:36.74, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'56', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'128', Cost:18.53, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'78', Cost:9.13, ParentId: '17'},
		]
	},
