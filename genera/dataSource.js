const timestamp_saved = '11/19/2023 10:15 AM';
const dataFechaAcualizado = '11/19/2023' + ' 6:11:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:15.06, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'66', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'96', Cost:9.91, ParentId: '17'},
		]
	},
