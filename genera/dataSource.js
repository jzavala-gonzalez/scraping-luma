const timestamp_saved = '10/01/2023 07:20 PM';
const dataFechaAcualizado = '10/1/2023' + ' 3:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'34', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'31', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'49', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'11', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'79', Cost:17.07, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'132', Cost:17.46, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'95', Cost:9.22, ParentId: '17'},
		]
	},
