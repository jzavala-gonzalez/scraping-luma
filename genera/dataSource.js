const timestamp_saved = '08/04/2023 01:30 PM';
const dataFechaAcualizado = '8/4/2023' + ' 9:25:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'43', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'50', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:141.02, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 261,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'86', Cost:17.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'149', Cost:17.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'90', Cost:10.97, ParentId: '17'},
		]
	},
