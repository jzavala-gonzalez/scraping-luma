const timestamp_saved = '10/06/2023 05:05 AM';
const dataFechaAcualizado = '10/6/2023' + ' 1:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:31.05, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'53', Cost:16.93, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 321, MVar:'152', Cost:16.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'92', Cost:10.06, ParentId: '17'},
		]
	},
