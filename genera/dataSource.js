const timestamp_saved = '12/02/2023 12:40 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'55', Cost:12.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'56', Cost:12.68, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 12, MVar:'0', Cost:31.39, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:28.82, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'95', Cost:9.18, ParentId: '17'},
		]
	},
