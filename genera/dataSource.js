const timestamp_saved = '08/30/2023 09:30 PM';
const dataFechaAcualizado = '8/30/2023' + ' 5:25:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2979},
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2980},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 160, MVar:'92', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'60', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'68', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'72', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 169,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 128, MVar:'32', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 87,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:26.90, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.88, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'3', Cost:27.64, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'4', Cost:27.12, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'21', Cost:31.10, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:19.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:19.15, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'8', Cost:28.52, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'0', Cost:28.71, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'43', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'109', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'178', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'107', Cost:9.18, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 20,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 4, MVar:'16', Cost:17, ParentId: '19'},
		]
	},
