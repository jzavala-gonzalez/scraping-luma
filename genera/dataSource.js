const timestamp_saved = '10/31/2023 07:40 AM';
const dataFechaAcualizado = '10/31/2023' + ' 3:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'46', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'50', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'58', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'49', Cost:9.80, ParentId: '17'},
		]
	},
