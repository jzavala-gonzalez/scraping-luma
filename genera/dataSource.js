const timestamp_saved = '08/10/2023 06:25 PM';
const dataFechaAcualizado = '8/10/2023' + ' 2:20:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'54', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'55', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'2', Cost:30.87, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:20.11, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'171', Cost:18.04, ParentId: '16'},
		]
	},
