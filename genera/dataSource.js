const timestamp_saved = '09/21/2023 12:00 PM';
const dataFechaAcualizado = '9/21/2023' + ' 7:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'41', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'46', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'65', Cost:11.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 98,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:29.89, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'20', Cost:26.54, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 77, MVar:'67', Cost:29.89, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 40,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 12, MVar:'0', Cost:19.60, ParentId: '19'},
