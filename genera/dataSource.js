const timestamp_saved = '09/29/2023 07:35 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'32', Cost:12.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'28', Cost:12.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'48', Cost:12.95, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'3', Cost:19.40, ParentId: '14'},
