const timestamp_saved = '12/03/2023 04:50 PM';
const dataFechaAcualizado = '12/3/2023' + ' 12:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.85, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.85, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'36', Cost:8.76, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:8.76, ParentId: '11'},
		]
	},
