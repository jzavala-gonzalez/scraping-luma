const timestamp_saved = '09/17/2023 09:20 AM';
const dataFechaAcualizado = '9/17/2023' + ' 5:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'40', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'39', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'53', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:8.06, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:8.06, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'18', Cost:19.35, ParentId: '14'},
