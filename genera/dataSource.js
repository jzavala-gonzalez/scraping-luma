const timestamp_saved = '07/30/2023 10:10 PM';
const dataFechaAcualizado = '7/30/2023' + ' 6:05:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'55', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'55', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'45', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:19.32, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'135', Cost:16.81, ParentId: '16'},
		]
	},
