const timestamp_saved = '08/04/2023 03:45 PM';
const dataFechaAcualizado = '8/4/2023' + ' 11:40:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'45', Cost:11.33, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'1', Cost:30.16, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 253,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'87', Cost:18.83, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'41', Cost:15.63, ParentId: '15'},
		]
	},
