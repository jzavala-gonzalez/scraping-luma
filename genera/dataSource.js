const timestamp_saved = '09/26/2023 05:25 PM';
const dataFechaAcualizado = '9/26/2023' + ' 1:20:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'48', Cost:12.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'49', Cost:12.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'58', Cost:12.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:17.44, ParentId: '11'},
