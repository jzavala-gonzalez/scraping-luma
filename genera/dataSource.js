const timestamp_saved = '11/24/2023 07:00 PM';
const dataFechaAcualizado = '11/24/2023' + ' 2:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'34', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'44', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'54', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'90', Cost:10.00, ParentId: '17'},
		]
	},
