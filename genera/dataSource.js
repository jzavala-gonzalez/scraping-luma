const timestamp_saved = '10/04/2023 11:00 AM';
const dataFechaAcualizado = '10/4/2023' + ' 6:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'36', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'33', Cost:10.88, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.09, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 284, MVar:'152', Cost:17.49, ParentId: '16'},
		]
	},
