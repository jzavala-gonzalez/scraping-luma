const timestamp_saved = '09/14/2023 07:10 AM';
const dataFechaAcualizado = '9/14/2023' + ' 3:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'49', Cost:11.06, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 267,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 267, MVar:'138', Cost:17.37, ParentId: '16'},
		]
	},
