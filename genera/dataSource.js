const timestamp_saved = '11/27/2023 08:35 AM';
const dataFechaAcualizado = '11/27/2023' + ' 4:31:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1843},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'17', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'27', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'99', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'59', Cost:9.85, ParentId: '17'},
		]
	},
