const timestamp_saved = '09/28/2023 01:30 AM';
const dataFechaAcualizado = '9/27/2023' + ' 9:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'35', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'35', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'65', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.91, ParentId: '11'},
