const timestamp_saved = '11/20/2023 01:40 PM';
const dataFechaAcualizado = '11/20/2023' + ' 9:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'44', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'52', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'63', Cost:10.31, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 163, MVar:'37', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.45, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'186', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'116', Cost:9.17, ParentId: '17'},
		]
	},
