const timestamp_saved = '09/29/2023 05:30 AM';
const dataFechaAcualizado = '9/29/2023' + ' 1:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'37', Cost:11.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'34', Cost:11.55, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 11,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 11, MVar:'1', Cost:27.29, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'5', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'58', Cost:16.81, ParentId: '15'},
