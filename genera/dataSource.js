const timestamp_saved = '12/01/2023 01:15 AM';
const dataFechaAcualizado = '11/30/2023' + ' 9:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'59', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'61', Cost:10.45, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'157', Cost:18.26, ParentId: '16'},
		]
	},
