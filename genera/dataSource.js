const timestamp_saved = '10/28/2023 08:15 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'35', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'39', Cost:11.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'44', Cost:11.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 125,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'20', Cost:28.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.52, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 55, MVar:'15', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'14', Cost:19.09, ParentId: '14'},
