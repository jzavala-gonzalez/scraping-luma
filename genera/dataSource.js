const timestamp_saved = '09/20/2023 11:30 PM';
const dataFechaAcualizado = '9/20/2023' + ' 7:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'51', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'53', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'62', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'8', Cost:35.68, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'23', Cost:26.69, ParentId: '14'},
