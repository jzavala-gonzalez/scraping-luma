const timestamp_saved = '08/10/2023 03:35 PM';
const dataFechaAcualizado = '8/10/2023' + ' 11:30:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'62', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'61', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'4', Cost:30.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'6', Cost:30.97, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'177', Cost:17.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'90', Cost:11.60, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 63,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 19, MVar:'0', Cost:26.22, ParentId: '21'},
