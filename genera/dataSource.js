const timestamp_saved = '11/21/2023 02:20 PM';
const dataFechaAcualizado = '11/21/2023' + ' 10:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'32', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'42', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'55', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'92', Cost:9.61, ParentId: '17'},
		]
	},
