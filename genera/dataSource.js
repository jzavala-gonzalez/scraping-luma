const timestamp_saved = '09/27/2023 04:01 PM';
const dataFechaAcualizado = '9/27/2023' + ' 11:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'34', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'34', Cost:11.39, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.92, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'12', Cost:19.00, ParentId: '14'},
