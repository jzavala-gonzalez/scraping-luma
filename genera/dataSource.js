const timestamp_saved = '09/16/2023 10:20 AM';
const dataFechaAcualizado = '9/16/2023' + ' 6:15:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'37', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'54', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 192,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'103', Cost:19.03, ParentId: '16'},
		]
	},
