const timestamp_saved = '10/07/2023 02:45 PM';
const dataFechaAcualizado = '10/7/2023' + ' 10:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 137, MVar:'49', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'43', Cost:13.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'44', Cost:13.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'44', Cost:13.42, ParentId: '7'},
		]
	},
