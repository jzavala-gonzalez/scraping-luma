const timestamp_saved = '09/29/2023 02:05 AM';
const dataFechaAcualizado = '9/28/2023' + ' 10:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'49', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'48', Cost:10.89, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'43', Cost:8.41, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'9', Cost:8.41, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'6', Cost:19.30, ParentId: '14'},
