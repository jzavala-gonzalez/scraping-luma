const timestamp_saved = '11/25/2023 12:30 PM';
const dataFechaAcualizado = '11/25/2023' + ' 8:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 147,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 147, MVar:'61', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'21', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'30', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'47', Cost:11.36, ParentId: '7'},
		]
	},
