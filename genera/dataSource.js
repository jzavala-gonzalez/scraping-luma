const timestamp_saved = '08/28/2023 12:50 AM';
const dataFechaAcualizado = '8/27/2023' + ' 8:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'50', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'49', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'52', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'9', Cost:22.03, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.64, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.52, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'6', Cost:22.41, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:30.76, ParentId: '13'},
