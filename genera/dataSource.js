const timestamp_saved = '10/20/2023 08:40 PM';
const dataFechaAcualizado = '10/20/2023' + ' 4:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'41', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'48', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'47', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 20,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'11', Cost:43.37, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.11, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'81', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 315, MVar:'155', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'102', Cost:10.55, ParentId: '17'},
		]
	},
