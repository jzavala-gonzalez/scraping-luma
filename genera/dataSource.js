const timestamp_saved = '11/13/2023 11:30 PM';
const dataFechaAcualizado = '11/13/2023' + ' 7:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'66', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'71', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 203, MVar:'68', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'1', Cost:25.92, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'11', Cost:17.28, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'11', Cost:30.88, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'134', Cost:10.90, ParentId: '17'},
		]
	},
