const timestamp_saved = '11/13/2023 10:30 AM';
const dataFechaAcualizado = '11/13/2023' + ' 6:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'48', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'51', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'52', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'38', Cost:17.42, ParentId: '11'},
