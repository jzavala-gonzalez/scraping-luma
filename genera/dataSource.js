const timestamp_saved = '12/02/2023 09:45 PM';
const dataFechaAcualizado = '12/2/2023' + ' 5:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'54', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'56', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:19.14, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'97', Cost:10.86, ParentId: '17'},
		]
	},
