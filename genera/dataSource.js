const timestamp_saved = '09/30/2023 09:50 AM';
const dataFechaAcualizado = '9/30/2023' + ' 5:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'36', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'34', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'135', Cost:17.51, ParentId: '16'},
		]
	},
