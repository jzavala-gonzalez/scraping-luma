const timestamp_saved = '11/07/2023 03:55 PM';
const dataFechaAcualizado = '11/7/2023' + ' 11:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'53', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'48', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:17.07, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'96', Cost:16.53, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 272,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 272, MVar:'102', Cost:9.81, ParentId: '17'},
		]
	},
