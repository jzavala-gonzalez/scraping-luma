const timestamp_saved = '11/01/2023 06:15 PM';
const dataFechaAcualizado = '11/1/2023' + ' 2:11:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2393},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'65', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'67', Cost:10.42, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'83', Cost:16.93, ParentId: '15'},
