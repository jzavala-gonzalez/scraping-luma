const timestamp_saved = '08/12/2023 10:00 PM';
const dataFechaAcualizado = '8/12/2023' + ' 5:57:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'82', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'92', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 507,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'45', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'49', Cost:10.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'46', Cost:10.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'0', Cost:23.23, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'3', Cost:30.93, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:14.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:14.44, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 295,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 295, MVar:'162', Cost:17.10, ParentId: '16'},
		]
	},
