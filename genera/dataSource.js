const timestamp_saved = '11/23/2023 09:35 PM';
const dataFechaAcualizado = '11/23/2023' + ' 5:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'26', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'37', Cost:10.65, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'8', Cost:0, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'62', Cost:9.74, ParentId: '17'},
		]
	},
