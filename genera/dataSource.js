const timestamp_saved = '10/12/2023 07:50 AM';
const dataFechaAcualizado = '10/12/2023' + ' 3:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'50', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'54', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'62', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:17.67, ParentId: '11'},
