const timestamp_saved = '11/10/2023 04:10 AM';
const dataFechaAcualizado = '11/10/2023' + ' 12:06:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 634},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'38', Cost:12.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'34', Cost:12.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'42', Cost:12.74, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'84', Cost:9.72, ParentId: '17'},
		]
	},
