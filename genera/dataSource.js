const timestamp_saved = '08/10/2023 01:05 PM';
const dataFechaAcualizado = '8/10/2023' + ' 9:00:43 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 615},
	{Index:'5', Desc:'Capacidad Disponible', value: 3061},
	{Index:'6', Desc:'Próxima Hora MW', value: 2460},
	{Index:'7', Desc:'Máxima para Hoy', value: 2549},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'109', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'63', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'62', Cost:10.63, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 86,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 86, MVar:'0', Cost:9.23, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'9', Cost:30.96, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'12', Cost:27.20, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 58,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.46, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:30.35, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'8', Cost:31.48, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'191', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'98', Cost:11.55, ParentId: '17'},
		]
	},
