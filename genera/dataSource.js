const timestamp_saved = '11/27/2023 07:50 PM';
const dataFechaAcualizado = '11/27/2023' + ' 3:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'41', Cost:10.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'53', Cost:10.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'62', Cost:10.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 380,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.85, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'172', Cost:18.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'114', Cost:9.31, ParentId: '17'},
		]
	},
