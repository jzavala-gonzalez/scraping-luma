const timestamp_saved = '09/30/2023 06:15 AM';
const dataFechaAcualizado = '9/30/2023' + ' 2:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'37', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'35', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'49', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:17.71, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 59, MVar:'0', Cost:18.85, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 12, MVar:'0', Cost:18.85, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'6', Cost:28.55, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'133', Cost:17.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'103', Cost:9.53, ParentId: '17'},
		]
	},
