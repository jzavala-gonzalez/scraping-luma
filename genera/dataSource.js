const timestamp_saved = '11/14/2023 06:06 PM';
const dataFechaAcualizado = '11/14/2023' + ' 2:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'52', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'55', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'58', Cost:11.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.87, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'13', Cost:30.85, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.71, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 180,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'161', Cost:19.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'107', Cost:10.93, ParentId: '17'},
		]
	},
