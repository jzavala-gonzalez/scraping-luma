const timestamp_saved = '08/18/2023 07:25 AM';
const dataFechaAcualizado = '8/18/2023' + ' 3:22:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'38', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'52', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'64', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:19.75, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'58', Cost:9.42, ParentId: '17'},
		]
	},
