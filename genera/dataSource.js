const timestamp_saved = '11/09/2023 05:05 PM';
const dataFechaAcualizado = '11/9/2023' + ' 1:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 160, MVar:'54', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 47, MVar:'19', Cost:22.08, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'24', Cost:18.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'87', Cost:16.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 224,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 224, MVar:'152', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'99', Cost:9.98, ParentId: '17'},
		]
	},
