const timestamp_saved = '10/27/2023 07:05 PM';
const dataFechaAcualizado = '10/27/2023' + ' 3:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'51', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'52', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'54', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.38, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'26', Cost:18.48, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'6', Cost:18.48, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.61, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'22', Cost:19.31, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'113', Cost:17.13, ParentId: '16'},
		]
	},
