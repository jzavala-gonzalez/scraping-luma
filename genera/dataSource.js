const timestamp_saved = '09/17/2023 11:55 AM';
const dataFechaAcualizado = '9/17/2023' + ' 7:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'41', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'39', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'57', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'0', Cost:10.01, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:10.01, ParentId: '11'},
		]
	},
