const timestamp_saved = '12/01/2023 12:50 PM';
const dataFechaAcualizado = '12/1/2023' + ' 8:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'49', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'74', Cost:9.55, ParentId: '17'},
		]
	},
