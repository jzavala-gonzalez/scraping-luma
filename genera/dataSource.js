const timestamp_saved = '10/19/2023 09:50 PM';
const dataFechaAcualizado = '10/19/2023' + ' 5:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'38', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'45', Cost:11.20, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'2', Cost:27.02, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'17', Cost:31.13, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 52, MVar:'15', Cost:22.99, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'80', Cost:16.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'189', Cost:16.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'103', Cost:10.54, ParentId: '17'},
		]
	},
