const timestamp_saved = '08/17/2023 02:00 PM';
const dataFechaAcualizado = '8/17/2023' + ' 9:57:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'64', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'72', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'8', Cost:31.87, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:31.58, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'35', Cost:19.45, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'150', Cost:18.21, ParentId: '16'},
		]
	},
