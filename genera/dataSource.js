const timestamp_saved = '08/17/2023 04:25 PM';
const dataFechaAcualizado = '8/17/2023' + ' 12:22:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'68', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'77', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'35', Cost:19.23, ParentId: '14'},
