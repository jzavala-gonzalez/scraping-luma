const timestamp_saved = '08/20/2023 08:20 AM';
const dataFechaAcualizado = '8/20/2023' + ' 4:17:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'54', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'52', Cost:11.10, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'3', Cost:30.45, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'103', Cost:16.50, ParentId: '15'},
