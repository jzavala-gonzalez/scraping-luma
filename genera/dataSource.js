const timestamp_saved = '09/29/2023 04:10 AM';
const dataFechaAcualizado = '9/29/2023' + ' 12:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'43', Cost:12.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'36', Cost:12.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'51', Cost:12.79, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:8.37, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:8.37, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:20.74, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'6', Cost:19.43, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'59', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'123', Cost:17.01, ParentId: '16'},
		]
	},
