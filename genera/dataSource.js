const timestamp_saved = '09/01/2023 11:20 PM';
const dataFechaAcualizado = '9/1/2023' + ' 7:15:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 523,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'54', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'62', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 197, MVar:'68', Cost:10.13, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 171,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.24, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 187,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 46, MVar:'3', Cost:22.92, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.69, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'8', Cost:25.80, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 150,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'11', Cost:27.92, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'12', Cost:28.86, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 36,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'6', Cost:25.85, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'14', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'72', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'155', Cost:16.24, ParentId: '16'},
		]
	},
