const timestamp_saved = '12/06/2023 07:40 AM';
const dataFechaAcualizado = '12/6/2023' + ' 3:35:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 1154},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'39', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'43', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'52', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'50', Cost:14.52, ParentId: '17'},
		]
	},
