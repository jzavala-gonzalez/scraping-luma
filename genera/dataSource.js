const timestamp_saved = '08/27/2023 04:35 AM';
const dataFechaAcualizado = '8/27/2023' + ' 12:30:49 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2171},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'63', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'29', Cost:33.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:33.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:33.59, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'5', Cost:27.17, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 96,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'1', Cost:30.88, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'69', Cost:17.13, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 315,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 315, MVar:'91', Cost:16.31, ParentId: '17'},
		]
	},
