const timestamp_saved = '11/30/2023 10:50 PM';
const dataFechaAcualizado = '11/30/2023' + ' 6:46:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'60', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'62', Cost:11.30, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 55,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 55, MVar:'22', Cost:31.78, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'166', Cost:17.17, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'106', Cost:9.12, ParentId: '17'},
		]
	},
