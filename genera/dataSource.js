const timestamp_saved = '10/21/2023 12:40 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 318,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'37', Cost:12.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'35', Cost:12.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'37', Cost:12.75, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'136', Cost:17.79, ParentId: '16'},
		]
	},
