const timestamp_saved = '08/07/2023 05:55 AM';
const dataFechaAcualizado = '8/7/2023' + ' 1:50:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'48', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'45', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'43', Cost:10.63, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 102, MVar:'0', Cost:3.19, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'1', Cost:26.45, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'10', Cost:31.03, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'6', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 220,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'52', Cost:18.45, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'28', Cost:16.35, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'95', Cost:11.64, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 21, MVar:'0', Cost:0, ParentId: '21'},
