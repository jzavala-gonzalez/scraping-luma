const timestamp_saved = '11/24/2023 12:20 PM';
const dataFechaAcualizado = '11/24/2023' + ' 8:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'23', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'32', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'49', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 215,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:17.23, ParentId: '11'},
