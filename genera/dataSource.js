const timestamp_saved = '10/10/2023 12:05 PM';
const dataFechaAcualizado = '10/10/2023' + ' 8:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'77', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'55', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'60', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'63', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.59, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:17.59, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'90', Cost:16.68, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'74', Cost:9.11, ParentId: '17'},
		]
	},
