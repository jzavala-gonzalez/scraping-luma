const timestamp_saved = '11/01/2023 04:20 PM';
const dataFechaAcualizado = '11/1/2023' + ' 12:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'58', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'63', Cost:10.99, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:17.25, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 54, MVar:'15', Cost:20.94, ParentId: '14'},
