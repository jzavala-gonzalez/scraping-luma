const timestamp_saved = '08/05/2023 04:20 AM';
const dataFechaAcualizado = '8/5/2023' + ' 12:15:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'47', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 66, MVar:'0', Cost:10.99, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 16, MVar:'5', Cost:10.99, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'2', Cost:31.53, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'89', Cost:16.98, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'51', Cost:15.62, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'134', Cost:17.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'91', Cost:11.39, ParentId: '17'},
		]
	},
