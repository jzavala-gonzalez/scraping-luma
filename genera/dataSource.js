const timestamp_saved = '08/23/2023 07:25 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:20:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'43', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'43', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'36', Cost:20.32, ParentId: '11'},
