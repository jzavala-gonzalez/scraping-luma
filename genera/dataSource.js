const timestamp_saved = '11/15/2023 07:45 PM';
const dataFechaAcualizado = '11/15/2023' + ' 3:41:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'61', Cost:10.74, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'32', Cost:19.30, ParentId: '14'},
