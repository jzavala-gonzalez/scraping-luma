const timestamp_saved = '10/06/2023 02:20 AM';
const dataFechaAcualizado = '10/5/2023' + ' 10:16:14 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2744},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'40', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'39', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'53', Cost:11.23, ParentId: '7'},
		]
	},
