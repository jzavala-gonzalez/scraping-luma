const timestamp_saved = '10/05/2023 05:55 AM';
const dataFechaAcualizado = '10/5/2023' + ' 1:51:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'34', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'32', Cost:10.28, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'131', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'87', Cost:9.40, ParentId: '17'},
		]
	},
