const timestamp_saved = '09/20/2023 07:55 PM';
const dataFechaAcualizado = '9/20/2023' + ' 3:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'52', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'56', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'63', Cost:10.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 137,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:35.46, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'7', Cost:36.79, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'14', Cost:30.81, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'17', Cost:30.92, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:19.90, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 34,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 34, MVar:'35', Cost:26.90, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'95', Cost:16.93, ParentId: '15'},
