const timestamp_saved = '11/15/2023 09:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 5:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'37', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'40', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'45', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.30, ParentId: '11'},
