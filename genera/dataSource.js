const timestamp_saved = '10/19/2023 03:40 AM';
const dataFechaAcualizado = '10/18/2023' + ' 11:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'41', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'47', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'59', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'9', Cost:19.07, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'96', Cost:10.52, ParentId: '17'},
		]
	},
