const timestamp_saved = '10/21/2023 12:51 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'38', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'34', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'38', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'68', Cost:11.02, ParentId: '17'},
		]
	},
