const timestamp_saved = '10/01/2023 05:20 PM';
const dataFechaAcualizado = '10/1/2023' + ' 1:15:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 501,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'33', Cost:10.12, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'19', Cost:18.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'89', Cost:16.51, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'135', Cost:17.47, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'100', Cost:9.46, ParentId: '17'},
		]
	},
