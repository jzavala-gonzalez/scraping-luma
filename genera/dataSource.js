const timestamp_saved = '11/27/2023 02:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 10:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'33', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'43', Cost:11.05, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'154', Cost:16.98, ParentId: '16'},
		]
	},
