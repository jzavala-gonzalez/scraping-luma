const timestamp_saved = '11/25/2023 01:10 AM';
const dataFechaAcualizado = '11/24/2023' + ' 9:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 83, MVar:'73', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'33', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'42', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'57', Cost:11.97, ParentId: '7'},
		]
	},
