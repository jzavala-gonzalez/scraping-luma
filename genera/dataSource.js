const timestamp_saved = '11/23/2023 06:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'22', Cost:13.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'32', Cost:13.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'48', Cost:13.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'51', Cost:9.93, ParentId: '17'},
		]
	},
