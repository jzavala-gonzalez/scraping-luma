const timestamp_saved = '11/15/2023 03:55 PM';
const dataFechaAcualizado = '11/15/2023' + ' 11:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'50', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'53', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'51', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'97', Cost:9.81, ParentId: '17'},
		]
	},
