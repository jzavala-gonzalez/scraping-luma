const timestamp_saved = '10/15/2023 05:55 PM';
const dataFechaAcualizado = '10/15/2023' + ' 1:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'51', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'50', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'52', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'0', Cost:26.93, ParentId: '9'},
		]
	},
