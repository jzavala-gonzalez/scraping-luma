const timestamp_saved = '09/18/2023 11:15 AM';
const dataFechaAcualizado = '9/18/2023' + ' 7:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'48', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'46', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'59', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.05, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'74', Cost:9.78, ParentId: '17'},
		]
	},
