const timestamp_saved = '11/04/2023 10:35 AM';
const dataFechaAcualizado = '11/4/2023' + ' 6:31:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'40', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'39', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 279,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'37', Cost:16.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:16.89, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'112', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'48', Cost:9.72, ParentId: '17'},
		]
	},
