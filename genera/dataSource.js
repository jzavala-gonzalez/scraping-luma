const timestamp_saved = '07/30/2023 02:55 AM';
const dataFechaAcualizado = '7/29/2023' + ' 10:50:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'51', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'43', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 199,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'8', Cost:22.35, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'9', Cost:20.78, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'12', Cost:31.11, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'107', Cost:10.96, ParentId: '17'},
		]
	},
