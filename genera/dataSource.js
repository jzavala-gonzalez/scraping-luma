const timestamp_saved = '12/01/2023 09:35 AM';
const dataFechaAcualizado = '12/1/2023' + ' 5:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'43', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'44', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'48', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'57', Cost:9.88, ParentId: '17'},
		]
	},
