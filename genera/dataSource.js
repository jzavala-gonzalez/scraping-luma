const timestamp_saved = '12/04/2023 09:00 AM';
const dataFechaAcualizado = '12/4/2023' + ' 4:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'39', Cost:12.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'40', Cost:12.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'44', Cost:12.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'45', Cost:11.60, ParentId: '17'},
		]
	},
