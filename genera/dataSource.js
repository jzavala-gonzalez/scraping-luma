const timestamp_saved = '10/05/2023 04:15 PM';
const dataFechaAcualizado = '10/5/2023' + ' 12:11:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'46', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'43', Cost:10.41, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'82', Cost:16.60, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'114', Cost:9.33, ParentId: '17'},
		]
	},
