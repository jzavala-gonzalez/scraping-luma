const timestamp_saved = '11/08/2023 05:15 PM';
const dataFechaAcualizado = '11/8/2023' + ' 1:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'58', Cost:10.07, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:17.11, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 72, MVar:'10', Cost:18.56, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'116', Cost:9.41, ParentId: '17'},
		]
	},
