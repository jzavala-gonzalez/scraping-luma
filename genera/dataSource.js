const timestamp_saved = '10/04/2023 09:25 PM';
const dataFechaAcualizado = '10/4/2023' + ' 5:21:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'46', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'44', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'57', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'39', Cost:17.96, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'83', Cost:17.07, ParentId: '15'},
