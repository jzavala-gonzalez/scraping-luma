const timestamp_saved = '08/04/2023 10:50 AM';
const dataFechaAcualizado = '8/4/2023' + ' 6:45:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 203, MVar:'70', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'38', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'38', Cost:15.60, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'129', Cost:18.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'77', Cost:10.96, ParentId: '17'},
		]
	},
