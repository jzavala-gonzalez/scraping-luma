const timestamp_saved = '09/04/2023 12:50 PM';
const dataFechaAcualizado = '9/4/2023' + ' 8:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'43', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'46', Cost:10.18, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'29', Cost:19.34, ParentId: '14'},
