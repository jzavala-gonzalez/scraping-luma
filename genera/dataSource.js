const timestamp_saved = '08/18/2023 11:50 AM';
const dataFechaAcualizado = '8/18/2023' + ' 7:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'58', Cost:10.29, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'72', Cost:9.27, ParentId: '17'},
		]
	},
