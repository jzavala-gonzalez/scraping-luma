const timestamp_saved = '10/29/2023 09:50 PM';
const dataFechaAcualizado = '10/29/2023' + ' 5:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'43', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'44', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'68', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 334, MVar:'134', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 164,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 164, MVar:'51', Cost:10.31, ParentId: '17'},
		]
	},
