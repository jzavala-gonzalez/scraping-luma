const timestamp_saved = '11/15/2023 11:05 AM';
const dataFechaAcualizado = '11/15/2023' + ' 7:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'39', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'42', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'43', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'6', Cost:31.25, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.57, ParentId: '11'},
