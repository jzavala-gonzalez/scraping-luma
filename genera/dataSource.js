const timestamp_saved = '12/02/2023 11:00 AM';
const dataFechaAcualizado = '12/2/2023' + ' 6:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'41', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'41', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'43', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.91, ParentId: '11'},
