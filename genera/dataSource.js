const timestamp_saved = '08/25/2023 04:55 AM';
const dataFechaAcualizado = '8/25/2023' + ' 12:50:47 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'59', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'57', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 117,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:16.26, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'22', Cost:19.22, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'65', Cost:16.95, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 323, MVar:'198', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 210,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 210, MVar:'89', Cost:10.82, ParentId: '17'},
		]
	},
