const timestamp_saved = '08/16/2023 04:25 AM';
const dataFechaAcualizado = '8/16/2023' + ' 12:22:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'68', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'72', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'68', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 10,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:40.96, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'20', Cost:30.09, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'23', Cost:30.55, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'112', Cost:10.24, ParentId: '17'},
		]
	},
