const timestamp_saved = '12/02/2023 09:55 AM';
const dataFechaAcualizado = '12/2/2023' + ' 5:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'42', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'44', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'43', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'38', Cost:8.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:8.30, ParentId: '11'},
		]
	},
