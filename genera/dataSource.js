const timestamp_saved = '09/01/2023 03:05 PM';
const dataFechaAcualizado = '9/1/2023' + ' 11:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'47', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'55', Cost:10.23, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'76', Cost:16.80, ParentId: '15'},
