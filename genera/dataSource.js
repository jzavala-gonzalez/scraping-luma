const timestamp_saved = '11/08/2023 07:40 AM';
const dataFechaAcualizado = '11/8/2023' + ' 3:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'38', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'36', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'42', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'60', Cost:16.69, ParentId: '15'},
