const timestamp_saved = '08/17/2023 01:55 AM';
const dataFechaAcualizado = '8/16/2023' + ' 9:52:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 527,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:9.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'75', Cost:9.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 184, MVar:'81', Cost:9.96, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'19', Cost:28.20, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:19.80, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:28.93, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'243', Cost:16.82, ParentId: '16'},
		]
	},
