const timestamp_saved = '11/06/2023 07:45 PM';
const dataFechaAcualizado = '11/6/2023' + ' 3:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'56', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'57', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'52', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:17.40, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'10', Cost:28.50, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 64, MVar:'9', Cost:20.08, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'116', Cost:9.19, ParentId: '17'},
		]
	},
