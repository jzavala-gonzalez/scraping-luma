const timestamp_saved = '12/04/2023 06:00 AM';
const dataFechaAcualizado = '12/4/2023' + ' 1:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'38', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'39', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'45', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'99', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'51', Cost:11.61, ParentId: '17'},
		]
	},
