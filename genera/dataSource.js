const timestamp_saved = '10/24/2023 01:15 PM';
const dataFechaAcualizado = '10/24/2023' + ' 9:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'50', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'51', Cost:10.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'53', Cost:10.68, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'79', Cost:11.27, ParentId: '17'},
		]
	},
