const timestamp_saved = '09/27/2023 03:00 AM';
const dataFechaAcualizado = '9/26/2023' + ' 10:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'49', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'58', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:24.14, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:18.32, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'0', Cost:18.32, ParentId: '11'},
		]
	},
