const timestamp_saved = '12/03/2023 05:20 AM';
const dataFechaAcualizado = '12/3/2023' + ' 1:16:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'41', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'43', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'46', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'58', Cost:11.64, ParentId: '17'},
		]
	},
