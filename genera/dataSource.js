const timestamp_saved = '10/11/2023 05:40 PM';
const dataFechaAcualizado = '10/11/2023' + ' 1:36:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'62', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'67', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'68', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'35', Cost:17.58, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:17.58, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'99', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'96', Cost:9.13, ParentId: '17'},
		]
	},
