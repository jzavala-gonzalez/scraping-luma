const timestamp_saved = '09/16/2023 07:50 AM';
const dataFechaAcualizado = '9/16/2023' + ' 3:45:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:11.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'0', Cost:8.79, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:8.79, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'14', Cost:18.88, ParentId: '14'},
