const timestamp_saved = '08/22/2023 12:20 AM';
const dataFechaAcualizado = '8/21/2023' + ' 8:15:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'58', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'53', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'57', Cost:10.92, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 89, MVar:'0', Cost:9.61, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'156', Cost:17.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'76', Cost:9.20, ParentId: '17'},
		]
	},
