const timestamp_saved = '11/26/2023 06:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 2:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'24', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'32', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.78, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'68', Cost:9.84, ParentId: '17'},
		]
	},
