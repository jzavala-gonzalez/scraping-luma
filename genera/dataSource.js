const timestamp_saved = '11/29/2023 06:40 AM';
const dataFechaAcualizado = '11/29/2023' + ' 2:36:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1940},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'22', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'32', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'47', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'69', Cost:9.80, ParentId: '17'},
		]
	},
