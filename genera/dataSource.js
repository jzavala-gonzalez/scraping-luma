const timestamp_saved = '08/20/2023 03:35 AM';
const dataFechaAcualizado = '8/19/2023' + ' 11:32:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'56', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'58', Cost:10.98, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 140, MVar:'28', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'0', Cost:27.03, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'9', Cost:30.77, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'101', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 371,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 371, MVar:'156', Cost:16.51, ParentId: '16'},
		]
	},
