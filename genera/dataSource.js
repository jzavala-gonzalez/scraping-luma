const timestamp_saved = '08/21/2023 10:45 PM';
const dataFechaAcualizado = '8/21/2023' + ' 6:40:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'53', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'53', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'54', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 12, MVar:'0', Cost:474.29, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'68', Cost:18.42, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'74', Cost:9.20, ParentId: '17'},
		]
	},
