const timestamp_saved = '11/23/2023 06:55 PM';
const dataFechaAcualizado = '11/23/2023' + ' 2:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'22', Cost:13.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'33', Cost:13.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'49', Cost:13.12, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.50, ParentId: '11'},
