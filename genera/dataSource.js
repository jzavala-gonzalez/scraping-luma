const timestamp_saved = '12/02/2023 02:00 PM';
const dataFechaAcualizado = '12/2/2023' + ' 9:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'43', Cost:13.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'44', Cost:13.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'45', Cost:13.27, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'29', Cost:19.04, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'121', Cost:18.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 234,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 234, MVar:'63', Cost:10.03, ParentId: '17'},
		]
	},
