const timestamp_saved = '10/29/2023 07:35 PM';
const dataFechaAcualizado = '10/29/2023' + ' 3:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'45', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'45', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'70', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 103, MVar:'28', Cost:18.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'7', Cost:18.05, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'17', Cost:19.63, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 0, MVar:'13', Cost:18.59, ParentId: '17'},
		]
	},
