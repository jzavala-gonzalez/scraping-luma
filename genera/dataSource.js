const timestamp_saved = '11/04/2023 07:35 PM';
const dataFechaAcualizado = '11/4/2023' + ' 3:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'54', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'53', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'48', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'143', Cost:18.22, ParentId: '16'},
		]
	},
