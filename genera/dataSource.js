const timestamp_saved = '08/09/2023 02:00 PM';
const dataFechaAcualizado = '8/9/2023' + ' 9:55:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'49', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'53', Cost:11.37, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'125', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'76', Cost:11.54, ParentId: '17'},
		]
	},
