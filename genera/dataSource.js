const timestamp_saved = '07/29/2023 05:10 PM';
const dataFechaAcualizado = '7/29/2023' + ' 1:05:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'50', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'49', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:19.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:19.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:18.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:18.11, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.91, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'88', Cost:17.06, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 141, MVar:'24', Cost:15.85, ParentId: '15'},
		]
	},
