const timestamp_saved = '10/04/2023 02:45 PM';
const dataFechaAcualizado = '10/4/2023' + ' 10:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'40', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'38', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'52', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 16, MVar:'0', Cost:26.47, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'20', Cost:28.19, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'158', Cost:18.31, ParentId: '16'},
		]
	},
