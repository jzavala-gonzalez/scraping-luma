const timestamp_saved = '11/20/2023 05:00 PM';
const dataFechaAcualizado = '11/20/2023' + ' 12:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'32', Cost:13.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'42', Cost:13.06, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'174', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'100', Cost:9.18, ParentId: '17'},
		]
	},
