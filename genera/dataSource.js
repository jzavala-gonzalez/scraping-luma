const timestamp_saved = '11/14/2023 07:05 PM';
const dataFechaAcualizado = '11/14/2023' + ' 3:01:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'55', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'58', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'59', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 67, MVar:'17', Cost:32.24, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'33', Cost:0, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 180,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'185', Cost:19.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'110', Cost:11.03, ParentId: '17'},
		]
	},
