const timestamp_saved = '09/12/2023 10:26 AM';
const dataFechaAcualizado = '9/12/2023' + ' 6:20:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'49', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'47', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'61', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'35', Cost:10.47, ParentId: '17'},
		]
	},
