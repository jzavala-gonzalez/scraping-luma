const timestamp_saved = '09/27/2023 12:50 AM';
const dataFechaAcualizado = '9/26/2023' + ' 8:45:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'61', Cost:10.35, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'11', Cost:25.85, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'45', Cost:17.67, ParentId: '11'},
