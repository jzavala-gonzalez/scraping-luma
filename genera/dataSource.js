const timestamp_saved = '10/26/2023 01:05 PM';
const dataFechaAcualizado = '10/26/2023' + ' 9:01:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'43', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'50', Cost:10.97, ParentId: '7'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 38,
		units:[
			{Index:'0', Unit:'CT Block 1', MW: 19, MVar:'0', Cost:47, ParentId: '21'},
