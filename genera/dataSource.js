const timestamp_saved = '08/06/2023 10:15 AM';
const dataFechaAcualizado = '8/6/2023' + ' 6:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'45', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'39', Cost:10.85, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'17', Cost:16.04, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'87', Cost:11.55, ParentId: '17'},
		]
	},
