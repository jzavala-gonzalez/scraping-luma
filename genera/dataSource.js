const timestamp_saved = '11/13/2023 10:35 PM';
const dataFechaAcualizado = '11/13/2023' + ' 6:31:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 256,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'109', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 550,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'68', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 202, MVar:'66', Cost:9.79, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'12', Cost:26.05, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 97,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'11', Cost:28.61, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'30', Cost:18.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'91', Cost:16.58, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'132', Cost:10.90, ParentId: '17'},
		]
	},
