const timestamp_saved = '10/11/2023 02:15 PM';
const dataFechaAcualizado = '10/11/2023' + ' 10:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'57', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'63', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'66', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'79', Cost:9.43, ParentId: '17'},
		]
	},
