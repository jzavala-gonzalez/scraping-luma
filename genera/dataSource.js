const timestamp_saved = '09/29/2023 11:10 AM';
const dataFechaAcualizado = '9/29/2023' + ' 7:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'54', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'31', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'30', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'48', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 131, MVar:'40', Cost:8.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:8.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 112, MVar:'0', Cost:17.19, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'0', Cost:17.19, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'10', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'72', Cost:16.67, ParentId: '15'},
