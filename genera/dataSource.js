const timestamp_saved = '08/16/2023 02:55 AM';
const dataFechaAcualizado = '8/15/2023' + ' 10:52:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'65', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'61', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'65', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 115,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'5', Cost:26.35, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:21.77, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'12', Cost:22.87, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 26, MVar:'7', Cost:20.78, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'17', Cost:30.81, ParentId: '10'},
