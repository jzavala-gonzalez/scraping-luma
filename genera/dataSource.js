const timestamp_saved = '08/11/2023 08:25 AM';
const dataFechaAcualizado = '8/11/2023' + ' 4:20:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'18', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'45', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.86, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'134', Cost:17.39, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 195,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 195, MVar:'78', Cost:14.66, ParentId: '17'},
		]
	},
