const timestamp_saved = '08/19/2023 04:30 AM';
const dataFechaAcualizado = '8/19/2023' + ' 12:27:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'61', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'71', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.05, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 64, MVar:'13', Cost:19.05, ParentId: '14'},
