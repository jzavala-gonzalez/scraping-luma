const timestamp_saved = '11/27/2023 01:50 PM';
const dataFechaAcualizado = '11/27/2023' + ' 9:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'31', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'41', Cost:11.60, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'86', Cost:9.81, ParentId: '17'},
		]
	},
