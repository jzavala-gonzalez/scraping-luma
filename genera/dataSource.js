const timestamp_saved = '08/11/2023 05:05 PM';
const dataFechaAcualizado = '8/11/2023' + ' 1:00:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'45', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'45', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'46', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:20.11, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'174', Cost:17.40, ParentId: '16'},
		]
	},
