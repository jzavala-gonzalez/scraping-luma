const timestamp_saved = '11/02/2023 07:10 PM';
const dataFechaAcualizado = '11/2/2023' + ' 3:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'62', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'60', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'54', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'113', Cost:16.96, ParentId: '15'},
