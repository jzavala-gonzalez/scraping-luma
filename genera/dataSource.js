const timestamp_saved = '12/01/2023 04:30 PM';
const dataFechaAcualizado = '12/1/2023' + ' 12:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'47', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'48', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'51', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:17.39, ParentId: '11'},
