const timestamp_saved = '09/05/2023 04:46 AM';
const dataFechaAcualizado = '9/5/2023' + ' 12:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'38', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'42', Cost:10.48, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'4', Cost:27.85, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'1', Cost:31.14, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 222,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 222, MVar:'143', Cost:18.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'71', Cost:9.18, ParentId: '17'},
		]
	},
