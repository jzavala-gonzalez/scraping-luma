const timestamp_saved = '09/30/2023 05:15 PM';
const dataFechaAcualizado = '9/30/2023' + ' 1:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'35', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'33', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.16, ParentId: '14'},
