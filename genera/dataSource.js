const timestamp_saved = '11/14/2023 02:15 AM';
const dataFechaAcualizado = '11/13/2023' + ' 10:11:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2606},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'64', Cost:9.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 180, MVar:'67', Cost:9.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 203, MVar:'66', Cost:9.70, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'25', Cost:28.23, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:17.04, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'14', Cost:31.28, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'0', Cost:25.62, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:31.18, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'69', Cost:17.15, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'129', Cost:10.87, ParentId: '17'},
		]
	},
