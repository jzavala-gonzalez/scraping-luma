const timestamp_saved = '07/28/2023 10:07 AM';
const dataFechaAcualizado = '7/28/2023' + ' 6:00:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'40', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'40', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'43', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'4', Cost:31.24, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 241,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'74', Cost:17.68, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'77', Cost:13.19, ParentId: '17'},
		]
	},
