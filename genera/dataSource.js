const timestamp_saved = '11/25/2023 03:40 AM';
const dataFechaAcualizado = '11/24/2023' + ' 11:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 151,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 151, MVar:'59', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'27', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'36', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'52', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:27.97, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.71, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'14', Cost:9.13, ParentId: '17'},
		]
	},
