const timestamp_saved = '12/01/2023 06:05 PM';
const dataFechaAcualizado = '12/1/2023' + ' 2:01:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2189},
	{Index:'8', Desc:'Máxima Mensual', value: 2189},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'52', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'54', Cost:11.12, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'79', Cost:9.58, ParentId: '17'},
		]
	},
