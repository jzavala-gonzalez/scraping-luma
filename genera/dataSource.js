const timestamp_saved = '09/28/2023 08:20 AM';
const dataFechaAcualizado = '9/28/2023' + ' 4:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'17', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'18', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'43', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:8.84, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'50', Cost:16.89, ParentId: '15'},
