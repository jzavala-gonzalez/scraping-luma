const timestamp_saved = '09/04/2023 10:50 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'36', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'40', Cost:11.03, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'135', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'61', Cost:9.78, ParentId: '17'},
		]
	},
