const timestamp_saved = '10/30/2023 12:40 PM';
const dataFechaAcualizado = '10/30/2023' + ' 8:36:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 251,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'90', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'53', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'54', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'49', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:18.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'8', Cost:18.55, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'15', Cost:21.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'76', Cost:17.29, ParentId: '15'},
