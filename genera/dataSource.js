const timestamp_saved = '10/08/2023 01:30 PM';
const dataFechaAcualizado = '10/8/2023' + ' 9:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'36', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'38', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'38', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'76', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 162,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 162, MVar:'68', Cost:11.39, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 83,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 31, MVar:'6', Cost:19.60, ParentId: '19'},
