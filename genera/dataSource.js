const timestamp_saved = '10/23/2023 04:30 PM';
const dataFechaAcualizado = '10/23/2023' + ' 12:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'53', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'54', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'51', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'27', Cost:19.62, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'85', Cost:11.30, ParentId: '17'},
		]
	},
