const timestamp_saved = '09/27/2023 01:15 AM';
const dataFechaAcualizado = '9/26/2023' + ' 9:10:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.79, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:17.31, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'195', Cost:16.62, ParentId: '16'},
		]
	},
