const timestamp_saved = '09/20/2023 05:05 AM';
const dataFechaAcualizado = '9/20/2023' + ' 1:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'50', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 91, MVar:'27', Cost:21.90, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'76', Cost:9.39, ParentId: '17'},
		]
	},
