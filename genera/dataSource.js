const timestamp_saved = '08/21/2023 08:10 PM';
const dataFechaAcualizado = '8/21/2023' + ' 4:05:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'58', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'58', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'15', Cost:19.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'76', Cost:18.40, ParentId: '15'},
