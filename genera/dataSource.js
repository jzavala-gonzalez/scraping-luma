const timestamp_saved = '11/22/2023 04:00 AM';
const dataFechaAcualizado = '11/21/2023' + ' 11:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'30', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'40', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'48', Cost:17.72, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 70, MVar:'69', Cost:19.69, ParentId: '15'},
