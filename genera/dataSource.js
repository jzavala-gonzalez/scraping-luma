const timestamp_saved = '08/07/2023 05:40 AM';
const dataFechaAcualizado = '8/7/2023' + ' 1:35:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'56', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'82', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'49', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'43', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:19.99, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'4', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 220,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'49', Cost:18.44, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'24', Cost:15.55, ParentId: '15'},
		]
	},
