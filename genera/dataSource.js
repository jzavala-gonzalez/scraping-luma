const timestamp_saved = '11/26/2023 11:00 AM';
const dataFechaAcualizado = '11/26/2023' + ' 6:56:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 243,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 243, MVar:'59', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'17', Cost:13.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'25', Cost:13.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'45', Cost:13.07, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'108', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'56', Cost:9.84, ParentId: '17'},
		]
	},
