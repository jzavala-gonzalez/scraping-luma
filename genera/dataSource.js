const timestamp_saved = '10/16/2023 03:20 PM';
const dataFechaAcualizado = '10/16/2023' + ' 11:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'65', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'63', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'62', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.04, ParentId: '11'},
