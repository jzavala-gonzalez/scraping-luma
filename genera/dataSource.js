const timestamp_saved = '09/08/2023 06:50 AM';
const dataFechaAcualizado = '9/8/2023' + ' 2:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'63', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'58', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'55', Cost:10.55, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 107, MVar:'0', Cost:7.58, ParentId: '8'},
