const timestamp_saved = '11/04/2023 10:20 PM';
const dataFechaAcualizado = '11/4/2023' + ' 6:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'54', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'51', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:16.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:16.62, ParentId: '11'},
