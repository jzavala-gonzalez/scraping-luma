const timestamp_saved = '10/25/2023 06:50 AM';
const dataFechaAcualizado = '10/25/2023' + ' 2:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'41', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'44', Cost:10.90, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'126', Cost:18.25, ParentId: '16'},
		]
	},
