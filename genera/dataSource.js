const timestamp_saved = '11/28/2023 05:55 AM';
const dataFechaAcualizado = '11/28/2023' + ' 1:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'25', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'35', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:8.79, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:8.79, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'2', Cost:197.64, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'9', Cost:19.16, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'141', Cost:17.86, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'74', Cost:9.51, ParentId: '17'},
		]
	},
