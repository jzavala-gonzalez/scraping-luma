const timestamp_saved = '09/07/2023 02:40 AM';
const dataFechaAcualizado = '9/6/2023' + ' 10:35:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'57', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'33', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'51', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 362, MVar:'165', Cost:16.67, ParentId: '16'},
		]
	},
