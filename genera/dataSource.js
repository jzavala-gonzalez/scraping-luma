const timestamp_saved = '11/25/2023 02:40 AM';
const dataFechaAcualizado = '11/24/2023' + ' 10:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 126,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 126, MVar:'63', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'30', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'40', Cost:11.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'54', Cost:11.99, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'20', Cost:28.86, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.35, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'150', Cost:16.78, ParentId: '16'},
		]
	},
