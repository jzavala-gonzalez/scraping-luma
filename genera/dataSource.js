const timestamp_saved = '10/03/2023 05:00 PM';
const dataFechaAcualizado = '10/3/2023' + ' 12:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'42', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'40', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'54', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.40, ParentId: '11'},
