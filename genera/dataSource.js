const timestamp_saved = '11/03/2023 07:45 AM';
const dataFechaAcualizado = '11/3/2023' + ' 3:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'42', Cost:11.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'42', Cost:11.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'42', Cost:11.89, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'70', Cost:16.90, ParentId: '15'},
