const timestamp_saved = '11/20/2023 06:55 PM';
const dataFechaAcualizado = '11/20/2023' + ' 2:51:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'33', Cost:12.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'43', Cost:12.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'56', Cost:12.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.69, ParentId: '11'},
