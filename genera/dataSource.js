const timestamp_saved = '10/12/2023 04:35 AM';
const dataFechaAcualizado = '10/12/2023' + ' 12:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'56', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'59', Cost:11.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:17.15, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:18.26, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.26, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'9', Cost:19.06, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'79', Cost:9.20, ParentId: '17'},
		]
	},
