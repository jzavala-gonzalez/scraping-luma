const timestamp_saved = '09/17/2023 02:45 PM';
const dataFechaAcualizado = '9/17/2023' + ' 10:40:53 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 583},
	{Index:'4', Desc:'Reserva Operacional', value: 1190},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'39', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'39', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'55', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'68', Cost:9.65, ParentId: '17'},
		]
	},
