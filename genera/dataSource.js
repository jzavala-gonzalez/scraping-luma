const timestamp_saved = '11/05/2023 11:10 AM';
const dataFechaAcualizado = '11/5/2023' + ' 7:06:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1943},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'40', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'39', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'39', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'35', Cost:18.05, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:18.05, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 113, MVar:'71', Cost:17.38, ParentId: '15'},
