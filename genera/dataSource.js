const timestamp_saved = '09/01/2023 07:40 AM';
const dataFechaAcualizado = '9/1/2023' + ' 3:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'36', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'44', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'57', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'121', Cost:17.09, ParentId: '16'},
		]
	},
