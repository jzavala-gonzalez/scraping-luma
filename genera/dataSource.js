const timestamp_saved = '11/12/2023 03:45 PM';
const dataFechaAcualizado = '11/12/2023' + ' 11:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'43', Cost:12.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'45', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'54', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:18.11, ParentId: '11'},
