const timestamp_saved = '11/17/2023 01:10 AM';
const dataFechaAcualizado = '11/16/2023' + ' 8:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'60', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'60', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'48', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 24, MVar:'8', Cost:22.39, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'0', Cost:22.78, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 100, MVar:'184', Cost:25.76, ParentId: '16'},
		]
	},
