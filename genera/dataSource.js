const timestamp_saved = '10/15/2023 08:05 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'48', Cost:12.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'48', Cost:12.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'53', Cost:12.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'62', Cost:9.16, ParentId: '17'},
		]
	},
