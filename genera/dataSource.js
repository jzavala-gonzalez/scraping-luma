const timestamp_saved = '10/05/2023 11:35 AM';
const dataFechaAcualizado = '10/5/2023' + ' 7:31:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'34', Cost:12.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'32', Cost:12.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'48', Cost:12.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'88', Cost:9.39, ParentId: '17'},
		]
	},
