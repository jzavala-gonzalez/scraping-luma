const timestamp_saved = '10/21/2023 07:25 PM';
const dataFechaAcualizado = '10/21/2023' + ' 3:21:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'51', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'50', Cost:10.76, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'73', Cost:11.04, ParentId: '17'},
		]
	},
