const timestamp_saved = '08/29/2023 03:15 PM';
const dataFechaAcualizado = '8/29/2023' + ' 11:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 201, MVar:'85', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'82', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'57', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'59', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'65', Cost:10.44, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'48', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'40', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'107', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'144', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'109', Cost:9.21, ParentId: '17'},
		]
	},
