const timestamp_saved = '07/25/2023 05:44 PM';
const dataFechaAcualizado = '7/25/2023' + ' 1:35:30 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 237, MVar:'87', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'70', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'59', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'54', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'1', Cost:20.93, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'8', Cost:30.66, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'11', Cost:31.06, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:20.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'50', Cost:20.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:11.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'0', Cost:11.30, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'47', Cost:15.39, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 200,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 200, MVar:'82', Cost:10.51, ParentId: '17'},
		]
	},
