const timestamp_saved = '09/15/2023 12:05 PM';
const dataFechaAcualizado = '9/15/2023' + ' 8:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'50', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'65', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'19', Cost:18.87, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 178,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 178, MVar:'81', Cost:16.46, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'102', Cost:9.32, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 40,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 12, MVar:'8', Cost:19.60, ParentId: '19'},
