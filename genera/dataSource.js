const timestamp_saved = '08/27/2023 10:55 AM';
const dataFechaAcualizado = '8/27/2023' + ' 6:50:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 260,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'22', Cost:14.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 93, MVar:'50', Cost:14.10, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 49, MVar:'1', Cost:31.17, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 109,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 109, MVar:'75', Cost:18.09, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 222,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 222, MVar:'100', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 264,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 264, MVar:'67', Cost:16.95, ParentId: '17'},
		]
	},
