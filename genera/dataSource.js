const timestamp_saved = '08/23/2023 12:15 AM';
const dataFechaAcualizado = '8/22/2023' + ' 8:10:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'50', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'49', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'10', Cost:31.14, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'19', Cost:18.79, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 302,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 302, MVar:'132', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'82', Cost:9.21, ParentId: '17'},
		]
	},
