const timestamp_saved = '08/12/2023 09:55 AM';
const dataFechaAcualizado = '8/12/2023' + ' 5:52:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'50', Cost:11.09, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 342,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 342, MVar:'159', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 333,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 333, MVar:'100', Cost:11.51, ParentId: '17'},
		]
	},
