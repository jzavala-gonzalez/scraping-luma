const timestamp_saved = '09/14/2023 12:45 AM';
const dataFechaAcualizado = '9/13/2023' + ' 8:40:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 551,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'68', Cost:9.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'66', Cost:9.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 208, MVar:'77', Cost:9.78, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'12', Cost:28.70, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'10', Cost:28.70, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'29', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'77', Cost:16.76, ParentId: '15'},
