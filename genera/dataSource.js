const timestamp_saved = '10/16/2023 01:00 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'61', Cost:10.40, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'10', Cost:17.29, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'168', Cost:17.80, ParentId: '16'},
		]
	},
