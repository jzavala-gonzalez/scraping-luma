const timestamp_saved = '10/14/2023 12:30 AM';
const dataFechaAcualizado = '10/13/2023' + ' 8:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'73', Cost:9.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'78', Cost:9.77, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'21', Cost:28.06, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 33,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'8', Cost:29.38, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'120', Cost:9.15, ParentId: '17'},
		]
	},
