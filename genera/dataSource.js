const timestamp_saved = '09/06/2023 12:55 PM';
const dataFechaAcualizado = '9/6/2023' + ' 8:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'44', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'47', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'59', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'70', Cost:9.19, ParentId: '17'},
		]
	},
