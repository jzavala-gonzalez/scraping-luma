const timestamp_saved = '10/20/2023 06:05 PM';
const dataFechaAcualizado = '10/20/2023' + ' 2:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'48', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'55', Cost:10.74, ParentId: '7'},
