const timestamp_saved = '11/20/2023 11:15 AM';
const dataFechaAcualizado = '11/20/2023' + ' 7:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'35', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'43', Cost:10.71, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'98', Cost:9.19, ParentId: '17'},
		]
	},
