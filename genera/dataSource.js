const timestamp_saved = '08/15/2023 01:40 PM';
const dataFechaAcualizado = '8/15/2023' + ' 9:37:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'45', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 127,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 41, MVar:'0', Cost:22.03, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'48', Cost:19.87, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 54, MVar:'30', Cost:21.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'118', Cost:11.62, ParentId: '17'},
		]
	},
