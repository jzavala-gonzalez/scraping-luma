const timestamp_saved = '11/28/2023 12:55 PM';
const dataFechaAcualizado = '11/28/2023' + ' 8:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'31', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'40', Cost:11.45, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'91', Cost:9.45, ParentId: '17'},
		]
	},
