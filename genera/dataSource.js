const timestamp_saved = '11/04/2023 06:55 AM';
const dataFechaAcualizado = '11/4/2023' + ' 2:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'42', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'43', Cost:10.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'40', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'53', Cost:9.75, ParentId: '17'},
		]
	},
