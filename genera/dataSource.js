const timestamp_saved = '09/02/2023 05:40 PM';
const dataFechaAcualizado = '9/2/2023' + ' 1:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'44', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'51', Cost:11.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'61', Cost:11.50, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'69', Cost:9.27, ParentId: '17'},
		]
	},
