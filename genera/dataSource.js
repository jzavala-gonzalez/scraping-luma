const timestamp_saved = '08/02/2023 04:20 PM';
const dataFechaAcualizado = '8/2/2023' + ' 12:15:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'43', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'48', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:20.65, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'104', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'93', Cost:11.02, ParentId: '17'},
		]
	},
