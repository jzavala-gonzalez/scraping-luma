const timestamp_saved = '10/20/2023 08:20 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'32', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'37', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'40', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'53', Cost:16.77, ParentId: '15'},
