const timestamp_saved = '09/04/2023 01:55 AM';
const dataFechaAcualizado = '9/3/2023' + ' 9:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'43', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'47', Cost:10.75, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'80', Cost:9.20, ParentId: '17'},
		]
	},
