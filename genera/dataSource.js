const timestamp_saved = '10/06/2023 01:30 AM';
const dataFechaAcualizado = '10/5/2023' + ' 9:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'45', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'56', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.46, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'47', Cost:16.90, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'12', Cost:16.90, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'8', Cost:31.03, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'126', Cost:9.18, ParentId: '17'},
		]
	},
