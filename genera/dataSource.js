const timestamp_saved = '10/21/2023 09:45 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'32', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'31', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'29', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'72', Cost:11.02, ParentId: '17'},
		]
	},
