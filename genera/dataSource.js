const timestamp_saved = '07/28/2023 11:46 AM';
const dataFechaAcualizado = '7/28/2023' + ' 7:40:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'42', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'44', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 21,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'0', Cost:27.01, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'9', Cost:27.97, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'34', Cost:16.18, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'76', Cost:13.64, ParentId: '17'},
		]
	},
