const timestamp_saved = '09/04/2023 09:30 PM';
const dataFechaAcualizado = '9/4/2023' + ' 5:25:51 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2631},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'41', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'45', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'56', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'7', Cost:23.06, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'5', Cost:26.97, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:31.05, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.63, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'180', Cost:16.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'82', Cost:9.19, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 10,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 8, MVar:'26', Cost:19.60, ParentId: '19'},
