const timestamp_saved = '10/20/2023 05:55 PM';
const dataFechaAcualizado = '10/20/2023' + ' 1:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'48', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'55', Cost:10.67, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'115', Cost:10.53, ParentId: '17'},
		]
	},
