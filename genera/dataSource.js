const timestamp_saved = '08/13/2023 06:15 PM';
const dataFechaAcualizado = '8/13/2023' + ' 2:12:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'35', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'42', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'41', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'1', Cost:26.80, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 46, MVar:'0', Cost:26.78, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'150', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'109', Cost:12.38, ParentId: '17'},
		]
	},
