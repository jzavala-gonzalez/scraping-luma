const timestamp_saved = '07/31/2023 03:10 PM';
const dataFechaAcualizado = '7/31/2023' + ' 11:05:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'46', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'49', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'55', Cost:15.70, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'93', Cost:11.44, ParentId: '17'},
		]
	},
