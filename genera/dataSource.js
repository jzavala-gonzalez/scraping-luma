const timestamp_saved = '10/06/2023 08:30 AM';
const dataFechaAcualizado = '10/6/2023' + ' 4:26:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'35', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'34', Cost:10.75, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:16.76, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'57', Cost:16.85, ParentId: '15'},
