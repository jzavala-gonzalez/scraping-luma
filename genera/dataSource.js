const timestamp_saved = '11/06/2023 09:30 PM';
const dataFechaAcualizado = '11/6/2023' + ' 5:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'56', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'54', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'51', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.22, ParentId: '11'},
