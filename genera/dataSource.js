const timestamp_saved = '08/05/2023 06:50 AM';
const dataFechaAcualizado = '8/5/2023' + ' 2:45:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'43', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'46', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 140,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'0', Cost:28.14, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'1', Cost:28.53, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'0', Cost:37.94, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'93', Cost:16.98, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'52', Cost:15.61, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 245, MVar:'132', Cost:17.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'87', Cost:11.41, ParentId: '17'},
		]
	},
