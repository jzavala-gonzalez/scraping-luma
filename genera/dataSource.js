const timestamp_saved = '09/13/2023 12:15 PM';
const dataFechaAcualizado = '9/13/2023' + ' 8:10:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'53', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'52', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'65', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'159', Cost:18.24, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 38,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 16, MVar:'9', Cost:19.60, ParentId: '19'},
