const timestamp_saved = '08/13/2023 05:45 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:42:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'35', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'38', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'39', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:30.75, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'106', Cost:12.36, ParentId: '17'},
		]
	},
