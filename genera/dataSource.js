const timestamp_saved = '08/13/2023 03:05 AM';
const dataFechaAcualizado = '8/12/2023' + ' 11:02:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 238, MVar:'81', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'90', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'37', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'41', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'42', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'19', Cost:18.85, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 241,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 241, MVar:'135', Cost:17.69, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'119', Cost:12.26, ParentId: '17'},
		]
	},
