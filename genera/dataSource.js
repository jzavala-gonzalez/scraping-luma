const timestamp_saved = '08/17/2023 05:45 PM';
const dataFechaAcualizado = '8/17/2023' + ' 1:37:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'70', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'77', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:19.67, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'29', Cost:19.34, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 80,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 38, MVar:'12', Cost:17, ParentId: '19'},
		]
	},
