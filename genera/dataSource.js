const timestamp_saved = '10/24/2023 07:35 PM';
const dataFechaAcualizado = '10/24/2023' + ' 3:31:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'55', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'56', Cost:10.22, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:38.90, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'87', Cost:16.88, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'161', Cost:17.04, ParentId: '16'},
		]
	},
