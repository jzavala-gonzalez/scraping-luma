const timestamp_saved = '08/04/2023 04:00 PM';
const dataFechaAcualizado = '8/4/2023' + ' 11:55:38 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 957},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'47', Cost:10.56, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:19.97, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 251,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'86', Cost:18.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'148', Cost:17.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'94', Cost:10.98, ParentId: '17'},
		]
	},
