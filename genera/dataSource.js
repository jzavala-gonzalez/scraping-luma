const timestamp_saved = '11/01/2023 02:20 AM';
const dataFechaAcualizado = '10/31/2023' + ' 10:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'59', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'63', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'68', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 353,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 353, MVar:'165', Cost:16.72, ParentId: '16'},
		]
	},
