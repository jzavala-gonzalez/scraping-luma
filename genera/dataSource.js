const timestamp_saved = '11/16/2023 02:30 AM';
const dataFechaAcualizado = '11/15/2023' + ' 10:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'55', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'55', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'58', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'74', Cost:16.75, ParentId: '15'},
