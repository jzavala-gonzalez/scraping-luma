const timestamp_saved = '10/03/2023 01:45 PM';
const dataFechaAcualizado = '10/3/2023' + ' 9:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'45', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'43', Cost:10.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:18.45, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.20, ParentId: '14'},
