const timestamp_saved = '08/18/2023 09:05 AM';
const dataFechaAcualizado = '8/18/2023' + ' 5:02:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'38', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'53', Cost:10.67, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'59', Cost:9.43, ParentId: '17'},
		]
	},
