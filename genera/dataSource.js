const timestamp_saved = '09/10/2023 01:15 PM';
const dataFechaAcualizado = '9/10/2023' + ' 9:10:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'61', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'61', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'124', Cost:17.82, ParentId: '16'},
		]
	},
