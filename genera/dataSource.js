const timestamp_saved = '09/21/2023 10:26 AM';
const dataFechaAcualizado = '9/21/2023' + ' 6:20:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'45', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'49', Cost:10.48, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:22.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:22.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'0', Cost:8.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 36,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 36, MVar:'19', Cost:26.63, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'80', Cost:16.94, ParentId: '15'},
