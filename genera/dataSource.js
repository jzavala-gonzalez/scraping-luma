const timestamp_saved = '09/01/2023 08:50 PM';
const dataFechaAcualizado = '9/1/2023' + ' 4:45:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2830},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'57', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'64', Cost:10.04, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'8', Cost:27.19, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'3', Cost:26.82, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'10', Cost:31.35, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'29', Cost:19.00, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'89', Cost:17.02, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'170', Cost:16.79, ParentId: '16'},
		]
	},
