const timestamp_saved = '08/25/2023 09:45 PM';
const dataFechaAcualizado = '8/25/2023' + ' 5:40:49 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'61', Cost:10.47, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'168', Cost:17.83, ParentId: '16'},
		]
	},
