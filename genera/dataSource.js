const timestamp_saved = '11/07/2023 07:55 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'38', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'37', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'37', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'9', Cost:20.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'46', Cost:16.84, ParentId: '15'},
