const timestamp_saved = '10/19/2023 03:15 AM';
const dataFechaAcualizado = '10/18/2023' + ' 11:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'44', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'49', Cost:12.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'62', Cost:12.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:21.59, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:16.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 80,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'9', Cost:18.86, ParentId: '14'},
