const timestamp_saved = '08/19/2023 10:40 PM';
const dataFechaAcualizado = '8/19/2023' + ' 6:37:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'58', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'57', Cost:10.84, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:30.70, ParentId: '12'},
