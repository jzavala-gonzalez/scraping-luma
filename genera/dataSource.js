const timestamp_saved = '09/09/2023 10:30 AM';
const dataFechaAcualizado = '9/9/2023' + ' 6:25:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'50', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'55', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:12.11, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 121,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 136, MVar:'49', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'7', Cost:19.25, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'64', Cost:16.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'136', Cost:16.65, ParentId: '16'},
		]
	},
