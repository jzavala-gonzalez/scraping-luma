const timestamp_saved = '10/04/2023 11:20 PM';
const dataFechaAcualizado = '10/4/2023' + ' 7:16:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'47', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'47', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'60', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'6', Cost:26.74, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:17.19, ParentId: '11'},
