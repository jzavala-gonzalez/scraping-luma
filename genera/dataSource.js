const timestamp_saved = '10/27/2023 01:45 AM';
const dataFechaAcualizado = '10/26/2023' + ' 9:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 151, MVar:'54', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'141', Cost:16.75, ParentId: '16'},
		]
	},
