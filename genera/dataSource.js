const timestamp_saved = '10/18/2023 09:40 PM';
const dataFechaAcualizado = '10/18/2023' + ' 5:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'49', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'52', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'63', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:16.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:16.51, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'49', Cost:8.15, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'98', Cost:16.84, ParentId: '15'},
