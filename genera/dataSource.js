const timestamp_saved = '09/22/2023 01:35 AM';
const dataFechaAcualizado = '9/21/2023' + ' 9:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'44', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'48', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'65', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'10', Cost:28.06, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'10', Cost:28.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.28, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'4', Cost:28.81, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'120', Cost:32.74, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'109', Cost:16.09, ParentId: '17'},
		]
	},
