const timestamp_saved = '11/08/2023 11:35 PM';
const dataFechaAcualizado = '11/8/2023' + ' 7:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'57', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'55', Cost:10.53, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'8', Cost:19.66, ParentId: '14'},
