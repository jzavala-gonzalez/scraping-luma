const timestamp_saved = '09/24/2023 12:00 AM';
const dataFechaAcualizado = '9/23/2023' + ' 7:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'53', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'54', Cost:10.63, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'8', Cost:28.07, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'24', Cost:19.49, ParentId: '14'},
