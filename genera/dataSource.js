const timestamp_saved = '11/24/2023 09:35 PM';
const dataFechaAcualizado = '11/24/2023' + ' 5:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'32', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'42', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'55', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.33, ParentId: '11'},
