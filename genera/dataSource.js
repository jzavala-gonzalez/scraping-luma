const timestamp_saved = '10/25/2023 01:55 AM';
const dataFechaAcualizado = '10/24/2023' + ' 9:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'53', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'54', Cost:10.51, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'20', Cost:19.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'153', Cost:16.66, ParentId: '16'},
		]
	},
