const timestamp_saved = '11/20/2023 02:15 PM';
const dataFechaAcualizado = '11/20/2023' + ' 10:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'40', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'49', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'60', Cost:10.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'35', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'181', Cost:18.23, ParentId: '16'},
		]
	},
