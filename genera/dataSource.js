const timestamp_saved = '11/20/2023 08:05 PM';
const dataFechaAcualizado = '11/20/2023' + ' 4:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'33', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'44', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'57', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'96', Cost:9.41, ParentId: '17'},
		]
	},
