const timestamp_saved = '09/26/2023 09:35 PM';
const dataFechaAcualizado = '9/26/2023' + ' 5:30:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'56', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'60', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'64', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'7', Cost:31.31, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'187', Cost:16.99, ParentId: '16'},
		]
	},
