const timestamp_saved = '08/21/2023 12:30 AM';
const dataFechaAcualizado = '8/20/2023' + ' 8:27:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'67', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'26', Cost:10.30, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'6', Cost:31.10, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 50, MVar:'11', Cost:21.57, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'87', Cost:17.38, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'93', Cost:9.19, ParentId: '17'},
		]
	},
