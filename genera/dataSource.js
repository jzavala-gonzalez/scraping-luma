const timestamp_saved = '10/01/2023 03:55 PM';
const dataFechaAcualizado = '10/1/2023' + ' 11:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'30', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'29', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 168,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 126, MVar:'40', Cost:17.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.89, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'124', Cost:17.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 290,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 290, MVar:'90', Cost:9.49, ParentId: '17'},
		]
	},
