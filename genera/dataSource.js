const timestamp_saved = '10/31/2023 04:20 PM';
const dataFechaAcualizado = '10/31/2023' + ' 12:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'60', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'66', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'67', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'30', Cost:18.88, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'85', Cost:16.57, ParentId: '15'},
