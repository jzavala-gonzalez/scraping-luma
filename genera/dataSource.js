const timestamp_saved = '10/02/2023 11:05 AM';
const dataFechaAcualizado = '10/2/2023' + ' 7:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'33', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'31', Cost:10.81, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'99', Cost:9.20, ParentId: '17'},
		]
	},
