const timestamp_saved = '12/01/2023 10:40 PM';
const dataFechaAcualizado = '12/1/2023' + ' 6:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'56', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'58', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'58', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'4', Cost:31.45, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.46, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'161', Cost:16.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 356,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 356, MVar:'99', Cost:9.21, ParentId: '17'},
		]
	},
