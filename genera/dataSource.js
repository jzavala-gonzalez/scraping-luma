const timestamp_saved = '12/06/2023 04:20 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:15:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Capacidad Disponible', value: 3009},
	{Index:'8', Desc:'Próxima Hora MW', value: 2139},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'47', Cost:13.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'49', Cost:13.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'58', Cost:13.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'48', Cost:8.10, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'67', Cost:14.56, ParentId: '17'},
		]
	},
