const timestamp_saved = '11/23/2023 09:50 AM';
const dataFechaAcualizado = '11/23/2023' + ' 5:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'63', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'18', Cost:13.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'28', Cost:13.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'46', Cost:13.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 284,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.62, ParentId: '11'},
