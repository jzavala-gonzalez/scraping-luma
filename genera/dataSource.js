const timestamp_saved = '10/02/2023 06:55 AM';
const dataFechaAcualizado = '10/2/2023' + ' 2:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'31', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'29', Cost:10.52, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'73', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'91', Cost:9.42, ParentId: '17'},
		]
	},
