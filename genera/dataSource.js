const timestamp_saved = '10/02/2023 08:50 AM';
const dataFechaAcualizado = '10/2/2023' + ' 4:45:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'31', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'31', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'46', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 3, MVar:'0', Cost:22.73, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'5', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'125', Cost:17.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'94', Cost:9.61, ParentId: '17'},
		]
	},
