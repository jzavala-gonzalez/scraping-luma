const timestamp_saved = '11/28/2023 08:50 AM';
const dataFechaAcualizado = '11/28/2023' + ' 4:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'24', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'32', Cost:11.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'48', Cost:11.49, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'111', Cost:18.60, ParentId: '16'},
		]
	},
