const timestamp_saved = '11/17/2023 02:05 PM';
const dataFechaAcualizado = '11/17/2023' + ' 10:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'59', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'60', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'47', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 115,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'30', Cost:19.36, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 69,
		units:[
			...
			{Index:'1', Unit:'Ilumina', MW: 12, MVar:'11', Cost:21.43, ParentId: '19'},
