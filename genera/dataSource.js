const timestamp_saved = '10/03/2023 08:10 AM';
const dataFechaAcualizado = '10/3/2023' + ' 4:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'37', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'35', Cost:10.44, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'93', Cost:9.82, ParentId: '17'},
		]
	},
