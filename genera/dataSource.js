const timestamp_saved = '10/28/2023 02:50 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:46:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1966},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:12.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'42', Cost:12.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'47', Cost:12.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'14', Cost:34.49, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'5', Cost:21.04, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 60, MVar:'77', Cost:23.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 290, MVar:'125', Cost:17.22, ParentId: '16'},
		]
	},
