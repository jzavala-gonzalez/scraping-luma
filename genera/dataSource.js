const timestamp_saved = '07/29/2023 03:15 AM';
const dataFechaAcualizado = '7/28/2023' + ' 11:10:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'46', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'47', Cost:11.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 147,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 24, MVar:'0', Cost:29.79, ParentId: '8'},
			{Index:'5', Unit:'Yabucoa', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
			{Index:'7', Unit:'FEMA GT PS', MW: 155, MVar:'1', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'2', Cost:22.37, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'9', Cost:30.85, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'7', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'80', Cost:16.71, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'23', Cost:15.53, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 263,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 263, MVar:'78', Cost:13.85, ParentId: '17'},
		]
	},
