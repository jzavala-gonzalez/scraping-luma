const timestamp_saved = '09/30/2023 04:40 PM';
const dataFechaAcualizado = '9/30/2023' + ' 12:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'31', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'31', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'48', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 202,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.38, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.38, ParentId: '11'},
