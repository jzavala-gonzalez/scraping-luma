const timestamp_saved = '10/19/2023 04:30 PM';
const dataFechaAcualizado = '10/19/2023' + ' 12:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'44', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'51', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'70', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'46', Cost:17.23, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'24', Cost:23.75, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'175', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'114', Cost:10.55, ParentId: '17'},
		]
	},
