const timestamp_saved = '10/02/2023 04:15 PM';
const dataFechaAcualizado = '10/2/2023' + ' 12:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'38', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'37', Cost:10.49, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:30.08, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'172', Cost:17.06, ParentId: '16'},
		]
	},
