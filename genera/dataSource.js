const timestamp_saved = '10/03/2023 10:45 PM';
const dataFechaAcualizado = '10/3/2023' + ' 6:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'43', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'43', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'55', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 187,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:22.09, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 38, MVar:'9', Cost:22.91, ParentId: '9'},
