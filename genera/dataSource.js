const timestamp_saved = '10/30/2023 09:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 4:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'32', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'35', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'61', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'36', Cost:9.69, ParentId: '17'},
		]
	},
