const timestamp_saved = '11/18/2023 07:30 AM';
const dataFechaAcualizado = '11/18/2023' + ' 3:26:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2226},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:23.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'73', Cost:23.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:23.65, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 65,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'6', Cost:29.69, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:30.62, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 65,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'11', Cost:29.81, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'80', Cost:17.12, ParentId: '15'},
