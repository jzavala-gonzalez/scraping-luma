const timestamp_saved = '09/10/2023 02:55 AM';
const dataFechaAcualizado = '9/9/2023' + ' 10:50:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'73', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'70', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 210, MVar:'70', Cost:9.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 155,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:9.49, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 74,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 20, MVar:'0', Cost:26.29, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.46, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:26.73, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.46, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'8', Cost:28.37, ParentId: '13'},
