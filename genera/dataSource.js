const timestamp_saved = '09/14/2023 07:05 AM';
const dataFechaAcualizado = '9/14/2023' + ' 3:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'50', Cost:11.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'49', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'63', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.49, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'139', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'83', Cost:9.42, ParentId: '17'},
		]
	},
