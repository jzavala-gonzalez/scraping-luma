const timestamp_saved = '09/10/2023 04:35 PM';
const dataFechaAcualizado = '9/10/2023' + ' 12:30:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'65', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'64', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'64', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'73', Cost:17.34, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 80,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 42, MVar:'8', Cost:19.60, ParentId: '19'},
