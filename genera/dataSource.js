const timestamp_saved = '10/03/2023 01:05 AM';
const dataFechaAcualizado = '10/2/2023' + ' 9:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'50', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 213, MVar:'62', Cost:9.77, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 186,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:8.64, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:25.48, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'13', Cost:18.86, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'97', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 331, MVar:'189', Cost:16.74, ParentId: '16'},
		]
	},
