const timestamp_saved = '09/17/2023 02:30 AM';
const dataFechaAcualizado = '9/16/2023' + ' 10:25:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'52', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'65', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 99, MVar:'30', Cost:8.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:8.69, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'92', Cost:16.76, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'109', Cost:9.11, ParentId: '17'},
		]
	},
