const timestamp_saved = '07/27/2023 06:28 AM';
const dataFechaAcualizado = '7/27/2023' + ' 2:20:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'53', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'55', Cost:10.81, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:37.78, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'21', Cost:15.42, ParentId: '15'},
		]
	},
