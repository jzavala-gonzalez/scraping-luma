const timestamp_saved = '10/17/2023 06:25 AM';
const dataFechaAcualizado = '10/17/2023' + ' 2:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'56', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'55', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'76', Cost:16.82, ParentId: '15'},
