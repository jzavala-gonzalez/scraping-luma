const timestamp_saved = '10/11/2023 05:35 AM';
const dataFechaAcualizado = '10/11/2023' + ' 1:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'53', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'57', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'62', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:18.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:18.01, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'157', Cost:16.54, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 269,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 269, MVar:'63', Cost:9.85, ParentId: '17'},
		]
	},
