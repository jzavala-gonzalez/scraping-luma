const timestamp_saved = '11/14/2023 12:25 AM';
const dataFechaAcualizado = '11/13/2023' + ' 8:21:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'66', Cost:9.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 178, MVar:'70', Cost:9.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 205, MVar:'66', Cost:9.70, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:25.90, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.56, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 4, MVar:'1', Cost:21.58, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'6', Cost:26.43, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.44, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'15', Cost:31.21, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'14', Cost:31.39, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'84', Cost:16.59, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'133', Cost:10.87, ParentId: '17'},
		]
	},
