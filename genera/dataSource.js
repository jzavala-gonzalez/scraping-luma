const timestamp_saved = '11/23/2023 10:10 PM';
const dataFechaAcualizado = '11/23/2023' + ' 6:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'31', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'40', Cost:10.41, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'66', Cost:9.60, ParentId: '17'},
		]
	},
