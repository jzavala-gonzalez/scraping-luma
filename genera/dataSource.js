const timestamp_saved = '07/26/2023 07:46 PM';
const dataFechaAcualizado = '7/26/2023' + ' 3:40:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 389,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 140, MVar:'70', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'56', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'54', Cost:11.02, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 137,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 36, MVar:'0', Cost:15.91, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'2', Cost:26.84, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.86, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'9', Cost:27.40, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:30.60, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'9', Cost:30.50, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'23', Cost:18.65, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 346,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'114', Cost:16.50, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'30', Cost:15.44, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'88', Cost:13.16, ParentId: '17'},
		]
	},
