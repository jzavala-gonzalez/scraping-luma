const timestamp_saved = '10/28/2023 12:05 AM';
const dataFechaAcualizado = '10/27/2023' + ' 8:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'48', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'49', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'4', Cost:22.60, ParentId: '14'},
