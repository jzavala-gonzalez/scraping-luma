const timestamp_saved = '11/07/2023 07:50 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'37', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'38', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.60, ParentId: '13'},
