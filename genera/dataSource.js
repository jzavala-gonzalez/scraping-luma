const timestamp_saved = '10/21/2023 11:15 AM';
const dataFechaAcualizado = '10/21/2023' + ' 7:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'36', Cost:12.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'33', Cost:12.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'36', Cost:12.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'65', Cost:11.04, ParentId: '17'},
		]
	},
