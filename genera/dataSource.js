const timestamp_saved = '11/13/2023 05:55 AM';
const dataFechaAcualizado = '11/13/2023' + ' 1:51:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 171,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 86, MVar:'44', Cost:21.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'48', Cost:21.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.57, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'7', Cost:27.94, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'59', Cost:16.94, ParentId: '15'},
