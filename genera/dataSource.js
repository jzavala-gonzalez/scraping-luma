const timestamp_saved = '09/07/2023 05:40 AM';
const dataFechaAcualizado = '9/7/2023' + ' 1:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'27', Cost:11.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'45', Cost:11.54, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 206,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 206, MVar:'133', Cost:18.31, ParentId: '16'},
		]
	},
