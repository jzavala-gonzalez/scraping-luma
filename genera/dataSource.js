const timestamp_saved = '09/10/2023 02:20 PM';
const dataFechaAcualizado = '9/10/2023' + ' 10:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'61', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'60', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 63,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 31, MVar:'7', Cost:19.60, ParentId: '19'},
