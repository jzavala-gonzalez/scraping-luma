const timestamp_saved = '09/29/2023 11:45 AM';
const dataFechaAcualizado = '9/29/2023' + ' 7:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'33', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'30', Cost:12.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'47', Cost:12.88, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'39', Cost:18.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'10', Cost:18.20, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'11', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'84', Cost:16.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'121', Cost:17.80, ParentId: '16'},
		]
	},
