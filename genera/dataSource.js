const timestamp_saved = '09/25/2023 10:55 PM';
const dataFechaAcualizado = '9/25/2023' + ' 6:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'52', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'52', Cost:10.33, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 145,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 125, MVar:'64', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 222, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'8', Cost:26.63, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:48.69, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'76', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 372, MVar:'191', Cost:16.62, ParentId: '16'},
		]
	},
