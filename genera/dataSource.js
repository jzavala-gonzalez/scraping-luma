const timestamp_saved = '12/03/2023 10:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 6:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'37', Cost:11.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'39', Cost:11.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'52', Cost:11.66, ParentId: '17'},
		]
	},
