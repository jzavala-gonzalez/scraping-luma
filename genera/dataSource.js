const timestamp_saved = '08/19/2023 11:20 PM';
const dataFechaAcualizado = '8/19/2023' + ' 7:17:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'61', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.29, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 138,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:65.25, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 132,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:21.95, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'6', Cost:31.44, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 33, MVar:'0', Cost:31.54, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 63,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'8', Cost:31.80, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'102', Cost:16.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 375,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 375, MVar:'167', Cost:16.57, ParentId: '16'},
		]
	},
