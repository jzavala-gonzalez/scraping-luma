const timestamp_saved = '08/23/2023 09:00 PM';
const dataFechaAcualizado = '8/23/2023' + ' 4:55:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'59', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'56', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'4', Cost:23.03, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'9', Cost:106.93, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'32', Cost:19.23, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'167', Cost:16.98, ParentId: '16'},
		]
	},
