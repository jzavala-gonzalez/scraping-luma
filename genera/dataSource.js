const timestamp_saved = '08/29/2023 04:00 PM';
const dataFechaAcualizado = '8/29/2023' + ' 11:55:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'89', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'88', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'58', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'60', Cost:10.60, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'5', Cost:22.05, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'39', Cost:19.19, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'106', Cost:16.88, ParentId: '15'},
