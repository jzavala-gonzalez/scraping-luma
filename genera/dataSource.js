const timestamp_saved = '11/08/2023 06:45 AM';
const dataFechaAcualizado = '11/8/2023' + ' 2:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'39', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'37', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'42', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'48', Cost:16.93, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'58', Cost:16.91, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'115', Cost:17.98, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'66', Cost:9.88, ParentId: '17'},
		]
	},
