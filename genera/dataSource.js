const timestamp_saved = '08/03/2023 11:15 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:10:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'42', Cost:10.58, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'80', Cost:17.09, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'40', Cost:16.67, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'85', Cost:11.38, ParentId: '17'},
		]
	},
