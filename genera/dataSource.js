const timestamp_saved = '08/04/2023 02:25 PM';
const dataFechaAcualizado = '8/4/2023' + ' 10:20:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'42', Cost:11.13, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'85', Cost:17.98, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'39', Cost:15.68, ParentId: '15'},
		]
	},
