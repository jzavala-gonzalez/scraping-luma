const timestamp_saved = '10/24/2023 04:50 PM';
const dataFechaAcualizado = '10/24/2023' + ' 12:46:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'54', Cost:10.20, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'87', Cost:17.04, ParentId: '15'},
