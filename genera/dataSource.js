const timestamp_saved = '10/11/2023 08:00 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'44', Cost:13.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'47', Cost:13.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'57', Cost:13.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:18.14, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:18.14, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'58', Cost:9.12, ParentId: '17'},
		]
	},
