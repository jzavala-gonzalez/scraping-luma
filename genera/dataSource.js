const timestamp_saved = '08/31/2023 04:35 AM';
const dataFechaAcualizado = '8/31/2023' + ' 12:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'42', Cost:13.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'52', Cost:13.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'62', Cost:13.47, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'11', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'12', Cost:28.22, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:31.10, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'75', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 332, MVar:'145', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'76', Cost:9.20, ParentId: '17'},
		]
	},
