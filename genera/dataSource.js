const timestamp_saved = '09/22/2023 06:30 AM';
const dataFechaAcualizado = '9/22/2023' + ' 2:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'39', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'43', Cost:10.73, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 143, MVar:'0', Cost:8.16, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'73', Cost:32.81, ParentId: '16'},
		]
	},
