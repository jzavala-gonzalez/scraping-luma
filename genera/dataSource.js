const timestamp_saved = '12/02/2023 12:25 AM';
const dataFechaAcualizado = '12/1/2023' + ' 8:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'54', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'58', Cost:12.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'58', Cost:12.21, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'5', Cost:28.11, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.30, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'164', Cost:16.78, ParentId: '16'},
		]
	},
