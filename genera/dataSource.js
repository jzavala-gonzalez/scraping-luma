const timestamp_saved = '11/05/2023 01:50 AM';
const dataFechaAcualizado = '11/4/2023' + ' 9:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'55', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'54', Cost:10.55, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 64,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 16, MVar:'7', Cost:27.01, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'80', Cost:9.21, ParentId: '17'},
		]
	},
