const timestamp_saved = '11/21/2023 07:55 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 275,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 87, MVar:'19', Cost:13.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 86, MVar:'28', Cost:13.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 102, MVar:'46', Cost:13.96, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'42', Cost:18.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'122', Cost:18.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'67', Cost:9.19, ParentId: '17'},
		]
	},
