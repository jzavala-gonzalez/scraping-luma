const timestamp_saved = '10/03/2023 10:45 AM';
const dataFechaAcualizado = '10/3/2023' + ' 6:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'49', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'98', Cost:9.39, ParentId: '17'},
		]
	},
