const timestamp_saved = '11/10/2023 08:20 AM';
const dataFechaAcualizado = '11/10/2023' + ' 4:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'43', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'48', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'41', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'8', Cost:17.54, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'53', Cost:9.82, ParentId: '17'},
		]
	},
