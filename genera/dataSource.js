const timestamp_saved = '10/19/2023 02:50 PM';
const dataFechaAcualizado = '10/19/2023' + ' 10:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'39', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'46', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'50', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'109', Cost:10.58, ParentId: '17'},
		]
	},
