const timestamp_saved = '11/24/2023 10:30 AM';
const dataFechaAcualizado = '11/24/2023' + ' 6:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'23', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'32', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'48', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 215,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:17.61, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.61, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'18', Cost:19.12, ParentId: '14'},
