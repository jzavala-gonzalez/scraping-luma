const timestamp_saved = '09/24/2023 04:05 AM';
const dataFechaAcualizado = '9/24/2023' + ' 12:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'45', Cost:13.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'45', Cost:13.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'56', Cost:13.06, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 52,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 4, MVar:'0', Cost:24.97, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 131,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'4', Cost:27.99, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 53, MVar:'3', Cost:30.77, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:10.02, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'0', Cost:10.02, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'1', Cost:30.81, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'4', Cost:28.32, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'90', Cost:9.21, ParentId: '17'},
		]
	},
