const timestamp_saved = '11/10/2023 07:20 AM';
const dataFechaAcualizado = '11/10/2023' + ' 3:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'44', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'49', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'41', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'53', Cost:9.83, ParentId: '17'},
		]
	},
