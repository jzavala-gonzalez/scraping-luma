const timestamp_saved = '09/22/2023 08:45 AM';
const dataFechaAcualizado = '9/22/2023' + ' 4:40:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'36', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'39', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'60', Cost:10.67, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'42', Cost:20.54, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.54, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'0', Cost:8.24, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'66', Cost:16.47, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'71', Cost:32.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'78', Cost:17.19, ParentId: '17'},
		]
	},
