const timestamp_saved = '12/02/2023 11:15 PM';
const dataFechaAcualizado = '12/2/2023' + ' 7:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'54', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'56', Cost:11.42, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 304,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 304, MVar:'139', Cost:17.11, ParentId: '16'},
		]
	},
