const timestamp_saved = '10/07/2023 11:00 AM';
const dataFechaAcualizado = '10/7/2023' + ' 6:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 64, MVar:'31', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'43', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'44', Cost:11.38, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'148', Cost:17.38, ParentId: '16'},
		]
	},
