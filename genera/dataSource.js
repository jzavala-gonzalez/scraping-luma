const timestamp_saved = '09/14/2023 02:40 PM';
const dataFechaAcualizado = '9/14/2023' + ' 10:35:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'57', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'57', Cost:10.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'68', Cost:10.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 68, MVar:'0', Cost:6.94, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'29', Cost:19.01, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'104', Cost:9.23, ParentId: '17'},
		]
	},
