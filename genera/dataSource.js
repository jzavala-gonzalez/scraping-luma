const timestamp_saved = '09/03/2023 04:20 PM';
const dataFechaAcualizado = '9/3/2023' + ' 12:15:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'38', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'42', Cost:10.43, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:18.82, ParentId: '14'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 96,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 29, MVar:'22', Cost:19.60, ParentId: '19'},
