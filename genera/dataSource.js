const timestamp_saved = '09/13/2023 04:10 PM';
const dataFechaAcualizado = '9/13/2023' + ' 12:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'54', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'53', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'66', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'13', Cost:28.41, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'14', Cost:28.36, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'25', Cost:19.13, ParentId: '14'},
