const timestamp_saved = '08/29/2023 04:25 AM';
const dataFechaAcualizado = '8/29/2023' + ' 12:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'49', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'50', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:11.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 95, MVar:'0', Cost:5.27, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'30', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 109,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 58, MVar:'14', Cost:27.49, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'24', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'72', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'165', Cost:16.76, ParentId: '16'},
		]
	},
