const timestamp_saved = '11/25/2023 11:00 PM';
const dataFechaAcualizado = '11/25/2023' + ' 6:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 204,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 204, MVar:'71', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'35', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'46', Cost:11.58, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:17.16, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.16, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'36', Cost:18.52, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:18.52, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'138', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'41', Cost:9.44, ParentId: '17'},
		]
	},
