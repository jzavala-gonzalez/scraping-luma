const timestamp_saved = '08/31/2023 11:20 PM';
const dataFechaAcualizado = '8/31/2023' + ' 7:15:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 3031},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'64', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'69', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'15', Cost:30.91, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:17.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:17.19, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'9', Cost:28.37, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'9', Cost:28.18, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'45', Cost:19.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'97', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'197', Cost:16.67, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'108', Cost:9.21, ParentId: '17'},
		]
	},
