const timestamp_saved = '09/02/2023 04:15 AM';
const dataFechaAcualizado = '9/2/2023' + ' 12:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'44', Cost:13.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'51', Cost:13.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'62', Cost:13.27, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 42, MVar:'0', Cost:22.28, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 335,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 335, MVar:'130', Cost:16.82, ParentId: '16'},
		]
	},
