const timestamp_saved = '08/09/2023 03:10 AM';
const dataFechaAcualizado = '8/8/2023' + ' 11:05:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'57', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'38', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'47', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'6', Cost:22.72, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.37, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.22, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 308,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 308, MVar:'133', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'76', Cost:12.23, ParentId: '17'},
		]
	},
