const timestamp_saved = '10/29/2023 07:56 AM';
const dataFechaAcualizado = '10/29/2023' + ' 3:51:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'34', Cost:11.14, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.11, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'8', Cost:18.11, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'58', Cost:17.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'103', Cost:18.22, ParentId: '16'},
		]
	},
