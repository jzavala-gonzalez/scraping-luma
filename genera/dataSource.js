const timestamp_saved = '11/03/2023 07:20 AM';
const dataFechaAcualizado = '11/3/2023' + ' 3:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'44', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'43', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'42', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'57', Cost:9.42, ParentId: '17'},
		]
	},
