const timestamp_saved = '07/28/2023 06:58 AM';
const dataFechaAcualizado = '7/28/2023' + ' 2:50:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'43', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'43', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'78', Cost:13.17, ParentId: '17'},
		]
	},
