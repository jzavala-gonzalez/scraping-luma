const timestamp_saved = '10/19/2023 10:15 AM';
const dataFechaAcualizado = '10/19/2023' + ' 6:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'37', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'44', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'48', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 100, MVar:'32', Cost:17.33, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'7', Cost:17.33, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.13, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'101', Cost:10.63, ParentId: '17'},
		]
	},
