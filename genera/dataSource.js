const timestamp_saved = '11/04/2023 11:00 AM';
const dataFechaAcualizado = '11/4/2023' + ' 6:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'41', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'52', Cost:9.73, ParentId: '17'},
		]
	},
