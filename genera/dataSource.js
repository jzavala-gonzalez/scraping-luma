const timestamp_saved = '08/30/2023 06:15 AM';
const dataFechaAcualizado = '8/30/2023' + ' 2:10:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'47', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'48', Cost:10.96, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'69', Cost:16.75, ParentId: '15'},
