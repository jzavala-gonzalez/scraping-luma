const timestamp_saved = '10/03/2023 10:05 AM';
const dataFechaAcualizado = '10/3/2023' + ' 6:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'40', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'38', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'52', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'102', Cost:9.42, ParentId: '17'},
		]
	},
