const timestamp_saved = '08/13/2023 04:30 AM';
const dataFechaAcualizado = '8/13/2023' + ' 12:27:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'41', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'46', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'44', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.33, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 278,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:20.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'2', Cost:20.24, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'7', Cost:31.68, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:32.49, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 32,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'6', Cost:31.82, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'35', Cost:18.92, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'148', Cost:17.37, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'119', Cost:12.29, ParentId: '17'},
		]
	},
