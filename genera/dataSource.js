const timestamp_saved = '08/18/2023 02:35 AM';
const dataFechaAcualizado = '8/17/2023' + ' 10:32:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'50', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'64', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'74', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'15', Cost:19.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'88', Cost:9.20, ParentId: '17'},
		]
	},
