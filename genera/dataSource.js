const timestamp_saved = '10/25/2023 09:05 PM';
const dataFechaAcualizado = '10/25/2023' + ' 5:01:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 480,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 170, MVar:'52', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:32.10, ParentId: '12'},
