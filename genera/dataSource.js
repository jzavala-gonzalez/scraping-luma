const timestamp_saved = '09/29/2023 07:45 AM';
const dataFechaAcualizado = '9/29/2023' + ' 3:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'31', Cost:13.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'28', Cost:13.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'48', Cost:13.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:17.71, ParentId: '11'},
