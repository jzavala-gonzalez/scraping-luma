const timestamp_saved = '10/19/2023 03:55 AM';
const dataFechaAcualizado = '10/18/2023' + ' 11:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'42', Cost:12.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'46', Cost:12.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'60', Cost:12.83, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'9', Cost:18.63, ParentId: '14'},
