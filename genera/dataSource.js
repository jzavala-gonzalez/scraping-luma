const timestamp_saved = '10/16/2023 12:10 PM';
const dataFechaAcualizado = '10/16/2023' + ' 8:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'57', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'57', Cost:10.61, ParentId: '7'},
