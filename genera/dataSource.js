const timestamp_saved = '11/16/2023 07:35 AM';
const dataFechaAcualizado = '11/16/2023' + ' 3:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'41', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'41', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'48', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'46', Cost:17.42, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'2', Cost:30.52, ParentId: '13'},
