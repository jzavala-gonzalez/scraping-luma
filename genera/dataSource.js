const timestamp_saved = '10/11/2023 09:45 AM';
const dataFechaAcualizado = '10/11/2023' + ' 5:41:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:18.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'10', Cost:18.15, ParentId: '11'},
