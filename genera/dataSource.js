const timestamp_saved = '08/27/2023 02:10 PM';
const dataFechaAcualizado = '8/27/2023' + ' 10:05:50 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2015},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 265,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'26', Cost:14.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:14.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 97, MVar:'54', Cost:14.04, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'9', Cost:31.78, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:18.92, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'88', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 245,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 245, MVar:'74', Cost:17.21, ParentId: '17'},
		]
	},
