const timestamp_saved = '08/23/2023 09:35 AM';
const dataFechaAcualizado = '8/23/2023' + ' 5:30:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'48', Cost:10.47, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'49', Cost:20.02, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:20.02, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 134, MVar:'0', Cost:8.69, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 101, MVar:'54', Cost:18.42, ParentId: '15'},
