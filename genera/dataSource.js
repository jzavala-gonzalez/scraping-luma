const timestamp_saved = '10/25/2023 06:00 AM';
const dataFechaAcualizado = '10/25/2023' + ' 1:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'43', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'46', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 37,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 37, MVar:'4', Cost:30.74, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'0', Cost:11.27, ParentId: '17'},
		]
	},
