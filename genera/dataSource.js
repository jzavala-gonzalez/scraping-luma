const timestamp_saved = '12/01/2023 12:50 AM';
const dataFechaAcualizado = '11/30/2023' + ' 8:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'61', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'64', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'61', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'162', Cost:18.26, ParentId: '16'},
		]
	},
