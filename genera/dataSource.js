const timestamp_saved = '12/01/2023 07:25 AM';
const dataFechaAcualizado = '12/1/2023' + ' 3:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'40', Cost:12.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'40', Cost:12.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'46', Cost:12.47, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'50', Cost:9.88, ParentId: '17'},
		]
	},
