const timestamp_saved = '10/28/2023 10:50 AM';
const dataFechaAcualizado = '10/28/2023' + ' 6:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'36', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'38', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'42', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'17', Cost:30.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:30.87, ParentId: '11'},
