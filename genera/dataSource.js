const timestamp_saved = '08/12/2023 02:45 AM';
const dataFechaAcualizado = '8/11/2023' + ' 10:42:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 135, MVar:'59', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'10', Cost:28.07, ParentId: '10'},
