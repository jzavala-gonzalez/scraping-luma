const timestamp_saved = '08/12/2023 06:30 PM';
const dataFechaAcualizado = '8/12/2023' + ' 2:27:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'73', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'84', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'42', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'41', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:11.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 130, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'0', Cost:22.15, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 135, MVar:'41', Cost:20.32, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:44.03, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'147', Cost:17.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'110', Cost:11.46, ParentId: '17'},
		]
	},
