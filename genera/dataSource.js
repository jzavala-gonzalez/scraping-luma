const timestamp_saved = '09/25/2023 05:20 AM';
const dataFechaAcualizado = '9/25/2023' + ' 1:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'54', Cost:10.94, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 333,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:10.06, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'0', Cost:17.44, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'0', Cost:17.44, ParentId: '11'},
		]
	},
