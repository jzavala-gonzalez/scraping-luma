const timestamp_saved = '08/06/2023 09:55 PM';
const dataFechaAcualizado = '8/6/2023' + ' 5:50:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'46', Cost:10.64, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 170,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 113, MVar:'0', Cost:14.98, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'19', Cost:31.05, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'22', Cost:31.01, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:9.47, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 101,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:28.42, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'9', Cost:30.76, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'20', Cost:18.75, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 275,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'100', Cost:17.68, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'12', Cost:15.61, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'106', Cost:11.56, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 65,
		units:[
			...
			{Index:'1', Unit:'CT Block 2', MW: 0, MVar:'0', Cost:86, ParentId: '21'},
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:85.82, ParentId: '21'},
