const timestamp_saved = '12/03/2023 05:35 PM';
const dataFechaAcualizado = '12/3/2023' + ' 1:31:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1736},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'36', Cost:13.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.71, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.71, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'37', Cost:8.75, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:8.75, ParentId: '11'},
		]
	},
