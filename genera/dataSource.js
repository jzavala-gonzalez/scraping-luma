const timestamp_saved = '08/01/2023 05:40 PM';
const dataFechaAcualizado = '8/1/2023' + ' 1:35:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'53', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'54', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:37.35, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'106', Cost:10.99, ParentId: '17'},
		]
	},
