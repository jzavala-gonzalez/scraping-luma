const timestamp_saved = '09/19/2023 11:10 PM';
const dataFechaAcualizado = '9/19/2023' + ' 7:05:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3212},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 207, MVar:'81', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'89', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'55', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'57', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'67', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'10', Cost:27.22, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:28.82, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'26', Cost:18.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'85', Cost:16.71, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'176', Cost:16.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'95', Cost:9.14, ParentId: '17'},
		]
	},
