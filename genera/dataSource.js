const timestamp_saved = '09/02/2023 05:25 AM';
const dataFechaAcualizado = '9/2/2023' + ' 1:20:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'45', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'51', Cost:11.94, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'67', Cost:16.52, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'61', Cost:9.50, ParentId: '17'},
		]
	},
