const timestamp_saved = '08/04/2023 01:25 PM';
const dataFechaAcualizado = '8/4/2023' + ' 9:20:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'79', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'47', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'50', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'87', Cost:17.74, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 258,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 258, MVar:'151', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'94', Cost:10.97, ParentId: '17'},
		]
	},
