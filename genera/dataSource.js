const timestamp_saved = '10/08/2023 06:05 PM';
const dataFechaAcualizado = '10/8/2023' + ' 2:01:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'83', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'45', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'45', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'43', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'96', Cost:16.64, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'157', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 196,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 196, MVar:'84', Cost:10.97, ParentId: '17'},
		]
	},
