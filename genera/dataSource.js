const timestamp_saved = '12/02/2023 11:25 PM';
const dataFechaAcualizado = '12/2/2023' + ' 7:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'56', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'58', Cost:11.43, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'141', Cost:17.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'102', Cost:10.88, ParentId: '17'},
		]
	},
