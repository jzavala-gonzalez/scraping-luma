const timestamp_saved = '11/27/2023 12:10 PM';
const dataFechaAcualizado = '11/27/2023' + ' 8:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'27', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'37', Cost:11.38, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'79', Cost:9.82, ParentId: '17'},
		]
	},
