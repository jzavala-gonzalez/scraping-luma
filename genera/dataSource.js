const timestamp_saved = '10/25/2023 04:55 PM';
const dataFechaAcualizado = '10/25/2023' + ' 12:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 503,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'54', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 178, MVar:'55', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 138, MVar:'40', Cost:18.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.31, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 133, MVar:'38', Cost:18.25, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 38,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 38, MVar:'0', Cost:32.15, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'23', Cost:18.75, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'87', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 274,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 274, MVar:'160', Cost:17.81, ParentId: '16'},
		]
	},
