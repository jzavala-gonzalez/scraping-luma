const timestamp_saved = '08/29/2023 06:10 PM';
const dataFechaAcualizado = '8/29/2023' + ' 2:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 199, MVar:'83', Cost:4.40, ParentId: '6'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:5.07, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'35', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'100', Cost:16.96, ParentId: '15'},
