const timestamp_saved = '09/11/2023 07:10 AM';
const dataFechaAcualizado = '9/11/2023' + ' 3:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'67', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'65', Cost:10.30, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'9', Cost:31.07, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'10', Cost:30.90, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'6', Cost:10.07, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'146', Cost:16.62, ParentId: '16'},
		]
	},
