const timestamp_saved = '10/13/2023 03:10 PM';
const dataFechaAcualizado = '10/13/2023' + ' 11:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'63', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'66', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'71', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.10, ParentId: '14'},
