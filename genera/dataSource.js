const timestamp_saved = '09/03/2023 04:40 AM';
const dataFechaAcualizado = '9/3/2023' + ' 12:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'42', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'51', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'62', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 320, MVar:'147', Cost:16.87, ParentId: '16'},
		]
	},
