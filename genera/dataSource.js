const timestamp_saved = '08/30/2023 04:45 AM';
const dataFechaAcualizado = '8/30/2023' + ' 12:40:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 21, MVar:'0', Cost:27.65, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.87, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.06, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 70, MVar:'15', Cost:27.87, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'19', Cost:18.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'69', Cost:16.72, ParentId: '15'},
