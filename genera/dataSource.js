const timestamp_saved = '09/04/2023 07:30 AM';
const dataFechaAcualizado = '9/4/2023' + ' 3:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'37', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'42', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'54', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'1', Cost:26.47, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.72, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'60', Cost:10.59, ParentId: '17'},
		]
	},
