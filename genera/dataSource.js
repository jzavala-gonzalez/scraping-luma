const timestamp_saved = '09/23/2023 05:40 PM';
const dataFechaAcualizado = '9/23/2023' + ' 1:35:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'52', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'55', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'67', Cost:10.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 89,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 89, MVar:'0', Cost:5.17, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 68, MVar:'19', Cost:29.87, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 128, MVar:'45', Cost:20.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:20.62, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 125, MVar:'0', Cost:8.72, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:8.72, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 49,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'11', Cost:29.40, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 86,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 86, MVar:'24', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'67', Cost:19.28, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'107', Cost:9.50, ParentId: '17'},
		]
	},
