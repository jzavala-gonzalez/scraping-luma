const timestamp_saved = '09/27/2023 10:45 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'36', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'35', Cost:10.44, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 235,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 235, MVar:'144', Cost:18.24, ParentId: '16'},
		]
	},
