const timestamp_saved = '10/14/2023 11:10 AM';
const dataFechaAcualizado = '10/14/2023' + ' 7:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'47', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'46', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'51', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.61, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'6', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 139,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 139, MVar:'78', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'68', Cost:9.27, ParentId: '17'},
		]
	},
