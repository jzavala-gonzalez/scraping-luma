const timestamp_saved = '11/27/2023 05:35 PM';
const dataFechaAcualizado = '11/27/2023' + ' 1:31:23 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2145},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'35', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'45', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'57', Cost:10.98, ParentId: '7'},
		]
	},
