const timestamp_saved = '09/27/2023 09:45 AM';
const dataFechaAcualizado = '9/27/2023' + ' 5:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'28', Cost:11.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'29', Cost:11.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'61', Cost:11.51, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 360,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 360, MVar:'76', Cost:9.07, ParentId: '17'},
		]
	},
