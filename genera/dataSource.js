const timestamp_saved = '09/29/2023 12:05 PM';
const dataFechaAcualizado = '9/29/2023' + ' 8:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'33', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'30', Cost:12.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 298,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:18.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:18.21, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:20.80, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 34, MVar:'0', Cost:20.80, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'13', Cost:19.13, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'86', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'122', Cost:17.80, ParentId: '16'},
		]
	},
