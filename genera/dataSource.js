const timestamp_saved = '11/29/2023 08:50 AM';
const dataFechaAcualizado = '11/29/2023' + ' 4:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'22', Cost:12.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'32', Cost:12.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'46', Cost:12.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 384,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.84, ParentId: '11'},
