const timestamp_saved = '09/06/2023 03:50 PM';
const dataFechaAcualizado = '9/6/2023' + ' 11:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 191,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'58', Cost:20.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'38', Cost:20.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:20.21, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'25', Cost:18.44, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'148', Cost:17.64, ParentId: '16'},
		]
	},
