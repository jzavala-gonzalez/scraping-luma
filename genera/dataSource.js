const timestamp_saved = '09/30/2023 10:40 AM';
const dataFechaAcualizado = '9/30/2023' + ' 6:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'33', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'31', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'48', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 208,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:17.59, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'130', Cost:16.96, ParentId: '16'},
		]
	},
