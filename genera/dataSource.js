const timestamp_saved = '08/20/2023 07:40 AM';
const dataFechaAcualizado = '8/20/2023' + ' 3:37:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'50', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'52', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'94', Cost:16.54, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'66', Cost:9.16, ParentId: '17'},
		]
	},
