const timestamp_saved = '10/26/2023 07:01 PM';
const dataFechaAcualizado = '10/26/2023' + ' 2:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'53', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'57', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'57', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:16.98, ParentId: '11'},
