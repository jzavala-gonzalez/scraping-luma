const timestamp_saved = '07/29/2023 08:55 AM';
const dataFechaAcualizado = '7/29/2023' + ' 4:50:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'45', Cost:10.97, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 135, MVar:'25', Cost:15.90, ParentId: '15'},
		]
	},
