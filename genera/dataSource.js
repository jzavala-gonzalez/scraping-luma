const timestamp_saved = '10/11/2023 07:40 AM';
const dataFechaAcualizado = '10/11/2023' + ' 3:36:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'45', Cost:13.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'48', Cost:13.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'58', Cost:13.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:8.50, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'138', Cost:17.12, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'60', Cost:9.12, ParentId: '17'},
		]
	},
