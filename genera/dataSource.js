const timestamp_saved = '11/26/2023 02:05 PM';
const dataFechaAcualizado = '11/26/2023' + ' 10:01:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1790},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'19', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'29', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'18', Cost:19.08, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'116', Cost:19.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'64', Cost:10.13, ParentId: '17'},
		]
	},
