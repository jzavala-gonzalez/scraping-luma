const timestamp_saved = '09/26/2023 06:15 AM';
const dataFechaAcualizado = '9/26/2023' + ' 2:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'48', Cost:11.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'50', Cost:11.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'58', Cost:11.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 75, MVar:'0', Cost:6.39, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'11', Cost:18.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'1', Cost:19.30, ParentId: '14'},
