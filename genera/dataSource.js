const timestamp_saved = '08/23/2023 08:15 PM';
const dataFechaAcualizado = '8/23/2023' + ' 4:10:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'57', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'54', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'7', Cost:43.57, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'16', Cost:30.82, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'47', Cost:19.63, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'29', Cost:19.32, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'92', Cost:9.33, ParentId: '17'},
		]
	},
