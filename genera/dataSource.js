const timestamp_saved = '11/04/2023 03:10 PM';
const dataFechaAcualizado = '11/4/2023' + ' 11:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:13.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'43', Cost:13.01, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'91', Cost:16.95, ParentId: '15'},
