const timestamp_saved = '08/01/2023 05:35 AM';
const dataFechaAcualizado = '8/1/2023' + ' 1:30:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'46', Cost:10.51, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 293,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'0', Cost:17.32, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 37, MVar:'7', Cost:17.32, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'144', Cost:17.26, ParentId: '16'},
		]
	},
