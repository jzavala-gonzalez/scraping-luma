const timestamp_saved = '10/22/2023 05:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 1:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'46', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'47', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'49', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'67', Cost:11.24, ParentId: '17'},
		]
	},
