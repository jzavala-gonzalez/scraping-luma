const timestamp_saved = '09/17/2023 12:25 PM';
const dataFechaAcualizado = '9/17/2023' + ' 8:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'41', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'41', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'72', Cost:9.40, ParentId: '17'},
		]
	},
