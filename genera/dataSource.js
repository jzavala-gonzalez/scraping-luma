const timestamp_saved = '08/20/2023 08:05 AM';
const dataFechaAcualizado = '8/20/2023' + ' 4:02:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'51', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'51', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'3', Cost:29.46, ParentId: '13'},
