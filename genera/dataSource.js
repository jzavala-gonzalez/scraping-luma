const timestamp_saved = '08/31/2023 04:50 PM';
const dataFechaAcualizado = '8/31/2023' + ' 12:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'52', Cost:10.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'60', Cost:10.68, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'43', Cost:19.51, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'100', Cost:9.33, ParentId: '17'},
		]
	},
