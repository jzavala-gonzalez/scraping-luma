const timestamp_saved = '08/02/2023 10:25 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:20:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'40', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.55, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'146', Cost:17.20, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'88', Cost:10.86, ParentId: '17'},
		]
	},
