const timestamp_saved = '09/29/2023 06:15 AM';
const dataFechaAcualizado = '9/29/2023' + ' 2:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'35', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'32', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'49', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:17.58, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'54', Cost:16.89, ParentId: '15'},
