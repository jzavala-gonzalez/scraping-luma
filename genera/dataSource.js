const timestamp_saved = '08/24/2023 03:05 PM';
const dataFechaAcualizado = '8/24/2023' + ' 11:00:45 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 230, MVar:'76', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'90', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'58', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'55', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'7', Cost:27.11, ParentId: '9'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'81', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'183', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'99', Cost:9.24, ParentId: '17'},
		]
	},
