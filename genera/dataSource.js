const timestamp_saved = '10/05/2023 01:45 PM';
const dataFechaAcualizado = '10/5/2023' + ' 9:41:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'41', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'40', Cost:10.83, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'106', Cost:9.30, ParentId: '17'},
		]
	},
