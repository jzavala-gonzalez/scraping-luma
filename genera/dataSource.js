const timestamp_saved = '07/27/2023 05:16 PM';
const dataFechaAcualizado = '7/27/2023' + ' 1:10:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'56', Cost:10.65, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:19.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:19.75, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'87', Cost:13.18, ParentId: '17'},
		]
	},
