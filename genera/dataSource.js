const timestamp_saved = '08/21/2023 01:10 AM';
const dataFechaAcualizado = '8/20/2023' + ' 9:07:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'47', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'60', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 51, MVar:'10', Cost:21.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'86', Cost:9.17, ParentId: '17'},
		]
	},
