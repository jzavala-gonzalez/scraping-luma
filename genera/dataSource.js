const timestamp_saved = '10/18/2023 09:35 AM';
const dataFechaAcualizado = '10/18/2023' + ' 5:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'37', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.74, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 59,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 59, MVar:'69', Cost:21.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'86', Cost:10.63, ParentId: '17'},
		]
	},
