const timestamp_saved = '08/02/2023 06:20 AM';
const dataFechaAcualizado = '8/2/2023' + ' 2:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'42', Cost:10.46, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'2', Cost:28.81, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'67', Cost:17.34, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 130, MVar:'40', Cost:16.03, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'84', Cost:11.00, ParentId: '17'},
		]
	},
