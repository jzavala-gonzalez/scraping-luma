const timestamp_saved = '08/12/2023 06:30 AM';
const dataFechaAcualizado = '8/12/2023' + ' 2:27:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'93', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'101', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'55', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'51', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'7', Cost:29.32, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'179', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'114', Cost:11.63, ParentId: '17'},
		]
	},
