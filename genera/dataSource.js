const timestamp_saved = '12/06/2023 05:05 PM';
const dataFechaAcualizado = '12/6/2023' + ' 1:00:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 550},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'50', Cost:12.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'57', Cost:12.54, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'69', Cost:14.58, ParentId: '17'},
		]
	},
