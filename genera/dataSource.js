const timestamp_saved = '10/20/2023 11:55 AM';
const dataFechaAcualizado = '10/20/2023' + ' 7:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'40', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'47', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'101', Cost:10.54, ParentId: '17'},
		]
	},
