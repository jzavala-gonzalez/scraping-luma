const timestamp_saved = '08/01/2023 10:05 AM';
const dataFechaAcualizado = '8/1/2023' + ' 6:00:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'41', Cost:11.17, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'0', Cost:18.13, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'86', Cost:16.60, ParentId: '15'},
