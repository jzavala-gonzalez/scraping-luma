const timestamp_saved = '10/15/2023 09:10 AM';
const dataFechaAcualizado = '10/15/2023' + ' 5:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'48', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'50', Cost:10.90, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'91', Cost:17.11, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 225,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 225, MVar:'51', Cost:9.94, ParentId: '17'},
		]
	},
