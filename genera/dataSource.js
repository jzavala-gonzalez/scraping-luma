const timestamp_saved = '08/04/2023 03:40 PM';
const dataFechaAcualizado = '8/4/2023' + ' 11:35:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'42', Cost:11.39, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 15, MVar:'1', Cost:26.79, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 147, MVar:'43', Cost:20.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:20.01, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 249,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'86', Cost:18.42, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'40', Cost:15.64, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 257,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 257, MVar:'148', Cost:17.68, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 10, MVar:'7', Cost:18.32, ParentId: '19'},
