const timestamp_saved = '11/05/2023 04:35 PM';
const dataFechaAcualizado = '11/5/2023' + ' 12:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'43', Cost:13.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'43', Cost:13.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:8.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'8', Cost:8.77, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'56', Cost:9.92, ParentId: '17'},
		]
	},
