const timestamp_saved = '10/13/2023 05:35 AM';
const dataFechaAcualizado = '10/13/2023' + ' 1:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'59', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'64', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'68', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'0', Cost:20.83, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 29,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'12', Cost:31.33, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:17.43, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'182', Cost:18.25, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'73', Cost:9.14, ParentId: '17'},
		]
	},
