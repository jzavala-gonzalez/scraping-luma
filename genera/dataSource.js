const timestamp_saved = '10/07/2023 09:40 PM';
const dataFechaAcualizado = '10/7/2023' + ' 5:36:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 179, MVar:'65', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'52', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'54', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'50', Cost:10.33, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 3, MVar:'0', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'4', Cost:26.75, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.38, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 47, MVar:'9', Cost:28.98, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 89,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'6', Cost:38.96, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 67, MVar:'12', Cost:19.52, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 143, MVar:'92', Cost:16.32, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'173', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'111', Cost:9.19, ParentId: '17'},
		]
	},
