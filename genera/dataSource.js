const timestamp_saved = '09/03/2023 12:00 AM';
const dataFechaAcualizado = '9/2/2023' + ' 7:55:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'54', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'62', Cost:10.57, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'6', Cost:21.97, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.66, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'13', Cost:27.40, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'67', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'152', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'91', Cost:9.20, ParentId: '17'},
		]
	},
