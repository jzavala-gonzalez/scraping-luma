const timestamp_saved = '10/15/2023 06:05 AM';
const dataFechaAcualizado = '10/15/2023' + ' 2:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'54', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'56', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'71', Cost:9.15, ParentId: '17'},
		]
	},
