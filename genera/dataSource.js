const timestamp_saved = '10/04/2023 01:35 AM';
const dataFechaAcualizado = '10/3/2023' + ' 9:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'39', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'39', Cost:11.19, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'12', Cost:18.83, ParentId: '14'},
