const timestamp_saved = '10/25/2023 04:45 AM';
const dataFechaAcualizado = '10/25/2023' + ' 12:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'46', Cost:10.55, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 73,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 73, MVar:'12', Cost:27.96, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:29.99, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 189,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'131', Cost:18.78, ParentId: '16'},
		]
	},
