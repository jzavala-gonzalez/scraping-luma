const timestamp_saved = '08/05/2023 03:10 AM';
const dataFechaAcualizado = '8/4/2023' + ' 11:05:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'46', Cost:10.56, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'87', Cost:16.97, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'49', Cost:15.60, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 327, MVar:'144', Cost:16.90, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'95', Cost:11.41, ParentId: '17'},
		]
	},
