const timestamp_saved = '11/12/2023 04:10 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'44', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'48', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'55', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 4, MVar:'1', Cost:26.09, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'12', Cost:31.13, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'1', Cost:31.68, ParentId: '13'},
