const timestamp_saved = '10/01/2023 12:15 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 306,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 55, MVar:'56', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'26', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'23', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'41', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'2', Cost:30.75, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'105', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'82', Cost:9.48, ParentId: '17'},
		]
	},
