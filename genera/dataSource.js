const timestamp_saved = '07/31/2023 01:55 PM';
const dataFechaAcualizado = '7/31/2023' + ' 9:50:35 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1048},
	{Index:'5', Desc:'Capacidad Disponible', value: 3552},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'49', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'45', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'50', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.30, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:17.30, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'89', Cost:11.15, ParentId: '17'},
		]
	},
