const timestamp_saved = '10/22/2023 02:36 PM';
const dataFechaAcualizado = '10/22/2023' + ' 10:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'40', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'41', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'46', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'16', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'85', Cost:17.65, ParentId: '15'},
