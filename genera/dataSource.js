const timestamp_saved = '10/25/2023 09:30 AM';
const dataFechaAcualizado = '10/25/2023' + ' 5:26:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'44', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'45', Cost:10.82, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 136, MVar:'42', Cost:17.20, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:17.20, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'43', Cost:17.70, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'8', Cost:17.70, ParentId: '11'},
		]
	},
