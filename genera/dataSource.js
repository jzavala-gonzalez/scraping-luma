const timestamp_saved = '09/25/2023 10:45 AM';
const dataFechaAcualizado = '9/25/2023' + ' 6:40:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'36', Cost:12.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'38', Cost:12.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:12.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:21.09, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'56', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 156,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 156, MVar:'121', Cost:21.09, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'74', Cost:9.87, ParentId: '17'},
		]
	},
