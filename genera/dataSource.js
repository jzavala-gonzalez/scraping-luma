const timestamp_saved = '11/01/2023 11:10 AM';
const dataFechaAcualizado = '11/1/2023' + ' 7:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'54', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'58', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'63', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:18.49, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 11,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 3, MVar:'8', Cost:19.60, ParentId: '19'},
