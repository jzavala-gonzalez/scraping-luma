const timestamp_saved = '11/04/2023 06:45 PM';
const dataFechaAcualizado = '11/4/2023' + ' 2:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'54', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'53', Cost:10.32, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'6', Cost:17.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 62, MVar:'11', Cost:20.38, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'70', Cost:9.84, ParentId: '17'},
		]
	},
