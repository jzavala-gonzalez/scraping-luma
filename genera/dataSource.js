const timestamp_saved = '09/30/2023 06:35 PM';
const dataFechaAcualizado = '9/30/2023' + ' 2:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'38', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'34', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'50', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 162,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:18.13, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'17', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'78', Cost:16.59, ParentId: '15'},
