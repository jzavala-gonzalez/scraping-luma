const timestamp_saved = '07/30/2023 08:20 AM';
const dataFechaAcualizado = '7/30/2023' + ' 4:15:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'42', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'38', Cost:11.39, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:21.35, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'5', Cost:31.44, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 137, MVar:'43', Cost:17.34, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.34, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 137, MVar:'0', Cost:17.14, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'9', Cost:17.14, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.33, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 16, MVar:'9', Cost:33.02, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'68', Cost:17.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 154,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 154, MVar:'62', Cost:21.35, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'64', Cost:11.15, ParentId: '17'},
		]
	},
