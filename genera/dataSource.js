const timestamp_saved = '11/08/2023 09:15 PM';
const dataFechaAcualizado = '11/8/2023' + ' 5:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'54', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'54', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 68, MVar:'9', Cost:19.85, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'173', Cost:17.13, ParentId: '16'},
		]
	},
