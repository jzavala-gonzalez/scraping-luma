const timestamp_saved = '08/17/2023 08:15 PM';
const dataFechaAcualizado = '8/17/2023' + ' 4:12:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'69', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'77', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 46,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'4', Cost:46.86, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'28', Cost:18.49, ParentId: '14'},
