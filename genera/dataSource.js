const timestamp_saved = '10/13/2023 09:30 PM';
const dataFechaAcualizado = '10/13/2023' + ' 5:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'62', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'67', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'70', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'18', Cost:27.92, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'20', Cost:19.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'95', Cost:16.77, ParentId: '15'},
