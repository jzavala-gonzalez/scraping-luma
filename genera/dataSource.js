const timestamp_saved = '10/13/2023 02:20 PM';
const dataFechaAcualizado = '10/13/2023' + ' 10:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'61', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'65', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'69', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'12', Cost:43.49, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:16.83, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'2', Cost:31.40, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'185', Cost:18.24, ParentId: '16'},
		]
	},
