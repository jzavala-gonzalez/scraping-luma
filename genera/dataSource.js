const timestamp_saved = '09/29/2023 06:25 AM';
const dataFechaAcualizado = '9/29/2023' + ' 2:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 309,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'34', Cost:12.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'30', Cost:12.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'49', Cost:12.56, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'56', Cost:16.84, ParentId: '15'},
