const timestamp_saved = '09/11/2023 11:05 AM';
const dataFechaAcualizado = '9/11/2023' + ' 7:00:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'72', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'65', Cost:10.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'64', Cost:10.79, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'139', Cost:16.76, ParentId: '16'},
		]
	},
