const timestamp_saved = '10/04/2023 05:10 AM';
const dataFechaAcualizado = '10/4/2023' + ' 1:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'35', Cost:11.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'34', Cost:11.54, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 16,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 16, MVar:'7', Cost:27.44, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:16.84, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'138', Cost:17.15, ParentId: '16'},
		]
	},
