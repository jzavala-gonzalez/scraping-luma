const timestamp_saved = '11/03/2023 10:35 AM';
const dataFechaAcualizado = '11/3/2023' + ' 6:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'47', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'45', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'45', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'64', Cost:9.40, ParentId: '17'},
		]
	},
