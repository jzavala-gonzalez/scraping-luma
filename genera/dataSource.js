const timestamp_saved = '11/20/2023 07:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 3:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 357,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'28', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'38', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'51', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.65, ParentId: '11'},
