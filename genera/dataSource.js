const timestamp_saved = '09/11/2023 10:50 AM';
const dataFechaAcualizado = '9/11/2023' + ' 6:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'65', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'64', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'64', Cost:10.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 85,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 85, MVar:'0', Cost:9.39, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:30.76, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'136', Cost:16.74, ParentId: '16'},
		]
	},
