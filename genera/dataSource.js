const timestamp_saved = '11/21/2023 09:15 AM';
const dataFechaAcualizado = '11/21/2023' + ' 5:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'22', Cost:12.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'31', Cost:12.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.21, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'67', Cost:9.58, ParentId: '17'},
		]
	},
