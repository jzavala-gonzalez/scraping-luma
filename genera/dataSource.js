const timestamp_saved = '09/01/2023 06:50 AM';
const dataFechaAcualizado = '9/1/2023' + ' 2:45:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'38', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'45', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'58', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'5', Cost:30.83, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:20.53, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'70', Cost:16.98, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'134', Cost:16.98, ParentId: '16'},
		]
	},
