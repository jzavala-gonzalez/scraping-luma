const timestamp_saved = '09/10/2023 01:55 PM';
const dataFechaAcualizado = '9/10/2023' + ' 9:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'62', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'61', Cost:11.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'61', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 245,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 245, MVar:'125', Cost:17.84, ParentId: '16'},
		]
	},
