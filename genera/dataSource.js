const timestamp_saved = '10/03/2023 09:05 PM';
const dataFechaAcualizado = '10/3/2023' + ' 5:00:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'40', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'52', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'12', Cost:17.00, ParentId: '11'},
		]
	},
