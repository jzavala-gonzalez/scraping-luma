const timestamp_saved = '11/08/2023 06:55 PM';
const dataFechaAcualizado = '11/8/2023' + ' 2:51:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'56', Cost:10.82, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 67, MVar:'10', Cost:19.88, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'109', Cost:9.24, ParentId: '17'},
		]
	},
