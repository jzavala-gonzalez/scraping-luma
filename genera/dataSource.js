const timestamp_saved = '10/22/2023 08:45 AM';
const dataFechaAcualizado = '10/22/2023' + ' 4:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'41', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'45', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'37', Cost:18.17, ParentId: '11'},
