const timestamp_saved = '08/29/2023 04:10 AM';
const dataFechaAcualizado = '8/29/2023' + ' 12:05:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'50', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'57', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'60', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 144,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 66, MVar:'13', Cost:27.97, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 79, MVar:'16', Cost:27.91, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'2', Cost:31.35, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'82', Cost:16.87, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'97', Cost:9.18, ParentId: '17'},
		]
	},
