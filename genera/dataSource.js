const timestamp_saved = '11/28/2023 01:45 AM';
const dataFechaAcualizado = '11/27/2023' + ' 9:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'39', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'51', Cost:10.64, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'12', Cost:17.49, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'49', Cost:8.08, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 52, MVar:'14', Cost:8.08, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:30.34, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.19, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 234,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'179', Cost:17.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'111', Cost:9.13, ParentId: '17'},
		]
	},
