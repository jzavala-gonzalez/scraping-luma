const timestamp_saved = '11/14/2023 01:45 AM';
const dataFechaAcualizado = '11/13/2023' + ' 9:41:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'65', Cost:9.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 179, MVar:'71', Cost:9.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 205, MVar:'68', Cost:9.81, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'28', Cost:28.04, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'15', Cost:30.99, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'14', Cost:28.67, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 44, MVar:'12', Cost:22.53, ParentId: '14'},
