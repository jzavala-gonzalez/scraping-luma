const timestamp_saved = '11/14/2023 04:10 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:06:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'49', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'53', Cost:11.81, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 71,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:25.15, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 105, MVar:'153', Cost:25.15, ParentId: '16'},
		]
	},
