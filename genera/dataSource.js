const timestamp_saved = '10/12/2023 05:05 PM';
const dataFechaAcualizado = '10/12/2023' + ' 1:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'60', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'64', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'69', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'181', Cost:17.38, ParentId: '16'},
		]
	},
