const timestamp_saved = '10/07/2023 11:00 PM';
const dataFechaAcualizado = '10/7/2023' + ' 6:56:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 180, MVar:'72', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'57', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'58', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'53', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:16.94, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'14', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'190', Cost:16.64, ParentId: '16'},
		]
	},
