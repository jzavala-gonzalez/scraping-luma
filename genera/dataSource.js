const timestamp_saved = '10/17/2023 08:46 PM';
const dataFechaAcualizado = '10/17/2023' + ' 4:41:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'67', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'66', Cost:10.82, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'5', Cost:23.92, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:16.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:16.67, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'11', Cost:31.21, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'13', Cost:18.61, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'116', Cost:9.23, ParentId: '17'},
		]
	},
