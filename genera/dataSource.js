const timestamp_saved = '10/02/2023 03:05 PM';
const dataFechaAcualizado = '10/2/2023' + ' 11:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'41', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'39', Cost:10.80, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'160', Cost:17.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'109', Cost:9.20, ParentId: '17'},
		]
	},
