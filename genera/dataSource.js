const timestamp_saved = '10/20/2023 09:40 PM';
const dataFechaAcualizado = '10/20/2023' + ' 5:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'39', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'45', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'45', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.69, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 313,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 313, MVar:'152', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'97', Cost:10.54, ParentId: '17'},
		]
	},
