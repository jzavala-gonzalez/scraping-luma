const timestamp_saved = '12/05/2023 03:00 AM';
const dataFechaAcualizado = '12/4/2023' + ' 10:56:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'49', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'51', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'58', Cost:11.43, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 21,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 1, MVar:'0', Cost:28.43, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 44,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 13, MVar:'0', Cost:31.22, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'4', Cost:18.77, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'18', Cost:18.73, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'77', Cost:10.85, ParentId: '17'},
		]
	},
