const timestamp_saved = '08/02/2023 03:45 PM';
const dataFechaAcualizado = '8/2/2023' + ' 11:40:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'43', Cost:11.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.20, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.44, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 128, MVar:'26', Cost:15.35, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 323, MVar:'159', Cost:17.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'92', Cost:11.03, ParentId: '17'},
		]
	},
