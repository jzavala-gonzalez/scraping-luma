const timestamp_saved = '08/15/2023 01:55 AM';
const dataFechaAcualizado = '8/14/2023' + ' 9:52:53 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 77},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 247, MVar:'79', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'105', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 556,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'54', Cost:9.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 179, MVar:'58', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 202, MVar:'56', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.12, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'18', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'195', Cost:16.58, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'141', Cost:11.63, ParentId: '17'},
		]
	},
