const timestamp_saved = '11/25/2023 09:35 AM';
const dataFechaAcualizado = '11/25/2023' + ' 5:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 231,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'58', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'21', Cost:12.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'28', Cost:12.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'47', Cost:12.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:17.90, ParentId: '11'},
