const timestamp_saved = '10/02/2023 11:00 AM';
const dataFechaAcualizado = '10/2/2023' + ' 6:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'35', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'33', Cost:10.77, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'97', Cost:9.20, ParentId: '17'},
		]
	},
