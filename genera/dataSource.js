const timestamp_saved = '11/24/2023 05:20 AM';
const dataFechaAcualizado = '11/24/2023' + ' 1:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'25', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'34', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'79', Cost:9.20, ParentId: '17'},
		]
	},
