const timestamp_saved = '11/06/2023 02:55 PM';
const dataFechaAcualizado = '11/6/2023' + ' 10:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'54', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'53', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'49', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:17.07, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:49.74, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'94', Cost:16.92, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'80', Cost:9.79, ParentId: '17'},
		]
	},
