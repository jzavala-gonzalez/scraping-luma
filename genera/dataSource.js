const timestamp_saved = '12/01/2023 04:20 PM';
const dataFechaAcualizado = '12/1/2023' + ' 12:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 302,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'46', Cost:13.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'49', Cost:13.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'52', Cost:13.14, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'24', Cost:19.26, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'71', Cost:9.57, ParentId: '17'},
		]
	},
