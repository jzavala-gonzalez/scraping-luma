const timestamp_saved = '08/03/2023 05:40 PM';
const dataFechaAcualizado = '8/3/2023' + ' 1:35:37 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3598},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 145, MVar:'49', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'92', Cost:11.38, ParentId: '17'},
		]
	},
