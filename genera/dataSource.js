const timestamp_saved = '09/04/2023 07:20 AM';
const dataFechaAcualizado = '9/4/2023' + ' 3:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'39', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'42', Cost:10.25, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'16', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 201,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 201, MVar:'58', Cost:10.50, ParentId: '17'},
		]
	},
