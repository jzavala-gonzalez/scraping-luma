const timestamp_saved = '10/01/2023 06:50 PM';
const dataFechaAcualizado = '10/1/2023' + ' 2:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'34', Cost:10.27, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'34', Cost:10.27, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'49', Cost:10.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 254,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:18.42, ParentId: '11'},
