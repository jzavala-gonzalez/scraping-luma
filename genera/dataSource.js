const timestamp_saved = '12/02/2023 02:40 AM';
const dataFechaAcualizado = '12/1/2023' + ' 10:36:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'52', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'54', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'56', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'3', Cost:29.26, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'3', Cost:32.25, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'13', Cost:19.84, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 223,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 223, MVar:'78', Cost:9.87, ParentId: '17'},
		]
	},
