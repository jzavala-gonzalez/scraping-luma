const timestamp_saved = '11/24/2023 06:30 PM';
const dataFechaAcualizado = '11/24/2023' + ' 2:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'31', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'41', Cost:10.61, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'84', Cost:9.86, ParentId: '17'},
		]
	},
