const timestamp_saved = '12/05/2023 02:35 AM';
const dataFechaAcualizado = '12/4/2023' + ' 10:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'51', Cost:11.02, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 178,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 89, MVar:'6', Cost:19.09, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'80', Cost:10.87, ParentId: '17'},
		]
	},
