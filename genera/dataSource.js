const timestamp_saved = '09/04/2023 01:45 PM';
const dataFechaAcualizado = '9/4/2023' + ' 9:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'38', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'43', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'55', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'68', Cost:9.39, ParentId: '17'},
		]
	},
