const timestamp_saved = '10/05/2023 08:30 PM';
const dataFechaAcualizado = '10/5/2023' + ' 4:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'48', Cost:10.31, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'134', Cost:9.19, ParentId: '17'},
		]
	},
