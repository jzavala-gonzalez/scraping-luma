const timestamp_saved = '11/08/2023 06:00 AM';
const dataFechaAcualizado = '11/8/2023' + ' 1:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'40', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'39', Cost:10.69, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'69', Cost:9.84, ParentId: '17'},
		]
	},
