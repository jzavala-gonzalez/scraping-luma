const timestamp_saved = '11/16/2023 06:45 AM';
const dataFechaAcualizado = '11/16/2023' + ' 2:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'42', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'42', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'49', Cost:11.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 182,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 182, MVar:'56', Cost:10.85, ParentId: '17'},
		]
	},
