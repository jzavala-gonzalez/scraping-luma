const timestamp_saved = '10/14/2023 03:05 AM';
const dataFechaAcualizado = '10/13/2023' + ' 11:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'64', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'69', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'71', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:31.92, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.78, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 325,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 325, MVar:'162', Cost:16.93, ParentId: '16'},
		]
	},
