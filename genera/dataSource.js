const timestamp_saved = '10/16/2023 05:45 AM';
const dataFechaAcualizado = '10/16/2023' + ' 1:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'51', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'48', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'53', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 322,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 322, MVar:'144', Cost:16.81, ParentId: '16'},
		]
	},
