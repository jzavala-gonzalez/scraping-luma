const timestamp_saved = '11/26/2023 10:50 AM';
const dataFechaAcualizado = '11/26/2023' + ' 6:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 304,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'18', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'26', Cost:12.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'44', Cost:12.93, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'109', Cost:18.26, ParentId: '16'},
		]
	},
