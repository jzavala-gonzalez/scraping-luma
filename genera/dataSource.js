const timestamp_saved = '11/24/2023 08:15 AM';
const dataFechaAcualizado = '11/24/2023' + ' 4:11:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'20', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'29', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'47', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'62', Cost:9.90, ParentId: '17'},
		]
	},
