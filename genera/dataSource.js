const timestamp_saved = '09/05/2023 07:40 AM';
const dataFechaAcualizado = '9/5/2023' + ' 3:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'35', Cost:12.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'40', Cost:12.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'53', Cost:12.05, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.32, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'67', Cost:9.31, ParentId: '17'},
		]
	},
