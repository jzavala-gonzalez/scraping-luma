const timestamp_saved = '08/01/2023 07:45 AM';
const dataFechaAcualizado = '8/1/2023' + ' 3:40:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'44', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'40', Cost:11.26, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 164, MVar:'33', Cost:15.51, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'134', Cost:17.81, ParentId: '16'},
		]
	},
