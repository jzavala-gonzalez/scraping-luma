const timestamp_saved = '10/01/2023 06:15 PM';
const dataFechaAcualizado = '10/1/2023' + ' 2:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'36', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'34', Cost:10.34, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'136', Cost:17.47, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'104', Cost:9.22, ParentId: '17'},
		]
	},
