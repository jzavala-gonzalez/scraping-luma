const timestamp_saved = '08/09/2023 03:20 AM';
const dataFechaAcualizado = '8/8/2023' + ' 11:15:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'60', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'56', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'39', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'46', Cost:11.09, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'31', Cost:18.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 308,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 308, MVar:'131', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 343,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 343, MVar:'75', Cost:12.22, ParentId: '17'},
		]
	},
