const timestamp_saved = '11/30/2023 07:45 PM';
const dataFechaAcualizado = '11/30/2023' + ' 3:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 500,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'59', Cost:10.33, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.43, ParentId: '11'},
