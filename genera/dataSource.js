const timestamp_saved = '09/23/2023 07:00 AM';
const dataFechaAcualizado = '9/23/2023' + ' 2:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'39', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'42', Cost:11.45, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'5', Cost:30.84, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'74', Cost:9.43, ParentId: '17'},
		]
	},
