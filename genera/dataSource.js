const timestamp_saved = '08/17/2023 10:15 AM';
const dataFechaAcualizado = '8/17/2023' + ' 6:12:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'59', Cost:10.80, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'18', Cost:18.75, ParentId: '14'},
