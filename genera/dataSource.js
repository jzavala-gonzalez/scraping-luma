const timestamp_saved = '08/09/2023 09:05 AM';
const dataFechaAcualizado = '8/9/2023' + ' 5:00:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'38', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'44', Cost:10.91, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.03, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'64', Cost:13.00, ParentId: '17'},
		]
	},
