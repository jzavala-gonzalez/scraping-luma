const timestamp_saved = '09/24/2023 10:30 AM';
const dataFechaAcualizado = '9/24/2023' + ' 6:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'38', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'41', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'45', Cost:20.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.52, ParentId: '11'},
