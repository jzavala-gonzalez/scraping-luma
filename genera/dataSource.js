const timestamp_saved = '08/27/2023 04:50 PM';
const dataFechaAcualizado = '8/27/2023' + ' 12:45:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'27', Cost:14.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 35, MVar:'12', Cost:14.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 98, MVar:'57', Cost:14.09, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 47,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 47, MVar:'6', Cost:31.59, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 139, MVar:'0', Cost:8.36, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'11', Cost:8.36, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'27', Cost:19.12, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'77', Cost:16.61, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 241,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 241, MVar:'79', Cost:12.52, ParentId: '17'},
		]
	},
