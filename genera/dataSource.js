const timestamp_saved = '10/31/2023 06:20 AM';
const dataFechaAcualizado = '10/31/2023' + ' 2:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'47', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'50', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'57', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'59', Cost:9.17, ParentId: '17'},
		]
	},
