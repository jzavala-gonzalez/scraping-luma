const timestamp_saved = '12/06/2023 07:30 AM';
const dataFechaAcualizado = '12/6/2023' + ' 3:25:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 559},
	{Index:'6', Desc:'Reserva Operacional', value: 1153},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'39', Cost:12.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'43', Cost:12.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'52', Cost:12.31, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 381,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.97, ParentId: '11'},
