const timestamp_saved = '08/10/2023 03:20 AM';
const dataFechaAcualizado = '8/9/2023' + ' 11:15:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'57', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'59', Cost:11.39, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 189,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:30.99, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'5', Cost:26.97, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 103,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'13', Cost:31.33, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.20, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'24', Cost:18.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 349,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 349, MVar:'171', Cost:16.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 339,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 339, MVar:'89', Cost:11.34, ParentId: '17'},
		]
	},
