const timestamp_saved = '11/16/2023 12:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 8:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'61', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'61', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'61', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'6', Cost:26.39, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'4', Cost:31.27, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'86', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 359,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 359, MVar:'107', Cost:9.18, ParentId: '17'},
		]
	},
