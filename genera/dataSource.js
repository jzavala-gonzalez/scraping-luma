const timestamp_saved = '10/18/2023 08:31 PM';
const dataFechaAcualizado = '10/18/2023' + ' 4:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'50', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'55', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'65', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'26', Cost:31.03, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'20', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'113', Cost:10.51, ParentId: '17'},
		]
	},
