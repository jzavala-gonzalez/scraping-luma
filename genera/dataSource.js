const timestamp_saved = '10/24/2023 09:00 AM';
const dataFechaAcualizado = '10/24/2023' + ' 4:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'40', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'43', Cost:11.09, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'61', Cost:11.30, ParentId: '17'},
		]
	},
