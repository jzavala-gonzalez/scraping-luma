const timestamp_saved = '10/20/2023 01:05 PM';
const dataFechaAcualizado = '10/20/2023' + ' 9:01:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'43', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'50', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:18.11, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 126,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 126, MVar:'84', Cost:17.67, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'156', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'107', Cost:10.55, ParentId: '17'},
		]
	},
