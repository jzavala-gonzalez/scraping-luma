const timestamp_saved = '10/15/2023 07:50 AM';
const dataFechaAcualizado = '10/15/2023' + ' 3:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'48', Cost:12.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'48', Cost:12.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'54', Cost:12.58, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'0', Cost:31.02, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'63', Cost:9.15, ParentId: '17'},
		]
	},
