const timestamp_saved = '11/28/2023 09:05 AM';
const dataFechaAcualizado = '11/28/2023' + ' 5:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'24', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'33', Cost:11.25, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 212,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 212, MVar:'114', Cost:18.62, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 289,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 289, MVar:'74', Cost:9.52, ParentId: '17'},
		]
	},
