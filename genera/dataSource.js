const timestamp_saved = '08/23/2023 08:00 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:55:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'43', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'36', Cost:20.40, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'123', Cost:18.26, ParentId: '16'},
		]
	},
