const timestamp_saved = '11/05/2023 01:00 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:56:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1925},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'41', Cost:12.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'41', Cost:12.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'40', Cost:12.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'36', Cost:17.65, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'10', Cost:17.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'50', Cost:9.80, ParentId: '17'},
		]
	},
