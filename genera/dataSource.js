const timestamp_saved = '08/19/2023 11:55 AM';
const dataFechaAcualizado = '8/19/2023' + ' 7:52:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'50', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'48', Cost:10.64, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 73, MVar:'26', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 108,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'7', Cost:30.57, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 54, MVar:'9', Cost:30.52, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 74,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'4', Cost:29.43, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'91', Cost:17.61, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'135', Cost:17.80, ParentId: '16'},
		]
	},
