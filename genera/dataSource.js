const timestamp_saved = '10/15/2023 05:06 AM';
const dataFechaAcualizado = '10/15/2023' + ' 1:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'52', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'54', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'56', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 69, MVar:'23', Cost:38.24, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'4', Cost:38.24, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'87', Cost:17.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'135', Cost:17.24, ParentId: '16'},
		]
	},
