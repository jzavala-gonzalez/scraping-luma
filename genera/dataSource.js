const timestamp_saved = '07/27/2023 05:33 AM';
const dataFechaAcualizado = '7/27/2023' + ' 1:25:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 425,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 178, MVar:'73', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'55', Cost:10.56, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 307,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 101, MVar:'0', Cost:8.75, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'17', Cost:18.69, ParentId: '14'},
