const timestamp_saved = '10/08/2023 07:35 PM';
const dataFechaAcualizado = '10/8/2023' + ' 3:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'49', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'51', Cost:10.24, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 159,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 159, MVar:'94', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 305,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 305, MVar:'159', Cost:17.26, ParentId: '16'},
		]
	},
