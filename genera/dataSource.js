const timestamp_saved = '12/03/2023 06:05 AM';
const dataFechaAcualizado = '12/3/2023' + ' 2:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 214,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 214, MVar:'63', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'41', Cost:10.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'43', Cost:10.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:10.81, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'10', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'100', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'56', Cost:11.65, ParentId: '17'},
		]
	},
