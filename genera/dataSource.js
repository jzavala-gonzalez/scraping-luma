const timestamp_saved = '12/06/2023 06:50 PM';
const dataFechaAcualizado = '12/6/2023' + ' 2:45:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 364},
	{Index:'6', Desc:'Reserva Operacional', value: 728},
	{Index:'7', Desc:'Capacidad Disponible', value: 3000},
	{Index:'8', Desc:'Próxima Hora MW', value: 2243},
	{Index:'9', Desc:'Máxima para Hoy', value: 2281},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'59', Cost:10.12, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 133, MVar:'38', Cost:17.81, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.81, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'84', Cost:14.16, ParentId: '17'},
		]
	},
