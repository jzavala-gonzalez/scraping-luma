const timestamp_saved = '09/05/2023 07:45 AM';
const dataFechaAcualizado = '9/5/2023' + ' 3:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'35', Cost:12.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'40', Cost:12.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'53', Cost:12.18, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'6', Cost:30.87, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.54, ParentId: '12'},
