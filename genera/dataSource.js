const timestamp_saved = '11/03/2023 09:50 AM';
const dataFechaAcualizado = '11/3/2023' + ' 5:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'46', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'45', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'43', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'62', Cost:9.42, ParentId: '17'},
		]
	},
