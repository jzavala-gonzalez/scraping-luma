const timestamp_saved = '09/06/2023 05:50 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:45:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'46', Cost:13.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'47', Cost:13.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'60', Cost:13.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'11', Cost:20.48, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'149', Cost:16.69, ParentId: '16'},
		]
	},
