const timestamp_saved = '11/15/2023 07:25 AM';
const dataFechaAcualizado = '11/15/2023' + ' 3:21:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'33', Cost:13.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'36', Cost:13.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 105, MVar:'44', Cost:13.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'66', Cost:16.78, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'59', Cost:9.75, ParentId: '17'},
		]
	},
