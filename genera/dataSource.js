const timestamp_saved = '09/30/2023 07:15 PM';
const dataFechaAcualizado = '9/30/2023' + ' 3:10:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'36', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'34', Cost:10.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 199,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:17.79, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 9,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 9, MVar:'10', Cost:83.60, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'136', Cost:17.96, ParentId: '16'},
		]
	},
