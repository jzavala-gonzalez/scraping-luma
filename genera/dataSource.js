const timestamp_saved = '10/29/2023 05:50 AM';
const dataFechaAcualizado = '10/29/2023' + ' 1:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'36', Cost:11.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'37', Cost:11.13, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'60', Cost:17.31, ParentId: '15'},
