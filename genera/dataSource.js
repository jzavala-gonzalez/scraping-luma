const timestamp_saved = '07/27/2023 03:13 AM';
const dataFechaAcualizado = '7/26/2023' + ' 11:05:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'55', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'56', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'53', Cost:11.02, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:0.58, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'1', Cost:26.27, ParentId: '9'},
		]
	},
