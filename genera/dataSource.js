const timestamp_saved = '07/28/2023 11:38 AM';
const dataFechaAcualizado = '7/28/2023' + ' 7:30:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'43', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'45', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'44', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'0', Cost:26.77, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'9', Cost:29.02, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:28.25, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'33', Cost:16.31, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'74', Cost:13.67, ParentId: '17'},
		]
	},
