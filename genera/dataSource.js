const timestamp_saved = '10/28/2023 09:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 5:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'51', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'52', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'52', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'8', Cost:18.46, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'36', Cost:18.64, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'9', Cost:18.64, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:31.92, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:32.07, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 127,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'9', Cost:19.00, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'76', Cost:16.48, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'1', Cost:11.13, ParentId: '17'},
		]
	},
