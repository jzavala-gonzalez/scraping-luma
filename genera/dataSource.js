const timestamp_saved = '08/28/2023 08:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 4:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'36', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'36', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'7', Cost:18.98, ParentId: '14'},
