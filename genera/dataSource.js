const timestamp_saved = '10/28/2023 02:40 PM';
const dataFechaAcualizado = '10/28/2023' + ' 10:36:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1981},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'43', Cost:12.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'46', Cost:12.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'12', Cost:34.38, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:34.38, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 91, MVar:'28', Cost:0, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 51, MVar:'77', Cost:23.09, ParentId: '15'},
