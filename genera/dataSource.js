const timestamp_saved = '11/05/2023 12:40 PM';
const dataFechaAcualizado = '11/5/2023' + ' 8:36:19 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1922},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'41', Cost:12.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'41', Cost:12.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'40', Cost:12.24, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'36', Cost:17.54, ParentId: '11'},
