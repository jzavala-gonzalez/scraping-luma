const timestamp_saved = '08/21/2023 05:40 PM';
const dataFechaAcualizado = '8/21/2023' + ' 1:35:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'59', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'39', Cost:10.58, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'76', Cost:18.46, ParentId: '15'},
