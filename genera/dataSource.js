const timestamp_saved = '10/03/2023 10:55 AM';
const dataFechaAcualizado = '10/3/2023' + ' 6:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'36', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'33', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'50', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'96', Cost:9.39, ParentId: '17'},
		]
	},
