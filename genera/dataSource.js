const timestamp_saved = '09/07/2023 08:45 AM';
const dataFechaAcualizado = '9/7/2023' + ' 4:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 380,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'49', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'38', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'45', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'87', Cost:9.77, ParentId: '17'},
		]
	},
