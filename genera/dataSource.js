const timestamp_saved = '10/02/2023 07:55 AM';
const dataFechaAcualizado = '10/2/2023' + ' 3:50:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'30', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'28', Cost:10.48, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:17.07, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 245,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 245, MVar:'84', Cost:9.87, ParentId: '17'},
		]
	},
