const timestamp_saved = '09/16/2023 07:10 AM';
const dataFechaAcualizado = '9/16/2023' + ' 3:05:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'47', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'44', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'58', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'7', Cost:8.29, ParentId: '11'},
		]
	},
