const timestamp_saved = '10/12/2023 09:50 PM';
const dataFechaAcualizado = '10/12/2023' + ' 5:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'65', Cost:10.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'71', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'71', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 116,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'1', Cost:27.39, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.05, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'98', Cost:16.78, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'194', Cost:16.62, ParentId: '16'},
		]
	},
