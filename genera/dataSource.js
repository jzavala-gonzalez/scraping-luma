const timestamp_saved = '11/16/2023 01:00 PM';
const dataFechaAcualizado = '11/16/2023' + ' 8:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'50', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'50', Cost:10.77, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 107, MVar:'35', Cost:0, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 190,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 190, MVar:'74', Cost:10.80, ParentId: '17'},
		]
	},
