const timestamp_saved = '09/06/2023 07:55 PM';
const dataFechaAcualizado = '9/6/2023' + ' 3:50:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'62', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'38', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'54', Cost:10.80, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 94, MVar:'0', Cost:3.12, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 126, MVar:'60', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 75,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'0', Cost:31.78, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'9', Cost:43.64, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'34', Cost:19.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'107', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'175', Cost:17.04, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'100', Cost:9.17, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 77,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 20, MVar:'19', Cost:17, ParentId: '19'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 24,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:24.33, ParentId: '21'},
