const timestamp_saved = '09/10/2023 12:20 PM';
const dataFechaAcualizado = '9/10/2023' + ' 8:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'60', Cost:11.33, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'120', Cost:17.84, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 42,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 17, MVar:'2', Cost:19.60, ParentId: '19'},
