const timestamp_saved = '10/24/2023 01:25 AM';
const dataFechaAcualizado = '10/23/2023' + ' 9:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'56', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'57', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'57', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'13', Cost:27.40, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'12', Cost:17.60, ParentId: '11'},
