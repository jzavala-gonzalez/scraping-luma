const timestamp_saved = '11/30/2023 10:30 AM';
const dataFechaAcualizado = '11/30/2023' + ' 6:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'50', Cost:9.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'51', Cost:9.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'51', Cost:9.96, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 21,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 21, MVar:'0', Cost:38.37, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'50', Cost:17.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'69', Cost:9.77, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 41,
		units:[
			...
			{Index:'1', Unit:'CT Block 2', MW: 21, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'2', Unit:'CT Block 3', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:0, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:38.37, ParentId: '21'},
			{Index:'5', Unit:'GT3', MW: 21, MVar:'0', Cost:0, ParentId: '21'},
