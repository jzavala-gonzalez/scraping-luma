const timestamp_saved = '12/01/2023 07:50 AM';
const dataFechaAcualizado = '12/1/2023' + ' 3:46:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'39', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'40', Cost:12.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'46', Cost:12.88, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'49', Cost:9.85, ParentId: '17'},
		]
	},
