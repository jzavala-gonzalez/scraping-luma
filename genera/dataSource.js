const timestamp_saved = '10/24/2023 06:25 PM';
const dataFechaAcualizado = '10/24/2023' + ' 2:21:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'53', Cost:9.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'53', Cost:9.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'54', Cost:9.96, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'12', Cost:31.27, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'28', Cost:19.45, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 283, MVar:'153', Cost:17.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'83', Cost:11.28, ParentId: '17'},
		]
	},
