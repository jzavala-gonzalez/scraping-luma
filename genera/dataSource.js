const timestamp_saved = '09/06/2023 05:20 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'48', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'50', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'61', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.23, ParentId: '14'},
