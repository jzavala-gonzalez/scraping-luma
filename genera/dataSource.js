const timestamp_saved = '10/31/2023 03:25 PM';
const dataFechaAcualizado = '10/31/2023' + ' 11:21:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'64', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'66', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'85', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 307,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 307, MVar:'82', Cost:9.39, ParentId: '17'},
		]
	},
