const timestamp_saved = '09/29/2023 12:15 PM';
const dataFechaAcualizado = '9/29/2023' + ' 8:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'34', Cost:12.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'31', Cost:12.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'49', Cost:12.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 54,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 8, MVar:'2', Cost:27.41, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'13', Cost:31.28, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'41', Cost:17.90, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'6', Cost:17.90, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'0', Cost:20.80, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'0', Cost:20.80, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'12', Cost:19.09, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'122', Cost:17.82, ParentId: '16'},
		]
	},
