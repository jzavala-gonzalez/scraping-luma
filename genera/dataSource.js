const timestamp_saved = '12/02/2023 08:35 AM';
const dataFechaAcualizado = '12/2/2023' + ' 4:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 307,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'38', Cost:12.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'40', Cost:12.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'47', Cost:12.98, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'54', Cost:9.82, ParentId: '17'},
		]
	},
