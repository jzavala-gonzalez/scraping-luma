const timestamp_saved = '09/26/2023 02:20 PM';
const dataFechaAcualizado = '9/26/2023' + ' 10:15:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 200, MVar:'68', Cost:4.41, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'48', Cost:11.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'55', Cost:11.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'47', Cost:17.75, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.75, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'7', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'71', Cost:16.90, ParentId: '15'},
