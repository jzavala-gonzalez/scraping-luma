const timestamp_saved = '11/04/2023 07:25 AM';
const dataFechaAcualizado = '11/4/2023' + ' 3:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'41', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'40', Cost:10.99, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'48', Cost:9.72, ParentId: '17'},
		]
	},
