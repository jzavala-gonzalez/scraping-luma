const timestamp_saved = '08/30/2023 02:20 AM';
const dataFechaAcualizado = '8/29/2023' + ' 10:15:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'58', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'59', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'67', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'23', Cost:28.06, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 98,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 98, MVar:'29', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'95', Cost:16.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 328, MVar:'173', Cost:16.78, ParentId: '16'},
		]
	},
