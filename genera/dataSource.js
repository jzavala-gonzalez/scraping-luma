const timestamp_saved = '11/26/2023 05:25 AM';
const dataFechaAcualizado = '11/26/2023' + ' 1:21:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'25', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'35', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'48', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'8', Cost:35.18, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 11,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 0, MVar:'2', Cost:26.86, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 1, MVar:'0', Cost:51.43, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'70', Cost:9.84, ParentId: '17'},
		]
	},
