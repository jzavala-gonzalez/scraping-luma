const timestamp_saved = '10/29/2023 08:10 PM';
const dataFechaAcualizado = '10/29/2023' + ' 4:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'41', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'41', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'66', Cost:12.16, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'3', Cost:30.36, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'84', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 361, MVar:'126', Cost:16.65, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 145,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 145, MVar:'36', Cost:11.98, ParentId: '17'},
		]
	},
