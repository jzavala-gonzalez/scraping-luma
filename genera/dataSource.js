const timestamp_saved = '09/06/2023 06:10 PM';
const dataFechaAcualizado = '9/6/2023' + ' 2:05:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'57', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'33', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'50', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'7', Cost:27.28, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'98', Cost:16.93, ParentId: '15'},
