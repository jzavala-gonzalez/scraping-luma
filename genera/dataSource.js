const timestamp_saved = '08/24/2023 03:55 AM';
const dataFechaAcualizado = '8/23/2023' + ' 11:50:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'55', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'56', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'52', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'15', Cost:19.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 267,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 267, MVar:'155', Cost:17.27, ParentId: '16'},
		]
	},
