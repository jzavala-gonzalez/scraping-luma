const timestamp_saved = '11/10/2023 12:10 PM';
const dataFechaAcualizado = '11/10/2023' + ' 8:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'51', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'57', Cost:11.22, ParentId: '7'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 22,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 20, MVar:'20', Cost:19.60, ParentId: '19'},
