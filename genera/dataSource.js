const timestamp_saved = '11/12/2023 10:35 AM';
const dataFechaAcualizado = '11/12/2023' + ' 6:31:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 131, MVar:'51', Cost:11.14, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'49', Cost:17.47, ParentId: '15'},
