const timestamp_saved = '11/07/2023 11:15 PM';
const dataFechaAcualizado = '11/7/2023' + ' 7:06:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'55', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'54', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'54', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'0', Cost:21.95, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'10', Cost:31.03, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'82', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'113', Cost:9.16, ParentId: '17'},
		]
	},
