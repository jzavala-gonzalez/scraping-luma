const timestamp_saved = '08/25/2023 03:35 PM';
const dataFechaAcualizado = '8/25/2023' + ' 11:30:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'64', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'66', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'59', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 69,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'3', Cost:27.14, ParentId: '9'},
		]
	},
