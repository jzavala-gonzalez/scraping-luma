const timestamp_saved = '08/23/2023 09:05 PM';
const dataFechaAcualizado = '8/23/2023' + ' 5:00:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'58', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'56', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.10, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.15, ParentId: '14'},
