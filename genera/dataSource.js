const timestamp_saved = '11/26/2023 11:25 PM';
const dataFechaAcualizado = '11/26/2023' + ' 7:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'37', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'47', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'58', Cost:10.56, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'3', Cost:26.03, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'9', Cost:29.72, ParentId: '13'},
