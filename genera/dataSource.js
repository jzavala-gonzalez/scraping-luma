const timestamp_saved = '08/18/2023 07:50 AM';
const dataFechaAcualizado = '8/18/2023' + ' 3:47:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'52', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'65', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'118', Cost:18.23, ParentId: '16'},
		]
	},
