const timestamp_saved = '10/24/2023 09:55 PM';
const dataFechaAcualizado = '10/24/2023' + ' 5:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'52', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'54', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'54', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'86', Cost:11.28, ParentId: '17'},
		]
	},
