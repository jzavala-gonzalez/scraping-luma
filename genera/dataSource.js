const timestamp_saved = '08/05/2023 06:05 PM';
const dataFechaAcualizado = '8/5/2023' + ' 2:00:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'46', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'50', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 311,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 160, MVar:'45', Cost:15.54, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'97', Cost:11.78, ParentId: '17'},
		]
	},
