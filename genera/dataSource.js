const timestamp_saved = '08/03/2023 12:20 PM';
const dataFechaAcualizado = '8/3/2023' + ' 8:15:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 508,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'43', Cost:10.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'41', Cost:10.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'44', Cost:10.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 143, MVar:'19', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:19.89, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 110, MVar:'37', Cost:16.63, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'136', Cost:18.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'76', Cost:11.39, ParentId: '17'},
		]
	},
