const timestamp_saved = '11/20/2023 07:45 AM';
const dataFechaAcualizado = '11/20/2023' + ' 3:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'26', Cost:11.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'36', Cost:11.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'51', Cost:11.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'89', Cost:9.17, ParentId: '17'},
		]
	},
