const timestamp_saved = '10/24/2023 04:55 PM';
const dataFechaAcualizado = '10/24/2023' + ' 12:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'51', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'52', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'53', Cost:10.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 273,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 273, MVar:'81', Cost:11.29, ParentId: '17'},
		]
	},
