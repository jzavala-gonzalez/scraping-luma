const timestamp_saved = '11/27/2023 10:35 PM';
const dataFechaAcualizado = '11/27/2023' + ' 6:31:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'43', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'53', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'61', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'12', Cost:31.57, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'119', Cost:9.16, ParentId: '17'},
		]
	},
