const timestamp_saved = '11/18/2023 06:40 AM';
const dataFechaAcualizado = '11/18/2023' + ' 2:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 140,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'73', Cost:23.66, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:17.45, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:17.45, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 72,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 44, MVar:'12', Cost:29.41, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 132,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'20', Cost:18.73, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'83', Cost:16.49, ParentId: '15'},
