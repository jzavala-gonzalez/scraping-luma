const timestamp_saved = '10/14/2023 08:10 PM';
const dataFechaAcualizado = '10/14/2023' + ' 4:06:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'61', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'64', Cost:10.55, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 268,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 268, MVar:'148', Cost:17.52, ParentId: '16'},
		]
	},
