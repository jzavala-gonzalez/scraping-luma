const timestamp_saved = '11/13/2023 07:00 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:56:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2447},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 206,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:16.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'41', Cost:16.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 27, MVar:'48', Cost:16.77, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'0', Cost:31.12, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'48', Cost:17.28, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'59', Cost:16.90, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'80', Cost:9.15, ParentId: '17'},
		]
	},
