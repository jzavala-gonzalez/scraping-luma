const timestamp_saved = '11/09/2023 07:00 PM';
const dataFechaAcualizado = '11/9/2023' + ' 2:56:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'51', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'52', Cost:10.98, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'45', Cost:17.18, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'13', Cost:17.18, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'104', Cost:9.15, ParentId: '17'},
		]
	},
