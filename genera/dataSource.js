const timestamp_saved = '09/01/2023 11:40 PM';
const dataFechaAcualizado = '9/1/2023' + ' 7:35:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'83', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 514,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'58', Cost:9.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'66', Cost:9.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 194, MVar:'72', Cost:9.90, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 164,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'5', Cost:22.29, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.96, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 37, MVar:'11', Cost:22.79, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'15', Cost:28.10, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'16', Cost:28.22, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'8', Cost:30.30, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 97,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 97, MVar:'17', Cost:19.01, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'78', Cost:16.75, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 361,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 361, MVar:'161', Cost:16.73, ParentId: '16'},
		]
	},
