const timestamp_saved = '08/03/2023 05:30 PM';
const dataFechaAcualizado = '8/3/2023' + ' 1:25:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'44', Cost:10.75, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'24', Cost:19.40, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'152', Cost:18.24, ParentId: '16'},
		]
	},
