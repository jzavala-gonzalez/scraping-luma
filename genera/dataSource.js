const timestamp_saved = '10/28/2023 04:15 AM';
const dataFechaAcualizado = '10/28/2023' + ' 12:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'46', Cost:9.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'46', Cost:9.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 171, MVar:'49', Cost:9.84, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 66, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'1', Cost:84.44, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 26, MVar:'5', Cost:50.92, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:50.92, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 84,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'6', Cost:30.16, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:29.14, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 38, MVar:'13', Cost:23.52, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'24', Cost:19.04, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 270,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 270, MVar:'127', Cost:17.30, ParentId: '16'},
		]
	},
