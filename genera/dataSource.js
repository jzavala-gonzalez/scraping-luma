const timestamp_saved = '11/13/2023 06:40 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:36:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 214,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:17.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'41', Cost:17.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 35, MVar:'49', Cost:17.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'1', Cost:28.75, ParentId: '10'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'61', Cost:16.88, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'83', Cost:9.14, ParentId: '17'},
		]
	},
