const timestamp_saved = '11/25/2023 08:10 PM';
const dataFechaAcualizado = '11/25/2023' + ' 4:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 183,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 183, MVar:'68', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'34', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'44', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'56', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.21, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'36', Cost:18.57, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'7', Cost:18.57, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'6', Cost:46.48, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'0', Cost:29.88, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'138', Cost:17.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'51', Cost:9.44, ParentId: '17'},
		]
	},
