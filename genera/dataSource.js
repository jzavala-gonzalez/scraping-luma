const timestamp_saved = '11/04/2023 09:50 AM';
const dataFechaAcualizado = '11/4/2023' + ' 5:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'42', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'41', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'40', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'48', Cost:9.72, ParentId: '17'},
		]
	},
