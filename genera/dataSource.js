const timestamp_saved = '12/05/2023 05:45 PM';
const dataFechaAcualizado = '12/5/2023' + ' 1:40:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 622},
	{Index:'6', Desc:'Reserva Operacional', value: 1187},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 292,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'46', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'50', Cost:13.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'56', Cost:13.51, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'66', Cost:11.61, ParentId: '17'},
		]
	},
