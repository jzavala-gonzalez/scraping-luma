const timestamp_saved = '09/29/2023 09:10 AM';
const dataFechaAcualizado = '9/29/2023' + ' 5:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'52', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'32', Cost:13.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'29', Cost:13.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 108, MVar:'48', Cost:13.32, ParentId: '7'},
		]
	},
