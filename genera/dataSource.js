const timestamp_saved = '09/06/2023 05:55 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:50:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'45', Cost:12.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'47', Cost:12.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'59', Cost:12.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 114, MVar:'0', Cost:7.28, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 134, MVar:'33', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:20.51, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'146', Cost:16.86, ParentId: '16'},
		]
	},
