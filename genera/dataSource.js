const timestamp_saved = '07/29/2023 12:55 AM';
const dataFechaAcualizado = '7/28/2023' + ' 8:50:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'50', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'50', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'48', Cost:11.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 178,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 102, MVar:'0', Cost:4.94, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 151, MVar:'7', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'3', Cost:22.38, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.27, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'84', Cost:13.87, ParentId: '17'},
		]
	},
