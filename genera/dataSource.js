const timestamp_saved = '09/24/2023 09:55 PM';
const dataFechaAcualizado = '9/24/2023' + ' 5:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'46', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'48', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:11.03, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 130,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 242, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'0', Cost:22.07, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.53, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:22.47, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:30.99, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'44', Cost:20.17, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:20.17, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'3', Cost:31.27, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'79', Cost:17.04, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'90', Cost:9.11, ParentId: '17'},
		]
	},
