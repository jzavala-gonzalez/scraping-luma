const timestamp_saved = '12/02/2023 09:30 PM';
const dataFechaAcualizado = '12/2/2023' + ' 5:26:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'55', Cost:10.95, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 421,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:17.46, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'94', Cost:10.88, ParentId: '17'},
		]
	},
