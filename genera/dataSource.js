const timestamp_saved = '11/18/2023 11:15 AM';
const dataFechaAcualizado = '11/18/2023' + ' 7:11:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2235},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 265,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:16.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'55', Cost:16.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:16.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 80,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 80, MVar:'15', Cost:27.95, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:31.45, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.48, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'21', Cost:18.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'77', Cost:16.96, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'119', Cost:9.18, ParentId: '17'},
		]
	},
