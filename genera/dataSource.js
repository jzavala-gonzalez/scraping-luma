const timestamp_saved = '10/25/2023 06:55 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'46', Cost:10.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'52', Cost:10.93, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 26,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'13', Cost:43.34, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.16, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'87', Cost:17.27, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'152', Cost:17.39, ParentId: '16'},
		]
	},
