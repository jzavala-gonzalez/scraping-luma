const timestamp_saved = '09/11/2023 04:05 PM';
const dataFechaAcualizado = '9/11/2023' + ' 12:00:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 220, MVar:'62', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'76', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'68', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'67', Cost:10.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'75', Cost:10.32, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'8', Cost:31.29, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'24', Cost:19.03, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 350, MVar:'149', Cost:16.76, ParentId: '16'},
		]
	},
