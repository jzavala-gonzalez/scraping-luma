const timestamp_saved = '09/10/2023 07:20 AM';
const dataFechaAcualizado = '9/10/2023' + ' 3:15:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'65', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'63', Cost:10.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'64', Cost:10.61, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:28.85, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'127', Cost:18.21, ParentId: '16'},
		]
	},
