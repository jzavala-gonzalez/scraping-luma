const timestamp_saved = '09/18/2023 01:45 AM';
const dataFechaAcualizado = '9/17/2023' + ' 9:40:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'51', Cost:10.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'51', Cost:10.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'64', Cost:10.59, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'23', Cost:19.02, ParentId: '14'},
