const timestamp_saved = '11/11/2023 05:55 PM';
const dataFechaAcualizado = '11/11/2023' + ' 1:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 251,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 251, MVar:'109', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'44', Cost:10.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'49', Cost:10.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'55', Cost:10.09, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 317,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'46', Cost:8.31, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 10, MVar:'21', Cost:113.45, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'95', Cost:16.66, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 274,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 274, MVar:'122', Cost:9.89, ParentId: '17'},
		]
	},
