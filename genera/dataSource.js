const timestamp_saved = '09/15/2023 11:55 AM';
const dataFechaAcualizado = '9/15/2023' + ' 7:50:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'49', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'63', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'8', Cost:19.83, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'17', Cost:18.95, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 173,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 173, MVar:'78', Cost:16.71, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 32,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 9, MVar:'7', Cost:19.60, ParentId: '19'},
