const timestamp_saved = '09/04/2023 10:15 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'37', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'43', Cost:10.62, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'135', Cost:17.35, ParentId: '16'},
		]
	},
