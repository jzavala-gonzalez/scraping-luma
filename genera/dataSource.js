const timestamp_saved = '11/24/2023 01:55 PM';
const dataFechaAcualizado = '11/24/2023' + ' 9:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'23', Cost:11.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'33', Cost:11.99, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 142,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 71, MVar:'10', Cost:19.72, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'140', Cost:18.31, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 242,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 242, MVar:'71', Cost:9.90, ParentId: '17'},
		]
	},
