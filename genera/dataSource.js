const timestamp_saved = '11/13/2023 06:45 AM';
const dataFechaAcualizado = '11/13/2023' + ' 2:41:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 213,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'38', Cost:16.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'42', Cost:16.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 34, MVar:'49', Cost:16.54, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'60', Cost:16.70, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'82', Cost:9.16, ParentId: '17'},
		]
	},
