const timestamp_saved = '09/10/2023 02:50 PM';
const dataFechaAcualizado = '9/10/2023' + ' 10:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'63', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'61', Cost:10.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'62', Cost:10.77, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'7', Cost:31.22, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:18.94, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'125', Cost:18.28, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 58,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 30, MVar:'8', Cost:19.60, ParentId: '19'},
