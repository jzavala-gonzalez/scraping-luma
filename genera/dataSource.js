const timestamp_saved = '10/24/2023 04:40 PM';
const dataFechaAcualizado = '10/24/2023' + ' 12:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'51', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'52', Cost:10.21, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'89', Cost:17.15, ParentId: '15'},
