const timestamp_saved = '11/05/2023 10:45 AM';
const dataFechaAcualizado = '11/5/2023' + ' 6:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'39', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'38', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'39', Cost:12.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'38', Cost:17.35, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.35, ParentId: '11'},
