const timestamp_saved = '09/26/2023 05:00 AM';
const dataFechaAcualizado = '9/26/2023' + ' 12:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'50', Cost:11.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'50', Cost:11.86, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 357,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:18.34, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'0', Cost:18.34, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'2', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'67', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'69', Cost:9.78, ParentId: '17'},
		]
	},
