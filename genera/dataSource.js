const timestamp_saved = '11/12/2023 12:50 PM';
const dataFechaAcualizado = '11/12/2023' + ' 8:46:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1942},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'43', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'44', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'53', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'36', Cost:18.04, ParentId: '11'},
