const timestamp_saved = '11/08/2023 03:45 PM';
const dataFechaAcualizado = '11/8/2023' + ' 11:41:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'53', Cost:10.67, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'1', Cost:22.98, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'103', Cost:9.60, ParentId: '17'},
		]
	},
