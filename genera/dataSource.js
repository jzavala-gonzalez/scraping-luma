const timestamp_saved = '08/13/2023 05:15 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:12:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'33', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'36', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'38', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'105', Cost:12.26, ParentId: '17'},
		]
	},
