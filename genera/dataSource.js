const timestamp_saved = '09/18/2023 03:55 PM';
const dataFechaAcualizado = '9/18/2023' + ' 11:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'50', Cost:10.31, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:19.88, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'83', Cost:9.84, ParentId: '17'},
		]
	},
