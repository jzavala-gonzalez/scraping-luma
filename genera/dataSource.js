const timestamp_saved = '11/20/2023 10:05 PM';
const dataFechaAcualizado = '11/20/2023' + ' 6:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'38', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'47', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'57', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.33, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'10', Cost:30.80, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 77,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'10', Cost:34.78, ParentId: '13'},
