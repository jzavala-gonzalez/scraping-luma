const timestamp_saved = '08/12/2023 08:10 PM';
const dataFechaAcualizado = '8/12/2023' + ' 4:07:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'46', Cost:10.41, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'1', Cost:26.48, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:20.53, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 244,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 244, MVar:'156', Cost:17.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 327, MVar:'111', Cost:11.75, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 49,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 6, MVar:'25', Cost:19.60, ParentId: '19'},
