const timestamp_saved = '10/05/2023 05:15 PM';
const dataFechaAcualizado = '10/5/2023' + ' 1:11:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'48', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'47', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 156, MVar:'59', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:22.75, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'38', Cost:17.44, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:17.44, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.03, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.03, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 29,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'9', Cost:32.13, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'76', Cost:17.03, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 330, MVar:'185', Cost:16.85, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'120', Cost:9.27, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 40,
		units:[
			...
			{Index:'1', Unit:'CT Block 2', MW: 3, MVar:'0', Cost:0, ParentId: '21'},
			...
			{Index:'5', Unit:'GT3', MW: 3, MVar:'0', Cost:0, ParentId: '21'},
