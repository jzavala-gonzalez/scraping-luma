const timestamp_saved = '10/13/2023 10:25 AM';
const dataFechaAcualizado = '10/13/2023' + ' 6:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'60', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'64', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'67', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'74', Cost:9.15, ParentId: '17'},
		]
	},
