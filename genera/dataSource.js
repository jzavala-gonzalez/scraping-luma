const timestamp_saved = '10/19/2023 04:25 AM';
const dataFechaAcualizado = '10/19/2023' + ' 12:21:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'34', Cost:12.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'43', Cost:12.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'49', Cost:12.69, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'1', Cost:18.84, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'100', Cost:10.61, ParentId: '17'},
		]
	},
