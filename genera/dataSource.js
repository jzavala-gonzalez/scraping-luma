const timestamp_saved = '11/06/2023 07:25 AM';
const dataFechaAcualizado = '11/6/2023' + ' 3:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'39', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'40', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'75', Cost:16.81, ParentId: '15'},
