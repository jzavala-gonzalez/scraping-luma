const timestamp_saved = '11/01/2023 06:40 PM';
const dataFechaAcualizado = '11/1/2023' + ' 2:36:18 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2439},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'66', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'69', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'71', Cost:10.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 323,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.28, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 125,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.45, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'81', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'154', Cost:17.87, ParentId: '16'},
		]
	},
