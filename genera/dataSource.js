const timestamp_saved = '08/04/2023 09:20 AM';
const dataFechaAcualizado = '8/4/2023' + ' 5:15:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 437,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'45', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'39', Cost:10.82, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'73', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'125', Cost:18.02, ParentId: '16'},
		]
	},
