const timestamp_saved = '09/19/2023 01:15 AM';
const dataFechaAcualizado = '9/18/2023' + ' 9:10:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'62', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'61', Cost:9.79, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'12', Cost:22.49, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 127,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'19', Cost:28.38, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'17', Cost:29.12, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'8', Cost:26.85, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'26', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'87', Cost:17.02, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 363,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 363, MVar:'189', Cost:16.76, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'115', Cost:9.12, ParentId: '17'},
		]
	},
