const timestamp_saved = '10/29/2023 03:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 11:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'5', Cost:18.97, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'51', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 232,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 232, MVar:'133', Cost:17.71, ParentId: '16'},
		]
	},
