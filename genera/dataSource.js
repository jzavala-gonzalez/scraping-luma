const timestamp_saved = '09/02/2023 07:35 PM';
const dataFechaAcualizado = '9/2/2023' + ' 3:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 414,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 158, MVar:'80', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'52', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'60', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 154, MVar:'65', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 94,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 106, MVar:'11', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'132', Cost:18.07, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'81', Cost:9.23, ParentId: '17'},
		]
	},
