const timestamp_saved = '10/23/2023 06:10 AM';
const dataFechaAcualizado = '10/23/2023' + ' 2:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'37', Cost:12.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'38', Cost:12.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'40', Cost:12.94, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'104', Cost:17.29, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'48', Cost:11.27, ParentId: '17'},
		]
	},
