const timestamp_saved = '11/10/2023 07:50 PM';
const dataFechaAcualizado = '11/10/2023' + ' 3:46:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'44', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'37', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'55', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'12', Cost:31.42, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'16', Cost:18.88, ParentId: '14'},
