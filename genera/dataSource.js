const timestamp_saved = '08/18/2023 01:25 AM';
const dataFechaAcualizado = '8/17/2023' + ' 9:22:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2930},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'56', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'70', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'78', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 193,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'6', Cost:22.08, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'14', Cost:31.06, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'9', Cost:31.70, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'0', Cost:29.89, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'7', Cost:29.93, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'198', Cost:16.64, ParentId: '16'},
		]
	},
