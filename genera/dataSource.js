const timestamp_saved = '10/13/2023 11:55 PM';
const dataFechaAcualizado = '10/13/2023' + ' 7:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 45, MVar:'9', Cost:28.15, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'92', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'200', Cost:16.62, ParentId: '16'},
		]
	},
