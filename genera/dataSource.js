const timestamp_saved = '08/11/2023 05:45 PM';
const dataFechaAcualizado = '8/11/2023' + ' 1:40:44 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'46', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'47', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'45', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:20.25, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'176', Cost:17.38, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'131', Cost:11.71, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 113,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 33, MVar:'18', Cost:17, ParentId: '19'},
		]
	},
