const timestamp_saved = '12/05/2023 08:35 PM';
const dataFechaAcualizado = '12/5/2023' + ' 4:30:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 814},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'58', Cost:9.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'60', Cost:9.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'62', Cost:9.99, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 47, MVar:'0', Cost:10.25, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 30,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:38.47, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 153,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 82, MVar:'26', Cost:19.24, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 269,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 269, MVar:'129', Cost:17.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'86', Cost:11.40, ParentId: '17'},
		]
	},
