const timestamp_saved = '08/06/2023 01:25 PM';
const dataFechaAcualizado = '8/6/2023' + ' 9:20:40 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2269},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'45', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'41', Cost:10.99, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'41', Cost:10.99, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'85', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'22', Cost:17.00, ParentId: '15'},
		]
	},
