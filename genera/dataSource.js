const timestamp_saved = '09/20/2023 03:30 PM';
const dataFechaAcualizado = '9/20/2023' + ' 11:25:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'52', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'64', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'151', Cost:18.15, ParentId: '16'},
		]
	},
