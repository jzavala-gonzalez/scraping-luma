const timestamp_saved = '10/24/2023 03:15 AM';
const dataFechaAcualizado = '10/23/2023' + ' 11:11:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'50', Cost:10.82, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 17, MVar:'11', Cost:27.32, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 1, MVar:'0', Cost:32.90, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'150', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'83', Cost:11.04, ParentId: '17'},
		]
	},
