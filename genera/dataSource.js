const timestamp_saved = '11/23/2023 10:05 PM';
const dataFechaAcualizado = '11/23/2023' + ' 6:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 241,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 241, MVar:'79', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'28', Cost:10.48, ParentId: '7'},
