const timestamp_saved = '12/04/2023 12:45 AM';
const dataFechaAcualizado = '12/3/2023' + ' 8:41:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'54', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'56', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'56', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 275,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 275, MVar:'143', Cost:17.09, ParentId: '16'},
		]
	},
