const timestamp_saved = '08/11/2023 01:40 PM';
const dataFechaAcualizado = '8/11/2023' + ' 9:35:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'40', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'41', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'43', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'121', Cost:11.70, ParentId: '17'},
		]
	},
