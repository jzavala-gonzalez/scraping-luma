const timestamp_saved = '09/17/2023 01:35 AM';
const dataFechaAcualizado = '9/16/2023' + ' 9:30:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'52', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'65', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 102,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'7', Cost:28.47, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'38', Cost:18.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'97', Cost:16.79, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'109', Cost:9.12, ParentId: '17'},
		]
	},
