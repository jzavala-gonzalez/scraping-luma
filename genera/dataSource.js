const timestamp_saved = '11/24/2023 03:30 PM';
const dataFechaAcualizado = '11/24/2023' + ' 11:26:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'26', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'38', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'52', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 143,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:19.48, ParentId: '14'},
