const timestamp_saved = '11/12/2023 05:55 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'45', Cost:12.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'46', Cost:12.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'54', Cost:12.30, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 270,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 270, MVar:'87', Cost:9.65, ParentId: '17'},
		]
	},
