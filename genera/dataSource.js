const timestamp_saved = '11/22/2023 09:05 AM';
const dataFechaAcualizado = '11/22/2023' + ' 5:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'21', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'32', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'48', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'66', Cost:9.77, ParentId: '17'},
		]
	},
