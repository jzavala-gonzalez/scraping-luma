const timestamp_saved = '08/15/2023 09:45 AM';
const dataFechaAcualizado = '8/15/2023' + ' 5:42:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'50', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'44', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 98,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'3', Cost:26.05, ParentId: '9'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'169', Cost:17.82, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'117', Cost:11.62, ParentId: '17'},
		]
	},
