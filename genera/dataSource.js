const timestamp_saved = '08/21/2023 03:45 AM';
const dataFechaAcualizado = '8/20/2023' + ' 11:42:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'50', Cost:10.90, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'1', Cost:19.23, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 130,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'63', Cost:17.35, ParentId: '15'},
