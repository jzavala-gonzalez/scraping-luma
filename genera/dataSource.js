const timestamp_saved = '12/01/2023 02:25 AM';
const dataFechaAcualizado = '11/30/2023' + ' 10:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'58', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'60', Cost:10.67, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:31.60, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'94', Cost:9.11, ParentId: '17'},
		]
	},
