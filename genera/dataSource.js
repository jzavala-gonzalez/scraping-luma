const timestamp_saved = '11/09/2023 09:10 AM';
const dataFechaAcualizado = '11/9/2023' + ' 5:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'39', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'38', Cost:12.00, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'21', Cost:21.98, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'70', Cost:9.81, ParentId: '17'},
		]
	},
