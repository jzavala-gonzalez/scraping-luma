const timestamp_saved = '11/11/2023 07:35 PM';
const dataFechaAcualizado = '11/11/2023' + ' 3:31:20 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2258},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'49', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'52', Cost:11.10, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 51,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:34.37, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:31.18, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 45, MVar:'10', Cost:22.25, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.30, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'102', Cost:16.97, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 342,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 342, MVar:'100', Cost:9.22, ParentId: '17'},
		]
	},
