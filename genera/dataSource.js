const timestamp_saved = '10/24/2023 07:40 AM';
const dataFechaAcualizado = '10/24/2023' + ' 3:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'43', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'45', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'14', Cost:19.55, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'61', Cost:11.29, ParentId: '17'},
		]
	},
