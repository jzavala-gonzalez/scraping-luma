const timestamp_saved = '11/27/2023 09:55 AM';
const dataFechaAcualizado = '11/27/2023' + ' 5:51:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'25', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'34', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'47', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'45', Cost:8.21, ParentId: '11'},
