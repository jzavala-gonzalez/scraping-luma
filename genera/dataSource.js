const timestamp_saved = '09/20/2023 05:05 PM';
const dataFechaAcualizado = '9/20/2023' + ' 1:00:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'55', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'56', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'67', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'45', Cost:19.97, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 19,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 28, MVar:'8', Cost:0, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'154', Cost:18.08, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'87', Cost:9.32, ParentId: '17'},
		]
	},
