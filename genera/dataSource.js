const timestamp_saved = '10/22/2023 08:35 AM';
const dataFechaAcualizado = '10/22/2023' + ' 4:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'40', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'39', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'45', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'4', Cost:19.28, ParentId: '14'},
