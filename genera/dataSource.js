const timestamp_saved = '11/13/2023 04:45 AM';
const dataFechaAcualizado = '11/13/2023' + ' 12:41:20 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2411},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 172,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 87, MVar:'47', Cost:21.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 87, MVar:'51', Cost:21.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:21.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:17.04, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'62', Cost:16.81, ParentId: '15'},
