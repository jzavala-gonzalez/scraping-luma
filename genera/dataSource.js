const timestamp_saved = '08/02/2023 10:10 PM';
const dataFechaAcualizado = '8/2/2023' + ' 6:05:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'40', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'46', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'90', Cost:16.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'9', Cost:15.83, ParentId: '15'},
		]
	},
