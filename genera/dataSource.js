const timestamp_saved = '10/26/2023 04:45 PM';
const dataFechaAcualizado = '10/26/2023' + ' 12:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'47', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'51', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 163, MVar:'53', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 354,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'45', Cost:16.98, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 92,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 31, MVar:'18', Cost:19.60, ParentId: '19'},
