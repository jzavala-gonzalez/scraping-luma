const timestamp_saved = '12/04/2023 02:10 AM';
const dataFechaAcualizado = '12/3/2023' + ' 10:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'51', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'53', Cost:10.90, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'85', Cost:10.93, ParentId: '17'},
		]
	},
