const timestamp_saved = '10/12/2023 04:50 AM';
const dataFechaAcualizado = '10/12/2023' + ' 12:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'55', Cost:11.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'59', Cost:11.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'65', Cost:11.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 8,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 8, MVar:'1', Cost:30.84, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'7', Cost:31.29, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 131, MVar:'40', Cost:16.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:16.97, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 142, MVar:'43', Cost:8.65, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'166', Cost:16.58, ParentId: '16'},
		]
	},
