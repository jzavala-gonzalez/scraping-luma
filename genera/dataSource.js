const timestamp_saved = '10/19/2023 08:20 AM';
const dataFechaAcualizado = '10/19/2023' + ' 4:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'33', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'40', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'43', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'64', Cost:16.82, ParentId: '15'},
