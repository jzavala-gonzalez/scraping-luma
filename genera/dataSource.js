const timestamp_saved = '08/13/2023 09:50 PM';
const dataFechaAcualizado = '8/13/2023' + ' 5:47:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'38', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'42', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'42', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 339,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 339, MVar:'161', Cost:16.94, ParentId: '16'},
		]
	},
