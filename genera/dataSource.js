const timestamp_saved = '09/21/2023 07:10 AM';
const dataFechaAcualizado = '9/21/2023' + ' 3:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'39', Cost:11.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'42', Cost:11.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'62', Cost:11.77, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'1', Cost:27.26, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:19.99, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'9', Cost:26.72, ParentId: '14'},
