const timestamp_saved = '10/03/2023 05:45 AM';
const dataFechaAcualizado = '10/3/2023' + ' 1:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'35', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'33', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'48', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:21.73, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'33', Cost:23.67, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:30.81, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'144', Cost:17.78, ParentId: '16'},
		]
	},
