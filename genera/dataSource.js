const timestamp_saved = '09/13/2023 05:15 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:10:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'56', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'55', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'66', Cost:10.50, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:13.33, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 147,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'14', Cost:28.17, ParentId: '10'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 81,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 38, MVar:'22', Cost:19.60, ParentId: '19'},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 36,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:51.08, ParentId: '21'},
