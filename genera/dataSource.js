const timestamp_saved = '11/02/2023 10:50 AM';
const dataFechaAcualizado = '11/2/2023' + ' 6:46:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'50', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'48', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'46', Cost:11.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:20.10, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'8', Cost:18.52, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 169,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 169, MVar:'122', Cost:20.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'67', Cost:9.25, ParentId: '17'},
		]
	},
