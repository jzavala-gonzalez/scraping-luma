const timestamp_saved = '10/28/2023 12:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 8:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:12.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'41', Cost:12.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'45', Cost:12.06, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 45, MVar:'15', Cost:34.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:34.21, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 41, MVar:'11', Cost:22.96, ParentId: '14'},
