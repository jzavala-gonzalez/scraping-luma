const timestamp_saved = '11/30/2023 07:10 AM';
const dataFechaAcualizado = '11/30/2023' + ' 3:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'36', Cost:12.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'39', Cost:12.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'45', Cost:12.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'49', Cost:17.52, ParentId: '11'},
