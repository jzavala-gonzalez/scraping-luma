const timestamp_saved = '11/30/2023 06:25 PM';
const dataFechaAcualizado = '11/30/2023' + ' 2:21:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'54', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'56', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'55', Cost:10.36, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 38,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 38, MVar:'0', Cost:28.47, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'162', Cost:18.21, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'83', Cost:9.57, ParentId: '17'},
		]
	},
