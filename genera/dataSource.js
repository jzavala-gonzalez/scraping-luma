const timestamp_saved = '09/20/2023 07:15 AM';
const dataFechaAcualizado = '9/20/2023' + ' 3:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'46', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'46', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'59', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'8', Cost:19.67, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 155,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 155, MVar:'141', Cost:20.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'68', Cost:9.40, ParentId: '17'},
		]
	},
