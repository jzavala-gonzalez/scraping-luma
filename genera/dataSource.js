const timestamp_saved = '08/09/2023 03:25 PM';
const dataFechaAcualizado = '8/9/2023' + ' 11:20:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 509,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'52', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'60', Cost:10.12, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'40', Cost:19.15, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'84', Cost:11.53, ParentId: '17'},
		]
	},
