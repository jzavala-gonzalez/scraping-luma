const timestamp_saved = '08/23/2023 04:40 AM';
const dataFechaAcualizado = '8/23/2023' + ' 12:35:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'45', Cost:10.90, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'65', Cost:18.42, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'66', Cost:9.57, ParentId: '17'},
		]
	},
