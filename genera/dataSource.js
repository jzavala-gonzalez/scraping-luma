const timestamp_saved = '10/17/2023 12:30 PM';
const dataFechaAcualizado = '10/17/2023' + ' 8:26:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'59', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'59', Cost:10.26, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'17', Cost:19.11, ParentId: '14'},
