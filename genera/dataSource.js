const timestamp_saved = '10/28/2023 08:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'36', Cost:11.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'38', Cost:11.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'44', Cost:11.63, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 130,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'23', Cost:28.39, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.39, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 60, MVar:'17', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 37, MVar:'12', Cost:23.60, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'14', Cost:19.10, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'108', Cost:18.23, ParentId: '16'},
		]
	},
