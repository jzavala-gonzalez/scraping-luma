const timestamp_saved = '10/28/2023 08:20 PM';
const dataFechaAcualizado = '10/28/2023' + ' 4:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 384,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'52', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'52', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'54', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 216,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:25.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:25.60, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 90, MVar:'28', Cost:20.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:20.74, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 72,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'7', Cost:30.31, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.38, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 48, MVar:'18', Cost:21.95, ParentId: '14'},
