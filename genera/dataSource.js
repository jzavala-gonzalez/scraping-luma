const timestamp_saved = '11/28/2023 06:30 AM';
const dataFechaAcualizado = '11/28/2023' + ' 2:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'25', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'35', Cost:10.80, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 93, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 332,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.81, ParentId: '11'},
