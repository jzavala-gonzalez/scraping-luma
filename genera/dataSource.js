const timestamp_saved = '11/23/2023 10:50 PM';
const dataFechaAcualizado = '11/23/2023' + ' 6:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'31', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'40', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'54', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'84', Cost:9.17, ParentId: '17'},
		]
	},
