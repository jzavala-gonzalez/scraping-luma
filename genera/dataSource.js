const timestamp_saved = '10/13/2023 11:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 7:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'58', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'61', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'67', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:18.51, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:18.51, ParentId: '11'},
