const timestamp_saved = '07/31/2023 05:50 PM';
const dataFechaAcualizado = '7/31/2023' + ' 1:45:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'54', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'29', Cost:31.36, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 285,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 285, MVar:'105', Cost:11.11, ParentId: '17'},
		]
	},
