const timestamp_saved = '11/16/2023 05:00 PM';
const dataFechaAcualizado = '11/16/2023' + ' 12:56:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'53', Cost:13.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'52', Cost:13.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'51', Cost:13.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.13, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'24', Cost:19.18, ParentId: '14'},
