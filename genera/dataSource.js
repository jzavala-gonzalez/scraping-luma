const timestamp_saved = '10/30/2023 10:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 5:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'43', Cost:10.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'44', Cost:10.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'42', Cost:10.46, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'53', Cost:9.68, ParentId: '17'},
		]
	},
