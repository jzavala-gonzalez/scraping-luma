const timestamp_saved = '12/03/2023 06:45 AM';
const dataFechaAcualizado = '12/3/2023' + ' 2:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 202,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 202, MVar:'61', Cost:4.40, ParentId: '6'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'42', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'45', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'58', Cost:11.63, ParentId: '17'},
		]
	},
