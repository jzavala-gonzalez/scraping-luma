const timestamp_saved = '08/07/2023 05:05 AM';
const dataFechaAcualizado = '8/7/2023' + ' 1:00:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'48', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'43', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'43', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 105,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'10', Cost:27.02, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'6', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'25', Cost:15.55, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'96', Cost:11.62, ParentId: '17'},
		]
	},
