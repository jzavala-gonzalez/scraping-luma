const timestamp_saved = '08/20/2023 09:35 AM';
const dataFechaAcualizado = '8/20/2023' + ' 5:32:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'50', Cost:11.22, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 417,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'0', Cost:6.83, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'12', Cost:6.83, ParentId: '11'},
		]
	},
