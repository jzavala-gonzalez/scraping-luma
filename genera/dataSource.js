const timestamp_saved = '11/07/2023 01:55 PM';
const dataFechaAcualizado = '11/7/2023' + ' 9:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'48', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'46', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'44', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 61, MVar:'10', Cost:20.40, ParentId: '14'},
