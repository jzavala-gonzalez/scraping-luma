const timestamp_saved = '10/15/2023 08:10 AM';
const dataFechaAcualizado = '10/15/2023' + ' 4:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'47', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'49', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'53', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 292,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 292, MVar:'123', Cost:17.21, ParentId: '16'},
		]
	},
