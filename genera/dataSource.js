const timestamp_saved = '09/13/2023 01:00 PM';
const dataFechaAcualizado = '9/13/2023' + ' 8:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'50', Cost:11.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'49', Cost:11.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'65', Cost:11.91, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 70,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 70, MVar:'0', Cost:6.83, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'12', Cost:28.19, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'9', Cost:19.90, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 56,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 18, MVar:'16', Cost:19.60, ParentId: '19'},
