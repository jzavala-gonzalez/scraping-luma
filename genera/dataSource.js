const timestamp_saved = '11/04/2023 05:15 PM';
const dataFechaAcualizado = '11/4/2023' + ' 1:11:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'44', Cost:12.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'44', Cost:12.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'43', Cost:12.86, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'92', Cost:16.77, ParentId: '15'},
