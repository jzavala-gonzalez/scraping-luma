const timestamp_saved = '10/28/2023 10:40 PM';
const dataFechaAcualizado = '10/28/2023' + ' 6:36:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'52', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'52', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'54', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 277,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'25', Cost:18.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 34, MVar:'6', Cost:18.64, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 115, MVar:'33', Cost:18.64, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'17', Cost:21.53, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'11', Cost:18.98, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'78', Cost:16.81, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 340,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 340, MVar:'133', Cost:17.08, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'2', Cost:11.21, ParentId: '17'},
		]
	},
