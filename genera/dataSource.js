const timestamp_saved = '11/09/2023 10:30 PM';
const dataFechaAcualizado = '11/9/2023' + ' 6:26:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'54', Cost:10.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'50', Cost:10.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'50', Cost:10.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'121', Cost:9.18, ParentId: '17'},
		]
	},
