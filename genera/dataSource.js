const timestamp_saved = '11/02/2023 01:00 AM';
const dataFechaAcualizado = '11/1/2023' + ' 8:56:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'73', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'73', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'70', Cost:10.50, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 37, MVar:'0', Cost:26.34, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.00, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:16.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'9', Cost:16.62, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'87', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 361,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 361, MVar:'99', Cost:9.15, ParentId: '17'},
		]
	},
