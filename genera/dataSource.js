const timestamp_saved = '10/19/2023 05:00 PM';
const dataFechaAcualizado = '10/19/2023' + ' 12:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'39', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'49', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'71', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 15,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 15, MVar:'8', Cost:161.73, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'21', Cost:23.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 144,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 144, MVar:'74', Cost:17.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 256,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 256, MVar:'175', Cost:17.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 358,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 358, MVar:'113', Cost:10.56, ParentId: '17'},
		]
	},
