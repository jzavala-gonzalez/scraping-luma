const timestamp_saved = '11/17/2023 04:10 AM';
const dataFechaAcualizado = '11/17/2023' + ' 12:06:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'58', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'59', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'47', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'15', Cost:31.01, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'11', Cost:22.44, ParentId: '14'},
