const timestamp_saved = '10/26/2023 02:20 PM';
const dataFechaAcualizado = '10/26/2023' + ' 10:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'47', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'51', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'52', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'48', Cost:16.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'12', Cost:16.99, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:0, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'83', Cost:16.85, ParentId: '15'},
