const timestamp_saved = '07/31/2023 11:30 PM';
const dataFechaAcualizado = '7/31/2023' + ' 7:25:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 496,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'48', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'49', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 123,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 27, MVar:'1', Cost:26.50, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'7', Cost:30.99, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'87', Cost:16.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'97', Cost:11.00, ParentId: '17'},
		]
	},
