const timestamp_saved = '11/05/2023 03:30 AM';
const dataFechaAcualizado = '11/4/2023' + ' 11:26:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'47', Cost:10.66, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'1', Cost:26.11, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 263,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 108, MVar:'30', Cost:18.65, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'75', Cost:9.21, ParentId: '17'},
		]
	},
