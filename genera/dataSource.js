const timestamp_saved = '10/27/2023 06:55 PM';
const dataFechaAcualizado = '10/27/2023' + ' 2:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'49', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'51', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:10.98, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.45, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:19.19, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'5', Cost:19.19, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 113, MVar:'36', Cost:18.15, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'5', Cost:28.66, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'23', Cost:19.51, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 298,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 298, MVar:'113', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'14', Cost:11.52, ParentId: '17'},
		]
	},
