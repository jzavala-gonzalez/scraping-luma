const timestamp_saved = '08/12/2023 11:30 AM';
const dataFechaAcualizado = '8/12/2023' + ' 7:27:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'46', Cost:10.92, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 278,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 278, MVar:'152', Cost:17.40, ParentId: '16'},
		]
	},
