const timestamp_saved = '08/13/2023 07:45 PM';
const dataFechaAcualizado = '8/13/2023' + ' 3:42:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'35', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'40', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'40', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 48,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 48, MVar:'13', Cost:42.43, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'111', Cost:12.24, ParentId: '17'},
		]
	},
