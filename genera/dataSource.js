const timestamp_saved = '12/02/2023 05:25 PM';
const dataFechaAcualizado = '12/2/2023' + ' 1:21:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 175,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 175, MVar:'71', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'44', Cost:12.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'46', Cost:12.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'44', Cost:12.10, ParentId: '7'},
		]
	},
