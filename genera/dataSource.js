const timestamp_saved = '09/22/2023 04:35 PM';
const dataFechaAcualizado = '9/22/2023' + ' 12:30:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 160, MVar:'61', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'71', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'41', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'45', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'64', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'45', Cost:19.77, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:31.76, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'25', Cost:19.32, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'71', Cost:16.47, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'95', Cost:9.67, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 18, MVar:'0', Cost:26.45, ParentId: '21'},
