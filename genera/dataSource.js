const timestamp_saved = '07/31/2023 08:50 AM';
const dataFechaAcualizado = '7/31/2023' + ' 4:45:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'43', Cost:10.98, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'35', Cost:18.42, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'87', Cost:11.37, ParentId: '17'},
		]
	},
