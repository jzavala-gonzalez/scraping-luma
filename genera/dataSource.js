const timestamp_saved = '12/04/2023 06:55 PM';
const dataFechaAcualizado = '12/4/2023' + ' 2:51:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 491,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'56', Cost:10.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'58', Cost:10.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'56', Cost:10.37, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.42, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'32', Cost:19.49, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'83', Cost:11.35, ParentId: '17'},
		]
	},
