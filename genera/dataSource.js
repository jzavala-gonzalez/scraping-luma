const timestamp_saved = '12/01/2023 07:05 PM';
const dataFechaAcualizado = '12/1/2023' + ' 3:01:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'56', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'58', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'57', Cost:10.24, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 319,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 319, MVar:'88', Cost:9.42, ParentId: '17'},
		]
	},
