const timestamp_saved = '10/16/2023 04:35 AM';
const dataFechaAcualizado = '10/16/2023' + ' 12:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'52', Cost:12.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'49', Cost:12.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'53', Cost:12.62, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 16,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 16, MVar:'2', Cost:26.44, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'9', Cost:17.28, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'75', Cost:16.49, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'88', Cost:9.15, ParentId: '17'},
		]
	},
