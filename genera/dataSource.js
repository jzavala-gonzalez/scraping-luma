const timestamp_saved = '09/24/2023 01:55 AM';
const dataFechaAcualizado = '9/23/2023' + ' 9:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'50', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'50', Cost:11.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'63', Cost:11.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 146,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'0', Cost:22.32, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'6', Cost:28.73, ParentId: '13'},
