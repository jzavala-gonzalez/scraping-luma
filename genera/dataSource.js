const timestamp_saved = '09/22/2023 11:50 PM';
const dataFechaAcualizado = '9/22/2023' + ' 7:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 248, MVar:'73', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 194, MVar:'77', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:9.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'57', Cost:9.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'69', Cost:9.76, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 154, MVar:'55', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 127,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'12', Cost:28.24, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'10', Cost:31.04, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 81,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'8', Cost:29.36, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'17', Cost:19.82, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'74', Cost:16.44, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'124', Cost:32.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'112', Cost:9.13, ParentId: '17'},
		]
	},
	...
	{Index:'22', Type:'Turbina de Gas', Desc:'Aguirre', SiteTotal: 0,
		units:[
			...
			{Index:'1', Unit:'GT2', MW: 0, MVar:'14', Cost:0, ParentId: '22'},
		]
	},
