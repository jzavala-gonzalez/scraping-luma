const timestamp_saved = '10/02/2023 07:10 PM';
const dataFechaAcualizado = '10/2/2023' + ' 3:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'44', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'43', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 159, MVar:'54', Cost:10.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 33,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:50.23, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'34', Cost:18.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'6', Cost:18.97, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'183', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'116', Cost:9.17, ParentId: '17'},
		]
	},
