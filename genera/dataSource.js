const timestamp_saved = '09/29/2023 10:35 PM';
const dataFechaAcualizado = '9/29/2023' + ' 6:30:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'44', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'56', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 178,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 178, MVar:'88', Cost:16.30, ParentId: '15'},
