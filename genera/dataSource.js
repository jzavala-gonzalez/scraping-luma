const timestamp_saved = '10/03/2023 09:30 PM';
const dataFechaAcualizado = '10/3/2023' + ' 5:25:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'40', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'38', Cost:11.21, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 415,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'12', Cost:16.89, ParentId: '11'},
