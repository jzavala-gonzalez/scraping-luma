const timestamp_saved = '10/25/2023 05:55 AM';
const dataFechaAcualizado = '10/25/2023' + ' 1:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'41', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'44', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'47', Cost:11.07, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'38', Cost:17.42, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'10', Cost:17.42, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'17', Cost:19.25, ParentId: '14'},
