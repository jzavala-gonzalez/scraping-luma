const timestamp_saved = '12/05/2023 04:45 AM';
const dataFechaAcualizado = '12/5/2023' + ' 12:41:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'42', Cost:12.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'43', Cost:12.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'52', Cost:12.32, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 43,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 43, MVar:'8', Cost:30.89, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 89, MVar:'17', Cost:18.76, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'108', Cost:19.75, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'63', Cost:10.86, ParentId: '17'},
		]
	},
