const timestamp_saved = '08/02/2023 01:40 PM';
const dataFechaAcualizado = '8/2/2023' + ' 9:35:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'48', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'51', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'40', Cost:15.67, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'97', Cost:11.02, ParentId: '17'},
		]
	},
