const timestamp_saved = '10/12/2023 10:10 AM';
const dataFechaAcualizado = '10/12/2023' + ' 6:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'55', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'61', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 160, MVar:'64', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:18.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'9', Cost:18.52, ParentId: '11'},
