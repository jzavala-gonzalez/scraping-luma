const timestamp_saved = '08/11/2023 09:40 PM';
const dataFechaAcualizado = '8/11/2023' + ' 5:37:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'46', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'48', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'46', Cost:10.82, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.74, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:30.53, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'34', Cost:19.31, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 337,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 337, MVar:'137', Cost:11.48, ParentId: '17'},
		]
	},
