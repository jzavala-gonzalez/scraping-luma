const timestamp_saved = '12/03/2023 04:00 PM';
const dataFechaAcualizado = '12/3/2023' + ' 11:56:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1737},
...
const dataLoadPerSite = [
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:17.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'36', Cost:8.77, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:8.77, ParentId: '11'},
		]
	},
