const timestamp_saved = '12/06/2023 04:00 PM';
const dataFechaAcualizado = '12/6/2023' + ' 11:55:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Reserva en Rotación', value: 563},
	{Index:'6', Desc:'Reserva Operacional', value: 931},
	{Index:'7', Desc:'Capacidad Disponible', value: 3013},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 313,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'47', Cost:12.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'49', Cost:12.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'58', Cost:12.61, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'68', Cost:14.56, ParentId: '17'},
		]
	},
