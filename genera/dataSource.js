const timestamp_saved = '09/25/2023 09:20 PM';
const dataFechaAcualizado = '9/25/2023' + ' 5:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'46', Cost:12.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'48', Cost:12.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'56', Cost:12.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'5', Cost:26.94, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:17.55, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'10', Cost:17.55, ParentId: '11'},
