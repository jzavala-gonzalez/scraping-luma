const timestamp_saved = '09/24/2023 07:05 PM';
const dataFechaAcualizado = '9/24/2023' + ' 3:00:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2338},
	{Index:'7', Desc:'Máxima para Hoy', value: 2429},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'50', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:10.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'58', Cost:10.78, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 73,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 73, MVar:'0', Cost:6.54, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 99,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'2', Cost:27.15, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.41, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'5', Cost:27.88, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'0', Cost:22.27, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'0', Cost:45.55, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'6', Cost:28.27, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'0', Cost:17.13, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:30.84, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 10,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'1', Unit:'Gas 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
			{Index:'2', Unit:'Gas 3', MW: 10, MVar:'0', Cost:54.73, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'32', Cost:19.50, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 147, MVar:'91', Cost:17.05, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'97', Cost:9.14, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 53,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 11, MVar:'5', Cost:18.32, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 24, MVar:'18', Cost:17, ParentId: '19'},
		]
	},
