const timestamp_saved = '09/04/2023 04:45 AM';
const dataFechaAcualizado = '9/4/2023' + ' 12:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'37', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'40', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'53', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'67', Cost:9.18, ParentId: '17'},
		]
	},
