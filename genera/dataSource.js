const timestamp_saved = '11/30/2023 01:15 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:11:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'52', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'53', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'76', Cost:9.56, ParentId: '17'},
		]
	},
