const timestamp_saved = '08/19/2023 10:55 PM';
const dataFechaAcualizado = '8/19/2023' + ' 6:52:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'60', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'59', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'59', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'86', Cost:9.19, ParentId: '17'},
		]
	},
