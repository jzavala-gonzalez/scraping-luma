const timestamp_saved = '09/14/2023 06:00 AM';
const dataFechaAcualizado = '9/14/2023' + ' 1:55:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'51', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'65', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 15,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 15, MVar:'1', Cost:28.50, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'56', Cost:16.97, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'156', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 228,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 228, MVar:'84', Cost:9.83, ParentId: '17'},
		]
	},
