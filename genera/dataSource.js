const timestamp_saved = '08/04/2023 08:50 AM';
const dataFechaAcualizado = '8/4/2023' + ' 4:45:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'38', Cost:11.06, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'73', Cost:11.41, ParentId: '17'},
		]
	},
