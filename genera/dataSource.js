const timestamp_saved = '12/01/2023 06:45 PM';
const dataFechaAcualizado = '12/1/2023' + ' 2:41:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2244},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'58', Cost:10.20, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'27', Cost:19.24, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'84', Cost:9.60, ParentId: '17'},
		]
	},
