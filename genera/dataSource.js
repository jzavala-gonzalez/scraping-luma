const timestamp_saved = '10/14/2023 12:45 PM';
const dataFechaAcualizado = '10/14/2023' + ' 8:41:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 132, MVar:'48', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'65', Cost:9.26, ParentId: '17'},
		]
	},
