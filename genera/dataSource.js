const timestamp_saved = '10/25/2023 02:45 AM';
const dataFechaAcualizado = '10/24/2023' + ' 10:41:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'49', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'52', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'53', Cost:11.10, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 1, MVar:'0', Cost:24.57, ParentId: '8'},
			{Index:'4', Unit:'Daguao', MW: 21, MVar:'0', Cost:1.78, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 91,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'4', Cost:26.45, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'23', Cost:19.49, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'162', Cost:16.74, ParentId: '16'},
		]
	},
