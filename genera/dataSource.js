const timestamp_saved = '10/19/2023 07:40 PM';
const dataFechaAcualizado = '10/19/2023' + ' 3:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'45', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'51', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'73', Cost:10.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 88,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.62, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'37', Cost:18.17, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'9', Cost:18.17, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:31.92, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 42,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 42, MVar:'21', Cost:23.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'84', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'183', Cost:17.14, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'118', Cost:10.51, ParentId: '17'},
		]
	},
