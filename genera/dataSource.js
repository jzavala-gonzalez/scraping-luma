const timestamp_saved = '12/03/2023 07:00 PM';
const dataFechaAcualizado = '12/3/2023' + ' 2:56:24 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 706},
	{Index:'4', Desc:'Reserva Operacional', value: 1343},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 159,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 159, MVar:'62', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'38', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'40', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'45', Cost:12.46, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 66,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 66, MVar:'20', Cost:19.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 217,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 217, MVar:'96', Cost:18.45, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 230,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 230, MVar:'55', Cost:11.96, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 76,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 30, MVar:'16', Cost:19.60, ParentId: '19'},
