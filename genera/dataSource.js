const timestamp_saved = '11/12/2023 04:20 AM';
const dataFechaAcualizado = '11/12/2023' + ' 12:16:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 336,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'45', Cost:12.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'47', Cost:12.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'55', Cost:12.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 28,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 5, MVar:'0', Cost:23.22, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.06, ParentId: '13'},
