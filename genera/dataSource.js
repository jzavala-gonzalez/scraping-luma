const timestamp_saved = '11/14/2023 04:10 AM';
const dataFechaAcualizado = '11/14/2023' + ' 12:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'51', Cost:11.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'55', Cost:11.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'57', Cost:11.08, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'11', Cost:31.17, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'12', Cost:31.14, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'13', Cost:18.67, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'106', Cost:10.87, ParentId: '17'},
		]
	},
