const timestamp_saved = '09/01/2023 06:05 AM';
const dataFechaAcualizado = '9/1/2023' + ' 2:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'39', Cost:12.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:12.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'58', Cost:12.08, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 38,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 14, MVar:'1', Cost:26.41, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 122, MVar:'0', Cost:16.94, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'10', Cost:16.94, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'140', Cost:16.96, ParentId: '16'},
		]
	},
