const timestamp_saved = '11/11/2023 10:55 PM';
const dataFechaAcualizado = '11/11/2023' + ' 6:51:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'54', Cost:10.95, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'114', Cost:9.13, ParentId: '17'},
		]
	},
