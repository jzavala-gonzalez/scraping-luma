const timestamp_saved = '08/08/2023 07:50 AM';
const dataFechaAcualizado = '8/8/2023' + ' 3:45:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'40', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'46', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 230,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 230, MVar:'135', Cost:18.22, ParentId: '16'},
		]
	},
