const timestamp_saved = '11/26/2023 02:10 PM';
const dataFechaAcualizado = '11/26/2023' + ' 10:06:23 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 1799},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'19', Cost:11.59, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'29', Cost:11.59, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'46', Cost:11.59, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 179,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'116', Cost:19.77, ParentId: '16'},
		]
	},
