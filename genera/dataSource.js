const timestamp_saved = '11/16/2023 03:40 PM';
const dataFechaAcualizado = '11/16/2023' + ' 11:36:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'50', Cost:12.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'51', Cost:12.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'51', Cost:12.47, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.22, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'80', Cost:9.99, ParentId: '17'},
		]
	},
