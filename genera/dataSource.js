const timestamp_saved = '10/13/2023 07:50 AM';
const dataFechaAcualizado = '10/13/2023' + ' 3:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'56', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'60', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'65', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'66', Cost:9.16, ParentId: '17'},
		]
	},
