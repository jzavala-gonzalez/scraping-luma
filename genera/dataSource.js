const timestamp_saved = '10/14/2023 03:20 AM';
const dataFechaAcualizado = '10/13/2023' + ' 11:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'67', Cost:10.30, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 312,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 312, MVar:'155', Cost:16.80, ParentId: '16'},
		]
	},
