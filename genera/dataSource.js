const timestamp_saved = '11/10/2023 11:05 AM';
const dataFechaAcualizado = '11/10/2023' + ' 7:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'55', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'44', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'69', Cost:9.54, ParentId: '17'},
		]
	},
