const timestamp_saved = '08/04/2023 03:55 AM';
const dataFechaAcualizado = '8/3/2023' + ' 11:50:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'43', Cost:10.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'47', Cost:10.71, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 51,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'2', Cost:32.18, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:31.94, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'1', Cost:31.98, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 91, MVar:'15', Cost:18.72, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'99', Cost:16.59, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 156, MVar:'21', Cost:15.62, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'91', Cost:10.89, ParentId: '17'},
		]
	},
