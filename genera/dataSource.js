const timestamp_saved = '11/17/2023 05:30 PM';
const dataFechaAcualizado = '11/17/2023' + ' 1:26:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2402},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'65', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'65', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'50', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'32', Cost:31.09, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.47, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:31.88, ParentId: '12'},
