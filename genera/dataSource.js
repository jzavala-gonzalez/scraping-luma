const timestamp_saved = '10/04/2023 03:55 AM';
const dataFechaAcualizado = '10/3/2023' + ' 11:50:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'38', Cost:10.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'37', Cost:10.74, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'0', Cost:26.37, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 244,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 244, MVar:'98', Cost:9.87, ParentId: '17'},
		]
	},
