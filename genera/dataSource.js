const timestamp_saved = '11/15/2023 10:35 AM';
const dataFechaAcualizado = '11/15/2023' + ' 6:31:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'43', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'44', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'45', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:17.46, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'75', Cost:9.79, ParentId: '17'},
		]
	},
