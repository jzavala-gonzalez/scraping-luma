const timestamp_saved = '11/14/2023 12:50 AM';
const dataFechaAcualizado = '11/13/2023' + ' 8:46:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'66', Cost:9.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 177, MVar:'71', Cost:9.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'68', Cost:9.72, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 129,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'27', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 63,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 15, MVar:'0', Cost:26.57, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'28', Cost:28.01, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'15', Cost:31.12, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'14', Cost:29.35, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'77', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'134', Cost:10.88, ParentId: '17'},
		]
	},
