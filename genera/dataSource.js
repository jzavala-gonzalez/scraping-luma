const timestamp_saved = '10/06/2023 04:20 AM';
const dataFechaAcualizado = '10/6/2023' + ' 12:16:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'40', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'38', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'51', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 2, MVar:'0', Cost:23.27, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 95, MVar:'30', Cost:20.16, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 39, MVar:'9', Cost:20.16, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:31.45, ParentId: '12'},
