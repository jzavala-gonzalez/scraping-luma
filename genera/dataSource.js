const timestamp_saved = '10/22/2023 01:45 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 112, MVar:'39', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'40', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'45', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'15', Cost:18.97, ParentId: '14'},
