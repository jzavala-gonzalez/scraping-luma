const timestamp_saved = '12/05/2023 03:10 AM';
const dataFechaAcualizado = '12/4/2023' + ' 11:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'48', Cost:11.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'49', Cost:11.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'57', Cost:11.22, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 19,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:31.35, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 179,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'4', Cost:18.78, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'16', Cost:18.69, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'120', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'76', Cost:10.87, ParentId: '17'},
		]
	},
