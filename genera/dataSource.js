const timestamp_saved = '09/11/2023 06:55 AM';
const dataFechaAcualizado = '9/11/2023' + ' 2:50:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'67', Cost:10.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'65', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'64', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'10', Cost:30.94, ParentId: '10'},
		]
	},
