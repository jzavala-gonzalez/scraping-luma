const timestamp_saved = '11/17/2023 07:20 PM';
const dataFechaAcualizado = '11/17/2023' + ' 3:16:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'7', Desc:'Máxima para Hoy', value: 2507},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 493,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'70', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'69', Cost:10.47, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'85', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'131', Cost:9.11, ParentId: '17'},
		]
	},
