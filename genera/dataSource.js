const timestamp_saved = '09/28/2023 11:20 PM';
const dataFechaAcualizado = '9/28/2023' + ' 7:15:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'54', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'56', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'55', Cost:10.28, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'11', Cost:27.52, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 348,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'41', Cost:8.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'11', Cost:8.86, ParentId: '11'},
