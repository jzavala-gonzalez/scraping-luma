const timestamp_saved = '10/11/2023 06:50 PM';
const dataFechaAcualizado = '10/11/2023' + ' 2:46:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'65', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'71', Cost:10.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'72', Cost:10.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'44', Cost:17.67, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.67, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 118, MVar:'36', Cost:18.34, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'7', Cost:18.34, ParentId: '11'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 273,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 273, MVar:'180', Cost:17.46, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'101', Cost:9.12, ParentId: '17'},
		]
	},
