const timestamp_saved = '08/10/2023 07:55 PM';
const dataFechaAcualizado = '8/10/2023' + ' 3:50:43 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'53', Cost:10.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'55', Cost:10.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 84, MVar:'0', Cost:9.06, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 143, MVar:'34', Cost:0, ParentId: '8'},
			{Index:'8', Unit:'FEMA GT SJ', MW: 0, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'1', Cost:26.74, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'7', Cost:28.26, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'8', Cost:28.42, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'43', Cost:20.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'11', Cost:20.06, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'182', Cost:17.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'129', Cost:11.29, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 62,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 8, MVar:'7', Cost:17, ParentId: '19'},
		]
	},
