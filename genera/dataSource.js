const timestamp_saved = '10/25/2023 07:30 PM';
const dataFechaAcualizado = '10/25/2023' + ' 3:26:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'49', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 165, MVar:'52', Cost:10.51, ParentId: '7'},
		]
	},
