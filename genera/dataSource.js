const timestamp_saved = '11/05/2023 09:20 PM';
const dataFechaAcualizado = '11/5/2023' + ' 5:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'52', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'48', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'85', Cost:16.90, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'76', Cost:9.20, ParentId: '17'},
		]
	},
