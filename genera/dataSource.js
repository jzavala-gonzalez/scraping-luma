const timestamp_saved = '11/06/2023 09:55 AM';
const dataFechaAcualizado = '11/6/2023' + ' 5:51:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'47', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'46', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'43', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 56, MVar:'11', Cost:8.17, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'85', Cost:16.75, ParentId: '15'},
