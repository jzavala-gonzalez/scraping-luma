const timestamp_saved = '11/15/2023 06:40 PM';
const dataFechaAcualizado = '11/15/2023' + ' 2:36:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'61', Cost:10.28, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 99, MVar:'89', Cost:18.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 240,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 240, MVar:'164', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 281, MVar:'99', Cost:9.58, ParentId: '17'},
		]
	},
