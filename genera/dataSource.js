const timestamp_saved = '08/01/2023 06:50 AM';
const dataFechaAcualizado = '8/1/2023' + ' 2:45:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'42', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'46', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'39', Cost:20.50, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 330,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'84', Cost:16.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'33', Cost:15.50, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 218,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 218, MVar:'135', Cost:18.29, ParentId: '16'},
		]
	},
