const timestamp_saved = '11/05/2023 05:35 PM';
const dataFechaAcualizado = '11/5/2023' + ' 1:31:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'44', Cost:12.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'43', Cost:12.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'43', Cost:12.28, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 121, MVar:'37', Cost:17.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'11', Cost:17.73, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 60, MVar:'11', Cost:20.25, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 240,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 240, MVar:'56', Cost:9.94, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 39, MVar:'4', Cost:19.60, ParentId: '19'},
