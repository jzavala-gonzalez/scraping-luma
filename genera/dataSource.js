const timestamp_saved = '09/08/2023 12:05 PM';
const dataFechaAcualizado = '9/8/2023' + ' 8:00:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'60', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'55', Cost:10.30, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 46, MVar:'10', Cost:8.62, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:30.48, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'142', Cost:17.14, ParentId: '16'},
		]
	},
