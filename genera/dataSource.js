const timestamp_saved = '10/21/2023 09:55 AM';
const dataFechaAcualizado = '10/21/2023' + ' 5:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'32', Cost:11.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'31', Cost:11.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'30', Cost:11.80, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'71', Cost:11.05, ParentId: '17'},
		]
	},
