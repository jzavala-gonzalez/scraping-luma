const timestamp_saved = '08/11/2023 12:35 PM';
const dataFechaAcualizado = '8/11/2023' + ' 8:30:44 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2477},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'40', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'44', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'43', Cost:10.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 113,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 121, MVar:'25', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'6', Cost:30.97, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'9', Cost:31.10, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'120', Cost:11.71, ParentId: '17'},
		]
	},
