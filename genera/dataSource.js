const timestamp_saved = '10/04/2023 12:25 AM';
const dataFechaAcualizado = '10/3/2023' + ' 8:20:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'45', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'42', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'55', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 41, MVar:'12', Cost:22.61, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'15', Cost:18.80, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 376,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 376, MVar:'169', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'120', Cost:9.17, ParentId: '17'},
		]
	},
