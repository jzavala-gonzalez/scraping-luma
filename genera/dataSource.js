const timestamp_saved = '11/12/2023 08:10 PM';
const dataFechaAcualizado = '11/12/2023' + ' 4:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'53', Cost:10.59, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'16', Cost:31.20, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'107', Cost:9.18, ParentId: '17'},
		]
	},
