const timestamp_saved = '11/27/2023 02:50 PM';
const dataFechaAcualizado = '11/27/2023' + ' 10:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'34', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'44', Cost:10.90, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'97', Cost:9.57, ParentId: '17'},
		]
	},
