const timestamp_saved = '11/24/2023 04:10 PM';
const dataFechaAcualizado = '11/24/2023' + ' 12:06:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'29', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'39', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'51', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'80', Cost:9.71, ParentId: '17'},
		]
	},
