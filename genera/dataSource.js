const timestamp_saved = '10/29/2023 02:40 AM';
const dataFechaAcualizado = '10/28/2023' + ' 10:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'50', Cost:10.58, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 128,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'7', Cost:18.97, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'53', Cost:16.82, ParentId: '15'},
