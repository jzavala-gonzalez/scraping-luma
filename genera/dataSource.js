const timestamp_saved = '10/08/2023 08:20 PM';
const dataFechaAcualizado = '10/8/2023' + ' 4:16:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 244,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 244, MVar:'90', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'53', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'49', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'1', Cost:40.11, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'36', Cost:17.49, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:17.49, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 169,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 169, MVar:'104', Cost:16.52, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 344,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 344, MVar:'166', Cost:16.84, ParentId: '16'},
		]
	},
