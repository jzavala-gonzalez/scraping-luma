const timestamp_saved = '11/16/2023 03:00 PM';
const dataFechaAcualizado = '11/16/2023' + ' 10:56:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'51', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'50', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'50', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:31.84, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'76', Cost:18.45, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 199,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'135', Cost:19.03, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 193,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 193, MVar:'76', Cost:10.63, ParentId: '17'},
		]
	},
