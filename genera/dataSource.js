const timestamp_saved = '10/21/2023 10:45 AM';
const dataFechaAcualizado = '10/21/2023' + ' 6:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'35', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'34', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'37', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'65', Cost:11.05, ParentId: '17'},
		]
	},
