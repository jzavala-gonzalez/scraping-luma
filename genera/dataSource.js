const timestamp_saved = '09/09/2023 01:05 PM';
const dataFechaAcualizado = '9/9/2023' + ' 9:00:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'52', Cost:11.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'57', Cost:11.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'54', Cost:11.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 119,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 83, MVar:'6', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'8', Cost:31.43, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'21', Cost:19.14, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'88', Cost:16.94, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 366,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 366, MVar:'146', Cost:16.66, ParentId: '16'},
		]
	},
