const timestamp_saved = '08/04/2023 11:40 PM';
const dataFechaAcualizado = '8/4/2023' + ' 7:35:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'51', Cost:10.08, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'53', Cost:10.08, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'99', Cost:16.50, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'53', Cost:15.63, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 306, MVar:'152', Cost:17.13, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'101', Cost:11.54, ParentId: '17'},
		]
	},
