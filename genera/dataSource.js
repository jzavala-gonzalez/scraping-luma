const timestamp_saved = '09/27/2023 10:30 PM';
const dataFechaAcualizado = '9/27/2023' + ' 6:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'31', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'31', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'63', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'140', Cost:18.24, ParentId: '16'},
		]
	},
