const timestamp_saved = '09/05/2023 01:00 PM';
const dataFechaAcualizado = '9/5/2023' + ' 8:55:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'43', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'48', Cost:10.36, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 78,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 131, MVar:'57', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'36', Cost:19.30, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'155', Cost:18.22, ParentId: '16'},
		]
	},
