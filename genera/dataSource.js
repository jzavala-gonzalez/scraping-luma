const timestamp_saved = '10/16/2023 01:55 PM';
const dataFechaAcualizado = '10/16/2023' + ' 9:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'60', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'59', Cost:10.83, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'36', Cost:17.05, ParentId: '11'},
