const timestamp_saved = '09/20/2023 07:20 PM';
const dataFechaAcualizado = '9/20/2023' + ' 3:15:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'54', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'56', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'62', Cost:10.19, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 96,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'14', Cost:36.47, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 91,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'0', Cost:30.66, ParentId: '13'},
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'7', Cost:28.67, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 36,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 36, MVar:'30', Cost:26.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'87', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 310,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 310, MVar:'167', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'107', Cost:9.12, ParentId: '17'},
		]
	},
