const timestamp_saved = '10/20/2023 02:00 PM';
const dataFechaAcualizado = '10/20/2023' + ' 9:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'45', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'51', Cost:10.73, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'102', Cost:10.84, ParentId: '17'},
		]
	},
