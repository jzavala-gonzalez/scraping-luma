const timestamp_saved = '08/31/2023 05:35 PM';
const dataFechaAcualizado = '8/31/2023' + ' 1:30:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'53', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'62', Cost:10.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'68', Cost:10.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'48', Cost:18.86, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'11', Cost:18.86, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 165, MVar:'0', Cost:17.03, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'42', Cost:19.35, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'96', Cost:16.93, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'102', Cost:9.33, ParentId: '17'},
		]
	},
