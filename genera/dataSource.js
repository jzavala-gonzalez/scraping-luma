const timestamp_saved = '09/18/2023 11:00 PM';
const dataFechaAcualizado = '9/18/2023' + ' 6:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 184, MVar:'103', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 541,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'61', Cost:9.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'61', Cost:9.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 192, MVar:'72', Cost:9.89, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 74, MVar:'18', Cost:28.26, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 40,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'10', Cost:29.34, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'33', Cost:19.02, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'97', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 364,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 364, MVar:'196', Cost:16.66, ParentId: '16'},
		]
	},
