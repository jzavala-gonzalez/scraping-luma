const timestamp_saved = '11/10/2023 08:25 AM';
const dataFechaAcualizado = '11/10/2023' + ' 4:21:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'41', Cost:10.96, ParentId: '7'},
		]
	},
