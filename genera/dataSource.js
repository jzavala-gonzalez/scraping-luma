const timestamp_saved = '08/17/2023 08:20 AM';
const dataFechaAcualizado = '8/17/2023' + ' 4:17:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'42', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'57', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'69', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'4', Cost:31.26, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'11', Cost:18.64, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'128', Cost:18.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'68', Cost:9.43, ParentId: '17'},
		]
	},
