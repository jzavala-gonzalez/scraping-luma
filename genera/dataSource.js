const timestamp_saved = '10/16/2023 02:50 PM';
const dataFechaAcualizado = '10/16/2023' + ' 10:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'64', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'62', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'176', Cost:17.80, ParentId: '16'},
		]
	},
