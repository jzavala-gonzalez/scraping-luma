const timestamp_saved = '12/04/2023 06:55 AM';
const dataFechaAcualizado = '12/4/2023' + ' 2:51:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'36', Cost:13.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'37', Cost:13.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 109, MVar:'44', Cost:13.05, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'43', Cost:11.64, ParentId: '17'},
		]
	},
