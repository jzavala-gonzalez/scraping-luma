const timestamp_saved = '11/24/2023 03:50 AM';
const dataFechaAcualizado = '11/23/2023' + ' 11:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'37', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'53', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'87', Cost:9.21, ParentId: '17'},
		]
	},
