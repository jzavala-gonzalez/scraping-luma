const timestamp_saved = '10/14/2023 05:25 PM';
const dataFechaAcualizado = '10/14/2023' + ' 1:21:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 502,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'53', Cost:10.10, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 119, MVar:'84', Cost:18.57, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'86', Cost:9.26, ParentId: '17'},
		]
	},
