const timestamp_saved = '10/04/2023 08:30 AM';
const dataFechaAcualizado = '10/4/2023' + ' 4:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'35', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'32', Cost:10.65, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'137', Cost:18.27, ParentId: '16'},
		]
	},
