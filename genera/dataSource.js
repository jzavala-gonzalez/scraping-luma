const timestamp_saved = '10/30/2023 12:30 PM';
const dataFechaAcualizado = '10/30/2023' + ' 8:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'54', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'55', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'49', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.24, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 123,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 53, MVar:'15', Cost:21.18, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:18.79, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 132,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 132, MVar:'76', Cost:17.85, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'75', Cost:9.41, ParentId: '17'},
		]
	},
