const timestamp_saved = '10/31/2023 02:45 AM';
const dataFechaAcualizado = '10/30/2023' + ' 10:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'58', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'62', Cost:11.05, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'164', Cost:16.79, ParentId: '16'},
		]
	},
