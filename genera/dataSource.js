const timestamp_saved = '12/01/2023 12:15 AM';
const dataFechaAcualizado = '11/30/2023' + ' 8:11:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'62', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'63', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'61', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'20', Cost:30.97, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 424,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.47, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'162', Cost:18.28, ParentId: '16'},
		]
	},
