const timestamp_saved = '10/29/2023 07:40 PM';
const dataFechaAcualizado = '10/29/2023' + ' 3:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 315,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'43', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'44', Cost:12.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'68', Cost:12.60, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 119, MVar:'35', Cost:19.26, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'7', Cost:19.26, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'46', Cost:16.97, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 120,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 49, MVar:'16', Cost:21.61, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'128', Cost:16.66, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 0, MVar:'21', Cost:13.80, ParentId: '17'},
		]
	},
