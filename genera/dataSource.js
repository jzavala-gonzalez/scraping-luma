const timestamp_saved = '11/03/2023 12:20 PM';
const dataFechaAcualizado = '11/3/2023' + ' 8:16:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'51', Cost:11.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'48', Cost:11.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'47', Cost:11.90, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 267,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 267, MVar:'139', Cost:17.78, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 56,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 18, MVar:'11', Cost:19.60, ParentId: '19'},
