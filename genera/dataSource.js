const timestamp_saved = '08/02/2023 01:20 PM';
const dataFechaAcualizado = '8/2/2023' + ' 9:15:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'49', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'50', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 298,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 298, MVar:'100', Cost:11.02, ParentId: '17'},
		]
	},
