const timestamp_saved = '11/07/2023 08:50 PM';
const dataFechaAcualizado = '11/7/2023' + ' 4:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'51', Cost:11.04, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'45', Cost:8.21, ParentId: '11'},
