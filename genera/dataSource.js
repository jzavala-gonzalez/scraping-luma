const timestamp_saved = '10/30/2023 02:30 PM';
const dataFechaAcualizado = '10/30/2023' + ' 10:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 477,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 163, MVar:'62', Cost:10.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'61', Cost:10.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'63', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'33', Cost:19.18, ParentId: '14'},
