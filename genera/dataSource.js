const timestamp_saved = '11/24/2023 05:40 PM';
const dataFechaAcualizado = '11/24/2023' + ' 1:36:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'32', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'40', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'53', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'84', Cost:9.88, ParentId: '17'},
		]
	},
