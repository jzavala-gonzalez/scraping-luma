const timestamp_saved = '10/30/2023 08:00 AM';
const dataFechaAcualizado = '10/30/2023' + ' 3:56:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 338,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'32', Cost:12.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'33', Cost:12.42, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'34', Cost:17.30, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 208,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 208, MVar:'89', Cost:18.74, ParentId: '16'},
		]
	},
