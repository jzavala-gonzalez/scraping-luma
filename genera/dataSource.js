const timestamp_saved = '10/27/2023 01:50 PM';
const dataFechaAcualizado = '10/27/2023' + ' 9:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'54', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'51', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'113', Cost:17.43, ParentId: '16'},
		]
	},
