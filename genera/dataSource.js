const timestamp_saved = '11/29/2023 07:40 AM';
const dataFechaAcualizado = '11/29/2023' + ' 3:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'22', Cost:13.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'30', Cost:13.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'48', Cost:13.00, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 433,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 163, MVar:'48', Cost:8.19, ParentId: '11'},
