const timestamp_saved = '10/15/2023 01:05 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:01:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'46', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'49', Cost:10.94, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'97', Cost:16.92, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'67', Cost:9.52, ParentId: '17'},
		]
	},
