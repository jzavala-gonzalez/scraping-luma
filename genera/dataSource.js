const timestamp_saved = '09/29/2023 02:05 PM';
const dataFechaAcualizado = '9/29/2023' + ' 10:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'37', Cost:10.99, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'34', Cost:10.99, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 32,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 32, MVar:'15', Cost:28.07, ParentId: '14'},
