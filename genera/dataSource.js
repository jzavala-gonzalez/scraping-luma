const timestamp_saved = '08/15/2023 03:05 PM';
const dataFechaAcualizado = '8/15/2023' + ' 11:02:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 147, MVar:'52', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 53, MVar:'30', Cost:21.18, ParentId: '14'},
