const timestamp_saved = '07/29/2023 10:30 AM';
const dataFechaAcualizado = '7/29/2023' + ' 6:25:33 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'43', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'44', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 281,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'25', Cost:15.86, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'75', Cost:13.63, ParentId: '17'},
		]
	},
