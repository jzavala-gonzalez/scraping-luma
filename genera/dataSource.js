const timestamp_saved = '12/01/2023 02:00 PM';
const dataFechaAcualizado = '12/1/2023' + ' 9:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'47', Cost:11.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'51', Cost:11.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'53', Cost:11.48, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 286,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 286, MVar:'74', Cost:9.53, ParentId: '17'},
		]
	},
