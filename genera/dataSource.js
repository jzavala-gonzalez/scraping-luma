const timestamp_saved = '10/31/2023 01:10 PM';
const dataFechaAcualizado = '10/31/2023' + ' 9:06:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'61', Cost:10.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'61', Cost:10.34, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'76', Cost:9.39, ParentId: '17'},
		]
	},
