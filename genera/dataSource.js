const timestamp_saved = '10/01/2023 11:40 AM';
const dataFechaAcualizado = '10/1/2023' + ' 7:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'58', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 57, MVar:'57', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'26', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'24', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'41', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'2', Cost:30.88, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:17.58, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'103', Cost:17.83, ParentId: '16'},
		]
	},
