const timestamp_saved = '11/30/2023 07:50 AM';
const dataFechaAcualizado = '11/30/2023' + ' 3:46:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'35', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'38', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'43', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'47', Cost:17.38, ParentId: '11'},
