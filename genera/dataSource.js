const timestamp_saved = '08/13/2023 10:20 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:17:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'36', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'40', Cost:11.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'41', Cost:11.28, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'144', Cost:17.07, ParentId: '16'},
		]
	},
