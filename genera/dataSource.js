const timestamp_saved = '10/14/2023 05:10 PM';
const dataFechaAcualizado = '10/14/2023' + ' 1:06:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 155, MVar:'51', Cost:10.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 328,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 328, MVar:'81', Cost:9.30, ParentId: '17'},
		]
	},
