const timestamp_saved = '09/28/2023 03:30 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:25:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'26', Cost:12.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'24', Cost:12.33, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'46', Cost:17.60, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:17.60, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:20.76, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'0', Cost:20.76, ParentId: '11'},
		]
	},
