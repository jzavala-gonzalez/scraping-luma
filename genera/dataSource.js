const timestamp_saved = '08/25/2023 08:40 AM';
const dataFechaAcualizado = '8/25/2023' + ' 4:35:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'56', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'54', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'8', Cost:8.11, ParentId: '11'},
		]
	},
