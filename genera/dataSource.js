const timestamp_saved = '10/20/2023 04:10 PM';
const dataFechaAcualizado = '10/20/2023' + ' 12:06:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'42', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'50', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'48', Cost:12.14, ParentId: '7'},
		]
	},
