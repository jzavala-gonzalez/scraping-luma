const timestamp_saved = '08/21/2023 05:15 PM';
const dataFechaAcualizado = '8/21/2023' + ' 1:10:32 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1091},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'58', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'38', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'59', Cost:10.85, ParentId: '7'},
		]
	},
