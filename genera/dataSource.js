const timestamp_saved = '08/03/2023 03:20 PM';
const dataFechaAcualizado = '8/3/2023' + ' 11:15:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'47', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'45', Cost:10.32, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 295,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'111', Cost:17.10, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'86', Cost:11.39, ParentId: '17'},
		]
	},
