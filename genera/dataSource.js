const timestamp_saved = '11/28/2023 07:40 AM';
const dataFechaAcualizado = '11/28/2023' + ' 3:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'19', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'34', Cost:11.01, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'136', Cost:17.83, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'71', Cost:9.49, ParentId: '17'},
		]
	},
