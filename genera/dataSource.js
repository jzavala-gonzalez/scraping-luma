const timestamp_saved = '10/13/2023 02:00 PM';
const dataFechaAcualizado = '10/13/2023' + ' 9:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'60', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'66', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'70', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 20, MVar:'11', Cost:43.29, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:16.88, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'178', Cost:18.24, ParentId: '16'},
		]
	},
