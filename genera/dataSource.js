const timestamp_saved = '08/22/2023 02:10 AM';
const dataFechaAcualizado = '8/21/2023' + ' 10:05:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'53', Cost:10.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'53', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'73', Cost:17.09, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'149', Cost:17.26, ParentId: '16'},
		]
	},
