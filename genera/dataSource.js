const timestamp_saved = '10/16/2023 11:30 PM';
const dataFechaAcualizado = '10/16/2023' + ' 7:26:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 553,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'79', Cost:9.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'82', Cost:9.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 210, MVar:'82', Cost:9.71, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 115,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 47, MVar:'6', Cost:22.38, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'47', Cost:16.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:16.52, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'50', Cost:8.10, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 29, MVar:'0', Cost:31.75, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'18', Cost:18.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'94', Cost:17.06, ParentId: '15'},
