const timestamp_saved = '08/09/2023 01:00 PM';
const dataFechaAcualizado = '8/9/2023' + ' 8:55:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 487,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 154, MVar:'61', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 280, MVar:'128', Cost:17.38, ParentId: '16'},
		]
	},
