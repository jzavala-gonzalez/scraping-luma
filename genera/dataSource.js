const timestamp_saved = '08/27/2023 06:55 AM';
const dataFechaAcualizado = '8/27/2023' + ' 2:50:49 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:33.26, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'81', Cost:16.67, ParentId: '17'},
		]
	},
