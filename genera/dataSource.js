const timestamp_saved = '09/30/2023 01:45 AM';
const dataFechaAcualizado = '9/29/2023' + ' 9:40:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'46', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'44', Cost:10.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'56', Cost:10.63, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 116,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'13', Cost:27.47, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:17.81, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'7', Cost:29.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'9', Cost:19.07, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 175,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 175, MVar:'85', Cost:16.48, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 305,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 305, MVar:'170', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'127', Cost:9.13, ParentId: '17'},
		]
	},
