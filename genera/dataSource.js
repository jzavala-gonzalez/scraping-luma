const timestamp_saved = '11/23/2023 08:05 AM';
const dataFechaAcualizado = '11/23/2023' + ' 4:01:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 211, MVar:'62', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 94, MVar:'17', Cost:13.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'27', Cost:13.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 102, MVar:'45', Cost:13.51, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 221,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 221, MVar:'109', Cost:18.34, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'59', Cost:9.23, ParentId: '17'},
		]
	},
