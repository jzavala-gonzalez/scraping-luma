const timestamp_saved = '10/30/2023 01:10 AM';
const dataFechaAcualizado = '10/29/2023' + ' 9:06:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'48', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'50', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'72', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 3,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 3, MVar:'1', Cost:21.51, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 370,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'47', Cost:16.91, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 315, MVar:'141', Cost:16.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'71', Cost:9.40, ParentId: '17'},
		]
	},
