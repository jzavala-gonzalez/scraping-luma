const timestamp_saved = '10/25/2023 06:20 PM';
const dataFechaAcualizado = '10/25/2023' + ' 2:16:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'47', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'52', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'13', Cost:43.07, ParentId: '10'},
