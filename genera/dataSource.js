const timestamp_saved = '08/28/2023 10:35 AM';
const dataFechaAcualizado = '8/28/2023' + ' 6:30:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'35', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'35', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'44', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'14', Cost:19.06, ParentId: '14'},
