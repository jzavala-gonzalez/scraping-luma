const timestamp_saved = '08/17/2023 10:30 AM';
const dataFechaAcualizado = '8/17/2023' + ' 6:27:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'44', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'58', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'69', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'18', Cost:18.03, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'70', Cost:9.43, ParentId: '17'},
		]
	},
