const timestamp_saved = '10/20/2023 09:02 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'30', Cost:11.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'38', Cost:11.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'40', Cost:11.69, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'54', Cost:16.93, ParentId: '15'},
