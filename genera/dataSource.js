const timestamp_saved = '11/30/2023 05:30 PM';
const dataFechaAcualizado = '11/30/2023' + ' 1:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'53', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'56', Cost:10.73, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'78', Cost:9.83, ParentId: '17'},
		]
	},
