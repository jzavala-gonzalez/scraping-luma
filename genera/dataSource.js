const timestamp_saved = '11/16/2023 12:20 PM';
const dataFechaAcualizado = '11/16/2023' + ' 8:16:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'50', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'50', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'48', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 185,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 185, MVar:'72', Cost:10.79, ParentId: '17'},
		]
	},
