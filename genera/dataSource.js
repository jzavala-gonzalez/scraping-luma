const timestamp_saved = '09/27/2023 07:45 PM';
const dataFechaAcualizado = '9/27/2023' + ' 3:40:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'30', Cost:11.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'29', Cost:11.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'60', Cost:11.34, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'174', Cost:17.39, ParentId: '16'},
		]
	},
