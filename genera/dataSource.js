const timestamp_saved = '10/02/2023 11:35 AM';
const dataFechaAcualizado = '10/2/2023' + ' 7:30:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'36', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'33', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'49', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'103', Cost:9.12, ParentId: '17'},
		]
	},
