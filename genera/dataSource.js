const timestamp_saved = '09/18/2023 04:00 AM';
const dataFechaAcualizado = '9/17/2023' + ' 11:55:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'49', Cost:10.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'47', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'61', Cost:10.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 92, MVar:'0', Cost:10.06, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'8', Cost:10.06, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'1', Cost:28.60, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'26', Cost:18.88, ParentId: '14'},
