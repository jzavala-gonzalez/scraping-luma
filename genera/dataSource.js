const timestamp_saved = '11/21/2023 07:45 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:41:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'19', Cost:13.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'27', Cost:13.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'45', Cost:13.54, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 100, MVar:'22', Cost:0, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 216,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 216, MVar:'124', Cost:18.40, ParentId: '16'},
		]
	},
