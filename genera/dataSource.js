const timestamp_saved = '08/03/2023 12:20 AM';
const dataFechaAcualizado = '8/2/2023' + ' 8:15:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:28.85, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'91', Cost:16.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'12', Cost:15.82, ParentId: '15'},
		]
	},
