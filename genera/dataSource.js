const timestamp_saved = '08/16/2023 07:05 PM';
const dataFechaAcualizado = '8/16/2023' + ' 3:02:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'61', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'56', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'63', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 62,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'5', Cost:30.52, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'35', Cost:18.73, ParentId: '14'},
