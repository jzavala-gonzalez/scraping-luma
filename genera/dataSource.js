const timestamp_saved = '11/12/2023 05:10 PM';
const dataFechaAcualizado = '11/12/2023' + ' 1:06:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 100, MVar:'42', Cost:12.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'45', Cost:12.88, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'10', Cost:8.72, ParentId: '11'},
