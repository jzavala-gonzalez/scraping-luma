const timestamp_saved = '09/28/2023 10:00 AM';
const dataFechaAcualizado = '9/28/2023' + ' 5:55:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 131, MVar:'21', Cost:11.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'20', Cost:11.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'45', Cost:11.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'107', Cost:18.44, ParentId: '16'},
		]
	},
