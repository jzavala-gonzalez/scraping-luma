const timestamp_saved = '07/30/2023 03:25 PM';
const dataFechaAcualizado = '7/30/2023' + ' 11:20:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 200,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'65', Cost:18.30, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'110', Cost:19.59, ParentId: '16'},
		]
	},
