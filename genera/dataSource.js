const timestamp_saved = '10/21/2023 02:30 AM';
const dataFechaAcualizado = '10/20/2023' + ' 10:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'41', Cost:10.71, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 56,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 26, MVar:'1', Cost:31.11, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'100', Cost:10.54, ParentId: '17'},
		]
	},
