const timestamp_saved = '09/10/2023 04:25 PM';
const dataFechaAcualizado = '9/10/2023' + ' 12:20:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'64', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'63', Cost:10.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'63', Cost:10.62, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 131, MVar:'78', Cost:17.33, ParentId: '15'},
