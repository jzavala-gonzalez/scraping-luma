const timestamp_saved = '11/20/2023 02:00 AM';
const dataFechaAcualizado = '11/19/2023' + ' 9:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'50', Cost:14.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'59', Cost:14.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:14.90, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:17.49, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 78, MVar:'25', Cost:19.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 158, MVar:'87', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'185', Cost:16.78, ParentId: '16'},
		]
	},
