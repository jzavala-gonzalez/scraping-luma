const timestamp_saved = '10/14/2023 01:50 AM';
const dataFechaAcualizado = '10/13/2023' + ' 9:46:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'67', Cost:10.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'73', Cost:10.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'74', Cost:10.14, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'112', Cost:9.15, ParentId: '17'},
		]
	},
