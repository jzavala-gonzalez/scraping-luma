const timestamp_saved = '09/01/2023 07:55 PM';
const dataFechaAcualizado = '9/1/2023' + ' 3:50:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2770},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'61', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'67', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'6', Cost:26.71, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 25, MVar:'0', Cost:26.22, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'12', Cost:27.44, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'15', Cost:31.01, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 42,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 42, MVar:'9', Cost:30.49, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'31', Cost:18.74, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'94', Cost:16.52, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 203,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 203, MVar:'85', Cost:10.44, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 54,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 24, MVar:'7', Cost:17, ParentId: '19'},
		]
	},
