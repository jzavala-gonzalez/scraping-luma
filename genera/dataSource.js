const timestamp_saved = '10/20/2023 01:15 PM';
const dataFechaAcualizado = '10/20/2023' + ' 9:11:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'49', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'47', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:16.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'11', Cost:16.99, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'38', Cost:18.12, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'10', Cost:18.12, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 134, MVar:'81', Cost:17.31, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'157', Cost:17.25, ParentId: '16'},
		]
	},
