const timestamp_saved = '10/18/2023 09:45 AM';
const dataFechaAcualizado = '10/18/2023' + ' 5:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'38', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'43', Cost:10.89, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 60,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 60, MVar:'74', Cost:21.67, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 347,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 347, MVar:'88', Cost:10.60, ParentId: '17'},
		]
	},
