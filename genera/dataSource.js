const timestamp_saved = '12/02/2023 05:50 PM';
const dataFechaAcualizado = '12/2/2023' + ' 1:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 174,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 174, MVar:'72', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'44', Cost:11.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'48', Cost:11.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'46', Cost:11.85, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.83, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'67', Cost:11.92, ParentId: '17'},
		]
	},
