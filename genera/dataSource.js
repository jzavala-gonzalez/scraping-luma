const timestamp_saved = '11/05/2023 02:25 PM';
const dataFechaAcualizado = '11/5/2023' + ' 10:21:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'42', Cost:13.44, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'40', Cost:13.44, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'42', Cost:13.44, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 243,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 243, MVar:'50', Cost:9.89, ParentId: '17'},
		]
	},
