const timestamp_saved = '09/22/2023 08:10 PM';
const dataFechaAcualizado = '9/22/2023' + ' 4:05:54 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2622},
	{Index:'1', Desc:'PREPA', value: 62},
	{Index:'2', Desc:'COGEN', value: 38},
	{Index:'3', Desc:'Reserva en Rotación', value: 373},
	{Index:'4', Desc:'Reserva Operacional', value: 379},
	{Index:'5', Desc:'Capacidad Disponible', value: 2998},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 204, MVar:'67', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'74', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'40', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'46', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'64', Cost:10.88, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 150,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 35, MVar:'0', Cost:31.66, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.12, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'1', Cost:26.91, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'3', Cost:31.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'6', Cost:31.09, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:8.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:8.27, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'0', Cost:9.92, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'0', Cost:9.92, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 41,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'7', Cost:29.69, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 78,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'7', Cost:29.76, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'28', Cost:19.26, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'78', Cost:16.46, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'116', Cost:32.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'100', Cost:9.13, ParentId: '17'},
		]
	},
	{Index:'18', Type:'Renovable', Desc:'Wind', SiteTotal: 55,
		units:[
			{Index:'0', Unit:'Pattern', MW: 55, MVar:'0', Cost:16.29, ParentId: '18'},
		]
	},
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 52,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 6, MVar:'3', Cost:18.32, ParentId: '19'},
			...
			{Index:'5', Unit:'Fonroche', MW: 17, MVar:'3', Cost:17, ParentId: '19'},
		]
	},
