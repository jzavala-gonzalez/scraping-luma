const timestamp_saved = '11/16/2023 11:30 PM';
const dataFechaAcualizado = '11/16/2023' + ' 7:26:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'61', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'61', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'49', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 43, MVar:'1', Cost:22.71, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'29', Cost:28.05, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 100, MVar:'183', Cost:25.77, ParentId: '16'},
		]
	},
