const timestamp_saved = '09/28/2023 01:30 PM';
const dataFechaAcualizado = '9/28/2023' + ' 9:25:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 423,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'27', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'27', Cost:10.95, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'122', Cost:18.44, ParentId: '16'},
		]
	},
