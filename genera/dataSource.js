const timestamp_saved = '11/22/2023 07:00 PM';
const dataFechaAcualizado = '11/22/2023' + ' 2:56:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'38', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'48', Cost:10.21, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'94', Cost:9.76, ParentId: '17'},
		]
	},
