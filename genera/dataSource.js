const timestamp_saved = '10/13/2023 12:20 PM';
const dataFechaAcualizado = '10/13/2023' + ' 8:16:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'62', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'67', Cost:10.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'69', Cost:10.52, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'78', Cost:9.23, ParentId: '17'},
		]
	},
