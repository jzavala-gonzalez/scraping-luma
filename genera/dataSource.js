const timestamp_saved = '10/28/2023 09:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 5:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'36', Cost:11.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'39', Cost:11.49, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 180,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'22', Cost:28.13, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'0', Cost:11.33, ParentId: '17'},
		]
	},
