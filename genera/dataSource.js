const timestamp_saved = '09/06/2023 10:35 AM';
const dataFechaAcualizado = '9/6/2023' + ' 6:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'44', Cost:11.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'49', Cost:11.52, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'57', Cost:11.52, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 330,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:20.47, ParentId: '11'},
