const timestamp_saved = '10/05/2023 02:51 PM';
const dataFechaAcualizado = '10/5/2023' + ' 10:46:13 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'44', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'42', Cost:10.83, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 130, MVar:'38', Cost:17.32, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.32, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'111', Cost:9.33, ParentId: '17'},
		]
	},
