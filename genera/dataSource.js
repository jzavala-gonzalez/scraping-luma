const timestamp_saved = '11/17/2023 06:30 AM';
const dataFechaAcualizado = '11/17/2023' + ' 2:26:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'52', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'51', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'41', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'2', Cost:30.93, ParentId: '12'},
