const timestamp_saved = '10/04/2023 09:45 AM';
const dataFechaAcualizado = '10/4/2023' + ' 5:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'37', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'36', Cost:10.45, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'143', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 345,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 345, MVar:'103', Cost:9.29, ParentId: '17'},
		]
	},
