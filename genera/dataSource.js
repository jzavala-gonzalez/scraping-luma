const timestamp_saved = '08/17/2023 06:40 PM';
const dataFechaAcualizado = '8/17/2023' + ' 2:37:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'71', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'77', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 99,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'12', Cost:30.94, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 50, MVar:'14', Cost:30.97, ParentId: '10'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 272,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 272, MVar:'167', Cost:17.37, ParentId: '16'},
		]
	},
