const timestamp_saved = '09/18/2023 05:20 PM';
const dataFechaAcualizado = '9/18/2023' + ' 1:15:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'53', Cost:10.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'52', Cost:10.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'63', Cost:10.25, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'33', Cost:18.91, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'152', Cost:18.16, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'88', Cost:9.57, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 114,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 42, MVar:'15', Cost:19.60, ParentId: '19'},
