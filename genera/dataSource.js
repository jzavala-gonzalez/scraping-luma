const timestamp_saved = '08/18/2023 11:10 PM';
const dataFechaAcualizado = '8/18/2023' + ' 7:07:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'53', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'70', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'76', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 120,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 27, MVar:'0', Cost:27.49, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'4', Cost:30.94, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'21', Cost:19.26, ParentId: '14'},
