const timestamp_saved = '11/14/2023 06:10 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'42', Cost:12.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'46', Cost:12.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'50', Cost:12.67, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 161, MVar:'16', Cost:0, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 300,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 300, MVar:'83', Cost:11.20, ParentId: '17'},
		]
	},
