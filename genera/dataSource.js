const timestamp_saved = '12/01/2023 10:00 AM';
const dataFechaAcualizado = '12/1/2023' + ' 5:56:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'47', Cost:10.64, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.44, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 246,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 246, MVar:'64', Cost:9.86, ParentId: '17'},
		]
	},
