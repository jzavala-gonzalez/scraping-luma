const timestamp_saved = '10/26/2023 12:40 PM';
const dataFechaAcualizado = '10/26/2023' + ' 8:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'44', Cost:10.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'49', Cost:10.78, ParentId: '7'},
