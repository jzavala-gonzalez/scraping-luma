const timestamp_saved = '12/03/2023 10:35 AM';
const dataFechaAcualizado = '12/3/2023' + ' 6:31:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'38', Cost:11.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'38', Cost:11.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'45', Cost:11.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'35', Cost:17.72, ParentId: '11'},
