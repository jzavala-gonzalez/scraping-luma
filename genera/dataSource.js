const timestamp_saved = '08/03/2023 08:35 AM';
const dataFechaAcualizado = '8/3/2023' + ' 4:30:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'39', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'26', Cost:21.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'7', Cost:21.99, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 239,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 135, MVar:'52', Cost:17.65, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'38', Cost:16.84, ParentId: '15'},
		]
	},
