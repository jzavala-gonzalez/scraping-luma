const timestamp_saved = '10/28/2023 07:50 AM';
const dataFechaAcualizado = '10/28/2023' + ' 3:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'36', Cost:11.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'38', Cost:11.36, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 41,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 17, MVar:'1', Cost:23.79, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 63, MVar:'21', Cost:29.06, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:29.06, ParentId: '11'},
