const timestamp_saved = '12/04/2023 01:50 AM';
const dataFechaAcualizado = '12/3/2023' + ' 9:46:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'53', Cost:10.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'55', Cost:10.50, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'135', Cost:18.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'89', Cost:10.93, ParentId: '17'},
		]
	},
