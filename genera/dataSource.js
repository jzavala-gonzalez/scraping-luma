const timestamp_saved = '09/03/2023 03:10 PM';
const dataFechaAcualizado = '9/3/2023' + ' 11:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'34', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'39', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'51', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'57', Cost:9.83, ParentId: '17'},
		]
	},
