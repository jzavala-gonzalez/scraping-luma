const timestamp_saved = '09/13/2023 12:45 PM';
const dataFechaAcualizado = '9/13/2023' + ' 8:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'5', Type:'Hidroelectricas', Desc:'Yauco', SiteTotal: 1,
		units:[
			...
			{Index:'2', Unit:'Hidro 3', MW: 1, MVar:'0', Cost:9.35, ParentId: '5'},
		]
	},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'52', Cost:11.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'51', Cost:11.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'65', Cost:11.26, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 152,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 75, MVar:'12', Cost:28.33, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'13', Cost:28.14, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'18', Cost:19.33, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'152', Cost:18.24, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'97', Cost:9.12, ParentId: '17'},
		]
	},
