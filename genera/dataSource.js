const timestamp_saved = '08/03/2023 09:30 PM';
const dataFechaAcualizado = '8/3/2023' + ' 5:25:38 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 3528},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'46', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'51', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'14', Cost:31.09, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 147, MVar:'0', Cost:8.22, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'9', Cost:8.22, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'8', Cost:30.52, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:28.05, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 326,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 171, MVar:'90', Cost:16.57, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'24', Cost:15.63, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'176', Cost:17.09, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 321,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 321, MVar:'99', Cost:10.88, ParentId: '17'},
		]
	},
