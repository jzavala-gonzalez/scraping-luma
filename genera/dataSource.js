const timestamp_saved = '09/09/2023 05:30 PM';
const dataFechaAcualizado = '9/9/2023' + ' 1:25:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'57', Cost:10.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'62', Cost:10.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 157, MVar:'56', Cost:10.19, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 82, MVar:'0', Cost:9.44, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 17, MVar:'5', Cost:130.00, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 101,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'8', Cost:31.07, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 67,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 37, MVar:'6', Cost:27.59, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'20', Cost:18.20, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'86', Cost:16.58, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 285,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 285, MVar:'156', Cost:17.41, ParentId: '16'},
		]
	},
