const timestamp_saved = '11/22/2023 01:55 PM';
const dataFechaAcualizado = '11/22/2023' + ' 9:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'33', Cost:11.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.14, ParentId: '7'},
