const timestamp_saved = '11/29/2023 04:10 AM';
const dataFechaAcualizado = '11/29/2023' + ' 12:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'28', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'39', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 308,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 308, MVar:'84', Cost:9.41, ParentId: '17'},
		]
	},
