const timestamp_saved = '09/08/2023 11:30 AM';
const dataFechaAcualizado = '9/8/2023' + ' 7:25:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'59', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'54', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'51', Cost:10.21, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 113,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 113, MVar:'0', Cost:7.27, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'12', Cost:31.14, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'13', Cost:30.89, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:19.77, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:19.77, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 148, MVar:'0', Cost:8.74, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'10', Cost:8.74, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:31.68, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'19', Cost:19.40, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'80', Cost:16.87, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 299,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 299, MVar:'147', Cost:17.15, ParentId: '16'},
		]
	},
