const timestamp_saved = '08/04/2023 07:15 PM';
const dataFechaAcualizado = '8/4/2023' + ' 3:10:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 497,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'53', Cost:10.08, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'51', Cost:10.08, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 247,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'86', Cost:17.02, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 92, MVar:'51', Cost:18.01, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 324, MVar:'162', Cost:16.95, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 324,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 324, MVar:'100', Cost:11.41, ParentId: '17'},
		]
	},
