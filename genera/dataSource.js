const timestamp_saved = '08/08/2023 08:00 AM';
const dataFechaAcualizado = '8/8/2023' + ' 3:55:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'40', Cost:11.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'47', Cost:11.33, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'78', Cost:11.65, ParentId: '17'},
		]
	},
