const timestamp_saved = '09/15/2023 10:50 PM';
const dataFechaAcualizado = '9/15/2023' + ' 6:45:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 483,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'58', Cost:10.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'55', Cost:10.17, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'1', Cost:28.62, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'35', Cost:18.39, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'104', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 374,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 374, MVar:'115', Cost:9.10, ParentId: '17'},
		]
	},
