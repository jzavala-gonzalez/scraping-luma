const timestamp_saved = '08/14/2023 01:35 PM';
const dataFechaAcualizado = '8/14/2023' + ' 9:32:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 250, MVar:'81', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'106', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'44', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'46', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'46', Cost:10.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'26', Cost:31.29, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'10', Cost:31.58, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:31.50, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 330,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 330, MVar:'124', Cost:12.36, ParentId: '17'},
		]
	},
