const timestamp_saved = '10/24/2023 07:10 AM';
const dataFechaAcualizado = '10/24/2023' + ' 3:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 139, MVar:'46', Cost:10.70, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'62', Cost:11.30, ParentId: '17'},
		]
	},
