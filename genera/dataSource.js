const timestamp_saved = '09/29/2023 04:45 AM';
const dataFechaAcualizado = '9/29/2023' + ' 12:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'53', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'38', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'35', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'51', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'4', Cost:18.89, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'54', Cost:16.92, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 214,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 214, MVar:'112', Cost:18.10, ParentId: '16'},
		]
	},
