const timestamp_saved = '11/12/2023 06:50 AM';
const dataFechaAcualizado = '11/12/2023' + ' 2:46:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'41', Cost:11.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'43', Cost:11.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'51', Cost:11.75, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.95, ParentId: '11'},
