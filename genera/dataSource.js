const timestamp_saved = '11/21/2023 01:30 AM';
const dataFechaAcualizado = '11/20/2023' + ' 9:26:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'49', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'61', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 41, MVar:'10', Cost:28.81, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'77', Cost:16.89, ParentId: '15'},
