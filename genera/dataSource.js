const timestamp_saved = '11/07/2023 11:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 7:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'41', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'41', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'77', Cost:9.82, ParentId: '17'},
		]
	},
