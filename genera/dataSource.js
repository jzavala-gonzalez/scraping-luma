const timestamp_saved = '08/14/2023 06:25 AM';
const dataFechaAcualizado = '8/14/2023' + ' 2:22:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'37', Cost:10.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'42', Cost:10.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'41', Cost:10.56, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 96, MVar:'0', Cost:3.79, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'145', Cost:16.97, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'102', Cost:13.00, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 28,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 14, MVar:'0', Cost:25.79, ParentId: '21'},
