const timestamp_saved = '11/13/2023 03:40 AM';
const dataFechaAcualizado = '11/12/2023' + ' 11:36:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 190,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'49', Cost:20.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'53', Cost:20.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:20.25, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 53, MVar:'0', Cost:21.84, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'10', Cost:27.97, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'15', Cost:28.57, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'9', Cost:19.46, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'62', Cost:16.75, ParentId: '15'},
