const timestamp_saved = '09/22/2023 10:50 AM';
const dataFechaAcualizado = '9/22/2023' + ' 6:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'38', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'41', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'61', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'79', Cost:32.79, ParentId: '16'},
		]
	},
