const timestamp_saved = '10/08/2023 01:00 PM';
const dataFechaAcualizado = '10/8/2023' + ' 8:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'75', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'37', Cost:11.62, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'39', Cost:11.62, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'87', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 161,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 161, MVar:'68', Cost:11.35, ParentId: '17'},
		]
	},
