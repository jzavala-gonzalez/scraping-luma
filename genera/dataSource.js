const timestamp_saved = '10/17/2023 10:25 AM';
const dataFechaAcualizado = '10/17/2023' + ' 6:21:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'54', Cost:10.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'53', Cost:10.42, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'10', Cost:19.10, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'79', Cost:9.22, ParentId: '17'},
		]
	},
