const timestamp_saved = '08/24/2023 01:30 PM';
const dataFechaAcualizado = '8/24/2023' + ' 9:25:44 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'57', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'56', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'54', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'28', Cost:19.12, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 282, MVar:'173', Cost:17.26, ParentId: '16'},
		]
	},
