const timestamp_saved = '10/02/2023 01:00 AM';
const dataFechaAcualizado = '10/1/2023' + ' 8:55:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'38', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'35', Cost:10.83, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:16.98, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'81', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 348,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 348, MVar:'146', Cost:16.75, ParentId: '16'},
		]
	},
