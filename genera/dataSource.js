const timestamp_saved = '11/09/2023 09:00 AM';
const dataFechaAcualizado = '11/9/2023' + ' 4:56:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'38', Cost:12.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'37', Cost:12.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'42', Cost:12.16, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 161, MVar:'50', Cost:17.01, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'21', Cost:21.90, ParentId: '14'},
