const timestamp_saved = '09/14/2023 12:05 AM';
const dataFechaAcualizado = '9/13/2023' + ' 8:00:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 548,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'69', Cost:9.77, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 206, MVar:'78', Cost:9.77, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 191,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'7', Cost:22.29, ParentId: '9'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 100,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'11', Cost:28.22, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 87,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 87, MVar:'31', Cost:18.96, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'93', Cost:16.72, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'203', Cost:16.66, ParentId: '16'},
		]
	},
