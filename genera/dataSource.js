const timestamp_saved = '09/23/2023 11:10 AM';
const dataFechaAcualizado = '9/23/2023' + ' 7:05:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'39', Cost:11.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'39', Cost:11.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'54', Cost:11.71, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 403,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 149, MVar:'0', Cost:8.17, ParentId: '11'},
