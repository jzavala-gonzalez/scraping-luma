const timestamp_saved = '09/18/2023 04:05 AM';
const dataFechaAcualizado = '9/18/2023' + ' 12:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'50', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'48', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'62', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 91,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 40, MVar:'5', Cost:30.00, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 351,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 107, MVar:'0', Cost:10.06, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'7', Cost:10.06, ParentId: '11'},
		]
	},
