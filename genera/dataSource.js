const timestamp_saved = '08/09/2023 07:05 AM';
const dataFechaAcualizado = '8/9/2023' + ' 3:00:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'37', Cost:11.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'42', Cost:11.40, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 291,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 291, MVar:'94', Cost:17.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'61', Cost:12.92, ParentId: '17'},
		]
	},
