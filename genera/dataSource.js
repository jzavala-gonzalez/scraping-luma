const timestamp_saved = '10/23/2023 01:55 AM';
const dataFechaAcualizado = '10/22/2023' + ' 9:51:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'51', Cost:10.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'52', Cost:10.61, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 40,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 1, MVar:'0', Cost:25.56, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'67', Cost:16.78, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'73', Cost:11.32, ParentId: '17'},
		]
	},
