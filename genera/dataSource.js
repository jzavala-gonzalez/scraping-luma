const timestamp_saved = '08/25/2023 12:20 AM';
const dataFechaAcualizado = '8/24/2023' + ' 8:15:46 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3177},
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 3174},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 452,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'113', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 488,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'74', Cost:10.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'76', Cost:10.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'69', Cost:10.18, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 190,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:22.07, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.99, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'17', Cost:22.93, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 49, MVar:'12', Cost:22.28, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 128,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'32', Cost:28.10, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'24', Cost:30.97, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'11', Cost:28.60, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'34', Cost:19.00, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'237', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 341,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 341, MVar:'134', Cost:9.23, ParentId: '17'},
		]
	},
