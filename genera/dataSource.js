const timestamp_saved = '11/04/2023 06:00 AM';
const dataFechaAcualizado = '11/4/2023' + ' 1:56:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'43', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'44', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'42', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'53', Cost:9.74, ParentId: '17'},
		]
	},
