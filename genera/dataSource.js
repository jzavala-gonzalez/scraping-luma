const timestamp_saved = '10/03/2023 09:30 AM';
const dataFechaAcualizado = '10/3/2023' + ' 5:25:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'37', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'35', Cost:10.40, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:19.52, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'97', Cost:9.60, ParentId: '17'},
		]
	},
