const timestamp_saved = '11/02/2023 10:20 PM';
const dataFechaAcualizado = '11/2/2023' + ' 6:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 554,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'68', Cost:9.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'66', Cost:9.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 203, MVar:'68', Cost:9.91, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 148,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'0', Cost:25.47, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.68, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'6', Cost:28.27, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 62, MVar:'24', Cost:29.47, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 97,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 49, MVar:'8', Cost:29.74, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'0', Cost:31.01, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 46, MVar:'8', Cost:30.28, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 138,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 138, MVar:'94', Cost:16.90, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 236,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 236, MVar:'178', Cost:17.40, ParentId: '16'},
		]
	},
