const timestamp_saved = '10/31/2023 09:50 PM';
const dataFechaAcualizado = '10/31/2023' + ' 5:46:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'59', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'62', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'68', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 33, MVar:'0', Cost:21.97, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 237,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 32, MVar:'7', Cost:43.15, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:43.15, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'6', Cost:31.83, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'32', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'99', Cost:16.94, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'89', Cost:9.14, ParentId: '17'},
		]
	},
