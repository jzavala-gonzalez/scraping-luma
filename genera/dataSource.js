const timestamp_saved = '08/28/2023 05:40 AM';
const dataFechaAcualizado = '8/28/2023' + ' 1:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'38', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'36', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'43', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:19.95, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'89', Cost:12.07, ParentId: '17'},
		]
	},
