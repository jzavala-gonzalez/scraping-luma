const timestamp_saved = '09/04/2023 10:45 AM';
const dataFechaAcualizado = '9/4/2023' + ' 6:40:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'37', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'41', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'54', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 276,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 276, MVar:'135', Cost:17.37, ParentId: '16'},
		]
	},
