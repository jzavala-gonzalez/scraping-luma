const timestamp_saved = '09/21/2023 10:40 AM';
const dataFechaAcualizado = '9/21/2023' + ' 6:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'46', Cost:10.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'48', Cost:10.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'67', Cost:10.64, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 336,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 35, MVar:'9', Cost:22.01, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'10', Cost:31.88, ParentId: '13'},
