const timestamp_saved = '08/13/2023 02:30 AM';
const dataFechaAcualizado = '8/12/2023' + ' 10:27:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 240, MVar:'81', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'91', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'44', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'45', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'44', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 124,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:21.97, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.41, ParentId: '11'},
