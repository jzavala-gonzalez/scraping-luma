const timestamp_saved = '10/27/2023 01:15 PM';
const dataFechaAcualizado = '10/27/2023' + ' 9:11:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 346,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'50', Cost:12.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'52', Cost:12.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'55', Cost:12.78, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'47', Cost:16.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'10', Cost:16.73, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'49', Cost:16.88, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 49, MVar:'10', Cost:16.88, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'28', Cost:19.17, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'95', Cost:16.86, ParentId: '15'},
