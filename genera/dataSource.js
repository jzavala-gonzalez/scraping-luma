const timestamp_saved = '12/06/2023 01:30 PM';
const dataFechaAcualizado = '12/6/2023' + ' 9:25:17 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 873},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'47', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'51', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'57', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 419,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'11', Cost:17.41, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 161,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 90, MVar:'13', Cost:19.44, ParentId: '14'},
