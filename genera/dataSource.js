const timestamp_saved = '11/29/2023 03:30 AM';
const dataFechaAcualizado = '11/28/2023' + ' 11:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'33', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'43', Cost:11.23, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 25,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'0', Cost:30.52, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'97', Cost:9.17, ParentId: '17'},
		]
	},
