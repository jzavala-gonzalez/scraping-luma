const timestamp_saved = '10/08/2023 07:00 AM';
const dataFechaAcualizado = '10/8/2023' + ' 2:56:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 231,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 232, MVar:'66', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'38', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'37', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'40', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'79', Cost:16.80, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'137', Cost:16.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 155,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 155, MVar:'71', Cost:11.61, ParentId: '17'},
		]
	},
