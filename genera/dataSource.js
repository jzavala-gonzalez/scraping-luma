const timestamp_saved = '09/28/2023 03:05 AM';
const dataFechaAcualizado = '9/27/2023' + ' 11:00:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 366,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'28', Cost:11.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'28', Cost:11.63, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'59', Cost:11.63, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 24,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 24, MVar:'0', Cost:27.98, ParentId: '13'},
