const timestamp_saved = '08/03/2023 09:45 AM';
const dataFechaAcualizado = '8/3/2023' + ' 5:40:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'40', Cost:10.88, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'47', Cost:20.36, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 245,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'55', Cost:17.10, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 105, MVar:'38', Cost:16.88, ParentId: '15'},
		]
	},
