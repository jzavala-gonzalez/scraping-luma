const timestamp_saved = '12/01/2023 09:15 AM';
const dataFechaAcualizado = '12/1/2023' + ' 5:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'40', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'43', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'46', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'55', Cost:9.87, ParentId: '17'},
		]
	},
