const timestamp_saved = '10/15/2023 11:10 AM';
const dataFechaAcualizado = '10/15/2023' + ' 7:06:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'49', Cost:11.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'44', Cost:11.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'49', Cost:11.92, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'59', Cost:9.52, ParentId: '17'},
		]
	},
