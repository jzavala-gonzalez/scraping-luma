const timestamp_saved = '08/23/2023 07:30 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:25:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 410,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'43', Cost:11.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'43', Cost:11.13, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'40', Cost:20.31, ParentId: '11'},
