const timestamp_saved = '11/26/2023 03:30 AM';
const dataFechaAcualizado = '11/25/2023' + ' 11:26:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'27', Cost:10.67, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:19.96, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'9', Cost:17.55, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 96, MVar:'31', Cost:18.91, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 38, MVar:'8', Cost:18.91, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'16', Cost:19.52, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'119', Cost:19.22, ParentId: '16'},
		]
	},
