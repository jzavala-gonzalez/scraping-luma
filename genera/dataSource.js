const timestamp_saved = '11/11/2023 10:15 PM';
const dataFechaAcualizado = '11/11/2023' + ' 6:11:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'55', Cost:10.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'55', Cost:10.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'59', Cost:10.21, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 73,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'9', Cost:31.88, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 73,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 52, MVar:'11', Cost:31.76, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 134,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'17', Cost:18.94, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 363,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 363, MVar:'109', Cost:9.16, ParentId: '17'},
		]
	},
