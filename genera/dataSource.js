const timestamp_saved = '10/21/2023 04:00 PM';
const dataFechaAcualizado = '10/21/2023' + ' 11:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 342,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'39', Cost:12.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'37', Cost:12.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'39', Cost:12.00, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'139', Cost:17.79, ParentId: '16'},
		]
	},
