const timestamp_saved = '07/26/2023 09:23 AM';
const dataFechaAcualizado = '7/26/2023' + ' 5:15:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'75', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'80', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 461,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'45', Cost:10.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'57', Cost:10.67, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.66, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.74, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'66', Cost:15.44, ParentId: '15'},
		]
	},
