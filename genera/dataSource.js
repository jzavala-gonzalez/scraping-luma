const timestamp_saved = '09/17/2023 11:45 AM';
const dataFechaAcualizado = '9/17/2023' + ' 7:40:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'40', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'41', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'56', Cost:11.17, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'7', Cost:10.05, ParentId: '11'},
		]
	},
