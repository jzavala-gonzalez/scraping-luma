const timestamp_saved = '09/27/2023 12:45 AM';
const dataFechaAcualizado = '9/26/2023' + ' 8:40:55 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3087},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'59', Cost:10.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'60', Cost:10.57, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 119,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'11', Cost:21.86, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'9', Cost:26.59, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'26', Cost:31.06, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:17.76, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.76, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:17.30, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'0', Cost:17.30, ParentId: '11'},
		]
	},
