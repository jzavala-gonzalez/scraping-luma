const timestamp_saved = '10/21/2023 12:16 AM';
const dataFechaAcualizado = '10/20/2023' + ' 8:11:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'46', Cost:10.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'53', Cost:10.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'49', Cost:10.30, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 69,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 69, MVar:'7', Cost:19.29, ParentId: '14'},
