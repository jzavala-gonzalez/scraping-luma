const timestamp_saved = '10/23/2023 06:00 AM';
const dataFechaAcualizado = '10/23/2023' + ' 1:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'36', Cost:13.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'37', Cost:13.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'39', Cost:13.03, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 286,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 286, MVar:'107', Cost:17.11, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 252,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 252, MVar:'49', Cost:11.29, ParentId: '17'},
		]
	},
