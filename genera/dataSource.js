const timestamp_saved = '12/01/2023 02:25 PM';
const dataFechaAcualizado = '12/1/2023' + ' 10:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 355,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'47', Cost:11.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'50', Cost:11.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'52', Cost:11.94, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 287,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 287, MVar:'72', Cost:9.53, ParentId: '17'},
		]
	},
