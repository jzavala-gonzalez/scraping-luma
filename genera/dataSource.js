const timestamp_saved = '09/22/2023 09:00 AM';
const dataFechaAcualizado = '9/22/2023' + ' 4:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 378,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'36', Cost:11.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'40', Cost:11.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'60', Cost:11.58, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:20.01, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'11', Cost:20.01, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 162, MVar:'0', Cost:8.18, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 67, MVar:'71', Cost:32.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'77', Cost:17.18, ParentId: '17'},
		]
	},
