const timestamp_saved = '10/16/2023 04:05 PM';
const dataFechaAcualizado = '10/16/2023' + ' 12:01:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 489,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'68', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'66', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'62', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'17', Cost:19.22, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'178', Cost:17.83, ParentId: '16'},
		]
	},
