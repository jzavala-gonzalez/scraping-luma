const timestamp_saved = '10/24/2023 05:40 AM';
const dataFechaAcualizado = '10/24/2023' + ' 1:36:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'44', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'46', Cost:10.82, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 385,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 149, MVar:'44', Cost:17.68, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.68, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'44', Cost:17.03, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 45, MVar:'10', Cost:17.03, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'70', Cost:16.79, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'137', Cost:18.26, ParentId: '16'},
		]
	},
