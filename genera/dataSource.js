const timestamp_saved = '08/05/2023 07:20 PM';
const dataFechaAcualizado = '8/5/2023' + ' 3:15:39 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 482,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'51', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'47', Cost:10.24, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 143,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'0', Cost:26.92, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'14', Cost:43.67, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'30', Cost:19.26, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'97', Cost:11.88, ParentId: '17'},
		]
	},
