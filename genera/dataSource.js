const timestamp_saved = '08/01/2023 12:30 AM';
const dataFechaAcualizado = '7/31/2023' + ' 8:25:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 439,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'48', Cost:10.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'50', Cost:10.88, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 174,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'11', Cost:22.37, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'3', Cost:22.55, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:19.26, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:31.51, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 288,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 288, MVar:'159', Cost:17.27, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'100', Cost:10.99, ParentId: '17'},
		]
	},
