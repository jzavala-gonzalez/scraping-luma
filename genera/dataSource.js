const timestamp_saved = '08/05/2023 01:20 AM';
const dataFechaAcualizado = '8/4/2023' + ' 9:15:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'48', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'52', Cost:11.01, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 95, MVar:'0', Cost:3.28, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 104,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'4', Cost:22.02, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'93', Cost:16.60, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 155, MVar:'49', Cost:15.57, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'100', Cost:11.39, ParentId: '17'},
		]
	},
