const timestamp_saved = '10/28/2023 11:50 AM';
const dataFechaAcualizado = '10/28/2023' + ' 7:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'37', Cost:11.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'42', Cost:11.28, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 145,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'16', Cost:31.05, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'7', Cost:28.71, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 118,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'19', Cost:18.96, ParentId: '14'},
