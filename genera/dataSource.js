const timestamp_saved = '10/16/2023 07:20 PM';
const dataFechaAcualizado = '10/16/2023' + ' 3:16:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 442,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'66', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'66', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'63', Cost:10.95, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 52,
		units:[
			...
			{Index:'8', Unit:'FEMA GT SJ', MW: 166, MVar:'0', Cost:0, ParentId: '8'},
		]
	},
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 45,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'1', Cost:27.03, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 22, MVar:'0', Cost:27.07, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 140, MVar:'42', Cost:16.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:16.83, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'99', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 368,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 368, MVar:'185', Cost:16.71, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'104', Cost:9.12, ParentId: '17'},
		]
	},
