const timestamp_saved = '11/02/2023 12:30 PM';
const dataFechaAcualizado = '11/2/2023' + ' 8:26:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'54', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'53', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'49', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.31, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 187,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 187, MVar:'127', Cost:19.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'72', Cost:9.41, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 48,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 18, MVar:'13', Cost:19.60, ParentId: '19'},
