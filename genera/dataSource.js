const timestamp_saved = '11/21/2023 07:50 AM';
const dataFechaAcualizado = '11/21/2023' + ' 3:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 284,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 90, MVar:'19', Cost:13.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 90, MVar:'28', Cost:13.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 103, MVar:'46', Cost:13.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 101, MVar:'27', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'42', Cost:18.41, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 211,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 211, MVar:'123', Cost:18.49, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'66', Cost:9.20, ParentId: '17'},
		]
	},
