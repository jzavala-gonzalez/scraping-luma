const timestamp_saved = '08/09/2023 04:20 AM';
const dataFechaAcualizado = '8/9/2023' + ' 12:15:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'41', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'48', Cost:11.07, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'7', Cost:22.95, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 59,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.78, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:32.43, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'0', Cost:30.64, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'82', Cost:12.22, ParentId: '17'},
		]
	},
