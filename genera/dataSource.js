const timestamp_saved = '08/03/2023 02:10 AM';
const dataFechaAcualizado = '8/2/2023' + ' 10:05:37 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'45', Cost:11.06, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'5', Cost:25.92, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 82,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'5', Cost:28.66, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 306,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'105', Cost:16.63, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 140, MVar:'15', Cost:15.85, ParentId: '15'},
		]
	},
