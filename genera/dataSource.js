const timestamp_saved = '11/14/2023 05:05 AM';
const dataFechaAcualizado = '11/14/2023' + ' 1:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 314,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 101, MVar:'44', Cost:12.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'50', Cost:12.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 112, MVar:'54', Cost:12.66, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 133,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'10', Cost:18.70, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'96', Cost:10.87, ParentId: '17'},
		]
	},
