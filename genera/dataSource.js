const timestamp_saved = '10/30/2023 12:40 AM';
const dataFechaAcualizado = '10/29/2023' + ' 8:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'50', Cost:11.26, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 216,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 216, MVar:'70', Cost:9.42, ParentId: '17'},
		]
	},
