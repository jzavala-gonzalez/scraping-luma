const timestamp_saved = '08/12/2023 04:10 AM';
const dataFechaAcualizado = '8/12/2023' + ' 12:07:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'54', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'55', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'53', Cost:10.75, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 139,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 102, MVar:'0', Cost:5.86, ParentId: '8'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'116', Cost:11.64, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 41,
		units:[
			...
			{Index:'6', Unit:'GT4', MW: 0, MVar:'0', Cost:90.65, ParentId: '21'},
