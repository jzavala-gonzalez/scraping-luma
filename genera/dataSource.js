const timestamp_saved = '11/23/2023 06:10 AM';
const dataFechaAcualizado = '11/23/2023' + ' 2:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'20', Cost:12.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'30', Cost:12.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'47', Cost:12.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 282,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'11', Cost:17.65, ParentId: '11'},
