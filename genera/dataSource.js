const timestamp_saved = '08/23/2023 07:15 AM';
const dataFechaAcualizado = '8/23/2023' + ' 3:10:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'42', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'43', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 249,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 249, MVar:'56', Cost:9.83, ParentId: '17'},
		]
	},
