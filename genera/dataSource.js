const timestamp_saved = '08/30/2023 12:05 PM';
const dataFechaAcualizado = '8/30/2023' + ' 8:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'62', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 159, MVar:'83', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'49', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'50', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'59', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:34.46, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 53, MVar:'36', Cost:21.42, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'89', Cost:16.93, ParentId: '15'},
