const timestamp_saved = '11/21/2023 09:10 AM';
const dataFechaAcualizado = '11/21/2023' + ' 5:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'21', Cost:12.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'31', Cost:12.50, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'47', Cost:12.50, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 315,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 50, MVar:'12', Cost:17.34, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'132', Cost:18.26, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 278,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 278, MVar:'68', Cost:9.59, ParentId: '17'},
		]
	},
