const timestamp_saved = '10/21/2023 11:50 AM';
const dataFechaAcualizado = '10/21/2023' + ' 7:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 330,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 108, MVar:'37', Cost:12.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'35', Cost:12.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'37', Cost:12.38, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'65', Cost:16.93, ParentId: '15'},
