const timestamp_saved = '09/10/2023 02:30 PM';
const dataFechaAcualizado = '9/10/2023' + ' 10:25:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'61', Cost:10.94, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'60', Cost:10.94, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'62', Cost:10.94, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:18.92, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'125', Cost:18.32, ParentId: '16'},
		]
	},
