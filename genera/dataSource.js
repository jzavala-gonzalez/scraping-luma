const timestamp_saved = '08/01/2023 10:00 AM';
const dataFechaAcualizado = '8/1/2023' + ' 5:55:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'48', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'41', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'47', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'87', Cost:10.98, ParentId: '17'},
		]
	},
