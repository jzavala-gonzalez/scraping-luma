const timestamp_saved = '12/04/2023 02:40 PM';
const dataFechaAcualizado = '12/4/2023' + ' 10:36:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'51', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'53', Cost:11.61, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 413,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'11', Cost:17.66, ParentId: '11'},
