const timestamp_saved = '08/30/2023 06:10 PM';
const dataFechaAcualizado = '8/30/2023' + ' 2:05:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'59', Cost:10.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'69', Cost:10.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'71', Cost:10.22, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:18.36, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:18.36, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 85,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 85, MVar:'41', Cost:18.98, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'95', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 247,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 247, MVar:'164', Cost:18.06, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'118', Cost:9.20, ParentId: '17'},
		]
	},
