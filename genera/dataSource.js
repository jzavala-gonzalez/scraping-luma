const timestamp_saved = '09/13/2023 03:05 PM';
const dataFechaAcualizado = '9/13/2023' + ' 11:00:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'53', Cost:12.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'50', Cost:12.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'66', Cost:12.46, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 69,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 69, MVar:'0', Cost:6.69, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'14', Cost:28.34, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'99', Cost:9.11, ParentId: '17'},
		]
	},
