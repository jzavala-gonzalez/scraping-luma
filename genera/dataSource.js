const timestamp_saved = '10/11/2023 07:55 PM';
const dataFechaAcualizado = '10/11/2023' + ' 3:51:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'67', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'72', Cost:10.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'73', Cost:10.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 14, MVar:'0', Cost:35.41, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 375,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:17.62, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:17.62, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 139, MVar:'40', Cost:18.42, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'9', Cost:18.42, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:30.80, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'22', Cost:19.18, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 172,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 172, MVar:'101', Cost:17.12, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 345,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 345, MVar:'188', Cost:16.73, ParentId: '16'},
		]
	},
