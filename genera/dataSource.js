const timestamp_saved = '09/17/2023 10:30 PM';
const dataFechaAcualizado = '9/17/2023' + ' 6:25:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 433,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'76', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'49', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'49', Cost:10.53, ParentId: '7'},
	...
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 146,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 132, MVar:'61', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 37,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 14, MVar:'2', Cost:0, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'34', Cost:18.93, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'147', Cost:17.13, ParentId: '16'},
		]
	},
