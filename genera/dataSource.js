const timestamp_saved = '09/10/2023 03:20 PM';
const dataFechaAcualizado = '9/10/2023' + ' 11:15:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 2198},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'63', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'62', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'62', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'125', Cost:18.30, ParentId: '16'},
		]
	},
