const timestamp_saved = '10/01/2023 01:45 PM';
const dataFechaAcualizado = '10/1/2023' + ' 9:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 263,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'84', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 10, MVar:'33', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'26', Cost:10.91, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'26', Cost:10.91, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'44', Cost:10.91, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'13', Cost:19.60, ParentId: '14'},
