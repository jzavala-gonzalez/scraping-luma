const timestamp_saved = '08/01/2023 07:55 AM';
const dataFechaAcualizado = '8/1/2023' + ' 3:50:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'45', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:17.22, ParentId: '11'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 303,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 303, MVar:'84', Cost:10.98, ParentId: '17'},
		]
	},
