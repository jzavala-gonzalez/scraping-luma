const timestamp_saved = '11/30/2023 01:40 PM';
const dataFechaAcualizado = '11/30/2023' + ' 9:36:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 370,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'49', Cost:11.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'51', Cost:11.66, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'52', Cost:11.66, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'75', Cost:9.57, ParentId: '17'},
		]
	},
