const timestamp_saved = '12/03/2023 01:15 PM';
const dataFechaAcualizado = '12/3/2023' + ' 9:11:24 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 1332},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 183,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 183, MVar:'62', Cost:4.35, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.35, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'38', Cost:13.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'40', Cost:13.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 106, MVar:'46', Cost:13.36, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'94', Cost:18.22, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'53', Cost:11.64, ParentId: '17'},
		]
	},
