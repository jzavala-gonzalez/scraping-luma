const timestamp_saved = '10/14/2023 08:50 AM';
const dataFechaAcualizado = '10/14/2023' + ' 4:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'47', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'51', Cost:11.30, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'63', Cost:9.28, ParentId: '17'},
		]
	},
