const timestamp_saved = '10/29/2023 08:35 PM';
const dataFechaAcualizado = '10/29/2023' + ' 4:31:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'38', Cost:12.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'41', Cost:12.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 121, MVar:'66', Cost:12.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'8', Cost:17.31, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'17', Cost:19.08, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 334,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 334, MVar:'123', Cost:16.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 164,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 164, MVar:'47', Cost:10.59, ParentId: '17'},
		]
	},
