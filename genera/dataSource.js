const timestamp_saved = '12/03/2023 12:35 AM';
const dataFechaAcualizado = '12/2/2023' + ' 8:31:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'57', Cost:10.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:10.79, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'98', Cost:10.88, ParentId: '17'},
		]
	},
