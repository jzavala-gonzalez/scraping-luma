const timestamp_saved = '09/22/2023 04:50 PM';
const dataFechaAcualizado = '9/22/2023' + ' 12:45:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 360,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 159, MVar:'61', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'71', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'42', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'46', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'63', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 130,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:32.67, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 180,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 180, MVar:'72', Cost:16.43, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 66, MVar:'109', Cost:32.82, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 110,
		units:[
			{Index:'0', Unit:'San Fermin', MW: 12, MVar:'2', Cost:18.32, ParentId: '19'},
			...
			{Index:'4', Unit:'Oriana', MW: 45, MVar:'21', Cost:19.60, ParentId: '19'},
