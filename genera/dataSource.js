const timestamp_saved = '10/11/2023 06:55 AM';
const dataFechaAcualizado = '10/11/2023' + ' 2:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'45', Cost:12.29, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'50', Cost:12.29, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'58', Cost:12.29, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'62', Cost:9.12, ParentId: '17'},
		]
	},
