const timestamp_saved = '10/08/2023 02:35 PM';
const dataFechaAcualizado = '10/8/2023' + ' 10:31:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'38', Cost:11.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'39', Cost:11.70, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'40', Cost:11.70, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 364,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 118, MVar:'37', Cost:17.45, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 161,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 161, MVar:'71', Cost:11.41, ParentId: '17'},
		]
	},
