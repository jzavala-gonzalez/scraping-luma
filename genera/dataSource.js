const timestamp_saved = '09/27/2023 05:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 1:50:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'34', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'32', Cost:10.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'62', Cost:10.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 124, MVar:'38', Cost:8.83, ParentId: '11'},
