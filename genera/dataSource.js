const timestamp_saved = '09/01/2023 10:40 PM';
const dataFechaAcualizado = '9/1/2023' + ' 6:35:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'3', Desc:'Reserva en Rotación', value: 72},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 549,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'60', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'68', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 211, MVar:'74', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'4', Cost:22.45, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.88, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 40, MVar:'9', Cost:23.28, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 150,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'13', Cost:28.19, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'15', Cost:29.22, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'46', Cost:8.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'9', Cost:8.31, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'0', Cost:8.13, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:8.13, ParentId: '11'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'8', Cost:28.47, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'23', Cost:18.53, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 162,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 162, MVar:'81', Cost:16.68, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 370,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 370, MVar:'171', Cost:16.63, ParentId: '16'},
		]
	},
