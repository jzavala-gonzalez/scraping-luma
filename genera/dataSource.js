const timestamp_saved = '10/20/2023 07:05 PM';
const dataFechaAcualizado = '10/20/2023' + ' 3:01:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'45', Cost:11.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'52', Cost:11.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'48', Cost:11.02, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'6', Cost:31.48, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'162', Cost:17.84, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 362,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 362, MVar:'109', Cost:10.55, ParentId: '17'},
		]
	},
