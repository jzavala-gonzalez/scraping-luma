const timestamp_saved = '09/25/2023 05:05 AM';
const dataFechaAcualizado = '9/25/2023' + ' 1:00:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'51', Cost:11.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'53', Cost:11.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'60', Cost:11.19, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 8,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 5, MVar:'1', Cost:27.19, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'1', Cost:22.61, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 345,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 115, MVar:'38', Cost:20.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:20.21, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 144, MVar:'0', Cost:17.61, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 41, MVar:'0', Cost:17.61, ParentId: '11'},
		]
	},
