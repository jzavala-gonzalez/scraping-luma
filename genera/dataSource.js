const timestamp_saved = '11/18/2023 11:45 AM';
const dataFechaAcualizado = '11/18/2023' + ' 7:41:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 280,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 140, MVar:'47', Cost:16.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'56', Cost:16.02, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'11', Cost:30.99, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.53, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'24', Cost:18.24, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'84', Cost:16.54, ParentId: '15'},
