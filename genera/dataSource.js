const timestamp_saved = '07/30/2023 10:00 AM';
const dataFechaAcualizado = '7/30/2023' + ' 5:55:34 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 89, MVar:'41', Cost:11.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'36', Cost:11.36, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'36', Cost:19.83, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 41, MVar:'10', Cost:19.83, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 272,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 132, MVar:'63', Cost:17.05, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'61', Cost:19.93, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 280,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 280, MVar:'60', Cost:11.14, ParentId: '17'},
		]
	},
