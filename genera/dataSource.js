const timestamp_saved = '10/01/2023 02:50 AM';
const dataFechaAcualizado = '9/30/2023' + ' 10:45:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 488,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 234, MVar:'69', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 138, MVar:'36', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'34', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'51', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'8', Cost:31.15, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 206,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:17.41, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'9', Cost:18.82, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 300,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 300, MVar:'144', Cost:17.14, ParentId: '16'},
		]
	},
