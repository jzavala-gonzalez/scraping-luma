const timestamp_saved = '10/21/2023 08:00 AM';
const dataFechaAcualizado = '10/21/2023' + ' 3:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 337,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'20', Cost:12.22, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'19', Cost:12.22, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'58', Cost:12.22, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'55', Cost:16.91, ParentId: '15'},
