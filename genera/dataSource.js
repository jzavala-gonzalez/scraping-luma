const timestamp_saved = '08/23/2023 08:00 PM';
const dataFechaAcualizado = '8/23/2023' + ' 3:55:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'58', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'57', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'55', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'6', Cost:30.09, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 74,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'29', Cost:19.24, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'91', Cost:9.31, ParentId: '17'},
		]
	},
