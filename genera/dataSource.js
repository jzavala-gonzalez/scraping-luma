const timestamp_saved = '11/07/2023 07:30 AM';
const dataFechaAcualizado = '11/7/2023' + ' 3:26:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'39', Cost:11.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'36', Cost:11.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'38', Cost:11.57, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'47', Cost:16.88, ParentId: '15'},
