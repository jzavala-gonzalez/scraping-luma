const timestamp_saved = '11/09/2023 02:06 PM';
const dataFechaAcualizado = '11/9/2023' + ' 10:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 356,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'47', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'45', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'49', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 35,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'1', Cost:28.80, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 119,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 46, MVar:'19', Cost:22.22, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'21', Cost:19.26, ParentId: '14'},
