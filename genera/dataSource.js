const timestamp_saved = '11/30/2023 12:05 PM';
const dataFechaAcualizado = '11/30/2023' + ' 8:01:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'47', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'49', Cost:11.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'51', Cost:11.35, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'70', Cost:9.57, ParentId: '17'},
		]
	},
