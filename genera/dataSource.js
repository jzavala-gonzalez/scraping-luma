const timestamp_saved = '07/31/2023 01:40 AM';
const dataFechaAcualizado = '7/30/2023' + ' 9:35:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 464,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'58', Cost:10.51, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 314,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'98', Cost:16.77, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'97', Cost:10.96, ParentId: '17'},
		]
	},
