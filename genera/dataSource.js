const timestamp_saved = '10/28/2023 06:55 PM';
const dataFechaAcualizado = '10/28/2023' + ' 2:51:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 415,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'50', Cost:10.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'53', Cost:10.71, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 160,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'21', Cost:29.15, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 71,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'8', Cost:30.00, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'87', Cost:16.50, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 318,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 318, MVar:'138', Cost:16.96, ParentId: '16'},
		]
	},
