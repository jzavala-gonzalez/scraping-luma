const timestamp_saved = '11/19/2023 11:35 PM';
const dataFechaAcualizado = '11/19/2023' + ' 7:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 344,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'52', Cost:14.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'62', Cost:14.33, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 122,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'27', Cost:19.71, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'90', Cost:16.83, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'186', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'128', Cost:9.25, ParentId: '17'},
		]
	},
