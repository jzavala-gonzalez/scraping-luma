const timestamp_saved = '10/02/2023 02:40 PM';
const dataFechaAcualizado = '10/2/2023' + ' 10:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 143, MVar:'41', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'39', Cost:10.45, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'7', Cost:18.04, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'94', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 311,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 311, MVar:'160', Cost:17.06, ParentId: '16'},
		]
	},
