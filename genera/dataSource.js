const timestamp_saved = '08/23/2023 06:10 AM';
const dataFechaAcualizado = '8/23/2023' + ' 2:05:39 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'44', Cost:10.59, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 334,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:20.31, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'8', Cost:20.31, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 123, MVar:'0', Cost:8.69, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 43, MVar:'12', Cost:8.69, ParentId: '11'},
		]
	},
