const timestamp_saved = '11/02/2023 09:05 AM';
const dataFechaAcualizado = '11/2/2023' + ' 5:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 441,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'46', Cost:10.73, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'45', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'43', Cost:10.73, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'56', Cost:9.61, ParentId: '17'},
		]
	},
