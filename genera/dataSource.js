const timestamp_saved = '08/16/2023 09:55 AM';
const dataFechaAcualizado = '8/16/2023' + ' 5:52:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'58', Cost:10.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'53', Cost:10.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'60', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 304,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 304, MVar:'84', Cost:10.48, ParentId: '17'},
		]
	},
