const timestamp_saved = '08/06/2023 05:05 PM';
const dataFechaAcualizado = '8/6/2023' + ' 1:00:40 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'50', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'47', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'45', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'5', Cost:30.95, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 32, MVar:'0', Cost:31.83, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 32, MVar:'8', Cost:30.93, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 271,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 120, MVar:'26', Cost:16.39, ParentId: '15'},
		]
	},
