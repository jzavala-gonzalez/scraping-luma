const timestamp_saved = '10/22/2023 01:20 PM';
const dataFechaAcualizado = '10/22/2023' + ' 9:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'38', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'39', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 122, MVar:'45', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'7', Cost:17.53, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 77, MVar:'14', Cost:19.04, ParentId: '14'},
