const timestamp_saved = '10/25/2023 12:50 PM';
const dataFechaAcualizado = '10/25/2023' + ' 8:46:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'50', Cost:10.70, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'46', Cost:10.70, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'144', Cost:17.38, ParentId: '16'},
		]
	},
