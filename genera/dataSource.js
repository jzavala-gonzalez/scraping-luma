const timestamp_saved = '12/05/2023 08:05 PM';
const dataFechaAcualizado = '12/5/2023' + ' 4:00:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'58', Cost:10.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'60', Cost:10.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'63', Cost:10.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'83', Cost:11.35, ParentId: '17'},
		]
	},
