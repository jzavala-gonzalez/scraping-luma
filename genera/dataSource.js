const timestamp_saved = '11/21/2023 01:40 PM';
const dataFechaAcualizado = '11/21/2023' + ' 9:36:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'33', Cost:10.77, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'44', Cost:10.77, ParentId: '7'},
