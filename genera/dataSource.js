const timestamp_saved = '09/24/2023 12:25 PM';
const dataFechaAcualizado = '9/24/2023' + ' 8:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 383,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'41', Cost:11.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'43', Cost:11.35, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:30.89, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'77', Cost:9.54, ParentId: '17'},
		]
	},
