const timestamp_saved = '08/17/2023 05:10 AM';
const dataFechaAcualizado = '8/17/2023' + ' 1:07:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'60', Cost:11.28, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'9', Cost:18.74, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 314,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 314, MVar:'183', Cost:16.93, ParentId: '16'},
		]
	},
