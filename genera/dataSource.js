const timestamp_saved = '10/14/2023 05:55 PM';
const dataFechaAcualizado = '10/14/2023' + ' 1:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'56', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'55', Cost:10.72, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'13', Cost:19.15, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 271,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 271, MVar:'164', Cost:17.63, ParentId: '16'},
		]
	},
