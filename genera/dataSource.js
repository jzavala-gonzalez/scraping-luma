const timestamp_saved = '11/22/2023 06:05 PM';
const dataFechaAcualizado = '11/22/2023' + ' 2:01:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'34', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'44', Cost:10.85, ParentId: '7'},
