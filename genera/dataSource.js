const timestamp_saved = '10/21/2023 12:35 PM';
const dataFechaAcualizado = '10/21/2023' + ' 8:31:16 AM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2101},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 321,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'37', Cost:11.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'35', Cost:11.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'37', Cost:11.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'47', Cost:16.97, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'11', Cost:19.21, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'65', Cost:16.90, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'67', Cost:11.05, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 0, MVar:'0', Cost:17.07, ParentId: '21'},
