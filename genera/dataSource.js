const timestamp_saved = '08/19/2023 02:45 PM';
const dataFechaAcualizado = '8/19/2023' + ' 10:42:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'52', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'51', Cost:11.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'53', Cost:11.05, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'8', Cost:30.75, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'5', Cost:28.07, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 100,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 100, MVar:'99', Cost:17.80, ParentId: '15'},
