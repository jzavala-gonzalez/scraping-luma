const timestamp_saved = '10/01/2023 11:15 PM';
const dataFechaAcualizado = '10/1/2023' + ' 7:10:56 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'8', Desc:'Máxima Mensual', value: 2734},
];
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'38', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'36', Cost:10.53, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 322,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:17.10, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 44, MVar:'9', Cost:17.10, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 97, MVar:'0', Cost:20.54, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 36, MVar:'6', Cost:20.54, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'84', Cost:16.76, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'146', Cost:16.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 344,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 344, MVar:'111', Cost:9.22, ParentId: '17'},
		]
	},
