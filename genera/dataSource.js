const timestamp_saved = '09/03/2023 01:20 AM';
const dataFechaAcualizado = '9/2/2023' + ' 9:15:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 457,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 155, MVar:'52', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'61', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'68', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'6', Cost:26.16, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 24, MVar:'0', Cost:26.59, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'12', Cost:27.25, ParentId: '9'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'60', Cost:17.10, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'172', Cost:16.66, ParentId: '16'},
		]
	},
