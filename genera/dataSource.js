const timestamp_saved = '12/05/2023 02:15 PM';
const dataFechaAcualizado = '12/5/2023' + ' 10:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 341,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'47', Cost:12.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'51', Cost:12.09, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 187,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 99, MVar:'9', Cost:18.55, ParentId: '14'},
