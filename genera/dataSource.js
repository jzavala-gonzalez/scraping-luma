const timestamp_saved = '11/23/2023 04:55 AM';
const dataFechaAcualizado = '11/23/2023' + ' 12:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 374,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'26', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'36', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'51', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:8.17, ParentId: '11'},
