const timestamp_saved = '08/10/2023 01:35 AM';
const dataFechaAcualizado = '8/9/2023' + ' 9:30:42 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 158, MVar:'53', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'61', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'61', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'6', Cost:26.91, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 25, MVar:'3', Cost:25.51, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'14', Cost:30.92, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:28.77, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 69,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 39, MVar:'6', Cost:29.98, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'91', Cost:11.32, ParentId: '17'},
		]
	},
