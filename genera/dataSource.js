const timestamp_saved = '11/27/2023 04:35 AM';
const dataFechaAcualizado = '11/27/2023' + ' 12:31:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 455,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'28', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'37', Cost:10.33, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 141, MVar:'44', Cost:17.46, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 312,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 312, MVar:'78', Cost:9.55, ParentId: '17'},
		]
	},
