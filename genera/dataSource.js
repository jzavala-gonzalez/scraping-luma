const timestamp_saved = '11/22/2023 08:45 PM';
const dataFechaAcualizado = '11/22/2023' + ' 4:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'34', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'46', Cost:10.86, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 21,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 21, MVar:'10', Cost:0, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 243,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 243, MVar:'167', Cost:18.19, ParentId: '16'},
		]
	},
