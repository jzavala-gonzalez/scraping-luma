const timestamp_saved = '11/18/2023 12:55 PM';
const dataFechaAcualizado = '11/18/2023' + ' 8:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 280,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'57', Cost:16.03, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 67,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 36, MVar:'0', Cost:30.22, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'86', Cost:16.92, ParentId: '15'},
