const timestamp_saved = '10/16/2023 04:55 AM';
const dataFechaAcualizado = '10/16/2023' + ' 12:51:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 296,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 93, MVar:'50', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'50', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'54', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'4', Cost:19.41, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 176,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 176, MVar:'79', Cost:16.49, ParentId: '15'},
