const timestamp_saved = '09/03/2023 06:05 AM';
const dataFechaAcualizado = '9/3/2023' + ' 2:00:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'41', Cost:10.90, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'51', Cost:10.90, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'59', Cost:10.90, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 26,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 2, MVar:'1', Cost:21.46, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.56, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'45', Cost:16.81, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'63', Cost:9.20, ParentId: '17'},
		]
	},
