const timestamp_saved = '10/22/2023 05:30 AM';
const dataFechaAcualizado = '10/22/2023' + ' 1:26:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'132', Cost:18.02, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 268,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 268, MVar:'61', Cost:11.12, ParentId: '17'},
		]
	},
