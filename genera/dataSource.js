const timestamp_saved = '10/04/2023 04:40 PM';
const dataFechaAcualizado = '10/4/2023' + ' 12:35:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'45', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 137, MVar:'41', Cost:11.12, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'61', Cost:17.06, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'167', Cost:17.40, ParentId: '16'},
		]
	},
