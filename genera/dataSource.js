const timestamp_saved = '11/20/2023 04:25 PM';
const dataFechaAcualizado = '11/20/2023' + ' 12:21:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 365,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 121, MVar:'36', Cost:11.61, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'44', Cost:11.61, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'57', Cost:11.61, ParentId: '7'},
		]
	},
