const timestamp_saved = '08/13/2023 05:40 PM';
const dataFechaAcualizado = '8/13/2023' + ' 1:37:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'34', Cost:10.49, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'40', Cost:10.49, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'40', Cost:10.49, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 331, MVar:'105', Cost:12.34, ParentId: '17'},
		]
	},
