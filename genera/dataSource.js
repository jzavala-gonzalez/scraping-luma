const timestamp_saved = '08/14/2023 08:20 AM';
const dataFechaAcualizado = '8/14/2023' + ' 4:17:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'35', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'41', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'39', Cost:10.26, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 81,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 120, MVar:'35', Cost:0, ParentId: '8'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'25', Cost:18.79, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 319, MVar:'145', Cost:16.96, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'100', Cost:12.97, ParentId: '17'},
		]
	},
