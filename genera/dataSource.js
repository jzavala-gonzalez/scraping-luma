const timestamp_saved = '08/29/2023 02:30 PM';
const dataFechaAcualizado = '8/29/2023' + ' 10:25:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'54', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'56', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'63', Cost:10.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 93,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 140, MVar:'49', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 406,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'0', Cost:19.84, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'40', Cost:19.49, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 249,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 249, MVar:'140', Cost:17.80, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 323,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 323, MVar:'105', Cost:9.31, ParentId: '17'},
		]
	},
