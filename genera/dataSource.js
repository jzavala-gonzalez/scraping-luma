const timestamp_saved = '10/07/2023 06:55 AM';
const dataFechaAcualizado = '10/7/2023' + ' 2:51:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 28, MVar:'37', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'46', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'45', Cost:10.95, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'50', Cost:10.95, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'9', Cost:17.47, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'5', Cost:30.67, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'6', Cost:19.20, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 334,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 334, MVar:'96', Cost:9.26, ParentId: '17'},
		]
	},
