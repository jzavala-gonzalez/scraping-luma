const timestamp_saved = '09/21/2023 09:35 AM';
const dataFechaAcualizado = '9/21/2023' + ' 5:30:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'42', Cost:10.52, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'47', Cost:10.52, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 358,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:19.92, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'11', Cost:19.92, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 112, MVar:'0', Cost:10.02, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'76', Cost:17.07, ParentId: '15'},
