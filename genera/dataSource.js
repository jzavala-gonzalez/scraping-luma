const timestamp_saved = '11/14/2023 02:25 AM';
const dataFechaAcualizado = '11/13/2023' + ' 10:21:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 555,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'63', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 181, MVar:'66', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 199, MVar:'64', Cost:9.74, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 66,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 66, MVar:'23', Cost:28.37, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 160, MVar:'50', Cost:17.09, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'13', Cost:30.84, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'12', Cost:30.76, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 146,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 146, MVar:'67', Cost:16.80, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'127', Cost:10.87, ParentId: '17'},
		]
	},
