const timestamp_saved = '10/23/2023 07:00 AM';
const dataFechaAcualizado = '10/23/2023' + ' 2:56:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'35', Cost:12.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'37', Cost:12.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'39', Cost:12.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'59', Cost:16.84, ParentId: '15'},
