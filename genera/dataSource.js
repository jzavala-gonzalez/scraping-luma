const timestamp_saved = '10/20/2023 12:45 PM';
const dataFechaAcualizado = '10/20/2023' + ' 8:41:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 478,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 165, MVar:'44', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 165, MVar:'51', Cost:10.38, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 260,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 260, MVar:'153', Cost:17.84, ParentId: '16'},
		]
	},
