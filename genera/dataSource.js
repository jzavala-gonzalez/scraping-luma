const timestamp_saved = '11/04/2023 05:20 PM';
const dataFechaAcualizado = '11/4/2023' + ' 1:16:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'46', Cost:12.57, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'44', Cost:12.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'44', Cost:12.57, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'93', Cost:16.67, ParentId: '15'},
