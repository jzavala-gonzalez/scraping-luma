const timestamp_saved = '08/13/2023 10:55 AM';
const dataFechaAcualizado = '8/13/2023' + ' 6:52:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'35', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'38', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'39', Cost:11.12, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 351,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 351, MVar:'106', Cost:12.26, ParentId: '17'},
		]
	},
