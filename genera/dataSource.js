const timestamp_saved = '09/11/2023 05:55 PM';
const dataFechaAcualizado = '9/11/2023' + ' 1:50:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'72', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'82', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'70', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'68', Cost:10.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'78', Cost:10.60, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 149,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 74, MVar:'13', Cost:28.28, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'11', Cost:28.25, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'3', Cost:28.46, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 84,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 84, MVar:'22', Cost:18.82, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 163,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 163, MVar:'94', Cost:16.24, ParentId: '15'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 99,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 29, MVar:'15', Cost:17, ParentId: '19'},
		]
	},
