const timestamp_saved = '08/29/2023 02:20 PM';
const dataFechaAcualizado = '8/29/2023' + ' 10:15:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'82', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'54', Cost:10.51, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'56', Cost:10.51, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'63', Cost:10.51, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'16', Cost:31.19, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'48', Cost:19.64, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 52, MVar:'10', Cost:19.64, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 155, MVar:'0', Cost:11.27, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'12', Cost:11.27, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'42', Cost:19.27, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'103', Cost:16.84, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'142', Cost:17.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 322,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 322, MVar:'104', Cost:9.32, ParentId: '17'},
		]
	},
