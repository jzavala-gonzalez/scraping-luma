const timestamp_saved = '10/12/2023 07:55 PM';
const dataFechaAcualizado = '10/12/2023' + ' 3:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'72', Cost:10.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 170, MVar:'75', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 155, MVar:'74', Cost:10.23, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 18, MVar:'0', Cost:25.49, ParentId: '8'},
			...
			{Index:'4', Unit:'Daguao', MW: 15, MVar:'0', Cost:35.82, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 76,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'33', Cost:28.21, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'22', Cost:19.31, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'98', Cost:16.77, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 346,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 346, MVar:'195', Cost:16.77, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 338,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 338, MVar:'103', Cost:9.26, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 37,
		units:[
			...
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:25.49, ParentId: '21'},
