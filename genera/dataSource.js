const timestamp_saved = '10/20/2023 07:50 AM';
const dataFechaAcualizado = '10/20/2023' + ' 3:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'31', Cost:11.67, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 120, MVar:'38', Cost:11.67, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'40', Cost:11.67, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'76', Cost:10.54, ParentId: '17'},
		]
	},
