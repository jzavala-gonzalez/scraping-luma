const timestamp_saved = '11/09/2023 03:45 AM';
const dataFechaAcualizado = '11/8/2023' + ' 11:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 421,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'46', Cost:10.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'45', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'48', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 9,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 9, MVar:'0', Cost:26.65, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 99,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 28, MVar:'26', Cost:31.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'76', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 210,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 210, MVar:'143', Cost:18.43, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 336,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 336, MVar:'92', Cost:9.26, ParentId: '17'},
		]
	},
