const timestamp_saved = '09/06/2023 05:25 AM';
const dataFechaAcualizado = '9/6/2023' + ' 1:20:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 102, MVar:'46', Cost:12.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'50', Cost:12.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'59', Cost:12.37, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 0,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:28.29, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'15', Cost:19.68, ParentId: '14'},
