const timestamp_saved = '10/24/2023 11:45 AM';
const dataFechaAcualizado = '10/24/2023' + ' 7:41:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 419,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'44', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'45', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'48', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 277,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 277, MVar:'69', Cost:11.03, ParentId: '17'},
		]
	},
