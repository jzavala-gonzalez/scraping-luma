const timestamp_saved = '09/19/2023 06:15 AM';
const dataFechaAcualizado = '9/19/2023' + ' 2:10:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'47', Cost:11.37, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'48', Cost:11.37, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'61', Cost:11.37, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 416,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 160, MVar:'0', Cost:10.28, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 47, MVar:'10', Cost:10.28, ParentId: '11'},
		]
	},
