const timestamp_saved = '08/20/2023 10:10 PM';
const dataFechaAcualizado = '8/20/2023' + ' 6:07:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'44', Cost:10.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:10.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'66', Cost:9.31, ParentId: '17'},
		]
	},
