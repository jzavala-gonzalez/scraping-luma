const timestamp_saved = '08/14/2023 03:45 AM';
const dataFechaAcualizado = '8/13/2023' + ' 11:42:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'37', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 94, MVar:'41', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'41', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 295,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 85, MVar:'27', Cost:31.22, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:31.22, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'143', Cost:16.61, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 353,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 353, MVar:'108', Cost:12.25, ParentId: '17'},
		]
	},
