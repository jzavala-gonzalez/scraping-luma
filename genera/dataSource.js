const timestamp_saved = '12/05/2023 07:05 AM';
const dataFechaAcualizado = '12/5/2023' + ' 3:01:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'36', Cost:13.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'40', Cost:13.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'50', Cost:13.38, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 405,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 142, MVar:'46', Cost:17.56, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 227,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 227, MVar:'97', Cost:18.42, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 284,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 284, MVar:'46', Cost:11.34, ParentId: '17'},
		]
	},
