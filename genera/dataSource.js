const timestamp_saved = '10/01/2023 07:05 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:00:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 310,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'28', Cost:12.93, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'28', Cost:12.93, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'45', Cost:12.93, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.69, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'9', Cost:17.69, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 292,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 292, MVar:'90', Cost:9.47, ParentId: '17'},
		]
	},
