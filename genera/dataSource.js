const timestamp_saved = '09/23/2023 07:40 AM';
const dataFechaAcualizado = '9/23/2023' + ' 3:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 110, MVar:'39', Cost:12.35, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 110, MVar:'40', Cost:12.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'56', Cost:12.35, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 102,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'3', Cost:31.26, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'5', Cost:19.03, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'48', Cost:16.82, ParentId: '15'},
