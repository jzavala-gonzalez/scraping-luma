const timestamp_saved = '10/01/2023 07:45 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:40:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'57', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'29', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'27', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'45', Cost:12.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.73, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.73, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'128', Cost:17.80, ParentId: '16'},
		]
	},
