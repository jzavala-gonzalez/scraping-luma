const timestamp_saved = '10/29/2023 05:15 PM';
const dataFechaAcualizado = '10/29/2023' + ' 1:11:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 411,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'48', Cost:11.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'51', Cost:11.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'72', Cost:11.15, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 156, MVar:'46', Cost:17.04, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 317,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 317, MVar:'124', Cost:16.97, ParentId: '16'},
		]
	},
