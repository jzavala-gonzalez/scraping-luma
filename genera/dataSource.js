const timestamp_saved = '08/09/2023 07:25 AM';
const dataFechaAcualizado = '8/9/2023' + ' 3:20:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'38', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'45', Cost:10.87, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 395,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'9', Cost:20.40, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:31.99, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'94', Cost:17.94, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 251,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 251, MVar:'63', Cost:12.98, ParentId: '17'},
		]
	},
