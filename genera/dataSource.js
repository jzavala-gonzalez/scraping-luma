const timestamp_saved = '11/01/2023 12:46 AM';
const dataFechaAcualizado = '10/31/2023' + ' 8:41:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 118, MVar:'59', Cost:11.64, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 118, MVar:'64', Cost:11.64, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 125, MVar:'68', Cost:11.64, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 65,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:21.46, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 16, MVar:'8', Cost:27.18, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.27, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:17.27, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 147,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'19', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'80', Cost:16.85, ParentId: '15'},
