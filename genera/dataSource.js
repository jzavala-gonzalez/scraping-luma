const timestamp_saved = '10/01/2023 07:40 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'57', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'29', Cost:12.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'27', Cost:12.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 118, MVar:'47', Cost:12.56, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 209,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.71, ParentId: '11'},
