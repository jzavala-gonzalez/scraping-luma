const timestamp_saved = '08/04/2023 12:50 AM';
const dataFechaAcualizado = '8/3/2023' + ' 8:45:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 143, MVar:'52', Cost:10.38, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 90,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 90, MVar:'25', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 325,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'102', Cost:16.53, ParentId: '15'},
