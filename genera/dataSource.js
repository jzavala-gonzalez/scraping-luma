const timestamp_saved = '11/20/2023 05:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 1:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 297,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'32', Cost:13.19, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'42', Cost:13.19, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'56', Cost:13.19, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'170', Cost:18.23, ParentId: '16'},
		]
	},
