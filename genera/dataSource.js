const timestamp_saved = '11/25/2023 11:20 AM';
const dataFechaAcualizado = '11/25/2023' + ' 7:16:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 116,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 116, MVar:'58', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'21', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'30', Cost:10.82, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 316,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:17.77, ParentId: '11'},
