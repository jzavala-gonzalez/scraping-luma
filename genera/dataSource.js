const timestamp_saved = '11/26/2023 01:30 PM';
const dataFechaAcualizado = '11/26/2023' + ' 9:26:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 393,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'22', Cost:11.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'32', Cost:11.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'47', Cost:11.82, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 335,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'43', Cost:17.89, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 46, MVar:'11', Cost:17.89, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 180,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 180, MVar:'127', Cost:19.32, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'68', Cost:10.16, ParentId: '17'},
		]
	},
