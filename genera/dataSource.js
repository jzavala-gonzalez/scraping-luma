const timestamp_saved = '08/20/2023 01:25 PM';
const dataFechaAcualizado = '8/20/2023' + ' 9:22:57 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 128, MVar:'51', Cost:10.58, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'47', Cost:19.52, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'12', Cost:19.52, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'5', Cost:30.16, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 297,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 297, MVar:'61', Cost:9.46, ParentId: '17'},
		]
	},
