const timestamp_saved = '08/14/2023 09:00 AM';
const dataFechaAcualizado = '8/14/2023' + ' 4:57:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'35', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'40', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'40', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'99', Cost:12.98, ParentId: '17'},
		]
	},
