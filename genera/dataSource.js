const timestamp_saved = '11/29/2023 06:10 PM';
const dataFechaAcualizado = '11/29/2023' + ' 2:06:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 428,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'53', Cost:10.84, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'86', Cost:9.81, ParentId: '17'},
		]
	},
