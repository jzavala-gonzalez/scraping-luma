const timestamp_saved = '07/26/2023 11:41 AM';
const dataFechaAcualizado = '7/26/2023' + ' 7:35:31 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 234, MVar:'83', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 209, MVar:'87', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'47', Cost:10.50, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'2', Cost:23.58, ParentId: '9'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:30.77, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 316,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 316, MVar:'89', Cost:9.33, ParentId: '17'},
		]
	},
