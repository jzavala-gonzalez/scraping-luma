const timestamp_saved = '11/22/2023 01:10 PM';
const dataFechaAcualizado = '11/22/2023' + ' 9:06:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'34', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'44', Cost:10.45, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'171', Cost:18.27, ParentId: '16'},
		]
	},
