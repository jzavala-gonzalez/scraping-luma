const timestamp_saved = '09/28/2023 05:00 PM';
const dataFechaAcualizado = '9/28/2023' + ' 12:55:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'27', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'27', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'50', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 259,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 259, MVar:'87', Cost:9.75, ParentId: '17'},
		]
	},
