const timestamp_saved = '08/03/2023 07:40 AM';
const dataFechaAcualizado = '8/3/2023' + ' 3:35:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 234,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 130, MVar:'38', Cost:17.35, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 104, MVar:'36', Cost:16.85, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 258,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 258, MVar:'74', Cost:11.24, ParentId: '17'},
		]
	},
