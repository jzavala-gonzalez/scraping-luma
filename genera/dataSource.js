const timestamp_saved = '11/14/2023 06:05 AM';
const dataFechaAcualizado = '11/14/2023' + ' 2:01:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 323,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'42', Cost:12.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'46', Cost:12.65, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 114,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 43, MVar:'11', Cost:22.39, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'83', Cost:11.19, ParentId: '17'},
		]
	},
