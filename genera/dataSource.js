const timestamp_saved = '08/19/2023 10:00 AM';
const dataFechaAcualizado = '8/19/2023' + ' 5:57:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'39', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'53', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'67', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'62', Cost:9.17, ParentId: '17'},
		]
	},
