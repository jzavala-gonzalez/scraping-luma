const timestamp_saved = '10/18/2023 02:20 PM';
const dataFechaAcualizado = '10/18/2023' + ' 10:16:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'47', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'50', Cost:11.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'62', Cost:11.04, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 49,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 49, MVar:'76', Cost:23.27, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'104', Cost:10.56, ParentId: '17'},
		]
	},
