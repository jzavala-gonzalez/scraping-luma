const timestamp_saved = '12/05/2023 08:00 PM';
const dataFechaAcualizado = '12/5/2023' + ' 3:55:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 913},
	{Index:'7', Desc:'Capacidad Disponible', value: 3225},
	{Index:'8', Desc:'Próxima Hora MW', value: 2283},
	{Index:'9', Desc:'Máxima para Hoy', value: 2324},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 505,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'57', Cost:10.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'59', Cost:10.11, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 267,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 267, MVar:'83', Cost:11.62, ParentId: '17'},
		]
	},
