const timestamp_saved = '11/13/2023 09:05 PM';
const dataFechaAcualizado = '11/13/2023' + ' 5:01:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 535,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'61', Cost:9.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'65', Cost:9.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 182, MVar:'63', Cost:9.92, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 72,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 72, MVar:'32', Cost:28.16, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 81,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 40, MVar:'11', Cost:29.68, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 98,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'9', Cost:27.96, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'128', Cost:9.14, ParentId: '17'},
		]
	},
