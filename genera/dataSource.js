const timestamp_saved = '11/18/2023 07:55 AM';
const dataFechaAcualizado = '11/18/2023' + ' 3:51:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 141,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'73', Cost:23.66, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 95,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 29, MVar:'0', Cost:21.06, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.89, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 20, MVar:'6', Cost:27.70, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'0', Cost:26.81, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 156, MVar:'48', Cost:17.18, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'6', Cost:29.70, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:31.81, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 66,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 36, MVar:'11', Cost:29.63, ParentId: '13'},
			{Index:'4', Unit:'STG 2', MW: 0, MVar:'0', Cost:0, ParentId: '13'},
		]
	},
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 132,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 42, MVar:'11', Cost:22.61, ParentId: '14'},
			{Index:'1', Unit:'Unit 8', MW: 0, MVar:'0', Cost:0, ParentId: '14'},
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'19', Cost:18.61, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 164,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 164, MVar:'78', Cost:17.02, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'132', Cost:9.12, ParentId: '17'},
		]
	},
