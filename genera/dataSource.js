const timestamp_saved = '09/04/2023 07:10 AM';
const dataFechaAcualizado = '9/4/2023' + ' 3:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 485,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'34', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'40', Cost:10.31, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 213,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 213, MVar:'51', Cost:10.20, ParentId: '17'},
		]
	},
