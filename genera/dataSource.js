const timestamp_saved = '09/05/2023 07:15 AM';
const dataFechaAcualizado = '9/5/2023' + ' 3:10:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'36', Cost:11.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'39', Cost:11.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'54', Cost:11.79, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:31.07, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 326,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 326, MVar:'66', Cost:9.30, ParentId: '17'},
		]
	},
