const timestamp_saved = '07/28/2023 07:05 PM';
const dataFechaAcualizado = '7/28/2023' + ' 3:00:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 256, MVar:'73', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'74', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 418,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:10.75, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 108, MVar:'51', Cost:10.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'49', Cost:10.75, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 77,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 139, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 67,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 44, MVar:'4', Cost:22.52, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'9', Cost:28.75, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'80', Cost:16.84, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'51', Cost:15.60, ParentId: '15'},
		]
	},
