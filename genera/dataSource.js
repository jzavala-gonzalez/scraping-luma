const timestamp_saved = '11/30/2023 05:10 AM';
const dataFechaAcualizado = '11/30/2023' + ' 1:06:23 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 447,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'43', Cost:10.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'48', Cost:10.60, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 428,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 163, MVar:'51', Cost:8.07, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 208,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 208, MVar:'68', Cost:10.35, ParentId: '17'},
		]
	},
