const timestamp_saved = '11/23/2023 05:45 PM';
const dataFechaAcualizado = '11/23/2023' + ' 1:41:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 235,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 235, MVar:'80', Cost:4.43, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.43, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 306,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 95, MVar:'22', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'34', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'50', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'38', Cost:17.66, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:17.66, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'52', Cost:9.83, ParentId: '17'},
		]
	},
