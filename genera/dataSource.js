const timestamp_saved = '08/12/2023 11:45 AM';
const dataFechaAcualizado = '8/12/2023' + ' 7:42:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'45', Cost:11.10, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 96, MVar:'44', Cost:11.10, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'45', Cost:11.10, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 393,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'0', Cost:14.10, ParentId: '11'},
