const timestamp_saved = '08/30/2023 11:05 PM';
const dataFechaAcualizado = '8/30/2023' + ' 7:00:50 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 3144},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 192, MVar:'100', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 537,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'64', Cost:10.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'72', Cost:10.05, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 190, MVar:'75', Cost:10.05, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 147,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 26, MVar:'3', Cost:27.69, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 34, MVar:'0', Cost:26.80, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 39, MVar:'5', Cost:23.15, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'6', Cost:24.90, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 76, MVar:'26', Cost:30.84, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 154, MVar:'45', Cost:19.05, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'8', Cost:26.81, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'0', Cost:28.63, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 83,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 83, MVar:'45', Cost:17.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'113', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 369, MVar:'195', Cost:16.64, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'116', Cost:9.18, ParentId: '17'},
		]
	},
