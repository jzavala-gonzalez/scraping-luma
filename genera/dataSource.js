const timestamp_saved = '10/28/2023 11:20 AM';
const dataFechaAcualizado = '10/28/2023' + ' 7:16:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'37', Cost:11.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'43', Cost:11.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'45', Cost:11.16, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 165,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 55, MVar:'16', Cost:31.00, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 80,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'6', Cost:30.13, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 117,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 80, MVar:'17', Cost:18.89, ParentId: '14'},
