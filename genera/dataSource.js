const timestamp_saved = '10/20/2023 09:10 AM';
const dataFechaAcualizado = '10/20/2023' + ' 5:06:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 128, MVar:'31', Cost:11.81, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'38', Cost:11.81, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'39', Cost:11.81, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'84', Cost:10.54, ParentId: '17'},
		]
	},
