const timestamp_saved = '09/10/2023 11:10 PM';
const dataFechaAcualizado = '9/10/2023' + ' 7:05:52 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 559,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'70', Cost:9.79, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 175, MVar:'71', Cost:9.79, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 212, MVar:'68', Cost:9.79, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 135,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 83, MVar:'0', Cost:9.20, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 176,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'3', Cost:21.90, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'0', Cost:21.99, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 25, MVar:'10', Cost:41.70, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 48, MVar:'1', Cost:22.58, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 154,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'15', Cost:28.18, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'13', Cost:28.29, ParentId: '10'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'6', Cost:28.94, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'11', Cost:28.72, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 93,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 93, MVar:'22', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 181,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 181, MVar:'96', Cost:16.54, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 373,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 373, MVar:'153', Cost:16.69, ParentId: '16'},
		]
	},
