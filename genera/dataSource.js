const timestamp_saved = '10/03/2023 04:10 PM';
const dataFechaAcualizado = '10/3/2023' + ' 12:05:56 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'44', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 162, MVar:'43', Cost:10.26, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'54', Cost:10.26, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'16', Cost:19.28, ParentId: '14'},
