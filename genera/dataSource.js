const timestamp_saved = '10/27/2023 06:25 AM';
const dataFechaAcualizado = '10/27/2023' + ' 2:21:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:11.17, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'44', Cost:11.17, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'48', Cost:11.17, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 8,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 8, MVar:'0', Cost:26.18, ParentId: '8'},
