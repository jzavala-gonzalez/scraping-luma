const timestamp_saved = '08/15/2023 03:05 AM';
const dataFechaAcualizado = '8/14/2023' + ' 11:02:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'57', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 100, MVar:'51', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'56', Cost:10.83, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'6', Cost:31.99, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:31.98, ParentId: '12'},
