const timestamp_saved = '11/22/2023 09:35 PM';
const dataFechaAcualizado = '11/22/2023' + ' 5:31:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 373,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 125, MVar:'33', Cost:11.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'43', Cost:11.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'56', Cost:11.87, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 59,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 29, MVar:'8', Cost:30.66, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'100', Cost:9.22, ParentId: '17'},
		]
	},
