const timestamp_saved = '11/06/2023 10:05 PM';
const dataFechaAcualizado = '11/6/2023' + ' 6:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 486,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'56', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'50', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 56,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 141, MVar:'29', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'48', Cost:16.97, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 55, MVar:'10', Cost:16.97, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 64,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 64, MVar:'8', Cost:20.10, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 226,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 226, MVar:'169', Cost:18.32, ParentId: '16'},
		]
	},
