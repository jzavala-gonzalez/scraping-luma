const timestamp_saved = '11/26/2023 10:45 PM';
const dataFechaAcualizado = '11/26/2023' + ' 6:41:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'40', Cost:10.33, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'50', Cost:10.33, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 148, MVar:'60', Cost:10.33, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 10,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 10, MVar:'4', Cost:0, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 49,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 49, MVar:'24', Cost:33.41, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'44', Cost:17.46, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:17.46, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 150, MVar:'44', Cost:8.19, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 350,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 350, MVar:'106', Cost:9.31, ParentId: '17'},
		]
	},
