const timestamp_saved = '11/08/2023 08:50 AM';
const dataFechaAcualizado = '11/8/2023' + ' 4:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'39', Cost:11.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'36', Cost:11.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'42', Cost:11.25, ParentId: '7'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:30.47, ParentId: '13'},
