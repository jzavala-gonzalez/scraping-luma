const timestamp_saved = '09/26/2023 08:16 AM';
const dataFechaAcualizado = '9/26/2023' + ' 4:10:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'45', Cost:11.46, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'47', Cost:11.46, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'55', Cost:11.46, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.18, ParentId: '11'},
