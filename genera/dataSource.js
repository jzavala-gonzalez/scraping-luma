const timestamp_saved = '09/16/2023 10:10 PM';
const dataFechaAcualizado = '9/16/2023' + ' 6:05:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 134, MVar:'46', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 134, MVar:'45', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'60', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 47,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'1', Cost:28.55, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'33', Cost:18.85, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 160,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'90', Cost:16.69, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 374,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 374, MVar:'132', Cost:16.64, ParentId: '16'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 2,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 2, MVar:'4', Cost:19.60, ParentId: '19'},
