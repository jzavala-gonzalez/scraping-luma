const timestamp_saved = '08/02/2023 01:25 PM';
const dataFechaAcualizado = '8/2/2023' + ' 9:20:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'52', Cost:10.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'49', Cost:10.32, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'100', Cost:11.00, ParentId: '17'},
		]
	},
