const timestamp_saved = '08/25/2023 08:55 AM';
const dataFechaAcualizado = '8/25/2023' + ' 4:50:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 406,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'57', Cost:11.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 101, MVar:'56', Cost:11.04, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 329,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 329, MVar:'94', Cost:9.27, ParentId: '17'},
		]
	},
