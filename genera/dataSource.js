const timestamp_saved = '08/06/2023 03:00 PM';
const dataFechaAcualizado = '8/6/2023' + ' 10:55:40 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 481,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 151, MVar:'44', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'4', Cost:30.42, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'8', Cost:30.40, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 230,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 100, MVar:'30', Cost:17.02, ParentId: '15'},
		]
	},
