const timestamp_saved = '08/10/2023 04:05 AM';
const dataFechaAcualizado = '8/10/2023' + ' 12:00:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'51', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'56', Cost:11.23, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 54,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'0', Cost:26.60, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:25.94, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 22, MVar:'5', Cost:27.20, ParentId: '9'},
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'2', Cost:32.24, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 108,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
			{Index:'1', Unit:'Gas 2', MW: 54, MVar:'12', Cost:30.88, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 54, MVar:'14', Cost:30.69, ParentId: '10'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'81', Cost:11.51, ParentId: '17'},
		]
	},
