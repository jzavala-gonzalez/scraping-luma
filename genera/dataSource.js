const timestamp_saved = '11/04/2023 12:50 PM';
const dataFechaAcualizado = '11/4/2023' + ' 8:46:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 126, MVar:'45', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'44', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'43', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 54,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 23, MVar:'2', Cost:19.60, ParentId: '19'},
