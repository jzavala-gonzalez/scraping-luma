const timestamp_saved = '11/05/2023 03:05 AM';
const dataFechaAcualizado = '11/4/2023' + ' 11:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'52', Cost:10.70, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 265,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 108, MVar:'33', Cost:18.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'9', Cost:18.21, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'77', Cost:9.20, ParentId: '17'},
		]
	},
