const timestamp_saved = '10/17/2023 10:00 PM';
const dataFechaAcualizado = '10/17/2023' + ' 5:56:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 159, MVar:'67', Cost:10.62, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'66', Cost:10.62, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 157, MVar:'89', Cost:16.88, ParentId: '15'},
