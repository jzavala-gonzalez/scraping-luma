const timestamp_saved = '11/28/2023 03:20 AM';
const dataFechaAcualizado = '11/27/2023' + ' 11:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'31', Cost:11.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 113, MVar:'39', Cost:11.88, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'55', Cost:11.88, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'4', Cost:19.20, ParentId: '14'},
