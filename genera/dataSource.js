const timestamp_saved = '11/08/2023 03:50 AM';
const dataFechaAcualizado = '11/7/2023' + ' 11:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'44', Cost:10.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'47', Cost:10.98, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 25,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 2, MVar:'0', Cost:25.29, ParentId: '9'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'93', Cost:9.17, ParentId: '17'},
		]
	},
