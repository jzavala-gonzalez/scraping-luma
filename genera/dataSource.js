const timestamp_saved = '08/09/2023 06:45 AM';
const dataFechaAcualizado = '8/9/2023' + ' 2:40:42 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'37', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 88, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'53', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.61, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:30.46, ParentId: '13'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 307,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 307, MVar:'98', Cost:17.05, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'63', Cost:13.31, ParentId: '17'},
		]
	},
