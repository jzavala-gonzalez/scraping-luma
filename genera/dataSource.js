const timestamp_saved = '09/21/2023 12:25 AM';
const dataFechaAcualizado = '9/20/2023' + ' 8:20:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 459,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 162, MVar:'51', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'56', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'63', Cost:11.42, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 167,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:14.10, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 135,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'18', Cost:27.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 58, MVar:'16', Cost:31.04, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'20', Cost:26.77, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 165,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 165, MVar:'89', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 197,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 197, MVar:'183', Cost:14.10, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'106', Cost:9.15, ParentId: '17'},
		]
	},
