const timestamp_saved = '11/28/2023 09:55 PM';
const dataFechaAcualizado = '11/28/2023' + ' 5:51:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 312,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 99, MVar:'41', Cost:12.58, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 98, MVar:'51', Cost:12.58, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'61', Cost:12.58, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 75,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:25.91, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 22,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'5', Cost:0, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 100,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'11', Cost:28.19, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'116', Cost:9.15, ParentId: '17'},
		]
	},
