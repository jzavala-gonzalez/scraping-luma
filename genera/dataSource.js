const timestamp_saved = '09/03/2023 03:30 AM';
const dataFechaAcualizado = '9/2/2023' + ' 11:25:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 413,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'48', Cost:10.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'55', Cost:10.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'65', Cost:10.85, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'5', Cost:31.56, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 52,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'0', Cost:31.29, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'62', Cost:17.00, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 340,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 340, MVar:'159', Cost:16.81, ParentId: '16'},
		]
	},
