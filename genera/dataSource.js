const timestamp_saved = '10/04/2023 09:20 PM';
const dataFechaAcualizado = '10/4/2023' + ' 5:16:13 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'47', Cost:10.80, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'45', Cost:10.80, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'58', Cost:10.80, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 23,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 23, MVar:'4', Cost:26.94, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:17.39, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 141,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 141, MVar:'85', Cost:17.05, ParentId: '15'},
