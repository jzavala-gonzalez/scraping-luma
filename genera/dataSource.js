const timestamp_saved = '08/28/2023 03:55 AM';
const dataFechaAcualizado = '8/27/2023' + ' 11:50:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 420,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'42', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'42', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'48', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 2,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 1, MVar:'0', Cost:27.98, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 1, MVar:'0', Cost:27.39, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'15', Cost:19.03, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 349,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 349, MVar:'105', Cost:11.64, ParentId: '17'},
		]
	},
