const timestamp_saved = '11/06/2023 05:40 AM';
const dataFechaAcualizado = '11/6/2023' + ' 1:36:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 91, MVar:'41', Cost:13.25, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'42', Cost:13.25, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'42', Cost:13.25, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 297,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 297, MVar:'112', Cost:17.15, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 260,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 260, MVar:'51', Cost:9.78, ParentId: '17'},
		]
	},
