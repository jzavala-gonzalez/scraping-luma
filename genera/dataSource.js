const timestamp_saved = '10/17/2023 01:55 AM';
const dataFechaAcualizado = '10/16/2023' + ' 9:51:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 472,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 160, MVar:'73', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 160, MVar:'73', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'76', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 23, MVar:'3', Cost:26.47, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:16.40, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 54, MVar:'10', Cost:16.40, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'94', Cost:9.15, ParentId: '17'},
		]
	},
