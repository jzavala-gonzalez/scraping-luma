const timestamp_saved = '10/20/2023 08:50 AM';
const dataFechaAcualizado = '10/20/2023' + ' 4:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 371,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 124, MVar:'30', Cost:11.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 124, MVar:'37', Cost:11.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'40', Cost:11.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 158, MVar:'46', Cost:17.58, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 364,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 364, MVar:'81', Cost:10.52, ParentId: '17'},
		]
	},
