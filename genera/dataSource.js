const timestamp_saved = '10/22/2023 06:50 PM';
const dataFechaAcualizado = '10/22/2023' + ' 2:46:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 434,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'47', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'48', Cost:10.82, ParentId: '7'},
