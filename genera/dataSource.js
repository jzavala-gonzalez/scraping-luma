const timestamp_saved = '11/15/2023 10:25 PM';
const dataFechaAcualizado = '11/15/2023' + ' 6:21:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 435,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 149, MVar:'60', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 149, MVar:'60', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'61', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.86, ParentId: '12'},
