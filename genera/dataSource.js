const timestamp_saved = '08/01/2023 09:50 AM';
const dataFechaAcualizado = '8/1/2023' + ' 5:45:36 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 426,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'42', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'48', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 124, MVar:'0', Cost:18.03, ParentId: '11'},
