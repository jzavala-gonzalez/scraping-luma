const timestamp_saved = '09/13/2023 12:30 PM';
const dataFechaAcualizado = '9/13/2023' + ' 8:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'52', Cost:10.92, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 131, MVar:'51', Cost:10.92, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'66', Cost:10.92, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 153,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 76, MVar:'13', Cost:30.17, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'14', Cost:28.58, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'22', Cost:19.34, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 228,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 228, MVar:'160', Cost:18.28, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 372,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 372, MVar:'100', Cost:9.12, ParentId: '17'},
		]
	},
