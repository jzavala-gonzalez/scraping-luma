const timestamp_saved = '11/10/2023 09:20 PM';
const dataFechaAcualizado = '11/10/2023' + ' 5:16:20 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 141, MVar:'43', Cost:11.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 141, MVar:'37', Cost:11.31, ParentId: '7'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'13', Cost:30.31, ParentId: '13'},
