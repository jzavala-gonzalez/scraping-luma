const timestamp_saved = '09/23/2023 10:40 AM';
const dataFechaAcualizado = '9/23/2023' + ' 6:35:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'36', Cost:13.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'39', Cost:13.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 107, MVar:'54', Cost:13.41, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'8', Cost:19.47, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 136,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 136, MVar:'47', Cost:16.89, ParentId: '15'},
