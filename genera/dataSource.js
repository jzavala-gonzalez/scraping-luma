const timestamp_saved = '11/20/2023 04:50 PM';
const dataFechaAcualizado = '11/20/2023' + ' 12:46:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 319,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 103, MVar:'34', Cost:12.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 103, MVar:'44', Cost:12.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'58', Cost:12.53, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 20,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 20, MVar:'0', Cost:26.49, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 162, MVar:'34', Cost:0, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'9', Cost:30.88, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'180', Cost:18.24, ParentId: '16'},
		]
	},
