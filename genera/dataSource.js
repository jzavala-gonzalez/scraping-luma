const timestamp_saved = '09/10/2023 11:25 AM';
const dataFechaAcualizado = '9/10/2023' + ' 7:20:52 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2703},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 381,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'58', Cost:11.30, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 127, MVar:'57', Cost:11.30, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 128, MVar:'59', Cost:11.30, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'8', Cost:19.27, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'113', Cost:17.82, ParentId: '16'},
		]
	},
