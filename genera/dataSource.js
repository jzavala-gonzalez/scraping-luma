const timestamp_saved = '08/12/2023 03:40 PM';
const dataFechaAcualizado = '8/12/2023' + ' 11:37:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 428,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 229, MVar:'73', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 198, MVar:'85', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'46', Cost:10.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'48', Cost:10.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'46', Cost:10.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'0', Cost:20.44, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 238,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 238, MVar:'141', Cost:18.01, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'99', Cost:11.62, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 82,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 35, MVar:'8', Cost:17, ParentId: '19'},
		]
	},
