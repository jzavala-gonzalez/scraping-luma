const timestamp_saved = '10/21/2023 04:40 PM';
const dataFechaAcualizado = '10/21/2023' + ' 12:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 311,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'39', Cost:12.85, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'35', Cost:12.85, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 113, MVar:'39', Cost:12.85, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 120,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 120, MVar:'75', Cost:17.69, ParentId: '15'},
