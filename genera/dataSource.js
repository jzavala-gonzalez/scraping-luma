const timestamp_saved = '11/09/2023 08:10 AM';
const dataFechaAcualizado = '11/9/2023' + ' 4:06:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 327,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 107, MVar:'37', Cost:12.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 106, MVar:'36', Cost:12.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'42', Cost:12.65, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 74, MVar:'17', Cost:0, ParentId: '8'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:29.56, ParentId: '13'},
