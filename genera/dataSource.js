const timestamp_saved = '09/19/2023 08:50 AM';
const dataFechaAcualizado = '9/19/2023' + ' 4:45:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 350,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'44', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'60', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 373,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 373, MVar:'81', Cost:9.12, ParentId: '17'},
		]
	},
