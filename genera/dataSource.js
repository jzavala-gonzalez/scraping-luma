const timestamp_saved = '08/20/2023 11:45 PM';
const dataFechaAcualizado = '8/20/2023' + ' 7:42:58 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 474,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'65', Cost:10.16, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'28', Cost:10.16, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'62', Cost:10.16, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 32,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 32, MVar:'11', Cost:32.56, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 301,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 301, MVar:'158', Cost:17.39, ParentId: '16'},
		]
	},
