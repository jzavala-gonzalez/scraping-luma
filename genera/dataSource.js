const timestamp_saved = '11/14/2023 04:45 PM';
const dataFechaAcualizado = '11/14/2023' + ' 12:41:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 353,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 117, MVar:'49', Cost:11.78, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'51', Cost:11.78, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'56', Cost:11.78, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'10', Cost:30.76, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'4', Cost:31.54, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'95', Cost:16.96, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 116,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 116, MVar:'154', Cost:24.78, ParentId: '16'},
		]
	},
