const timestamp_saved = '10/13/2023 07:35 AM';
const dataFechaAcualizado = '10/13/2023' + ' 3:31:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 390,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'60', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'65', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 2,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 2, MVar:'0', Cost:33.28, ParentId: '9'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 229,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 229, MVar:'171', Cost:18.24, ParentId: '16'},
		]
	},
