const timestamp_saved = '08/03/2023 03:00 PM';
const dataFechaAcualizado = '8/3/2023' + ' 10:55:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 468,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'49', Cost:10.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'44', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'48', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 296,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'101', Cost:17.07, ParentId: '15'},
