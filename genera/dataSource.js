const timestamp_saved = '08/31/2023 11:55 PM';
const dataFechaAcualizado = '8/31/2023' + ' 7:50:50 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 495,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'56', Cost:10.16, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 130,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'25', Cost:28.04, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'16', Cost:30.93, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 80,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 50, MVar:'10', Cost:28.40, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'46', Cost:19.28, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'111', Cost:9.19, ParentId: '17'},
		]
	},
