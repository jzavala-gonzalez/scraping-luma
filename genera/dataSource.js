const timestamp_saved = '10/19/2023 06:35 AM';
const dataFechaAcualizado = '10/19/2023' + ' 2:31:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 96, MVar:'29', Cost:12.98, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'35', Cost:12.98, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'42', Cost:12.98, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'13', Cost:30.78, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 294,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 294, MVar:'79', Cost:10.90, ParentId: '17'},
		]
	},
