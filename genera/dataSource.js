const timestamp_saved = '11/16/2023 12:05 PM';
const dataFechaAcualizado = '11/16/2023' + ' 8:01:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'48', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'48', Cost:10.87, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 186,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 186, MVar:'69', Cost:10.78, ParentId: '17'},
		]
	},
