const timestamp_saved = '09/23/2023 08:00 AM';
const dataFechaAcualizado = '9/23/2023' + ' 3:55:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 324,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'37', Cost:12.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'40', Cost:12.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'55', Cost:12.40, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 98,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 47, MVar:'1', Cost:31.02, ParentId: '10'},
