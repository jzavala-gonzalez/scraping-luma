const timestamp_saved = '12/01/2023 04:15 AM';
const dataFechaAcualizado = '12/1/2023' + ' 12:11:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'51', Cost:10.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'52', Cost:10.43, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'66', Cost:9.86, ParentId: '17'},
		]
	},
