const timestamp_saved = '12/01/2023 06:10 PM';
const dataFechaAcualizado = '12/1/2023' + ' 2:06:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 147, MVar:'51', Cost:11.09, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'53', Cost:11.09, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'55', Cost:11.09, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'80', Cost:9.57, ParentId: '17'},
		]
	},
