const timestamp_saved = '11/18/2023 04:45 PM';
const dataFechaAcualizado = '11/18/2023' + ' 12:41:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 299,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 150, MVar:'49', Cost:15.45, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 328,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'47', Cost:17.39, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 145,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 145, MVar:'81', Cost:16.56, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'122', Cost:9.43, ParentId: '17'},
		]
	},
