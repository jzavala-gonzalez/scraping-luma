const timestamp_saved = '11/23/2023 06:35 AM';
const dataFechaAcualizado = '11/23/2023' + ' 2:31:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 291,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 92, MVar:'20', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'29', Cost:13.20, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 283,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 45, MVar:'10', Cost:18.16, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 340,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 340, MVar:'45', Cost:9.23, ParentId: '17'},
		]
	},
