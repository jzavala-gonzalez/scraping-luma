const timestamp_saved = '10/19/2023 12:40 AM';
const dataFechaAcualizado = '10/18/2023' + ' 8:36:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 460,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'52', Cost:10.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'57', Cost:10.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'66', Cost:10.38, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 92,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'6', Cost:26.24, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'34', Cost:27.97, ParentId: '10'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 418,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 53, MVar:'10', Cost:17.11, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 159, MVar:'50', Cost:8.11, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'10', Cost:8.11, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 77,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 36, MVar:'11', Cost:29.90, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 75,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 35, MVar:'9', Cost:29.70, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 94, MVar:'22', Cost:18.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 368,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 368, MVar:'118', Cost:10.54, ParentId: '17'},
		]
	},
