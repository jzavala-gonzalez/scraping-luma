const timestamp_saved = '10/28/2023 06:00 PM';
const dataFechaAcualizado = '10/28/2023' + ' 1:56:17 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'46', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'49', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'50', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 136,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 46, MVar:'15', Cost:34.60, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'2', Cost:11.57, ParentId: '17'},
		]
	},
