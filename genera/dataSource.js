const timestamp_saved = '10/29/2023 10:40 PM';
const dataFechaAcualizado = '10/29/2023' + ' 6:36:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 470,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'49', Cost:10.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'50', Cost:10.41, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 369,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 40, MVar:'10', Cost:17.38, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 213,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 213, MVar:'64', Cost:10.30, ParentId: '17'},
		]
	},
