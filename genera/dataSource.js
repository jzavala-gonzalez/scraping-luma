const timestamp_saved = '10/19/2023 09:00 AM';
const dataFechaAcualizado = '10/19/2023' + ' 4:56:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'33', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 155, MVar:'40', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 143, MVar:'43', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'0', Cost:19.72, ParentId: '14'},
