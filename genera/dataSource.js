const timestamp_saved = '09/30/2023 12:10 PM';
const dataFechaAcualizado = '9/30/2023' + ' 8:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 458,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 157, MVar:'32', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 157, MVar:'30', Cost:10.53, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'117', Cost:17.79, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 302,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 302, MVar:'90', Cost:9.41, ParentId: '17'},
		]
	},
