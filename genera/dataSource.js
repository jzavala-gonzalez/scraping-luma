const timestamp_saved = '11/15/2023 12:50 PM';
const dataFechaAcualizado = '11/15/2023' + ' 8:46:21 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'43', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'44', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'46', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 288,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 123, MVar:'37', Cost:17.61, ParentId: '11'},
