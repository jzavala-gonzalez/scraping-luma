const timestamp_saved = '10/09/2023 02:05 PM';
const dataFechaAcualizado = '10/9/2023' + ' 10:01:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 246,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'89', Cost:4.39, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 448,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'50', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'51', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'48', Cost:10.69, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 17,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 17, MVar:'0', Cost:26.96, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 321,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 39, MVar:'9', Cost:17.56, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 120, MVar:'35', Cost:18.20, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:18.20, ParentId: '11'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 34,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:26.96, ParentId: '21'},
