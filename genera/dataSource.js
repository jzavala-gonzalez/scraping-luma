const timestamp_saved = '08/03/2023 11:55 AM';
const dataFechaAcualizado = '8/3/2023' + ' 7:50:37 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 471,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'50', Cost:10.36, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'46', Cost:10.36, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'49', Cost:10.36, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 256,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 256, MVar:'89', Cost:11.41, ParentId: '17'},
		]
	},
