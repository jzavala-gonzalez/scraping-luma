const timestamp_saved = '08/24/2023 06:25 AM';
const dataFechaAcualizado = '8/24/2023' + ' 2:20:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 490,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 166, MVar:'54', Cost:10.14, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 82,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 82, MVar:'18', Cost:19.41, ParentId: '14'},
