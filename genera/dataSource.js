const timestamp_saved = '12/02/2023 07:30 AM';
const dataFechaAcualizado = '12/2/2023' + ' 3:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 347,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 114, MVar:'40', Cost:12.02, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 114, MVar:'41', Cost:12.02, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 119, MVar:'47', Cost:12.02, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 253,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 253, MVar:'54', Cost:9.82, ParentId: '17'},
		]
	},
