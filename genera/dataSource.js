const timestamp_saved = '07/27/2023 09:29 PM';
const dataFechaAcualizado = '7/27/2023' + ' 5:20:32 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'66', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'69', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 391,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'50', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'52', Cost:11.38, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 50,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 26, MVar:'0', Cost:25.29, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'21', Cost:18.68, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'75', Cost:16.89, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 171, MVar:'64', Cost:15.43, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'79', Cost:13.19, ParentId: '17'},
		]
	},
