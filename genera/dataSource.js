const timestamp_saved = '09/28/2023 12:55 AM';
const dataFechaAcualizado = '9/27/2023' + ' 8:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'36', Cost:10.76, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'37', Cost:10.76, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 138, MVar:'65', Cost:10.76, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 360,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'9', Cost:8.31, ParentId: '11'},
