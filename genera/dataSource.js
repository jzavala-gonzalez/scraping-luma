const timestamp_saved = '11/08/2023 12:10 PM';
const dataFechaAcualizado = '11/8/2023' + ' 8:06:19 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 450,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'46', Cost:10.69, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'88', Cost:9.61, ParentId: '17'},
		]
	},
