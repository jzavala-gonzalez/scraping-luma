const timestamp_saved = '08/04/2023 06:00 PM';
const dataFechaAcualizado = '8/4/2023' + ' 1:55:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 429,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 141, MVar:'51', Cost:10.58, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 256,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'85', Cost:18.40, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 320,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 320, MVar:'97', Cost:10.87, ParentId: '17'},
		]
	},
