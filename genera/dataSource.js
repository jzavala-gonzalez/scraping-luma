const timestamp_saved = '11/18/2023 10:15 PM';
const dataFechaAcualizado = '11/18/2023' + ' 6:11:21 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'4', Desc:'Reserva Operacional', value: 102},
	{Index:'5', Desc:'Capacidad Disponible', value: 2663},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 340,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'52', Cost:14.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 171, MVar:'62', Cost:14.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 1, MVar:'3', Cost:14.38, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 90,
		units:[
			...
			{Index:'6', Unit:'Aguirre', MW: 0, MVar:'0', Cost:47.92, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 171,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'7', Cost:27.80, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 78,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'21', Cost:28.02, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 79,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 41, MVar:'2', Cost:29.28, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 45, MVar:'0', Cost:28.54, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 131,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'23', Cost:18.70, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 161,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 161, MVar:'86', Cost:16.29, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 38,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 38, MVar:'109', Cost:47.92, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'133', Cost:9.13, ParentId: '17'},
		]
	},
