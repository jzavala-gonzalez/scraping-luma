const timestamp_saved = '09/05/2023 05:35 AM';
const dataFechaAcualizado = '9/5/2023' + ' 1:30:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 386,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'35', Cost:11.21, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'39', Cost:11.21, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'51', Cost:11.21, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 27,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 25, MVar:'3', Cost:25.81, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.82, ParentId: '12'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'67', Cost:9.17, ParentId: '17'},
		]
	},
