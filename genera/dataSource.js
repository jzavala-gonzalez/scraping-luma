const timestamp_saved = '08/11/2023 05:20 AM';
const dataFechaAcualizado = '8/11/2023' + ' 1:15:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'48', Cost:10.73, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'52', Cost:10.73, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 96,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 96, MVar:'0', Cost:3.26, ParentId: '8'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'0', Cost:30.99, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 60,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 30, MVar:'0', Cost:31.00, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'114', Cost:11.27, ParentId: '17'},
		]
	},
