const timestamp_saved = '09/03/2023 03:20 PM';
const dataFechaAcualizado = '9/3/2023' + ' 11:15:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 453,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 154, MVar:'35', Cost:10.55, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 154, MVar:'40', Cost:10.55, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 145, MVar:'53', Cost:10.55, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 408,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'48', Cost:19.72, ParentId: '11'},
