const timestamp_saved = '09/20/2023 06:55 AM';
const dataFechaAcualizado = '9/20/2023' + ' 2:50:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 121,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 121, MVar:'44', Cost:17.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 202,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 202, MVar:'133', Cost:18.35, ParentId: '16'},
		]
	},
