const timestamp_saved = '11/18/2023 05:55 AM';
const dataFechaAcualizado = '11/18/2023' + ' 1:51:21 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'5', Desc:'Capacidad Disponible', value: 2361},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 0, MVar:'0', Cost:23.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'74', Cost:23.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:23.60, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 91,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 19, MVar:'0', Cost:32.15, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 79,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 79, MVar:'17', Cost:27.87, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 331,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'49', Cost:17.11, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 35,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 35, MVar:'4', Cost:65.10, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 64,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 34, MVar:'9', Cost:32.55, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'79', Cost:16.62, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'132', Cost:9.11, ParentId: '17'},
		]
	},
