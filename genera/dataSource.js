const timestamp_saved = '12/05/2023 10:25 AM';
const dataFechaAcualizado = '12/5/2023' + ' 6:21:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 498,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 155, MVar:'57', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 305,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 305, MVar:'72', Cost:11.20, ParentId: '17'},
		]
	},
