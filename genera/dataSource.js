const timestamp_saved = '10/21/2023 02:40 PM';
const dataFechaAcualizado = '10/21/2023' + ' 10:36:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 349,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 113, MVar:'37', Cost:11.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'36', Cost:11.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 124, MVar:'37', Cost:11.68, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 275,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 275, MVar:'69', Cost:11.06, ParentId: '17'},
		]
	},
