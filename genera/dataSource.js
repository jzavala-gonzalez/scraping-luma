const timestamp_saved = '09/29/2023 01:15 PM';
const dataFechaAcualizado = '9/29/2023' + ' 9:10:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'36', Cost:11.39, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'33', Cost:11.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'49', Cost:11.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 135, MVar:'41', Cost:17.98, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 38,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 38, MVar:'16', Cost:23.42, ParentId: '14'},
