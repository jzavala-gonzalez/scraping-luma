const timestamp_saved = '07/31/2023 04:25 PM';
const dataFechaAcualizado = '7/31/2023' + ' 12:20:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 456,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'51', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'48', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 151, MVar:'50', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 392,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'10', Cost:17.35, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 261,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 261, MVar:'99', Cost:11.41, ParentId: '17'},
		]
	},
