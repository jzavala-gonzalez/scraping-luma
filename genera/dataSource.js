const timestamp_saved = '07/26/2023 03:56 AM';
const dataFechaAcualizado = '7/25/2023' + ' 11:50:31 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 465,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'69', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 465,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 175, MVar:'44', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 140, MVar:'54', Cost:10.31, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'50', Cost:10.31, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 92,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 92, MVar:'11', Cost:18.67, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 170, MVar:'62', Cost:15.42, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 317,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 317, MVar:'76', Cost:9.34, ParentId: '17'},
		]
	},
