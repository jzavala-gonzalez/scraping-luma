const timestamp_saved = '09/06/2023 02:40 PM';
const dataFechaAcualizado = '9/6/2023' + ' 10:35:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 202,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 106, MVar:'58', Cost:19.68, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'34', Cost:19.68, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 0, MVar:'3', Cost:19.68, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 71, MVar:'25', Cost:19.09, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'96', Cost:17.11, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'144', Cost:17.19, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 354,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 354, MVar:'91', Cost:9.20, ParentId: '17'},
		]
	},
