const timestamp_saved = '10/18/2023 02:50 PM';
const dataFechaAcualizado = '10/18/2023' + ' 10:46:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 234,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 234, MVar:'69', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 388,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 127, MVar:'45', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 126, MVar:'50', Cost:11.06, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'62', Cost:11.06, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'76', Cost:23.26, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 357,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 357, MVar:'104', Cost:10.55, ParentId: '17'},
		]
	},
