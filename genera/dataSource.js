const timestamp_saved = '08/08/2023 07:25 AM';
const dataFechaAcualizado = '8/8/2023' + ' 3:20:41 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 407,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'39', Cost:11.06, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 102, MVar:'48', Cost:11.06, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 377,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 125, MVar:'38', Cost:20.53, ParentId: '11'},
