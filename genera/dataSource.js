const timestamp_saved = '10/12/2023 05:10 PM';
const dataFechaAcualizado = '10/12/2023' + ' 1:06:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'59', Cost:10.87, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'66', Cost:10.87, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 135, MVar:'68', Cost:10.87, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 51,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 51, MVar:'26', Cost:31.15, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 410,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 155, MVar:'46', Cost:16.83, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 281, MVar:'189', Cost:17.35, ParentId: '16'},
		]
	},
