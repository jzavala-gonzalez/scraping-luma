const timestamp_saved = '10/04/2023 08:41 AM';
const dataFechaAcualizado = '10/4/2023' + ' 4:35:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 445,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 152, MVar:'34', Cost:10.63, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 152, MVar:'32', Cost:10.63, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 306,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 306, MVar:'92', Cost:9.40, ParentId: '17'},
		]
	},
