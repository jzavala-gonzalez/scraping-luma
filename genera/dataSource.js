const timestamp_saved = '10/27/2023 04:55 AM';
const dataFechaAcualizado = '10/27/2023' + ' 12:51:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 427,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'43', Cost:10.86, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 37,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 37, MVar:'15', Cost:30.84, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 231,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 231, MVar:'111', Cost:18.18, ParentId: '16'},
		]
	},
