const timestamp_saved = '10/29/2023 07:45 AM';
const dataFechaAcualizado = '10/29/2023' + ' 3:41:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 130, MVar:'61', Cost:11.27, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 289,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'28', Cost:18.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'9', Cost:18.28, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 121,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 50, MVar:'16', Cost:21.47, ParentId: '14'},
