const timestamp_saved = '08/15/2023 03:00 PM';
const dataFechaAcualizado = '8/15/2023' + ' 10:57:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'98', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'55', Cost:10.69, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'51', Cost:10.69, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'53', Cost:10.69, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 61,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:30.63, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'0', Cost:30.04, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 53,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 53, MVar:'30', Cost:21.21, ParentId: '14'},
