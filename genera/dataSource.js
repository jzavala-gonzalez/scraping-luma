const timestamp_saved = '09/20/2023 03:55 AM';
const dataFechaAcualizado = '9/19/2023' + ' 11:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 443,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 189, MVar:'76', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 352,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 115, MVar:'43', Cost:12.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 115, MVar:'47', Cost:12.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'61', Cost:12.11, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 71,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 1, MVar:'1', Cost:22.82, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 44, MVar:'10', Cost:8.26, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'52', Cost:16.95, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 370,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 370, MVar:'75', Cost:9.12, ParentId: '17'},
		]
	},
