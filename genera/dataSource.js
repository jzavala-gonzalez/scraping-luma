const timestamp_saved = '08/17/2023 09:05 AM';
const dataFechaAcualizado = '8/17/2023' + ' 5:02:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'43', Cost:10.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 147, MVar:'59', Cost:10.12, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 89,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 89, MVar:'11', Cost:18.69, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 204,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 204, MVar:'64', Cost:10.52, ParentId: '17'},
		]
	},
