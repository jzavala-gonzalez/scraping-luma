const timestamp_saved = '09/18/2023 09:05 AM';
const dataFechaAcualizado = '9/18/2023' + ' 5:00:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'41', Cost:10.82, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'40', Cost:10.82, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'56', Cost:10.82, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 76,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 137, MVar:'47', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 420,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'8', Cost:8.22, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'64', Cost:9.80, ParentId: '17'},
		]
	},
