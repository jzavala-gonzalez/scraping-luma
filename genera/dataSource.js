const timestamp_saved = '11/24/2023 04:50 AM';
const dataFechaAcualizado = '11/24/2023' + ' 12:46:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 404,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'26', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 136, MVar:'35', Cost:11.01, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 279,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 279, MVar:'83', Cost:9.22, ParentId: '17'},
		]
	},
