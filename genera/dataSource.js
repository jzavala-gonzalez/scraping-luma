const timestamp_saved = '09/28/2023 06:50 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:45:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 105, MVar:'19', Cost:12.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'18', Cost:12.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 116, MVar:'44', Cost:12.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'102', Cost:18.47, ParentId: '16'},
		]
	},
