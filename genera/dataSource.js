const timestamp_saved = '11/28/2023 04:00 AM';
const dataFechaAcualizado = '11/27/2023' + ' 11:56:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 436,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'30', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.88, ParentId: '7'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 13,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 13, MVar:'8', Cost:35.30, ParentId: '10'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 248,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 248, MVar:'83', Cost:9.80, ParentId: '17'},
		]
	},
