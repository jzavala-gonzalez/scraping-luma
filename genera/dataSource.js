const timestamp_saved = '09/03/2023 08:00 PM';
const dataFechaAcualizado = '9/3/2023' + ' 3:55:51 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'39', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 169, MVar:'43', Cost:10.15, ParentId: '7'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 18,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 18, MVar:'8', Cost:308.17, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'86', Cost:16.89, ParentId: '15'},
