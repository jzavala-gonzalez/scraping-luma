const timestamp_saved = '08/01/2023 02:15 AM';
const dataFechaAcualizado = '7/31/2023' + ' 10:10:35 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'46', Cost:10.52, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 289,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 289, MVar:'150', Cost:17.25, ParentId: '16'},
		]
	},
