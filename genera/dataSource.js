const timestamp_saved = '10/09/2023 08:15 AM';
const dataFechaAcualizado = '10/9/2023' + ' 4:11:14 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 417,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 142, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 142, MVar:'43', Cost:11.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'43', Cost:11.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 319,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 38, MVar:'8', Cost:17.44, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 248,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 248, MVar:'131', Cost:17.82, ParentId: '16'},
		]
	},
