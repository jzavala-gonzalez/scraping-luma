const timestamp_saved = '11/24/2023 06:20 PM';
const dataFechaAcualizado = '11/24/2023' + ' 2:16:22 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 444,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'31', Cost:10.65, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'40', Cost:10.65, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'54', Cost:10.65, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 247,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 247, MVar:'83', Cost:9.87, ParentId: '17'},
		]
	},
