const timestamp_saved = '12/06/2023 04:55 PM';
const dataFechaAcualizado = '12/6/2023' + ' 12:50:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 909},
	{Index:'7', Desc:'Capacidad Disponible', value: 3020},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 329,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 107, MVar:'51', Cost:12.47, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 140,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 69, MVar:'26', Cost:19.77, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'68', Cost:14.58, ParentId: '17'},
		]
	},
