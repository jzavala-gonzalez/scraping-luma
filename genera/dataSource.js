const timestamp_saved = '08/24/2023 02:30 PM';
const dataFechaAcualizado = '8/24/2023' + ' 10:25:45 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 431,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 231, MVar:'73', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 199, MVar:'89', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'58', Cost:10.88, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 117, MVar:'57', Cost:10.88, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 96,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'6', Cost:27.24, ParentId: '9'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 79,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 79, MVar:'28', Cost:18.64, ParentId: '14'},
