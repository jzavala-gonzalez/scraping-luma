const timestamp_saved = '12/05/2023 10:55 PM';
const dataFechaAcualizado = '12/5/2023' + ' 6:50:17 PM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Reserva Operacional', value: 540},
	{Index:'7', Desc:'Capacidad Disponible', value: 3119},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'63', Cost:10.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'65', Cost:10.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'67', Cost:10.24, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 48,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 48, MVar:'0', Cost:10.59, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 24,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'6', Cost:26.55, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 23,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'20', Cost:43.85, ParentId: '10'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 157,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 74, MVar:'24', Cost:19.53, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 367,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 367, MVar:'105', Cost:10.85, ParentId: '17'},
		]
	},
