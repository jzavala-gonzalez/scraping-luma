const timestamp_saved = '12/02/2023 10:30 AM';
const dataFechaAcualizado = '12/2/2023' + ' 6:26:24 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 367,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 122, MVar:'43', Cost:11.56, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 122, MVar:'45', Cost:11.56, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'44', Cost:11.56, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'58', Cost:9.81, ParentId: '17'},
		]
	},
