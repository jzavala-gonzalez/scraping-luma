const timestamp_saved = '10/14/2023 02:40 AM';
const dataFechaAcualizado = '10/13/2023' + ' 10:36:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 473,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'64', Cost:10.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'70', Cost:10.20, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'72', Cost:10.20, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'12', Cost:28.78, ParentId: '10'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 365,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 365, MVar:'169', Cost:16.62, ParentId: '16'},
		]
	},
