const timestamp_saved = '12/02/2023 04:20 PM';
const dataFechaAcualizado = '12/2/2023' + ' 12:16:24 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 178,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 178, MVar:'74', Cost:4.42, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.42, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 98, MVar:'43', Cost:12.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'45', Cost:12.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 111, MVar:'44', Cost:12.83, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'31', Cost:19.04, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 231,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 231, MVar:'66', Cost:11.93, ParentId: '17'},
		]
	},
