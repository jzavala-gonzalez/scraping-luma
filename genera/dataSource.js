const timestamp_saved = '07/31/2023 11:00 AM';
const dataFechaAcualizado = '7/31/2023' + ' 6:55:35 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 476,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:10.28, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'47', Cost:10.28, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'50', Cost:10.28, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 0,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 160, MVar:'20', Cost:0, ParentId: '8'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 359,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 122, MVar:'38', Cost:19.80, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 331,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 165, MVar:'54', Cost:15.45, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 255,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 255, MVar:'91', Cost:11.38, ParentId: '17'},
		]
	},
