const timestamp_saved = '10/03/2023 09:25 AM';
const dataFechaAcualizado = '10/3/2023' + ' 5:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 161, MVar:'39', Cost:10.31, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 161, MVar:'35', Cost:10.31, ParentId: '7'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 8,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 8, MVar:'1', Cost:101.96, ParentId: '9'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 320,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 110, MVar:'34', Cost:23.74, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 282,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 282, MVar:'97', Cost:9.58, ParentId: '17'},
		]
	},
