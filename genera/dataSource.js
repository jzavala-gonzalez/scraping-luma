const timestamp_saved = '10/18/2023 04:30 PM';
const dataFechaAcualizado = '10/18/2023' + ' 12:26:16 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 424,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 144, MVar:'50', Cost:10.89, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 144, MVar:'55', Cost:10.89, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'65', Cost:10.89, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 368,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 120, MVar:'35', Cost:17.13, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'8', Cost:17.13, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 50,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 50, MVar:'75', Cost:23.26, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'180', Cost:17.36, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 355,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 355, MVar:'110', Cost:10.56, ParentId: '17'},
		]
	},
