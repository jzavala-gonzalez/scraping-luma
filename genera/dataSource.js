const timestamp_saved = '09/09/2023 04:10 AM';
const dataFechaAcualizado = '9/9/2023' + ' 12:05:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 446,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 151, MVar:'62', Cost:10.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 150, MVar:'67', Cost:10.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'60', Cost:10.47, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'2', Cost:25.98, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 157,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 78, MVar:'24', Cost:27.88, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 78, MVar:'23', Cost:28.00, ParentId: '10'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 70,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'16', Cost:19.11, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 168,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 168, MVar:'78', Cost:16.62, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 367,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 367, MVar:'165', Cost:16.66, ParentId: '16'},
		]
	},
