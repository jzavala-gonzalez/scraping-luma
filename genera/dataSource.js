const timestamp_saved = '09/17/2023 01:35 PM';
const dataFechaAcualizado = '9/17/2023' + ' 9:30:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 434,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 181, MVar:'65', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 351,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 116, MVar:'42', Cost:12.14, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 116, MVar:'41', Cost:12.14, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'59', Cost:12.14, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 400,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'7', Cost:19.81, ParentId: '11'},
