const timestamp_saved = '08/19/2023 04:55 AM';
const dataFechaAcualizado = '8/19/2023' + ' 12:52:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'46', Cost:10.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 125, MVar:'60', Cost:10.72, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'70', Cost:10.72, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 100,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 50, MVar:'6', Cost:31.11, ParentId: '10'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 61,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.11, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 5,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 5, MVar:'14', Cost:38.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'64', Cost:16.55, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 294,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 294, MVar:'164', Cost:17.20, ParentId: '16'},
		]
	},
