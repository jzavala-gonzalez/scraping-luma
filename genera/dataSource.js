const timestamp_saved = '10/12/2023 12:35 AM';
const dataFechaAcualizado = '10/11/2023' + ' 8:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 567,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 176, MVar:'76', Cost:9.71, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'80', Cost:9.71, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 216, MVar:'79', Cost:9.71, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 72,
		units:[
			...
			{Index:'4', Unit:'Daguao', MW: 16, MVar:'0', Cost:35.05, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 196,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'8', Cost:22.06, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'0', Cost:21.94, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 45, MVar:'10', Cost:22.48, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 145, MVar:'44', Cost:18.09, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 47, MVar:'8', Cost:18.09, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 161, MVar:'47', Cost:16.93, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'17', Cost:19.44, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 142,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 142, MVar:'92', Cost:16.73, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 372,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 372, MVar:'224', Cost:16.63, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 352,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 352, MVar:'116', Cost:9.19, ParentId: '17'},
		]
	},
