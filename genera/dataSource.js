const timestamp_saved = '11/06/2023 11:00 PM';
const dataFechaAcualizado = '11/6/2023' + ' 6:56:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 452,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 156, MVar:'59', Cost:10.66, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'58', Cost:10.66, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 225,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 225, MVar:'177', Cost:18.29, ParentId: '16'},
		]
	},
