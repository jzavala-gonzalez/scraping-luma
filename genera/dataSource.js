const timestamp_saved = '09/15/2023 09:25 AM';
const dataFechaAcualizado = '9/15/2023' + ' 5:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 454,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 254, MVar:'46', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 200, MVar:'67', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 510,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 174, MVar:'52', Cost:10.03, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 176, MVar:'49', Cost:10.03, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 161, MVar:'63', Cost:10.03, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 342,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 96, MVar:'0', Cost:9.58, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 35, MVar:'8', Cost:9.58, ParentId: '11'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 166,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 166, MVar:'83', Cost:16.51, ParentId: '15'},
