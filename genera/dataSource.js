const timestamp_saved = '10/15/2023 12:15 AM';
const dataFechaAcualizado = '10/14/2023' + ' 8:11:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 449,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 153, MVar:'63', Cost:10.54, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 153, MVar:'64', Cost:10.54, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 142, MVar:'63', Cost:10.54, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 52,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'14', Cost:30.64, ParentId: '10'},
