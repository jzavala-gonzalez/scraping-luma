const timestamp_saved = '09/13/2023 06:00 PM';
const dataFechaAcualizado = '9/13/2023' + ' 1:55:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 146, MVar:'58', Cost:10.83, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 146, MVar:'55', Cost:10.83, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'68', Cost:10.83, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 68,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 68, MVar:'0', Cost:6.77, ParentId: '8'},
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 144, MVar:'69', Cost:0, ParentId: '8'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 73, MVar:'15', Cost:28.33, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'43', Cost:19.89, ParentId: '11'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 369,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 369, MVar:'104', Cost:9.11, ParentId: '17'},
		]
	},
