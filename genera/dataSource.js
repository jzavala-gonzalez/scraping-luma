const timestamp_saved = '11/06/2023 04:05 PM';
const dataFechaAcualizado = '11/6/2023' + ' 12:01:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 499,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'58', Cost:10.35, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 153, MVar:'53', Cost:10.35, ParentId: '7'},
		]
	},
