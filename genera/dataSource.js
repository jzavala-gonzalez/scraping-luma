const timestamp_saved = '11/04/2023 01:50 AM';
const dataFechaAcualizado = '11/3/2023' + ' 9:46:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 469,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 147, MVar:'51', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 149,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 149, MVar:'77', Cost:16.90, ParentId: '15'},
