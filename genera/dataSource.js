const timestamp_saved = '10/29/2023 07:35 AM';
const dataFechaAcualizado = '10/29/2023' + ' 3:31:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 133, MVar:'33', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 133, MVar:'36', Cost:11.23, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 290,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 90, MVar:'27', Cost:18.29, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 37, MVar:'6', Cost:18.29, ParentId: '11'},
