const timestamp_saved = '10/01/2023 12:00 PM';
const dataFechaAcualizado = '10/1/2023' + ' 7:55:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 305,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 253, MVar:'59', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 53, MVar:'54', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'25', Cost:11.47, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'23', Cost:11.47, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'42', Cost:11.47, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 159, MVar:'47', Cost:17.65, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 250,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 250, MVar:'103', Cost:17.80, ParentId: '16'},
		]
	},
