const timestamp_saved = '08/17/2023 07:30 PM';
const dataFechaAcualizado = '8/17/2023' + ' 3:27:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 394,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 91, MVar:'66', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 134, MVar:'76', Cost:11.18, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 166,
		units:[
			...
			{Index:'3', Unit:'Jobos', MW: 18, MVar:'0', Cost:30.79, ParentId: '8'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 279,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 279, MVar:'162', Cost:17.39, ParentId: '16'},
		]
	},
