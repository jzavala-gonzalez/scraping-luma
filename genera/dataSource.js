const timestamp_saved = '07/30/2023 09:40 PM';
const dataFechaAcualizado = '7/30/2023' + ' 5:35:34 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 475,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 170, MVar:'53', Cost:10.40, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 156, MVar:'55', Cost:10.40, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 150, MVar:'46', Cost:10.40, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 37,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 7, MVar:'5', Cost:178.79, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 33,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 3, MVar:'5', Cost:0, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 73,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 73, MVar:'24', Cost:19.15, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 300,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 140, MVar:'95', Cost:17.08, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 338,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 338, MVar:'131', Cost:16.81, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 254,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 254, MVar:'83', Cost:11.41, ParentId: '17'},
		]
	},
