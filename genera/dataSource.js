const timestamp_saved = '10/15/2023 01:50 PM';
const dataFechaAcualizado = '10/15/2023' + ' 9:46:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'53', Cost:11.23, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'52', Cost:11.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'52', Cost:11.23, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 288,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 288, MVar:'63', Cost:9.50, ParentId: '17'},
		]
	},
