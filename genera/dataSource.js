const timestamp_saved = '08/11/2023 09:55 AM';
const dataFechaAcualizado = '8/11/2023' + ' 5:50:43 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 403,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'22', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 92, MVar:'48', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 139, MVar:'48', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 32,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 32, MVar:'4', Cost:31.99, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 63,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 33, MVar:'6', Cost:31.90, ParentId: '13'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'89', Cost:11.91, ParentId: '17'},
		]
	},
