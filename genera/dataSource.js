const timestamp_saved = '10/13/2023 12:00 PM';
const dataFechaAcualizado = '10/13/2023' + ' 7:56:15 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 432,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 148, MVar:'60', Cost:10.95, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 148, MVar:'64', Cost:10.95, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 346,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 346, MVar:'74', Cost:9.12, ParentId: '17'},
		]
	},
