const timestamp_saved = '08/23/2023 07:40 PM';
const dataFechaAcualizado = '8/23/2023' + ' 3:35:41 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'56', Cost:11.01, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'55', Cost:11.01, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'55', Cost:11.01, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 107,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 34, MVar:'4', Cost:25.60, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 401,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 151, MVar:'44', Cost:19.61, ParentId: '11'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 5,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 5, MVar:'7', Cost:0, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'30', Cost:19.62, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'87', Cost:16.83, ParentId: '15'},
