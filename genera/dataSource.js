const timestamp_saved = '10/12/2023 11:10 PM';
const dataFechaAcualizado = '10/12/2023' + ' 7:06:15 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 172, MVar:'83', Cost:9.75, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'82', Cost:9.75, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 158,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 12, MVar:'9', Cost:133.69, ParentId: '9'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 101,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 51, MVar:'14', Cost:28.62, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 148,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 148, MVar:'97', Cost:16.65, ParentId: '15'},
