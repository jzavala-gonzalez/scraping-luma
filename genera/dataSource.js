const timestamp_saved = '07/29/2023 01:05 AM';
const dataFechaAcualizado = '7/28/2023' + ' 9:00:33 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 425,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'49', Cost:11.00, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'50', Cost:11.00, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'48', Cost:11.00, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 201,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'2', Cost:21.98, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 53, MVar:'0', Cost:21.96, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 46, MVar:'4', Cost:22.33, ParentId: '9'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 62,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 31, MVar:'9', Cost:31.15, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 38,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 8, MVar:'1', Cost:81.32, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 96,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 96, MVar:'16', Cost:18.66, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 321,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 160, MVar:'92', Cost:16.71, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 161, MVar:'27', Cost:15.53, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 262,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 262, MVar:'87', Cost:13.86, ParentId: '17'},
		]
	},
