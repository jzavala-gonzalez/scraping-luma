const timestamp_saved = '09/24/2023 06:10 PM';
const dataFechaAcualizado = '9/24/2023' + ' 2:05:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 416,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 139, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 139, MVar:'48', Cost:11.07, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 137, MVar:'56', Cost:11.07, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 46,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 46, MVar:'0', Cost:10.02, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 93,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 22, MVar:'0', Cost:26.89, ParentId: '9'},
		]
	},
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 77, MVar:'6', Cost:28.07, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'90', Cost:16.89, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 365,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 365, MVar:'96', Cost:9.13, ParentId: '17'},
		]
	},
