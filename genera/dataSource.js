const timestamp_saved = '09/24/2023 06:55 PM';
const dataFechaAcualizado = '9/24/2023' + ' 2:50:55 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 430,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 145, MVar:'48', Cost:10.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 145, MVar:'51', Cost:10.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 140, MVar:'58', Cost:10.84, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 122,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 22, MVar:'0', Cost:27.14, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:22.15, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Gas 3', MW: 75, MVar:'6', Cost:28.79, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 152, MVar:'45', Cost:20.07, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 51, MVar:'12', Cost:20.07, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'3', Cost:40.90, ParentId: '12'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'94', Cost:17.19, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'97', Cost:9.15, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 48,
		units:[
			...
			{Index:'5', Unit:'Fonroche', MW: 27, MVar:'18', Cost:17, ParentId: '19'},
		]
	},
