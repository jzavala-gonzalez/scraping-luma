const timestamp_saved = '10/30/2023 10:20 PM';
const dataFechaAcualizado = '10/30/2023' + ' 6:16:18 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 158, MVar:'66', Cost:10.23, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'68', Cost:10.23, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 59,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 66, MVar:'19', Cost:30.98, ParentId: '10'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 66,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 46, MVar:'7', Cost:30.94, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 124,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 70, MVar:'35', Cost:19.38, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 150,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 150, MVar:'93', Cost:16.81, ParentId: '15'},
