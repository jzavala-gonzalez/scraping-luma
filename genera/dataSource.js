const timestamp_saved = '10/08/2023 06:30 PM';
const dataFechaAcualizado = '10/8/2023' + ' 2:26:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 494,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 167, MVar:'46', Cost:10.15, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'46', Cost:10.15, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 158, MVar:'45', Cost:10.15, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 170,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'93', Cost:16.57, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 233,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 233, MVar:'154', Cost:18.23, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 229,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 229, MVar:'88', Cost:10.15, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 84,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 24, MVar:'26', Cost:19.60, ParentId: '19'},
