const timestamp_saved = '11/23/2023 01:55 PM';
const dataFechaAcualizado = '11/23/2023' + ' 9:51:22 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 210,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 210, MVar:'74', Cost:4.41, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.41, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 303,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'20', Cost:13.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'30', Cost:13.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 110, MVar:'47', Cost:13.13, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 257,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 257, MVar:'67', Cost:9.75, ParentId: '17'},
		]
	},
