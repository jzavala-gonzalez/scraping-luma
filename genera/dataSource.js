const timestamp_saved = '10/06/2023 11:35 PM';
const dataFechaAcualizado = '10/6/2023' + ' 7:31:14 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 560,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'61', Cost:9.74, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 174, MVar:'63', Cost:9.74, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 215, MVar:'61', Cost:9.74, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 137,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 65, MVar:'0', Cost:15.00, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 192,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 51, MVar:'9', Cost:22.01, ParentId: '9'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 414,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'47', Cost:16.87, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 49, MVar:'10', Cost:16.87, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 158, MVar:'46', Cost:8.10, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 51, MVar:'9', Cost:8.10, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 30,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 30, MVar:'11', Cost:31.01, ParentId: '12'},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 90,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 40, MVar:'12', Cost:28.77, ParentId: '13'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 72,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 72, MVar:'12', Cost:19.28, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'84', Cost:16.96, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 332,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 332, MVar:'130', Cost:9.28, ParentId: '17'},
		]
	},
