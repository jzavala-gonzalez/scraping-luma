const timestamp_saved = '08/30/2023 08:40 AM';
const dataFechaAcualizado = '8/30/2023' + ' 4:35:50 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 395,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 132, MVar:'43', Cost:11.24, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 132, MVar:'44', Cost:11.24, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 132, MVar:'56', Cost:11.24, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 76,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'20', Cost:19.06, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 156,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 156, MVar:'63', Cost:16.75, ParentId: '15'},
