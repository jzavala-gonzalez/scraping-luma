const timestamp_saved = '09/16/2023 06:25 PM';
const dataFechaAcualizado = '9/16/2023' + ' 2:20:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 479,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 164, MVar:'48', Cost:10.26, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 164, MVar:'47', Cost:10.26, ParentId: '7'},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 376,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 42, MVar:'8', Cost:8.18, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 68,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 68, MVar:'27', Cost:19.08, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 94,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 94, MVar:'78', Cost:19.49, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'115', Cost:17.09, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 295,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 295, MVar:'88', Cost:9.47, ParentId: '17'},
		]
	},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 87,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 36, MVar:'2', Cost:19.60, ParentId: '19'},
