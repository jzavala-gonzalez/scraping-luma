const timestamp_saved = '10/01/2023 07:10 AM';
const dataFechaAcualizado = '10/1/2023' + ' 3:05:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 457,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 204, MVar:'61', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 308,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'28', Cost:12.97, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'26', Cost:12.97, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 114, MVar:'45', Cost:12.97, ParentId: '7'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'91', Cost:9.49, ParentId: '17'},
		]
	},
