const timestamp_saved = '08/20/2023 12:00 PM';
const dataFechaAcualizado = '8/20/2023' + ' 7:57:57 AM';
const dataFuelCost = [
...
const dataMetrics = [
	...
	{Index:'6', Desc:'Próxima Hora MW', value: 1973},
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 397,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'48', Cost:11.05, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 93, MVar:'46', Cost:11.05, ParentId: '7'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 299,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 299, MVar:'55', Cost:9.45, ParentId: '17'},
		]
	},
