const timestamp_saved = '10/01/2023 12:25 PM';
const dataFechaAcualizado = '10/1/2023' + ' 8:20:56 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 301,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 252, MVar:'60', Cost:4.35, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 47, MVar:'56', Cost:4.35, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 389,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 129, MVar:'25', Cost:11.38, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 129, MVar:'24', Cost:11.38, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 131, MVar:'42', Cost:11.38, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 251,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 251, MVar:'105', Cost:17.78, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 291,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 291, MVar:'81', Cost:9.49, ParentId: '17'},
		]
	},
