const timestamp_saved = '10/09/2023 09:55 PM';
const dataFechaAcualizado = '10/9/2023' + ' 5:51:14 PM';
const dataFuelCost = [
...
const dataMetrics = [
	{Index:'0', Desc:'Total de Generación', value: 2941},
	{Index:'1', Desc:'PREPA', value: 70},
	{Index:'2', Desc:'COGEN', value: 30},
	{Index:'3', Desc:'Reserva en Rotación', value: 167},
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 245,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 245, MVar:'97', Cost:4.37, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 0, MVar:'0', Cost:4.37, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 525,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'66', Cost:10.04, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 173, MVar:'66', Cost:10.04, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 182, MVar:'58', Cost:10.04, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 90,
		units:[
			{Index:'0', Unit:'Palo Seco', MW: 36, MVar:'0', Cost:25.79, ParentId: '8'},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 118,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 24, MVar:'2', Cost:19.63, ParentId: '9'},
			{Index:'1', Unit:'Gas 2', MW: 23, MVar:'0', Cost:26.67, ParentId: '9'},
			{Index:'2', Unit:'Gas 3', MW: 21, MVar:'4', Cost:27.17, ParentId: '9'},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 77,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 77, MVar:'32', Cost:28.01, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 0, MVar:'0', Cost:0, ParentId: '10'},
		]
	},
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 412,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 157, MVar:'48', Cost:16.99, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:16.99, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 157, MVar:'49', Cost:16.92, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 50, MVar:'10', Cost:16.92, ParentId: '11'},
		]
	},
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 50,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 50, MVar:'12', Cost:28.33, ParentId: '12'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'18', Cost:19.64, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 155,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'102', Cost:17.35, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 358,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 358, MVar:'198', Cost:16.68, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 366,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 366, MVar:'111', Cost:9.14, ParentId: '17'},
		]
	},
	...
	{Index:'21', Type:'Turbina de Gas', Desc:'Palo Seco', SiteTotal: 71,
		units:[
			...
			{Index:'3', Unit:'GT1', MW: 17, MVar:'0', Cost:26.21, ParentId: '21'},
			{Index:'4', Unit:'GT2', MW: 0, MVar:'0', Cost:25.40, ParentId: '21'},
