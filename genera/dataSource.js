const timestamp_saved = '08/04/2023 01:50 PM';
const dataFechaAcualizado = '8/4/2023' + ' 9:45:38 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 453,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 205, MVar:'78', Cost:4.39, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 440,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 173, MVar:'47', Cost:10.45, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 121, MVar:'42', Cost:10.45, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'47', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 260,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 110, MVar:'87', Cost:17.98, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'39', Cost:15.70, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 259,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 259, MVar:'148', Cost:17.70, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 309,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 309, MVar:'89', Cost:11.00, ParentId: '17'},
		]
	},
