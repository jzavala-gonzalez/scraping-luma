const timestamp_saved = '09/28/2023 06:25 AM';
const dataFechaAcualizado = '9/28/2023' + ' 2:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 372,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 123, MVar:'20', Cost:11.43, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 123, MVar:'20', Cost:11.43, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 126, MVar:'45', Cost:11.43, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 327,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 42, MVar:'7', Cost:17.93, ParentId: '11'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 177,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 177, MVar:'101', Cost:20.32, ParentId: '16'},
		]
	},
