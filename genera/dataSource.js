const timestamp_saved = '11/26/2023 02:20 AM';
const dataFechaAcualizado = '11/25/2023' + ' 10:16:23 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'29', Cost:11.41, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'40', Cost:11.41, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 127, MVar:'54', Cost:11.41, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 356,
		units:[
			...
			{Index:'2', Unit:'CTG 6', MW: 116, MVar:'37', Cost:18.46, ParentId: '11'},
			{Index:'3', Unit:'STG 6', MW: 40, MVar:'8', Cost:18.46, ParentId: '11'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 141,
		units:[
			{Index:'0', Unit:'Unit 7', MW: 70, MVar:'10', Cost:19.68, ParentId: '14'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 239,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 239, MVar:'126', Cost:17.62, ParentId: '16'},
		]
	},
