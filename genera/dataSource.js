const timestamp_saved = '11/10/2023 02:30 PM';
const dataFechaAcualizado = '11/10/2023' + ' 10:26:20 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 361,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 119, MVar:'51', Cost:11.72, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'57', Cost:11.72, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 152,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 152, MVar:'83', Cost:16.89, ParentId: '15'},
