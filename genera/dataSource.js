const timestamp_saved = '08/19/2023 06:05 PM';
const dataFechaAcualizado = '8/19/2023' + ' 2:02:57 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 462,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'54', Cost:10.48, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 151, MVar:'54', Cost:10.48, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 144, MVar:'55', Cost:10.48, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 108,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 52, MVar:'11', Cost:29.91, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 52, MVar:'12', Cost:30.72, ParentId: '10'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 105,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 105, MVar:'93', Cost:18.28, ParentId: '15'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 325,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 325, MVar:'72', Cost:9.29, ParentId: '17'},
		]
	},
