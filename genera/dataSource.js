const timestamp_saved = '10/23/2023 07:10 AM';
const dataFechaAcualizado = '10/23/2023' + ' 3:06:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 325,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 104, MVar:'35', Cost:12.60, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 104, MVar:'35', Cost:12.60, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 115, MVar:'38', Cost:12.60, ParentId: '7'},
		]
	},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'59', Cost:16.83, ParentId: '15'},
