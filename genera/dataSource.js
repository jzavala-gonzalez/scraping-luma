const timestamp_saved = '08/04/2023 10:30 PM';
const dataFechaAcualizado = '8/4/2023' + ' 6:25:38 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 396,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'43', Cost:11.36, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 320,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 170, MVar:'94', Cost:16.56, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 303,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 303, MVar:'149', Cost:17.10, ParentId: '16'},
		]
	},
