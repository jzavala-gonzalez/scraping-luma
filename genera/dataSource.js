const timestamp_saved = '08/25/2023 09:00 AM';
const dataFechaAcualizado = '8/25/2023' + ' 4:55:48 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'58', Cost:11.11, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 105, MVar:'57', Cost:11.11, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'56', Cost:11.11, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 75,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 75, MVar:'18', Cost:19.27, ParentId: '14'},
