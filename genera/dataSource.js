const timestamp_saved = '11/03/2023 11:05 AM';
const dataFechaAcualizado = '11/3/2023' + ' 7:01:18 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'4', Type:'Hidroelectricas', Desc:'Toro Negro', SiteTotal: 0,
		units:[
			...
			{Index:'3', Unit:'Hidro 4', MW: 0, MVar:'1', Cost:0, ParentId: '4'},
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 136, MVar:'49', Cost:11.32, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'46', Cost:11.32, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 130, MVar:'44', Cost:11.32, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'7', Cost:17.21, ParentId: '11'},
	...
	{Index:'19', Type:'Renovable', Desc:'Solar', SiteTotal: 6,
		units:[
			...
			{Index:'4', Unit:'Oriana', MW: 2, MVar:'2', Cost:19.60, ParentId: '19'},
