const timestamp_saved = '11/03/2023 07:45 PM';
const dataFechaAcualizado = '11/3/2023' + ' 3:41:19 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 168, MVar:'61', Cost:10.53, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 168, MVar:'60', Cost:10.53, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 149, MVar:'53', Cost:10.53, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 281,
		units:[
			...
			{Index:'1', Unit:'STG 5', MW: 43, MVar:'9', Cost:17.16, ParentId: '11'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'105', Cost:16.84, ParentId: '15'},
