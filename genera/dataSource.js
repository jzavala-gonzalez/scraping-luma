const timestamp_saved = '08/02/2023 02:10 AM';
const dataFechaAcualizado = '8/1/2023' + ' 10:05:36 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 399,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 169, MVar:'49', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 95, MVar:'44', Cost:11.12, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 136, MVar:'48', Cost:11.12, ParentId: '7'},
		]
	},
	{Index:'8', Type:'Turbina de Gas', Desc:'Estaciones GT', SiteTotal: 117,
		units:[
			...
			{Index:'7', Unit:'FEMA GT PS', MW: 159, MVar:'2', Cost:0, ParentId: '8'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 305,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 155, MVar:'75', Cost:16.81, ParentId: '15'},
			{Index:'3', Unit:'Unit 4', MW: 150, MVar:'37', Cost:15.64, ParentId: '15'},
		]
	},
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 329,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 0, MVar:'0', Cost:0, ParentId: '16'},
			{Index:'1', Unit:'Unit 2', MW: 329, MVar:'140', Cost:16.88, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 301, MVar:'93', Cost:10.99, ParentId: '17'},
		]
	},
