const timestamp_saved = '09/15/2023 10:55 PM';
const dataFechaAcualizado = '9/15/2023' + ' 6:50:53 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 484,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 166, MVar:'58', Cost:10.13, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 167, MVar:'55', Cost:10.13, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 152, MVar:'67', Cost:10.13, ParentId: '7'},
		]
	},
	...
	{Index:'9', Type:'Turbina de Gas', Desc:'Mayaguez', SiteTotal: 76,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 52, MVar:'2', Cost:25.91, ParentId: '9'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 81,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 81, MVar:'35', Cost:19.29, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 154,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 154, MVar:'102', Cost:16.85, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 357,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 357, MVar:'170', Cost:16.71, ParentId: '16'},
		]
	},
