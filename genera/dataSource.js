const timestamp_saved = '09/28/2023 08:25 AM';
const dataFechaAcualizado = '9/28/2023' + ' 4:20:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 300,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 97, MVar:'17', Cost:13.20, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 97, MVar:'17', Cost:13.20, ParentId: '7'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 151,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 151, MVar:'51', Cost:16.89, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'92', Cost:18.43, ParentId: '16'},
		]
	},
