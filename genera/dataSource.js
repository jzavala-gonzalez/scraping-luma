const timestamp_saved = '09/14/2023 01:30 PM';
const dataFechaAcualizado = '9/14/2023' + ' 9:25:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 466,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 159, MVar:'54', Cost:10.57, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 146, MVar:'66', Cost:10.57, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 409,
		units:[
			...
			{Index:'3', Unit:'STG 6', MW: 48, MVar:'11', Cost:8.11, ParentId: '11'},
		]
	},
