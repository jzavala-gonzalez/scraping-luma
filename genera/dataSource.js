const timestamp_saved = '09/12/2023 07:50 AM';
const dataFechaAcualizado = '9/12/2023' + ' 3:45:52 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 451,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 249, MVar:'62', Cost:4.38, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 201, MVar:'59', Cost:4.38, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 398,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 135, MVar:'47', Cost:11.42, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 135, MVar:'44', Cost:11.42, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 129, MVar:'61', Cost:11.42, ParentId: '7'},
		]
	},
	...
	{Index:'10', Type:'Turbina de Gas', Desc:'Cambalache', SiteTotal: 59,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 8, MVar:'0', Cost:32.64, ParentId: '10'},
			{Index:'2', Unit:'Gas 3', MW: 51, MVar:'0', Cost:31.06, ParentId: '10'},
		]
	},
	...
	{Index:'13', Type:'Ciclo Combinado', Desc:'Aguirre Stag 2', SiteTotal: 31,
		units:[
			...
			{Index:'3', Unit:'Gas 4', MW: 31, MVar:'0', Cost:31.67, ParentId: '13'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 153,
		units:[
			...
			{Index:'2', Unit:'Unit 3', MW: 153, MVar:'76', Cost:16.86, ParentId: '15'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 220,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 220, MVar:'115', Cost:18.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 205,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 205, MVar:'32', Cost:10.45, ParentId: '17'},
		]
	},
