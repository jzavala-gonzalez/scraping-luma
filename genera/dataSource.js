const timestamp_saved = '07/27/2023 01:07 PM';
const dataFechaAcualizado = '7/27/2023' + ' 9:00:32 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'6', Type:'COGEN', Desc:'AES', SiteTotal: 426,
		units:[
			{Index:'0', Unit:'Unit 1', MW: 246, MVar:'62', Cost:4.40, ParentId: '6'},
			{Index:'1', Unit:'Unit 2', MW: 179, MVar:'65', Cost:4.40, ParentId: '6'},
		]
	},
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 422,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 171, MVar:'51', Cost:10.86, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 112, MVar:'52', Cost:10.86, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'49', Cost:10.86, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 382,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 150, MVar:'45', Cost:20.28, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 48, MVar:'9', Cost:20.28, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 140, MVar:'0', Cost:8.71, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 95,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 95, MVar:'18', Cost:18.69, ParentId: '14'},
	...
	{Index:'15', Type:'Vapor', Desc:'Palo Seco', SiteTotal: 301,
		units:[
			...
			{Index:'3', Unit:'Unit 4', MW: 151, MVar:'47', Cost:15.63, ParentId: '15'},
		]
	},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 348,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 348, MVar:'80', Cost:13.18, ParentId: '17'},
		]
	},
