const timestamp_saved = '09/13/2023 08:25 AM';
const dataFechaAcualizado = '9/13/2023' + ' 4:20:53 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 438,
		units:[
			...
			{Index:'2', Unit:'STG', MW: 142, MVar:'61', Cost:10.45, ParentId: '7'},
		]
	},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 216,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 216, MVar:'137', Cost:19.07, ParentId: '16'},
		]
	},
