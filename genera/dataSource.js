const timestamp_saved = '11/15/2023 07:15 PM';
const dataFechaAcualizado = '11/15/2023' + ' 3:11:21 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 467,
		units:[
			...
			{Index:'1', Unit:'Gas 2', MW: 163, MVar:'60', Cost:10.39, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 141, MVar:'60', Cost:10.39, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 326,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 153, MVar:'48', Cost:17.15, ParentId: '11'},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 60,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'4', Cost:31.60, ParentId: '12'},
			{Index:'1', Unit:'Gas 2', MW: 30, MVar:'0', Cost:38.78, ParentId: '12'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 262,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 262, MVar:'166', Cost:17.62, ParentId: '16'},
		]
	},
