const timestamp_saved = '08/17/2023 10:50 AM';
const dataFechaAcualizado = '8/17/2023' + ' 6:47:55 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 402,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 172, MVar:'44', Cost:11.18, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 99, MVar:'57', Cost:11.18, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 133, MVar:'69', Cost:11.18, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 88,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 88, MVar:'19', Cost:18.80, ParentId: '14'},
