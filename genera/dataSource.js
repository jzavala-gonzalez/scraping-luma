const timestamp_saved = '10/28/2023 08:35 AM';
const dataFechaAcualizado = '10/28/2023' + ' 4:31:17 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 343,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 111, MVar:'34', Cost:11.96, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 111, MVar:'36', Cost:11.96, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 120, MVar:'43', Cost:11.96, ParentId: '7'},
		]
	},
	...
	{Index:'11', Type:'Ciclo Combinado', Desc:'San Juan', SiteTotal: 150,
		units:[
			{Index:'0', Unit:'CTG 5', MW: 70, MVar:'20', Cost:28.21, ParentId: '11'},
			{Index:'1', Unit:'STG 5', MW: 0, MVar:'0', Cost:28.21, ParentId: '11'},
			{Index:'2', Unit:'CTG 6', MW: 80, MVar:'23', Cost:0, ParentId: '11'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 113,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 76, MVar:'13', Cost:19.00, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 250,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 250, MVar:'0', Cost:9.59, ParentId: '17'},
		]
	},
