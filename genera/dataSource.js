const timestamp_saved = '09/21/2023 08:20 AM';
const dataFechaAcualizado = '9/21/2023' + ' 4:15:54 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 362,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 120, MVar:'37', Cost:11.84, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 119, MVar:'41', Cost:11.84, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 123, MVar:'61', Cost:11.84, ParentId: '7'},
		]
	},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'9', Cost:26.68, ParentId: '14'},
