const timestamp_saved = '09/20/2023 11:55 PM';
const dataFechaAcualizado = '9/20/2023' + ' 7:50:54 PM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 409,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 137, MVar:'50', Cost:11.12, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 138, MVar:'55', Cost:11.12, ParentId: '7'},
	...
	{Index:'14', Type:'Vapor', Desc:'San Juan', SiteTotal: 35,
		units:[
			...
			{Index:'2', Unit:'Unit 9', MW: 35, MVar:'23', Cost:26.58, ParentId: '14'},
	...
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 371,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 371, MVar:'103', Cost:9.13, ParentId: '17'},
		]
	},
