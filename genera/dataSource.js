const timestamp_saved = '10/21/2023 05:55 AM';
const dataFechaAcualizado = '10/21/2023' + ' 1:51:16 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 387,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 130, MVar:'24', Cost:11.50, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 130, MVar:'23', Cost:11.50, ParentId: '7'},
	...
	{Index:'16', Type:'Vapor', Desc:'Aguirre', SiteTotal: 252,
		units:[
			...
			{Index:'1', Unit:'Unit 2', MW: 252, MVar:'134', Cost:17.60, ParentId: '16'},
		]
	},
	{Index:'17', Type:'Vapor', Desc:'Costa Sur', SiteTotal: 276,
		units:[
			...
			{Index:'3', Unit:'Unit 6', MW: 276, MVar:'77', Cost:11.05, ParentId: '17'},
		]
	},
