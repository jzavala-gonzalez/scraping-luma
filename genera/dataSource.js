const timestamp_saved = '09/05/2023 08:10 AM';
const dataFechaAcualizado = '9/5/2023' + ' 4:05:51 AM';
const dataFuelCost = [
...
const dataLoadPerSite = [
	...
	{Index:'7', Type:'COGEN', Desc:'Ecoelectrica', SiteTotal: 333,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 109, MVar:'33', Cost:12.34, ParentId: '7'},
			{Index:'1', Unit:'Gas 2', MW: 109, MVar:'38', Cost:12.34, ParentId: '7'},
			{Index:'2', Unit:'STG', MW: 117, MVar:'52', Cost:12.34, ParentId: '7'},
		]
	},
	...
	{Index:'12', Type:'Ciclo Combinado', Desc:'Aguirre Stag 1', SiteTotal: 31,
		units:[
			{Index:'0', Unit:'Gas 1', MW: 31, MVar:'0', Cost:30.49, ParentId: '12'},
